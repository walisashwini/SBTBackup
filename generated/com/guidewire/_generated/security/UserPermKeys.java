...
public class UserPermKeys {
  ...
  public static final StaticPermissionKey SERVERTOOLS = new StaticPermissionKey("ServerTools", entity.User.class.getSimpleName(), com.guidewire.pl.system.security.PermissionHandlerConfig.builder().withPermissions("internaltools", "toolsInfoview", "toolsJMXBeansview", "toolsJProfileredit", "toolsBatchProcessview", "toolsWorkQueueview", "toolsProfilerview", "toolsPluginview", "toolsLogview", "toolsLogedit", "toolsClusterview", "toolsProductModelInfoview").withDisplayKey("Web.ServerTools.NoPermission").build());
  ...
  public static final StaticPermissionKey VIEWPRODUCTMODELINFO = new StaticPermissionKey("ViewProductModelInfo", entity.User.class.getSimpleName(), com.guidewire.pl.system.security.PermissionHandlerConfig.builder().withPermissions("internaltools", "toolsProductModelInfoview").build());
  ...
  public static List<PermissionKey> getPermissionKeys() {
    ...
    permissionKeys.add(VIEWPRODUCTMODELINFO);

...
/**
 * APDClaimCostCategory
 * A type of cost resulting from a claim; matches CC CostCategory typelist
 */
...
@gw.entity.EntityName(value = "APDClaimCostCategory")
public class APDClaimCostCategory extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.APDClaimCostCategory> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.APDClaimCostCategory>("entity.APDClaimCostCategory");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> RESTRICTEDPERILS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "RestrictedPerils");
  ...
  private com.guidewire._generated.entity.APDClaimCostCategoryInternal _internal;
   ...
   */
  public APDClaimCostCategory(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected APDClaimCostCategory(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.APDClaimCostCategoryInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDClaimCostCategoryInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToRestrictedPerils(entity.APDClaimPeril element) {
    __getInternalInterface().addArrayElement(RESTRICTEDPERILS_PROP.get(), element);
  }
  ...
  public typekey.APDCostType getCostType() {
    return (typekey.APDCostType)__getInternalInterface().getFieldValue(COSTTYPE_PROP.get());
  }
  ...
  public entity.APDClaimCostCategory_Description_L10N[] getDescription_L10N_ARRAY() {
    return (entity.APDClaimCostCategory_Description_L10N[])__getInternalInterface().getFieldValue(DESCRIPTION_L10N_ARRAY_PROP.get());
  }
  ...
  public entity.APDClaimCostCategory_Name_L10N[] getName_L10N_ARRAY() {
    return (entity.APDClaimCostCategory_Name_L10N[])__getInternalInterface().getFieldValue(NAME_L10N_ARRAY_PROP.get());
  }
  ...
  public entity.APDClaimPeril[] getRestrictedPerils() {
    return (entity.APDClaimPeril[])__getInternalInterface().getFieldValue(RESTRICTEDPERILS_PROP.get());
  }
  ...
  public void removeFromRestrictedPerils(entity.APDClaimPeril element) {
    __getInternalInterface().removeArrayElement(RESTRICTEDPERILS_PROP.get(), element);
  }
  ...
  public void removeFromRestrictedPerils(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(RESTRICTEDPERILS_PROP.get(), elementID);
  }
   ...
   */
  private void setDescription_L10N_ARRAY(entity.APDClaimCostCategory_Description_L10N[] value) {
   ...
   */
  private void setName_L10N_ARRAY(entity.APDClaimCostCategory_Name_L10N[] value) {
  ...
  public void setRestrictedPerils(entity.APDClaimPeril[] value) {
    __getInternalInterface().setFieldValue(RESTRICTEDPERILS_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDClaimCostCategoryInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDClaimCostCategory.this.__getDelegateManager();
    }
    ...
    public entity.APDClaimCostCategory_Description_L10N getDescription_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.APDClaimCostCategory_Description_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
    ...
    public entity.APDClaimCostCategory_Name_L10N getName_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.APDClaimCostCategory_Name_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDClaimCostCategory.class, config);
    com.guidewire._generated.entity.APDClaimCostCategoryInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDClaimCostCategory, com.guidewire._generated.entity.APDClaimCostCategoryInternal>() {
      public java.lang.Object getImplementation(entity.APDClaimCostCategory bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDClaimCostCategoryInternal getInternalInterface(entity.APDClaimCostCategory bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDClaimCostCategory newEmptyInstance() {
        return new entity.APDClaimCostCategory((java.lang.Void)null);
      }

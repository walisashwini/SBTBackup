 ...
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "APDCondition.eti;APDCondition.eix;APDCondition.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "APDCondition")
public class APDCondition extends entity.APDClause {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.APDCondition> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.APDCondition>("entity.APDCondition");
   ...
   */
  public APDCondition(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected APDCondition(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.APDConditionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDConditionInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.APDConditionInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDConditionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDCondition.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDCondition.class, config);
    com.guidewire._generated.entity.APDConditionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDCondition, com.guidewire._generated.entity.APDConditionInternal>() {
      public java.lang.Object getImplementation(entity.APDCondition bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDConditionInternal getInternalInterface(entity.APDCondition bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDCondition newEmptyInstance() {
        return new entity.APDCondition((java.lang.Void)null);
      }

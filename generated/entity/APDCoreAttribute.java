...
/**
 * APDCoreAttribute
 * Core application field; used for definition of core fields in rules etc.
 */
...
@gw.entity.EntityName(value = "APDCoreAttribute")
public class APDCoreAttribute extends entity.APDAttribute {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.APDCoreAttribute> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.APDCoreAttribute>("entity.APDCoreAttribute");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> FIELDTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "FieldType");
   ...
   */
  public APDCoreAttribute(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected APDCoreAttribute(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.APDCoreAttributeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDCoreAttributeInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.APDCoreAttributeInternal)super.__getInternalInterface();
  }
  ...
  public typekey.APDCoreFieldType getFieldType() {
    return (typekey.APDCoreFieldType)__getInternalInterface().getFieldValue(FIELDTYPE_PROP.get());
  }
  ...
  public void setFieldType(typekey.APDCoreFieldType value) {
    __getInternalInterface().setFieldValue(FIELDTYPE_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDCoreAttributeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDCoreAttribute.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDCoreAttribute.class, config);
    com.guidewire._generated.entity.APDCoreAttributeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDCoreAttribute, com.guidewire._generated.entity.APDCoreAttributeInternal>() {
      public java.lang.Object getImplementation(entity.APDCoreAttribute bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDCoreAttributeInternal getInternalInterface(entity.APDCoreAttribute bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDCoreAttribute newEmptyInstance() {
        return new entity.APDCoreAttribute((java.lang.Void)null);
      }

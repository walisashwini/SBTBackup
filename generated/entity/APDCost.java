...
/**
 * APDCost
 * A unit of premium or other cost (taxes, fees, etc.) for the Manual Products line.
 */
...
public abstract class APDCost extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.APDCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.APDCost, entity.PolicyPeriod>("entity.APDCost");
  ...
  private com.guidewire._generated.entity.APDCostInternal _internal;
  ...
  protected APDCost(java.lang.Void ignored)  {
    
  }
  
  protected abstract com.guidewire._generated.entity.APDCostInternal __createInternalInterface();
  ...
  protected com.guidewire._generated.entity.APDCostInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.APDCost clone() {
    return (entity.APDCost)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.APDCost getBasedOn() {
    return (entity.APDCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.APDCost getSlice(java.util.Date sliceDate) {
    return (entity.APDCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.APDCost getUnsliced() {
    return (entity.APDCost)getUnslicedUntyped();
  }
  ...
  public entity.windowed.APDCostVersionList getVersionList() {
    return (entity.windowed.APDCostVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.APDCost value) {
   ...
   */
  private void setFixed(entity.APDCost value) {
   ...
   */
  private void setSubtype(typekey.APDCost value) {
   ...
   */
  private void setTransactions(entity.APDTransaction[] value) {
  ...
  public entity.APDCost split(java.util.Date splitDate) {
    return (entity.APDCost)splitUntyped(splitDate);
  }
  ...
  static {
    com.guidewire._generated.entity.APDCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.EntityFriendAccess<entity.APDCost, com.guidewire._generated.entity.APDCostInternal>() {
      public java.lang.Object getImplementation(entity.APDCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDCostInternal getInternalInterface(entity.APDCost bean) {
        if(bean == null) {
          return null;
        };

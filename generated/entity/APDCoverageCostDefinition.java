...
/**
 * APDCoverageCostDefinition
 * A definition of a cost for a risk object
 */
...
@gw.entity.EntityName(value = "APDCoverageCostDefinition")
public class APDCoverageCostDefinition extends entity.APDCostDefinition {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.APDCoverageCostDefinition> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.APDCoverageCostDefinition>("entity.APDCoverageCostDefinition");
   ...
   */
  public APDCoverageCostDefinition()  {
   ...
   */
  public APDCoverageCostDefinition(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected APDCoverageCostDefinition(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.APDCoverageCostDefinitionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDCoverageCostDefinitionInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.APDCoverageCostDefinitionInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDCoverageCostDefinitionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDCoverageCostDefinition.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDCoverageCostDefinition.class, config);
    com.guidewire._generated.entity.APDCoverageCostDefinitionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDCoverageCostDefinition, com.guidewire._generated.entity.APDCoverageCostDefinitionInternal>() {
      public java.lang.Object getImplementation(entity.APDCoverageCostDefinition bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDCoverageCostDefinitionInternal getInternalInterface(entity.APDCoverageCostDefinition bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDCoverageCostDefinition newEmptyInstance() {
        return new entity.APDCoverageCostDefinition((java.lang.Void)null);
      }

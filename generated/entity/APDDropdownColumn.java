...
/**
 * APDDropdownColumn
 * A column for a value associated with a dropdown entry 
 */
...
@gw.entity.EntityName(value = "APDDropdownColumn")
public class APDDropdownColumn extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.APDDropdownColumn> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.APDDropdownColumn>("entity.APDDropdownColumn");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> TERM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "Term");
  ...
  private com.guidewire._generated.entity.APDDropdownColumnInternal _internal;
   ...
   */
  public APDDropdownColumn(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected APDDropdownColumn(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.APDDropdownColumnInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDDropdownColumnInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.APDDropdownColumn_Name_L10N[] getName_L10N_ARRAY() {
    return (entity.APDDropdownColumn_Name_L10N[])__getInternalInterface().getFieldValue(NAME_L10N_ARRAY_PROP.get());
  }
  ...
  public typekey.APDDropdownColumn getSubtype() {
    return (typekey.APDDropdownColumn)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.APDTerm getTerm() {
    return (entity.APDTerm)__getInternalInterface().getFieldValue(TERM_PROP.get());
  }
  ...
  public typekey.CovTermModelVal getValueType() {
    return (typekey.CovTermModelVal)__getInternalInterface().getFieldValue(VALUETYPE_PROP.get());
  }
   ...
   */
  private void setName_L10N_ARRAY(entity.APDDropdownColumn_Name_L10N[] value) {
   ...
   */
  private void setSubtype(typekey.APDDropdownColumn value) {
  ...
  public void setTerm(entity.APDTerm value) {
    __getInternalInterface().setFieldValue(TERM_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDDropdownColumnInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDDropdownColumn.this.__getDelegateManager();
    }
    ...
    public entity.APDDropdownColumn_Name_L10N getName_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.APDDropdownColumn_Name_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
    ...
    public gw.pl.persistence.core.Key getTermID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(TERM_PROP.get());
    }
    ...
    public void setTermID(gw.pl.persistence.core.Key value) {
      setFieldValue(TERM_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDDropdownColumn.class, config);
    com.guidewire._generated.entity.APDDropdownColumnInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDDropdownColumn, com.guidewire._generated.entity.APDDropdownColumnInternal>() {
      public java.lang.Object getImplementation(entity.APDDropdownColumn bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDDropdownColumnInternal getInternalInterface(entity.APDDropdownColumn bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDDropdownColumn newEmptyInstance() {
        return new entity.APDDropdownColumn((java.lang.Void)null);
      }

...
/**
 * APDDropdownEntryRule
 * Rules that apply to a dropdown entry
 */
...
@gw.entity.EntityName(value = "APDDropdownEntryRule")
public class APDDropdownEntryRule extends entity.APDAttributeRule {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.APDDropdownEntryRule> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.APDDropdownEntryRule>("entity.APDDropdownEntryRule");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> DROPDOWNENTRY_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "DropdownEntry");
   ...
   */
  public APDDropdownEntryRule(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected APDDropdownEntryRule(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.APDDropdownEntryRuleInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDDropdownEntryRuleInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.APDDropdownEntryRuleInternal)super.__getInternalInterface();
  }
  ...
  public entity.APDDropdownEntry getDropdownEntry() {
    return (entity.APDDropdownEntry)__getInternalInterface().getFieldValue(DROPDOWNENTRY_PROP.get());
  }
  ...
  public void setDropdownEntry(entity.APDDropdownEntry value) {
    __getInternalInterface().setFieldValue(DROPDOWNENTRY_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDDropdownEntryRuleInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDDropdownEntryRule.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getDropdownEntryID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(DROPDOWNENTRY_PROP.get());
    }
    ...
    public void setDropdownEntryID(gw.pl.persistence.core.Key value) {
      setFieldValue(DROPDOWNENTRY_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDDropdownEntryRule.class, config);
    com.guidewire._generated.entity.APDDropdownEntryRuleInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDDropdownEntryRule, com.guidewire._generated.entity.APDDropdownEntryRuleInternal>() {
      public java.lang.Object getImplementation(entity.APDDropdownEntryRule bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDDropdownEntryRuleInternal getInternalInterface(entity.APDDropdownEntryRule bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDDropdownEntryRule newEmptyInstance() {
        return new entity.APDDropdownEntryRule((java.lang.Void)null);
      }

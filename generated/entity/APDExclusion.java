 ...
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "APDExclusion.eti;APDExclusion.eix;APDExclusion.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "APDExclusion")
public class APDExclusion extends entity.APDClause {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.APDExclusion> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.APDExclusion>("entity.APDExclusion");
   ...
   */
  public APDExclusion(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected APDExclusion(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.APDExclusionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDExclusionInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.APDExclusionInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDExclusionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDExclusion.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDExclusion.class, config);
    com.guidewire._generated.entity.APDExclusionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDExclusion, com.guidewire._generated.entity.APDExclusionInternal>() {
      public java.lang.Object getImplementation(entity.APDExclusion bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDExclusionInternal getInternalInterface(entity.APDExclusion bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDExclusion newEmptyInstance() {
        return new entity.APDExclusion((java.lang.Void)null);
      }

...
/**
 * APDField
 * The base definition of any type of field
 */
...
@gw.entity.EntityName(value = "APDField")
public class APDField extends entity.APDAttribute {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.APDField> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.APDField>("entity.APDField");
   ...
   */
  public APDField(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected APDField(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.APDFieldInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDFieldInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.APDFieldInternal)super.__getInternalInterface();
  }
  ...
  public java.lang.Boolean isIdentifier() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(IDENTIFIER_PROP.get());
  }
  ...
  public void setIdentifier(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(IDENTIFIER_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDFieldInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDField.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDField.class, config);
    com.guidewire._generated.entity.APDFieldInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDField, com.guidewire._generated.entity.APDFieldInternal>() {
      public java.lang.Object getImplementation(entity.APDField bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDFieldInternal getInternalInterface(entity.APDField bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDField newEmptyInstance() {
        return new entity.APDField((java.lang.Void)null);
      }

...
/**
 * APDInvolvedParty
 * Involved Party Account Contact Role
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "APDInvolvedParty.eti;APDInvolvedParty.eix;APDInvolvedParty.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "APDInvolvedParty")
public class APDInvolvedParty extends entity.AccountContactRole {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.APDInvolvedParty> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.APDInvolvedParty>("entity.APDInvolvedParty");
   ...
   */
  public APDInvolvedParty(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected APDInvolvedParty(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.APDInvolvedPartyInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDInvolvedPartyInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.APDInvolvedPartyInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDInvolvedPartyInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDInvolvedParty.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDInvolvedParty.class, config);
    com.guidewire._generated.entity.APDInvolvedPartyInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDInvolvedParty, com.guidewire._generated.entity.APDInvolvedPartyInternal>() {
      public java.lang.Object getImplementation(entity.APDInvolvedParty bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDInvolvedPartyInternal getInternalInterface(entity.APDInvolvedParty bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDInvolvedParty newEmptyInstance() {
        return new entity.APDInvolvedParty((java.lang.Void)null);
      }

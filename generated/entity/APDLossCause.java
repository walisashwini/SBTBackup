...
/**
 * APDLossCause
 * Cause of Loss - used to create/sync with CC LossCause typelist
 */
...
@gw.entity.EntityName(value = "APDLossCause")
public class APDLossCause extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.APDLossCause> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.APDLossCause>("entity.APDLossCause");
  ...
  private com.guidewire._generated.entity.APDLossCauseInternal _internal;
   ...
   */
  public APDLossCause(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected APDLossCause(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.APDLossCauseInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDLossCauseInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.APDLossCause_Description_L10N[] getDescription_L10N_ARRAY() {
    return (entity.APDLossCause_Description_L10N[])__getInternalInterface().getFieldValue(DESCRIPTION_L10N_ARRAY_PROP.get());
  }
  ...
  public typekey.APDLossType getLossType() {
    return (typekey.APDLossType)__getInternalInterface().getFieldValue(LOSSTYPE_PROP.get());
  }
  ...
  public entity.APDLossCause_Name_L10N[] getName_L10N_ARRAY() {
    return (entity.APDLossCause_Name_L10N[])__getInternalInterface().getFieldValue(NAME_L10N_ARRAY_PROP.get());
  }
   ...
   */
  private void setDescription_L10N_ARRAY(entity.APDLossCause_Description_L10N[] value) {
   ...
   */
  private void setName_L10N_ARRAY(entity.APDLossCause_Name_L10N[] value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDLossCauseInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDLossCause.this.__getDelegateManager();
    }
    ...
    public entity.APDLossCause_Description_L10N getDescription_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.APDLossCause_Description_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
    ...
    public entity.APDLossCause_Name_L10N getName_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.APDLossCause_Name_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDLossCause.class, config);
    com.guidewire._generated.entity.APDLossCauseInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDLossCause, com.guidewire._generated.entity.APDLossCauseInternal>() {
      public java.lang.Object getImplementation(entity.APDLossCause bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDLossCauseInternal getInternalInterface(entity.APDLossCause bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDLossCause newEmptyInstance() {
        return new entity.APDLossCause((java.lang.Void)null);
      }

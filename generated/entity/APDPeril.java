...
/**
 * APDPeril
 * The peril or subclassification of a coverage; matches to the CoverageSubtype typelist in CC
 */
...
@gw.entity.EntityName(value = "APDPeril")
public class APDPeril extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.APDPeril> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.APDPeril>("entity.APDPeril");
  ...
  private com.guidewire._generated.entity.APDPerilInternal _internal;
   ...
   */
  public APDPeril(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected APDPeril(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.APDPerilInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDPerilInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.APDPeril_Description_L10N[] getDescription_L10N_ARRAY() {
    return (entity.APDPeril_Description_L10N[])__getInternalInterface().getFieldValue(DESCRIPTION_L10N_ARRAY_PROP.get());
  }
  ...
  public entity.APDPerilCause[] getLossCauses() {
    return (entity.APDPerilCause[])__getInternalInterface().getFieldValue(LOSSCAUSES_PROP.get());
  }
  ...
  public entity.APDPeril_Name_L10N[] getName_L10N_ARRAY() {
    return (entity.APDPeril_Name_L10N[])__getInternalInterface().getFieldValue(NAME_L10N_ARRAY_PROP.get());
  }
   ...
   */
  private void setDescription_L10N_ARRAY(entity.APDPeril_Description_L10N[] value) {
   ...
   */
  private void setName_L10N_ARRAY(entity.APDPeril_Name_L10N[] value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDPerilInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDPeril.this.__getDelegateManager();
    }
    ...
    public entity.APDPeril_Description_L10N getDescription_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.APDPeril_Description_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
    ...
    public entity.APDPeril_Name_L10N getName_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.APDPeril_Name_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDPeril.class, config);
    com.guidewire._generated.entity.APDPerilInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDPeril, com.guidewire._generated.entity.APDPerilInternal>() {
      public java.lang.Object getImplementation(entity.APDPeril bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDPerilInternal getInternalInterface(entity.APDPeril bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDPeril newEmptyInstance() {
        return new entity.APDPeril((java.lang.Void)null);
      }

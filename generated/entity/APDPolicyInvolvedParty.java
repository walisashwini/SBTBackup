 ...
 * Involved Party Policy Contact Role
 */
...
@gw.entity.EntityName(value = "APDPolicyInvolvedParty")
public class APDPolicyInvolvedParty extends entity.PolicyContactRole {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.APDPolicyInvolvedParty, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.APDPolicyInvolvedParty, entity.PolicyPeriod>("entity.APDPolicyInvolvedParty");
   ...
   */
  public APDPolicyInvolvedParty(entity.PolicyPeriod branch)  {
   ...
   */
  public APDPolicyInvolvedParty(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected APDPolicyInvolvedParty(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.APDPolicyInvolvedPartyInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDPolicyInvolvedPartyInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.APDPolicyInvolvedPartyInternal)super.__getInternalInterface();
  }
  
  public entity.APDPolicyInvolvedParty clone() {
    return (entity.APDPolicyInvolvedParty)__getInternalInterface().cloneUntyped();
  }
  
  public entity.APDPolicyInvolvedParty getBasedOn() {
    return (entity.APDPolicyInvolvedParty)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.APDPolicyInvolvedParty getSlice(java.util.Date sliceDate) {
    return (entity.APDPolicyInvolvedParty)getSliceUntyped(sliceDate);
  }
  
  public entity.APDPolicyInvolvedParty getUnsliced() {
    return (entity.APDPolicyInvolvedParty)getUnslicedUntyped();
  }
  
  public entity.windowed.APDPolicyInvolvedPartyVersionList getVersionList() {
    return (entity.windowed.APDPolicyInvolvedPartyVersionList)getVersionListUntyped();
  }
  
  public entity.APDPolicyInvolvedParty split(java.util.Date splitDate) {
    return (entity.APDPolicyInvolvedParty)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDPolicyInvolvedPartyInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDPolicyInvolvedParty.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDPolicyInvolvedParty.class, config);
    com.guidewire._generated.entity.APDPolicyInvolvedPartyInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDPolicyInvolvedParty, com.guidewire._generated.entity.APDPolicyInvolvedPartyInternal>() {
      public java.lang.Object getImplementation(entity.APDPolicyInvolvedParty bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDPolicyInvolvedPartyInternal getInternalInterface(entity.APDPolicyInvolvedParty bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDPolicyInvolvedParty newEmptyInstance() {
        return new entity.APDPolicyInvolvedParty((java.lang.Void)null);
      }

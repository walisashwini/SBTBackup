...
/**
 * APDPricing
 * Identifies the rate from which a cost is created
 */
...
public abstract class APDPricing extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.APDPricing, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.APDPricing, entity.PolicyPeriod>("entity.APDPricing");
  ...
  private com.guidewire._generated.entity.APDPricingInternal _internal;
  ...
  protected APDPricing(java.lang.Void ignored)  {
    
  }
  
  protected abstract com.guidewire._generated.entity.APDPricingInternal __createInternalInterface();
  ...
  protected com.guidewire._generated.entity.APDPricingInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.APDPricing clone() {
    return (entity.APDPricing)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.APDPricing getBasedOn() {
    return (entity.APDPricing)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.APDPricing getSlice(java.util.Date sliceDate) {
    return (entity.APDPricing)getSliceUntyped(sliceDate);
  }
  ...
  public entity.APDPricing getUnsliced() {
    return (entity.APDPricing)getUnslicedUntyped();
  }
  ...
  public entity.windowed.APDPricingVersionList getVersionList() {
    return (entity.windowed.APDPricingVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.APDPricing value) {
   ...
   */
  private void setFixed(entity.APDPricing value) {
   ...
   */
  private void setSubtype(typekey.APDPricing value) {
  ...
  public entity.APDPricing split(java.util.Date splitDate) {
    return (entity.APDPricing)splitUntyped(splitDate);
  }
  ...
  static {
    com.guidewire._generated.entity.APDPricingInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.EntityFriendAccess<entity.APDPricing, com.guidewire._generated.entity.APDPricingInternal>() {
      public java.lang.Object getImplementation(entity.APDPricing bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDPricingInternal getInternalInterface(entity.APDPricing bean) {
        if(bean == null) {
          return null;
        };

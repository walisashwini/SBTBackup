...
@gw.entity.EntityName(value = "APDRiskClause")
public class APDRiskClause extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.APDRiskClause, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.APDRiskClause, entity.PolicyPeriod>("entity.APDRiskClause");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> RISKITEMS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "RiskItems");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> RISKTERMS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "RiskTerms");
  ...
  private com.guidewire._generated.entity.APDRiskClauseInternal _internal;
   ...
   */
  public APDRiskClause(entity.PolicyPeriod branch)  {
   ...
   */
  public APDRiskClause(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected APDRiskClause(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.APDRiskClauseInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDRiskClauseInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.APDRiskClause clone() {
    return (entity.APDRiskClause)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.APDRiskClause getBasedOn() {
    return (entity.APDRiskClause)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.APDRiskClause getSlice(java.util.Date sliceDate) {
    return (entity.APDRiskClause)getSliceUntyped(sliceDate);
  }
  ...
  public entity.APDRiskClause getUnsliced() {
    return (entity.APDRiskClause)getUnslicedUntyped();
  }
  ...
  public entity.windowed.APDRiskClauseVersionList getVersionList() {
    return (entity.windowed.APDRiskClauseVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.APDRiskClause value) {
   ...
   */
  private void setFixed(entity.APDRiskClause value) {
   ...
   */
  private void setSubtype(typekey.APDRiskClause value) {
  ...
  public entity.APDRiskClause split(java.util.Date splitDate) {
    return (entity.APDRiskClause)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDRiskClauseInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDRiskClause.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDRiskClause.class, config);
    com.guidewire._generated.entity.APDRiskClauseInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDRiskClause, com.guidewire._generated.entity.APDRiskClauseInternal>() {
      public java.lang.Object getImplementation(entity.APDRiskClause bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDRiskClauseInternal getInternalInterface(entity.APDRiskClause bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDRiskClause newEmptyInstance() {
        return new entity.APDRiskClause((java.lang.Void)null);
      }

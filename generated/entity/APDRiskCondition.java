...
/**
 * APDRiskCondition
 * A condition clause qualifying a risk
 */
...
@gw.entity.EntityName(value = "APDRiskCondition")
public class APDRiskCondition extends entity.APDRiskClause {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.APDRiskCondition, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.APDRiskCondition, entity.PolicyPeriod>("entity.APDRiskCondition");
   ...
   */
  public APDRiskCondition(entity.PolicyPeriod branch)  {
   ...
   */
  public APDRiskCondition(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected APDRiskCondition(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.APDRiskConditionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDRiskConditionInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.APDRiskConditionInternal)super.__getInternalInterface();
  }
  
  public entity.APDRiskCondition clone() {
    return (entity.APDRiskCondition)__getInternalInterface().cloneUntyped();
  }
  
  public entity.APDRiskCondition getBasedOn() {
    return (entity.APDRiskCondition)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.APDCondition getCondition() {
    return (entity.APDCondition)__getInternalInterface().getFieldValue(CONDITION_PROP.get());
  }
  
  public entity.APDRiskCondition getSlice(java.util.Date sliceDate) {
    return (entity.APDRiskCondition)getSliceUntyped(sliceDate);
  }
  
  public entity.APDRiskCondition getUnsliced() {
    return (entity.APDRiskCondition)getUnslicedUntyped();
  }
  
  public entity.windowed.APDRiskConditionVersionList getVersionList() {
    return (entity.windowed.APDRiskConditionVersionList)getVersionListUntyped();
  }
  ...
  public entity.APDRiskCondition split(java.util.Date splitDate) {
    return (entity.APDRiskCondition)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDRiskConditionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDRiskCondition.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDRiskCondition.class, config);
    com.guidewire._generated.entity.APDRiskConditionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDRiskCondition, com.guidewire._generated.entity.APDRiskConditionInternal>() {
      public java.lang.Object getImplementation(entity.APDRiskCondition bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDRiskConditionInternal getInternalInterface(entity.APDRiskCondition bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDRiskCondition newEmptyInstance() {
        return new entity.APDRiskCondition((java.lang.Void)null);
      }

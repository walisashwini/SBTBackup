...
@gw.entity.EntityName(value = "APDRiskCost")
public class APDRiskCost extends entity.APDCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.APDRiskCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.APDRiskCost, entity.PolicyPeriod>("entity.APDRiskCost");
   ...
   */
  public APDRiskCost(entity.PolicyPeriod branch)  {
   ...
   */
  public APDRiskCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected APDRiskCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.APDRiskCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDRiskCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.APDRiskCostInternal)super.__getInternalInterface();
  }
  
  public entity.APDRiskCost clone() {
    return (entity.APDRiskCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.APDRiskCost getBasedOn() {
    return (entity.APDRiskCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.APDRiskCost getSlice(java.util.Date sliceDate) {
    return (entity.APDRiskCost)getSliceUntyped(sliceDate);
  }
  
  public entity.APDRiskCost getUnsliced() {
    return (entity.APDRiskCost)getUnslicedUntyped();
  }
  
  public entity.windowed.APDRiskCostVersionList getVersionList() {
    return (entity.windowed.APDRiskCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.APDRiskCost split(java.util.Date splitDate) {
    return (entity.APDRiskCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDRiskCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDRiskCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.apd.financials.APDCostMethods", "gw.apd.financials.APDRiskCostMethodsImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDRiskCost.class, config);
    com.guidewire._generated.entity.APDRiskCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDRiskCost, com.guidewire._generated.entity.APDRiskCostInternal>() {
      public java.lang.Object getImplementation(entity.APDRiskCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDRiskCostInternal getInternalInterface(entity.APDRiskCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDRiskCost newEmptyInstance() {
        return new entity.APDRiskCost((java.lang.Void)null);
      }

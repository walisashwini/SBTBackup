...
@gw.entity.EntityName(value = "APDRiskCovCost")
public class APDRiskCovCost extends entity.APDCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.APDRiskCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.APDRiskCovCost, entity.PolicyPeriod>("entity.APDRiskCovCost");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> RISK_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "Risk");
   ...
   */
  public APDRiskCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public APDRiskCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected APDRiskCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.APDRiskCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDRiskCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.APDRiskCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.APDRiskCovCost clone() {
    return (entity.APDRiskCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.APDRiskCovCost getBasedOn() {
    return (entity.APDRiskCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.APDRiskExposure getExposure() {
    return (entity.APDRiskExposure)__getInternalInterface().getFieldValue(EXPOSURE_PROP.get());
  }
  ...
  public entity.APDRiskCoverable getRisk() {
    return (entity.APDRiskCoverable)__getInternalInterface().getFieldValue(RISK_PROP.get());
  }
  ...
  public entity.APDRiskCovCost getSlice(java.util.Date sliceDate) {
    return (entity.APDRiskCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.APDRiskCovCost getUnsliced() {
    return (entity.APDRiskCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.APDRiskCovCostVersionList getVersionList() {
    return (entity.windowed.APDRiskCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setRisk(entity.APDRiskCoverable value) {
    __getInternalInterface().setFieldValue(RISK_PROP.get(), value);
  }
  ...
  public entity.APDRiskCovCost split(java.util.Date splitDate) {
    return (entity.APDRiskCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDRiskCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDRiskCovCost.this.__getDelegateManager();
    }
    ...
    public entity.APDCost getBasedOnValue() {
      return (entity.APDCost)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public entity.APDCost getFixed() {
      return (entity.APDCost)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getRiskID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(RISK_PROP.get());
    }
    ...
    public typekey.APDCost getSubtype() {
      return (typekey.APDCost)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
    ...
    public entity.APDTransaction[] getTransactions() {
      return (entity.APDTransaction[])__getInternalInterface().getFieldValue(TRANSACTIONS_PROP.get());
    }
    ...
    public void setRiskID(gw.pl.persistence.core.Key value) {
      setFieldValue(RISK_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.apd.financials.APDCostMethods", "gw.apd.financials.APDRiskCovCostMethodsImpl");
    config.put("gw.api.domain.financials.CostAdapter", "gw.apd.financials.APDCostAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDRiskCovCost.class, config);
    com.guidewire._generated.entity.APDRiskCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDRiskCovCost, com.guidewire._generated.entity.APDRiskCovCostInternal>() {
      public java.lang.Object getImplementation(entity.APDRiskCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDRiskCovCostInternal getInternalInterface(entity.APDRiskCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDRiskCovCost newEmptyInstance() {
        return new entity.APDRiskCovCost((java.lang.Void)null);
      }

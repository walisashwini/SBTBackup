...
/**
 * APDRiskCovPricing
 * Pricing that creates a coverage cost
 */
...
@gw.entity.EntityName(value = "APDRiskCovPricing")
public class APDRiskCovPricing extends entity.APDPricing {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.APDRiskCovPricing, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.APDRiskCovPricing, entity.PolicyPeriod>("entity.APDRiskCovPricing");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> EXPOSUREPRICES_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "ExposurePrices");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> RISKCOVERAGE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "RiskCoverage");
   ...
   */
  public APDRiskCovPricing(entity.PolicyPeriod branch)  {
   ...
   */
  public APDRiskCovPricing(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected APDRiskCovPricing(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.APDRiskCovPricingInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDRiskCovPricingInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.APDRiskCovPricingInternal)super.__getInternalInterface();
  }
  ...
  public void addToExposurePrices(entity.APDExposurePrice element) {
    __getInternalInterface().addArrayElement(EXPOSUREPRICES_PROP.get(), element);
  }
  
  public entity.APDRiskCovPricing clone() {
    return (entity.APDRiskCovPricing)__getInternalInterface().cloneUntyped();
  }
  
  public entity.APDRiskCovPricing getBasedOn() {
    return (entity.APDRiskCovPricing)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.APDExposurePrice[] getExposurePrices() {
    return (entity.APDExposurePrice[])__getInternalInterface().getFieldValue(EXPOSUREPRICES_PROP.get());
  }
  ...
  public entity.APDRiskCoverage getRiskCoverage() {
    return (entity.APDRiskCoverage)__getInternalInterface().getFieldValue(RISKCOVERAGE_PROP.get());
  }
  
  public entity.APDRiskCovPricing getSlice(java.util.Date sliceDate) {
    return (entity.APDRiskCovPricing)getSliceUntyped(sliceDate);
  }
  
  public entity.APDRiskCovPricing getUnsliced() {
    return (entity.APDRiskCovPricing)getUnslicedUntyped();
  }
  
  public entity.windowed.APDRiskCovPricingVersionList getVersionList() {
    return (entity.windowed.APDRiskCovPricingVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromExposurePrices(entity.APDExposurePrice element) {
    __getInternalInterface().removeArrayElement(EXPOSUREPRICES_PROP.get(), element);
  }
  ...
  public void removeFromExposurePrices(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(EXPOSUREPRICES_PROP.get(), elementID);
  }
  ...
  public void setExposurePrices(entity.APDExposurePrice[] value) {
    __getInternalInterface().setFieldValue(EXPOSUREPRICES_PROP.get(), value);
  }
  ...
  public void setRiskCoverage(entity.APDRiskCoverage value) {
    __getInternalInterface().setFieldValue(RISKCOVERAGE_PROP.get(), value);
  }
  
  public entity.APDRiskCovPricing split(java.util.Date splitDate) {
    return (entity.APDRiskCovPricing)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDRiskCovPricingInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDRiskCovPricing.this.__getDelegateManager();
    }
    ...
    public entity.APDPricing getBasedOnValue() {
      return (entity.APDPricing)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public entity.APDCostDefinition getCostDefinition() {
      return (entity.APDCostDefinition)__getInternalInterface().getFieldValue(COSTDEFINITION_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getCostDefinitionID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(COSTDEFINITION_PROP.get());
    }
    ...
    public entity.APDPricing getFixed() {
      return (entity.APDPricing)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getRiskCoverageID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(RISKCOVERAGE_PROP.get());
    }
    ...
    public typekey.APDPricing getSubtype() {
      return (typekey.APDPricing)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
    ...
    public void setCostDefinition(entity.APDCostDefinition value) {
      __getInternalInterface().setFieldValue(COSTDEFINITION_PROP.get(), value);
    }
    
    public void setCostDefinitionID(gw.pl.persistence.core.Key value) {
      setFieldValue(COSTDEFINITION_PROP.get(), value);
    }
    ...
    public void setRiskCoverageID(gw.pl.persistence.core.Key value) {
      setFieldValue(RISKCOVERAGE_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDRiskCovPricing.class, config);
    com.guidewire._generated.entity.APDRiskCovPricingInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDRiskCovPricing, com.guidewire._generated.entity.APDRiskCovPricingInternal>() {
      public java.lang.Object getImplementation(entity.APDRiskCovPricing bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDRiskCovPricingInternal getInternalInterface(entity.APDRiskCovPricing bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDRiskCovPricing newEmptyInstance() {
        return new entity.APDRiskCovPricing((java.lang.Void)null);
      }

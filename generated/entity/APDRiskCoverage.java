...
/**
 * APDRiskCoverage
 * A coverage clause covering a risk
 */
...
@gw.entity.EntityName(value = "APDRiskCoverage")
public class APDRiskCoverage extends entity.APDRiskClause {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.APDRiskCoverage, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.APDRiskCoverage, entity.PolicyPeriod>("entity.APDRiskCoverage");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> RISKCOVCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "RiskCovCosts");
   ...
   */
  public APDRiskCoverage(entity.PolicyPeriod branch)  {
   ...
   */
  public APDRiskCoverage(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected APDRiskCoverage(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.APDRiskCoverageInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDRiskCoverageInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.APDRiskCoverageInternal)super.__getInternalInterface();
  }
  ...
  public void addToRiskCovCosts(entity.APDRiskCovCost element) {
    __getInternalInterface().addArrayElement(RISKCOVCOSTS_PROP.get(), element);
  }
  
  public entity.APDRiskCoverage clone() {
    return (entity.APDRiskCoverage)__getInternalInterface().cloneUntyped();
  }
  
  public entity.APDRiskCoverage getBasedOn() {
    return (entity.APDRiskCoverage)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.APDRiskCovPricing[] getCostPricing() {
    return (entity.APDRiskCovPricing[])__getInternalInterface().getFieldValue(COSTPRICING_PROP.get());
  }
  ...
  public entity.APDCoverage getCoverage() {
    return (entity.APDCoverage)__getInternalInterface().getFieldValue(COVERAGE_PROP.get());
  }
  ...
  public entity.APDRiskCovCost[] getRiskCovCosts() {
    return (entity.APDRiskCovCost[])__getInternalInterface().getFieldValue(RISKCOVCOSTS_PROP.get());
  }
  
  public entity.APDRiskCoverage getSlice(java.util.Date sliceDate) {
    return (entity.APDRiskCoverage)getSliceUntyped(sliceDate);
  }
  ...
  public entity.APDRiskCoverage getUnsliced() {
    return (entity.APDRiskCoverage)getUnslicedUntyped();
  }
  
  public entity.windowed.APDRiskCoverageVersionList getVersionList() {
    return (entity.windowed.APDRiskCoverageVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromRiskCovCosts(entity.APDRiskCovCost element) {
    __getInternalInterface().removeArrayElement(RISKCOVCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromRiskCovCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(RISKCOVCOSTS_PROP.get(), elementID);
  }
  ...
  public void setRiskCovCosts(entity.APDRiskCovCost[] value) {
    __getInternalInterface().setFieldValue(RISKCOVCOSTS_PROP.get(), value);
  }
  ...
  public entity.APDRiskCoverage split(java.util.Date splitDate) {
    return (entity.APDRiskCoverage)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDRiskCoverageInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDRiskCoverage.this.__getDelegateManager();
    }
    ...
    public void addToRiskItems(entity.APDRiskScheduleItem element) {
      __getInternalInterface().addArrayElement(RISKITEMS_PROP.get(), element);
    }
    ...
    public void addToRiskTerms(entity.APDRiskTerm element) {
      __getInternalInterface().addArrayElement(RISKTERMS_PROP.get(), element);
    }
    ...
    public entity.APDRiskClause getBasedOnValue() {
      return (entity.APDRiskClause)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public entity.APDRiskClause getFixed() {
      return (entity.APDRiskClause)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public entity.APDRiskCoverable getRiskCoverable() {
      return (entity.APDRiskCoverable)__getInternalInterface().getFieldValue(RISKCOVERABLE_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getRiskCoverableID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(RISKCOVERABLE_PROP.get());
    }
    ...
    public entity.APDRiskScheduleItem[] getRiskItems() {
      return (entity.APDRiskScheduleItem[])__getInternalInterface().getFieldValue(RISKITEMS_PROP.get());
    }
    ...
    public entity.APDRiskTerm[] getRiskTerms() {
      return (entity.APDRiskTerm[])__getInternalInterface().getFieldValue(RISKTERMS_PROP.get());
    }
    ...
    public typekey.APDRiskClause getSubtype() {
      return (typekey.APDRiskClause)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
    ...
    public void removeFromRiskItems(entity.APDRiskScheduleItem element) {
      __getInternalInterface().removeArrayElement(RISKITEMS_PROP.get(), element);
    }
    ...
    public void removeFromRiskItems(gw.pl.persistence.core.Key elementID) {
      __getInternalInterface().removeArrayElement(RISKITEMS_PROP.get(), elementID);
    }
    ...
    public void removeFromRiskTerms(entity.APDRiskTerm element) {
      __getInternalInterface().removeArrayElement(RISKTERMS_PROP.get(), element);
    }
    ...
    public void removeFromRiskTerms(gw.pl.persistence.core.Key elementID) {
      __getInternalInterface().removeArrayElement(RISKTERMS_PROP.get(), elementID);
    }
    ...
    public void setRiskCoverable(entity.APDRiskCoverable value) {
      __getInternalInterface().setFieldValue(RISKCOVERABLE_PROP.get(), value);
    }
    
    public void setRiskCoverableID(gw.pl.persistence.core.Key value) {
      setFieldValue(RISKCOVERABLE_PROP.get(), value);
    }
    ...
    public void setRiskItems(entity.APDRiskScheduleItem[] value) {
      __getInternalInterface().setFieldValue(RISKITEMS_PROP.get(), value);
    }
    ...
    public void setRiskTerms(entity.APDRiskTerm[] value) {
      __getInternalInterface().setFieldValue(RISKTERMS_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDRiskCoverage.class, config);
    com.guidewire._generated.entity.APDRiskCoverageInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDRiskCoverage, com.guidewire._generated.entity.APDRiskCoverageInternal>() {
      public java.lang.Object getImplementation(entity.APDRiskCoverage bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDRiskCoverageInternal getInternalInterface(entity.APDRiskCoverage bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDRiskCoverage newEmptyInstance() {
        return new entity.APDRiskCoverage((java.lang.Void)null);
      }

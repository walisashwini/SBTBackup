...
/**
 * APDRiskExclusion
 * An exclusion clause qualifying a risk
 */
...
@gw.entity.EntityName(value = "APDRiskExclusion")
public class APDRiskExclusion extends entity.APDRiskClause {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.APDRiskExclusion, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.APDRiskExclusion, entity.PolicyPeriod>("entity.APDRiskExclusion");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> EXCLUSION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "Exclusion");
   ...
   */
  public APDRiskExclusion(entity.PolicyPeriod branch)  {
   ...
   */
  public APDRiskExclusion(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected APDRiskExclusion(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.APDRiskExclusionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDRiskExclusionInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.APDRiskExclusionInternal)super.__getInternalInterface();
  }
  
  public entity.APDRiskExclusion clone() {
    return (entity.APDRiskExclusion)__getInternalInterface().cloneUntyped();
  }
  
  public entity.APDRiskExclusion getBasedOn() {
    return (entity.APDRiskExclusion)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.APDExclusion getExclusion() {
    return (entity.APDExclusion)__getInternalInterface().getFieldValue(EXCLUSION_PROP.get());
  }
  
  public entity.APDRiskExclusion getSlice(java.util.Date sliceDate) {
    return (entity.APDRiskExclusion)getSliceUntyped(sliceDate);
  }
  
  public entity.APDRiskExclusion getUnsliced() {
    return (entity.APDRiskExclusion)getUnslicedUntyped();
  }
  
  public entity.windowed.APDRiskExclusionVersionList getVersionList() {
    return (entity.windowed.APDRiskExclusionVersionList)getVersionListUntyped();
  }
  ...
  public void setExclusion(entity.APDExclusion value) {
    __getInternalInterface().setFieldValue(EXCLUSION_PROP.get(), value);
  }
  
  public entity.APDRiskExclusion split(java.util.Date splitDate) {
    return (entity.APDRiskExclusion)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDRiskExclusionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDRiskExclusion.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getExclusionID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(EXCLUSION_PROP.get());
    }
    ...
    public void setExclusionID(gw.pl.persistence.core.Key value) {
      setFieldValue(EXCLUSION_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDRiskExclusion.class, config);
    com.guidewire._generated.entity.APDRiskExclusionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDRiskExclusion, com.guidewire._generated.entity.APDRiskExclusionInternal>() {
      public java.lang.Object getImplementation(entity.APDRiskExclusion bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDRiskExclusionInternal getInternalInterface(entity.APDRiskExclusion bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDRiskExclusion newEmptyInstance() {
        return new entity.APDRiskExclusion((java.lang.Void)null);
      }

...
/**
 * APDRiskExposure
 * An exposure to risk within a manual line
 */
...
@gw.entity.EntityName(value = "APDRiskExposure")
public class APDRiskExposure extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.APDRiskExposure, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.APDRiskExposure, entity.PolicyPeriod>("entity.APDRiskExposure");
  ...
  private com.guidewire._generated.entity.APDRiskExposureInternal _internal;
   ...
   */
  public APDRiskExposure(entity.PolicyPeriod branch)  {
   ...
   */
  public APDRiskExposure(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected APDRiskExposure(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.APDRiskExposureInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDRiskExposureInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.APDRiskExposure clone() {
    return (entity.APDRiskExposure)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.APDRiskExposure getBasedOn() {
    return (entity.APDRiskExposure)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.APDRiskExposure getBasedOnValue() {
    return (entity.APDRiskExposure)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.APDRiskExposureField[] getFields() {
    return (entity.APDRiskExposureField[])__getInternalInterface().getFieldValue(FIELDS_PROP.get());
  }
  ...
  public entity.APDRiskExposure getFixed() {
    return (entity.APDRiskExposure)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.APDRiskExposure getSlice(java.util.Date sliceDate) {
    return (entity.APDRiskExposure)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.APDRiskExposure getSubtype() {
    return (typekey.APDRiskExposure)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.APDRiskExposure getUnsliced() {
    return (entity.APDRiskExposure)getUnslicedUntyped();
  }
  ...
  public entity.windowed.APDRiskExposureVersionList getVersionList() {
    return (entity.windowed.APDRiskExposureVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.APDRiskExposure value) {
   ...
   */
  private void setFixed(entity.APDRiskExposure value) {
   ...
   */
  private void setSubtype(typekey.APDRiskExposure value) {
  ...
  public entity.APDRiskExposure split(java.util.Date splitDate) {
    return (entity.APDRiskExposure)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDRiskExposureInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDRiskExposure.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.apd.APDSplittableRisk", "gw.lob.apd.APDSplittableRiskExposure");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDRiskExposure.class, config);
    com.guidewire._generated.entity.APDRiskExposureInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDRiskExposure, com.guidewire._generated.entity.APDRiskExposureInternal>() {
      public java.lang.Object getImplementation(entity.APDRiskExposure bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDRiskExposureInternal getInternalInterface(entity.APDRiskExposure bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDRiskExposure newEmptyInstance() {
        return new entity.APDRiskExposure((java.lang.Void)null);
      }

...
/**
 * APDRiskExposureField
 * The instance of a field within a manual exposure
 */
...
@gw.entity.EntityName(value = "APDRiskExposureField")
public class APDRiskExposureField extends entity.APDDataField {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.APDRiskExposureField, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.APDRiskExposureField, entity.PolicyPeriod>("entity.APDRiskExposureField");
   ...
   */
  public APDRiskExposureField(entity.PolicyPeriod branch)  {
   ...
   */
  public APDRiskExposureField(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected APDRiskExposureField(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.APDRiskExposureFieldInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDRiskExposureFieldInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.APDRiskExposureFieldInternal)super.__getInternalInterface();
  }
  
  public entity.APDRiskExposureField clone() {
    return (entity.APDRiskExposureField)__getInternalInterface().cloneUntyped();
  }
  
  public entity.APDRiskExposureField getBasedOn() {
    return (entity.APDRiskExposureField)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.APDRiskExposureField getSlice(java.util.Date sliceDate) {
    return (entity.APDRiskExposureField)getSliceUntyped(sliceDate);
  }
  
  public entity.APDRiskExposureField getUnsliced() {
    return (entity.APDRiskExposureField)getUnslicedUntyped();
  }
  
  public entity.windowed.APDRiskExposureFieldVersionList getVersionList() {
    return (entity.windowed.APDRiskExposureFieldVersionList)getVersionListUntyped();
  }
  ...
  public entity.APDRiskExposureField split(java.util.Date splitDate) {
    return (entity.APDRiskExposureField)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDRiskExposureFieldInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDRiskExposureField.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDRiskExposureField.class, config);
    com.guidewire._generated.entity.APDRiskExposureFieldInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDRiskExposureField, com.guidewire._generated.entity.APDRiskExposureFieldInternal>() {
      public java.lang.Object getImplementation(entity.APDRiskExposureField bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDRiskExposureFieldInternal getInternalInterface(entity.APDRiskExposureField bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDRiskExposureField newEmptyInstance() {
        return new entity.APDRiskExposureField((java.lang.Void)null);
      }

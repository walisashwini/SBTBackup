...
/**
 * APDRiskField
 * The instance of a field within a manual risk
 */
...
@gw.entity.EntityName(value = "APDRiskField")
public class APDRiskField extends entity.APDDataField {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.APDRiskField, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.APDRiskField, entity.PolicyPeriod>("entity.APDRiskField");
   ...
   */
  public APDRiskField(entity.PolicyPeriod branch)  {
   ...
   */
  public APDRiskField(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected APDRiskField(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.APDRiskFieldInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDRiskFieldInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.APDRiskFieldInternal)super.__getInternalInterface();
  }
  
  public entity.APDRiskField clone() {
    return (entity.APDRiskField)__getInternalInterface().cloneUntyped();
  }
  
  public entity.APDRiskField getBasedOn() {
    return (entity.APDRiskField)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.APDRiskField getSlice(java.util.Date sliceDate) {
    return (entity.APDRiskField)getSliceUntyped(sliceDate);
  }
  
  public entity.APDRiskField getUnsliced() {
    return (entity.APDRiskField)getUnslicedUntyped();
  }
  
  public entity.windowed.APDRiskFieldVersionList getVersionList() {
    return (entity.windowed.APDRiskFieldVersionList)getVersionListUntyped();
  }
  ...
  public entity.APDRiskField split(java.util.Date splitDate) {
    return (entity.APDRiskField)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDRiskFieldInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDRiskField.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDRiskField.class, config);
    com.guidewire._generated.entity.APDRiskFieldInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDRiskField, com.guidewire._generated.entity.APDRiskFieldInternal>() {
      public java.lang.Object getImplementation(entity.APDRiskField bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDRiskFieldInternal getInternalInterface(entity.APDRiskField bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDRiskField newEmptyInstance() {
        return new entity.APDRiskField((java.lang.Void)null);
      }

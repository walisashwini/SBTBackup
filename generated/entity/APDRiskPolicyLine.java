...
/**
 * APDRiskPolicyLine
 * The policy line for a manual risk
 */
...
@gw.entity.EntityName(value = "APDRiskPolicyLine")
public class APDRiskPolicyLine extends entity.APDRiskCoverable {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.APDRiskPolicyLine, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.APDRiskPolicyLine, entity.PolicyPeriod>("entity.APDRiskPolicyLine");
   ...
   */
  public APDRiskPolicyLine(entity.PolicyPeriod branch)  {
   ...
   */
  public APDRiskPolicyLine(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected APDRiskPolicyLine(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.APDRiskPolicyLineInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDRiskPolicyLineInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.APDRiskPolicyLineInternal)super.__getInternalInterface();
  }
  
  public entity.APDRiskPolicyLine clone() {
    return (entity.APDRiskPolicyLine)__getInternalInterface().cloneUntyped();
  }
  
  public entity.APDRiskPolicyLine getBasedOn() {
    return (entity.APDRiskPolicyLine)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.APDRiskPolicyLine getSlice(java.util.Date sliceDate) {
    return (entity.APDRiskPolicyLine)getSliceUntyped(sliceDate);
  }
  
  public entity.APDRiskPolicyLine getUnsliced() {
    return (entity.APDRiskPolicyLine)getUnslicedUntyped();
  }
  
  public entity.windowed.APDRiskPolicyLineVersionList getVersionList() {
    return (entity.windowed.APDRiskPolicyLineVersionList)getVersionListUntyped();
  }
  
  public entity.APDRiskPolicyLine split(java.util.Date splitDate) {
    return (entity.APDRiskPolicyLine)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDRiskPolicyLineInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDRiskPolicyLine.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDRiskPolicyLine.class, config);
    com.guidewire._generated.entity.APDRiskPolicyLineInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDRiskPolicyLine, com.guidewire._generated.entity.APDRiskPolicyLineInternal>() {
      public java.lang.Object getImplementation(entity.APDRiskPolicyLine bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDRiskPolicyLineInternal getInternalInterface(entity.APDRiskPolicyLine bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDRiskPolicyLine newEmptyInstance() {
        return new entity.APDRiskPolicyLine((java.lang.Void)null);
      }

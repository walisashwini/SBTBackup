...
/**
 * APDRiskPricing
 * The pricing for a coverage cost
 */
...
@gw.entity.EntityName(value = "APDRiskPricing")
public class APDRiskPricing extends entity.APDPricing {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.APDRiskPricing, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.APDRiskPricing, entity.PolicyPeriod>("entity.APDRiskPricing");
   ...
   */
  public APDRiskPricing(entity.PolicyPeriod branch)  {
   ...
   */
  public APDRiskPricing(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected APDRiskPricing(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.APDRiskPricingInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDRiskPricingInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.APDRiskPricingInternal)super.__getInternalInterface();
  }
  
  public entity.APDRiskPricing clone() {
    return (entity.APDRiskPricing)__getInternalInterface().cloneUntyped();
  }
  
  public entity.APDRiskPricing getBasedOn() {
    return (entity.APDRiskPricing)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.APDRiskPricing getSlice(java.util.Date sliceDate) {
    return (entity.APDRiskPricing)getSliceUntyped(sliceDate);
  }
  
  public entity.APDRiskPricing getUnsliced() {
    return (entity.APDRiskPricing)getUnslicedUntyped();
  }
  
  public entity.windowed.APDRiskPricingVersionList getVersionList() {
    return (entity.windowed.APDRiskPricingVersionList)getVersionListUntyped();
  }
  ...
  public entity.APDRiskPricing split(java.util.Date splitDate) {
    return (entity.APDRiskPricing)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDRiskPricingInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDRiskPricing.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDRiskPricing.class, config);
    com.guidewire._generated.entity.APDRiskPricingInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDRiskPricing, com.guidewire._generated.entity.APDRiskPricingInternal>() {
      public java.lang.Object getImplementation(entity.APDRiskPricing bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDRiskPricingInternal getInternalInterface(entity.APDRiskPricing bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDRiskPricing newEmptyInstance() {
        return new entity.APDRiskPricing((java.lang.Void)null);
      }

...
/**
 * APDRiskScheduleTerm
 * A term that is part of a schedule item
 */
...
@gw.entity.EntityName(value = "APDRiskScheduleTerm")
public class APDRiskScheduleTerm extends entity.APDRiskTerm {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.APDRiskScheduleTerm, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.APDRiskScheduleTerm, entity.PolicyPeriod>("entity.APDRiskScheduleTerm");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> RISKITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "RiskItem");
   ...
   */
  public APDRiskScheduleTerm(entity.PolicyPeriod branch)  {
   ...
   */
  public APDRiskScheduleTerm(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected APDRiskScheduleTerm(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.APDRiskScheduleTermInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDRiskScheduleTermInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.APDRiskScheduleTermInternal)super.__getInternalInterface();
  }
  
  public entity.APDRiskScheduleTerm clone() {
    return (entity.APDRiskScheduleTerm)__getInternalInterface().cloneUntyped();
  }
  
  public entity.APDRiskScheduleTerm getBasedOn() {
    return (entity.APDRiskScheduleTerm)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.APDRiskScheduleItem getRiskItem() {
    return (entity.APDRiskScheduleItem)__getInternalInterface().getFieldValue(RISKITEM_PROP.get());
  }
  
  public entity.APDRiskScheduleTerm getSlice(java.util.Date sliceDate) {
    return (entity.APDRiskScheduleTerm)getSliceUntyped(sliceDate);
  }
  
  public entity.APDRiskScheduleTerm getUnsliced() {
    return (entity.APDRiskScheduleTerm)getUnslicedUntyped();
  }
  
  public entity.windowed.APDRiskScheduleTermVersionList getVersionList() {
    return (entity.windowed.APDRiskScheduleTermVersionList)getVersionListUntyped();
  }
  ...
  public void setRiskItem(entity.APDRiskScheduleItem value) {
    __getInternalInterface().setFieldValue(RISKITEM_PROP.get(), value);
  }
  
  public entity.APDRiskScheduleTerm split(java.util.Date splitDate) {
    return (entity.APDRiskScheduleTerm)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDRiskScheduleTermInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDRiskScheduleTerm.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getCodeValueID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(CODEVALUE_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getPartyID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(PARTY_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getRiskItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(RISKITEM_PROP.get());
    }
    ...
    public void setCodeValueID(gw.pl.persistence.core.Key value) {
      setFieldValue(CODEVALUE_PROP.get(), value);
    }
    ...
    public void setPartyID(gw.pl.persistence.core.Key value) {
      setFieldValue(PARTY_PROP.get(), value);
    }
    ...
    public void setRiskItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(RISKITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDRiskScheduleTerm.class, config);
    com.guidewire._generated.entity.APDRiskScheduleTermInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDRiskScheduleTerm, com.guidewire._generated.entity.APDRiskScheduleTermInternal>() {
      public java.lang.Object getImplementation(entity.APDRiskScheduleTerm bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDRiskScheduleTermInternal getInternalInterface(entity.APDRiskScheduleTerm bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDRiskScheduleTerm newEmptyInstance() {
        return new entity.APDRiskScheduleTerm((java.lang.Void)null);
      }

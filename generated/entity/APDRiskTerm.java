...
@gw.entity.EntityName(value = "APDRiskTerm")
public class APDRiskTerm extends entity.APDDataField {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.APDRiskTerm, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.APDRiskTerm, entity.PolicyPeriod>("entity.APDRiskTerm");
   ...
   */
  public APDRiskTerm(entity.PolicyPeriod branch)  {
   ...
   */
  public APDRiskTerm(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected APDRiskTerm(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.APDRiskTermInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDRiskTermInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.APDRiskTermInternal)super.__getInternalInterface();
  }
  
  public entity.APDRiskTerm clone() {
    return (entity.APDRiskTerm)__getInternalInterface().cloneUntyped();
  }
  
  public entity.APDRiskTerm getBasedOn() {
    return (entity.APDRiskTerm)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.APDRiskTerm getSlice(java.util.Date sliceDate) {
    return (entity.APDRiskTerm)getSliceUntyped(sliceDate);
  }
  
  public entity.APDRiskTerm getUnsliced() {
    return (entity.APDRiskTerm)getUnslicedUntyped();
  }
  
  public entity.windowed.APDRiskTermVersionList getVersionList() {
    return (entity.windowed.APDRiskTermVersionList)getVersionListUntyped();
  }
  ...
  public entity.APDRiskTerm split(java.util.Date splitDate) {
    return (entity.APDRiskTerm)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDRiskTermInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDRiskTerm.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDRiskTerm.class, config);
    com.guidewire._generated.entity.APDRiskTermInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDRiskTerm, com.guidewire._generated.entity.APDRiskTermInternal>() {
      public java.lang.Object getImplementation(entity.APDRiskTerm bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDRiskTermInternal getInternalInterface(entity.APDRiskTerm bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDRiskTerm newEmptyInstance() {
        return new entity.APDRiskTerm((java.lang.Void)null);
      }

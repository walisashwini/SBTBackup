...
/**
 * APDRuleElement
 * A set of conditions that make up a rule element
 */
...
@gw.entity.EntityName(value = "APDRuleElement")
public class APDRuleElement extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.APDRuleElement> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.APDRuleElement>("entity.APDRuleElement");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> RULECONDITIONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "RuleConditions");
  ...
  private com.guidewire._generated.entity.APDRuleElementInternal _internal;
   ...
   */
  public APDRuleElement(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected APDRuleElement(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.APDRuleElementInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDRuleElementInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToRuleConditions(entity.APDRuleCondition element) {
    __getInternalInterface().addArrayElement(RULECONDITIONS_PROP.get(), element);
  }
  ...
  public entity.APDRule getRule() {
    return (entity.APDRule)__getInternalInterface().getFieldValue(RULE_PROP.get());
  }
  ...
  public entity.APDRuleCondition[] getRuleConditions() {
    return (entity.APDRuleCondition[])__getInternalInterface().getFieldValue(RULECONDITIONS_PROP.get());
  }
  ...
  public typekey.APDRuleElement getSubtype() {
    return (typekey.APDRuleElement)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public void removeFromRuleConditions(entity.APDRuleCondition element) {
    __getInternalInterface().removeArrayElement(RULECONDITIONS_PROP.get(), element);
  }
  ...
  public void removeFromRuleConditions(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(RULECONDITIONS_PROP.get(), elementID);
  }
  ...
  public void setRuleConditions(entity.APDRuleCondition[] value) {
    __getInternalInterface().setFieldValue(RULECONDITIONS_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.APDRuleElement value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDRuleElementInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDRuleElement.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDRuleElement.class, config);
    com.guidewire._generated.entity.APDRuleElementInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDRuleElement, com.guidewire._generated.entity.APDRuleElementInternal>() {
      public java.lang.Object getImplementation(entity.APDRuleElement bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDRuleElementInternal getInternalInterface(entity.APDRuleElement bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDRuleElement newEmptyInstance() {
        return new entity.APDRuleElement((java.lang.Void)null);
      }

...
/**
 * APDScheduledItem
 * Scheduled item definition
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "APDScheduledItem.eti;APDScheduledItem.eix;APDScheduledItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "APDScheduledItem")
public class APDScheduledItem extends entity.APDCoverable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.APDScheduledItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.APDScheduledItem>("entity.APDScheduledItem");
   ...
   */
  public APDScheduledItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected APDScheduledItem(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.APDScheduledItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDScheduledItemInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.APDScheduledItemInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDScheduledItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDScheduledItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDScheduledItem.class, config);
    com.guidewire._generated.entity.APDScheduledItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDScheduledItem, com.guidewire._generated.entity.APDScheduledItemInternal>() {
      public java.lang.Object getImplementation(entity.APDScheduledItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDScheduledItemInternal getInternalInterface(entity.APDScheduledItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDScheduledItem newEmptyInstance() {
        return new entity.APDScheduledItem((java.lang.Void)null);
      }

...
/**
 * APDTransaction
 * A transaction for the Manual Products line
 */
...
@gw.entity.EntityName(value = "APDTransaction")
public class APDTransaction extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Transaction {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.APDTransaction, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.APDTransaction, entity.PolicyPeriod>("entity.APDTransaction");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> APDCOST_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "APDCost");
  ...
  private com.guidewire._generated.entity.APDTransactionInternal _internal;
   ...
   */
  public APDTransaction(entity.PolicyPeriod branch)  {
   ...
   */
  public APDTransaction(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected APDTransaction(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.APDTransactionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.APDTransactionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.APDTransaction clone() {
    return (entity.APDTransaction)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.APDCost getAPDCost() {
    return (entity.APDCost)__getInternalInterface().getFieldValue(APDCOST_PROP.get());
  }
  ...
  public entity.APDTransaction getBasedOn() {
    return (entity.APDTransaction)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.APDTransaction getBasedOnValue() {
    return (entity.APDTransaction)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.APDTransaction getFixed() {
    return (entity.APDTransaction)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.APDTransaction getSlice(java.util.Date sliceDate) {
    return (entity.APDTransaction)getSliceUntyped(sliceDate);
  }
  ...
  public entity.APDTransaction getUnsliced() {
    return (entity.APDTransaction)getUnslicedUntyped();
  }
  ...
  public entity.windowed.APDTransactionVersionList getVersionList() {
    return (entity.windowed.APDTransactionVersionList)getVersionListUntyped();
  }
  ...
  public void setAPDCost(entity.APDCost value) {
    __getInternalInterface().setFieldValue(APDCOST_PROP.get(), value);
  }
   ...
   */
  private void setBasedOnValue(entity.APDTransaction value) {
   ...
   */
  private void setFixed(entity.APDTransaction value) {
  ...
  public entity.APDTransaction split(java.util.Date splitDate) {
    return (entity.APDTransaction)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.APDTransactionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.APDTransaction.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getAPDCostID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(APDCOST_PROP.get());
    }
    ...
    public void setAPDCostID(gw.pl.persistence.core.Key value) {
      setFieldValue(APDCOST_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.financials.TransactionAdapter", "gw.apd.financials.APDTransactionAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.APDTransaction.class, config);
    com.guidewire._generated.entity.APDTransactionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.APDTransaction, com.guidewire._generated.entity.APDTransactionInternal>() {
      public java.lang.Object getImplementation(entity.APDTransaction bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.APDTransactionInternal getInternalInterface(entity.APDTransaction bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.APDTransaction newEmptyInstance() {
        return new entity.APDTransaction((java.lang.Void)null);
      }

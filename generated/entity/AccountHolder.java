 ...
 * AccountHolder
 * 
 *     A company or person which requires one or more insurance products.
 * 
 *   
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "AccountHolder.eti;AccountHolder.eix;AccountHolder.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "AccountHolder")
public class AccountHolder extends entity.AccountContactRole {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AccountHolder> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AccountHolder>("entity.AccountHolder");
   ...
   */
  public AccountHolder(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected AccountHolder(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.AccountHolderInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AccountHolderInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.AccountHolderInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AccountHolderInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.AccountHolder.this.__getDelegateManager();
    }
    ...
    public void updateAccountHolderDenorm() {
      ((com.guidewire.pc.domain.account.impl.AccountHolderInternal)__getDelegateManager().getImplementation("com.guidewire.pc.domain.account.impl.AccountHolderInternal")).updateAccountHolderDenorm();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.account.AccountContactRolePublicMethods", "com.guidewire.pc.domain.account.impl.AccountHolderImpl");
    config.put("com.guidewire.pc.domain.account.impl.AccountHolderInternal", "com.guidewire.pc.domain.account.impl.AccountHolderImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.account.impl.AccountHolderImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.pc.domain.account.impl.AccountHolderImpl");
    ...
    config.put("gw.pc.account.entity.AccountHolder", "com.guidewire.pc.domain.account.impl.AccountHolderImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.AccountHolder.class, config);
    com.guidewire._generated.entity.AccountHolderInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.AccountHolder, com.guidewire._generated.entity.AccountHolderInternal>() {
      public java.lang.Object getImplementation(entity.AccountHolder bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AccountHolderInternal getInternalInterface(entity.AccountHolder bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.AccountHolder newEmptyInstance() {
        return new entity.AccountHolder((java.lang.Void)null);
      }

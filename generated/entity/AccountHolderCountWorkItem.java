...
/**
 * AccountHolderCountWorkItem
 * WorkItem to update Contact.AccountHolderCount
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "AccountHolderCountWorkItem.eti;AccountHolderCountWorkItem.eix;AccountHolderCountWorkItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "AccountHolderCountWorkItem")
public class AccountHolderCountWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.KeyableBean, entity.WorkItem {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AccountHolderCountWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AccountHolderCountWorkItem>("entity.AccountHolderCountWorkItem");
  ...
  private com.guidewire._generated.entity.AccountHolderCountWorkItemInternal _internal;
   ...
   */
  public AccountHolderCountWorkItem()  {
   ...
   */
  public AccountHolderCountWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected AccountHolderCountWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.AccountHolderCountWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AccountHolderCountWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AccountHolderCountWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.AccountHolderCountWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.AccountHolderCountWorkItem.class, config);
    com.guidewire._generated.entity.AccountHolderCountWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.AccountHolderCountWorkItem, com.guidewire._generated.entity.AccountHolderCountWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.AccountHolderCountWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AccountHolderCountWorkItemInternal getInternalInterface(entity.AccountHolderCountWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.AccountHolderCountWorkItem newEmptyInstance() {
        return new entity.AccountHolderCountWorkItem((java.lang.Void)null);
      }

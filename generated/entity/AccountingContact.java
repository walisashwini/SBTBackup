 ...
 *     who would be the primary source of information required to perform premium
 *     audits of the account or one of its underlying policies.
 * 
 *   
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "AccountingContact.eti;AccountingContact.eix;AccountingContact.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "AccountingContact")
public class AccountingContact extends entity.AccountContactRole {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AccountingContact> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AccountingContact>("entity.AccountingContact");
   ...
   */
  public AccountingContact(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected AccountingContact(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.AccountingContactInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AccountingContactInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.AccountingContactInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AccountingContactInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.AccountingContact.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.AccountingContact.class, config);
    com.guidewire._generated.entity.AccountingContactInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.AccountingContact, com.guidewire._generated.entity.AccountingContactInternal>() {
      public java.lang.Object getImplementation(entity.AccountingContact bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AccountingContactInternal getInternalInterface(entity.AccountingContact bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.AccountingContact newEmptyInstance() {
        return new entity.AccountingContact((java.lang.Void)null);
      }

...
public class ActivityPattern extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.DecentralizedEntity {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> PATTERNLEVEL_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "PatternLevel");
  ...
  public static final gw.api.domain.activity.impl.ActivityPatternFinderImpl finder = com.guidewire.pc.domain.activity.impl.ActivityPatternCoreExtMethods.finder;
  ...
  public entity.Activity createAccountActivity(gw.pl.persistence.core.Bundle bundle, entity.ActivityPattern pattern, entity.Account account, java.lang.String subject, java.lang.String description, java.lang.String approvalIssue, typekey.Priority priority, java.lang.Boolean mandatory, java.util.Date targetDate, java.util.Date escalationDate) {
    return ((com.guidewire.pc.domain.activity.impl.ActivityPatternCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.activity.impl.ActivityPatternCoreExtMethods")).createAccountActivity(bundle, pattern, account, subject, description, approvalIssue, priority, mandatory, targetDate, escalationDate);
  }
  
  public entity.Activity createContactActivity(gw.pl.persistence.core.Bundle bundle, entity.Contact contact, java.lang.String subject, java.lang.String description, java.lang.String approvalIssue, typekey.Priority priority, java.lang.Boolean mandatory, java.util.Date targetDate, java.util.Date escalationDate) {
    return ((com.guidewire.pc.domain.activity.impl.ActivityPatternCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.activity.impl.ActivityPatternCoreExtMethods")).createContactActivity(bundle, contact, subject, description, approvalIssue, priority, mandatory, targetDate, escalationDate);
  }
  
  public entity.Activity createDefaultPolicyActivity(gw.pl.persistence.core.Bundle bundle, entity.Policy policy, java.util.Date targetDate, java.util.Date escalationDate) {
    return ((com.guidewire.pc.domain.activity.impl.ActivityPatternCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.activity.impl.ActivityPatternCoreExtMethods")).createDefaultPolicyActivity(bundle, policy, targetDate, escalationDate);
  }
  
  public entity.Activity createJobActivity(gw.pl.persistence.core.Bundle bundle, entity.Job job, java.lang.String subject, java.lang.String description, java.lang.String approvalIssue, typekey.Priority priority, java.lang.Boolean mandatory, java.util.Date targetDate, java.util.Date escalationDate) {
    return ((com.guidewire.pc.domain.activity.impl.ActivityPatternCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.activity.impl.ActivityPatternCoreExtMethods")).createJobActivity(bundle, job, subject, description, approvalIssue, priority, mandatory, targetDate, escalationDate);
  }
  
  public entity.Activity createPolicyActivity(gw.pl.persistence.core.Bundle bundle, entity.Policy policy, java.lang.String subject, java.lang.String description, java.lang.String approvalIssue, typekey.Priority priority, java.lang.Boolean mandatory, java.util.Date targetDate, java.util.Date escalationDate) {
    return ((com.guidewire.pc.domain.activity.impl.ActivityPatternCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.activity.impl.ActivityPatternCoreExtMethods")).createPolicyActivity(bundle, policy, subject, description, approvalIssue, priority, mandatory, targetDate, escalationDate);
  }
  
  public entity.Activity createPolicyPeriodActivity(gw.pl.persistence.core.Bundle bundle, entity.PolicyPeriod policyPeriod, java.lang.String subject, java.lang.String description, java.lang.String approvalIssue, typekey.Priority priority, java.lang.Boolean mandatory, java.util.Date targetDate, java.util.Date escalationDate) {
    return ((com.guidewire.pc.domain.activity.impl.ActivityPatternCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.activity.impl.ActivityPatternCoreExtMethods")).createPolicyPeriodActivity(bundle, policyPeriod, subject, description, approvalIssue, priority, mandatory, targetDate, escalationDate);
  }
  ...
  /**
   * Gets the value of the PatternLevel field.
   * the level that this activity pattern is for.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.ActivityPatternLevel getPatternLevel() {
    return (typekey.ActivityPatternLevel)__getInternalInterface().getFieldValue(PATTERNLEVEL_PROP.get());
  }
  ...
  /**
   * Sets the value of the PatternLevel field.
   */
  public void setPatternLevel(typekey.ActivityPatternLevel value) {
    __getInternalInterface().setFieldValue(PATTERNLEVEL_PROP.get(), value);
  }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.activity.impl.ActivityPatternCoreExtMethods", "com.guidewire.pc.domain.activity.impl.ActivityPatternCoreExtMethodsImpl");

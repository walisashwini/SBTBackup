 ...
 *   
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "AdditionalInterest.eti;AdditionalInterest.eix;AdditionalInterest.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "AdditionalInterest")
public class AdditionalInterest extends entity.AccountContactRole {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AdditionalInterest> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AdditionalInterest>("entity.AdditionalInterest");
   ...
   */
  public AdditionalInterest(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected AdditionalInterest(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.AdditionalInterestInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AdditionalInterestInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.AdditionalInterestInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AdditionalInterestInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.AdditionalInterest.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.AdditionalInterest.class, config);
    com.guidewire._generated.entity.AdditionalInterestInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.AdditionalInterest, com.guidewire._generated.entity.AdditionalInterestInternal>() {
      public java.lang.Object getImplementation(entity.AdditionalInterest bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AdditionalInterestInternal getInternalInterface(entity.AdditionalInterest bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.AdditionalInterest newEmptyInstance() {
        return new entity.AdditionalInterest((java.lang.Void)null);
      }

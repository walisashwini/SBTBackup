...
/**
 * AddlInterestDetail
 * The details of the relationship of a PolicyAddlInterest to some entity.
 */
...
public abstract class AddlInterestDetail extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, gw.api.contact.AddlInterestDetailJavaMethods, gw.api.contact.AddlInterestDetailMethods, gw.api.copier.EffDatedCopyable, gw.api.domain.account.Mergeable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.AddlInterestDetail, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.AddlInterestDetail, entity.PolicyPeriod>("entity.AddlInterestDetail");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> ADDITIONALINTERESTTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "AdditionalInterestType");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CERTREQUIRED_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CertRequired");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CONTRACTNUMBER_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ContractNumber");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> POLICYADDLINTEREST_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "PolicyAddlInterest");
  ...
  private com.guidewire._generated.entity.AddlInterestDetailInternal _internal;
  ...
  protected AddlInterestDetail(java.lang.Void ignored)  {
    
  }
  
  protected abstract com.guidewire._generated.entity.AddlInterestDetailInternal __createInternalInterface();
  ...
  protected com.guidewire._generated.entity.AddlInterestDetailInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.AddlInterestDetail clone() {
    return (entity.AddlInterestDetail)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.AddlInterestDetail getBasedOn() {
    return (entity.AddlInterestDetail)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.AddlInterestDetail getSlice(java.util.Date sliceDate) {
    return (entity.AddlInterestDetail)getSliceUntyped(sliceDate);
  }
  ...
  public entity.AddlInterestDetail getUnsliced() {
    return (entity.AddlInterestDetail)getUnslicedUntyped();
  }
  ...
  public entity.windowed.AddlInterestDetailVersionList getVersionList() {
    return (entity.windowed.AddlInterestDetailVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.AddlInterestDetail value) {
   ...
   */
  private void setFixed(entity.AddlInterestDetail value) {
   ...
   */
  private void setSubtype(typekey.AddlInterestDetail value) {
  ...
  public entity.AddlInterestDetail split(java.util.Date splitDate) {
    return (entity.AddlInterestDetail)splitUntyped(splitDate);
  }
  ...
  static {
    com.guidewire._generated.entity.AddlInterestDetailInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.EntityFriendAccess<entity.AddlInterestDetail, com.guidewire._generated.entity.AddlInterestDetailInternal>() {
      public java.lang.Object getImplementation(entity.AddlInterestDetail bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AddlInterestDetailInternal getInternalInterface(entity.AddlInterestDetail bean) {
        if(bean == null) {
          return null;
        };

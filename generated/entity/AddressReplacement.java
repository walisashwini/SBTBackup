...
/**
 * AddressReplacement
 * Indicates that two Addresses were merged, and which one replaces the other
 */
...
@gw.entity.EntityName(value = "AddressReplacement")
public class AddressReplacement extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.Extractable, entity.OverlapTable, entity.Obfuscatable, entity.FrozenSetMember, gw.api.obfuscation.Obfuscator {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AddressReplacement> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AddressReplacement>("entity.AddressReplacement");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> REPLACEMENTADDRESS_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ReplacementAddress");
  ...
  private com.guidewire._generated.entity.AddressReplacementInternal _internal;
   ...
   */
  public AddressReplacement(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected AddressReplacement(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.AddressReplacementInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AddressReplacementInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.Address getReplacementAddress() {
    return (entity.Address)__getInternalInterface().getFieldValue(REPLACEMENTADDRESS_PROP.get());
  }
   ...
   */
  private void setReplacementAddress(entity.Address value) {
    __getInternalInterface().setFieldValue(REPLACEMENTADDRESS_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AddressReplacementInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.AddressReplacement.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getReplacementAddressID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(REPLACEMENTADDRESS_PROP.get());
    }
    ...
    public void setReplacementAddressID(gw.pl.persistence.core.Key value) {
      setFieldValue(REPLACEMENTADDRESS_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.AddressReplacement.class, config);
    com.guidewire._generated.entity.AddressReplacementInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.AddressReplacement, com.guidewire._generated.entity.AddressReplacementInternal>() {
      public java.lang.Object getImplementation(entity.AddressReplacement bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AddressReplacementInternal getInternalInterface(entity.AddressReplacement bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.AddressReplacement newEmptyInstance() {
        return new entity.AddressReplacement((java.lang.Void)null);
      }

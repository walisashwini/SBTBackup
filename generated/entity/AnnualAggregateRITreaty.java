 ...
 * 
 *     Annual aggregate reinsurance treaty.  An Annual Aggregate treaty is Nonproportional, Loss-Date attachable,
 *     and is meant to apply to an entire "book" of business.
 *   
 */
...
public class AnnualAggregateRITreaty extends entity.NonProportionalRIAgreement implements entity.Treaty, entity.LossDateAttachable {
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.reinsurance.AnnualAggregateRITreatyPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.AnnualAggregateRITreatyImpl");
    config.put("com.guidewire.pc.domain.reinsurance.LossDateAttachablePublicMethods", "com.guidewire.pc.domain.reinsurance.impl.AnnualAggregateRITreatyImpl");
    config.put("com.guidewire.pc.domain.reinsurance.NonProportionalRIAgreementPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.AnnualAggregateRITreatyImpl");
    config.put("com.guidewire.pc.domain.reinsurance.RIAgreementPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.AnnualAggregateRITreatyImpl");
    ...
    config.put("com.guidewire.pc.domain.reinsurance.impl.RIAgreementInternalMethods", "com.guidewire.pc.domain.reinsurance.impl.AnnualAggregateRITreatyImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.reinsurance.impl.AnnualAggregateRITreatyImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.pc.domain.reinsurance.impl.AnnualAggregateRITreatyImpl");
    config.put("gw.api.contact.ContactOwner", "com.guidewire.pc.domain.reinsurance.impl.AnnualAggregateRITreatyImpl");
    config.put("gw.api.domain.reinsurance.RICoverageGroupOwner", "com.guidewire.pc.domain.reinsurance.impl.AnnualAggregateRITreatyImpl");

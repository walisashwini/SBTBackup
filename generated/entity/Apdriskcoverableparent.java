...
@gw.entity.EntityName(value = "Apdriskcoverableparent")
public class Apdriskcoverableparent extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.Apdriskcoverableparent, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.Apdriskcoverableparent, entity.PolicyPeriod>("entity.Apdriskcoverableparent");
  ...
  private com.guidewire._generated.entity.ApdriskcoverableparentInternal _internal;
   ...
   */
  public Apdriskcoverableparent(entity.PolicyPeriod branch)  {
   ...
   */
  public Apdriskcoverableparent(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected Apdriskcoverableparent(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ApdriskcoverableparentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ApdriskcoverableparentInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.Apdriskcoverableparent clone() {
    return (entity.Apdriskcoverableparent)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.Apdriskcoverableparent getBasedOn() {
    return (entity.Apdriskcoverableparent)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.Apdriskcoverableparent getBasedOnValue() {
    return (entity.Apdriskcoverableparent)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.Apdriskcoverableparent getFixed() {
    return (entity.Apdriskcoverableparent)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.APDRiskCoverable getForeignEntity() {
    return (entity.APDRiskCoverable)__getInternalInterface().getFieldValue(FOREIGNENTITY_PROP.get());
  }
  ...
  public entity.APDRiskCoverable getOwner() {
    return (entity.APDRiskCoverable)__getInternalInterface().getFieldValue(OWNER_PROP.get());
  }
  ...
  public entity.Apdriskcoverableparent getSlice(java.util.Date sliceDate) {
    return (entity.Apdriskcoverableparent)getSliceUntyped(sliceDate);
  }
  ...
  public entity.Apdriskcoverableparent getUnsliced() {
    return (entity.Apdriskcoverableparent)getUnslicedUntyped();
  }
  ...
  public entity.windowed.ApdriskcoverableparentVersionList getVersionList() {
    return (entity.windowed.ApdriskcoverableparentVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.Apdriskcoverableparent value) {
   ...
   */
  private void setFixed(entity.Apdriskcoverableparent value) {
  ...
  public entity.Apdriskcoverableparent split(java.util.Date splitDate) {
    return (entity.Apdriskcoverableparent)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ApdriskcoverableparentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.Apdriskcoverableparent.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.Apdriskcoverableparent.class, config);
    com.guidewire._generated.entity.ApdriskcoverableparentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.Apdriskcoverableparent, com.guidewire._generated.entity.ApdriskcoverableparentInternal>() {
      public java.lang.Object getImplementation(entity.Apdriskcoverableparent bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ApdriskcoverableparentInternal getInternalInterface(entity.Apdriskcoverableparent bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.Apdriskcoverableparent newEmptyInstance() {
        return new entity.Apdriskcoverableparent((java.lang.Void)null);
      }

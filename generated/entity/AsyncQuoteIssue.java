...
/**
 * AsyncQuoteIssue
 * Issue found during an asynchronous quote
 */
...
@gw.entity.EntityName(value = "AsyncQuoteIssue")
public class AsyncQuoteIssue extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable, entity.Extractable, entity.FrozenSetMember {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AsyncQuoteIssue> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AsyncQuoteIssue>("entity.AsyncQuoteIssue");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ISSUESEQUENCE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "IssueSequence");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> ISSUETYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "IssueType");
  ...
  private com.guidewire._generated.entity.AsyncQuoteIssueInternal _internal;
   ...
   */
  public AsyncQuoteIssue(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected AsyncQuoteIssue(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.AsyncQuoteIssueInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AsyncQuoteIssueInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.Integer getIssueSequence() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(ISSUESEQUENCE_PROP.get());
  }
  ...
  public typekey.AsyncQuoteIssueType getIssueType() {
    return (typekey.AsyncQuoteIssueType)__getInternalInterface().getFieldValue(ISSUETYPE_PROP.get());
  }
  ...
  public void setIssueSequence(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(ISSUESEQUENCE_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AsyncQuoteIssueInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.AsyncQuoteIssue.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.AsyncQuoteIssue.class, config);
    com.guidewire._generated.entity.AsyncQuoteIssueInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.AsyncQuoteIssue, com.guidewire._generated.entity.AsyncQuoteIssueInternal>() {
      public java.lang.Object getImplementation(entity.AsyncQuoteIssue bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AsyncQuoteIssueInternal getInternalInterface(entity.AsyncQuoteIssue bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.AsyncQuoteIssue newEmptyInstance() {
        return new entity.AsyncQuoteIssue((java.lang.Void)null);
      }

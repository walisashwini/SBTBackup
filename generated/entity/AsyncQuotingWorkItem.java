...
/**
 * AsyncQuotingWorkItem
 * WorkItem to asynchronously quote PolicyPeriod
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "AsyncQuotingWorkItem.eti;AsyncQuotingWorkItem.eix;AsyncQuotingWorkItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "AsyncQuotingWorkItem")
public class AsyncQuotingWorkItem extends entity.BaseQuotingWorkItem {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AsyncQuotingWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AsyncQuotingWorkItem>("entity.AsyncQuotingWorkItem");
   ...
   */
  public AsyncQuotingWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected AsyncQuotingWorkItem(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.AsyncQuotingWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AsyncQuotingWorkItemInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.AsyncQuotingWorkItemInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AsyncQuotingWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.AsyncQuotingWorkItem.this.__getDelegateManager();
    }
    ...
    public typekey.BaseQuotingWorkItem getSubtype() {
      return (typekey.BaseQuotingWorkItem)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.AsyncQuotingWorkItem.class, config);
    com.guidewire._generated.entity.AsyncQuotingWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.AsyncQuotingWorkItem, com.guidewire._generated.entity.AsyncQuotingWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.AsyncQuotingWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AsyncQuotingWorkItemInternal getInternalInterface(entity.AsyncQuotingWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.AsyncQuotingWorkItem newEmptyInstance() {
        return new entity.AsyncQuotingWorkItem((java.lang.Void)null);
      }

...
/**
 * AsyncRatingWorkItem
 * WorkItem to asynchronously rate PolicyPeriod
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "AsyncRatingWorkItem.eti;AsyncRatingWorkItem.eix;AsyncRatingWorkItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "AsyncRatingWorkItem")
public class AsyncRatingWorkItem extends entity.BaseQuotingWorkItem {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AsyncRatingWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AsyncRatingWorkItem>("entity.AsyncRatingWorkItem");
   ...
   */
  public AsyncRatingWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected AsyncRatingWorkItem(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.AsyncRatingWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AsyncRatingWorkItemInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.AsyncRatingWorkItemInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AsyncRatingWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.AsyncRatingWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.AsyncRatingWorkItem.class, config);
    com.guidewire._generated.entity.AsyncRatingWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.AsyncRatingWorkItem, com.guidewire._generated.entity.AsyncRatingWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.AsyncRatingWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AsyncRatingWorkItemInternal getInternalInterface(entity.AsyncRatingWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.AsyncRatingWorkItem newEmptyInstance() {
        return new entity.AsyncRatingWorkItem((java.lang.Void)null);
      }

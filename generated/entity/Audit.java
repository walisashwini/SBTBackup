...
@gw.entity.EntityName(value = "Audit")
public class Audit extends entity.Job {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.Audit> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.Audit>("entity.Audit");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> AUDITINFORMATION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "AuditInformation");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IMonetaryAmountPropertyInfo> PAYMENTRECEIVED_PROP = new com.guidewire.commons.metadata.types.MonetaryAmountPropertyInfoCache(TYPE, "PaymentReceived");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PAYMENTRECEIVED_AMT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PaymentReceived_amt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> PAYMENTRECEIVED_CUR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "PaymentReceived_cur");
   ...
   */
  public Audit(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected Audit(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.AuditInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AuditInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.AuditInternal)super.__getInternalInterface();
  }
  ...
  public entity.AuditInformation getAuditInformation() {
    return (entity.AuditInformation)__getInternalInterface().getFieldValue(AUDITINFORMATION_PROP.get());
  }
  
  /**
   * 
   * @return the value of the currency property for this Audit
   */
  public typekey.Currency getCurrency() {
    return ((com.guidewire.pc.domain.job.AuditPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.AuditPublicMethods")).getCurrency();
  }
  ...
  public gw.pl.currency.MonetaryAmount getPaymentReceived() {
    return (gw.pl.currency.MonetaryAmount)__getInternalInterface().getFieldValue(PAYMENTRECEIVED_PROP.get());
  }
  ...
  public java.math.BigDecimal getPaymentReceived_amt() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(PAYMENTRECEIVED_AMT_PROP.get());
  }
  ...
  public typekey.Currency getPaymentReceived_cur() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(PAYMENTRECEIVED_CUR_PROP.get());
  }
  
  /**
   * Gets the PolicyPeriod associated with this audit job.
   * There is only one period associated with an audit.
   * @return the policy period for the job
   */
  public entity.PolicyPeriod getPolicyPeriod() {
    return ((com.guidewire.pc.domain.job.AuditPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.AuditPublicMethods")).getPolicyPeriod();
  }
  
  /**
   * Reverses this audit
   * @return the policy period of the reversal job
   */
  public entity.PolicyPeriod reverse() {
    return ((com.guidewire.pc.domain.job.AuditPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.AuditPublicMethods")).reverse();
  }
  
  /**
   * Revises this audit by creating, starting, and committing a new Audit job.
   * @return the policy period for the revise job
   */
  public entity.PolicyPeriod revise() {
    return ((com.guidewire.pc.domain.job.AuditPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.AuditPublicMethods")).revise();
  }
  ...
  public void setAuditInformation(entity.AuditInformation value) {
    __getInternalInterface().setFieldValue(AUDITINFORMATION_PROP.get(), value);
  }
  ...
  public void setPaymentReceived(gw.pl.currency.MonetaryAmount value) {
    __getInternalInterface().setFieldValue(PAYMENTRECEIVED_PROP.get(), value);
  }
  
  /**
   * Sets the value of the PaymentReceived_amt field.
   */
  private void setPaymentReceived_amt(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(PAYMENTRECEIVED_AMT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the PaymentReceived_cur field.
   */
  private void setPaymentReceived_cur(typekey.Currency value) {
    __getInternalInterface().setFieldValue(PAYMENTRECEIVED_CUR_PROP.get(), value);
  }
  
  /**
   * Starts an audit job on the latest bound period of the passed-in policy that includes the given effective date.
   ...
   */
  public void startJob(entity.Policy policy, java.util.Date effDate) throws com.guidewire.pl.web.controller.UserDisplayableException {
    ((com.guidewire.pc.domain.job.AuditPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.AuditPublicMethods")).startJob(policy, effDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AuditInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.Audit.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getAuditInformationID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(AUDITINFORMATION_PROP.get());
    }
    ...
    public void setAuditInformationID(gw.pl.persistence.core.Key value) {
      setFieldValue(AUDITINFORMATION_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.job.AuditPublicMethods", "com.guidewire.pc.domain.job.impl.AuditImpl");
    config.put("com.guidewire.pc.domain.job.JobPublicMethods", "com.guidewire.pc.domain.job.impl.AuditImpl");
    config.put("com.guidewire.pc.domain.job.impl.JobInternalMethods", "com.guidewire.pc.domain.job.impl.JobImpl");
    config.put("com.guidewire.pc.domain.note.NoteContainer", "com.guidewire.pc.domain.job.impl.AuditImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.job.impl.AuditImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.pc.domain.job.impl.JobImpl");
    config.put("com.guidewire.pl.system.entity.DoesNotValidateOnCommit", "com.guidewire.pc.domain.job.impl.AuditImpl");
    config.put("gw.api.assignment.UserRoleOwner", "com.guidewire.pc.domain.job.impl.AuditImpl");
    config.put("gw.api.domain.document.DocumentContainer", "com.guidewire.pc.domain.job.impl.AuditImpl");
    config.put("gw.api.domain.linkedobject.LinkedObjectContainer", "com.guidewire.pc.domain.job.impl.AuditImpl");
    config.put("gw.api.history.CustomHistory", "gw.api.history.JobCustomHistoryImpl");
    config.put("gw.api.job.JobMethods", "gw.api.job.AuditJobMethods");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.Audit.class, config);
    com.guidewire._generated.entity.AuditInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.Audit, com.guidewire._generated.entity.AuditInternal>() {
      public java.lang.Object getImplementation(entity.Audit bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AuditInternal getInternalInterface(entity.Audit bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.Audit newEmptyInstance() {
        return new entity.Audit((java.lang.Void)null);
      }

...
/**
 * BACededPremium
 * A CommercialAuto implementation of the RICededPremium delegate
 */
...
@gw.entity.EntityName(value = "BACededPremium")
public class BACededPremium extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.RICededPremium, entity.FrozenSetMember, gw.api.reinsurance.RICededPremiumAdapter {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.BACededPremium> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.BACededPremium>("entity.BACededPremium");
  ...
  private com.guidewire._generated.entity.BACededPremiumInternal _internal;
   ...
   */
  public BACededPremium(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected BACededPremium(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BACededPremiumInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BACededPremiumInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BACededPremiumHistory[] getCedingHistory() {
    return (entity.BACededPremiumHistory[])__getInternalInterface().getFieldValue(CEDINGHISTORY_PROP.get());
  }
  ...
  public entity.BACededPremiumTransaction[] getCedingTransactions() {
    return (entity.BACededPremiumTransaction[])__getInternalInterface().getFieldValue(CEDINGTRANSACTIONS_PROP.get());
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BACededPremiumInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BACededPremium.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.reinsurance.RICededPremiumAdapter", "gw.reinsurance.ceding.BACededPremiumAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BACededPremium.class, config);
    com.guidewire._generated.entity.BACededPremiumInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BACededPremium, com.guidewire._generated.entity.BACededPremiumInternal>() {
      public java.lang.Object getImplementation(entity.BACededPremium bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BACededPremiumInternal getInternalInterface(entity.BACededPremium bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BACededPremium newEmptyInstance() {
        return new entity.BACededPremium((java.lang.Void)null);
      }

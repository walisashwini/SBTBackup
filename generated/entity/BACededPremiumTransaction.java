...
/**
 * BACededPremiumTransaction
 * A Commercial Auto implementation of the RICededPremiumTransaction delegate
 */
...
@gw.entity.EntityName(value = "BACededPremiumTransaction")
public class BACededPremiumTransaction extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.RICededPremiumTransaction, entity.FrozenSetMember, gw.api.reinsurance.RICededPremiumTxnAdapter {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.BACededPremiumTransaction> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.BACededPremiumTransaction>("entity.BACededPremiumTransaction");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> BACEDEDPREMIUM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "BACededPremium");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> BACEDEDPREMIUMHISTORY_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "BACededPremiumHistory");
  ...
  private com.guidewire._generated.entity.BACededPremiumTransactionInternal _internal;
   ...
   */
  public BACededPremiumTransaction()  {
   ...
   */
  public BACededPremiumTransaction(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected BACededPremiumTransaction(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BACededPremiumTransactionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BACededPremiumTransactionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BACededPremium getBACededPremium() {
    return (entity.BACededPremium)__getInternalInterface().getFieldValue(BACEDEDPREMIUM_PROP.get());
  }
  ...
  public entity.BACededPremiumHistory getBACededPremiumHistory() {
    return (entity.BACededPremiumHistory)__getInternalInterface().getFieldValue(BACEDEDPREMIUMHISTORY_PROP.get());
  }
  ...
  public void setBACededPremium(entity.BACededPremium value) {
    __getInternalInterface().setFieldValue(BACEDEDPREMIUM_PROP.get(), value);
  }
  ...
  public void setBACededPremiumHistory(entity.BACededPremiumHistory value) {
    __getInternalInterface().setFieldValue(BACEDEDPREMIUMHISTORY_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BACededPremiumTransactionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BACededPremiumTransaction.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getBACededPremiumHistoryID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(BACEDEDPREMIUMHISTORY_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getBACededPremiumID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(BACEDEDPREMIUM_PROP.get());
    }
    ...
    public void setBACededPremiumHistoryID(gw.pl.persistence.core.Key value) {
      setFieldValue(BACEDEDPREMIUMHISTORY_PROP.get(), value);
    }
    
    public void setBACededPremiumID(gw.pl.persistence.core.Key value) {
      setFieldValue(BACEDEDPREMIUM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.reinsurance.RICededPremiumTxnAdapter", "gw.reinsurance.ceding.BACededPremiumTransactionAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BACededPremiumTransaction.class, config);
    com.guidewire._generated.entity.BACededPremiumTransactionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BACededPremiumTransaction, com.guidewire._generated.entity.BACededPremiumTransactionInternal>() {
      public java.lang.Object getImplementation(entity.BACededPremiumTransaction bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BACededPremiumTransactionInternal getInternalInterface(entity.BACededPremiumTransaction bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BACededPremiumTransaction newEmptyInstance() {
        return new entity.BACededPremiumTransaction((java.lang.Void)null);
      }

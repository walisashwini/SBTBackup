...
/**
 * BACondLookup
 * BA Condition Lookup Table.
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "BACondLookup.eti;BACondLookup.eix;BACondLookup.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "BACondLookup")
public class BACondLookup extends entity.ConditionLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.BACondLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.BACondLookup>("entity.BACondLookup");
   ...
   */
  protected BACondLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected BACondLookup(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BACondLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BACondLookupInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BACondLookupInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BACondLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BACondLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BACondLookup.class, config);
    com.guidewire._generated.entity.BACondLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BACondLookup, com.guidewire._generated.entity.BACondLookupInternal>() {
      public java.lang.Object getImplementation(entity.BACondLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BACondLookupInternal getInternalInterface(entity.BACondLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BACondLookup newEmptyInstance() {
        return new entity.BACondLookup((java.lang.Void)null);
      }

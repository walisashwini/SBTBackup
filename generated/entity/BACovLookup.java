...
/**
 * BACovLookup
 * BA Coverage Lookup Table.
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "BACovLookup.eti;BACovLookup.eix;BACovLookup.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "BACovLookup")
public class BACovLookup extends entity.CoverageLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.BACovLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.BACovLookup>("entity.BACovLookup");
   ...
   */
  protected BACovLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected BACovLookup(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BACovLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BACovLookupInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BACovLookupInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BACovLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BACovLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BACovLookup.class, config);
    com.guidewire._generated.entity.BACovLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BACovLookup, com.guidewire._generated.entity.BACovLookupInternal>() {
      public java.lang.Object getImplementation(entity.BACovLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BACovLookupInternal getInternalInterface(entity.BACovLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BACovLookup newEmptyInstance() {
        return new entity.BACovLookup((java.lang.Void)null);
      }

...
/**
 * BAExclLookup
 * BA Exclusion Lookup Table.
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "BAExclLookup.eti;BAExclLookup.eix;BAExclLookup.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "BAExclLookup")
public class BAExclLookup extends entity.ExclusionLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.BAExclLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.BAExclLookup>("entity.BAExclLookup");
   ...
   */
  protected BAExclLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected BAExclLookup(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BAExclLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BAExclLookupInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BAExclLookupInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BAExclLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BAExclLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BAExclLookup.class, config);
    com.guidewire._generated.entity.BAExclLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BAExclLookup, com.guidewire._generated.entity.BAExclLookupInternal>() {
      public java.lang.Object getImplementation(entity.BAExclLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BAExclLookupInternal getInternalInterface(entity.BAExclLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BAExclLookup newEmptyInstance() {
        return new entity.BAExclLookup((java.lang.Void)null);
      }

...
/**
 * BAHiredAutoBasis
 * Information necessary for rating hired auto coverages
 */
...
@gw.entity.EntityName(value = "BAHiredAutoBasis")
public class BAHiredAutoBasis extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BAHiredAutoBasis, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BAHiredAutoBasis, entity.PolicyPeriod>("entity.BAHiredAutoBasis");
  ...
  private com.guidewire._generated.entity.BAHiredAutoBasisInternal _internal;
   ...
   */
  public BAHiredAutoBasis(entity.PolicyPeriod branch)  {
   ...
   */
  public BAHiredAutoBasis(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BAHiredAutoBasis(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BAHiredAutoBasisInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BAHiredAutoBasisInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BAHiredAutoBasis clone() {
    return (entity.BAHiredAutoBasis)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BAHiredAutoBasis getBasedOn() {
    return (entity.BAHiredAutoBasis)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BAHiredAutoBasis getBasedOnValue() {
    return (entity.BAHiredAutoBasis)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public java.lang.Integer getBasis() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(BASIS_PROP.get());
  }
  ...
  public entity.BAHiredAutoBasis getFixed() {
    return (entity.BAHiredAutoBasis)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.BAHiredAutoBasis getSlice(java.util.Date sliceDate) {
    return (entity.BAHiredAutoBasis)getSliceUntyped(sliceDate);
  }
  ...
  public entity.BAHiredAutoBasis getUnsliced() {
    return (entity.BAHiredAutoBasis)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BAHiredAutoBasisVersionList getVersionList() {
    return (entity.windowed.BAHiredAutoBasisVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.BAHiredAutoBasis value) {
   ...
   */
  private void setFixed(entity.BAHiredAutoBasis value) {
  ...
  public entity.BAHiredAutoBasis split(java.util.Date splitDate) {
    return (entity.BAHiredAutoBasis)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BAHiredAutoBasisInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BAHiredAutoBasis.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.ba.BAHiredAutoBasisMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.ba.BAHiredAutoBasisMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BAHiredAutoBasis.class, config);
    com.guidewire._generated.entity.BAHiredAutoBasisInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BAHiredAutoBasis, com.guidewire._generated.entity.BAHiredAutoBasisInternal>() {
      public java.lang.Object getImplementation(entity.BAHiredAutoBasis bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BAHiredAutoBasisInternal getInternalInterface(entity.BAHiredAutoBasis bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BAHiredAutoBasis newEmptyInstance() {
        return new entity.BAHiredAutoBasis((java.lang.Void)null);
      }

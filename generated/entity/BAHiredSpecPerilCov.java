...
@gw.entity.EntityName(value = "BAHiredSpecPerilCov")
public class BAHiredSpecPerilCov extends entity.BAStateCov {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BAHiredSpecPerilCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BAHiredSpecPerilCov, entity.PolicyPeriod>("entity.BAHiredSpecPerilCov");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> HIREDCAUSEOFLOSS_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "HiredCauseOfLoss");
   ...
   */
  protected BAHiredSpecPerilCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected BAHiredSpecPerilCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected BAHiredSpecPerilCov(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BAHiredSpecPerilCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BAHiredSpecPerilCovInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BAHiredSpecPerilCovInternal)super.__getInternalInterface();
  }
  
  public entity.BAHiredSpecPerilCov clone() {
    return (entity.BAHiredSpecPerilCov)__getInternalInterface().cloneUntyped();
  }
  
  public entity.BAHiredSpecPerilCov getBasedOn() {
    return (entity.BAHiredSpecPerilCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  /**
   * Gets the value of the HiredCauseOfLoss field.
   * Cause of loss
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.SpecifiedCauseOfLoss getHiredCauseOfLoss() {
    return (typekey.SpecifiedCauseOfLoss)__getInternalInterface().getFieldValue(HIREDCAUSEOFLOSS_PROP.get());
  }
  
  public entity.BAHiredSpecPerilCov getSlice(java.util.Date sliceDate) {
    return (entity.BAHiredSpecPerilCov)getSliceUntyped(sliceDate);
  }
  
  public entity.BAHiredSpecPerilCov getUnsliced() {
    return (entity.BAHiredSpecPerilCov)getUnslicedUntyped();
  }
  
  public entity.windowed.BAHiredSpecPerilCovVersionList getVersionList() {
    return (entity.windowed.BAHiredSpecPerilCovVersionList)getVersionListUntyped();
  }
  
  /**
   * Sets the value of the HiredCauseOfLoss field.
   */
  public void setHiredCauseOfLoss(typekey.SpecifiedCauseOfLoss value) {
    __getInternalInterface().setFieldValue(HIREDCAUSEOFLOSS_PROP.get(), value);
  }
  
  public entity.BAHiredSpecPerilCov split(java.util.Date splitDate) {
    return (entity.BAHiredSpecPerilCov)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BAHiredSpecPerilCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BAHiredSpecPerilCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BAHiredSpecPerilCov.class, config);
    com.guidewire._generated.entity.BAHiredSpecPerilCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BAHiredSpecPerilCov, com.guidewire._generated.entity.BAHiredSpecPerilCovInternal>() {
      public java.lang.Object getImplementation(entity.BAHiredSpecPerilCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BAHiredSpecPerilCovInternal getInternalInterface(entity.BAHiredSpecPerilCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BAHiredSpecPerilCov newEmptyInstance() {
        return new entity.BAHiredSpecPerilCov((java.lang.Void)null);
      }

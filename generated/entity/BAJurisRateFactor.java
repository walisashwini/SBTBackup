...
/**
 * BAJurisRateFactor
 * A rate factor is a risk characteristic and its associated numeric value which might have an impact on premium. A common example of Rate Factors are the components of IRPM (individual risk premium modifier).
 */
...
@gw.entity.EntityName(value = "BAJurisRateFactor")
public class BAJurisRateFactor extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.RateFactor, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BAJurisRateFactor, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BAJurisRateFactor, entity.PolicyPeriod>("entity.BAJurisRateFactor");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> BAJURISMODIFIER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "BAJurisModifier");
  ...
  private com.guidewire._generated.entity.BAJurisRateFactorInternal _internal;
   ...
   */
  public BAJurisRateFactor(entity.PolicyPeriod branch)  {
   ...
   */
  public BAJurisRateFactor(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BAJurisRateFactor(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BAJurisRateFactorInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BAJurisRateFactorInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BAJurisRateFactor clone() {
    return (entity.BAJurisRateFactor)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BAJurisModifier getBAJurisModifier() {
    return (entity.BAJurisModifier)__getInternalInterface().getFieldValue(BAJURISMODIFIER_PROP.get());
  }
  
  public entity.BAJurisRateFactor getBasedOn() {
    return (entity.BAJurisRateFactor)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BAJurisRateFactor getBasedOnValue() {
    return (entity.BAJurisRateFactor)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.BAJurisRateFactor getFixed() {
    return (entity.BAJurisRateFactor)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.BAJurisRateFactor getSlice(java.util.Date sliceDate) {
    return (entity.BAJurisRateFactor)getSliceUntyped(sliceDate);
  }
  ...
  public entity.BAJurisRateFactor getUnsliced() {
    return (entity.BAJurisRateFactor)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BAJurisRateFactorVersionList getVersionList() {
    return (entity.windowed.BAJurisRateFactorVersionList)getVersionListUntyped();
  }
  ...
  public void setBAJurisModifier(entity.BAJurisModifier value) {
    __getInternalInterface().setFieldValue(BAJURISMODIFIER_PROP.get(), value);
  }
  
  /**
   * Sets the value of the BasedOnValue field.
   */
  private void setBasedOnValue(entity.BAJurisRateFactor value) {
   ...
   */
  private void setFixed(entity.BAJurisRateFactor value) {
  ...
  public entity.BAJurisRateFactor split(java.util.Date splitDate) {
    return (entity.BAJurisRateFactor)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BAJurisRateFactorInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BAJurisRateFactor.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getBAJurisModifierID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(BAJURISMODIFIER_PROP.get());
    }
    ...
    public void setBAJurisModifierID(gw.pl.persistence.core.Key value) {
      setFieldValue(BAJURISMODIFIER_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.RateFactorAdapter", "gw.lob.ba.BAJurisdictionRateFactorAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.ba.BAJurisdictionRateFactorMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.ba.BAJurisdictionRateFactorMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BAJurisRateFactor.class, config);
    com.guidewire._generated.entity.BAJurisRateFactorInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BAJurisRateFactor, com.guidewire._generated.entity.BAJurisRateFactorInternal>() {
      public java.lang.Object getImplementation(entity.BAJurisRateFactor bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BAJurisRateFactorInternal getInternalInterface(entity.BAJurisRateFactor bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BAJurisRateFactor newEmptyInstance() {
        return new entity.BAJurisRateFactor((java.lang.Void)null);
      }

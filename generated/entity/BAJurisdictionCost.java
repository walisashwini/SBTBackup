...
/**
 * BAJurisdictionCost
 * A cost at the BA Jurisdiction level.
 */
...
@gw.entity.EntityName(value = "BAJurisdictionCost")
public class BAJurisdictionCost extends entity.BACost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BAJurisdictionCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BAJurisdictionCost, entity.PolicyPeriod>("entity.BAJurisdictionCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> BAJURISDICTIONCOSTTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "BAJurisdictionCostType");
   ...
   */
  public BAJurisdictionCost(entity.PolicyPeriod branch)  {
   ...
   */
  public BAJurisdictionCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BAJurisdictionCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BAJurisdictionCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BAJurisdictionCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BAJurisdictionCostInternal)super.__getInternalInterface();
  }
  
  public entity.BAJurisdictionCost clone() {
    return (entity.BAJurisdictionCost)__getInternalInterface().cloneUntyped();
  }
  
  /**
   * Gets the value of the BAJurisdictionCostType field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.BAJurisdictionCostType getBAJurisdictionCostType() {
    return (typekey.BAJurisdictionCostType)__getInternalInterface().getFieldValue(BAJURISDICTIONCOSTTYPE_PROP.get());
  }
  
  public entity.BAJurisdictionCost getBasedOn() {
    return (entity.BAJurisdictionCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BAJurisdictionCost getSlice(java.util.Date sliceDate) {
    return (entity.BAJurisdictionCost)getSliceUntyped(sliceDate);
  }
  
  public entity.BAJurisdictionCost getUnsliced() {
    return (entity.BAJurisdictionCost)getUnslicedUntyped();
  }
  
  public entity.windowed.BAJurisdictionCostVersionList getVersionList() {
    return (entity.windowed.BAJurisdictionCostVersionList)getVersionListUntyped();
  }
  
  /**
   * Sets the value of the BAJurisdictionCostType field.
   */
  public void setBAJurisdictionCostType(typekey.BAJurisdictionCostType value) {
    __getInternalInterface().setFieldValue(BAJURISDICTIONCOSTTYPE_PROP.get(), value);
  }
  
  public entity.BAJurisdictionCost split(java.util.Date splitDate) {
    return (entity.BAJurisdictionCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BAJurisdictionCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BAJurisdictionCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.ba.financials.BACostMethods", "gw.lob.ba.financials.BAJurisdictionCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BAJurisdictionCost.class, config);
    com.guidewire._generated.entity.BAJurisdictionCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BAJurisdictionCost, com.guidewire._generated.entity.BAJurisdictionCostInternal>() {
      public java.lang.Object getImplementation(entity.BAJurisdictionCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BAJurisdictionCostInternal getInternalInterface(entity.BAJurisdictionCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BAJurisdictionCost newEmptyInstance() {
        return new entity.BAJurisdictionCost((java.lang.Void)null);
      }

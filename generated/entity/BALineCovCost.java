...
/**
 * BALineCovCost
 * A  unit of cost for a Commercial Auto Line coverage
 */
...
@gw.entity.EntityName(value = "BALineCovCost")
public class BALineCovCost extends entity.BACost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BALineCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BALineCovCost, entity.PolicyPeriod>("entity.BALineCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> BUSINESSAUTOCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "BusinessAutoCov");
   ...
   */
  public BALineCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public BALineCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BALineCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BALineCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BALineCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BALineCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.BALineCovCost clone() {
    return (entity.BALineCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.BALineCovCost getBasedOn() {
    return (entity.BALineCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BALineCovCost getSlice(java.util.Date sliceDate) {
    return (entity.BALineCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.BALineCovCost getUnsliced() {
    return (entity.BALineCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.BALineCovCostVersionList getVersionList() {
    return (entity.windowed.BALineCovCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.BALineCovCost split(java.util.Date splitDate) {
    return (entity.BALineCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BALineCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BALineCovCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.ba.financials.BACostMethods", "gw.lob.ba.financials.BALineCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BALineCovCost.class, config);
    com.guidewire._generated.entity.BALineCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BALineCovCost, com.guidewire._generated.entity.BALineCovCostInternal>() {
      public java.lang.Object getImplementation(entity.BALineCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BALineCovCostInternal getInternalInterface(entity.BALineCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BALineCovCost newEmptyInstance() {
        return new entity.BALineCovCost((java.lang.Void)null);
      }

...
/**
 * BALineCovNonownedCost
 * A unit of price for a Commercial Auto Line coverage rated by state and Nonowned Exposure type
 */
...
@gw.entity.EntityName(value = "BALineCovNonownedCost")
public class BALineCovNonownedCost extends entity.BALineCovCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BALineCovNonownedCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BALineCovNonownedCost, entity.PolicyPeriod>("entity.BALineCovNonownedCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> BANONOWNEDLIABCOVCOSTTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "BANonOwnedLiabCovCostType");
   ...
   */
  public BALineCovNonownedCost(entity.PolicyPeriod branch)  {
   ...
   */
  public BALineCovNonownedCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BALineCovNonownedCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BALineCovNonownedCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BALineCovNonownedCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BALineCovNonownedCostInternal)super.__getInternalInterface();
  }
  
  public entity.BALineCovNonownedCost clone() {
    return (entity.BALineCovNonownedCost)__getInternalInterface().cloneUntyped();
  }
  ...
  public typekey.BANonOwnedLiabCovCostType getBANonOwnedLiabCovCostType() {
    return (typekey.BANonOwnedLiabCovCostType)__getInternalInterface().getFieldValue(BANONOWNEDLIABCOVCOSTTYPE_PROP.get());
  }
  
  public entity.BALineCovNonownedCost getBasedOn() {
    return (entity.BALineCovNonownedCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BALineCovNonownedCost getSlice(java.util.Date sliceDate) {
    return (entity.BALineCovNonownedCost)getSliceUntyped(sliceDate);
  }
  
  public entity.BALineCovNonownedCost getUnsliced() {
    return (entity.BALineCovNonownedCost)getUnslicedUntyped();
  }
  
  public entity.windowed.BALineCovNonownedCostVersionList getVersionList() {
    return (entity.windowed.BALineCovNonownedCostVersionList)getVersionListUntyped();
  }
  ...
  public void setBANonOwnedLiabCovCostType(typekey.BANonOwnedLiabCovCostType value) {
    __getInternalInterface().setFieldValue(BANONOWNEDLIABCOVCOSTTYPE_PROP.get(), value);
  }
  
  public entity.BALineCovNonownedCost split(java.util.Date splitDate) {
    return (entity.BALineCovNonownedCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BALineCovNonownedCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BALineCovNonownedCost.this.__getDelegateManager();
    }
    ...
    public entity.BusinessAutoCov getBusinessAutoCov() {
      return (entity.BusinessAutoCov)__getInternalInterface().getFieldValue(BUSINESSAUTOCOV_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getBusinessAutoCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(BUSINESSAUTOCOV_PROP.get());
    }
    ...
    public void setBusinessAutoCov(entity.BusinessAutoCov value) {
      __getInternalInterface().setFieldValue(BUSINESSAUTOCOV_PROP.get(), value);
    }
    
    public void setBusinessAutoCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(BUSINESSAUTOCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.ba.financials.BACostMethods", "gw.lob.ba.financials.BALineCovNonownedCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BALineCovNonownedCost.class, config);
    com.guidewire._generated.entity.BALineCovNonownedCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BALineCovNonownedCost, com.guidewire._generated.entity.BALineCovNonownedCostInternal>() {
      public java.lang.Object getImplementation(entity.BALineCovNonownedCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BALineCovNonownedCostInternal getInternalInterface(entity.BALineCovNonownedCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BALineCovNonownedCost newEmptyInstance() {
        return new entity.BALineCovNonownedCost((java.lang.Void)null);
      }

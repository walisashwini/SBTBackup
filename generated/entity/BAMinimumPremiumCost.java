...
/**
 * BAMinimumPremiumCost
 * The minimum premium adjustment cost for the Commercial Auto Line
 */
...
@gw.entity.EntityName(value = "BAMinimumPremiumCost")
public class BAMinimumPremiumCost extends entity.BACost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BAMinimumPremiumCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BAMinimumPremiumCost, entity.PolicyPeriod>("entity.BAMinimumPremiumCost");
   ...
   */
  public BAMinimumPremiumCost(entity.PolicyPeriod branch)  {
   ...
   */
  public BAMinimumPremiumCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BAMinimumPremiumCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BAMinimumPremiumCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BAMinimumPremiumCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BAMinimumPremiumCostInternal)super.__getInternalInterface();
  }
  
  public entity.BAMinimumPremiumCost clone() {
    return (entity.BAMinimumPremiumCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.BAMinimumPremiumCost getBasedOn() {
    return (entity.BAMinimumPremiumCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BAMinimumPremiumCost getSlice(java.util.Date sliceDate) {
    return (entity.BAMinimumPremiumCost)getSliceUntyped(sliceDate);
  }
  
  public entity.BAMinimumPremiumCost getUnsliced() {
    return (entity.BAMinimumPremiumCost)getUnslicedUntyped();
  }
  
  public entity.windowed.BAMinimumPremiumCostVersionList getVersionList() {
    return (entity.windowed.BAMinimumPremiumCostVersionList)getVersionListUntyped();
  }
  
  public entity.BAMinimumPremiumCost split(java.util.Date splitDate) {
    return (entity.BAMinimumPremiumCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BAMinimumPremiumCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BAMinimumPremiumCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.ba.financials.BACostMethods", "gw.lob.ba.financials.BAMinimumPremiumCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BAMinimumPremiumCost.class, config);
    com.guidewire._generated.entity.BAMinimumPremiumCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BAMinimumPremiumCost, com.guidewire._generated.entity.BAMinimumPremiumCostInternal>() {
      public java.lang.Object getImplementation(entity.BAMinimumPremiumCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BAMinimumPremiumCostInternal getInternalInterface(entity.BAMinimumPremiumCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BAMinimumPremiumCost newEmptyInstance() {
        return new entity.BAMinimumPremiumCost((java.lang.Void)null);
      }

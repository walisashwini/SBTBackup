...
/**
 * BAModLookup
 * BA Modifier Lookup Table.
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "BAModLookup.eti;BAModLookup.eix;BAModLookup.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "BAModLookup")
public class BAModLookup extends entity.ModifierLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.BAModLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.BAModLookup>("entity.BAModLookup");
   ...
   */
  protected BAModLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected BAModLookup(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BAModLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BAModLookupInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BAModLookupInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BAModLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BAModLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BAModLookup.class, config);
    com.guidewire._generated.entity.BAModLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BAModLookup, com.guidewire._generated.entity.BAModLookupInternal>() {
      public java.lang.Object getImplementation(entity.BAModLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BAModLookupInternal getInternalInterface(entity.BAModLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BAModLookup newEmptyInstance() {
        return new entity.BAModLookup((java.lang.Void)null);
      }

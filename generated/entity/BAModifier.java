...
/**
 * BAModifier
 * A line-level modifier for Commercial Auto
 */
...
@gw.entity.EntityName(value = "BAModifier")
public class BAModifier extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Modifier, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BAModifier, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BAModifier, entity.PolicyPeriod>("entity.BAModifier");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> BARATEFACTORS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "BARateFactors");
  ...
  private com.guidewire._generated.entity.BAModifierInternal _internal;
   ...
   */
  public BAModifier(entity.PolicyPeriod branch)  {
   ...
   */
  public BAModifier(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BAModifier(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BAModifierInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BAModifierInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToBARateFactors(entity.BARateFactor element) {
    __getInternalInterface().addArrayElement(BARATEFACTORS_PROP.get(), element);
  }
  ...
  public entity.BAModifier clone() {
    return (entity.BAModifier)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BARateFactor[] getBARateFactors() {
    return (entity.BARateFactor[])__getInternalInterface().getFieldValue(BARATEFACTORS_PROP.get());
  }
  
  public entity.BAModifier getBasedOn() {
    return (entity.BAModifier)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BAModifier getBasedOnValue() {
    return (entity.BAModifier)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.BAModifier getFixed() {
    return (entity.BAModifier)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.BAModifier getSlice(java.util.Date sliceDate) {
    return (entity.BAModifier)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.BAModifier getSubtype() {
    return (typekey.BAModifier)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.BAModifier getUnsliced() {
    return (entity.BAModifier)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BAModifierVersionList getVersionList() {
    return (entity.windowed.BAModifierVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromBARateFactors(entity.BARateFactor element) {
    __getInternalInterface().removeArrayElement(BARATEFACTORS_PROP.get(), element);
  }
  ...
  public void removeFromBARateFactors(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(BARATEFACTORS_PROP.get(), elementID);
  }
  ...
  public void setBARateFactors(entity.BARateFactor[] value) {
    __getInternalInterface().setFieldValue(BARATEFACTORS_PROP.get(), value);
  }
  
  /**
   * Sets the value of the BasedOnValue field.
   */
  private void setBasedOnValue(entity.BAModifier value) {
   ...
   */
  private void setFixed(entity.BAModifier value) {
   ...
   */
  private void setSubtype(typekey.BAModifier value) {
  ...
  public entity.BAModifier split(java.util.Date splitDate) {
    return (entity.BAModifier)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BAModifierInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BAModifier.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ModifierAbstractDomainMethods", "gw.lob.ba.BAModifierAdapter");
    config.put("gw.api.domain.ModifierAdapter", "gw.lob.ba.BAModifierAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.ba.BAModifierMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.ba.BAModifierMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BAModifier.class, config);
    com.guidewire._generated.entity.BAModifierInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BAModifier, com.guidewire._generated.entity.BAModifierInternal>() {
      public java.lang.Object getImplementation(entity.BAModifier bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BAModifierInternal getInternalInterface(entity.BAModifier bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BAModifier newEmptyInstance() {
        return new entity.BAModifier((java.lang.Void)null);
      }

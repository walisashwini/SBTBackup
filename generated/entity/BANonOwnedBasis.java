...
/**
 * BANonOwnedBasis
 * Information necessary for rating non-owned coverages
 */
...
@gw.entity.EntityName(value = "BANonOwnedBasis")
public class BANonOwnedBasis extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BANonOwnedBasis, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BANonOwnedBasis, entity.PolicyPeriod>("entity.BANonOwnedBasis");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> NUMPARTNERS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "NumPartners");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> NUMVOLUNTEERS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "NumVolunteers");
  ...
  private com.guidewire._generated.entity.BANonOwnedBasisInternal _internal;
   ...
   */
  public BANonOwnedBasis(entity.PolicyPeriod branch)  {
   ...
   */
  public BANonOwnedBasis(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BANonOwnedBasis(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BANonOwnedBasisInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BANonOwnedBasisInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BANonOwnedBasis clone() {
    return (entity.BANonOwnedBasis)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BANonOwnedBasis getBasedOn() {
    return (entity.BANonOwnedBasis)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BANonOwnedBasis getBasedOnValue() {
    return (entity.BANonOwnedBasis)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.BANonOwnedBasis getFixed() {
    return (entity.BANonOwnedBasis)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public java.lang.Integer getNumPartners() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(NUMPARTNERS_PROP.get());
  }
  ...
  public java.lang.Integer getNumVolunteers() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(NUMVOLUNTEERS_PROP.get());
  }
  ...
  public entity.BANonOwnedBasis getSlice(java.util.Date sliceDate) {
    return (entity.BANonOwnedBasis)getSliceUntyped(sliceDate);
  }
  ...
  public entity.BANonOwnedBasis getUnsliced() {
    return (entity.BANonOwnedBasis)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BANonOwnedBasisVersionList getVersionList() {
    return (entity.windowed.BANonOwnedBasisVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.BANonOwnedBasis value) {
   ...
   */
  private void setFixed(entity.BANonOwnedBasis value) {
  ...
  public void setNumPartners(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(NUMPARTNERS_PROP.get(), value);
  }
  ...
  public void setNumVolunteers(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(NUMVOLUNTEERS_PROP.get(), value);
  }
  ...
  public entity.BANonOwnedBasis split(java.util.Date splitDate) {
    return (entity.BANonOwnedBasis)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BANonOwnedBasisInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BANonOwnedBasis.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.ba.BANonOwnedBasisMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.ba.BANonOwnedBasisMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BANonOwnedBasis.class, config);
    com.guidewire._generated.entity.BANonOwnedBasisInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BANonOwnedBasis, com.guidewire._generated.entity.BANonOwnedBasisInternal>() {
      public java.lang.Object getImplementation(entity.BANonOwnedBasis bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BANonOwnedBasisInternal getInternalInterface(entity.BANonOwnedBasis bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BANonOwnedBasis newEmptyInstance() {
        return new entity.BANonOwnedBasis((java.lang.Void)null);
      }

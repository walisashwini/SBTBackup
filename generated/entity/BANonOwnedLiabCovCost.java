...
/**
 * BANonOwnedLiabCovCost
 * The cost for non-owned auto liability coverage for a particular group of people.
 */
...
@gw.entity.EntityName(value = "BANonOwnedLiabCovCost")
public class BANonOwnedLiabCovCost extends entity.BAStateCovCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BANonOwnedLiabCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BANonOwnedLiabCovCost, entity.PolicyPeriod>("entity.BANonOwnedLiabCovCost");
   ...
   */
  public BANonOwnedLiabCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public BANonOwnedLiabCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BANonOwnedLiabCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BANonOwnedLiabCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BANonOwnedLiabCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BANonOwnedLiabCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.BANonOwnedLiabCovCost clone() {
    return (entity.BANonOwnedLiabCovCost)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BANonOwnedLiabCovCost getBasedOn() {
    return (entity.BANonOwnedLiabCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BANonOwnedLiabCovCost getSlice(java.util.Date sliceDate) {
    return (entity.BANonOwnedLiabCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.BANonOwnedLiabCovCost getUnsliced() {
    return (entity.BANonOwnedLiabCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.BANonOwnedLiabCovCostVersionList getVersionList() {
    return (entity.windowed.BANonOwnedLiabCovCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.BANonOwnedLiabCovCost split(java.util.Date splitDate) {
    return (entity.BANonOwnedLiabCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BANonOwnedLiabCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BANonOwnedLiabCovCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.ba.financials.BACostMethods", "gw.lob.ba.financials.BAStateCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BANonOwnedLiabCovCost.class, config);
    com.guidewire._generated.entity.BANonOwnedLiabCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BANonOwnedLiabCovCost, com.guidewire._generated.entity.BANonOwnedLiabCovCostInternal>() {
      public java.lang.Object getImplementation(entity.BANonOwnedLiabCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BANonOwnedLiabCovCostInternal getInternalInterface(entity.BANonOwnedLiabCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BANonOwnedLiabCovCost newEmptyInstance() {
        return new entity.BANonOwnedLiabCovCost((java.lang.Void)null);
      }

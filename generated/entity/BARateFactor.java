...
@gw.entity.EntityName(value = "BARateFactor")
public class BARateFactor extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.RateFactor, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BARateFactor, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BARateFactor, entity.PolicyPeriod>("entity.BARateFactor");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> BAMODIFIER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "BAModifier");
  ...
  private com.guidewire._generated.entity.BARateFactorInternal _internal;
   ...
   */
  public BARateFactor(entity.PolicyPeriod branch)  {
   ...
   */
  public BARateFactor(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BARateFactor(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BARateFactorInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BARateFactorInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BARateFactor clone() {
    return (entity.BARateFactor)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BAModifier getBAModifier() {
    return (entity.BAModifier)__getInternalInterface().getFieldValue(BAMODIFIER_PROP.get());
  }
  
  public entity.BARateFactor getBasedOn() {
    return (entity.BARateFactor)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BARateFactor getBasedOnValue() {
    return (entity.BARateFactor)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.BARateFactor getFixed() {
    return (entity.BARateFactor)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.BARateFactor getSlice(java.util.Date sliceDate) {
    return (entity.BARateFactor)getSliceUntyped(sliceDate);
  }
  ...
  public entity.BARateFactor getUnsliced() {
    return (entity.BARateFactor)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BARateFactorVersionList getVersionList() {
    return (entity.windowed.BARateFactorVersionList)getVersionListUntyped();
  }
  ...
  public void setBAModifier(entity.BAModifier value) {
    __getInternalInterface().setFieldValue(BAMODIFIER_PROP.get(), value);
  }
  
  /**
   * Sets the value of the BasedOnValue field.
   */
  private void setBasedOnValue(entity.BARateFactor value) {
   ...
   */
  private void setFixed(entity.BARateFactor value) {
  ...
  public entity.BARateFactor split(java.util.Date splitDate) {
    return (entity.BARateFactor)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BARateFactorInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BARateFactor.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getBAModifierID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(BAMODIFIER_PROP.get());
    }
    ...
    public void setBAModifierID(gw.pl.persistence.core.Key value) {
      setFieldValue(BAMODIFIER_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.RateFactorAdapter", "gw.lob.ba.BARateFactorAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.ba.BARateFactorMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.ba.BARateFactorMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BARateFactor.class, config);
    com.guidewire._generated.entity.BARateFactorInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BARateFactor, com.guidewire._generated.entity.BARateFactorInternal>() {
      public java.lang.Object getImplementation(entity.BARateFactor bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BARateFactorInternal getInternalInterface(entity.BARateFactor bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BARateFactor newEmptyInstance() {
        return new entity.BARateFactor((java.lang.Void)null);
      }

...
/**
 * BARateLookup
 * BA Rate Factor Lookup Table.
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "BARateLookup.eti;BARateLookup.eix;BARateLookup.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "BARateLookup")
public class BARateLookup extends entity.RateFactorLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.BARateLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.BARateLookup>("entity.BARateLookup");
   ...
   */
  protected BARateLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected BARateLookup(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BARateLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BARateLookupInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BARateLookupInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BARateLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BARateLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BARateLookup.class, config);
    com.guidewire._generated.entity.BARateLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BARateLookup, com.guidewire._generated.entity.BARateLookupInternal>() {
      public java.lang.Object getImplementation(entity.BARateLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BARateLookupInternal getInternalInterface(entity.BARateLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BARateLookup newEmptyInstance() {
        return new entity.BARateLookup((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "BASpecCausesLossCov")
public class BASpecCausesLossCov extends entity.BusinessVehicleCov {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BASpecCausesLossCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BASpecCausesLossCov, entity.PolicyPeriod>("entity.BASpecCausesLossCov");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> SPECIFIEDCAUSEOFLOSS_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "SpecifiedCauseOfLoss");
   ...
   */
  protected BASpecCausesLossCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected BASpecCausesLossCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected BASpecCausesLossCov(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BASpecCausesLossCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BASpecCausesLossCovInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BASpecCausesLossCovInternal)super.__getInternalInterface();
  }
  
  public entity.BASpecCausesLossCov clone() {
    return (entity.BASpecCausesLossCov)__getInternalInterface().cloneUntyped();
  }
  
  public entity.BASpecCausesLossCov getBasedOn() {
    return (entity.BASpecCausesLossCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BASpecCausesLossCov getSlice(java.util.Date sliceDate) {
    return (entity.BASpecCausesLossCov)getSliceUntyped(sliceDate);
  }
  
  /**
   * Gets the value of the SpecifiedCauseOfLoss field.
   * Cause of loss
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.SpecifiedCauseOfLoss getSpecifiedCauseOfLoss() {
    return (typekey.SpecifiedCauseOfLoss)__getInternalInterface().getFieldValue(SPECIFIEDCAUSEOFLOSS_PROP.get());
  }
  
  public entity.BASpecCausesLossCov getUnsliced() {
    return (entity.BASpecCausesLossCov)getUnslicedUntyped();
  }
  
  public entity.windowed.BASpecCausesLossCovVersionList getVersionList() {
    return (entity.windowed.BASpecCausesLossCovVersionList)getVersionListUntyped();
  }
  
  /**
   * Sets the value of the SpecifiedCauseOfLoss field.
   */
  public void setSpecifiedCauseOfLoss(typekey.SpecifiedCauseOfLoss value) {
    __getInternalInterface().setFieldValue(SPECIFIEDCAUSEOFLOSS_PROP.get(), value);
  }
  
  public entity.BASpecCausesLossCov split(java.util.Date splitDate) {
    return (entity.BASpecCausesLossCov)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BASpecCausesLossCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BASpecCausesLossCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BASpecCausesLossCov.class, config);
    com.guidewire._generated.entity.BASpecCausesLossCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BASpecCausesLossCov, com.guidewire._generated.entity.BASpecCausesLossCovInternal>() {
      public java.lang.Object getImplementation(entity.BASpecCausesLossCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BASpecCausesLossCovInternal getInternalInterface(entity.BASpecCausesLossCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BASpecCausesLossCov newEmptyInstance() {
        return new entity.BASpecCausesLossCov((java.lang.Void)null);
      }

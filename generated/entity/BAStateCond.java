...
/**
 * BAStateCond
 * A state-level policy condition for Commercial Auto
 */
...
@gw.entity.EntityName(value = "BAStateCond")
public class BAStateCond extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PolicyCondition, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BAStateCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BAStateCond, entity.PolicyPeriod>("entity.BAStateCond");
  ...
  private com.guidewire._generated.entity.BAStateCondInternal _internal;
   ...
   */
  protected BAStateCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected BAStateCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected BAStateCond(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BAStateCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BAStateCondInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BAStateCond clone() {
    return (entity.BAStateCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BAStateCond getBasedOn() {
    return (entity.BAStateCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.BAStateCond getBasedOnValue() {
    return (entity.BAStateCond)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.BAStateCond getFixed() {
    return (entity.BAStateCond)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.BAStateCond getSlice(java.util.Date sliceDate) {
    return (entity.BAStateCond)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.BAStateCond getSubtype() {
    return (typekey.BAStateCond)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.BAStateCond getUnsliced() {
    return (entity.BAStateCond)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BAStateCondVersionList getVersionList() {
    return (entity.windowed.BAStateCondVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.BAStateCond value) {
   ...
   */
  private void setFixed(entity.BAStateCond value) {
   ...
   */
  private void setSubtype(typekey.BAStateCond value) {
  ...
  public entity.BAStateCond split(java.util.Date splitDate) {
    return (entity.BAStateCond)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BAStateCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BAStateCond.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.BAStateCond value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.BAStateCond value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.BAStateCond value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.ba.BAStateCondConditionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.ba.BAStateCondConditionAdapter");
    config.put("gw.api.domain.PolicyConditionAdapter", "gw.lob.ba.BAStateCondConditionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.ba.BAStateCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.ba.BAStateCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BAStateCond.class, config);
    com.guidewire._generated.entity.BAStateCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BAStateCond, com.guidewire._generated.entity.BAStateCondInternal>() {
      public java.lang.Object getImplementation(entity.BAStateCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BAStateCondInternal getInternalInterface(entity.BAStateCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BAStateCond newEmptyInstance() {
        return new entity.BAStateCond((java.lang.Void)null);
      }

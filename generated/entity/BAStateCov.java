...
/**
 * BAStateCov
 * A state-level coverage for Commercial Auto
 */
...
@gw.entity.EntityName(value = "BAStateCov")
public class BAStateCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BAStateCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BAStateCov, entity.PolicyPeriod>("entity.BAStateCov");
  ...
  private com.guidewire._generated.entity.BAStateCovInternal _internal;
   ...
   */
  protected BAStateCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected BAStateCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected BAStateCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BAStateCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BAStateCovInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  public void addToCosts(entity.BAStateCovCost element) {
  ...
  public entity.BAStateCov clone() {
    return (entity.BAStateCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BAStateCov getBasedOn() {
    return (entity.BAStateCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.BAStateCov getBasedOnValue() {
    return (entity.BAStateCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.BAStateCovCost[] getCosts() {
    return (entity.BAStateCovCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.BAStateCov getFixed() {
    return (entity.BAStateCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.BAStateCov getSlice(java.util.Date sliceDate) {
    return (entity.BAStateCov)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.BAStateCov getSubtype() {
    return (typekey.BAStateCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.BAStateCov getUnsliced() {
    return (entity.BAStateCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BAStateCovVersionList getVersionList() {
    return (entity.windowed.BAStateCovVersionList)getVersionListUntyped();
  }
   ...
   */
  public void removeFromCosts(entity.BAStateCovCost element) {
   ...
   */
  private void setBasedOnValue(entity.BAStateCov value) {
   ...
   */
  public void setCosts(entity.BAStateCovCost[] value) {
   ...
   */
  private void setFixed(entity.BAStateCov value) {
   ...
   */
  private void setSubtype(typekey.BAStateCov value) {
  ...
  public entity.BAStateCov split(java.util.Date splitDate) {
    return (entity.BAStateCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BAStateCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BAStateCov.this.__getDelegateManager();
    }
     ...
     * whether or not the BooleanTerm3field was available the last time availability was checked
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public java.lang.Boolean isBooleanTerm3Avl() {
      return (java.lang.Boolean)__getInternalInterface().getFieldValue(BOOLEANTERM3AVL_PROP.get());
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.BAStateCov value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.BAStateCov value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.BAStateCov value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.ba.BAStateCovCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.ba.BAStateCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.ba.BAStateCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.ba.BAStateCovCoverageAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.ba.BAStateCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.ba.BAStateCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BAStateCov.class, config);
    com.guidewire._generated.entity.BAStateCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BAStateCov, com.guidewire._generated.entity.BAStateCovInternal>() {
      public java.lang.Object getImplementation(entity.BAStateCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BAStateCovInternal getInternalInterface(entity.BAStateCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BAStateCov newEmptyInstance() {
        return new entity.BAStateCov((java.lang.Void)null);
      }

...
/**
 * BAStateCovCost
 * The cost for a state-level coverage.
 */
...
@gw.entity.EntityName(value = "BAStateCovCost")
public class BAStateCovCost extends entity.BACost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BAStateCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BAStateCovCost, entity.PolicyPeriod>("entity.BAStateCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> BASTATECOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "BAStateCov");
   ...
   */
  public BAStateCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public BAStateCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BAStateCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BAStateCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BAStateCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BAStateCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.BAStateCovCost clone() {
    return (entity.BAStateCovCost)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BAStateCovCost getBasedOn() {
    return (entity.BAStateCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BAStateCovCost getSlice(java.util.Date sliceDate) {
    return (entity.BAStateCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.BAStateCovCost getUnsliced() {
    return (entity.BAStateCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.BAStateCovCostVersionList getVersionList() {
    return (entity.windowed.BAStateCovCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.BAStateCovCost split(java.util.Date splitDate) {
    return (entity.BAStateCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BAStateCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BAStateCovCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BAStateCovCost.class, config);
    com.guidewire._generated.entity.BAStateCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BAStateCovCost, com.guidewire._generated.entity.BAStateCovCostInternal>() {
      public java.lang.Object getImplementation(entity.BAStateCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BAStateCovCostInternal getInternalInterface(entity.BAStateCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BAStateCovCost newEmptyInstance() {
        return new entity.BAStateCovCost((java.lang.Void)null);
      }

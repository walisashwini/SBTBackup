...
/**
 * BAStateCovVehicleCost
 * The cost for a state-level coverage on a particular business vehicle.
 */
...
@gw.entity.EntityName(value = "BAStateCovVehicleCost")
public class BAStateCovVehicleCost extends entity.BAStateCovCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BAStateCovVehicleCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BAStateCovVehicleCost, entity.PolicyPeriod>("entity.BAStateCovVehicleCost");
   ...
   */
  public BAStateCovVehicleCost(entity.PolicyPeriod branch)  {
   ...
   */
  public BAStateCovVehicleCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BAStateCovVehicleCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BAStateCovVehicleCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BAStateCovVehicleCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BAStateCovVehicleCostInternal)super.__getInternalInterface();
  }
  
  public entity.BAStateCovVehicleCost clone() {
    return (entity.BAStateCovVehicleCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.BAStateCovVehicleCost getBasedOn() {
    return (entity.BAStateCovVehicleCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BAStateCovVehicleCost getSlice(java.util.Date sliceDate) {
    return (entity.BAStateCovVehicleCost)getSliceUntyped(sliceDate);
  }
  
  public entity.BAStateCovVehicleCost getUnsliced() {
    return (entity.BAStateCovVehicleCost)getUnslicedUntyped();
  }
  
  public entity.windowed.BAStateCovVehicleCostVersionList getVersionList() {
    return (entity.windowed.BAStateCovVehicleCostVersionList)getVersionListUntyped();
  }
  
  public entity.BAStateCovVehicleCost split(java.util.Date splitDate) {
    return (entity.BAStateCovVehicleCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BAStateCovVehicleCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BAStateCovVehicleCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.ba.financials.BACostMethods", "gw.lob.ba.financials.BAStateCovVehicleCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BAStateCovVehicleCost.class, config);
    com.guidewire._generated.entity.BAStateCovVehicleCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BAStateCovVehicleCost, com.guidewire._generated.entity.BAStateCovVehicleCostInternal>() {
      public java.lang.Object getImplementation(entity.BAStateCovVehicleCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BAStateCovVehicleCostInternal getInternalInterface(entity.BAStateCovVehicleCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BAStateCovVehicleCost newEmptyInstance() {
        return new entity.BAStateCovVehicleCost((java.lang.Void)null);
      }

...
/**
 * BAStateCovVehiclePIPCost
 * The cost for a state-level PIP coverage on a particular business vehicle.
 */
...
@gw.entity.EntityName(value = "BAStateCovVehiclePIPCost")
public class BAStateCovVehiclePIPCost extends entity.BAStateCovVehicleCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BAStateCovVehiclePIPCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BAStateCovVehiclePIPCost, entity.PolicyPeriod>("entity.BAStateCovVehiclePIPCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> BASTATECOVPIPCOSTTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "BAStateCovPIPCostType");
   ...
   */
  public BAStateCovVehiclePIPCost(entity.PolicyPeriod branch)  {
   ...
   */
  public BAStateCovVehiclePIPCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BAStateCovVehiclePIPCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BAStateCovVehiclePIPCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BAStateCovVehiclePIPCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BAStateCovVehiclePIPCostInternal)super.__getInternalInterface();
  }
  
  public entity.BAStateCovVehiclePIPCost clone() {
    return (entity.BAStateCovVehiclePIPCost)__getInternalInterface().cloneUntyped();
  }
  
  /**
   * Gets the value of the BAStateCovPIPCostType field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.BAStateCovPIPCostType getBAStateCovPIPCostType() {
    return (typekey.BAStateCovPIPCostType)__getInternalInterface().getFieldValue(BASTATECOVPIPCOSTTYPE_PROP.get());
  }
  
  public entity.BAStateCovVehiclePIPCost getBasedOn() {
    return (entity.BAStateCovVehiclePIPCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BAStateCovVehiclePIPCost getSlice(java.util.Date sliceDate) {
    return (entity.BAStateCovVehiclePIPCost)getSliceUntyped(sliceDate);
  }
  
  public entity.BAStateCovVehiclePIPCost getUnsliced() {
    return (entity.BAStateCovVehiclePIPCost)getUnslicedUntyped();
  }
  
  public entity.windowed.BAStateCovVehiclePIPCostVersionList getVersionList() {
    return (entity.windowed.BAStateCovVehiclePIPCostVersionList)getVersionListUntyped();
  }
  
  /**
   * Sets the value of the BAStateCovPIPCostType field.
   */
  public void setBAStateCovPIPCostType(typekey.BAStateCovPIPCostType value) {
    __getInternalInterface().setFieldValue(BASTATECOVPIPCOSTTYPE_PROP.get(), value);
  }
  
  public entity.BAStateCovVehiclePIPCost split(java.util.Date splitDate) {
    return (entity.BAStateCovVehiclePIPCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BAStateCovVehiclePIPCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BAStateCovVehiclePIPCost.this.__getDelegateManager();
    }
    ...
    public entity.BAStateCov getBAStateCov() {
      return (entity.BAStateCov)__getInternalInterface().getFieldValue(BASTATECOV_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getBAStateCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(BASTATECOV_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getBusinessVehicleID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(BUSINESSVEHICLE_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getJurisdictionID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(JURISDICTION_PROP.get());
    }
    ...
    public void setBAStateCov(entity.BAStateCov value) {
      __getInternalInterface().setFieldValue(BASTATECOV_PROP.get(), value);
    }
    
    public void setBAStateCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(BASTATECOV_PROP.get(), value);
    }
    ...
    public void setBusinessVehicleID(gw.pl.persistence.core.Key value) {
      setFieldValue(BUSINESSVEHICLE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.financials.CostAdapter", "gw.lob.ba.financials.BACostAdapter");
    config.put("gw.lob.ba.financials.BACostMethods", "gw.lob.ba.financials.BAStateCovVehiclePIPCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BAStateCovVehiclePIPCost.class, config);
    com.guidewire._generated.entity.BAStateCovVehiclePIPCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BAStateCovVehiclePIPCost, com.guidewire._generated.entity.BAStateCovVehiclePIPCostInternal>() {
      public java.lang.Object getImplementation(entity.BAStateCovVehiclePIPCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BAStateCovVehiclePIPCostInternal getInternalInterface(entity.BAStateCovVehiclePIPCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BAStateCovVehiclePIPCost newEmptyInstance() {
        return new entity.BAStateCovVehiclePIPCost((java.lang.Void)null);
      }

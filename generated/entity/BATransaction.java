...
/**
 * BATransaction
 * A transaction for the Commercial Auto line
 */
...
@gw.entity.EntityName(value = "BATransaction")
public class BATransaction extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Transaction {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BATransaction, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BATransaction, entity.PolicyPeriod>("entity.BATransaction");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> BACOST_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "BACost");
  ...
  private com.guidewire._generated.entity.BATransactionInternal _internal;
   ...
   */
  public BATransaction(entity.PolicyPeriod branch)  {
   ...
   */
  public BATransaction(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BATransaction(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BATransactionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BATransactionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BATransaction clone() {
    return (entity.BATransaction)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BACost getBACost() {
    return (entity.BACost)__getInternalInterface().getFieldValue(BACOST_PROP.get());
  }
  
  public entity.BATransaction getBasedOn() {
    return (entity.BATransaction)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BATransaction getBasedOnValue() {
    return (entity.BATransaction)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.BATransaction getFixed() {
    return (entity.BATransaction)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.BATransaction getSlice(java.util.Date sliceDate) {
    return (entity.BATransaction)getSliceUntyped(sliceDate);
  }
  ...
  public entity.BATransaction getUnsliced() {
    return (entity.BATransaction)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BATransactionVersionList getVersionList() {
    return (entity.windowed.BATransactionVersionList)getVersionListUntyped();
  }
  ...
  public void setBACost(entity.BACost value) {
    __getInternalInterface().setFieldValue(BACOST_PROP.get(), value);
  }
  
  /**
   * Sets the value of the BasedOnValue field.
   */
  private void setBasedOnValue(entity.BATransaction value) {
   ...
   */
  private void setFixed(entity.BATransaction value) {
  ...
  public entity.BATransaction split(java.util.Date splitDate) {
    return (entity.BATransaction)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BATransactionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BATransaction.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getBACostID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(BACOST_PROP.get());
    }
    ...
    public void setBACostID(gw.pl.persistence.core.Key value) {
      setFieldValue(BACOST_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.financials.TransactionAdapter", "gw.lob.ba.financials.BATransactionAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BATransaction.class, config);
    com.guidewire._generated.entity.BATransactionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BATransaction, com.guidewire._generated.entity.BATransactionInternal>() {
      public java.lang.Object getImplementation(entity.BATransaction bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BATransactionInternal getInternalInterface(entity.BATransaction bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BATransaction newEmptyInstance() {
        return new entity.BATransaction((java.lang.Void)null);
      }

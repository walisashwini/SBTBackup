...
/**
 * BAVhcleAddlInterest
 * An additional interest on a businsess auto vehicle
 */
...
@gw.entity.EntityName(value = "BAVhcleAddlInterest")
public class BAVhcleAddlInterest extends entity.AddlInterestDetail implements gw.api.copier.EffDatedCopyable, gw.api.domain.account.Mergeable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BAVhcleAddlInterest, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BAVhcleAddlInterest, entity.PolicyPeriod>("entity.BAVhcleAddlInterest");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> BAVEHICLE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "BAVehicle");
   ...
   */
  public BAVhcleAddlInterest(entity.PolicyPeriod branch)  {
   ...
   */
  public BAVhcleAddlInterest(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BAVhcleAddlInterest(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BAVhcleAddlInterestInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BAVhcleAddlInterestInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BAVhcleAddlInterestInternal)super.__getInternalInterface();
  }
  
  public entity.BAVhcleAddlInterest clone() {
    return (entity.BAVhcleAddlInterest)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BusinessVehicle getBAVehicle() {
    return (entity.BusinessVehicle)__getInternalInterface().getFieldValue(BAVEHICLE_PROP.get());
  }
  
  public entity.BAVhcleAddlInterest getBasedOn() {
    return (entity.BAVhcleAddlInterest)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BAVhcleAddlInterest getSlice(java.util.Date sliceDate) {
    return (entity.BAVhcleAddlInterest)getSliceUntyped(sliceDate);
  }
  
  public entity.BAVhcleAddlInterest getUnsliced() {
    return (entity.BAVhcleAddlInterest)getUnslicedUntyped();
  }
  
  public entity.windowed.BAVhcleAddlInterestVersionList getVersionList() {
    return (entity.windowed.BAVhcleAddlInterestVersionList)getVersionListUntyped();
  }
  ...
  public void setBAVehicle(entity.BusinessVehicle value) {
    __getInternalInterface().setFieldValue(BAVEHICLE_PROP.get(), value);
  }
  
  public entity.BAVhcleAddlInterest split(java.util.Date splitDate) {
    return (entity.BAVhcleAddlInterest)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BAVhcleAddlInterestInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BAVhcleAddlInterest.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getBAVehicleID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(BAVEHICLE_PROP.get());
    }
    ...
    public void setBAVehicleID(gw.pl.persistence.core.Key value) {
      setFieldValue(BAVEHICLE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.account.Mergeable", "gw.lob.ba.BAVhcleAddlInterestMergeableImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.ba.BAVhcleAddlInterestMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.ba.BAVhcleAddlInterestMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BAVhcleAddlInterest.class, config);
    com.guidewire._generated.entity.BAVhcleAddlInterestInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BAVhcleAddlInterest, com.guidewire._generated.entity.BAVhcleAddlInterestInternal>() {
      public java.lang.Object getImplementation(entity.BAVhcleAddlInterest bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BAVhcleAddlInterestInternal getInternalInterface(entity.BAVhcleAddlInterest bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BAVhcleAddlInterest newEmptyInstance() {
        return new entity.BAVhcleAddlInterest((java.lang.Void)null);
      }

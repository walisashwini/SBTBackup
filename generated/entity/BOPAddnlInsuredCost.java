...
/**
 * BOPAddnlInsuredCost
 * A taxable unit of price for a period of time, not to be broken up any further, for a Business Owners additional insured
 */
...
@gw.entity.EntityName(value = "BOPAddnlInsuredCost")
public class BOPAddnlInsuredCost extends entity.BOPGeneralPremium implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BOPAddnlInsuredCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BOPAddnlInsuredCost, entity.PolicyPeriod>("entity.BOPAddnlInsuredCost");
   ...
   */
  public BOPAddnlInsuredCost(entity.PolicyPeriod branch)  {
   ...
   */
  public BOPAddnlInsuredCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BOPAddnlInsuredCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BOPAddnlInsuredCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BOPAddnlInsuredCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BOPAddnlInsuredCostInternal)super.__getInternalInterface();
  }
  
  public entity.BOPAddnlInsuredCost clone() {
    return (entity.BOPAddnlInsuredCost)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BOPAddnlInsuredCost getBasedOn() {
    return (entity.BOPAddnlInsuredCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BOPAddnlInsuredCost getSlice(java.util.Date sliceDate) {
    return (entity.BOPAddnlInsuredCost)getSliceUntyped(sliceDate);
  }
  
  public entity.BOPAddnlInsuredCost getUnsliced() {
    return (entity.BOPAddnlInsuredCost)getUnslicedUntyped();
  }
  
  public entity.windowed.BOPAddnlInsuredCostVersionList getVersionList() {
    return (entity.windowed.BOPAddnlInsuredCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.BOPAddnlInsuredCost split(java.util.Date splitDate) {
    return (entity.BOPAddnlInsuredCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BOPAddnlInsuredCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BOPAddnlInsuredCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.bop.financials.BOPCostMethods", "gw.lob.bop.financials.BOPAddnlInsuredCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BOPAddnlInsuredCost.class, config);
    com.guidewire._generated.entity.BOPAddnlInsuredCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BOPAddnlInsuredCost, com.guidewire._generated.entity.BOPAddnlInsuredCostInternal>() {
      public java.lang.Object getImplementation(entity.BOPAddnlInsuredCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPAddnlInsuredCostInternal getInternalInterface(entity.BOPAddnlInsuredCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BOPAddnlInsuredCost newEmptyInstance() {
        return new entity.BOPAddnlInsuredCost((java.lang.Void)null);
      }

...
/**
 * BOPBldgAddlInterest
 * An additional interest on a building
 */
...
@gw.entity.EntityName(value = "BOPBldgAddlInterest")
public class BOPBldgAddlInterest extends entity.AddlInterestDetail implements gw.api.copier.EffDatedCopyable, gw.api.domain.account.Mergeable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BOPBldgAddlInterest, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BOPBldgAddlInterest, entity.PolicyPeriod>("entity.BOPBldgAddlInterest");
   ...
   */
  public BOPBldgAddlInterest(entity.PolicyPeriod branch)  {
   ...
   */
  public BOPBldgAddlInterest(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BOPBldgAddlInterest(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BOPBldgAddlInterestInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BOPBldgAddlInterestInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BOPBldgAddlInterestInternal)super.__getInternalInterface();
  }
  
  public entity.BOPBldgAddlInterest clone() {
    return (entity.BOPBldgAddlInterest)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BOPBldgAddlInterest getBasedOn() {
    return (entity.BOPBldgAddlInterest)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BOPBldgAddlInterest getSlice(java.util.Date sliceDate) {
    return (entity.BOPBldgAddlInterest)getSliceUntyped(sliceDate);
  }
  
  public entity.BOPBldgAddlInterest getUnsliced() {
    return (entity.BOPBldgAddlInterest)getUnslicedUntyped();
  }
  
  public entity.windowed.BOPBldgAddlInterestVersionList getVersionList() {
    return (entity.windowed.BOPBldgAddlInterestVersionList)getVersionListUntyped();
  }
  ...
  public entity.BOPBldgAddlInterest split(java.util.Date splitDate) {
    return (entity.BOPBldgAddlInterest)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BOPBldgAddlInterestInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BOPBldgAddlInterest.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.account.Mergeable", "gw.lob.bop.BOPBldgAddlInterestMergeableImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.bop.BOPBldgAddlInterestMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.bop.BOPBldgAddlInterestMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BOPBldgAddlInterest.class, config);
    com.guidewire._generated.entity.BOPBldgAddlInterestInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BOPBldgAddlInterest, com.guidewire._generated.entity.BOPBldgAddlInterestInternal>() {
      public java.lang.Object getImplementation(entity.BOPBldgAddlInterest bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPBldgAddlInterestInternal getInternalInterface(entity.BOPBldgAddlInterest bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BOPBldgAddlInterest newEmptyInstance() {
        return new entity.BOPBldgAddlInterest((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "BOPBuilding")
public class BOPBuilding extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverable, gw.api.contact.AdditionalInterestContainer, gw.api.copier.EffDatedCopyable, gw.api.domain.LineSpecificBuilding, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BOPBuilding, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BOPBuilding, entity.PolicyPeriod>("entity.BOPBuilding");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> BOPLOCATION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "BOPLocation");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> NUMDIVING_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "NumDiving");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> NUMPOOLS_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "NumPools");
  ...
  private com.guidewire._generated.entity.BOPBuildingInternal _internal;
   ...
   */
  public BOPBuilding(entity.PolicyPeriod branch)  {
   ...
   */
  public BOPBuilding(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BOPBuilding(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BOPBuildingInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BOPBuildingInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BOPBuilding clone() {
    return (entity.BOPBuilding)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BOPBldgAddlInterest[] getAdditionalInterests() {
    return (entity.BOPBldgAddlInterest[])__getInternalInterface().getFieldValue(ADDITIONALINTERESTS_PROP.get());
  }
  ...
  public entity.BOPLocation getBOPLocation() {
    return (entity.BOPLocation)__getInternalInterface().getFieldValue(BOPLOCATION_PROP.get());
  }
  
  public entity.BOPBuilding getBasedOn() {
    return (entity.BOPBuilding)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BOPBuilding getBasedOnValue() {
    return (entity.BOPBuilding)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.BOPClassCode getClassCode() {
    return (entity.BOPClassCode)__getInternalInterface().getFieldValue(CLASSCODE_PROP.get());
  }
  ...
  public typekey.BOPConstructionType getConstructionType() {
    return (typekey.BOPConstructionType)__getInternalInterface().getFieldValue(CONSTRUCTIONTYPE_PROP.get());
  }
  ...
  public entity.BOPCovBuildingCost[] getCosts() {
    return (entity.BOPCovBuildingCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
  }
  ...
  public entity.BOPBuildingCov[] getCoverages() {
    return (entity.BOPBuildingCov[])__getInternalInterface().getFieldValue(COVERAGES_PROP.get());
  }
  ...
  public entity.BOPBuilding getFixed() {
    return (entity.BOPBuilding)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.Building getLocationBuilding() {
    return ((gw.api.domain.LineSpecificBuilding)__getDelegateManager().getImplementation("gw.api.domain.LineSpecificBuilding")).getLocationBuilding();
  }
  ...
  public typekey.DivingBoards getNumDiving() {
    return (typekey.DivingBoards)__getInternalInterface().getFieldValue(NUMDIVING_PROP.get());
  }
  ...
  public typekey.SwimmingPools getNumPools() {
    return (typekey.SwimmingPools)__getInternalInterface().getFieldValue(NUMPOOLS_PROP.get());
  }
  ...
  public entity.BOPBuilding getSlice(java.util.Date sliceDate) {
    return (entity.BOPBuilding)getSliceUntyped(sliceDate);
  }
  ...
  public entity.BOPBuilding getUnsliced() {
    return (entity.BOPBuilding)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BOPBuildingVersionList getVersionList() {
    return (entity.windowed.BOPBuildingVersionList)getVersionListUntyped();
  }
  ...
  public void setBOPLocation(entity.BOPLocation value) {
    __getInternalInterface().setFieldValue(BOPLOCATION_PROP.get(), value);
  }
  
  /**
   * Sets the value of the BasedOnValue field.
   */
  private void setBasedOnValue(entity.BOPBuilding value) {
   ...
   */
  private void setCosts(entity.BOPCovBuildingCost[] value) {
   ...
   */
  private void setFixed(entity.BOPBuilding value) {
  ...
  public void setLocationBuilding(entity.Building building) {
    ((gw.api.domain.LineSpecificBuilding)__getDelegateManager().getImplementation("gw.api.domain.LineSpecificBuilding")).setLocationBuilding(building);
  }
  ...
  public void setNumDiving(typekey.DivingBoards value) {
    __getInternalInterface().setFieldValue(NUMDIVING_PROP.get(), value);
  }
  ...
  public void setNumPools(typekey.SwimmingPools value) {
    __getInternalInterface().setFieldValue(NUMPOOLS_PROP.get(), value);
  }
  ...
  public entity.BOPBuilding split(java.util.Date splitDate) {
    return (entity.BOPBuilding)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BOPBuildingInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BOPBuilding.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getBOPLocationID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(BOPLOCATION_PROP.get());
    }
    ...
    public void setBOPLocationID(gw.pl.persistence.core.Key value) {
      setFieldValue(BOPLOCATION_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.contact.AdditionalInterestContainer", "gw.lob.bop.contact.BOPBuildingAdditionalInterestContainer");
    config.put("gw.api.copier.EffDatedCopyable", "gw.api.copier.EffDatedCopier");
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.bop.BOPBuildingCoverableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.bop.BOPBuildingCoverableAdapter");
    config.put("gw.api.domain.LineSpecificBuilding", "gw.lob.bop.BOPSpecificBuilding");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.bop.BOPBuildingMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.bop.BOPBuildingMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BOPBuilding.class, config);
    com.guidewire._generated.entity.BOPBuildingInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BOPBuilding, com.guidewire._generated.entity.BOPBuildingInternal>() {
      public java.lang.Object getImplementation(entity.BOPBuilding bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPBuildingInternal getInternalInterface(entity.BOPBuilding bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BOPBuilding newEmptyInstance() {
        return new entity.BOPBuilding((java.lang.Void)null);
      }

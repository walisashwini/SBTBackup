...
@gw.entity.EntityName(value = "BOPBuildingCovCost")
public class BOPBuildingCovCost extends entity.BOPCoveragePremium implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BOPBuildingCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BOPBuildingCovCost, entity.PolicyPeriod>("entity.BOPBuildingCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> BOPBUILDINGCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "BOPBuildingCov");
   ...
   */
  public BOPBuildingCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public BOPBuildingCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BOPBuildingCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BOPBuildingCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BOPBuildingCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BOPBuildingCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.BOPBuildingCovCost clone() {
    return (entity.BOPBuildingCovCost)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BOPBuildingCov getBOPBuildingCov() {
    return (entity.BOPBuildingCov)__getInternalInterface().getFieldValue(BOPBUILDINGCOV_PROP.get());
  }
  
  public entity.BOPBuildingCovCost getBasedOn() {
    return (entity.BOPBuildingCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BOPBuildingCovCost getSlice(java.util.Date sliceDate) {
    return (entity.BOPBuildingCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.BOPBuildingCovCost getUnsliced() {
    return (entity.BOPBuildingCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.BOPBuildingCovCostVersionList getVersionList() {
    return (entity.windowed.BOPBuildingCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setBOPBuildingCov(entity.BOPBuildingCov value) {
    __getInternalInterface().setFieldValue(BOPBUILDINGCOV_PROP.get(), value);
  }
  
  public entity.BOPBuildingCovCost split(java.util.Date splitDate) {
    return (entity.BOPBuildingCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BOPBuildingCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BOPBuildingCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getBOPBuildingCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(BOPBUILDINGCOV_PROP.get());
    }
    ...
    public void setBOPBuildingCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(BOPBUILDINGCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.bop.financials.BOPCostMethods", "gw.lob.bop.financials.BOPBuildingCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BOPBuildingCovCost.class, config);
    com.guidewire._generated.entity.BOPBuildingCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BOPBuildingCovCost, com.guidewire._generated.entity.BOPBuildingCovCostInternal>() {
      public java.lang.Object getImplementation(entity.BOPBuildingCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPBuildingCovCostInternal getInternalInterface(entity.BOPBuildingCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BOPBuildingCovCost newEmptyInstance() {
        return new entity.BOPBuildingCovCost((java.lang.Void)null);
      }

...
/**
 * BOPCededPremium
 * A BusinessOwners implementation of the RICededPremium delegate
 */
...
@gw.entity.EntityName(value = "BOPCededPremium")
public class BOPCededPremium extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.RICededPremium, entity.FrozenSetMember, gw.api.reinsurance.RICededPremiumAdapter {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.BOPCededPremium> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.BOPCededPremium>("entity.BOPCededPremium");
  ...
  private com.guidewire._generated.entity.BOPCededPremiumInternal _internal;
   ...
   */
  public BOPCededPremium(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected BOPCededPremium(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BOPCededPremiumInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BOPCededPremiumInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BOPCededPremiumHistory[] getCedingHistory() {
    return (entity.BOPCededPremiumHistory[])__getInternalInterface().getFieldValue(CEDINGHISTORY_PROP.get());
  }
  ...
  public entity.BOPCededPremiumTransaction[] getCedingTransactions() {
    return (entity.BOPCededPremiumTransaction[])__getInternalInterface().getFieldValue(CEDINGTRANSACTIONS_PROP.get());
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BOPCededPremiumInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BOPCededPremium.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.reinsurance.RICededPremiumAdapter", "gw.reinsurance.ceding.BOPCededPremiumAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BOPCededPremium.class, config);
    com.guidewire._generated.entity.BOPCededPremiumInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BOPCededPremium, com.guidewire._generated.entity.BOPCededPremiumInternal>() {
      public java.lang.Object getImplementation(entity.BOPCededPremium bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPCededPremiumInternal getInternalInterface(entity.BOPCededPremium bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BOPCededPremium newEmptyInstance() {
        return new entity.BOPCededPremium((java.lang.Void)null);
      }

...
/**
 * BOPCededPremiumHistory
 * A BusinessOwners implementation of the RICededPremiumHistory delegate
 */
...
@gw.entity.EntityName(value = "BOPCededPremiumHistory")
public class BOPCededPremiumHistory extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.RICededPremiumHistory, entity.FrozenSetMember {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.BOPCededPremiumHistory> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.BOPCededPremiumHistory>("entity.BOPCededPremiumHistory");
  ...
  private com.guidewire._generated.entity.BOPCededPremiumHistoryInternal _internal;
   ...
   */
  public BOPCededPremiumHistory(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected BOPCededPremiumHistory(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BOPCededPremiumHistoryInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BOPCededPremiumHistoryInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BOPCededPremiumHistoryInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BOPCededPremiumHistory.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BOPCededPremiumHistory.class, config);
    com.guidewire._generated.entity.BOPCededPremiumHistoryInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BOPCededPremiumHistory, com.guidewire._generated.entity.BOPCededPremiumHistoryInternal>() {
      public java.lang.Object getImplementation(entity.BOPCededPremiumHistory bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPCededPremiumHistoryInternal getInternalInterface(entity.BOPCededPremiumHistory bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BOPCededPremiumHistory newEmptyInstance() {
        return new entity.BOPCededPremiumHistory((java.lang.Void)null);
      }

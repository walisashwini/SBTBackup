...
/**
 * BOPCost
 * A BusinessOwners unit of price for a period of time, not to be broken up any further
 */
...
public abstract class BOPCost extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BOPCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BOPCost, entity.PolicyPeriod>("entity.BOPCost");
  ...
  private com.guidewire._generated.entity.BOPCostInternal _internal;
  ...
  protected BOPCost(java.lang.Void ignored)  {
    
  }
  
  protected abstract com.guidewire._generated.entity.BOPCostInternal __createInternalInterface();
  ...
  protected com.guidewire._generated.entity.BOPCostInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BOPCost clone() {
    return (entity.BOPCost)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BOPCost getBasedOn() {
    return (entity.BOPCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BOPCost getSlice(java.util.Date sliceDate) {
    return (entity.BOPCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.BOPCost getUnsliced() {
    return (entity.BOPCost)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BOPCostVersionList getVersionList() {
    return (entity.windowed.BOPCostVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.BOPCost value) {
   ...
   */
  private void setFixed(entity.BOPCost value) {
   ...
   */
  private void setSubtype(typekey.BOPCost value) {
   ...
   */
  private void setTransactions(entity.BOPTransaction[] value) {
  ...
  public entity.BOPCost split(java.util.Date splitDate) {
    return (entity.BOPCost)splitUntyped(splitDate);
  }
  ...
  static {
    com.guidewire._generated.entity.BOPCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.EntityFriendAccess<entity.BOPCost, com.guidewire._generated.entity.BOPCostInternal>() {
      public java.lang.Object getImplementation(entity.BOPCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPCostInternal getInternalInterface(entity.BOPCost bean) {
        if(bean == null) {
          return null;
        };

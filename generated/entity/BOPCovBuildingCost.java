...
/**
 * BOPCovBuildingCost
 * A taxable unit of price for a period of time, not to be broken up any further, for a Business Owners building coverage
 */
...
@gw.entity.EntityName(value = "BOPCovBuildingCost")
public class BOPCovBuildingCost extends entity.BOPCovCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BOPCovBuildingCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BOPCovBuildingCost, entity.PolicyPeriod>("entity.BOPCovBuildingCost");
   ...
   */
  public BOPCovBuildingCost(entity.PolicyPeriod branch)  {
   ...
   */
  public BOPCovBuildingCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BOPCovBuildingCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BOPCovBuildingCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BOPCovBuildingCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BOPCovBuildingCostInternal)super.__getInternalInterface();
  }
  
  public entity.BOPCovBuildingCost clone() {
    return (entity.BOPCovBuildingCost)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BOPCovBuildingCost getBasedOn() {
    return (entity.BOPCovBuildingCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BOPCovBuildingCost getSlice(java.util.Date sliceDate) {
    return (entity.BOPCovBuildingCost)getSliceUntyped(sliceDate);
  }
  
  public entity.BOPCovBuildingCost getUnsliced() {
    return (entity.BOPCovBuildingCost)getUnslicedUntyped();
  }
  
  public entity.windowed.BOPCovBuildingCostVersionList getVersionList() {
    return (entity.windowed.BOPCovBuildingCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.BOPCovBuildingCost split(java.util.Date splitDate) {
    return (entity.BOPCovBuildingCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BOPCovBuildingCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BOPCovBuildingCost.this.__getDelegateManager();
    }
    ...
    public entity.BOPCost getBasedOnValue() {
      return (entity.BOPCost)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public entity.BusinessOwnersCov getBusinessOwnersCov() {
      return (entity.BusinessOwnersCov)__getInternalInterface().getFieldValue(BUSINESSOWNERSCOV_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getBusinessOwnersCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(BUSINESSOWNERSCOV_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getBusinessOwnersLineID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(BUSINESSOWNERSLINE_PROP.get());
    }
    ...
    public entity.BOPCost getFixed() {
      return (entity.BOPCost)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public typekey.BOPCost getSubtype() {
      return (typekey.BOPCost)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
    ...
    public entity.BOPTransaction[] getTransactions() {
      return (entity.BOPTransaction[])__getInternalInterface().getFieldValue(TRANSACTIONS_PROP.get());
    }
    ...
    public void setBusinessOwnersCov(entity.BusinessOwnersCov value) {
      __getInternalInterface().setFieldValue(BUSINESSOWNERSCOV_PROP.get(), value);
    }
    
    public void setBusinessOwnersCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(BUSINESSOWNERSCOV_PROP.get(), value);
    }
    ...
    public void setBusinessOwnersLineID(gw.pl.persistence.core.Key value) {
      setFieldValue(BUSINESSOWNERSLINE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.financials.CostAdapter", "gw.lob.bop.financials.BOPCostAdapter");
    config.put("gw.lob.bop.financials.BOPCostMethods", "gw.lob.bop.financials.BOPCovBuildingCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BOPCovBuildingCost.class, config);
    com.guidewire._generated.entity.BOPCovBuildingCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BOPCovBuildingCost, com.guidewire._generated.entity.BOPCovBuildingCostInternal>() {
      public java.lang.Object getImplementation(entity.BOPCovBuildingCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPCovBuildingCostInternal getInternalInterface(entity.BOPCovBuildingCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BOPCovBuildingCost newEmptyInstance() {
        return new entity.BOPCovBuildingCost((java.lang.Void)null);
      }

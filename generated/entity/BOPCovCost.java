...
/**
 * BOPCovCost
 * A taxable unit of price for a period of time, not to be broken up any further, for a Business Owners coverage
 */
...
@gw.entity.EntityName(value = "BOPCovCost")
public class BOPCovCost extends entity.BOPCoveragePremium implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BOPCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BOPCovCost, entity.PolicyPeriod>("entity.BOPCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> BUSINESSOWNERSCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "BusinessOwnersCov");
   ...
   */
  public BOPCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public BOPCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BOPCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BOPCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BOPCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BOPCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.BOPCovCost clone() {
    return (entity.BOPCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.BOPCovCost getBasedOn() {
    return (entity.BOPCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BOPCovCost getSlice(java.util.Date sliceDate) {
    return (entity.BOPCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.BOPCovCost getUnsliced() {
    return (entity.BOPCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.BOPCovCostVersionList getVersionList() {
    return (entity.windowed.BOPCovCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.BOPCovCost split(java.util.Date splitDate) {
    return (entity.BOPCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BOPCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BOPCovCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.bop.financials.BOPCostMethods", "gw.lob.bop.financials.BOPCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BOPCovCost.class, config);
    com.guidewire._generated.entity.BOPCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BOPCovCost, com.guidewire._generated.entity.BOPCovCostInternal>() {
      public java.lang.Object getImplementation(entity.BOPCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPCovCostInternal getInternalInterface(entity.BOPCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BOPCovCost newEmptyInstance() {
        return new entity.BOPCovCost((java.lang.Void)null);
      }

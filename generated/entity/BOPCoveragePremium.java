...
@gw.entity.EntityName(value = "BOPCoveragePremium")
public class BOPCoveragePremium extends entity.BOPGeneralPremium {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BOPCoveragePremium, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BOPCoveragePremium, entity.PolicyPeriod>("entity.BOPCoveragePremium");
   ...
   */
  public BOPCoveragePremium(entity.PolicyPeriod branch)  {
   ...
   */
  public BOPCoveragePremium(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BOPCoveragePremium(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BOPCoveragePremiumInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BOPCoveragePremiumInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BOPCoveragePremiumInternal)super.__getInternalInterface();
  }
  
  public entity.BOPCoveragePremium clone() {
    return (entity.BOPCoveragePremium)__getInternalInterface().cloneUntyped();
  }
  
  public entity.BOPCoveragePremium getBasedOn() {
    return (entity.BOPCoveragePremium)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BOPCoveragePremium getSlice(java.util.Date sliceDate) {
    return (entity.BOPCoveragePremium)getSliceUntyped(sliceDate);
  }
  
  public entity.BOPCoveragePremium getUnsliced() {
    return (entity.BOPCoveragePremium)getUnslicedUntyped();
  }
  
  public entity.windowed.BOPCoveragePremiumVersionList getVersionList() {
    return (entity.windowed.BOPCoveragePremiumVersionList)getVersionListUntyped();
  }
  
  public entity.BOPCoveragePremium split(java.util.Date splitDate) {
    return (entity.BOPCoveragePremium)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BOPCoveragePremiumInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BOPCoveragePremium.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.bop.financials.BOPCostMethods", "gw.lob.bop.financials.BOPCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BOPCoveragePremium.class, config);
    com.guidewire._generated.entity.BOPCoveragePremiumInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BOPCoveragePremium, com.guidewire._generated.entity.BOPCoveragePremiumInternal>() {
      public java.lang.Object getImplementation(entity.BOPCoveragePremium bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPCoveragePremiumInternal getInternalInterface(entity.BOPCoveragePremium bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BOPCoveragePremium newEmptyInstance() {
        return new entity.BOPCoveragePremium((java.lang.Void)null);
      }

...
/**
 * BOPGeneralPremium
 * A taxable unit of price for a period of time, not to be broken up any further, for Business Owners
 */
...
@gw.entity.EntityName(value = "BOPGeneralPremium")
public class BOPGeneralPremium extends entity.BOPTaxable {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BOPGeneralPremium, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BOPGeneralPremium, entity.PolicyPeriod>("entity.BOPGeneralPremium");
   ...
   */
  public BOPGeneralPremium(entity.PolicyPeriod branch)  {
   ...
   */
  public BOPGeneralPremium(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BOPGeneralPremium(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BOPGeneralPremiumInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BOPGeneralPremiumInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BOPGeneralPremiumInternal)super.__getInternalInterface();
  }
  
  public entity.BOPGeneralPremium clone() {
    return (entity.BOPGeneralPremium)__getInternalInterface().cloneUntyped();
  }
  
  public entity.BOPGeneralPremium getBasedOn() {
    return (entity.BOPGeneralPremium)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BOPGeneralPremium getSlice(java.util.Date sliceDate) {
    return (entity.BOPGeneralPremium)getSliceUntyped(sliceDate);
  }
  
  public entity.BOPGeneralPremium getUnsliced() {
    return (entity.BOPGeneralPremium)getUnslicedUntyped();
  }
  
  public entity.windowed.BOPGeneralPremiumVersionList getVersionList() {
    return (entity.windowed.BOPGeneralPremiumVersionList)getVersionListUntyped();
  }
  
  public entity.BOPGeneralPremium split(java.util.Date splitDate) {
    return (entity.BOPGeneralPremium)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BOPGeneralPremiumInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BOPGeneralPremium.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BOPGeneralPremium.class, config);
    com.guidewire._generated.entity.BOPGeneralPremiumInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BOPGeneralPremium, com.guidewire._generated.entity.BOPGeneralPremiumInternal>() {
      public java.lang.Object getImplementation(entity.BOPGeneralPremium bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPGeneralPremiumInternal getInternalInterface(entity.BOPGeneralPremium bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BOPGeneralPremium newEmptyInstance() {
        return new entity.BOPGeneralPremium((java.lang.Void)null);
      }

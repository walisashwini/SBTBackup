...
@gw.entity.EntityName(value = "BOPLocation")
public class BOPLocation extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverable, gw.api.copier.EffDatedCopyable, gw.api.domain.LineSpecificLocation, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BOPLocation, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BOPLocation, entity.PolicyPeriod>("entity.BOPLocation");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CITYLIMITS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CityLimits");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PRINCIPALOPSDESC_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PrincipalOpsDesc");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> RISKCLASS_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "RiskClass");
  ...
  private com.guidewire._generated.entity.BOPLocationInternal _internal;
   ...
   */
  public BOPLocation(entity.PolicyPeriod branch)  {
   ...
   */
  public BOPLocation(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BOPLocation(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BOPLocationInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BOPLocationInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BOPLocation clone() {
    return (entity.BOPLocation)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BOPLocation getBasedOn() {
    return (entity.BOPLocation)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BOPLocation getBasedOnValue() {
    return (entity.BOPLocation)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.BOPBuilding[] getBuildings() {
    return (entity.BOPBuilding[])__getInternalInterface().getFieldValue(BUILDINGS_PROP.get());
  }
  ...
  public entity.BOPLocationCov[] getCoverages() {
    return (entity.BOPLocationCov[])__getInternalInterface().getFieldValue(COVERAGES_PROP.get());
  }
  ...
  public entity.BOPLocation getFixed() {
    return (entity.BOPLocation)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.BOPLocationAnswer[] getLocationAnswers() {
    return (entity.BOPLocationAnswer[])__getInternalInterface().getFieldValue(LOCATIONANSWERS_PROP.get());
  }
  ...
  public java.lang.String getPrincipalOpsDesc() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(PRINCIPALOPSDESC_PROP.get());
  }
  ...
  public entity.RiskClass getRiskClass() {
    return (entity.RiskClass)__getInternalInterface().getFieldValue(RISKCLASS_PROP.get());
  }
  
  public entity.BOPLocation getSlice(java.util.Date sliceDate) {
    return (entity.BOPLocation)getSliceUntyped(sliceDate);
  }
  ...
  public entity.BOPLocation getUnsliced() {
    return (entity.BOPLocation)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BOPLocationVersionList getVersionList() {
    return (entity.windowed.BOPLocationVersionList)getVersionListUntyped();
  }
  ...
  public java.lang.Boolean isCityLimits() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(CITYLIMITS_PROP.get());
  }
   ...
   */
  private void setBasedOnValue(entity.BOPLocation value) {
  ...
  public void setCityLimits(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(CITYLIMITS_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.BOPLocation value) {
  ...
  public void setPrincipalOpsDesc(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(PRINCIPALOPSDESC_PROP.get(), value);
  }
  ...
  public void setRiskClass(entity.RiskClass value) {
    __getInternalInterface().setFieldValue(RISKCLASS_PROP.get(), value);
  }
  ...
  public entity.BOPLocation split(java.util.Date splitDate) {
    return (entity.BOPLocation)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BOPLocationInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BOPLocation.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getRiskClassID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(RISKCLASS_PROP.get());
    }
    ...
    public void setRiskClassID(gw.pl.persistence.core.Key value) {
      setFieldValue(RISKCLASS_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.copier.EffDatedCopyable", "gw.lob.bop.BOPLocationCopier");
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.bop.BOPLocationCoverableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.bop.BOPLocationCoverableAdapter");
    config.put("gw.api.domain.LineSpecificLocation", "gw.lob.bop.BOPSpecificLocation");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.bop.BOPLocationMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.bop.BOPLocationMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BOPLocation.class, config);
    com.guidewire._generated.entity.BOPLocationInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BOPLocation, com.guidewire._generated.entity.BOPLocationInternal>() {
      public java.lang.Object getImplementation(entity.BOPLocation bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPLocationInternal getInternalInterface(entity.BOPLocation bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BOPLocation newEmptyInstance() {
        return new entity.BOPLocation((java.lang.Void)null);
      }

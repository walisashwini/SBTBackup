...
/**
 * BOPLocationAnswer
 * Links location and answer references - answers are persisted text responses to questions in the location ui. Specific to Policy Center
 */
...
@gw.entity.EntityName(value = "BOPLocationAnswer")
public class BOPLocationAnswer extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PCAnswerDelegate {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BOPLocationAnswer, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BOPLocationAnswer, entity.PolicyPeriod>("entity.BOPLocationAnswer");
  ...
  private com.guidewire._generated.entity.BOPLocationAnswerInternal _internal;
   ...
   */
  public BOPLocationAnswer(entity.PolicyPeriod branch)  {
   ...
   */
  public BOPLocationAnswer(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BOPLocationAnswer(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BOPLocationAnswerInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BOPLocationAnswerInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BOPLocationAnswer clone() {
    return (entity.BOPLocationAnswer)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BOPLocationAnswer getBasedOn() {
    return (entity.BOPLocationAnswer)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BOPLocationAnswer getBasedOnValue() {
    return (entity.BOPLocationAnswer)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.BOPLocationAnswer getFixed() {
    return (entity.BOPLocationAnswer)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.BOPLocationAnswer getSlice(java.util.Date sliceDate) {
    return (entity.BOPLocationAnswer)getSliceUntyped(sliceDate);
  }
  ...
  public entity.BOPLocationAnswer getUnsliced() {
    return (entity.BOPLocationAnswer)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BOPLocationAnswerVersionList getVersionList() {
    return (entity.windowed.BOPLocationAnswerVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.BOPLocationAnswer value) {
   ...
   */
  private void setFixed(entity.BOPLocationAnswer value) {
  ...
  public entity.BOPLocationAnswer split(java.util.Date splitDate) {
    return (entity.BOPLocationAnswer)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BOPLocationAnswerInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BOPLocationAnswer.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BOPLocationAnswer.class, config);
    com.guidewire._generated.entity.BOPLocationAnswerInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BOPLocationAnswer, com.guidewire._generated.entity.BOPLocationAnswerInternal>() {
      public java.lang.Object getImplementation(entity.BOPLocationAnswer bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPLocationAnswerInternal getInternalInterface(entity.BOPLocationAnswer bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BOPLocationAnswer newEmptyInstance() {
        return new entity.BOPLocationAnswer((java.lang.Void)null);
      }

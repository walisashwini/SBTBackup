...
/**
 * BOPLocationCov
 * A location-level coverage for Business Owners
 */
...
@gw.entity.EntityName(value = "BOPLocationCov")
public class BOPLocationCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BOPLocationCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BOPLocationCov, entity.PolicyPeriod>("entity.BOPLocationCov");
  ...
  private com.guidewire._generated.entity.BOPLocationCovInternal _internal;
   ...
   */
  protected BOPLocationCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected BOPLocationCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected BOPLocationCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BOPLocationCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BOPLocationCovInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  public void addToCosts(entity.BOPLocationCovCost element) {
  ...
  public entity.BOPLocationCov clone() {
    return (entity.BOPLocationCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BOPLocationCov getBasedOn() {
    return (entity.BOPLocationCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.BOPLocationCov getBasedOnValue() {
    return (entity.BOPLocationCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.BOPLocationCovCost[] getCosts() {
    return (entity.BOPLocationCovCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.BOPLocationCov getFixed() {
    return (entity.BOPLocationCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.BOPLocationCov getSlice(java.util.Date sliceDate) {
    return (entity.BOPLocationCov)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.BOPLocationCov getSubtype() {
    return (typekey.BOPLocationCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.BOPLocationCov getUnsliced() {
    return (entity.BOPLocationCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BOPLocationCovVersionList getVersionList() {
    return (entity.windowed.BOPLocationCovVersionList)getVersionListUntyped();
  }
   ...
   */
  public void removeFromCosts(entity.BOPLocationCovCost element) {
   ...
   */
  private void setBasedOnValue(entity.BOPLocationCov value) {
   ...
   */
  public void setCosts(entity.BOPLocationCovCost[] value) {
   ...
   */
  private void setFixed(entity.BOPLocationCov value) {
   ...
   */
  private void setSubtype(typekey.BOPLocationCov value) {
  ...
  public entity.BOPLocationCov split(java.util.Date splitDate) {
    return (entity.BOPLocationCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BOPLocationCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BOPLocationCov.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.BOPLocationCov value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.BOPLocationCov value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.BOPLocationCov value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.bop.BOPLocationCovCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.bop.BOPLocationCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.bop.BOPLocationCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.bop.BOPLocationCovCoverageAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.bop.BOPLocationCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.bop.BOPLocationCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BOPLocationCov.class, config);
    com.guidewire._generated.entity.BOPLocationCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BOPLocationCov, com.guidewire._generated.entity.BOPLocationCovInternal>() {
      public java.lang.Object getImplementation(entity.BOPLocationCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPLocationCovInternal getInternalInterface(entity.BOPLocationCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BOPLocationCov newEmptyInstance() {
        return new entity.BOPLocationCov((java.lang.Void)null);
      }

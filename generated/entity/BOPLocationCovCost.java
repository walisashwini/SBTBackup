...
/**
 * BOPLocationCovCost
 * A taxable unit of price for a period of time, not to be broken up any further, for a Business Owners location coverage
 */
...
@gw.entity.EntityName(value = "BOPLocationCovCost")
public class BOPLocationCovCost extends entity.BOPCoveragePremium implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BOPLocationCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BOPLocationCovCost, entity.PolicyPeriod>("entity.BOPLocationCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> BOPLOCATIONCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "BOPLocationCov");
   ...
   */
  public BOPLocationCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public BOPLocationCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BOPLocationCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BOPLocationCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BOPLocationCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BOPLocationCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.BOPLocationCovCost clone() {
    return (entity.BOPLocationCovCost)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BOPLocationCovCost getBasedOn() {
    return (entity.BOPLocationCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BOPLocationCovCost getSlice(java.util.Date sliceDate) {
    return (entity.BOPLocationCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.BOPLocationCovCost getUnsliced() {
    return (entity.BOPLocationCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.BOPLocationCovCostVersionList getVersionList() {
    return (entity.windowed.BOPLocationCovCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.BOPLocationCovCost split(java.util.Date splitDate) {
    return (entity.BOPLocationCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BOPLocationCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BOPLocationCovCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BOPLocationCovCost.class, config);
    com.guidewire._generated.entity.BOPLocationCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BOPLocationCovCost, com.guidewire._generated.entity.BOPLocationCovCostInternal>() {
      public java.lang.Object getImplementation(entity.BOPLocationCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPLocationCovCostInternal getInternalInterface(entity.BOPLocationCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BOPLocationCovCost newEmptyInstance() {
        return new entity.BOPLocationCovCost((java.lang.Void)null);
      }

...
/**
 * BOPMinPremiumCost
 * The minimum premium adjustment cost for the Business Owners line
 */
...
@gw.entity.EntityName(value = "BOPMinPremiumCost")
public class BOPMinPremiumCost extends entity.BOPTaxable implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BOPMinPremiumCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BOPMinPremiumCost, entity.PolicyPeriod>("entity.BOPMinPremiumCost");
   ...
   */
  public BOPMinPremiumCost(entity.PolicyPeriod branch)  {
   ...
   */
  public BOPMinPremiumCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BOPMinPremiumCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BOPMinPremiumCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BOPMinPremiumCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BOPMinPremiumCostInternal)super.__getInternalInterface();
  }
  
  public entity.BOPMinPremiumCost clone() {
    return (entity.BOPMinPremiumCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.BOPMinPremiumCost getBasedOn() {
    return (entity.BOPMinPremiumCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BOPMinPremiumCost getSlice(java.util.Date sliceDate) {
    return (entity.BOPMinPremiumCost)getSliceUntyped(sliceDate);
  }
  
  public entity.BOPMinPremiumCost getUnsliced() {
    return (entity.BOPMinPremiumCost)getUnslicedUntyped();
  }
  
  public entity.windowed.BOPMinPremiumCostVersionList getVersionList() {
    return (entity.windowed.BOPMinPremiumCostVersionList)getVersionListUntyped();
  }
  
  public entity.BOPMinPremiumCost split(java.util.Date splitDate) {
    return (entity.BOPMinPremiumCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BOPMinPremiumCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BOPMinPremiumCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.bop.financials.BOPCostMethods", "gw.lob.bop.financials.BOPMinPremiumCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BOPMinPremiumCost.class, config);
    com.guidewire._generated.entity.BOPMinPremiumCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BOPMinPremiumCost, com.guidewire._generated.entity.BOPMinPremiumCostInternal>() {
      public java.lang.Object getImplementation(entity.BOPMinPremiumCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPMinPremiumCostInternal getInternalInterface(entity.BOPMinPremiumCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BOPMinPremiumCost newEmptyInstance() {
        return new entity.BOPMinPremiumCost((java.lang.Void)null);
      }

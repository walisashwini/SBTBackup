...
/**
 * BOPModifier
 * A line-level modifier for Business Owners
 */
...
@gw.entity.EntityName(value = "BOPModifier")
public class BOPModifier extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Modifier, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BOPModifier, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BOPModifier, entity.PolicyPeriod>("entity.BOPModifier");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> BOPRATEFACTORS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "BOPRateFactors");
  ...
  private com.guidewire._generated.entity.BOPModifierInternal _internal;
   ...
   */
  public BOPModifier(entity.PolicyPeriod branch)  {
   ...
   */
  public BOPModifier(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BOPModifier(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BOPModifierInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BOPModifierInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToBOPRateFactors(entity.BOPRateFactor element) {
    __getInternalInterface().addArrayElement(BOPRATEFACTORS_PROP.get(), element);
  }
  ...
  public entity.BOPModifier clone() {
    return (entity.BOPModifier)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BOPRateFactor[] getBOPRateFactors() {
    return (entity.BOPRateFactor[])__getInternalInterface().getFieldValue(BOPRATEFACTORS_PROP.get());
  }
  
  public entity.BOPModifier getBasedOn() {
    return (entity.BOPModifier)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BOPModifier getBasedOnValue() {
    return (entity.BOPModifier)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.BOPModifier getFixed() {
    return (entity.BOPModifier)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.BOPModifier getSlice(java.util.Date sliceDate) {
    return (entity.BOPModifier)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.BOPModifier getSubtype() {
    return (typekey.BOPModifier)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.BOPModifier getUnsliced() {
    return (entity.BOPModifier)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BOPModifierVersionList getVersionList() {
    return (entity.windowed.BOPModifierVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromBOPRateFactors(entity.BOPRateFactor element) {
    __getInternalInterface().removeArrayElement(BOPRATEFACTORS_PROP.get(), element);
  }
  ...
  public void removeFromBOPRateFactors(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(BOPRATEFACTORS_PROP.get(), elementID);
  }
  ...
  public void setBOPRateFactors(entity.BOPRateFactor[] value) {
    __getInternalInterface().setFieldValue(BOPRATEFACTORS_PROP.get(), value);
  }
  
  /**
   * Sets the value of the BasedOnValue field.
   */
  private void setBasedOnValue(entity.BOPModifier value) {
   ...
   */
  private void setFixed(entity.BOPModifier value) {
   ...
   */
  private void setSubtype(typekey.BOPModifier value) {
  ...
  public entity.BOPModifier split(java.util.Date splitDate) {
    return (entity.BOPModifier)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BOPModifierInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BOPModifier.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ModifierAbstractDomainMethods", "gw.lob.bop.BOPModifierAdapter");
    config.put("gw.api.domain.ModifierAdapter", "gw.lob.bop.BOPModifierAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.bop.BOPModifierMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.bop.BOPModifierMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BOPModifier.class, config);
    com.guidewire._generated.entity.BOPModifierInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BOPModifier, com.guidewire._generated.entity.BOPModifierInternal>() {
      public java.lang.Object getImplementation(entity.BOPModifier bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPModifierInternal getInternalInterface(entity.BOPModifier bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BOPModifier newEmptyInstance() {
        return new entity.BOPModifier((java.lang.Void)null);
      }

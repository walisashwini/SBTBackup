...
/**
 * BOPMoneySecCovCost
 * A unit of price for a period of time, not to be broken up any further, for Business Owners money and securities coverage
 */
...
@gw.entity.EntityName(value = "BOPMoneySecCovCost")
public class BOPMoneySecCovCost extends entity.BOPLocationCovCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BOPMoneySecCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BOPMoneySecCovCost, entity.PolicyPeriod>("entity.BOPMoneySecCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ONPREMISES_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "OnPremises");
   ...
   */
  public BOPMoneySecCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public BOPMoneySecCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BOPMoneySecCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BOPMoneySecCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BOPMoneySecCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BOPMoneySecCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.BOPMoneySecCovCost clone() {
    return (entity.BOPMoneySecCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.BOPMoneySecCovCost getBasedOn() {
    return (entity.BOPMoneySecCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BOPMoneySecCovCost getSlice(java.util.Date sliceDate) {
    return (entity.BOPMoneySecCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.BOPMoneySecCovCost getUnsliced() {
    return (entity.BOPMoneySecCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.BOPMoneySecCovCostVersionList getVersionList() {
    return (entity.windowed.BOPMoneySecCovCostVersionList)getVersionListUntyped();
  }
  ...
  public java.lang.Boolean isOnPremises() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(ONPREMISES_PROP.get());
  }
  ...
  public void setOnPremises(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(ONPREMISES_PROP.get(), value);
  }
  
  public entity.BOPMoneySecCovCost split(java.util.Date splitDate) {
    return (entity.BOPMoneySecCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BOPMoneySecCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BOPMoneySecCovCost.this.__getDelegateManager();
    }
    ...
    public entity.BOPLocationCov getBOPLocationCov() {
      return (entity.BOPLocationCov)__getInternalInterface().getFieldValue(BOPLOCATIONCOV_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getBOPLocationCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(BOPLOCATIONCOV_PROP.get());
    }
    ...
    public void setBOPLocationCov(entity.BOPLocationCov value) {
      __getInternalInterface().setFieldValue(BOPLOCATIONCOV_PROP.get(), value);
    }
    
    public void setBOPLocationCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(BOPLOCATIONCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.bop.financials.BOPCostMethods", "gw.lob.bop.financials.BOPLocationCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BOPMoneySecCovCost.class, config);
    com.guidewire._generated.entity.BOPMoneySecCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BOPMoneySecCovCost, com.guidewire._generated.entity.BOPMoneySecCovCostInternal>() {
      public java.lang.Object getImplementation(entity.BOPMoneySecCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPMoneySecCovCostInternal getInternalInterface(entity.BOPMoneySecCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BOPMoneySecCovCost newEmptyInstance() {
        return new entity.BOPMoneySecCovCost((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "BOPRateFactor")
public class BOPRateFactor extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.RateFactor, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BOPRateFactor, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BOPRateFactor, entity.PolicyPeriod>("entity.BOPRateFactor");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> BOPMODIFIER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "BOPModifier");
  ...
  private com.guidewire._generated.entity.BOPRateFactorInternal _internal;
   ...
   */
  public BOPRateFactor(entity.PolicyPeriod branch)  {
   ...
   */
  public BOPRateFactor(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BOPRateFactor(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BOPRateFactorInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BOPRateFactorInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BOPRateFactor clone() {
    return (entity.BOPRateFactor)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BOPModifier getBOPModifier() {
    return (entity.BOPModifier)__getInternalInterface().getFieldValue(BOPMODIFIER_PROP.get());
  }
  
  public entity.BOPRateFactor getBasedOn() {
    return (entity.BOPRateFactor)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BOPRateFactor getBasedOnValue() {
    return (entity.BOPRateFactor)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.BOPRateFactor getFixed() {
    return (entity.BOPRateFactor)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.BOPRateFactor getSlice(java.util.Date sliceDate) {
    return (entity.BOPRateFactor)getSliceUntyped(sliceDate);
  }
  ...
  public entity.BOPRateFactor getUnsliced() {
    return (entity.BOPRateFactor)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BOPRateFactorVersionList getVersionList() {
    return (entity.windowed.BOPRateFactorVersionList)getVersionListUntyped();
  }
  ...
  public void setBOPModifier(entity.BOPModifier value) {
    __getInternalInterface().setFieldValue(BOPMODIFIER_PROP.get(), value);
  }
  
  /**
   * Sets the value of the BasedOnValue field.
   */
  private void setBasedOnValue(entity.BOPRateFactor value) {
   ...
   */
  private void setFixed(entity.BOPRateFactor value) {
  ...
  public entity.BOPRateFactor split(java.util.Date splitDate) {
    return (entity.BOPRateFactor)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BOPRateFactorInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BOPRateFactor.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getBOPModifierID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(BOPMODIFIER_PROP.get());
    }
    ...
    public void setBOPModifierID(gw.pl.persistence.core.Key value) {
      setFieldValue(BOPMODIFIER_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.RateFactorAdapter", "gw.lob.bop.BOPRateFactorAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.bop.BOPRateFactorMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.bop.BOPRateFactorMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BOPRateFactor.class, config);
    com.guidewire._generated.entity.BOPRateFactorInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BOPRateFactor, com.guidewire._generated.entity.BOPRateFactorInternal>() {
      public java.lang.Object getImplementation(entity.BOPRateFactor bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPRateFactorInternal getInternalInterface(entity.BOPRateFactor bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BOPRateFactor newEmptyInstance() {
        return new entity.BOPRateFactor((java.lang.Void)null);
      }

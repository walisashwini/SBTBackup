...
@gw.entity.EntityName(value = "BOPScheduledEquipment")
public class BOPScheduledEquipment extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BOPScheduledEquipment, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BOPScheduledEquipment, entity.PolicyPeriod>("entity.BOPScheduledEquipment");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> EQUIPMENTNUMBER_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "EquipmentNumber");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> EQUIPMENTVALUE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "EquipmentValue");
  ...
  private com.guidewire._generated.entity.BOPScheduledEquipmentInternal _internal;
   ...
   */
  public BOPScheduledEquipment(entity.PolicyPeriod branch)  {
   ...
   */
  public BOPScheduledEquipment(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BOPScheduledEquipment(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BOPScheduledEquipmentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BOPScheduledEquipmentInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BOPScheduledEquipment clone() {
    return (entity.BOPScheduledEquipment)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BOPScheduledEquipment getBasedOn() {
    return (entity.BOPScheduledEquipment)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BOPScheduledEquipment getBasedOnValue() {
    return (entity.BOPScheduledEquipment)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public java.lang.Integer getEquipmentNumber() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(EQUIPMENTNUMBER_PROP.get());
  }
  ...
  public java.lang.Integer getEquipmentValue() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(EQUIPMENTVALUE_PROP.get());
  }
  ...
  public entity.BOPScheduledEquipment getFixed() {
    return (entity.BOPScheduledEquipment)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.BOPScheduledEquipment getSlice(java.util.Date sliceDate) {
    return (entity.BOPScheduledEquipment)getSliceUntyped(sliceDate);
  }
  ...
  public entity.BOPScheduledEquipment getUnsliced() {
    return (entity.BOPScheduledEquipment)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BOPScheduledEquipmentVersionList getVersionList() {
    return (entity.windowed.BOPScheduledEquipmentVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.BOPScheduledEquipment value) {
  ...
  public void setEquipmentNumber(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(EQUIPMENTNUMBER_PROP.get(), value);
  }
  ...
  public void setEquipmentValue(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(EQUIPMENTVALUE_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.BOPScheduledEquipment value) {
  ...
  public entity.BOPScheduledEquipment split(java.util.Date splitDate) {
    return (entity.BOPScheduledEquipment)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BOPScheduledEquipmentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BOPScheduledEquipment.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BOPScheduledEquipment.class, config);
    com.guidewire._generated.entity.BOPScheduledEquipmentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BOPScheduledEquipment, com.guidewire._generated.entity.BOPScheduledEquipmentInternal>() {
      public java.lang.Object getImplementation(entity.BOPScheduledEquipment bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPScheduledEquipmentInternal getInternalInterface(entity.BOPScheduledEquipment bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BOPScheduledEquipment newEmptyInstance() {
        return new entity.BOPScheduledEquipment((java.lang.Void)null);
      }

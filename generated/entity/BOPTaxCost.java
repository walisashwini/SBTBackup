...
/**
 * BOPTaxCost
 * State tax costs for Business Owners
 */
...
@gw.entity.EntityName(value = "BOPTaxCost")
public class BOPTaxCost extends entity.BOPCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BOPTaxCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BOPTaxCost, entity.PolicyPeriod>("entity.BOPTaxCost");
   ...
   */
  public BOPTaxCost(entity.PolicyPeriod branch)  {
   ...
   */
  public BOPTaxCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BOPTaxCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BOPTaxCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BOPTaxCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BOPTaxCostInternal)super.__getInternalInterface();
  }
  
  public entity.BOPTaxCost clone() {
    return (entity.BOPTaxCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.BOPTaxCost getBasedOn() {
    return (entity.BOPTaxCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BOPTaxCost getSlice(java.util.Date sliceDate) {
    return (entity.BOPTaxCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.BOPTaxCost getUnsliced() {
    return (entity.BOPTaxCost)getUnslicedUntyped();
  }
  
  public entity.windowed.BOPTaxCostVersionList getVersionList() {
    return (entity.windowed.BOPTaxCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.BOPTaxCost split(java.util.Date splitDate) {
    return (entity.BOPTaxCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BOPTaxCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BOPTaxCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.bop.financials.BOPCostMethods", "gw.lob.bop.financials.BOPTaxCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BOPTaxCost.class, config);
    com.guidewire._generated.entity.BOPTaxCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BOPTaxCost, com.guidewire._generated.entity.BOPTaxCostInternal>() {
      public java.lang.Object getImplementation(entity.BOPTaxCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPTaxCostInternal getInternalInterface(entity.BOPTaxCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BOPTaxCost newEmptyInstance() {
        return new entity.BOPTaxCost((java.lang.Void)null);
      }

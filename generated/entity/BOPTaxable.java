...
@gw.entity.EntityName(value = "BOPTaxable")
public class BOPTaxable extends entity.BOPCost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BOPTaxable, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BOPTaxable, entity.PolicyPeriod>("entity.BOPTaxable");
   ...
   */
  public BOPTaxable(entity.PolicyPeriod branch)  {
   ...
   */
  public BOPTaxable(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BOPTaxable(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BOPTaxableInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BOPTaxableInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BOPTaxableInternal)super.__getInternalInterface();
  }
  
  public entity.BOPTaxable clone() {
    return (entity.BOPTaxable)__getInternalInterface().cloneUntyped();
  }
  
  public entity.BOPTaxable getBasedOn() {
    return (entity.BOPTaxable)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BOPTaxable getSlice(java.util.Date sliceDate) {
    return (entity.BOPTaxable)getSliceUntyped(sliceDate);
  }
  
  public entity.BOPTaxable getUnsliced() {
    return (entity.BOPTaxable)getUnslicedUntyped();
  }
  
  public entity.windowed.BOPTaxableVersionList getVersionList() {
    return (entity.windowed.BOPTaxableVersionList)getVersionListUntyped();
  }
  
  public entity.BOPTaxable split(java.util.Date splitDate) {
    return (entity.BOPTaxable)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BOPTaxableInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BOPTaxable.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BOPTaxable.class, config);
    com.guidewire._generated.entity.BOPTaxableInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BOPTaxable, com.guidewire._generated.entity.BOPTaxableInternal>() {
      public java.lang.Object getImplementation(entity.BOPTaxable bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPTaxableInternal getInternalInterface(entity.BOPTaxable bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BOPTaxable newEmptyInstance() {
        return new entity.BOPTaxable((java.lang.Void)null);
      }

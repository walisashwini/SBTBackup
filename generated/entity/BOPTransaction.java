...
/**
 * BOPTransaction
 * A transaction for the Business Owners line
 */
...
@gw.entity.EntityName(value = "BOPTransaction")
public class BOPTransaction extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Transaction {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BOPTransaction, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BOPTransaction, entity.PolicyPeriod>("entity.BOPTransaction");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> BOPCOST_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "BOPCost");
  ...
  private com.guidewire._generated.entity.BOPTransactionInternal _internal;
   ...
   */
  public BOPTransaction(entity.PolicyPeriod branch)  {
   ...
   */
  public BOPTransaction(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BOPTransaction(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BOPTransactionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BOPTransactionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BOPTransaction clone() {
    return (entity.BOPTransaction)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BOPCost getBOPCost() {
    return (entity.BOPCost)__getInternalInterface().getFieldValue(BOPCOST_PROP.get());
  }
  
  public entity.BOPTransaction getBasedOn() {
    return (entity.BOPTransaction)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BOPTransaction getBasedOnValue() {
    return (entity.BOPTransaction)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.BOPTransaction getFixed() {
    return (entity.BOPTransaction)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.BOPTransaction getSlice(java.util.Date sliceDate) {
    return (entity.BOPTransaction)getSliceUntyped(sliceDate);
  }
  ...
  public entity.BOPTransaction getUnsliced() {
    return (entity.BOPTransaction)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BOPTransactionVersionList getVersionList() {
    return (entity.windowed.BOPTransactionVersionList)getVersionListUntyped();
  }
  ...
  public void setBOPCost(entity.BOPCost value) {
    __getInternalInterface().setFieldValue(BOPCOST_PROP.get(), value);
  }
  
  /**
   * Sets the value of the BasedOnValue field.
   */
  private void setBasedOnValue(entity.BOPTransaction value) {
   ...
   */
  private void setFixed(entity.BOPTransaction value) {
  ...
  public entity.BOPTransaction split(java.util.Date splitDate) {
    return (entity.BOPTransaction)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BOPTransactionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BOPTransaction.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getBOPCostID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(BOPCOST_PROP.get());
    }
    ...
    public void setBOPCostID(gw.pl.persistence.core.Key value) {
      setFieldValue(BOPCOST_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.financials.TransactionAdapter", "gw.lob.bop.financials.BOPTransactionAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BOPTransaction.class, config);
    com.guidewire._generated.entity.BOPTransactionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BOPTransaction, com.guidewire._generated.entity.BOPTransactionInternal>() {
      public java.lang.Object getImplementation(entity.BOPTransaction bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BOPTransactionInternal getInternalInterface(entity.BOPTransaction bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BOPTransaction newEmptyInstance() {
        return new entity.BOPTransaction((java.lang.Void)null);
      }

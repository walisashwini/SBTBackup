...
/**
 * BaseQuotingWorkItem
 * WorkItem to asynchronously quote or rate PolicyPeriod
 */
...
@gw.entity.EntityName(value = "BaseQuotingWorkItem")
public class BaseQuotingWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.KeyableBean, entity.WorkItem, entity.Extractable, entity.FrozenSetMember {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.BaseQuotingWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.BaseQuotingWorkItem>("entity.BaseQuotingWorkItem");
  ...
  private com.guidewire._generated.entity.BaseQuotingWorkItemInternal _internal;
   ...
   */
  public BaseQuotingWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected BaseQuotingWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BaseQuotingWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BaseQuotingWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setSubtype(typekey.BaseQuotingWorkItem value) {
    __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BaseQuotingWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BaseQuotingWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BaseQuotingWorkItem.class, config);
    com.guidewire._generated.entity.BaseQuotingWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BaseQuotingWorkItem, com.guidewire._generated.entity.BaseQuotingWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.BaseQuotingWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BaseQuotingWorkItemInternal getInternalInterface(entity.BaseQuotingWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BaseQuotingWorkItem newEmptyInstance() {
        return new entity.BaseQuotingWorkItem((java.lang.Void)null);
      }

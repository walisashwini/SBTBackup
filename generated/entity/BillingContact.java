 ...
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "BillingContact.eti;BillingContact.eix;BillingContact.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "BillingContact")
public class BillingContact extends entity.AccountContactRole implements entity.Extractable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.BillingContact> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.BillingContact>("entity.BillingContact");
   ...
   */
  public BillingContact(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected BillingContact(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BillingContactInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BillingContactInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BillingContactInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BillingContactInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BillingContact.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BillingContact.class, config);
    com.guidewire._generated.entity.BillingContactInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BillingContact, com.guidewire._generated.entity.BillingContactInternal>() {
      public java.lang.Object getImplementation(entity.BillingContact bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BillingContactInternal getInternalInterface(entity.BillingContact bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BillingContact newEmptyInstance() {
        return new entity.BillingContact((java.lang.Void)null);
      }

...
/**
 * BuildingImprovement
 * Building improvements by type (e.g. electrical, plumbing, etc.) and year of improvement.
 */
...
@gw.entity.EntityName(value = "BuildingImprovement")
public class BuildingImprovement extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BuildingImprovement, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BuildingImprovement, entity.PolicyPeriod>("entity.BuildingImprovement");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> BUILDINGIMPRTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "BuildingImprType");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> YEARADDED_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "YearAdded");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.BuildingImprovementInternal _internal;
   ...
   */
  public BuildingImprovement(entity.PolicyPeriod branch)  {
   ...
   */
  public BuildingImprovement(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BuildingImprovement(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BuildingImprovementInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BuildingImprovementInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BuildingImprovement clone() {
    return (entity.BuildingImprovement)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BuildingImprovement getBasedOn() {
    return (entity.BuildingImprovement)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BuildingImprovement getBasedOnValue() {
    return (entity.BuildingImprovement)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public typekey.BuildingImprType getBuildingImprType() {
    return (typekey.BuildingImprType)__getInternalInterface().getFieldValue(BUILDINGIMPRTYPE_PROP.get());
  }
  ...
  public entity.BuildingImprovement getFixed() {
    return (entity.BuildingImprovement)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.BuildingImprovement getSlice(java.util.Date sliceDate) {
    return (entity.BuildingImprovement)getSliceUntyped(sliceDate);
  }
  ...
  public entity.BuildingImprovement getUnsliced() {
    return (entity.BuildingImprovement)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BuildingImprovementVersionList getVersionList() {
    return (entity.windowed.BuildingImprovementVersionList)getVersionListUntyped();
  }
  ...
  public java.lang.Integer getYearAdded() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(YEARADDED_PROP.get());
  }
   ...
   */
  private void setBasedOnValue(entity.BuildingImprovement value) {
  ...
  public void setBuildingImprType(typekey.BuildingImprType value) {
    __getInternalInterface().setFieldValue(BUILDINGIMPRTYPE_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.BuildingImprovement value) {
  ...
  public void setYearAdded(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(YEARADDED_PROP.get(), value);
  }
  
  public entity.BuildingImprovement split(java.util.Date splitDate) {
    return (entity.BuildingImprovement)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BuildingImprovementInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BuildingImprovement.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.copier.EffDatedCopyable", "gw.lob.common.BuildingImprovementEffDatedCopier");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.common.BuildingImprovementMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.common.BuildingImprovementMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BuildingImprovement.class, config);
    com.guidewire._generated.entity.BuildingImprovementInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BuildingImprovement, com.guidewire._generated.entity.BuildingImprovementInternal>() {
      public java.lang.Object getImplementation(entity.BuildingImprovement bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BuildingImprovementInternal getInternalInterface(entity.BuildingImprovement bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BuildingImprovement newEmptyInstance() {
        return new entity.BuildingImprovement((java.lang.Void)null);
      }

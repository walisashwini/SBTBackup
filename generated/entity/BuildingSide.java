...
/**
 * BuildingSide
 * A hazardous adjacent exposure to an insured property - a proximate cause of loss (e.g. next door lumberyard, solvent mfg.,etc.)
 */
...
@gw.entity.EntityName(value = "BuildingSide")
public class BuildingSide extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BuildingSide, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BuildingSide, entity.PolicyPeriod>("entity.BuildingSide");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> BUILDINGSIDETYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "BuildingSideType");
  ...
  private com.guidewire._generated.entity.BuildingSideInternal _internal;
   ...
   */
  public BuildingSide(entity.PolicyPeriod branch)  {
   ...
   */
  public BuildingSide(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BuildingSide(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BuildingSideInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BuildingSideInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BuildingSide clone() {
    return (entity.BuildingSide)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BuildingSide getBasedOn() {
    return (entity.BuildingSide)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BuildingSide getBasedOnValue() {
    return (entity.BuildingSide)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public typekey.BuildingSideType getBuildingSideType() {
    return (typekey.BuildingSideType)__getInternalInterface().getFieldValue(BUILDINGSIDETYPE_PROP.get());
  }
  ...
  public entity.BuildingSide getFixed() {
    return (entity.BuildingSide)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.BuildingSide getSlice(java.util.Date sliceDate) {
    return (entity.BuildingSide)getSliceUntyped(sliceDate);
  }
  ...
  public entity.BuildingSide getUnsliced() {
    return (entity.BuildingSide)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BuildingSideVersionList getVersionList() {
    return (entity.windowed.BuildingSideVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.BuildingSide value) {
  ...
  public void setBuildingSideType(typekey.BuildingSideType value) {
    __getInternalInterface().setFieldValue(BUILDINGSIDETYPE_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.BuildingSide value) {
  ...
  public entity.BuildingSide split(java.util.Date splitDate) {
    return (entity.BuildingSide)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BuildingSideInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BuildingSide.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.copier.EffDatedCopyable", "gw.lob.common.BuildingSideEffDatedCopier");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.common.BuildingSideMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.common.BuildingSideMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BuildingSide.class, config);
    com.guidewire._generated.entity.BuildingSideInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BuildingSide, com.guidewire._generated.entity.BuildingSideInternal>() {
      public java.lang.Object getImplementation(entity.BuildingSide bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BuildingSideInternal getInternalInterface(entity.BuildingSide bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BuildingSide newEmptyInstance() {
        return new entity.BuildingSide((java.lang.Void)null);
      }

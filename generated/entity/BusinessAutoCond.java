...
/**
 * BusinessAutoCond
 * A line-level condition for Commercial Auto
 */
...
@gw.entity.EntityName(value = "BusinessAutoCond")
public class BusinessAutoCond extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PolicyCondition, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BusinessAutoCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BusinessAutoCond, entity.PolicyPeriod>("entity.BusinessAutoCond");
  ...
  private com.guidewire._generated.entity.BusinessAutoCondInternal _internal;
   ...
   */
  protected BusinessAutoCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected BusinessAutoCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected BusinessAutoCond(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BusinessAutoCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BusinessAutoCondInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BusinessAutoCond clone() {
    return (entity.BusinessAutoCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BusinessAutoCond getBasedOn() {
    return (entity.BusinessAutoCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BusinessAutoCond getBasedOnValue() {
    return (entity.BusinessAutoCond)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.BusinessAutoCond getFixed() {
    return (entity.BusinessAutoCond)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.BusinessAutoCond getSlice(java.util.Date sliceDate) {
    return (entity.BusinessAutoCond)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.BusinessAutoCond getSubtype() {
    return (typekey.BusinessAutoCond)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.BusinessAutoCond getUnsliced() {
    return (entity.BusinessAutoCond)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BusinessAutoCondVersionList getVersionList() {
    return (entity.windowed.BusinessAutoCondVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.BusinessAutoCond value) {
   ...
   */
  private void setFixed(entity.BusinessAutoCond value) {
   ...
   */
  private void setSubtype(typekey.BusinessAutoCond value) {
  ...
  public entity.BusinessAutoCond split(java.util.Date splitDate) {
    return (entity.BusinessAutoCond)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BusinessAutoCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BusinessAutoCond.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.ba.BusinessAutoCondConditionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.ba.BusinessAutoCondConditionAdapter");
    config.put("gw.api.domain.PolicyConditionAdapter", "gw.lob.ba.BusinessAutoCondConditionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.ba.BusinessAutoCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.ba.BusinessAutoCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BusinessAutoCond.class, config);
    com.guidewire._generated.entity.BusinessAutoCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BusinessAutoCond, com.guidewire._generated.entity.BusinessAutoCondInternal>() {
      public java.lang.Object getImplementation(entity.BusinessAutoCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BusinessAutoCondInternal getInternalInterface(entity.BusinessAutoCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BusinessAutoCond newEmptyInstance() {
        return new entity.BusinessAutoCond((java.lang.Void)null);
      }

...
/**
 * BusinessAutoExcl
 * A line-level exclusion for Commercial Auto
 */
...
@gw.entity.EntityName(value = "BusinessAutoExcl")
public class BusinessAutoExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BusinessAutoExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BusinessAutoExcl, entity.PolicyPeriod>("entity.BusinessAutoExcl");
  ...
  private com.guidewire._generated.entity.BusinessAutoExclInternal _internal;
   ...
   */
  protected BusinessAutoExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected BusinessAutoExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected BusinessAutoExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BusinessAutoExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BusinessAutoExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BusinessAutoExcl clone() {
    return (entity.BusinessAutoExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BusinessAutoExcl getBasedOn() {
    return (entity.BusinessAutoExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.BusinessAutoExcl getBasedOnValue() {
    return (entity.BusinessAutoExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.BusinessAutoExcl getFixed() {
    return (entity.BusinessAutoExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.BusinessAutoExcl getSlice(java.util.Date sliceDate) {
    return (entity.BusinessAutoExcl)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.BusinessAutoExcl getSubtype() {
    return (typekey.BusinessAutoExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.BusinessAutoExcl getUnsliced() {
    return (entity.BusinessAutoExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BusinessAutoExclVersionList getVersionList() {
    return (entity.windowed.BusinessAutoExclVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.BusinessAutoExcl value) {
   ...
   */
  private void setFixed(entity.BusinessAutoExcl value) {
   ...
   */
  private void setSubtype(typekey.BusinessAutoExcl value) {
  ...
  public entity.BusinessAutoExcl split(java.util.Date splitDate) {
    return (entity.BusinessAutoExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BusinessAutoExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BusinessAutoExcl.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.BusinessAutoExcl value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.BusinessAutoExcl value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.BusinessAutoExcl value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.ba.BusinessAutoExclExclusionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.ba.BusinessAutoExclExclusionAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.ba.BusinessAutoExclExclusionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.ba.BusinessAutoExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.ba.BusinessAutoExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BusinessAutoExcl.class, config);
    com.guidewire._generated.entity.BusinessAutoExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BusinessAutoExcl, com.guidewire._generated.entity.BusinessAutoExclInternal>() {
      public java.lang.Object getImplementation(entity.BusinessAutoExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BusinessAutoExclInternal getInternalInterface(entity.BusinessAutoExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BusinessAutoExcl newEmptyInstance() {
        return new entity.BusinessAutoExcl((java.lang.Void)null);
      }

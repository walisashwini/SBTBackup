...
/**
 * BusinessOwnersCond
 * A line-level condition for Business Owners
 */
...
@gw.entity.EntityName(value = "BusinessOwnersCond")
public class BusinessOwnersCond extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PolicyCondition, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BusinessOwnersCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BusinessOwnersCond, entity.PolicyPeriod>("entity.BusinessOwnersCond");
  ...
  private com.guidewire._generated.entity.BusinessOwnersCondInternal _internal;
   ...
   */
  protected BusinessOwnersCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected BusinessOwnersCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected BusinessOwnersCond(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BusinessOwnersCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BusinessOwnersCondInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BusinessOwnersCond clone() {
    return (entity.BusinessOwnersCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BusinessOwnersCond getBasedOn() {
    return (entity.BusinessOwnersCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.BusinessOwnersCond getBasedOnValue() {
    return (entity.BusinessOwnersCond)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.BusinessOwnersCond getFixed() {
    return (entity.BusinessOwnersCond)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.BusinessOwnersCond getSlice(java.util.Date sliceDate) {
    return (entity.BusinessOwnersCond)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.BusinessOwnersCond getSubtype() {
    return (typekey.BusinessOwnersCond)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.BusinessOwnersCond getUnsliced() {
    return (entity.BusinessOwnersCond)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BusinessOwnersCondVersionList getVersionList() {
    return (entity.windowed.BusinessOwnersCondVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.BusinessOwnersCond value) {
   ...
   */
  private void setFixed(entity.BusinessOwnersCond value) {
   ...
   */
  private void setSubtype(typekey.BusinessOwnersCond value) {
  ...
  public entity.BusinessOwnersCond split(java.util.Date splitDate) {
    return (entity.BusinessOwnersCond)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BusinessOwnersCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BusinessOwnersCond.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.BusinessOwnersCond value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.BusinessOwnersCond value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.BusinessOwnersCond value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.bop.BusinessOwnersCondConditionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.bop.BusinessOwnersCondConditionAdapter");
    config.put("gw.api.domain.PolicyConditionAdapter", "gw.lob.bop.BusinessOwnersCondConditionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.bop.BusinessOwnersCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.bop.BusinessOwnersCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BusinessOwnersCond.class, config);
    com.guidewire._generated.entity.BusinessOwnersCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BusinessOwnersCond, com.guidewire._generated.entity.BusinessOwnersCondInternal>() {
      public java.lang.Object getImplementation(entity.BusinessOwnersCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BusinessOwnersCondInternal getInternalInterface(entity.BusinessOwnersCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BusinessOwnersCond newEmptyInstance() {
        return new entity.BusinessOwnersCond((java.lang.Void)null);
      }

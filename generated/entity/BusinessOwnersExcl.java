...
/**
 * BusinessOwnersExcl
 * A line-level exclusion for Business Owners
 */
...
@gw.entity.EntityName(value = "BusinessOwnersExcl")
public class BusinessOwnersExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BusinessOwnersExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BusinessOwnersExcl, entity.PolicyPeriod>("entity.BusinessOwnersExcl");
  ...
  private com.guidewire._generated.entity.BusinessOwnersExclInternal _internal;
   ...
   */
  protected BusinessOwnersExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected BusinessOwnersExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected BusinessOwnersExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BusinessOwnersExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BusinessOwnersExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BusinessOwnersExcl clone() {
    return (entity.BusinessOwnersExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BusinessOwnersExcl getBasedOn() {
    return (entity.BusinessOwnersExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.BusinessOwnersExcl getBasedOnValue() {
    return (entity.BusinessOwnersExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.BusinessOwnersExcl getFixed() {
    return (entity.BusinessOwnersExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.BusinessOwnersExcl getSlice(java.util.Date sliceDate) {
    return (entity.BusinessOwnersExcl)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.BusinessOwnersExcl getSubtype() {
    return (typekey.BusinessOwnersExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.BusinessOwnersExcl getUnsliced() {
    return (entity.BusinessOwnersExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BusinessOwnersExclVersionList getVersionList() {
    return (entity.windowed.BusinessOwnersExclVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.BusinessOwnersExcl value) {
   ...
   */
  private void setFixed(entity.BusinessOwnersExcl value) {
   ...
   */
  private void setSubtype(typekey.BusinessOwnersExcl value) {
  ...
  public entity.BusinessOwnersExcl split(java.util.Date splitDate) {
    return (entity.BusinessOwnersExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BusinessOwnersExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BusinessOwnersExcl.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.BusinessOwnersExcl value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.BusinessOwnersExcl value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.BusinessOwnersExcl value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.bop.BusinessOwnersExclExclusionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.bop.BusinessOwnersExclExclusionAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.bop.BusinessOwnersExclExclusionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.bop.BusinessOwnersExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.bop.BusinessOwnersExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BusinessOwnersExcl.class, config);
    com.guidewire._generated.entity.BusinessOwnersExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BusinessOwnersExcl, com.guidewire._generated.entity.BusinessOwnersExclInternal>() {
      public java.lang.Object getImplementation(entity.BusinessOwnersExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BusinessOwnersExclInternal getInternalInterface(entity.BusinessOwnersExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BusinessOwnersExcl newEmptyInstance() {
        return new entity.BusinessOwnersExcl((java.lang.Void)null);
      }

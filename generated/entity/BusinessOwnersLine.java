...
/**
 * BusinessOwnersLine
 * Businessowners Policy line of business.
 */
...
@gw.entity.EntityName(value = "BusinessOwnersLine")
public class BusinessOwnersLine extends entity.PolicyLine implements entity.Coverable, entity.Modifiable, gw.api.domain.LineSpecificLocationContainer, gw.api.policy.PolicyLineJavaMethods {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BusinessOwnersLine, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BusinessOwnersLine, entity.PolicyPeriod>("entity.BusinessOwnersLine");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> BOPCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "BOPCosts");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> BOPLINECONDITIONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "BOPLineConditions");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> BOPLINECOVERAGES_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "BOPLineCoverages");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> BOPLINEEXCLUSIONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "BOPLineExclusions");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> BOPLOCATIONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "BOPLocations");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> BOPMODIFIERS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "BOPModifiers");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> BOPSCHEDULEDEQUIPMENTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "BOPScheduledEquipments");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> BLANKETTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "BlanketType");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> EQUIPMENTAUTONUMBERSEQ_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "EquipmentAutoNumberSeq");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> SMALLBUSINESSTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "SmallBusinessType");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> VIEWBUNDLEDCOVERAGES_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ViewBundledCoverages");
   ...
   */
  protected BusinessOwnersLine(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected BusinessOwnersLine(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected BusinessOwnersLine(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BusinessOwnersLineInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BusinessOwnersLineInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BusinessOwnersLineInternal)super.__getInternalInterface();
  }
  ...
  public void addToBOPCosts(entity.BOPCost element) {
    __getInternalInterface().addArrayElement(BOPCOSTS_PROP.get(), element);
  }
  ...
  public void addToBOPLineConditions(entity.BusinessOwnersCond element) {
    __getInternalInterface().addArrayElement(BOPLINECONDITIONS_PROP.get(), element);
  }
  ...
  public void addToBOPLineCoverages(entity.BusinessOwnersCov element) {
    __getInternalInterface().addArrayElement(BOPLINECOVERAGES_PROP.get(), element);
  }
  ...
  public void addToBOPLineExclusions(entity.BusinessOwnersExcl element) {
    __getInternalInterface().addArrayElement(BOPLINEEXCLUSIONS_PROP.get(), element);
  }
  ...
  public void addToBOPLocations(entity.BOPLocation element) {
    __getInternalInterface().addArrayElement(BOPLOCATIONS_PROP.get(), element);
  }
  ...
  public void addToBOPModifiers(entity.BOPModifier element) {
    __getInternalInterface().addArrayElement(BOPMODIFIERS_PROP.get(), element);
  }
  ...
  public void addToBOPScheduledEquipments(entity.BOPScheduledEquipment element) {
    __getInternalInterface().addArrayElement(BOPSCHEDULEDEQUIPMENTS_PROP.get(), element);
  }
  ...
  public entity.BusinessOwnersLine clone() {
    return (entity.BusinessOwnersLine)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BOPCost[] getBOPCosts() {
    return (entity.BOPCost[])__getInternalInterface().getFieldValue(BOPCOSTS_PROP.get());
  }
  ...
  public entity.BusinessOwnersCond[] getBOPLineConditions() {
    return (entity.BusinessOwnersCond[])__getInternalInterface().getFieldValue(BOPLINECONDITIONS_PROP.get());
  }
  ...
  public entity.BusinessOwnersCov[] getBOPLineCoverages() {
    return (entity.BusinessOwnersCov[])__getInternalInterface().getFieldValue(BOPLINECOVERAGES_PROP.get());
  }
  ...
  public entity.BusinessOwnersExcl[] getBOPLineExclusions() {
    return (entity.BusinessOwnersExcl[])__getInternalInterface().getFieldValue(BOPLINEEXCLUSIONS_PROP.get());
  }
  ...
  public entity.BOPLocation[] getBOPLocations() {
    return (entity.BOPLocation[])__getInternalInterface().getFieldValue(BOPLOCATIONS_PROP.get());
  }
  ...
  public entity.BOPModifier[] getBOPModifiers() {
    return (entity.BOPModifier[])__getInternalInterface().getFieldValue(BOPMODIFIERS_PROP.get());
  }
  ...
  public entity.BOPScheduledEquipment[] getBOPScheduledEquipments() {
    return (entity.BOPScheduledEquipment[])__getInternalInterface().getFieldValue(BOPSCHEDULEDEQUIPMENTS_PROP.get());
  }
  
  public entity.BusinessOwnersLine getBasedOn() {
    return (entity.BusinessOwnersLine)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public typekey.BlanketType getBlanketType() {
    return (typekey.BlanketType)__getInternalInterface().getFieldValue(BLANKETTYPE_PROP.get());
  }
  ...
  public entity.AutoNumberSequence getEquipmentAutoNumberSeq() {
    return (entity.AutoNumberSequence)__getInternalInterface().getFieldValue(EQUIPMENTAUTONUMBERSEQ_PROP.get());
  }
  ...
  public entity.BusinessOwnersLine getSlice(java.util.Date sliceDate) {
    return (entity.BusinessOwnersLine)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.SmallBusinessType getSmallBusinessType() {
    return (typekey.SmallBusinessType)__getInternalInterface().getFieldValue(SMALLBUSINESSTYPE_PROP.get());
  }
  
  public entity.BusinessOwnersLine getUnsliced() {
    return (entity.BusinessOwnersLine)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BusinessOwnersLineVersionList getVersionList() {
    return (entity.windowed.BusinessOwnersLineVersionList)getVersionListUntyped();
  }
  ...
  public java.lang.Boolean isViewBundledCoverages() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(VIEWBUNDLEDCOVERAGES_PROP.get());
  }
  ...
  public void removeFromBOPCosts(entity.BOPCost element) {
    __getInternalInterface().removeArrayElement(BOPCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromBOPCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(BOPCOSTS_PROP.get(), elementID);
  }
  ...
  public void removeFromBOPLineConditions(entity.BusinessOwnersCond element) {
    __getInternalInterface().removeArrayElement(BOPLINECONDITIONS_PROP.get(), element);
  }
  ...
  public void removeFromBOPLineConditions(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(BOPLINECONDITIONS_PROP.get(), elementID);
  }
  ...
  public void removeFromBOPLineCoverages(entity.BusinessOwnersCov element) {
    __getInternalInterface().removeArrayElement(BOPLINECOVERAGES_PROP.get(), element);
  }
  ...
  public void removeFromBOPLineCoverages(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(BOPLINECOVERAGES_PROP.get(), elementID);
  }
  ...
  public void removeFromBOPLineExclusions(entity.BusinessOwnersExcl element) {
    __getInternalInterface().removeArrayElement(BOPLINEEXCLUSIONS_PROP.get(), element);
  }
  ...
  public void removeFromBOPLineExclusions(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(BOPLINEEXCLUSIONS_PROP.get(), elementID);
  }
  ...
  public void removeFromBOPLocations(entity.BOPLocation element) {
    __getInternalInterface().removeArrayElement(BOPLOCATIONS_PROP.get(), element);
  }
  ...
  public void removeFromBOPLocations(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(BOPLOCATIONS_PROP.get(), elementID);
  }
  ...
  public void removeFromBOPModifiers(entity.BOPModifier element) {
    __getInternalInterface().removeArrayElement(BOPMODIFIERS_PROP.get(), element);
  }
  ...
  public void removeFromBOPModifiers(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(BOPMODIFIERS_PROP.get(), elementID);
  }
  ...
  public void removeFromBOPScheduledEquipments(entity.BOPScheduledEquipment element) {
    __getInternalInterface().removeArrayElement(BOPSCHEDULEDEQUIPMENTS_PROP.get(), element);
  }
  ...
  public void removeFromBOPScheduledEquipments(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(BOPSCHEDULEDEQUIPMENTS_PROP.get(), elementID);
  }
  ...
  public void setBOPCosts(entity.BOPCost[] value) {
    __getInternalInterface().setFieldValue(BOPCOSTS_PROP.get(), value);
  }
  ...
  public void setBOPLineConditions(entity.BusinessOwnersCond[] value) {
    __getInternalInterface().setFieldValue(BOPLINECONDITIONS_PROP.get(), value);
  }
  ...
  public void setBOPLineCoverages(entity.BusinessOwnersCov[] value) {
    __getInternalInterface().setFieldValue(BOPLINECOVERAGES_PROP.get(), value);
  }
  ...
  public void setBOPLineExclusions(entity.BusinessOwnersExcl[] value) {
    __getInternalInterface().setFieldValue(BOPLINEEXCLUSIONS_PROP.get(), value);
  }
  ...
  public void setBOPLocations(entity.BOPLocation[] value) {
    __getInternalInterface().setFieldValue(BOPLOCATIONS_PROP.get(), value);
  }
  ...
  public void setBOPModifiers(entity.BOPModifier[] value) {
    __getInternalInterface().setFieldValue(BOPMODIFIERS_PROP.get(), value);
  }
  ...
  public void setBOPScheduledEquipments(entity.BOPScheduledEquipment[] value) {
    __getInternalInterface().setFieldValue(BOPSCHEDULEDEQUIPMENTS_PROP.get(), value);
  }
  ...
  public void setBlanketType(typekey.BlanketType value) {
    __getInternalInterface().setFieldValue(BLANKETTYPE_PROP.get(), value);
  }
  ...
  public void setEquipmentAutoNumberSeq(entity.AutoNumberSequence value) {
    __getInternalInterface().setFieldValue(EQUIPMENTAUTONUMBERSEQ_PROP.get(), value);
  }
  ...
  public void setSmallBusinessType(typekey.SmallBusinessType value) {
    __getInternalInterface().setFieldValue(SMALLBUSINESSTYPE_PROP.get(), value);
  }
  ...
  public void setViewBundledCoverages(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(VIEWBUNDLEDCOVERAGES_PROP.get(), value);
  }
  
  public entity.BusinessOwnersLine split(java.util.Date splitDate) {
    return (entity.BusinessOwnersLine)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BusinessOwnersLineInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BusinessOwnersLine.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getEquipmentAutoNumberSeqID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(EQUIPMENTAUTONUMBERSEQ_PROP.get());
    }
    ...
    public void setEquipmentAutoNumberSeqID(gw.pl.persistence.core.Key value) {
      setFieldValue(EQUIPMENTAUTONUMBERSEQ_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.bop.BOPLineCoverableModifiableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.bop.BOPLineCoverableModifiableAdapter");
    config.put("gw.api.domain.LineSpecificLocationContainer", "gw.lob.bop.BOPSpecificLocationContainer");
    config.put("gw.api.domain.ModifiableAdapter", "gw.lob.bop.BOPLineCoverableModifiableAdapter");
    ...
    config.put("gw.api.policy.PolicyLineJavaMethods", "gw.lob.bop.BOPPolicyLineMethods");
    config.put("gw.api.policy.PolicyLineMethods", "gw.lob.bop.BOPPolicyLineMethods");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BusinessOwnersLine.class, config);
    com.guidewire._generated.entity.BusinessOwnersLineInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BusinessOwnersLine, com.guidewire._generated.entity.BusinessOwnersLineInternal>() {
      public java.lang.Object getImplementation(entity.BusinessOwnersLine bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BusinessOwnersLineInternal getInternalInterface(entity.BusinessOwnersLine bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BusinessOwnersLine newEmptyInstance() {
        return new entity.BusinessOwnersLine((java.lang.Void)null);
      }

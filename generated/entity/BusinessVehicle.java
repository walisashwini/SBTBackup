...
@gw.entity.EntityName(value = "BusinessVehicle")
public class BusinessVehicle extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverable, entity.Modifiable, gw.api.contact.AdditionalInterestContainer, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BusinessVehicle, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BusinessVehicle, entity.PolicyPeriod>("entity.BusinessVehicle");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ANTILOCKBRAKES_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AntiLockBrakes");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ANTITHEFT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AntiTheft");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ARCHIVEPARTITION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ArchivePartition");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> BALINE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "BALine");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> BODYTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "BodyType");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> BUSINESSVEHICLEMODIFIERS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "BusinessVehicleModifiers");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IMonetaryAmountPropertyInfo> COSTNEW_PROP = new com.guidewire.commons.metadata.types.MonetaryAmountPropertyInfoCache(TYPE, "CostNew");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> COSTNEW_AMT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CostNew_amt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> COSTNEW_CUR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "CostNew_cur");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> DESTINATIONZONE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "DestinationZone");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DOESUMUIMAPPLY_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DoesUMUIMApply");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> EXPERIENCE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "Experience");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> INDUSTRY_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "Industry");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> INDUSTRYUSE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "IndustryUse");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> INTRAINTERSTATEUSAGE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "IntraInterStateUsage");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LEASEORRENT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LeaseOrRent");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> LENGTHOFLEASE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "LengthOfLease");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> LINECOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "LineCosts");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> ORIGINATIONZONE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "OriginationZone");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> OWNEDBYPOLITICALSUB_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "OwnedByPoliticalSub");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> PIPCOVERED_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "PipCovered");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> PRIMARYUSE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "PrimaryUse");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> SAFEDRIVINGCERT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "SafeDrivingCert");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IMonetaryAmountPropertyInfo> STATEDVALUE_PROP = new com.guidewire.commons.metadata.types.MonetaryAmountPropertyInfoCache(TYPE, "StatedValue");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> STATEDVALUE_AMT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "StatedValue_amt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> STATEDVALUE_CUR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "StatedValue_cur");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> UPDATETIME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "UpdateTime");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> UPDATEUSER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "UpdateUser");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> VEHICLECLASSCODE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "VehicleClassCode");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> VEHICLECONDITION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "VehicleCondition");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> VEHICLERADIUS_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "VehicleRadius");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> VEHICLESIZECLASS_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "VehicleSizeClass");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> YEARPURCHASED_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "YearPurchased");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.BusinessVehicleInternal _internal;
   ...
   */
  public BusinessVehicle(entity.PolicyPeriod branch)  {
   ...
   */
  public BusinessVehicle(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BusinessVehicle(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BusinessVehicleInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BusinessVehicleInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToBusinessVehicleModifiers(entity.BusinessVehicleModifier element) {
    __getInternalInterface().addArrayElement(BUSINESSVEHICLEMODIFIERS_PROP.get(), element);
  }
  ...
  public void addToLineCosts(entity.BALineCovCost element) {
    __getInternalInterface().addArrayElement(LINECOSTS_PROP.get(), element);
  }
  ...
  public entity.BusinessVehicle clone() {
    return (entity.BusinessVehicle)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BAVhcleAddlInterest[] getAdditionalInterests() {
    return (entity.BAVhcleAddlInterest[])__getInternalInterface().getFieldValue(ADDITIONALINTERESTS_PROP.get());
  }
  ...
  public entity.BusinessAutoLine getBALine() {
    return (entity.BusinessAutoLine)__getInternalInterface().getFieldValue(BALINE_PROP.get());
  }
  
  public entity.BusinessVehicle getBasedOn() {
    return (entity.BusinessVehicle)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BusinessVehicle getBasedOnValue() {
    return (entity.BusinessVehicle)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public typekey.BodyType getBodyType() {
    return (typekey.BodyType)__getInternalInterface().getFieldValue(BODYTYPE_PROP.get());
  }
  ...
  public entity.BusinessVehicleModifier[] getBusinessVehicleModifiers() {
    return (entity.BusinessVehicleModifier[])__getInternalInterface().getFieldValue(BUSINESSVEHICLEMODIFIERS_PROP.get());
  }
  ...
  public gw.pl.currency.MonetaryAmount getCostNew() {
    return (gw.pl.currency.MonetaryAmount)__getInternalInterface().getFieldValue(COSTNEW_PROP.get());
  }
  ...
  public java.math.BigDecimal getCostNew_amt() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(COSTNEW_AMT_PROP.get());
  }
  ...
  public typekey.Currency getCostNew_cur() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(COSTNEW_CUR_PROP.get());
  }
  ...
  public entity.BAStateCovVehicleCost[] getCosts() {
    return (entity.BAStateCovVehicleCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
  }
  ...
  public entity.BusinessVehicleCov[] getCoverages() {
    return (entity.BusinessVehicleCov[])__getInternalInterface().getFieldValue(COVERAGES_PROP.get());
  }
  ...
  public typekey.Zone getDestinationZone() {
    return (typekey.Zone)__getInternalInterface().getFieldValue(DESTINATIONZONE_PROP.get());
  }
  ...
  public typekey.CombinedDriverExp getExperience() {
    return (typekey.CombinedDriverExp)__getInternalInterface().getFieldValue(EXPERIENCE_PROP.get());
  }
  ...
  public entity.BusinessVehicle getFixed() {
    return (entity.BusinessVehicle)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public typekey.VehicleIndustry getIndustry() {
    return (typekey.VehicleIndustry)__getInternalInterface().getFieldValue(INDUSTRY_PROP.get());
  }
  ...
  public typekey.VehicleIndustryUse getIndustryUse() {
    return (typekey.VehicleIndustryUse)__getInternalInterface().getFieldValue(INDUSTRYUSE_PROP.get());
  }
  ...
  public typekey.IntraInterStateUsage getIntraInterStateUsage() {
    return (typekey.IntraInterStateUsage)__getInternalInterface().getFieldValue(INTRAINTERSTATEUSAGE_PROP.get());
  }
  ...
  public typekey.LengthOfLease getLengthOfLease() {
    return (typekey.LengthOfLease)__getInternalInterface().getFieldValue(LENGTHOFLEASE_PROP.get());
  }
  ...
  public entity.BALineCovCost[] getLineCosts() {
    return (entity.BALineCovCost[])__getInternalInterface().getFieldValue(LINECOSTS_PROP.get());
  }
  ...
  public typekey.Zone getOriginationZone() {
    return (typekey.Zone)__getInternalInterface().getFieldValue(ORIGINATIONZONE_PROP.get());
  }
  ...
  public typekey.PipCovered getPipCovered() {
    return (typekey.PipCovered)__getInternalInterface().getFieldValue(PIPCOVERED_PROP.get());
  }
  ...
  public typekey.VehiclePrimaryUse getPrimaryUse() {
    return (typekey.VehiclePrimaryUse)__getInternalInterface().getFieldValue(PRIMARYUSE_PROP.get());
  }
  ...
  public entity.BusinessVehicle getSlice(java.util.Date sliceDate) {
    return (entity.BusinessVehicle)getSliceUntyped(sliceDate);
  }
  ...
  public gw.pl.currency.MonetaryAmount getStatedValue() {
    return (gw.pl.currency.MonetaryAmount)__getInternalInterface().getFieldValue(STATEDVALUE_PROP.get());
  }
  ...
  public java.math.BigDecimal getStatedValue_amt() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(STATEDVALUE_AMT_PROP.get());
  }
  ...
  public typekey.Currency getStatedValue_cur() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(STATEDVALUE_CUR_PROP.get());
  }
  ...
  public entity.BusinessVehicle getUnsliced() {
    return (entity.BusinessVehicle)getUnslicedUntyped();
  }
  ...
  public java.lang.String getVehicleClassCode() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(VEHICLECLASSCODE_PROP.get());
  }
  ...
  public typekey.RadiusCode getVehicleRadius() {
    return (typekey.RadiusCode)__getInternalInterface().getFieldValue(VEHICLERADIUS_PROP.get());
  }
  ...
  public typekey.VehicleSizeClass getVehicleSizeClass() {
    return (typekey.VehicleSizeClass)__getInternalInterface().getFieldValue(VEHICLESIZECLASS_PROP.get());
  }
  ...
  public entity.windowed.BusinessVehicleVersionList getVersionList() {
    return (entity.windowed.BusinessVehicleVersionList)getVersionListUntyped();
  }
  ...
  public java.lang.Integer getYearPurchased() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(YEARPURCHASED_PROP.get());
  }
  ...
  public java.lang.Boolean isAntiLockBrakes() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(ANTILOCKBRAKES_PROP.get());
  }
  ...
  public java.lang.Boolean isAntiTheft() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(ANTITHEFT_PROP.get());
  }
  ...
  public java.lang.Boolean isDoesUMUIMApply() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(DOESUMUIMAPPLY_PROP.get());
  }
  ...
  public java.lang.Boolean isLeaseOrRent() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(LEASEORRENT_PROP.get());
  }
  ...
  public java.lang.Boolean isOwnedByPoliticalSub() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(OWNEDBYPOLITICALSUB_PROP.get());
  }
  ...
  public java.lang.Boolean isSafeDrivingCert() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(SAFEDRIVINGCERT_PROP.get());
  }
  ...
  public java.lang.Boolean isVehicleCondition() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(VEHICLECONDITION_PROP.get());
  }
  ...
  public void removeFromBusinessVehicleModifiers(entity.BusinessVehicleModifier element) {
    __getInternalInterface().removeArrayElement(BUSINESSVEHICLEMODIFIERS_PROP.get(), element);
  }
  ...
  public void removeFromBusinessVehicleModifiers(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(BUSINESSVEHICLEMODIFIERS_PROP.get(), elementID);
  }
  ...
  public void removeFromLineCosts(entity.BALineCovCost element) {
    __getInternalInterface().removeArrayElement(LINECOSTS_PROP.get(), element);
  }
  ...
  public void removeFromLineCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(LINECOSTS_PROP.get(), elementID);
  }
  ...
  public void setAntiLockBrakes(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(ANTILOCKBRAKES_PROP.get(), value);
  }
  ...
  public void setAntiTheft(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(ANTITHEFT_PROP.get(), value);
  }
  ...
  public void setBALine(entity.BusinessAutoLine value) {
    __getInternalInterface().setFieldValue(BALINE_PROP.get(), value);
  }
  
  /**
   * Sets the value of the BasedOnValue field.
   */
  private void setBasedOnValue(entity.BusinessVehicle value) {
  ...
  public void setBodyType(typekey.BodyType value) {
    __getInternalInterface().setFieldValue(BODYTYPE_PROP.get(), value);
  }
  ...
  public void setBusinessVehicleModifiers(entity.BusinessVehicleModifier[] value) {
    __getInternalInterface().setFieldValue(BUSINESSVEHICLEMODIFIERS_PROP.get(), value);
  }
  ...
  public void setCostNew(gw.pl.currency.MonetaryAmount value) {
    __getInternalInterface().setFieldValue(COSTNEW_PROP.get(), value);
  }
  
  /**
   * Sets the value of the CostNew_amt field.
   */
  private void setCostNew_amt(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(COSTNEW_AMT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the CostNew_cur field.
   */
  private void setCostNew_cur(typekey.Currency value) {
    __getInternalInterface().setFieldValue(COSTNEW_CUR_PROP.get(), value);
  }
  ...
  public void setDestinationZone(typekey.Zone value) {
    __getInternalInterface().setFieldValue(DESTINATIONZONE_PROP.get(), value);
  }
  ...
  public void setDoesUMUIMApply(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(DOESUMUIMAPPLY_PROP.get(), value);
  }
  ...
  public void setExperience(typekey.CombinedDriverExp value) {
    __getInternalInterface().setFieldValue(EXPERIENCE_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.BusinessVehicle value) {
  ...
  public void setIndustry(typekey.VehicleIndustry value) {
    __getInternalInterface().setFieldValue(INDUSTRY_PROP.get(), value);
  }
  ...
  public void setIndustryUse(typekey.VehicleIndustryUse value) {
    __getInternalInterface().setFieldValue(INDUSTRYUSE_PROP.get(), value);
  }
  ...
  public void setIntraInterStateUsage(typekey.IntraInterStateUsage value) {
    __getInternalInterface().setFieldValue(INTRAINTERSTATEUSAGE_PROP.get(), value);
  }
  ...
  public void setLeaseOrRent(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(LEASEORRENT_PROP.get(), value);
  }
  ...
  public void setLengthOfLease(typekey.LengthOfLease value) {
    __getInternalInterface().setFieldValue(LENGTHOFLEASE_PROP.get(), value);
  }
  ...
  public void setLineCosts(entity.BALineCovCost[] value) {
    __getInternalInterface().setFieldValue(LINECOSTS_PROP.get(), value);
  }
  ...
  public void setOriginationZone(typekey.Zone value) {
    __getInternalInterface().setFieldValue(ORIGINATIONZONE_PROP.get(), value);
  }
  ...
  public void setOwnedByPoliticalSub(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(OWNEDBYPOLITICALSUB_PROP.get(), value);
  }
  ...
  public void setPipCovered(typekey.PipCovered value) {
    __getInternalInterface().setFieldValue(PIPCOVERED_PROP.get(), value);
  }
  ...
  public void setPrimaryUse(typekey.VehiclePrimaryUse value) {
    __getInternalInterface().setFieldValue(PRIMARYUSE_PROP.get(), value);
  }
  ...
  public void setSafeDrivingCert(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(SAFEDRIVINGCERT_PROP.get(), value);
  }
  ...
  public void setStatedValue(gw.pl.currency.MonetaryAmount value) {
    __getInternalInterface().setFieldValue(STATEDVALUE_PROP.get(), value);
  }
  
  /**
   * Sets the value of the StatedValue_amt field.
   */
  private void setStatedValue_amt(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(STATEDVALUE_AMT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the StatedValue_cur field.
   */
  private void setStatedValue_cur(typekey.Currency value) {
    __getInternalInterface().setFieldValue(STATEDVALUE_CUR_PROP.get(), value);
  }
  ...
  public void setVehicleClassCode(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(VEHICLECLASSCODE_PROP.get(), value);
  }
  ...
  public void setVehicleCondition(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(VEHICLECONDITION_PROP.get(), value);
  }
  ...
  public void setVehicleRadius(typekey.RadiusCode value) {
    __getInternalInterface().setFieldValue(VEHICLERADIUS_PROP.get(), value);
  }
  ...
  public void setVehicleSizeClass(typekey.VehicleSizeClass value) {
    __getInternalInterface().setFieldValue(VEHICLESIZECLASS_PROP.get(), value);
  }
  ...
  public void setYearPurchased(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(YEARPURCHASED_PROP.get(), value);
  }
  
  public entity.BusinessVehicle split(java.util.Date splitDate) {
    return (entity.BusinessVehicle)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BusinessVehicleInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BusinessVehicle.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getBALineID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(BALINE_PROP.get());
    }
    ...
    public void setBALineID(gw.pl.persistence.core.Key value) {
      setFieldValue(BALINE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.contact.AdditionalInterestContainer", "gw.lob.ba.BusinessVehicleAdditionalInterestContainerCoverableModifiableAdapter");
    config.put("gw.api.copier.EffDatedCopyable", "gw.lob.ba.BusinessVehicleCopier");
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.ba.BusinessVehicleAdditionalInterestContainerCoverableModifiableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.ba.BusinessVehicleAdditionalInterestContainerCoverableModifiableAdapter");
    config.put("gw.api.domain.ModifiableAdapter", "gw.lob.ba.BusinessVehicleAdditionalInterestContainerCoverableModifiableAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.ba.BusinessVehicleMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.ba.BusinessVehicleMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BusinessVehicle.class, config);
    com.guidewire._generated.entity.BusinessVehicleInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BusinessVehicle, com.guidewire._generated.entity.BusinessVehicleInternal>() {
      public java.lang.Object getImplementation(entity.BusinessVehicle bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BusinessVehicleInternal getInternalInterface(entity.BusinessVehicle bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BusinessVehicle newEmptyInstance() {
        return new entity.BusinessVehicle((java.lang.Void)null);
      }

...
/**
 * BusinessVehicleCov
 * A vehicle-level coverage for Commercial Auto
 */
...
@gw.entity.EntityName(value = "BusinessVehicleCov")
public class BusinessVehicleCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BusinessVehicleCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BusinessVehicleCov, entity.PolicyPeriod>("entity.BusinessVehicleCov");
  ...
  private com.guidewire._generated.entity.BusinessVehicleCovInternal _internal;
   ...
   */
  protected BusinessVehicleCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected BusinessVehicleCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected BusinessVehicleCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BusinessVehicleCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BusinessVehicleCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BusinessVehicleCov clone() {
    return (entity.BusinessVehicleCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BusinessVehicleCov getBasedOn() {
    return (entity.BusinessVehicleCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BusinessVehicleCov getBasedOnValue() {
    return (entity.BusinessVehicleCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.BusinessVehicleCovCost[] getCosts() {
    return (entity.BusinessVehicleCovCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
  }
  ...
  public entity.BusinessVehicleCov getFixed() {
    return (entity.BusinessVehicleCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.BusinessVehicleCov getSlice(java.util.Date sliceDate) {
    return (entity.BusinessVehicleCov)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.BusinessVehicleCov getSubtype() {
    return (typekey.BusinessVehicleCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.BusinessVehicleCov getUnsliced() {
    return (entity.BusinessVehicleCov)getUnslicedUntyped();
  }
  ...
  public entity.BusinessVehicle getVehicle() {
    return (entity.BusinessVehicle)__getInternalInterface().getFieldValue(VEHICLE_PROP.get());
  }
  
  public entity.windowed.BusinessVehicleCovVersionList getVersionList() {
    return (entity.windowed.BusinessVehicleCovVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.BusinessVehicleCov value) {
   ...
   */
  private void setFixed(entity.BusinessVehicleCov value) {
   ...
   */
  private void setSubtype(typekey.BusinessVehicleCov value) {
  ...
  public entity.BusinessVehicleCov split(java.util.Date splitDate) {
    return (entity.BusinessVehicleCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BusinessVehicleCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BusinessVehicleCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.ba.BusinessVehicleCovCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.ba.BusinessVehicleCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.ba.BusinessVehicleCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.ba.BusinessVehicleCovCoverageAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.ba.BusinessVehicleCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.ba.BusinessVehicleCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BusinessVehicleCov.class, config);
    com.guidewire._generated.entity.BusinessVehicleCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BusinessVehicleCov, com.guidewire._generated.entity.BusinessVehicleCovInternal>() {
      public java.lang.Object getImplementation(entity.BusinessVehicleCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BusinessVehicleCovInternal getInternalInterface(entity.BusinessVehicleCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BusinessVehicleCov newEmptyInstance() {
        return new entity.BusinessVehicleCov((java.lang.Void)null);
      }

...
/**
 * BusinessVehicleCovCost
 * The cost for a vehicle-level coverage.
 */
...
@gw.entity.EntityName(value = "BusinessVehicleCovCost")
public class BusinessVehicleCovCost extends entity.BACost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BusinessVehicleCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BusinessVehicleCovCost, entity.PolicyPeriod>("entity.BusinessVehicleCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> BUSINESSVEHICLECOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "BusinessVehicleCov");
   ...
   */
  public BusinessVehicleCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public BusinessVehicleCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BusinessVehicleCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BusinessVehicleCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BusinessVehicleCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BusinessVehicleCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.BusinessVehicleCovCost clone() {
    return (entity.BusinessVehicleCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.BusinessVehicleCovCost getBasedOn() {
    return (entity.BusinessVehicleCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BusinessVehicleCov getBusinessVehicleCov() {
    return (entity.BusinessVehicleCov)__getInternalInterface().getFieldValue(BUSINESSVEHICLECOV_PROP.get());
  }
  
  public entity.BusinessVehicleCovCost getSlice(java.util.Date sliceDate) {
    return (entity.BusinessVehicleCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.BusinessVehicleCovCost getUnsliced() {
    return (entity.BusinessVehicleCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.BusinessVehicleCovCostVersionList getVersionList() {
    return (entity.windowed.BusinessVehicleCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setBusinessVehicleCov(entity.BusinessVehicleCov value) {
    __getInternalInterface().setFieldValue(BUSINESSVEHICLECOV_PROP.get(), value);
  }
  
  public entity.BusinessVehicleCovCost split(java.util.Date splitDate) {
    return (entity.BusinessVehicleCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BusinessVehicleCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BusinessVehicleCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getBusinessVehicleCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(BUSINESSVEHICLECOV_PROP.get());
    }
    ...
    public void setBusinessVehicleCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(BUSINESSVEHICLECOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.ba.financials.BACostMethods", "gw.lob.ba.financials.BusinessVehicleCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BusinessVehicleCovCost.class, config);
    com.guidewire._generated.entity.BusinessVehicleCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BusinessVehicleCovCost, com.guidewire._generated.entity.BusinessVehicleCovCostInternal>() {
      public java.lang.Object getImplementation(entity.BusinessVehicleCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BusinessVehicleCovCostInternal getInternalInterface(entity.BusinessVehicleCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BusinessVehicleCovCost newEmptyInstance() {
        return new entity.BusinessVehicleCovCost((java.lang.Void)null);
      }

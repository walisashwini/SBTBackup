...
/**
 * BusinessVehicleModifier
 * A modifier for Business Vehicles
 */
...
@gw.entity.EntityName(value = "BusinessVehicleModifier")
public class BusinessVehicleModifier extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Modifier, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.BusinessVehicleModifier, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.BusinessVehicleModifier, entity.PolicyPeriod>("entity.BusinessVehicleModifier");
  ...
  private com.guidewire._generated.entity.BusinessVehicleModifierInternal _internal;
   ...
   */
  public BusinessVehicleModifier(entity.PolicyPeriod branch)  {
   ...
   */
  public BusinessVehicleModifier(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected BusinessVehicleModifier(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BusinessVehicleModifierInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BusinessVehicleModifierInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.BusinessVehicleModifier clone() {
    return (entity.BusinessVehicleModifier)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.BusinessVehicleModifier getBasedOn() {
    return (entity.BusinessVehicleModifier)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.BusinessVehicleModifier getBasedOnValue() {
    return (entity.BusinessVehicleModifier)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.BusinessVehicleModifier getFixed() {
    return (entity.BusinessVehicleModifier)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.BusinessVehicleModifier getSlice(java.util.Date sliceDate) {
    return (entity.BusinessVehicleModifier)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.BusinessVehicleModifier getSubtype() {
    return (typekey.BusinessVehicleModifier)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.BusinessVehicleModifier getUnsliced() {
    return (entity.BusinessVehicleModifier)getUnslicedUntyped();
  }
  ...
  public entity.windowed.BusinessVehicleModifierVersionList getVersionList() {
    return (entity.windowed.BusinessVehicleModifierVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.BusinessVehicleModifier value) {
   ...
   */
  private void setFixed(entity.BusinessVehicleModifier value) {
   ...
   */
  private void setSubtype(typekey.BusinessVehicleModifier value) {
  ...
  public entity.BusinessVehicleModifier split(java.util.Date splitDate) {
    return (entity.BusinessVehicleModifier)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BusinessVehicleModifierInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BusinessVehicleModifier.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ModifierAbstractDomainMethods", "gw.lob.ba.BusinessVehicleModifierAdapter");
    config.put("gw.api.domain.ModifierAdapter", "gw.lob.ba.BusinessVehicleModifierAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.ba.BusinessVehicleModifierMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.ba.BusinessVehicleModifierMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BusinessVehicleModifier.class, config);
    com.guidewire._generated.entity.BusinessVehicleModifierInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BusinessVehicleModifier, com.guidewire._generated.entity.BusinessVehicleModifierInternal>() {
      public java.lang.Object getImplementation(entity.BusinessVehicleModifier bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BusinessVehicleModifierInternal getInternalInterface(entity.BusinessVehicleModifier bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BusinessVehicleModifier newEmptyInstance() {
        return new entity.BusinessVehicleModifier((java.lang.Void)null);
      }

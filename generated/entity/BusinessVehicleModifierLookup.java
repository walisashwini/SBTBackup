...
/**
 * BusinessVehicleModifierLookup
 * Business Vehicle Level Modifier Lookup Table.
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "BusinessVehicleModifierLookup.eti;BusinessVehicleModifierLookup.eix;BusinessVehicleModifierLookup.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "BusinessVehicleModifierLookup")
public class BusinessVehicleModifierLookup extends entity.BAModLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.BusinessVehicleModifierLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.BusinessVehicleModifierLookup>("entity.BusinessVehicleModifierLookup");
   ...
   */
  protected BusinessVehicleModifierLookup()  {
   ...
   */
  protected BusinessVehicleModifierLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected BusinessVehicleModifierLookup(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BusinessVehicleModifierLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BusinessVehicleModifierLookupInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BusinessVehicleModifierLookupInternal)super.__getInternalInterface();
  }
  
  /**
   * Gets the value of the VehicleType field.
   * The vehicle type of this lookup
   */
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BusinessVehicleModifierLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BusinessVehicleModifierLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BusinessVehicleModifierLookup.class, config);
    com.guidewire._generated.entity.BusinessVehicleModifierLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BusinessVehicleModifierLookup, com.guidewire._generated.entity.BusinessVehicleModifierLookupInternal>() {
      public java.lang.Object getImplementation(entity.BusinessVehicleModifierLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BusinessVehicleModifierLookupInternal getInternalInterface(entity.BusinessVehicleModifierLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BusinessVehicleModifierLookup newEmptyInstance() {
        return new entity.BusinessVehicleModifierLookup((java.lang.Void)null);
      }

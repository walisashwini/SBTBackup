...
/**
 * CPBlanket
 * Commercial Property Blanket for combining CP coverages into a blanket
 */
...
@gw.entity.EntityName(value = "CPBlanket")
public class CPBlanket extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverable, gw.api.copier.EffDatedCopyable {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.CPBlanket, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.CPBlanket, entity.PolicyPeriod>("entity.CPBlanket");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> BLANKETGROUPTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "BlanketGroupType");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> BUILDINGCOVERAGES_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "BuildingCoverages");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CPBLANKETDESCRIPTION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CPBlanketDescription");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CPBLANKETNUM_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CPBlanketNum");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CPBUILDINGCOVNAME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CPBuildingCovName");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> CPLOCATION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "CPLocation");
  ...
  private com.guidewire._generated.entity.CPBlanketInternal _internal;
   ...
   */
  public CPBlanket(entity.PolicyPeriod branch)  {
   ...
   */
  public CPBlanket(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected CPBlanket(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CPBlanketInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CPBlanketInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToBuildingCoverages(entity.CPBuildingCov element) {
    __getInternalInterface().addArrayElement(BUILDINGCOVERAGES_PROP.get(), element);
  }
  ...
  public entity.CPBlanket clone() {
    return (entity.CPBlanket)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.CPBlanket getBasedOn() {
    return (entity.CPBlanket)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.CPBlanket getBasedOnValue() {
    return (entity.CPBlanket)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public typekey.BlanketGroupType getBlanketGroupType() {
    return (typekey.BlanketGroupType)__getInternalInterface().getFieldValue(BLANKETGROUPTYPE_PROP.get());
  }
  ...
  public entity.CPBuildingCov[] getBuildingCoverages() {
    return (entity.CPBuildingCov[])__getInternalInterface().getFieldValue(BUILDINGCOVERAGES_PROP.get());
  }
  ...
  public java.lang.String getCPBlanketDescription() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CPBLANKETDESCRIPTION_PROP.get());
  }
  ...
  public java.lang.Integer getCPBlanketNum() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(CPBLANKETNUM_PROP.get());
  }
  ...
  public java.lang.String getCPBuildingCovName() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CPBUILDINGCOVNAME_PROP.get());
  }
  ...
  public entity.CPLocation getCPLocation() {
    return (entity.CPLocation)__getInternalInterface().getFieldValue(CPLOCATION_PROP.get());
  }
  ...
  public entity.CPBlanketCov[] getCoverages() {
    return (entity.CPBlanketCov[])__getInternalInterface().getFieldValue(COVERAGES_PROP.get());
  }
  ...
  public entity.CPBlanket getFixed() {
    return (entity.CPBlanket)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.CPBlanket getSlice(java.util.Date sliceDate) {
    return (entity.CPBlanket)getSliceUntyped(sliceDate);
  }
  ...
  public entity.CPBlanket getUnsliced() {
    return (entity.CPBlanket)getUnslicedUntyped();
  }
  ...
  public entity.windowed.CPBlanketVersionList getVersionList() {
    return (entity.windowed.CPBlanketVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromBuildingCoverages(entity.CPBuildingCov element) {
    __getInternalInterface().removeArrayElement(BUILDINGCOVERAGES_PROP.get(), element);
  }
  ...
  public void removeFromBuildingCoverages(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(BUILDINGCOVERAGES_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.CPBlanket value) {
  ...
  public void setBlanketGroupType(typekey.BlanketGroupType value) {
    __getInternalInterface().setFieldValue(BLANKETGROUPTYPE_PROP.get(), value);
  }
  ...
  public void setBuildingCoverages(entity.CPBuildingCov[] value) {
    __getInternalInterface().setFieldValue(BUILDINGCOVERAGES_PROP.get(), value);
  }
  ...
  public void setCPBlanketDescription(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CPBLANKETDESCRIPTION_PROP.get(), value);
  }
  ...
  public void setCPBlanketNum(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(CPBLANKETNUM_PROP.get(), value);
  }
  ...
  public void setCPBuildingCovName(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CPBUILDINGCOVNAME_PROP.get(), value);
  }
  ...
  public void setCPLocation(entity.CPLocation value) {
    __getInternalInterface().setFieldValue(CPLOCATION_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.CPBlanket value) {
  ...
  public entity.CPBlanket split(java.util.Date splitDate) {
    return (entity.CPBlanket)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CPBlanketInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CPBlanket.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getCPLocationID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(CPLOCATION_PROP.get());
    }
    ...
    public void setCPLocationID(gw.pl.persistence.core.Key value) {
      setFieldValue(CPLOCATION_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.copier.EffDatedCopyable", "gw.lob.cp.CPBlanketCopier");
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.cp.CPBlanketCoverableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.cp.CPBlanketCoverableAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CPBlanket.class, config);
    com.guidewire._generated.entity.CPBlanketInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CPBlanket, com.guidewire._generated.entity.CPBlanketInternal>() {
      public java.lang.Object getImplementation(entity.CPBlanket bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CPBlanketInternal getInternalInterface(entity.CPBlanket bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CPBlanket newEmptyInstance() {
        return new entity.CPBlanket((java.lang.Void)null);
      }

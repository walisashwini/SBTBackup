...
@gw.entity.EntityName(value = "CPBlanketCov")
public class CPBlanketCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.CPBlanketCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.CPBlanketCov, entity.PolicyPeriod>("entity.CPBlanketCov");
  ...
  private com.guidewire._generated.entity.CPBlanketCovInternal _internal;
   ...
   */
  protected CPBlanketCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected CPBlanketCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected CPBlanketCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CPBlanketCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CPBlanketCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.CPBlanketCov clone() {
    return (entity.CPBlanketCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.CPBlanketCov getBasedOn() {
    return (entity.CPBlanketCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.CPBlanketCov getBasedOnValue() {
    return (entity.CPBlanketCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.CPBlanketCov getFixed() {
    return (entity.CPBlanketCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.CPBlanketCov getSlice(java.util.Date sliceDate) {
    return (entity.CPBlanketCov)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.CPBlanketCov getSubtype() {
    return (typekey.CPBlanketCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.CPBlanketCov getUnsliced() {
    return (entity.CPBlanketCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.CPBlanketCovVersionList getVersionList() {
    return (entity.windowed.CPBlanketCovVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.CPBlanketCov value) {
   ...
   */
  private void setFixed(entity.CPBlanketCov value) {
   ...
   */
  private void setSubtype(typekey.CPBlanketCov value) {
  ...
  public entity.CPBlanketCov split(java.util.Date splitDate) {
    return (entity.CPBlanketCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CPBlanketCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CPBlanketCov.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.CPBlanketCov value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.CPBlanketCov value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.CPBlanketCov value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.cp.CPBlanketCovCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.cp.CPBlanketCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.cp.CPBlanketCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.cp.CPBlanketCovCoverageAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CPBlanketCov.class, config);
    com.guidewire._generated.entity.CPBlanketCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CPBlanketCov, com.guidewire._generated.entity.CPBlanketCovInternal>() {
      public java.lang.Object getImplementation(entity.CPBlanketCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CPBlanketCovInternal getInternalInterface(entity.CPBlanketCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CPBlanketCov newEmptyInstance() {
        return new entity.CPBlanketCov((java.lang.Void)null);
      }

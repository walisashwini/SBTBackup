...
@gw.entity.EntityName(value = "CPBldgAddlInterest")
public class CPBldgAddlInterest extends entity.AddlInterestDetail implements gw.api.copier.EffDatedCopyable, gw.api.domain.account.Mergeable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.CPBldgAddlInterest, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.CPBldgAddlInterest, entity.PolicyPeriod>("entity.CPBldgAddlInterest");
   ...
   */
  public CPBldgAddlInterest(entity.PolicyPeriod branch)  {
   ...
   */
  public CPBldgAddlInterest(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected CPBldgAddlInterest(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.CPBldgAddlInterestInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CPBldgAddlInterestInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.CPBldgAddlInterestInternal)super.__getInternalInterface();
  }
  
  public entity.CPBldgAddlInterest clone() {
    return (entity.CPBldgAddlInterest)__getInternalInterface().cloneUntyped();
  }
  
  public entity.CPBldgAddlInterest getBasedOn() {
    return (entity.CPBldgAddlInterest)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.CPBldgAddlInterest getSlice(java.util.Date sliceDate) {
    return (entity.CPBldgAddlInterest)getSliceUntyped(sliceDate);
  }
  
  public entity.CPBldgAddlInterest getUnsliced() {
    return (entity.CPBldgAddlInterest)getUnslicedUntyped();
  }
  
  public entity.windowed.CPBldgAddlInterestVersionList getVersionList() {
    return (entity.windowed.CPBldgAddlInterestVersionList)getVersionListUntyped();
  }
  ...
  public entity.CPBldgAddlInterest split(java.util.Date splitDate) {
    return (entity.CPBldgAddlInterest)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CPBldgAddlInterestInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CPBldgAddlInterest.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.account.Mergeable", "gw.lob.cp.CPBldgAddlInterestMergeableImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.cp.CPBldgAddlInterestMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.cp.CPBldgAddlInterestMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CPBldgAddlInterest.class, config);
    com.guidewire._generated.entity.CPBldgAddlInterestInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CPBldgAddlInterest, com.guidewire._generated.entity.CPBldgAddlInterestInternal>() {
      public java.lang.Object getImplementation(entity.CPBldgAddlInterest bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CPBldgAddlInterestInternal getInternalInterface(entity.CPBldgAddlInterest bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CPBldgAddlInterest newEmptyInstance() {
        return new entity.CPBldgAddlInterest((java.lang.Void)null);
      }

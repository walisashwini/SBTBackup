...
@gw.entity.EntityName(value = "CPBuilding")
public class CPBuilding extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverable, gw.api.contact.AdditionalInterestContainer, gw.api.domain.LineSpecificBuilding {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.CPBuilding, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.CPBuilding, entity.PolicyPeriod>("entity.CPBuilding");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> RATETYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "RateType");
  ...
  private com.guidewire._generated.entity.CPBuildingInternal _internal;
   ...
   */
  public CPBuilding(entity.PolicyPeriod branch)  {
   ...
   */
  public CPBuilding(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected CPBuilding(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CPBuildingInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CPBuildingInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.CPBuilding clone() {
    return (entity.CPBuilding)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.CPBldgAddlInterest[] getAdditionalInterests() {
    return (entity.CPBldgAddlInterest[])__getInternalInterface().getFieldValue(ADDITIONALINTERESTS_PROP.get());
  }
  ...
  public entity.CPBuilding getBasedOn() {
    return (entity.CPBuilding)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.CPBuilding getBasedOnValue() {
    return (entity.CPBuilding)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.CPClassCode getClassCode() {
    return (entity.CPClassCode)__getInternalInterface().getFieldValue(CLASSCODE_PROP.get());
  }
  ...
  public entity.CPBuildingCov[] getCoverages() {
    return (entity.CPBuildingCov[])__getInternalInterface().getFieldValue(COVERAGES_PROP.get());
  }
  ...
  public entity.CPBuilding getFixed() {
    return (entity.CPBuilding)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public typekey.RateType getRateType() {
    return (typekey.RateType)__getInternalInterface().getFieldValue(RATETYPE_PROP.get());
  }
  ...
  public entity.CPBuilding getSlice(java.util.Date sliceDate) {
    return (entity.CPBuilding)getSliceUntyped(sliceDate);
  }
  ...
  public entity.CPBuilding getUnsliced() {
    return (entity.CPBuilding)getUnslicedUntyped();
  }
  ...
  public entity.windowed.CPBuildingVersionList getVersionList() {
    return (entity.windowed.CPBuildingVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.CPBuilding value) {
   ...
   */
  private void setFixed(entity.CPBuilding value) {
  ...
  public void setRateType(typekey.RateType value) {
    __getInternalInterface().setFieldValue(RATETYPE_PROP.get(), value);
  }
  ...
  public entity.CPBuilding split(java.util.Date splitDate) {
    return (entity.CPBuilding)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CPBuildingInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CPBuilding.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.contact.AdditionalInterestContainer", "gw.lob.cp.contact.CPBuildingAdditionalInterestContainer");
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.cp.CPBuildingCoverableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.cp.CPBuildingCoverableAdapter");
    config.put("gw.api.domain.LineSpecificBuilding", "gw.lob.cp.CPSpecificBuilding");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CPBuilding.class, config);
    com.guidewire._generated.entity.CPBuildingInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CPBuilding, com.guidewire._generated.entity.CPBuildingInternal>() {
      public java.lang.Object getImplementation(entity.CPBuilding bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CPBuildingInternal getInternalInterface(entity.CPBuilding bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CPBuilding newEmptyInstance() {
        return new entity.CPBuilding((java.lang.Void)null);
      }

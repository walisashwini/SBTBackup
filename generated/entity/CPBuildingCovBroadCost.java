...
/**
 * CPBuildingCovBroadCost
 * A cost for a CPBuildingCov using Broad rates.
 */
...
@gw.entity.EntityName(value = "CPBuildingCovBroadCost")
public class CPBuildingCovBroadCost extends entity.CPBuildingCovCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.CPBuildingCovBroadCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.CPBuildingCovBroadCost, entity.PolicyPeriod>("entity.CPBuildingCovBroadCost");
   ...
   */
  public CPBuildingCovBroadCost(entity.PolicyPeriod branch)  {
   ...
   */
  public CPBuildingCovBroadCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected CPBuildingCovBroadCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.CPBuildingCovBroadCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CPBuildingCovBroadCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.CPBuildingCovBroadCostInternal)super.__getInternalInterface();
  }
  
  public entity.CPBuildingCovBroadCost clone() {
    return (entity.CPBuildingCovBroadCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.CPBuildingCovBroadCost getBasedOn() {
    return (entity.CPBuildingCovBroadCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.CPBuildingCovBroadCost getSlice(java.util.Date sliceDate) {
    return (entity.CPBuildingCovBroadCost)getSliceUntyped(sliceDate);
  }
  
  public entity.CPBuildingCovBroadCost getUnsliced() {
    return (entity.CPBuildingCovBroadCost)getUnslicedUntyped();
  }
  
  public entity.windowed.CPBuildingCovBroadCostVersionList getVersionList() {
    return (entity.windowed.CPBuildingCovBroadCostVersionList)getVersionListUntyped();
  }
  
  public entity.CPBuildingCovBroadCost split(java.util.Date splitDate) {
    return (entity.CPBuildingCovBroadCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CPBuildingCovBroadCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CPBuildingCovBroadCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CPBuildingCovBroadCost.class, config);
    com.guidewire._generated.entity.CPBuildingCovBroadCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CPBuildingCovBroadCost, com.guidewire._generated.entity.CPBuildingCovBroadCostInternal>() {
      public java.lang.Object getImplementation(entity.CPBuildingCovBroadCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CPBuildingCovBroadCostInternal getInternalInterface(entity.CPBuildingCovBroadCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CPBuildingCovBroadCost newEmptyInstance() {
        return new entity.CPBuildingCovBroadCost((java.lang.Void)null);
      }

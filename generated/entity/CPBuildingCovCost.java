...
/**
 * CPBuildingCovCost
 * A unit of price for a period of time, not to be broken up any further, for a Commercial Property building coverage
 */
...
@gw.entity.EntityName(value = "CPBuildingCovCost")
public class CPBuildingCovCost extends entity.CPCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.CPBuildingCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.CPBuildingCovCost, entity.PolicyPeriod>("entity.CPBuildingCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> CPBUILDINGCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "CPBuildingCov");
   ...
   */
  public CPBuildingCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public CPBuildingCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected CPBuildingCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.CPBuildingCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CPBuildingCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.CPBuildingCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.CPBuildingCovCost clone() {
    return (entity.CPBuildingCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.CPBuildingCovCost getBasedOn() {
    return (entity.CPBuildingCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.CPBuildingCov getCPBuildingCov() {
    return (entity.CPBuildingCov)__getInternalInterface().getFieldValue(CPBUILDINGCOV_PROP.get());
  }
  
  public entity.CPBuildingCovCost getSlice(java.util.Date sliceDate) {
    return (entity.CPBuildingCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.CPBuildingCovCost getUnsliced() {
    return (entity.CPBuildingCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.CPBuildingCovCostVersionList getVersionList() {
    return (entity.windowed.CPBuildingCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setCPBuildingCov(entity.CPBuildingCov value) {
    __getInternalInterface().setFieldValue(CPBUILDINGCOV_PROP.get(), value);
  }
  
  public entity.CPBuildingCovCost split(java.util.Date splitDate) {
    return (entity.CPBuildingCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CPBuildingCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CPBuildingCovCost.this.__getDelegateManager();
    }
    ...
    public entity.CPCost getBasedOnValue() {
      return (entity.CPCost)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getCPBuildingCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(CPBUILDINGCOV_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getCommercialPropertyLineID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(COMMERCIALPROPERTYLINE_PROP.get());
    }
    ...
    public entity.CPCost getFixed() {
      return (entity.CPCost)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public typekey.CPCost getSubtype() {
      return (typekey.CPCost)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
    ...
    public entity.CPTransaction[] getTransactions() {
      return (entity.CPTransaction[])__getInternalInterface().getFieldValue(TRANSACTIONS_PROP.get());
    }
    ...
    public void setCPBuildingCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(CPBUILDINGCOV_PROP.get(), value);
    }
    ...
    public void setCommercialPropertyLineID(gw.pl.persistence.core.Key value) {
      setFieldValue(COMMERCIALPROPERTYLINE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.financials.CostAdapter", "gw.lob.cp.financials.CPCostAdapter");
    config.put("gw.lob.cp.financials.CPCostMethods", "gw.lob.cp.financials.CPBuildingCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CPBuildingCovCost.class, config);
    com.guidewire._generated.entity.CPBuildingCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CPBuildingCovCost, com.guidewire._generated.entity.CPBuildingCovCostInternal>() {
      public java.lang.Object getImplementation(entity.CPBuildingCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CPBuildingCovCostInternal getInternalInterface(entity.CPBuildingCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CPBuildingCovCost newEmptyInstance() {
        return new entity.CPBuildingCovCost((java.lang.Void)null);
      }

...
/**
 * CPBuildingCovGrp1Cost
 * A cost for a CPBuildingCov using Group I rates.
 */
...
@gw.entity.EntityName(value = "CPBuildingCovGrp1Cost")
public class CPBuildingCovGrp1Cost extends entity.CPBuildingCovCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.CPBuildingCovGrp1Cost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.CPBuildingCovGrp1Cost, entity.PolicyPeriod>("entity.CPBuildingCovGrp1Cost");
   ...
   */
  public CPBuildingCovGrp1Cost(entity.PolicyPeriod branch)  {
   ...
   */
  public CPBuildingCovGrp1Cost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected CPBuildingCovGrp1Cost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.CPBuildingCovGrp1CostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CPBuildingCovGrp1CostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.CPBuildingCovGrp1CostInternal)super.__getInternalInterface();
  }
  
  public entity.CPBuildingCovGrp1Cost clone() {
    return (entity.CPBuildingCovGrp1Cost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.CPBuildingCovGrp1Cost getBasedOn() {
    return (entity.CPBuildingCovGrp1Cost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.CPBuildingCovGrp1Cost getSlice(java.util.Date sliceDate) {
    return (entity.CPBuildingCovGrp1Cost)getSliceUntyped(sliceDate);
  }
  
  public entity.CPBuildingCovGrp1Cost getUnsliced() {
    return (entity.CPBuildingCovGrp1Cost)getUnslicedUntyped();
  }
  
  public entity.windowed.CPBuildingCovGrp1CostVersionList getVersionList() {
    return (entity.windowed.CPBuildingCovGrp1CostVersionList)getVersionListUntyped();
  }
  
  public entity.CPBuildingCovGrp1Cost split(java.util.Date splitDate) {
    return (entity.CPBuildingCovGrp1Cost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CPBuildingCovGrp1CostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CPBuildingCovGrp1Cost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CPBuildingCovGrp1Cost.class, config);
    com.guidewire._generated.entity.CPBuildingCovGrp1CostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CPBuildingCovGrp1Cost, com.guidewire._generated.entity.CPBuildingCovGrp1CostInternal>() {
      public java.lang.Object getImplementation(entity.CPBuildingCovGrp1Cost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CPBuildingCovGrp1CostInternal getInternalInterface(entity.CPBuildingCovGrp1Cost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CPBuildingCovGrp1Cost newEmptyInstance() {
        return new entity.CPBuildingCovGrp1Cost((java.lang.Void)null);
      }

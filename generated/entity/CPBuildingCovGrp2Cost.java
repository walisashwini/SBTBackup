...
/**
 * CPBuildingCovGrp2Cost
 * A cost for a CPBuildingCov using Group II rates.
 */
...
@gw.entity.EntityName(value = "CPBuildingCovGrp2Cost")
public class CPBuildingCovGrp2Cost extends entity.CPBuildingCovCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.CPBuildingCovGrp2Cost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.CPBuildingCovGrp2Cost, entity.PolicyPeriod>("entity.CPBuildingCovGrp2Cost");
   ...
   */
  public CPBuildingCovGrp2Cost(entity.PolicyPeriod branch)  {
   ...
   */
  public CPBuildingCovGrp2Cost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected CPBuildingCovGrp2Cost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.CPBuildingCovGrp2CostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CPBuildingCovGrp2CostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.CPBuildingCovGrp2CostInternal)super.__getInternalInterface();
  }
  
  public entity.CPBuildingCovGrp2Cost clone() {
    return (entity.CPBuildingCovGrp2Cost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.CPBuildingCovGrp2Cost getBasedOn() {
    return (entity.CPBuildingCovGrp2Cost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.CPBuildingCovGrp2Cost getSlice(java.util.Date sliceDate) {
    return (entity.CPBuildingCovGrp2Cost)getSliceUntyped(sliceDate);
  }
  
  public entity.CPBuildingCovGrp2Cost getUnsliced() {
    return (entity.CPBuildingCovGrp2Cost)getUnslicedUntyped();
  }
  
  public entity.windowed.CPBuildingCovGrp2CostVersionList getVersionList() {
    return (entity.windowed.CPBuildingCovGrp2CostVersionList)getVersionListUntyped();
  }
  
  public entity.CPBuildingCovGrp2Cost split(java.util.Date splitDate) {
    return (entity.CPBuildingCovGrp2Cost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CPBuildingCovGrp2CostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CPBuildingCovGrp2Cost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CPBuildingCovGrp2Cost.class, config);
    com.guidewire._generated.entity.CPBuildingCovGrp2CostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CPBuildingCovGrp2Cost, com.guidewire._generated.entity.CPBuildingCovGrp2CostInternal>() {
      public java.lang.Object getImplementation(entity.CPBuildingCovGrp2Cost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CPBuildingCovGrp2CostInternal getInternalInterface(entity.CPBuildingCovGrp2Cost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CPBuildingCovGrp2Cost newEmptyInstance() {
        return new entity.CPBuildingCovGrp2Cost((java.lang.Void)null);
      }

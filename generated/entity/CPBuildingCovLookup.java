...
/**
 * CPBuildingCovLookup
 * CPBuilding Coverage Lookup Table.
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "CPBuildingCovLookup.eti;CPBuildingCovLookup.eix;CPBuildingCovLookup.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "CPBuildingCovLookup")
public class CPBuildingCovLookup extends entity.CoverageLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CPBuildingCovLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CPBuildingCovLookup>("entity.CPBuildingCovLookup");
   ...
   */
  protected CPBuildingCovLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CPBuildingCovLookup(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.CPBuildingCovLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CPBuildingCovLookupInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.CPBuildingCovLookupInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CPBuildingCovLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CPBuildingCovLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CPBuildingCovLookup.class, config);
    com.guidewire._generated.entity.CPBuildingCovLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CPBuildingCovLookup, com.guidewire._generated.entity.CPBuildingCovLookupInternal>() {
      public java.lang.Object getImplementation(entity.CPBuildingCovLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CPBuildingCovLookupInternal getInternalInterface(entity.CPBuildingCovLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CPBuildingCovLookup newEmptyInstance() {
        return new entity.CPBuildingCovLookup((java.lang.Void)null);
      }

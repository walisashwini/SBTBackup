 ...
 * A cost for a CPBuildingCov using Special rates.
 */
...
@gw.entity.EntityName(value = "CPBuildingCovSpecCost")
public class CPBuildingCovSpecCost extends entity.CPBuildingCovCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.CPBuildingCovSpecCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.CPBuildingCovSpecCost, entity.PolicyPeriod>("entity.CPBuildingCovSpecCost");
   ...
   */
  public CPBuildingCovSpecCost(entity.PolicyPeriod branch)  {
   ...
   */
  public CPBuildingCovSpecCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected CPBuildingCovSpecCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.CPBuildingCovSpecCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CPBuildingCovSpecCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.CPBuildingCovSpecCostInternal)super.__getInternalInterface();
  }
  
  public entity.CPBuildingCovSpecCost clone() {
    return (entity.CPBuildingCovSpecCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.CPBuildingCovSpecCost getBasedOn() {
    return (entity.CPBuildingCovSpecCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.CPBuildingCovSpecCost getSlice(java.util.Date sliceDate) {
    return (entity.CPBuildingCovSpecCost)getSliceUntyped(sliceDate);
  }
  
  public entity.CPBuildingCovSpecCost getUnsliced() {
    return (entity.CPBuildingCovSpecCost)getUnslicedUntyped();
  }
  
  public entity.windowed.CPBuildingCovSpecCostVersionList getVersionList() {
    return (entity.windowed.CPBuildingCovSpecCostVersionList)getVersionListUntyped();
  }
  
  public entity.CPBuildingCovSpecCost split(java.util.Date splitDate) {
    return (entity.CPBuildingCovSpecCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CPBuildingCovSpecCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CPBuildingCovSpecCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CPBuildingCovSpecCost.class, config);
    com.guidewire._generated.entity.CPBuildingCovSpecCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CPBuildingCovSpecCost, com.guidewire._generated.entity.CPBuildingCovSpecCostInternal>() {
      public java.lang.Object getImplementation(entity.CPBuildingCovSpecCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CPBuildingCovSpecCostInternal getInternalInterface(entity.CPBuildingCovSpecCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CPBuildingCovSpecCost newEmptyInstance() {
        return new entity.CPBuildingCovSpecCost((java.lang.Void)null);
      }

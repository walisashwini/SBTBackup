...
/**
 * CPCededPremium
 * A CommercialProperty implementation of the RICededPremium delegate
 */
...
@gw.entity.EntityName(value = "CPCededPremium")
public class CPCededPremium extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.RICededPremium, entity.FrozenSetMember, gw.api.reinsurance.RICededPremiumAdapter {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CPCededPremium> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CPCededPremium>("entity.CPCededPremium");
  ...
  private com.guidewire._generated.entity.CPCededPremiumInternal _internal;
   ...
   */
  public CPCededPremium(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CPCededPremium(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CPCededPremiumInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CPCededPremiumInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.CPCededPremiumHistory[] getCedingHistory() {
    return (entity.CPCededPremiumHistory[])__getInternalInterface().getFieldValue(CEDINGHISTORY_PROP.get());
  }
  ...
  public entity.CPCededPremiumTransaction[] getCedingTransactions() {
    return (entity.CPCededPremiumTransaction[])__getInternalInterface().getFieldValue(CEDINGTRANSACTIONS_PROP.get());
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CPCededPremiumInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CPCededPremium.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.reinsurance.RICededPremiumAdapter", "gw.reinsurance.ceding.CPCededPremiumAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CPCededPremium.class, config);
    com.guidewire._generated.entity.CPCededPremiumInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CPCededPremium, com.guidewire._generated.entity.CPCededPremiumInternal>() {
      public java.lang.Object getImplementation(entity.CPCededPremium bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CPCededPremiumInternal getInternalInterface(entity.CPCededPremium bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CPCededPremium newEmptyInstance() {
        return new entity.CPCededPremium((java.lang.Void)null);
      }

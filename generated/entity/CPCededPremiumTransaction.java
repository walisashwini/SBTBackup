...
/**
 * CPCededPremiumTransaction
 * A CommercialProperty implementation of the RICededPremiumTransaction delegate
 */
...
@gw.entity.EntityName(value = "CPCededPremiumTransaction")
public class CPCededPremiumTransaction extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.RICededPremiumTransaction, entity.FrozenSetMember, gw.api.reinsurance.RICededPremiumTxnAdapter {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CPCededPremiumTransaction> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CPCededPremiumTransaction>("entity.CPCededPremiumTransaction");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> CPCEDEDPREMIUM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "CPCededPremium");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> CPCEDEDPREMIUMHISTORY_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "CPCededPremiumHistory");
  ...
  private com.guidewire._generated.entity.CPCededPremiumTransactionInternal _internal;
   ...
   */
  public CPCededPremiumTransaction()  {
   ...
   */
  public CPCededPremiumTransaction(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CPCededPremiumTransaction(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CPCededPremiumTransactionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CPCededPremiumTransactionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.CPCededPremium getCPCededPremium() {
    return (entity.CPCededPremium)__getInternalInterface().getFieldValue(CPCEDEDPREMIUM_PROP.get());
  }
  ...
  public entity.CPCededPremiumHistory getCPCededPremiumHistory() {
    return (entity.CPCededPremiumHistory)__getInternalInterface().getFieldValue(CPCEDEDPREMIUMHISTORY_PROP.get());
  }
  ...
  public void setCPCededPremium(entity.CPCededPremium value) {
    __getInternalInterface().setFieldValue(CPCEDEDPREMIUM_PROP.get(), value);
  }
  ...
  public void setCPCededPremiumHistory(entity.CPCededPremiumHistory value) {
    __getInternalInterface().setFieldValue(CPCEDEDPREMIUMHISTORY_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CPCededPremiumTransactionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CPCededPremiumTransaction.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getCPCededPremiumHistoryID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(CPCEDEDPREMIUMHISTORY_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getCPCededPremiumID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(CPCEDEDPREMIUM_PROP.get());
    }
    ...
    public void setCPCededPremiumHistoryID(gw.pl.persistence.core.Key value) {
      setFieldValue(CPCEDEDPREMIUMHISTORY_PROP.get(), value);
    }
    
    public void setCPCededPremiumID(gw.pl.persistence.core.Key value) {
      setFieldValue(CPCEDEDPREMIUM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.reinsurance.RICededPremiumTxnAdapter", "gw.reinsurance.ceding.CPCededPremiumTransactionAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CPCededPremiumTransaction.class, config);
    com.guidewire._generated.entity.CPCededPremiumTransactionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CPCededPremiumTransaction, com.guidewire._generated.entity.CPCededPremiumTransactionInternal>() {
      public java.lang.Object getImplementation(entity.CPCededPremiumTransaction bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CPCededPremiumTransactionInternal getInternalInterface(entity.CPCededPremiumTransaction bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CPCededPremiumTransaction newEmptyInstance() {
        return new entity.CPCededPremiumTransaction((java.lang.Void)null);
      }

...
/**
 * CPClassCode
 * Commercial property building class codes.  Premium calculations are driven by class codes and both premium and losses are reported by class codes to rating bureaus.
 */
...
@gw.entity.EntityName(value = "CPClassCode")
public class CPClassCode extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated, entity.AbstractBuildingClassCode {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CPClassCode> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CPClassCode>("entity.CPClassCode");
  ...
  private com.guidewire._generated.entity.CPClassCodeInternal _internal;
   ...
   */
  public CPClassCode(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CPClassCode(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CPClassCodeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CPClassCodeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.CPClassCode_Classification_L10N[] getClassification_L10N_ARRAY() {
    return (entity.CPClassCode_Classification_L10N[])__getInternalInterface().getFieldValue(CLASSIFICATION_L10N_ARRAY_PROP.get());
  }
   ...
   */
  private void setClassification_L10N_ARRAY(entity.CPClassCode_Classification_L10N[] value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CPClassCodeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CPClassCode.this.__getDelegateManager();
    }
    ...
    public entity.CPClassCode_Classification_L10N getClassification_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.CPClassCode_Classification_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CPClassCode.class, config);
    com.guidewire._generated.entity.CPClassCodeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CPClassCode, com.guidewire._generated.entity.CPClassCodeInternal>() {
      public java.lang.Object getImplementation(entity.CPClassCode bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CPClassCodeInternal getInternalInterface(entity.CPClassCode bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CPClassCode newEmptyInstance() {
        return new entity.CPClassCode((java.lang.Void)null);
      }

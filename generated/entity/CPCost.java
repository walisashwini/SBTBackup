...
/**
 * CPCost
 * A CommercialProperty unit of price for a period of time, not to be broken up any further
 */
...
public abstract class CPCost extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.CPCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.CPCost, entity.PolicyPeriod>("entity.CPCost");
  ...
  private com.guidewire._generated.entity.CPCostInternal _internal;
  ...
  protected CPCost(java.lang.Void ignored)  {
    
  }
  
  protected abstract com.guidewire._generated.entity.CPCostInternal __createInternalInterface();
  ...
  protected com.guidewire._generated.entity.CPCostInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.CPCost clone() {
    return (entity.CPCost)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.CPCost getBasedOn() {
    return (entity.CPCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.CPCost getSlice(java.util.Date sliceDate) {
    return (entity.CPCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.CPCost getUnsliced() {
    return (entity.CPCost)getUnslicedUntyped();
  }
  ...
  public entity.windowed.CPCostVersionList getVersionList() {
    return (entity.windowed.CPCostVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.CPCost value) {
   ...
   */
  private void setFixed(entity.CPCost value) {
   ...
   */
  private void setSubtype(typekey.CPCost value) {
   ...
   */
  private void setTransactions(entity.CPTransaction[] value) {
  ...
  public entity.CPCost split(java.util.Date splitDate) {
    return (entity.CPCost)splitUntyped(splitDate);
  }
  ...
  static {
    com.guidewire._generated.entity.CPCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.EntityFriendAccess<entity.CPCost, com.guidewire._generated.entity.CPCostInternal>() {
      public java.lang.Object getImplementation(entity.CPCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CPCostInternal getInternalInterface(entity.CPCost bean) {
        if(bean == null) {
          return null;
        };

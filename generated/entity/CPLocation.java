...
@gw.entity.EntityName(value = "CPLocation")
public class CPLocation extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverable, gw.api.copier.EffDatedCopyable, gw.api.domain.LineSpecificLocation, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.CPLocation, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.CPLocation, entity.PolicyPeriod>("entity.CPLocation");
  ...
  private com.guidewire._generated.entity.CPLocationInternal _internal;
   ...
   */
  public CPLocation(entity.PolicyPeriod branch)  {
   ...
   */
  public CPLocation(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected CPLocation(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CPLocationInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CPLocationInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.CPLocation clone() {
    return (entity.CPLocation)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.CPLocation getBasedOn() {
    return (entity.CPLocation)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.CPLocation getBasedOnValue() {
    return (entity.CPLocation)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.CPBuilding[] getBuildings() {
    return (entity.CPBuilding[])__getInternalInterface().getFieldValue(BUILDINGS_PROP.get());
  }
  ...
  public entity.CPLocationCov[] getCoverages() {
    return (entity.CPLocationCov[])__getInternalInterface().getFieldValue(COVERAGES_PROP.get());
  }
  ...
  public entity.CPLocation getFixed() {
    return (entity.CPLocation)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.CPLocation getSlice(java.util.Date sliceDate) {
    return (entity.CPLocation)getSliceUntyped(sliceDate);
  }
  ...
  public entity.CPLocation getUnsliced() {
    return (entity.CPLocation)getUnslicedUntyped();
  }
  ...
  public entity.windowed.CPLocationVersionList getVersionList() {
    return (entity.windowed.CPLocationVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.CPLocation value) {
   ...
   */
  private void setFixed(entity.CPLocation value) {
  ...
  public entity.CPLocation split(java.util.Date splitDate) {
    return (entity.CPLocation)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CPLocationInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CPLocation.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.copier.EffDatedCopyable", "gw.lob.cp.CPLocationEffDatedCopier");
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.cp.CPLocationCoverableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.cp.CPLocationCoverableAdapter");
    config.put("gw.api.domain.LineSpecificLocation", "gw.lob.cp.CPSpecificLocation");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.cp.CPLocationMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.cp.CPLocationMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CPLocation.class, config);
    com.guidewire._generated.entity.CPLocationInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CPLocation, com.guidewire._generated.entity.CPLocationInternal>() {
      public java.lang.Object getImplementation(entity.CPLocation bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CPLocationInternal getInternalInterface(entity.CPLocation bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CPLocation newEmptyInstance() {
        return new entity.CPLocation((java.lang.Void)null);
      }

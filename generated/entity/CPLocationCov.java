...
/**
 * CPLocationCov
 * A location-level coverage for Commercial Property
 */
...
@gw.entity.EntityName(value = "CPLocationCov")
public class CPLocationCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.CPLocationCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.CPLocationCov, entity.PolicyPeriod>("entity.CPLocationCov");
  ...
  private com.guidewire._generated.entity.CPLocationCovInternal _internal;
   ...
   */
  protected CPLocationCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected CPLocationCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected CPLocationCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CPLocationCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CPLocationCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.CPLocationCov clone() {
    return (entity.CPLocationCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.CPLocationCov getBasedOn() {
    return (entity.CPLocationCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.CPLocationCov getBasedOnValue() {
    return (entity.CPLocationCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.CPLocationCov getFixed() {
    return (entity.CPLocationCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.CPLocationCov getSlice(java.util.Date sliceDate) {
    return (entity.CPLocationCov)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.CPLocationCov getSubtype() {
    return (typekey.CPLocationCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.CPLocationCov getUnsliced() {
    return (entity.CPLocationCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.CPLocationCovVersionList getVersionList() {
    return (entity.windowed.CPLocationCovVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.CPLocationCov value) {
   ...
   */
  private void setFixed(entity.CPLocationCov value) {
   ...
   */
  private void setSubtype(typekey.CPLocationCov value) {
  ...
  public entity.CPLocationCov split(java.util.Date splitDate) {
    return (entity.CPLocationCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CPLocationCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CPLocationCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.cp.CPLocationCovCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.cp.CPLocationCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.cp.CPLocationCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.cp.CPLocationCovCoverageAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.cp.CPLocationCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.cp.CPLocationCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CPLocationCov.class, config);
    com.guidewire._generated.entity.CPLocationCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CPLocationCov, com.guidewire._generated.entity.CPLocationCovInternal>() {
      public java.lang.Object getImplementation(entity.CPLocationCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CPLocationCovInternal getInternalInterface(entity.CPLocationCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CPLocationCov newEmptyInstance() {
        return new entity.CPLocationCov((java.lang.Void)null);
      }

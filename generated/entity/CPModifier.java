...
/**
 * CPModifier
 * A line-level modifier for Commercial Property
 */
...
@gw.entity.EntityName(value = "CPModifier")
public class CPModifier extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Modifier, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.CPModifier, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.CPModifier, entity.PolicyPeriod>("entity.CPModifier");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> CPRATEFACTORS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "CPRateFactors");
  ...
  private com.guidewire._generated.entity.CPModifierInternal _internal;
   ...
   */
  public CPModifier(entity.PolicyPeriod branch)  {
   ...
   */
  public CPModifier(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected CPModifier(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CPModifierInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CPModifierInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToCPRateFactors(entity.CPRateFactor element) {
    __getInternalInterface().addArrayElement(CPRATEFACTORS_PROP.get(), element);
  }
  ...
  public entity.CPModifier clone() {
    return (entity.CPModifier)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.CPModifier getBasedOn() {
    return (entity.CPModifier)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.CPModifier getBasedOnValue() {
    return (entity.CPModifier)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.CPRateFactor[] getCPRateFactors() {
    return (entity.CPRateFactor[])__getInternalInterface().getFieldValue(CPRATEFACTORS_PROP.get());
  }
  ...
  public entity.CPModifier getFixed() {
    return (entity.CPModifier)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.CPModifier getSlice(java.util.Date sliceDate) {
    return (entity.CPModifier)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.CPModifier getSubtype() {
    return (typekey.CPModifier)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.CPModifier getUnsliced() {
    return (entity.CPModifier)getUnslicedUntyped();
  }
  ...
  public entity.windowed.CPModifierVersionList getVersionList() {
    return (entity.windowed.CPModifierVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromCPRateFactors(entity.CPRateFactor element) {
    __getInternalInterface().removeArrayElement(CPRATEFACTORS_PROP.get(), element);
  }
  ...
  public void removeFromCPRateFactors(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(CPRATEFACTORS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.CPModifier value) {
  ...
  public void setCPRateFactors(entity.CPRateFactor[] value) {
    __getInternalInterface().setFieldValue(CPRATEFACTORS_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.CPModifier value) {
   ...
   */
  private void setSubtype(typekey.CPModifier value) {
  ...
  public entity.CPModifier split(java.util.Date splitDate) {
    return (entity.CPModifier)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CPModifierInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CPModifier.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ModifierAbstractDomainMethods", "gw.lob.cp.CPModifierAdapter");
    config.put("gw.api.domain.ModifierAdapter", "gw.lob.cp.CPModifierAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.cp.CPModifierMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.cp.CPModifierMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CPModifier.class, config);
    com.guidewire._generated.entity.CPModifierInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CPModifier, com.guidewire._generated.entity.CPModifierInternal>() {
      public java.lang.Object getImplementation(entity.CPModifier bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CPModifierInternal getInternalInterface(entity.CPModifier bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CPModifier newEmptyInstance() {
        return new entity.CPModifier((java.lang.Void)null);
      }

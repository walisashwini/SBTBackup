...
@gw.entity.EntityName(value = "CPRateFactor")
public class CPRateFactor extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.RateFactor, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.CPRateFactor, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.CPRateFactor, entity.PolicyPeriod>("entity.CPRateFactor");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> CPMODIFIER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "CPModifier");
  ...
  private com.guidewire._generated.entity.CPRateFactorInternal _internal;
   ...
   */
  public CPRateFactor(entity.PolicyPeriod branch)  {
   ...
   */
  public CPRateFactor(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected CPRateFactor(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CPRateFactorInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CPRateFactorInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.CPRateFactor clone() {
    return (entity.CPRateFactor)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.CPRateFactor getBasedOn() {
    return (entity.CPRateFactor)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.CPRateFactor getBasedOnValue() {
    return (entity.CPRateFactor)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.CPModifier getCPModifier() {
    return (entity.CPModifier)__getInternalInterface().getFieldValue(CPMODIFIER_PROP.get());
  }
  ...
  public entity.CPRateFactor getFixed() {
    return (entity.CPRateFactor)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.CPRateFactor getSlice(java.util.Date sliceDate) {
    return (entity.CPRateFactor)getSliceUntyped(sliceDate);
  }
  ...
  public entity.CPRateFactor getUnsliced() {
    return (entity.CPRateFactor)getUnslicedUntyped();
  }
  ...
  public entity.windowed.CPRateFactorVersionList getVersionList() {
    return (entity.windowed.CPRateFactorVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.CPRateFactor value) {
  ...
  public void setCPModifier(entity.CPModifier value) {
    __getInternalInterface().setFieldValue(CPMODIFIER_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.CPRateFactor value) {
  ...
  public entity.CPRateFactor split(java.util.Date splitDate) {
    return (entity.CPRateFactor)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CPRateFactorInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CPRateFactor.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getCPModifierID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(CPMODIFIER_PROP.get());
    }
    ...
    public void setCPModifierID(gw.pl.persistence.core.Key value) {
      setFieldValue(CPMODIFIER_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.RateFactorAdapter", "gw.lob.cp.CPRateFactorAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.cp.CPRateFactorMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.cp.CPRateFactorMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CPRateFactor.class, config);
    com.guidewire._generated.entity.CPRateFactorInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CPRateFactor, com.guidewire._generated.entity.CPRateFactorInternal>() {
      public java.lang.Object getImplementation(entity.CPRateFactor bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CPRateFactorInternal getInternalInterface(entity.CPRateFactor bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CPRateFactor newEmptyInstance() {
        return new entity.CPRateFactor((java.lang.Void)null);
      }

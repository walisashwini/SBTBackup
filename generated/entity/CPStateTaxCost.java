...
/**
 * CPStateTaxCost
 * State tax costs for Commercial Property
 */
...
@gw.entity.EntityName(value = "CPStateTaxCost")
public class CPStateTaxCost extends entity.CPCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.CPStateTaxCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.CPStateTaxCost, entity.PolicyPeriod>("entity.CPStateTaxCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> TAXSTATE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "TaxState");
   ...
   */
  public CPStateTaxCost(entity.PolicyPeriod branch)  {
   ...
   */
  public CPStateTaxCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected CPStateTaxCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.CPStateTaxCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CPStateTaxCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.CPStateTaxCostInternal)super.__getInternalInterface();
  }
  
  public entity.CPStateTaxCost clone() {
    return (entity.CPStateTaxCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.CPStateTaxCost getBasedOn() {
    return (entity.CPStateTaxCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.CPStateTaxCost getSlice(java.util.Date sliceDate) {
    return (entity.CPStateTaxCost)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.Jurisdiction getTaxState() {
    return (typekey.Jurisdiction)__getInternalInterface().getFieldValue(TAXSTATE_PROP.get());
  }
  
  public entity.CPStateTaxCost getUnsliced() {
    return (entity.CPStateTaxCost)getUnslicedUntyped();
  }
  
  public entity.windowed.CPStateTaxCostVersionList getVersionList() {
    return (entity.windowed.CPStateTaxCostVersionList)getVersionListUntyped();
  }
  ...
  public void setTaxState(typekey.Jurisdiction value) {
    __getInternalInterface().setFieldValue(TAXSTATE_PROP.get(), value);
  }
  
  public entity.CPStateTaxCost split(java.util.Date splitDate) {
    return (entity.CPStateTaxCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CPStateTaxCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CPStateTaxCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.cp.financials.CPCostMethods", "gw.lob.cp.financials.CPStateTaxCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CPStateTaxCost.class, config);
    com.guidewire._generated.entity.CPStateTaxCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CPStateTaxCost, com.guidewire._generated.entity.CPStateTaxCostInternal>() {
      public java.lang.Object getImplementation(entity.CPStateTaxCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CPStateTaxCostInternal getInternalInterface(entity.CPStateTaxCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CPStateTaxCost newEmptyInstance() {
        return new entity.CPStateTaxCost((java.lang.Void)null);
      }

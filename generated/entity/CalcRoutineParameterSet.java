 ...
 * Calculation routine parameter set
 */
...
@gw.entity.EntityName(value = "CalcRoutineParameterSet")
public class CalcRoutineParameterSet extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CalcRoutineParameterSet> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CalcRoutineParameterSet>("entity.CalcRoutineParameterSet");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> INCLUDESCOST_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "IncludesCost");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> PARAMETERS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "Parameters");
  ...
  private com.guidewire._generated.entity.CalcRoutineParameterSetInternal _internal;
   ...
   */
  public CalcRoutineParameterSet()  {
   ...
   */
  public CalcRoutineParameterSet(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CalcRoutineParameterSet(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CalcRoutineParameterSetInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CalcRoutineParameterSetInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToParameters(entity.CalcRoutineParameter element) {
    __getInternalInterface().addArrayElement(PARAMETERS_PROP.get(), element);
  }
  ...
  public entity.CalcRoutineParameterSet_Name_L10N[] getName_L10N_ARRAY() {
    return (entity.CalcRoutineParameterSet_Name_L10N[])__getInternalInterface().getFieldValue(NAME_L10N_ARRAY_PROP.get());
  }
  ...
  public entity.CalcRoutineParameter[] getParameters() {
    return (entity.CalcRoutineParameter[])__getInternalInterface().getFieldValue(PARAMETERS_PROP.get());
  }
  ...
  public java.lang.Boolean isIncludesCost() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(INCLUDESCOST_PROP.get());
  }
  ...
  public void removeFromParameters(entity.CalcRoutineParameter element) {
    __getInternalInterface().removeArrayElement(PARAMETERS_PROP.get(), element);
  }
  ...
  public void removeFromParameters(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(PARAMETERS_PROP.get(), elementID);
  }
  ...
  public void setIncludesCost(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(INCLUDESCOST_PROP.get(), value);
  }
   ...
   */
  private void setName_L10N_ARRAY(entity.CalcRoutineParameterSet_Name_L10N[] value) {
  ...
  public void setParameters(entity.CalcRoutineParameter[] value) {
    __getInternalInterface().setFieldValue(PARAMETERS_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CalcRoutineParameterSetInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CalcRoutineParameterSet.this.__getDelegateManager();
    }
    ...
    public entity.CalcRoutineParameterSet_Name_L10N getName_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.CalcRoutineParameterSet_Name_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CalcRoutineParameterSet.class, config);
    com.guidewire._generated.entity.CalcRoutineParameterSetInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CalcRoutineParameterSet, com.guidewire._generated.entity.CalcRoutineParameterSetInternal>() {
      public java.lang.Object getImplementation(entity.CalcRoutineParameterSet bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CalcRoutineParameterSetInternal getInternalInterface(entity.CalcRoutineParameterSet bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CalcRoutineParameterSet newEmptyInstance() {
        return new entity.CalcRoutineParameterSet((java.lang.Void)null);
      }

 ...
 * Operand for a calculation step
 */
...
@gw.entity.EntityName(value = "CalcStepDefinitionOperand")
public class CalcStepDefinitionOperand extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.CalcStepValueDelegate {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CalcStepDefinitionOperand> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CalcStepDefinitionOperand>("entity.CalcStepDefinitionOperand");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ARGUMENTSOURCESETCODE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ArgumentSourceSetCode");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> CALCSTEP_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "CalcStep");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> FUNCTIONNAME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "FunctionName");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LEFTPARENTHESISGROUP_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LeftParenthesisGroup");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LOGICALNOT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LogicalNot");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> OPERANDORDER_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "OperandOrder");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> OPERATORTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "OperatorType");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PUBLICID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PublicID");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> RETIREDVALUE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "RetiredValue");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> RETURNFACTORCOLUMNS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "ReturnFactorColumns");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> RIGHTPARENTHESISGROUP_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "RightParenthesisGroup");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> ROUNDINGSCALETYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "RoundingScaleType");
  ...
  private com.guidewire._generated.entity.CalcStepDefinitionOperandInternal _internal;
   ...
   */
  public CalcStepDefinitionOperand()  {
   ...
   */
  public CalcStepDefinitionOperand(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CalcStepDefinitionOperand(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CalcStepDefinitionOperandInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CalcStepDefinitionOperandInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToReturnFactorColumns(entity.CalcStepDefinitionRateFactor element) {
    __getInternalInterface().addArrayElement(RETURNFACTORCOLUMNS_PROP.get(), element);
  }
  ...
  public java.lang.String getArgumentSourceSetCode() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(ARGUMENTSOURCESETCODE_PROP.get());
  }
  ...
  public entity.CalcStepDefinitionArgument[] getArgumentSources() {
    return (entity.CalcStepDefinitionArgument[])__getInternalInterface().getFieldValue(ARGUMENTSOURCES_PROP.get());
  }
  ...
  public entity.CalcStepDefinition getCalcStep() {
    return (entity.CalcStepDefinition)__getInternalInterface().getFieldValue(CALCSTEP_PROP.get());
  }
  ...
  public java.lang.String getFunctionName() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(FUNCTIONNAME_PROP.get());
  }
  ...
  public java.lang.String getLeftParenthesisGroup() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(LEFTPARENTHESISGROUP_PROP.get());
  }
  ...
  public java.lang.Integer getOperandOrder() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(OPERANDORDER_PROP.get());
  }
  ...
  public typekey.CalcStepOperatorType getOperatorType() {
    return (typekey.CalcStepOperatorType)__getInternalInterface().getFieldValue(OPERATORTYPE_PROP.get());
  }
  ...
  public entity.CalcStepDefinitionRateFactor[] getReturnFactorColumns() {
    return (entity.CalcStepDefinitionRateFactor[])__getInternalInterface().getFieldValue(RETURNFACTORCOLUMNS_PROP.get());
  }
  ...
  public java.lang.String getRightParenthesisGroup() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(RIGHTPARENTHESISGROUP_PROP.get());
  }
  ...
  public typekey.RoundingScaleType getRoundingScaleType() {
    return (typekey.RoundingScaleType)__getInternalInterface().getFieldValue(ROUNDINGSCALETYPE_PROP.get());
  }
  ...
  public java.lang.Boolean isLogicalNot() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(LOGICALNOT_PROP.get());
  }
  ...
  public void removeFromReturnFactorColumns(entity.CalcStepDefinitionRateFactor element) {
    __getInternalInterface().removeArrayElement(RETURNFACTORCOLUMNS_PROP.get(), element);
  }
  ...
  public void removeFromReturnFactorColumns(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(RETURNFACTORCOLUMNS_PROP.get(), elementID);
  }
  ...
  public void setArgumentSourceSetCode(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(ARGUMENTSOURCESETCODE_PROP.get(), value);
  }
  ...
  public void setCalcStep(entity.CalcStepDefinition value) {
    __getInternalInterface().setFieldValue(CALCSTEP_PROP.get(), value);
  }
  ...
  public void setFunctionName(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(FUNCTIONNAME_PROP.get(), value);
  }
  ...
  public void setLeftParenthesisGroup(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(LEFTPARENTHESISGROUP_PROP.get(), value);
  }
  ...
  public void setLogicalNot(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(LOGICALNOT_PROP.get(), value);
  }
  ...
  public void setOperandOrder(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(OPERANDORDER_PROP.get(), value);
  }
  ...
  public void setOperatorType(typekey.CalcStepOperatorType value) {
    __getInternalInterface().setFieldValue(OPERATORTYPE_PROP.get(), value);
  }
  ...
  public void setReturnFactorColumns(entity.CalcStepDefinitionRateFactor[] value) {
    __getInternalInterface().setFieldValue(RETURNFACTORCOLUMNS_PROP.get(), value);
  }
  ...
  public void setRightParenthesisGroup(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(RIGHTPARENTHESISGROUP_PROP.get(), value);
  }
  ...
  public void setRoundingScaleType(typekey.RoundingScaleType value) {
    __getInternalInterface().setFieldValue(ROUNDINGSCALETYPE_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CalcStepDefinitionOperandInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CalcStepDefinitionOperand.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getCalcStepID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(CALCSTEP_PROP.get());
    }
    ...
    public void setCalcStepID(gw.pl.persistence.core.Key value) {
      setFieldValue(CALCSTEP_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.rating.flow.CalcStepValueDelegateAdapter", "gw.rating.flow.CalcStepDefinitionOperandAdapter");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CalcStepDefinitionOperand.class, config);
    com.guidewire._generated.entity.CalcStepDefinitionOperandInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CalcStepDefinitionOperand, com.guidewire._generated.entity.CalcStepDefinitionOperandInternal>() {
      public java.lang.Object getImplementation(entity.CalcStepDefinitionOperand bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CalcStepDefinitionOperandInternal getInternalInterface(entity.CalcStepDefinitionOperand bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CalcStepDefinitionOperand newEmptyInstance() {
        return new entity.CalcStepDefinitionOperand((java.lang.Void)null);
      }

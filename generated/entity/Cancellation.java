...
@gw.entity.EntityName(value = "Cancellation")
public class Cancellation extends entity.Job implements entity.EventAware {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.Cancellation> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.Cancellation>("entity.Cancellation");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CANCELPROCESSDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CancelProcessDate");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> CANCELREASONCODE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "CancelReasonCode");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> INITIALNOTIFICATIONDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "InitialNotificationDate");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LASTNOTIFIEDCANCELLATIONDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LastNotifiedCancellationDate");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> NOTIFICATIONACKDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "NotificationAckDate");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> NOTIFICATIONDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "NotificationDate");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> QUOTEONSTART_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "QuoteOnStart");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> RESCINDNOTIFICATIONDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "RescindNotificationDate");
  ...
  public static final java.lang.String CANCELLATIONADDED_EVENT = "CancellationAdded";
  
  public static final java.lang.String CANCELLATIONCHANGED_EVENT = "CancellationChanged";
  
  public static final java.lang.String CANCELLATIONREMOVED_EVENT = "CancellationRemoved";
   ...
   */
  public Cancellation(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected Cancellation(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.CancellationInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CancellationInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.CancellationInternal)super.__getInternalInterface();
  }
  ...
  public java.util.Date getCancelProcessDate() {
    return (java.util.Date)__getInternalInterface().getFieldValue(CANCELPROCESSDATE_PROP.get());
  }
  ...
  public typekey.ReasonCode getCancelReasonCode() {
    return (typekey.ReasonCode)__getInternalInterface().getFieldValue(CANCELREASONCODE_PROP.get());
  }
  ...
  public java.util.Date getInitialNotificationDate() {
    return (java.util.Date)__getInternalInterface().getFieldValue(INITIALNOTIFICATIONDATE_PROP.get());
  }
  ...
  public java.util.Date getLastNotifiedCancellationDate() {
    return (java.util.Date)__getInternalInterface().getFieldValue(LASTNOTIFIEDCANCELLATIONDATE_PROP.get());
  }
  ...
  public java.util.Date getNotificationAckDate() {
    return (java.util.Date)__getInternalInterface().getFieldValue(NOTIFICATIONACKDATE_PROP.get());
  }
  ...
  public java.util.Date getNotificationDate() {
    return (java.util.Date)__getInternalInterface().getFieldValue(NOTIFICATIONDATE_PROP.get());
  }
  
  /**
   * Gets the PolicyPeriod associated with this cancellation job.
   * There is only one period associated with a cancellation, because a
   * cancellation has only one branch.
   * @return the policy period for the job
   */
  public entity.PolicyPeriod getPolicyPeriod() {
    return ((com.guidewire.pc.domain.job.CancellationPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.CancellationPublicMethods")).getPolicyPeriod();
  }
  ...
  public java.util.Date getRescindNotificationDate() {
    return (java.util.Date)__getInternalInterface().getFieldValue(RESCINDNOTIFICATIONDATE_PROP.get());
  }
  ...
  public typekey.CancellationSource getSource() {
    return (typekey.CancellationSource)__getInternalInterface().getFieldValue(SOURCE_PROP.get());
  }
  
  /**
   * Returns true if this Cancellation is part of a rewrite, as indicated by
   * the value of {@link entity.Cancellation#getCancelReasonCode()}.
   * @return true if part of rewrite
   */
  public boolean isForRewrite() {
    return ((com.guidewire.pc.domain.job.CancellationPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.CancellationPublicMethods")).isForRewrite();
  }
  ...
  public java.lang.Boolean isQuoteOnStart() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(QUOTEONSTART_PROP.get());
  }
  ...
  public void setCancelProcessDate(java.util.Date value) {
    __getInternalInterface().setFieldValue(CANCELPROCESSDATE_PROP.get(), value);
  }
  ...
  public void setCancelReasonCode(typekey.ReasonCode value) {
    __getInternalInterface().setFieldValue(CANCELREASONCODE_PROP.get(), value);
  }
  ...
  public void setInitialNotificationDate(java.util.Date value) {
    __getInternalInterface().setFieldValue(INITIALNOTIFICATIONDATE_PROP.get(), value);
  }
  ...
  public void setLastNotifiedCancellationDate(java.util.Date value) {
    __getInternalInterface().setFieldValue(LASTNOTIFIEDCANCELLATIONDATE_PROP.get(), value);
  }
  ...
  public void setNotificationAckDate(java.util.Date value) {
    __getInternalInterface().setFieldValue(NOTIFICATIONACKDATE_PROP.get(), value);
  }
  ...
  public void setNotificationDate(java.util.Date value) {
    __getInternalInterface().setFieldValue(NOTIFICATIONDATE_PROP.get(), value);
  }
  ...
  public void setQuoteOnStart(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(QUOTEONSTART_PROP.get(), value);
  }
  ...
  public void setRescindNotificationDate(java.util.Date value) {
    __getInternalInterface().setFieldValue(RESCINDNOTIFICATIONDATE_PROP.get(), value);
  }
  ...
  /**
   * Starts a cancellation job on the latest bound period of the passed-in policy that includes the given effective date.
   * @param policy The policy for which the job is to be started
   * @param effDate The date at which the job should be started.
   * @param refundCalcMethod the calculation method used to figure the refund
   * @throws com.guidewire.pl.web.controller.UserDisplayableException if the job cannot be started
   */
  public void startJob(entity.Policy policy, java.util.Date effDate, typekey.CalculationMethod refundCalcMethod) throws com.guidewire.pl.web.controller.UserDisplayableException {
    ((com.guidewire.pc.domain.job.CancellationPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.CancellationPublicMethods")).startJob(policy, effDate, refundCalcMethod);
  }
   ...
   */
  public boolean startJobAndCommit(entity.Policy policy, java.util.Date effDate, typekey.CalculationMethod refundCalcMethod, pcf.api.Location location) {
    return ((com.guidewire.pc.domain.job.CancellationPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.CancellationPublicMethods")).startJobAndCommit(policy, effDate, refundCalcMethod, location);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CancellationInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.Cancellation.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.job.CancellationPublicMethods", "com.guidewire.pc.domain.job.impl.CancellationImpl");
    config.put("com.guidewire.pc.domain.job.JobPublicMethods", "com.guidewire.pc.domain.job.impl.CancellationImpl");
    config.put("com.guidewire.pc.domain.job.impl.JobInternalMethods", "com.guidewire.pc.domain.job.impl.JobImpl");
    config.put("com.guidewire.pc.domain.note.NoteContainer", "com.guidewire.pc.domain.job.impl.CancellationImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.job.impl.CancellationImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.pc.domain.job.impl.JobImpl");
    config.put("com.guidewire.pl.system.entity.DoesNotValidateOnCommit", "com.guidewire.pc.domain.job.impl.CancellationImpl");
    config.put("gw.api.assignment.UserRoleOwner", "com.guidewire.pc.domain.job.impl.CancellationImpl");
    config.put("gw.api.domain.document.DocumentContainer", "com.guidewire.pc.domain.job.impl.CancellationImpl");
    config.put("gw.api.domain.linkedobject.LinkedObjectContainer", "com.guidewire.pc.domain.job.impl.CancellationImpl");
    config.put("gw.api.history.CustomHistory", "gw.api.history.JobCustomHistoryImpl");
    config.put("gw.api.job.JobMethods", "gw.api.job.CancellationJobMethods");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.Cancellation.class, config);
    com.guidewire._generated.entity.CancellationInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.Cancellation, com.guidewire._generated.entity.CancellationInternal>() {
      public java.lang.Object getImplementation(entity.Cancellation bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CancellationInternal getInternalInterface(entity.Cancellation bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.Cancellation newEmptyInstance() {
        return new entity.Cancellation((java.lang.Void)null);
      }

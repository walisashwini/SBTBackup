 ...
 * ClaimsInfoContact
 * 
 *     A person at an insured entity, or a delegated company, who would be the
 *     primary source of information to set up and update claims for an account or
 *     underlying policy.
 * 
 *   
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ClaimsInfoContact.eti;ClaimsInfoContact.eix;ClaimsInfoContact.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ClaimsInfoContact")
public class ClaimsInfoContact extends entity.AccountContactRole {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ClaimsInfoContact> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ClaimsInfoContact>("entity.ClaimsInfoContact");
   ...
   */
  public ClaimsInfoContact(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ClaimsInfoContact(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ClaimsInfoContactInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ClaimsInfoContactInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ClaimsInfoContactInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ClaimsInfoContactInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ClaimsInfoContact.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ClaimsInfoContact.class, config);
    com.guidewire._generated.entity.ClaimsInfoContactInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ClaimsInfoContact, com.guidewire._generated.entity.ClaimsInfoContactInternal>() {
      public java.lang.Object getImplementation(entity.ClaimsInfoContact bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ClaimsInfoContactInternal getInternalInterface(entity.ClaimsInfoContact bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ClaimsInfoContact newEmptyInstance() {
        return new entity.ClaimsInfoContact((java.lang.Void)null);
      }

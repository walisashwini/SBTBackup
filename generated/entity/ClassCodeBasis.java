...
/**
 * ClassCodeBasis
 * Measurement basis associated with a classcode (e.g. per 100 payroll; 1000 sales; 100 sqft area)
 */
...
@gw.entity.EntityName(value = "ClassCodeBasis")
public class ClassCodeBasis extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ClassCodeBasis> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ClassCodeBasis>("entity.ClassCodeBasis");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> AUDITABLE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Auditable");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> RATEFACTOR_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "RateFactor");
  ...
  private com.guidewire._generated.entity.ClassCodeBasisInternal _internal;
   ...
   */
  public ClassCodeBasis(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ClassCodeBasis(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ClassCodeBasisInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ClassCodeBasisInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.ClassCodeBasis_Description_L10N[] getDescription_L10N_ARRAY() {
    return (entity.ClassCodeBasis_Description_L10N[])__getInternalInterface().getFieldValue(DESCRIPTION_L10N_ARRAY_PROP.get());
  }
  ...
  public entity.ClassCodeBasis_Name_L10N[] getName_L10N_ARRAY() {
    return (entity.ClassCodeBasis_Name_L10N[])__getInternalInterface().getFieldValue(NAME_L10N_ARRAY_PROP.get());
  }
  ...
  public java.math.BigDecimal getRateFactor() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(RATEFACTOR_PROP.get());
  }
  ...
  public java.lang.Boolean isAuditable() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(AUDITABLE_PROP.get());
  }
  ...
  public void setAuditable(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(AUDITABLE_PROP.get(), value);
  }
   ...
   */
  private void setDescription_L10N_ARRAY(entity.ClassCodeBasis_Description_L10N[] value) {
   ...
   */
  private void setName_L10N_ARRAY(entity.ClassCodeBasis_Name_L10N[] value) {
  ...
  public void setRateFactor(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(RATEFACTOR_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ClassCodeBasisInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ClassCodeBasis.this.__getDelegateManager();
    }
    ...
    public entity.ClassCodeBasis_Description_L10N getDescription_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.ClassCodeBasis_Description_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
    ...
    public entity.ClassCodeBasis_Name_L10N getName_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.ClassCodeBasis_Name_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ClassCodeBasis.class, config);
    com.guidewire._generated.entity.ClassCodeBasisInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ClassCodeBasis, com.guidewire._generated.entity.ClassCodeBasisInternal>() {
      public java.lang.Object getImplementation(entity.ClassCodeBasis bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ClassCodeBasisInternal getInternalInterface(entity.ClassCodeBasis bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ClassCodeBasis newEmptyInstance() {
        return new entity.ClassCodeBasis((java.lang.Void)null);
      }

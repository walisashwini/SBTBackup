...
/**
 * CommercialDriver
 * A driver on a Commercial Auto policy.
 */
...
@gw.entity.EntityName(value = "CommercialDriver")
public class CommercialDriver extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.CommercialDriver, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.CommercialDriver, entity.PolicyPeriod>("entity.CommercialDriver");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DRIVERTRAINING_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DriverTraining");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> GOODDRIVERDISCOUNT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "GoodDriverDiscount");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MATUREDRIVERTRAINING_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "MatureDriverTraining");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> STUDENT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Student");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> UPDATETIME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "UpdateTime");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> UPDATEUSER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "UpdateUser");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> YEARLICENSED_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "YearLicensed");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> YEARSEXPERIENCE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "YearsExperience");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.CommercialDriverInternal _internal;
   ...
   */
  public CommercialDriver(entity.PolicyPeriod branch)  {
   ...
   */
  public CommercialDriver(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected CommercialDriver(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CommercialDriverInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CommercialDriverInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.CommercialDriver clone() {
    return (entity.CommercialDriver)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.CommercialDriver getBasedOn() {
    return (entity.CommercialDriver)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.CommercialDriver getBasedOnValue() {
    return (entity.CommercialDriver)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.CommercialDriver getFixed() {
    return (entity.CommercialDriver)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.CommercialDriver getSlice(java.util.Date sliceDate) {
    return (entity.CommercialDriver)getSliceUntyped(sliceDate);
  }
  ...
  public entity.CommercialDriver getUnsliced() {
    return (entity.CommercialDriver)getUnslicedUntyped();
  }
  ...
  public entity.windowed.CommercialDriverVersionList getVersionList() {
    return (entity.windowed.CommercialDriverVersionList)getVersionListUntyped();
  }
  ...
  public java.lang.Integer getYearLicensed() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(YEARLICENSED_PROP.get());
  }
  ...
  public typekey.DriverExperience getYearsExperience() {
    return (typekey.DriverExperience)__getInternalInterface().getFieldValue(YEARSEXPERIENCE_PROP.get());
  }
  ...
  public java.lang.Boolean isDriverTraining() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(DRIVERTRAINING_PROP.get());
  }
  ...
  public java.lang.Boolean isGoodDriverDiscount() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(GOODDRIVERDISCOUNT_PROP.get());
  }
  ...
  public java.lang.Boolean isMatureDriverTraining() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(MATUREDRIVERTRAINING_PROP.get());
  }
  ...
  public java.lang.Boolean isStudent() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(STUDENT_PROP.get());
  }
   ...
   */
  private void setBasedOnValue(entity.CommercialDriver value) {
  ...
  public void setDriverTraining(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(DRIVERTRAINING_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.CommercialDriver value) {
  ...
  public void setGoodDriverDiscount(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(GOODDRIVERDISCOUNT_PROP.get(), value);
  }
  ...
  public void setMatureDriverTraining(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(MATUREDRIVERTRAINING_PROP.get(), value);
  }
   ...
   */
  private void setSeqNumber(java.lang.Integer value) {
  ...
  public void setStudent(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(STUDENT_PROP.get(), value);
  }
  ...
  public void setYearLicensed(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(YEARLICENSED_PROP.get(), value);
  }
  ...
  public void setYearsExperience(typekey.DriverExperience value) {
    __getInternalInterface().setFieldValue(YEARSEXPERIENCE_PROP.get(), value);
  }
  
  public entity.CommercialDriver split(java.util.Date splitDate) {
    return (entity.CommercialDriver)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CommercialDriverInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CommercialDriver.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getBusinessAutoLineID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(BUSINESSAUTOLINE_PROP.get());
    }
    ...
    public void setBusinessAutoLineID(gw.pl.persistence.core.Key value) {
      setFieldValue(BUSINESSAUTOLINE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.ba.CommercialDriverMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.ba.CommercialDriverMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CommercialDriver.class, config);
    com.guidewire._generated.entity.CommercialDriverInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CommercialDriver, com.guidewire._generated.entity.CommercialDriverInternal>() {
      public java.lang.Object getImplementation(entity.CommercialDriver bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CommercialDriverInternal getInternalInterface(entity.CommercialDriver bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CommercialDriver newEmptyInstance() {
        return new entity.CommercialDriver((java.lang.Void)null);
      }

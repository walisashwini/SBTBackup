...
/**
 * CommercialPropertyCov
 * A line-level coverage for Commercial Property
 */
...
@gw.entity.EntityName(value = "CommercialPropertyCov")
public class CommercialPropertyCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.CommercialPropertyCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.CommercialPropertyCov, entity.PolicyPeriod>("entity.CommercialPropertyCov");
  ...
  private com.guidewire._generated.entity.CommercialPropertyCovInternal _internal;
   ...
   */
  protected CommercialPropertyCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected CommercialPropertyCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected CommercialPropertyCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CommercialPropertyCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CommercialPropertyCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.CommercialPropertyCov clone() {
    return (entity.CommercialPropertyCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.CommercialPropertyCov getBasedOn() {
    return (entity.CommercialPropertyCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.CommercialPropertyCov getBasedOnValue() {
    return (entity.CommercialPropertyCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.CommercialPropertyCov getFixed() {
    return (entity.CommercialPropertyCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.CommercialPropertyCov getSlice(java.util.Date sliceDate) {
    return (entity.CommercialPropertyCov)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.CommercialPropertyCov getSubtype() {
    return (typekey.CommercialPropertyCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.CommercialPropertyCov getUnsliced() {
    return (entity.CommercialPropertyCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.CommercialPropertyCovVersionList getVersionList() {
    return (entity.windowed.CommercialPropertyCovVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.CommercialPropertyCov value) {
   ...
   */
  private void setFixed(entity.CommercialPropertyCov value) {
   ...
   */
  private void setSubtype(typekey.CommercialPropertyCov value) {
  ...
  public entity.CommercialPropertyCov split(java.util.Date splitDate) {
    return (entity.CommercialPropertyCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CommercialPropertyCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CommercialPropertyCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.cp.CommercialPropertyCovCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.cp.CommercialPropertyCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.cp.CommercialPropertyCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.cp.CommercialPropertyCovCoverageAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.cp.CommercialPropertyCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.cp.CommercialPropertyCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CommercialPropertyCov.class, config);
    com.guidewire._generated.entity.CommercialPropertyCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CommercialPropertyCov, com.guidewire._generated.entity.CommercialPropertyCovInternal>() {
      public java.lang.Object getImplementation(entity.CommercialPropertyCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CommercialPropertyCovInternal getInternalInterface(entity.CommercialPropertyCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CommercialPropertyCov newEmptyInstance() {
        return new entity.CommercialPropertyCov((java.lang.Void)null);
      }

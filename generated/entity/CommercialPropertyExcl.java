 ...
 * A line-level exclusion for Commercial Property
 */
...
@gw.entity.EntityName(value = "CommercialPropertyExcl")
public class CommercialPropertyExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.CommercialPropertyExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.CommercialPropertyExcl, entity.PolicyPeriod>("entity.CommercialPropertyExcl");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> CPLINE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "CPLine");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> STRINGTERM1AV2_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "StringTerm1Av2");
  ...
  private com.guidewire._generated.entity.CommercialPropertyExclInternal _internal;
   ...
   */
  protected CommercialPropertyExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected CommercialPropertyExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected CommercialPropertyExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CommercialPropertyExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CommercialPropertyExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.CommercialPropertyExcl clone() {
    return (entity.CommercialPropertyExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.CommercialPropertyExcl getBasedOn() {
    return (entity.CommercialPropertyExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.CommercialPropertyExcl getBasedOnValue() {
    return (entity.CommercialPropertyExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.CommercialPropertyLine getCPLine() {
    return (entity.CommercialPropertyLine)__getInternalInterface().getFieldValue(CPLINE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.CommercialPropertyExcl getFixed() {
    return (entity.CommercialPropertyExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.CommercialPropertyExcl getSlice(java.util.Date sliceDate) {
    return (entity.CommercialPropertyExcl)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.CommercialPropertyExcl getSubtype() {
    return (typekey.CommercialPropertyExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.CommercialPropertyExcl getUnsliced() {
    return (entity.CommercialPropertyExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.CommercialPropertyExclVersionList getVersionList() {
    return (entity.windowed.CommercialPropertyExclVersionList)getVersionListUntyped();
  }
  ...
  public java.lang.Boolean isStringTerm1Av2() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(STRINGTERM1AV2_PROP.get());
  }
   ...
   */
  private void setBasedOnValue(entity.CommercialPropertyExcl value) {
  ...
  public void setCPLine(entity.CommercialPropertyLine value) {
    __getInternalInterface().setFieldValue(CPLINE_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.CommercialPropertyExcl value) {
   ...
   */
  private void setStringTerm1Av2(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(STRINGTERM1AV2_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.CommercialPropertyExcl value) {
  ...
  public entity.CommercialPropertyExcl split(java.util.Date splitDate) {
    return (entity.CommercialPropertyExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CommercialPropertyExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CommercialPropertyExcl.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getCPLineID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(CPLINE_PROP.get());
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.CommercialPropertyExcl value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
    ...
    public void setCPLineID(gw.pl.persistence.core.Key value) {
      setFieldValue(CPLINE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.CommercialPropertyExcl value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.CommercialPropertyExcl value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.cp.CommercialPropertyExclExclusionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.cp.CommercialPropertyExclExclusionAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.cp.CommercialPropertyExclExclusionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.cp.CommercialPropertyExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.cp.CommercialPropertyExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CommercialPropertyExcl.class, config);
    com.guidewire._generated.entity.CommercialPropertyExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CommercialPropertyExcl, com.guidewire._generated.entity.CommercialPropertyExclInternal>() {
      public java.lang.Object getImplementation(entity.CommercialPropertyExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CommercialPropertyExclInternal getInternalInterface(entity.CommercialPropertyExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CommercialPropertyExcl newEmptyInstance() {
        return new entity.CommercialPropertyExcl((java.lang.Void)null);
      }

 ...
 * Commercial Property Policy line of business.
 */
...
@gw.entity.EntityName(value = "CommercialPropertyLine")
public class CommercialPropertyLine extends entity.PolicyLine implements entity.Coverable, entity.Modifiable, gw.api.domain.LineSpecificLocationContainer, gw.api.policy.PolicyLineJavaMethods {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.CommercialPropertyLine, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.CommercialPropertyLine, entity.PolicyPeriod>("entity.CommercialPropertyLine");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> CPBLANKETAUTONUMBERSEQ_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "CPBlanketAutoNumberSeq");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> CPBLANKETS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "CPBlankets");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> CPCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "CPCosts");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> CPLINECONDITIONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "CPLineConditions");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> CPLINECOVERAGES_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "CPLineCoverages");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> CPLINEEXCLUSIONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "CPLineExclusions");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> CPLOCATIONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "CPLocations");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> CPMODIFIERS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "CPModifiers");
   ...
   */
  protected CommercialPropertyLine(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected CommercialPropertyLine(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected CommercialPropertyLine(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.CommercialPropertyLineInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CommercialPropertyLineInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.CommercialPropertyLineInternal)super.__getInternalInterface();
  }
  ...
  public void addToCPBlankets(entity.CPBlanket element) {
    __getInternalInterface().addArrayElement(CPBLANKETS_PROP.get(), element);
  }
  ...
  public void addToCPCosts(entity.CPCost element) {
    __getInternalInterface().addArrayElement(CPCOSTS_PROP.get(), element);
  }
  ...
  public void addToCPLineConditions(entity.CommercialPropertyCond element) {
    __getInternalInterface().addArrayElement(CPLINECONDITIONS_PROP.get(), element);
  }
  ...
  public void addToCPLineCoverages(entity.CommercialPropertyCov element) {
    __getInternalInterface().addArrayElement(CPLINECOVERAGES_PROP.get(), element);
  }
  ...
  public void addToCPLineExclusions(entity.CommercialPropertyExcl element) {
    __getInternalInterface().addArrayElement(CPLINEEXCLUSIONS_PROP.get(), element);
  }
  ...
  public void addToCPLocations(entity.CPLocation element) {
    __getInternalInterface().addArrayElement(CPLOCATIONS_PROP.get(), element);
  }
  ...
  public void addToCPModifiers(entity.CPModifier element) {
    __getInternalInterface().addArrayElement(CPMODIFIERS_PROP.get(), element);
  }
  ...
  public entity.CommercialPropertyLine clone() {
    return (entity.CommercialPropertyLine)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.CommercialPropertyLine getBasedOn() {
    return (entity.CommercialPropertyLine)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.AutoNumberSequence getCPBlanketAutoNumberSeq() {
    return (entity.AutoNumberSequence)__getInternalInterface().getFieldValue(CPBLANKETAUTONUMBERSEQ_PROP.get());
  }
  ...
  public entity.CPBlanket[] getCPBlankets() {
    return (entity.CPBlanket[])__getInternalInterface().getFieldValue(CPBLANKETS_PROP.get());
  }
  ...
  public entity.CPCost[] getCPCosts() {
    return (entity.CPCost[])__getInternalInterface().getFieldValue(CPCOSTS_PROP.get());
  }
  ...
  public entity.CommercialPropertyCond[] getCPLineConditions() {
    return (entity.CommercialPropertyCond[])__getInternalInterface().getFieldValue(CPLINECONDITIONS_PROP.get());
  }
  ...
  public entity.CommercialPropertyCov[] getCPLineCoverages() {
    return (entity.CommercialPropertyCov[])__getInternalInterface().getFieldValue(CPLINECOVERAGES_PROP.get());
  }
  ...
  public entity.CommercialPropertyExcl[] getCPLineExclusions() {
    return (entity.CommercialPropertyExcl[])__getInternalInterface().getFieldValue(CPLINEEXCLUSIONS_PROP.get());
  }
  ...
  public entity.CPLocation[] getCPLocations() {
    return (entity.CPLocation[])__getInternalInterface().getFieldValue(CPLOCATIONS_PROP.get());
  }
  ...
  public entity.CPModifier[] getCPModifiers() {
    return (entity.CPModifier[])__getInternalInterface().getFieldValue(CPMODIFIERS_PROP.get());
  }
  ...
  public entity.CommercialPropertyLine getSlice(java.util.Date sliceDate) {
    return (entity.CommercialPropertyLine)getSliceUntyped(sliceDate);
  }
  
  public entity.CommercialPropertyLine getUnsliced() {
    return (entity.CommercialPropertyLine)getUnslicedUntyped();
  }
  ...
  public entity.windowed.CommercialPropertyLineVersionList getVersionList() {
    return (entity.windowed.CommercialPropertyLineVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromCPBlankets(entity.CPBlanket element) {
    __getInternalInterface().removeArrayElement(CPBLANKETS_PROP.get(), element);
  }
  ...
  public void removeFromCPBlankets(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(CPBLANKETS_PROP.get(), elementID);
  }
  ...
  public void removeFromCPCosts(entity.CPCost element) {
    __getInternalInterface().removeArrayElement(CPCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromCPCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(CPCOSTS_PROP.get(), elementID);
  }
  ...
  public void removeFromCPLineConditions(entity.CommercialPropertyCond element) {
    __getInternalInterface().removeArrayElement(CPLINECONDITIONS_PROP.get(), element);
  }
  ...
  public void removeFromCPLineConditions(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(CPLINECONDITIONS_PROP.get(), elementID);
  }
  ...
  public void removeFromCPLineCoverages(entity.CommercialPropertyCov element) {
    __getInternalInterface().removeArrayElement(CPLINECOVERAGES_PROP.get(), element);
  }
  ...
  public void removeFromCPLineCoverages(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(CPLINECOVERAGES_PROP.get(), elementID);
  }
  ...
  public void removeFromCPLineExclusions(entity.CommercialPropertyExcl element) {
    __getInternalInterface().removeArrayElement(CPLINEEXCLUSIONS_PROP.get(), element);
  }
  ...
  public void removeFromCPLineExclusions(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(CPLINEEXCLUSIONS_PROP.get(), elementID);
  }
  ...
  public void removeFromCPLocations(entity.CPLocation element) {
    __getInternalInterface().removeArrayElement(CPLOCATIONS_PROP.get(), element);
  }
  ...
  public void removeFromCPLocations(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(CPLOCATIONS_PROP.get(), elementID);
  }
  ...
  public void removeFromCPModifiers(entity.CPModifier element) {
    __getInternalInterface().removeArrayElement(CPMODIFIERS_PROP.get(), element);
  }
  ...
  public void removeFromCPModifiers(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(CPMODIFIERS_PROP.get(), elementID);
  }
  ...
  public void setCPBlanketAutoNumberSeq(entity.AutoNumberSequence value) {
    __getInternalInterface().setFieldValue(CPBLANKETAUTONUMBERSEQ_PROP.get(), value);
  }
  ...
  public void setCPBlankets(entity.CPBlanket[] value) {
    __getInternalInterface().setFieldValue(CPBLANKETS_PROP.get(), value);
  }
  ...
  public void setCPCosts(entity.CPCost[] value) {
    __getInternalInterface().setFieldValue(CPCOSTS_PROP.get(), value);
  }
  ...
  public void setCPLineConditions(entity.CommercialPropertyCond[] value) {
    __getInternalInterface().setFieldValue(CPLINECONDITIONS_PROP.get(), value);
  }
  ...
  public void setCPLineCoverages(entity.CommercialPropertyCov[] value) {
    __getInternalInterface().setFieldValue(CPLINECOVERAGES_PROP.get(), value);
  }
  ...
  public void setCPLineExclusions(entity.CommercialPropertyExcl[] value) {
    __getInternalInterface().setFieldValue(CPLINEEXCLUSIONS_PROP.get(), value);
  }
  ...
  public void setCPLocations(entity.CPLocation[] value) {
    __getInternalInterface().setFieldValue(CPLOCATIONS_PROP.get(), value);
  }
  ...
  public void setCPModifiers(entity.CPModifier[] value) {
    __getInternalInterface().setFieldValue(CPMODIFIERS_PROP.get(), value);
  }
  ...
  public entity.CommercialPropertyLine split(java.util.Date splitDate) {
    return (entity.CommercialPropertyLine)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CommercialPropertyLineInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CommercialPropertyLine.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getCPBlanketAutoNumberSeqID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(CPBLANKETAUTONUMBERSEQ_PROP.get());
    }
    ...
    public void setCPBlanketAutoNumberSeqID(gw.pl.persistence.core.Key value) {
      setFieldValue(CPBLANKETAUTONUMBERSEQ_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.cp.CPLineCoverableModifiableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.cp.CPLineCoverableModifiableAdapter");
    config.put("gw.api.domain.LineSpecificLocationContainer", "gw.lob.cp.CPSpecificLocationContainer");
    config.put("gw.api.domain.ModifiableAdapter", "gw.lob.cp.CPLineCoverableModifiableAdapter");
    ...
    config.put("gw.api.policy.PolicyLineJavaMethods", "gw.lob.cp.CPPolicyLineMethods");
    config.put("gw.api.policy.PolicyLineMethods", "gw.lob.cp.CPPolicyLineMethods");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CommercialPropertyLine.class, config);
    com.guidewire._generated.entity.CommercialPropertyLineInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CommercialPropertyLine, com.guidewire._generated.entity.CommercialPropertyLineInternal>() {
      public java.lang.Object getImplementation(entity.CommercialPropertyLine bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CommercialPropertyLineInternal getInternalInterface(entity.CommercialPropertyLine bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CommercialPropertyLine newEmptyInstance() {
        return new entity.CommercialPropertyLine((java.lang.Void)null);
      }

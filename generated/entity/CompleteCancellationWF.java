...
/**
 * CompleteCancellationWF
 * Workflow for completing a cancellation
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "CompleteCancellationWF.eti;CompleteCancellationWF.eix;CompleteCancellationWF.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "CompleteCancellationWF")
public class CompleteCancellationWF extends entity.PolicyPeriodWorkflow {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CompleteCancellationWF> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CompleteCancellationWF>("entity.CompleteCancellationWF");
   ...
   */
  public CompleteCancellationWF(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CompleteCancellationWF(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.CompleteCancellationWFInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CompleteCancellationWFInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.CompleteCancellationWFInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CompleteCancellationWFInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CompleteCancellationWF.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CompleteCancellationWF.class, config);
    com.guidewire._generated.entity.CompleteCancellationWFInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CompleteCancellationWF, com.guidewire._generated.entity.CompleteCancellationWFInternal>() {
      public java.lang.Object getImplementation(entity.CompleteCancellationWF bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CompleteCancellationWFInternal getInternalInterface(entity.CompleteCancellationWF bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CompleteCancellationWF newEmptyInstance() {
        return new entity.CompleteCancellationWF((java.lang.Void)null);
      }

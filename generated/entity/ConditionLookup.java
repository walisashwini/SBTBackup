...
/**
 * ConditionLookup
 * An availability lookup for condition patterns.
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ConditionLookup.eti;ConditionLookup.eix;ConditionLookup.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ConditionLookup")
public class ConditionLookup extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.ProductModelDelegate, entity.AvailabilityLookup, entity.StateDrivenLookup, entity.PolicyLinePatternFilteredLookup, entity.JobTypeFilteredLookup, entity.UWCompanyFilteredLookup, com.guidewire.pc.domain.productmodel.DenormLookupInitialisable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ConditionLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ConditionLookup>("entity.ConditionLookup");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CONDITIONPATTERNCODE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ConditionPatternCode");
  ...
  private com.guidewire._generated.entity.ConditionLookupInternal _internal;
   ...
   */
  protected ConditionLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ConditionLookup(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ConditionLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ConditionLookupInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setSubtype(typekey.ConditionLookup value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ConditionLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ConditionLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ConditionLookup.class, config);
    com.guidewire._generated.entity.ConditionLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ConditionLookup, com.guidewire._generated.entity.ConditionLookupInternal>() {
      public java.lang.Object getImplementation(entity.ConditionLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ConditionLookupInternal getInternalInterface(entity.ConditionLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ConditionLookup newEmptyInstance() {
        return new entity.ConditionLookup((java.lang.Void)null);
      }

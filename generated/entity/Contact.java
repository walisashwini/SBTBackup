...
public abstract class Contact extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.Validatable, entity.AddressBookConvertable, entity.GlobalContactName, entity.CommonContact, entity.DestructionRootPinnable, entity.RootInfo, entity.Extractable, entity.Obfuscatable, entity.EventAware, com.guidewire.pc.domain.contact.PCContactPublicMethods, com.guidewire.pc.domain.personaldata.PinnableDomainMethods, com.guidewire.pl.domain.contact.CommonContactAdapter, gw.api.contact.ContactLifecycle, gw.api.contact.ContactMinimalTags, gw.api.history.CustomHistory, gw.api.obfuscation.Obfuscator {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ACCOUNTHOLDERCOUNT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AccountHolderCount");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> EXTERNALVERSION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ExternalVersion");
   ...
   */
  private void setAccountHolderCount(java.lang.Integer value) {
   ...
   */
  private void setCountry(typekey.Country value) {
   ...
   */
  private void setState(typekey.State value) {

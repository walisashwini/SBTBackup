...
public class ContactSearchCriteria extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable, com.guidewire.pl.system.service.search.CommonContactSearchCriteria {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> FIRSTNAMEEXACT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "FirstNameExact");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> KEYWORDEXACT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "KeywordExact");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PERMISSIVESEARCH_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PermissiveSearch");
  ...
  public java.lang.Boolean isFirstNameExact() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(FIRSTNAMEEXACT_PROP.get());
  }
  ...
  public java.lang.Boolean isKeywordExact() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(KEYWORDEXACT_PROP.get());
  }
  ...
  public java.lang.Boolean isPermissiveSearch() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(PERMISSIVESEARCH_PROP.get());
  }
  ...
  public gw.plugin.contact.ContactResult[] searchExternalContacts() {
    return ((com.guidewire.pc.domain.contact.impl.ContactSearchCriteriaCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.contact.impl.ContactSearchCriteriaCoreExtMethods")).searchExternalContacts();
  }
  
  public gw.api.database.IQueryBeanResult<entity.Contact> searchInternal() {
    return ((com.guidewire.pc.domain.contact.impl.ContactSearchCriteriaCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.contact.impl.ContactSearchCriteriaCoreExtMethods")).searchInternal();
  }
  ...
  public void setFirstNameExact(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(FIRSTNAMEEXACT_PROP.get(), value);
  }
  ...
  public void setKeywordExact(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(KEYWORDEXACT_PROP.get(), value);
  }
  ...
  public void setPermissiveSearch(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(PERMISSIVESEARCH_PROP.get(), value);
  }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.contact.impl.ContactSearchCriteriaCoreExtMethods", "com.guidewire.pc.domain.contact.impl.ContactSearchCriteriaCoreExtMethodsImpl");

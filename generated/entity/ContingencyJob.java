...
/**
 * ContingencyJob
 * Join table from Contingency and Job
 */
...
@gw.entity.EntityName(value = "ContingencyJob")
public class ContingencyJob extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.Extractable, entity.FrozenSetMember {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ContingencyJob> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ContingencyJob>("entity.ContingencyJob");
  ...
  private com.guidewire._generated.entity.ContingencyJobInternal _internal;
   ...
   */
  public ContingencyJob(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ContingencyJob(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ContingencyJobInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ContingencyJobInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ContingencyJobInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ContingencyJob.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ContingencyJob.class, config);
    com.guidewire._generated.entity.ContingencyJobInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ContingencyJob, com.guidewire._generated.entity.ContingencyJobInternal>() {
      public java.lang.Object getImplementation(entity.ContingencyJob bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ContingencyJobInternal getInternalInterface(entity.ContingencyJob bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ContingencyJob newEmptyInstance() {
        return new entity.ContingencyJob((java.lang.Void)null);
      }

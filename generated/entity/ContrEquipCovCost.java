...
/**
 * ContrEquipCovCost
 * Costs for an inland marine contractors equipment coverage
 */
...
@gw.entity.EntityName(value = "ContrEquipCovCost")
public class ContrEquipCovCost extends entity.ContrEquipPartCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.ContrEquipCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.ContrEquipCovCost, entity.PolicyPeriod>("entity.ContrEquipCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> CONTRACTORSEQUIPCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ContractorsEquipCov");
   ...
   */
  public ContrEquipCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public ContrEquipCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected ContrEquipCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ContrEquipCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ContrEquipCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ContrEquipCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.ContrEquipCovCost clone() {
    return (entity.ContrEquipCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.ContrEquipCovCost getBasedOn() {
    return (entity.ContrEquipCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.ContractorsEquipCov getContractorsEquipCov() {
    return (entity.ContractorsEquipCov)__getInternalInterface().getFieldValue(CONTRACTORSEQUIPCOV_PROP.get());
  }
  
  public entity.ContrEquipCovCost getSlice(java.util.Date sliceDate) {
    return (entity.ContrEquipCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.ContrEquipCovCost getUnsliced() {
    return (entity.ContrEquipCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.ContrEquipCovCostVersionList getVersionList() {
    return (entity.windowed.ContrEquipCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setContractorsEquipCov(entity.ContractorsEquipCov value) {
    __getInternalInterface().setFieldValue(CONTRACTORSEQUIPCOV_PROP.get(), value);
  }
  
  public entity.ContrEquipCovCost split(java.util.Date splitDate) {
    return (entity.ContrEquipCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ContrEquipCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ContrEquipCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getContractorsEquipCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(CONTRACTORSEQUIPCOV_PROP.get());
    }
    ...
    public void setContractorsEquipCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(CONTRACTORSEQUIPCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.financials.CostAdapter", "gw.lob.im.financials.ContrEquipCovCostAdapter");
    config.put("gw.lob.im.financials.IMCostMethods", "gw.lob.im.financials.ContrEquipCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ContrEquipCovCost.class, config);
    com.guidewire._generated.entity.ContrEquipCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ContrEquipCovCost, com.guidewire._generated.entity.ContrEquipCovCostInternal>() {
      public java.lang.Object getImplementation(entity.ContrEquipCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ContrEquipCovCostInternal getInternalInterface(entity.ContrEquipCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ContrEquipCovCost newEmptyInstance() {
        return new entity.ContrEquipCovCost((java.lang.Void)null);
      }

...
/**
 * ContrEquipPartCond
 * A Contractors' Equipment part-level condition for Inland Marine
 */
...
@gw.entity.EntityName(value = "ContrEquipPartCond")
public class ContrEquipPartCond extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PolicyCondition, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.ContrEquipPartCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.ContrEquipPartCond, entity.PolicyPeriod>("entity.ContrEquipPartCond");
  ...
  private com.guidewire._generated.entity.ContrEquipPartCondInternal _internal;
   ...
   */
  protected ContrEquipPartCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected ContrEquipPartCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected ContrEquipPartCond(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ContrEquipPartCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ContrEquipPartCondInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.ContrEquipPartCond clone() {
    return (entity.ContrEquipPartCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.ContrEquipPartCond getBasedOn() {
    return (entity.ContrEquipPartCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.ContrEquipPartCond getBasedOnValue() {
    return (entity.ContrEquipPartCond)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.ContrEquipPartCond getFixed() {
    return (entity.ContrEquipPartCond)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.ContrEquipPartCond getSlice(java.util.Date sliceDate) {
    return (entity.ContrEquipPartCond)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.ContrEquipPartCond getSubtype() {
    return (typekey.ContrEquipPartCond)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.ContrEquipPartCond getUnsliced() {
    return (entity.ContrEquipPartCond)getUnslicedUntyped();
  }
  ...
  public entity.windowed.ContrEquipPartCondVersionList getVersionList() {
    return (entity.windowed.ContrEquipPartCondVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.ContrEquipPartCond value) {
   ...
   */
  private void setFixed(entity.ContrEquipPartCond value) {
   ...
   */
  private void setSubtype(typekey.ContrEquipPartCond value) {
  ...
  public entity.ContrEquipPartCond split(java.util.Date splitDate) {
    return (entity.ContrEquipPartCond)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ContrEquipPartCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ContrEquipPartCond.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.ContrEquipPartCond value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.ContrEquipPartCond value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.ContrEquipPartCond value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.im.contractorsequip.ContractorsEquipPartCondConditionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.im.contractorsequip.ContractorsEquipPartCondConditionAdapter");
    config.put("gw.api.domain.PolicyConditionAdapter", "gw.lob.im.contractorsequip.ContractorsEquipPartCondConditionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.im.ContrEquipPartCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.im.ContrEquipPartCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ContrEquipPartCond.class, config);
    com.guidewire._generated.entity.ContrEquipPartCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ContrEquipPartCond, com.guidewire._generated.entity.ContrEquipPartCondInternal>() {
      public java.lang.Object getImplementation(entity.ContrEquipPartCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ContrEquipPartCondInternal getInternalInterface(entity.ContrEquipPartCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ContrEquipPartCond newEmptyInstance() {
        return new entity.ContrEquipPartCond((java.lang.Void)null);
      }

...
/**
 * ContrEquipPartCost
 * Costs for inland marine contractors equipment part
 */
...
@gw.entity.EntityName(value = "ContrEquipPartCost")
public class ContrEquipPartCost extends entity.IMTaxableCost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.ContrEquipPartCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.ContrEquipPartCost, entity.PolicyPeriod>("entity.ContrEquipPartCost");
   ...
   */
  public ContrEquipPartCost(entity.PolicyPeriod branch)  {
   ...
   */
  public ContrEquipPartCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected ContrEquipPartCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ContrEquipPartCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ContrEquipPartCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ContrEquipPartCostInternal)super.__getInternalInterface();
  }
  
  public entity.ContrEquipPartCost clone() {
    return (entity.ContrEquipPartCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.ContrEquipPartCost getBasedOn() {
    return (entity.ContrEquipPartCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.ContrEquipPartCost getSlice(java.util.Date sliceDate) {
    return (entity.ContrEquipPartCost)getSliceUntyped(sliceDate);
  }
  
  public entity.ContrEquipPartCost getUnsliced() {
    return (entity.ContrEquipPartCost)getUnslicedUntyped();
  }
  
  public entity.windowed.ContrEquipPartCostVersionList getVersionList() {
    return (entity.windowed.ContrEquipPartCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.ContrEquipPartCost split(java.util.Date splitDate) {
    return (entity.ContrEquipPartCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ContrEquipPartCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ContrEquipPartCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.im.financials.IMCostMethods", "gw.lob.im.financials.IMCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ContrEquipPartCost.class, config);
    com.guidewire._generated.entity.ContrEquipPartCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ContrEquipPartCost, com.guidewire._generated.entity.ContrEquipPartCostInternal>() {
      public java.lang.Object getImplementation(entity.ContrEquipPartCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ContrEquipPartCostInternal getInternalInterface(entity.ContrEquipPartCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ContrEquipPartCost newEmptyInstance() {
        return new entity.ContrEquipPartCost((java.lang.Void)null);
      }

...
/**
 * ContrEquipPartCov
 * A Contractors' Equipment part-level coverage for Inland Marine
 */
...
@gw.entity.EntityName(value = "ContrEquipPartCov")
public class ContrEquipPartCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.ContrEquipPartCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.ContrEquipPartCov, entity.PolicyPeriod>("entity.ContrEquipPartCov");
  ...
  private com.guidewire._generated.entity.ContrEquipPartCovInternal _internal;
   ...
   */
  protected ContrEquipPartCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected ContrEquipPartCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected ContrEquipPartCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ContrEquipPartCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ContrEquipPartCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.ContrEquipPartCov clone() {
    return (entity.ContrEquipPartCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.ContrEquipPartCov getBasedOn() {
    return (entity.ContrEquipPartCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.ContrEquipPartCov getBasedOnValue() {
    return (entity.ContrEquipPartCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.ContrEquipPartCovCost[] getCosts() {
    return (entity.ContrEquipPartCovCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
  }
  ...
  public entity.ContrEquipPartCov getFixed() {
    return (entity.ContrEquipPartCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.ContrEquipPartCov getSlice(java.util.Date sliceDate) {
    return (entity.ContrEquipPartCov)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.ContrEquipPartCov getSubtype() {
    return (typekey.ContrEquipPartCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.ContrEquipPartCov getUnsliced() {
    return (entity.ContrEquipPartCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.ContrEquipPartCovVersionList getVersionList() {
    return (entity.windowed.ContrEquipPartCovVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.ContrEquipPartCov value) {
   ...
   */
  private void setFixed(entity.ContrEquipPartCov value) {
   ...
   */
  private void setSubtype(typekey.ContrEquipPartCov value) {
  ...
  public entity.ContrEquipPartCov split(java.util.Date splitDate) {
    return (entity.ContrEquipPartCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ContrEquipPartCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ContrEquipPartCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.im.contractorsequip.ContractorsEquipmentPartCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.im.contractorsequip.ContractorsEquipmentPartCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.im.contractorsequip.ContractorsEquipmentPartCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.im.contractorsequip.ContractorsEquipmentPartCoverageAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.im.contractorsequip.ContrEquipPartCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.im.contractorsequip.ContrEquipPartCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ContrEquipPartCov.class, config);
    com.guidewire._generated.entity.ContrEquipPartCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ContrEquipPartCov, com.guidewire._generated.entity.ContrEquipPartCovInternal>() {
      public java.lang.Object getImplementation(entity.ContrEquipPartCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ContrEquipPartCovInternal getInternalInterface(entity.ContrEquipPartCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ContrEquipPartCov newEmptyInstance() {
        return new entity.ContrEquipPartCov((java.lang.Void)null);
      }

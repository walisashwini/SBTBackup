 ...
 * Costs for inland marine contractors equipment part coverage
 */
...
@gw.entity.EntityName(value = "ContrEquipPartCovCost")
public class ContrEquipPartCovCost extends entity.ContrEquipPartCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.ContrEquipPartCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.ContrEquipPartCovCost, entity.PolicyPeriod>("entity.ContrEquipPartCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> CONTREQUIPPARTCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ContrEquipPartCov");
   ...
   */
  public ContrEquipPartCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public ContrEquipPartCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected ContrEquipPartCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ContrEquipPartCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ContrEquipPartCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ContrEquipPartCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.ContrEquipPartCovCost clone() {
    return (entity.ContrEquipPartCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.ContrEquipPartCovCost getBasedOn() {
    return (entity.ContrEquipPartCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.ContrEquipPartCov getContrEquipPartCov() {
    return (entity.ContrEquipPartCov)__getInternalInterface().getFieldValue(CONTREQUIPPARTCOV_PROP.get());
  }
  
  public entity.ContrEquipPartCovCost getSlice(java.util.Date sliceDate) {
    return (entity.ContrEquipPartCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.ContrEquipPartCovCost getUnsliced() {
    return (entity.ContrEquipPartCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.ContrEquipPartCovCostVersionList getVersionList() {
    return (entity.windowed.ContrEquipPartCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setContrEquipPartCov(entity.ContrEquipPartCov value) {
    __getInternalInterface().setFieldValue(CONTREQUIPPARTCOV_PROP.get(), value);
  }
  
  public entity.ContrEquipPartCovCost split(java.util.Date splitDate) {
    return (entity.ContrEquipPartCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ContrEquipPartCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ContrEquipPartCovCost.this.__getDelegateManager();
    }
    ...
    public entity.IMCost getBasedOnValue() {
      return (entity.IMCost)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getContrEquipPartCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(CONTREQUIPPARTCOV_PROP.get());
    }
    ...
    public entity.IMCost getFixed() {
      return (entity.IMCost)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public typekey.IMCost getSubtype() {
      return (typekey.IMCost)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
    ...
    public entity.IMTransaction[] getTransactions() {
      return (entity.IMTransaction[])__getInternalInterface().getFieldValue(TRANSACTIONS_PROP.get());
    }
    ...
    public void setContrEquipPartCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(CONTREQUIPPARTCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.financials.CostAdapter", "gw.lob.im.financials.IMCostAdapter");
    config.put("gw.lob.im.financials.IMCostMethods", "gw.lob.im.financials.ContrEquipPartCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ContrEquipPartCovCost.class, config);
    com.guidewire._generated.entity.ContrEquipPartCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ContrEquipPartCovCost, com.guidewire._generated.entity.ContrEquipPartCovCostInternal>() {
      public java.lang.Object getImplementation(entity.ContrEquipPartCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ContrEquipPartCovCostInternal getInternalInterface(entity.ContrEquipPartCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ContrEquipPartCovCost newEmptyInstance() {
        return new entity.ContrEquipPartCovCost((java.lang.Void)null);
      }

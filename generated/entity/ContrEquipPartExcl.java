...
/**
 * ContrEquipPartExcl
 * A Contractors' Equipment part-level exclusion for Inland Marine
 */
...
@gw.entity.EntityName(value = "ContrEquipPartExcl")
public class ContrEquipPartExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.ContrEquipPartExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.ContrEquipPartExcl, entity.PolicyPeriod>("entity.ContrEquipPartExcl");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> CONTRACTORSEQUIPPART_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ContractorsEquipPart");
  ...
  private com.guidewire._generated.entity.ContrEquipPartExclInternal _internal;
   ...
   */
  protected ContrEquipPartExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected ContrEquipPartExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected ContrEquipPartExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ContrEquipPartExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ContrEquipPartExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.ContrEquipPartExcl clone() {
    return (entity.ContrEquipPartExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.ContrEquipPartExcl getBasedOn() {
    return (entity.ContrEquipPartExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.ContrEquipPartExcl getBasedOnValue() {
    return (entity.ContrEquipPartExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.ContractorsEquipPart getContractorsEquipPart() {
    return (entity.ContractorsEquipPart)__getInternalInterface().getFieldValue(CONTRACTORSEQUIPPART_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.ContrEquipPartExcl getFixed() {
    return (entity.ContrEquipPartExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.ContrEquipPartExcl getSlice(java.util.Date sliceDate) {
    return (entity.ContrEquipPartExcl)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.ContrEquipPartExcl getSubtype() {
    return (typekey.ContrEquipPartExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.ContrEquipPartExcl getUnsliced() {
    return (entity.ContrEquipPartExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.ContrEquipPartExclVersionList getVersionList() {
    return (entity.windowed.ContrEquipPartExclVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.ContrEquipPartExcl value) {
  ...
  public void setContractorsEquipPart(entity.ContractorsEquipPart value) {
    __getInternalInterface().setFieldValue(CONTRACTORSEQUIPPART_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.ContrEquipPartExcl value) {
   ...
   */
  private void setSubtype(typekey.ContrEquipPartExcl value) {
  ...
  public entity.ContrEquipPartExcl split(java.util.Date splitDate) {
    return (entity.ContrEquipPartExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ContrEquipPartExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ContrEquipPartExcl.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getContractorsEquipPartID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(CONTRACTORSEQUIPPART_PROP.get());
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.ContrEquipPartExcl value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
    ...
    public void setContractorsEquipPartID(gw.pl.persistence.core.Key value) {
      setFieldValue(CONTRACTORSEQUIPPART_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.ContrEquipPartExcl value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.ContrEquipPartExcl value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.im.contractorsequip.ContractorsEquipPartExclExclusionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.im.contractorsequip.ContractorsEquipPartExclExclusionAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.im.contractorsequip.ContractorsEquipPartExclExclusionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.im.ContrEquipPartExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.im.ContrEquipPartExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ContrEquipPartExcl.class, config);
    com.guidewire._generated.entity.ContrEquipPartExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ContrEquipPartExcl, com.guidewire._generated.entity.ContrEquipPartExclInternal>() {
      public java.lang.Object getImplementation(entity.ContrEquipPartExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ContrEquipPartExclInternal getInternalInterface(entity.ContrEquipPartExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ContrEquipPartExcl newEmptyInstance() {
        return new entity.ContrEquipPartExcl((java.lang.Void)null);
      }

...
/**
 * ContractorsEquipCov
 * A Contractors' Equipment item-level coverage for Inland Marine
 */
...
@gw.entity.EntityName(value = "ContractorsEquipCov")
public class ContractorsEquipCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.ContractorsEquipCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.ContractorsEquipCov, entity.PolicyPeriod>("entity.ContractorsEquipCov");
  ...
  private com.guidewire._generated.entity.ContractorsEquipCovInternal _internal;
   ...
   */
  protected ContractorsEquipCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected ContractorsEquipCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected ContractorsEquipCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ContractorsEquipCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ContractorsEquipCovInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  public void addToCosts(entity.ContrEquipCovCost element) {
  ...
  public entity.ContractorsEquipCov clone() {
    return (entity.ContractorsEquipCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.ContractorsEquipCov getBasedOn() {
    return (entity.ContractorsEquipCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.ContractorsEquipCov getBasedOnValue() {
    return (entity.ContractorsEquipCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.ContrEquipCovCost[] getCosts() {
    return (entity.ContrEquipCovCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.ContractorsEquipCov getFixed() {
    return (entity.ContractorsEquipCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.ContractorsEquipCov getSlice(java.util.Date sliceDate) {
    return (entity.ContractorsEquipCov)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.ContractorsEquipCov getSubtype() {
    return (typekey.ContractorsEquipCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.ContractorsEquipCov getUnsliced() {
    return (entity.ContractorsEquipCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.ContractorsEquipCovVersionList getVersionList() {
    return (entity.windowed.ContractorsEquipCovVersionList)getVersionListUntyped();
  }
   ...
   */
  public void removeFromCosts(entity.ContrEquipCovCost element) {
   ...
   */
  private void setBasedOnValue(entity.ContractorsEquipCov value) {
   ...
   */
  public void setCosts(entity.ContrEquipCovCost[] value) {
   ...
   */
  private void setFixed(entity.ContractorsEquipCov value) {
   ...
   */
  private void setSubtype(typekey.ContractorsEquipCov value) {
  ...
  public entity.ContractorsEquipCov split(java.util.Date splitDate) {
    return (entity.ContractorsEquipCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ContractorsEquipCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ContractorsEquipCov.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.ContractorsEquipCov value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.ContractorsEquipCov value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.ContractorsEquipCov value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.im.contractorsequip.ContractorsEquipmentCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.im.contractorsequip.ContractorsEquipmentCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.im.contractorsequip.ContractorsEquipmentCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.im.contractorsequip.ContractorsEquipmentCoverageAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.im.contractorsequip.ContractorsEquipCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.im.contractorsequip.ContractorsEquipCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ContractorsEquipCov.class, config);
    com.guidewire._generated.entity.ContractorsEquipCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ContractorsEquipCov, com.guidewire._generated.entity.ContractorsEquipCovInternal>() {
      public java.lang.Object getImplementation(entity.ContractorsEquipCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ContractorsEquipCovInternal getInternalInterface(entity.ContractorsEquipCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ContractorsEquipCov newEmptyInstance() {
        return new entity.ContractorsEquipCov((java.lang.Void)null);
      }

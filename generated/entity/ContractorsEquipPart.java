 ...
 * Inland Marine Contractors' Equipment coverage part
 */
...
@gw.entity.EntityName(value = "ContractorsEquipPart")
public class ContractorsEquipPart extends entity.IMCoveragePart implements entity.Coverable {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.ContractorsEquipPart, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.ContractorsEquipPart, entity.PolicyPeriod>("entity.ContractorsEquipPart");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> CONTREQPARTAUTONUMBERSEQ_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ContrEqPartAutoNumberSeq");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> CONTREQUIPPARTCONDITIONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "ContrEquipPartConditions");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> CONTREQUIPPARTCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "ContrEquipPartCosts");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> CONTREQUIPPARTCOVS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "ContrEquipPartCovs");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> CONTREQUIPPARTEXCLUSIONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "ContrEquipPartExclusions");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> CONTRACTORTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "ContractorType");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> CONTRACTORSEQUIPMENTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "ContractorsEquipments");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PEROCCURRENCELIMIT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PerOccurrenceLimit");
   ...
   */
  public ContractorsEquipPart(entity.PolicyPeriod branch)  {
   ...
   */
  public ContractorsEquipPart(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected ContractorsEquipPart(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ContractorsEquipPartInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ContractorsEquipPartInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ContractorsEquipPartInternal)super.__getInternalInterface();
  }
  ...
  public void addToContrEquipPartConditions(entity.ContrEquipPartCond element) {
    __getInternalInterface().addArrayElement(CONTREQUIPPARTCONDITIONS_PROP.get(), element);
  }
  ...
  public void addToContrEquipPartCosts(entity.ContrEquipPartCost element) {
    __getInternalInterface().addArrayElement(CONTREQUIPPARTCOSTS_PROP.get(), element);
  }
  ...
  public void addToContrEquipPartCovs(entity.ContrEquipPartCov element) {
    __getInternalInterface().addArrayElement(CONTREQUIPPARTCOVS_PROP.get(), element);
  }
  ...
  public void addToContrEquipPartExclusions(entity.ContrEquipPartExcl element) {
    __getInternalInterface().addArrayElement(CONTREQUIPPARTEXCLUSIONS_PROP.get(), element);
  }
  ...
  public void addToContractorsEquipments(entity.ContractorsEquipment element) {
    __getInternalInterface().addArrayElement(CONTRACTORSEQUIPMENTS_PROP.get(), element);
  }
  ...
  public entity.ContractorsEquipPart clone() {
    return (entity.ContractorsEquipPart)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.ContractorsEquipPart getBasedOn() {
    return (entity.ContractorsEquipPart)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.AutoNumberSequence getContrEqPartAutoNumberSeq() {
    return (entity.AutoNumberSequence)__getInternalInterface().getFieldValue(CONTREQPARTAUTONUMBERSEQ_PROP.get());
  }
  ...
  public entity.ContrEquipPartCond[] getContrEquipPartConditions() {
    return (entity.ContrEquipPartCond[])__getInternalInterface().getFieldValue(CONTREQUIPPARTCONDITIONS_PROP.get());
  }
  ...
  public entity.ContrEquipPartCost[] getContrEquipPartCosts() {
    return (entity.ContrEquipPartCost[])__getInternalInterface().getFieldValue(CONTREQUIPPARTCOSTS_PROP.get());
  }
  ...
  public entity.ContrEquipPartCov[] getContrEquipPartCovs() {
    return (entity.ContrEquipPartCov[])__getInternalInterface().getFieldValue(CONTREQUIPPARTCOVS_PROP.get());
  }
  ...
  public entity.ContrEquipPartExcl[] getContrEquipPartExclusions() {
    return (entity.ContrEquipPartExcl[])__getInternalInterface().getFieldValue(CONTREQUIPPARTEXCLUSIONS_PROP.get());
  }
  ...
  public typekey.ContractorType getContractorType() {
    return (typekey.ContractorType)__getInternalInterface().getFieldValue(CONTRACTORTYPE_PROP.get());
  }
  ...
  public entity.ContractorsEquipment[] getContractorsEquipments() {
    return (entity.ContractorsEquipment[])__getInternalInterface().getFieldValue(CONTRACTORSEQUIPMENTS_PROP.get());
  }
  ...
  public java.lang.Integer getPerOccurrenceLimit() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(PEROCCURRENCELIMIT_PROP.get());
  }
  ...
  public entity.ContractorsEquipPart getSlice(java.util.Date sliceDate) {
    return (entity.ContractorsEquipPart)getSliceUntyped(sliceDate);
  }
  
  public entity.ContractorsEquipPart getUnsliced() {
    return (entity.ContractorsEquipPart)getUnslicedUntyped();
  }
  
  public entity.windowed.ContractorsEquipPartVersionList getVersionList() {
    return (entity.windowed.ContractorsEquipPartVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromContrEquipPartConditions(entity.ContrEquipPartCond element) {
    __getInternalInterface().removeArrayElement(CONTREQUIPPARTCONDITIONS_PROP.get(), element);
  }
  ...
  public void removeFromContrEquipPartConditions(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(CONTREQUIPPARTCONDITIONS_PROP.get(), elementID);
  }
  ...
  public void removeFromContrEquipPartCosts(entity.ContrEquipPartCost element) {
    __getInternalInterface().removeArrayElement(CONTREQUIPPARTCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromContrEquipPartCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(CONTREQUIPPARTCOSTS_PROP.get(), elementID);
  }
  ...
  public void removeFromContrEquipPartCovs(entity.ContrEquipPartCov element) {
    __getInternalInterface().removeArrayElement(CONTREQUIPPARTCOVS_PROP.get(), element);
  }
  ...
  public void removeFromContrEquipPartCovs(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(CONTREQUIPPARTCOVS_PROP.get(), elementID);
  }
  ...
  public void removeFromContrEquipPartExclusions(entity.ContrEquipPartExcl element) {
    __getInternalInterface().removeArrayElement(CONTREQUIPPARTEXCLUSIONS_PROP.get(), element);
  }
  ...
  public void removeFromContrEquipPartExclusions(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(CONTREQUIPPARTEXCLUSIONS_PROP.get(), elementID);
  }
  ...
  public void removeFromContractorsEquipments(entity.ContractorsEquipment element) {
    __getInternalInterface().removeArrayElement(CONTRACTORSEQUIPMENTS_PROP.get(), element);
  }
  ...
  public void removeFromContractorsEquipments(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(CONTRACTORSEQUIPMENTS_PROP.get(), elementID);
  }
  ...
  public void setContrEqPartAutoNumberSeq(entity.AutoNumberSequence value) {
    __getInternalInterface().setFieldValue(CONTREQPARTAUTONUMBERSEQ_PROP.get(), value);
  }
  ...
  public void setContrEquipPartConditions(entity.ContrEquipPartCond[] value) {
    __getInternalInterface().setFieldValue(CONTREQUIPPARTCONDITIONS_PROP.get(), value);
  }
  ...
  public void setContrEquipPartCosts(entity.ContrEquipPartCost[] value) {
    __getInternalInterface().setFieldValue(CONTREQUIPPARTCOSTS_PROP.get(), value);
  }
  ...
  public void setContrEquipPartCovs(entity.ContrEquipPartCov[] value) {
    __getInternalInterface().setFieldValue(CONTREQUIPPARTCOVS_PROP.get(), value);
  }
  ...
  public void setContrEquipPartExclusions(entity.ContrEquipPartExcl[] value) {
    __getInternalInterface().setFieldValue(CONTREQUIPPARTEXCLUSIONS_PROP.get(), value);
  }
  ...
  public void setContractorType(typekey.ContractorType value) {
    __getInternalInterface().setFieldValue(CONTRACTORTYPE_PROP.get(), value);
  }
  ...
  public void setContractorsEquipments(entity.ContractorsEquipment[] value) {
    __getInternalInterface().setFieldValue(CONTRACTORSEQUIPMENTS_PROP.get(), value);
  }
  ...
  public void setPerOccurrenceLimit(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(PEROCCURRENCELIMIT_PROP.get(), value);
  }
  ...
  public entity.ContractorsEquipPart split(java.util.Date splitDate) {
    return (entity.ContractorsEquipPart)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ContractorsEquipPartInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ContractorsEquipPart.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getContrEqPartAutoNumberSeqID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(CONTREQPARTAUTONUMBERSEQ_PROP.get());
    }
    ...
    public void setContrEqPartAutoNumberSeqID(gw.pl.persistence.core.Key value) {
      setFieldValue(CONTREQPARTAUTONUMBERSEQ_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.im.contractorsequip.ContractorsEquipmentPartCoverableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.im.contractorsequip.ContractorsEquipmentPartCoverableAdapter");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ContractorsEquipPart.class, config);
    com.guidewire._generated.entity.ContractorsEquipPartInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ContractorsEquipPart, com.guidewire._generated.entity.ContractorsEquipPartInternal>() {
      public java.lang.Object getImplementation(entity.ContractorsEquipPart bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ContractorsEquipPartInternal getInternalInterface(entity.ContractorsEquipPart bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ContractorsEquipPart newEmptyInstance() {
        return new entity.ContractorsEquipPart((java.lang.Void)null);
      }

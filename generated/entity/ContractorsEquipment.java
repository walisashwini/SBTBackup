 ...
 * A scheduled item of equipment on the Inland Marine Contractors' Equipment coverage part
 */
...
@gw.entity.EntityName(value = "ContractorsEquipment")
public class ContractorsEquipment extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverable, gw.api.contact.AdditionalInterestContainer, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.ContractorsEquipment, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.ContractorsEquipment, entity.PolicyPeriod>("entity.ContractorsEquipment");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CONTRACTORSEQUIPMENTID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ContractorsEquipmentID");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CONTRACTORSEQUIPMENTNUMBER_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ContractorsEquipmentNumber");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MODELYEAR_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ModelYear");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> YEARBOUGHT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "YearBought");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.ContractorsEquipmentInternal _internal;
   ...
   */
  public ContractorsEquipment(entity.PolicyPeriod branch)  {
   ...
   */
  public ContractorsEquipment(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected ContractorsEquipment(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ContractorsEquipmentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ContractorsEquipmentInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.ContractorsEquipment clone() {
    return (entity.ContractorsEquipment)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.IMSchEquipAddlInterest[] getAdditionalInterests() {
    return (entity.IMSchEquipAddlInterest[])__getInternalInterface().getFieldValue(ADDITIONALINTERESTS_PROP.get());
  }
  ...
  public entity.ContractorsEquipment getBasedOn() {
    return (entity.ContractorsEquipment)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.ContractorsEquipment getBasedOnValue() {
    return (entity.ContractorsEquipment)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public java.lang.String getContractorsEquipmentID() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CONTRACTORSEQUIPMENTID_PROP.get());
  }
  ...
  public java.lang.Integer getContractorsEquipmentNumber() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(CONTRACTORSEQUIPMENTNUMBER_PROP.get());
  }
  ...
  public entity.ContractorsEquipCov[] getCoverages() {
    return (entity.ContractorsEquipCov[])__getInternalInterface().getFieldValue(COVERAGES_PROP.get());
  }
  ...
  public entity.ContractorsEquipment getFixed() {
    return (entity.ContractorsEquipment)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public java.lang.Integer getModelYear() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(MODELYEAR_PROP.get());
  }
  ...
  public entity.ContractorsEquipment getSlice(java.util.Date sliceDate) {
    return (entity.ContractorsEquipment)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.ContractorsEquipment getSubtype() {
    return (typekey.ContractorsEquipment)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.ContractorsEquipment getUnsliced() {
    return (entity.ContractorsEquipment)getUnslicedUntyped();
  }
  ...
  public entity.windowed.ContractorsEquipmentVersionList getVersionList() {
    return (entity.windowed.ContractorsEquipmentVersionList)getVersionListUntyped();
  }
  ...
  public java.lang.Integer getYearBought() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(YEARBOUGHT_PROP.get());
  }
   ...
   */
  private void setBasedOnValue(entity.ContractorsEquipment value) {
  ...
  public void setContractorsEquipmentID(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CONTRACTORSEQUIPMENTID_PROP.get(), value);
  }
  ...
  public void setContractorsEquipmentNumber(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(CONTRACTORSEQUIPMENTNUMBER_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.ContractorsEquipment value) {
  ...
  public void setModelYear(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(MODELYEAR_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.ContractorsEquipment value) {
  ...
  public void setYearBought(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(YEARBOUGHT_PROP.get(), value);
  }
  
  public entity.ContractorsEquipment split(java.util.Date splitDate) {
    return (entity.ContractorsEquipment)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ContractorsEquipmentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ContractorsEquipment.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.contact.AdditionalInterestContainer", "gw.lob.im.contact.ScheduledEquipmentAdditionalInterestContainer");
    config.put("gw.api.copier.EffDatedCopyable", "gw.api.copier.EffDatedCopier");
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.im.contractorsequip.ContractorsEquipmentCoverableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.im.contractorsequip.ContractorsEquipmentCoverableAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.im.contractorsequip.ContractorsEquipmentMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.im.contractorsequip.ContractorsEquipmentMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ContractorsEquipment.class, config);
    com.guidewire._generated.entity.ContractorsEquipmentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ContractorsEquipment, com.guidewire._generated.entity.ContractorsEquipmentInternal>() {
      public java.lang.Object getImplementation(entity.ContractorsEquipment bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ContractorsEquipmentInternal getInternalInterface(entity.ContractorsEquipment bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ContractorsEquipment newEmptyInstance() {
        return new entity.ContractorsEquipment((java.lang.Void)null);
      }

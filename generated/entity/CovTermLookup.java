...
@gw.entity.EntityName(value = "CovTermLookup")
public class CovTermLookup extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.ProductModelDelegate, entity.AvailabilityLookup, entity.StateDrivenLookup, entity.PolicyLinePatternFilteredLookup, entity.JobTypeFilteredLookup, entity.UWCompanyFilteredLookup, com.guidewire.pc.domain.productmodel.DenormLookupInitialisable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CovTermLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CovTermLookup>("entity.CovTermLookup");
  ...
  private com.guidewire._generated.entity.CovTermLookupInternal _internal;
   ...
   */
  protected CovTermLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CovTermLookup(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CovTermLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CovTermLookupInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setSubtype(typekey.CovTermLookup value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CovTermLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CovTermLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CovTermLookup.class, config);
    com.guidewire._generated.entity.CovTermLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CovTermLookup, com.guidewire._generated.entity.CovTermLookupInternal>() {
      public java.lang.Object getImplementation(entity.CovTermLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CovTermLookupInternal getInternalInterface(entity.CovTermLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CovTermLookup newEmptyInstance() {
        return new entity.CovTermLookup((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "CovTermOptLookup")
public class CovTermOptLookup extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.ProductModelDelegate, entity.AvailabilityLookup, entity.StateDrivenLookup, entity.CovTermPatternFilteredLookup, entity.JobTypeFilteredLookup, entity.UWCompanyFilteredLookup, entity.CurrencyFilteredLookup, com.guidewire.pc.domain.productmodel.DenormLookupInitialisable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CovTermOptLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CovTermOptLookup>("entity.CovTermOptLookup");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> COVTERMOPTCODE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CovTermOptCode");
  ...
  private com.guidewire._generated.entity.CovTermOptLookupInternal _internal;
   ...
   */
  protected CovTermOptLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CovTermOptLookup(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CovTermOptLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CovTermOptLookupInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setSubtype(typekey.CovTermOptLookup value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CovTermOptLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CovTermOptLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CovTermOptLookup.class, config);
    com.guidewire._generated.entity.CovTermOptLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CovTermOptLookup, com.guidewire._generated.entity.CovTermOptLookupInternal>() {
      public java.lang.Object getImplementation(entity.CovTermOptLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CovTermOptLookupInternal getInternalInterface(entity.CovTermOptLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CovTermOptLookup newEmptyInstance() {
        return new entity.CovTermOptLookup((java.lang.Void)null);
      }

...
/**
 * CovTermPackLookup
 * The base coverage term availability lookup type.
 */
...
@gw.entity.EntityName(value = "CovTermPackLookup")
public class CovTermPackLookup extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.ProductModelDelegate, entity.AvailabilityLookup, entity.StateDrivenLookup, entity.CovTermPatternFilteredLookup, entity.JobTypeFilteredLookup, entity.UWCompanyFilteredLookup, entity.CurrencyFilteredLookup, com.guidewire.pc.domain.productmodel.DenormLookupInitialisable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CovTermPackLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CovTermPackLookup>("entity.CovTermPackLookup");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> COVTERMPACKCODE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CovTermPackCode");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> COVTERMPATTERNCODE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CovTermPatternCode");
  ...
  private com.guidewire._generated.entity.CovTermPackLookupInternal _internal;
   ...
   */
  protected CovTermPackLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CovTermPackLookup(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CovTermPackLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CovTermPackLookupInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setCovTermPatternCode(java.lang.String value) {
   ...
   */
  private void setSubtype(typekey.CovTermPackLookup value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CovTermPackLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CovTermPackLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CovTermPackLookup.class, config);
    com.guidewire._generated.entity.CovTermPackLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CovTermPackLookup, com.guidewire._generated.entity.CovTermPackLookupInternal>() {
      public java.lang.Object getImplementation(entity.CovTermPackLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CovTermPackLookupInternal getInternalInterface(entity.CovTermPackLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CovTermPackLookup newEmptyInstance() {
        return new entity.CovTermPackLookup((java.lang.Void)null);
      }

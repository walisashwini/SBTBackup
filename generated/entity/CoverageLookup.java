...
/**
 * CoverageLookup
 * An availability lookup for coverage patterns.
 */
...
@gw.entity.EntityName(value = "CoverageLookup")
public class CoverageLookup extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.ProductModelDelegate, entity.AvailabilityLookup, entity.StateDrivenLookup, entity.PolicyLinePatternFilteredLookup, entity.JobTypeFilteredLookup, entity.UWCompanyFilteredLookup, com.guidewire.pc.domain.productmodel.DenormLookupInitialisable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CoverageLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CoverageLookup>("entity.CoverageLookup");
  ...
  private com.guidewire._generated.entity.CoverageLookupInternal _internal;
   ...
   */
  protected CoverageLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CoverageLookup(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CoverageLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CoverageLookupInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setSubtype(typekey.CoverageLookup value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CoverageLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CoverageLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CoverageLookup.class, config);
    com.guidewire._generated.entity.CoverageLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CoverageLookup, com.guidewire._generated.entity.CoverageLookupInternal>() {
      public java.lang.Object getImplementation(entity.CoverageLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CoverageLookupInternal getInternalInterface(entity.CoverageLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CoverageLookup newEmptyInstance() {
        return new entity.CoverageLookup((java.lang.Void)null);
      }

...
/**
 * CoverageSymbol
 * The individual coverage symbol
 */
...
@gw.entity.EntityName(value = "CoverageSymbol")
public class CoverageSymbol extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.CoverageSymbol, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.CoverageSymbol, entity.PolicyPeriod>("entity.CoverageSymbol");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> COVERAGESYMBOLGROUP_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "CoverageSymbolGroup");
  ...
  private com.guidewire._generated.entity.CoverageSymbolInternal _internal;
   ...
   */
  public CoverageSymbol(entity.PolicyPeriod branch)  {
   ...
   */
  public CoverageSymbol(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected CoverageSymbol(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CoverageSymbolInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CoverageSymbolInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.CoverageSymbol clone() {
    return (entity.CoverageSymbol)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.CoverageSymbol getBasedOn() {
    return (entity.CoverageSymbol)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.CoverageSymbol getBasedOnValue() {
    return (entity.CoverageSymbol)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.CoverageSymbolGroup getCoverageSymbolGroup() {
    return (entity.CoverageSymbolGroup)__getInternalInterface().getFieldValue(COVERAGESYMBOLGROUP_PROP.get());
  }
  ...
  public entity.CoverageSymbol getFixed() {
    return (entity.CoverageSymbol)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.CoverageSymbol getSlice(java.util.Date sliceDate) {
    return (entity.CoverageSymbol)getSliceUntyped(sliceDate);
  }
  ...
  public entity.CoverageSymbol getUnsliced() {
    return (entity.CoverageSymbol)getUnslicedUntyped();
  }
  ...
  public entity.windowed.CoverageSymbolVersionList getVersionList() {
    return (entity.windowed.CoverageSymbolVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.CoverageSymbol value) {
  ...
  public void setCoverageSymbolGroup(entity.CoverageSymbolGroup value) {
    __getInternalInterface().setFieldValue(COVERAGESYMBOLGROUP_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.CoverageSymbol value) {
  ...
  public entity.CoverageSymbol split(java.util.Date splitDate) {
    return (entity.CoverageSymbol)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CoverageSymbolInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CoverageSymbol.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getCoverageSymbolGroupID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(COVERAGESYMBOLGROUP_PROP.get());
    }
    ...
    public void setCoverageSymbolGroupID(gw.pl.persistence.core.Key value) {
      setFieldValue(COVERAGESYMBOLGROUP_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.copier.EffDatedCopyable", "gw.coverage.CoverageSymbolCopier");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.coverage.CoverageSymbolMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.coverage.CoverageSymbolMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CoverageSymbol.class, config);
    com.guidewire._generated.entity.CoverageSymbolInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CoverageSymbol, com.guidewire._generated.entity.CoverageSymbolInternal>() {
      public java.lang.Object getImplementation(entity.CoverageSymbol bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CoverageSymbolInternal getInternalInterface(entity.CoverageSymbol bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CoverageSymbol newEmptyInstance() {
        return new entity.CoverageSymbol((java.lang.Void)null);
      }

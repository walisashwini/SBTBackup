...
/**
 * CoverageSymbolGroup
 * One group of CoverageSymbols on a given PolicyLine
 */
...
@gw.entity.EntityName(value = "CoverageSymbolGroup")
public class CoverageSymbolGroup extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.CoverageSymbolGroup, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.CoverageSymbolGroup, entity.PolicyPeriod>("entity.CoverageSymbolGroup");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> COVERAGESYMBOLS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "CoverageSymbols");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> POLICYLINE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "PolicyLine");
  ...
  private com.guidewire._generated.entity.CoverageSymbolGroupInternal _internal;
   ...
   */
  public CoverageSymbolGroup(entity.PolicyPeriod branch)  {
   ...
   */
  public CoverageSymbolGroup(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected CoverageSymbolGroup(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CoverageSymbolGroupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CoverageSymbolGroupInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToCoverageSymbols(entity.CoverageSymbol element) {
    __getInternalInterface().addArrayElement(COVERAGESYMBOLS_PROP.get(), element);
  }
  
  public entity.CoverageSymbolGroup clone() {
    return (entity.CoverageSymbolGroup)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.CoverageSymbolGroup getBasedOn() {
    return (entity.CoverageSymbolGroup)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.CoverageSymbolGroup getBasedOnValue() {
    return (entity.CoverageSymbolGroup)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  /**
   * Returns the symbol in this group whose pattern is the same as the passed-in one, or null
   * if the symbol is not available.
   * @param symbolPattern 
   */
  public entity.CoverageSymbol getCoverageSymbol(gw.api.productmodel.CoverageSymbolPattern symbolPattern) {
    return ((com.guidewire.pc.domain.coverage.CoverageSymbolGroupPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.coverage.CoverageSymbolGroupPublicMethods")).getCoverageSymbol(symbolPattern);
  }
  
  /**
   * Returns the symbol in this group whose pattern has the given symbol type, or null if the
   * symbol is not available.
   * @param symbolType 
   */
  public entity.CoverageSymbol getCoverageSymbolByType(typekey.CoverageSymbolType symbolType) {
    return ((com.guidewire.pc.domain.coverage.CoverageSymbolGroupPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.coverage.CoverageSymbolGroupPublicMethods")).getCoverageSymbolByType(symbolType);
  }
  ...
  public entity.CoverageSymbol[] getCoverageSymbols() {
    return (entity.CoverageSymbol[])__getInternalInterface().getFieldValue(COVERAGESYMBOLS_PROP.get());
  }
  ...
  public entity.CoverageSymbolGroup getFixed() {
    return (entity.CoverageSymbolGroup)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  /**
   * Returns the CoverageSymbolGruopPattern associated with this CoverageSymbolGroup.
   */
  public gw.api.productmodel.CoverageSymbolGroupPattern getPattern() {
    return ((com.guidewire.pc.domain.coverage.CoverageSymbolGroupPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.coverage.CoverageSymbolGroupPublicMethods")).getPattern();
  }
  ...
  public entity.PolicyLine getPolicyLine() {
    return (entity.PolicyLine)__getInternalInterface().getFieldValue(POLICYLINE_PROP.get());
  }
  ...
  public entity.CoverageSymbolGroup getSlice(java.util.Date sliceDate) {
    return (entity.CoverageSymbolGroup)getSliceUntyped(sliceDate);
  }
  ...
  public entity.CoverageSymbolGroup getUnsliced() {
    return (entity.CoverageSymbolGroup)getUnslicedUntyped();
  }
  ...
  public entity.windowed.CoverageSymbolGroupVersionList getVersionList() {
    return (entity.windowed.CoverageSymbolGroupVersionList)getVersionListUntyped();
  }
  ...
  /**
   * Returns true if the group contains the CoverageSymbol specified by the given pattern,
   * whether or not the symbol is selected.
   * @param symbolPattern 
   */
  public java.lang.Boolean isCoverageSymbolAvailable(gw.api.productmodel.CoverageSymbolPattern symbolPattern) {
    return ((com.guidewire.pc.domain.coverage.CoverageSymbolGroupPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.coverage.CoverageSymbolGroupPublicMethods")).isCoverageSymbolAvailable(symbolPattern);
  }
  
  /**
   * Returns true if the group contains the CoverageSymbol specified by the given pattern, and
   * the symbol is selected.
   * @param symbolPattern 
   */
  public java.lang.Boolean isCoverageSymbolSelected(gw.api.productmodel.CoverageSymbolPattern symbolPattern) {
    return ((com.guidewire.pc.domain.coverage.CoverageSymbolGroupPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.coverage.CoverageSymbolGroupPublicMethods")).isCoverageSymbolSelected(symbolPattern);
  }
  
  /**
   * Returns true if the group contains the CoverageSymbol whose pattern has the given symbol type,
   * whether or not the symbol is selected.
   * @param symbolType 
   */
  public java.lang.Boolean isCoverageSymbolTypeAvailable(typekey.CoverageSymbolType symbolType) {
    return ((com.guidewire.pc.domain.coverage.CoverageSymbolGroupPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.coverage.CoverageSymbolGroupPublicMethods")).isCoverageSymbolTypeAvailable(symbolType);
  }
  
  /**
   * Returns true if the group contains the CoverageSymbol whose pattern has the given symbol type, and
   * the symbol is selected.
   * @param symbolType 
   */
  public java.lang.Boolean isCoverageSymbolTypeSelected(typekey.CoverageSymbolType symbolType) {
    return ((com.guidewire.pc.domain.coverage.CoverageSymbolGroupPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.coverage.CoverageSymbolGroupPublicMethods")).isCoverageSymbolTypeSelected(symbolType);
  }
  ...
  public void removeFromCoverageSymbols(entity.CoverageSymbol element) {
    __getInternalInterface().removeArrayElement(COVERAGESYMBOLS_PROP.get(), element);
  }
  ...
  public void removeFromCoverageSymbols(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(COVERAGESYMBOLS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.CoverageSymbolGroup value) {
  ...
  /**
   * Sets the selected state of the CoverageSymbol specified by the given pattern.
   * @param symbolPattern 
   * @param selected 
   * @throws IllegalArgumentException if the given pattern does not exist within this group's pattern
   */
  public void setCoverageSymbolSelected(gw.api.productmodel.CoverageSymbolPattern symbolPattern, java.lang.Boolean selected) {
    ((com.guidewire.pc.domain.coverage.CoverageSymbolGroupPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.coverage.CoverageSymbolGroupPublicMethods")).setCoverageSymbolSelected(symbolPattern, selected);
  }
  
  /**
   * Sets the selected state of the CoverageSymbol specified by the given symbol type.
   * @param symbolType 
   * @param selected 
   * @throws IllegalArgumentException if no CoverageSymbolPattern with the given CoverageSymbolType
   *         exists within this group's pattern
   */
  public void setCoverageSymbolTypeSelected(typekey.CoverageSymbolType symbolType, java.lang.Boolean selected) {
    ((com.guidewire.pc.domain.coverage.CoverageSymbolGroupPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.coverage.CoverageSymbolGroupPublicMethods")).setCoverageSymbolTypeSelected(symbolType, selected);
  }
  ...
  public void setCoverageSymbols(entity.CoverageSymbol[] value) {
    __getInternalInterface().setFieldValue(COVERAGESYMBOLS_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.CoverageSymbolGroup value) {
  ...
  public void setPolicyLine(entity.PolicyLine value) {
    __getInternalInterface().setFieldValue(POLICYLINE_PROP.get(), value);
  }
  ...
  public entity.CoverageSymbolGroup split(java.util.Date splitDate) {
    return (entity.CoverageSymbolGroup)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CoverageSymbolGroupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CoverageSymbolGroup.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getPolicyLineID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(POLICYLINE_PROP.get());
    }
    ...
    public void setPolicyLineID(gw.pl.persistence.core.Key value) {
      setFieldValue(POLICYLINE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.coverage.CoverageSymbolGroupPublicMethods", "com.guidewire.pc.domain.coverage.impl.CoverageSymbolGroupImpl");
    ...
    config.put("gw.api.copier.EffDatedCopyable", "gw.coverage.CoverageSymbolGroupCopier");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.coverage.CoverageSymbolGroupMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.coverage.CoverageSymbolGroupMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CoverageSymbolGroup.class, config);
    com.guidewire._generated.entity.CoverageSymbolGroupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CoverageSymbolGroup, com.guidewire._generated.entity.CoverageSymbolGroupInternal>() {
      public java.lang.Object getImplementation(entity.CoverageSymbolGroup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CoverageSymbolGroupInternal getInternalInterface(entity.CoverageSymbolGroup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CoverageSymbolGroup newEmptyInstance() {
        return new entity.CoverageSymbolGroup((java.lang.Void)null);
      }

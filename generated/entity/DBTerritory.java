...
@gw.entity.EntityName(value = "DBTerritory")
public class DBTerritory extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.DBTerritory> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.DBTerritory>("entity.DBTerritory");
  ...
  private com.guidewire._generated.entity.DBTerritoryInternal _internal;
   ...
   */
  public DBTerritory(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected DBTerritory(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.DBTerritoryInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.DBTerritoryInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.DBTerritory_Description_L10N[] getDescription_L10N_ARRAY() {
    return (entity.DBTerritory_Description_L10N[])__getInternalInterface().getFieldValue(DESCRIPTION_L10N_ARRAY_PROP.get());
  }
   ...
   */
  private void setDescription_L10N_ARRAY(entity.DBTerritory_Description_L10N[] value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.DBTerritoryInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.DBTerritory.this.__getDelegateManager();
    }
    ...
    public entity.DBTerritory_Description_L10N getDescription_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.DBTerritory_Description_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.DBTerritory.class, config);
    com.guidewire._generated.entity.DBTerritoryInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.DBTerritory, com.guidewire._generated.entity.DBTerritoryInternal>() {
      public java.lang.Object getImplementation(entity.DBTerritory bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.DBTerritoryInternal getInternalInterface(entity.DBTerritory bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.DBTerritory newEmptyInstance() {
        return new entity.DBTerritory((java.lang.Void)null);
      }

 ...
 * This default table which stores the factors used in rating calculations
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "DefaultRateFactorRow.eti;DefaultRateFactorRow.eix;DefaultRateFactorRow.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "DefaultRateFactorRow")
public class DefaultRateFactorRow extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.DefaultRateFactorRow> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.DefaultRateFactorRow>("entity.DefaultRateFactorRow");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> STR9_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "str9");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.DefaultRateFactorRowInternal _internal;
   ...
   */
  public DefaultRateFactorRow(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected DefaultRateFactorRow(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.DefaultRateFactorRowInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.DefaultRateFactorRowInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.DefaultRateFactorRow getSubtype() {
    return (typekey.DefaultRateFactorRow)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  /**
   * Gets the value of the str9 field.
   * String 9
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getstr9() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(STR9_PROP.get());
  }
   ...
   */
  private void setSubtype(typekey.DefaultRateFactorRow value) {
  ...
  /**
   * Sets the value of the str9 field.
   */
  public void setstr9(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(STR9_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.DefaultRateFactorRowInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.DefaultRateFactorRow.this.__getDelegateManager();
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.DefaultRateFactorRow value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.DefaultRateFactorRow.class, config);
    com.guidewire._generated.entity.DefaultRateFactorRowInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.DefaultRateFactorRow, com.guidewire._generated.entity.DefaultRateFactorRowInternal>() {
      public java.lang.Object getImplementation(entity.DefaultRateFactorRow bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.DefaultRateFactorRowInternal getInternalInterface(entity.DefaultRateFactorRow bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.DefaultRateFactorRow newEmptyInstance() {
        return new entity.DefaultRateFactorRow((java.lang.Void)null);
      }

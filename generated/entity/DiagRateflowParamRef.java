...
/**
 * DiagRateflowParamRef
 * Foreign key reference to rateflow parameter value
 */
...
@gw.entity.EntityName(value = "DiagRateflowParamRef")
public class DiagRateflowParamRef extends entity.DiagRatingWorksheetRef {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.DiagRateflowParamRef, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.DiagRateflowParamRef, entity.PolicyPeriod>("entity.DiagRateflowParamRef");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> CALCROUTINEPARAMETER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "CalcRoutineParameter");
   ...
   */
  public DiagRateflowParamRef(entity.PolicyPeriod branch)  {
   ...
   */
  public DiagRateflowParamRef(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected DiagRateflowParamRef(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.DiagRateflowParamRefInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.DiagRateflowParamRefInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.DiagRateflowParamRefInternal)super.__getInternalInterface();
  }
  
  public entity.DiagRateflowParamRef clone() {
    return (entity.DiagRateflowParamRef)__getInternalInterface().cloneUntyped();
  }
  
  public entity.DiagRateflowParamRef getBasedOn() {
    return (entity.DiagRateflowParamRef)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.CalcRoutineParameter getCalcRoutineParameter() {
    return (entity.CalcRoutineParameter)__getInternalInterface().getFieldValue(CALCROUTINEPARAMETER_PROP.get());
  }
  
  public entity.DiagRateflowParamRef getSlice(java.util.Date sliceDate) {
    return (entity.DiagRateflowParamRef)getSliceUntyped(sliceDate);
  }
  ...
  public entity.DiagRateflowParamRef getUnsliced() {
    return (entity.DiagRateflowParamRef)getUnslicedUntyped();
  }
  
  public entity.windowed.DiagRateflowParamRefVersionList getVersionList() {
    return (entity.windowed.DiagRateflowParamRefVersionList)getVersionListUntyped();
  }
  ...
  public void setCalcRoutineParameter(entity.CalcRoutineParameter value) {
    __getInternalInterface().setFieldValue(CALCROUTINEPARAMETER_PROP.get(), value);
  }
  ...
  public entity.DiagRateflowParamRef split(java.util.Date splitDate) {
    return (entity.DiagRateflowParamRef)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.DiagRateflowParamRefInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.DiagRateflowParamRef.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getCalcRoutineParameterID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(CALCROUTINEPARAMETER_PROP.get());
    }
    ...
    public void setCalcRoutineParameterID(gw.pl.persistence.core.Key value) {
      setFieldValue(CALCROUTINEPARAMETER_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.DiagRateflowParamRef.class, config);
    com.guidewire._generated.entity.DiagRateflowParamRefInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.DiagRateflowParamRef, com.guidewire._generated.entity.DiagRateflowParamRefInternal>() {
      public java.lang.Object getImplementation(entity.DiagRateflowParamRef bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.DiagRateflowParamRefInternal getInternalInterface(entity.DiagRateflowParamRef bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.DiagRateflowParamRef newEmptyInstance() {
        return new entity.DiagRateflowParamRef((java.lang.Void)null);
      }

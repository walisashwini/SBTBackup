...
/**
 * DiagRatingWorksheetRef
 * A foreign key reference that relates to a diagnostic rating worksheet
 */
...
@gw.entity.EntityName(value = "DiagRatingWorksheetRef")
public class DiagRatingWorksheetRef extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.DiagRatingWorksheetRef, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.DiagRatingWorksheetRef, entity.PolicyPeriod>("entity.DiagRatingWorksheetRef");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> REFERENCEDID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ReferencedID");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> REFERENCEDTYPE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ReferencedType");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> WORKSHEET_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "Worksheet");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.DiagRatingWorksheetRefInternal _internal;
   ...
   */
  public DiagRatingWorksheetRef(entity.PolicyPeriod branch)  {
   ...
   */
  public DiagRatingWorksheetRef(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected DiagRatingWorksheetRef(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.DiagRatingWorksheetRefInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.DiagRatingWorksheetRefInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.DiagRatingWorksheetRef clone() {
    return (entity.DiagRatingWorksheetRef)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.DiagRatingWorksheetRef getBasedOn() {
    return (entity.DiagRatingWorksheetRef)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.DiagRatingWorksheetRef getBasedOnValue() {
    return (entity.DiagRatingWorksheetRef)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.DiagRatingWorksheetRef getFixed() {
    return (entity.DiagRatingWorksheetRef)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  /**
   * 
   * @return The EffDated to which this refers
   */
  public entity.EffDated getReference() {
    return ((com.guidewire.pc.domain.rating.worksheet.DiagRatingWorksheetRefPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.rating.worksheet.DiagRatingWorksheetRefPublicMethods")).getReference();
  }
  
  /**
   * 
   * @return the FixedID key for the referenced EffDated.
   */
  public gw.pl.persistence.core.Key getReferenceFixedKey() {
    return ((com.guidewire.pc.domain.rating.worksheet.DiagRatingWorksheetRefPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.rating.worksheet.DiagRatingWorksheetRefPublicMethods")).getReferenceFixedKey();
  }
  ...
  public java.lang.Long getReferencedID() {
    return (java.lang.Long)__getInternalInterface().getFieldValue(REFERENCEDID_PROP.get());
  }
  ...
  public java.lang.String getReferencedType() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(REFERENCEDTYPE_PROP.get());
  }
  
  public entity.DiagRatingWorksheetRef getSlice(java.util.Date sliceDate) {
    return (entity.DiagRatingWorksheetRef)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.DiagRatingWorksheetRef getSubtype() {
    return (typekey.DiagRatingWorksheetRef)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.DiagRatingWorksheetRef getUnsliced() {
    return (entity.DiagRatingWorksheetRef)getUnslicedUntyped();
  }
  ...
  public entity.windowed.DiagRatingWorksheetRefVersionList getVersionList() {
    return (entity.windowed.DiagRatingWorksheetRefVersionList)getVersionListUntyped();
  }
  ...
  public entity.DiagnosticRatingWorksheet getWorksheet() {
    return (entity.DiagnosticRatingWorksheet)__getInternalInterface().getFieldValue(WORKSHEET_PROP.get());
  }
   ...
   */
  private void setBasedOnValue(entity.DiagRatingWorksheetRef value) {
   ...
   */
  private void setFixed(entity.DiagRatingWorksheetRef value) {
  ...
  /**
   * 
   * @param e EffDated to which this should refer
   */
  public void setReference(entity.EffDated e) {
    ((com.guidewire.pc.domain.rating.worksheet.DiagRatingWorksheetRefPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.rating.worksheet.DiagRatingWorksheetRefPublicMethods")).setReference(e);
  }
  
  /**
   * IMPORTANT: The function has no ability to distinguish whether this is a fixed ID or a regular ID.
   * You must pass a FixedID if you are using this function directly, or you may get a wrong result.
   * @param k FixedID for the referenced EffDated.
   */
  public void setReferenceFixedKey(gw.pl.persistence.core.Key k) {
    ((com.guidewire.pc.domain.rating.worksheet.DiagRatingWorksheetRefPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.rating.worksheet.DiagRatingWorksheetRefPublicMethods")).setReferenceFixedKey(k);
  }
  
  /**
   * Sets the value of the ReferencedID field.
   */
  private void setReferencedID(java.lang.Long value) {
    __getInternalInterface().setFieldValue(REFERENCEDID_PROP.get(), value);
  }
  
  /**
   * Sets the value of the ReferencedType field.
   */
  private void setReferencedType(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(REFERENCEDTYPE_PROP.get(), value);
  }
  
  /**
   * Sets the value of the Subtype field.
   */
  private void setSubtype(typekey.DiagRatingWorksheetRef value) {
  ...
  public void setWorksheet(entity.DiagnosticRatingWorksheet value) {
    __getInternalInterface().setFieldValue(WORKSHEET_PROP.get(), value);
  }
  
  public entity.DiagRatingWorksheetRef split(java.util.Date splitDate) {
    return (entity.DiagRatingWorksheetRef)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.DiagRatingWorksheetRefInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.DiagRatingWorksheetRef.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getWorksheetID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(WORKSHEET_PROP.get());
    }
    ...
    public void setWorksheetID(gw.pl.persistence.core.Key value) {
      setFieldValue(WORKSHEET_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.rating.worksheet.DiagRatingWorksheetRefPublicMethods", "com.guidewire.pc.domain.rating.worksheet.impl.DiagRatingWorksheetRefImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.DiagRatingWorksheetRef.class, config);
    com.guidewire._generated.entity.DiagRatingWorksheetRefInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.DiagRatingWorksheetRef, com.guidewire._generated.entity.DiagRatingWorksheetRefInternal>() {
      public java.lang.Object getImplementation(entity.DiagRatingWorksheetRef bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.DiagRatingWorksheetRefInternal getInternalInterface(entity.DiagRatingWorksheetRef bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.DiagRatingWorksheetRef newEmptyInstance() {
        return new entity.DiagRatingWorksheetRef((java.lang.Void)null);
      }

...
/**
 * DiagnosticRatingWorksheet
 * A rating worksheet for capturing diagnostic data in the case of a problem during rating.
 */
...
@gw.entity.EntityName(value = "DiagnosticRatingWorksheet")
public class DiagnosticRatingWorksheet extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.DiagnosticRatingWorksheet, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.DiagnosticRatingWorksheet, entity.PolicyPeriod>("entity.DiagnosticRatingWorksheet");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DIAGNOSTICCAPTURE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DiagnosticCapture");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> ENTITYREFERENCES_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "EntityReferences");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> TEXTDATA_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "TextData");
  ...
  private com.guidewire._generated.entity.DiagnosticRatingWorksheetInternal _internal;
   ...
   */
  public DiagnosticRatingWorksheet(entity.PolicyPeriod branch)  {
   ...
   */
  public DiagnosticRatingWorksheet(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected DiagnosticRatingWorksheet(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.DiagnosticRatingWorksheetInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.DiagnosticRatingWorksheetInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToEntityReferences(entity.DiagRatingWorksheetRef element) {
    __getInternalInterface().addArrayElement(ENTITYREFERENCES_PROP.get(), element);
  }
  
  public entity.DiagnosticRatingWorksheet clone() {
    return (entity.DiagnosticRatingWorksheet)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.DiagnosticRatingWorksheet getBasedOn() {
    return (entity.DiagnosticRatingWorksheet)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.DiagnosticRatingWorksheet getBasedOnValue() {
    return (entity.DiagnosticRatingWorksheet)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public java.lang.String getDiagnosticCapture() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(DIAGNOSTICCAPTURE_PROP.get());
  }
  ...
  public entity.DiagRatingWorksheetRef[] getEntityReferences() {
    return (entity.DiagRatingWorksheetRef[])__getInternalInterface().getFieldValue(ENTITYREFERENCES_PROP.get());
  }
  ...
  public entity.DiagnosticRatingWorksheet getFixed() {
    return (entity.DiagnosticRatingWorksheet)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.DiagnosticRatingWorksheet getSlice(java.util.Date sliceDate) {
    return (entity.DiagnosticRatingWorksheet)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.DiagnosticRatingWorksheet getSubtype() {
    return (typekey.DiagnosticRatingWorksheet)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public java.lang.String getTextData() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(TEXTDATA_PROP.get());
  }
  
  public entity.DiagnosticRatingWorksheet getUnsliced() {
    return (entity.DiagnosticRatingWorksheet)getUnslicedUntyped();
  }
  ...
  public entity.windowed.DiagnosticRatingWorksheetVersionList getVersionList() {
    return (entity.windowed.DiagnosticRatingWorksheetVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromEntityReferences(entity.DiagRatingWorksheetRef element) {
    __getInternalInterface().removeArrayElement(ENTITYREFERENCES_PROP.get(), element);
  }
  ...
  public void removeFromEntityReferences(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(ENTITYREFERENCES_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.DiagnosticRatingWorksheet value) {
  ...
  public void setDiagnosticCapture(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(DIAGNOSTICCAPTURE_PROP.get(), value);
  }
  ...
  public void setEntityReferences(entity.DiagRatingWorksheetRef[] value) {
    __getInternalInterface().setFieldValue(ENTITYREFERENCES_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.DiagnosticRatingWorksheet value) {
   ...
   */
  private void setSubtype(typekey.DiagnosticRatingWorksheet value) {
  ...
  public void setTextData(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(TEXTDATA_PROP.get(), value);
  }
  ...
  public entity.DiagnosticRatingWorksheet split(java.util.Date splitDate) {
    return (entity.DiagnosticRatingWorksheet)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.DiagnosticRatingWorksheetInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.DiagnosticRatingWorksheet.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.DiagnosticRatingWorksheet.class, config);
    com.guidewire._generated.entity.DiagnosticRatingWorksheetInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.DiagnosticRatingWorksheet, com.guidewire._generated.entity.DiagnosticRatingWorksheetInternal>() {
      public java.lang.Object getImplementation(entity.DiagnosticRatingWorksheet bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.DiagnosticRatingWorksheetInternal getInternalInterface(entity.DiagnosticRatingWorksheet bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.DiagnosticRatingWorksheet newEmptyInstance() {
        return new entity.DiagnosticRatingWorksheet((java.lang.Void)null);
      }

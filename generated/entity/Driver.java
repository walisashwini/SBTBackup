...
@gw.entity.EntityName(value = "Driver")
public class Driver extends entity.AccountContactRole implements entity.Extractable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.Driver> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.Driver>("entity.Driver");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DATECOMPLETEDTRAININGCLASS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DateCompletedTrainingClass");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> TRAININGCLASSTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "TrainingClassType");
   ...
   */
  public Driver(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected Driver(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.DriverInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.DriverInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.DriverInternal)super.__getInternalInterface();
  }
  ...
  public java.util.Date getDateCompletedTrainingClass() {
    return (java.util.Date)__getInternalInterface().getFieldValue(DATECOMPLETEDTRAININGCLASS_PROP.get());
  }
  ...
  public typekey.TrainingClassType getTrainingClassType() {
    return (typekey.TrainingClassType)__getInternalInterface().getFieldValue(TRAININGCLASSTYPE_PROP.get());
  }
  ...
  public void setDateCompletedTrainingClass(java.util.Date value) {
    __getInternalInterface().setFieldValue(DATECOMPLETEDTRAININGCLASS_PROP.get(), value);
  }
  ...
  public void setTrainingClassType(typekey.TrainingClassType value) {
    __getInternalInterface().setFieldValue(TRAININGCLASSTYPE_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.DriverInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.Driver.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.Driver.class, config);
    com.guidewire._generated.entity.DriverInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.Driver, com.guidewire._generated.entity.DriverInternal>() {
      public java.lang.Object getImplementation(entity.Driver bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.DriverInternal getInternalInterface(entity.Driver bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.Driver newEmptyInstance() {
        return new entity.Driver((java.lang.Void)null);
      }

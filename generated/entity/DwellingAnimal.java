...
@gw.entity.EntityName(value = "DwellingAnimal")
public class DwellingAnimal extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.DwellingAnimal, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.DwellingAnimal, entity.PolicyPeriod>("entity.DwellingAnimal");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ANIMALBITEHISTORY_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AnimalBiteHistory");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> ANIMALBREED_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "AnimalBreed");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> ANIMALTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "AnimalType");
  ...
  private com.guidewire._generated.entity.DwellingAnimalInternal _internal;
   ...
   */
  public DwellingAnimal(entity.PolicyPeriod branch)  {
   ...
   */
  public DwellingAnimal(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected DwellingAnimal(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.DwellingAnimalInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.DwellingAnimalInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.DwellingAnimal clone() {
    return (entity.DwellingAnimal)__getInternalInterface().cloneUntyped();
  }
  ...
  public typekey.AnimalBreed getAnimalBreed() {
    return (typekey.AnimalBreed)__getInternalInterface().getFieldValue(ANIMALBREED_PROP.get());
  }
  ...
  public typekey.AnimalType getAnimalType() {
    return (typekey.AnimalType)__getInternalInterface().getFieldValue(ANIMALTYPE_PROP.get());
  }
  ...
  public entity.DwellingAnimal getBasedOn() {
    return (entity.DwellingAnimal)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.DwellingAnimal getBasedOnValue() {
    return (entity.DwellingAnimal)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.DwellingAnimal getFixed() {
    return (entity.DwellingAnimal)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.DwellingAnimal getSlice(java.util.Date sliceDate) {
    return (entity.DwellingAnimal)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.DwellingAnimal getSubtype() {
    return (typekey.DwellingAnimal)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.DwellingAnimal getUnsliced() {
    return (entity.DwellingAnimal)getUnslicedUntyped();
  }
  ...
  public entity.windowed.DwellingAnimalVersionList getVersionList() {
    return (entity.windowed.DwellingAnimalVersionList)getVersionListUntyped();
  }
  ...
  public java.lang.Boolean isAnimalBiteHistory() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(ANIMALBITEHISTORY_PROP.get());
  }
  ...
  public void setAnimalBiteHistory(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(ANIMALBITEHISTORY_PROP.get(), value);
  }
  ...
  public void setAnimalBreed(typekey.AnimalBreed value) {
    __getInternalInterface().setFieldValue(ANIMALBREED_PROP.get(), value);
  }
  ...
  public void setAnimalType(typekey.AnimalType value) {
    __getInternalInterface().setFieldValue(ANIMALTYPE_PROP.get(), value);
  }
   ...
   */
  private void setBasedOnValue(entity.DwellingAnimal value) {
   ...
   */
  private void setFixed(entity.DwellingAnimal value) {
   ...
   */
  private void setSubtype(typekey.DwellingAnimal value) {
  ...
  public entity.DwellingAnimal split(java.util.Date splitDate) {
    return (entity.DwellingAnimal)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.DwellingAnimalInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.DwellingAnimal.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.DwellingAnimal.class, config);
    com.guidewire._generated.entity.DwellingAnimalInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.DwellingAnimal, com.guidewire._generated.entity.DwellingAnimalInternal>() {
      public java.lang.Object getImplementation(entity.DwellingAnimal bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.DwellingAnimalInternal getInternalInterface(entity.DwellingAnimal bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.DwellingAnimal newEmptyInstance() {
        return new entity.DwellingAnimal((java.lang.Void)null);
      }

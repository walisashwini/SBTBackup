...
/**
 * ETLCovTermOpt
 * Database representation of Product Model coverage term option patterns
 */
...
@gw.entity.EntityName(value = "ETLCovTermOpt")
public class ETLCovTermOpt extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ETLCovTermOpt> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ETLCovTermOpt>("entity.ETLCovTermOpt");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> OPTIONCODE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "OptionCode");
  ...
  private com.guidewire._generated.entity.ETLCovTermOptInternal _internal;
   ...
   */
  public ETLCovTermOpt(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ETLCovTermOpt(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ETLCovTermOptInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ETLCovTermOptInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.ETLOptionCovTermPattern getCoverageTermPattern() {
    return (entity.ETLOptionCovTermPattern)__getInternalInterface().getFieldValue(COVERAGETERMPATTERN_PROP.get());
  }
  ...
  public java.lang.String getOptionCode() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(OPTIONCODE_PROP.get());
  }
  ...
  public typekey.ETLCovTermOpt getSubtype() {
    return (typekey.ETLCovTermOpt)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public void setOptionCode(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(OPTIONCODE_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.ETLCovTermOpt value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ETLCovTermOptInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ETLCovTermOpt.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ETLCovTermOpt.class, config);
    com.guidewire._generated.entity.ETLCovTermOptInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ETLCovTermOpt, com.guidewire._generated.entity.ETLCovTermOptInternal>() {
      public java.lang.Object getImplementation(entity.ETLCovTermOpt bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ETLCovTermOptInternal getInternalInterface(entity.ETLCovTermOpt bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ETLCovTermOpt newEmptyInstance() {
        return new entity.ETLCovTermOpt((java.lang.Void)null);
      }

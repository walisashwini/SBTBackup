...
@gw.entity.EntityName(value = "ETLCoverageTermPattern")
public class ETLCoverageTermPattern extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ETLCoverageTermPattern> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ETLCoverageTermPattern>("entity.ETLCoverageTermPattern");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BEANVERSION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BeanVersion");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> CLAUSEPATTERN_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ClausePattern");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> COVTERMTYPE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CovTermType");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ID");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MODELTYPE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ModelType");
  ...
  private com.guidewire._generated.entity.ETLCoverageTermPatternInternal _internal;
   ...
   */
  public ETLCoverageTermPattern(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ETLCoverageTermPattern(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ETLCoverageTermPatternInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ETLCoverageTermPatternInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setSubtype(typekey.ETLCoverageTermPattern value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ETLCoverageTermPatternInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ETLCoverageTermPattern.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ETLCoverageTermPattern.class, config);
    com.guidewire._generated.entity.ETLCoverageTermPatternInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ETLCoverageTermPattern, com.guidewire._generated.entity.ETLCoverageTermPatternInternal>() {
      public java.lang.Object getImplementation(entity.ETLCoverageTermPattern bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ETLCoverageTermPatternInternal getInternalInterface(entity.ETLCoverageTermPattern bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ETLCoverageTermPattern newEmptyInstance() {
        return new entity.ETLCoverageTermPattern((java.lang.Void)null);
      }

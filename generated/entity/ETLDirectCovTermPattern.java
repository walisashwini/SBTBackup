 ...
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ETLDirectCovTermPattern.eti;ETLDirectCovTermPattern.eix;ETLDirectCovTermPattern.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ETLDirectCovTermPattern")
public class ETLDirectCovTermPattern extends entity.ETLCoverageTermPattern {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ETLDirectCovTermPattern> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ETLDirectCovTermPattern>("entity.ETLDirectCovTermPattern");
   ...
   */
  public ETLDirectCovTermPattern()  {
   ...
   */
  public ETLDirectCovTermPattern(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ETLDirectCovTermPattern(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ETLDirectCovTermPatternInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ETLDirectCovTermPatternInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ETLDirectCovTermPatternInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ETLDirectCovTermPatternInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ETLDirectCovTermPattern.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ETLDirectCovTermPattern.class, config);
    com.guidewire._generated.entity.ETLDirectCovTermPatternInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ETLDirectCovTermPattern, com.guidewire._generated.entity.ETLDirectCovTermPatternInternal>() {
      public java.lang.Object getImplementation(entity.ETLDirectCovTermPattern bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ETLDirectCovTermPatternInternal getInternalInterface(entity.ETLDirectCovTermPattern bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ETLDirectCovTermPattern newEmptyInstance() {
        return new entity.ETLDirectCovTermPattern((java.lang.Void)null);
      }

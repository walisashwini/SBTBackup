 ...
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ETLGenericCovTermPattern.eti;ETLGenericCovTermPattern.eix;ETLGenericCovTermPattern.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ETLGenericCovTermPattern")
public class ETLGenericCovTermPattern extends entity.ETLCoverageTermPattern {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ETLGenericCovTermPattern> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ETLGenericCovTermPattern>("entity.ETLGenericCovTermPattern");
   ...
   */
  public ETLGenericCovTermPattern()  {
   ...
   */
  public ETLGenericCovTermPattern(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ETLGenericCovTermPattern(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ETLGenericCovTermPatternInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ETLGenericCovTermPatternInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ETLGenericCovTermPatternInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ETLGenericCovTermPatternInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ETLGenericCovTermPattern.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ETLGenericCovTermPattern.class, config);
    com.guidewire._generated.entity.ETLGenericCovTermPatternInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ETLGenericCovTermPattern, com.guidewire._generated.entity.ETLGenericCovTermPatternInternal>() {
      public java.lang.Object getImplementation(entity.ETLGenericCovTermPattern bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ETLGenericCovTermPatternInternal getInternalInterface(entity.ETLGenericCovTermPattern bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ETLGenericCovTermPattern newEmptyInstance() {
        return new entity.ETLGenericCovTermPattern((java.lang.Void)null);
      }

...
/**
 * ETLModifierPattern
 * Database representation of Product Model modifier patterns
 */
...
@gw.entity.EntityName(value = "ETLModifierPattern")
public class ETLModifierPattern extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ETLModifierPattern> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ETLModifierPattern>("entity.ETLModifierPattern");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MODIFIERDATATYPE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ModifierDataType");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> RATEFACTORPATTERNS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "RateFactorPatterns");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> SCHEDULERATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ScheduleRate");
  ...
  private com.guidewire._generated.entity.ETLModifierPatternInternal _internal;
   ...
   */
  public ETLModifierPattern(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ETLModifierPattern(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ETLModifierPatternInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ETLModifierPatternInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToRateFactorPatterns(entity.ETLRateFactorPattern element) {
    __getInternalInterface().addArrayElement(RATEFACTORPATTERNS_PROP.get(), element);
  }
  ...
  public java.lang.String getModifierDataType() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(MODIFIERDATATYPE_PROP.get());
  }
  ...
  public entity.ETLRateFactorPattern[] getRateFactorPatterns() {
    return (entity.ETLRateFactorPattern[])__getInternalInterface().getFieldValue(RATEFACTORPATTERNS_PROP.get());
  }
  ...
  public java.lang.String getScheduleRate() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(SCHEDULERATE_PROP.get());
  }
  ...
  public void removeFromRateFactorPatterns(entity.ETLRateFactorPattern element) {
    __getInternalInterface().removeArrayElement(RATEFACTORPATTERNS_PROP.get(), element);
  }
  ...
  public void removeFromRateFactorPatterns(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(RATEFACTORPATTERNS_PROP.get(), elementID);
  }
  ...
  public void setModifierDataType(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(MODIFIERDATATYPE_PROP.get(), value);
  }
  ...
  public void setRateFactorPatterns(entity.ETLRateFactorPattern[] value) {
    __getInternalInterface().setFieldValue(RATEFACTORPATTERNS_PROP.get(), value);
  }
  ...
  public void setScheduleRate(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(SCHEDULERATE_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ETLModifierPatternInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ETLModifierPattern.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ETLModifierPattern.class, config);
    com.guidewire._generated.entity.ETLModifierPatternInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ETLModifierPattern, com.guidewire._generated.entity.ETLModifierPatternInternal>() {
      public java.lang.Object getImplementation(entity.ETLModifierPattern bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ETLModifierPatternInternal getInternalInterface(entity.ETLModifierPattern bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ETLModifierPattern newEmptyInstance() {
        return new entity.ETLModifierPattern((java.lang.Void)null);
      }

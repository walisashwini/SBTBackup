...
@gw.entity.EntityName(value = "ETLOptionCovTermPattern")
public class ETLOptionCovTermPattern extends entity.ETLCoverageTermPattern {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ETLOptionCovTermPattern> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ETLOptionCovTermPattern>("entity.ETLOptionCovTermPattern");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> OPTIONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "Options");
   ...
   */
  public ETLOptionCovTermPattern()  {
   ...
   */
  public ETLOptionCovTermPattern(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ETLOptionCovTermPattern(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ETLOptionCovTermPatternInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ETLOptionCovTermPatternInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ETLOptionCovTermPatternInternal)super.__getInternalInterface();
  }
  ...
  public void addToOptions(entity.ETLCovTermOpt element) {
    __getInternalInterface().addArrayElement(OPTIONS_PROP.get(), element);
  }
  ...
  public entity.ETLCovTermOpt[] getOptions() {
    return (entity.ETLCovTermOpt[])__getInternalInterface().getFieldValue(OPTIONS_PROP.get());
  }
  ...
  public void removeFromOptions(entity.ETLCovTermOpt element) {
    __getInternalInterface().removeArrayElement(OPTIONS_PROP.get(), element);
  }
  ...
  public void removeFromOptions(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(OPTIONS_PROP.get(), elementID);
  }
  ...
  public void setOptions(entity.ETLCovTermOpt[] value) {
    __getInternalInterface().setFieldValue(OPTIONS_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ETLOptionCovTermPatternInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ETLOptionCovTermPattern.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ETLOptionCovTermPattern.class, config);
    com.guidewire._generated.entity.ETLOptionCovTermPatternInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ETLOptionCovTermPattern, com.guidewire._generated.entity.ETLOptionCovTermPatternInternal>() {
      public java.lang.Object getImplementation(entity.ETLOptionCovTermPattern bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ETLOptionCovTermPatternInternal getInternalInterface(entity.ETLOptionCovTermPattern bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ETLOptionCovTermPattern newEmptyInstance() {
        return new entity.ETLOptionCovTermPattern((java.lang.Void)null);
      }

...
/**
 * ETLPackageTerm
 * Database representation of Product Model package term patterns
 */
...
@gw.entity.EntityName(value = "ETLPackageTerm")
public class ETLPackageTerm extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ETLPackageTerm> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ETLPackageTerm>("entity.ETLPackageTerm");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> COVTERMPACK_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "CovTermPack");
  ...
  private com.guidewire._generated.entity.ETLPackageTermInternal _internal;
   ...
   */
  public ETLPackageTerm(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ETLPackageTerm(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ETLPackageTermInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ETLPackageTermInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.ETLCovTermPack getCovTermPack() {
    return (entity.ETLCovTermPack)__getInternalInterface().getFieldValue(COVTERMPACK_PROP.get());
  }
  ...
  public typekey.ETLPackageTerm getSubtype() {
    return (typekey.ETLPackageTerm)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public void setCovTermPack(entity.ETLCovTermPack value) {
    __getInternalInterface().setFieldValue(COVTERMPACK_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.ETLPackageTerm value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ETLPackageTermInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ETLPackageTerm.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getCovTermPackID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(COVTERMPACK_PROP.get());
    }
    ...
    public void setCovTermPackID(gw.pl.persistence.core.Key value) {
      setFieldValue(COVTERMPACK_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ETLPackageTerm.class, config);
    com.guidewire._generated.entity.ETLPackageTermInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ETLPackageTerm, com.guidewire._generated.entity.ETLPackageTermInternal>() {
      public java.lang.Object getImplementation(entity.ETLPackageTerm bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ETLPackageTermInternal getInternalInterface(entity.ETLPackageTerm bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ETLPackageTerm newEmptyInstance() {
        return new entity.ETLPackageTerm((java.lang.Void)null);
      }

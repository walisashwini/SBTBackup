 ...
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ETLTypekeyCovTermPattern.eti;ETLTypekeyCovTermPattern.eix;ETLTypekeyCovTermPattern.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ETLTypekeyCovTermPattern")
public class ETLTypekeyCovTermPattern extends entity.ETLCoverageTermPattern {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ETLTypekeyCovTermPattern> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ETLTypekeyCovTermPattern>("entity.ETLTypekeyCovTermPattern");
   ...
   */
  public ETLTypekeyCovTermPattern()  {
   ...
   */
  public ETLTypekeyCovTermPattern(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ETLTypekeyCovTermPattern(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ETLTypekeyCovTermPatternInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ETLTypekeyCovTermPatternInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ETLTypekeyCovTermPatternInternal)super.__getInternalInterface();
  }
  
  /**
   * Gets the value of the Typelist field.
   * The typelist that this Coverage Term Pattern references
   */
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ETLTypekeyCovTermPatternInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ETLTypekeyCovTermPattern.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ETLTypekeyCovTermPattern.class, config);
    com.guidewire._generated.entity.ETLTypekeyCovTermPatternInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ETLTypekeyCovTermPattern, com.guidewire._generated.entity.ETLTypekeyCovTermPatternInternal>() {
      public java.lang.Object getImplementation(entity.ETLTypekeyCovTermPattern bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ETLTypekeyCovTermPatternInternal getInternalInterface(entity.ETLTypekeyCovTermPattern bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ETLTypekeyCovTermPattern newEmptyInstance() {
        return new entity.ETLTypekeyCovTermPattern((java.lang.Void)null);
      }

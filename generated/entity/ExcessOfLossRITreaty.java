 ...
 * 
 *     Gross Excess of Loss reinsurance treaty.  
 *   
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ExcessOfLossRITreaty.eti;ExcessOfLossRITreaty.eix;ExcessOfLossRITreaty.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ExcessOfLossRITreaty")
public class ExcessOfLossRITreaty extends entity.NonProportionalRIAgreement implements entity.PerRisk, entity.Treaty, entity.LossDateAttachable {
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.reinsurance.ExcessOfLossRITreatyPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.ExcessOfLossRITreatyImpl");
    config.put("com.guidewire.pc.domain.reinsurance.LossDateAttachablePublicMethods", "com.guidewire.pc.domain.reinsurance.impl.ExcessOfLossRITreatyImpl");
    config.put("com.guidewire.pc.domain.reinsurance.NonProportionalRIAgreementPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.ExcessOfLossRITreatyImpl");
    config.put("com.guidewire.pc.domain.reinsurance.PerRiskPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.PerRiskImpl");
    config.put("com.guidewire.pc.domain.reinsurance.RIAgreementPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.ExcessOfLossRITreatyImpl");
    ...
    config.put("com.guidewire.pc.domain.reinsurance.impl.RIAgreementInternalMethods", "com.guidewire.pc.domain.reinsurance.impl.ExcessOfLossRITreatyImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.reinsurance.impl.ExcessOfLossRITreatyImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.pc.domain.reinsurance.impl.ExcessOfLossRITreatyImpl");
    config.put("gw.api.contact.ContactOwner", "com.guidewire.pc.domain.reinsurance.impl.ExcessOfLossRITreatyImpl");
    config.put("gw.api.domain.reinsurance.RICoverageGroupOwner", "com.guidewire.pc.domain.reinsurance.impl.ExcessOfLossRITreatyImpl");

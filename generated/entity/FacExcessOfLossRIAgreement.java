 ...
 *   
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "FacExcessOfLossRIAgreement.eti;FacExcessOfLossRIAgreement.eix;FacExcessOfLossRIAgreement.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "FacExcessOfLossRIAgreement")
public class FacExcessOfLossRIAgreement extends entity.NonProportionalRIAgreement implements entity.Facultative, entity.PerRisk, gw.api.reinsurance.CedingRecipient {
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.reinsurance.FacExcessOfLossRIAgreementPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.FacExcessOfLossRIAgreementImpl");
    ...
    config.put("com.guidewire.pc.domain.reinsurance.NonProportionalRIAgreementPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.FacExcessOfLossRIAgreementImpl");
    config.put("com.guidewire.pc.domain.reinsurance.PerRiskPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.PerRiskImpl");
    config.put("com.guidewire.pc.domain.reinsurance.RIAgreementPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.FacExcessOfLossRIAgreementImpl");
    ...
    config.put("com.guidewire.pc.domain.reinsurance.impl.RIAgreementInternalMethods", "com.guidewire.pc.domain.reinsurance.impl.FacExcessOfLossRIAgreementImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.reinsurance.impl.FacExcessOfLossRIAgreementImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.pc.domain.reinsurance.impl.FacExcessOfLossRIAgreementImpl");
    config.put("gw.api.contact.ContactOwner", "com.guidewire.pc.domain.reinsurance.impl.FacExcessOfLossRIAgreementImpl");
    config.put("gw.api.domain.reinsurance.RICoverageGroupOwner", "com.guidewire.pc.domain.reinsurance.impl.FacExcessOfLossRIAgreementImpl");
    config.put("gw.api.reinsurance.CedingRecipient", "gw.plugin.reinsurance.FacXOLCedingRecipientAdapter");

 ...
 * 
 *     Facultative Proportional reinsurance agreement.  
 *   
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "FacProportionalRIAgreement.eti;FacProportionalRIAgreement.eix;FacProportionalRIAgreement.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "FacProportionalRIAgreement")
public class FacProportionalRIAgreement extends entity.ProportionalRIAgreement implements entity.PerRisk, entity.Facultative, gw.api.reinsurance.CedingRecipient {
  ...
  public java.math.BigDecimal getMarkUp() {
    return ((com.guidewire.pc.domain.reinsurance.FacProportionalRIAgreementPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.reinsurance.FacProportionalRIAgreementPublicMethods")).getMarkUp();
  }
  ...
  @com.guidewire.pl.persistence.codegen.annotation.OverridesAccessor
  public void setMarkUp(java.math.BigDecimal o1) {
    ((com.guidewire.pc.domain.reinsurance.FacProportionalRIAgreementPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.reinsurance.FacProportionalRIAgreementPublicMethods")).setMarkUp(o1);
  }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.reinsurance.FacProportionalRIAgreementPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.FacProportionalRIAgreementImpl");
    ...
    config.put("com.guidewire.pc.domain.reinsurance.ProportionalRIAgreementPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.FacProportionalRIAgreementImpl");
    config.put("com.guidewire.pc.domain.reinsurance.RIAgreementPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.FacProportionalRIAgreementImpl");
    ...
    config.put("com.guidewire.pc.domain.reinsurance.impl.RIAgreementInternalMethods", "com.guidewire.pc.domain.reinsurance.impl.FacProportionalRIAgreementImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.reinsurance.impl.FacProportionalRIAgreementImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.pc.domain.reinsurance.impl.FacProportionalRIAgreementImpl");
    config.put("gw.api.contact.ContactOwner", "com.guidewire.pc.domain.reinsurance.impl.FacProportionalRIAgreementImpl");
    config.put("gw.api.domain.reinsurance.RICoverageGroupOwner", "com.guidewire.pc.domain.reinsurance.impl.FacProportionalRIAgreementImpl");
    config.put("gw.api.reinsurance.CedingRecipient", "gw.plugin.reinsurance.FacPropCedingRecipientAdapter");

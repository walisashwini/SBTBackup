...
@gw.entity.EntityName(value = "FormAssociation")
public class FormAssociation extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.FormAssociation, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.FormAssociation, entity.PolicyPeriod>("entity.FormAssociation");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> FORM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "Form");
  ...
  private com.guidewire._generated.entity.FormAssociationInternal _internal;
   ...
   */
  public FormAssociation(entity.PolicyPeriod branch)  {
   ...
   */
  public FormAssociation(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected FormAssociation(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.FormAssociationInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.FormAssociationInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.FormAssociation clone() {
    return (entity.FormAssociation)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.FormAssociation getBasedOn() {
    return (entity.FormAssociation)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.FormAssociation getSlice(java.util.Date sliceDate) {
    return (entity.FormAssociation)getSliceUntyped(sliceDate);
  }
  ...
  public entity.FormAssociation getUnsliced() {
    return (entity.FormAssociation)getUnslicedUntyped();
  }
  ...
  public entity.windowed.FormAssociationVersionList getVersionList() {
    return (entity.windowed.FormAssociationVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.FormAssociation value) {
   ...
   */
  private void setFixed(entity.FormAssociation value) {
   ...
   */
  private void setSubtype(typekey.FormAssociation value) {
  ...
  public entity.FormAssociation split(java.util.Date splitDate) {
    return (entity.FormAssociation)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.FormAssociationInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.FormAssociation.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.FormAssociation.class, config);
    com.guidewire._generated.entity.FormAssociationInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.FormAssociation, com.guidewire._generated.entity.FormAssociationInternal>() {
      public java.lang.Object getImplementation(entity.FormAssociation bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.FormAssociationInternal getInternalInterface(entity.FormAssociation bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.FormAssociation newEmptyInstance() {
        return new entity.FormAssociation((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "FormEdgeTable")
public class FormEdgeTable extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.FormEdgeTable, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.FormEdgeTable, entity.PolicyPeriod>("entity.FormEdgeTable");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> OWNINGFORM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "OwningForm");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PUBLICID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PublicID");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> TARGETFORM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "TargetForm");
  ...
  private com.guidewire._generated.entity.FormEdgeTableInternal _internal;
   ...
   */
  public FormEdgeTable(entity.PolicyPeriod branch)  {
   ...
   */
  public FormEdgeTable(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected FormEdgeTable(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.FormEdgeTableInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.FormEdgeTableInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.FormEdgeTable clone() {
    return (entity.FormEdgeTable)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.FormEdgeTable getBasedOn() {
    return (entity.FormEdgeTable)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.FormEdgeTable getBasedOnValue() {
    return (entity.FormEdgeTable)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.FormEdgeTable getFixed() {
    return (entity.FormEdgeTable)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.Form getOwningForm() {
    return (entity.Form)__getInternalInterface().getFieldValue(OWNINGFORM_PROP.get());
  }
  ...
  public entity.FormEdgeTable getSlice(java.util.Date sliceDate) {
    return (entity.FormEdgeTable)getSliceUntyped(sliceDate);
  }
  ...
  public entity.Form getTargetForm() {
    return (entity.Form)__getInternalInterface().getFieldValue(TARGETFORM_PROP.get());
  }
  
  public entity.FormEdgeTable getUnsliced() {
    return (entity.FormEdgeTable)getUnslicedUntyped();
  }
  ...
  public entity.windowed.FormEdgeTableVersionList getVersionList() {
    return (entity.windowed.FormEdgeTableVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.FormEdgeTable value) {
   ...
   */
  private void setFixed(entity.FormEdgeTable value) {
  ...
  public void setOwningForm(entity.Form value) {
    __getInternalInterface().setFieldValue(OWNINGFORM_PROP.get(), value);
  }
  ...
  public void setTargetForm(entity.Form value) {
    __getInternalInterface().setFieldValue(TARGETFORM_PROP.get(), value);
  }
  ...
  public entity.FormEdgeTable split(java.util.Date splitDate) {
    return (entity.FormEdgeTable)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.FormEdgeTableInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.FormEdgeTable.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getOwningFormID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(OWNINGFORM_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getTargetFormID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(TARGETFORM_PROP.get());
    }
    ...
    public void setOwningFormID(gw.pl.persistence.core.Key value) {
      setFieldValue(OWNINGFORM_PROP.get(), value);
    }
    ...
    public void setTargetFormID(gw.pl.persistence.core.Key value) {
      setFieldValue(TARGETFORM_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.FormEdgeTable.class, config);
    com.guidewire._generated.entity.FormEdgeTableInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.FormEdgeTable, com.guidewire._generated.entity.FormEdgeTableInternal>() {
      public java.lang.Object getImplementation(entity.FormEdgeTable bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.FormEdgeTableInternal getInternalInterface(entity.FormEdgeTable bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.FormEdgeTable newEmptyInstance() {
        return new entity.FormEdgeTable((java.lang.Void)null);
      }

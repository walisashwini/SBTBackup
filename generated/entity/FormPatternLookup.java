...
/**
 * FormPatternLookup
 * A lookup entity specifying conditions under which a particular form is attached to a policy.
 */
...
@gw.entity.EntityName(value = "FormPatternLookup")
public class FormPatternLookup extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.FormPatternLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.FormPatternLookup>("entity.FormPatternLookup");
  ...
  private com.guidewire._generated.entity.FormPatternLookupInternal _internal;
   ...
   */
  public FormPatternLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected FormPatternLookup(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.FormPatternLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.FormPatternLookupInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.FormPatternLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.FormPatternLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.FormPatternLookup.class, config);
    com.guidewire._generated.entity.FormPatternLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.FormPatternLookup, com.guidewire._generated.entity.FormPatternLookupInternal>() {
      public java.lang.Object getImplementation(entity.FormPatternLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.FormPatternLookupInternal getInternalInterface(entity.FormPatternLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.FormPatternLookup newEmptyInstance() {
        return new entity.FormPatternLookup((java.lang.Void)null);
      }

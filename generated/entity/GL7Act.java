...
@gw.entity.EntityName(value = "GL7Act")
public class GL7Act extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7Act> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7Act>("entity.GL7Act");
  ...
  private com.guidewire._generated.entity.GL7ActInternal _internal;
   ...
   */
  public GL7Act(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7Act(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ActInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ActInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ActInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7Act.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7Act.class, config);
    com.guidewire._generated.entity.GL7ActInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7Act, com.guidewire._generated.entity.GL7ActInternal>() {
      public java.lang.Object getImplementation(entity.GL7Act bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ActInternal getInternalInterface(entity.GL7Act bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7Act newEmptyInstance() {
        return new entity.GL7Act((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "GL7AggregateLimitLiquor")
public class GL7AggregateLimitLiquor extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7AggregateLimitLiquor> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7AggregateLimitLiquor>("entity.GL7AggregateLimitLiquor");
  ...
  private com.guidewire._generated.entity.GL7AggregateLimitLiquorInternal _internal;
   ...
   */
  public GL7AggregateLimitLiquor()  {
   ...
   */
  public GL7AggregateLimitLiquor(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7AggregateLimitLiquor(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7AggregateLimitLiquorInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7AggregateLimitLiquorInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7AggregateLimitLiquorInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7AggregateLimitLiquor.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7AggregateLimitLiquor.class, config);
    com.guidewire._generated.entity.GL7AggregateLimitLiquorInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7AggregateLimitLiquor, com.guidewire._generated.entity.GL7AggregateLimitLiquorInternal>() {
      public java.lang.Object getImplementation(entity.GL7AggregateLimitLiquor bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7AggregateLimitLiquorInternal getInternalInterface(entity.GL7AggregateLimitLiquor bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7AggregateLimitLiquor newEmptyInstance() {
        return new entity.GL7AggregateLimitLiquor((java.lang.Void)null);
      }

...
/**
 * GL7AggregateLimitOwnersCo
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7AggregateLimitOwnersCo.eti;GL7AggregateLimitOwnersCo.eix;GL7AggregateLimitOwnersCo.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7AggregateLimitOwnersCo")
public class GL7AggregateLimitOwnersCo extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7AggregateLimitOwnersCo> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7AggregateLimitOwnersCo>("entity.GL7AggregateLimitOwnersCo");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> EACHOCCURRENCELIMOWNERSCONTRAC_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "EachOccurrenceLimOwnersContrac");
  ...
  private com.guidewire._generated.entity.GL7AggregateLimitOwnersCoInternal _internal;
   ...
   */
  public GL7AggregateLimitOwnersCo()  {
   ...
   */
  public GL7AggregateLimitOwnersCo(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7AggregateLimitOwnersCo(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7AggregateLimitOwnersCoInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7AggregateLimitOwnersCoInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Gets the value of the EachOccurrenceLimOwnersContrac field.
   * EachOccurrenceLimitOwnersContractors
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getEachOccurrenceLimOwnersContrac() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(EACHOCCURRENCELIMOWNERSCONTRAC_PROP.get());
  }
  ...
  /**
   * Sets the value of the EachOccurrenceLimOwnersContrac field.
   */
  public void setEachOccurrenceLimOwnersContrac(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(EACHOCCURRENCELIMOWNERSCONTRAC_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7AggregateLimitOwnersCoInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7AggregateLimitOwnersCo.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7AggregateLimitOwnersCo.class, config);
    com.guidewire._generated.entity.GL7AggregateLimitOwnersCoInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7AggregateLimitOwnersCo, com.guidewire._generated.entity.GL7AggregateLimitOwnersCoInternal>() {
      public java.lang.Object getImplementation(entity.GL7AggregateLimitOwnersCo bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7AggregateLimitOwnersCoInternal getInternalInterface(entity.GL7AggregateLimitOwnersCo bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7AggregateLimitOwnersCo newEmptyInstance() {
        return new entity.GL7AggregateLimitOwnersCo((java.lang.Void)null);
      }

...
/**
 * GL7AggregateLimitRailroad
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7AggregateLimitRailroad.eti;GL7AggregateLimitRailroad.eix;GL7AggregateLimitRailroad.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7AggregateLimitRailroad")
public class GL7AggregateLimitRailroad extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7AggregateLimitRailroad> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7AggregateLimitRailroad>("entity.GL7AggregateLimitRailroad");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> EACHOCCURRENCELIMRAILROAD_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "EachOccurrenceLimRailroad");
  ...
  private com.guidewire._generated.entity.GL7AggregateLimitRailroadInternal _internal;
   ...
   */
  public GL7AggregateLimitRailroad()  {
   ...
   */
  public GL7AggregateLimitRailroad(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7AggregateLimitRailroad(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7AggregateLimitRailroadInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7AggregateLimitRailroadInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Gets the value of the EachOccurrenceLimRailroad field.
   * EachOccurrenceLimitRailroad
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getEachOccurrenceLimRailroad() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(EACHOCCURRENCELIMRAILROAD_PROP.get());
  }
  ...
  /**
   * Sets the value of the EachOccurrenceLimRailroad field.
   */
  public void setEachOccurrenceLimRailroad(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(EACHOCCURRENCELIMRAILROAD_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7AggregateLimitRailroadInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7AggregateLimitRailroad.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7AggregateLimitRailroad.class, config);
    com.guidewire._generated.entity.GL7AggregateLimitRailroadInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7AggregateLimitRailroad, com.guidewire._generated.entity.GL7AggregateLimitRailroadInternal>() {
      public java.lang.Object getImplementation(entity.GL7AggregateLimitRailroad bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7AggregateLimitRailroadInternal getInternalInterface(entity.GL7AggregateLimitRailroad bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7AggregateLimitRailroad newEmptyInstance() {
        return new entity.GL7AggregateLimitRailroad((java.lang.Void)null);
      }

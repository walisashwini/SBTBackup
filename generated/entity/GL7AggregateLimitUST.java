...
/**
 * GL7AggregateLimitUST
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7AggregateLimitUST.eti;GL7AggregateLimitUST.eix;GL7AggregateLimitUST.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7AggregateLimitUST")
public class GL7AggregateLimitUST extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7AggregateLimitUST> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7AggregateLimitUST>("entity.GL7AggregateLimitUST");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> INCIDENTLIMUST_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "IncidentLimUST");
  ...
  private com.guidewire._generated.entity.GL7AggregateLimitUSTInternal _internal;
   ...
   */
  public GL7AggregateLimitUST(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7AggregateLimitUST(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7AggregateLimitUSTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7AggregateLimitUSTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Gets the value of the IncidentLimUST field.
   * IncidentLimitUST
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getIncidentLimUST() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(INCIDENTLIMUST_PROP.get());
  }
  ...
  /**
   * Sets the value of the IncidentLimUST field.
   */
  public void setIncidentLimUST(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(INCIDENTLIMUST_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7AggregateLimitUSTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7AggregateLimitUST.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7AggregateLimitUST.class, config);
    com.guidewire._generated.entity.GL7AggregateLimitUSTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7AggregateLimitUST, com.guidewire._generated.entity.GL7AggregateLimitUSTInternal>() {
      public java.lang.Object getImplementation(entity.GL7AggregateLimitUST bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7AggregateLimitUSTInternal getInternalInterface(entity.GL7AggregateLimitUST bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7AggregateLimitUST newEmptyInstance() {
        return new entity.GL7AggregateLimitUST((java.lang.Void)null);
      }

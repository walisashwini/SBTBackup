...
@gw.entity.EntityName(value = "GL7BaseELPRRRT")
public class GL7BaseELPRRRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7BaseELPRRRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7BaseELPRRRT>("entity.GL7BaseELPRRRT");
  ...
  private com.guidewire._generated.entity.GL7BaseELPRRRTInternal _internal;
   ...
   */
  public GL7BaseELPRRRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7BaseELPRRRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7BaseELPRRRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7BaseELPRRRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7BaseELPRRRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7BaseELPRRRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7BaseELPRRRT.class, config);
    com.guidewire._generated.entity.GL7BaseELPRRRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7BaseELPRRRT, com.guidewire._generated.entity.GL7BaseELPRRRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7BaseELPRRRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7BaseELPRRRTInternal getInternalInterface(entity.GL7BaseELPRRRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7BaseELPRRRT newEmptyInstance() {
        return new entity.GL7BaseELPRRRT((java.lang.Void)null);
      }

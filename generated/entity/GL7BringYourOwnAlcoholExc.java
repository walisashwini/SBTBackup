...
/**
 * GL7BringYourOwnAlcoholExc
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7BringYourOwnAlcoholExc.eti;GL7BringYourOwnAlcoholExc.eix;GL7BringYourOwnAlcoholExc.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7BringYourOwnAlcoholExc")
public class GL7BringYourOwnAlcoholExc extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7BringYourOwnAlcoholExc> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7BringYourOwnAlcoholExc>("entity.GL7BringYourOwnAlcoholExc");
  ...
  private com.guidewire._generated.entity.GL7BringYourOwnAlcoholExcInternal _internal;
   ...
   */
  public GL7BringYourOwnAlcoholExc()  {
   ...
   */
  public GL7BringYourOwnAlcoholExc(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7BringYourOwnAlcoholExc(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7BringYourOwnAlcoholExcInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7BringYourOwnAlcoholExcInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7BringYourOwnAlcoholExcInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7BringYourOwnAlcoholExc.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7BringYourOwnAlcoholExc.class, config);
    com.guidewire._generated.entity.GL7BringYourOwnAlcoholExcInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7BringYourOwnAlcoholExc, com.guidewire._generated.entity.GL7BringYourOwnAlcoholExcInternal>() {
      public java.lang.Object getImplementation(entity.GL7BringYourOwnAlcoholExc bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7BringYourOwnAlcoholExcInternal getInternalInterface(entity.GL7BringYourOwnAlcoholExc bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7BringYourOwnAlcoholExc newEmptyInstance() {
        return new entity.GL7BringYourOwnAlcoholExc((java.lang.Void)null);
      }

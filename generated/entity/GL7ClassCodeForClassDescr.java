...
/**
 * GL7ClassCodeForClassDescr
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7ClassCodeForClassDescr.eti;GL7ClassCodeForClassDescr.eix;GL7ClassCodeForClassDescr.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7ClassCodeForClassDescr")
public class GL7ClassCodeForClassDescr extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ClassCodeForClassDescr> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ClassCodeForClassDescr>("entity.GL7ClassCodeForClassDescr");
  ...
  private com.guidewire._generated.entity.GL7ClassCodeForClassDescrInternal _internal;
   ...
   */
  public GL7ClassCodeForClassDescr()  {
   ...
   */
  public GL7ClassCodeForClassDescr(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ClassCodeForClassDescr(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ClassCodeForClassDescrInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ClassCodeForClassDescrInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ClassCodeForClassDescrInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ClassCodeForClassDescr.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ClassCodeForClassDescr.class, config);
    com.guidewire._generated.entity.GL7ClassCodeForClassDescrInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ClassCodeForClassDescr, com.guidewire._generated.entity.GL7ClassCodeForClassDescrInternal>() {
      public java.lang.Object getImplementation(entity.GL7ClassCodeForClassDescr bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ClassCodeForClassDescrInternal getInternalInterface(entity.GL7ClassCodeForClassDescr bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ClassCodeForClassDescr newEmptyInstance() {
        return new entity.GL7ClassCodeForClassDescr((java.lang.Void)null);
      }

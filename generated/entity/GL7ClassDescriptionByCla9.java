...
/**
 * GL7ClassDescriptionByCla9
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7ClassDescriptionByCla9.eti;GL7ClassDescriptionByCla9.eix;GL7ClassDescriptionByCla9.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7ClassDescriptionByCla9")
public class GL7ClassDescriptionByCla9 extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ClassDescriptionByCla9> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ClassDescriptionByCla9>("entity.GL7ClassDescriptionByCla9");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BEANVERSION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BeanVersion");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CLASSCODEFORCLASSDESCRIPTIONLI_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ClassCodeForClassDescriptionLi");
  ...
  private com.guidewire._generated.entity.GL7ClassDescriptionByCla9Internal _internal;
   ...
   */
  public GL7ClassDescriptionByCla9()  {
   ...
   */
  public GL7ClassDescriptionByCla9(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ClassDescriptionByCla9(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ClassDescriptionByCla9Internal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ClassDescriptionByCla9Internal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Gets the value of the ClassCodeForClassDescriptionLi field.
   * ClassCodeForClassDescriptionLiquor
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getClassCodeForClassDescriptionLi() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CLASSCODEFORCLASSDESCRIPTIONLI_PROP.get());
  }
  ...
  /**
   * Sets the value of the ClassCodeForClassDescriptionLi field.
   */
  public void setClassCodeForClassDescriptionLi(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CLASSCODEFORCLASSDESCRIPTIONLI_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ClassDescriptionByCla9Internal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ClassDescriptionByCla9.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ClassDescriptionByCla9.class, config);
    com.guidewire._generated.entity.GL7ClassDescriptionByCla9InternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ClassDescriptionByCla9, com.guidewire._generated.entity.GL7ClassDescriptionByCla9Internal>() {
      public java.lang.Object getImplementation(entity.GL7ClassDescriptionByCla9 bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ClassDescriptionByCla9Internal getInternalInterface(entity.GL7ClassDescriptionByCla9 bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ClassDescriptionByCla9 newEmptyInstance() {
        return new entity.GL7ClassDescriptionByCla9((java.lang.Void)null);
      }

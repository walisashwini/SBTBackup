...
/**
 * GL7ClassDescriptionByClas
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7ClassDescriptionByClas.eti;GL7ClassDescriptionByClas.eix;GL7ClassDescriptionByClas.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7ClassDescriptionByClas")
public class GL7ClassDescriptionByClas extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ClassDescriptionByClas> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ClassDescriptionByClas>("entity.GL7ClassDescriptionByClas");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BEANVERSION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BeanVersion");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CLASSCODEFORCLASSDESCRIPTION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ClassCodeForClassDescription");
  ...
  private com.guidewire._generated.entity.GL7ClassDescriptionByClasInternal _internal;
   ...
   */
  public GL7ClassDescriptionByClas()  {
   ...
   */
  public GL7ClassDescriptionByClas(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ClassDescriptionByClas(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ClassDescriptionByClasInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ClassDescriptionByClasInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Gets the value of the ClassCodeForClassDescription field.
   * ClassCodeForClassDescription
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getClassCodeForClassDescription() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CLASSCODEFORCLASSDESCRIPTION_PROP.get());
  }
  ...
  /**
   * Sets the value of the ClassCodeForClassDescription field.
   */
  public void setClassCodeForClassDescription(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CLASSCODEFORCLASSDESCRIPTION_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ClassDescriptionByClasInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ClassDescriptionByClas.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ClassDescriptionByClas.class, config);
    com.guidewire._generated.entity.GL7ClassDescriptionByClasInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ClassDescriptionByClas, com.guidewire._generated.entity.GL7ClassDescriptionByClasInternal>() {
      public java.lang.Object getImplementation(entity.GL7ClassDescriptionByClas bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ClassDescriptionByClasInternal getInternalInterface(entity.GL7ClassDescriptionByClas bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ClassDescriptionByClas newEmptyInstance() {
        return new entity.GL7ClassDescriptionByClas((java.lang.Void)null);
      }

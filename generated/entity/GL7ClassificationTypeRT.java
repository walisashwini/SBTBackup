...
/**
 * GL7ClassificationTypeRT
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7ClassificationTypeRT.eti;GL7ClassificationTypeRT.eix;GL7ClassificationTypeRT.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7ClassificationTypeRT")
public class GL7ClassificationTypeRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ClassificationTypeRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ClassificationTypeRT>("entity.GL7ClassificationTypeRT");
  ...
  private com.guidewire._generated.entity.GL7ClassificationTypeRTInternal _internal;
   ...
   */
  public GL7ClassificationTypeRT()  {
   ...
   */
  public GL7ClassificationTypeRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ClassificationTypeRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ClassificationTypeRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ClassificationTypeRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ClassificationTypeRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ClassificationTypeRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ClassificationTypeRT.class, config);
    com.guidewire._generated.entity.GL7ClassificationTypeRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ClassificationTypeRT, com.guidewire._generated.entity.GL7ClassificationTypeRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7ClassificationTypeRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ClassificationTypeRTInternal getInternalInterface(entity.GL7ClassificationTypeRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ClassificationTypeRT newEmptyInstance() {
        return new entity.GL7ClassificationTypeRT((java.lang.Void)null);
      }

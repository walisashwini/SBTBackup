...
/**
 * GL7Cost
 * A unit of premium or other cost (taxes, fees, etc.) for the General Liability line.
 */
...
public abstract class GL7Cost extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7Cost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7Cost, entity.PolicyPeriod>("entity.GL7Cost");
  ...
  private com.guidewire._generated.entity.GL7CostInternal _internal;
  ...
  protected GL7Cost(java.lang.Void ignored)  {
    
  }
  
  protected abstract com.guidewire._generated.entity.GL7CostInternal __createInternalInterface();
  ...
  protected com.guidewire._generated.entity.GL7CostInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7Cost clone() {
    return (entity.GL7Cost)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7Cost getBasedOn() {
    return (entity.GL7Cost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7Cost getSlice(java.util.Date sliceDate) {
    return (entity.GL7Cost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7Cost getUnsliced() {
    return (entity.GL7Cost)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7CostVersionList getVersionList() {
    return (entity.windowed.GL7CostVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7Cost value) {
   ...
   */
  private void setFixed(entity.GL7Cost value) {
   ...
   */
  private void setSubtype(typekey.GL7Cost value) {
   ...
   */
  private void setTransactions(entity.GL7Transaction[] value) {
  ...
  public entity.GL7Cost split(java.util.Date splitDate) {
    return (entity.GL7Cost)splitUntyped(splitDate);
  }
  ...
  static {
    com.guidewire._generated.entity.GL7CostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.EntityFriendAccess<entity.GL7Cost, com.guidewire._generated.entity.GL7CostInternal>() {
      public java.lang.Object getImplementation(entity.GL7Cost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7CostInternal getInternalInterface(entity.GL7Cost bean) {
        if(bean == null) {
          return null;
        };

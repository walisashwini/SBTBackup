 ...
 * GL7CoverageForm
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7CoverageForm.eti;GL7CoverageForm.eix;GL7CoverageForm.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7CoverageForm")
public class GL7CoverageForm extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7CoverageForm> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7CoverageForm>("entity.GL7CoverageForm");
  ...
  private com.guidewire._generated.entity.GL7CoverageFormInternal _internal;
   ...
   */
  public GL7CoverageForm(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7CoverageForm(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7CoverageFormInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7CoverageFormInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7CoverageFormInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7CoverageForm.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7CoverageForm.class, config);
    com.guidewire._generated.entity.GL7CoverageFormInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7CoverageForm, com.guidewire._generated.entity.GL7CoverageFormInternal>() {
      public java.lang.Object getImplementation(entity.GL7CoverageForm bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7CoverageFormInternal getInternalInterface(entity.GL7CoverageForm bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7CoverageForm newEmptyInstance() {
        return new entity.GL7CoverageForm((java.lang.Void)null);
      }

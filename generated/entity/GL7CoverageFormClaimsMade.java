...
/**
 * GL7CoverageFormClaimsMade
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7CoverageFormClaimsMade.eti;GL7CoverageFormClaimsMade.eix;GL7CoverageFormClaimsMade.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7CoverageFormClaimsMade")
public class GL7CoverageFormClaimsMade extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7CoverageFormClaimsMade> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7CoverageFormClaimsMade>("entity.GL7CoverageFormClaimsMade");
  ...
  private com.guidewire._generated.entity.GL7CoverageFormClaimsMadeInternal _internal;
   ...
   */
  public GL7CoverageFormClaimsMade()  {
   ...
   */
  public GL7CoverageFormClaimsMade(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7CoverageFormClaimsMade(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7CoverageFormClaimsMadeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7CoverageFormClaimsMadeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7CoverageFormClaimsMadeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7CoverageFormClaimsMade.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7CoverageFormClaimsMade.class, config);
    com.guidewire._generated.entity.GL7CoverageFormClaimsMadeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7CoverageFormClaimsMade, com.guidewire._generated.entity.GL7CoverageFormClaimsMadeInternal>() {
      public java.lang.Object getImplementation(entity.GL7CoverageFormClaimsMade bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7CoverageFormClaimsMadeInternal getInternalInterface(entity.GL7CoverageFormClaimsMade bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7CoverageFormClaimsMade newEmptyInstance() {
        return new entity.GL7CoverageFormClaimsMade((java.lang.Void)null);
      }

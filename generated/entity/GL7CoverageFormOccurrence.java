...
/**
 * GL7CoverageFormOccurrence
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7CoverageFormOccurrence.eti;GL7CoverageFormOccurrence.eix;GL7CoverageFormOccurrence.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7CoverageFormOccurrence")
public class GL7CoverageFormOccurrence extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7CoverageFormOccurrence> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7CoverageFormOccurrence>("entity.GL7CoverageFormOccurrence");
  ...
  private com.guidewire._generated.entity.GL7CoverageFormOccurrenceInternal _internal;
   ...
   */
  public GL7CoverageFormOccurrence()  {
   ...
   */
  public GL7CoverageFormOccurrence(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7CoverageFormOccurrence(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7CoverageFormOccurrenceInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7CoverageFormOccurrenceInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7CoverageFormOccurrenceInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7CoverageFormOccurrence.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7CoverageFormOccurrence.class, config);
    com.guidewire._generated.entity.GL7CoverageFormOccurrenceInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7CoverageFormOccurrence, com.guidewire._generated.entity.GL7CoverageFormOccurrenceInternal>() {
      public java.lang.Object getImplementation(entity.GL7CoverageFormOccurrence bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7CoverageFormOccurrenceInternal getInternalInterface(entity.GL7CoverageFormOccurrence bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7CoverageFormOccurrence newEmptyInstance() {
        return new entity.GL7CoverageFormOccurrence((java.lang.Void)null);
      }

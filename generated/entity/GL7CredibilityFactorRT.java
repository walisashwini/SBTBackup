...
@gw.entity.EntityName(value = "GL7CredibilityFactorRT")
public class GL7CredibilityFactorRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7CredibilityFactorRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7CredibilityFactorRT>("entity.GL7CredibilityFactorRT");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> TOTALBASICLMTSCOSUBJECTLOSSCOS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "TotalBasicLmtsCoSubjectLossCos");
  ...
  private com.guidewire._generated.entity.GL7CredibilityFactorRTInternal _internal;
   ...
   */
  public GL7CredibilityFactorRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7CredibilityFactorRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7CredibilityFactorRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7CredibilityFactorRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.Integer getTotalBasicLmtsCoSubjectLossCos() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(TOTALBASICLMTSCOSUBJECTLOSSCOS_PROP.get());
  }
  ...
  public void setTotalBasicLmtsCoSubjectLossCos(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(TOTALBASICLMTSCOSUBJECTLOSSCOS_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7CredibilityFactorRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7CredibilityFactorRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7CredibilityFactorRT.class, config);
    com.guidewire._generated.entity.GL7CredibilityFactorRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7CredibilityFactorRT, com.guidewire._generated.entity.GL7CredibilityFactorRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7CredibilityFactorRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7CredibilityFactorRTInternal getInternalInterface(entity.GL7CredibilityFactorRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7CredibilityFactorRT newEmptyInstance() {
        return new entity.GL7CredibilityFactorRT((java.lang.Void)null);
      }

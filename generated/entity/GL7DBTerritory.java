...
/**
 * GL7DBTerritory
 * A lookup table matching physical addresses to territory codes.
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7DBTerritory.eti;GL7DBTerritory.eix;GL7DBTerritory.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7DBTerritory")
public class GL7DBTerritory extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7DBTerritory> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7DBTerritory>("entity.GL7DBTerritory");
  ...
  private com.guidewire._generated.entity.GL7DBTerritoryInternal _internal;
   ...
   */
  public GL7DBTerritory(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7DBTerritory(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7DBTerritoryInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7DBTerritoryInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7DBTerritory_Description_L10N[] getDescription_L10N_ARRAY() {
    return (entity.GL7DBTerritory_Description_L10N[])__getInternalInterface().getFieldValue(DESCRIPTION_L10N_ARRAY_PROP.get());
  }
   ...
   */
  private void setDescription_L10N_ARRAY(entity.GL7DBTerritory_Description_L10N[] value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7DBTerritoryInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7DBTerritory.this.__getDelegateManager();
    }
     ...
     */
    public void addToDescription_L10N_ARRAY(entity.GL7DBTerritory_Description_L10N element) {
     ...
     */
    public entity.GL7DBTerritory_Description_L10N getDescription_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.GL7DBTerritory_Description_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
     ...
     */
    public void removeFromDescription_L10N_ARRAY(entity.GL7DBTerritory_Description_L10N element) {
     ...
     * Sets the value of the Description_L10N_ARRAY field.
     */
    public void setDescription_L10N_ARRAY(entity.GL7DBTerritory_Description_L10N[] value) {
      __getInternalInterface().setFieldValue(DESCRIPTION_L10N_ARRAY_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7DBTerritory.class, config);
    com.guidewire._generated.entity.GL7DBTerritoryInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7DBTerritory, com.guidewire._generated.entity.GL7DBTerritoryInternal>() {
      public java.lang.Object getImplementation(entity.GL7DBTerritory bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7DBTerritoryInternal getInternalInterface(entity.GL7DBTerritory bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7DBTerritory newEmptyInstance() {
        return new entity.GL7DBTerritory((java.lang.Void)null);
      }

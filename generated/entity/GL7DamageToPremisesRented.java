...
/**
 * GL7DamageToPremisesRented
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7DamageToPremisesRented.eti;GL7DamageToPremisesRented.eix;GL7DamageToPremisesRented.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7DamageToPremisesRented")
public class GL7DamageToPremisesRented extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7DamageToPremisesRented> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7DamageToPremisesRented>("entity.GL7DamageToPremisesRented");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> EACHOCCURRENCELIM_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "EachOccurrenceLim");
  ...
  private com.guidewire._generated.entity.GL7DamageToPremisesRentedInternal _internal;
   ...
   */
  public GL7DamageToPremisesRented()  {
   ...
   */
  public GL7DamageToPremisesRented(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7DamageToPremisesRented(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7DamageToPremisesRentedInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7DamageToPremisesRentedInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.String getEachOccurrenceLim() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(EACHOCCURRENCELIM_PROP.get());
  }
  ...
  public void setEachOccurrenceLim(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(EACHOCCURRENCELIM_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7DamageToPremisesRentedInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7DamageToPremisesRented.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7DamageToPremisesRented.class, config);
    com.guidewire._generated.entity.GL7DamageToPremisesRentedInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7DamageToPremisesRented, com.guidewire._generated.entity.GL7DamageToPremisesRentedInternal>() {
      public java.lang.Object getImplementation(entity.GL7DamageToPremisesRented bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7DamageToPremisesRentedInternal getInternalInterface(entity.GL7DamageToPremisesRented bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7DamageToPremisesRented newEmptyInstance() {
        return new entity.GL7DamageToPremisesRented((java.lang.Void)null);
      }

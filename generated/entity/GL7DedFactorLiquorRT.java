...
/**
 * GL7DedFactorLiquorRT
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7DedFactorLiquorRT.eti;GL7DedFactorLiquorRT.eix;GL7DedFactorLiquorRT.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7DedFactorLiquorRT")
public class GL7DedFactorLiquorRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7DedFactorLiquorRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7DedFactorLiquorRT>("entity.GL7DedFactorLiquorRT");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DEDLIQUOR_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DedLiquor");
  ...
  private com.guidewire._generated.entity.GL7DedFactorLiquorRTInternal _internal;
   ...
   */
  public GL7DedFactorLiquorRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7DedFactorLiquorRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7DedFactorLiquorRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7DedFactorLiquorRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Gets the value of the DedLiquor field.
   * DeductibleLiquor
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getDedLiquor() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(DEDLIQUOR_PROP.get());
  }
  ...
  /**
   * Sets the value of the DedLiquor field.
   */
  public void setDedLiquor(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(DEDLIQUOR_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7DedFactorLiquorRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7DedFactorLiquorRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7DedFactorLiquorRT.class, config);
    com.guidewire._generated.entity.GL7DedFactorLiquorRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7DedFactorLiquorRT, com.guidewire._generated.entity.GL7DedFactorLiquorRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7DedFactorLiquorRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7DedFactorLiquorRTInternal getInternalInterface(entity.GL7DedFactorLiquorRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7DedFactorLiquorRT newEmptyInstance() {
        return new entity.GL7DedFactorLiquorRT((java.lang.Void)null);
      }

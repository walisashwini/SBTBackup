...
@gw.entity.EntityName(value = "GL7DedFactorPremOpsBIRT")
public class GL7DedFactorPremOpsBIRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7DedFactorPremOpsBIRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7DedFactorPremOpsBIRT>("entity.GL7DedFactorPremOpsBIRT");
  ...
  private com.guidewire._generated.entity.GL7DedFactorPremOpsBIRTInternal _internal;
   ...
   */
  public GL7DedFactorPremOpsBIRT()  {
   ...
   */
  public GL7DedFactorPremOpsBIRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7DedFactorPremOpsBIRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7DedFactorPremOpsBIRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7DedFactorPremOpsBIRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7DedFactorPremOpsBIRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7DedFactorPremOpsBIRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7DedFactorPremOpsBIRT.class, config);
    com.guidewire._generated.entity.GL7DedFactorPremOpsBIRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7DedFactorPremOpsBIRT, com.guidewire._generated.entity.GL7DedFactorPremOpsBIRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7DedFactorPremOpsBIRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7DedFactorPremOpsBIRTInternal getInternalInterface(entity.GL7DedFactorPremOpsBIRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7DedFactorPremOpsBIRT newEmptyInstance() {
        return new entity.GL7DedFactorPremOpsBIRT((java.lang.Void)null);
      }

...
/**
 * GL7DedFactorPremOpsCSLRT
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7DedFactorPremOpsCSLRT.eti;GL7DedFactorPremOpsCSLRT.eix;GL7DedFactorPremOpsCSLRT.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7DedFactorPremOpsCSLRT")
public class GL7DedFactorPremOpsCSLRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7DedFactorPremOpsCSLRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7DedFactorPremOpsCSLRT>("entity.GL7DedFactorPremOpsCSLRT");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PREMOPSDED_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PremOpsDed");
  ...
  private com.guidewire._generated.entity.GL7DedFactorPremOpsCSLRTInternal _internal;
   ...
   */
  public GL7DedFactorPremOpsCSLRT()  {
   ...
   */
  public GL7DedFactorPremOpsCSLRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7DedFactorPremOpsCSLRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7DedFactorPremOpsCSLRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7DedFactorPremOpsCSLRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.String getPremOpsDed() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(PREMOPSDED_PROP.get());
  }
  ...
  public void setPremOpsDed(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(PREMOPSDED_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7DedFactorPremOpsCSLRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7DedFactorPremOpsCSLRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7DedFactorPremOpsCSLRT.class, config);
    com.guidewire._generated.entity.GL7DedFactorPremOpsCSLRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7DedFactorPremOpsCSLRT, com.guidewire._generated.entity.GL7DedFactorPremOpsCSLRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7DedFactorPremOpsCSLRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7DedFactorPremOpsCSLRTInternal getInternalInterface(entity.GL7DedFactorPremOpsCSLRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7DedFactorPremOpsCSLRT newEmptyInstance() {
        return new entity.GL7DedFactorPremOpsCSLRT((java.lang.Void)null);
      }

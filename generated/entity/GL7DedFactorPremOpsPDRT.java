...
/**
 * GL7DedFactorPremOpsPDRT
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7DedFactorPremOpsPDRT.eti;GL7DedFactorPremOpsPDRT.eix;GL7DedFactorPremOpsPDRT.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7DedFactorPremOpsPDRT")
public class GL7DedFactorPremOpsPDRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7DedFactorPremOpsPDRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7DedFactorPremOpsPDRT>("entity.GL7DedFactorPremOpsPDRT");
  ...
  private com.guidewire._generated.entity.GL7DedFactorPremOpsPDRTInternal _internal;
   ...
   */
  public GL7DedFactorPremOpsPDRT()  {
   ...
   */
  public GL7DedFactorPremOpsPDRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7DedFactorPremOpsPDRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7DedFactorPremOpsPDRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7DedFactorPremOpsPDRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7DedFactorPremOpsPDRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7DedFactorPremOpsPDRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7DedFactorPremOpsPDRT.class, config);
    com.guidewire._generated.entity.GL7DedFactorPremOpsPDRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7DedFactorPremOpsPDRT, com.guidewire._generated.entity.GL7DedFactorPremOpsPDRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7DedFactorPremOpsPDRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7DedFactorPremOpsPDRTInternal getInternalInterface(entity.GL7DedFactorPremOpsPDRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7DedFactorPremOpsPDRT newEmptyInstance() {
        return new entity.GL7DedFactorPremOpsPDRT((java.lang.Void)null);
      }

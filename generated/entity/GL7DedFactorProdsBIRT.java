...
/**
 * GL7DedFactorProdsBIRT
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7DedFactorProdsBIRT.eti;GL7DedFactorProdsBIRT.eix;GL7DedFactorProdsBIRT.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7DedFactorProdsBIRT")
public class GL7DedFactorProdsBIRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7DedFactorProdsBIRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7DedFactorProdsBIRT>("entity.GL7DedFactorProdsBIRT");
  ...
  private com.guidewire._generated.entity.GL7DedFactorProdsBIRTInternal _internal;
   ...
   */
  public GL7DedFactorProdsBIRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7DedFactorProdsBIRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7DedFactorProdsBIRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7DedFactorProdsBIRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7DedFactorProdsBIRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7DedFactorProdsBIRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7DedFactorProdsBIRT.class, config);
    com.guidewire._generated.entity.GL7DedFactorProdsBIRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7DedFactorProdsBIRT, com.guidewire._generated.entity.GL7DedFactorProdsBIRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7DedFactorProdsBIRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7DedFactorProdsBIRTInternal getInternalInterface(entity.GL7DedFactorProdsBIRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7DedFactorProdsBIRT newEmptyInstance() {
        return new entity.GL7DedFactorProdsBIRT((java.lang.Void)null);
      }

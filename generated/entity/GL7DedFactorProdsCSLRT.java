...
@gw.entity.EntityName(value = "GL7DedFactorProdsCSLRT")
public class GL7DedFactorProdsCSLRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7DedFactorProdsCSLRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7DedFactorProdsCSLRT>("entity.GL7DedFactorProdsCSLRT");
  ...
  private com.guidewire._generated.entity.GL7DedFactorProdsCSLRTInternal _internal;
   ...
   */
  public GL7DedFactorProdsCSLRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7DedFactorProdsCSLRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7DedFactorProdsCSLRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7DedFactorProdsCSLRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7DedFactorProdsCSLRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7DedFactorProdsCSLRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7DedFactorProdsCSLRT.class, config);
    com.guidewire._generated.entity.GL7DedFactorProdsCSLRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7DedFactorProdsCSLRT, com.guidewire._generated.entity.GL7DedFactorProdsCSLRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7DedFactorProdsCSLRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7DedFactorProdsCSLRTInternal getInternalInterface(entity.GL7DedFactorProdsCSLRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7DedFactorProdsCSLRT newEmptyInstance() {
        return new entity.GL7DedFactorProdsCSLRT((java.lang.Void)null);
      }

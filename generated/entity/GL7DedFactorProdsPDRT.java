...
/**
 * GL7DedFactorProdsPDRT
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7DedFactorProdsPDRT.eti;GL7DedFactorProdsPDRT.eix;GL7DedFactorProdsPDRT.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7DedFactorProdsPDRT")
public class GL7DedFactorProdsPDRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7DedFactorProdsPDRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7DedFactorProdsPDRT>("entity.GL7DedFactorProdsPDRT");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PRODSCOMPLDOPSDED_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ProdsCompldOpsDed");
  ...
  private com.guidewire._generated.entity.GL7DedFactorProdsPDRTInternal _internal;
   ...
   */
  public GL7DedFactorProdsPDRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7DedFactorProdsPDRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7DedFactorProdsPDRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7DedFactorProdsPDRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.String getProdsCompldOpsDed() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(PRODSCOMPLDOPSDED_PROP.get());
  }
  ...
  public void setProdsCompldOpsDed(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(PRODSCOMPLDOPSDED_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7DedFactorProdsPDRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7DedFactorProdsPDRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7DedFactorProdsPDRT.class, config);
    com.guidewire._generated.entity.GL7DedFactorProdsPDRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7DedFactorProdsPDRT, com.guidewire._generated.entity.GL7DedFactorProdsPDRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7DedFactorProdsPDRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7DedFactorProdsPDRTInternal getInternalInterface(entity.GL7DedFactorProdsPDRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7DedFactorProdsPDRT newEmptyInstance() {
        return new entity.GL7DedFactorProdsPDRT((java.lang.Void)null);
      }

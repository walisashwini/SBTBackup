 ...
 * GL7DeductibleLiquor
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7DeductibleLiquor.eti;GL7DeductibleLiquor.eix;GL7DeductibleLiquor.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7DeductibleLiquor")
public class GL7DeductibleLiquor extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7DeductibleLiquor> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7DeductibleLiquor>("entity.GL7DeductibleLiquor");
  ...
  private com.guidewire._generated.entity.GL7DeductibleLiquorInternal _internal;
   ...
   */
  public GL7DeductibleLiquor(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7DeductibleLiquor(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7DeductibleLiquorInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7DeductibleLiquorInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7DeductibleLiquorInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7DeductibleLiquor.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7DeductibleLiquor.class, config);
    com.guidewire._generated.entity.GL7DeductibleLiquorInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7DeductibleLiquor, com.guidewire._generated.entity.GL7DeductibleLiquorInternal>() {
      public java.lang.Object getImplementation(entity.GL7DeductibleLiquor bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7DeductibleLiquorInternal getInternalInterface(entity.GL7DeductibleLiquor bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7DeductibleLiquor newEmptyInstance() {
        return new entity.GL7DeductibleLiquor((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "GL7DetrendFactorRT")
public class GL7DetrendFactorRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7DetrendFactorRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7DetrendFactorRT>("entity.GL7DetrendFactorRT");
  ...
  private com.guidewire._generated.entity.GL7DetrendFactorRTInternal _internal;
   ...
   */
  public GL7DetrendFactorRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7DetrendFactorRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7DetrendFactorRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7DetrendFactorRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7DetrendFactorRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7DetrendFactorRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7DetrendFactorRT.class, config);
    com.guidewire._generated.entity.GL7DetrendFactorRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7DetrendFactorRT, com.guidewire._generated.entity.GL7DetrendFactorRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7DetrendFactorRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7DetrendFactorRTInternal getInternalInterface(entity.GL7DetrendFactorRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7DetrendFactorRT newEmptyInstance() {
        return new entity.GL7DetrendFactorRT((java.lang.Void)null);
      }

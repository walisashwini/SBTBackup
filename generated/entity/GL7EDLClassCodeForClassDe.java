...
/**
 * GL7EDLClassCodeForClassDe
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7EDLClassCodeForClassDe.eti;GL7EDLClassCodeForClassDe.eix;GL7EDLClassCodeForClassDe.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7EDLClassCodeForClassDe")
public class GL7EDLClassCodeForClassDe extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7EDLClassCodeForClassDe> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7EDLClassCodeForClassDe>("entity.GL7EDLClassCodeForClassDe");
  ...
  private com.guidewire._generated.entity.GL7EDLClassCodeForClassDeInternal _internal;
   ...
   */
  public GL7EDLClassCodeForClassDe()  {
   ...
   */
  public GL7EDLClassCodeForClassDe(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7EDLClassCodeForClassDe(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7EDLClassCodeForClassDeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7EDLClassCodeForClassDeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7EDLClassCodeForClassDeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7EDLClassCodeForClassDe.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7EDLClassCodeForClassDe.class, config);
    com.guidewire._generated.entity.GL7EDLClassCodeForClassDeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7EDLClassCodeForClassDe, com.guidewire._generated.entity.GL7EDLClassCodeForClassDeInternal>() {
      public java.lang.Object getImplementation(entity.GL7EDLClassCodeForClassDe bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7EDLClassCodeForClassDeInternal getInternalInterface(entity.GL7EDLClassCodeForClassDe bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7EDLClassCodeForClassDe newEmptyInstance() {
        return new entity.GL7EDLClassCodeForClassDe((java.lang.Void)null);
      }

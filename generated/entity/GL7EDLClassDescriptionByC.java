...
/**
 * GL7EDLClassDescriptionByC
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7EDLClassDescriptionByC.eti;GL7EDLClassDescriptionByC.eix;GL7EDLClassDescriptionByC.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7EDLClassDescriptionByC")
public class GL7EDLClassDescriptionByC extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7EDLClassDescriptionByC> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7EDLClassDescriptionByC>("entity.GL7EDLClassDescriptionByC");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> EDLCLASSCODEFORCLASSDESCRIPTIO_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "EDLClassCodeForClassDescriptio");
  ...
  private com.guidewire._generated.entity.GL7EDLClassDescriptionByCInternal _internal;
   ...
   */
  public GL7EDLClassDescriptionByC()  {
   ...
   */
  public GL7EDLClassDescriptionByC(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7EDLClassDescriptionByC(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7EDLClassDescriptionByCInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7EDLClassDescriptionByCInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Gets the value of the EDLClassCodeForClassDescriptio field.
   * EDLClassCodeForClassDescription
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getEDLClassCodeForClassDescriptio() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(EDLCLASSCODEFORCLASSDESCRIPTIO_PROP.get());
  }
  ...
  /**
   * Sets the value of the EDLClassCodeForClassDescriptio field.
   */
  public void setEDLClassCodeForClassDescriptio(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(EDLCLASSCODEFORCLASSDESCRIPTIO_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7EDLClassDescriptionByCInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7EDLClassDescriptionByC.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7EDLClassDescriptionByC.class, config);
    com.guidewire._generated.entity.GL7EDLClassDescriptionByCInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7EDLClassDescriptionByC, com.guidewire._generated.entity.GL7EDLClassDescriptionByCInternal>() {
      public java.lang.Object getImplementation(entity.GL7EDLClassDescriptionByC bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7EDLClassDescriptionByCInternal getInternalInterface(entity.GL7EDLClassDescriptionByC bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7EDLClassDescriptionByC newEmptyInstance() {
        return new entity.GL7EDLClassDescriptionByC((java.lang.Void)null);
      }

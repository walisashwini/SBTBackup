...
/**
 * GL7EachOccurrenceLimitGov
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7EachOccurrenceLimitGov.eti;GL7EachOccurrenceLimitGov.eix;GL7EachOccurrenceLimitGov.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7EachOccurrenceLimitGov")
public class GL7EachOccurrenceLimitGov extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7EachOccurrenceLimitGov> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7EachOccurrenceLimitGov>("entity.GL7EachOccurrenceLimitGov");
  ...
  private com.guidewire._generated.entity.GL7EachOccurrenceLimitGovInternal _internal;
   ...
   */
  public GL7EachOccurrenceLimitGov()  {
   ...
   */
  public GL7EachOccurrenceLimitGov(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7EachOccurrenceLimitGov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7EachOccurrenceLimitGovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7EachOccurrenceLimitGovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7EachOccurrenceLimitGovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7EachOccurrenceLimitGov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7EachOccurrenceLimitGov.class, config);
    com.guidewire._generated.entity.GL7EachOccurrenceLimitGovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7EachOccurrenceLimitGov, com.guidewire._generated.entity.GL7EachOccurrenceLimitGovInternal>() {
      public java.lang.Object getImplementation(entity.GL7EachOccurrenceLimitGov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7EachOccurrenceLimitGovInternal getInternalInterface(entity.GL7EachOccurrenceLimitGov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7EachOccurrenceLimitGov newEmptyInstance() {
        return new entity.GL7EachOccurrenceLimitGov((java.lang.Void)null);
      }

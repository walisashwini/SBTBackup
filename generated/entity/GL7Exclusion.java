 ...
 * GL7Exclusion
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7Exclusion.eti;GL7Exclusion.eix;GL7Exclusion.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7Exclusion")
public class GL7Exclusion extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7Exclusion> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7Exclusion>("entity.GL7Exclusion");
  ...
  private com.guidewire._generated.entity.GL7ExclusionInternal _internal;
   ...
   */
  public GL7Exclusion(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7Exclusion(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ExclusionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExclusionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExclusionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7Exclusion.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7Exclusion.class, config);
    com.guidewire._generated.entity.GL7ExclusionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7Exclusion, com.guidewire._generated.entity.GL7ExclusionInternal>() {
      public java.lang.Object getImplementation(entity.GL7Exclusion bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExclusionInternal getInternalInterface(entity.GL7Exclusion bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7Exclusion newEmptyInstance() {
        return new entity.GL7Exclusion((java.lang.Void)null);
      }

...
/**
 * GL7ExpSchedCondItemCond
 * GL7 exposure level condition scheduled item with condition terms
 */
...
@gw.entity.EntityName(value = "GL7ExpSchedCondItemCond")
public class GL7ExpSchedCondItemCond extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PolicyCondition, entity.GL7Clause, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExpSchedCondItemCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExpSchedCondItemCond, entity.PolicyPeriod>("entity.GL7ExpSchedCondItemCond");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> EXPSCHEDCONDITEMCONDCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "ExpSchedCondItemCondCosts");
  ...
  private com.guidewire._generated.entity.GL7ExpSchedCondItemCondInternal _internal;
   ...
   */
  protected GL7ExpSchedCondItemCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7ExpSchedCondItemCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExpSchedCondItemCond(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ExpSchedCondItemCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExpSchedCondItemCondInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Adds the given element to the ExpSchedCondItemCondCosts array. This is achieved by setting the parent foreign key to this entity instance.
   */
  public void addToExpSchedCondItemCondCosts(entity.GL7ExpSchedCondItemCondCost element) {
    __getInternalInterface().addArrayElement(EXPSCHEDCONDITEMCONDCOSTS_PROP.get(), element);
  }
  ...
  public entity.GL7ExpSchedCondItemCond clone() {
    return (entity.GL7ExpSchedCondItemCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7ExpSchedCondItemCond getBasedOn() {
    return (entity.GL7ExpSchedCondItemCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7ExpSchedCondItemCond getBasedOnValue() {
    return (entity.GL7ExpSchedCondItemCond)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  /**
   * Gets the value of the ExpSchedCondItemCondCosts field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7ExpSchedCondItemCondCost[] getExpSchedCondItemCondCosts() {
    return (entity.GL7ExpSchedCondItemCondCost[])__getInternalInterface().getFieldValue(EXPSCHEDCONDITEMCONDCOSTS_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7ExpSchedCondItemCond getFixed() {
    return (entity.GL7ExpSchedCondItemCond)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7ExpSchedCondItemCond getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExpSchedCondItemCond)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.GL7ExpSchedCondItemCond getSubtype() {
    return (typekey.GL7ExpSchedCondItemCond)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.GL7ExpSchedCondItemCond getUnsliced() {
    return (entity.GL7ExpSchedCondItemCond)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7ExpSchedCondItemCondVersionList getVersionList() {
    return (entity.windowed.GL7ExpSchedCondItemCondVersionList)getVersionListUntyped();
  }
  ...
  /**
   * Removes the given element from the ExpSchedCondItemCondCosts array. This is achieved by marking the element for removal.
   */
  public void removeFromExpSchedCondItemCondCosts(entity.GL7ExpSchedCondItemCondCost element) {
    __getInternalInterface().removeArrayElement(EXPSCHEDCONDITEMCONDCOSTS_PROP.get(), element);
  }
   ...
   */
  @java.lang.Deprecated
  public void removeFromExpSchedCondItemCondCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(EXPSCHEDCONDITEMCONDCOSTS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.GL7ExpSchedCondItemCond value) {
  ...
  /**
   * Sets the value of the ExpSchedCondItemCondCosts field.
   */
  public void setExpSchedCondItemCondCosts(entity.GL7ExpSchedCondItemCondCost[] value) {
    __getInternalInterface().setFieldValue(EXPSCHEDCONDITEMCONDCOSTS_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.GL7ExpSchedCondItemCond value) {
   ...
   */
  private void setSubtype(typekey.GL7ExpSchedCondItemCond value) {
  ...
  public entity.GL7ExpSchedCondItemCond split(java.util.Date splitDate) {
    return (entity.GL7ExpSchedCondItemCond)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExpSchedCondItemCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExpSchedCondItemCond.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.GL7ExpSchedCondItemCond value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.GL7ExpSchedCondItemCond value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.GL7ExpSchedCondItemCond value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.schedules.GL7ExposureSchedCondItemCondAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.schedules.GL7ExposureSchedCondItemCondAdapter");
    config.put("gw.api.domain.PolicyConditionAdapter", "gw.lob.gl7.schedules.GL7ExposureSchedCondItemCondAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7ExposureSchedCondItemCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7ExposureSchedCondItemCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExpSchedCondItemCond.class, config);
    com.guidewire._generated.entity.GL7ExpSchedCondItemCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExpSchedCondItemCond, com.guidewire._generated.entity.GL7ExpSchedCondItemCondInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExpSchedCondItemCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExpSchedCondItemCondInternal getInternalInterface(entity.GL7ExpSchedCondItemCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExpSchedCondItemCond newEmptyInstance() {
        return new entity.GL7ExpSchedCondItemCond((java.lang.Void)null);
      }

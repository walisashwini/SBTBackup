...
/**
 * GL7ExpSchedCondItemCondCost
 * GL7 Exposure Condition Schedule Item Condition Cost
 */
...
@gw.entity.EntityName(value = "GL7ExpSchedCondItemCondCost")
public class GL7ExpSchedCondItemCondCost extends entity.GL7ExpSchedCondItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExpSchedCondItemCondCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExpSchedCondItemCondCost, entity.PolicyPeriod>("entity.GL7ExpSchedCondItemCondCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> EXPSCHEDCONDITEMCOND_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ExpSchedCondItemCond");
   ...
   */
  public GL7ExpSchedCondItemCondCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7ExpSchedCondItemCondCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExpSchedCondItemCondCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7ExpSchedCondItemCondCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExpSchedCondItemCondCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7ExpSchedCondItemCondCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7ExpSchedCondItemCondCost clone() {
    return (entity.GL7ExpSchedCondItemCondCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7ExpSchedCondItemCondCost getBasedOn() {
    return (entity.GL7ExpSchedCondItemCondCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExpSchedCondItemCond getExpSchedCondItemCond() {
    return (entity.GL7ExpSchedCondItemCond)__getInternalInterface().getFieldValue(EXPSCHEDCONDITEMCOND_PROP.get());
  }
  
  public entity.GL7ExpSchedCondItemCondCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExpSchedCondItemCondCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7ExpSchedCondItemCondCost getUnsliced() {
    return (entity.GL7ExpSchedCondItemCondCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7ExpSchedCondItemCondCostVersionList getVersionList() {
    return (entity.windowed.GL7ExpSchedCondItemCondCostVersionList)getVersionListUntyped();
  }
  ...
  public void setExpSchedCondItemCond(entity.GL7ExpSchedCondItemCond value) {
    __getInternalInterface().setFieldValue(EXPSCHEDCONDITEMCOND_PROP.get(), value);
  }
  
  public entity.GL7ExpSchedCondItemCondCost split(java.util.Date splitDate) {
    return (entity.GL7ExpSchedCondItemCondCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExpSchedCondItemCondCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExpSchedCondItemCondCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getExpSchedCondItemCondID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(EXPSCHEDCONDITEMCOND_PROP.get());
    }
    ...
    public void setExpSchedCondItemCondID(gw.pl.persistence.core.Key value) {
      setFieldValue(EXPSCHEDCONDITEMCOND_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7ExpSchedCondItemCondCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExpSchedCondItemCondCost.class, config);
    com.guidewire._generated.entity.GL7ExpSchedCondItemCondCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExpSchedCondItemCondCost, com.guidewire._generated.entity.GL7ExpSchedCondItemCondCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExpSchedCondItemCondCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExpSchedCondItemCondCostInternal getInternalInterface(entity.GL7ExpSchedCondItemCondCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExpSchedCondItemCondCost newEmptyInstance() {
        return new entity.GL7ExpSchedCondItemCondCost((java.lang.Void)null);
      }

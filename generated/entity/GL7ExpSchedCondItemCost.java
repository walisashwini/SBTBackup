...
/**
 * GL7ExpSchedCondItemCost
 * Base Exposure Condition Schedule Item Cost
 */
...
@gw.entity.EntityName(value = "GL7ExpSchedCondItemCost")
public class GL7ExpSchedCondItemCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExpSchedCondItemCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExpSchedCondItemCost, entity.PolicyPeriod>("entity.GL7ExpSchedCondItemCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> EXPSCHEDCONDITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ExpSchedCondItem");
   ...
   */
  public GL7ExpSchedCondItemCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7ExpSchedCondItemCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExpSchedCondItemCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7ExpSchedCondItemCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExpSchedCondItemCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7ExpSchedCondItemCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7ExpSchedCondItemCost clone() {
    return (entity.GL7ExpSchedCondItemCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7ExpSchedCondItemCost getBasedOn() {
    return (entity.GL7ExpSchedCondItemCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExpSchedCondItemCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExpSchedCondItemCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7ExpSchedCondItemCost getUnsliced() {
    return (entity.GL7ExpSchedCondItemCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7ExpSchedCondItemCostVersionList getVersionList() {
    return (entity.windowed.GL7ExpSchedCondItemCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7ExpSchedCondItemCost split(java.util.Date splitDate) {
    return (entity.GL7ExpSchedCondItemCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExpSchedCondItemCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExpSchedCondItemCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7ExpSchedCondItemCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExpSchedCondItemCost.class, config);
    com.guidewire._generated.entity.GL7ExpSchedCondItemCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExpSchedCondItemCost, com.guidewire._generated.entity.GL7ExpSchedCondItemCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExpSchedCondItemCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExpSchedCondItemCostInternal getInternalInterface(entity.GL7ExpSchedCondItemCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExpSchedCondItemCost newEmptyInstance() {
        return new entity.GL7ExpSchedCondItemCost((java.lang.Void)null);
      }

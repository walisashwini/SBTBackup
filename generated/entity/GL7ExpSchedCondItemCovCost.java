...
/**
 * GL7ExpSchedCondItemCovCost
 * GL7 Exposure Condition Schedule Item Coverage Cost
 */
...
@gw.entity.EntityName(value = "GL7ExpSchedCondItemCovCost")
public class GL7ExpSchedCondItemCovCost extends entity.GL7ExpSchedCondItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExpSchedCondItemCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExpSchedCondItemCovCost, entity.PolicyPeriod>("entity.GL7ExpSchedCondItemCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> EXPSCHEDCONDITEMCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ExpSchedCondItemCov");
   ...
   */
  public GL7ExpSchedCondItemCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7ExpSchedCondItemCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExpSchedCondItemCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7ExpSchedCondItemCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExpSchedCondItemCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7ExpSchedCondItemCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7ExpSchedCondItemCovCost clone() {
    return (entity.GL7ExpSchedCondItemCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7ExpSchedCondItemCovCost getBasedOn() {
    return (entity.GL7ExpSchedCondItemCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExpSchedCondItemCov getExpSchedCondItemCov() {
    return (entity.GL7ExpSchedCondItemCov)__getInternalInterface().getFieldValue(EXPSCHEDCONDITEMCOV_PROP.get());
  }
  
  public entity.GL7ExpSchedCondItemCovCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExpSchedCondItemCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7ExpSchedCondItemCovCost getUnsliced() {
    return (entity.GL7ExpSchedCondItemCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7ExpSchedCondItemCovCostVersionList getVersionList() {
    return (entity.windowed.GL7ExpSchedCondItemCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setExpSchedCondItemCov(entity.GL7ExpSchedCondItemCov value) {
    __getInternalInterface().setFieldValue(EXPSCHEDCONDITEMCOV_PROP.get(), value);
  }
  
  public entity.GL7ExpSchedCondItemCovCost split(java.util.Date splitDate) {
    return (entity.GL7ExpSchedCondItemCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExpSchedCondItemCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExpSchedCondItemCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getExpSchedCondItemCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(EXPSCHEDCONDITEMCOV_PROP.get());
    }
    ...
    public void setExpSchedCondItemCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(EXPSCHEDCONDITEMCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7ExpSchedCondItemCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExpSchedCondItemCovCost.class, config);
    com.guidewire._generated.entity.GL7ExpSchedCondItemCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExpSchedCondItemCovCost, com.guidewire._generated.entity.GL7ExpSchedCondItemCovCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExpSchedCondItemCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExpSchedCondItemCovCostInternal getInternalInterface(entity.GL7ExpSchedCondItemCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExpSchedCondItemCovCost newEmptyInstance() {
        return new entity.GL7ExpSchedCondItemCovCost((java.lang.Void)null);
      }

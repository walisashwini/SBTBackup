...
/**
 * GL7ExpSchedCondItemExclCost
 * GL7 Exposure Condition Schedule Item Exclusion Cost
 */
...
@gw.entity.EntityName(value = "GL7ExpSchedCondItemExclCost")
public class GL7ExpSchedCondItemExclCost extends entity.GL7ExpSchedCondItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExpSchedCondItemExclCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExpSchedCondItemExclCost, entity.PolicyPeriod>("entity.GL7ExpSchedCondItemExclCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> EXPSCHEDCONDITEMEXCL_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ExpSchedCondItemExcl");
   ...
   */
  public GL7ExpSchedCondItemExclCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7ExpSchedCondItemExclCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExpSchedCondItemExclCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7ExpSchedCondItemExclCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExpSchedCondItemExclCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7ExpSchedCondItemExclCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7ExpSchedCondItemExclCost clone() {
    return (entity.GL7ExpSchedCondItemExclCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7ExpSchedCondItemExclCost getBasedOn() {
    return (entity.GL7ExpSchedCondItemExclCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExpSchedCondItemExcl getExpSchedCondItemExcl() {
    return (entity.GL7ExpSchedCondItemExcl)__getInternalInterface().getFieldValue(EXPSCHEDCONDITEMEXCL_PROP.get());
  }
  
  public entity.GL7ExpSchedCondItemExclCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExpSchedCondItemExclCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7ExpSchedCondItemExclCost getUnsliced() {
    return (entity.GL7ExpSchedCondItemExclCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7ExpSchedCondItemExclCostVersionList getVersionList() {
    return (entity.windowed.GL7ExpSchedCondItemExclCostVersionList)getVersionListUntyped();
  }
  ...
  public void setExpSchedCondItemExcl(entity.GL7ExpSchedCondItemExcl value) {
    __getInternalInterface().setFieldValue(EXPSCHEDCONDITEMEXCL_PROP.get(), value);
  }
  
  public entity.GL7ExpSchedCondItemExclCost split(java.util.Date splitDate) {
    return (entity.GL7ExpSchedCondItemExclCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExpSchedCondItemExclCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExpSchedCondItemExclCost.this.__getDelegateManager();
    }
    ...
    public entity.GL7ExposureSchedCondItem getExpSchedCondItem() {
      return (entity.GL7ExposureSchedCondItem)__getInternalInterface().getFieldValue(EXPSCHEDCONDITEM_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getExpSchedCondItemExclID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(EXPSCHEDCONDITEMEXCL_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getExpSchedCondItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(EXPSCHEDCONDITEM_PROP.get());
    }
    ...
    public void setExpSchedCondItem(entity.GL7ExposureSchedCondItem value) {
      __getInternalInterface().setFieldValue(EXPSCHEDCONDITEM_PROP.get(), value);
    }
    ...
    public void setExpSchedCondItemExclID(gw.pl.persistence.core.Key value) {
      setFieldValue(EXPSCHEDCONDITEMEXCL_PROP.get(), value);
    }
    
    public void setExpSchedCondItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(EXPSCHEDCONDITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7ExpSchedCondItemExclCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExpSchedCondItemExclCost.class, config);
    com.guidewire._generated.entity.GL7ExpSchedCondItemExclCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExpSchedCondItemExclCost, com.guidewire._generated.entity.GL7ExpSchedCondItemExclCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExpSchedCondItemExclCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExpSchedCondItemExclCostInternal getInternalInterface(entity.GL7ExpSchedCondItemExclCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExpSchedCondItemExclCost newEmptyInstance() {
        return new entity.GL7ExpSchedCondItemExclCost((java.lang.Void)null);
      }

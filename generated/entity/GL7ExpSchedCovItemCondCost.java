...
/**
 * GL7ExpSchedCovItemCondCost
 * GL7 Exposure Coverage Schedule Item Condition Cost
 */
...
@gw.entity.EntityName(value = "GL7ExpSchedCovItemCondCost")
public class GL7ExpSchedCovItemCondCost extends entity.GL7ExpSchedCovItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExpSchedCovItemCondCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExpSchedCovItemCondCost, entity.PolicyPeriod>("entity.GL7ExpSchedCovItemCondCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> EXPSCHEDCOVITEMCOND_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ExpSchedCovItemCond");
   ...
   */
  public GL7ExpSchedCovItemCondCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7ExpSchedCovItemCondCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExpSchedCovItemCondCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7ExpSchedCovItemCondCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExpSchedCovItemCondCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7ExpSchedCovItemCondCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7ExpSchedCovItemCondCost clone() {
    return (entity.GL7ExpSchedCovItemCondCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7ExpSchedCovItemCondCost getBasedOn() {
    return (entity.GL7ExpSchedCovItemCondCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExpSchedCovItemCond getExpSchedCovItemCond() {
    return (entity.GL7ExpSchedCovItemCond)__getInternalInterface().getFieldValue(EXPSCHEDCOVITEMCOND_PROP.get());
  }
  
  public entity.GL7ExpSchedCovItemCondCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExpSchedCovItemCondCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7ExpSchedCovItemCondCost getUnsliced() {
    return (entity.GL7ExpSchedCovItemCondCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7ExpSchedCovItemCondCostVersionList getVersionList() {
    return (entity.windowed.GL7ExpSchedCovItemCondCostVersionList)getVersionListUntyped();
  }
  ...
  public void setExpSchedCovItemCond(entity.GL7ExpSchedCovItemCond value) {
    __getInternalInterface().setFieldValue(EXPSCHEDCOVITEMCOND_PROP.get(), value);
  }
  
  public entity.GL7ExpSchedCovItemCondCost split(java.util.Date splitDate) {
    return (entity.GL7ExpSchedCovItemCondCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExpSchedCovItemCondCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExpSchedCovItemCondCost.this.__getDelegateManager();
    }
    ...
    public entity.GL7ExposureSchedCovItem getExpSchedCovItem() {
      return (entity.GL7ExposureSchedCovItem)__getInternalInterface().getFieldValue(EXPSCHEDCOVITEM_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getExpSchedCovItemCondID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(EXPSCHEDCOVITEMCOND_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getExpSchedCovItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(EXPSCHEDCOVITEM_PROP.get());
    }
    ...
    public void setExpSchedCovItem(entity.GL7ExposureSchedCovItem value) {
      __getInternalInterface().setFieldValue(EXPSCHEDCOVITEM_PROP.get(), value);
    }
    ...
    public void setExpSchedCovItemCondID(gw.pl.persistence.core.Key value) {
      setFieldValue(EXPSCHEDCOVITEMCOND_PROP.get(), value);
    }
    
    public void setExpSchedCovItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(EXPSCHEDCOVITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7ExpSchedCovItemCondCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExpSchedCovItemCondCost.class, config);
    com.guidewire._generated.entity.GL7ExpSchedCovItemCondCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExpSchedCovItemCondCost, com.guidewire._generated.entity.GL7ExpSchedCovItemCondCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExpSchedCovItemCondCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExpSchedCovItemCondCostInternal getInternalInterface(entity.GL7ExpSchedCovItemCondCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExpSchedCovItemCondCost newEmptyInstance() {
        return new entity.GL7ExpSchedCovItemCondCost((java.lang.Void)null);
      }

...
/**
 * GL7ExpSchedCovItemCost
 * Base Exposure Coverage Schedule Item Cost
 */
...
@gw.entity.EntityName(value = "GL7ExpSchedCovItemCost")
public class GL7ExpSchedCovItemCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExpSchedCovItemCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExpSchedCovItemCost, entity.PolicyPeriod>("entity.GL7ExpSchedCovItemCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> EXPSCHEDCOVITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ExpSchedCovItem");
   ...
   */
  public GL7ExpSchedCovItemCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7ExpSchedCovItemCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExpSchedCovItemCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7ExpSchedCovItemCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExpSchedCovItemCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7ExpSchedCovItemCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7ExpSchedCovItemCost clone() {
    return (entity.GL7ExpSchedCovItemCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7ExpSchedCovItemCost getBasedOn() {
    return (entity.GL7ExpSchedCovItemCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExpSchedCovItemCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExpSchedCovItemCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7ExpSchedCovItemCost getUnsliced() {
    return (entity.GL7ExpSchedCovItemCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7ExpSchedCovItemCostVersionList getVersionList() {
    return (entity.windowed.GL7ExpSchedCovItemCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7ExpSchedCovItemCost split(java.util.Date splitDate) {
    return (entity.GL7ExpSchedCovItemCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExpSchedCovItemCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExpSchedCovItemCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7ExpSchedCovItemCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExpSchedCovItemCost.class, config);
    com.guidewire._generated.entity.GL7ExpSchedCovItemCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExpSchedCovItemCost, com.guidewire._generated.entity.GL7ExpSchedCovItemCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExpSchedCovItemCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExpSchedCovItemCostInternal getInternalInterface(entity.GL7ExpSchedCovItemCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExpSchedCovItemCost newEmptyInstance() {
        return new entity.GL7ExpSchedCovItemCost((java.lang.Void)null);
      }

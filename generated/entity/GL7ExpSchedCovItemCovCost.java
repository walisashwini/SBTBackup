...
/**
 * GL7ExpSchedCovItemCovCost
 * GL7 Exposure Coverage Schedule Item Coverage Cost
 */
...
@gw.entity.EntityName(value = "GL7ExpSchedCovItemCovCost")
public class GL7ExpSchedCovItemCovCost extends entity.GL7ExpSchedCovItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExpSchedCovItemCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExpSchedCovItemCovCost, entity.PolicyPeriod>("entity.GL7ExpSchedCovItemCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> EXPSCHEDCOVITEMCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ExpSchedCovItemCov");
   ...
   */
  public GL7ExpSchedCovItemCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7ExpSchedCovItemCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExpSchedCovItemCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7ExpSchedCovItemCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExpSchedCovItemCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7ExpSchedCovItemCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7ExpSchedCovItemCovCost clone() {
    return (entity.GL7ExpSchedCovItemCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7ExpSchedCovItemCovCost getBasedOn() {
    return (entity.GL7ExpSchedCovItemCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExpSchedCovItemCov getExpSchedCovItemCov() {
    return (entity.GL7ExpSchedCovItemCov)__getInternalInterface().getFieldValue(EXPSCHEDCOVITEMCOV_PROP.get());
  }
  
  public entity.GL7ExpSchedCovItemCovCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExpSchedCovItemCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7ExpSchedCovItemCovCost getUnsliced() {
    return (entity.GL7ExpSchedCovItemCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7ExpSchedCovItemCovCostVersionList getVersionList() {
    return (entity.windowed.GL7ExpSchedCovItemCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setExpSchedCovItemCov(entity.GL7ExpSchedCovItemCov value) {
    __getInternalInterface().setFieldValue(EXPSCHEDCOVITEMCOV_PROP.get(), value);
  }
  
  public entity.GL7ExpSchedCovItemCovCost split(java.util.Date splitDate) {
    return (entity.GL7ExpSchedCovItemCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExpSchedCovItemCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExpSchedCovItemCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getExpSchedCovItemCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(EXPSCHEDCOVITEMCOV_PROP.get());
    }
    ...
    public void setExpSchedCovItemCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(EXPSCHEDCOVITEMCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7ExpSchedCovItemCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExpSchedCovItemCovCost.class, config);
    com.guidewire._generated.entity.GL7ExpSchedCovItemCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExpSchedCovItemCovCost, com.guidewire._generated.entity.GL7ExpSchedCovItemCovCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExpSchedCovItemCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExpSchedCovItemCovCostInternal getInternalInterface(entity.GL7ExpSchedCovItemCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExpSchedCovItemCovCost newEmptyInstance() {
        return new entity.GL7ExpSchedCovItemCovCost((java.lang.Void)null);
      }

...
/**
 * GL7ExpSchedCovItemExclCost
 * GL7 Exposure Coverage Schedule Item Exclusion Cost
 */
...
@gw.entity.EntityName(value = "GL7ExpSchedCovItemExclCost")
public class GL7ExpSchedCovItemExclCost extends entity.GL7ExpSchedCovItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExpSchedCovItemExclCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExpSchedCovItemExclCost, entity.PolicyPeriod>("entity.GL7ExpSchedCovItemExclCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> EXPSCHEDCOVITEMEXCL_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ExpSchedCovItemExcl");
   ...
   */
  public GL7ExpSchedCovItemExclCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7ExpSchedCovItemExclCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExpSchedCovItemExclCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7ExpSchedCovItemExclCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExpSchedCovItemExclCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7ExpSchedCovItemExclCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7ExpSchedCovItemExclCost clone() {
    return (entity.GL7ExpSchedCovItemExclCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7ExpSchedCovItemExclCost getBasedOn() {
    return (entity.GL7ExpSchedCovItemExclCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExpSchedCovItemExcl getExpSchedCovItemExcl() {
    return (entity.GL7ExpSchedCovItemExcl)__getInternalInterface().getFieldValue(EXPSCHEDCOVITEMEXCL_PROP.get());
  }
  
  public entity.GL7ExpSchedCovItemExclCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExpSchedCovItemExclCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7ExpSchedCovItemExclCost getUnsliced() {
    return (entity.GL7ExpSchedCovItemExclCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7ExpSchedCovItemExclCostVersionList getVersionList() {
    return (entity.windowed.GL7ExpSchedCovItemExclCostVersionList)getVersionListUntyped();
  }
  ...
  public void setExpSchedCovItemExcl(entity.GL7ExpSchedCovItemExcl value) {
    __getInternalInterface().setFieldValue(EXPSCHEDCOVITEMEXCL_PROP.get(), value);
  }
  
  public entity.GL7ExpSchedCovItemExclCost split(java.util.Date splitDate) {
    return (entity.GL7ExpSchedCovItemExclCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExpSchedCovItemExclCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExpSchedCovItemExclCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getExpSchedCovItemExclID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(EXPSCHEDCOVITEMEXCL_PROP.get());
    }
    ...
    public void setExpSchedCovItemExclID(gw.pl.persistence.core.Key value) {
      setFieldValue(EXPSCHEDCOVITEMEXCL_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7ExpSchedCovItemExclCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExpSchedCovItemExclCost.class, config);
    com.guidewire._generated.entity.GL7ExpSchedCovItemExclCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExpSchedCovItemExclCost, com.guidewire._generated.entity.GL7ExpSchedCovItemExclCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExpSchedCovItemExclCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExpSchedCovItemExclCostInternal getInternalInterface(entity.GL7ExpSchedCovItemExclCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExpSchedCovItemExclCost newEmptyInstance() {
        return new entity.GL7ExpSchedCovItemExclCost((java.lang.Void)null);
      }

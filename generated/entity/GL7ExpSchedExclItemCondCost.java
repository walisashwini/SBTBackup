...
/**
 * GL7ExpSchedExclItemCondCost
 * GL7 Exposure Exclusion Schedule Item Condition Cost
 */
...
@gw.entity.EntityName(value = "GL7ExpSchedExclItemCondCost")
public class GL7ExpSchedExclItemCondCost extends entity.GL7ExpSchedExclItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExpSchedExclItemCondCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExpSchedExclItemCondCost, entity.PolicyPeriod>("entity.GL7ExpSchedExclItemCondCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> EXPSCHEDEXCLITEMCOND_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ExpSchedExclItemCond");
   ...
   */
  public GL7ExpSchedExclItemCondCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7ExpSchedExclItemCondCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExpSchedExclItemCondCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7ExpSchedExclItemCondCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExpSchedExclItemCondCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7ExpSchedExclItemCondCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7ExpSchedExclItemCondCost clone() {
    return (entity.GL7ExpSchedExclItemCondCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7ExpSchedExclItemCondCost getBasedOn() {
    return (entity.GL7ExpSchedExclItemCondCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExpSchedExclItemCond getExpSchedExclItemCond() {
    return (entity.GL7ExpSchedExclItemCond)__getInternalInterface().getFieldValue(EXPSCHEDEXCLITEMCOND_PROP.get());
  }
  
  public entity.GL7ExpSchedExclItemCondCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExpSchedExclItemCondCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7ExpSchedExclItemCondCost getUnsliced() {
    return (entity.GL7ExpSchedExclItemCondCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7ExpSchedExclItemCondCostVersionList getVersionList() {
    return (entity.windowed.GL7ExpSchedExclItemCondCostVersionList)getVersionListUntyped();
  }
  ...
  public void setExpSchedExclItemCond(entity.GL7ExpSchedExclItemCond value) {
    __getInternalInterface().setFieldValue(EXPSCHEDEXCLITEMCOND_PROP.get(), value);
  }
  
  public entity.GL7ExpSchedExclItemCondCost split(java.util.Date splitDate) {
    return (entity.GL7ExpSchedExclItemCondCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExpSchedExclItemCondCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExpSchedExclItemCondCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getExpSchedExclItemCondID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(EXPSCHEDEXCLITEMCOND_PROP.get());
    }
    ...
    public void setExpSchedExclItemCondID(gw.pl.persistence.core.Key value) {
      setFieldValue(EXPSCHEDEXCLITEMCOND_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7ExpSchedExclItemCondCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExpSchedExclItemCondCost.class, config);
    com.guidewire._generated.entity.GL7ExpSchedExclItemCondCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExpSchedExclItemCondCost, com.guidewire._generated.entity.GL7ExpSchedExclItemCondCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExpSchedExclItemCondCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExpSchedExclItemCondCostInternal getInternalInterface(entity.GL7ExpSchedExclItemCondCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExpSchedExclItemCondCost newEmptyInstance() {
        return new entity.GL7ExpSchedExclItemCondCost((java.lang.Void)null);
      }

...
/**
 * GL7ExpSchedExclItemCost
 * Base Exposure Exclusion Schedule Item Cost
 */
...
@gw.entity.EntityName(value = "GL7ExpSchedExclItemCost")
public class GL7ExpSchedExclItemCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExpSchedExclItemCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExpSchedExclItemCost, entity.PolicyPeriod>("entity.GL7ExpSchedExclItemCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> EXPSCHEDEXCLITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ExpSchedExclItem");
   ...
   */
  public GL7ExpSchedExclItemCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7ExpSchedExclItemCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExpSchedExclItemCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7ExpSchedExclItemCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExpSchedExclItemCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7ExpSchedExclItemCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7ExpSchedExclItemCost clone() {
    return (entity.GL7ExpSchedExclItemCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7ExpSchedExclItemCost getBasedOn() {
    return (entity.GL7ExpSchedExclItemCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExpSchedExclItemCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExpSchedExclItemCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7ExpSchedExclItemCost getUnsliced() {
    return (entity.GL7ExpSchedExclItemCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7ExpSchedExclItemCostVersionList getVersionList() {
    return (entity.windowed.GL7ExpSchedExclItemCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7ExpSchedExclItemCost split(java.util.Date splitDate) {
    return (entity.GL7ExpSchedExclItemCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExpSchedExclItemCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExpSchedExclItemCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7ExpSchedExclItemCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExpSchedExclItemCost.class, config);
    com.guidewire._generated.entity.GL7ExpSchedExclItemCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExpSchedExclItemCost, com.guidewire._generated.entity.GL7ExpSchedExclItemCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExpSchedExclItemCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExpSchedExclItemCostInternal getInternalInterface(entity.GL7ExpSchedExclItemCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExpSchedExclItemCost newEmptyInstance() {
        return new entity.GL7ExpSchedExclItemCost((java.lang.Void)null);
      }

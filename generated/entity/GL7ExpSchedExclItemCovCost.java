...
/**
 * GL7ExpSchedExclItemCovCost
 * GL7 Exposure Exclusion Schedule Item Coverage Cost
 */
...
@gw.entity.EntityName(value = "GL7ExpSchedExclItemCovCost")
public class GL7ExpSchedExclItemCovCost extends entity.GL7ExpSchedExclItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExpSchedExclItemCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExpSchedExclItemCovCost, entity.PolicyPeriod>("entity.GL7ExpSchedExclItemCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> EXPSCHEDEXCLITEMCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ExpSchedExclItemCov");
   ...
   */
  public GL7ExpSchedExclItemCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7ExpSchedExclItemCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExpSchedExclItemCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7ExpSchedExclItemCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExpSchedExclItemCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7ExpSchedExclItemCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7ExpSchedExclItemCovCost clone() {
    return (entity.GL7ExpSchedExclItemCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7ExpSchedExclItemCovCost getBasedOn() {
    return (entity.GL7ExpSchedExclItemCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExpSchedExclItemCov getExpSchedExclItemCov() {
    return (entity.GL7ExpSchedExclItemCov)__getInternalInterface().getFieldValue(EXPSCHEDEXCLITEMCOV_PROP.get());
  }
  
  public entity.GL7ExpSchedExclItemCovCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExpSchedExclItemCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7ExpSchedExclItemCovCost getUnsliced() {
    return (entity.GL7ExpSchedExclItemCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7ExpSchedExclItemCovCostVersionList getVersionList() {
    return (entity.windowed.GL7ExpSchedExclItemCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setExpSchedExclItemCov(entity.GL7ExpSchedExclItemCov value) {
    __getInternalInterface().setFieldValue(EXPSCHEDEXCLITEMCOV_PROP.get(), value);
  }
  
  public entity.GL7ExpSchedExclItemCovCost split(java.util.Date splitDate) {
    return (entity.GL7ExpSchedExclItemCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExpSchedExclItemCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExpSchedExclItemCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getExpSchedExclItemCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(EXPSCHEDEXCLITEMCOV_PROP.get());
    }
    ...
    public void setExpSchedExclItemCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(EXPSCHEDEXCLITEMCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7ExpSchedExclItemCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExpSchedExclItemCovCost.class, config);
    com.guidewire._generated.entity.GL7ExpSchedExclItemCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExpSchedExclItemCovCost, com.guidewire._generated.entity.GL7ExpSchedExclItemCovCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExpSchedExclItemCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExpSchedExclItemCovCostInternal getInternalInterface(entity.GL7ExpSchedExclItemCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExpSchedExclItemCovCost newEmptyInstance() {
        return new entity.GL7ExpSchedExclItemCovCost((java.lang.Void)null);
      }

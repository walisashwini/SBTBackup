...
/**
 * GL7ExpSchedExclItemExcl
 * GL7 exposure level exclusion scheduled item with exclusion terms
 */
...
@gw.entity.EntityName(value = "GL7ExpSchedExclItemExcl")
public class GL7ExpSchedExclItemExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, entity.GL7Clause, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExpSchedExclItemExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExpSchedExclItemExcl, entity.PolicyPeriod>("entity.GL7ExpSchedExclItemExcl");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> EXPSCHEDEXCLITEMEXCLCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "ExpSchedExclItemExclCosts");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GL7EXPOSURESCHEDEXCLITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GL7ExposureSchedExclItem");
  ...
  private com.guidewire._generated.entity.GL7ExpSchedExclItemExclInternal _internal;
   ...
   */
  protected GL7ExpSchedExclItemExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7ExpSchedExclItemExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExpSchedExclItemExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ExpSchedExclItemExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExpSchedExclItemExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToExpSchedExclItemExclCosts(entity.GL7ExpSchedExclItemExclCost element) {
    __getInternalInterface().addArrayElement(EXPSCHEDEXCLITEMEXCLCOSTS_PROP.get(), element);
  }
  ...
  public entity.GL7ExpSchedExclItemExcl clone() {
    return (entity.GL7ExpSchedExclItemExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7ExpSchedExclItemExcl getBasedOn() {
    return (entity.GL7ExpSchedExclItemExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExpSchedExclItemExcl getBasedOnValue() {
    return (entity.GL7ExpSchedExclItemExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7ExpSchedExclItemExclCost[] getExpSchedExclItemExclCosts() {
    return (entity.GL7ExpSchedExclItemExclCost[])__getInternalInterface().getFieldValue(EXPSCHEDEXCLITEMEXCLCOSTS_PROP.get());
  }
  ...
  public entity.GL7ExpSchedExclItemExcl getFixed() {
    return (entity.GL7ExpSchedExclItemExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7ExposureSchedExclItem getGL7ExposureSchedExclItem() {
    return (entity.GL7ExposureSchedExclItem)__getInternalInterface().getFieldValue(GL7EXPOSURESCHEDEXCLITEM_PROP.get());
  }
  ...
  public entity.GL7ExpSchedExclItemExcl getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExpSchedExclItemExcl)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.GL7ExpSchedExclItemExcl getSubtype() {
    return (typekey.GL7ExpSchedExclItemExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.GL7ExpSchedExclItemExcl getUnsliced() {
    return (entity.GL7ExpSchedExclItemExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7ExpSchedExclItemExclVersionList getVersionList() {
    return (entity.windowed.GL7ExpSchedExclItemExclVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromExpSchedExclItemExclCosts(entity.GL7ExpSchedExclItemExclCost element) {
    __getInternalInterface().removeArrayElement(EXPSCHEDEXCLITEMEXCLCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromExpSchedExclItemExclCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(EXPSCHEDEXCLITEMEXCLCOSTS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.GL7ExpSchedExclItemExcl value) {
  ...
  public void setExpSchedExclItemExclCosts(entity.GL7ExpSchedExclItemExclCost[] value) {
    __getInternalInterface().setFieldValue(EXPSCHEDEXCLITEMEXCLCOSTS_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.GL7ExpSchedExclItemExcl value) {
  ...
  public void setGL7ExposureSchedExclItem(entity.GL7ExposureSchedExclItem value) {
    __getInternalInterface().setFieldValue(GL7EXPOSURESCHEDEXCLITEM_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.GL7ExpSchedExclItemExcl value) {
  ...
  public entity.GL7ExpSchedExclItemExcl split(java.util.Date splitDate) {
    return (entity.GL7ExpSchedExclItemExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExpSchedExclItemExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExpSchedExclItemExcl.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getGL7ExposureSchedExclItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GL7EXPOSURESCHEDEXCLITEM_PROP.get());
    }
    ...
    public void setGL7ExposureSchedExclItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(GL7EXPOSURESCHEDEXCLITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.schedules.GL7ExposureSchedExclItemExclAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.schedules.GL7ExposureSchedExclItemExclAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.gl7.schedules.GL7ExposureSchedExclItemExclAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7ExposureSchedExclItemExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7ExposureSchedExclItemExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExpSchedExclItemExcl.class, config);
    com.guidewire._generated.entity.GL7ExpSchedExclItemExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExpSchedExclItemExcl, com.guidewire._generated.entity.GL7ExpSchedExclItemExclInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExpSchedExclItemExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExpSchedExclItemExclInternal getInternalInterface(entity.GL7ExpSchedExclItemExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExpSchedExclItemExcl newEmptyInstance() {
        return new entity.GL7ExpSchedExclItemExcl((java.lang.Void)null);
      }

...
/**
 * GL7ExpSchedExclItemExclCost
 * GL7 Exposure Exclusion Schedule Item Exclusion Cost
 */
...
@gw.entity.EntityName(value = "GL7ExpSchedExclItemExclCost")
public class GL7ExpSchedExclItemExclCost extends entity.GL7ExpSchedExclItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExpSchedExclItemExclCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExpSchedExclItemExclCost, entity.PolicyPeriod>("entity.GL7ExpSchedExclItemExclCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> EXPSCHEDEXCLITEMEXCL_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ExpSchedExclItemExcl");
   ...
   */
  public GL7ExpSchedExclItemExclCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7ExpSchedExclItemExclCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExpSchedExclItemExclCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7ExpSchedExclItemExclCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExpSchedExclItemExclCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7ExpSchedExclItemExclCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7ExpSchedExclItemExclCost clone() {
    return (entity.GL7ExpSchedExclItemExclCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7ExpSchedExclItemExclCost getBasedOn() {
    return (entity.GL7ExpSchedExclItemExclCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExpSchedExclItemExcl getExpSchedExclItemExcl() {
    return (entity.GL7ExpSchedExclItemExcl)__getInternalInterface().getFieldValue(EXPSCHEDEXCLITEMEXCL_PROP.get());
  }
  
  public entity.GL7ExpSchedExclItemExclCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExpSchedExclItemExclCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7ExpSchedExclItemExclCost getUnsliced() {
    return (entity.GL7ExpSchedExclItemExclCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7ExpSchedExclItemExclCostVersionList getVersionList() {
    return (entity.windowed.GL7ExpSchedExclItemExclCostVersionList)getVersionListUntyped();
  }
  ...
  public void setExpSchedExclItemExcl(entity.GL7ExpSchedExclItemExcl value) {
    __getInternalInterface().setFieldValue(EXPSCHEDEXCLITEMEXCL_PROP.get(), value);
  }
  
  public entity.GL7ExpSchedExclItemExclCost split(java.util.Date splitDate) {
    return (entity.GL7ExpSchedExclItemExclCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExpSchedExclItemExclCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExpSchedExclItemExclCost.this.__getDelegateManager();
    }
    ...
    public entity.GL7ExposureSchedExclItem getExpSchedExclItem() {
      return (entity.GL7ExposureSchedExclItem)__getInternalInterface().getFieldValue(EXPSCHEDEXCLITEM_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getExpSchedExclItemExclID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(EXPSCHEDEXCLITEMEXCL_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getExpSchedExclItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(EXPSCHEDEXCLITEM_PROP.get());
    }
    ...
    public void setExpSchedExclItem(entity.GL7ExposureSchedExclItem value) {
      __getInternalInterface().setFieldValue(EXPSCHEDEXCLITEM_PROP.get(), value);
    }
    ...
    public void setExpSchedExclItemExclID(gw.pl.persistence.core.Key value) {
      setFieldValue(EXPSCHEDEXCLITEMEXCL_PROP.get(), value);
    }
    
    public void setExpSchedExclItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(EXPSCHEDEXCLITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7ExpSchedExclItemExclCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExpSchedExclItemExclCost.class, config);
    com.guidewire._generated.entity.GL7ExpSchedExclItemExclCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExpSchedExclItemExclCost, com.guidewire._generated.entity.GL7ExpSchedExclItemExclCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExpSchedExclItemExclCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExpSchedExclItemExclCostInternal getInternalInterface(entity.GL7ExpSchedExclItemExclCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExpSchedExclItemExclCost newEmptyInstance() {
        return new entity.GL7ExpSchedExclItemExclCost((java.lang.Void)null);
      }

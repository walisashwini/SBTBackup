...
/**
 * GL7ExpectedLossRatioRT
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7ExpectedLossRatioRT.eti;GL7ExpectedLossRatioRT.eix;GL7ExpectedLossRatioRT.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7ExpectedLossRatioRT")
public class GL7ExpectedLossRatioRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ExpectedLossRatioRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ExpectedLossRatioRT>("entity.GL7ExpectedLossRatioRT");
  ...
  private com.guidewire._generated.entity.GL7ExpectedLossRatioRTInternal _internal;
   ...
   */
  public GL7ExpectedLossRatioRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ExpectedLossRatioRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ExpectedLossRatioRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExpectedLossRatioRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExpectedLossRatioRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExpectedLossRatioRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExpectedLossRatioRT.class, config);
    com.guidewire._generated.entity.GL7ExpectedLossRatioRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExpectedLossRatioRT, com.guidewire._generated.entity.GL7ExpectedLossRatioRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExpectedLossRatioRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExpectedLossRatioRTInternal getInternalInterface(entity.GL7ExpectedLossRatioRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExpectedLossRatioRT newEmptyInstance() {
        return new entity.GL7ExpectedLossRatioRT((java.lang.Void)null);
      }

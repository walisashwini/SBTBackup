...
/**
 * GL7ExposureCond
 * Conditions directly attached to each GL7 Exposure
 */
...
@gw.entity.EntityName(value = "GL7ExposureCond")
public class GL7ExposureCond extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PolicyCondition, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExposureCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExposureCond, entity.PolicyPeriod>("entity.GL7ExposureCond");
  ...
  private com.guidewire._generated.entity.GL7ExposureCondInternal _internal;
   ...
   */
  protected GL7ExposureCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7ExposureCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExposureCond(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ExposureCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExposureCondInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7ExposureCond clone() {
    return (entity.GL7ExposureCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7ExposureCond getBasedOn() {
    return (entity.GL7ExposureCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExposureCond getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExposureCond)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7ExposureCond getUnsliced() {
    return (entity.GL7ExposureCond)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7ExposureCondVersionList getVersionList() {
    return (entity.windowed.GL7ExposureCondVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7ExposureCond value) {
   ...
   */
  private void setFixed(entity.GL7ExposureCond value) {
   ...
   */
  private void setSubtype(typekey.GL7ExposureCond value) {
  ...
  public entity.GL7ExposureCond split(java.util.Date splitDate) {
    return (entity.GL7ExposureCond)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExposureCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExposureCond.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.GL7ExposureCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.GL7ExposureCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExposureCond.class, config);
    com.guidewire._generated.entity.GL7ExposureCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExposureCond, com.guidewire._generated.entity.GL7ExposureCondInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExposureCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExposureCondInternal getInternalInterface(entity.GL7ExposureCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExposureCond newEmptyInstance() {
        return new entity.GL7ExposureCond((java.lang.Void)null);
      }

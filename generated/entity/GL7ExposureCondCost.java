...
/**
 * GL7ExposureCondCost
 * The cost for a Exposure Condition
 */
...
@gw.entity.EntityName(value = "GL7ExposureCondCost")
public class GL7ExposureCondCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExposureCondCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExposureCondCost, entity.PolicyPeriod>("entity.GL7ExposureCondCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> EXPOSURECONDITION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ExposureCondition");
   ...
   */
  public GL7ExposureCondCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7ExposureCondCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExposureCondCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7ExposureCondCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExposureCondCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7ExposureCondCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7ExposureCondCost clone() {
    return (entity.GL7ExposureCondCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7ExposureCondCost getBasedOn() {
    return (entity.GL7ExposureCondCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExposureCond getExposureCondition() {
    return (entity.GL7ExposureCond)__getInternalInterface().getFieldValue(EXPOSURECONDITION_PROP.get());
  }
  
  public entity.GL7ExposureCondCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExposureCondCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7ExposureCondCost getUnsliced() {
    return (entity.GL7ExposureCondCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7ExposureCondCostVersionList getVersionList() {
    return (entity.windowed.GL7ExposureCondCostVersionList)getVersionListUntyped();
  }
  ...
  public void setExposureCondition(entity.GL7ExposureCond value) {
    __getInternalInterface().setFieldValue(EXPOSURECONDITION_PROP.get(), value);
  }
  
  public entity.GL7ExposureCondCost split(java.util.Date splitDate) {
    return (entity.GL7ExposureCondCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExposureCondCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExposureCondCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getExposureConditionID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(EXPOSURECONDITION_PROP.get());
    }
    ...
    public void setExposureConditionID(gw.pl.persistence.core.Key value) {
      setFieldValue(EXPOSURECONDITION_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7ExposureCondCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExposureCondCost.class, config);
    com.guidewire._generated.entity.GL7ExposureCondCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExposureCondCost, com.guidewire._generated.entity.GL7ExposureCondCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExposureCondCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExposureCondCostInternal getInternalInterface(entity.GL7ExposureCondCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExposureCondCost newEmptyInstance() {
        return new entity.GL7ExposureCondCost((java.lang.Void)null);
      }

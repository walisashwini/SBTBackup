...
/**
 * GL7ExposureCov
 * Coverages directly attached to each GL7 Exposure
 */
...
@gw.entity.EntityName(value = "GL7ExposureCov")
public class GL7ExposureCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExposureCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExposureCov, entity.PolicyPeriod>("entity.GL7ExposureCov");
  ...
  private com.guidewire._generated.entity.GL7ExposureCovInternal _internal;
   ...
   */
  protected GL7ExposureCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7ExposureCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExposureCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ExposureCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExposureCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7ExposureCov clone() {
    return (entity.GL7ExposureCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7ExposureCov getBasedOn() {
    return (entity.GL7ExposureCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExposureCov getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExposureCov)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7ExposureCov getUnsliced() {
    return (entity.GL7ExposureCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7ExposureCovVersionList getVersionList() {
    return (entity.windowed.GL7ExposureCovVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7ExposureCov value) {
   ...
   */
  private void setFixed(entity.GL7ExposureCov value) {
   ...
   */
  private void setSubtype(typekey.GL7ExposureCov value) {
  ...
  public entity.GL7ExposureCov split(java.util.Date splitDate) {
    return (entity.GL7ExposureCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExposureCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExposureCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.GL7ExposureCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.GL7ExposureCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExposureCov.class, config);
    com.guidewire._generated.entity.GL7ExposureCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExposureCov, com.guidewire._generated.entity.GL7ExposureCovInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExposureCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExposureCovInternal getInternalInterface(entity.GL7ExposureCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExposureCov newEmptyInstance() {
        return new entity.GL7ExposureCov((java.lang.Void)null);
      }

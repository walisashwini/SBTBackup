...
/**
 * GL7ExposureCovCost
 * The cost for a Exposure Coverage
 */
...
@gw.entity.EntityName(value = "GL7ExposureCovCost")
public class GL7ExposureCovCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExposureCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExposureCovCost, entity.PolicyPeriod>("entity.GL7ExposureCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> EXPOSURECOVERAGE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ExposureCoverage");
   ...
   */
  public GL7ExposureCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7ExposureCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExposureCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7ExposureCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExposureCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7ExposureCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7ExposureCovCost clone() {
    return (entity.GL7ExposureCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7ExposureCovCost getBasedOn() {
    return (entity.GL7ExposureCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExposureCov getExposureCoverage() {
    return (entity.GL7ExposureCov)__getInternalInterface().getFieldValue(EXPOSURECOVERAGE_PROP.get());
  }
  
  public entity.GL7ExposureCovCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExposureCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7ExposureCovCost getUnsliced() {
    return (entity.GL7ExposureCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7ExposureCovCostVersionList getVersionList() {
    return (entity.windowed.GL7ExposureCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setExposureCoverage(entity.GL7ExposureCov value) {
    __getInternalInterface().setFieldValue(EXPOSURECOVERAGE_PROP.get(), value);
  }
  
  public entity.GL7ExposureCovCost split(java.util.Date splitDate) {
    return (entity.GL7ExposureCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExposureCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExposureCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getExposureCoverageID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(EXPOSURECOVERAGE_PROP.get());
    }
    ...
    public void setExposureCoverageID(gw.pl.persistence.core.Key value) {
      setFieldValue(EXPOSURECOVERAGE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7ExposureCovCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExposureCovCost.class, config);
    com.guidewire._generated.entity.GL7ExposureCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExposureCovCost, com.guidewire._generated.entity.GL7ExposureCovCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExposureCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExposureCovCostInternal getInternalInterface(entity.GL7ExposureCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExposureCovCost newEmptyInstance() {
        return new entity.GL7ExposureCovCost((java.lang.Void)null);
      }

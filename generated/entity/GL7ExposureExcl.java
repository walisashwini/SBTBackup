...
/**
 * GL7ExposureExcl
 * Exclusions directly attached to each GL7 Exposure
 */
...
@gw.entity.EntityName(value = "GL7ExposureExcl")
public class GL7ExposureExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExposureExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExposureExcl, entity.PolicyPeriod>("entity.GL7ExposureExcl");
  ...
  private com.guidewire._generated.entity.GL7ExposureExclInternal _internal;
   ...
   */
  protected GL7ExposureExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7ExposureExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExposureExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ExposureExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExposureExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7ExposureExcl clone() {
    return (entity.GL7ExposureExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7ExposureExcl getBasedOn() {
    return (entity.GL7ExposureExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExposureExcl getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExposureExcl)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7ExposureExcl getUnsliced() {
    return (entity.GL7ExposureExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7ExposureExclVersionList getVersionList() {
    return (entity.windowed.GL7ExposureExclVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7ExposureExcl value) {
   ...
   */
  private void setFixed(entity.GL7ExposureExcl value) {
   ...
   */
  private void setSubtype(typekey.GL7ExposureExcl value) {
  ...
  public entity.GL7ExposureExcl split(java.util.Date splitDate) {
    return (entity.GL7ExposureExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExposureExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExposureExcl.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.GL7ExposureExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.GL7ExposureExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExposureExcl.class, config);
    com.guidewire._generated.entity.GL7ExposureExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExposureExcl, com.guidewire._generated.entity.GL7ExposureExclInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExposureExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExposureExclInternal getInternalInterface(entity.GL7ExposureExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExposureExcl newEmptyInstance() {
        return new entity.GL7ExposureExcl((java.lang.Void)null);
      }

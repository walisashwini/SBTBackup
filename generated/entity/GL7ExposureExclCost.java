...
/**
 * GL7ExposureExclCost
 * The cost for an Exposure Exclusion
 */
...
@gw.entity.EntityName(value = "GL7ExposureExclCost")
public class GL7ExposureExclCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExposureExclCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExposureExclCost, entity.PolicyPeriod>("entity.GL7ExposureExclCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> EXPOSUREEXCLUSION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ExposureExclusion");
   ...
   */
  public GL7ExposureExclCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7ExposureExclCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExposureExclCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7ExposureExclCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExposureExclCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7ExposureExclCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7ExposureExclCost clone() {
    return (entity.GL7ExposureExclCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7ExposureExclCost getBasedOn() {
    return (entity.GL7ExposureExclCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExposureExcl getExposureExclusion() {
    return (entity.GL7ExposureExcl)__getInternalInterface().getFieldValue(EXPOSUREEXCLUSION_PROP.get());
  }
  
  public entity.GL7ExposureExclCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExposureExclCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7ExposureExclCost getUnsliced() {
    return (entity.GL7ExposureExclCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7ExposureExclCostVersionList getVersionList() {
    return (entity.windowed.GL7ExposureExclCostVersionList)getVersionListUntyped();
  }
  ...
  public void setExposureExclusion(entity.GL7ExposureExcl value) {
    __getInternalInterface().setFieldValue(EXPOSUREEXCLUSION_PROP.get(), value);
  }
  
  public entity.GL7ExposureExclCost split(java.util.Date splitDate) {
    return (entity.GL7ExposureExclCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExposureExclCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExposureExclCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getExposureExclusionID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(EXPOSUREEXCLUSION_PROP.get());
    }
    ...
    public void setExposureExclusionID(gw.pl.persistence.core.Key value) {
      setFieldValue(EXPOSUREEXCLUSION_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7ExposureExclCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExposureExclCost.class, config);
    com.guidewire._generated.entity.GL7ExposureExclCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExposureExclCost, com.guidewire._generated.entity.GL7ExposureExclCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExposureExclCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExposureExclCostInternal getInternalInterface(entity.GL7ExposureExclCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExposureExclCost newEmptyInstance() {
        return new entity.GL7ExposureExclCost((java.lang.Void)null);
      }

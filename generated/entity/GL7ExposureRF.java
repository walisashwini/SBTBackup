...
@gw.entity.EntityName(value = "GL7ExposureRF")
public class GL7ExposureRF extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.RateFactor, gw.api.copier.EffDatedCopyable {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExposureRF, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExposureRF, entity.PolicyPeriod>("entity.GL7ExposureRF");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GL7EXPOSUREMODIFIER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GL7ExposureModifier");
  ...
  private com.guidewire._generated.entity.GL7ExposureRFInternal _internal;
   ...
   */
  public GL7ExposureRF(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7ExposureRF(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExposureRF(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ExposureRFInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExposureRFInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7ExposureRF clone() {
    return (entity.GL7ExposureRF)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7ExposureRF getBasedOn() {
    return (entity.GL7ExposureRF)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExposureRF getBasedOnValue() {
    return (entity.GL7ExposureRF)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7ExposureRF getFixed() {
    return (entity.GL7ExposureRF)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7ExposureMod getGL7ExposureModifier() {
    return (entity.GL7ExposureMod)__getInternalInterface().getFieldValue(GL7EXPOSUREMODIFIER_PROP.get());
  }
  ...
  public entity.GL7ExposureRF getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExposureRF)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7ExposureRF getUnsliced() {
    return (entity.GL7ExposureRF)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7ExposureRFVersionList getVersionList() {
    return (entity.windowed.GL7ExposureRFVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7ExposureRF value) {
   ...
   */
  private void setFixed(entity.GL7ExposureRF value) {
  ...
  public void setGL7ExposureModifier(entity.GL7ExposureMod value) {
    __getInternalInterface().setFieldValue(GL7EXPOSUREMODIFIER_PROP.get(), value);
  }
  ...
  public entity.GL7ExposureRF split(java.util.Date splitDate) {
    return (entity.GL7ExposureRF)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExposureRFInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExposureRF.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getGL7ExposureModifierID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GL7EXPOSUREMODIFIER_PROP.get());
    }
    ...
    public void setGL7ExposureModifierID(gw.pl.persistence.core.Key value) {
      setFieldValue(GL7EXPOSUREMODIFIER_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.RateFactorAdapter", "gw.lob.gl7.GL7ExposureRateFactorAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExposureRF.class, config);
    com.guidewire._generated.entity.GL7ExposureRFInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExposureRF, com.guidewire._generated.entity.GL7ExposureRFInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExposureRF bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExposureRFInternal getInternalInterface(entity.GL7ExposureRF bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExposureRF newEmptyInstance() {
        return new entity.GL7ExposureRF((java.lang.Void)null);
      }

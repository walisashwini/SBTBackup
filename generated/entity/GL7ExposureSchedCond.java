...
/**
 * GL7ExposureSchedCond
 * GL7Exposure Condition with a schedule
 */
...
@gw.entity.EntityName(value = "GL7ExposureSchedCond")
public class GL7ExposureSchedCond extends entity.GL7ExposureCond implements entity.ScheduleAutoNumberSequence, gw.api.copier.EffDatedCopyable, gw.api.domain.Schedule, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExposureSchedCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExposureSchedCond, entity.PolicyPeriod>("entity.GL7ExposureSchedCond");
   ...
   */
  protected GL7ExposureSchedCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7ExposureSchedCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExposureSchedCond(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7ExposureSchedCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExposureSchedCondInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7ExposureSchedCondInternal)super.__getInternalInterface();
  }
   ...
   */
  public void addToGL7ScheduledItems(entity.GL7ExposureSchedCondItem element) {
  ...
  public entity.GL7ExposureSchedCond clone() {
    return (entity.GL7ExposureSchedCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7ExposureSchedCond getBasedOn() {
    return (entity.GL7ExposureSchedCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExposureSchedCondItem[] getGL7ScheduledItems() {
    return (entity.GL7ExposureSchedCondItem[])__getInternalInterface().getFieldValue(GL7SCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.GL7ExposureSchedCond getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExposureSchedCond)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7ExposureSchedCond getUnsliced() {
    return (entity.GL7ExposureSchedCond)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7ExposureSchedCondVersionList getVersionList() {
    return (entity.windowed.GL7ExposureSchedCondVersionList)getVersionListUntyped();
  }
   ...
   */
  public void removeFromGL7ScheduledItems(entity.GL7ExposureSchedCondItem element) {
   ...
   */
  public void setGL7ScheduledItems(entity.GL7ExposureSchedCondItem[] value) {
  ...
  public entity.GL7ExposureSchedCond split(java.util.Date splitDate) {
    return (entity.GL7ExposureSchedCond)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExposureSchedCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExposureSchedCond.this.__getDelegateManager();
    }
    ...
    public entity.GL7ExposureCond getBasedOnValue() {
      return (entity.GL7ExposureCond)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public entity.GL7ExposureCondCost[] getCosts() {
      return (entity.GL7ExposureCondCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
    }
    ...
    public entity.GL7ExposureCond getFixed() {
      return (entity.GL7ExposureCond)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public typekey.GL7ExposureCond getSubtype() {
      return (typekey.GL7ExposureCond)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.GL7ExposureCondConditionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.GL7ExposureCondConditionAdapter");
    config.put("gw.api.domain.PolicyConditionAdapter", "gw.lob.gl7.GL7ExposureCondConditionAdapter");
    config.put("gw.api.domain.Schedule", "gw.lob.gl7.schedules.GL7ExposureSchedCondImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7ExposureSchedCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7ExposureSchedCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExposureSchedCond.class, config);
    com.guidewire._generated.entity.GL7ExposureSchedCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExposureSchedCond, com.guidewire._generated.entity.GL7ExposureSchedCondInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExposureSchedCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExposureSchedCondInternal getInternalInterface(entity.GL7ExposureSchedCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExposureSchedCond newEmptyInstance() {
        return new entity.GL7ExposureSchedCond((java.lang.Void)null);
      }

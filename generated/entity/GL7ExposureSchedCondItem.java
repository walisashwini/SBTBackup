 ...
 * GL7 exposure level condition scheduled item
 */
...
@gw.entity.EntityName(value = "GL7ExposureSchedCondItem")
public class GL7ExposureSchedCondItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.ScheduledItem, entity.Coverable, entity.CoverableFieldAvailability, entity.GL7ScheduledItem, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExposureSchedCondItem, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExposureSchedCondItem, entity.PolicyPeriod>("entity.GL7ExposureSchedCondItem");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> ADDITIONALINSURED_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "AdditionalInsured");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> CONDITIONCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "ConditionCosts");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> COVERAGECOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "CoverageCosts");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DATECOL2_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DateCol2");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DECIMALCOL1_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DecimalCol1");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> EXCLUSIONCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "ExclusionCosts");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LONGSTRINGCOL1_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LongStringCol1");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LONGSTRINGCOL2_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LongStringCol2");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LONGSTRINGCOL3_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LongStringCol3");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LONGSTRINGCOL4_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LongStringCol4");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LONGSTRINGCOL5_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LongStringCol5");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> OPTIONCOL1_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "OptionCol1");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> OPTIONCOL2_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "OptionCol2");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> OPTIONCOL3_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "OptionCol3");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SCHEDULECONDITION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ScheduleCondition");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> SCHEDULEITEMCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "ScheduleItemCosts");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> STRINGCOL5_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "StringCol5");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> STRINGCOL6_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "StringCol6");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> STRINGCOL7_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "StringCol7");
  ...
  private com.guidewire._generated.entity.GL7ExposureSchedCondItemInternal _internal;
   ...
   */
  public GL7ExposureSchedCondItem(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7ExposureSchedCondItem(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExposureSchedCondItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ExposureSchedCondItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExposureSchedCondItemInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  public void addToConditionCosts(entity.GL7ExpSchedCondItemCondCost element) {
    __getInternalInterface().addArrayElement(CONDITIONCOSTS_PROP.get(), element);
  }
   ...
   */
  public void addToConditions(entity.GL7ExpSchedCondItemCond element) {
   ...
   */
  public void addToCoverageCosts(entity.GL7ExpSchedCondItemCovCost element) {
    __getInternalInterface().addArrayElement(COVERAGECOSTS_PROP.get(), element);
  }
  
  /**
   * Adds the given element to the Coverages array. This is achieved by setting the parent foreign key to this entity instance.
   */
  public void addToCoverages(entity.GL7ExpSchedCondItemCov element) {
   ...
   */
  public void addToExclusionCosts(entity.GL7ExpSchedCondItemExclCost element) {
    __getInternalInterface().addArrayElement(EXCLUSIONCOSTS_PROP.get(), element);
  }
   ...
   */
  public void addToExclusions(entity.GL7ExpSchedCondItemExcl element) {
   ...
   */
  public void addToScheduleItemCosts(entity.GL7ExpSchedCondItemCost element) {
    __getInternalInterface().addArrayElement(SCHEDULEITEMCOSTS_PROP.get(), element);
  }
  ...
  public entity.GL7ExposureSchedCondItem clone() {
    return (entity.GL7ExposureSchedCondItem)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.PolicyAddlInsuredDetail getAdditionalInsured() {
    return (entity.PolicyAddlInsuredDetail)__getInternalInterface().getFieldValue(ADDITIONALINSURED_PROP.get());
  }
  ...
  public entity.GL7ExposureSchedCondItem getBasedOn() {
    return (entity.GL7ExposureSchedCondItem)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7ExposureSchedCondItem getBasedOnValue() {
    return (entity.GL7ExposureSchedCondItem)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7ExpSchedCondItemCondCost[] getConditionCosts() {
    return (entity.GL7ExpSchedCondItemCondCost[])__getInternalInterface().getFieldValue(CONDITIONCOSTS_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7ExpSchedCondItemCond[] getConditions() {
    return (entity.GL7ExpSchedCondItemCond[])__getInternalInterface().getFieldValue(CONDITIONS_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7ExpSchedCondItemCovCost[] getCoverageCosts() {
    return (entity.GL7ExpSchedCondItemCovCost[])__getInternalInterface().getFieldValue(COVERAGECOSTS_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7ExpSchedCondItemCov[] getCoverages() {
    return (entity.GL7ExpSchedCondItemCov[])__getInternalInterface().getFieldValue(COVERAGES_PROP.get());
  }
  ...
  public java.util.Date getDateCol2() {
    return (java.util.Date)__getInternalInterface().getFieldValue(DATECOL2_PROP.get());
  }
  ...
  public java.math.BigDecimal getDecimalCol1() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(DECIMALCOL1_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7ExpSchedCondItemExclCost[] getExclusionCosts() {
    return (entity.GL7ExpSchedCondItemExclCost[])__getInternalInterface().getFieldValue(EXCLUSIONCOSTS_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7ExpSchedCondItemExcl[] getExclusions() {
    return (entity.GL7ExpSchedCondItemExcl[])__getInternalInterface().getFieldValue(EXCLUSIONS_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7ExposureSchedCondItem getFixed() {
    return (entity.GL7ExposureSchedCondItem)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public java.lang.String getLongStringCol1() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(LONGSTRINGCOL1_PROP.get());
  }
  ...
  public java.lang.String getLongStringCol2() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(LONGSTRINGCOL2_PROP.get());
  }
  ...
  public java.lang.String getLongStringCol3() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(LONGSTRINGCOL3_PROP.get());
  }
  ...
  public java.lang.String getLongStringCol4() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(LONGSTRINGCOL4_PROP.get());
  }
  ...
  public java.lang.String getLongStringCol5() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(LONGSTRINGCOL5_PROP.get());
  }
  ...
  public java.lang.String getOptionCol1() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(OPTIONCOL1_PROP.get());
  }
  ...
  public java.lang.String getOptionCol2() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(OPTIONCOL2_PROP.get());
  }
  ...
  public java.lang.String getOptionCol3() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(OPTIONCOL3_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7ExposureSchedCond getScheduleCondition() {
    return (entity.GL7ExposureSchedCond)__getInternalInterface().getFieldValue(SCHEDULECONDITION_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7ExpSchedCondItemCost[] getScheduleItemCosts() {
    return (entity.GL7ExpSchedCondItemCost[])__getInternalInterface().getFieldValue(SCHEDULEITEMCOSTS_PROP.get());
  }
  ...
  public entity.GL7ExposureSchedCondItem getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExposureSchedCondItem)getSliceUntyped(sliceDate);
  }
  ...
  public java.lang.String getStringCol5() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(STRINGCOL5_PROP.get());
  }
  ...
  public java.lang.String getStringCol6() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(STRINGCOL6_PROP.get());
  }
  ...
  public java.lang.String getStringCol7() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(STRINGCOL7_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.GL7ExposureSchedCondItem getSubtype() {
    return (typekey.GL7ExposureSchedCondItem)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.GL7ExposureSchedCondItem getUnsliced() {
    return (entity.GL7ExposureSchedCondItem)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7ExposureSchedCondItemVersionList getVersionList() {
    return (entity.windowed.GL7ExposureSchedCondItemVersionList)getVersionListUntyped();
  }
   ...
   */
  public void removeFromConditionCosts(entity.GL7ExpSchedCondItemCondCost element) {
    __getInternalInterface().removeArrayElement(CONDITIONCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromConditionCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(CONDITIONCOSTS_PROP.get(), elementID);
  }
  
  /**
   * Removes the given element from the Conditions array. This is achieved by marking the element for removal.
   */
  public void removeFromConditions(entity.GL7ExpSchedCondItemCond element) {
   ...
   */
  public void removeFromCoverageCosts(entity.GL7ExpSchedCondItemCovCost element) {
    __getInternalInterface().removeArrayElement(COVERAGECOSTS_PROP.get(), element);
  }
  ...
  public void removeFromCoverageCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(COVERAGECOSTS_PROP.get(), elementID);
  }
  
  /**
   * Removes the given element from the Coverages array. This is achieved by marking the element for removal.
   */
  public void removeFromCoverages(entity.GL7ExpSchedCondItemCov element) {
   ...
   */
  public void removeFromExclusionCosts(entity.GL7ExpSchedCondItemExclCost element) {
    __getInternalInterface().removeArrayElement(EXCLUSIONCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromExclusionCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(EXCLUSIONCOSTS_PROP.get(), elementID);
  }
  
  /**
   * Removes the given element from the Exclusions array. This is achieved by marking the element for removal.
   */
  public void removeFromExclusions(entity.GL7ExpSchedCondItemExcl element) {
   ...
   */
  public void removeFromScheduleItemCosts(entity.GL7ExpSchedCondItemCost element) {
    __getInternalInterface().removeArrayElement(SCHEDULEITEMCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromScheduleItemCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(SCHEDULEITEMCOSTS_PROP.get(), elementID);
  }
  ...
  public void setAdditionalInsured(entity.PolicyAddlInsuredDetail value) {
    __getInternalInterface().setFieldValue(ADDITIONALINSURED_PROP.get(), value);
  }
   ...
   */
  private void setBasedOnValue(entity.GL7ExposureSchedCondItem value) {
   ...
   */
  public void setConditionCosts(entity.GL7ExpSchedCondItemCondCost[] value) {
    __getInternalInterface().setFieldValue(CONDITIONCOSTS_PROP.get(), value);
  }
   ...
   */
  public void setConditions(entity.GL7ExpSchedCondItemCond[] value) {
   ...
   */
  public void setCoverageCosts(entity.GL7ExpSchedCondItemCovCost[] value) {
    __getInternalInterface().setFieldValue(COVERAGECOSTS_PROP.get(), value);
  }
   ...
   */
  public void setCoverages(entity.GL7ExpSchedCondItemCov[] value) {
  ...
  /**
   * Sets the value of the DateCol2 field.
   */
  private void setDateCol2(java.util.Date value) {
    __getInternalInterface().setFieldValue(DATECOL2_PROP.get(), value);
  }
  ...
  public void setDecimalCol1(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(DECIMALCOL1_PROP.get(), value);
  }
   ...
   */
  public void setExclusionCosts(entity.GL7ExpSchedCondItemExclCost[] value) {
    __getInternalInterface().setFieldValue(EXCLUSIONCOSTS_PROP.get(), value);
  }
   ...
   */
  public void setExclusions(entity.GL7ExpSchedCondItemExcl[] value) {
   ...
   */
  private void setFixed(entity.GL7ExposureSchedCondItem value) {
  ...
  public void setLongStringCol1(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(LONGSTRINGCOL1_PROP.get(), value);
  }
  ...
  public void setLongStringCol2(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(LONGSTRINGCOL2_PROP.get(), value);
  }
  ...
  public void setLongStringCol3(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(LONGSTRINGCOL3_PROP.get(), value);
  }
  ...
  public void setLongStringCol4(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(LONGSTRINGCOL4_PROP.get(), value);
  }
  ...
  public void setLongStringCol5(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(LONGSTRINGCOL5_PROP.get(), value);
  }
  ...
  public void setOptionCol1(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(OPTIONCOL1_PROP.get(), value);
  }
  ...
  public void setOptionCol2(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(OPTIONCOL2_PROP.get(), value);
  }
  ...
  public void setOptionCol3(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(OPTIONCOL3_PROP.get(), value);
  }
   ...
   */
  public void setScheduleCondition(entity.GL7ExposureSchedCond value) {
    __getInternalInterface().setFieldValue(SCHEDULECONDITION_PROP.get(), value);
  }
  
  /**
   * Sets the value of the ScheduleItemCosts field.
   */
  public void setScheduleItemCosts(entity.GL7ExpSchedCondItemCost[] value) {
    __getInternalInterface().setFieldValue(SCHEDULEITEMCOSTS_PROP.get(), value);
  }
  ...
  public void setStringCol5(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(STRINGCOL5_PROP.get(), value);
  }
  ...
  public void setStringCol6(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(STRINGCOL6_PROP.get(), value);
  }
  ...
  public void setStringCol7(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(STRINGCOL7_PROP.get(), value);
  }
  
  /**
   * Sets the value of the Subtype field.
   */
  private void setSubtype(typekey.GL7ExposureSchedCondItem value) {
  ...
  public entity.GL7ExposureSchedCondItem split(java.util.Date splitDate) {
    return (entity.GL7ExposureSchedCondItem)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExposureSchedCondItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExposureSchedCondItem.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getAdditionalInsuredID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(ADDITIONALINSURED_PROP.get());
    }
    ...
    /**
     * Gets the value of the DateCol2 field.
     * Date Field
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public java.util.Date getDateCol2() {
    ...
    public gw.pl.persistence.core.Key getScheduleConditionID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SCHEDULECONDITION_PROP.get());
    }
    ...
    public void setAdditionalInsuredID(gw.pl.persistence.core.Key value) {
      setFieldValue(ADDITIONALINSURED_PROP.get(), value);
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.GL7ExposureSchedCondItem value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the DateCol2 field.
     */
    public void setDateCol2(java.util.Date value) {
      __getInternalInterface().setFieldValue(DATECOL2_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.GL7ExposureSchedCondItem value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
    ...
    public void setScheduleConditionID(gw.pl.persistence.core.Key value) {
      setFieldValue(SCHEDULECONDITION_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.GL7ExposureSchedCondItem value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.gl7.schedules.GL7ExposureSchedCondItemAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.gl7.schedules.GL7ExposureSchedCondItemAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7ExposureSchedCondItemMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7ExposureSchedCondItemMatcher");
    config.put("gw.api.productmodel.ScheduledItemAdapter", "gw.lob.gl7.schedules.GL7ExposureSchedCondItemAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExposureSchedCondItem.class, config);
    com.guidewire._generated.entity.GL7ExposureSchedCondItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExposureSchedCondItem, com.guidewire._generated.entity.GL7ExposureSchedCondItemInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExposureSchedCondItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExposureSchedCondItemInternal getInternalInterface(entity.GL7ExposureSchedCondItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExposureSchedCondItem newEmptyInstance() {
        return new entity.GL7ExposureSchedCondItem((java.lang.Void)null);
      }

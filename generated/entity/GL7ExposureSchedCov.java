...
/**
 * GL7ExposureSchedCov
 * GL7Exposure Coverage with a schedule
 */
...
@gw.entity.EntityName(value = "GL7ExposureSchedCov")
public class GL7ExposureSchedCov extends entity.GL7ExposureCov implements entity.ScheduleAutoNumberSequence, gw.api.copier.EffDatedCopyable, gw.api.domain.Schedule, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExposureSchedCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExposureSchedCov, entity.PolicyPeriod>("entity.GL7ExposureSchedCov");
   ...
   */
  protected GL7ExposureSchedCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7ExposureSchedCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExposureSchedCov(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7ExposureSchedCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExposureSchedCovInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7ExposureSchedCovInternal)super.__getInternalInterface();
  }
   ...
   */
  public void addToGL7ScheduledItems(entity.GL7ExposureSchedCovItem element) {
  ...
  public entity.GL7ExposureSchedCov clone() {
    return (entity.GL7ExposureSchedCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7ExposureSchedCov getBasedOn() {
    return (entity.GL7ExposureSchedCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExposureSchedCovItem[] getGL7ScheduledItems() {
    return (entity.GL7ExposureSchedCovItem[])__getInternalInterface().getFieldValue(GL7SCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.GL7ExposureSchedCov getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExposureSchedCov)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7ExposureSchedCov getUnsliced() {
    return (entity.GL7ExposureSchedCov)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7ExposureSchedCovVersionList getVersionList() {
    return (entity.windowed.GL7ExposureSchedCovVersionList)getVersionListUntyped();
  }
   ...
   */
  public void removeFromGL7ScheduledItems(entity.GL7ExposureSchedCovItem element) {
   ...
   */
  public void setGL7ScheduledItems(entity.GL7ExposureSchedCovItem[] value) {
  ...
  public entity.GL7ExposureSchedCov split(java.util.Date splitDate) {
    return (entity.GL7ExposureSchedCov)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExposureSchedCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExposureSchedCov.this.__getDelegateManager();
    }
    ...
    public entity.GL7ExposureCov getBasedOnValue() {
      return (entity.GL7ExposureCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public entity.GL7ExposureCovCost[] getCosts() {
      return (entity.GL7ExposureCovCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
    }
    ...
    public entity.GL7ExposureCov getFixed() {
      return (entity.GL7ExposureCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public typekey.GL7ExposureCov getSubtype() {
      return (typekey.GL7ExposureCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.GL7ExposureCovCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.GL7ExposureCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.gl7.GL7ExposureCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.gl7.GL7ExposureCovCoverageAdapter");
    config.put("gw.api.domain.Schedule", "gw.lob.gl7.schedules.GL7ExposureSchedCovImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7ExposureSchedCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7ExposureSchedCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExposureSchedCov.class, config);
    com.guidewire._generated.entity.GL7ExposureSchedCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExposureSchedCov, com.guidewire._generated.entity.GL7ExposureSchedCovInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExposureSchedCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExposureSchedCovInternal getInternalInterface(entity.GL7ExposureSchedCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExposureSchedCov newEmptyInstance() {
        return new entity.GL7ExposureSchedCov((java.lang.Void)null);
      }

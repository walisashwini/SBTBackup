...
/**
 * GL7ExposureSchedExcl
 * GL7Exposure Exclusion with a schedule
 */
...
@gw.entity.EntityName(value = "GL7ExposureSchedExcl")
public class GL7ExposureSchedExcl extends entity.GL7ExposureExcl implements entity.ScheduleAutoNumberSequence, gw.api.copier.EffDatedCopyable, gw.api.domain.Schedule, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7ExposureSchedExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7ExposureSchedExcl, entity.PolicyPeriod>("entity.GL7ExposureSchedExcl");
   ...
   */
  protected GL7ExposureSchedExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7ExposureSchedExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7ExposureSchedExcl(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7ExposureSchedExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ExposureSchedExclInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7ExposureSchedExclInternal)super.__getInternalInterface();
  }
  ...
  public entity.GL7ExposureSchedExcl clone() {
    return (entity.GL7ExposureSchedExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7ExposureSchedExcl getBasedOn() {
    return (entity.GL7ExposureSchedExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7ExposureSchedExclItem[] getGL7ScheduledItems() {
    return (entity.GL7ExposureSchedExclItem[])__getInternalInterface().getFieldValue(GL7SCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.GL7ExposureSchedExcl getSlice(java.util.Date sliceDate) {
    return (entity.GL7ExposureSchedExcl)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7ExposureSchedExcl getUnsliced() {
    return (entity.GL7ExposureSchedExcl)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7ExposureSchedExclVersionList getVersionList() {
    return (entity.windowed.GL7ExposureSchedExclVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7ExposureSchedExcl split(java.util.Date splitDate) {
    return (entity.GL7ExposureSchedExcl)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ExposureSchedExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ExposureSchedExcl.this.__getDelegateManager();
    }
    ...
    public entity.GL7ExposureExcl getBasedOnValue() {
      return (entity.GL7ExposureExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public entity.GL7ExposureExclCost[] getCosts() {
      return (entity.GL7ExposureExclCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
    }
    ...
    public entity.GL7ExposureExcl getFixed() {
      return (entity.GL7ExposureExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public typekey.GL7ExposureExcl getSubtype() {
      return (typekey.GL7ExposureExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.GL7ExposureExclExclusionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.GL7ExposureExclExclusionAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.gl7.GL7ExposureExclExclusionAdapter");
    config.put("gw.api.domain.Schedule", "gw.lob.gl7.schedules.GL7ExposureSchedExclImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7ExposureSchedExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7ExposureSchedExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ExposureSchedExcl.class, config);
    com.guidewire._generated.entity.GL7ExposureSchedExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ExposureSchedExcl, com.guidewire._generated.entity.GL7ExposureSchedExclInternal>() {
      public java.lang.Object getImplementation(entity.GL7ExposureSchedExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ExposureSchedExclInternal getInternalInterface(entity.GL7ExposureSchedExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ExposureSchedExcl newEmptyInstance() {
        return new entity.GL7ExposureSchedExcl((java.lang.Void)null);
      }

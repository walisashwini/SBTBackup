...
/**
 * GL7FinalPremOpsIncrdLimit
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7FinalPremOpsIncrdLimit.eti;GL7FinalPremOpsIncrdLimit.eix;GL7FinalPremOpsIncrdLimit.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7FinalPremOpsIncrdLimit")
public class GL7FinalPremOpsIncrdLimit extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7FinalPremOpsIncrdLimit> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7FinalPremOpsIncrdLimit>("entity.GL7FinalPremOpsIncrdLimit");
  ...
  private com.guidewire._generated.entity.GL7FinalPremOpsIncrdLimitInternal _internal;
   ...
   */
  public GL7FinalPremOpsIncrdLimit()  {
   ...
   */
  public GL7FinalPremOpsIncrdLimit(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7FinalPremOpsIncrdLimit(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7FinalPremOpsIncrdLimitInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7FinalPremOpsIncrdLimitInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   * IncreasedLimitsTableAssignmentPremOpsOverride
   */
  @gw.internal.gosu.parser.ExtendedProperty
   ...
   * IncreasedLimitsTableAssignmentPremOps
   */
  @gw.internal.gosu.parser.ExtendedProperty
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7FinalPremOpsIncrdLimitInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7FinalPremOpsIncrdLimit.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7FinalPremOpsIncrdLimit.class, config);
    com.guidewire._generated.entity.GL7FinalPremOpsIncrdLimitInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7FinalPremOpsIncrdLimit, com.guidewire._generated.entity.GL7FinalPremOpsIncrdLimitInternal>() {
      public java.lang.Object getImplementation(entity.GL7FinalPremOpsIncrdLimit bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7FinalPremOpsIncrdLimitInternal getInternalInterface(entity.GL7FinalPremOpsIncrdLimit bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7FinalPremOpsIncrdLimit newEmptyInstance() {
        return new entity.GL7FinalPremOpsIncrdLimit((java.lang.Void)null);
      }

...
/**
 * GL7FinalProdsCompldOpsInc
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7FinalProdsCompldOpsInc.eti;GL7FinalProdsCompldOpsInc.eix;GL7FinalProdsCompldOpsInc.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7FinalProdsCompldOpsInc")
public class GL7FinalProdsCompldOpsInc extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7FinalProdsCompldOpsInc> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7FinalProdsCompldOpsInc>("entity.GL7FinalProdsCompldOpsInc");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> INCREASEDLMTSTABLEASSIGNMENTP1_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "IncreasedLmtsTableAssignmentP1");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> INCREASEDLMTSTABLEASSIGNMENTPR_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "IncreasedLmtsTableAssignmentPr");
  ...
  private com.guidewire._generated.entity.GL7FinalProdsCompldOpsIncInternal _internal;
   ...
   */
  public GL7FinalProdsCompldOpsInc()  {
   ...
   */
  public GL7FinalProdsCompldOpsInc(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7FinalProdsCompldOpsInc(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7FinalProdsCompldOpsIncInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7FinalProdsCompldOpsIncInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Gets the value of the IncreasedLmtsTableAssignmentP1 field.
   * IncreasedLimitsTableAssignmentProdsCompldOpsOverride
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getIncreasedLmtsTableAssignmentP1() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(INCREASEDLMTSTABLEASSIGNMENTP1_PROP.get());
  }
  
  /**
   * Gets the value of the IncreasedLmtsTableAssignmentPr field.
   * IncreasedLimitsTableAssignmentProdsCompldOps
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getIncreasedLmtsTableAssignmentPr() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(INCREASEDLMTSTABLEASSIGNMENTPR_PROP.get());
  }
  ...
  /**
   * Sets the value of the IncreasedLmtsTableAssignmentP1 field.
   */
  public void setIncreasedLmtsTableAssignmentP1(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(INCREASEDLMTSTABLEASSIGNMENTP1_PROP.get(), value);
  }
  ...
  public void setIncreasedLmtsTableAssignmentPr(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(INCREASEDLMTSTABLEASSIGNMENTPR_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7FinalProdsCompldOpsIncInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7FinalProdsCompldOpsInc.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7FinalProdsCompldOpsInc.class, config);
    com.guidewire._generated.entity.GL7FinalProdsCompldOpsIncInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7FinalProdsCompldOpsInc, com.guidewire._generated.entity.GL7FinalProdsCompldOpsIncInternal>() {
      public java.lang.Object getImplementation(entity.GL7FinalProdsCompldOpsInc bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7FinalProdsCompldOpsIncInternal getInternalInterface(entity.GL7FinalProdsCompldOpsInc bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7FinalProdsCompldOpsInc newEmptyInstance() {
        return new entity.GL7FinalProdsCompldOpsInc((java.lang.Void)null);
      }

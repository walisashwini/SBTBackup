...
/**
 * GL7GeneralAggregateLimit
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7GeneralAggregateLimit.eti;GL7GeneralAggregateLimit.eix;GL7GeneralAggregateLimit.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7GeneralAggregateLimit")
public class GL7GeneralAggregateLimit extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7GeneralAggregateLimit> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7GeneralAggregateLimit>("entity.GL7GeneralAggregateLimit");
  ...
  private com.guidewire._generated.entity.GL7GeneralAggregateLimitInternal _internal;
   ...
   */
  public GL7GeneralAggregateLimit()  {
   ...
   */
  public GL7GeneralAggregateLimit(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7GeneralAggregateLimit(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7GeneralAggregateLimitInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7GeneralAggregateLimitInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7GeneralAggregateLimitInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7GeneralAggregateLimit.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7GeneralAggregateLimit.class, config);
    com.guidewire._generated.entity.GL7GeneralAggregateLimitInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7GeneralAggregateLimit, com.guidewire._generated.entity.GL7GeneralAggregateLimitInternal>() {
      public java.lang.Object getImplementation(entity.GL7GeneralAggregateLimit bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7GeneralAggregateLimitInternal getInternalInterface(entity.GL7GeneralAggregateLimit bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7GeneralAggregateLimit newEmptyInstance() {
        return new entity.GL7GeneralAggregateLimit((java.lang.Void)null);
      }

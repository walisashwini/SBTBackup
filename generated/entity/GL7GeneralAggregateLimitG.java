...
/**
 * GL7GeneralAggregateLimitG
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7GeneralAggregateLimitG.eti;GL7GeneralAggregateLimitG.eix;GL7GeneralAggregateLimitG.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7GeneralAggregateLimitG")
public class GL7GeneralAggregateLimitG extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7GeneralAggregateLimitG> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7GeneralAggregateLimitG>("entity.GL7GeneralAggregateLimitG");
  ...
  private com.guidewire._generated.entity.GL7GeneralAggregateLimitGInternal _internal;
   ...
   */
  public GL7GeneralAggregateLimitG()  {
   ...
   */
  public GL7GeneralAggregateLimitG(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7GeneralAggregateLimitG(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7GeneralAggregateLimitGInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7GeneralAggregateLimitGInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7GeneralAggregateLimitGInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7GeneralAggregateLimitG.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7GeneralAggregateLimitG.class, config);
    com.guidewire._generated.entity.GL7GeneralAggregateLimitGInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7GeneralAggregateLimitG, com.guidewire._generated.entity.GL7GeneralAggregateLimitGInternal>() {
      public java.lang.Object getImplementation(entity.GL7GeneralAggregateLimitG bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7GeneralAggregateLimitGInternal getInternalInterface(entity.GL7GeneralAggregateLimitG bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7GeneralAggregateLimitG newEmptyInstance() {
        return new entity.GL7GeneralAggregateLimitG((java.lang.Void)null);
      }

...
/**
 * GL7GovernmentalSubdivisio
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7GovernmentalSubdivisio.eti;GL7GovernmentalSubdivisio.eix;GL7GovernmentalSubdivisio.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7GovernmentalSubdivisio")
public class GL7GovernmentalSubdivisio extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7GovernmentalSubdivisio> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7GovernmentalSubdivisio>("entity.GL7GovernmentalSubdivisio");
  ...
  private com.guidewire._generated.entity.GL7GovernmentalSubdivisioInternal _internal;
   ...
   */
  public GL7GovernmentalSubdivisio()  {
   ...
   */
  public GL7GovernmentalSubdivisio(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7GovernmentalSubdivisio(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7GovernmentalSubdivisioInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7GovernmentalSubdivisioInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7GovernmentalSubdivisioInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7GovernmentalSubdivisio.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7GovernmentalSubdivisio.class, config);
    com.guidewire._generated.entity.GL7GovernmentalSubdivisioInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7GovernmentalSubdivisio, com.guidewire._generated.entity.GL7GovernmentalSubdivisioInternal>() {
      public java.lang.Object getImplementation(entity.GL7GovernmentalSubdivisio bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7GovernmentalSubdivisioInternal getInternalInterface(entity.GL7GovernmentalSubdivisio bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7GovernmentalSubdivisio newEmptyInstance() {
        return new entity.GL7GovernmentalSubdivisio((java.lang.Void)null);
      }

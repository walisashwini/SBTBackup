...
@gw.entity.EntityName(value = "GL7GovernmentalUnitsPremi")
public class GL7GovernmentalUnitsPremi extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7GovernmentalUnitsPremi> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7GovernmentalUnitsPremi>("entity.GL7GovernmentalUnitsPremi");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> GENERALAGGLIMGOVSUBDIVISION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "GeneralAggLimGovSubdivision");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PERPERSONLIM_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PerPersonLim");
  ...
  private com.guidewire._generated.entity.GL7GovernmentalUnitsPremiInternal _internal;
   ...
   */
  public GL7GovernmentalUnitsPremi()  {
   ...
   */
  public GL7GovernmentalUnitsPremi(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7GovernmentalUnitsPremi(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7GovernmentalUnitsPremiInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7GovernmentalUnitsPremiInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.String getGeneralAggLimGovSubdivision() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(GENERALAGGLIMGOVSUBDIVISION_PROP.get());
  }
  ...
  public java.lang.String getPerPersonLim() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(PERPERSONLIM_PROP.get());
  }
  ...
  public java.math.BigDecimal getValue() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(VALUE_PROP.get());
  }
  ...
  public void setGeneralAggLimGovSubdivision(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(GENERALAGGLIMGOVSUBDIVISION_PROP.get(), value);
  }
  ...
  public void setPerPersonLim(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(PERPERSONLIM_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7GovernmentalUnitsPremiInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7GovernmentalUnitsPremi.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7GovernmentalUnitsPremi.class, config);
    com.guidewire._generated.entity.GL7GovernmentalUnitsPremiInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7GovernmentalUnitsPremi, com.guidewire._generated.entity.GL7GovernmentalUnitsPremiInternal>() {
      public java.lang.Object getImplementation(entity.GL7GovernmentalUnitsPremi bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7GovernmentalUnitsPremiInternal getInternalInterface(entity.GL7GovernmentalUnitsPremi bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7GovernmentalUnitsPremi newEmptyInstance() {
        return new entity.GL7GovernmentalUnitsPremi((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "GL7ILFLiquorRT")
public class GL7ILFLiquorRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ILFLiquorRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ILFLiquorRT>("entity.GL7ILFLiquorRT");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> AGGLIMLIQUOR_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AggLimLiquor");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> EACHCOMMONCAUSELIM_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "EachCommonCauseLim");
  ...
  private com.guidewire._generated.entity.GL7ILFLiquorRTInternal _internal;
   ...
   */
  public GL7ILFLiquorRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ILFLiquorRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ILFLiquorRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ILFLiquorRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.String getAggLimLiquor() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(AGGLIMLIQUOR_PROP.get());
  }
  ...
  public java.lang.String getEachCommonCauseLim() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(EACHCOMMONCAUSELIM_PROP.get());
  }
  ...
  public void setAggLimLiquor(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(AGGLIMLIQUOR_PROP.get(), value);
  }
  ...
  public void setEachCommonCauseLim(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(EACHCOMMONCAUSELIM_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ILFLiquorRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ILFLiquorRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ILFLiquorRT.class, config);
    com.guidewire._generated.entity.GL7ILFLiquorRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ILFLiquorRT, com.guidewire._generated.entity.GL7ILFLiquorRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7ILFLiquorRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ILFLiquorRTInternal getInternalInterface(entity.GL7ILFLiquorRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ILFLiquorRT newEmptyInstance() {
        return new entity.GL7ILFLiquorRT((java.lang.Void)null);
      }

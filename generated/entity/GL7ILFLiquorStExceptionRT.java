...
@gw.entity.EntityName(value = "GL7ILFLiquorStExceptionRT")
public class GL7ILFLiquorStExceptionRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ILFLiquorStExceptionRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ILFLiquorStExceptionRT>("entity.GL7ILFLiquorStExceptionRT");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> AGGLIMLIQUORLIAB_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AggLimLiquorLiab");
  ...
  private com.guidewire._generated.entity.GL7ILFLiquorStExceptionRTInternal _internal;
   ...
   */
  public GL7ILFLiquorStExceptionRT()  {
   ...
   */
  public GL7ILFLiquorStExceptionRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ILFLiquorStExceptionRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ILFLiquorStExceptionRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ILFLiquorStExceptionRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.String getAggLimLiquorLiab() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(AGGLIMLIQUORLIAB_PROP.get());
  }
  ...
  public void setAggLimLiquorLiab(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(AGGLIMLIQUORLIAB_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ILFLiquorStExceptionRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ILFLiquorStExceptionRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ILFLiquorStExceptionRT.class, config);
    com.guidewire._generated.entity.GL7ILFLiquorStExceptionRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ILFLiquorStExceptionRT, com.guidewire._generated.entity.GL7ILFLiquorStExceptionRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7ILFLiquorStExceptionRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ILFLiquorStExceptionRTInternal getInternalInterface(entity.GL7ILFLiquorStExceptionRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ILFLiquorStExceptionRT newEmptyInstance() {
        return new entity.GL7ILFLiquorStExceptionRT((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "GL7ILFProdsRT")
public class GL7ILFProdsRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ILFProdsRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ILFProdsRT>("entity.GL7ILFProdsRT");
  ...
  private com.guidewire._generated.entity.GL7ILFProdsRTInternal _internal;
   ...
   */
  public GL7ILFProdsRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ILFProdsRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ILFProdsRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ILFProdsRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ILFProdsRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ILFProdsRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ILFProdsRT.class, config);
    com.guidewire._generated.entity.GL7ILFProdsRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ILFProdsRT, com.guidewire._generated.entity.GL7ILFProdsRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7ILFProdsRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ILFProdsRTInternal getInternalInterface(entity.GL7ILFProdsRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ILFProdsRT newEmptyInstance() {
        return new entity.GL7ILFProdsRT((java.lang.Void)null);
      }

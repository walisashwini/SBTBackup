...
/**
 * GL7IncreasedLimitsTableA8
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7IncreasedLimitsTableA8.eti;GL7IncreasedLimitsTableA8.eix;GL7IncreasedLimitsTableA8.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7IncreasedLimitsTableA8")
public class GL7IncreasedLimitsTableA8 extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7IncreasedLimitsTableA8> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7IncreasedLimitsTableA8>("entity.GL7IncreasedLimitsTableA8");
  ...
  private com.guidewire._generated.entity.GL7IncreasedLimitsTableA8Internal _internal;
   ...
   */
  public GL7IncreasedLimitsTableA8()  {
   ...
   */
  public GL7IncreasedLimitsTableA8(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7IncreasedLimitsTableA8(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7IncreasedLimitsTableA8Internal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7IncreasedLimitsTableA8Internal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7IncreasedLimitsTableA8Internal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7IncreasedLimitsTableA8.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7IncreasedLimitsTableA8.class, config);
    com.guidewire._generated.entity.GL7IncreasedLimitsTableA8InternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7IncreasedLimitsTableA8, com.guidewire._generated.entity.GL7IncreasedLimitsTableA8Internal>() {
      public java.lang.Object getImplementation(entity.GL7IncreasedLimitsTableA8 bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7IncreasedLimitsTableA8Internal getInternalInterface(entity.GL7IncreasedLimitsTableA8 bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7IncreasedLimitsTableA8 newEmptyInstance() {
        return new entity.GL7IncreasedLimitsTableA8((java.lang.Void)null);
      }

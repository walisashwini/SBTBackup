...
/**
 * GL7IncreasedLimitsTableA9
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7IncreasedLimitsTableA9.eti;GL7IncreasedLimitsTableA9.eix;GL7IncreasedLimitsTableA9.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7IncreasedLimitsTableA9")
public class GL7IncreasedLimitsTableA9 extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7IncreasedLimitsTableA9> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7IncreasedLimitsTableA9>("entity.GL7IncreasedLimitsTableA9");
  ...
  private com.guidewire._generated.entity.GL7IncreasedLimitsTableA9Internal _internal;
   ...
   */
  public GL7IncreasedLimitsTableA9()  {
   ...
   */
  public GL7IncreasedLimitsTableA9(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7IncreasedLimitsTableA9(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7IncreasedLimitsTableA9Internal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7IncreasedLimitsTableA9Internal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7IncreasedLimitsTableA9Internal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7IncreasedLimitsTableA9.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7IncreasedLimitsTableA9.class, config);
    com.guidewire._generated.entity.GL7IncreasedLimitsTableA9InternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7IncreasedLimitsTableA9, com.guidewire._generated.entity.GL7IncreasedLimitsTableA9Internal>() {
      public java.lang.Object getImplementation(entity.GL7IncreasedLimitsTableA9 bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7IncreasedLimitsTableA9Internal getInternalInterface(entity.GL7IncreasedLimitsTableA9 bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7IncreasedLimitsTableA9 newEmptyInstance() {
        return new entity.GL7IncreasedLimitsTableA9((java.lang.Void)null);
      }

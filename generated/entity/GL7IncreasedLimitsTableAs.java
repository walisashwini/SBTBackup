...
/**
 * GL7IncreasedLimitsTableAs
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7IncreasedLimitsTableAs.eti;GL7IncreasedLimitsTableAs.eix;GL7IncreasedLimitsTableAs.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7IncreasedLimitsTableAs")
public class GL7IncreasedLimitsTableAs extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7IncreasedLimitsTableAs> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7IncreasedLimitsTableAs>("entity.GL7IncreasedLimitsTableAs");
  ...
  private com.guidewire._generated.entity.GL7IncreasedLimitsTableAsInternal _internal;
   ...
   */
  public GL7IncreasedLimitsTableAs()  {
   ...
   */
  public GL7IncreasedLimitsTableAs(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7IncreasedLimitsTableAs(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7IncreasedLimitsTableAsInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7IncreasedLimitsTableAsInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7IncreasedLimitsTableAsInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7IncreasedLimitsTableAs.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7IncreasedLimitsTableAs.class, config);
    com.guidewire._generated.entity.GL7IncreasedLimitsTableAsInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7IncreasedLimitsTableAs, com.guidewire._generated.entity.GL7IncreasedLimitsTableAsInternal>() {
      public java.lang.Object getImplementation(entity.GL7IncreasedLimitsTableAs bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7IncreasedLimitsTableAsInternal getInternalInterface(entity.GL7IncreasedLimitsTableAs bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7IncreasedLimitsTableAs newEmptyInstance() {
        return new entity.GL7IncreasedLimitsTableAs((java.lang.Void)null);
      }

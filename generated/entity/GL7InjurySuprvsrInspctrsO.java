...
/**
 * GL7InjurySuprvsrInspctrsO
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7InjurySuprvsrInspctrsO.eti;GL7InjurySuprvsrInspctrsO.eix;GL7InjurySuprvsrInspctrsO.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7InjurySuprvsrInspctrsO")
public class GL7InjurySuprvsrInspctrsO extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7InjurySuprvsrInspctrsO> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7InjurySuprvsrInspctrsO>("entity.GL7InjurySuprvsrInspctrsO");
  ...
  private com.guidewire._generated.entity.GL7InjurySuprvsrInspctrsOInternal _internal;
   ...
   */
  public GL7InjurySuprvsrInspctrsO()  {
   ...
   */
  public GL7InjurySuprvsrInspctrsO(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7InjurySuprvsrInspctrsO(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7InjurySuprvsrInspctrsOInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7InjurySuprvsrInspctrsOInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7InjurySuprvsrInspctrsOInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7InjurySuprvsrInspctrsO.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7InjurySuprvsrInspctrsO.class, config);
    com.guidewire._generated.entity.GL7InjurySuprvsrInspctrsOInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7InjurySuprvsrInspctrsO, com.guidewire._generated.entity.GL7InjurySuprvsrInspctrsOInternal>() {
      public java.lang.Object getImplementation(entity.GL7InjurySuprvsrInspctrsO bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7InjurySuprvsrInspctrsOInternal getInternalInterface(entity.GL7InjurySuprvsrInspctrsO bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7InjurySuprvsrInspctrsO newEmptyInstance() {
        return new entity.GL7InjurySuprvsrInspctrsO((java.lang.Void)null);
      }

 ...
 * GL7LegalEntity
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7LegalEntity.eti;GL7LegalEntity.eix;GL7LegalEntity.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7LegalEntity")
public class GL7LegalEntity extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7LegalEntity> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7LegalEntity>("entity.GL7LegalEntity");
  ...
  private com.guidewire._generated.entity.GL7LegalEntityInternal _internal;
   ...
   */
  public GL7LegalEntity(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7LegalEntity(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7LegalEntityInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LegalEntityInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LegalEntityInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LegalEntity.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LegalEntity.class, config);
    com.guidewire._generated.entity.GL7LegalEntityInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LegalEntity, com.guidewire._generated.entity.GL7LegalEntityInternal>() {
      public java.lang.Object getImplementation(entity.GL7LegalEntity bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LegalEntityInternal getInternalInterface(entity.GL7LegalEntity bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LegalEntity newEmptyInstance() {
        return new entity.GL7LegalEntity((java.lang.Void)null);
      }

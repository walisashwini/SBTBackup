...
@gw.entity.EntityName(value = "GL7LimitNumericRT")
public class GL7LimitNumericRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7LimitNumericRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7LimitNumericRT>("entity.GL7LimitNumericRT");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LIM_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Lim");
  ...
  private com.guidewire._generated.entity.GL7LimitNumericRTInternal _internal;
   ...
   */
  public GL7LimitNumericRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7LimitNumericRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7LimitNumericRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LimitNumericRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.String getLim() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(LIM_PROP.get());
  }
  ...
  public void setLim(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(LIM_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LimitNumericRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LimitNumericRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LimitNumericRT.class, config);
    com.guidewire._generated.entity.GL7LimitNumericRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LimitNumericRT, com.guidewire._generated.entity.GL7LimitNumericRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7LimitNumericRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LimitNumericRTInternal getInternalInterface(entity.GL7LimitNumericRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LimitNumericRT newEmptyInstance() {
        return new entity.GL7LimitNumericRT((java.lang.Void)null);
      }

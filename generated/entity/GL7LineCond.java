...
/**
 * GL7LineCond
 * Conditions for the General Liability Line
 */
...
@gw.entity.EntityName(value = "GL7LineCond")
public class GL7LineCond extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PolicyCondition, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LineCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LineCond, entity.PolicyPeriod>("entity.GL7LineCond");
  ...
  private com.guidewire._generated.entity.GL7LineCondInternal _internal;
   ...
   */
  protected GL7LineCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7LineCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7LineCond(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7LineCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LineCondInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7LineCond clone() {
    return (entity.GL7LineCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7LineCond getBasedOn() {
    return (entity.GL7LineCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LineCond getSlice(java.util.Date sliceDate) {
    return (entity.GL7LineCond)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7LineCond getUnsliced() {
    return (entity.GL7LineCond)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7LineCondVersionList getVersionList() {
    return (entity.windowed.GL7LineCondVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7LineCond value) {
   ...
   */
  private void setFixed(entity.GL7LineCond value) {
   ...
   */
  private void setSubtype(typekey.GL7LineCond value) {
  ...
  public entity.GL7LineCond split(java.util.Date splitDate) {
    return (entity.GL7LineCond)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LineCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LineCond.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.GL7LineCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.GL7LineCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LineCond.class, config);
    com.guidewire._generated.entity.GL7LineCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LineCond, com.guidewire._generated.entity.GL7LineCondInternal>() {
      public java.lang.Object getImplementation(entity.GL7LineCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LineCondInternal getInternalInterface(entity.GL7LineCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LineCond newEmptyInstance() {
        return new entity.GL7LineCond((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "GL7LineCondCost")
public class GL7LineCondCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LineCondCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LineCondCost, entity.PolicyPeriod>("entity.GL7LineCondCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> LINECONDITION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "LineCondition");
   ...
   */
  public GL7LineCondCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LineCondCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LineCondCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LineCondCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LineCondCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LineCondCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7LineCondCost clone() {
    return (entity.GL7LineCondCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7LineCondCost getBasedOn() {
    return (entity.GL7LineCondCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LineCond getLineCondition() {
    return (entity.GL7LineCond)__getInternalInterface().getFieldValue(LINECONDITION_PROP.get());
  }
  
  public entity.GL7LineCondCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7LineCondCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LineCondCost getUnsliced() {
    return (entity.GL7LineCondCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LineCondCostVersionList getVersionList() {
    return (entity.windowed.GL7LineCondCostVersionList)getVersionListUntyped();
  }
  ...
  public void setLineCondition(entity.GL7LineCond value) {
    __getInternalInterface().setFieldValue(LINECONDITION_PROP.get(), value);
  }
  
  public entity.GL7LineCondCost split(java.util.Date splitDate) {
    return (entity.GL7LineCondCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LineCondCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LineCondCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getLineConditionID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(LINECONDITION_PROP.get());
    }
    ...
    public void setLineConditionID(gw.pl.persistence.core.Key value) {
      setFieldValue(LINECONDITION_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7LineCondCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LineCondCost.class, config);
    com.guidewire._generated.entity.GL7LineCondCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LineCondCost, com.guidewire._generated.entity.GL7LineCondCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7LineCondCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LineCondCostInternal getInternalInterface(entity.GL7LineCondCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LineCondCost newEmptyInstance() {
        return new entity.GL7LineCondCost((java.lang.Void)null);
      }

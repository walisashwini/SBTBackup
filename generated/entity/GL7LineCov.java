...
/**
 * GL7LineCov
 * Coverages for the General Liability Line
 */
...
@gw.entity.EntityName(value = "GL7LineCov")
public class GL7LineCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LineCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LineCov, entity.PolicyPeriod>("entity.GL7LineCov");
  ...
  private com.guidewire._generated.entity.GL7LineCovInternal _internal;
   ...
   */
  protected GL7LineCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7LineCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7LineCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7LineCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LineCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7LineCov clone() {
    return (entity.GL7LineCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7LineCov getBasedOn() {
    return (entity.GL7LineCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LineCov getSlice(java.util.Date sliceDate) {
    return (entity.GL7LineCov)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7LineCov getUnsliced() {
    return (entity.GL7LineCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7LineCovVersionList getVersionList() {
    return (entity.windowed.GL7LineCovVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7LineCov value) {
   ...
   */
  private void setFixed(entity.GL7LineCov value) {
   ...
   */
  private void setSubtype(typekey.GL7LineCov value) {
  ...
  public entity.GL7LineCov split(java.util.Date splitDate) {
    return (entity.GL7LineCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LineCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LineCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.GL7LineCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.GL7LineCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LineCov.class, config);
    com.guidewire._generated.entity.GL7LineCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LineCov, com.guidewire._generated.entity.GL7LineCovInternal>() {
      public java.lang.Object getImplementation(entity.GL7LineCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LineCovInternal getInternalInterface(entity.GL7LineCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LineCov newEmptyInstance() {
        return new entity.GL7LineCov((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "GL7LineCovCost")
public class GL7LineCovCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LineCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LineCovCost, entity.PolicyPeriod>("entity.GL7LineCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> LINECOVERAGE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "LineCoverage");
   ...
   */
  public GL7LineCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LineCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LineCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LineCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LineCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LineCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7LineCovCost clone() {
    return (entity.GL7LineCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7LineCovCost getBasedOn() {
    return (entity.GL7LineCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LineCov getLineCoverage() {
    return (entity.GL7LineCov)__getInternalInterface().getFieldValue(LINECOVERAGE_PROP.get());
  }
  
  public entity.GL7LineCovCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7LineCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LineCovCost getUnsliced() {
    return (entity.GL7LineCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LineCovCostVersionList getVersionList() {
    return (entity.windowed.GL7LineCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setLineCoverage(entity.GL7LineCov value) {
    __getInternalInterface().setFieldValue(LINECOVERAGE_PROP.get(), value);
  }
  
  public entity.GL7LineCovCost split(java.util.Date splitDate) {
    return (entity.GL7LineCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LineCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LineCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getLineCoverageID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(LINECOVERAGE_PROP.get());
    }
    ...
    public void setLineCoverageID(gw.pl.persistence.core.Key value) {
      setFieldValue(LINECOVERAGE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7LineCovCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LineCovCost.class, config);
    com.guidewire._generated.entity.GL7LineCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LineCovCost, com.guidewire._generated.entity.GL7LineCovCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7LineCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LineCovCostInternal getInternalInterface(entity.GL7LineCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LineCovCost newEmptyInstance() {
        return new entity.GL7LineCovCost((java.lang.Void)null);
      }

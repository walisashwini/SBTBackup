...
/**
 * GL7LineExcl
 * Exclusions for the General Liability Line
 */
...
@gw.entity.EntityName(value = "GL7LineExcl")
public class GL7LineExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LineExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LineExcl, entity.PolicyPeriod>("entity.GL7LineExcl");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GL7LINE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GL7Line");
  ...
  private com.guidewire._generated.entity.GL7LineExclInternal _internal;
   ...
   */
  protected GL7LineExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7LineExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7LineExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7LineExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LineExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7LineExcl clone() {
    return (entity.GL7LineExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7LineExcl getBasedOn() {
    return (entity.GL7LineExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LineExcl getSlice(java.util.Date sliceDate) {
    return (entity.GL7LineExcl)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7LineExcl getUnsliced() {
    return (entity.GL7LineExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7LineExclVersionList getVersionList() {
    return (entity.windowed.GL7LineExclVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7LineExcl value) {
   ...
   */
  private void setFixed(entity.GL7LineExcl value) {
   ...
   */
  private void setSubtype(typekey.GL7LineExcl value) {
  ...
  public entity.GL7LineExcl split(java.util.Date splitDate) {
    return (entity.GL7LineExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LineExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LineExcl.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.GL7LineExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.GL7LineExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LineExcl.class, config);
    com.guidewire._generated.entity.GL7LineExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LineExcl, com.guidewire._generated.entity.GL7LineExclInternal>() {
      public java.lang.Object getImplementation(entity.GL7LineExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LineExclInternal getInternalInterface(entity.GL7LineExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LineExcl newEmptyInstance() {
        return new entity.GL7LineExcl((java.lang.Void)null);
      }

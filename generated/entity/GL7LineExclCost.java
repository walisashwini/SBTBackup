...
@gw.entity.EntityName(value = "GL7LineExclCost")
public class GL7LineExclCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LineExclCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LineExclCost, entity.PolicyPeriod>("entity.GL7LineExclCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> LINEEXCLUSION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "LineExclusion");
   ...
   */
  public GL7LineExclCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LineExclCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LineExclCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LineExclCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LineExclCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LineExclCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7LineExclCost clone() {
    return (entity.GL7LineExclCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7LineExclCost getBasedOn() {
    return (entity.GL7LineExclCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LineExcl getLineExclusion() {
    return (entity.GL7LineExcl)__getInternalInterface().getFieldValue(LINEEXCLUSION_PROP.get());
  }
  
  public entity.GL7LineExclCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7LineExclCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LineExclCost getUnsliced() {
    return (entity.GL7LineExclCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LineExclCostVersionList getVersionList() {
    return (entity.windowed.GL7LineExclCostVersionList)getVersionListUntyped();
  }
  ...
  public void setLineExclusion(entity.GL7LineExcl value) {
    __getInternalInterface().setFieldValue(LINEEXCLUSION_PROP.get(), value);
  }
  
  public entity.GL7LineExclCost split(java.util.Date splitDate) {
    return (entity.GL7LineExclCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LineExclCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LineExclCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getLineExclusionID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(LINEEXCLUSION_PROP.get());
    }
    ...
    public void setLineExclusionID(gw.pl.persistence.core.Key value) {
      setFieldValue(LINEEXCLUSION_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7LineExclCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LineExclCost.class, config);
    com.guidewire._generated.entity.GL7LineExclCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LineExclCost, com.guidewire._generated.entity.GL7LineExclCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7LineExclCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LineExclCostInternal getInternalInterface(entity.GL7LineExclCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LineExclCost newEmptyInstance() {
        return new entity.GL7LineExclCost((java.lang.Void)null);
      }

...
/**
 * GL7LineMod
 * A modifier for General Liability Line
 */
...
@gw.entity.EntityName(value = "GL7LineMod")
public class GL7LineMod extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Modifier, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LineMod, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LineMod, entity.PolicyPeriod>("entity.GL7LineMod");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> GL7LINERATEFACTORS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "GL7LineRateFactors");
  ...
  private com.guidewire._generated.entity.GL7LineModInternal _internal;
   ...
   */
  public GL7LineMod(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LineMod(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LineMod(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7LineModInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LineModInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Adds the given element to the GL7LineRateFactors array. This is achieved by setting the parent foreign key to this entity instance.
   */
  public void addToGL7LineRateFactors(entity.GL7LineRF element) {
    __getInternalInterface().addArrayElement(GL7LINERATEFACTORS_PROP.get(), element);
  }
  ...
  public entity.GL7LineMod clone() {
    return (entity.GL7LineMod)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7LineMod getBasedOn() {
    return (entity.GL7LineMod)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7LineMod getBasedOnValue() {
    return (entity.GL7LineMod)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7LineMod getFixed() {
    return (entity.GL7LineMod)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  /**
   * Gets the value of the GL7LineRateFactors field.
   * Individual components of the rating factor
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7LineRF[] getGL7LineRateFactors() {
    return (entity.GL7LineRF[])__getInternalInterface().getFieldValue(GL7LINERATEFACTORS_PROP.get());
  }
  ...
  public entity.GL7LineMod getSlice(java.util.Date sliceDate) {
    return (entity.GL7LineMod)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.GL7LineMod getSubtype() {
    return (typekey.GL7LineMod)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.GL7LineMod getUnsliced() {
    return (entity.GL7LineMod)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7LineModVersionList getVersionList() {
    return (entity.windowed.GL7LineModVersionList)getVersionListUntyped();
  }
  ...
  /**
   * Removes the given element from the GL7LineRateFactors array. This is achieved by marking the element for removal.
   */
  public void removeFromGL7LineRateFactors(entity.GL7LineRF element) {
    __getInternalInterface().removeArrayElement(GL7LINERATEFACTORS_PROP.get(), element);
  }
   ...
   */
  @java.lang.Deprecated
  public void removeFromGL7LineRateFactors(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(GL7LINERATEFACTORS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.GL7LineMod value) {
   ...
   */
  private void setFixed(entity.GL7LineMod value) {
  ...
  /**
   * Sets the value of the GL7LineRateFactors field.
   */
  public void setGL7LineRateFactors(entity.GL7LineRF[] value) {
    __getInternalInterface().setFieldValue(GL7LINERATEFACTORS_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.GL7LineMod value) {
  ...
  public entity.GL7LineMod split(java.util.Date splitDate) {
    return (entity.GL7LineMod)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LineModInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LineMod.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.GL7LineMod value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.GL7LineMod value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.GL7LineMod value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ModifierAbstractDomainMethods", "gw.lob.gl7.GL7LineModifierAdapter");
    config.put("gw.api.domain.ModifierAdapter", "gw.lob.gl7.GL7LineModifierAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.GL7LineModifierMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.GL7LineModifierMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LineMod.class, config);
    com.guidewire._generated.entity.GL7LineModInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LineMod, com.guidewire._generated.entity.GL7LineModInternal>() {
      public java.lang.Object getImplementation(entity.GL7LineMod bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LineModInternal getInternalInterface(entity.GL7LineMod bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LineMod newEmptyInstance() {
        return new entity.GL7LineMod((java.lang.Void)null);
      }

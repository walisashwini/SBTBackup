...
@gw.entity.EntityName(value = "GL7LineRF")
public class GL7LineRF extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.RateFactor, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LineRF, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LineRF, entity.PolicyPeriod>("entity.GL7LineRF");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GL7LINEMODIFIER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GL7LineModifier");
  ...
  private com.guidewire._generated.entity.GL7LineRFInternal _internal;
   ...
   */
  public GL7LineRF(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LineRF(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LineRF(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7LineRFInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LineRFInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7LineRF clone() {
    return (entity.GL7LineRF)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7LineRF getBasedOn() {
    return (entity.GL7LineRF)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LineRF getBasedOnValue() {
    return (entity.GL7LineRF)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7LineRF getFixed() {
    return (entity.GL7LineRF)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7LineMod getGL7LineModifier() {
    return (entity.GL7LineMod)__getInternalInterface().getFieldValue(GL7LINEMODIFIER_PROP.get());
  }
  ...
  public entity.GL7LineRF getSlice(java.util.Date sliceDate) {
    return (entity.GL7LineRF)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7LineRF getUnsliced() {
    return (entity.GL7LineRF)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7LineRFVersionList getVersionList() {
    return (entity.windowed.GL7LineRFVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7LineRF value) {
   ...
   */
  private void setFixed(entity.GL7LineRF value) {
  ...
  public void setGL7LineModifier(entity.GL7LineMod value) {
    __getInternalInterface().setFieldValue(GL7LINEMODIFIER_PROP.get(), value);
  }
  ...
  public entity.GL7LineRF split(java.util.Date splitDate) {
    return (entity.GL7LineRF)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LineRFInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LineRF.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getGL7LineModifierID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GL7LINEMODIFIER_PROP.get());
    }
    ...
    public void setGL7LineModifierID(gw.pl.persistence.core.Key value) {
      setFieldValue(GL7LINEMODIFIER_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.RateFactorAdapter", "gw.lob.gl7.GL7LineRateFactorAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.GL7LineRateFactorMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.GL7LineRateFactorMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LineRF.class, config);
    com.guidewire._generated.entity.GL7LineRFInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LineRF, com.guidewire._generated.entity.GL7LineRFInternal>() {
      public java.lang.Object getImplementation(entity.GL7LineRF bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LineRFInternal getInternalInterface(entity.GL7LineRF bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LineRF newEmptyInstance() {
        return new entity.GL7LineRF((java.lang.Void)null);
      }

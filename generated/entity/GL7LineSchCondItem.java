...
/**
 * GL7LineSchCondItem
 * GL7 Line level condition scheduled item
 */
...
@gw.entity.EntityName(value = "GL7LineSchCondItem")
public class GL7LineSchCondItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.ScheduledItem, entity.Coverable, entity.CoverableFieldAvailability, entity.GL7ScheduledItem, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LineSchCondItem, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LineSchCondItem, entity.PolicyPeriod>("entity.GL7LineSchCondItem");
  ...
  private com.guidewire._generated.entity.GL7LineSchCondItemInternal _internal;
   ...
   */
  public GL7LineSchCondItem(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LineSchCondItem(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LineSchCondItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7LineSchCondItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LineSchCondItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7LineSchCondItem clone() {
    return (entity.GL7LineSchCondItem)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7LineSchCondItem getBasedOn() {
    return (entity.GL7LineSchCondItem)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LineSchCondItem getBasedOnValue() {
    return (entity.GL7LineSchCondItem)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7LineSchCondItem getFixed() {
    return (entity.GL7LineSchCondItem)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7LineSchedCond getScheduleCondition() {
    return (entity.GL7LineSchedCond)__getInternalInterface().getFieldValue(SCHEDULECONDITION_PROP.get());
  }
  ...
  public entity.GL7LineSchCondItem getSlice(java.util.Date sliceDate) {
    return (entity.GL7LineSchCondItem)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.GL7LineSchCondItem getSubtype() {
    return (typekey.GL7LineSchCondItem)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.GL7LineSchCondItem getUnsliced() {
    return (entity.GL7LineSchCondItem)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7LineSchCondItemVersionList getVersionList() {
    return (entity.windowed.GL7LineSchCondItemVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7LineSchCondItem value) {
   ...
   */
  private void setFixed(entity.GL7LineSchCondItem value) {
   ...
   */
  private void setSubtype(typekey.GL7LineSchCondItem value) {
  ...
  public entity.GL7LineSchCondItem split(java.util.Date splitDate) {
    return (entity.GL7LineSchCondItem)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LineSchCondItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LineSchCondItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.gl7.schedules.GL7LineSchedCondItemAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.gl7.schedules.GL7LineSchedCondItemAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7LineSchedCondItemMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7LineSchedCondItemMatcher");
    config.put("gw.api.productmodel.ScheduledItemAdapter", "gw.lob.gl7.schedules.GL7LineSchedCondItemAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LineSchCondItem.class, config);
    com.guidewire._generated.entity.GL7LineSchCondItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LineSchCondItem, com.guidewire._generated.entity.GL7LineSchCondItemInternal>() {
      public java.lang.Object getImplementation(entity.GL7LineSchCondItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LineSchCondItemInternal getInternalInterface(entity.GL7LineSchCondItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LineSchCondItem newEmptyInstance() {
        return new entity.GL7LineSchCondItem((java.lang.Void)null);
      }

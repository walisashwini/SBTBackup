...
/**
 * GL7LineSchCovItem
 * GL7 Line level coverage scheduled item
 */
...
@gw.entity.EntityName(value = "GL7LineSchCovItem")
public class GL7LineSchCovItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.ScheduledItem, entity.Coverable, entity.CoverableFieldAvailability, entity.GL7ScheduledItem, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LineSchCovItem, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LineSchCovItem, entity.PolicyPeriod>("entity.GL7LineSchCovItem");
  ...
  private com.guidewire._generated.entity.GL7LineSchCovItemInternal _internal;
   ...
   */
  public GL7LineSchCovItem(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LineSchCovItem(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LineSchCovItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7LineSchCovItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LineSchCovItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7LineSchCovItem clone() {
    return (entity.GL7LineSchCovItem)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7LineSchCovItem getBasedOn() {
    return (entity.GL7LineSchCovItem)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LineSchCovItem getBasedOnValue() {
    return (entity.GL7LineSchCovItem)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7LineSchCovItem getFixed() {
    return (entity.GL7LineSchCovItem)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7LineSchedCov getScheduleCoverage() {
    return (entity.GL7LineSchedCov)__getInternalInterface().getFieldValue(SCHEDULECOVERAGE_PROP.get());
  }
  ...
  public entity.GL7LineSchCovItem getSlice(java.util.Date sliceDate) {
    return (entity.GL7LineSchCovItem)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.GL7LineSchCovItem getSubtype() {
    return (typekey.GL7LineSchCovItem)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.GL7LineSchCovItem getUnsliced() {
    return (entity.GL7LineSchCovItem)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7LineSchCovItemVersionList getVersionList() {
    return (entity.windowed.GL7LineSchCovItemVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7LineSchCovItem value) {
   ...
   */
  private void setFixed(entity.GL7LineSchCovItem value) {
   ...
   */
  private void setSubtype(typekey.GL7LineSchCovItem value) {
  ...
  public entity.GL7LineSchCovItem split(java.util.Date splitDate) {
    return (entity.GL7LineSchCovItem)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LineSchCovItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LineSchCovItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.gl7.schedules.GL7LineSchedCovItemAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.gl7.schedules.GL7LineSchedCovItemAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7LineSchedCovItemMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7LineSchedCovItemMatcher");
    config.put("gw.api.productmodel.ScheduledItemAdapter", "gw.lob.gl7.schedules.GL7LineSchedCovItemAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LineSchCovItem.class, config);
    com.guidewire._generated.entity.GL7LineSchCovItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LineSchCovItem, com.guidewire._generated.entity.GL7LineSchCovItemInternal>() {
      public java.lang.Object getImplementation(entity.GL7LineSchCovItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LineSchCovItemInternal getInternalInterface(entity.GL7LineSchCovItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LineSchCovItem newEmptyInstance() {
        return new entity.GL7LineSchCovItem((java.lang.Void)null);
      }

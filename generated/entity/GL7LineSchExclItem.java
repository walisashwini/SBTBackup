...
/**
 * GL7LineSchExclItem
 * GL7 Line level exclusion scheduled item
 */
...
@gw.entity.EntityName(value = "GL7LineSchExclItem")
public class GL7LineSchExclItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.ScheduledItem, entity.Coverable, entity.CoverableFieldAvailability, entity.GL7ScheduledItem, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LineSchExclItem, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LineSchExclItem, entity.PolicyPeriod>("entity.GL7LineSchExclItem");
  ...
  private com.guidewire._generated.entity.GL7LineSchExclItemInternal _internal;
   ...
   */
  public GL7LineSchExclItem(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LineSchExclItem(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LineSchExclItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7LineSchExclItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LineSchExclItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7LineSchExclItem clone() {
    return (entity.GL7LineSchExclItem)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7LineSchExclItem getBasedOn() {
    return (entity.GL7LineSchExclItem)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LineSchExclItem getBasedOnValue() {
    return (entity.GL7LineSchExclItem)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7LineSchExclItem getFixed() {
    return (entity.GL7LineSchExclItem)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7LineSchedExcl getScheduleExclusion() {
    return (entity.GL7LineSchedExcl)__getInternalInterface().getFieldValue(SCHEDULEEXCLUSION_PROP.get());
  }
  ...
  public entity.GL7LineSchExclItem getSlice(java.util.Date sliceDate) {
    return (entity.GL7LineSchExclItem)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.GL7LineSchExclItem getSubtype() {
    return (typekey.GL7LineSchExclItem)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.GL7LineSchExclItem getUnsliced() {
    return (entity.GL7LineSchExclItem)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7LineSchExclItemVersionList getVersionList() {
    return (entity.windowed.GL7LineSchExclItemVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7LineSchExclItem value) {
   ...
   */
  private void setFixed(entity.GL7LineSchExclItem value) {
   ...
   */
  private void setSubtype(typekey.GL7LineSchExclItem value) {
  ...
  public entity.GL7LineSchExclItem split(java.util.Date splitDate) {
    return (entity.GL7LineSchExclItem)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LineSchExclItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LineSchExclItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.gl7.schedules.GL7LineSchedExclItemAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.gl7.schedules.GL7LineSchedExclItemAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7LineSchedExclItemMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7LineSchedExclItemMatcher");
    config.put("gw.api.productmodel.ScheduledItemAdapter", "gw.lob.gl7.schedules.GL7LineSchedExclItemAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LineSchExclItem.class, config);
    com.guidewire._generated.entity.GL7LineSchExclItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LineSchExclItem, com.guidewire._generated.entity.GL7LineSchExclItemInternal>() {
      public java.lang.Object getImplementation(entity.GL7LineSchExclItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LineSchExclItemInternal getInternalInterface(entity.GL7LineSchExclItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LineSchExclItem newEmptyInstance() {
        return new entity.GL7LineSchExclItem((java.lang.Void)null);
      }

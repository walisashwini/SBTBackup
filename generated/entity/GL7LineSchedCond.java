...
/**
 * GL7LineSchedCond
 * GL7 Line Condition with a schedule
 */
...
@gw.entity.EntityName(value = "GL7LineSchedCond")
public class GL7LineSchedCond extends entity.GL7LineCond implements entity.ScheduleAutoNumberSequence, gw.api.copier.EffDatedCopyable, gw.api.domain.Schedule, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LineSchedCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LineSchedCond, entity.PolicyPeriod>("entity.GL7LineSchedCond");
   ...
   */
  protected GL7LineSchedCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7LineSchedCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7LineSchedCond(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LineSchedCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LineSchedCondInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LineSchedCondInternal)super.__getInternalInterface();
  }
   ...
   */
  public void addToGL7ScheduledItems(entity.GL7LineSchCondItem element) {
  ...
  public entity.GL7LineSchedCond clone() {
    return (entity.GL7LineSchedCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7LineSchedCond getBasedOn() {
    return (entity.GL7LineSchedCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LineSchCondItem[] getGL7ScheduledItems() {
    return (entity.GL7LineSchCondItem[])__getInternalInterface().getFieldValue(GL7SCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.GL7LineSchedCond getSlice(java.util.Date sliceDate) {
    return (entity.GL7LineSchedCond)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LineSchedCond getUnsliced() {
    return (entity.GL7LineSchedCond)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LineSchedCondVersionList getVersionList() {
    return (entity.windowed.GL7LineSchedCondVersionList)getVersionListUntyped();
  }
   ...
   */
  public void removeFromGL7ScheduledItems(entity.GL7LineSchCondItem element) {
   ...
   */
  public void setGL7ScheduledItems(entity.GL7LineSchCondItem[] value) {
  ...
  public entity.GL7LineSchedCond split(java.util.Date splitDate) {
    return (entity.GL7LineSchedCond)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LineSchedCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LineSchedCond.this.__getDelegateManager();
    }
     ...
     */
    public void addToCosts(entity.GL7LineCondCost element) {
     ...
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public entity.GL7LineCond getBasedOnValue() {
      return (entity.GL7LineCond)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
     ...
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public entity.GL7LineCondCost[] getCosts() {
      return (entity.GL7LineCondCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
    }
     ...
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public entity.GL7LineCond getFixed() {
      return (entity.GL7LineCond)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
     ...
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public typekey.GL7LineCond getSubtype() {
      return (typekey.GL7LineCond)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
     ...
     */
    public void removeFromCosts(entity.GL7LineCondCost element) {
     ...
     */
    public void setBasedOnValue(entity.GL7LineCond value) {
     ...
     */
    public void setCosts(entity.GL7LineCondCost[] value) {
     ...
     */
    public void setFixed(entity.GL7LineCond value) {
     ...
     */
    public void setSubtype(typekey.GL7LineCond value) {
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.GL7LineConditionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.GL7LineConditionAdapter");
    config.put("gw.api.domain.PolicyConditionAdapter", "gw.lob.gl7.GL7LineConditionAdapter");
    config.put("gw.api.domain.Schedule", "gw.lob.gl7.schedules.GL7LineSchedCondImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7LineSchedCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7LineSchedCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LineSchedCond.class, config);
    com.guidewire._generated.entity.GL7LineSchedCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LineSchedCond, com.guidewire._generated.entity.GL7LineSchedCondInternal>() {
      public java.lang.Object getImplementation(entity.GL7LineSchedCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LineSchedCondInternal getInternalInterface(entity.GL7LineSchedCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LineSchedCond newEmptyInstance() {
        return new entity.GL7LineSchedCond((java.lang.Void)null);
      }

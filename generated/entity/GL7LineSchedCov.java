...
/**
 * GL7LineSchedCov
 * GL7 Line Coverage with a schedule
 */
...
@gw.entity.EntityName(value = "GL7LineSchedCov")
public class GL7LineSchedCov extends entity.GL7LineCov implements entity.ScheduleAutoNumberSequence, gw.api.copier.EffDatedCopyable, gw.api.domain.Schedule, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LineSchedCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LineSchedCov, entity.PolicyPeriod>("entity.GL7LineSchedCov");
   ...
   */
  protected GL7LineSchedCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7LineSchedCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7LineSchedCov(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LineSchedCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LineSchedCovInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LineSchedCovInternal)super.__getInternalInterface();
  }
  ...
  public entity.GL7LineSchedCov clone() {
    return (entity.GL7LineSchedCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7LineSchedCov getBasedOn() {
    return (entity.GL7LineSchedCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LineSchCovItem[] getGL7ScheduledItems() {
    return (entity.GL7LineSchCovItem[])__getInternalInterface().getFieldValue(GL7SCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.GL7LineSchedCov getSlice(java.util.Date sliceDate) {
    return (entity.GL7LineSchedCov)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LineSchedCov getUnsliced() {
    return (entity.GL7LineSchedCov)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LineSchedCovVersionList getVersionList() {
    return (entity.windowed.GL7LineSchedCovVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7LineSchedCov split(java.util.Date splitDate) {
    return (entity.GL7LineSchedCov)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LineSchedCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LineSchedCov.this.__getDelegateManager();
    }
    ...
    public entity.GL7LineCov getBasedOnValue() {
      return (entity.GL7LineCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public entity.GL7LineCovCost[] getCosts() {
      return (entity.GL7LineCovCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
    }
    ...
    public entity.GL7LineCov getFixed() {
      return (entity.GL7LineCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public typekey.GL7LineCov getSubtype() {
      return (typekey.GL7LineCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.GL7LineCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.GL7LineCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.gl7.GL7LineCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.gl7.GL7LineCoverageAdapter");
    config.put("gw.api.domain.Schedule", "gw.lob.gl7.schedules.GL7LineSchedCovImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7LineSchedCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7LineSchedCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LineSchedCov.class, config);
    com.guidewire._generated.entity.GL7LineSchedCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LineSchedCov, com.guidewire._generated.entity.GL7LineSchedCovInternal>() {
      public java.lang.Object getImplementation(entity.GL7LineSchedCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LineSchedCovInternal getInternalInterface(entity.GL7LineSchedCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LineSchedCov newEmptyInstance() {
        return new entity.GL7LineSchedCov((java.lang.Void)null);
      }

...
/**
 * GL7LineSchedExcl
 * GL7 Line Exclusion with a schedule
 */
...
@gw.entity.EntityName(value = "GL7LineSchedExcl")
public class GL7LineSchedExcl extends entity.GL7LineExcl implements entity.ScheduleAutoNumberSequence, gw.api.copier.EffDatedCopyable, gw.api.domain.Schedule, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LineSchedExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LineSchedExcl, entity.PolicyPeriod>("entity.GL7LineSchedExcl");
   ...
   */
  protected GL7LineSchedExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7LineSchedExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7LineSchedExcl(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LineSchedExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LineSchedExclInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LineSchedExclInternal)super.__getInternalInterface();
  }
   ...
   */
  public void addToGL7ScheduledItems(entity.GL7LineSchExclItem element) {
  ...
  public entity.GL7LineSchedExcl clone() {
    return (entity.GL7LineSchedExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7LineSchedExcl getBasedOn() {
    return (entity.GL7LineSchedExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LineSchExclItem[] getGL7ScheduledItems() {
    return (entity.GL7LineSchExclItem[])__getInternalInterface().getFieldValue(GL7SCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.GL7LineSchedExcl getSlice(java.util.Date sliceDate) {
    return (entity.GL7LineSchedExcl)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LineSchedExcl getUnsliced() {
    return (entity.GL7LineSchedExcl)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LineSchedExclVersionList getVersionList() {
    return (entity.windowed.GL7LineSchedExclVersionList)getVersionListUntyped();
  }
   ...
   */
  public void removeFromGL7ScheduledItems(entity.GL7LineSchExclItem element) {
   ...
   */
  public void setGL7ScheduledItems(entity.GL7LineSchExclItem[] value) {
  ...
  public entity.GL7LineSchedExcl split(java.util.Date splitDate) {
    return (entity.GL7LineSchedExcl)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LineSchedExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LineSchedExcl.this.__getDelegateManager();
    }
     ...
     */
    public void addToCosts(entity.GL7LineExclCost element) {
     ...
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public entity.GL7LineExcl getBasedOnValue() {
      return (entity.GL7LineExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
     ...
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public entity.GL7LineExclCost[] getCosts() {
      return (entity.GL7LineExclCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
    }
     ...
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public entity.GL7LineExcl getFixed() {
      return (entity.GL7LineExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
     ...
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public typekey.GL7LineExcl getSubtype() {
      return (typekey.GL7LineExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
     ...
     */
    public void removeFromCosts(entity.GL7LineExclCost element) {
     ...
     */
    public void setBasedOnValue(entity.GL7LineExcl value) {
     ...
     */
    public void setCosts(entity.GL7LineExclCost[] value) {
     ...
     */
    public void setFixed(entity.GL7LineExcl value) {
     ...
     */
    public void setSubtype(typekey.GL7LineExcl value) {
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.GL7LineExclusionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.GL7LineExclusionAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.gl7.GL7LineExclusionAdapter");
    config.put("gw.api.domain.Schedule", "gw.lob.gl7.schedules.GL7LineSchedExclImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7LineSchedExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7LineSchedExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LineSchedExcl.class, config);
    com.guidewire._generated.entity.GL7LineSchedExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LineSchedExcl, com.guidewire._generated.entity.GL7LineSchedExclInternal>() {
      public java.lang.Object getImplementation(entity.GL7LineSchedExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LineSchedExclInternal getInternalInterface(entity.GL7LineSchedExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LineSchedExcl newEmptyInstance() {
        return new entity.GL7LineSchedExcl((java.lang.Void)null);
      }

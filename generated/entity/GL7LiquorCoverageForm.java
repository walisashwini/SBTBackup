...
/**
 * GL7LiquorCoverageForm
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7LiquorCoverageForm.eti;GL7LiquorCoverageForm.eix;GL7LiquorCoverageForm.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7LiquorCoverageForm")
public class GL7LiquorCoverageForm extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7LiquorCoverageForm> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7LiquorCoverageForm>("entity.GL7LiquorCoverageForm");
  ...
  private com.guidewire._generated.entity.GL7LiquorCoverageFormInternal _internal;
   ...
   */
  public GL7LiquorCoverageForm(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7LiquorCoverageForm(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7LiquorCoverageFormInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LiquorCoverageFormInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LiquorCoverageFormInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LiquorCoverageForm.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LiquorCoverageForm.class, config);
    com.guidewire._generated.entity.GL7LiquorCoverageFormInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LiquorCoverageForm, com.guidewire._generated.entity.GL7LiquorCoverageFormInternal>() {
      public java.lang.Object getImplementation(entity.GL7LiquorCoverageForm bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LiquorCoverageFormInternal getInternalInterface(entity.GL7LiquorCoverageForm bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LiquorCoverageForm newEmptyInstance() {
        return new entity.GL7LiquorCoverageForm((java.lang.Void)null);
      }

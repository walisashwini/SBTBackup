 ...
 * GL7LiquorELPRT
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7LiquorELPRT.eti;GL7LiquorELPRT.eix;GL7LiquorELPRT.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7LiquorELPRT")
public class GL7LiquorELPRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7LiquorELPRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7LiquorELPRT>("entity.GL7LiquorELPRT");
  ...
  private com.guidewire._generated.entity.GL7LiquorELPRTInternal _internal;
   ...
   */
  public GL7LiquorELPRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7LiquorELPRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7LiquorELPRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LiquorELPRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LiquorELPRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LiquorELPRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LiquorELPRT.class, config);
    com.guidewire._generated.entity.GL7LiquorELPRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LiquorELPRT, com.guidewire._generated.entity.GL7LiquorELPRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7LiquorELPRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LiquorELPRTInternal getInternalInterface(entity.GL7LiquorELPRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LiquorELPRT newEmptyInstance() {
        return new entity.GL7LiquorELPRT((java.lang.Void)null);
      }

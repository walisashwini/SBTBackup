 ...
 * GL7LiquorELPTextRT
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7LiquorELPTextRT.eti;GL7LiquorELPTextRT.eix;GL7LiquorELPTextRT.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7LiquorELPTextRT")
public class GL7LiquorELPTextRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7LiquorELPTextRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7LiquorELPTextRT>("entity.GL7LiquorELPTextRT");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BEANVERSION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BeanVersion");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CLASSCODELIQUOR_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ClassCodeLiquor");
  ...
  private com.guidewire._generated.entity.GL7LiquorELPTextRTInternal _internal;
   ...
   */
  public GL7LiquorELPTextRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7LiquorELPTextRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7LiquorELPTextRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LiquorELPTextRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Gets the value of the ClassCodeLiquor field.
   * ClassCodeLiquor
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getClassCodeLiquor() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CLASSCODELIQUOR_PROP.get());
  }
  ...
  /**
   * Sets the value of the ClassCodeLiquor field.
   */
  public void setClassCodeLiquor(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CLASSCODELIQUOR_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LiquorELPTextRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LiquorELPTextRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LiquorELPTextRT.class, config);
    com.guidewire._generated.entity.GL7LiquorELPTextRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LiquorELPTextRT, com.guidewire._generated.entity.GL7LiquorELPTextRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7LiquorELPTextRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LiquorELPTextRTInternal getInternalInterface(entity.GL7LiquorELPTextRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LiquorELPTextRT newEmptyInstance() {
        return new entity.GL7LiquorELPTextRT((java.lang.Void)null);
      }

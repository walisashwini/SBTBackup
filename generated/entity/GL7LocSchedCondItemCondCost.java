...
/**
 * GL7LocSchedCondItemCondCost
 * GL7 Location Condition Schedule Item Condition Cost
 */
...
@gw.entity.EntityName(value = "GL7LocSchedCondItemCondCost")
public class GL7LocSchedCondItemCondCost extends entity.GL7LocSchedCondItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocSchedCondItemCondCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocSchedCondItemCondCost, entity.PolicyPeriod>("entity.GL7LocSchedCondItemCondCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> LOCSCHEDCONDITEMCOND_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "LocSchedCondItemCond");
   ...
   */
  public GL7LocSchedCondItemCondCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LocSchedCondItemCondCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocSchedCondItemCondCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LocSchedCondItemCondCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocSchedCondItemCondCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LocSchedCondItemCondCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7LocSchedCondItemCondCost clone() {
    return (entity.GL7LocSchedCondItemCondCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7LocSchedCondItemCondCost getBasedOn() {
    return (entity.GL7LocSchedCondItemCondCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocSchedCondItemCond getLocSchedCondItemCond() {
    return (entity.GL7LocSchedCondItemCond)__getInternalInterface().getFieldValue(LOCSCHEDCONDITEMCOND_PROP.get());
  }
  
  public entity.GL7LocSchedCondItemCondCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocSchedCondItemCondCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LocSchedCondItemCondCost getUnsliced() {
    return (entity.GL7LocSchedCondItemCondCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LocSchedCondItemCondCostVersionList getVersionList() {
    return (entity.windowed.GL7LocSchedCondItemCondCostVersionList)getVersionListUntyped();
  }
  ...
  public void setLocSchedCondItemCond(entity.GL7LocSchedCondItemCond value) {
    __getInternalInterface().setFieldValue(LOCSCHEDCONDITEMCOND_PROP.get(), value);
  }
  
  public entity.GL7LocSchedCondItemCondCost split(java.util.Date splitDate) {
    return (entity.GL7LocSchedCondItemCondCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocSchedCondItemCondCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocSchedCondItemCondCost.this.__getDelegateManager();
    }
    ...
    public entity.GL7LocationSchedCondItem getLocSchedCondItem() {
      return (entity.GL7LocationSchedCondItem)__getInternalInterface().getFieldValue(LOCSCHEDCONDITEM_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getLocSchedCondItemCondID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(LOCSCHEDCONDITEMCOND_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getLocSchedCondItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(LOCSCHEDCONDITEM_PROP.get());
    }
    ...
    public void setLocSchedCondItem(entity.GL7LocationSchedCondItem value) {
      __getInternalInterface().setFieldValue(LOCSCHEDCONDITEM_PROP.get(), value);
    }
    ...
    public void setLocSchedCondItemCondID(gw.pl.persistence.core.Key value) {
      setFieldValue(LOCSCHEDCONDITEMCOND_PROP.get(), value);
    }
    
    public void setLocSchedCondItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(LOCSCHEDCONDITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7LocSchedCondItemCondCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocSchedCondItemCondCost.class, config);
    com.guidewire._generated.entity.GL7LocSchedCondItemCondCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocSchedCondItemCondCost, com.guidewire._generated.entity.GL7LocSchedCondItemCondCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocSchedCondItemCondCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocSchedCondItemCondCostInternal getInternalInterface(entity.GL7LocSchedCondItemCondCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocSchedCondItemCondCost newEmptyInstance() {
        return new entity.GL7LocSchedCondItemCondCost((java.lang.Void)null);
      }

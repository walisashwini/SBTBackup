...
/**
 * GL7LocSchedCondItemCost
 * Base Location Condition Schedule Item Cost
 */
...
@gw.entity.EntityName(value = "GL7LocSchedCondItemCost")
public class GL7LocSchedCondItemCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocSchedCondItemCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocSchedCondItemCost, entity.PolicyPeriod>("entity.GL7LocSchedCondItemCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> LOCSCHEDCONDITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "LocSchedCondItem");
   ...
   */
  public GL7LocSchedCondItemCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LocSchedCondItemCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocSchedCondItemCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LocSchedCondItemCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocSchedCondItemCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LocSchedCondItemCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7LocSchedCondItemCost clone() {
    return (entity.GL7LocSchedCondItemCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7LocSchedCondItemCost getBasedOn() {
    return (entity.GL7LocSchedCondItemCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocSchedCondItemCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocSchedCondItemCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LocSchedCondItemCost getUnsliced() {
    return (entity.GL7LocSchedCondItemCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LocSchedCondItemCostVersionList getVersionList() {
    return (entity.windowed.GL7LocSchedCondItemCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7LocSchedCondItemCost split(java.util.Date splitDate) {
    return (entity.GL7LocSchedCondItemCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocSchedCondItemCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocSchedCondItemCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7LocSchedCondItemCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocSchedCondItemCost.class, config);
    com.guidewire._generated.entity.GL7LocSchedCondItemCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocSchedCondItemCost, com.guidewire._generated.entity.GL7LocSchedCondItemCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocSchedCondItemCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocSchedCondItemCostInternal getInternalInterface(entity.GL7LocSchedCondItemCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocSchedCondItemCost newEmptyInstance() {
        return new entity.GL7LocSchedCondItemCost((java.lang.Void)null);
      }

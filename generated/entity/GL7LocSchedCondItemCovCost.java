...
/**
 * GL7LocSchedCondItemCovCost
 * GL7 Location Condition Schedule Item Coverage Cost
 */
...
@gw.entity.EntityName(value = "GL7LocSchedCondItemCovCost")
public class GL7LocSchedCondItemCovCost extends entity.GL7LocSchedCondItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocSchedCondItemCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocSchedCondItemCovCost, entity.PolicyPeriod>("entity.GL7LocSchedCondItemCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> LOCSCHEDCONDITEMCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "LocSchedCondItemCov");
   ...
   */
  public GL7LocSchedCondItemCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LocSchedCondItemCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocSchedCondItemCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LocSchedCondItemCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocSchedCondItemCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LocSchedCondItemCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7LocSchedCondItemCovCost clone() {
    return (entity.GL7LocSchedCondItemCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7LocSchedCondItemCovCost getBasedOn() {
    return (entity.GL7LocSchedCondItemCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocSchedCondItemCov getLocSchedCondItemCov() {
    return (entity.GL7LocSchedCondItemCov)__getInternalInterface().getFieldValue(LOCSCHEDCONDITEMCOV_PROP.get());
  }
  
  public entity.GL7LocSchedCondItemCovCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocSchedCondItemCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LocSchedCondItemCovCost getUnsliced() {
    return (entity.GL7LocSchedCondItemCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LocSchedCondItemCovCostVersionList getVersionList() {
    return (entity.windowed.GL7LocSchedCondItemCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setLocSchedCondItemCov(entity.GL7LocSchedCondItemCov value) {
    __getInternalInterface().setFieldValue(LOCSCHEDCONDITEMCOV_PROP.get(), value);
  }
  
  public entity.GL7LocSchedCondItemCovCost split(java.util.Date splitDate) {
    return (entity.GL7LocSchedCondItemCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocSchedCondItemCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocSchedCondItemCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getLocSchedCondItemCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(LOCSCHEDCONDITEMCOV_PROP.get());
    }
    ...
    public void setLocSchedCondItemCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(LOCSCHEDCONDITEMCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7LocSchedCondItemCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocSchedCondItemCovCost.class, config);
    com.guidewire._generated.entity.GL7LocSchedCondItemCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocSchedCondItemCovCost, com.guidewire._generated.entity.GL7LocSchedCondItemCovCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocSchedCondItemCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocSchedCondItemCovCostInternal getInternalInterface(entity.GL7LocSchedCondItemCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocSchedCondItemCovCost newEmptyInstance() {
        return new entity.GL7LocSchedCondItemCovCost((java.lang.Void)null);
      }

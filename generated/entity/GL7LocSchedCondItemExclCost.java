...
/**
 * GL7LocSchedCondItemExclCost
 * GL7 Location Condition Schedule Item Exclusion Cost
 */
...
@gw.entity.EntityName(value = "GL7LocSchedCondItemExclCost")
public class GL7LocSchedCondItemExclCost extends entity.GL7LocSchedCondItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocSchedCondItemExclCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocSchedCondItemExclCost, entity.PolicyPeriod>("entity.GL7LocSchedCondItemExclCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> LOCSCHEDCONDITEMEXCL_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "LocSchedCondItemExcl");
   ...
   */
  public GL7LocSchedCondItemExclCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LocSchedCondItemExclCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocSchedCondItemExclCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LocSchedCondItemExclCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocSchedCondItemExclCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LocSchedCondItemExclCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7LocSchedCondItemExclCost clone() {
    return (entity.GL7LocSchedCondItemExclCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7LocSchedCondItemExclCost getBasedOn() {
    return (entity.GL7LocSchedCondItemExclCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocSchedCondItemExcl getLocSchedCondItemExcl() {
    return (entity.GL7LocSchedCondItemExcl)__getInternalInterface().getFieldValue(LOCSCHEDCONDITEMEXCL_PROP.get());
  }
  
  public entity.GL7LocSchedCondItemExclCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocSchedCondItemExclCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LocSchedCondItemExclCost getUnsliced() {
    return (entity.GL7LocSchedCondItemExclCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LocSchedCondItemExclCostVersionList getVersionList() {
    return (entity.windowed.GL7LocSchedCondItemExclCostVersionList)getVersionListUntyped();
  }
  ...
  public void setLocSchedCondItemExcl(entity.GL7LocSchedCondItemExcl value) {
    __getInternalInterface().setFieldValue(LOCSCHEDCONDITEMEXCL_PROP.get(), value);
  }
  
  public entity.GL7LocSchedCondItemExclCost split(java.util.Date splitDate) {
    return (entity.GL7LocSchedCondItemExclCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocSchedCondItemExclCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocSchedCondItemExclCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getLocSchedCondItemExclID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(LOCSCHEDCONDITEMEXCL_PROP.get());
    }
    ...
    public void setLocSchedCondItemExclID(gw.pl.persistence.core.Key value) {
      setFieldValue(LOCSCHEDCONDITEMEXCL_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7LocSchedCondItemExclCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocSchedCondItemExclCost.class, config);
    com.guidewire._generated.entity.GL7LocSchedCondItemExclCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocSchedCondItemExclCost, com.guidewire._generated.entity.GL7LocSchedCondItemExclCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocSchedCondItemExclCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocSchedCondItemExclCostInternal getInternalInterface(entity.GL7LocSchedCondItemExclCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocSchedCondItemExclCost newEmptyInstance() {
        return new entity.GL7LocSchedCondItemExclCost((java.lang.Void)null);
      }

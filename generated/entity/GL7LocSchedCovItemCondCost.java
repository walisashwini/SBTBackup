...
/**
 * GL7LocSchedCovItemCondCost
 * GL7 Location Coverage Schedule Item Condition Cost
 */
...
@gw.entity.EntityName(value = "GL7LocSchedCovItemCondCost")
public class GL7LocSchedCovItemCondCost extends entity.GL7LocSchedCovItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocSchedCovItemCondCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocSchedCovItemCondCost, entity.PolicyPeriod>("entity.GL7LocSchedCovItemCondCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> LOCSCHEDCOVITEMCOND_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "LocSchedCovItemCond");
   ...
   */
  public GL7LocSchedCovItemCondCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LocSchedCovItemCondCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocSchedCovItemCondCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LocSchedCovItemCondCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocSchedCovItemCondCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LocSchedCovItemCondCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7LocSchedCovItemCondCost clone() {
    return (entity.GL7LocSchedCovItemCondCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7LocSchedCovItemCondCost getBasedOn() {
    return (entity.GL7LocSchedCovItemCondCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocSchedCovItemCond getLocSchedCovItemCond() {
    return (entity.GL7LocSchedCovItemCond)__getInternalInterface().getFieldValue(LOCSCHEDCOVITEMCOND_PROP.get());
  }
  
  public entity.GL7LocSchedCovItemCondCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocSchedCovItemCondCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LocSchedCovItemCondCost getUnsliced() {
    return (entity.GL7LocSchedCovItemCondCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LocSchedCovItemCondCostVersionList getVersionList() {
    return (entity.windowed.GL7LocSchedCovItemCondCostVersionList)getVersionListUntyped();
  }
  ...
  public void setLocSchedCovItemCond(entity.GL7LocSchedCovItemCond value) {
    __getInternalInterface().setFieldValue(LOCSCHEDCOVITEMCOND_PROP.get(), value);
  }
  
  public entity.GL7LocSchedCovItemCondCost split(java.util.Date splitDate) {
    return (entity.GL7LocSchedCovItemCondCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocSchedCovItemCondCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocSchedCovItemCondCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getLocSchedCovItemCondID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(LOCSCHEDCOVITEMCOND_PROP.get());
    }
    ...
    public void setLocSchedCovItemCondID(gw.pl.persistence.core.Key value) {
      setFieldValue(LOCSCHEDCOVITEMCOND_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7LocSchedCovItemCondCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocSchedCovItemCondCost.class, config);
    com.guidewire._generated.entity.GL7LocSchedCovItemCondCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocSchedCovItemCondCost, com.guidewire._generated.entity.GL7LocSchedCovItemCondCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocSchedCovItemCondCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocSchedCovItemCondCostInternal getInternalInterface(entity.GL7LocSchedCovItemCondCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocSchedCovItemCondCost newEmptyInstance() {
        return new entity.GL7LocSchedCovItemCondCost((java.lang.Void)null);
      }

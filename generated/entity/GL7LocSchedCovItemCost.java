...
/**
 * GL7LocSchedCovItemCost
 * Base Location Coverage Schedule Item Cost
 */
...
@gw.entity.EntityName(value = "GL7LocSchedCovItemCost")
public class GL7LocSchedCovItemCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocSchedCovItemCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocSchedCovItemCost, entity.PolicyPeriod>("entity.GL7LocSchedCovItemCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> LOCSCHEDCOVITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "LocSchedCovItem");
   ...
   */
  public GL7LocSchedCovItemCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LocSchedCovItemCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocSchedCovItemCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LocSchedCovItemCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocSchedCovItemCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LocSchedCovItemCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7LocSchedCovItemCost clone() {
    return (entity.GL7LocSchedCovItemCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7LocSchedCovItemCost getBasedOn() {
    return (entity.GL7LocSchedCovItemCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocSchedCovItemCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocSchedCovItemCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LocSchedCovItemCost getUnsliced() {
    return (entity.GL7LocSchedCovItemCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LocSchedCovItemCostVersionList getVersionList() {
    return (entity.windowed.GL7LocSchedCovItemCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7LocSchedCovItemCost split(java.util.Date splitDate) {
    return (entity.GL7LocSchedCovItemCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocSchedCovItemCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocSchedCovItemCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7LocSchedCovItemCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocSchedCovItemCost.class, config);
    com.guidewire._generated.entity.GL7LocSchedCovItemCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocSchedCovItemCost, com.guidewire._generated.entity.GL7LocSchedCovItemCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocSchedCovItemCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocSchedCovItemCostInternal getInternalInterface(entity.GL7LocSchedCovItemCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocSchedCovItemCost newEmptyInstance() {
        return new entity.GL7LocSchedCovItemCost((java.lang.Void)null);
      }

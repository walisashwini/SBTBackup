...
/**
 * GL7LocSchedCovItemCovCost
 * GL7 Location Coverage Schedule Item Coverage Cost
 */
...
@gw.entity.EntityName(value = "GL7LocSchedCovItemCovCost")
public class GL7LocSchedCovItemCovCost extends entity.GL7LocSchedCovItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocSchedCovItemCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocSchedCovItemCovCost, entity.PolicyPeriod>("entity.GL7LocSchedCovItemCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> LOCSCHEDCOVITEMCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "LocSchedCovItemCov");
   ...
   */
  public GL7LocSchedCovItemCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LocSchedCovItemCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocSchedCovItemCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LocSchedCovItemCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocSchedCovItemCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LocSchedCovItemCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7LocSchedCovItemCovCost clone() {
    return (entity.GL7LocSchedCovItemCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7LocSchedCovItemCovCost getBasedOn() {
    return (entity.GL7LocSchedCovItemCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocSchedCovItemCov getLocSchedCovItemCov() {
    return (entity.GL7LocSchedCovItemCov)__getInternalInterface().getFieldValue(LOCSCHEDCOVITEMCOV_PROP.get());
  }
  
  public entity.GL7LocSchedCovItemCovCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocSchedCovItemCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LocSchedCovItemCovCost getUnsliced() {
    return (entity.GL7LocSchedCovItemCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LocSchedCovItemCovCostVersionList getVersionList() {
    return (entity.windowed.GL7LocSchedCovItemCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setLocSchedCovItemCov(entity.GL7LocSchedCovItemCov value) {
    __getInternalInterface().setFieldValue(LOCSCHEDCOVITEMCOV_PROP.get(), value);
  }
  
  public entity.GL7LocSchedCovItemCovCost split(java.util.Date splitDate) {
    return (entity.GL7LocSchedCovItemCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocSchedCovItemCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocSchedCovItemCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getLocSchedCovItemCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(LOCSCHEDCOVITEMCOV_PROP.get());
    }
    ...
    public void setLocSchedCovItemCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(LOCSCHEDCOVITEMCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7LocSchedCovItemCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocSchedCovItemCovCost.class, config);
    com.guidewire._generated.entity.GL7LocSchedCovItemCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocSchedCovItemCovCost, com.guidewire._generated.entity.GL7LocSchedCovItemCovCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocSchedCovItemCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocSchedCovItemCovCostInternal getInternalInterface(entity.GL7LocSchedCovItemCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocSchedCovItemCovCost newEmptyInstance() {
        return new entity.GL7LocSchedCovItemCovCost((java.lang.Void)null);
      }

...
/**
 * GL7LocSchedCovItemExclCost
 * GL7 Location Coverage Schedule Item Exclusion Cost
 */
...
@gw.entity.EntityName(value = "GL7LocSchedCovItemExclCost")
public class GL7LocSchedCovItemExclCost extends entity.GL7LocSchedCovItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocSchedCovItemExclCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocSchedCovItemExclCost, entity.PolicyPeriod>("entity.GL7LocSchedCovItemExclCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> LOCSCHEDCOVITEMEXCL_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "LocSchedCovItemExcl");
   ...
   */
  public GL7LocSchedCovItemExclCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LocSchedCovItemExclCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocSchedCovItemExclCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LocSchedCovItemExclCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocSchedCovItemExclCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LocSchedCovItemExclCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7LocSchedCovItemExclCost clone() {
    return (entity.GL7LocSchedCovItemExclCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7LocSchedCovItemExclCost getBasedOn() {
    return (entity.GL7LocSchedCovItemExclCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocSchedCovItemExcl getLocSchedCovItemExcl() {
    return (entity.GL7LocSchedCovItemExcl)__getInternalInterface().getFieldValue(LOCSCHEDCOVITEMEXCL_PROP.get());
  }
  
  public entity.GL7LocSchedCovItemExclCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocSchedCovItemExclCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LocSchedCovItemExclCost getUnsliced() {
    return (entity.GL7LocSchedCovItemExclCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LocSchedCovItemExclCostVersionList getVersionList() {
    return (entity.windowed.GL7LocSchedCovItemExclCostVersionList)getVersionListUntyped();
  }
  ...
  public void setLocSchedCovItemExcl(entity.GL7LocSchedCovItemExcl value) {
    __getInternalInterface().setFieldValue(LOCSCHEDCOVITEMEXCL_PROP.get(), value);
  }
  
  public entity.GL7LocSchedCovItemExclCost split(java.util.Date splitDate) {
    return (entity.GL7LocSchedCovItemExclCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocSchedCovItemExclCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocSchedCovItemExclCost.this.__getDelegateManager();
    }
    ...
    public entity.GL7LocationSchedCovItem getLocSchedCovItem() {
      return (entity.GL7LocationSchedCovItem)__getInternalInterface().getFieldValue(LOCSCHEDCOVITEM_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getLocSchedCovItemExclID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(LOCSCHEDCOVITEMEXCL_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getLocSchedCovItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(LOCSCHEDCOVITEM_PROP.get());
    }
    ...
    public void setLocSchedCovItem(entity.GL7LocationSchedCovItem value) {
      __getInternalInterface().setFieldValue(LOCSCHEDCOVITEM_PROP.get(), value);
    }
    ...
    public void setLocSchedCovItemExclID(gw.pl.persistence.core.Key value) {
      setFieldValue(LOCSCHEDCOVITEMEXCL_PROP.get(), value);
    }
    
    public void setLocSchedCovItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(LOCSCHEDCOVITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7LocSchedCovItemExclCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocSchedCovItemExclCost.class, config);
    com.guidewire._generated.entity.GL7LocSchedCovItemExclCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocSchedCovItemExclCost, com.guidewire._generated.entity.GL7LocSchedCovItemExclCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocSchedCovItemExclCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocSchedCovItemExclCostInternal getInternalInterface(entity.GL7LocSchedCovItemExclCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocSchedCovItemExclCost newEmptyInstance() {
        return new entity.GL7LocSchedCovItemExclCost((java.lang.Void)null);
      }

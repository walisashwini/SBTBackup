...
/**
 * GL7LocSchedExclItemCondCost
 * GL7 Location Exclusion Schedule Item Condition Cost
 */
...
@gw.entity.EntityName(value = "GL7LocSchedExclItemCondCost")
public class GL7LocSchedExclItemCondCost extends entity.GL7LocSchedExclItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocSchedExclItemCondCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocSchedExclItemCondCost, entity.PolicyPeriod>("entity.GL7LocSchedExclItemCondCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> LOCSCHEDEXCLITEMCOND_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "LocSchedExclItemCond");
   ...
   */
  public GL7LocSchedExclItemCondCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LocSchedExclItemCondCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocSchedExclItemCondCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LocSchedExclItemCondCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocSchedExclItemCondCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LocSchedExclItemCondCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7LocSchedExclItemCondCost clone() {
    return (entity.GL7LocSchedExclItemCondCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7LocSchedExclItemCondCost getBasedOn() {
    return (entity.GL7LocSchedExclItemCondCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocSchedExclItemCond getLocSchedExclItemCond() {
    return (entity.GL7LocSchedExclItemCond)__getInternalInterface().getFieldValue(LOCSCHEDEXCLITEMCOND_PROP.get());
  }
  
  public entity.GL7LocSchedExclItemCondCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocSchedExclItemCondCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LocSchedExclItemCondCost getUnsliced() {
    return (entity.GL7LocSchedExclItemCondCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LocSchedExclItemCondCostVersionList getVersionList() {
    return (entity.windowed.GL7LocSchedExclItemCondCostVersionList)getVersionListUntyped();
  }
  ...
  public void setLocSchedExclItemCond(entity.GL7LocSchedExclItemCond value) {
    __getInternalInterface().setFieldValue(LOCSCHEDEXCLITEMCOND_PROP.get(), value);
  }
  
  public entity.GL7LocSchedExclItemCondCost split(java.util.Date splitDate) {
    return (entity.GL7LocSchedExclItemCondCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocSchedExclItemCondCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocSchedExclItemCondCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getLocSchedExclItemCondID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(LOCSCHEDEXCLITEMCOND_PROP.get());
    }
    ...
    public void setLocSchedExclItemCondID(gw.pl.persistence.core.Key value) {
      setFieldValue(LOCSCHEDEXCLITEMCOND_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7LocSchedExclItemCondCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocSchedExclItemCondCost.class, config);
    com.guidewire._generated.entity.GL7LocSchedExclItemCondCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocSchedExclItemCondCost, com.guidewire._generated.entity.GL7LocSchedExclItemCondCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocSchedExclItemCondCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocSchedExclItemCondCostInternal getInternalInterface(entity.GL7LocSchedExclItemCondCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocSchedExclItemCondCost newEmptyInstance() {
        return new entity.GL7LocSchedExclItemCondCost((java.lang.Void)null);
      }

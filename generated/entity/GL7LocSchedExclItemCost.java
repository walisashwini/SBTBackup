...
/**
 * GL7LocSchedExclItemCost
 * Base Location Exclusion Schedule Item Cost
 */
...
@gw.entity.EntityName(value = "GL7LocSchedExclItemCost")
public class GL7LocSchedExclItemCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocSchedExclItemCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocSchedExclItemCost, entity.PolicyPeriod>("entity.GL7LocSchedExclItemCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> LOCSCHEDEXCLITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "LocSchedExclItem");
   ...
   */
  public GL7LocSchedExclItemCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LocSchedExclItemCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocSchedExclItemCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LocSchedExclItemCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocSchedExclItemCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LocSchedExclItemCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7LocSchedExclItemCost clone() {
    return (entity.GL7LocSchedExclItemCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7LocSchedExclItemCost getBasedOn() {
    return (entity.GL7LocSchedExclItemCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocSchedExclItemCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocSchedExclItemCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LocSchedExclItemCost getUnsliced() {
    return (entity.GL7LocSchedExclItemCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LocSchedExclItemCostVersionList getVersionList() {
    return (entity.windowed.GL7LocSchedExclItemCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7LocSchedExclItemCost split(java.util.Date splitDate) {
    return (entity.GL7LocSchedExclItemCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocSchedExclItemCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocSchedExclItemCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7LocSchedExclItemCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocSchedExclItemCost.class, config);
    com.guidewire._generated.entity.GL7LocSchedExclItemCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocSchedExclItemCost, com.guidewire._generated.entity.GL7LocSchedExclItemCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocSchedExclItemCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocSchedExclItemCostInternal getInternalInterface(entity.GL7LocSchedExclItemCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocSchedExclItemCost newEmptyInstance() {
        return new entity.GL7LocSchedExclItemCost((java.lang.Void)null);
      }

...
/**
 * GL7LocSchedExclItemCovCost
 * GL7 Location Exclusion Schedule Item Coverage Cost
 */
...
@gw.entity.EntityName(value = "GL7LocSchedExclItemCovCost")
public class GL7LocSchedExclItemCovCost extends entity.GL7LocSchedExclItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocSchedExclItemCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocSchedExclItemCovCost, entity.PolicyPeriod>("entity.GL7LocSchedExclItemCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> LOCSCHEDEXCLITEMCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "LocSchedExclItemCov");
   ...
   */
  public GL7LocSchedExclItemCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LocSchedExclItemCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocSchedExclItemCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LocSchedExclItemCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocSchedExclItemCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LocSchedExclItemCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7LocSchedExclItemCovCost clone() {
    return (entity.GL7LocSchedExclItemCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7LocSchedExclItemCovCost getBasedOn() {
    return (entity.GL7LocSchedExclItemCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocSchedExclItemCov getLocSchedExclItemCov() {
    return (entity.GL7LocSchedExclItemCov)__getInternalInterface().getFieldValue(LOCSCHEDEXCLITEMCOV_PROP.get());
  }
  
  public entity.GL7LocSchedExclItemCovCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocSchedExclItemCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LocSchedExclItemCovCost getUnsliced() {
    return (entity.GL7LocSchedExclItemCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LocSchedExclItemCovCostVersionList getVersionList() {
    return (entity.windowed.GL7LocSchedExclItemCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setLocSchedExclItemCov(entity.GL7LocSchedExclItemCov value) {
    __getInternalInterface().setFieldValue(LOCSCHEDEXCLITEMCOV_PROP.get(), value);
  }
  
  public entity.GL7LocSchedExclItemCovCost split(java.util.Date splitDate) {
    return (entity.GL7LocSchedExclItemCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocSchedExclItemCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocSchedExclItemCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getLocSchedExclItemCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(LOCSCHEDEXCLITEMCOV_PROP.get());
    }
    ...
    public void setLocSchedExclItemCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(LOCSCHEDEXCLITEMCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7LocSchedExclItemCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocSchedExclItemCovCost.class, config);
    com.guidewire._generated.entity.GL7LocSchedExclItemCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocSchedExclItemCovCost, com.guidewire._generated.entity.GL7LocSchedExclItemCovCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocSchedExclItemCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocSchedExclItemCovCostInternal getInternalInterface(entity.GL7LocSchedExclItemCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocSchedExclItemCovCost newEmptyInstance() {
        return new entity.GL7LocSchedExclItemCovCost((java.lang.Void)null);
      }

...
/**
 * GL7LocSchedExclItemExcl
 * GL7 Location level exclusion scheduled item with exclusion terms
 */
...
@gw.entity.EntityName(value = "GL7LocSchedExclItemExcl")
public class GL7LocSchedExclItemExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, entity.GL7Clause, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocSchedExclItemExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocSchedExclItemExcl, entity.PolicyPeriod>("entity.GL7LocSchedExclItemExcl");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GL7LOCATIONSCHEDEXCLITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GL7LocationSchedExclItem");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ID");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> LOCSCHEDEXCLITEMEXCLCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "LocSchedExclItemExclCosts");
  ...
  private com.guidewire._generated.entity.GL7LocSchedExclItemExclInternal _internal;
   ...
   */
  protected GL7LocSchedExclItemExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7LocSchedExclItemExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocSchedExclItemExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7LocSchedExclItemExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocSchedExclItemExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToLocSchedExclItemExclCosts(entity.GL7LocSchedExclItemExclCost element) {
    __getInternalInterface().addArrayElement(LOCSCHEDEXCLITEMEXCLCOSTS_PROP.get(), element);
  }
  ...
  public entity.GL7LocSchedExclItemExcl clone() {
    return (entity.GL7LocSchedExclItemExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7LocSchedExclItemExcl getBasedOn() {
    return (entity.GL7LocSchedExclItemExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocSchedExclItemExcl getBasedOnValue() {
    return (entity.GL7LocSchedExclItemExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7LocSchedExclItemExcl getFixed() {
    return (entity.GL7LocSchedExclItemExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7LocationSchedExclItem getGL7LocationSchedExclItem() {
    return (entity.GL7LocationSchedExclItem)__getInternalInterface().getFieldValue(GL7LOCATIONSCHEDEXCLITEM_PROP.get());
  }
  ...
  public entity.GL7LocSchedExclItemExclCost[] getLocSchedExclItemExclCosts() {
    return (entity.GL7LocSchedExclItemExclCost[])__getInternalInterface().getFieldValue(LOCSCHEDEXCLITEMEXCLCOSTS_PROP.get());
  }
  ...
  public entity.GL7LocSchedExclItemExcl getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocSchedExclItemExcl)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.GL7LocSchedExclItemExcl getSubtype() {
    return (typekey.GL7LocSchedExclItemExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.GL7LocSchedExclItemExcl getUnsliced() {
    return (entity.GL7LocSchedExclItemExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7LocSchedExclItemExclVersionList getVersionList() {
    return (entity.windowed.GL7LocSchedExclItemExclVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromLocSchedExclItemExclCosts(entity.GL7LocSchedExclItemExclCost element) {
    __getInternalInterface().removeArrayElement(LOCSCHEDEXCLITEMEXCLCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromLocSchedExclItemExclCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(LOCSCHEDEXCLITEMEXCLCOSTS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.GL7LocSchedExclItemExcl value) {
   ...
   */
  private void setFixed(entity.GL7LocSchedExclItemExcl value) {
  ...
  public void setGL7LocationSchedExclItem(entity.GL7LocationSchedExclItem value) {
    __getInternalInterface().setFieldValue(GL7LOCATIONSCHEDEXCLITEM_PROP.get(), value);
  }
  ...
  public void setLocSchedExclItemExclCosts(entity.GL7LocSchedExclItemExclCost[] value) {
    __getInternalInterface().setFieldValue(LOCSCHEDEXCLITEMEXCLCOSTS_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.GL7LocSchedExclItemExcl value) {
  ...
  public entity.GL7LocSchedExclItemExcl split(java.util.Date splitDate) {
    return (entity.GL7LocSchedExclItemExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocSchedExclItemExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocSchedExclItemExcl.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getGL7LocationSchedExclItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GL7LOCATIONSCHEDEXCLITEM_PROP.get());
    }
    ...
    public void setGL7LocationSchedExclItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(GL7LOCATIONSCHEDEXCLITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.schedules.GL7LocationSchedExclItemExclAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.schedules.GL7LocationSchedExclItemExclAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.gl7.schedules.GL7LocationSchedExclItemExclAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7LocationSchedExclItemExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7LocationSchedExclItemExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocSchedExclItemExcl.class, config);
    com.guidewire._generated.entity.GL7LocSchedExclItemExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocSchedExclItemExcl, com.guidewire._generated.entity.GL7LocSchedExclItemExclInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocSchedExclItemExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocSchedExclItemExclInternal getInternalInterface(entity.GL7LocSchedExclItemExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocSchedExclItemExcl newEmptyInstance() {
        return new entity.GL7LocSchedExclItemExcl((java.lang.Void)null);
      }

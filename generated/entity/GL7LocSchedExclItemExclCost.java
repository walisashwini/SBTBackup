...
/**
 * GL7LocSchedExclItemExclCost
 * GL7 Location Exclusion Schedule Item Exclusion Cost
 */
...
@gw.entity.EntityName(value = "GL7LocSchedExclItemExclCost")
public class GL7LocSchedExclItemExclCost extends entity.GL7LocSchedExclItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocSchedExclItemExclCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocSchedExclItemExclCost, entity.PolicyPeriod>("entity.GL7LocSchedExclItemExclCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> LOCSCHEDEXCLITEMEXCL_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "LocSchedExclItemExcl");
   ...
   */
  public GL7LocSchedExclItemExclCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LocSchedExclItemExclCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocSchedExclItemExclCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LocSchedExclItemExclCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocSchedExclItemExclCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LocSchedExclItemExclCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7LocSchedExclItemExclCost clone() {
    return (entity.GL7LocSchedExclItemExclCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7LocSchedExclItemExclCost getBasedOn() {
    return (entity.GL7LocSchedExclItemExclCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocSchedExclItemExcl getLocSchedExclItemExcl() {
    return (entity.GL7LocSchedExclItemExcl)__getInternalInterface().getFieldValue(LOCSCHEDEXCLITEMEXCL_PROP.get());
  }
  
  public entity.GL7LocSchedExclItemExclCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocSchedExclItemExclCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LocSchedExclItemExclCost getUnsliced() {
    return (entity.GL7LocSchedExclItemExclCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LocSchedExclItemExclCostVersionList getVersionList() {
    return (entity.windowed.GL7LocSchedExclItemExclCostVersionList)getVersionListUntyped();
  }
  ...
  public void setLocSchedExclItemExcl(entity.GL7LocSchedExclItemExcl value) {
    __getInternalInterface().setFieldValue(LOCSCHEDEXCLITEMEXCL_PROP.get(), value);
  }
  
  public entity.GL7LocSchedExclItemExclCost split(java.util.Date splitDate) {
    return (entity.GL7LocSchedExclItemExclCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocSchedExclItemExclCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocSchedExclItemExclCost.this.__getDelegateManager();
    }
    ...
    public entity.GL7LocationSchedExclItem getLocSchedExclItem() {
      return (entity.GL7LocationSchedExclItem)__getInternalInterface().getFieldValue(LOCSCHEDEXCLITEM_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getLocSchedExclItemExclID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(LOCSCHEDEXCLITEMEXCL_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getLocSchedExclItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(LOCSCHEDEXCLITEM_PROP.get());
    }
    ...
    public void setLocSchedExclItem(entity.GL7LocationSchedExclItem value) {
      __getInternalInterface().setFieldValue(LOCSCHEDEXCLITEM_PROP.get(), value);
    }
    ...
    public void setLocSchedExclItemExclID(gw.pl.persistence.core.Key value) {
      setFieldValue(LOCSCHEDEXCLITEMEXCL_PROP.get(), value);
    }
    
    public void setLocSchedExclItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(LOCSCHEDEXCLITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7LocSchedExclItemExclCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocSchedExclItemExclCost.class, config);
    com.guidewire._generated.entity.GL7LocSchedExclItemExclCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocSchedExclItemExclCost, com.guidewire._generated.entity.GL7LocSchedExclItemExclCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocSchedExclItemExclCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocSchedExclItemExclCostInternal getInternalInterface(entity.GL7LocSchedExclItemExclCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocSchedExclItemExclCost newEmptyInstance() {
        return new entity.GL7LocSchedExclItemExclCost((java.lang.Void)null);
      }

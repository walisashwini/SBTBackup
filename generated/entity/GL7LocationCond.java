...
/**
 * GL7LocationCond
 * Conditions directly attached to each GL7 Location
 */
...
@gw.entity.EntityName(value = "GL7LocationCond")
public class GL7LocationCond extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PolicyCondition, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocationCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocationCond, entity.PolicyPeriod>("entity.GL7LocationCond");
  ...
  private com.guidewire._generated.entity.GL7LocationCondInternal _internal;
   ...
   */
  protected GL7LocationCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7LocationCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocationCond(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7LocationCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocationCondInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7LocationCond clone() {
    return (entity.GL7LocationCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7LocationCond getBasedOn() {
    return (entity.GL7LocationCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocationCond getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocationCond)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7LocationCond getUnsliced() {
    return (entity.GL7LocationCond)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7LocationCondVersionList getVersionList() {
    return (entity.windowed.GL7LocationCondVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7LocationCond value) {
   ...
   */
  private void setFixed(entity.GL7LocationCond value) {
   ...
   */
  private void setSubtype(typekey.GL7LocationCond value) {
  ...
  public entity.GL7LocationCond split(java.util.Date splitDate) {
    return (entity.GL7LocationCond)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocationCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocationCond.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.GL7LocationCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.GL7LocationCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocationCond.class, config);
    com.guidewire._generated.entity.GL7LocationCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocationCond, com.guidewire._generated.entity.GL7LocationCondInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocationCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocationCondInternal getInternalInterface(entity.GL7LocationCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocationCond newEmptyInstance() {
        return new entity.GL7LocationCond((java.lang.Void)null);
      }

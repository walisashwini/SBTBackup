...
/**
 * GL7LocationCondCost
 * The cost for a Location Condition
 */
...
@gw.entity.EntityName(value = "GL7LocationCondCost")
public class GL7LocationCondCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocationCondCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocationCondCost, entity.PolicyPeriod>("entity.GL7LocationCondCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> LOCATIONCONDITION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "LocationCondition");
   ...
   */
  public GL7LocationCondCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LocationCondCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocationCondCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LocationCondCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocationCondCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LocationCondCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7LocationCondCost clone() {
    return (entity.GL7LocationCondCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7LocationCondCost getBasedOn() {
    return (entity.GL7LocationCondCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocationCond getLocationCondition() {
    return (entity.GL7LocationCond)__getInternalInterface().getFieldValue(LOCATIONCONDITION_PROP.get());
  }
  
  public entity.GL7LocationCondCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocationCondCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LocationCondCost getUnsliced() {
    return (entity.GL7LocationCondCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LocationCondCostVersionList getVersionList() {
    return (entity.windowed.GL7LocationCondCostVersionList)getVersionListUntyped();
  }
  ...
  public void setLocationCondition(entity.GL7LocationCond value) {
    __getInternalInterface().setFieldValue(LOCATIONCONDITION_PROP.get(), value);
  }
  
  public entity.GL7LocationCondCost split(java.util.Date splitDate) {
    return (entity.GL7LocationCondCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocationCondCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocationCondCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getLocationConditionID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(LOCATIONCONDITION_PROP.get());
    }
    ...
    public void setLocationConditionID(gw.pl.persistence.core.Key value) {
      setFieldValue(LOCATIONCONDITION_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7LocationCondCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocationCondCost.class, config);
    com.guidewire._generated.entity.GL7LocationCondCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocationCondCost, com.guidewire._generated.entity.GL7LocationCondCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocationCondCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocationCondCostInternal getInternalInterface(entity.GL7LocationCondCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocationCondCost newEmptyInstance() {
        return new entity.GL7LocationCondCost((java.lang.Void)null);
      }

...
/**
 * GL7LocationCov
 * Coverages directly attached to each GL7 Location
 */
...
@gw.entity.EntityName(value = "GL7LocationCov")
public class GL7LocationCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocationCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocationCov, entity.PolicyPeriod>("entity.GL7LocationCov");
  ...
  private com.guidewire._generated.entity.GL7LocationCovInternal _internal;
   ...
   */
  protected GL7LocationCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7LocationCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocationCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7LocationCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocationCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7LocationCov clone() {
    return (entity.GL7LocationCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7LocationCov getBasedOn() {
    return (entity.GL7LocationCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocationCov getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocationCov)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7LocationCov getUnsliced() {
    return (entity.GL7LocationCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7LocationCovVersionList getVersionList() {
    return (entity.windowed.GL7LocationCovVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7LocationCov value) {
   ...
   */
  private void setFixed(entity.GL7LocationCov value) {
   ...
   */
  private void setSubtype(typekey.GL7LocationCov value) {
  ...
  public entity.GL7LocationCov split(java.util.Date splitDate) {
    return (entity.GL7LocationCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocationCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocationCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.GL7LocationCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.GL7LocationCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocationCov.class, config);
    com.guidewire._generated.entity.GL7LocationCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocationCov, com.guidewire._generated.entity.GL7LocationCovInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocationCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocationCovInternal getInternalInterface(entity.GL7LocationCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocationCov newEmptyInstance() {
        return new entity.GL7LocationCov((java.lang.Void)null);
      }

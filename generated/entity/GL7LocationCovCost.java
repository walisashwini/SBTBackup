...
/**
 * GL7LocationCovCost
 * The cost for a Location Coverage
 */
...
@gw.entity.EntityName(value = "GL7LocationCovCost")
public class GL7LocationCovCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocationCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocationCovCost, entity.PolicyPeriod>("entity.GL7LocationCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> LOCATIONCOVERAGE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "LocationCoverage");
   ...
   */
  public GL7LocationCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LocationCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocationCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LocationCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocationCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LocationCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7LocationCovCost clone() {
    return (entity.GL7LocationCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7LocationCovCost getBasedOn() {
    return (entity.GL7LocationCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocationCov getLocationCoverage() {
    return (entity.GL7LocationCov)__getInternalInterface().getFieldValue(LOCATIONCOVERAGE_PROP.get());
  }
  
  public entity.GL7LocationCovCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocationCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LocationCovCost getUnsliced() {
    return (entity.GL7LocationCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LocationCovCostVersionList getVersionList() {
    return (entity.windowed.GL7LocationCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setLocationCoverage(entity.GL7LocationCov value) {
    __getInternalInterface().setFieldValue(LOCATIONCOVERAGE_PROP.get(), value);
  }
  
  public entity.GL7LocationCovCost split(java.util.Date splitDate) {
    return (entity.GL7LocationCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocationCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocationCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getLocationCoverageID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(LOCATIONCOVERAGE_PROP.get());
    }
    ...
    public void setLocationCoverageID(gw.pl.persistence.core.Key value) {
      setFieldValue(LOCATIONCOVERAGE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7LocationCovCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocationCovCost.class, config);
    com.guidewire._generated.entity.GL7LocationCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocationCovCost, com.guidewire._generated.entity.GL7LocationCovCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocationCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocationCovCostInternal getInternalInterface(entity.GL7LocationCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocationCovCost newEmptyInstance() {
        return new entity.GL7LocationCovCost((java.lang.Void)null);
      }

...
/**
 * GL7LocationExcl
 * Exclusions directly attached to each GL7 Location
 */
...
@gw.entity.EntityName(value = "GL7LocationExcl")
public class GL7LocationExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocationExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocationExcl, entity.PolicyPeriod>("entity.GL7LocationExcl");
  ...
  private com.guidewire._generated.entity.GL7LocationExclInternal _internal;
   ...
   */
  protected GL7LocationExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7LocationExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocationExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7LocationExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocationExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7LocationExcl clone() {
    return (entity.GL7LocationExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7LocationExcl getBasedOn() {
    return (entity.GL7LocationExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocationExcl getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocationExcl)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7LocationExcl getUnsliced() {
    return (entity.GL7LocationExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7LocationExclVersionList getVersionList() {
    return (entity.windowed.GL7LocationExclVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7LocationExcl value) {
   ...
   */
  private void setFixed(entity.GL7LocationExcl value) {
   ...
   */
  private void setSubtype(typekey.GL7LocationExcl value) {
  ...
  public entity.GL7LocationExcl split(java.util.Date splitDate) {
    return (entity.GL7LocationExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocationExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocationExcl.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.GL7LocationExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.GL7LocationExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocationExcl.class, config);
    com.guidewire._generated.entity.GL7LocationExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocationExcl, com.guidewire._generated.entity.GL7LocationExclInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocationExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocationExclInternal getInternalInterface(entity.GL7LocationExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocationExcl newEmptyInstance() {
        return new entity.GL7LocationExcl((java.lang.Void)null);
      }

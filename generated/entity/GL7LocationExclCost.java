...
/**
 * GL7LocationExclCost
 * The cost for a Location Exclusion
 */
...
@gw.entity.EntityName(value = "GL7LocationExclCost")
public class GL7LocationExclCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocationExclCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocationExclCost, entity.PolicyPeriod>("entity.GL7LocationExclCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> LOCATIONEXCLUSION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "LocationExclusion");
   ...
   */
  public GL7LocationExclCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LocationExclCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocationExclCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LocationExclCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocationExclCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LocationExclCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7LocationExclCost clone() {
    return (entity.GL7LocationExclCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7LocationExclCost getBasedOn() {
    return (entity.GL7LocationExclCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocationExcl getLocationExclusion() {
    return (entity.GL7LocationExcl)__getInternalInterface().getFieldValue(LOCATIONEXCLUSION_PROP.get());
  }
  
  public entity.GL7LocationExclCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocationExclCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LocationExclCost getUnsliced() {
    return (entity.GL7LocationExclCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LocationExclCostVersionList getVersionList() {
    return (entity.windowed.GL7LocationExclCostVersionList)getVersionListUntyped();
  }
  ...
  public void setLocationExclusion(entity.GL7LocationExcl value) {
    __getInternalInterface().setFieldValue(LOCATIONEXCLUSION_PROP.get(), value);
  }
  
  public entity.GL7LocationExclCost split(java.util.Date splitDate) {
    return (entity.GL7LocationExclCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocationExclCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocationExclCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getLocationExclusionID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(LOCATIONEXCLUSION_PROP.get());
    }
    ...
    public void setLocationExclusionID(gw.pl.persistence.core.Key value) {
      setFieldValue(LOCATIONEXCLUSION_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7LocationExclCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocationExclCost.class, config);
    com.guidewire._generated.entity.GL7LocationExclCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocationExclCost, com.guidewire._generated.entity.GL7LocationExclCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocationExclCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocationExclCostInternal getInternalInterface(entity.GL7LocationExclCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocationExclCost newEmptyInstance() {
        return new entity.GL7LocationExclCost((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "GL7LocationMod")
public class GL7LocationMod extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Modifier, gw.api.copier.EffDatedCopyable {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocationMod, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocationMod, entity.PolicyPeriod>("entity.GL7LocationMod");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> GL7LOCATIONRATEFACTORS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "GL7LocationRateFactors");
  ...
  private com.guidewire._generated.entity.GL7LocationModInternal _internal;
   ...
   */
  public GL7LocationMod(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LocationMod(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocationMod(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7LocationModInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocationModInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToGL7LocationRateFactors(entity.GL7LocationRF element) {
    __getInternalInterface().addArrayElement(GL7LOCATIONRATEFACTORS_PROP.get(), element);
  }
  ...
  public entity.GL7LocationMod clone() {
    return (entity.GL7LocationMod)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7LocationMod getBasedOn() {
    return (entity.GL7LocationMod)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocationMod getBasedOnValue() {
    return (entity.GL7LocationMod)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7LocationMod getFixed() {
    return (entity.GL7LocationMod)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7LocationRF[] getGL7LocationRateFactors() {
    return (entity.GL7LocationRF[])__getInternalInterface().getFieldValue(GL7LOCATIONRATEFACTORS_PROP.get());
  }
  ...
  public entity.GL7LocationMod getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocationMod)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.GL7LocationMod getSubtype() {
    return (typekey.GL7LocationMod)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.GL7LocationMod getUnsliced() {
    return (entity.GL7LocationMod)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7LocationModVersionList getVersionList() {
    return (entity.windowed.GL7LocationModVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromGL7LocationRateFactors(entity.GL7LocationRF element) {
    __getInternalInterface().removeArrayElement(GL7LOCATIONRATEFACTORS_PROP.get(), element);
  }
  ...
  public void removeFromGL7LocationRateFactors(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(GL7LOCATIONRATEFACTORS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.GL7LocationMod value) {
   ...
   */
  private void setFixed(entity.GL7LocationMod value) {
  ...
  public void setGL7LocationRateFactors(entity.GL7LocationRF[] value) {
    __getInternalInterface().setFieldValue(GL7LOCATIONRATEFACTORS_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.GL7LocationMod value) {
  ...
  public entity.GL7LocationMod split(java.util.Date splitDate) {
    return (entity.GL7LocationMod)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocationModInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocationMod.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ModifierAbstractDomainMethods", "gw.lob.gl7.GL7LocationModifierAdapter");
    config.put("gw.api.domain.ModifierAdapter", "gw.lob.gl7.GL7LocationModifierAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocationMod.class, config);
    com.guidewire._generated.entity.GL7LocationModInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocationMod, com.guidewire._generated.entity.GL7LocationModInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocationMod bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocationModInternal getInternalInterface(entity.GL7LocationMod bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocationMod newEmptyInstance() {
        return new entity.GL7LocationMod((java.lang.Void)null);
      }

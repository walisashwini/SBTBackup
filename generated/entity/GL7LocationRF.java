...
@gw.entity.EntityName(value = "GL7LocationRF")
public class GL7LocationRF extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.RateFactor, gw.api.copier.EffDatedCopyable {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocationRF, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocationRF, entity.PolicyPeriod>("entity.GL7LocationRF");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GL7LOCATIONMODIFIER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GL7LocationModifier");
  ...
  private com.guidewire._generated.entity.GL7LocationRFInternal _internal;
   ...
   */
  public GL7LocationRF(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7LocationRF(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocationRF(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7LocationRFInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocationRFInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7LocationRF clone() {
    return (entity.GL7LocationRF)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7LocationRF getBasedOn() {
    return (entity.GL7LocationRF)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocationRF getBasedOnValue() {
    return (entity.GL7LocationRF)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7LocationRF getFixed() {
    return (entity.GL7LocationRF)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7LocationMod getGL7LocationModifier() {
    return (entity.GL7LocationMod)__getInternalInterface().getFieldValue(GL7LOCATIONMODIFIER_PROP.get());
  }
  ...
  public entity.GL7LocationRF getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocationRF)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7LocationRF getUnsliced() {
    return (entity.GL7LocationRF)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7LocationRFVersionList getVersionList() {
    return (entity.windowed.GL7LocationRFVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7LocationRF value) {
   ...
   */
  private void setFixed(entity.GL7LocationRF value) {
  ...
  public void setGL7LocationModifier(entity.GL7LocationMod value) {
    __getInternalInterface().setFieldValue(GL7LOCATIONMODIFIER_PROP.get(), value);
  }
  ...
  public entity.GL7LocationRF split(java.util.Date splitDate) {
    return (entity.GL7LocationRF)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocationRFInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocationRF.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getGL7LocationModifierID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GL7LOCATIONMODIFIER_PROP.get());
    }
    ...
    public void setGL7LocationModifierID(gw.pl.persistence.core.Key value) {
      setFieldValue(GL7LOCATIONMODIFIER_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.RateFactorAdapter", "gw.lob.gl7.GL7LocationRateFactorAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocationRF.class, config);
    com.guidewire._generated.entity.GL7LocationRFInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocationRF, com.guidewire._generated.entity.GL7LocationRFInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocationRF bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocationRFInternal getInternalInterface(entity.GL7LocationRF bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocationRF newEmptyInstance() {
        return new entity.GL7LocationRF((java.lang.Void)null);
      }

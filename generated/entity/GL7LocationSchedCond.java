...
/**
 * GL7LocationSchedCond
 * GL7Location Condition with a schedule
 */
...
@gw.entity.EntityName(value = "GL7LocationSchedCond")
public class GL7LocationSchedCond extends entity.GL7LocationCond implements entity.ScheduleAutoNumberSequence, gw.api.copier.EffDatedCopyable, gw.api.domain.Schedule, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocationSchedCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocationSchedCond, entity.PolicyPeriod>("entity.GL7LocationSchedCond");
   ...
   */
  protected GL7LocationSchedCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7LocationSchedCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocationSchedCond(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LocationSchedCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocationSchedCondInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LocationSchedCondInternal)super.__getInternalInterface();
  }
  ...
  public entity.GL7LocationSchedCond clone() {
    return (entity.GL7LocationSchedCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7LocationSchedCond getBasedOn() {
    return (entity.GL7LocationSchedCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocationSchedCondItem[] getGL7ScheduledItems() {
    return (entity.GL7LocationSchedCondItem[])__getInternalInterface().getFieldValue(GL7SCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.GL7LocationSchedCond getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocationSchedCond)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LocationSchedCond getUnsliced() {
    return (entity.GL7LocationSchedCond)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LocationSchedCondVersionList getVersionList() {
    return (entity.windowed.GL7LocationSchedCondVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7LocationSchedCond split(java.util.Date splitDate) {
    return (entity.GL7LocationSchedCond)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocationSchedCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocationSchedCond.this.__getDelegateManager();
    }
    ...
    public entity.GL7LocationCond getBasedOnValue() {
      return (entity.GL7LocationCond)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public entity.GL7LocationCondCost[] getCosts() {
      return (entity.GL7LocationCondCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
    }
    ...
    public entity.GL7LocationCond getFixed() {
      return (entity.GL7LocationCond)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public typekey.GL7LocationCond getSubtype() {
      return (typekey.GL7LocationCond)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.GL7LocationCondConditionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.GL7LocationCondConditionAdapter");
    config.put("gw.api.domain.PolicyConditionAdapter", "gw.lob.gl7.GL7LocationCondConditionAdapter");
    config.put("gw.api.domain.Schedule", "gw.lob.gl7.schedules.GL7LocationSchedCondImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7LocationSchedCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7LocationSchedCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocationSchedCond.class, config);
    com.guidewire._generated.entity.GL7LocationSchedCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocationSchedCond, com.guidewire._generated.entity.GL7LocationSchedCondInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocationSchedCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocationSchedCondInternal getInternalInterface(entity.GL7LocationSchedCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocationSchedCond newEmptyInstance() {
        return new entity.GL7LocationSchedCond((java.lang.Void)null);
      }

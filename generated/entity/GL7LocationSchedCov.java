...
/**
 * GL7LocationSchedCov
 * GL7Location Coverage with a schedule
 */
...
@gw.entity.EntityName(value = "GL7LocationSchedCov")
public class GL7LocationSchedCov extends entity.GL7LocationCov implements entity.ScheduleAutoNumberSequence, gw.api.copier.EffDatedCopyable, gw.api.domain.Schedule, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocationSchedCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocationSchedCov, entity.PolicyPeriod>("entity.GL7LocationSchedCov");
   ...
   */
  protected GL7LocationSchedCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7LocationSchedCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocationSchedCov(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LocationSchedCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocationSchedCovInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LocationSchedCovInternal)super.__getInternalInterface();
  }
  ...
  public entity.GL7LocationSchedCov clone() {
    return (entity.GL7LocationSchedCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7LocationSchedCov getBasedOn() {
    return (entity.GL7LocationSchedCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocationSchedCovItem[] getGL7ScheduledItems() {
    return (entity.GL7LocationSchedCovItem[])__getInternalInterface().getFieldValue(GL7SCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.GL7LocationSchedCov getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocationSchedCov)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LocationSchedCov getUnsliced() {
    return (entity.GL7LocationSchedCov)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LocationSchedCovVersionList getVersionList() {
    return (entity.windowed.GL7LocationSchedCovVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7LocationSchedCov split(java.util.Date splitDate) {
    return (entity.GL7LocationSchedCov)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocationSchedCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocationSchedCov.this.__getDelegateManager();
    }
    ...
    public entity.GL7LocationCov getBasedOnValue() {
      return (entity.GL7LocationCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public entity.GL7LocationCovCost[] getCosts() {
      return (entity.GL7LocationCovCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
    }
    ...
    public entity.GL7LocationCov getFixed() {
      return (entity.GL7LocationCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public typekey.GL7LocationCov getSubtype() {
      return (typekey.GL7LocationCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.GL7LocationCovCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.GL7LocationCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.gl7.GL7LocationCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.gl7.GL7LocationCovCoverageAdapter");
    config.put("gw.api.domain.Schedule", "gw.lob.gl7.schedules.GL7LocationSchedCovImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7LocationSchedCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7LocationSchedCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocationSchedCov.class, config);
    com.guidewire._generated.entity.GL7LocationSchedCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocationSchedCov, com.guidewire._generated.entity.GL7LocationSchedCovInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocationSchedCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocationSchedCovInternal getInternalInterface(entity.GL7LocationSchedCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocationSchedCov newEmptyInstance() {
        return new entity.GL7LocationSchedCov((java.lang.Void)null);
      }

...
/**
 * GL7LocationSchedExcl
 * GL7 Condition with a schedule
 */
...
@gw.entity.EntityName(value = "GL7LocationSchedExcl")
public class GL7LocationSchedExcl extends entity.GL7LocationExcl implements entity.ScheduleAutoNumberSequence, gw.api.copier.EffDatedCopyable, gw.api.domain.Schedule, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7LocationSchedExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7LocationSchedExcl, entity.PolicyPeriod>("entity.GL7LocationSchedExcl");
   ...
   */
  protected GL7LocationSchedExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7LocationSchedExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7LocationSchedExcl(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7LocationSchedExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LocationSchedExclInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7LocationSchedExclInternal)super.__getInternalInterface();
  }
  ...
  public entity.GL7LocationSchedExcl clone() {
    return (entity.GL7LocationSchedExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7LocationSchedExcl getBasedOn() {
    return (entity.GL7LocationSchedExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7LocationSchedExclItem[] getGL7ScheduledItems() {
    return (entity.GL7LocationSchedExclItem[])__getInternalInterface().getFieldValue(GL7SCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.GL7LocationSchedExcl getSlice(java.util.Date sliceDate) {
    return (entity.GL7LocationSchedExcl)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7LocationSchedExcl getUnsliced() {
    return (entity.GL7LocationSchedExcl)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7LocationSchedExclVersionList getVersionList() {
    return (entity.windowed.GL7LocationSchedExclVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7LocationSchedExcl split(java.util.Date splitDate) {
    return (entity.GL7LocationSchedExcl)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LocationSchedExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LocationSchedExcl.this.__getDelegateManager();
    }
     ...
     */
    public void addToCosts(entity.GL7LocationExclCost element) {
     ...
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public entity.GL7LocationExcl getBasedOnValue() {
      return (entity.GL7LocationExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
     ...
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public entity.GL7LocationExclCost[] getCosts() {
      return (entity.GL7LocationExclCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
    }
     ...
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public entity.GL7LocationExcl getFixed() {
      return (entity.GL7LocationExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
     ...
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public typekey.GL7LocationExcl getSubtype() {
      return (typekey.GL7LocationExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
     ...
     */
    public void removeFromCosts(entity.GL7LocationExclCost element) {
     ...
     */
    public void setBasedOnValue(entity.GL7LocationExcl value) {
     ...
     */
    public void setCosts(entity.GL7LocationExclCost[] value) {
     ...
     */
    public void setFixed(entity.GL7LocationExcl value) {
     ...
     */
    public void setSubtype(typekey.GL7LocationExcl value) {
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.GL7LocationExclExclusionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.GL7LocationExclExclusionAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.gl7.GL7LocationExclExclusionAdapter");
    config.put("gw.api.domain.Schedule", "gw.lob.gl7.schedules.GL7LocationSchedExclImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7LocationSchedExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7LocationSchedExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LocationSchedExcl.class, config);
    com.guidewire._generated.entity.GL7LocationSchedExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LocationSchedExcl, com.guidewire._generated.entity.GL7LocationSchedExclInternal>() {
      public java.lang.Object getImplementation(entity.GL7LocationSchedExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LocationSchedExclInternal getInternalInterface(entity.GL7LocationSchedExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LocationSchedExcl newEmptyInstance() {
        return new entity.GL7LocationSchedExcl((java.lang.Void)null);
      }

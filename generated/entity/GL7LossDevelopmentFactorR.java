...
@gw.entity.EntityName(value = "GL7LossDevelopmentFactorR")
public class GL7LossDevelopmentFactorR extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7LossDevelopmentFactorR> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7LossDevelopmentFactorR>("entity.GL7LossDevelopmentFactorR");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MATURITYMONTHS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "MaturityMonths");
  ...
  private com.guidewire._generated.entity.GL7LossDevelopmentFactorRInternal _internal;
   ...
   */
  public GL7LossDevelopmentFactorR()  {
   ...
   */
  public GL7LossDevelopmentFactorR(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7LossDevelopmentFactorR(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7LossDevelopmentFactorRInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7LossDevelopmentFactorRInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.Integer getMaturityMonths() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(MATURITYMONTHS_PROP.get());
  }
  ...
  public void setMaturityMonths(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(MATURITYMONTHS_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7LossDevelopmentFactorRInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7LossDevelopmentFactorR.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7LossDevelopmentFactorR.class, config);
    com.guidewire._generated.entity.GL7LossDevelopmentFactorRInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7LossDevelopmentFactorR, com.guidewire._generated.entity.GL7LossDevelopmentFactorRInternal>() {
      public java.lang.Object getImplementation(entity.GL7LossDevelopmentFactorR bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7LossDevelopmentFactorRInternal getInternalInterface(entity.GL7LossDevelopmentFactorR bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7LossDevelopmentFactorR newEmptyInstance() {
        return new entity.GL7LossDevelopmentFactorR((java.lang.Void)null);
      }

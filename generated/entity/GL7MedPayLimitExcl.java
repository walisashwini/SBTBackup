 ...
 * GL7MedPayLimitExcl
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7MedPayLimitExcl.eti;GL7MedPayLimitExcl.eix;GL7MedPayLimitExcl.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7MedPayLimitExcl")
public class GL7MedPayLimitExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7MedPayLimitExcl> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7MedPayLimitExcl>("entity.GL7MedPayLimitExcl");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MEDPAYEXCL_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "MedPayExcl");
  ...
  private com.guidewire._generated.entity.GL7MedPayLimitExclInternal _internal;
   ...
   */
  public GL7MedPayLimitExcl(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7MedPayLimitExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7MedPayLimitExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7MedPayLimitExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Gets the value of the MedPayExcl field.
   * MedicalPaymentsExcl
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getMedPayExcl() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(MEDPAYEXCL_PROP.get());
  }
  ...
  /**
   * Sets the value of the MedPayExcl field.
   */
  public void setMedPayExcl(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(MEDPAYEXCL_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7MedPayLimitExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7MedPayLimitExcl.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7MedPayLimitExcl.class, config);
    com.guidewire._generated.entity.GL7MedPayLimitExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7MedPayLimitExcl, com.guidewire._generated.entity.GL7MedPayLimitExclInternal>() {
      public java.lang.Object getImplementation(entity.GL7MedPayLimitExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7MedPayLimitExclInternal getInternalInterface(entity.GL7MedPayLimitExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7MedPayLimitExcl newEmptyInstance() {
        return new entity.GL7MedPayLimitExcl((java.lang.Void)null);
      }

...
/**
 * GL7NumPassgrFreightTrains
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7NumPassgrFreightTrains.eti;GL7NumPassgrFreightTrains.eix;GL7NumPassgrFreightTrains.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7NumPassgrFreightTrains")
public class GL7NumPassgrFreightTrains extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7NumPassgrFreightTrains> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7NumPassgrFreightTrains>("entity.GL7NumPassgrFreightTrains");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BEANVERSION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BeanVersion");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CLASSCODERAILROAD_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ClassCodeRailroad");
  ...
  private com.guidewire._generated.entity.GL7NumPassgrFreightTrainsInternal _internal;
   ...
   */
  public GL7NumPassgrFreightTrains()  {
   ...
   */
  public GL7NumPassgrFreightTrains(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7NumPassgrFreightTrains(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7NumPassgrFreightTrainsInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7NumPassgrFreightTrainsInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Gets the value of the ClassCodeRailroad field.
   * ClassCodeRailroad
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getClassCodeRailroad() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CLASSCODERAILROAD_PROP.get());
  }
  ...
  /**
   * Sets the value of the ClassCodeRailroad field.
   */
  public void setClassCodeRailroad(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CLASSCODERAILROAD_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7NumPassgrFreightTrainsInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7NumPassgrFreightTrains.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7NumPassgrFreightTrains.class, config);
    com.guidewire._generated.entity.GL7NumPassgrFreightTrainsInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7NumPassgrFreightTrains, com.guidewire._generated.entity.GL7NumPassgrFreightTrainsInternal>() {
      public java.lang.Object getImplementation(entity.GL7NumPassgrFreightTrains bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7NumPassgrFreightTrainsInternal getInternalInterface(entity.GL7NumPassgrFreightTrains bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7NumPassgrFreightTrains newEmptyInstance() {
        return new entity.GL7NumPassgrFreightTrains((java.lang.Void)null);
      }

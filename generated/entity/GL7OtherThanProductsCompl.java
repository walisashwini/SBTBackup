...
/**
 * GL7OtherThanProductsCompl
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7OtherThanProductsCompl.eti;GL7OtherThanProductsCompl.eix;GL7OtherThanProductsCompl.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7OtherThanProductsCompl")
public class GL7OtherThanProductsCompl extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7OtherThanProductsCompl> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7OtherThanProductsCompl>("entity.GL7OtherThanProductsCompl");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BEANVERSION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BeanVersion");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CLASSDESCRIPTIONCGLPRODS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ClassDescriptionCGLProds");
  ...
  private com.guidewire._generated.entity.GL7OtherThanProductsComplInternal _internal;
   ...
   */
  public GL7OtherThanProductsCompl()  {
   ...
   */
  public GL7OtherThanProductsCompl(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7OtherThanProductsCompl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7OtherThanProductsComplInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7OtherThanProductsComplInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Gets the value of the ClassDescriptionCGLProds field.
   * ClassDescriptionCGLProds
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getClassDescriptionCGLProds() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CLASSDESCRIPTIONCGLPRODS_PROP.get());
  }
  ...
  /**
   * Sets the value of the ClassDescriptionCGLProds field.
   */
  public void setClassDescriptionCGLProds(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CLASSDESCRIPTIONCGLPRODS_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7OtherThanProductsComplInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7OtherThanProductsCompl.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7OtherThanProductsCompl.class, config);
    com.guidewire._generated.entity.GL7OtherThanProductsComplInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7OtherThanProductsCompl, com.guidewire._generated.entity.GL7OtherThanProductsComplInternal>() {
      public java.lang.Object getImplementation(entity.GL7OtherThanProductsCompl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7OtherThanProductsComplInternal getInternalInterface(entity.GL7OtherThanProductsCompl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7OtherThanProductsCompl newEmptyInstance() {
        return new entity.GL7OtherThanProductsCompl((java.lang.Void)null);
      }

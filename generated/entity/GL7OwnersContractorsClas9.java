...
/**
 * GL7OwnersContractorsClas9
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7OwnersContractorsClas9.eti;GL7OwnersContractorsClas9.eix;GL7OwnersContractorsClas9.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7OwnersContractorsClas9")
public class GL7OwnersContractorsClas9 extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7OwnersContractorsClas9> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7OwnersContractorsClas9>("entity.GL7OwnersContractorsClas9");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> OWNERSCONTRACTORSCLASSCODEFORC_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "OwnersContractorsClassCodeForC");
  ...
  private com.guidewire._generated.entity.GL7OwnersContractorsClas9Internal _internal;
   ...
   */
  public GL7OwnersContractorsClas9()  {
   ...
   */
  public GL7OwnersContractorsClas9(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7OwnersContractorsClas9(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7OwnersContractorsClas9Internal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7OwnersContractorsClas9Internal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Gets the value of the OwnersContractorsClassCodeForC field.
   * OwnersContractorsClassCodeForClassDescription
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getOwnersContractorsClassCodeForC() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(OWNERSCONTRACTORSCLASSCODEFORC_PROP.get());
  }
  ...
  /**
   * Sets the value of the OwnersContractorsClassCodeForC field.
   */
  public void setOwnersContractorsClassCodeForC(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(OWNERSCONTRACTORSCLASSCODEFORC_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7OwnersContractorsClas9Internal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7OwnersContractorsClas9.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7OwnersContractorsClas9.class, config);
    com.guidewire._generated.entity.GL7OwnersContractorsClas9InternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7OwnersContractorsClas9, com.guidewire._generated.entity.GL7OwnersContractorsClas9Internal>() {
      public java.lang.Object getImplementation(entity.GL7OwnersContractorsClas9 bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7OwnersContractorsClas9Internal getInternalInterface(entity.GL7OwnersContractorsClas9 bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7OwnersContractorsClas9 newEmptyInstance() {
        return new entity.GL7OwnersContractorsClas9((java.lang.Void)null);
      }

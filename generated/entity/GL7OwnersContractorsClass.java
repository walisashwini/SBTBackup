...
/**
 * GL7OwnersContractorsClass
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7OwnersContractorsClass.eti;GL7OwnersContractorsClass.eix;GL7OwnersContractorsClass.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7OwnersContractorsClass")
public class GL7OwnersContractorsClass extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7OwnersContractorsClass> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7OwnersContractorsClass>("entity.GL7OwnersContractorsClass");
  ...
  private com.guidewire._generated.entity.GL7OwnersContractorsClassInternal _internal;
   ...
   */
  public GL7OwnersContractorsClass()  {
   ...
   */
  public GL7OwnersContractorsClass(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7OwnersContractorsClass(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7OwnersContractorsClassInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7OwnersContractorsClassInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7OwnersContractorsClassInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7OwnersContractorsClass.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7OwnersContractorsClass.class, config);
    com.guidewire._generated.entity.GL7OwnersContractorsClassInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7OwnersContractorsClass, com.guidewire._generated.entity.GL7OwnersContractorsClassInternal>() {
      public java.lang.Object getImplementation(entity.GL7OwnersContractorsClass bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7OwnersContractorsClassInternal getInternalInterface(entity.GL7OwnersContractorsClass bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7OwnersContractorsClass newEmptyInstance() {
        return new entity.GL7OwnersContractorsClass((java.lang.Void)null);
      }

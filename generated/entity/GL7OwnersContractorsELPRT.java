...
/**
 * GL7OwnersContractorsELPRT
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7OwnersContractorsELPRT.eti;GL7OwnersContractorsELPRT.eix;GL7OwnersContractorsELPRT.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7OwnersContractorsELPRT")
public class GL7OwnersContractorsELPRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7OwnersContractorsELPRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7OwnersContractorsELPRT>("entity.GL7OwnersContractorsELPRT");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BEANVERSION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BeanVersion");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CLASSCODEOWNERSCONTRCTRS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ClassCodeOwnersContrctrs");
  ...
  private com.guidewire._generated.entity.GL7OwnersContractorsELPRTInternal _internal;
   ...
   */
  public GL7OwnersContractorsELPRT()  {
   ...
   */
  public GL7OwnersContractorsELPRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7OwnersContractorsELPRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7OwnersContractorsELPRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7OwnersContractorsELPRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Gets the value of the ClassCodeOwnersContrctrs field.
   * ClassCodeOwnersContrctrs
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getClassCodeOwnersContrctrs() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CLASSCODEOWNERSCONTRCTRS_PROP.get());
  }
  ...
  /**
   * Sets the value of the ClassCodeOwnersContrctrs field.
   */
  public void setClassCodeOwnersContrctrs(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CLASSCODEOWNERSCONTRCTRS_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7OwnersContractorsELPRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7OwnersContractorsELPRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7OwnersContractorsELPRT.class, config);
    com.guidewire._generated.entity.GL7OwnersContractorsELPRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7OwnersContractorsELPRT, com.guidewire._generated.entity.GL7OwnersContractorsELPRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7OwnersContractorsELPRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7OwnersContractorsELPRTInternal getInternalInterface(entity.GL7OwnersContractorsELPRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7OwnersContractorsELPRT newEmptyInstance() {
        return new entity.GL7OwnersContractorsELPRT((java.lang.Void)null);
      }

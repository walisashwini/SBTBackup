...
/**
 * GL7OwnersContractorsELPTe
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7OwnersContractorsELPTe.eti;GL7OwnersContractorsELPTe.eix;GL7OwnersContractorsELPTe.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7OwnersContractorsELPTe")
public class GL7OwnersContractorsELPTe extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7OwnersContractorsELPTe> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7OwnersContractorsELPTe>("entity.GL7OwnersContractorsELPTe");
  ...
  private com.guidewire._generated.entity.GL7OwnersContractorsELPTeInternal _internal;
   ...
   */
  public GL7OwnersContractorsELPTe()  {
   ...
   */
  public GL7OwnersContractorsELPTe(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7OwnersContractorsELPTe(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7OwnersContractorsELPTeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7OwnersContractorsELPTeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7OwnersContractorsELPTeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7OwnersContractorsELPTe.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7OwnersContractorsELPTe.class, config);
    com.guidewire._generated.entity.GL7OwnersContractorsELPTeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7OwnersContractorsELPTe, com.guidewire._generated.entity.GL7OwnersContractorsELPTeInternal>() {
      public java.lang.Object getImplementation(entity.GL7OwnersContractorsELPTe bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7OwnersContractorsELPTeInternal getInternalInterface(entity.GL7OwnersContractorsELPTe bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7OwnersContractorsELPTe newEmptyInstance() {
        return new entity.GL7OwnersContractorsELPTe((java.lang.Void)null);
      }

...
/**
 * GL7OwnersContractorsTerr
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7OwnersContractorsTerr.eti;GL7OwnersContractorsTerr.eix;GL7OwnersContractorsTerr.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7OwnersContractorsTerr")
public class GL7OwnersContractorsTerr extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7OwnersContractorsTerr> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7OwnersContractorsTerr>("entity.GL7OwnersContractorsTerr");
  ...
  private com.guidewire._generated.entity.GL7OwnersContractorsTerrInternal _internal;
   ...
   */
  public GL7OwnersContractorsTerr()  {
   ...
   */
  public GL7OwnersContractorsTerr(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7OwnersContractorsTerr(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7OwnersContractorsTerrInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7OwnersContractorsTerrInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7OwnersContractorsTerrInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7OwnersContractorsTerr.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7OwnersContractorsTerr.class, config);
    com.guidewire._generated.entity.GL7OwnersContractorsTerrInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7OwnersContractorsTerr, com.guidewire._generated.entity.GL7OwnersContractorsTerrInternal>() {
      public java.lang.Object getImplementation(entity.GL7OwnersContractorsTerr bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7OwnersContractorsTerrInternal getInternalInterface(entity.GL7OwnersContractorsTerr bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7OwnersContractorsTerr newEmptyInstance() {
        return new entity.GL7OwnersContractorsTerr((java.lang.Void)null);
      }

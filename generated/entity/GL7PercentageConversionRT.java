...
@gw.entity.EntityName(value = "GL7PercentageConversionRT")
public class GL7PercentageConversionRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7PercentageConversionRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7PercentageConversionRT>("entity.GL7PercentageConversionRT");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PERCENTAGETEXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PercentageText");
  ...
  private com.guidewire._generated.entity.GL7PercentageConversionRTInternal _internal;
   ...
   */
  public GL7PercentageConversionRT()  {
   ...
   */
  public GL7PercentageConversionRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7PercentageConversionRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7PercentageConversionRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7PercentageConversionRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.String getPercentageText() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(PERCENTAGETEXT_PROP.get());
  }
  ...
  public void setPercentageText(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(PERCENTAGETEXT_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7PercentageConversionRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7PercentageConversionRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7PercentageConversionRT.class, config);
    com.guidewire._generated.entity.GL7PercentageConversionRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7PercentageConversionRT, com.guidewire._generated.entity.GL7PercentageConversionRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7PercentageConversionRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7PercentageConversionRTInternal getInternalInterface(entity.GL7PercentageConversionRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7PercentageConversionRT newEmptyInstance() {
        return new entity.GL7PercentageConversionRT((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "GL7PersonalAndAdvertising")
public class GL7PersonalAndAdvertising extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7PersonalAndAdvertising> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7PersonalAndAdvertising>("entity.GL7PersonalAndAdvertising");
  ...
  private com.guidewire._generated.entity.GL7PersonalAndAdvertisingInternal _internal;
   ...
   */
  public GL7PersonalAndAdvertising()  {
   ...
   */
  public GL7PersonalAndAdvertising(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7PersonalAndAdvertising(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7PersonalAndAdvertisingInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7PersonalAndAdvertisingInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7PersonalAndAdvertisingInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7PersonalAndAdvertising.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7PersonalAndAdvertising.class, config);
    com.guidewire._generated.entity.GL7PersonalAndAdvertisingInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7PersonalAndAdvertising, com.guidewire._generated.entity.GL7PersonalAndAdvertisingInternal>() {
      public java.lang.Object getImplementation(entity.GL7PersonalAndAdvertising bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7PersonalAndAdvertisingInternal getInternalInterface(entity.GL7PersonalAndAdvertising bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7PersonalAndAdvertising newEmptyInstance() {
        return new entity.GL7PersonalAndAdvertising((java.lang.Void)null);
      }

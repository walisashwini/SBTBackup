...
@gw.entity.EntityName(value = "GL7PolicyAdjustmentFacto1")
public class GL7PolicyAdjustmentFacto1 extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7PolicyAdjustmentFacto1> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7PolicyAdjustmentFacto1>("entity.GL7PolicyAdjustmentFacto1");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> YIP_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "YIP");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.GL7PolicyAdjustmentFacto1Internal _internal;
   ...
   */
  public GL7PolicyAdjustmentFacto1()  {
   ...
   */
  public GL7PolicyAdjustmentFacto1(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7PolicyAdjustmentFacto1(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7PolicyAdjustmentFacto1Internal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7PolicyAdjustmentFacto1Internal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.Integer getYIP() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(YIP_PROP.get());
  }
  ...
  public void setYIP(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(YIP_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7PolicyAdjustmentFacto1Internal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7PolicyAdjustmentFacto1.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7PolicyAdjustmentFacto1.class, config);
    com.guidewire._generated.entity.GL7PolicyAdjustmentFacto1InternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7PolicyAdjustmentFacto1, com.guidewire._generated.entity.GL7PolicyAdjustmentFacto1Internal>() {
      public java.lang.Object getImplementation(entity.GL7PolicyAdjustmentFacto1 bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7PolicyAdjustmentFacto1Internal getInternalInterface(entity.GL7PolicyAdjustmentFacto1 bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7PolicyAdjustmentFacto1 newEmptyInstance() {
        return new entity.GL7PolicyAdjustmentFacto1((java.lang.Void)null);
      }

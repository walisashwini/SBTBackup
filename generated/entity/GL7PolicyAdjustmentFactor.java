...
@gw.entity.EntityName(value = "GL7PolicyAdjustmentFactor")
public class GL7PolicyAdjustmentFactor extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7PolicyAdjustmentFactor> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7PolicyAdjustmentFactor>("entity.GL7PolicyAdjustmentFactor");
  ...
  private com.guidewire._generated.entity.GL7PolicyAdjustmentFactorInternal _internal;
   ...
   */
  public GL7PolicyAdjustmentFactor()  {
   ...
   */
  public GL7PolicyAdjustmentFactor(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7PolicyAdjustmentFactor(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7PolicyAdjustmentFactorInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7PolicyAdjustmentFactorInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7PolicyAdjustmentFactorInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7PolicyAdjustmentFactor.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7PolicyAdjustmentFactor.class, config);
    com.guidewire._generated.entity.GL7PolicyAdjustmentFactorInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7PolicyAdjustmentFactor, com.guidewire._generated.entity.GL7PolicyAdjustmentFactorInternal>() {
      public java.lang.Object getImplementation(entity.GL7PolicyAdjustmentFactor bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7PolicyAdjustmentFactorInternal getInternalInterface(entity.GL7PolicyAdjustmentFactor bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7PolicyAdjustmentFactor newEmptyInstance() {
        return new entity.GL7PolicyAdjustmentFactor((java.lang.Void)null);
      }

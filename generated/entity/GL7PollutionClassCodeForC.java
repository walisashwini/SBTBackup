...
/**
 * GL7PollutionClassCodeForC
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7PollutionClassCodeForC.eti;GL7PollutionClassCodeForC.eix;GL7PollutionClassCodeForC.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7PollutionClassCodeForC")
public class GL7PollutionClassCodeForC extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7PollutionClassCodeForC> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7PollutionClassCodeForC>("entity.GL7PollutionClassCodeForC");
  ...
  private com.guidewire._generated.entity.GL7PollutionClassCodeForCInternal _internal;
   ...
   */
  public GL7PollutionClassCodeForC()  {
   ...
   */
  public GL7PollutionClassCodeForC(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7PollutionClassCodeForC(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7PollutionClassCodeForCInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7PollutionClassCodeForCInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7PollutionClassCodeForCInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7PollutionClassCodeForC.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7PollutionClassCodeForC.class, config);
    com.guidewire._generated.entity.GL7PollutionClassCodeForCInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7PollutionClassCodeForC, com.guidewire._generated.entity.GL7PollutionClassCodeForCInternal>() {
      public java.lang.Object getImplementation(entity.GL7PollutionClassCodeForC bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7PollutionClassCodeForCInternal getInternalInterface(entity.GL7PollutionClassCodeForC bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7PollutionClassCodeForC newEmptyInstance() {
        return new entity.GL7PollutionClassCodeForC((java.lang.Void)null);
      }

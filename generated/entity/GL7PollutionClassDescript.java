...
/**
 * GL7PollutionClassDescript
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7PollutionClassDescript.eti;GL7PollutionClassDescript.eix;GL7PollutionClassDescript.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7PollutionClassDescript")
public class GL7PollutionClassDescript extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7PollutionClassDescript> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7PollutionClassDescript>("entity.GL7PollutionClassDescript");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> POLLUTIONCLASSCODEFORCLASSDESC_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PollutionClassCodeForClassDesc");
  ...
  private com.guidewire._generated.entity.GL7PollutionClassDescriptInternal _internal;
   ...
   */
  public GL7PollutionClassDescript()  {
   ...
   */
  public GL7PollutionClassDescript(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7PollutionClassDescript(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7PollutionClassDescriptInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7PollutionClassDescriptInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Gets the value of the PollutionClassCodeForClassDesc field.
   * PollutionClassCodeForClassDescription
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getPollutionClassCodeForClassDesc() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(POLLUTIONCLASSCODEFORCLASSDESC_PROP.get());
  }
  ...
  /**
   * Sets the value of the PollutionClassCodeForClassDesc field.
   */
  public void setPollutionClassCodeForClassDesc(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(POLLUTIONCLASSCODEFORCLASSDESC_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7PollutionClassDescriptInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7PollutionClassDescript.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7PollutionClassDescript.class, config);
    com.guidewire._generated.entity.GL7PollutionClassDescriptInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7PollutionClassDescript, com.guidewire._generated.entity.GL7PollutionClassDescriptInternal>() {
      public java.lang.Object getImplementation(entity.GL7PollutionClassDescript bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7PollutionClassDescriptInternal getInternalInterface(entity.GL7PollutionClassDescript bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7PollutionClassDescript newEmptyInstance() {
        return new entity.GL7PollutionClassDescript((java.lang.Void)null);
      }

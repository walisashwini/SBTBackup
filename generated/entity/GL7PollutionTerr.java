 ...
 * GL7PollutionTerr
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7PollutionTerr.eti;GL7PollutionTerr.eix;GL7PollutionTerr.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7PollutionTerr")
public class GL7PollutionTerr extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7PollutionTerr> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7PollutionTerr>("entity.GL7PollutionTerr");
  ...
  private com.guidewire._generated.entity.GL7PollutionTerrInternal _internal;
   ...
   */
  public GL7PollutionTerr(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7PollutionTerr(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7PollutionTerrInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7PollutionTerrInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7PollutionTerrInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7PollutionTerr.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7PollutionTerr.class, config);
    com.guidewire._generated.entity.GL7PollutionTerrInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7PollutionTerr, com.guidewire._generated.entity.GL7PollutionTerrInternal>() {
      public java.lang.Object getImplementation(entity.GL7PollutionTerr bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7PollutionTerrInternal getInternalInterface(entity.GL7PollutionTerr bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7PollutionTerr newEmptyInstance() {
        return new entity.GL7PollutionTerr((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "GL7PremOpsClaimsMadeMulti")
public class GL7PremOpsClaimsMadeMulti extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7PremOpsClaimsMadeMulti> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7PremOpsClaimsMadeMulti>("entity.GL7PremOpsClaimsMadeMulti");
  ...
  private com.guidewire._generated.entity.GL7PremOpsClaimsMadeMultiInternal _internal;
   ...
   */
  public GL7PremOpsClaimsMadeMulti()  {
   ...
   */
  public GL7PremOpsClaimsMadeMulti(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7PremOpsClaimsMadeMulti(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7PremOpsClaimsMadeMultiInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7PremOpsClaimsMadeMultiInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7PremOpsClaimsMadeMultiInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7PremOpsClaimsMadeMulti.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7PremOpsClaimsMadeMulti.class, config);
    com.guidewire._generated.entity.GL7PremOpsClaimsMadeMultiInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7PremOpsClaimsMadeMulti, com.guidewire._generated.entity.GL7PremOpsClaimsMadeMultiInternal>() {
      public java.lang.Object getImplementation(entity.GL7PremOpsClaimsMadeMulti bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7PremOpsClaimsMadeMultiInternal getInternalInterface(entity.GL7PremOpsClaimsMadeMulti bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7PremOpsClaimsMadeMulti newEmptyInstance() {
        return new entity.GL7PremOpsClaimsMadeMulti((java.lang.Void)null);
      }

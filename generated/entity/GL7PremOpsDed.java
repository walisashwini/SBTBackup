 ...
 * GL7PremOpsDed
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7PremOpsDed.eti;GL7PremOpsDed.eix;GL7PremOpsDed.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7PremOpsDed")
public class GL7PremOpsDed extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7PremOpsDed> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7PremOpsDed>("entity.GL7PremOpsDed");
  ...
  private com.guidewire._generated.entity.GL7PremOpsDedInternal _internal;
   ...
   */
  public GL7PremOpsDed(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7PremOpsDed(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7PremOpsDedInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7PremOpsDedInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7PremOpsDedInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7PremOpsDed.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7PremOpsDed.class, config);
    com.guidewire._generated.entity.GL7PremOpsDedInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7PremOpsDed, com.guidewire._generated.entity.GL7PremOpsDedInternal>() {
      public java.lang.Object getImplementation(entity.GL7PremOpsDed bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7PremOpsDedInternal getInternalInterface(entity.GL7PremOpsDed bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7PremOpsDed newEmptyInstance() {
        return new entity.GL7PremOpsDed((java.lang.Void)null);
      }

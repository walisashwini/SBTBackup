 ...
 * GL7PremOpsELPRT
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7PremOpsELPRT.eti;GL7PremOpsELPRT.eix;GL7PremOpsELPRT.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7PremOpsELPRT")
public class GL7PremOpsELPRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7PremOpsELPRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7PremOpsELPRT>("entity.GL7PremOpsELPRT");
  ...
  private com.guidewire._generated.entity.GL7PremOpsELPRTInternal _internal;
   ...
   */
  public GL7PremOpsELPRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7PremOpsELPRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7PremOpsELPRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7PremOpsELPRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7PremOpsELPRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7PremOpsELPRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7PremOpsELPRT.class, config);
    com.guidewire._generated.entity.GL7PremOpsELPRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7PremOpsELPRT, com.guidewire._generated.entity.GL7PremOpsELPRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7PremOpsELPRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7PremOpsELPRTInternal getInternalInterface(entity.GL7PremOpsELPRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7PremOpsELPRT newEmptyInstance() {
        return new entity.GL7PremOpsELPRT((java.lang.Void)null);
      }

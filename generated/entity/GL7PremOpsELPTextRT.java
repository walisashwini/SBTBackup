 ...
 * GL7PremOpsELPTextRT
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7PremOpsELPTextRT.eti;GL7PremOpsELPTextRT.eix;GL7PremOpsELPTextRT.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7PremOpsELPTextRT")
public class GL7PremOpsELPTextRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7PremOpsELPTextRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7PremOpsELPTextRT>("entity.GL7PremOpsELPTextRT");
  ...
  private com.guidewire._generated.entity.GL7PremOpsELPTextRTInternal _internal;
   ...
   */
  public GL7PremOpsELPTextRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7PremOpsELPTextRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7PremOpsELPTextRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7PremOpsELPTextRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7PremOpsELPTextRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7PremOpsELPTextRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7PremOpsELPTextRT.class, config);
    com.guidewire._generated.entity.GL7PremOpsELPTextRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7PremOpsELPTextRT, com.guidewire._generated.entity.GL7PremOpsELPTextRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7PremOpsELPTextRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7PremOpsELPTextRTInternal getInternalInterface(entity.GL7PremOpsELPTextRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7PremOpsELPTextRT newEmptyInstance() {
        return new entity.GL7PremOpsELPTextRT((java.lang.Void)null);
      }

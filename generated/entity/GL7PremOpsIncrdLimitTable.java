...
/**
 * GL7PremOpsIncrdLimitTable
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7PremOpsIncrdLimitTable.eti;GL7PremOpsIncrdLimitTable.eix;GL7PremOpsIncrdLimitTable.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7PremOpsIncrdLimitTable")
public class GL7PremOpsIncrdLimitTable extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7PremOpsIncrdLimitTable> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7PremOpsIncrdLimitTable>("entity.GL7PremOpsIncrdLimitTable");
  ...
  private com.guidewire._generated.entity.GL7PremOpsIncrdLimitTableInternal _internal;
   ...
   */
  public GL7PremOpsIncrdLimitTable()  {
   ...
   */
  public GL7PremOpsIncrdLimitTable(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7PremOpsIncrdLimitTable(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7PremOpsIncrdLimitTableInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7PremOpsIncrdLimitTableInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7PremOpsIncrdLimitTableInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7PremOpsIncrdLimitTable.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7PremOpsIncrdLimitTable.class, config);
    com.guidewire._generated.entity.GL7PremOpsIncrdLimitTableInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7PremOpsIncrdLimitTable, com.guidewire._generated.entity.GL7PremOpsIncrdLimitTableInternal>() {
      public java.lang.Object getImplementation(entity.GL7PremOpsIncrdLimitTable bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7PremOpsIncrdLimitTableInternal getInternalInterface(entity.GL7PremOpsIncrdLimitTable bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7PremOpsIncrdLimitTable newEmptyInstance() {
        return new entity.GL7PremOpsIncrdLimitTable((java.lang.Void)null);
      }

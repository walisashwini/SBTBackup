...
@gw.entity.EntityName(value = "GL7PremOpsLCMRT")
public class GL7PremOpsLCMRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7PremOpsLCMRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7PremOpsLCMRT>("entity.GL7PremOpsLCMRT");
  ...
  private com.guidewire._generated.entity.GL7PremOpsLCMRTInternal _internal;
   ...
   */
  public GL7PremOpsLCMRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7PremOpsLCMRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7PremOpsLCMRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7PremOpsLCMRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7PremOpsLCMRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7PremOpsLCMRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7PremOpsLCMRT.class, config);
    com.guidewire._generated.entity.GL7PremOpsLCMRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7PremOpsLCMRT, com.guidewire._generated.entity.GL7PremOpsLCMRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7PremOpsLCMRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7PremOpsLCMRTInternal getInternalInterface(entity.GL7PremOpsLCMRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7PremOpsLCMRT newEmptyInstance() {
        return new entity.GL7PremOpsLCMRT((java.lang.Void)null);
      }

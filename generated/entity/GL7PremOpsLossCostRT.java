...
/**
 * GL7PremOpsLossCostRT
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7PremOpsLossCostRT.eti;GL7PremOpsLossCostRT.eix;GL7PremOpsLossCostRT.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7PremOpsLossCostRT")
public class GL7PremOpsLossCostRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7PremOpsLossCostRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7PremOpsLossCostRT>("entity.GL7PremOpsLossCostRT");
  ...
  private com.guidewire._generated.entity.GL7PremOpsLossCostRTInternal _internal;
   ...
   */
  public GL7PremOpsLossCostRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7PremOpsLossCostRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7PremOpsLossCostRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7PremOpsLossCostRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7PremOpsLossCostRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7PremOpsLossCostRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7PremOpsLossCostRT.class, config);
    com.guidewire._generated.entity.GL7PremOpsLossCostRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7PremOpsLossCostRT, com.guidewire._generated.entity.GL7PremOpsLossCostRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7PremOpsLossCostRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7PremOpsLossCostRTInternal getInternalInterface(entity.GL7PremOpsLossCostRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7PremOpsLossCostRT newEmptyInstance() {
        return new entity.GL7PremOpsLossCostRT((java.lang.Void)null);
      }

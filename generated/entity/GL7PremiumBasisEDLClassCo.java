...
@gw.entity.EntityName(value = "GL7PremiumBasisEDLClassCo")
public class GL7PremiumBasisEDLClassCo extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7PremiumBasisEDLClassCo> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7PremiumBasisEDLClassCo>("entity.GL7PremiumBasisEDLClassCo");
  ...
  private com.guidewire._generated.entity.GL7PremiumBasisEDLClassCoInternal _internal;
   ...
   */
  public GL7PremiumBasisEDLClassCo()  {
   ...
   */
  public GL7PremiumBasisEDLClassCo(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7PremiumBasisEDLClassCo(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7PremiumBasisEDLClassCoInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7PremiumBasisEDLClassCoInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7PremiumBasisEDLClassCoInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7PremiumBasisEDLClassCo.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7PremiumBasisEDLClassCo.class, config);
    com.guidewire._generated.entity.GL7PremiumBasisEDLClassCoInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7PremiumBasisEDLClassCo, com.guidewire._generated.entity.GL7PremiumBasisEDLClassCoInternal>() {
      public java.lang.Object getImplementation(entity.GL7PremiumBasisEDLClassCo bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7PremiumBasisEDLClassCoInternal getInternalInterface(entity.GL7PremiumBasisEDLClassCo bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7PremiumBasisEDLClassCo newEmptyInstance() {
        return new entity.GL7PremiumBasisEDLClassCo((java.lang.Void)null);
      }

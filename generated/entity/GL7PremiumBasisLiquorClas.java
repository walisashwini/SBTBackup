...
/**
 * GL7PremiumBasisLiquorClas
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7PremiumBasisLiquorClas.eti;GL7PremiumBasisLiquorClas.eix;GL7PremiumBasisLiquorClas.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7PremiumBasisLiquorClas")
public class GL7PremiumBasisLiquorClas extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7PremiumBasisLiquorClas> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7PremiumBasisLiquorClas>("entity.GL7PremiumBasisLiquorClas");
  ...
  private com.guidewire._generated.entity.GL7PremiumBasisLiquorClasInternal _internal;
   ...
   */
  public GL7PremiumBasisLiquorClas()  {
   ...
   */
  public GL7PremiumBasisLiquorClas(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7PremiumBasisLiquorClas(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7PremiumBasisLiquorClasInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7PremiumBasisLiquorClasInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7PremiumBasisLiquorClasInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7PremiumBasisLiquorClas.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7PremiumBasisLiquorClas.class, config);
    com.guidewire._generated.entity.GL7PremiumBasisLiquorClasInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7PremiumBasisLiquorClas, com.guidewire._generated.entity.GL7PremiumBasisLiquorClasInternal>() {
      public java.lang.Object getImplementation(entity.GL7PremiumBasisLiquorClas bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7PremiumBasisLiquorClasInternal getInternalInterface(entity.GL7PremiumBasisLiquorClas bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7PremiumBasisLiquorClas newEmptyInstance() {
        return new entity.GL7PremiumBasisLiquorClas((java.lang.Void)null);
      }

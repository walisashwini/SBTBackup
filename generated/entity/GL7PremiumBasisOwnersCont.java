...
/**
 * GL7PremiumBasisOwnersCont
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7PremiumBasisOwnersCont.eti;GL7PremiumBasisOwnersCont.eix;GL7PremiumBasisOwnersCont.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7PremiumBasisOwnersCont")
public class GL7PremiumBasisOwnersCont extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7PremiumBasisOwnersCont> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7PremiumBasisOwnersCont>("entity.GL7PremiumBasisOwnersCont");
  ...
  private com.guidewire._generated.entity.GL7PremiumBasisOwnersContInternal _internal;
   ...
   */
  public GL7PremiumBasisOwnersCont()  {
   ...
   */
  public GL7PremiumBasisOwnersCont(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7PremiumBasisOwnersCont(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7PremiumBasisOwnersContInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7PremiumBasisOwnersContInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7PremiumBasisOwnersContInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7PremiumBasisOwnersCont.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7PremiumBasisOwnersCont.class, config);
    com.guidewire._generated.entity.GL7PremiumBasisOwnersContInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7PremiumBasisOwnersCont, com.guidewire._generated.entity.GL7PremiumBasisOwnersContInternal>() {
      public java.lang.Object getImplementation(entity.GL7PremiumBasisOwnersCont bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7PremiumBasisOwnersContInternal getInternalInterface(entity.GL7PremiumBasisOwnersCont bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7PremiumBasisOwnersCont newEmptyInstance() {
        return new entity.GL7PremiumBasisOwnersCont((java.lang.Void)null);
      }

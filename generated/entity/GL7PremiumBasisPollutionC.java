...
@gw.entity.EntityName(value = "GL7PremiumBasisPollutionC")
public class GL7PremiumBasisPollutionC extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7PremiumBasisPollutionC> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7PremiumBasisPollutionC>("entity.GL7PremiumBasisPollutionC");
  ...
  private com.guidewire._generated.entity.GL7PremiumBasisPollutionCInternal _internal;
   ...
   */
  public GL7PremiumBasisPollutionC()  {
   ...
   */
  public GL7PremiumBasisPollutionC(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7PremiumBasisPollutionC(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7PremiumBasisPollutionCInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7PremiumBasisPollutionCInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7PremiumBasisPollutionCInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7PremiumBasisPollutionC.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7PremiumBasisPollutionC.class, config);
    com.guidewire._generated.entity.GL7PremiumBasisPollutionCInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7PremiumBasisPollutionC, com.guidewire._generated.entity.GL7PremiumBasisPollutionCInternal>() {
      public java.lang.Object getImplementation(entity.GL7PremiumBasisPollutionC bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7PremiumBasisPollutionCInternal getInternalInterface(entity.GL7PremiumBasisPollutionC bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7PremiumBasisPollutionC newEmptyInstance() {
        return new entity.GL7PremiumBasisPollutionC((java.lang.Void)null);
      }

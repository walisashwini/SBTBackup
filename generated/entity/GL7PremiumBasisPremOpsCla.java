...
/**
 * GL7PremiumBasisPremOpsCla
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7PremiumBasisPremOpsCla.eti;GL7PremiumBasisPremOpsCla.eix;GL7PremiumBasisPremOpsCla.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7PremiumBasisPremOpsCla")
public class GL7PremiumBasisPremOpsCla extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7PremiumBasisPremOpsCla> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7PremiumBasisPremOpsCla>("entity.GL7PremiumBasisPremOpsCla");
  ...
  private com.guidewire._generated.entity.GL7PremiumBasisPremOpsClaInternal _internal;
   ...
   */
  public GL7PremiumBasisPremOpsCla()  {
   ...
   */
  public GL7PremiumBasisPremOpsCla(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7PremiumBasisPremOpsCla(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7PremiumBasisPremOpsClaInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7PremiumBasisPremOpsClaInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7PremiumBasisPremOpsClaInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7PremiumBasisPremOpsCla.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7PremiumBasisPremOpsCla.class, config);
    com.guidewire._generated.entity.GL7PremiumBasisPremOpsClaInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7PremiumBasisPremOpsCla, com.guidewire._generated.entity.GL7PremiumBasisPremOpsClaInternal>() {
      public java.lang.Object getImplementation(entity.GL7PremiumBasisPremOpsCla bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7PremiumBasisPremOpsClaInternal getInternalInterface(entity.GL7PremiumBasisPremOpsCla bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7PremiumBasisPremOpsCla newEmptyInstance() {
        return new entity.GL7PremiumBasisPremOpsCla((java.lang.Void)null);
      }

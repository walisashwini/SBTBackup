...
/**
 * GL7PremiumBasisProdsCompl
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7PremiumBasisProdsCompl.eti;GL7PremiumBasisProdsCompl.eix;GL7PremiumBasisProdsCompl.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7PremiumBasisProdsCompl")
public class GL7PremiumBasisProdsCompl extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7PremiumBasisProdsCompl> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7PremiumBasisProdsCompl>("entity.GL7PremiumBasisProdsCompl");
  ...
  private com.guidewire._generated.entity.GL7PremiumBasisProdsComplInternal _internal;
   ...
   */
  public GL7PremiumBasisProdsCompl()  {
   ...
   */
  public GL7PremiumBasisProdsCompl(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7PremiumBasisProdsCompl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7PremiumBasisProdsComplInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7PremiumBasisProdsComplInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7PremiumBasisProdsComplInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7PremiumBasisProdsCompl.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7PremiumBasisProdsCompl.class, config);
    com.guidewire._generated.entity.GL7PremiumBasisProdsComplInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7PremiumBasisProdsCompl, com.guidewire._generated.entity.GL7PremiumBasisProdsComplInternal>() {
      public java.lang.Object getImplementation(entity.GL7PremiumBasisProdsCompl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7PremiumBasisProdsComplInternal getInternalInterface(entity.GL7PremiumBasisProdsCompl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7PremiumBasisProdsCompl newEmptyInstance() {
        return new entity.GL7PremiumBasisProdsCompl((java.lang.Void)null);
      }

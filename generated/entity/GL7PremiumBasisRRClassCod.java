...
/**
 * GL7PremiumBasisRRClassCod
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7PremiumBasisRRClassCod.eti;GL7PremiumBasisRRClassCod.eix;GL7PremiumBasisRRClassCod.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7PremiumBasisRRClassCod")
public class GL7PremiumBasisRRClassCod extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7PremiumBasisRRClassCod> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7PremiumBasisRRClassCod>("entity.GL7PremiumBasisRRClassCod");
  ...
  private com.guidewire._generated.entity.GL7PremiumBasisRRClassCodInternal _internal;
   ...
   */
  public GL7PremiumBasisRRClassCod()  {
   ...
   */
  public GL7PremiumBasisRRClassCod(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7PremiumBasisRRClassCod(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7PremiumBasisRRClassCodInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7PremiumBasisRRClassCodInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7PremiumBasisRRClassCodInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7PremiumBasisRRClassCod.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7PremiumBasisRRClassCod.class, config);
    com.guidewire._generated.entity.GL7PremiumBasisRRClassCodInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7PremiumBasisRRClassCod, com.guidewire._generated.entity.GL7PremiumBasisRRClassCodInternal>() {
      public java.lang.Object getImplementation(entity.GL7PremiumBasisRRClassCod bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7PremiumBasisRRClassCodInternal getInternalInterface(entity.GL7PremiumBasisRRClassCod bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7PremiumBasisRRClassCod newEmptyInstance() {
        return new entity.GL7PremiumBasisRRClassCod((java.lang.Void)null);
      }

...
/**
 * GL7PremiumBasisUSTClassCo
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7PremiumBasisUSTClassCo.eti;GL7PremiumBasisUSTClassCo.eix;GL7PremiumBasisUSTClassCo.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7PremiumBasisUSTClassCo")
public class GL7PremiumBasisUSTClassCo extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7PremiumBasisUSTClassCo> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7PremiumBasisUSTClassCo>("entity.GL7PremiumBasisUSTClassCo");
  ...
  private com.guidewire._generated.entity.GL7PremiumBasisUSTClassCoInternal _internal;
   ...
   */
  public GL7PremiumBasisUSTClassCo()  {
   ...
   */
  public GL7PremiumBasisUSTClassCo(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7PremiumBasisUSTClassCo(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7PremiumBasisUSTClassCoInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7PremiumBasisUSTClassCoInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7PremiumBasisUSTClassCoInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7PremiumBasisUSTClassCo.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7PremiumBasisUSTClassCo.class, config);
    com.guidewire._generated.entity.GL7PremiumBasisUSTClassCoInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7PremiumBasisUSTClassCo, com.guidewire._generated.entity.GL7PremiumBasisUSTClassCoInternal>() {
      public java.lang.Object getImplementation(entity.GL7PremiumBasisUSTClassCo bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7PremiumBasisUSTClassCoInternal getInternalInterface(entity.GL7PremiumBasisUSTClassCo bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7PremiumBasisUSTClassCo newEmptyInstance() {
        return new entity.GL7PremiumBasisUSTClassCo((java.lang.Void)null);
      }

...
/**
 * GL7ProdsCompldOpsAggregat
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7ProdsCompldOpsAggregat.eti;GL7ProdsCompldOpsAggregat.eix;GL7ProdsCompldOpsAggregat.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7ProdsCompldOpsAggregat")
public class GL7ProdsCompldOpsAggregat extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ProdsCompldOpsAggregat> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ProdsCompldOpsAggregat>("entity.GL7ProdsCompldOpsAggregat");
  ...
  private com.guidewire._generated.entity.GL7ProdsCompldOpsAggregatInternal _internal;
   ...
   */
  public GL7ProdsCompldOpsAggregat()  {
   ...
   */
  public GL7ProdsCompldOpsAggregat(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ProdsCompldOpsAggregat(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ProdsCompldOpsAggregatInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ProdsCompldOpsAggregatInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ProdsCompldOpsAggregatInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ProdsCompldOpsAggregat.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ProdsCompldOpsAggregat.class, config);
    com.guidewire._generated.entity.GL7ProdsCompldOpsAggregatInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ProdsCompldOpsAggregat, com.guidewire._generated.entity.GL7ProdsCompldOpsAggregatInternal>() {
      public java.lang.Object getImplementation(entity.GL7ProdsCompldOpsAggregat bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ProdsCompldOpsAggregatInternal getInternalInterface(entity.GL7ProdsCompldOpsAggregat bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ProdsCompldOpsAggregat newEmptyInstance() {
        return new entity.GL7ProdsCompldOpsAggregat((java.lang.Void)null);
      }

...
/**
 * GL7ProdsCompldOpsClaimsMa
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7ProdsCompldOpsClaimsMa.eti;GL7ProdsCompldOpsClaimsMa.eix;GL7ProdsCompldOpsClaimsMa.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7ProdsCompldOpsClaimsMa")
public class GL7ProdsCompldOpsClaimsMa extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ProdsCompldOpsClaimsMa> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ProdsCompldOpsClaimsMa>("entity.GL7ProdsCompldOpsClaimsMa");
  ...
  private com.guidewire._generated.entity.GL7ProdsCompldOpsClaimsMaInternal _internal;
   ...
   */
  public GL7ProdsCompldOpsClaimsMa()  {
   ...
   */
  public GL7ProdsCompldOpsClaimsMa(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ProdsCompldOpsClaimsMa(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ProdsCompldOpsClaimsMaInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ProdsCompldOpsClaimsMaInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ProdsCompldOpsClaimsMaInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ProdsCompldOpsClaimsMa.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ProdsCompldOpsClaimsMa.class, config);
    com.guidewire._generated.entity.GL7ProdsCompldOpsClaimsMaInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ProdsCompldOpsClaimsMa, com.guidewire._generated.entity.GL7ProdsCompldOpsClaimsMaInternal>() {
      public java.lang.Object getImplementation(entity.GL7ProdsCompldOpsClaimsMa bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ProdsCompldOpsClaimsMaInternal getInternalInterface(entity.GL7ProdsCompldOpsClaimsMa bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ProdsCompldOpsClaimsMa newEmptyInstance() {
        return new entity.GL7ProdsCompldOpsClaimsMa((java.lang.Void)null);
      }

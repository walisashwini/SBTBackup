...
/**
 * GL7ProdsCompldOpsDed
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7ProdsCompldOpsDed.eti;GL7ProdsCompldOpsDed.eix;GL7ProdsCompldOpsDed.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7ProdsCompldOpsDed")
public class GL7ProdsCompldOpsDed extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ProdsCompldOpsDed> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ProdsCompldOpsDed>("entity.GL7ProdsCompldOpsDed");
  ...
  private com.guidewire._generated.entity.GL7ProdsCompldOpsDedInternal _internal;
   ...
   */
  public GL7ProdsCompldOpsDed(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ProdsCompldOpsDed(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ProdsCompldOpsDedInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ProdsCompldOpsDedInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ProdsCompldOpsDedInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ProdsCompldOpsDed.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ProdsCompldOpsDed.class, config);
    com.guidewire._generated.entity.GL7ProdsCompldOpsDedInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ProdsCompldOpsDed, com.guidewire._generated.entity.GL7ProdsCompldOpsDedInternal>() {
      public java.lang.Object getImplementation(entity.GL7ProdsCompldOpsDed bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ProdsCompldOpsDedInternal getInternalInterface(entity.GL7ProdsCompldOpsDed bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ProdsCompldOpsDed newEmptyInstance() {
        return new entity.GL7ProdsCompldOpsDed((java.lang.Void)null);
      }

...
/**
 * GL7ProdsCompldOpsELPFacto
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7ProdsCompldOpsELPFacto.eti;GL7ProdsCompldOpsELPFacto.eix;GL7ProdsCompldOpsELPFacto.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7ProdsCompldOpsELPFacto")
public class GL7ProdsCompldOpsELPFacto extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ProdsCompldOpsELPFacto> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ProdsCompldOpsELPFacto>("entity.GL7ProdsCompldOpsELPFacto");
  ...
  private com.guidewire._generated.entity.GL7ProdsCompldOpsELPFactoInternal _internal;
   ...
   */
  public GL7ProdsCompldOpsELPFacto()  {
   ...
   */
  public GL7ProdsCompldOpsELPFacto(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ProdsCompldOpsELPFacto(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ProdsCompldOpsELPFactoInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ProdsCompldOpsELPFactoInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ProdsCompldOpsELPFactoInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ProdsCompldOpsELPFacto.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ProdsCompldOpsELPFacto.class, config);
    com.guidewire._generated.entity.GL7ProdsCompldOpsELPFactoInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ProdsCompldOpsELPFacto, com.guidewire._generated.entity.GL7ProdsCompldOpsELPFactoInternal>() {
      public java.lang.Object getImplementation(entity.GL7ProdsCompldOpsELPFacto bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ProdsCompldOpsELPFactoInternal getInternalInterface(entity.GL7ProdsCompldOpsELPFacto bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ProdsCompldOpsELPFacto newEmptyInstance() {
        return new entity.GL7ProdsCompldOpsELPFacto((java.lang.Void)null);
      }

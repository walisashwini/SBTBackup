...
/**
 * GL7ProdsCompldOpsELPTextR
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7ProdsCompldOpsELPTextR.eti;GL7ProdsCompldOpsELPTextR.eix;GL7ProdsCompldOpsELPTextR.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7ProdsCompldOpsELPTextR")
public class GL7ProdsCompldOpsELPTextR extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ProdsCompldOpsELPTextR> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ProdsCompldOpsELPTextR>("entity.GL7ProdsCompldOpsELPTextR");
  ...
  private com.guidewire._generated.entity.GL7ProdsCompldOpsELPTextRInternal _internal;
   ...
   */
  public GL7ProdsCompldOpsELPTextR()  {
   ...
   */
  public GL7ProdsCompldOpsELPTextR(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ProdsCompldOpsELPTextR(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ProdsCompldOpsELPTextRInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ProdsCompldOpsELPTextRInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ProdsCompldOpsELPTextRInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ProdsCompldOpsELPTextR.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ProdsCompldOpsELPTextR.class, config);
    com.guidewire._generated.entity.GL7ProdsCompldOpsELPTextRInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ProdsCompldOpsELPTextR, com.guidewire._generated.entity.GL7ProdsCompldOpsELPTextRInternal>() {
      public java.lang.Object getImplementation(entity.GL7ProdsCompldOpsELPTextR bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ProdsCompldOpsELPTextRInternal getInternalInterface(entity.GL7ProdsCompldOpsELPTextR bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ProdsCompldOpsELPTextR newEmptyInstance() {
        return new entity.GL7ProdsCompldOpsELPTextR((java.lang.Void)null);
      }

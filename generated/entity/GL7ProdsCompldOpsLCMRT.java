...
@gw.entity.EntityName(value = "GL7ProdsCompldOpsLCMRT")
public class GL7ProdsCompldOpsLCMRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ProdsCompldOpsLCMRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ProdsCompldOpsLCMRT>("entity.GL7ProdsCompldOpsLCMRT");
  ...
  private com.guidewire._generated.entity.GL7ProdsCompldOpsLCMRTInternal _internal;
   ...
   */
  public GL7ProdsCompldOpsLCMRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ProdsCompldOpsLCMRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ProdsCompldOpsLCMRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ProdsCompldOpsLCMRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ProdsCompldOpsLCMRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ProdsCompldOpsLCMRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ProdsCompldOpsLCMRT.class, config);
    com.guidewire._generated.entity.GL7ProdsCompldOpsLCMRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ProdsCompldOpsLCMRT, com.guidewire._generated.entity.GL7ProdsCompldOpsLCMRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7ProdsCompldOpsLCMRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ProdsCompldOpsLCMRTInternal getInternalInterface(entity.GL7ProdsCompldOpsLCMRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ProdsCompldOpsLCMRT newEmptyInstance() {
        return new entity.GL7ProdsCompldOpsLCMRT((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "GL7ProdsCompldOpsLossCost")
public class GL7ProdsCompldOpsLossCost extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ProdsCompldOpsLossCost> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ProdsCompldOpsLossCost>("entity.GL7ProdsCompldOpsLossCost");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PRODSCOMPLDOPSTERR_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ProdsCompldOpsTerr");
  ...
  private com.guidewire._generated.entity.GL7ProdsCompldOpsLossCostInternal _internal;
   ...
   */
  public GL7ProdsCompldOpsLossCost()  {
   ...
   */
  public GL7ProdsCompldOpsLossCost(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ProdsCompldOpsLossCost(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ProdsCompldOpsLossCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ProdsCompldOpsLossCostInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.String getProdsCompldOpsTerr() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(PRODSCOMPLDOPSTERR_PROP.get());
  }
  ...
  public void setProdsCompldOpsTerr(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(PRODSCOMPLDOPSTERR_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ProdsCompldOpsLossCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ProdsCompldOpsLossCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ProdsCompldOpsLossCost.class, config);
    com.guidewire._generated.entity.GL7ProdsCompldOpsLossCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ProdsCompldOpsLossCost, com.guidewire._generated.entity.GL7ProdsCompldOpsLossCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7ProdsCompldOpsLossCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ProdsCompldOpsLossCostInternal getInternalInterface(entity.GL7ProdsCompldOpsLossCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ProdsCompldOpsLossCost newEmptyInstance() {
        return new entity.GL7ProdsCompldOpsLossCost((java.lang.Void)null);
      }

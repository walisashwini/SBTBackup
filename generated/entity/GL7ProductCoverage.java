 ...
 * GL7ProductCoverage
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7ProductCoverage.eti;GL7ProductCoverage.eix;GL7ProductCoverage.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7ProductCoverage")
public class GL7ProductCoverage extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ProductCoverage> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ProductCoverage>("entity.GL7ProductCoverage");
  ...
  private com.guidewire._generated.entity.GL7ProductCoverageInternal _internal;
   ...
   */
  public GL7ProductCoverage(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ProductCoverage(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ProductCoverageInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ProductCoverageInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ProductCoverageInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ProductCoverage.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ProductCoverage.class, config);
    com.guidewire._generated.entity.GL7ProductCoverageInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ProductCoverage, com.guidewire._generated.entity.GL7ProductCoverageInternal>() {
      public java.lang.Object getImplementation(entity.GL7ProductCoverage bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ProductCoverageInternal getInternalInterface(entity.GL7ProductCoverage bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ProductCoverage newEmptyInstance() {
        return new entity.GL7ProductCoverage((java.lang.Void)null);
      }

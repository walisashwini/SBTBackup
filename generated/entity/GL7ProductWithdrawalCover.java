...
/**
 * GL7ProductWithdrawalCover
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7ProductWithdrawalCover.eti;GL7ProductWithdrawalCover.eix;GL7ProductWithdrawalCover.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7ProductWithdrawalCover")
public class GL7ProductWithdrawalCover extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ProductWithdrawalCover> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ProductWithdrawalCover>("entity.GL7ProductWithdrawalCover");
  ...
  private com.guidewire._generated.entity.GL7ProductWithdrawalCoverInternal _internal;
   ...
   */
  public GL7ProductWithdrawalCover()  {
   ...
   */
  public GL7ProductWithdrawalCover(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ProductWithdrawalCover(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ProductWithdrawalCoverInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ProductWithdrawalCoverInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ProductWithdrawalCoverInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ProductWithdrawalCover.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ProductWithdrawalCover.class, config);
    com.guidewire._generated.entity.GL7ProductWithdrawalCoverInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ProductWithdrawalCover, com.guidewire._generated.entity.GL7ProductWithdrawalCoverInternal>() {
      public java.lang.Object getImplementation(entity.GL7ProductWithdrawalCover bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ProductWithdrawalCoverInternal getInternalInterface(entity.GL7ProductWithdrawalCover bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ProductWithdrawalCover newEmptyInstance() {
        return new entity.GL7ProductWithdrawalCover((java.lang.Void)null);
      }

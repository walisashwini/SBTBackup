...
@gw.entity.EntityName(value = "GL7ProductWithdrawalExpen")
public class GL7ProductWithdrawalExpen extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ProductWithdrawalExpen> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ProductWithdrawalExpen>("entity.GL7ProductWithdrawalExpen");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PRODWITHDRAWLAGGLIM_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ProdWithdrawlAggLim");
  ...
  private com.guidewire._generated.entity.GL7ProductWithdrawalExpenInternal _internal;
   ...
   */
  public GL7ProductWithdrawalExpen()  {
   ...
   */
  public GL7ProductWithdrawalExpen(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ProductWithdrawalExpen(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ProductWithdrawalExpenInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ProductWithdrawalExpenInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.String getProdWithdrawlAggLim() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(PRODWITHDRAWLAGGLIM_PROP.get());
  }
  ...
  public void setProdWithdrawlAggLim(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(PRODWITHDRAWLAGGLIM_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ProductWithdrawalExpenInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ProductWithdrawalExpen.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ProductWithdrawalExpen.class, config);
    com.guidewire._generated.entity.GL7ProductWithdrawalExpenInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ProductWithdrawalExpen, com.guidewire._generated.entity.GL7ProductWithdrawalExpenInternal>() {
      public java.lang.Object getImplementation(entity.GL7ProductWithdrawalExpen bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ProductWithdrawalExpenInternal getInternalInterface(entity.GL7ProductWithdrawalExpen bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ProductWithdrawalExpen newEmptyInstance() {
        return new entity.GL7ProductWithdrawalExpen((java.lang.Void)null);
      }

...
/**
 * GL7ProductWithdrawalLCMRT
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7ProductWithdrawalLCMRT.eti;GL7ProductWithdrawalLCMRT.eix;GL7ProductWithdrawalLCMRT.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7ProductWithdrawalLCMRT")
public class GL7ProductWithdrawalLCMRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ProductWithdrawalLCMRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ProductWithdrawalLCMRT>("entity.GL7ProductWithdrawalLCMRT");
  ...
  private com.guidewire._generated.entity.GL7ProductWithdrawalLCMRTInternal _internal;
   ...
   */
  public GL7ProductWithdrawalLCMRT()  {
   ...
   */
  public GL7ProductWithdrawalLCMRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ProductWithdrawalLCMRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ProductWithdrawalLCMRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ProductWithdrawalLCMRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ProductWithdrawalLCMRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ProductWithdrawalLCMRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ProductWithdrawalLCMRT.class, config);
    com.guidewire._generated.entity.GL7ProductWithdrawalLCMRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ProductWithdrawalLCMRT, com.guidewire._generated.entity.GL7ProductWithdrawalLCMRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7ProductWithdrawalLCMRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ProductWithdrawalLCMRTInternal getInternalInterface(entity.GL7ProductWithdrawalLCMRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ProductWithdrawalLCMRT newEmptyInstance() {
        return new entity.GL7ProductWithdrawalLCMRT((java.lang.Void)null);
      }

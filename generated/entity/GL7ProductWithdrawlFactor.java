...
@gw.entity.EntityName(value = "GL7ProductWithdrawlFactor")
public class GL7ProductWithdrawlFactor extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ProductWithdrawlFactor> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ProductWithdrawlFactor>("entity.GL7ProductWithdrawlFactor");
  ...
  private com.guidewire._generated.entity.GL7ProductWithdrawlFactorInternal _internal;
   ...
   */
  public GL7ProductWithdrawlFactor()  {
   ...
   */
  public GL7ProductWithdrawlFactor(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ProductWithdrawlFactor(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ProductWithdrawlFactorInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ProductWithdrawlFactorInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ProductWithdrawlFactorInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ProductWithdrawlFactor.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ProductWithdrawlFactor.class, config);
    com.guidewire._generated.entity.GL7ProductWithdrawlFactorInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ProductWithdrawlFactor, com.guidewire._generated.entity.GL7ProductWithdrawlFactorInternal>() {
      public java.lang.Object getImplementation(entity.GL7ProductWithdrawlFactor bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ProductWithdrawlFactorInternal getInternalInterface(entity.GL7ProductWithdrawlFactor bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ProductWithdrawlFactor newEmptyInstance() {
        return new entity.GL7ProductWithdrawlFactor((java.lang.Void)null);
      }

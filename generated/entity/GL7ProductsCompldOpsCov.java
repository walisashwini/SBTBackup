...
/**
 * GL7ProductsCompldOpsCov
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7ProductsCompldOpsCov.eti;GL7ProductsCompldOpsCov.eix;GL7ProductsCompldOpsCov.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7ProductsCompldOpsCov")
public class GL7ProductsCompldOpsCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ProductsCompldOpsCov> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ProductsCompldOpsCov>("entity.GL7ProductsCompldOpsCov");
  ...
  private com.guidewire._generated.entity.GL7ProductsCompldOpsCovInternal _internal;
   ...
   */
  public GL7ProductsCompldOpsCov()  {
   ...
   */
  public GL7ProductsCompldOpsCov(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ProductsCompldOpsCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ProductsCompldOpsCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ProductsCompldOpsCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ProductsCompldOpsCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ProductsCompldOpsCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ProductsCompldOpsCov.class, config);
    com.guidewire._generated.entity.GL7ProductsCompldOpsCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ProductsCompldOpsCov, com.guidewire._generated.entity.GL7ProductsCompldOpsCovInternal>() {
      public java.lang.Object getImplementation(entity.GL7ProductsCompldOpsCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ProductsCompldOpsCovInternal getInternalInterface(entity.GL7ProductsCompldOpsCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ProductsCompldOpsCov newEmptyInstance() {
        return new entity.GL7ProductsCompldOpsCov((java.lang.Void)null);
      }

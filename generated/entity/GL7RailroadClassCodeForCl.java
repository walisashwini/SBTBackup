...
/**
 * GL7RailroadClassCodeForCl
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7RailroadClassCodeForCl.eti;GL7RailroadClassCodeForCl.eix;GL7RailroadClassCodeForCl.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7RailroadClassCodeForCl")
public class GL7RailroadClassCodeForCl extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7RailroadClassCodeForCl> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7RailroadClassCodeForCl>("entity.GL7RailroadClassCodeForCl");
  ...
  private com.guidewire._generated.entity.GL7RailroadClassCodeForClInternal _internal;
   ...
   */
  public GL7RailroadClassCodeForCl()  {
   ...
   */
  public GL7RailroadClassCodeForCl(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7RailroadClassCodeForCl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7RailroadClassCodeForClInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7RailroadClassCodeForClInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7RailroadClassCodeForClInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7RailroadClassCodeForCl.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7RailroadClassCodeForCl.class, config);
    com.guidewire._generated.entity.GL7RailroadClassCodeForClInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7RailroadClassCodeForCl, com.guidewire._generated.entity.GL7RailroadClassCodeForClInternal>() {
      public java.lang.Object getImplementation(entity.GL7RailroadClassCodeForCl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7RailroadClassCodeForClInternal getInternalInterface(entity.GL7RailroadClassCodeForCl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7RailroadClassCodeForCl newEmptyInstance() {
        return new entity.GL7RailroadClassCodeForCl((java.lang.Void)null);
      }

...
/**
 * GL7RailroadClassDescripti
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7RailroadClassDescripti.eti;GL7RailroadClassDescripti.eix;GL7RailroadClassDescripti.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7RailroadClassDescripti")
public class GL7RailroadClassDescripti extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7RailroadClassDescripti> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7RailroadClassDescripti>("entity.GL7RailroadClassDescripti");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> RAILROADCLASSCODEFORCLASSDESCR_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "RailroadClassCodeForClassDescr");
  ...
  private com.guidewire._generated.entity.GL7RailroadClassDescriptiInternal _internal;
   ...
   */
  public GL7RailroadClassDescripti()  {
   ...
   */
  public GL7RailroadClassDescripti(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7RailroadClassDescripti(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7RailroadClassDescriptiInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7RailroadClassDescriptiInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Gets the value of the RailroadClassCodeForClassDescr field.
   * RailroadClassCodeForClassDescription
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getRailroadClassCodeForClassDescr() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(RAILROADCLASSCODEFORCLASSDESCR_PROP.get());
  }
  ...
  /**
   * Sets the value of the RailroadClassCodeForClassDescr field.
   */
  public void setRailroadClassCodeForClassDescr(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(RAILROADCLASSCODEFORCLASSDESCR_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7RailroadClassDescriptiInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7RailroadClassDescripti.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7RailroadClassDescripti.class, config);
    com.guidewire._generated.entity.GL7RailroadClassDescriptiInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7RailroadClassDescripti, com.guidewire._generated.entity.GL7RailroadClassDescriptiInternal>() {
      public java.lang.Object getImplementation(entity.GL7RailroadClassDescripti bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7RailroadClassDescriptiInternal getInternalInterface(entity.GL7RailroadClassDescripti bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7RailroadClassDescripti newEmptyInstance() {
        return new entity.GL7RailroadClassDescripti((java.lang.Void)null);
      }

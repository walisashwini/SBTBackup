 ...
 * GL7RailroadELPRT
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7RailroadELPRT.eti;GL7RailroadELPRT.eix;GL7RailroadELPRT.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7RailroadELPRT")
public class GL7RailroadELPRT extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7RailroadELPRT> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7RailroadELPRT>("entity.GL7RailroadELPRT");
  ...
  private com.guidewire._generated.entity.GL7RailroadELPRTInternal _internal;
   ...
   */
  public GL7RailroadELPRT(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7RailroadELPRT(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7RailroadELPRTInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7RailroadELPRTInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7RailroadELPRTInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7RailroadELPRT.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7RailroadELPRT.class, config);
    com.guidewire._generated.entity.GL7RailroadELPRTInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7RailroadELPRT, com.guidewire._generated.entity.GL7RailroadELPRTInternal>() {
      public java.lang.Object getImplementation(entity.GL7RailroadELPRT bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7RailroadELPRTInternal getInternalInterface(entity.GL7RailroadELPRT bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7RailroadELPRT newEmptyInstance() {
        return new entity.GL7RailroadELPRT((java.lang.Void)null);
      }

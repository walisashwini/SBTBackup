 ...
 * GL7RailroadTerr
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7RailroadTerr.eti;GL7RailroadTerr.eix;GL7RailroadTerr.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7RailroadTerr")
public class GL7RailroadTerr extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7RailroadTerr> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7RailroadTerr>("entity.GL7RailroadTerr");
  ...
  private com.guidewire._generated.entity.GL7RailroadTerrInternal _internal;
   ...
   */
  public GL7RailroadTerr(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7RailroadTerr(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7RailroadTerrInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7RailroadTerrInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7RailroadTerrInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7RailroadTerr.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7RailroadTerr.class, config);
    com.guidewire._generated.entity.GL7RailroadTerrInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7RailroadTerr, com.guidewire._generated.entity.GL7RailroadTerrInternal>() {
      public java.lang.Object getImplementation(entity.GL7RailroadTerr bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7RailroadTerrInternal getInternalInterface(entity.GL7RailroadTerr bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7RailroadTerr newEmptyInstance() {
        return new entity.GL7RailroadTerr((java.lang.Void)null);
      }

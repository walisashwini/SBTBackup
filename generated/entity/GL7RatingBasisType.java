...
/**
 * GL7RatingBasisType
 * GL7 rating basis type configuration
 */
...
@gw.entity.EntityName(value = "GL7RatingBasisType")
public class GL7RatingBasisType extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7RatingBasisType> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7RatingBasisType>("entity.GL7RatingBasisType");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BASISTYPE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BasisType");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> RATINGBASISTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "RatingBasisType");
  ...
  private com.guidewire._generated.entity.GL7RatingBasisTypeInternal _internal;
   ...
   */
  public GL7RatingBasisType(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7RatingBasisType(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7RatingBasisTypeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7RatingBasisTypeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.String getBasisType() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(BASISTYPE_PROP.get());
  }
  ...
  public typekey.RatingBasisType getRatingBasisType() {
    return (typekey.RatingBasisType)__getInternalInterface().getFieldValue(RATINGBASISTYPE_PROP.get());
  }
  ...
  public void setBasisType(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(BASISTYPE_PROP.get(), value);
  }
  ...
  public void setRatingBasisType(typekey.RatingBasisType value) {
    __getInternalInterface().setFieldValue(RATINGBASISTYPE_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7RatingBasisTypeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7RatingBasisType.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7RatingBasisType.class, config);
    com.guidewire._generated.entity.GL7RatingBasisTypeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7RatingBasisType, com.guidewire._generated.entity.GL7RatingBasisTypeInternal>() {
      public java.lang.Object getImplementation(entity.GL7RatingBasisType bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7RatingBasisTypeInternal getInternalInterface(entity.GL7RatingBasisType bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7RatingBasisType newEmptyInstance() {
        return new entity.GL7RatingBasisType((java.lang.Void)null);
      }

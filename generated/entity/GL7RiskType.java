 ...
 * GL7RiskType
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7RiskType.eti;GL7RiskType.eix;GL7RiskType.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7RiskType")
public class GL7RiskType extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7RiskType> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7RiskType>("entity.GL7RiskType");
  ...
  private com.guidewire._generated.entity.GL7RiskTypeInternal _internal;
   ...
   */
  public GL7RiskType(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7RiskType(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7RiskTypeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7RiskTypeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7RiskTypeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7RiskType.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7RiskType.class, config);
    com.guidewire._generated.entity.GL7RiskTypeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7RiskType, com.guidewire._generated.entity.GL7RiskTypeInternal>() {
      public java.lang.Object getImplementation(entity.GL7RiskType bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7RiskTypeInternal getInternalInterface(entity.GL7RiskType bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7RiskType newEmptyInstance() {
        return new entity.GL7RiskType((java.lang.Void)null);
      }

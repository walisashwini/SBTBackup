...
/**
 * GL7ScheduleRatingMaximumC
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7ScheduleRatingMaximumC.eti;GL7ScheduleRatingMaximumC.eix;GL7ScheduleRatingMaximumC.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7ScheduleRatingMaximumC")
public class GL7ScheduleRatingMaximumC extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ScheduleRatingMaximumC> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ScheduleRatingMaximumC>("entity.GL7ScheduleRatingMaximumC");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BEANVERSION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BeanVersion");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CONSTANT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Constant");
  ...
  private com.guidewire._generated.entity.GL7ScheduleRatingMaximumCInternal _internal;
   ...
   */
  public GL7ScheduleRatingMaximumC()  {
   ...
   */
  public GL7ScheduleRatingMaximumC(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ScheduleRatingMaximumC(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ScheduleRatingMaximumCInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ScheduleRatingMaximumCInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.String getConstant() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CONSTANT_PROP.get());
  }
  ...
  public void setConstant(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CONSTANT_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ScheduleRatingMaximumCInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ScheduleRatingMaximumC.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ScheduleRatingMaximumC.class, config);
    com.guidewire._generated.entity.GL7ScheduleRatingMaximumCInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ScheduleRatingMaximumC, com.guidewire._generated.entity.GL7ScheduleRatingMaximumCInternal>() {
      public java.lang.Object getImplementation(entity.GL7ScheduleRatingMaximumC bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ScheduleRatingMaximumCInternal getInternalInterface(entity.GL7ScheduleRatingMaximumC bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ScheduleRatingMaximumC newEmptyInstance() {
        return new entity.GL7ScheduleRatingMaximumC((java.lang.Void)null);
      }

...
/**
 * GL7ScheduleRatingMaximumD
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7ScheduleRatingMaximumD.eti;GL7ScheduleRatingMaximumD.eix;GL7ScheduleRatingMaximumD.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7ScheduleRatingMaximumD")
public class GL7ScheduleRatingMaximumD extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ScheduleRatingMaximumD> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ScheduleRatingMaximumD>("entity.GL7ScheduleRatingMaximumD");
  ...
  private com.guidewire._generated.entity.GL7ScheduleRatingMaximumDInternal _internal;
   ...
   */
  public GL7ScheduleRatingMaximumD()  {
   ...
   */
  public GL7ScheduleRatingMaximumD(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ScheduleRatingMaximumD(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ScheduleRatingMaximumDInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ScheduleRatingMaximumDInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ScheduleRatingMaximumDInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ScheduleRatingMaximumD.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ScheduleRatingMaximumD.class, config);
    com.guidewire._generated.entity.GL7ScheduleRatingMaximumDInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ScheduleRatingMaximumD, com.guidewire._generated.entity.GL7ScheduleRatingMaximumDInternal>() {
      public java.lang.Object getImplementation(entity.GL7ScheduleRatingMaximumD bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ScheduleRatingMaximumDInternal getInternalInterface(entity.GL7ScheduleRatingMaximumD bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ScheduleRatingMaximumD newEmptyInstance() {
        return new entity.GL7ScheduleRatingMaximumD((java.lang.Void)null);
      }

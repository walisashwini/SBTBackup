...
/**
 * GL7ScheduleRatingModifica
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7ScheduleRatingModifica.eti;GL7ScheduleRatingModifica.eix;GL7ScheduleRatingModifica.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7ScheduleRatingModifica")
public class GL7ScheduleRatingModifica extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ScheduleRatingModifica> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ScheduleRatingModifica>("entity.GL7ScheduleRatingModifica");
  ...
  private com.guidewire._generated.entity.GL7ScheduleRatingModificaInternal _internal;
   ...
   */
  public GL7ScheduleRatingModifica()  {
   ...
   */
  public GL7ScheduleRatingModifica(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ScheduleRatingModifica(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ScheduleRatingModificaInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ScheduleRatingModificaInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ScheduleRatingModificaInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ScheduleRatingModifica.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ScheduleRatingModifica.class, config);
    com.guidewire._generated.entity.GL7ScheduleRatingModificaInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ScheduleRatingModifica, com.guidewire._generated.entity.GL7ScheduleRatingModificaInternal>() {
      public java.lang.Object getImplementation(entity.GL7ScheduleRatingModifica bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ScheduleRatingModificaInternal getInternalInterface(entity.GL7ScheduleRatingModifica bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ScheduleRatingModifica newEmptyInstance() {
        return new entity.GL7ScheduleRatingModifica((java.lang.Void)null);
      }

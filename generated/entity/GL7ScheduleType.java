 ...
 * GL7ScheduleType
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7ScheduleType.eti;GL7ScheduleType.eix;GL7ScheduleType.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7ScheduleType")
public class GL7ScheduleType extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ScheduleType> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ScheduleType>("entity.GL7ScheduleType");
  ...
  private com.guidewire._generated.entity.GL7ScheduleTypeInternal _internal;
   ...
   */
  public GL7ScheduleType(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ScheduleType(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ScheduleTypeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ScheduleTypeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ScheduleTypeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ScheduleType.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ScheduleType.class, config);
    com.guidewire._generated.entity.GL7ScheduleTypeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ScheduleType, com.guidewire._generated.entity.GL7ScheduleTypeInternal>() {
      public java.lang.Object getImplementation(entity.GL7ScheduleType bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ScheduleTypeInternal getInternalInterface(entity.GL7ScheduleType bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ScheduleType newEmptyInstance() {
        return new entity.GL7ScheduleType((java.lang.Void)null);
      }

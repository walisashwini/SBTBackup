...
@gw.entity.EntityName(value = "GL7Subline")
public class GL7Subline extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverable, entity.CoverableFieldAvailability, entity.Modifiable {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7Subline, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7Subline, entity.PolicyPeriod>("entity.GL7Subline");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BYLAWSCREATEDORAMENDEDONORAFTERDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ByLawsCreatedOrAmendedOnOrAfterDate");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CONDOMINIUMASSOCIATION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CondominiumAssociation");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DAMAGETOPREMISESRENTEDTOYOUEXCLGOVERNMENTALSUBDIVISION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DamageToPremisesRentedToYouExclGovernmentalSubdivision");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DOESTHISRISKOPERATESCAFFOLDBUILDINGSINCHICAGOTHATREQUIREPERMIT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DoesThisRiskOperateScaffoldBuildingsInChicagoThatRequirePermit");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DOESTHISRISKOPERATESCAFFOLDS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DoesThisRiskOperateScaffolds");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DOESTHISRISKPERFORMHOMEREPAIRANDREMODELING_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DoesThisRiskPerformHomeRepairAndRemodeling");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ENERGYEFFICIENCYINSTALLER_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "EnergyEfficiencyInstaller");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> STOPGAP_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "StopGap");
  ...
  private com.guidewire._generated.entity.GL7SublineInternal _internal;
   ...
   */
  public GL7Subline(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7Subline(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7Subline(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7SublineInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7Subline clone() {
    return (entity.GL7Subline)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7Subline getBasedOn() {
    return (entity.GL7Subline)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7Subline getBasedOnValue() {
    return (entity.GL7Subline)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public java.lang.String getByLawsCreatedOrAmendedOnOrAfterDate() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(BYLAWSCREATEDORAMENDEDONORAFTERDATE_PROP.get());
  }
  ...
  public entity.GL7SublineCond[] getConditions() {
    return (entity.GL7SublineCond[])__getInternalInterface().getFieldValue(CONDITIONS_PROP.get());
  }
  ...
  public java.lang.String getCondominiumAssociation() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CONDOMINIUMASSOCIATION_PROP.get());
  }
  ...
  public entity.GL7SublineCov[] getCoverages() {
    return (entity.GL7SublineCov[])__getInternalInterface().getFieldValue(COVERAGES_PROP.get());
  }
  ...
  public java.lang.String getDamageToPremisesRentedToYouExclGovernmentalSubdivision() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(DAMAGETOPREMISESRENTEDTOYOUEXCLGOVERNMENTALSUBDIVISION_PROP.get());
  }
  ...
  public java.lang.String getDoesThisRiskOperateScaffoldBuildingsInChicagoThatRequirePermit() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(DOESTHISRISKOPERATESCAFFOLDBUILDINGSINCHICAGOTHATREQUIREPERMIT_PROP.get());
  }
  ...
  public java.lang.String getDoesThisRiskOperateScaffolds() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(DOESTHISRISKOPERATESCAFFOLDS_PROP.get());
  }
  ...
  public java.lang.String getDoesThisRiskPerformHomeRepairAndRemodeling() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(DOESTHISRISKPERFORMHOMEREPAIRANDREMODELING_PROP.get());
  }
  ...
  public java.lang.String getEnergyEfficiencyInstaller() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(ENERGYEFFICIENCYINSTALLER_PROP.get());
  }
  ...
  public entity.GL7SublineExcl[] getExclusions() {
    return (entity.GL7SublineExcl[])__getInternalInterface().getFieldValue(EXCLUSIONS_PROP.get());
  }
  ...
  public entity.GL7Subline getFixed() {
    return (entity.GL7Subline)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7SublineMod[] getModifiers() {
    return (entity.GL7SublineMod[])__getInternalInterface().getFieldValue(MODIFIERS_PROP.get());
  }
  ...
  public entity.GL7Subline getSlice(java.util.Date sliceDate) {
    return (entity.GL7Subline)getSliceUntyped(sliceDate);
  }
  ...
  public java.lang.String getStopGap() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(STOPGAP_PROP.get());
  }
  ...
  public entity.GL7Subline getUnsliced() {
    return (entity.GL7Subline)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7SublineVersionList getVersionList() {
    return (entity.windowed.GL7SublineVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7Subline value) {
  ...
  public void setByLawsCreatedOrAmendedOnOrAfterDate(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(BYLAWSCREATEDORAMENDEDONORAFTERDATE_PROP.get(), value);
  }
  ...
  public void setCondominiumAssociation(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CONDOMINIUMASSOCIATION_PROP.get(), value);
  }
  ...
  public void setDamageToPremisesRentedToYouExclGovernmentalSubdivision(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(DAMAGETOPREMISESRENTEDTOYOUEXCLGOVERNMENTALSUBDIVISION_PROP.get(), value);
  }
  ...
  public void setDoesThisRiskOperateScaffoldBuildingsInChicagoThatRequirePermit(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(DOESTHISRISKOPERATESCAFFOLDBUILDINGSINCHICAGOTHATREQUIREPERMIT_PROP.get(), value);
  }
  ...
  public void setDoesThisRiskOperateScaffolds(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(DOESTHISRISKOPERATESCAFFOLDS_PROP.get(), value);
  }
  ...
  public void setDoesThisRiskPerformHomeRepairAndRemodeling(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(DOESTHISRISKPERFORMHOMEREPAIRANDREMODELING_PROP.get(), value);
  }
  ...
  public void setEnergyEfficiencyInstaller(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(ENERGYEFFICIENCYINSTALLER_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.GL7Subline value) {
  ...
  public void setStopGap(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(STOPGAP_PROP.get(), value);
  }
  ...
  public entity.GL7Subline split(java.util.Date splitDate) {
    return (entity.GL7Subline)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7Subline.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.gl7.GL7SublineCoverableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.gl7.GL7SublineCoverableAdapter");
    config.put("gw.api.domain.ModifiableAdapter", "gw.lob.gl7.GL7SublineCoverableAdapter");
    config.put("gw.lob.common.LobCoverable", "gw.lob.gl7.GL7SublineCoverable");
    config.put("gw.lob.gl7.GL7Coverable", "gw.lob.gl7.GL7SublineCoverable");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7Subline.class, config);
    com.guidewire._generated.entity.GL7SublineInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7Subline, com.guidewire._generated.entity.GL7SublineInternal>() {
      public java.lang.Object getImplementation(entity.GL7Subline bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineInternal getInternalInterface(entity.GL7Subline bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7Subline newEmptyInstance() {
        return new entity.GL7Subline((java.lang.Void)null);
      }

...
/**
 * GL7SublineCondCost
 * The cost for a Subline Condition
 */
...
@gw.entity.EntityName(value = "GL7SublineCondCost")
public class GL7SublineCondCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublineCondCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublineCondCost, entity.PolicyPeriod>("entity.GL7SublineCondCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLINECONDITION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublineCondition");
   ...
   */
  public GL7SublineCondCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublineCondCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublineCondCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublineCondCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineCondCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublineCondCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublineCondCost clone() {
    return (entity.GL7SublineCondCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublineCondCost getBasedOn() {
    return (entity.GL7SublineCondCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublineCondCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublineCondCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublineCond getSublineCondition() {
    return (entity.GL7SublineCond)__getInternalInterface().getFieldValue(SUBLINECONDITION_PROP.get());
  }
  
  public entity.GL7SublineCondCost getUnsliced() {
    return (entity.GL7SublineCondCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublineCondCostVersionList getVersionList() {
    return (entity.windowed.GL7SublineCondCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublineCondition(entity.GL7SublineCond value) {
    __getInternalInterface().setFieldValue(SUBLINECONDITION_PROP.get(), value);
  }
  
  public entity.GL7SublineCondCost split(java.util.Date splitDate) {
    return (entity.GL7SublineCondCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineCondCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublineCondCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getSublineConditionID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLINECONDITION_PROP.get());
    }
    ...
    public void setSublineConditionID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLINECONDITION_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7SublineCondCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublineCondCost.class, config);
    com.guidewire._generated.entity.GL7SublineCondCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublineCondCost, com.guidewire._generated.entity.GL7SublineCondCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublineCondCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineCondCostInternal getInternalInterface(entity.GL7SublineCondCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublineCondCost newEmptyInstance() {
        return new entity.GL7SublineCondCost((java.lang.Void)null);
      }

...
/**
 * GL7SublineCov
 * Coverages for the General Liability Subline
 */
...
@gw.entity.EntityName(value = "GL7SublineCov")
public class GL7SublineCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublineCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublineCov, entity.PolicyPeriod>("entity.GL7SublineCov");
  ...
  private com.guidewire._generated.entity.GL7SublineCovInternal _internal;
   ...
   */
  protected GL7SublineCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7SublineCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublineCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7SublineCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7SublineCov clone() {
    return (entity.GL7SublineCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7SublineCov getBasedOn() {
    return (entity.GL7SublineCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublineCov getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublineCov)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublineCov getUnsliced() {
    return (entity.GL7SublineCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7SublineCovVersionList getVersionList() {
    return (entity.windowed.GL7SublineCovVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7SublineCov value) {
   ...
   */
  private void setFixed(entity.GL7SublineCov value) {
   ...
   */
  private void setSubtype(typekey.GL7SublineCov value) {
  ...
  public entity.GL7SublineCov split(java.util.Date splitDate) {
    return (entity.GL7SublineCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublineCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.GL7SublineCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.GL7SublineCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublineCov.class, config);
    com.guidewire._generated.entity.GL7SublineCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublineCov, com.guidewire._generated.entity.GL7SublineCovInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublineCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineCovInternal getInternalInterface(entity.GL7SublineCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublineCov newEmptyInstance() {
        return new entity.GL7SublineCov((java.lang.Void)null);
      }

...
/**
 * GL7SublineCovCost
 * The cost for a Subline Coverage.
 */
...
@gw.entity.EntityName(value = "GL7SublineCovCost")
public class GL7SublineCovCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublineCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublineCovCost, entity.PolicyPeriod>("entity.GL7SublineCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLINECOVERAGE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublineCoverage");
   ...
   */
  public GL7SublineCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublineCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublineCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublineCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublineCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublineCovCost clone() {
    return (entity.GL7SublineCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublineCovCost getBasedOn() {
    return (entity.GL7SublineCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublineCovCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublineCovCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublineCov getSublineCoverage() {
    return (entity.GL7SublineCov)__getInternalInterface().getFieldValue(SUBLINECOVERAGE_PROP.get());
  }
  
  public entity.GL7SublineCovCost getUnsliced() {
    return (entity.GL7SublineCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublineCovCostVersionList getVersionList() {
    return (entity.windowed.GL7SublineCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublineCoverage(entity.GL7SublineCov value) {
    __getInternalInterface().setFieldValue(SUBLINECOVERAGE_PROP.get(), value);
  }
  
  public entity.GL7SublineCovCost split(java.util.Date splitDate) {
    return (entity.GL7SublineCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublineCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getSublineCoverageID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLINECOVERAGE_PROP.get());
    }
    ...
    public void setSublineCoverageID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLINECOVERAGE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7SublineCovCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublineCovCost.class, config);
    com.guidewire._generated.entity.GL7SublineCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublineCovCost, com.guidewire._generated.entity.GL7SublineCovCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublineCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineCovCostInternal getInternalInterface(entity.GL7SublineCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublineCovCost newEmptyInstance() {
        return new entity.GL7SublineCovCost((java.lang.Void)null);
      }

...
/**
 * GL7SublineExcl
 * Exclusions for the General Liability Subline
 */
...
@gw.entity.EntityName(value = "GL7SublineExcl")
public class GL7SublineExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublineExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublineExcl, entity.PolicyPeriod>("entity.GL7SublineExcl");
  ...
  private com.guidewire._generated.entity.GL7SublineExclInternal _internal;
   ...
   */
  protected GL7SublineExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7SublineExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublineExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7SublineExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7SublineExcl clone() {
    return (entity.GL7SublineExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7SublineExcl getBasedOn() {
    return (entity.GL7SublineExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublineExcl getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublineExcl)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublineExcl getUnsliced() {
    return (entity.GL7SublineExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7SublineExclVersionList getVersionList() {
    return (entity.windowed.GL7SublineExclVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7SublineExcl value) {
   ...
   */
  private void setFixed(entity.GL7SublineExcl value) {
   ...
   */
  private void setSubtype(typekey.GL7SublineExcl value) {
  ...
  public entity.GL7SublineExcl split(java.util.Date splitDate) {
    return (entity.GL7SublineExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublineExcl.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.GL7SublineExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.GL7SublineExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublineExcl.class, config);
    com.guidewire._generated.entity.GL7SublineExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublineExcl, com.guidewire._generated.entity.GL7SublineExclInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublineExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineExclInternal getInternalInterface(entity.GL7SublineExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublineExcl newEmptyInstance() {
        return new entity.GL7SublineExcl((java.lang.Void)null);
      }

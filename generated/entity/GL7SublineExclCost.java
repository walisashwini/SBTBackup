...
/**
 * GL7SublineExclCost
 * The cost for a Subline Exclusion
 */
...
@gw.entity.EntityName(value = "GL7SublineExclCost")
public class GL7SublineExclCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublineExclCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublineExclCost, entity.PolicyPeriod>("entity.GL7SublineExclCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLINEEXCLUSION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublineExclusion");
   ...
   */
  public GL7SublineExclCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublineExclCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublineExclCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublineExclCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineExclCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublineExclCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublineExclCost clone() {
    return (entity.GL7SublineExclCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublineExclCost getBasedOn() {
    return (entity.GL7SublineExclCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublineExclCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublineExclCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublineExcl getSublineExclusion() {
    return (entity.GL7SublineExcl)__getInternalInterface().getFieldValue(SUBLINEEXCLUSION_PROP.get());
  }
  
  public entity.GL7SublineExclCost getUnsliced() {
    return (entity.GL7SublineExclCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublineExclCostVersionList getVersionList() {
    return (entity.windowed.GL7SublineExclCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublineExclusion(entity.GL7SublineExcl value) {
    __getInternalInterface().setFieldValue(SUBLINEEXCLUSION_PROP.get(), value);
  }
  
  public entity.GL7SublineExclCost split(java.util.Date splitDate) {
    return (entity.GL7SublineExclCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineExclCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublineExclCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getSublineExclusionID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLINEEXCLUSION_PROP.get());
    }
    ...
    public void setSublineExclusionID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLINEEXCLUSION_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7SublineExclCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublineExclCost.class, config);
    com.guidewire._generated.entity.GL7SublineExclCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublineExclCost, com.guidewire._generated.entity.GL7SublineExclCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublineExclCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineExclCostInternal getInternalInterface(entity.GL7SublineExclCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublineExclCost newEmptyInstance() {
        return new entity.GL7SublineExclCost((java.lang.Void)null);
      }

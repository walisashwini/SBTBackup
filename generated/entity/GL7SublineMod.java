...
/**
 * GL7SublineMod
 * A modifier for General Liability Subline
 */
...
@gw.entity.EntityName(value = "GL7SublineMod")
public class GL7SublineMod extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Modifier, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublineMod, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublineMod, entity.PolicyPeriod>("entity.GL7SublineMod");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> GL7SUBLINERATEFACTORS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "GL7SublineRateFactors");
  ...
  private com.guidewire._generated.entity.GL7SublineModInternal _internal;
   ...
   */
  public GL7SublineMod(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublineMod(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublineMod(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7SublineModInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineModInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToGL7SublineRateFactors(entity.GL7SublineRF element) {
    __getInternalInterface().addArrayElement(GL7SUBLINERATEFACTORS_PROP.get(), element);
  }
  ...
  public entity.GL7SublineMod clone() {
    return (entity.GL7SublineMod)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7SublineMod getBasedOn() {
    return (entity.GL7SublineMod)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublineMod getBasedOnValue() {
    return (entity.GL7SublineMod)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7SublineMod getFixed() {
    return (entity.GL7SublineMod)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7SublineRF[] getGL7SublineRateFactors() {
    return (entity.GL7SublineRF[])__getInternalInterface().getFieldValue(GL7SUBLINERATEFACTORS_PROP.get());
  }
  ...
  public entity.GL7SublineMod getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublineMod)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.GL7SublineMod getSubtype() {
    return (typekey.GL7SublineMod)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.GL7SublineMod getUnsliced() {
    return (entity.GL7SublineMod)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7SublineModVersionList getVersionList() {
    return (entity.windowed.GL7SublineModVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromGL7SublineRateFactors(entity.GL7SublineRF element) {
    __getInternalInterface().removeArrayElement(GL7SUBLINERATEFACTORS_PROP.get(), element);
  }
  ...
  public void removeFromGL7SublineRateFactors(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(GL7SUBLINERATEFACTORS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.GL7SublineMod value) {
   ...
   */
  private void setFixed(entity.GL7SublineMod value) {
  ...
  public void setGL7SublineRateFactors(entity.GL7SublineRF[] value) {
    __getInternalInterface().setFieldValue(GL7SUBLINERATEFACTORS_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.GL7SublineMod value) {
  ...
  public entity.GL7SublineMod split(java.util.Date splitDate) {
    return (entity.GL7SublineMod)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineModInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublineMod.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ModifierAbstractDomainMethods", "gw.lob.gl7.GL7SublineModifierAdapter");
    config.put("gw.api.domain.ModifierAdapter", "gw.lob.gl7.GL7SublineModifierAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.GL7SublineModifierMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.GL7SublineModifierMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublineMod.class, config);
    com.guidewire._generated.entity.GL7SublineModInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublineMod, com.guidewire._generated.entity.GL7SublineModInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublineMod bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineModInternal getInternalInterface(entity.GL7SublineMod bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublineMod newEmptyInstance() {
        return new entity.GL7SublineMod((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "GL7SublineRF")
public class GL7SublineRF extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.RateFactor, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublineRF, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublineRF, entity.PolicyPeriod>("entity.GL7SublineRF");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GL7SUBLINEMODIFIER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GL7SublineModifier");
  ...
  private com.guidewire._generated.entity.GL7SublineRFInternal _internal;
   ...
   */
  public GL7SublineRF(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublineRF(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublineRF(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7SublineRFInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineRFInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7SublineRF clone() {
    return (entity.GL7SublineRF)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7SublineRF getBasedOn() {
    return (entity.GL7SublineRF)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublineRF getBasedOnValue() {
    return (entity.GL7SublineRF)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7SublineRF getFixed() {
    return (entity.GL7SublineRF)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7SublineMod getGL7SublineModifier() {
    return (entity.GL7SublineMod)__getInternalInterface().getFieldValue(GL7SUBLINEMODIFIER_PROP.get());
  }
  ...
  public entity.GL7SublineRF getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublineRF)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublineRF getUnsliced() {
    return (entity.GL7SublineRF)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7SublineRFVersionList getVersionList() {
    return (entity.windowed.GL7SublineRFVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7SublineRF value) {
   ...
   */
  private void setFixed(entity.GL7SublineRF value) {
  ...
  public void setGL7SublineModifier(entity.GL7SublineMod value) {
    __getInternalInterface().setFieldValue(GL7SUBLINEMODIFIER_PROP.get(), value);
  }
  ...
  public entity.GL7SublineRF split(java.util.Date splitDate) {
    return (entity.GL7SublineRF)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineRFInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublineRF.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getGL7SublineModifierID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GL7SUBLINEMODIFIER_PROP.get());
    }
    ...
    public void setGL7SublineModifierID(gw.pl.persistence.core.Key value) {
      setFieldValue(GL7SUBLINEMODIFIER_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.RateFactorAdapter", "gw.lob.gl7.GL7SublineRateFactorAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.GL7SublineRateFactorMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.GL7SublineRateFactorMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublineRF.class, config);
    com.guidewire._generated.entity.GL7SublineRFInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublineRF, com.guidewire._generated.entity.GL7SublineRFInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublineRF bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineRFInternal getInternalInterface(entity.GL7SublineRF bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublineRF newEmptyInstance() {
        return new entity.GL7SublineRF((java.lang.Void)null);
      }

...
/**
 * GL7SublineSchedCond
 * GL7 Subline Condition with a schedule
 */
...
@gw.entity.EntityName(value = "GL7SublineSchedCond")
public class GL7SublineSchedCond extends entity.GL7SublineCond implements entity.ScheduleAutoNumberSequence, gw.api.copier.EffDatedCopyable, gw.api.domain.Schedule, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublineSchedCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublineSchedCond, entity.PolicyPeriod>("entity.GL7SublineSchedCond");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> GL7SCHEDULEDITEMS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "GL7ScheduledItems");
   ...
   */
  protected GL7SublineSchedCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7SublineSchedCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublineSchedCond(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublineSchedCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineSchedCondInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublineSchedCondInternal)super.__getInternalInterface();
  }
   ...
   */
  public void addToGL7ScheduledItems(entity.GL7SublineSchedCondItem element) {
    __getInternalInterface().addArrayElement(GL7SCHEDULEDITEMS_PROP.get(), element);
  }
  ...
  public entity.GL7SublineSchedCond clone() {
    return (entity.GL7SublineSchedCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7SublineSchedCond getBasedOn() {
    return (entity.GL7SublineSchedCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublineSchedCondItem[] getGL7ScheduledItems() {
    return (entity.GL7SublineSchedCondItem[])__getInternalInterface().getFieldValue(GL7SCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.GL7SublineSchedCond getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublineSchedCond)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7SublineSchedCond getUnsliced() {
    return (entity.GL7SublineSchedCond)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublineSchedCondVersionList getVersionList() {
    return (entity.windowed.GL7SublineSchedCondVersionList)getVersionListUntyped();
  }
   ...
   */
  public void removeFromGL7ScheduledItems(entity.GL7SublineSchedCondItem element) {
    __getInternalInterface().removeArrayElement(GL7SCHEDULEDITEMS_PROP.get(), element);
  }
  ...
  public void removeFromGL7ScheduledItems(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(GL7SCHEDULEDITEMS_PROP.get(), elementID);
  }
   ...
   */
  public void setGL7ScheduledItems(entity.GL7SublineSchedCondItem[] value) {
    __getInternalInterface().setFieldValue(GL7SCHEDULEDITEMS_PROP.get(), value);
  }
  ...
  public entity.GL7SublineSchedCond split(java.util.Date splitDate) {
    return (entity.GL7SublineSchedCond)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineSchedCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublineSchedCond.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.Schedule", "gw.lob.gl7.schedules.GL7SublineSchedCondImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7SublineSchedCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7SublineSchedCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublineSchedCond.class, config);
    com.guidewire._generated.entity.GL7SublineSchedCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublineSchedCond, com.guidewire._generated.entity.GL7SublineSchedCondInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublineSchedCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineSchedCondInternal getInternalInterface(entity.GL7SublineSchedCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublineSchedCond newEmptyInstance() {
        return new entity.GL7SublineSchedCond((java.lang.Void)null);
      }

 ...
 * GL7 Subline level condition scheduled item
 */
...
@gw.entity.EntityName(value = "GL7SublineSchedCondItem")
public class GL7SublineSchedCondItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.ScheduledItem, entity.Coverable, entity.CoverableFieldAvailability, entity.GL7ScheduledItem, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublineSchedCondItem, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublineSchedCondItem, entity.PolicyPeriod>("entity.GL7SublineSchedCondItem");
  ...
  private com.guidewire._generated.entity.GL7SublineSchedCondItemInternal _internal;
   ...
   */
  public GL7SublineSchedCondItem(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublineSchedCondItem(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublineSchedCondItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7SublineSchedCondItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineSchedCondItemInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  public void addToConditionCosts(entity.GL7SublnSchedCondItemCondCost element) {
   ...
   */
  public void addToConditions(entity.GL7SublnSchedCondItmCond element) {
   ...
   */
  public void addToCoverageCosts(entity.GL7SublnSchedCondItemCovCost element) {
   ...
   */
  public void addToCoverages(entity.GL7SublnSchedCondItmCov element) {
   ...
   */
  public void addToExclusionCosts(entity.GL7SublnSchedCondItemExclCost element) {
   ...
   */
  public void addToExclusions(entity.GL7SublnSchedCondItmExcl element) {
   ...
   */
  public void addToScheduleItemCosts(entity.GL7SublnSchedCondItemCost element) {
  ...
  public entity.GL7SublineSchedCondItem clone() {
    return (entity.GL7SublineSchedCondItem)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7SublineSchedCondItem getBasedOn() {
    return (entity.GL7SublineSchedCondItem)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7SublineSchedCondItem getBasedOnValue() {
    return (entity.GL7SublineSchedCondItem)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7SublnSchedCondItemCondCost[] getConditionCosts() {
    return (entity.GL7SublnSchedCondItemCondCost[])__getInternalInterface().getFieldValue(CONDITIONCOSTS_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7SublnSchedCondItmCond[] getConditions() {
    return (entity.GL7SublnSchedCondItmCond[])__getInternalInterface().getFieldValue(CONDITIONS_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7SublnSchedCondItemCovCost[] getCoverageCosts() {
    return (entity.GL7SublnSchedCondItemCovCost[])__getInternalInterface().getFieldValue(COVERAGECOSTS_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7SublnSchedCondItmCov[] getCoverages() {
    return (entity.GL7SublnSchedCondItmCov[])__getInternalInterface().getFieldValue(COVERAGES_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7SublnSchedCondItemExclCost[] getExclusionCosts() {
    return (entity.GL7SublnSchedCondItemExclCost[])__getInternalInterface().getFieldValue(EXCLUSIONCOSTS_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7SublnSchedCondItmExcl[] getExclusions() {
    return (entity.GL7SublnSchedCondItmExcl[])__getInternalInterface().getFieldValue(EXCLUSIONS_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7SublineSchedCondItem getFixed() {
    return (entity.GL7SublineSchedCondItem)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7SublineSchedCond getScheduleCondition() {
    return (entity.GL7SublineSchedCond)__getInternalInterface().getFieldValue(SCHEDULECONDITION_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7SublnSchedCondItemCost[] getScheduleItemCosts() {
    return (entity.GL7SublnSchedCondItemCost[])__getInternalInterface().getFieldValue(SCHEDULEITEMCOSTS_PROP.get());
  }
  ...
  public entity.GL7SublineSchedCondItem getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublineSchedCondItem)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.GL7SublineSchedCondItem getSubtype() {
    return (typekey.GL7SublineSchedCondItem)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.GL7SublineSchedCondItem getUnsliced() {
    return (entity.GL7SublineSchedCondItem)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7SublineSchedCondItemVersionList getVersionList() {
    return (entity.windowed.GL7SublineSchedCondItemVersionList)getVersionListUntyped();
  }
   ...
   */
  public void removeFromConditionCosts(entity.GL7SublnSchedCondItemCondCost element) {
   ...
   */
  public void removeFromConditions(entity.GL7SublnSchedCondItmCond element) {
   ...
   */
  public void removeFromCoverageCosts(entity.GL7SublnSchedCondItemCovCost element) {
   ...
   */
  public void removeFromCoverages(entity.GL7SublnSchedCondItmCov element) {
   ...
   */
  public void removeFromExclusionCosts(entity.GL7SublnSchedCondItemExclCost element) {
   ...
   */
  public void removeFromExclusions(entity.GL7SublnSchedCondItmExcl element) {
   ...
   */
  public void removeFromScheduleItemCosts(entity.GL7SublnSchedCondItemCost element) {
   ...
   */
  private void setBasedOnValue(entity.GL7SublineSchedCondItem value) {
   ...
   */
  public void setConditionCosts(entity.GL7SublnSchedCondItemCondCost[] value) {
   ...
   */
  public void setConditions(entity.GL7SublnSchedCondItmCond[] value) {
   ...
   */
  public void setCoverageCosts(entity.GL7SublnSchedCondItemCovCost[] value) {
   ...
   */
  public void setCoverages(entity.GL7SublnSchedCondItmCov[] value) {
   ...
   */
  public void setExclusionCosts(entity.GL7SublnSchedCondItemExclCost[] value) {
   ...
   */
  public void setExclusions(entity.GL7SublnSchedCondItmExcl[] value) {
   ...
   */
  private void setFixed(entity.GL7SublineSchedCondItem value) {
   ...
   */
  public void setScheduleCondition(entity.GL7SublineSchedCond value) {
   ...
   */
  public void setScheduleItemCosts(entity.GL7SublnSchedCondItemCost[] value) {
   ...
   */
  private void setSubtype(typekey.GL7SublineSchedCondItem value) {
  ...
  public entity.GL7SublineSchedCondItem split(java.util.Date splitDate) {
    return (entity.GL7SublineSchedCondItem)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineSchedCondItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublineSchedCondItem.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.GL7SublineSchedCondItem value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.GL7SublineSchedCondItem value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.GL7SublineSchedCondItem value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.gl7.schedules.GL7SublineSchedCondItemAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.gl7.schedules.GL7SublineSchedCondItemAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7SublineSchedCondItemMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7SublineSchedCondItemMatcher");
    config.put("gw.api.productmodel.ScheduledItemAdapter", "gw.lob.gl7.schedules.GL7SublineSchedCondItemAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublineSchedCondItem.class, config);
    com.guidewire._generated.entity.GL7SublineSchedCondItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublineSchedCondItem, com.guidewire._generated.entity.GL7SublineSchedCondItemInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublineSchedCondItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineSchedCondItemInternal getInternalInterface(entity.GL7SublineSchedCondItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublineSchedCondItem newEmptyInstance() {
        return new entity.GL7SublineSchedCondItem((java.lang.Void)null);
      }

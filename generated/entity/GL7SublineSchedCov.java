...
/**
 * GL7SublineSchedCov
 * GL7 Subline Coverage with a schedule
 */
...
@gw.entity.EntityName(value = "GL7SublineSchedCov")
public class GL7SublineSchedCov extends entity.GL7SublineCov implements entity.ScheduleAutoNumberSequence, gw.api.copier.EffDatedCopyable, gw.api.domain.Schedule, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublineSchedCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublineSchedCov, entity.PolicyPeriod>("entity.GL7SublineSchedCov");
   ...
   */
  protected GL7SublineSchedCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7SublineSchedCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublineSchedCov(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublineSchedCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineSchedCovInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublineSchedCovInternal)super.__getInternalInterface();
  }
   ...
   */
  public void addToGL7ScheduledItems(entity.GL7SublineSchedCovItem element) {
  ...
  public entity.GL7SublineSchedCov clone() {
    return (entity.GL7SublineSchedCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7SublineSchedCov getBasedOn() {
    return (entity.GL7SublineSchedCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublineSchedCovItem[] getGL7ScheduledItems() {
    return (entity.GL7SublineSchedCovItem[])__getInternalInterface().getFieldValue(GL7SCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.GL7SublineSchedCov getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublineSchedCov)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7SublineSchedCov getUnsliced() {
    return (entity.GL7SublineSchedCov)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublineSchedCovVersionList getVersionList() {
    return (entity.windowed.GL7SublineSchedCovVersionList)getVersionListUntyped();
  }
   ...
   */
  public void removeFromGL7ScheduledItems(entity.GL7SublineSchedCovItem element) {
   ...
   */
  public void setGL7ScheduledItems(entity.GL7SublineSchedCovItem[] value) {
  ...
  public entity.GL7SublineSchedCov split(java.util.Date splitDate) {
    return (entity.GL7SublineSchedCov)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineSchedCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublineSchedCov.this.__getDelegateManager();
    }
    ...
    public entity.GL7SublineCov getBasedOnValue() {
      return (entity.GL7SublineCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public entity.GL7SublineCovCost[] getCosts() {
      return (entity.GL7SublineCovCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
    }
    ...
    public entity.GL7SublineCov getFixed() {
      return (entity.GL7SublineCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public typekey.GL7SublineCov getSubtype() {
      return (typekey.GL7SublineCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.GL7SublineCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.GL7SublineCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.gl7.GL7SublineCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.gl7.GL7SublineCoverageAdapter");
    config.put("gw.api.domain.Schedule", "gw.lob.gl7.schedules.GL7SublineSchedCovImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7SublineSchedCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7SublineSchedCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublineSchedCov.class, config);
    com.guidewire._generated.entity.GL7SublineSchedCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublineSchedCov, com.guidewire._generated.entity.GL7SublineSchedCovInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublineSchedCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineSchedCovInternal getInternalInterface(entity.GL7SublineSchedCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublineSchedCov newEmptyInstance() {
        return new entity.GL7SublineSchedCov((java.lang.Void)null);
      }

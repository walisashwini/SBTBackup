...
/**
 * GL7SublineSchedExcl
 * GL7 Subline Exclusion with a schedule
 */
...
@gw.entity.EntityName(value = "GL7SublineSchedExcl")
public class GL7SublineSchedExcl extends entity.GL7SublineExcl implements entity.ScheduleAutoNumberSequence, gw.api.copier.EffDatedCopyable, gw.api.domain.Schedule, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublineSchedExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublineSchedExcl, entity.PolicyPeriod>("entity.GL7SublineSchedExcl");
   ...
   */
  protected GL7SublineSchedExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7SublineSchedExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublineSchedExcl(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublineSchedExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineSchedExclInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublineSchedExclInternal)super.__getInternalInterface();
  }
  ...
  public entity.GL7SublineSchedExcl clone() {
    return (entity.GL7SublineSchedExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7SublineSchedExcl getBasedOn() {
    return (entity.GL7SublineSchedExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublineSchedExclItem[] getGL7ScheduledItems() {
    return (entity.GL7SublineSchedExclItem[])__getInternalInterface().getFieldValue(GL7SCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.GL7SublineSchedExcl getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublineSchedExcl)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7SublineSchedExcl getUnsliced() {
    return (entity.GL7SublineSchedExcl)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublineSchedExclVersionList getVersionList() {
    return (entity.windowed.GL7SublineSchedExclVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7SublineSchedExcl split(java.util.Date splitDate) {
    return (entity.GL7SublineSchedExcl)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineSchedExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublineSchedExcl.this.__getDelegateManager();
    }
    ...
    public entity.GL7SublineExcl getBasedOnValue() {
      return (entity.GL7SublineExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public entity.GL7SublineExclCost[] getCosts() {
      return (entity.GL7SublineExclCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
    }
    ...
    public entity.GL7SublineExcl getFixed() {
      return (entity.GL7SublineExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public typekey.GL7SublineExcl getSubtype() {
      return (typekey.GL7SublineExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.GL7SublineExclusionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.GL7SublineExclusionAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.gl7.GL7SublineExclusionAdapter");
    config.put("gw.api.domain.Schedule", "gw.lob.gl7.schedules.GL7SublineSchedExclImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7SublineSchedExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7SublineSchedExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublineSchedExcl.class, config);
    com.guidewire._generated.entity.GL7SublineSchedExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublineSchedExcl, com.guidewire._generated.entity.GL7SublineSchedExclInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublineSchedExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineSchedExclInternal getInternalInterface(entity.GL7SublineSchedExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublineSchedExcl newEmptyInstance() {
        return new entity.GL7SublineSchedExcl((java.lang.Void)null);
      }

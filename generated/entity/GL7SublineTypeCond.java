...
/**
 * GL7SublineTypeCond
 * Conditions for the General Liability Subline Type
 */
...
@gw.entity.EntityName(value = "GL7SublineTypeCond")
public class GL7SublineTypeCond extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PolicyCondition, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublineTypeCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublineTypeCond, entity.PolicyPeriod>("entity.GL7SublineTypeCond");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GL7SUBLINETYPE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GL7SublineType");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> STRINGTERM7_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "StringTerm7");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> STRINGTERM7AVL_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "StringTerm7Avl");
  ...
  private com.guidewire._generated.entity.GL7SublineTypeCondInternal _internal;
   ...
   */
  protected GL7SublineTypeCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7SublineTypeCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublineTypeCond(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7SublineTypeCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineTypeCondInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7SublineTypeCond clone() {
    return (entity.GL7SublineTypeCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7SublineTypeCond getBasedOn() {
    return (entity.GL7SublineTypeCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublineTypeCond getBasedOnValue() {
    return (entity.GL7SublineTypeCond)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7SublineTypeCondCost[] getCosts() {
    return (entity.GL7SublineTypeCondCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
  }
  ...
  public entity.GL7SublineTypeCond getFixed() {
    return (entity.GL7SublineTypeCond)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7SublineType getGL7SublineType() {
    return (entity.GL7SublineType)__getInternalInterface().getFieldValue(GL7SUBLINETYPE_PROP.get());
  }
  ...
  public entity.GL7SublineTypeCond getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublineTypeCond)getSliceUntyped(sliceDate);
  }
  ...
  public java.lang.String getStringTerm7() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(STRINGTERM7_PROP.get());
  }
  ...
  public typekey.GL7SublineTypeCond getSubtype() {
    return (typekey.GL7SublineTypeCond)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.GL7SublineTypeCond getUnsliced() {
    return (entity.GL7SublineTypeCond)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7SublineTypeCondVersionList getVersionList() {
    return (entity.windowed.GL7SublineTypeCondVersionList)getVersionListUntyped();
  }
  ...
  public java.lang.Boolean isStringTerm7Avl() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(STRINGTERM7AVL_PROP.get());
  }
   ...
   */
  private void setBasedOnValue(entity.GL7SublineTypeCond value) {
   ...
   */
  private void setFixed(entity.GL7SublineTypeCond value) {
  ...
  public void setGL7SublineType(entity.GL7SublineType value) {
    __getInternalInterface().setFieldValue(GL7SUBLINETYPE_PROP.get(), value);
  }
   ...
   */
  private void setStringTerm7(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(STRINGTERM7_PROP.get(), value);
  }
  
  /**
   * Sets the value of the StringTerm7Avl field.
   */
  private void setStringTerm7Avl(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(STRINGTERM7AVL_PROP.get(), value);
  }
  
  /**
   * Sets the value of the Subtype field.
   */
  private void setSubtype(typekey.GL7SublineTypeCond value) {
  ...
  public entity.GL7SublineTypeCond split(java.util.Date splitDate) {
    return (entity.GL7SublineTypeCond)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineTypeCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublineTypeCond.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getGL7SublineTypeID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GL7SUBLINETYPE_PROP.get());
    }
    ...
    public void setGL7SublineTypeID(gw.pl.persistence.core.Key value) {
      setFieldValue(GL7SUBLINETYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.GL7SublineTypeConditionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.GL7SublineTypeConditionAdapter");
    config.put("gw.api.domain.PolicyConditionAdapter", "gw.lob.gl7.GL7SublineTypeConditionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.GL7SublineTypeCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.GL7SublineTypeCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublineTypeCond.class, config);
    com.guidewire._generated.entity.GL7SublineTypeCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublineTypeCond, com.guidewire._generated.entity.GL7SublineTypeCondInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublineTypeCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineTypeCondInternal getInternalInterface(entity.GL7SublineTypeCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublineTypeCond newEmptyInstance() {
        return new entity.GL7SublineTypeCond((java.lang.Void)null);
      }

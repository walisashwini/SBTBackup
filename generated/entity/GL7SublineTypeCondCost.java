...
/**
 * GL7SublineTypeCondCost
 * The cost for a Subline Type Condition
 */
...
@gw.entity.EntityName(value = "GL7SublineTypeCondCost")
public class GL7SublineTypeCondCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublineTypeCondCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublineTypeCondCost, entity.PolicyPeriod>("entity.GL7SublineTypeCondCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLINETYPECONDITION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublineTypeCondition");
   ...
   */
  public GL7SublineTypeCondCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublineTypeCondCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublineTypeCondCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublineTypeCondCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineTypeCondCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublineTypeCondCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublineTypeCondCost clone() {
    return (entity.GL7SublineTypeCondCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublineTypeCondCost getBasedOn() {
    return (entity.GL7SublineTypeCondCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublineTypeCondCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublineTypeCondCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublineTypeCond getSublineTypeCondition() {
    return (entity.GL7SublineTypeCond)__getInternalInterface().getFieldValue(SUBLINETYPECONDITION_PROP.get());
  }
  
  public entity.GL7SublineTypeCondCost getUnsliced() {
    return (entity.GL7SublineTypeCondCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublineTypeCondCostVersionList getVersionList() {
    return (entity.windowed.GL7SublineTypeCondCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublineTypeCondition(entity.GL7SublineTypeCond value) {
    __getInternalInterface().setFieldValue(SUBLINETYPECONDITION_PROP.get(), value);
  }
  
  public entity.GL7SublineTypeCondCost split(java.util.Date splitDate) {
    return (entity.GL7SublineTypeCondCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineTypeCondCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublineTypeCondCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getSublineTypeConditionID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLINETYPECONDITION_PROP.get());
    }
    ...
    public void setSublineTypeConditionID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLINETYPECONDITION_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7SublineTypeCondCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublineTypeCondCost.class, config);
    com.guidewire._generated.entity.GL7SublineTypeCondCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublineTypeCondCost, com.guidewire._generated.entity.GL7SublineTypeCondCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublineTypeCondCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineTypeCondCostInternal getInternalInterface(entity.GL7SublineTypeCondCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublineTypeCondCost newEmptyInstance() {
        return new entity.GL7SublineTypeCondCost((java.lang.Void)null);
      }

...
/**
 * GL7SublineTypeCov
 * Coverages for the General Liability Subline Type
 */
...
@gw.entity.EntityName(value = "GL7SublineTypeCov")
public class GL7SublineTypeCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublineTypeCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublineTypeCov, entity.PolicyPeriod>("entity.GL7SublineTypeCov");
  ...
  private com.guidewire._generated.entity.GL7SublineTypeCovInternal _internal;
   ...
   */
  protected GL7SublineTypeCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7SublineTypeCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublineTypeCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7SublineTypeCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineTypeCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7SublineTypeCov clone() {
    return (entity.GL7SublineTypeCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7SublineTypeCov getBasedOn() {
    return (entity.GL7SublineTypeCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublineTypeCov getBasedOnValue() {
    return (entity.GL7SublineTypeCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7SublineTypeCovCost[] getCosts() {
    return (entity.GL7SublineTypeCovCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
  }
  ...
  public entity.GL7SublineTypeCov getFixed() {
    return (entity.GL7SublineTypeCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7SublineTypeCov getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublineTypeCov)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.GL7SublineTypeCov getSubtype() {
    return (typekey.GL7SublineTypeCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.GL7SublineTypeCov getUnsliced() {
    return (entity.GL7SublineTypeCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7SublineTypeCovVersionList getVersionList() {
    return (entity.windowed.GL7SublineTypeCovVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7SublineTypeCov value) {
   ...
   */
  private void setFixed(entity.GL7SublineTypeCov value) {
   ...
   */
  private void setSubtype(typekey.GL7SublineTypeCov value) {
  ...
  public entity.GL7SublineTypeCov split(java.util.Date splitDate) {
    return (entity.GL7SublineTypeCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineTypeCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublineTypeCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.GL7SublineTypeCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.GL7SublineTypeCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.gl7.GL7SublineTypeCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.gl7.GL7SublineTypeCoverageAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.GL7SublineTypeCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.GL7SublineTypeCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublineTypeCov.class, config);
    com.guidewire._generated.entity.GL7SublineTypeCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublineTypeCov, com.guidewire._generated.entity.GL7SublineTypeCovInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublineTypeCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineTypeCovInternal getInternalInterface(entity.GL7SublineTypeCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublineTypeCov newEmptyInstance() {
        return new entity.GL7SublineTypeCov((java.lang.Void)null);
      }

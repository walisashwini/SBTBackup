...
/**
 * GL7SublineTypeCovCost
 * The cost for a Subline Type Coverage
 */
...
@gw.entity.EntityName(value = "GL7SublineTypeCovCost")
public class GL7SublineTypeCovCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublineTypeCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublineTypeCovCost, entity.PolicyPeriod>("entity.GL7SublineTypeCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLINETYPECOVERAGE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublineTypeCoverage");
   ...
   */
  public GL7SublineTypeCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublineTypeCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublineTypeCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublineTypeCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineTypeCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublineTypeCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublineTypeCovCost clone() {
    return (entity.GL7SublineTypeCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublineTypeCovCost getBasedOn() {
    return (entity.GL7SublineTypeCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublineTypeCovCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublineTypeCovCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublineTypeCov getSublineTypeCoverage() {
    return (entity.GL7SublineTypeCov)__getInternalInterface().getFieldValue(SUBLINETYPECOVERAGE_PROP.get());
  }
  
  public entity.GL7SublineTypeCovCost getUnsliced() {
    return (entity.GL7SublineTypeCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublineTypeCovCostVersionList getVersionList() {
    return (entity.windowed.GL7SublineTypeCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublineTypeCoverage(entity.GL7SublineTypeCov value) {
    __getInternalInterface().setFieldValue(SUBLINETYPECOVERAGE_PROP.get(), value);
  }
  
  public entity.GL7SublineTypeCovCost split(java.util.Date splitDate) {
    return (entity.GL7SublineTypeCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineTypeCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublineTypeCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getSublineTypeCoverageID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLINETYPECOVERAGE_PROP.get());
    }
    ...
    public void setSublineTypeCoverageID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLINETYPECOVERAGE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7SublineTypeCovCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublineTypeCovCost.class, config);
    com.guidewire._generated.entity.GL7SublineTypeCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublineTypeCovCost, com.guidewire._generated.entity.GL7SublineTypeCovCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublineTypeCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineTypeCovCostInternal getInternalInterface(entity.GL7SublineTypeCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublineTypeCovCost newEmptyInstance() {
        return new entity.GL7SublineTypeCovCost((java.lang.Void)null);
      }

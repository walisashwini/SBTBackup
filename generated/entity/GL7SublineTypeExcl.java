...
/**
 * GL7SublineTypeExcl
 * Exclusions for the General Liability Subline Type
 */
...
@gw.entity.EntityName(value = "GL7SublineTypeExcl")
public class GL7SublineTypeExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublineTypeExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublineTypeExcl, entity.PolicyPeriod>("entity.GL7SublineTypeExcl");
  ...
  private com.guidewire._generated.entity.GL7SublineTypeExclInternal _internal;
   ...
   */
  protected GL7SublineTypeExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7SublineTypeExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublineTypeExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7SublineTypeExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineTypeExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7SublineTypeExcl clone() {
    return (entity.GL7SublineTypeExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7SublineTypeExcl getBasedOn() {
    return (entity.GL7SublineTypeExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublineTypeExcl getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublineTypeExcl)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublineTypeExcl getUnsliced() {
    return (entity.GL7SublineTypeExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7SublineTypeExclVersionList getVersionList() {
    return (entity.windowed.GL7SublineTypeExclVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7SublineTypeExcl value) {
   ...
   */
  private void setFixed(entity.GL7SublineTypeExcl value) {
   ...
   */
  private void setSubtype(typekey.GL7SublineTypeExcl value) {
  ...
  public entity.GL7SublineTypeExcl split(java.util.Date splitDate) {
    return (entity.GL7SublineTypeExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineTypeExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublineTypeExcl.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.GL7SublineTypeExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.GL7SublineTypeExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublineTypeExcl.class, config);
    com.guidewire._generated.entity.GL7SublineTypeExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublineTypeExcl, com.guidewire._generated.entity.GL7SublineTypeExclInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublineTypeExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineTypeExclInternal getInternalInterface(entity.GL7SublineTypeExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublineTypeExcl newEmptyInstance() {
        return new entity.GL7SublineTypeExcl((java.lang.Void)null);
      }

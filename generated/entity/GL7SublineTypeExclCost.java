...
/**
 * GL7SublineTypeExclCost
 * The cost for a Subline Type Exclusion
 */
...
@gw.entity.EntityName(value = "GL7SublineTypeExclCost")
public class GL7SublineTypeExclCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublineTypeExclCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublineTypeExclCost, entity.PolicyPeriod>("entity.GL7SublineTypeExclCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLINETYPEEXCLUSION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublineTypeExclusion");
   ...
   */
  public GL7SublineTypeExclCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublineTypeExclCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublineTypeExclCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublineTypeExclCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineTypeExclCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublineTypeExclCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublineTypeExclCost clone() {
    return (entity.GL7SublineTypeExclCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublineTypeExclCost getBasedOn() {
    return (entity.GL7SublineTypeExclCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublineTypeExclCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublineTypeExclCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublineTypeExcl getSublineTypeExclusion() {
    return (entity.GL7SublineTypeExcl)__getInternalInterface().getFieldValue(SUBLINETYPEEXCLUSION_PROP.get());
  }
  
  public entity.GL7SublineTypeExclCost getUnsliced() {
    return (entity.GL7SublineTypeExclCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublineTypeExclCostVersionList getVersionList() {
    return (entity.windowed.GL7SublineTypeExclCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublineTypeExclusion(entity.GL7SublineTypeExcl value) {
    __getInternalInterface().setFieldValue(SUBLINETYPEEXCLUSION_PROP.get(), value);
  }
  
  public entity.GL7SublineTypeExclCost split(java.util.Date splitDate) {
    return (entity.GL7SublineTypeExclCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineTypeExclCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublineTypeExclCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getSublineTypeExclusionID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLINETYPEEXCLUSION_PROP.get());
    }
    ...
    public void setSublineTypeExclusionID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLINETYPEEXCLUSION_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7SublineTypeExclCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublineTypeExclCost.class, config);
    com.guidewire._generated.entity.GL7SublineTypeExclCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublineTypeExclCost, com.guidewire._generated.entity.GL7SublineTypeExclCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublineTypeExclCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineTypeExclCostInternal getInternalInterface(entity.GL7SublineTypeExclCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublineTypeExclCost newEmptyInstance() {
        return new entity.GL7SublineTypeExclCost((java.lang.Void)null);
      }

 ...
 * GL7 Subline Type level exclusion scheduled item
 */
...
@gw.entity.EntityName(value = "GL7SublineTypeSchExclItem")
public class GL7SublineTypeSchExclItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.ScheduledItem, entity.Coverable, entity.CoverableFieldAvailability, entity.GL7ScheduledItem, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublineTypeSchExclItem, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublineTypeSchExclItem, entity.PolicyPeriod>("entity.GL7SublineTypeSchExclItem");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SCHEDULEEXCLUSION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ScheduleExclusion");
  ...
  private com.guidewire._generated.entity.GL7SublineTypeSchExclItemInternal _internal;
   ...
   */
  public GL7SublineTypeSchExclItem(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublineTypeSchExclItem(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublineTypeSchExclItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7SublineTypeSchExclItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineTypeSchExclItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7SublineTypeSchExclItem clone() {
    return (entity.GL7SublineTypeSchExclItem)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7SublineTypeSchExclItem getBasedOn() {
    return (entity.GL7SublineTypeSchExclItem)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublineTypeSchExclItem getBasedOnValue() {
    return (entity.GL7SublineTypeSchExclItem)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7SublnTypSchExclItemCondCost[] getConditionCosts() {
    return (entity.GL7SublnTypSchExclItemCondCost[])__getInternalInterface().getFieldValue(CONDITIONCOSTS_PROP.get());
  }
  ...
  public entity.GL7SublnTypSchExclItmCond[] getConditions() {
    return (entity.GL7SublnTypSchExclItmCond[])__getInternalInterface().getFieldValue(CONDITIONS_PROP.get());
  }
  ...
  public entity.GL7SublnTypSchExclItemCovCost[] getCoverageCosts() {
    return (entity.GL7SublnTypSchExclItemCovCost[])__getInternalInterface().getFieldValue(COVERAGECOSTS_PROP.get());
  }
  ...
  public entity.GL7SublnTypSchExclItmCov[] getCoverages() {
    return (entity.GL7SublnTypSchExclItmCov[])__getInternalInterface().getFieldValue(COVERAGES_PROP.get());
  }
  ...
  public entity.GL7SublnTypSchExclItemExclCost[] getExclusionCosts() {
    return (entity.GL7SublnTypSchExclItemExclCost[])__getInternalInterface().getFieldValue(EXCLUSIONCOSTS_PROP.get());
  }
  ...
  public entity.GL7SublnTypSchExclItmExcl[] getExclusions() {
    return (entity.GL7SublnTypSchExclItmExcl[])__getInternalInterface().getFieldValue(EXCLUSIONS_PROP.get());
  }
  ...
  public entity.GL7SublineTypeSchExclItem getFixed() {
    return (entity.GL7SublineTypeSchExclItem)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7SublineTypeSchedExcl getScheduleExclusion() {
    return (entity.GL7SublineTypeSchedExcl)__getInternalInterface().getFieldValue(SCHEDULEEXCLUSION_PROP.get());
  }
  ...
  public entity.GL7SublnTypSchExclItemCost[] getScheduleItemCosts() {
    return (entity.GL7SublnTypSchExclItemCost[])__getInternalInterface().getFieldValue(SCHEDULEITEMCOSTS_PROP.get());
  }
  ...
  public entity.GL7SublineTypeSchExclItem getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublineTypeSchExclItem)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.GL7SublineTypeSchExclItem getSubtype() {
    return (typekey.GL7SublineTypeSchExclItem)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.GL7SublineTypeSchExclItem getUnsliced() {
    return (entity.GL7SublineTypeSchExclItem)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7SublineTypeSchExclItemVersionList getVersionList() {
    return (entity.windowed.GL7SublineTypeSchExclItemVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7SublineTypeSchExclItem value) {
   ...
   */
  private void setFixed(entity.GL7SublineTypeSchExclItem value) {
  ...
  public void setScheduleExclusion(entity.GL7SublineTypeSchedExcl value) {
    __getInternalInterface().setFieldValue(SCHEDULEEXCLUSION_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.GL7SublineTypeSchExclItem value) {
  ...
  public entity.GL7SublineTypeSchExclItem split(java.util.Date splitDate) {
    return (entity.GL7SublineTypeSchExclItem)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineTypeSchExclItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublineTypeSchExclItem.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getScheduleExclusionID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SCHEDULEEXCLUSION_PROP.get());
    }
    ...
    public void setScheduleExclusionID(gw.pl.persistence.core.Key value) {
      setFieldValue(SCHEDULEEXCLUSION_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.gl7.schedules.GL7SublineTypeSchedExclItemAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.gl7.schedules.GL7SublineTypeSchedExclItemAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7SublineTypeSchedExclItemMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7SublineTypeSchedExclItemMatcher");
    config.put("gw.api.productmodel.ScheduledItemAdapter", "gw.lob.gl7.schedules.GL7SublineTypeSchedExclItemAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublineTypeSchExclItem.class, config);
    com.guidewire._generated.entity.GL7SublineTypeSchExclItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublineTypeSchExclItem, com.guidewire._generated.entity.GL7SublineTypeSchExclItemInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublineTypeSchExclItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineTypeSchExclItemInternal getInternalInterface(entity.GL7SublineTypeSchExclItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublineTypeSchExclItem newEmptyInstance() {
        return new entity.GL7SublineTypeSchExclItem((java.lang.Void)null);
      }

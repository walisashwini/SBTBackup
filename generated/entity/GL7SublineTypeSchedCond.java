...
/**
 * GL7SublineTypeSchedCond
 * GL7 Subline Type Condition with a schedule
 */
...
@gw.entity.EntityName(value = "GL7SublineTypeSchedCond")
public class GL7SublineTypeSchedCond extends entity.GL7SublineTypeCond implements entity.ScheduleAutoNumberSequence, gw.api.copier.EffDatedCopyable, gw.api.domain.Schedule, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublineTypeSchedCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublineTypeSchedCond, entity.PolicyPeriod>("entity.GL7SublineTypeSchedCond");
   ...
   */
  protected GL7SublineTypeSchedCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7SublineTypeSchedCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublineTypeSchedCond(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublineTypeSchedCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineTypeSchedCondInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublineTypeSchedCondInternal)super.__getInternalInterface();
  }
  ...
  public entity.GL7SublineTypeSchedCond clone() {
    return (entity.GL7SublineTypeSchedCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7SublineTypeSchedCond getBasedOn() {
    return (entity.GL7SublineTypeSchedCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublineTypeSchCondItem[] getGL7ScheduledItems() {
    return (entity.GL7SublineTypeSchCondItem[])__getInternalInterface().getFieldValue(GL7SCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.GL7SublineTypeSchedCond getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublineTypeSchedCond)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7SublineTypeSchedCond getUnsliced() {
    return (entity.GL7SublineTypeSchedCond)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublineTypeSchedCondVersionList getVersionList() {
    return (entity.windowed.GL7SublineTypeSchedCondVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7SublineTypeSchedCond split(java.util.Date splitDate) {
    return (entity.GL7SublineTypeSchedCond)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineTypeSchedCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublineTypeSchedCond.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.Schedule", "gw.lob.gl7.schedules.GL7SublineTypeSchedCondImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7SublineTypeSchedCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7SublineTypeSchedCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublineTypeSchedCond.class, config);
    com.guidewire._generated.entity.GL7SublineTypeSchedCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublineTypeSchedCond, com.guidewire._generated.entity.GL7SublineTypeSchedCondInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublineTypeSchedCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineTypeSchedCondInternal getInternalInterface(entity.GL7SublineTypeSchedCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublineTypeSchedCond newEmptyInstance() {
        return new entity.GL7SublineTypeSchedCond((java.lang.Void)null);
      }

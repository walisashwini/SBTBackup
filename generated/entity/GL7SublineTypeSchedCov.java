...
/**
 * GL7SublineTypeSchedCov
 * GL7 Subline Type Coverage with a schedule
 */
...
@gw.entity.EntityName(value = "GL7SublineTypeSchedCov")
public class GL7SublineTypeSchedCov extends entity.GL7SublineTypeCov implements entity.ScheduleAutoNumberSequence, gw.api.copier.EffDatedCopyable, gw.api.domain.Schedule, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublineTypeSchedCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublineTypeSchedCov, entity.PolicyPeriod>("entity.GL7SublineTypeSchedCov");
   ...
   */
  protected GL7SublineTypeSchedCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7SublineTypeSchedCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublineTypeSchedCov(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublineTypeSchedCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineTypeSchedCovInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublineTypeSchedCovInternal)super.__getInternalInterface();
  }
  ...
  public entity.GL7SublineTypeSchedCov clone() {
    return (entity.GL7SublineTypeSchedCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7SublineTypeSchedCov getBasedOn() {
    return (entity.GL7SublineTypeSchedCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublineTypeSchCovItem[] getGL7ScheduledItems() {
    return (entity.GL7SublineTypeSchCovItem[])__getInternalInterface().getFieldValue(GL7SCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.GL7SublineTypeSchedCov getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublineTypeSchedCov)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7SublineTypeSchedCov getUnsliced() {
    return (entity.GL7SublineTypeSchedCov)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublineTypeSchedCovVersionList getVersionList() {
    return (entity.windowed.GL7SublineTypeSchedCovVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7SublineTypeSchedCov split(java.util.Date splitDate) {
    return (entity.GL7SublineTypeSchedCov)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineTypeSchedCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublineTypeSchedCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.Schedule", "gw.lob.gl7.schedules.GL7SublineTypeSchedCovImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7SublineTypeSchedCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7SublineTypeSchedCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublineTypeSchedCov.class, config);
    com.guidewire._generated.entity.GL7SublineTypeSchedCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublineTypeSchedCov, com.guidewire._generated.entity.GL7SublineTypeSchedCovInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublineTypeSchedCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineTypeSchedCovInternal getInternalInterface(entity.GL7SublineTypeSchedCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublineTypeSchedCov newEmptyInstance() {
        return new entity.GL7SublineTypeSchedCov((java.lang.Void)null);
      }

...
/**
 * GL7SublineTypeSchedExcl
 * GL7 Subline Type Exclusion with a schedule
 */
...
@gw.entity.EntityName(value = "GL7SublineTypeSchedExcl")
public class GL7SublineTypeSchedExcl extends entity.GL7SublineTypeExcl implements entity.ScheduleAutoNumberSequence, gw.api.copier.EffDatedCopyable, gw.api.domain.Schedule, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublineTypeSchedExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublineTypeSchedExcl, entity.PolicyPeriod>("entity.GL7SublineTypeSchedExcl");
   ...
   */
  protected GL7SublineTypeSchedExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7SublineTypeSchedExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublineTypeSchedExcl(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublineTypeSchedExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineTypeSchedExclInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublineTypeSchedExclInternal)super.__getInternalInterface();
  }
  ...
  public entity.GL7SublineTypeSchedExcl clone() {
    return (entity.GL7SublineTypeSchedExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7SublineTypeSchedExcl getBasedOn() {
    return (entity.GL7SublineTypeSchedExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublineTypeSchExclItem[] getGL7ScheduledItems() {
    return (entity.GL7SublineTypeSchExclItem[])__getInternalInterface().getFieldValue(GL7SCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.GL7SublineTypeSchedExcl getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublineTypeSchedExcl)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7SublineTypeSchedExcl getUnsliced() {
    return (entity.GL7SublineTypeSchedExcl)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublineTypeSchedExclVersionList getVersionList() {
    return (entity.windowed.GL7SublineTypeSchedExclVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7SublineTypeSchedExcl split(java.util.Date splitDate) {
    return (entity.GL7SublineTypeSchedExcl)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineTypeSchedExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublineTypeSchedExcl.this.__getDelegateManager();
    }
     ...
     */
    public void addToCosts(entity.GL7SublineTypeExclCost element) {
     ...
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public entity.GL7SublineTypeExcl getBasedOnValue() {
      return (entity.GL7SublineTypeExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
     ...
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public entity.GL7SublineTypeExclCost[] getCosts() {
      return (entity.GL7SublineTypeExclCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
    }
     ...
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public entity.GL7SublineTypeExcl getFixed() {
      return (entity.GL7SublineTypeExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
     ...
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public typekey.GL7SublineTypeExcl getSubtype() {
      return (typekey.GL7SublineTypeExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
     ...
     */
    public void removeFromCosts(entity.GL7SublineTypeExclCost element) {
     ...
     */
    public void setBasedOnValue(entity.GL7SublineTypeExcl value) {
     ...
     */
    public void setCosts(entity.GL7SublineTypeExclCost[] value) {
     ...
     */
    public void setFixed(entity.GL7SublineTypeExcl value) {
     ...
     */
    public void setSubtype(typekey.GL7SublineTypeExcl value) {
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.GL7SublineTypeExclusionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.GL7SublineTypeExclusionAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.gl7.GL7SublineTypeExclusionAdapter");
    config.put("gw.api.domain.Schedule", "gw.lob.gl7.schedules.GL7SublineTypeSchedExclImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7SublineTypeSchedExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7SublineTypeSchedExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublineTypeSchedExcl.class, config);
    com.guidewire._generated.entity.GL7SublineTypeSchedExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublineTypeSchedExcl, com.guidewire._generated.entity.GL7SublineTypeSchedExclInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublineTypeSchedExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineTypeSchedExclInternal getInternalInterface(entity.GL7SublineTypeSchedExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublineTypeSchedExcl newEmptyInstance() {
        return new entity.GL7SublineTypeSchedExcl((java.lang.Void)null);
      }

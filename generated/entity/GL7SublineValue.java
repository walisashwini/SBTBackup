 ...
 * GL7SublineValue
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7SublineValue.eti;GL7SublineValue.eix;GL7SublineValue.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7SublineValue")
public class GL7SublineValue extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7SublineValue> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7SublineValue>("entity.GL7SublineValue");
  ...
  private com.guidewire._generated.entity.GL7SublineValueInternal _internal;
   ...
   */
  public GL7SublineValue(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7SublineValue(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7SublineValueInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublineValueInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublineValueInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublineValue.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublineValue.class, config);
    com.guidewire._generated.entity.GL7SublineValueInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublineValue, com.guidewire._generated.entity.GL7SublineValueInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublineValue bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublineValueInternal getInternalInterface(entity.GL7SublineValue bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublineValue newEmptyInstance() {
        return new entity.GL7SublineValue((java.lang.Void)null);
      }

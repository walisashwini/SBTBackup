...
/**
 * GL7SublnSchedCondItemCondCost
 * GL7 Subline Condition Schedule Item Condition Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnSchedCondItemCondCost")
public class GL7SublnSchedCondItemCondCost extends entity.GL7SublnSchedCondItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnSchedCondItemCondCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnSchedCondItemCondCost, entity.PolicyPeriod>("entity.GL7SublnSchedCondItemCondCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNSCHEDCONDITEMCOND_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnSchedCondItemCond");
   ...
   */
  public GL7SublnSchedCondItemCondCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnSchedCondItemCondCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnSchedCondItemCondCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnSchedCondItemCondCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnSchedCondItemCondCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnSchedCondItemCondCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnSchedCondItemCondCost clone() {
    return (entity.GL7SublnSchedCondItemCondCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnSchedCondItemCondCost getBasedOn() {
    return (entity.GL7SublnSchedCondItemCondCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnSchedCondItemCondCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnSchedCondItemCondCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnSchedCondItmCond getSublnSchedCondItemCond() {
    return (entity.GL7SublnSchedCondItmCond)__getInternalInterface().getFieldValue(SUBLNSCHEDCONDITEMCOND_PROP.get());
  }
  
  public entity.GL7SublnSchedCondItemCondCost getUnsliced() {
    return (entity.GL7SublnSchedCondItemCondCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnSchedCondItemCondCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnSchedCondItemCondCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublnSchedCondItemCond(entity.GL7SublnSchedCondItmCond value) {
    __getInternalInterface().setFieldValue(SUBLNSCHEDCONDITEMCOND_PROP.get(), value);
  }
  
  public entity.GL7SublnSchedCondItemCondCost split(java.util.Date splitDate) {
    return (entity.GL7SublnSchedCondItemCondCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnSchedCondItemCondCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnSchedCondItemCondCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getSublnSchedCondItemCondID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNSCHEDCONDITEMCOND_PROP.get());
    }
    ...
    public void setSublnSchedCondItemCondID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNSCHEDCONDITEMCOND_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnSchedCondItemCondCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnSchedCondItemCondCost.class, config);
    com.guidewire._generated.entity.GL7SublnSchedCondItemCondCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnSchedCondItemCondCost, com.guidewire._generated.entity.GL7SublnSchedCondItemCondCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnSchedCondItemCondCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnSchedCondItemCondCostInternal getInternalInterface(entity.GL7SublnSchedCondItemCondCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnSchedCondItemCondCost newEmptyInstance() {
        return new entity.GL7SublnSchedCondItemCondCost((java.lang.Void)null);
      }

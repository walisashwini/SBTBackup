...
/**
 * GL7SublnSchedCondItemCovCost
 * GL7 Subline Condition Schedule Item Coverage Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnSchedCondItemCovCost")
public class GL7SublnSchedCondItemCovCost extends entity.GL7SublnSchedCondItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnSchedCondItemCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnSchedCondItemCovCost, entity.PolicyPeriod>("entity.GL7SublnSchedCondItemCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNSCHEDCONDITEMCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnSchedCondItemCov");
   ...
   */
  public GL7SublnSchedCondItemCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnSchedCondItemCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnSchedCondItemCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnSchedCondItemCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnSchedCondItemCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnSchedCondItemCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnSchedCondItemCovCost clone() {
    return (entity.GL7SublnSchedCondItemCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnSchedCondItemCovCost getBasedOn() {
    return (entity.GL7SublnSchedCondItemCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnSchedCondItemCovCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnSchedCondItemCovCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnSchedCondItmCov getSublnSchedCondItemCov() {
    return (entity.GL7SublnSchedCondItmCov)__getInternalInterface().getFieldValue(SUBLNSCHEDCONDITEMCOV_PROP.get());
  }
  
  public entity.GL7SublnSchedCondItemCovCost getUnsliced() {
    return (entity.GL7SublnSchedCondItemCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnSchedCondItemCovCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnSchedCondItemCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublnSchedCondItemCov(entity.GL7SublnSchedCondItmCov value) {
    __getInternalInterface().setFieldValue(SUBLNSCHEDCONDITEMCOV_PROP.get(), value);
  }
  
  public entity.GL7SublnSchedCondItemCovCost split(java.util.Date splitDate) {
    return (entity.GL7SublnSchedCondItemCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnSchedCondItemCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnSchedCondItemCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getSublnSchedCondItemCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNSCHEDCONDITEMCOV_PROP.get());
    }
    ...
    public void setSublnSchedCondItemCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNSCHEDCONDITEMCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnSchedCondItemCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnSchedCondItemCovCost.class, config);
    com.guidewire._generated.entity.GL7SublnSchedCondItemCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnSchedCondItemCovCost, com.guidewire._generated.entity.GL7SublnSchedCondItemCovCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnSchedCondItemCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnSchedCondItemCovCostInternal getInternalInterface(entity.GL7SublnSchedCondItemCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnSchedCondItemCovCost newEmptyInstance() {
        return new entity.GL7SublnSchedCondItemCovCost((java.lang.Void)null);
      }

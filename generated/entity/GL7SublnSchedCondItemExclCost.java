...
/**
 * GL7SublnSchedCondItemExclCost
 * GL7 Subline Condition Schedule Item Exclusion Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnSchedCondItemExclCost")
public class GL7SublnSchedCondItemExclCost extends entity.GL7SublnSchedCondItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnSchedCondItemExclCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnSchedCondItemExclCost, entity.PolicyPeriod>("entity.GL7SublnSchedCondItemExclCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNSCHEDCONDITEMEXCL_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnSchedCondItemExcl");
   ...
   */
  public GL7SublnSchedCondItemExclCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnSchedCondItemExclCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnSchedCondItemExclCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnSchedCondItemExclCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnSchedCondItemExclCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnSchedCondItemExclCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnSchedCondItemExclCost clone() {
    return (entity.GL7SublnSchedCondItemExclCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnSchedCondItemExclCost getBasedOn() {
    return (entity.GL7SublnSchedCondItemExclCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnSchedCondItemExclCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnSchedCondItemExclCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnSchedCondItmExcl getSublnSchedCondItemExcl() {
    return (entity.GL7SublnSchedCondItmExcl)__getInternalInterface().getFieldValue(SUBLNSCHEDCONDITEMEXCL_PROP.get());
  }
  
  public entity.GL7SublnSchedCondItemExclCost getUnsliced() {
    return (entity.GL7SublnSchedCondItemExclCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnSchedCondItemExclCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnSchedCondItemExclCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublnSchedCondItemExcl(entity.GL7SublnSchedCondItmExcl value) {
    __getInternalInterface().setFieldValue(SUBLNSCHEDCONDITEMEXCL_PROP.get(), value);
  }
  
  public entity.GL7SublnSchedCondItemExclCost split(java.util.Date splitDate) {
    return (entity.GL7SublnSchedCondItemExclCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnSchedCondItemExclCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnSchedCondItemExclCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getSublnSchedCondItemExclID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNSCHEDCONDITEMEXCL_PROP.get());
    }
    ...
    public void setSublnSchedCondItemExclID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNSCHEDCONDITEMEXCL_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnSchedCondItemExclCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnSchedCondItemExclCost.class, config);
    com.guidewire._generated.entity.GL7SublnSchedCondItemExclCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnSchedCondItemExclCost, com.guidewire._generated.entity.GL7SublnSchedCondItemExclCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnSchedCondItemExclCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnSchedCondItemExclCostInternal getInternalInterface(entity.GL7SublnSchedCondItemExclCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnSchedCondItemExclCost newEmptyInstance() {
        return new entity.GL7SublnSchedCondItemExclCost((java.lang.Void)null);
      }

...
/**
 * GL7SublnSchedCondItmExcl
 * GL7 Subline level condition scheduled item with exclusion terms
 */
...
@gw.entity.EntityName(value = "GL7SublnSchedCondItmExcl")
public class GL7SublnSchedCondItmExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, entity.GL7Clause, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnSchedCondItmExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnSchedCondItmExcl, entity.PolicyPeriod>("entity.GL7SublnSchedCondItmExcl");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GL7SUBLNSCHEDCONDITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GL7SublnSchedCondItem");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> SUBLNSCHEDCONDITEMEXCLCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "SublnSchedCondItemExclCosts");
  ...
  private com.guidewire._generated.entity.GL7SublnSchedCondItmExclInternal _internal;
   ...
   */
  protected GL7SublnSchedCondItmExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7SublnSchedCondItmExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnSchedCondItmExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7SublnSchedCondItmExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnSchedCondItmExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToSublnSchedCondItemExclCosts(entity.GL7SublnSchedCondItemExclCost element) {
    __getInternalInterface().addArrayElement(SUBLNSCHEDCONDITEMEXCLCOSTS_PROP.get(), element);
  }
  ...
  public entity.GL7SublnSchedCondItmExcl clone() {
    return (entity.GL7SublnSchedCondItmExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7SublnSchedCondItmExcl getBasedOn() {
    return (entity.GL7SublnSchedCondItmExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnSchedCondItmExcl getBasedOnValue() {
    return (entity.GL7SublnSchedCondItmExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7SublnSchedCondItmExcl getFixed() {
    return (entity.GL7SublnSchedCondItmExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7SublineSchedCondItem getGL7SublnSchedCondItem() {
    return (entity.GL7SublineSchedCondItem)__getInternalInterface().getFieldValue(GL7SUBLNSCHEDCONDITEM_PROP.get());
  }
  ...
  public entity.GL7SublnSchedCondItmExcl getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnSchedCondItmExcl)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnSchedCondItemExclCost[] getSublnSchedCondItemExclCosts() {
    return (entity.GL7SublnSchedCondItemExclCost[])__getInternalInterface().getFieldValue(SUBLNSCHEDCONDITEMEXCLCOSTS_PROP.get());
  }
  ...
  public typekey.GL7SublnSchedCondItmExcl getSubtype() {
    return (typekey.GL7SublnSchedCondItmExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.GL7SublnSchedCondItmExcl getUnsliced() {
    return (entity.GL7SublnSchedCondItmExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7SublnSchedCondItmExclVersionList getVersionList() {
    return (entity.windowed.GL7SublnSchedCondItmExclVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromSublnSchedCondItemExclCosts(entity.GL7SublnSchedCondItemExclCost element) {
    __getInternalInterface().removeArrayElement(SUBLNSCHEDCONDITEMEXCLCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromSublnSchedCondItemExclCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(SUBLNSCHEDCONDITEMEXCLCOSTS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.GL7SublnSchedCondItmExcl value) {
   ...
   */
  private void setFixed(entity.GL7SublnSchedCondItmExcl value) {
  ...
  public void setGL7SublnSchedCondItem(entity.GL7SublineSchedCondItem value) {
    __getInternalInterface().setFieldValue(GL7SUBLNSCHEDCONDITEM_PROP.get(), value);
  }
  ...
  public void setSublnSchedCondItemExclCosts(entity.GL7SublnSchedCondItemExclCost[] value) {
    __getInternalInterface().setFieldValue(SUBLNSCHEDCONDITEMEXCLCOSTS_PROP.get(), value);
  }
  
  /**
   * Sets the value of the Subtype field.
   */
  private void setSubtype(typekey.GL7SublnSchedCondItmExcl value) {
  ...
  public entity.GL7SublnSchedCondItmExcl split(java.util.Date splitDate) {
    return (entity.GL7SublnSchedCondItmExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnSchedCondItmExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnSchedCondItmExcl.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getGL7SublnSchedCondItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GL7SUBLNSCHEDCONDITEM_PROP.get());
    }
    ...
    public void setGL7SublnSchedCondItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(GL7SUBLNSCHEDCONDITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.schedules.GL7SublnSchedCondItemExclAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.schedules.GL7SublnSchedCondItemExclAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.gl7.schedules.GL7SublnSchedCondItemExclAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7SublnSchedCondItemExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7SublnSchedCondItemExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnSchedCondItmExcl.class, config);
    com.guidewire._generated.entity.GL7SublnSchedCondItmExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnSchedCondItmExcl, com.guidewire._generated.entity.GL7SublnSchedCondItmExclInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnSchedCondItmExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnSchedCondItmExclInternal getInternalInterface(entity.GL7SublnSchedCondItmExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnSchedCondItmExcl newEmptyInstance() {
        return new entity.GL7SublnSchedCondItmExcl((java.lang.Void)null);
      }

...
/**
 * GL7SublnSchedCovItemCondCost
 * GL7 Subline Coverage Schedule Item Condition Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnSchedCovItemCondCost")
public class GL7SublnSchedCovItemCondCost extends entity.GL7SublnSchedCovItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnSchedCovItemCondCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnSchedCovItemCondCost, entity.PolicyPeriod>("entity.GL7SublnSchedCovItemCondCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNSCHEDCOVITEMCOND_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnSchedCovItemCond");
   ...
   */
  public GL7SublnSchedCovItemCondCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnSchedCovItemCondCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnSchedCovItemCondCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnSchedCovItemCondCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnSchedCovItemCondCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnSchedCovItemCondCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnSchedCovItemCondCost clone() {
    return (entity.GL7SublnSchedCovItemCondCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnSchedCovItemCondCost getBasedOn() {
    return (entity.GL7SublnSchedCovItemCondCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnSchedCovItemCondCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnSchedCovItemCondCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnSchedCovItmCond getSublnSchedCovItemCond() {
    return (entity.GL7SublnSchedCovItmCond)__getInternalInterface().getFieldValue(SUBLNSCHEDCOVITEMCOND_PROP.get());
  }
  
  public entity.GL7SublnSchedCovItemCondCost getUnsliced() {
    return (entity.GL7SublnSchedCovItemCondCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnSchedCovItemCondCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnSchedCovItemCondCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublnSchedCovItemCond(entity.GL7SublnSchedCovItmCond value) {
    __getInternalInterface().setFieldValue(SUBLNSCHEDCOVITEMCOND_PROP.get(), value);
  }
  
  public entity.GL7SublnSchedCovItemCondCost split(java.util.Date splitDate) {
    return (entity.GL7SublnSchedCovItemCondCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnSchedCovItemCondCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnSchedCovItemCondCost.this.__getDelegateManager();
    }
    ...
    public entity.GL7SublineSchedCovItem getSublnSchedCovItem() {
      return (entity.GL7SublineSchedCovItem)__getInternalInterface().getFieldValue(SUBLNSCHEDCOVITEM_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getSublnSchedCovItemCondID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNSCHEDCOVITEMCOND_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getSublnSchedCovItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNSCHEDCOVITEM_PROP.get());
    }
    ...
    public void setSublnSchedCovItem(entity.GL7SublineSchedCovItem value) {
      __getInternalInterface().setFieldValue(SUBLNSCHEDCOVITEM_PROP.get(), value);
    }
    ...
    public void setSublnSchedCovItemCondID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNSCHEDCOVITEMCOND_PROP.get(), value);
    }
    
    public void setSublnSchedCovItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNSCHEDCOVITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnSchedCovItemCondCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnSchedCovItemCondCost.class, config);
    com.guidewire._generated.entity.GL7SublnSchedCovItemCondCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnSchedCovItemCondCost, com.guidewire._generated.entity.GL7SublnSchedCovItemCondCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnSchedCovItemCondCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnSchedCovItemCondCostInternal getInternalInterface(entity.GL7SublnSchedCovItemCondCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnSchedCovItemCondCost newEmptyInstance() {
        return new entity.GL7SublnSchedCovItemCondCost((java.lang.Void)null);
      }

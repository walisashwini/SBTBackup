...
/**
 * GL7SublnSchedCovItemCost
 * Base Subline Coverage Schedule Item Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnSchedCovItemCost")
public class GL7SublnSchedCovItemCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnSchedCovItemCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnSchedCovItemCost, entity.PolicyPeriod>("entity.GL7SublnSchedCovItemCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNSCHEDCOVITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnSchedCovItem");
   ...
   */
  public GL7SublnSchedCovItemCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnSchedCovItemCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnSchedCovItemCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnSchedCovItemCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnSchedCovItemCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnSchedCovItemCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnSchedCovItemCost clone() {
    return (entity.GL7SublnSchedCovItemCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnSchedCovItemCost getBasedOn() {
    return (entity.GL7SublnSchedCovItemCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnSchedCovItemCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnSchedCovItemCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnSchedCovItemCost getUnsliced() {
    return (entity.GL7SublnSchedCovItemCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnSchedCovItemCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnSchedCovItemCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7SublnSchedCovItemCost split(java.util.Date splitDate) {
    return (entity.GL7SublnSchedCovItemCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnSchedCovItemCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnSchedCovItemCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnSchedCovItemCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnSchedCovItemCost.class, config);
    com.guidewire._generated.entity.GL7SublnSchedCovItemCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnSchedCovItemCost, com.guidewire._generated.entity.GL7SublnSchedCovItemCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnSchedCovItemCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnSchedCovItemCostInternal getInternalInterface(entity.GL7SublnSchedCovItemCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnSchedCovItemCost newEmptyInstance() {
        return new entity.GL7SublnSchedCovItemCost((java.lang.Void)null);
      }

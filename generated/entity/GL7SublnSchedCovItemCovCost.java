...
/**
 * GL7SublnSchedCovItemCovCost
 * GL7 Subline Coverage Schedule Item Coverage Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnSchedCovItemCovCost")
public class GL7SublnSchedCovItemCovCost extends entity.GL7SublnSchedCovItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnSchedCovItemCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnSchedCovItemCovCost, entity.PolicyPeriod>("entity.GL7SublnSchedCovItemCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNSCHEDCOVITEMCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnSchedCovItemCov");
   ...
   */
  public GL7SublnSchedCovItemCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnSchedCovItemCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnSchedCovItemCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnSchedCovItemCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnSchedCovItemCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnSchedCovItemCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnSchedCovItemCovCost clone() {
    return (entity.GL7SublnSchedCovItemCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnSchedCovItemCovCost getBasedOn() {
    return (entity.GL7SublnSchedCovItemCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnSchedCovItemCovCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnSchedCovItemCovCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnSchedCovItmCov getSublnSchedCovItemCov() {
    return (entity.GL7SublnSchedCovItmCov)__getInternalInterface().getFieldValue(SUBLNSCHEDCOVITEMCOV_PROP.get());
  }
  
  public entity.GL7SublnSchedCovItemCovCost getUnsliced() {
    return (entity.GL7SublnSchedCovItemCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnSchedCovItemCovCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnSchedCovItemCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublnSchedCovItemCov(entity.GL7SublnSchedCovItmCov value) {
    __getInternalInterface().setFieldValue(SUBLNSCHEDCOVITEMCOV_PROP.get(), value);
  }
  
  public entity.GL7SublnSchedCovItemCovCost split(java.util.Date splitDate) {
    return (entity.GL7SublnSchedCovItemCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnSchedCovItemCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnSchedCovItemCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getSublnSchedCovItemCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNSCHEDCOVITEMCOV_PROP.get());
    }
    ...
    public void setSublnSchedCovItemCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNSCHEDCOVITEMCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnSchedCovItemCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnSchedCovItemCovCost.class, config);
    com.guidewire._generated.entity.GL7SublnSchedCovItemCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnSchedCovItemCovCost, com.guidewire._generated.entity.GL7SublnSchedCovItemCovCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnSchedCovItemCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnSchedCovItemCovCostInternal getInternalInterface(entity.GL7SublnSchedCovItemCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnSchedCovItemCovCost newEmptyInstance() {
        return new entity.GL7SublnSchedCovItemCovCost((java.lang.Void)null);
      }

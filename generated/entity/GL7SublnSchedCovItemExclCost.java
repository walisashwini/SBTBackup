...
/**
 * GL7SublnSchedCovItemExclCost
 * GL7 Subline Coverage Schedule Item Exclusion Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnSchedCovItemExclCost")
public class GL7SublnSchedCovItemExclCost extends entity.GL7SublnSchedCovItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnSchedCovItemExclCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnSchedCovItemExclCost, entity.PolicyPeriod>("entity.GL7SublnSchedCovItemExclCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNSCHEDCOVITEMEXCL_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnSchedCovItemExcl");
   ...
   */
  public GL7SublnSchedCovItemExclCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnSchedCovItemExclCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnSchedCovItemExclCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnSchedCovItemExclCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnSchedCovItemExclCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnSchedCovItemExclCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnSchedCovItemExclCost clone() {
    return (entity.GL7SublnSchedCovItemExclCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnSchedCovItemExclCost getBasedOn() {
    return (entity.GL7SublnSchedCovItemExclCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnSchedCovItemExclCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnSchedCovItemExclCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnSchedCovItmExcl getSublnSchedCovItemExcl() {
    return (entity.GL7SublnSchedCovItmExcl)__getInternalInterface().getFieldValue(SUBLNSCHEDCOVITEMEXCL_PROP.get());
  }
  
  public entity.GL7SublnSchedCovItemExclCost getUnsliced() {
    return (entity.GL7SublnSchedCovItemExclCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnSchedCovItemExclCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnSchedCovItemExclCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublnSchedCovItemExcl(entity.GL7SublnSchedCovItmExcl value) {
    __getInternalInterface().setFieldValue(SUBLNSCHEDCOVITEMEXCL_PROP.get(), value);
  }
  
  public entity.GL7SublnSchedCovItemExclCost split(java.util.Date splitDate) {
    return (entity.GL7SublnSchedCovItemExclCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnSchedCovItemExclCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnSchedCovItemExclCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getSublnSchedCovItemExclID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNSCHEDCOVITEMEXCL_PROP.get());
    }
    ...
    public void setSublnSchedCovItemExclID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNSCHEDCOVITEMEXCL_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnSchedCovItemExclCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnSchedCovItemExclCost.class, config);
    com.guidewire._generated.entity.GL7SublnSchedCovItemExclCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnSchedCovItemExclCost, com.guidewire._generated.entity.GL7SublnSchedCovItemExclCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnSchedCovItemExclCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnSchedCovItemExclCostInternal getInternalInterface(entity.GL7SublnSchedCovItemExclCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnSchedCovItemExclCost newEmptyInstance() {
        return new entity.GL7SublnSchedCovItemExclCost((java.lang.Void)null);
      }

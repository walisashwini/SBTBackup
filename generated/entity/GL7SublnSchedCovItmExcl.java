...
/**
 * GL7SublnSchedCovItmExcl
 * GL7 Subline level coverage scheduled item with exclusion terms
 */
...
@gw.entity.EntityName(value = "GL7SublnSchedCovItmExcl")
public class GL7SublnSchedCovItmExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, entity.GL7Clause, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnSchedCovItmExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnSchedCovItmExcl, entity.PolicyPeriod>("entity.GL7SublnSchedCovItmExcl");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GL7SUBLNSCHEDCOVITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GL7SublnSchedCovItem");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> SUBLNSCHEDCOVITEMEXCLCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "SublnSchedCovItemExclCosts");
  ...
  private com.guidewire._generated.entity.GL7SublnSchedCovItmExclInternal _internal;
   ...
   */
  protected GL7SublnSchedCovItmExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7SublnSchedCovItmExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnSchedCovItmExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7SublnSchedCovItmExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnSchedCovItmExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToSublnSchedCovItemExclCosts(entity.GL7SublnSchedCovItemExclCost element) {
    __getInternalInterface().addArrayElement(SUBLNSCHEDCOVITEMEXCLCOSTS_PROP.get(), element);
  }
  ...
  public entity.GL7SublnSchedCovItmExcl clone() {
    return (entity.GL7SublnSchedCovItmExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7SublnSchedCovItmExcl getBasedOn() {
    return (entity.GL7SublnSchedCovItmExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnSchedCovItmExcl getBasedOnValue() {
    return (entity.GL7SublnSchedCovItmExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7SublnSchedCovItmExcl getFixed() {
    return (entity.GL7SublnSchedCovItmExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7SublineSchedCovItem getGL7SublnSchedCovItem() {
    return (entity.GL7SublineSchedCovItem)__getInternalInterface().getFieldValue(GL7SUBLNSCHEDCOVITEM_PROP.get());
  }
  ...
  public entity.GL7SublnSchedCovItmExcl getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnSchedCovItmExcl)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnSchedCovItemExclCost[] getSublnSchedCovItemExclCosts() {
    return (entity.GL7SublnSchedCovItemExclCost[])__getInternalInterface().getFieldValue(SUBLNSCHEDCOVITEMEXCLCOSTS_PROP.get());
  }
  ...
  public typekey.GL7SublnSchedCovItmExcl getSubtype() {
    return (typekey.GL7SublnSchedCovItmExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.GL7SublnSchedCovItmExcl getUnsliced() {
    return (entity.GL7SublnSchedCovItmExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7SublnSchedCovItmExclVersionList getVersionList() {
    return (entity.windowed.GL7SublnSchedCovItmExclVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromSublnSchedCovItemExclCosts(entity.GL7SublnSchedCovItemExclCost element) {
    __getInternalInterface().removeArrayElement(SUBLNSCHEDCOVITEMEXCLCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromSublnSchedCovItemExclCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(SUBLNSCHEDCOVITEMEXCLCOSTS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.GL7SublnSchedCovItmExcl value) {
   ...
   */
  private void setFixed(entity.GL7SublnSchedCovItmExcl value) {
  ...
  public void setGL7SublnSchedCovItem(entity.GL7SublineSchedCovItem value) {
    __getInternalInterface().setFieldValue(GL7SUBLNSCHEDCOVITEM_PROP.get(), value);
  }
  ...
  public void setSublnSchedCovItemExclCosts(entity.GL7SublnSchedCovItemExclCost[] value) {
    __getInternalInterface().setFieldValue(SUBLNSCHEDCOVITEMEXCLCOSTS_PROP.get(), value);
  }
  
  /**
   * Sets the value of the Subtype field.
   */
  private void setSubtype(typekey.GL7SublnSchedCovItmExcl value) {
  ...
  public entity.GL7SublnSchedCovItmExcl split(java.util.Date splitDate) {
    return (entity.GL7SublnSchedCovItmExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnSchedCovItmExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnSchedCovItmExcl.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getGL7SublnSchedCovItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GL7SUBLNSCHEDCOVITEM_PROP.get());
    }
    ...
    public void setGL7SublnSchedCovItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(GL7SUBLNSCHEDCOVITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.schedules.GL7SublnSchedCovItemExclAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.schedules.GL7SublnSchedCovItemExclAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.gl7.schedules.GL7SublnSchedCovItemExclAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7SublnSchedCovItemExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7SublnSchedCovItemExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnSchedCovItmExcl.class, config);
    com.guidewire._generated.entity.GL7SublnSchedCovItmExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnSchedCovItmExcl, com.guidewire._generated.entity.GL7SublnSchedCovItmExclInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnSchedCovItmExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnSchedCovItmExclInternal getInternalInterface(entity.GL7SublnSchedCovItmExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnSchedCovItmExcl newEmptyInstance() {
        return new entity.GL7SublnSchedCovItmExcl((java.lang.Void)null);
      }

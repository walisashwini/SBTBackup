...
/**
 * GL7SublnSchedExclItemCondCost
 * GL7 Subline Exclusion Schedule Item Condition Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnSchedExclItemCondCost")
public class GL7SublnSchedExclItemCondCost extends entity.GL7SublnSchedExclItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnSchedExclItemCondCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnSchedExclItemCondCost, entity.PolicyPeriod>("entity.GL7SublnSchedExclItemCondCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNSCHEDEXCLITEMCOND_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnSchedExclItemCond");
   ...
   */
  public GL7SublnSchedExclItemCondCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnSchedExclItemCondCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnSchedExclItemCondCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnSchedExclItemCondCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnSchedExclItemCondCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnSchedExclItemCondCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnSchedExclItemCondCost clone() {
    return (entity.GL7SublnSchedExclItemCondCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnSchedExclItemCondCost getBasedOn() {
    return (entity.GL7SublnSchedExclItemCondCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnSchedExclItemCondCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnSchedExclItemCondCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnSchedExclItmCond getSublnSchedExclItemCond() {
    return (entity.GL7SublnSchedExclItmCond)__getInternalInterface().getFieldValue(SUBLNSCHEDEXCLITEMCOND_PROP.get());
  }
  
  public entity.GL7SublnSchedExclItemCondCost getUnsliced() {
    return (entity.GL7SublnSchedExclItemCondCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnSchedExclItemCondCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnSchedExclItemCondCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublnSchedExclItemCond(entity.GL7SublnSchedExclItmCond value) {
    __getInternalInterface().setFieldValue(SUBLNSCHEDEXCLITEMCOND_PROP.get(), value);
  }
  
  public entity.GL7SublnSchedExclItemCondCost split(java.util.Date splitDate) {
    return (entity.GL7SublnSchedExclItemCondCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnSchedExclItemCondCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnSchedExclItemCondCost.this.__getDelegateManager();
    }
    ...
    public entity.GL7SublineSchedExclItem getSublnSchedExclItem() {
      return (entity.GL7SublineSchedExclItem)__getInternalInterface().getFieldValue(SUBLNSCHEDEXCLITEM_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getSublnSchedExclItemCondID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNSCHEDEXCLITEMCOND_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getSublnSchedExclItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNSCHEDEXCLITEM_PROP.get());
    }
    ...
    public void setSublnSchedExclItem(entity.GL7SublineSchedExclItem value) {
      __getInternalInterface().setFieldValue(SUBLNSCHEDEXCLITEM_PROP.get(), value);
    }
    ...
    public void setSublnSchedExclItemCondID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNSCHEDEXCLITEMCOND_PROP.get(), value);
    }
    
    public void setSublnSchedExclItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNSCHEDEXCLITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnSchedExclItemCondCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnSchedExclItemCondCost.class, config);
    com.guidewire._generated.entity.GL7SublnSchedExclItemCondCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnSchedExclItemCondCost, com.guidewire._generated.entity.GL7SublnSchedExclItemCondCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnSchedExclItemCondCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnSchedExclItemCondCostInternal getInternalInterface(entity.GL7SublnSchedExclItemCondCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnSchedExclItemCondCost newEmptyInstance() {
        return new entity.GL7SublnSchedExclItemCondCost((java.lang.Void)null);
      }

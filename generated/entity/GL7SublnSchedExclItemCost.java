...
/**
 * GL7SublnSchedExclItemCost
 * Base Subline Exclusion Schedule Item Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnSchedExclItemCost")
public class GL7SublnSchedExclItemCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnSchedExclItemCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnSchedExclItemCost, entity.PolicyPeriod>("entity.GL7SublnSchedExclItemCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNSCHEDEXCLITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnSchedExclItem");
   ...
   */
  public GL7SublnSchedExclItemCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnSchedExclItemCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnSchedExclItemCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnSchedExclItemCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnSchedExclItemCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnSchedExclItemCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnSchedExclItemCost clone() {
    return (entity.GL7SublnSchedExclItemCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnSchedExclItemCost getBasedOn() {
    return (entity.GL7SublnSchedExclItemCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnSchedExclItemCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnSchedExclItemCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnSchedExclItemCost getUnsliced() {
    return (entity.GL7SublnSchedExclItemCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnSchedExclItemCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnSchedExclItemCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7SublnSchedExclItemCost split(java.util.Date splitDate) {
    return (entity.GL7SublnSchedExclItemCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnSchedExclItemCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnSchedExclItemCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnSchedExclItemCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnSchedExclItemCost.class, config);
    com.guidewire._generated.entity.GL7SublnSchedExclItemCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnSchedExclItemCost, com.guidewire._generated.entity.GL7SublnSchedExclItemCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnSchedExclItemCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnSchedExclItemCostInternal getInternalInterface(entity.GL7SublnSchedExclItemCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnSchedExclItemCost newEmptyInstance() {
        return new entity.GL7SublnSchedExclItemCost((java.lang.Void)null);
      }

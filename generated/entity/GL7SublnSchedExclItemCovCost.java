...
/**
 * GL7SublnSchedExclItemCovCost
 * GL7 Subline Exclusion Schedule Item Coverage Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnSchedExclItemCovCost")
public class GL7SublnSchedExclItemCovCost extends entity.GL7SublnSchedExclItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnSchedExclItemCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnSchedExclItemCovCost, entity.PolicyPeriod>("entity.GL7SublnSchedExclItemCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNSCHEDEXCLITEMCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnSchedExclItemCov");
   ...
   */
  public GL7SublnSchedExclItemCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnSchedExclItemCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnSchedExclItemCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnSchedExclItemCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnSchedExclItemCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnSchedExclItemCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnSchedExclItemCovCost clone() {
    return (entity.GL7SublnSchedExclItemCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnSchedExclItemCovCost getBasedOn() {
    return (entity.GL7SublnSchedExclItemCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnSchedExclItemCovCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnSchedExclItemCovCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnSchedExclItmCov getSublnSchedExclItemCov() {
    return (entity.GL7SublnSchedExclItmCov)__getInternalInterface().getFieldValue(SUBLNSCHEDEXCLITEMCOV_PROP.get());
  }
  
  public entity.GL7SublnSchedExclItemCovCost getUnsliced() {
    return (entity.GL7SublnSchedExclItemCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnSchedExclItemCovCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnSchedExclItemCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublnSchedExclItemCov(entity.GL7SublnSchedExclItmCov value) {
    __getInternalInterface().setFieldValue(SUBLNSCHEDEXCLITEMCOV_PROP.get(), value);
  }
  
  public entity.GL7SublnSchedExclItemCovCost split(java.util.Date splitDate) {
    return (entity.GL7SublnSchedExclItemCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnSchedExclItemCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnSchedExclItemCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getSublnSchedExclItemCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNSCHEDEXCLITEMCOV_PROP.get());
    }
    ...
    public void setSublnSchedExclItemCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNSCHEDEXCLITEMCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnSchedExclItemCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnSchedExclItemCovCost.class, config);
    com.guidewire._generated.entity.GL7SublnSchedExclItemCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnSchedExclItemCovCost, com.guidewire._generated.entity.GL7SublnSchedExclItemCovCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnSchedExclItemCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnSchedExclItemCovCostInternal getInternalInterface(entity.GL7SublnSchedExclItemCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnSchedExclItemCovCost newEmptyInstance() {
        return new entity.GL7SublnSchedExclItemCovCost((java.lang.Void)null);
      }

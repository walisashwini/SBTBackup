...
/**
 * GL7SublnSchedExclItemExclCost
 * GL7 Subline Exclusion Schedule Item Exclusion Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnSchedExclItemExclCost")
public class GL7SublnSchedExclItemExclCost extends entity.GL7SublnSchedExclItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnSchedExclItemExclCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnSchedExclItemExclCost, entity.PolicyPeriod>("entity.GL7SublnSchedExclItemExclCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNSCHEDEXCLITEMEXCL_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnSchedExclItemExcl");
   ...
   */
  public GL7SublnSchedExclItemExclCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnSchedExclItemExclCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnSchedExclItemExclCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnSchedExclItemExclCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnSchedExclItemExclCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnSchedExclItemExclCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnSchedExclItemExclCost clone() {
    return (entity.GL7SublnSchedExclItemExclCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnSchedExclItemExclCost getBasedOn() {
    return (entity.GL7SublnSchedExclItemExclCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnSchedExclItemExclCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnSchedExclItemExclCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnSchedExclItmExcl getSublnSchedExclItemExcl() {
    return (entity.GL7SublnSchedExclItmExcl)__getInternalInterface().getFieldValue(SUBLNSCHEDEXCLITEMEXCL_PROP.get());
  }
  
  public entity.GL7SublnSchedExclItemExclCost getUnsliced() {
    return (entity.GL7SublnSchedExclItemExclCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnSchedExclItemExclCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnSchedExclItemExclCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublnSchedExclItemExcl(entity.GL7SublnSchedExclItmExcl value) {
    __getInternalInterface().setFieldValue(SUBLNSCHEDEXCLITEMEXCL_PROP.get(), value);
  }
  
  public entity.GL7SublnSchedExclItemExclCost split(java.util.Date splitDate) {
    return (entity.GL7SublnSchedExclItemExclCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnSchedExclItemExclCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnSchedExclItemExclCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getSublnSchedExclItemExclID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNSCHEDEXCLITEMEXCL_PROP.get());
    }
    ...
    public void setSublnSchedExclItemExclID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNSCHEDEXCLITEMEXCL_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnSchedExclItemExclCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnSchedExclItemExclCost.class, config);
    com.guidewire._generated.entity.GL7SublnSchedExclItemExclCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnSchedExclItemExclCost, com.guidewire._generated.entity.GL7SublnSchedExclItemExclCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnSchedExclItemExclCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnSchedExclItemExclCostInternal getInternalInterface(entity.GL7SublnSchedExclItemExclCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnSchedExclItemExclCost newEmptyInstance() {
        return new entity.GL7SublnSchedExclItemExclCost((java.lang.Void)null);
      }

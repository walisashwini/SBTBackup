...
/**
 * GL7SublnSchedExclItmExcl
 * GL7 Subline level exclusion scheduled item with exclusion terms
 */
...
@gw.entity.EntityName(value = "GL7SublnSchedExclItmExcl")
public class GL7SublnSchedExclItmExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, entity.GL7Clause, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnSchedExclItmExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnSchedExclItmExcl, entity.PolicyPeriod>("entity.GL7SublnSchedExclItmExcl");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GL7SUBLNSCHEDEXCLITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GL7SublnSchedExclItem");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> SUBLNSCHEDEXCLITEMEXCLCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "SublnSchedExclItemExclCosts");
  ...
  private com.guidewire._generated.entity.GL7SublnSchedExclItmExclInternal _internal;
   ...
   */
  protected GL7SublnSchedExclItmExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7SublnSchedExclItmExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnSchedExclItmExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7SublnSchedExclItmExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnSchedExclItmExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToSublnSchedExclItemExclCosts(entity.GL7SublnSchedExclItemExclCost element) {
    __getInternalInterface().addArrayElement(SUBLNSCHEDEXCLITEMEXCLCOSTS_PROP.get(), element);
  }
  ...
  public entity.GL7SublnSchedExclItmExcl clone() {
    return (entity.GL7SublnSchedExclItmExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7SublnSchedExclItmExcl getBasedOn() {
    return (entity.GL7SublnSchedExclItmExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnSchedExclItmExcl getBasedOnValue() {
    return (entity.GL7SublnSchedExclItmExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7SublnSchedExclItmExcl getFixed() {
    return (entity.GL7SublnSchedExclItmExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7SublineSchedExclItem getGL7SublnSchedExclItem() {
    return (entity.GL7SublineSchedExclItem)__getInternalInterface().getFieldValue(GL7SUBLNSCHEDEXCLITEM_PROP.get());
  }
  ...
  public entity.GL7SublnSchedExclItmExcl getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnSchedExclItmExcl)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnSchedExclItemExclCost[] getSublnSchedExclItemExclCosts() {
    return (entity.GL7SublnSchedExclItemExclCost[])__getInternalInterface().getFieldValue(SUBLNSCHEDEXCLITEMEXCLCOSTS_PROP.get());
  }
  ...
  public typekey.GL7SublnSchedExclItmExcl getSubtype() {
    return (typekey.GL7SublnSchedExclItmExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.GL7SublnSchedExclItmExcl getUnsliced() {
    return (entity.GL7SublnSchedExclItmExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7SublnSchedExclItmExclVersionList getVersionList() {
    return (entity.windowed.GL7SublnSchedExclItmExclVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromSublnSchedExclItemExclCosts(entity.GL7SublnSchedExclItemExclCost element) {
    __getInternalInterface().removeArrayElement(SUBLNSCHEDEXCLITEMEXCLCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromSublnSchedExclItemExclCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(SUBLNSCHEDEXCLITEMEXCLCOSTS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.GL7SublnSchedExclItmExcl value) {
   ...
   */
  private void setFixed(entity.GL7SublnSchedExclItmExcl value) {
  ...
  public void setGL7SublnSchedExclItem(entity.GL7SublineSchedExclItem value) {
    __getInternalInterface().setFieldValue(GL7SUBLNSCHEDEXCLITEM_PROP.get(), value);
  }
  ...
  public void setSublnSchedExclItemExclCosts(entity.GL7SublnSchedExclItemExclCost[] value) {
    __getInternalInterface().setFieldValue(SUBLNSCHEDEXCLITEMEXCLCOSTS_PROP.get(), value);
  }
  
  /**
   * Sets the value of the Subtype field.
   */
  private void setSubtype(typekey.GL7SublnSchedExclItmExcl value) {
  ...
  public entity.GL7SublnSchedExclItmExcl split(java.util.Date splitDate) {
    return (entity.GL7SublnSchedExclItmExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnSchedExclItmExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnSchedExclItmExcl.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getGL7SublnSchedExclItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GL7SUBLNSCHEDEXCLITEM_PROP.get());
    }
    ...
    public void setGL7SublnSchedExclItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(GL7SUBLNSCHEDEXCLITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.schedules.GL7SublnSchedExclItemExclAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.schedules.GL7SublnSchedExclItemExclAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.gl7.schedules.GL7SublnSchedExclItemExclAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7SublnSchedExclItemExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7SublnSchedExclItemExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnSchedExclItmExcl.class, config);
    com.guidewire._generated.entity.GL7SublnSchedExclItmExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnSchedExclItmExcl, com.guidewire._generated.entity.GL7SublnSchedExclItmExclInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnSchedExclItmExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnSchedExclItmExclInternal getInternalInterface(entity.GL7SublnSchedExclItmExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnSchedExclItmExcl newEmptyInstance() {
        return new entity.GL7SublnSchedExclItmExcl((java.lang.Void)null);
      }

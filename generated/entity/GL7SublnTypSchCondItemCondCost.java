...
/**
 * GL7SublnTypSchCondItemCondCost
 * GL7 Subline Type Condition Schedule Item Condition Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnTypSchCondItemCondCost")
public class GL7SublnTypSchCondItemCondCost extends entity.GL7SublnTypSchCondItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnTypSchCondItemCondCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnTypSchCondItemCondCost, entity.PolicyPeriod>("entity.GL7SublnTypSchCondItemCondCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNTYPSCHCONDITEMCOND_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnTypSchCondItemCond");
   ...
   */
  public GL7SublnTypSchCondItemCondCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnTypSchCondItemCondCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnTypSchCondItemCondCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnTypSchCondItemCondCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnTypSchCondItemCondCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnTypSchCondItemCondCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnTypSchCondItemCondCost clone() {
    return (entity.GL7SublnTypSchCondItemCondCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnTypSchCondItemCondCost getBasedOn() {
    return (entity.GL7SublnTypSchCondItemCondCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnTypSchCondItemCondCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnTypSchCondItemCondCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnTypSchCondItmCond getSublnTypSchCondItemCond() {
    return (entity.GL7SublnTypSchCondItmCond)__getInternalInterface().getFieldValue(SUBLNTYPSCHCONDITEMCOND_PROP.get());
  }
  
  public entity.GL7SublnTypSchCondItemCondCost getUnsliced() {
    return (entity.GL7SublnTypSchCondItemCondCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnTypSchCondItemCondCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnTypSchCondItemCondCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublnTypSchCondItemCond(entity.GL7SublnTypSchCondItmCond value) {
    __getInternalInterface().setFieldValue(SUBLNTYPSCHCONDITEMCOND_PROP.get(), value);
  }
  
  public entity.GL7SublnTypSchCondItemCondCost split(java.util.Date splitDate) {
    return (entity.GL7SublnTypSchCondItemCondCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnTypSchCondItemCondCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnTypSchCondItemCondCost.this.__getDelegateManager();
    }
    ...
    public entity.GL7SublineTypeSchCondItem getSublnTypSchCondItem() {
      return (entity.GL7SublineTypeSchCondItem)__getInternalInterface().getFieldValue(SUBLNTYPSCHCONDITEM_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getSublnTypSchCondItemCondID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNTYPSCHCONDITEMCOND_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getSublnTypSchCondItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNTYPSCHCONDITEM_PROP.get());
    }
    ...
    public void setSublnTypSchCondItem(entity.GL7SublineTypeSchCondItem value) {
      __getInternalInterface().setFieldValue(SUBLNTYPSCHCONDITEM_PROP.get(), value);
    }
    ...
    public void setSublnTypSchCondItemCondID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNTYPSCHCONDITEMCOND_PROP.get(), value);
    }
    
    public void setSublnTypSchCondItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNTYPSCHCONDITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnTypSchCondItemCondCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnTypSchCondItemCondCost.class, config);
    com.guidewire._generated.entity.GL7SublnTypSchCondItemCondCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnTypSchCondItemCondCost, com.guidewire._generated.entity.GL7SublnTypSchCondItemCondCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnTypSchCondItemCondCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnTypSchCondItemCondCostInternal getInternalInterface(entity.GL7SublnTypSchCondItemCondCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnTypSchCondItemCondCost newEmptyInstance() {
        return new entity.GL7SublnTypSchCondItemCondCost((java.lang.Void)null);
      }

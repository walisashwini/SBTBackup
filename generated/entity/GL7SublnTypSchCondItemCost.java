...
/**
 * GL7SublnTypSchCondItemCost
 * Base Subline Type Condition Schedule Item Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnTypSchCondItemCost")
public class GL7SublnTypSchCondItemCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnTypSchCondItemCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnTypSchCondItemCost, entity.PolicyPeriod>("entity.GL7SublnTypSchCondItemCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNTYPSCHCONDITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnTypSchCondItem");
   ...
   */
  public GL7SublnTypSchCondItemCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnTypSchCondItemCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnTypSchCondItemCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnTypSchCondItemCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnTypSchCondItemCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnTypSchCondItemCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnTypSchCondItemCost clone() {
    return (entity.GL7SublnTypSchCondItemCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnTypSchCondItemCost getBasedOn() {
    return (entity.GL7SublnTypSchCondItemCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnTypSchCondItemCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnTypSchCondItemCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnTypSchCondItemCost getUnsliced() {
    return (entity.GL7SublnTypSchCondItemCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnTypSchCondItemCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnTypSchCondItemCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7SublnTypSchCondItemCost split(java.util.Date splitDate) {
    return (entity.GL7SublnTypSchCondItemCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnTypSchCondItemCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnTypSchCondItemCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnTypSchCondItemCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnTypSchCondItemCost.class, config);
    com.guidewire._generated.entity.GL7SublnTypSchCondItemCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnTypSchCondItemCost, com.guidewire._generated.entity.GL7SublnTypSchCondItemCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnTypSchCondItemCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnTypSchCondItemCostInternal getInternalInterface(entity.GL7SublnTypSchCondItemCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnTypSchCondItemCost newEmptyInstance() {
        return new entity.GL7SublnTypSchCondItemCost((java.lang.Void)null);
      }

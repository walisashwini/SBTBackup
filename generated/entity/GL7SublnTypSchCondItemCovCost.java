...
/**
 * GL7SublnTypSchCondItemCovCost
 * GL7 Subline Type Condition Schedule Item Coverage Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnTypSchCondItemCovCost")
public class GL7SublnTypSchCondItemCovCost extends entity.GL7SublnTypSchCondItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnTypSchCondItemCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnTypSchCondItemCovCost, entity.PolicyPeriod>("entity.GL7SublnTypSchCondItemCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNTYPSCHCONDITEMCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnTypSchCondItemCov");
   ...
   */
  public GL7SublnTypSchCondItemCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnTypSchCondItemCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnTypSchCondItemCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnTypSchCondItemCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnTypSchCondItemCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnTypSchCondItemCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnTypSchCondItemCovCost clone() {
    return (entity.GL7SublnTypSchCondItemCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnTypSchCondItemCovCost getBasedOn() {
    return (entity.GL7SublnTypSchCondItemCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnTypSchCondItemCovCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnTypSchCondItemCovCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnTypSchCondItmCov getSublnTypSchCondItemCov() {
    return (entity.GL7SublnTypSchCondItmCov)__getInternalInterface().getFieldValue(SUBLNTYPSCHCONDITEMCOV_PROP.get());
  }
  
  public entity.GL7SublnTypSchCondItemCovCost getUnsliced() {
    return (entity.GL7SublnTypSchCondItemCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnTypSchCondItemCovCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnTypSchCondItemCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublnTypSchCondItemCov(entity.GL7SublnTypSchCondItmCov value) {
    __getInternalInterface().setFieldValue(SUBLNTYPSCHCONDITEMCOV_PROP.get(), value);
  }
  
  public entity.GL7SublnTypSchCondItemCovCost split(java.util.Date splitDate) {
    return (entity.GL7SublnTypSchCondItemCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnTypSchCondItemCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnTypSchCondItemCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getSublnTypSchCondItemCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNTYPSCHCONDITEMCOV_PROP.get());
    }
    ...
    public void setSublnTypSchCondItemCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNTYPSCHCONDITEMCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnTypSchCondItemCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnTypSchCondItemCovCost.class, config);
    com.guidewire._generated.entity.GL7SublnTypSchCondItemCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnTypSchCondItemCovCost, com.guidewire._generated.entity.GL7SublnTypSchCondItemCovCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnTypSchCondItemCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnTypSchCondItemCovCostInternal getInternalInterface(entity.GL7SublnTypSchCondItemCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnTypSchCondItemCovCost newEmptyInstance() {
        return new entity.GL7SublnTypSchCondItemCovCost((java.lang.Void)null);
      }

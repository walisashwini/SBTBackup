...
/**
 * GL7SublnTypSchCondItemExclCost
 * GL7 Subline Type Condition Schedule Item Exclusion Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnTypSchCondItemExclCost")
public class GL7SublnTypSchCondItemExclCost extends entity.GL7SublnTypSchCondItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnTypSchCondItemExclCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnTypSchCondItemExclCost, entity.PolicyPeriod>("entity.GL7SublnTypSchCondItemExclCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNTYPSCHCONDITEMEXCL_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnTypSchCondItemExcl");
   ...
   */
  public GL7SublnTypSchCondItemExclCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnTypSchCondItemExclCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnTypSchCondItemExclCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnTypSchCondItemExclCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnTypSchCondItemExclCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnTypSchCondItemExclCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnTypSchCondItemExclCost clone() {
    return (entity.GL7SublnTypSchCondItemExclCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnTypSchCondItemExclCost getBasedOn() {
    return (entity.GL7SublnTypSchCondItemExclCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnTypSchCondItemExclCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnTypSchCondItemExclCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnTypSchCondItmExcl getSublnTypSchCondItemExcl() {
    return (entity.GL7SublnTypSchCondItmExcl)__getInternalInterface().getFieldValue(SUBLNTYPSCHCONDITEMEXCL_PROP.get());
  }
  
  public entity.GL7SublnTypSchCondItemExclCost getUnsliced() {
    return (entity.GL7SublnTypSchCondItemExclCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnTypSchCondItemExclCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnTypSchCondItemExclCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublnTypSchCondItemExcl(entity.GL7SublnTypSchCondItmExcl value) {
    __getInternalInterface().setFieldValue(SUBLNTYPSCHCONDITEMEXCL_PROP.get(), value);
  }
  
  public entity.GL7SublnTypSchCondItemExclCost split(java.util.Date splitDate) {
    return (entity.GL7SublnTypSchCondItemExclCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnTypSchCondItemExclCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnTypSchCondItemExclCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getSublnTypSchCondItemExclID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNTYPSCHCONDITEMEXCL_PROP.get());
    }
    ...
    public void setSublnTypSchCondItemExclID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNTYPSCHCONDITEMEXCL_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnTypSchCondItemExclCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnTypSchCondItemExclCost.class, config);
    com.guidewire._generated.entity.GL7SublnTypSchCondItemExclCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnTypSchCondItemExclCost, com.guidewire._generated.entity.GL7SublnTypSchCondItemExclCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnTypSchCondItemExclCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnTypSchCondItemExclCostInternal getInternalInterface(entity.GL7SublnTypSchCondItemExclCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnTypSchCondItemExclCost newEmptyInstance() {
        return new entity.GL7SublnTypSchCondItemExclCost((java.lang.Void)null);
      }

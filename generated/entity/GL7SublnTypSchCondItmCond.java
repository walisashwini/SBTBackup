...
/**
 * GL7SublnTypSchCondItmCond
 * GL7 Line level condition scheduled item with condition terms
 */
...
@gw.entity.EntityName(value = "GL7SublnTypSchCondItmCond")
public class GL7SublnTypSchCondItmCond extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PolicyCondition, entity.GL7Clause, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnTypSchCondItmCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnTypSchCondItmCond, entity.PolicyPeriod>("entity.GL7SublnTypSchCondItmCond");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> SUBLNTYPSCHCONDITEMCONDCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "SublnTypSchCondItemCondCosts");
  ...
  private com.guidewire._generated.entity.GL7SublnTypSchCondItmCondInternal _internal;
   ...
   */
  protected GL7SublnTypSchCondItmCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7SublnTypSchCondItmCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnTypSchCondItmCond(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7SublnTypSchCondItmCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnTypSchCondItmCondInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Adds the given element to the SublnTypSchCondItemCondCosts array. This is achieved by setting the parent foreign key to this entity instance.
   */
  public void addToSublnTypSchCondItemCondCosts(entity.GL7SublnTypSchCondItemCondCost element) {
    __getInternalInterface().addArrayElement(SUBLNTYPSCHCONDITEMCONDCOSTS_PROP.get(), element);
  }
  ...
  public entity.GL7SublnTypSchCondItmCond clone() {
    return (entity.GL7SublnTypSchCondItmCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7SublnTypSchCondItmCond getBasedOn() {
    return (entity.GL7SublnTypSchCondItmCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7SublnTypSchCondItmCond getBasedOnValue() {
    return (entity.GL7SublnTypSchCondItmCond)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7SublnTypSchCondItmCond getFixed() {
    return (entity.GL7SublnTypSchCondItmCond)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7SublnTypSchCondItmCond getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnTypSchCondItmCond)getSliceUntyped(sliceDate);
  }
  ...
  /**
   * Gets the value of the SublnTypSchCondItemCondCosts field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GL7SublnTypSchCondItemCondCost[] getSublnTypSchCondItemCondCosts() {
    return (entity.GL7SublnTypSchCondItemCondCost[])__getInternalInterface().getFieldValue(SUBLNTYPSCHCONDITEMCONDCOSTS_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.GL7SublnTypSchCondItmCond getSubtype() {
    return (typekey.GL7SublnTypSchCondItmCond)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.GL7SublnTypSchCondItmCond getUnsliced() {
    return (entity.GL7SublnTypSchCondItmCond)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7SublnTypSchCondItmCondVersionList getVersionList() {
    return (entity.windowed.GL7SublnTypSchCondItmCondVersionList)getVersionListUntyped();
  }
  ...
  /**
   * Removes the given element from the SublnTypSchCondItemCondCosts array. This is achieved by marking the element for removal.
   */
  public void removeFromSublnTypSchCondItemCondCosts(entity.GL7SublnTypSchCondItemCondCost element) {
    __getInternalInterface().removeArrayElement(SUBLNTYPSCHCONDITEMCONDCOSTS_PROP.get(), element);
  }
   ...
   */
  @java.lang.Deprecated
  public void removeFromSublnTypSchCondItemCondCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(SUBLNTYPSCHCONDITEMCONDCOSTS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.GL7SublnTypSchCondItmCond value) {
   ...
   */
  private void setFixed(entity.GL7SublnTypSchCondItmCond value) {
  ...
  /**
   * Sets the value of the SublnTypSchCondItemCondCosts field.
   */
  public void setSublnTypSchCondItemCondCosts(entity.GL7SublnTypSchCondItemCondCost[] value) {
    __getInternalInterface().setFieldValue(SUBLNTYPSCHCONDITEMCONDCOSTS_PROP.get(), value);
  }
  
  /**
   * Sets the value of the Subtype field.
   */
  private void setSubtype(typekey.GL7SublnTypSchCondItmCond value) {
  ...
  public entity.GL7SublnTypSchCondItmCond split(java.util.Date splitDate) {
    return (entity.GL7SublnTypSchCondItmCond)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnTypSchCondItmCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnTypSchCondItmCond.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.GL7SublnTypSchCondItmCond value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.GL7SublnTypSchCondItmCond value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.GL7SublnTypSchCondItmCond value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.schedules.GL7SublineTypeSchedCondItemCondAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.schedules.GL7SublineTypeSchedCondItemCondAdapter");
    config.put("gw.api.domain.PolicyConditionAdapter", "gw.lob.gl7.schedules.GL7SublineTypeSchedCondItemCondAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7SublineTypeSchedCondItemCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7SublineTypeSchedCondItemCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnTypSchCondItmCond.class, config);
    com.guidewire._generated.entity.GL7SublnTypSchCondItmCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnTypSchCondItmCond, com.guidewire._generated.entity.GL7SublnTypSchCondItmCondInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnTypSchCondItmCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnTypSchCondItmCondInternal getInternalInterface(entity.GL7SublnTypSchCondItmCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnTypSchCondItmCond newEmptyInstance() {
        return new entity.GL7SublnTypSchCondItmCond((java.lang.Void)null);
      }

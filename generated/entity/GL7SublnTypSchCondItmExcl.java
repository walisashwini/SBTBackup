...
/**
 * GL7SublnTypSchCondItmExcl
 * GL7 Line level condition scheduled item with exclusion terms
 */
...
@gw.entity.EntityName(value = "GL7SublnTypSchCondItmExcl")
public class GL7SublnTypSchCondItmExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, entity.GL7Clause, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnTypSchCondItmExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnTypSchCondItmExcl, entity.PolicyPeriod>("entity.GL7SublnTypSchCondItmExcl");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GL7SUBLINETYPESCHCONDITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GL7SublineTypeSchCondItem");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> SUBLNTYPSCHCONDITEMEXCLCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "SublnTypSchCondItemExclCosts");
  ...
  private com.guidewire._generated.entity.GL7SublnTypSchCondItmExclInternal _internal;
   ...
   */
  protected GL7SublnTypSchCondItmExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7SublnTypSchCondItmExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnTypSchCondItmExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7SublnTypSchCondItmExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnTypSchCondItmExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToSublnTypSchCondItemExclCosts(entity.GL7SublnTypSchCondItemExclCost element) {
    __getInternalInterface().addArrayElement(SUBLNTYPSCHCONDITEMEXCLCOSTS_PROP.get(), element);
  }
  ...
  public entity.GL7SublnTypSchCondItmExcl clone() {
    return (entity.GL7SublnTypSchCondItmExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7SublnTypSchCondItmExcl getBasedOn() {
    return (entity.GL7SublnTypSchCondItmExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnTypSchCondItmExcl getBasedOnValue() {
    return (entity.GL7SublnTypSchCondItmExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7SublnTypSchCondItmExcl getFixed() {
    return (entity.GL7SublnTypSchCondItmExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7SublineTypeSchCondItem getGL7SublineTypeSchCondItem() {
    return (entity.GL7SublineTypeSchCondItem)__getInternalInterface().getFieldValue(GL7SUBLINETYPESCHCONDITEM_PROP.get());
  }
  ...
  public entity.GL7SublnTypSchCondItmExcl getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnTypSchCondItmExcl)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnTypSchCondItemExclCost[] getSublnTypSchCondItemExclCosts() {
    return (entity.GL7SublnTypSchCondItemExclCost[])__getInternalInterface().getFieldValue(SUBLNTYPSCHCONDITEMEXCLCOSTS_PROP.get());
  }
  ...
  public typekey.GL7SublnTypSchCondItmExcl getSubtype() {
    return (typekey.GL7SublnTypSchCondItmExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.GL7SublnTypSchCondItmExcl getUnsliced() {
    return (entity.GL7SublnTypSchCondItmExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7SublnTypSchCondItmExclVersionList getVersionList() {
    return (entity.windowed.GL7SublnTypSchCondItmExclVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromSublnTypSchCondItemExclCosts(entity.GL7SublnTypSchCondItemExclCost element) {
    __getInternalInterface().removeArrayElement(SUBLNTYPSCHCONDITEMEXCLCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromSublnTypSchCondItemExclCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(SUBLNTYPSCHCONDITEMEXCLCOSTS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.GL7SublnTypSchCondItmExcl value) {
   ...
   */
  private void setFixed(entity.GL7SublnTypSchCondItmExcl value) {
  ...
  public void setGL7SublineTypeSchCondItem(entity.GL7SublineTypeSchCondItem value) {
    __getInternalInterface().setFieldValue(GL7SUBLINETYPESCHCONDITEM_PROP.get(), value);
  }
  ...
  public void setSublnTypSchCondItemExclCosts(entity.GL7SublnTypSchCondItemExclCost[] value) {
    __getInternalInterface().setFieldValue(SUBLNTYPSCHCONDITEMEXCLCOSTS_PROP.get(), value);
  }
  
  /**
   * Sets the value of the Subtype field.
   */
  private void setSubtype(typekey.GL7SublnTypSchCondItmExcl value) {
  ...
  public entity.GL7SublnTypSchCondItmExcl split(java.util.Date splitDate) {
    return (entity.GL7SublnTypSchCondItmExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnTypSchCondItmExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnTypSchCondItmExcl.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getGL7SublineTypeSchCondItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GL7SUBLINETYPESCHCONDITEM_PROP.get());
    }
    ...
    public void setGL7SublineTypeSchCondItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(GL7SUBLINETYPESCHCONDITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.schedules.GL7SublineTypeSchedCondItemExclAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.schedules.GL7SublineTypeSchedCondItemExclAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.gl7.schedules.GL7SublineTypeSchedCondItemExclAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7SublineTypeSchedCondItemExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7SublineTypeSchedCondItemExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnTypSchCondItmExcl.class, config);
    com.guidewire._generated.entity.GL7SublnTypSchCondItmExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnTypSchCondItmExcl, com.guidewire._generated.entity.GL7SublnTypSchCondItmExclInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnTypSchCondItmExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnTypSchCondItmExclInternal getInternalInterface(entity.GL7SublnTypSchCondItmExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnTypSchCondItmExcl newEmptyInstance() {
        return new entity.GL7SublnTypSchCondItmExcl((java.lang.Void)null);
      }

...
/**
 * GL7SublnTypSchCovItemCondCost
 * GL7 Subline Type Coverage Schedule Item Condition Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnTypSchCovItemCondCost")
public class GL7SublnTypSchCovItemCondCost extends entity.GL7SublnTypSchCovItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnTypSchCovItemCondCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnTypSchCovItemCondCost, entity.PolicyPeriod>("entity.GL7SublnTypSchCovItemCondCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNTYPSCHCOVITEMCOND_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnTypSchCovItemCond");
   ...
   */
  public GL7SublnTypSchCovItemCondCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnTypSchCovItemCondCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnTypSchCovItemCondCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnTypSchCovItemCondCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnTypSchCovItemCondCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnTypSchCovItemCondCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnTypSchCovItemCondCost clone() {
    return (entity.GL7SublnTypSchCovItemCondCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnTypSchCovItemCondCost getBasedOn() {
    return (entity.GL7SublnTypSchCovItemCondCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnTypSchCovItemCondCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnTypSchCovItemCondCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnTypSchCovItmCond getSublnTypSchCovItemCond() {
    return (entity.GL7SublnTypSchCovItmCond)__getInternalInterface().getFieldValue(SUBLNTYPSCHCOVITEMCOND_PROP.get());
  }
  
  public entity.GL7SublnTypSchCovItemCondCost getUnsliced() {
    return (entity.GL7SublnTypSchCovItemCondCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnTypSchCovItemCondCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnTypSchCovItemCondCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublnTypSchCovItemCond(entity.GL7SublnTypSchCovItmCond value) {
    __getInternalInterface().setFieldValue(SUBLNTYPSCHCOVITEMCOND_PROP.get(), value);
  }
  
  public entity.GL7SublnTypSchCovItemCondCost split(java.util.Date splitDate) {
    return (entity.GL7SublnTypSchCovItemCondCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnTypSchCovItemCondCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnTypSchCovItemCondCost.this.__getDelegateManager();
    }
    ...
    public entity.GL7SublineTypeSchCovItem getSublnTypSchCovItem() {
      return (entity.GL7SublineTypeSchCovItem)__getInternalInterface().getFieldValue(SUBLNTYPSCHCOVITEM_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getSublnTypSchCovItemCondID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNTYPSCHCOVITEMCOND_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getSublnTypSchCovItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNTYPSCHCOVITEM_PROP.get());
    }
    ...
    public void setSublnTypSchCovItem(entity.GL7SublineTypeSchCovItem value) {
      __getInternalInterface().setFieldValue(SUBLNTYPSCHCOVITEM_PROP.get(), value);
    }
    ...
    public void setSublnTypSchCovItemCondID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNTYPSCHCOVITEMCOND_PROP.get(), value);
    }
    
    public void setSublnTypSchCovItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNTYPSCHCOVITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnTypSchCovItemCondCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnTypSchCovItemCondCost.class, config);
    com.guidewire._generated.entity.GL7SublnTypSchCovItemCondCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnTypSchCovItemCondCost, com.guidewire._generated.entity.GL7SublnTypSchCovItemCondCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnTypSchCovItemCondCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnTypSchCovItemCondCostInternal getInternalInterface(entity.GL7SublnTypSchCovItemCondCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnTypSchCovItemCondCost newEmptyInstance() {
        return new entity.GL7SublnTypSchCovItemCondCost((java.lang.Void)null);
      }

...
/**
 * GL7SublnTypSchCovItemCost
 * Base Subline Type Coverage Schedule Item Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnTypSchCovItemCost")
public class GL7SublnTypSchCovItemCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnTypSchCovItemCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnTypSchCovItemCost, entity.PolicyPeriod>("entity.GL7SublnTypSchCovItemCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNTYPSCHCOVITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnTypSchCovItem");
   ...
   */
  public GL7SublnTypSchCovItemCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnTypSchCovItemCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnTypSchCovItemCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnTypSchCovItemCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnTypSchCovItemCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnTypSchCovItemCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnTypSchCovItemCost clone() {
    return (entity.GL7SublnTypSchCovItemCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnTypSchCovItemCost getBasedOn() {
    return (entity.GL7SublnTypSchCovItemCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnTypSchCovItemCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnTypSchCovItemCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnTypSchCovItemCost getUnsliced() {
    return (entity.GL7SublnTypSchCovItemCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnTypSchCovItemCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnTypSchCovItemCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7SublnTypSchCovItemCost split(java.util.Date splitDate) {
    return (entity.GL7SublnTypSchCovItemCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnTypSchCovItemCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnTypSchCovItemCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnTypSchCovItemCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnTypSchCovItemCost.class, config);
    com.guidewire._generated.entity.GL7SublnTypSchCovItemCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnTypSchCovItemCost, com.guidewire._generated.entity.GL7SublnTypSchCovItemCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnTypSchCovItemCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnTypSchCovItemCostInternal getInternalInterface(entity.GL7SublnTypSchCovItemCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnTypSchCovItemCost newEmptyInstance() {
        return new entity.GL7SublnTypSchCovItemCost((java.lang.Void)null);
      }

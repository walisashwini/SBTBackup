...
/**
 * GL7SublnTypSchCovItemCovCost
 * GL7 Subline Type Coverage Schedule Item Coverage Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnTypSchCovItemCovCost")
public class GL7SublnTypSchCovItemCovCost extends entity.GL7SublnTypSchCovItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnTypSchCovItemCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnTypSchCovItemCovCost, entity.PolicyPeriod>("entity.GL7SublnTypSchCovItemCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNTYPSCHCOVITEMCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnTypSchCovItemCov");
   ...
   */
  public GL7SublnTypSchCovItemCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnTypSchCovItemCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnTypSchCovItemCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnTypSchCovItemCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnTypSchCovItemCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnTypSchCovItemCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnTypSchCovItemCovCost clone() {
    return (entity.GL7SublnTypSchCovItemCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnTypSchCovItemCovCost getBasedOn() {
    return (entity.GL7SublnTypSchCovItemCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnTypSchCovItemCovCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnTypSchCovItemCovCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnTypSchCovItmCov getSublnTypSchCovItemCov() {
    return (entity.GL7SublnTypSchCovItmCov)__getInternalInterface().getFieldValue(SUBLNTYPSCHCOVITEMCOV_PROP.get());
  }
  
  public entity.GL7SublnTypSchCovItemCovCost getUnsliced() {
    return (entity.GL7SublnTypSchCovItemCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnTypSchCovItemCovCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnTypSchCovItemCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublnTypSchCovItemCov(entity.GL7SublnTypSchCovItmCov value) {
    __getInternalInterface().setFieldValue(SUBLNTYPSCHCOVITEMCOV_PROP.get(), value);
  }
  
  public entity.GL7SublnTypSchCovItemCovCost split(java.util.Date splitDate) {
    return (entity.GL7SublnTypSchCovItemCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnTypSchCovItemCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnTypSchCovItemCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getSublnTypSchCovItemCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNTYPSCHCOVITEMCOV_PROP.get());
    }
    ...
    public void setSublnTypSchCovItemCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNTYPSCHCOVITEMCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnTypSchCovItemCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnTypSchCovItemCovCost.class, config);
    com.guidewire._generated.entity.GL7SublnTypSchCovItemCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnTypSchCovItemCovCost, com.guidewire._generated.entity.GL7SublnTypSchCovItemCovCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnTypSchCovItemCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnTypSchCovItemCovCostInternal getInternalInterface(entity.GL7SublnTypSchCovItemCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnTypSchCovItemCovCost newEmptyInstance() {
        return new entity.GL7SublnTypSchCovItemCovCost((java.lang.Void)null);
      }

...
/**
 * GL7SublnTypSchCovItemExclCost
 * GL7 Subline Type Coverage Schedule Item Exclusion Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnTypSchCovItemExclCost")
public class GL7SublnTypSchCovItemExclCost extends entity.GL7SublnTypSchCovItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnTypSchCovItemExclCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnTypSchCovItemExclCost, entity.PolicyPeriod>("entity.GL7SublnTypSchCovItemExclCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNTYPSCHCOVITEMEXCL_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnTypSchCovItemExcl");
   ...
   */
  public GL7SublnTypSchCovItemExclCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnTypSchCovItemExclCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnTypSchCovItemExclCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnTypSchCovItemExclCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnTypSchCovItemExclCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnTypSchCovItemExclCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnTypSchCovItemExclCost clone() {
    return (entity.GL7SublnTypSchCovItemExclCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnTypSchCovItemExclCost getBasedOn() {
    return (entity.GL7SublnTypSchCovItemExclCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnTypSchCovItemExclCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnTypSchCovItemExclCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnTypSchCovItmExcl getSublnTypSchCovItemExcl() {
    return (entity.GL7SublnTypSchCovItmExcl)__getInternalInterface().getFieldValue(SUBLNTYPSCHCOVITEMEXCL_PROP.get());
  }
  
  public entity.GL7SublnTypSchCovItemExclCost getUnsliced() {
    return (entity.GL7SublnTypSchCovItemExclCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnTypSchCovItemExclCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnTypSchCovItemExclCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublnTypSchCovItemExcl(entity.GL7SublnTypSchCovItmExcl value) {
    __getInternalInterface().setFieldValue(SUBLNTYPSCHCOVITEMEXCL_PROP.get(), value);
  }
  
  public entity.GL7SublnTypSchCovItemExclCost split(java.util.Date splitDate) {
    return (entity.GL7SublnTypSchCovItemExclCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnTypSchCovItemExclCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnTypSchCovItemExclCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getSublnTypSchCovItemExclID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNTYPSCHCOVITEMEXCL_PROP.get());
    }
    ...
    public void setSublnTypSchCovItemExclID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNTYPSCHCOVITEMEXCL_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnTypSchCovItemExclCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnTypSchCovItemExclCost.class, config);
    com.guidewire._generated.entity.GL7SublnTypSchCovItemExclCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnTypSchCovItemExclCost, com.guidewire._generated.entity.GL7SublnTypSchCovItemExclCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnTypSchCovItemExclCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnTypSchCovItemExclCostInternal getInternalInterface(entity.GL7SublnTypSchCovItemExclCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnTypSchCovItemExclCost newEmptyInstance() {
        return new entity.GL7SublnTypSchCovItemExclCost((java.lang.Void)null);
      }

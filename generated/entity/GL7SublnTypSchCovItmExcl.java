...
/**
 * GL7SublnTypSchCovItmExcl
 * GL7 Line level coverage scheduled item with exclusion terms
 */
...
@gw.entity.EntityName(value = "GL7SublnTypSchCovItmExcl")
public class GL7SublnTypSchCovItmExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, entity.GL7Clause, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnTypSchCovItmExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnTypSchCovItmExcl, entity.PolicyPeriod>("entity.GL7SublnTypSchCovItmExcl");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GL7SUBLINETYPESCHCOVITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GL7SublineTypeSchCovItem");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> SUBLNTYPSCHCOVITEMEXCLCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "SublnTypSchCovItemExclCosts");
  ...
  private com.guidewire._generated.entity.GL7SublnTypSchCovItmExclInternal _internal;
   ...
   */
  protected GL7SublnTypSchCovItmExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7SublnTypSchCovItmExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnTypSchCovItmExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7SublnTypSchCovItmExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnTypSchCovItmExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToSublnTypSchCovItemExclCosts(entity.GL7SublnTypSchCovItemExclCost element) {
    __getInternalInterface().addArrayElement(SUBLNTYPSCHCOVITEMEXCLCOSTS_PROP.get(), element);
  }
  ...
  public entity.GL7SublnTypSchCovItmExcl clone() {
    return (entity.GL7SublnTypSchCovItmExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7SublnTypSchCovItmExcl getBasedOn() {
    return (entity.GL7SublnTypSchCovItmExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnTypSchCovItmExcl getBasedOnValue() {
    return (entity.GL7SublnTypSchCovItmExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7SublnTypSchCovItmExcl getFixed() {
    return (entity.GL7SublnTypSchCovItmExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7SublineTypeSchCovItem getGL7SublineTypeSchCovItem() {
    return (entity.GL7SublineTypeSchCovItem)__getInternalInterface().getFieldValue(GL7SUBLINETYPESCHCOVITEM_PROP.get());
  }
  ...
  public entity.GL7SublnTypSchCovItmExcl getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnTypSchCovItmExcl)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnTypSchCovItemExclCost[] getSublnTypSchCovItemExclCosts() {
    return (entity.GL7SublnTypSchCovItemExclCost[])__getInternalInterface().getFieldValue(SUBLNTYPSCHCOVITEMEXCLCOSTS_PROP.get());
  }
  ...
  public typekey.GL7SublnTypSchCovItmExcl getSubtype() {
    return (typekey.GL7SublnTypSchCovItmExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.GL7SublnTypSchCovItmExcl getUnsliced() {
    return (entity.GL7SublnTypSchCovItmExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7SublnTypSchCovItmExclVersionList getVersionList() {
    return (entity.windowed.GL7SublnTypSchCovItmExclVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromSublnTypSchCovItemExclCosts(entity.GL7SublnTypSchCovItemExclCost element) {
    __getInternalInterface().removeArrayElement(SUBLNTYPSCHCOVITEMEXCLCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromSublnTypSchCovItemExclCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(SUBLNTYPSCHCOVITEMEXCLCOSTS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.GL7SublnTypSchCovItmExcl value) {
   ...
   */
  private void setFixed(entity.GL7SublnTypSchCovItmExcl value) {
  ...
  public void setGL7SublineTypeSchCovItem(entity.GL7SublineTypeSchCovItem value) {
    __getInternalInterface().setFieldValue(GL7SUBLINETYPESCHCOVITEM_PROP.get(), value);
  }
  ...
  public void setSublnTypSchCovItemExclCosts(entity.GL7SublnTypSchCovItemExclCost[] value) {
    __getInternalInterface().setFieldValue(SUBLNTYPSCHCOVITEMEXCLCOSTS_PROP.get(), value);
  }
  
  /**
   * Sets the value of the Subtype field.
   */
  private void setSubtype(typekey.GL7SublnTypSchCovItmExcl value) {
  ...
  public entity.GL7SublnTypSchCovItmExcl split(java.util.Date splitDate) {
    return (entity.GL7SublnTypSchCovItmExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnTypSchCovItmExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnTypSchCovItmExcl.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getGL7SublineTypeSchCovItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GL7SUBLINETYPESCHCOVITEM_PROP.get());
    }
    ...
    public void setGL7SublineTypeSchCovItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(GL7SUBLINETYPESCHCOVITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.schedules.GL7SublineTypeSchedCovItemExclAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.schedules.GL7SublineTypeSchedCovItemExclAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.gl7.schedules.GL7SublineTypeSchedCovItemExclAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7SublineTypeSchedCovItemExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7SublineTypeSchedCovItemExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnTypSchCovItmExcl.class, config);
    com.guidewire._generated.entity.GL7SublnTypSchCovItmExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnTypSchCovItmExcl, com.guidewire._generated.entity.GL7SublnTypSchCovItmExclInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnTypSchCovItmExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnTypSchCovItmExclInternal getInternalInterface(entity.GL7SublnTypSchCovItmExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnTypSchCovItmExcl newEmptyInstance() {
        return new entity.GL7SublnTypSchCovItmExcl((java.lang.Void)null);
      }

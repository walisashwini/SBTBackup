...
/**
 * GL7SublnTypSchExclItemCondCost
 * GL7 Subline Type Exclusion Schedule Item Condition Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnTypSchExclItemCondCost")
public class GL7SublnTypSchExclItemCondCost extends entity.GL7SublnTypSchExclItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnTypSchExclItemCondCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnTypSchExclItemCondCost, entity.PolicyPeriod>("entity.GL7SublnTypSchExclItemCondCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNTYPSCHEXCLITEMCOND_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnTypSchExclItemCond");
   ...
   */
  public GL7SublnTypSchExclItemCondCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnTypSchExclItemCondCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnTypSchExclItemCondCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnTypSchExclItemCondCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnTypSchExclItemCondCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnTypSchExclItemCondCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnTypSchExclItemCondCost clone() {
    return (entity.GL7SublnTypSchExclItemCondCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnTypSchExclItemCondCost getBasedOn() {
    return (entity.GL7SublnTypSchExclItemCondCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnTypSchExclItemCondCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnTypSchExclItemCondCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnTypSchExclItmCond getSublnTypSchExclItemCond() {
    return (entity.GL7SublnTypSchExclItmCond)__getInternalInterface().getFieldValue(SUBLNTYPSCHEXCLITEMCOND_PROP.get());
  }
  
  public entity.GL7SublnTypSchExclItemCondCost getUnsliced() {
    return (entity.GL7SublnTypSchExclItemCondCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnTypSchExclItemCondCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnTypSchExclItemCondCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublnTypSchExclItemCond(entity.GL7SublnTypSchExclItmCond value) {
    __getInternalInterface().setFieldValue(SUBLNTYPSCHEXCLITEMCOND_PROP.get(), value);
  }
  
  public entity.GL7SublnTypSchExclItemCondCost split(java.util.Date splitDate) {
    return (entity.GL7SublnTypSchExclItemCondCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnTypSchExclItemCondCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnTypSchExclItemCondCost.this.__getDelegateManager();
    }
    ...
    public entity.GL7SublineTypeSchExclItem getSublnTypSchExclItem() {
      return (entity.GL7SublineTypeSchExclItem)__getInternalInterface().getFieldValue(SUBLNTYPSCHEXCLITEM_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getSublnTypSchExclItemCondID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNTYPSCHEXCLITEMCOND_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getSublnTypSchExclItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNTYPSCHEXCLITEM_PROP.get());
    }
    ...
    public void setSublnTypSchExclItem(entity.GL7SublineTypeSchExclItem value) {
      __getInternalInterface().setFieldValue(SUBLNTYPSCHEXCLITEM_PROP.get(), value);
    }
    ...
    public void setSublnTypSchExclItemCondID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNTYPSCHEXCLITEMCOND_PROP.get(), value);
    }
    
    public void setSublnTypSchExclItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNTYPSCHEXCLITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnTypSchExclItemCondCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnTypSchExclItemCondCost.class, config);
    com.guidewire._generated.entity.GL7SublnTypSchExclItemCondCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnTypSchExclItemCondCost, com.guidewire._generated.entity.GL7SublnTypSchExclItemCondCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnTypSchExclItemCondCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnTypSchExclItemCondCostInternal getInternalInterface(entity.GL7SublnTypSchExclItemCondCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnTypSchExclItemCondCost newEmptyInstance() {
        return new entity.GL7SublnTypSchExclItemCondCost((java.lang.Void)null);
      }

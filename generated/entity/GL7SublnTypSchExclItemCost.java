...
/**
 * GL7SublnTypSchExclItemCost
 * Base Subline Type Exclusion Schedule Item Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnTypSchExclItemCost")
public class GL7SublnTypSchExclItemCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnTypSchExclItemCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnTypSchExclItemCost, entity.PolicyPeriod>("entity.GL7SublnTypSchExclItemCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNTYPSCHEXCLITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnTypSchExclItem");
   ...
   */
  public GL7SublnTypSchExclItemCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnTypSchExclItemCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnTypSchExclItemCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnTypSchExclItemCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnTypSchExclItemCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnTypSchExclItemCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnTypSchExclItemCost clone() {
    return (entity.GL7SublnTypSchExclItemCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnTypSchExclItemCost getBasedOn() {
    return (entity.GL7SublnTypSchExclItemCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnTypSchExclItemCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnTypSchExclItemCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnTypSchExclItemCost getUnsliced() {
    return (entity.GL7SublnTypSchExclItemCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnTypSchExclItemCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnTypSchExclItemCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7SublnTypSchExclItemCost split(java.util.Date splitDate) {
    return (entity.GL7SublnTypSchExclItemCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnTypSchExclItemCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnTypSchExclItemCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnTypSchExclItemCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnTypSchExclItemCost.class, config);
    com.guidewire._generated.entity.GL7SublnTypSchExclItemCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnTypSchExclItemCost, com.guidewire._generated.entity.GL7SublnTypSchExclItemCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnTypSchExclItemCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnTypSchExclItemCostInternal getInternalInterface(entity.GL7SublnTypSchExclItemCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnTypSchExclItemCost newEmptyInstance() {
        return new entity.GL7SublnTypSchExclItemCost((java.lang.Void)null);
      }

...
/**
 * GL7SublnTypSchExclItemCovCost
 * GL7 Subline Type Exclusion Schedule Item Coverage Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnTypSchExclItemCovCost")
public class GL7SublnTypSchExclItemCovCost extends entity.GL7SublnTypSchExclItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnTypSchExclItemCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnTypSchExclItemCovCost, entity.PolicyPeriod>("entity.GL7SublnTypSchExclItemCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNTYPSCHEXCLITEMCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnTypSchExclItemCov");
   ...
   */
  public GL7SublnTypSchExclItemCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnTypSchExclItemCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnTypSchExclItemCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnTypSchExclItemCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnTypSchExclItemCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnTypSchExclItemCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnTypSchExclItemCovCost clone() {
    return (entity.GL7SublnTypSchExclItemCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnTypSchExclItemCovCost getBasedOn() {
    return (entity.GL7SublnTypSchExclItemCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnTypSchExclItemCovCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnTypSchExclItemCovCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnTypSchExclItmCov getSublnTypSchExclItemCov() {
    return (entity.GL7SublnTypSchExclItmCov)__getInternalInterface().getFieldValue(SUBLNTYPSCHEXCLITEMCOV_PROP.get());
  }
  
  public entity.GL7SublnTypSchExclItemCovCost getUnsliced() {
    return (entity.GL7SublnTypSchExclItemCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnTypSchExclItemCovCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnTypSchExclItemCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublnTypSchExclItemCov(entity.GL7SublnTypSchExclItmCov value) {
    __getInternalInterface().setFieldValue(SUBLNTYPSCHEXCLITEMCOV_PROP.get(), value);
  }
  
  public entity.GL7SublnTypSchExclItemCovCost split(java.util.Date splitDate) {
    return (entity.GL7SublnTypSchExclItemCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnTypSchExclItemCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnTypSchExclItemCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getSublnTypSchExclItemCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNTYPSCHEXCLITEMCOV_PROP.get());
    }
    ...
    public void setSublnTypSchExclItemCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNTYPSCHEXCLITEMCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnTypSchExclItemCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnTypSchExclItemCovCost.class, config);
    com.guidewire._generated.entity.GL7SublnTypSchExclItemCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnTypSchExclItemCovCost, com.guidewire._generated.entity.GL7SublnTypSchExclItemCovCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnTypSchExclItemCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnTypSchExclItemCovCostInternal getInternalInterface(entity.GL7SublnTypSchExclItemCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnTypSchExclItemCovCost newEmptyInstance() {
        return new entity.GL7SublnTypSchExclItemCovCost((java.lang.Void)null);
      }

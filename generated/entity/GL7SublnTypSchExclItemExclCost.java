...
/**
 * GL7SublnTypSchExclItemExclCost
 * GL7 Subline Type Exclusion Schedule Item Exclusion Cost
 */
...
@gw.entity.EntityName(value = "GL7SublnTypSchExclItemExclCost")
public class GL7SublnTypSchExclItemExclCost extends entity.GL7SublnTypSchExclItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnTypSchExclItemExclCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnTypSchExclItemExclCost, entity.PolicyPeriod>("entity.GL7SublnTypSchExclItemExclCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SUBLNTYPSCHEXCLITEMEXCL_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SublnTypSchExclItemExcl");
   ...
   */
  public GL7SublnTypSchExclItemExclCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7SublnTypSchExclItemExclCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnTypSchExclItemExclCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7SublnTypSchExclItemExclCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnTypSchExclItemExclCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7SublnTypSchExclItemExclCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7SublnTypSchExclItemExclCost clone() {
    return (entity.GL7SublnTypSchExclItemExclCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7SublnTypSchExclItemExclCost getBasedOn() {
    return (entity.GL7SublnTypSchExclItemExclCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnTypSchExclItemExclCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnTypSchExclItemExclCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnTypSchExclItmExcl getSublnTypSchExclItemExcl() {
    return (entity.GL7SublnTypSchExclItmExcl)__getInternalInterface().getFieldValue(SUBLNTYPSCHEXCLITEMEXCL_PROP.get());
  }
  
  public entity.GL7SublnTypSchExclItemExclCost getUnsliced() {
    return (entity.GL7SublnTypSchExclItemExclCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7SublnTypSchExclItemExclCostVersionList getVersionList() {
    return (entity.windowed.GL7SublnTypSchExclItemExclCostVersionList)getVersionListUntyped();
  }
  ...
  public void setSublnTypSchExclItemExcl(entity.GL7SublnTypSchExclItmExcl value) {
    __getInternalInterface().setFieldValue(SUBLNTYPSCHEXCLITEMEXCL_PROP.get(), value);
  }
  
  public entity.GL7SublnTypSchExclItemExclCost split(java.util.Date splitDate) {
    return (entity.GL7SublnTypSchExclItemExclCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnTypSchExclItemExclCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnTypSchExclItemExclCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getSublnTypSchExclItemExclID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SUBLNTYPSCHEXCLITEMEXCL_PROP.get());
    }
    ...
    public void setSublnTypSchExclItemExclID(gw.pl.persistence.core.Key value) {
      setFieldValue(SUBLNTYPSCHEXCLITEMEXCL_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.schedules.GL7SublnTypSchExclItemExclCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnTypSchExclItemExclCost.class, config);
    com.guidewire._generated.entity.GL7SublnTypSchExclItemExclCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnTypSchExclItemExclCost, com.guidewire._generated.entity.GL7SublnTypSchExclItemExclCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnTypSchExclItemExclCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnTypSchExclItemExclCostInternal getInternalInterface(entity.GL7SublnTypSchExclItemExclCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnTypSchExclItemExclCost newEmptyInstance() {
        return new entity.GL7SublnTypSchExclItemExclCost((java.lang.Void)null);
      }

...
/**
 * GL7SublnTypSchExclItmExcl
 * GL7 Line level exclusion scheduled item with exclusion terms
 */
...
@gw.entity.EntityName(value = "GL7SublnTypSchExclItmExcl")
public class GL7SublnTypSchExclItmExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, entity.GL7Clause, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7SublnTypSchExclItmExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7SublnTypSchExclItmExcl, entity.PolicyPeriod>("entity.GL7SublnTypSchExclItmExcl");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GL7SUBLINETYPESCHEXCLITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GL7SublineTypeSchExclItem");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> SUBLNTYPSCHEXCLITEMEXCLCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "SublnTypSchExclItemExclCosts");
  ...
  private com.guidewire._generated.entity.GL7SublnTypSchExclItmExclInternal _internal;
   ...
   */
  protected GL7SublnTypSchExclItmExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7SublnTypSchExclItmExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7SublnTypSchExclItmExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7SublnTypSchExclItmExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7SublnTypSchExclItmExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToSublnTypSchExclItemExclCosts(entity.GL7SublnTypSchExclItemExclCost element) {
    __getInternalInterface().addArrayElement(SUBLNTYPSCHEXCLITEMEXCLCOSTS_PROP.get(), element);
  }
  ...
  public entity.GL7SublnTypSchExclItmExcl clone() {
    return (entity.GL7SublnTypSchExclItmExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7SublnTypSchExclItmExcl getBasedOn() {
    return (entity.GL7SublnTypSchExclItmExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7SublnTypSchExclItmExcl getBasedOnValue() {
    return (entity.GL7SublnTypSchExclItmExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7SublnTypSchExclItmExcl getFixed() {
    return (entity.GL7SublnTypSchExclItmExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7SublineTypeSchExclItem getGL7SublineTypeSchExclItem() {
    return (entity.GL7SublineTypeSchExclItem)__getInternalInterface().getFieldValue(GL7SUBLINETYPESCHEXCLITEM_PROP.get());
  }
  ...
  public entity.GL7SublnTypSchExclItmExcl getSlice(java.util.Date sliceDate) {
    return (entity.GL7SublnTypSchExclItmExcl)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7SublnTypSchExclItemExclCost[] getSublnTypSchExclItemExclCosts() {
    return (entity.GL7SublnTypSchExclItemExclCost[])__getInternalInterface().getFieldValue(SUBLNTYPSCHEXCLITEMEXCLCOSTS_PROP.get());
  }
  ...
  public typekey.GL7SublnTypSchExclItmExcl getSubtype() {
    return (typekey.GL7SublnTypSchExclItmExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.GL7SublnTypSchExclItmExcl getUnsliced() {
    return (entity.GL7SublnTypSchExclItmExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7SublnTypSchExclItmExclVersionList getVersionList() {
    return (entity.windowed.GL7SublnTypSchExclItmExclVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromSublnTypSchExclItemExclCosts(entity.GL7SublnTypSchExclItemExclCost element) {
    __getInternalInterface().removeArrayElement(SUBLNTYPSCHEXCLITEMEXCLCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromSublnTypSchExclItemExclCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(SUBLNTYPSCHEXCLITEMEXCLCOSTS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.GL7SublnTypSchExclItmExcl value) {
   ...
   */
  private void setFixed(entity.GL7SublnTypSchExclItmExcl value) {
  ...
  public void setGL7SublineTypeSchExclItem(entity.GL7SublineTypeSchExclItem value) {
    __getInternalInterface().setFieldValue(GL7SUBLINETYPESCHEXCLITEM_PROP.get(), value);
  }
  ...
  public void setSublnTypSchExclItemExclCosts(entity.GL7SublnTypSchExclItemExclCost[] value) {
    __getInternalInterface().setFieldValue(SUBLNTYPSCHEXCLITEMEXCLCOSTS_PROP.get(), value);
  }
  
  /**
   * Sets the value of the Subtype field.
   */
  private void setSubtype(typekey.GL7SublnTypSchExclItmExcl value) {
  ...
  public entity.GL7SublnTypSchExclItmExcl split(java.util.Date splitDate) {
    return (entity.GL7SublnTypSchExclItmExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7SublnTypSchExclItmExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7SublnTypSchExclItmExcl.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getGL7SublineTypeSchExclItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GL7SUBLINETYPESCHEXCLITEM_PROP.get());
    }
    ...
    public void setGL7SublineTypeSchExclItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(GL7SUBLINETYPESCHEXCLITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.schedules.GL7SublineTypeSchedExclItemExclAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.schedules.GL7SublineTypeSchedExclItemExclAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.gl7.schedules.GL7SublineTypeSchedExclItemExclAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7SublineTypeSchedExclItemExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7SublineTypeSchedExclItemExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7SublnTypSchExclItmExcl.class, config);
    com.guidewire._generated.entity.GL7SublnTypSchExclItmExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7SublnTypSchExclItmExcl, com.guidewire._generated.entity.GL7SublnTypSchExclItmExclInternal>() {
      public java.lang.Object getImplementation(entity.GL7SublnTypSchExclItmExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7SublnTypSchExclItmExclInternal getInternalInterface(entity.GL7SublnTypSchExclItmExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7SublnTypSchExclItmExcl newEmptyInstance() {
        return new entity.GL7SublnTypSchExclItmExcl((java.lang.Void)null);
      }

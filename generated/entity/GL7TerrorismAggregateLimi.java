...
/**
 * GL7TerrorismAggregateLimi
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7TerrorismAggregateLimi.eti;GL7TerrorismAggregateLimi.eix;GL7TerrorismAggregateLimi.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7TerrorismAggregateLimi")
public class GL7TerrorismAggregateLimi extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7TerrorismAggregateLimi> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7TerrorismAggregateLimi>("entity.GL7TerrorismAggregateLimi");
  ...
  private com.guidewire._generated.entity.GL7TerrorismAggregateLimiInternal _internal;
   ...
   */
  public GL7TerrorismAggregateLimi()  {
   ...
   */
  public GL7TerrorismAggregateLimi(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7TerrorismAggregateLimi(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7TerrorismAggregateLimiInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7TerrorismAggregateLimiInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7TerrorismAggregateLimiInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7TerrorismAggregateLimi.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7TerrorismAggregateLimi.class, config);
    com.guidewire._generated.entity.GL7TerrorismAggregateLimiInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7TerrorismAggregateLimi, com.guidewire._generated.entity.GL7TerrorismAggregateLimiInternal>() {
      public java.lang.Object getImplementation(entity.GL7TerrorismAggregateLimi bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7TerrorismAggregateLimiInternal getInternalInterface(entity.GL7TerrorismAggregateLimi bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7TerrorismAggregateLimi newEmptyInstance() {
        return new entity.GL7TerrorismAggregateLimi((java.lang.Void)null);
      }

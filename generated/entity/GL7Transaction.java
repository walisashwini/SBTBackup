...
/**
 * GL7Transaction
 * A transaction for the General Liability line
 */
...
@gw.entity.EntityName(value = "GL7Transaction")
public class GL7Transaction extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Transaction {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7Transaction, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7Transaction, entity.PolicyPeriod>("entity.GL7Transaction");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GL7COST_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GL7Cost");
  ...
  private com.guidewire._generated.entity.GL7TransactionInternal _internal;
   ...
   */
  public GL7Transaction(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7Transaction(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7Transaction(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7TransactionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7TransactionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7Transaction clone() {
    return (entity.GL7Transaction)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7Transaction getBasedOn() {
    return (entity.GL7Transaction)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7Transaction getBasedOnValue() {
    return (entity.GL7Transaction)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7Transaction getFixed() {
    return (entity.GL7Transaction)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7Cost getGL7Cost() {
    return (entity.GL7Cost)__getInternalInterface().getFieldValue(GL7COST_PROP.get());
  }
  ...
  public entity.GL7Transaction getSlice(java.util.Date sliceDate) {
    return (entity.GL7Transaction)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7Transaction getUnsliced() {
    return (entity.GL7Transaction)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7TransactionVersionList getVersionList() {
    return (entity.windowed.GL7TransactionVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7Transaction value) {
   ...
   */
  private void setFixed(entity.GL7Transaction value) {
  ...
  public void setGL7Cost(entity.GL7Cost value) {
    __getInternalInterface().setFieldValue(GL7COST_PROP.get(), value);
  }
  ...
  public entity.GL7Transaction split(java.util.Date splitDate) {
    return (entity.GL7Transaction)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7TransactionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7Transaction.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getGL7CostID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GL7COST_PROP.get());
    }
    ...
    public void setGL7CostID(gw.pl.persistence.core.Key value) {
      setFieldValue(GL7COST_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.financials.TransactionAdapter", "gw.lob.gl7.financials.GL7TransactionAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7Transaction.class, config);
    com.guidewire._generated.entity.GL7TransactionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7Transaction, com.guidewire._generated.entity.GL7TransactionInternal>() {
      public java.lang.Object getImplementation(entity.GL7Transaction bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7TransactionInternal getInternalInterface(entity.GL7Transaction bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7Transaction newEmptyInstance() {
        return new entity.GL7Transaction((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "GL7UAircrSchedCond")
public class GL7UAircrSchedCond extends entity.GL7UnmannedAircraftCond implements entity.ScheduleAutoNumberSequence, gw.api.domain.Schedule {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7UAircrSchedCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7UAircrSchedCond, entity.PolicyPeriod>("entity.GL7UAircrSchedCond");
   ...
   */
  protected GL7UAircrSchedCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7UAircrSchedCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7UAircrSchedCond(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7UAircrSchedCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UAircrSchedCondInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7UAircrSchedCondInternal)super.__getInternalInterface();
  }
  ...
  public entity.GL7UAircrSchedCond clone() {
    return (entity.GL7UAircrSchedCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7UAircrSchedCond getBasedOn() {
    return (entity.GL7UAircrSchedCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7UAircrSchedCondItem[] getScheduledItems() {
    return (entity.GL7UAircrSchedCondItem[])__getInternalInterface().getFieldValue(SCHEDULEDITEMS_PROP.get());
  }
  
  public entity.GL7UAircrSchedCond getSlice(java.util.Date sliceDate) {
    return (entity.GL7UAircrSchedCond)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7UAircrSchedCond getUnsliced() {
    return (entity.GL7UAircrSchedCond)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7UAircrSchedCondVersionList getVersionList() {
    return (entity.windowed.GL7UAircrSchedCondVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7UAircrSchedCond split(java.util.Date splitDate) {
    return (entity.GL7UAircrSchedCond)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UAircrSchedCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UAircrSchedCond.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.Schedule", "gw.lob.gl7.schedules.GL7UAircrSchedCondImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UAircrSchedCond.class, config);
    com.guidewire._generated.entity.GL7UAircrSchedCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UAircrSchedCond, com.guidewire._generated.entity.GL7UAircrSchedCondInternal>() {
      public java.lang.Object getImplementation(entity.GL7UAircrSchedCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UAircrSchedCondInternal getInternalInterface(entity.GL7UAircrSchedCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UAircrSchedCond newEmptyInstance() {
        return new entity.GL7UAircrSchedCond((java.lang.Void)null);
      }

...
/**
 * GL7UAircrSchedCondItemCost
 * The cost for a GL7UAircrSchedCondItem
 */
...
@gw.entity.EntityName(value = "GL7UAircrSchedCondItemCost")
public class GL7UAircrSchedCondItemCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7UAircrSchedCondItemCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7UAircrSchedCondItemCost, entity.PolicyPeriod>("entity.GL7UAircrSchedCondItemCost");
   ...
   */
  public GL7UAircrSchedCondItemCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7UAircrSchedCondItemCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7UAircrSchedCondItemCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7UAircrSchedCondItemCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UAircrSchedCondItemCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7UAircrSchedCondItemCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7UAircrSchedCondItemCost clone() {
    return (entity.GL7UAircrSchedCondItemCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7UAircrSchedCondItemCost getBasedOn() {
    return (entity.GL7UAircrSchedCondItemCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7UAircrSchedCondItemCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7UAircrSchedCondItemCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7UAircrSchedCondItemCost getUnsliced() {
    return (entity.GL7UAircrSchedCondItemCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7UAircrSchedCondItemCostVersionList getVersionList() {
    return (entity.windowed.GL7UAircrSchedCondItemCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7UAircrSchedCondItemCost split(java.util.Date splitDate) {
    return (entity.GL7UAircrSchedCondItemCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UAircrSchedCondItemCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UAircrSchedCondItemCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7UAircrSchedCondItemCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UAircrSchedCondItemCost.class, config);
    com.guidewire._generated.entity.GL7UAircrSchedCondItemCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UAircrSchedCondItemCost, com.guidewire._generated.entity.GL7UAircrSchedCondItemCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7UAircrSchedCondItemCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UAircrSchedCondItemCostInternal getInternalInterface(entity.GL7UAircrSchedCondItemCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UAircrSchedCondItemCost newEmptyInstance() {
        return new entity.GL7UAircrSchedCondItemCost((java.lang.Void)null);
      }

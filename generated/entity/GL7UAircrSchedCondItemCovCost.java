...
/**
 * GL7UAircrSchedCondItemCovCost
 * The cost for a GL7UAircrSchedCondItemCov
 */
...
@gw.entity.EntityName(value = "GL7UAircrSchedCondItemCovCost")
public class GL7UAircrSchedCondItemCovCost extends entity.GL7UAircrSchedCondItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7UAircrSchedCondItemCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7UAircrSchedCondItemCovCost, entity.PolicyPeriod>("entity.GL7UAircrSchedCondItemCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> UAIRCRSCHEDCONDITEMCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "UAircrSchedCondItemCov");
   ...
   */
  public GL7UAircrSchedCondItemCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7UAircrSchedCondItemCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7UAircrSchedCondItemCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7UAircrSchedCondItemCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UAircrSchedCondItemCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7UAircrSchedCondItemCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7UAircrSchedCondItemCovCost clone() {
    return (entity.GL7UAircrSchedCondItemCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7UAircrSchedCondItemCovCost getBasedOn() {
    return (entity.GL7UAircrSchedCondItemCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7UAircrSchedCondItemCovCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7UAircrSchedCondItemCovCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7UAircrSchedCondItemCov getUAircrSchedCondItemCov() {
    return (entity.GL7UAircrSchedCondItemCov)__getInternalInterface().getFieldValue(UAIRCRSCHEDCONDITEMCOV_PROP.get());
  }
  
  public entity.GL7UAircrSchedCondItemCovCost getUnsliced() {
    return (entity.GL7UAircrSchedCondItemCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7UAircrSchedCondItemCovCostVersionList getVersionList() {
    return (entity.windowed.GL7UAircrSchedCondItemCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setUAircrSchedCondItemCov(entity.GL7UAircrSchedCondItemCov value) {
    __getInternalInterface().setFieldValue(UAIRCRSCHEDCONDITEMCOV_PROP.get(), value);
  }
  
  public entity.GL7UAircrSchedCondItemCovCost split(java.util.Date splitDate) {
    return (entity.GL7UAircrSchedCondItemCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UAircrSchedCondItemCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UAircrSchedCondItemCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getUAircrSchedCondItemCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(UAIRCRSCHEDCONDITEMCOV_PROP.get());
    }
    ...
    public void setUAircrSchedCondItemCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(UAIRCRSCHEDCONDITEMCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7UAircrSchedCondItemCovCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UAircrSchedCondItemCovCost.class, config);
    com.guidewire._generated.entity.GL7UAircrSchedCondItemCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UAircrSchedCondItemCovCost, com.guidewire._generated.entity.GL7UAircrSchedCondItemCovCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7UAircrSchedCondItemCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UAircrSchedCondItemCovCostInternal getInternalInterface(entity.GL7UAircrSchedCondItemCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UAircrSchedCondItemCovCost newEmptyInstance() {
        return new entity.GL7UAircrSchedCondItemCovCost((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "GL7UAircrSchedCov")
public class GL7UAircrSchedCov extends entity.GL7UnmannedAircraftCov implements entity.ScheduleAutoNumberSequence, gw.api.domain.Schedule {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7UAircrSchedCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7UAircrSchedCov, entity.PolicyPeriod>("entity.GL7UAircrSchedCov");
   ...
   */
  protected GL7UAircrSchedCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7UAircrSchedCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7UAircrSchedCov(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7UAircrSchedCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UAircrSchedCovInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7UAircrSchedCovInternal)super.__getInternalInterface();
  }
  ...
  public entity.GL7UAircrSchedCov clone() {
    return (entity.GL7UAircrSchedCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7UAircrSchedCov getBasedOn() {
    return (entity.GL7UAircrSchedCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7UAircrSchedCovItem[] getScheduledItems() {
    return (entity.GL7UAircrSchedCovItem[])__getInternalInterface().getFieldValue(SCHEDULEDITEMS_PROP.get());
  }
  
  public entity.GL7UAircrSchedCov getSlice(java.util.Date sliceDate) {
    return (entity.GL7UAircrSchedCov)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7UAircrSchedCov getUnsliced() {
    return (entity.GL7UAircrSchedCov)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7UAircrSchedCovVersionList getVersionList() {
    return (entity.windowed.GL7UAircrSchedCovVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7UAircrSchedCov split(java.util.Date splitDate) {
    return (entity.GL7UAircrSchedCov)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UAircrSchedCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UAircrSchedCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.Schedule", "gw.lob.gl7.schedules.GL7UAircrSchedCovImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UAircrSchedCov.class, config);
    com.guidewire._generated.entity.GL7UAircrSchedCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UAircrSchedCov, com.guidewire._generated.entity.GL7UAircrSchedCovInternal>() {
      public java.lang.Object getImplementation(entity.GL7UAircrSchedCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UAircrSchedCovInternal getInternalInterface(entity.GL7UAircrSchedCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UAircrSchedCov newEmptyInstance() {
        return new entity.GL7UAircrSchedCov((java.lang.Void)null);
      }

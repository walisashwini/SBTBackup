...
/**
 * GL7UAircrSchedCovItemCost
 * The cost for a GL7UAircrSchedCovItem
 */
...
@gw.entity.EntityName(value = "GL7UAircrSchedCovItemCost")
public class GL7UAircrSchedCovItemCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7UAircrSchedCovItemCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7UAircrSchedCovItemCost, entity.PolicyPeriod>("entity.GL7UAircrSchedCovItemCost");
   ...
   */
  public GL7UAircrSchedCovItemCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7UAircrSchedCovItemCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7UAircrSchedCovItemCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7UAircrSchedCovItemCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UAircrSchedCovItemCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7UAircrSchedCovItemCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7UAircrSchedCovItemCost clone() {
    return (entity.GL7UAircrSchedCovItemCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7UAircrSchedCovItemCost getBasedOn() {
    return (entity.GL7UAircrSchedCovItemCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7UAircrSchedCovItemCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7UAircrSchedCovItemCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7UAircrSchedCovItemCost getUnsliced() {
    return (entity.GL7UAircrSchedCovItemCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7UAircrSchedCovItemCostVersionList getVersionList() {
    return (entity.windowed.GL7UAircrSchedCovItemCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7UAircrSchedCovItemCost split(java.util.Date splitDate) {
    return (entity.GL7UAircrSchedCovItemCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UAircrSchedCovItemCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UAircrSchedCovItemCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7UAircrSchedCovItemCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UAircrSchedCovItemCost.class, config);
    com.guidewire._generated.entity.GL7UAircrSchedCovItemCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UAircrSchedCovItemCost, com.guidewire._generated.entity.GL7UAircrSchedCovItemCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7UAircrSchedCovItemCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UAircrSchedCovItemCostInternal getInternalInterface(entity.GL7UAircrSchedCovItemCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UAircrSchedCovItemCost newEmptyInstance() {
        return new entity.GL7UAircrSchedCovItemCost((java.lang.Void)null);
      }

...
/**
 * GL7UAircrSchedCovItemCovCost
 * The cost for a GL7UAircrSchedCovItemCov
 */
...
@gw.entity.EntityName(value = "GL7UAircrSchedCovItemCovCost")
public class GL7UAircrSchedCovItemCovCost extends entity.GL7UAircrSchedCovItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7UAircrSchedCovItemCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7UAircrSchedCovItemCovCost, entity.PolicyPeriod>("entity.GL7UAircrSchedCovItemCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> UAIRCRSCHEDCOVITEMCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "UAircrSchedCovItemCov");
   ...
   */
  public GL7UAircrSchedCovItemCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7UAircrSchedCovItemCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7UAircrSchedCovItemCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7UAircrSchedCovItemCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UAircrSchedCovItemCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7UAircrSchedCovItemCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7UAircrSchedCovItemCovCost clone() {
    return (entity.GL7UAircrSchedCovItemCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7UAircrSchedCovItemCovCost getBasedOn() {
    return (entity.GL7UAircrSchedCovItemCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7UAircrSchedCovItemCovCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7UAircrSchedCovItemCovCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7UAircrSchedCovItemCov getUAircrSchedCovItemCov() {
    return (entity.GL7UAircrSchedCovItemCov)__getInternalInterface().getFieldValue(UAIRCRSCHEDCOVITEMCOV_PROP.get());
  }
  
  public entity.GL7UAircrSchedCovItemCovCost getUnsliced() {
    return (entity.GL7UAircrSchedCovItemCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7UAircrSchedCovItemCovCostVersionList getVersionList() {
    return (entity.windowed.GL7UAircrSchedCovItemCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setUAircrSchedCovItemCov(entity.GL7UAircrSchedCovItemCov value) {
    __getInternalInterface().setFieldValue(UAIRCRSCHEDCOVITEMCOV_PROP.get(), value);
  }
  
  public entity.GL7UAircrSchedCovItemCovCost split(java.util.Date splitDate) {
    return (entity.GL7UAircrSchedCovItemCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UAircrSchedCovItemCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UAircrSchedCovItemCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getUAircrSchedCovItemCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(UAIRCRSCHEDCOVITEMCOV_PROP.get());
    }
    ...
    public void setUAircrSchedCovItemCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(UAIRCRSCHEDCOVITEMCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7UAircrSchedCovItemCovCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UAircrSchedCovItemCovCost.class, config);
    com.guidewire._generated.entity.GL7UAircrSchedCovItemCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UAircrSchedCovItemCovCost, com.guidewire._generated.entity.GL7UAircrSchedCovItemCovCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7UAircrSchedCovItemCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UAircrSchedCovItemCovCostInternal getInternalInterface(entity.GL7UAircrSchedCovItemCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UAircrSchedCovItemCovCost newEmptyInstance() {
        return new entity.GL7UAircrSchedCovItemCovCost((java.lang.Void)null);
      }

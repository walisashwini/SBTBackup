...
@gw.entity.EntityName(value = "GL7UAircrSchedExcl")
public class GL7UAircrSchedExcl extends entity.GL7UnmannedAircraftExcl implements entity.ScheduleAutoNumberSequence, gw.api.domain.Schedule {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7UAircrSchedExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7UAircrSchedExcl, entity.PolicyPeriod>("entity.GL7UAircrSchedExcl");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> SCHEDULEDITEMS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "ScheduledItems");
   ...
   */
  protected GL7UAircrSchedExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7UAircrSchedExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7UAircrSchedExcl(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7UAircrSchedExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UAircrSchedExclInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7UAircrSchedExclInternal)super.__getInternalInterface();
  }
  ...
  public void addToScheduledItems(entity.GL7UAircrSchedExclItem element) {
    __getInternalInterface().addArrayElement(SCHEDULEDITEMS_PROP.get(), element);
  }
  ...
  public entity.GL7UAircrSchedExcl clone() {
    return (entity.GL7UAircrSchedExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7UAircrSchedExcl getBasedOn() {
    return (entity.GL7UAircrSchedExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7UAircrSchedExclItem[] getScheduledItems() {
    return (entity.GL7UAircrSchedExclItem[])__getInternalInterface().getFieldValue(SCHEDULEDITEMS_PROP.get());
  }
  
  public entity.GL7UAircrSchedExcl getSlice(java.util.Date sliceDate) {
    return (entity.GL7UAircrSchedExcl)getSliceUntyped(sliceDate);
  }
  
  public entity.GL7UAircrSchedExcl getUnsliced() {
    return (entity.GL7UAircrSchedExcl)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7UAircrSchedExclVersionList getVersionList() {
    return (entity.windowed.GL7UAircrSchedExclVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromScheduledItems(entity.GL7UAircrSchedExclItem element) {
    __getInternalInterface().removeArrayElement(SCHEDULEDITEMS_PROP.get(), element);
  }
  ...
  public void removeFromScheduledItems(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(SCHEDULEDITEMS_PROP.get(), elementID);
  }
  ...
  public void setScheduledItems(entity.GL7UAircrSchedExclItem[] value) {
    __getInternalInterface().setFieldValue(SCHEDULEDITEMS_PROP.get(), value);
  }
  
  public entity.GL7UAircrSchedExcl split(java.util.Date splitDate) {
    return (entity.GL7UAircrSchedExcl)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UAircrSchedExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UAircrSchedExcl.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.Schedule", "gw.lob.gl7.schedules.GL7UAircrSchedExclImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UAircrSchedExcl.class, config);
    com.guidewire._generated.entity.GL7UAircrSchedExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UAircrSchedExcl, com.guidewire._generated.entity.GL7UAircrSchedExclInternal>() {
      public java.lang.Object getImplementation(entity.GL7UAircrSchedExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UAircrSchedExclInternal getInternalInterface(entity.GL7UAircrSchedExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UAircrSchedExcl newEmptyInstance() {
        return new entity.GL7UAircrSchedExcl((java.lang.Void)null);
      }

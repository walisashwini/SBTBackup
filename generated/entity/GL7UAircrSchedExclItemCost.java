...
/**
 * GL7UAircrSchedExclItemCost
 * The cost for a GL7UAircrSchedExclItem
 */
...
@gw.entity.EntityName(value = "GL7UAircrSchedExclItemCost")
public class GL7UAircrSchedExclItemCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7UAircrSchedExclItemCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7UAircrSchedExclItemCost, entity.PolicyPeriod>("entity.GL7UAircrSchedExclItemCost");
   ...
   */
  public GL7UAircrSchedExclItemCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7UAircrSchedExclItemCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7UAircrSchedExclItemCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7UAircrSchedExclItemCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UAircrSchedExclItemCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7UAircrSchedExclItemCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7UAircrSchedExclItemCost clone() {
    return (entity.GL7UAircrSchedExclItemCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7UAircrSchedExclItemCost getBasedOn() {
    return (entity.GL7UAircrSchedExclItemCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7UAircrSchedExclItemCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7UAircrSchedExclItemCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7UAircrSchedExclItemCost getUnsliced() {
    return (entity.GL7UAircrSchedExclItemCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7UAircrSchedExclItemCostVersionList getVersionList() {
    return (entity.windowed.GL7UAircrSchedExclItemCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.GL7UAircrSchedExclItemCost split(java.util.Date splitDate) {
    return (entity.GL7UAircrSchedExclItemCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UAircrSchedExclItemCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UAircrSchedExclItemCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7UAircrSchedExclItemCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UAircrSchedExclItemCost.class, config);
    com.guidewire._generated.entity.GL7UAircrSchedExclItemCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UAircrSchedExclItemCost, com.guidewire._generated.entity.GL7UAircrSchedExclItemCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7UAircrSchedExclItemCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UAircrSchedExclItemCostInternal getInternalInterface(entity.GL7UAircrSchedExclItemCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UAircrSchedExclItemCost newEmptyInstance() {
        return new entity.GL7UAircrSchedExclItemCost((java.lang.Void)null);
      }

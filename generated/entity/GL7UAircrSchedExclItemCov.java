...
/**
 * GL7UAircrSchedExclItemCov
 * Coverages directly attached to each Schedule UAircrSchedExclItem
 */
...
@gw.entity.EntityName(value = "GL7UAircrSchedExclItemCov")
public class GL7UAircrSchedExclItemCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, entity.GL7Clause, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7UAircrSchedExclItemCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7UAircrSchedExclItemCov, entity.PolicyPeriod>("entity.GL7UAircrSchedExclItemCov");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> UAIRCRSCHEDEXCLITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "UAircrSchedExclItem");
  ...
  private com.guidewire._generated.entity.GL7UAircrSchedExclItemCovInternal _internal;
   ...
   */
  protected GL7UAircrSchedExclItemCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7UAircrSchedExclItemCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7UAircrSchedExclItemCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7UAircrSchedExclItemCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UAircrSchedExclItemCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7UAircrSchedExclItemCov clone() {
    return (entity.GL7UAircrSchedExclItemCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7UAircrSchedExclItemCov getBasedOn() {
    return (entity.GL7UAircrSchedExclItemCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7UAircrSchedExclItemCov getBasedOnValue() {
    return (entity.GL7UAircrSchedExclItemCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7UAircrSchedExclItemCovCost[] getCosts() {
    return (entity.GL7UAircrSchedExclItemCovCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
  }
  ...
  public entity.GL7UAircrSchedExclItemCov getFixed() {
    return (entity.GL7UAircrSchedExclItemCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7UAircrSchedExclItemCov getSlice(java.util.Date sliceDate) {
    return (entity.GL7UAircrSchedExclItemCov)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.GL7UAircrSchedExclItemCov getSubtype() {
    return (typekey.GL7UAircrSchedExclItemCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.GL7UAircrSchedExclItem getUAircrSchedExclItem() {
    return (entity.GL7UAircrSchedExclItem)__getInternalInterface().getFieldValue(UAIRCRSCHEDEXCLITEM_PROP.get());
  }
  
  public entity.GL7UAircrSchedExclItemCov getUnsliced() {
    return (entity.GL7UAircrSchedExclItemCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7UAircrSchedExclItemCovVersionList getVersionList() {
    return (entity.windowed.GL7UAircrSchedExclItemCovVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7UAircrSchedExclItemCov value) {
   ...
   */
  private void setFixed(entity.GL7UAircrSchedExclItemCov value) {
   ...
   */
  private void setSubtype(typekey.GL7UAircrSchedExclItemCov value) {
  ...
  public void setUAircrSchedExclItem(entity.GL7UAircrSchedExclItem value) {
    __getInternalInterface().setFieldValue(UAIRCRSCHEDEXCLITEM_PROP.get(), value);
  }
  ...
  public entity.GL7UAircrSchedExclItemCov split(java.util.Date splitDate) {
    return (entity.GL7UAircrSchedExclItemCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UAircrSchedExclItemCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UAircrSchedExclItemCov.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getUAircrSchedExclItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(UAIRCRSCHEDEXCLITEM_PROP.get());
    }
    ...
    public void setUAircrSchedExclItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(UAIRCRSCHEDEXCLITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.schedules.GL7UAircrSchedExclItemCovAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.schedules.GL7UAircrSchedExclItemCovAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.gl7.schedules.GL7UAircrSchedExclItemCovAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.gl7.schedules.GL7UAircrSchedExclItemCovAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.schedules.GL7UAircrSchedExclItemCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.schedules.GL7UAircrSchedExclItemCovMatcher");
    config.put("gw.lob.common.LobQuotable", "gw.lob.common.LobDefaultQuotable");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UAircrSchedExclItemCov.class, config);
    com.guidewire._generated.entity.GL7UAircrSchedExclItemCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UAircrSchedExclItemCov, com.guidewire._generated.entity.GL7UAircrSchedExclItemCovInternal>() {
      public java.lang.Object getImplementation(entity.GL7UAircrSchedExclItemCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UAircrSchedExclItemCovInternal getInternalInterface(entity.GL7UAircrSchedExclItemCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UAircrSchedExclItemCov newEmptyInstance() {
        return new entity.GL7UAircrSchedExclItemCov((java.lang.Void)null);
      }

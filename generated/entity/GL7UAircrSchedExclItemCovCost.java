...
/**
 * GL7UAircrSchedExclItemCovCost
 * The cost for a GL7UAircrSchedExclItemCov
 */
...
@gw.entity.EntityName(value = "GL7UAircrSchedExclItemCovCost")
public class GL7UAircrSchedExclItemCovCost extends entity.GL7UAircrSchedExclItemCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7UAircrSchedExclItemCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7UAircrSchedExclItemCovCost, entity.PolicyPeriod>("entity.GL7UAircrSchedExclItemCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> UAIRCRSCHEDEXCLITEMCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "UAircrSchedExclItemCov");
   ...
   */
  public GL7UAircrSchedExclItemCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7UAircrSchedExclItemCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7UAircrSchedExclItemCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7UAircrSchedExclItemCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UAircrSchedExclItemCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7UAircrSchedExclItemCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7UAircrSchedExclItemCovCost clone() {
    return (entity.GL7UAircrSchedExclItemCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7UAircrSchedExclItemCovCost getBasedOn() {
    return (entity.GL7UAircrSchedExclItemCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7UAircrSchedExclItemCovCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7UAircrSchedExclItemCovCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7UAircrSchedExclItemCov getUAircrSchedExclItemCov() {
    return (entity.GL7UAircrSchedExclItemCov)__getInternalInterface().getFieldValue(UAIRCRSCHEDEXCLITEMCOV_PROP.get());
  }
  
  public entity.GL7UAircrSchedExclItemCovCost getUnsliced() {
    return (entity.GL7UAircrSchedExclItemCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7UAircrSchedExclItemCovCostVersionList getVersionList() {
    return (entity.windowed.GL7UAircrSchedExclItemCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setUAircrSchedExclItemCov(entity.GL7UAircrSchedExclItemCov value) {
    __getInternalInterface().setFieldValue(UAIRCRSCHEDEXCLITEMCOV_PROP.get(), value);
  }
  
  public entity.GL7UAircrSchedExclItemCovCost split(java.util.Date splitDate) {
    return (entity.GL7UAircrSchedExclItemCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UAircrSchedExclItemCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UAircrSchedExclItemCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getUAircrSchedExclItemCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(UAIRCRSCHEDEXCLITEMCOV_PROP.get());
    }
    ...
    public void setUAircrSchedExclItemCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(UAIRCRSCHEDEXCLITEMCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7UAircrSchedExclItemCovCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UAircrSchedExclItemCovCost.class, config);
    com.guidewire._generated.entity.GL7UAircrSchedExclItemCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UAircrSchedExclItemCovCost, com.guidewire._generated.entity.GL7UAircrSchedExclItemCovCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7UAircrSchedExclItemCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UAircrSchedExclItemCovCostInternal getInternalInterface(entity.GL7UAircrSchedExclItemCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UAircrSchedExclItemCovCost newEmptyInstance() {
        return new entity.GL7UAircrSchedExclItemCovCost((java.lang.Void)null);
      }

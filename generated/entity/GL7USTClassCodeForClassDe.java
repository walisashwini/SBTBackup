...
/**
 * GL7USTClassCodeForClassDe
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7USTClassCodeForClassDe.eti;GL7USTClassCodeForClassDe.eix;GL7USTClassCodeForClassDe.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7USTClassCodeForClassDe")
public class GL7USTClassCodeForClassDe extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7USTClassCodeForClassDe> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7USTClassCodeForClassDe>("entity.GL7USTClassCodeForClassDe");
  ...
  private com.guidewire._generated.entity.GL7USTClassCodeForClassDeInternal _internal;
   ...
   */
  public GL7USTClassCodeForClassDe()  {
   ...
   */
  public GL7USTClassCodeForClassDe(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7USTClassCodeForClassDe(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7USTClassCodeForClassDeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7USTClassCodeForClassDeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7USTClassCodeForClassDeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7USTClassCodeForClassDe.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7USTClassCodeForClassDe.class, config);
    com.guidewire._generated.entity.GL7USTClassCodeForClassDeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7USTClassCodeForClassDe, com.guidewire._generated.entity.GL7USTClassCodeForClassDeInternal>() {
      public java.lang.Object getImplementation(entity.GL7USTClassCodeForClassDe bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7USTClassCodeForClassDeInternal getInternalInterface(entity.GL7USTClassCodeForClassDe bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7USTClassCodeForClassDe newEmptyInstance() {
        return new entity.GL7USTClassCodeForClassDe((java.lang.Void)null);
      }

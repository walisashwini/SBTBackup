...
/**
 * GL7USTClassDescriptionByC
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7USTClassDescriptionByC.eti;GL7USTClassDescriptionByC.eix;GL7USTClassDescriptionByC.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7USTClassDescriptionByC")
public class GL7USTClassDescriptionByC extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7USTClassDescriptionByC> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7USTClassDescriptionByC>("entity.GL7USTClassDescriptionByC");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> USTCLASSCODEFORCLASSDESCRIPTIO_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "USTClassCodeForClassDescriptio");
  ...
  private com.guidewire._generated.entity.GL7USTClassDescriptionByCInternal _internal;
   ...
   */
  public GL7USTClassDescriptionByC()  {
   ...
   */
  public GL7USTClassDescriptionByC(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7USTClassDescriptionByC(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7USTClassDescriptionByCInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7USTClassDescriptionByCInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Gets the value of the USTClassCodeForClassDescriptio field.
   * USTClassCodeForClassDescription
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getUSTClassCodeForClassDescriptio() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(USTCLASSCODEFORCLASSDESCRIPTIO_PROP.get());
  }
  ...
  /**
   * Sets the value of the USTClassCodeForClassDescriptio field.
   */
  public void setUSTClassCodeForClassDescriptio(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(USTCLASSCODEFORCLASSDESCRIPTIO_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7USTClassDescriptionByCInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7USTClassDescriptionByC.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7USTClassDescriptionByC.class, config);
    com.guidewire._generated.entity.GL7USTClassDescriptionByCInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7USTClassDescriptionByC, com.guidewire._generated.entity.GL7USTClassDescriptionByCInternal>() {
      public java.lang.Object getImplementation(entity.GL7USTClassDescriptionByC bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7USTClassDescriptionByCInternal getInternalInterface(entity.GL7USTClassDescriptionByC bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7USTClassDescriptionByC newEmptyInstance() {
        return new entity.GL7USTClassDescriptionByC((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "GL7UnmannedAircraft")
public class GL7UnmannedAircraft extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverable, entity.CoverableFieldAvailability, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7UnmannedAircraft, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7UnmannedAircraft, entity.PolicyPeriod>("entity.GL7UnmannedAircraft");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> COVAAPPLIES_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CovAApplies");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> COVBAPPLIES_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CovBApplies");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> HOURSOFOPERATIONPERYEAR_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "HoursOfOperationPerYear");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LEVELOFCERTIFICATION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LevelOfCertification");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MANUFACTURER_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Manufacturer");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MAXIMUMTAKEOFFWEIGHT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "MaximumTakeoffWeight");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> OPERATORYEARSOFEXPERIENCE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "OperatorYearsOfExperience");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> OWNERSHIPANDOPERATION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "OwnershipAndOperation");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PRIMARYPLACEOFOPERATION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PrimaryPlaceOfOperation");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> TYPEOFMODIFICATIONS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "TypeOfModifications");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> UAIDENTIFICATIONCODE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "UAIdentificationCode");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> UNMANNEDAIRCRAFTNUMBER_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "UnmannedAircraftNumber");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> UPDATETIME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "UpdateTime");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> UPDATEUSER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "UpdateUser");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> USAGE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Usage");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.GL7UnmannedAircraftInternal _internal;
   ...
   */
  public GL7UnmannedAircraft(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7UnmannedAircraft(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7UnmannedAircraft(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7UnmannedAircraftInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UnmannedAircraftInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7UnmannedAircraft clone() {
    return (entity.GL7UnmannedAircraft)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7UnmannedAircraft getBasedOn() {
    return (entity.GL7UnmannedAircraft)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7UnmannedAircraft getBasedOnValue() {
    return (entity.GL7UnmannedAircraft)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7UnmannedAircraftCond[] getConditions() {
    return (entity.GL7UnmannedAircraftCond[])__getInternalInterface().getFieldValue(CONDITIONS_PROP.get());
  }
  ...
  public java.lang.String getCovAApplies() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(COVAAPPLIES_PROP.get());
  }
  ...
  public java.lang.String getCovBApplies() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(COVBAPPLIES_PROP.get());
  }
  ...
  public entity.GL7UnmannedAircraftCov[] getCoverages() {
    return (entity.GL7UnmannedAircraftCov[])__getInternalInterface().getFieldValue(COVERAGES_PROP.get());
  }
  ...
  public entity.GL7UnmannedAircraftExcl[] getExclusions() {
    return (entity.GL7UnmannedAircraftExcl[])__getInternalInterface().getFieldValue(EXCLUSIONS_PROP.get());
  }
  ...
  public entity.GL7Exposure getExposure() {
    return (entity.GL7Exposure)__getInternalInterface().getFieldValue(EXPOSURE_PROP.get());
  }
  ...
  public entity.GL7UnmannedAircraft getFixed() {
    return (entity.GL7UnmannedAircraft)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public java.lang.Integer getHoursOfOperationPerYear() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(HOURSOFOPERATIONPERYEAR_PROP.get());
  }
  ...
  public java.lang.String getLevelOfCertification() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(LEVELOFCERTIFICATION_PROP.get());
  }
  ...
  public java.lang.String getManufacturer() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(MANUFACTURER_PROP.get());
  }
  ...
  public java.math.BigDecimal getMaximumTakeoffWeight() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(MAXIMUMTAKEOFFWEIGHT_PROP.get());
  }
  ...
  public java.lang.String getOperatorYearsOfExperience() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(OPERATORYEARSOFEXPERIENCE_PROP.get());
  }
  ...
  public java.lang.String getOwnershipAndOperation() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(OWNERSHIPANDOPERATION_PROP.get());
  }
  ...
  public java.lang.String getPrimaryPlaceOfOperation() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(PRIMARYPLACEOFOPERATION_PROP.get());
  }
  ...
  public entity.GL7UnmannedAircraft getSlice(java.util.Date sliceDate) {
    return (entity.GL7UnmannedAircraft)getSliceUntyped(sliceDate);
  }
  ...
  public java.lang.String getTypeOfModifications() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(TYPEOFMODIFICATIONS_PROP.get());
  }
  ...
  public java.lang.String getUAIdentificationCode() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(UAIDENTIFICATIONCODE_PROP.get());
  }
  ...
  public java.lang.Integer getUnmannedAircraftNumber() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(UNMANNEDAIRCRAFTNUMBER_PROP.get());
  }
  
  public entity.GL7UnmannedAircraft getUnsliced() {
    return (entity.GL7UnmannedAircraft)getUnslicedUntyped();
  }
  ...
  public java.lang.String getUsage() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(USAGE_PROP.get());
  }
  
  public entity.windowed.GL7UnmannedAircraftVersionList getVersionList() {
    return (entity.windowed.GL7UnmannedAircraftVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7UnmannedAircraft value) {
  ...
  public void setCovAApplies(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(COVAAPPLIES_PROP.get(), value);
  }
  ...
  public void setCovBApplies(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(COVBAPPLIES_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.GL7UnmannedAircraft value) {
  ...
  public void setHoursOfOperationPerYear(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(HOURSOFOPERATIONPERYEAR_PROP.get(), value);
  }
  ...
  public void setLevelOfCertification(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(LEVELOFCERTIFICATION_PROP.get(), value);
  }
  ...
  public void setManufacturer(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(MANUFACTURER_PROP.get(), value);
  }
  ...
  public void setMaximumTakeoffWeight(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(MAXIMUMTAKEOFFWEIGHT_PROP.get(), value);
  }
  ...
  public void setOperatorYearsOfExperience(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(OPERATORYEARSOFEXPERIENCE_PROP.get(), value);
  }
  ...
  public void setOwnershipAndOperation(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(OWNERSHIPANDOPERATION_PROP.get(), value);
  }
  ...
  public void setPrimaryPlaceOfOperation(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(PRIMARYPLACEOFOPERATION_PROP.get(), value);
  }
  ...
  public void setTypeOfModifications(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(TYPEOFMODIFICATIONS_PROP.get(), value);
  }
  ...
  public void setUAIdentificationCode(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(UAIDENTIFICATIONCODE_PROP.get(), value);
  }
  ...
  public void setUnmannedAircraftNumber(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(UNMANNEDAIRCRAFTNUMBER_PROP.get(), value);
  }
  ...
  public void setUsage(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(USAGE_PROP.get(), value);
  }
  
  public entity.GL7UnmannedAircraft split(java.util.Date splitDate) {
    return (entity.GL7UnmannedAircraft)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UnmannedAircraftInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UnmannedAircraft.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.gl7.GL7UnmannedAircraftCoverableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.gl7.GL7UnmannedAircraftCoverableAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.GL7UnmannedAircraftMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.GL7UnmannedAircraftMatcher");
    config.put("gw.lob.common.LobCoverable", "gw.lob.gl7.GL7UnmannedAircraftCoverable");
    config.put("gw.lob.gl7.GL7Coverable", "gw.lob.gl7.GL7UnmannedAircraftCoverable");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UnmannedAircraft.class, config);
    com.guidewire._generated.entity.GL7UnmannedAircraftInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UnmannedAircraft, com.guidewire._generated.entity.GL7UnmannedAircraftInternal>() {
      public java.lang.Object getImplementation(entity.GL7UnmannedAircraft bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UnmannedAircraftInternal getInternalInterface(entity.GL7UnmannedAircraft bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UnmannedAircraft newEmptyInstance() {
        return new entity.GL7UnmannedAircraft((java.lang.Void)null);
      }

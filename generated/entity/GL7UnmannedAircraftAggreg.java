...
/**
 * GL7UnmannedAircraftAggreg
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7UnmannedAircraftAggreg.eti;GL7UnmannedAircraftAggreg.eix;GL7UnmannedAircraftAggreg.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7UnmannedAircraftAggreg")
public class GL7UnmannedAircraftAggreg extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7UnmannedAircraftAggreg> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7UnmannedAircraftAggreg>("entity.GL7UnmannedAircraftAggreg");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> POLICYEACHOCCURRENCELIM_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PolicyEachOccurrenceLim");
  ...
  private com.guidewire._generated.entity.GL7UnmannedAircraftAggregInternal _internal;
   ...
   */
  public GL7UnmannedAircraftAggreg()  {
   ...
   */
  public GL7UnmannedAircraftAggreg(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7UnmannedAircraftAggreg(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7UnmannedAircraftAggregInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UnmannedAircraftAggregInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Gets the value of the PolicyEachOccurrenceLim field.
   * PolicyEachOccurrenceLimit
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getPolicyEachOccurrenceLim() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(POLICYEACHOCCURRENCELIM_PROP.get());
  }
  ...
  /**
   * Sets the value of the PolicyEachOccurrenceLim field.
   */
  public void setPolicyEachOccurrenceLim(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(POLICYEACHOCCURRENCELIM_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UnmannedAircraftAggregInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UnmannedAircraftAggreg.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UnmannedAircraftAggreg.class, config);
    com.guidewire._generated.entity.GL7UnmannedAircraftAggregInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UnmannedAircraftAggreg, com.guidewire._generated.entity.GL7UnmannedAircraftAggregInternal>() {
      public java.lang.Object getImplementation(entity.GL7UnmannedAircraftAggreg bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UnmannedAircraftAggregInternal getInternalInterface(entity.GL7UnmannedAircraftAggreg bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UnmannedAircraftAggreg newEmptyInstance() {
        return new entity.GL7UnmannedAircraftAggreg((java.lang.Void)null);
      }

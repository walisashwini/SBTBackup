...
/**
 * GL7UnmannedAircraftCond
 * Conditions directly attached to each Covered UnmannedAircraft
 */
...
@gw.entity.EntityName(value = "GL7UnmannedAircraftCond")
public class GL7UnmannedAircraftCond extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PolicyCondition, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7UnmannedAircraftCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7UnmannedAircraftCond, entity.PolicyPeriod>("entity.GL7UnmannedAircraftCond");
  ...
  private com.guidewire._generated.entity.GL7UnmannedAircraftCondInternal _internal;
   ...
   */
  protected GL7UnmannedAircraftCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7UnmannedAircraftCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7UnmannedAircraftCond(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7UnmannedAircraftCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UnmannedAircraftCondInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7UnmannedAircraftCond clone() {
    return (entity.GL7UnmannedAircraftCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7UnmannedAircraftCond getBasedOn() {
    return (entity.GL7UnmannedAircraftCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7UnmannedAircraftCond getBasedOnValue() {
    return (entity.GL7UnmannedAircraftCond)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7UnmannedAircraftCondCost[] getCosts() {
    return (entity.GL7UnmannedAircraftCondCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
  }
  ...
  public entity.GL7UnmannedAircraftCond getFixed() {
    return (entity.GL7UnmannedAircraftCond)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7UnmannedAircraftCond getSlice(java.util.Date sliceDate) {
    return (entity.GL7UnmannedAircraftCond)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.GL7UnmannedAircraftCond getSubtype() {
    return (typekey.GL7UnmannedAircraftCond)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.GL7UnmannedAircraftCond getUnsliced() {
    return (entity.GL7UnmannedAircraftCond)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7UnmannedAircraftCondVersionList getVersionList() {
    return (entity.windowed.GL7UnmannedAircraftCondVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7UnmannedAircraftCond value) {
   ...
   */
  private void setFixed(entity.GL7UnmannedAircraftCond value) {
   ...
   */
  private void setSubtype(typekey.GL7UnmannedAircraftCond value) {
  ...
  public entity.GL7UnmannedAircraftCond split(java.util.Date splitDate) {
    return (entity.GL7UnmannedAircraftCond)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UnmannedAircraftCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UnmannedAircraftCond.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.GL7UnmannedAircraftCondAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.GL7UnmannedAircraftCondAdapter");
    config.put("gw.api.domain.PolicyConditionAdapter", "gw.lob.gl7.GL7UnmannedAircraftCondAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.GL7UnmannedAircraftCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.GL7UnmannedAircraftCondMatcher");
    config.put("gw.lob.common.LobQuotable", "gw.lob.common.LobDefaultQuotable");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UnmannedAircraftCond.class, config);
    com.guidewire._generated.entity.GL7UnmannedAircraftCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UnmannedAircraftCond, com.guidewire._generated.entity.GL7UnmannedAircraftCondInternal>() {
      public java.lang.Object getImplementation(entity.GL7UnmannedAircraftCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UnmannedAircraftCondInternal getInternalInterface(entity.GL7UnmannedAircraftCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UnmannedAircraftCond newEmptyInstance() {
        return new entity.GL7UnmannedAircraftCond((java.lang.Void)null);
      }

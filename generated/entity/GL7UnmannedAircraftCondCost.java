...
/**
 * GL7UnmannedAircraftCondCost
 * The cost for a GL7UnmannedAircraftCond
 */
...
@gw.entity.EntityName(value = "GL7UnmannedAircraftCondCost")
public class GL7UnmannedAircraftCondCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7UnmannedAircraftCondCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7UnmannedAircraftCondCost, entity.PolicyPeriod>("entity.GL7UnmannedAircraftCondCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> UNMANNEDAIRCRAFTCOND_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "UnmannedAircraftCond");
   ...
   */
  public GL7UnmannedAircraftCondCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7UnmannedAircraftCondCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7UnmannedAircraftCondCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7UnmannedAircraftCondCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UnmannedAircraftCondCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7UnmannedAircraftCondCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7UnmannedAircraftCondCost clone() {
    return (entity.GL7UnmannedAircraftCondCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7UnmannedAircraftCondCost getBasedOn() {
    return (entity.GL7UnmannedAircraftCondCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7UnmannedAircraftCondCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7UnmannedAircraftCondCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7UnmannedAircraftCond getUnmannedAircraftCond() {
    return (entity.GL7UnmannedAircraftCond)__getInternalInterface().getFieldValue(UNMANNEDAIRCRAFTCOND_PROP.get());
  }
  
  public entity.GL7UnmannedAircraftCondCost getUnsliced() {
    return (entity.GL7UnmannedAircraftCondCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7UnmannedAircraftCondCostVersionList getVersionList() {
    return (entity.windowed.GL7UnmannedAircraftCondCostVersionList)getVersionListUntyped();
  }
  ...
  public void setUnmannedAircraftCond(entity.GL7UnmannedAircraftCond value) {
    __getInternalInterface().setFieldValue(UNMANNEDAIRCRAFTCOND_PROP.get(), value);
  }
  
  public entity.GL7UnmannedAircraftCondCost split(java.util.Date splitDate) {
    return (entity.GL7UnmannedAircraftCondCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UnmannedAircraftCondCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UnmannedAircraftCondCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getUnmannedAircraftCondID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(UNMANNEDAIRCRAFTCOND_PROP.get());
    }
    ...
    public void setUnmannedAircraftCondID(gw.pl.persistence.core.Key value) {
      setFieldValue(UNMANNEDAIRCRAFTCOND_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7UnmannedAircraftCondCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UnmannedAircraftCondCost.class, config);
    com.guidewire._generated.entity.GL7UnmannedAircraftCondCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UnmannedAircraftCondCost, com.guidewire._generated.entity.GL7UnmannedAircraftCondCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7UnmannedAircraftCondCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UnmannedAircraftCondCostInternal getInternalInterface(entity.GL7UnmannedAircraftCondCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UnmannedAircraftCondCost newEmptyInstance() {
        return new entity.GL7UnmannedAircraftCondCost((java.lang.Void)null);
      }

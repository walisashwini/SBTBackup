...
/**
 * GL7UnmannedAircraftCov
 * Coverages directly attached to each Covered UnmannedAircraft
 */
...
@gw.entity.EntityName(value = "GL7UnmannedAircraftCov")
public class GL7UnmannedAircraftCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7UnmannedAircraftCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7UnmannedAircraftCov, entity.PolicyPeriod>("entity.GL7UnmannedAircraftCov");
  ...
  private com.guidewire._generated.entity.GL7UnmannedAircraftCovInternal _internal;
   ...
   */
  protected GL7UnmannedAircraftCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GL7UnmannedAircraftCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GL7UnmannedAircraftCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7UnmannedAircraftCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UnmannedAircraftCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GL7UnmannedAircraftCov clone() {
    return (entity.GL7UnmannedAircraftCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GL7UnmannedAircraftCov getBasedOn() {
    return (entity.GL7UnmannedAircraftCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7UnmannedAircraftCov getBasedOnValue() {
    return (entity.GL7UnmannedAircraftCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GL7UnmannedAircraftCovCost[] getCosts() {
    return (entity.GL7UnmannedAircraftCovCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
  }
  ...
  public entity.GL7UnmannedAircraftCov getFixed() {
    return (entity.GL7UnmannedAircraftCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GL7UnmannedAircraftCov getSlice(java.util.Date sliceDate) {
    return (entity.GL7UnmannedAircraftCov)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.GL7UnmannedAircraftCov getSubtype() {
    return (typekey.GL7UnmannedAircraftCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.GL7UnmannedAircraftCov getUnsliced() {
    return (entity.GL7UnmannedAircraftCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GL7UnmannedAircraftCovVersionList getVersionList() {
    return (entity.windowed.GL7UnmannedAircraftCovVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GL7UnmannedAircraftCov value) {
   ...
   */
  private void setFixed(entity.GL7UnmannedAircraftCov value) {
   ...
   */
  private void setSubtype(typekey.GL7UnmannedAircraftCov value) {
  ...
  public entity.GL7UnmannedAircraftCov split(java.util.Date splitDate) {
    return (entity.GL7UnmannedAircraftCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UnmannedAircraftCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UnmannedAircraftCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl7.GL7UnmannedAircraftCovAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl7.GL7UnmannedAircraftCovAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.gl7.GL7UnmannedAircraftCovAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.gl7.GL7UnmannedAircraftCovAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl7.GL7UnmannedAircraftCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl7.GL7UnmannedAircraftCovMatcher");
    config.put("gw.lob.common.LobQuotable", "gw.lob.common.LobDefaultQuotable");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UnmannedAircraftCov.class, config);
    com.guidewire._generated.entity.GL7UnmannedAircraftCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UnmannedAircraftCov, com.guidewire._generated.entity.GL7UnmannedAircraftCovInternal>() {
      public java.lang.Object getImplementation(entity.GL7UnmannedAircraftCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UnmannedAircraftCovInternal getInternalInterface(entity.GL7UnmannedAircraftCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UnmannedAircraftCov newEmptyInstance() {
        return new entity.GL7UnmannedAircraftCov((java.lang.Void)null);
      }

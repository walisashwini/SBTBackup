...
/**
 * GL7UnmannedAircraftCovCost
 * The cost for a GL7UnmannedAircraftCov
 */
...
@gw.entity.EntityName(value = "GL7UnmannedAircraftCovCost")
public class GL7UnmannedAircraftCovCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7UnmannedAircraftCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7UnmannedAircraftCovCost, entity.PolicyPeriod>("entity.GL7UnmannedAircraftCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> UNMANNEDAIRCRAFTCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "UnmannedAircraftCov");
   ...
   */
  public GL7UnmannedAircraftCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7UnmannedAircraftCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7UnmannedAircraftCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7UnmannedAircraftCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UnmannedAircraftCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7UnmannedAircraftCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7UnmannedAircraftCovCost clone() {
    return (entity.GL7UnmannedAircraftCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7UnmannedAircraftCovCost getBasedOn() {
    return (entity.GL7UnmannedAircraftCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7UnmannedAircraftCovCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7UnmannedAircraftCovCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7UnmannedAircraftCov getUnmannedAircraftCov() {
    return (entity.GL7UnmannedAircraftCov)__getInternalInterface().getFieldValue(UNMANNEDAIRCRAFTCOV_PROP.get());
  }
  
  public entity.GL7UnmannedAircraftCovCost getUnsliced() {
    return (entity.GL7UnmannedAircraftCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7UnmannedAircraftCovCostVersionList getVersionList() {
    return (entity.windowed.GL7UnmannedAircraftCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setUnmannedAircraftCov(entity.GL7UnmannedAircraftCov value) {
    __getInternalInterface().setFieldValue(UNMANNEDAIRCRAFTCOV_PROP.get(), value);
  }
  
  public entity.GL7UnmannedAircraftCovCost split(java.util.Date splitDate) {
    return (entity.GL7UnmannedAircraftCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UnmannedAircraftCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UnmannedAircraftCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getUnmannedAircraftCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(UNMANNEDAIRCRAFTCOV_PROP.get());
    }
    ...
    public void setUnmannedAircraftCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(UNMANNEDAIRCRAFTCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7UnmannedAircraftCovCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UnmannedAircraftCovCost.class, config);
    com.guidewire._generated.entity.GL7UnmannedAircraftCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UnmannedAircraftCovCost, com.guidewire._generated.entity.GL7UnmannedAircraftCovCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7UnmannedAircraftCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UnmannedAircraftCovCostInternal getInternalInterface(entity.GL7UnmannedAircraftCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UnmannedAircraftCovCost newEmptyInstance() {
        return new entity.GL7UnmannedAircraftCovCost((java.lang.Void)null);
      }

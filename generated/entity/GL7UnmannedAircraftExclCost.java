...
/**
 * GL7UnmannedAircraftExclCost
 * The cost for a GL7UnmannedAircraftExcl
 */
...
@gw.entity.EntityName(value = "GL7UnmannedAircraftExclCost")
public class GL7UnmannedAircraftExclCost extends entity.GL7Cost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GL7UnmannedAircraftExclCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GL7UnmannedAircraftExclCost, entity.PolicyPeriod>("entity.GL7UnmannedAircraftExclCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> UNMANNEDAIRCRAFTEXCL_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "UnmannedAircraftExcl");
   ...
   */
  public GL7UnmannedAircraftExclCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GL7UnmannedAircraftExclCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GL7UnmannedAircraftExclCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GL7UnmannedAircraftExclCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UnmannedAircraftExclCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GL7UnmannedAircraftExclCostInternal)super.__getInternalInterface();
  }
  
  public entity.GL7UnmannedAircraftExclCost clone() {
    return (entity.GL7UnmannedAircraftExclCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GL7UnmannedAircraftExclCost getBasedOn() {
    return (entity.GL7UnmannedAircraftExclCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GL7UnmannedAircraftExclCost getSlice(java.util.Date sliceDate) {
    return (entity.GL7UnmannedAircraftExclCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GL7UnmannedAircraftExcl getUnmannedAircraftExcl() {
    return (entity.GL7UnmannedAircraftExcl)__getInternalInterface().getFieldValue(UNMANNEDAIRCRAFTEXCL_PROP.get());
  }
  
  public entity.GL7UnmannedAircraftExclCost getUnsliced() {
    return (entity.GL7UnmannedAircraftExclCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GL7UnmannedAircraftExclCostVersionList getVersionList() {
    return (entity.windowed.GL7UnmannedAircraftExclCostVersionList)getVersionListUntyped();
  }
  ...
  public void setUnmannedAircraftExcl(entity.GL7UnmannedAircraftExcl value) {
    __getInternalInterface().setFieldValue(UNMANNEDAIRCRAFTEXCL_PROP.get(), value);
  }
  
  public entity.GL7UnmannedAircraftExclCost split(java.util.Date splitDate) {
    return (entity.GL7UnmannedAircraftExclCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UnmannedAircraftExclCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UnmannedAircraftExclCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getUnmannedAircraftExclID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(UNMANNEDAIRCRAFTEXCL_PROP.get());
    }
    ...
    public void setUnmannedAircraftExclID(gw.pl.persistence.core.Key value) {
      setFieldValue(UNMANNEDAIRCRAFTEXCL_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.common.financials.LobCostMethods", "gw.lob.gl7.financials.GL7UnmannedAircraftExclCostImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UnmannedAircraftExclCost.class, config);
    com.guidewire._generated.entity.GL7UnmannedAircraftExclCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UnmannedAircraftExclCost, com.guidewire._generated.entity.GL7UnmannedAircraftExclCostInternal>() {
      public java.lang.Object getImplementation(entity.GL7UnmannedAircraftExclCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UnmannedAircraftExclCostInternal getInternalInterface(entity.GL7UnmannedAircraftExclCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UnmannedAircraftExclCost newEmptyInstance() {
        return new entity.GL7UnmannedAircraftExclCost((java.lang.Void)null);
      }

...
/**
 * GL7UnmannedAircraftLevelO
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7UnmannedAircraftLevelO.eti;GL7UnmannedAircraftLevelO.eix;GL7UnmannedAircraftLevelO.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7UnmannedAircraftLevelO")
public class GL7UnmannedAircraftLevelO extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7UnmannedAircraftLevelO> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7UnmannedAircraftLevelO>("entity.GL7UnmannedAircraftLevelO");
  ...
  private com.guidewire._generated.entity.GL7UnmannedAircraftLevelOInternal _internal;
   ...
   */
  public GL7UnmannedAircraftLevelO()  {
   ...
   */
  public GL7UnmannedAircraftLevelO(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7UnmannedAircraftLevelO(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7UnmannedAircraftLevelOInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UnmannedAircraftLevelOInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UnmannedAircraftLevelOInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UnmannedAircraftLevelO.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UnmannedAircraftLevelO.class, config);
    com.guidewire._generated.entity.GL7UnmannedAircraftLevelOInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UnmannedAircraftLevelO, com.guidewire._generated.entity.GL7UnmannedAircraftLevelOInternal>() {
      public java.lang.Object getImplementation(entity.GL7UnmannedAircraftLevelO bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UnmannedAircraftLevelOInternal getInternalInterface(entity.GL7UnmannedAircraftLevelO bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UnmannedAircraftLevelO newEmptyInstance() {
        return new entity.GL7UnmannedAircraftLevelO((java.lang.Void)null);
      }

...
/**
 * GL7UnmannedAircraftManufa
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7UnmannedAircraftManufa.eti;GL7UnmannedAircraftManufa.eix;GL7UnmannedAircraftManufa.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7UnmannedAircraftManufa")
public class GL7UnmannedAircraftManufa extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7UnmannedAircraftManufa> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7UnmannedAircraftManufa>("entity.GL7UnmannedAircraftManufa");
  ...
  private com.guidewire._generated.entity.GL7UnmannedAircraftManufaInternal _internal;
   ...
   */
  public GL7UnmannedAircraftManufa()  {
   ...
   */
  public GL7UnmannedAircraftManufa(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7UnmannedAircraftManufa(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7UnmannedAircraftManufaInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UnmannedAircraftManufaInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UnmannedAircraftManufaInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UnmannedAircraftManufa.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UnmannedAircraftManufa.class, config);
    com.guidewire._generated.entity.GL7UnmannedAircraftManufaInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UnmannedAircraftManufa, com.guidewire._generated.entity.GL7UnmannedAircraftManufaInternal>() {
      public java.lang.Object getImplementation(entity.GL7UnmannedAircraftManufa bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UnmannedAircraftManufaInternal getInternalInterface(entity.GL7UnmannedAircraftManufa bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UnmannedAircraftManufa newEmptyInstance() {
        return new entity.GL7UnmannedAircraftManufa((java.lang.Void)null);
      }

...
/**
 * GL7UnmannedAircraftModel
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7UnmannedAircraftModel.eti;GL7UnmannedAircraftModel.eix;GL7UnmannedAircraftModel.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7UnmannedAircraftModel")
public class GL7UnmannedAircraftModel extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7UnmannedAircraftModel> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7UnmannedAircraftModel>("entity.GL7UnmannedAircraftModel");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> UNMANNEDAIRCRAFTMANUFACTURER_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "UnmannedAircraftManufacturer");
  ...
  private com.guidewire._generated.entity.GL7UnmannedAircraftModelInternal _internal;
   ...
   */
  public GL7UnmannedAircraftModel()  {
   ...
   */
  public GL7UnmannedAircraftModel(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7UnmannedAircraftModel(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7UnmannedAircraftModelInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UnmannedAircraftModelInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Gets the value of the UnmannedAircraftManufacturer field.
   * UnmannedAircraftManufacturer
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getUnmannedAircraftManufacturer() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(UNMANNEDAIRCRAFTMANUFACTURER_PROP.get());
  }
  ...
  /**
   * Sets the value of the UnmannedAircraftManufacturer field.
   */
  public void setUnmannedAircraftManufacturer(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(UNMANNEDAIRCRAFTMANUFACTURER_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UnmannedAircraftModelInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UnmannedAircraftModel.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UnmannedAircraftModel.class, config);
    com.guidewire._generated.entity.GL7UnmannedAircraftModelInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UnmannedAircraftModel, com.guidewire._generated.entity.GL7UnmannedAircraftModelInternal>() {
      public java.lang.Object getImplementation(entity.GL7UnmannedAircraftModel bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UnmannedAircraftModelInternal getInternalInterface(entity.GL7UnmannedAircraftModel bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UnmannedAircraftModel newEmptyInstance() {
        return new entity.GL7UnmannedAircraftModel((java.lang.Void)null);
      }

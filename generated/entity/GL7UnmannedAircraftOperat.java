...
/**
 * GL7UnmannedAircraftOperat
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7UnmannedAircraftOperat.eti;GL7UnmannedAircraftOperat.eix;GL7UnmannedAircraftOperat.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7UnmannedAircraftOperat")
public class GL7UnmannedAircraftOperat extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7UnmannedAircraftOperat> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7UnmannedAircraftOperat>("entity.GL7UnmannedAircraftOperat");
  ...
  private com.guidewire._generated.entity.GL7UnmannedAircraftOperatInternal _internal;
   ...
   */
  public GL7UnmannedAircraftOperat()  {
   ...
   */
  public GL7UnmannedAircraftOperat(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7UnmannedAircraftOperat(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7UnmannedAircraftOperatInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UnmannedAircraftOperatInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UnmannedAircraftOperatInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UnmannedAircraftOperat.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UnmannedAircraftOperat.class, config);
    com.guidewire._generated.entity.GL7UnmannedAircraftOperatInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UnmannedAircraftOperat, com.guidewire._generated.entity.GL7UnmannedAircraftOperatInternal>() {
      public java.lang.Object getImplementation(entity.GL7UnmannedAircraftOperat bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UnmannedAircraftOperatInternal getInternalInterface(entity.GL7UnmannedAircraftOperat bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UnmannedAircraftOperat newEmptyInstance() {
        return new entity.GL7UnmannedAircraftOperat((java.lang.Void)null);
      }

...
/**
 * GL7UnmannedAircraftOwners
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7UnmannedAircraftOwners.eti;GL7UnmannedAircraftOwners.eix;GL7UnmannedAircraftOwners.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7UnmannedAircraftOwners")
public class GL7UnmannedAircraftOwners extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7UnmannedAircraftOwners> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7UnmannedAircraftOwners>("entity.GL7UnmannedAircraftOwners");
  ...
  private com.guidewire._generated.entity.GL7UnmannedAircraftOwnersInternal _internal;
   ...
   */
  public GL7UnmannedAircraftOwners()  {
   ...
   */
  public GL7UnmannedAircraftOwners(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7UnmannedAircraftOwners(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7UnmannedAircraftOwnersInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UnmannedAircraftOwnersInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UnmannedAircraftOwnersInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UnmannedAircraftOwners.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UnmannedAircraftOwners.class, config);
    com.guidewire._generated.entity.GL7UnmannedAircraftOwnersInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UnmannedAircraftOwners, com.guidewire._generated.entity.GL7UnmannedAircraftOwnersInternal>() {
      public java.lang.Object getImplementation(entity.GL7UnmannedAircraftOwners bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UnmannedAircraftOwnersInternal getInternalInterface(entity.GL7UnmannedAircraftOwners bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UnmannedAircraftOwners newEmptyInstance() {
        return new entity.GL7UnmannedAircraftOwners((java.lang.Void)null);
      }

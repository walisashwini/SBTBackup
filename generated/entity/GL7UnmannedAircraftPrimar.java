...
/**
 * GL7UnmannedAircraftPrimar
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7UnmannedAircraftPrimar.eti;GL7UnmannedAircraftPrimar.eix;GL7UnmannedAircraftPrimar.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7UnmannedAircraftPrimar")
public class GL7UnmannedAircraftPrimar extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7UnmannedAircraftPrimar> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7UnmannedAircraftPrimar>("entity.GL7UnmannedAircraftPrimar");
  ...
  private com.guidewire._generated.entity.GL7UnmannedAircraftPrimarInternal _internal;
   ...
   */
  public GL7UnmannedAircraftPrimar()  {
   ...
   */
  public GL7UnmannedAircraftPrimar(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7UnmannedAircraftPrimar(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7UnmannedAircraftPrimarInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UnmannedAircraftPrimarInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UnmannedAircraftPrimarInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UnmannedAircraftPrimar.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UnmannedAircraftPrimar.class, config);
    com.guidewire._generated.entity.GL7UnmannedAircraftPrimarInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UnmannedAircraftPrimar, com.guidewire._generated.entity.GL7UnmannedAircraftPrimarInternal>() {
      public java.lang.Object getImplementation(entity.GL7UnmannedAircraftPrimar bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UnmannedAircraftPrimarInternal getInternalInterface(entity.GL7UnmannedAircraftPrimar bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UnmannedAircraftPrimar newEmptyInstance() {
        return new entity.GL7UnmannedAircraftPrimar((java.lang.Void)null);
      }

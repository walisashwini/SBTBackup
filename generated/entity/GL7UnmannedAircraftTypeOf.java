...
/**
 * GL7UnmannedAircraftTypeOf
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7UnmannedAircraftTypeOf.eti;GL7UnmannedAircraftTypeOf.eix;GL7UnmannedAircraftTypeOf.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7UnmannedAircraftTypeOf")
public class GL7UnmannedAircraftTypeOf extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7UnmannedAircraftTypeOf> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7UnmannedAircraftTypeOf>("entity.GL7UnmannedAircraftTypeOf");
  ...
  private com.guidewire._generated.entity.GL7UnmannedAircraftTypeOfInternal _internal;
   ...
   */
  public GL7UnmannedAircraftTypeOf()  {
   ...
   */
  public GL7UnmannedAircraftTypeOf(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7UnmannedAircraftTypeOf(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7UnmannedAircraftTypeOfInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UnmannedAircraftTypeOfInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UnmannedAircraftTypeOfInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UnmannedAircraftTypeOf.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UnmannedAircraftTypeOf.class, config);
    com.guidewire._generated.entity.GL7UnmannedAircraftTypeOfInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UnmannedAircraftTypeOf, com.guidewire._generated.entity.GL7UnmannedAircraftTypeOfInternal>() {
      public java.lang.Object getImplementation(entity.GL7UnmannedAircraftTypeOf bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UnmannedAircraftTypeOfInternal getInternalInterface(entity.GL7UnmannedAircraftTypeOf bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UnmannedAircraftTypeOf newEmptyInstance() {
        return new entity.GL7UnmannedAircraftTypeOf((java.lang.Void)null);
      }

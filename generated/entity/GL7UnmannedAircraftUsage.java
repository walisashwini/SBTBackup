...
/**
 * GL7UnmannedAircraftUsage
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7UnmannedAircraftUsage.eti;GL7UnmannedAircraftUsage.eix;GL7UnmannedAircraftUsage.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7UnmannedAircraftUsage")
public class GL7UnmannedAircraftUsage extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7UnmannedAircraftUsage> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7UnmannedAircraftUsage>("entity.GL7UnmannedAircraftUsage");
  ...
  private com.guidewire._generated.entity.GL7UnmannedAircraftUsageInternal _internal;
   ...
   */
  public GL7UnmannedAircraftUsage()  {
   ...
   */
  public GL7UnmannedAircraftUsage(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7UnmannedAircraftUsage(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7UnmannedAircraftUsageInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7UnmannedAircraftUsageInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7UnmannedAircraftUsageInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7UnmannedAircraftUsage.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7UnmannedAircraftUsage.class, config);
    com.guidewire._generated.entity.GL7UnmannedAircraftUsageInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7UnmannedAircraftUsage, com.guidewire._generated.entity.GL7UnmannedAircraftUsageInternal>() {
      public java.lang.Object getImplementation(entity.GL7UnmannedAircraftUsage bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7UnmannedAircraftUsageInternal getInternalInterface(entity.GL7UnmannedAircraftUsage bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7UnmannedAircraftUsage newEmptyInstance() {
        return new entity.GL7UnmannedAircraftUsage((java.lang.Void)null);
      }

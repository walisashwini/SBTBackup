...
/**
 * GL7YearsOfExperienceIncur
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7YearsOfExperienceIncur.eti;GL7YearsOfExperienceIncur.eix;GL7YearsOfExperienceIncur.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7YearsOfExperienceIncur")
public class GL7YearsOfExperienceIncur extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7YearsOfExperienceIncur> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7YearsOfExperienceIncur>("entity.GL7YearsOfExperienceIncur");
  ...
  private com.guidewire._generated.entity.GL7YearsOfExperienceIncurInternal _internal;
   ...
   */
  public GL7YearsOfExperienceIncur()  {
   ...
   */
  public GL7YearsOfExperienceIncur(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7YearsOfExperienceIncur(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7YearsOfExperienceIncurInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7YearsOfExperienceIncurInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7YearsOfExperienceIncurInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7YearsOfExperienceIncur.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7YearsOfExperienceIncur.class, config);
    com.guidewire._generated.entity.GL7YearsOfExperienceIncurInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7YearsOfExperienceIncur, com.guidewire._generated.entity.GL7YearsOfExperienceIncurInternal>() {
      public java.lang.Object getImplementation(entity.GL7YearsOfExperienceIncur bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7YearsOfExperienceIncurInternal getInternalInterface(entity.GL7YearsOfExperienceIncur bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7YearsOfExperienceIncur newEmptyInstance() {
        return new entity.GL7YearsOfExperienceIncur((java.lang.Void)null);
      }

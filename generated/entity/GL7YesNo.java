 ...
 * GL7YesNo
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7YesNo.eti;GL7YesNo.eix;GL7YesNo.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7YesNo")
public class GL7YesNo extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7YesNo> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7YesNo>("entity.GL7YesNo");
  ...
  private com.guidewire._generated.entity.GL7YesNoInternal _internal;
   ...
   */
  public GL7YesNo(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7YesNo(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7YesNoInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7YesNoInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7YesNoInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7YesNo.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7YesNo.class, config);
    com.guidewire._generated.entity.GL7YesNoInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7YesNo, com.guidewire._generated.entity.GL7YesNoInternal>() {
      public java.lang.Object getImplementation(entity.GL7YesNo bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7YesNoInternal getInternalInterface(entity.GL7YesNo bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7YesNo newEmptyInstance() {
        return new entity.GL7YesNo((java.lang.Void)null);
      }

 ...
 * GL7ZipCode
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GL7ZipCode.eti;GL7ZipCode.eix;GL7ZipCode.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GL7ZipCode")
public class GL7ZipCode extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GL7ZipCode> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GL7ZipCode>("entity.GL7ZipCode");
  ...
  private com.guidewire._generated.entity.GL7ZipCodeInternal _internal;
   ...
   */
  public GL7ZipCode(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GL7ZipCode(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GL7ZipCodeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GL7ZipCodeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GL7ZipCodeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GL7ZipCode.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GL7ZipCode.class, config);
    com.guidewire._generated.entity.GL7ZipCodeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GL7ZipCode, com.guidewire._generated.entity.GL7ZipCodeInternal>() {
      public java.lang.Object getImplementation(entity.GL7ZipCode bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GL7ZipCodeInternal getInternalInterface(entity.GL7ZipCode bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GL7ZipCode newEmptyInstance() {
        return new entity.GL7ZipCode((java.lang.Void)null);
      }

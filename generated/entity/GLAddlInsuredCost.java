...
/**
 * GLAddlInsuredCost
 * The cost for an additional insured.
 */
...
@gw.entity.EntityName(value = "GLAddlInsuredCost")
public class GLAddlInsuredCost extends entity.GLCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GLAddlInsuredCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GLAddlInsuredCost, entity.PolicyPeriod>("entity.GLAddlInsuredCost");
   ...
   */
  public GLAddlInsuredCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GLAddlInsuredCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GLAddlInsuredCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GLAddlInsuredCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GLAddlInsuredCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GLAddlInsuredCostInternal)super.__getInternalInterface();
  }
  
  public entity.GLAddlInsuredCost clone() {
    return (entity.GLAddlInsuredCost)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.PolicyAddlInsured getAdditionalInsured() {
    return (entity.PolicyAddlInsured)__getInternalInterface().getFieldValue(ADDITIONALINSURED_PROP.get());
  }
  
  public entity.GLAddlInsuredCost getBasedOn() {
    return (entity.GLAddlInsuredCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GLAddlInsuredCost getSlice(java.util.Date sliceDate) {
    return (entity.GLAddlInsuredCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GLAddlInsuredCost getUnsliced() {
    return (entity.GLAddlInsuredCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GLAddlInsuredCostVersionList getVersionList() {
    return (entity.windowed.GLAddlInsuredCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.GLAddlInsuredCost split(java.util.Date splitDate) {
    return (entity.GLAddlInsuredCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GLAddlInsuredCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GLAddlInsuredCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.gl.financials.GLCostMethods", "gw.lob.gl.financials.GLAddlInsuredCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GLAddlInsuredCost.class, config);
    com.guidewire._generated.entity.GLAddlInsuredCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GLAddlInsuredCost, com.guidewire._generated.entity.GLAddlInsuredCostInternal>() {
      public java.lang.Object getImplementation(entity.GLAddlInsuredCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GLAddlInsuredCostInternal getInternalInterface(entity.GLAddlInsuredCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GLAddlInsuredCost newEmptyInstance() {
        return new entity.GLAddlInsuredCost((java.lang.Void)null);
      }

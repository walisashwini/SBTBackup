...
/**
 * GLCededPremiumTransaction
 * A GeneralLiability implementation of the RICededPremiumTransaction delegate
 */
...
@gw.entity.EntityName(value = "GLCededPremiumTransaction")
public class GLCededPremiumTransaction extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.RICededPremiumTransaction, entity.FrozenSetMember, gw.api.reinsurance.RICededPremiumTxnAdapter {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GLCededPremiumTransaction> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GLCededPremiumTransaction>("entity.GLCededPremiumTransaction");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GLCEDEDPREMIUM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GLCededPremium");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GLCEDEDPREMIUMHISTORY_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GLCededPremiumHistory");
  ...
  private com.guidewire._generated.entity.GLCededPremiumTransactionInternal _internal;
   ...
   */
  public GLCededPremiumTransaction()  {
   ...
   */
  public GLCededPremiumTransaction(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GLCededPremiumTransaction(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GLCededPremiumTransactionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GLCededPremiumTransactionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GLCededPremium getGLCededPremium() {
    return (entity.GLCededPremium)__getInternalInterface().getFieldValue(GLCEDEDPREMIUM_PROP.get());
  }
  ...
  public entity.GLCededPremiumHistory getGLCededPremiumHistory() {
    return (entity.GLCededPremiumHistory)__getInternalInterface().getFieldValue(GLCEDEDPREMIUMHISTORY_PROP.get());
  }
  ...
  public void setGLCededPremium(entity.GLCededPremium value) {
    __getInternalInterface().setFieldValue(GLCEDEDPREMIUM_PROP.get(), value);
  }
  ...
  public void setGLCededPremiumHistory(entity.GLCededPremiumHistory value) {
    __getInternalInterface().setFieldValue(GLCEDEDPREMIUMHISTORY_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GLCededPremiumTransactionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GLCededPremiumTransaction.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getGLCededPremiumHistoryID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GLCEDEDPREMIUMHISTORY_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getGLCededPremiumID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GLCEDEDPREMIUM_PROP.get());
    }
    ...
    public void setGLCededPremiumHistoryID(gw.pl.persistence.core.Key value) {
      setFieldValue(GLCEDEDPREMIUMHISTORY_PROP.get(), value);
    }
    
    public void setGLCededPremiumID(gw.pl.persistence.core.Key value) {
      setFieldValue(GLCEDEDPREMIUM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.reinsurance.RICededPremiumTxnAdapter", "gw.reinsurance.ceding.GLCededPremiumTransactionAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GLCededPremiumTransaction.class, config);
    com.guidewire._generated.entity.GLCededPremiumTransactionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GLCededPremiumTransaction, com.guidewire._generated.entity.GLCededPremiumTransactionInternal>() {
      public java.lang.Object getImplementation(entity.GLCededPremiumTransaction bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GLCededPremiumTransactionInternal getInternalInterface(entity.GLCededPremiumTransaction bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GLCededPremiumTransaction newEmptyInstance() {
        return new entity.GLCededPremiumTransaction((java.lang.Void)null);
      }

...
/**
 * GLClassCode
 * General liability class codes.  Premium calculations are driven by class codes and both premium and losses are reported by class codes to rating bureaus.
 */
...
@gw.entity.EntityName(value = "GLClassCode")
public class GLClassCode extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GLClassCode> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GLClassCode>("entity.GLClassCode");
  ...
  private com.guidewire._generated.entity.GLClassCodeInternal _internal;
   ...
   */
  public GLClassCode(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GLClassCode(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GLClassCodeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GLClassCodeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GLClassCode_Classification_L10N[] getClassification_L10N_ARRAY() {
    return (entity.GLClassCode_Classification_L10N[])__getInternalInterface().getFieldValue(CLASSIFICATION_L10N_ARRAY_PROP.get());
  }
   ...
   */
  private void setClassification_L10N_ARRAY(entity.GLClassCode_Classification_L10N[] value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GLClassCodeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GLClassCode.this.__getDelegateManager();
    }
    ...
    public entity.GLClassCode_Classification_L10N getClassification_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.GLClassCode_Classification_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GLClassCode.class, config);
    com.guidewire._generated.entity.GLClassCodeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GLClassCode, com.guidewire._generated.entity.GLClassCodeInternal>() {
      public java.lang.Object getImplementation(entity.GLClassCode bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GLClassCodeInternal getInternalInterface(entity.GLClassCode bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GLClassCode newEmptyInstance() {
        return new entity.GLClassCode((java.lang.Void)null);
      }

...
/**
 * GLCost
 * A GeneralLiability unit of price for a period of time that should not be broken up any further.
 */
...
public abstract class GLCost extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GLCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GLCost, entity.PolicyPeriod>("entity.GLCost");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> SPLITTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "SplitType");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> SUBLINE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "Subline");
  ...
  private com.guidewire._generated.entity.GLCostInternal _internal;
  ...
  protected GLCost(java.lang.Void ignored)  {
    
  }
  
  protected abstract com.guidewire._generated.entity.GLCostInternal __createInternalInterface();
  ...
  protected com.guidewire._generated.entity.GLCostInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GLCost clone() {
    return (entity.GLCost)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GLCost getBasedOn() {
    return (entity.GLCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GLCost getSlice(java.util.Date sliceDate) {
    return (entity.GLCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GLCost getUnsliced() {
    return (entity.GLCost)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GLCostVersionList getVersionList() {
    return (entity.windowed.GLCostVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GLCost value) {
   ...
   */
  private void setFixed(entity.GLCost value) {
   ...
   */
  private void setSubtype(typekey.GLCost value) {
   ...
   */
  private void setTransactions(entity.GLTransaction[] value) {
  ...
  public entity.GLCost split(java.util.Date splitDate) {
    return (entity.GLCost)splitUntyped(splitDate);
  }
  ...
  static {
    com.guidewire._generated.entity.GLCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.EntityFriendAccess<entity.GLCost, com.guidewire._generated.entity.GLCostInternal>() {
      public java.lang.Object getImplementation(entity.GLCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GLCostInternal getInternalInterface(entity.GLCost bean) {
        if(bean == null) {
          return null;
        };

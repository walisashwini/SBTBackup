...
/**
 * GLCovExposureCost
 * The cost for a GeneralLiabilityCov on a particular GLExposure.
 */
...
@gw.entity.EntityName(value = "GLCovExposureCost")
public class GLCovExposureCost extends entity.GLCovCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GLCovExposureCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GLCovExposureCost, entity.PolicyPeriod>("entity.GLCovExposureCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GLEXPOSURE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GLExposure");
   ...
   */
  public GLCovExposureCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GLCovExposureCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GLCovExposureCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GLCovExposureCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GLCovExposureCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GLCovExposureCostInternal)super.__getInternalInterface();
  }
  
  public entity.GLCovExposureCost clone() {
    return (entity.GLCovExposureCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GLCovExposureCost getBasedOn() {
    return (entity.GLCovExposureCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GLExposure getGLExposure() {
    return (entity.GLExposure)__getInternalInterface().getFieldValue(GLEXPOSURE_PROP.get());
  }
  
  public entity.GLCovExposureCost getSlice(java.util.Date sliceDate) {
    return (entity.GLCovExposureCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GLCovExposureCost getUnsliced() {
    return (entity.GLCovExposureCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GLCovExposureCostVersionList getVersionList() {
    return (entity.windowed.GLCovExposureCostVersionList)getVersionListUntyped();
  }
  ...
  public void setGLExposure(entity.GLExposure value) {
    __getInternalInterface().setFieldValue(GLEXPOSURE_PROP.get(), value);
  }
  
  public entity.GLCovExposureCost split(java.util.Date splitDate) {
    return (entity.GLCovExposureCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GLCovExposureCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GLCovExposureCost.this.__getDelegateManager();
    }
    ...
    public entity.GLCost getBasedOnValue() {
      return (entity.GLCost)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public entity.GLCost getFixed() {
      return (entity.GLCost)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getGLExposureID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GLEXPOSURE_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getGeneralLiabilityCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GENERALLIABILITYCOV_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getGeneralLiabilityLineID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GENERALLIABILITYLINE_PROP.get());
    }
    ...
    public typekey.GLCostSplitType getSplitType() {
      return (typekey.GLCostSplitType)__getInternalInterface().getFieldValue(SPLITTYPE_PROP.get());
    }
    ...
    public typekey.GLCostSubline getSubline() {
      return (typekey.GLCostSubline)__getInternalInterface().getFieldValue(SUBLINE_PROP.get());
    }
    ...
    public typekey.GLCost getSubtype() {
      return (typekey.GLCost)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
    ...
    public entity.GLTransaction[] getTransactions() {
      return (entity.GLTransaction[])__getInternalInterface().getFieldValue(TRANSACTIONS_PROP.get());
    }
    ...
    public void setGLExposureID(gw.pl.persistence.core.Key value) {
      setFieldValue(GLEXPOSURE_PROP.get(), value);
    }
    ...
    public void setGeneralLiabilityCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(GENERALLIABILITYCOV_PROP.get(), value);
    }
    ...
    public void setGeneralLiabilityLineID(gw.pl.persistence.core.Key value) {
      setFieldValue(GENERALLIABILITYLINE_PROP.get(), value);
    }
    ...
    public void setSplitType(typekey.GLCostSplitType value) {
      __getInternalInterface().setFieldValue(SPLITTYPE_PROP.get(), value);
    }
    ...
    public void setSubline(typekey.GLCostSubline value) {
      __getInternalInterface().setFieldValue(SUBLINE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.financials.CostAdapter", "gw.lob.gl.financials.GLCostAdapter");
    config.put("gw.lob.gl.financials.GLCostMethods", "gw.lob.gl.financials.GLCovExposureCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GLCovExposureCost.class, config);
    com.guidewire._generated.entity.GLCovExposureCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GLCovExposureCost, com.guidewire._generated.entity.GLCovExposureCostInternal>() {
      public java.lang.Object getImplementation(entity.GLCovExposureCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GLCovExposureCostInternal getInternalInterface(entity.GLCovExposureCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GLCovExposureCost newEmptyInstance() {
        return new entity.GLCovExposureCost((java.lang.Void)null);
      }

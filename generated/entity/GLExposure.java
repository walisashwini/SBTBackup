...
/**
 * GLExposure
 * An exposure that can be covered.
 */
...
@gw.entity.EntityName(value = "GLExposure")
public class GLExposure extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GLExposure, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GLExposure, entity.PolicyPeriod>("entity.GLExposure");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ARCHIVEPARTITION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ArchivePartition");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> AUDITEDBASIS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AuditedBasis");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> CLASSCODEINTERNAL_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ClassCodeInternal");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> FIXEDBASISAMOUNT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "FixedBasisAmount");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> SCALABLEBASISAMOUNT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ScalableBasisAmount");
  ...
  private com.guidewire._generated.entity.GLExposureInternal _internal;
   ...
   */
  public GLExposure(entity.PolicyPeriod branch)  {
   ...
   */
  public GLExposure(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GLExposure(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GLExposureInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GLExposureInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GLExposure clone() {
    return (entity.GLExposure)__getInternalInterface().cloneUntyped();
  }
  ...
  public java.lang.Integer getAuditedBasis() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(AUDITEDBASIS_PROP.get());
  }
  
  public entity.GLExposure getBasedOn() {
    return (entity.GLExposure)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GLExposure getBasedOnValue() {
    return (entity.GLExposure)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GLClassCode getClassCodeInternal() {
    return (entity.GLClassCode)__getInternalInterface().getFieldValue(CLASSCODEINTERNAL_PROP.get());
  }
  ...
  public entity.GLCovExposureCost[] getCosts() {
    return (entity.GLCovExposureCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
  }
  ...
  public entity.GLExposure getFixed() {
    return (entity.GLExposure)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public java.lang.Integer getFixedBasisAmount() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(FIXEDBASISAMOUNT_PROP.get());
  }
  ...
  public java.lang.Integer getScalableBasisAmount() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(SCALABLEBASISAMOUNT_PROP.get());
  }
  
  public entity.GLExposure getSlice(java.util.Date sliceDate) {
    return (entity.GLExposure)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GLExposure getUnsliced() {
    return (entity.GLExposure)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GLExposureVersionList getVersionList() {
    return (entity.windowed.GLExposureVersionList)getVersionListUntyped();
  }
  ...
  public void setAuditedBasis(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(AUDITEDBASIS_PROP.get(), value);
  }
  
  /**
   * Sets the value of the BasedOnValue field.
   */
  private void setBasedOnValue(entity.GLExposure value) {
   ...
   */
  private void setClassCodeInternal(entity.GLClassCode value) {
    __getInternalInterface().setFieldValue(CLASSCODEINTERNAL_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.GLExposure value) {
  ...
  public void setFixedBasisAmount(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(FIXEDBASISAMOUNT_PROP.get(), value);
  }
  ...
  public void setScalableBasisAmount(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(SCALABLEBASISAMOUNT_PROP.get(), value);
  }
  ...
  public entity.GLExposure split(java.util.Date splitDate) {
    return (entity.GLExposure)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GLExposureInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GLExposure.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getClassCodeInternalID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(CLASSCODEINTERNAL_PROP.get());
    }
    ...
    public void setClassCodeInternalID(gw.pl.persistence.core.Key value) {
      setFieldValue(CLASSCODEINTERNAL_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GLExposure.class, config);
    com.guidewire._generated.entity.GLExposureInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GLExposure, com.guidewire._generated.entity.GLExposureInternal>() {
      public java.lang.Object getImplementation(entity.GLExposure bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GLExposureInternal getInternalInterface(entity.GLExposure bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GLExposure newEmptyInstance() {
        return new entity.GLExposure((java.lang.Void)null);
      }

...
/**
 * GLLineCovCost
 * Concrete subtype of GLCovCost representing costs for line-level coverages.
 */
...
@gw.entity.EntityName(value = "GLLineCovCost")
public class GLLineCovCost extends entity.GLCovCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GLLineCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GLLineCovCost, entity.PolicyPeriod>("entity.GLLineCovCost");
   ...
   */
  public GLLineCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GLLineCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GLLineCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GLLineCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GLLineCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GLLineCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.GLLineCovCost clone() {
    return (entity.GLLineCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GLLineCovCost getBasedOn() {
    return (entity.GLLineCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GLLineCovCost getSlice(java.util.Date sliceDate) {
    return (entity.GLLineCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.GLLineCovCost getUnsliced() {
    return (entity.GLLineCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GLLineCovCostVersionList getVersionList() {
    return (entity.windowed.GLLineCovCostVersionList)getVersionListUntyped();
  }
  
  public entity.GLLineCovCost split(java.util.Date splitDate) {
    return (entity.GLLineCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GLLineCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GLLineCovCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.gl.financials.GLCostMethods", "gw.lob.gl.financials.GLLineCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GLLineCovCost.class, config);
    com.guidewire._generated.entity.GLLineCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GLLineCovCost, com.guidewire._generated.entity.GLLineCovCostInternal>() {
      public java.lang.Object getImplementation(entity.GLLineCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GLLineCovCostInternal getInternalInterface(entity.GLLineCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GLLineCovCost newEmptyInstance() {
        return new entity.GLLineCovCost((java.lang.Void)null);
      }

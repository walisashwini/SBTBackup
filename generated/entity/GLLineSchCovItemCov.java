...
/**
 * GLLineSchCovItemCov
 * GL Line level coverage scheduled item with coverage terms
 */
...
@gw.entity.EntityName(value = "GLLineSchCovItemCov")
public class GLLineSchCovItemCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, entity.ScheduledItemClause {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GLLineSchCovItemCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GLLineSchCovItemCov, entity.PolicyPeriod>("entity.GLLineSchCovItemCov");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GLLINESCHEDULECOVITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GLLineScheduleCovItem");
  ...
  private com.guidewire._generated.entity.GLLineSchCovItemCovInternal _internal;
   ...
   */
  protected GLLineSchCovItemCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GLLineSchCovItemCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GLLineSchCovItemCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GLLineSchCovItemCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GLLineSchCovItemCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GLLineSchCovItemCov clone() {
    return (entity.GLLineSchCovItemCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GLLineSchCovItemCov getBasedOn() {
    return (entity.GLLineSchCovItemCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GLLineSchCovItemCov getBasedOnValue() {
    return (entity.GLLineSchCovItemCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GLLineSchCovItemCov getFixed() {
    return (entity.GLLineSchCovItemCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GLLineScheduleCovItem getGLLineScheduleCovItem() {
    return (entity.GLLineScheduleCovItem)__getInternalInterface().getFieldValue(GLLINESCHEDULECOVITEM_PROP.get());
  }
  ...
  public entity.GLLineSchCovItemCov getSlice(java.util.Date sliceDate) {
    return (entity.GLLineSchCovItemCov)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.GLLineSchCovItemCov getSubtype() {
    return (typekey.GLLineSchCovItemCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.GLLineSchCovItemCov getUnsliced() {
    return (entity.GLLineSchCovItemCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GLLineSchCovItemCovVersionList getVersionList() {
    return (entity.windowed.GLLineSchCovItemCovVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GLLineSchCovItemCov value) {
   ...
   */
  private void setFixed(entity.GLLineSchCovItemCov value) {
  ...
  public void setGLLineScheduleCovItem(entity.GLLineScheduleCovItem value) {
    __getInternalInterface().setFieldValue(GLLINESCHEDULECOVITEM_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.GLLineSchCovItemCov value) {
  ...
  public entity.GLLineSchCovItemCov split(java.util.Date splitDate) {
    return (entity.GLLineSchCovItemCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GLLineSchCovItemCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GLLineSchCovItemCov.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getGLLineScheduleCovItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GLLINESCHEDULECOVITEM_PROP.get());
    }
    ...
    public void setGLLineScheduleCovItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(GLLINESCHEDULECOVITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl.GLLineSchCovItemCovCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl.GLLineSchCovItemCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.gl.GLLineSchCovItemCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.gl.GLLineSchCovItemCovCoverageAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GLLineSchCovItemCov.class, config);
    com.guidewire._generated.entity.GLLineSchCovItemCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GLLineSchCovItemCov, com.guidewire._generated.entity.GLLineSchCovItemCovInternal>() {
      public java.lang.Object getImplementation(entity.GLLineSchCovItemCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GLLineSchCovItemCovInternal getInternalInterface(entity.GLLineSchCovItemCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GLLineSchCovItemCov newEmptyInstance() {
        return new entity.GLLineSchCovItemCov((java.lang.Void)null);
      }

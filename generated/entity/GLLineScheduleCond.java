...
/**
 * GLLineScheduleCond
 * GL Line Condition with a schedule
 */
...
@gw.entity.EntityName(value = "GLLineScheduleCond")
public class GLLineScheduleCond extends entity.GeneralLiabilityCond implements entity.ScheduleAutoNumberSequence, gw.api.domain.Schedule {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GLLineScheduleCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GLLineScheduleCond, entity.PolicyPeriod>("entity.GLLineScheduleCond");
   ...
   */
  protected GLLineScheduleCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GLLineScheduleCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GLLineScheduleCond(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GLLineScheduleCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GLLineScheduleCondInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GLLineScheduleCondInternal)super.__getInternalInterface();
  }
  ...
  public entity.GLLineScheduleCond clone() {
    return (entity.GLLineScheduleCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GLLineScheduleCond getBasedOn() {
    return (entity.GLLineScheduleCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GLLineScheduleCondItem[] getGLLineScheduledItems() {
    return (entity.GLLineScheduleCondItem[])__getInternalInterface().getFieldValue(GLLINESCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.GLLineScheduleCond getSlice(java.util.Date sliceDate) {
    return (entity.GLLineScheduleCond)getSliceUntyped(sliceDate);
  }
  
  public entity.GLLineScheduleCond getUnsliced() {
    return (entity.GLLineScheduleCond)getUnslicedUntyped();
  }
  
  public entity.windowed.GLLineScheduleCondVersionList getVersionList() {
    return (entity.windowed.GLLineScheduleCondVersionList)getVersionListUntyped();
  }
  ...
  public entity.GLLineScheduleCond split(java.util.Date splitDate) {
    return (entity.GLLineScheduleCond)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GLLineScheduleCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GLLineScheduleCond.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.Schedule", "gw.lob.gl.schedule.GLLineScheduleCondImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GLLineScheduleCond.class, config);
    com.guidewire._generated.entity.GLLineScheduleCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GLLineScheduleCond, com.guidewire._generated.entity.GLLineScheduleCondInternal>() {
      public java.lang.Object getImplementation(entity.GLLineScheduleCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GLLineScheduleCondInternal getInternalInterface(entity.GLLineScheduleCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GLLineScheduleCond newEmptyInstance() {
        return new entity.GLLineScheduleCond((java.lang.Void)null);
      }

...
/**
 * GLLineScheduleCondItem
 * GL Line level Condition scheduled item
 */
...
@gw.entity.EntityName(value = "GLLineScheduleCondItem")
public class GLLineScheduleCondItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.GLScheduledItem, entity.ScheduledItem, entity.Coverable {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GLLineScheduleCondItem, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GLLineScheduleCondItem, entity.PolicyPeriod>("entity.GLLineScheduleCondItem");
  ...
  private com.guidewire._generated.entity.GLLineScheduleCondItemInternal _internal;
   ...
   */
  public GLLineScheduleCondItem(entity.PolicyPeriod branch)  {
   ...
   */
  public GLLineScheduleCondItem(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GLLineScheduleCondItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GLLineScheduleCondItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GLLineScheduleCondItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GLLineScheduleCondItem clone() {
    return (entity.GLLineScheduleCondItem)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GLLineScheduleCondItem getBasedOn() {
    return (entity.GLLineScheduleCondItem)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GLLineScheduleCondItem getBasedOnValue() {
    return (entity.GLLineScheduleCondItem)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GLLineScheduleCondItem getFixed() {
    return (entity.GLLineScheduleCondItem)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GLLineScheduleCond getSchedule() {
    return (entity.GLLineScheduleCond)__getInternalInterface().getFieldValue(SCHEDULE_PROP.get());
  }
  ...
  public entity.GLLineScheduleCondItem getSlice(java.util.Date sliceDate) {
    return (entity.GLLineScheduleCondItem)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.GLLineScheduleCondItem getSubtype() {
    return (typekey.GLLineScheduleCondItem)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.GLLineScheduleCondItem getUnsliced() {
    return (entity.GLLineScheduleCondItem)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GLLineScheduleCondItemVersionList getVersionList() {
    return (entity.windowed.GLLineScheduleCondItemVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GLLineScheduleCondItem value) {
   ...
   */
  private void setFixed(entity.GLLineScheduleCondItem value) {
   ...
   */
  private void setSubtype(typekey.GLLineScheduleCondItem value) {
  ...
  public entity.GLLineScheduleCondItem split(java.util.Date splitDate) {
    return (entity.GLLineScheduleCondItem)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GLLineScheduleCondItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GLLineScheduleCondItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.gl.GLLineScheduleCondItemCoverableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.gl.GLLineScheduleCondItemCoverableAdapter");
    config.put("gw.api.productmodel.ScheduledItemAdapter", "gw.lob.gl.GLLineScheduleCondItemCoverableAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GLLineScheduleCondItem.class, config);
    com.guidewire._generated.entity.GLLineScheduleCondItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GLLineScheduleCondItem, com.guidewire._generated.entity.GLLineScheduleCondItemInternal>() {
      public java.lang.Object getImplementation(entity.GLLineScheduleCondItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GLLineScheduleCondItemInternal getInternalInterface(entity.GLLineScheduleCondItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GLLineScheduleCondItem newEmptyInstance() {
        return new entity.GLLineScheduleCondItem((java.lang.Void)null);
      }

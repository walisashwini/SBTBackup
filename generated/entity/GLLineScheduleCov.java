...
/**
 * GLLineScheduleCov
 * GL Line coverage with a schedule
 */
...
@gw.entity.EntityName(value = "GLLineScheduleCov")
public class GLLineScheduleCov extends entity.GeneralLiabilityCov implements entity.ScheduleAutoNumberSequence, gw.api.domain.Schedule {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GLLineScheduleCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GLLineScheduleCov, entity.PolicyPeriod>("entity.GLLineScheduleCov");
   ...
   */
  protected GLLineScheduleCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GLLineScheduleCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GLLineScheduleCov(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GLLineScheduleCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GLLineScheduleCovInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GLLineScheduleCovInternal)super.__getInternalInterface();
  }
  ...
  public entity.GLLineScheduleCov clone() {
    return (entity.GLLineScheduleCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GLLineScheduleCov getBasedOn() {
    return (entity.GLLineScheduleCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GLLineScheduleCovItem[] getGLLineScheduledItems() {
    return (entity.GLLineScheduleCovItem[])__getInternalInterface().getFieldValue(GLLINESCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.GLLineScheduleCov getSlice(java.util.Date sliceDate) {
    return (entity.GLLineScheduleCov)getSliceUntyped(sliceDate);
  }
  
  public entity.GLLineScheduleCov getUnsliced() {
    return (entity.GLLineScheduleCov)getUnslicedUntyped();
  }
  
  public entity.windowed.GLLineScheduleCovVersionList getVersionList() {
    return (entity.windowed.GLLineScheduleCovVersionList)getVersionListUntyped();
  }
  ...
  public entity.GLLineScheduleCov split(java.util.Date splitDate) {
    return (entity.GLLineScheduleCov)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GLLineScheduleCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GLLineScheduleCov.this.__getDelegateManager();
    }
    ...
    public entity.GeneralLiabilityCov getBasedOnValue() {
      return (entity.GeneralLiabilityCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public entity.GLCovCost[] getCosts() {
      return (entity.GLCovCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
    }
    ...
    public entity.GeneralLiabilityCov getFixed() {
      return (entity.GeneralLiabilityCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public typekey.GeneralLiabilityCov getSubtype() {
      return (typekey.GeneralLiabilityCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl.GeneralLiabilityCovCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl.GeneralLiabilityCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.gl.GeneralLiabilityCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.gl.GeneralLiabilityCovCoverageAdapter");
    config.put("gw.api.domain.Schedule", "gw.lob.gl.schedule.GLLineScheduleCovImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl.GeneralLiabilityCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl.GeneralLiabilityCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GLLineScheduleCov.class, config);
    com.guidewire._generated.entity.GLLineScheduleCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GLLineScheduleCov, com.guidewire._generated.entity.GLLineScheduleCovInternal>() {
      public java.lang.Object getImplementation(entity.GLLineScheduleCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GLLineScheduleCovInternal getInternalInterface(entity.GLLineScheduleCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GLLineScheduleCov newEmptyInstance() {
        return new entity.GLLineScheduleCov((java.lang.Void)null);
      }

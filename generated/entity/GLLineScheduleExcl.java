...
/**
 * GLLineScheduleExcl
 * GL Line exclusion with a schedule
 */
...
@gw.entity.EntityName(value = "GLLineScheduleExcl")
public class GLLineScheduleExcl extends entity.GeneralLiabilityExcl implements entity.ScheduleAutoNumberSequence, gw.api.domain.Schedule {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GLLineScheduleExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GLLineScheduleExcl, entity.PolicyPeriod>("entity.GLLineScheduleExcl");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> GLLINESCHEDULEDITEMS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "GLLineScheduledItems");
   ...
   */
  protected GLLineScheduleExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GLLineScheduleExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GLLineScheduleExcl(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GLLineScheduleExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GLLineScheduleExclInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GLLineScheduleExclInternal)super.__getInternalInterface();
  }
  ...
  public void addToGLLineScheduledItems(entity.GLLineScheduleExclItem element) {
    __getInternalInterface().addArrayElement(GLLINESCHEDULEDITEMS_PROP.get(), element);
  }
  ...
  public entity.GLLineScheduleExcl clone() {
    return (entity.GLLineScheduleExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GLLineScheduleExcl getBasedOn() {
    return (entity.GLLineScheduleExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GLLineScheduleExclItem[] getGLLineScheduledItems() {
    return (entity.GLLineScheduleExclItem[])__getInternalInterface().getFieldValue(GLLINESCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.GLLineScheduleExcl getSlice(java.util.Date sliceDate) {
    return (entity.GLLineScheduleExcl)getSliceUntyped(sliceDate);
  }
  
  public entity.GLLineScheduleExcl getUnsliced() {
    return (entity.GLLineScheduleExcl)getUnslicedUntyped();
  }
  
  public entity.windowed.GLLineScheduleExclVersionList getVersionList() {
    return (entity.windowed.GLLineScheduleExclVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromGLLineScheduledItems(entity.GLLineScheduleExclItem element) {
    __getInternalInterface().removeArrayElement(GLLINESCHEDULEDITEMS_PROP.get(), element);
  }
  ...
  public void removeFromGLLineScheduledItems(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(GLLINESCHEDULEDITEMS_PROP.get(), elementID);
  }
  ...
  public void setGLLineScheduledItems(entity.GLLineScheduleExclItem[] value) {
    __getInternalInterface().setFieldValue(GLLINESCHEDULEDITEMS_PROP.get(), value);
  }
  ...
  public entity.GLLineScheduleExcl split(java.util.Date splitDate) {
    return (entity.GLLineScheduleExcl)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GLLineScheduleExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GLLineScheduleExcl.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.Schedule", "gw.lob.gl.schedule.GLLineScheduleExclImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GLLineScheduleExcl.class, config);
    com.guidewire._generated.entity.GLLineScheduleExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GLLineScheduleExcl, com.guidewire._generated.entity.GLLineScheduleExclInternal>() {
      public java.lang.Object getImplementation(entity.GLLineScheduleExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GLLineScheduleExclInternal getInternalInterface(entity.GLLineScheduleExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GLLineScheduleExcl newEmptyInstance() {
        return new entity.GLLineScheduleExcl((java.lang.Void)null);
      }

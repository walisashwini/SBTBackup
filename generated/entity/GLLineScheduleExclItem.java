...
/**
 * GLLineScheduleExclItem
 * GL Line level exclusion scheduled item
 */
...
@gw.entity.EntityName(value = "GLLineScheduleExclItem")
public class GLLineScheduleExclItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.GLScheduledItem, entity.ScheduledItem, entity.Coverable {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GLLineScheduleExclItem, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GLLineScheduleExclItem, entity.PolicyPeriod>("entity.GLLineScheduleExclItem");
  ...
  private com.guidewire._generated.entity.GLLineScheduleExclItemInternal _internal;
   ...
   */
  public GLLineScheduleExclItem(entity.PolicyPeriod branch)  {
   ...
   */
  public GLLineScheduleExclItem(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GLLineScheduleExclItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GLLineScheduleExclItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GLLineScheduleExclItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GLLineScheduleExclItem clone() {
    return (entity.GLLineScheduleExclItem)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GLLineScheduleExclItem getBasedOn() {
    return (entity.GLLineScheduleExclItem)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GLLineScheduleExclItem getBasedOnValue() {
    return (entity.GLLineScheduleExclItem)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GLLineScheduleExclItem getFixed() {
    return (entity.GLLineScheduleExclItem)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GLLineScheduleExcl getSchedule() {
    return (entity.GLLineScheduleExcl)__getInternalInterface().getFieldValue(SCHEDULE_PROP.get());
  }
  ...
  public entity.GLLineScheduleExclItem getSlice(java.util.Date sliceDate) {
    return (entity.GLLineScheduleExclItem)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.GLLineScheduleExclItem getSubtype() {
    return (typekey.GLLineScheduleExclItem)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.GLLineScheduleExclItem getUnsliced() {
    return (entity.GLLineScheduleExclItem)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GLLineScheduleExclItemVersionList getVersionList() {
    return (entity.windowed.GLLineScheduleExclItemVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GLLineScheduleExclItem value) {
   ...
   */
  private void setFixed(entity.GLLineScheduleExclItem value) {
   ...
   */
  public void setSchedule(entity.GLLineScheduleExcl value) {
   ...
   */
  private void setSubtype(typekey.GLLineScheduleExclItem value) {
  ...
  public entity.GLLineScheduleExclItem split(java.util.Date splitDate) {
    return (entity.GLLineScheduleExclItem)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GLLineScheduleExclItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GLLineScheduleExclItem.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.GLLineScheduleExclItem value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.GLLineScheduleExclItem value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.GLLineScheduleExclItem value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.gl.GLLineScheduleExclItemCoverableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.gl.GLLineScheduleExclItemCoverableAdapter");
    config.put("gw.api.productmodel.ScheduledItemAdapter", "gw.lob.gl.GLLineScheduleExclItemCoverableAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GLLineScheduleExclItem.class, config);
    com.guidewire._generated.entity.GLLineScheduleExclItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GLLineScheduleExclItem, com.guidewire._generated.entity.GLLineScheduleExclItemInternal>() {
      public java.lang.Object getImplementation(entity.GLLineScheduleExclItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GLLineScheduleExclItemInternal getInternalInterface(entity.GLLineScheduleExclItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GLLineScheduleExclItem newEmptyInstance() {
        return new entity.GLLineScheduleExclItem((java.lang.Void)null);
      }

...
/**
 * GLModifier
 * A line-level modifier for General Liability
 */
...
@gw.entity.EntityName(value = "GLModifier")
public class GLModifier extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Modifier, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GLModifier, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GLModifier, entity.PolicyPeriod>("entity.GLModifier");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> GLRATEFACTORS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "GLRateFactors");
  ...
  private com.guidewire._generated.entity.GLModifierInternal _internal;
   ...
   */
  public GLModifier(entity.PolicyPeriod branch)  {
   ...
   */
  public GLModifier(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GLModifier(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GLModifierInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GLModifierInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToGLRateFactors(entity.GLRateFactor element) {
    __getInternalInterface().addArrayElement(GLRATEFACTORS_PROP.get(), element);
  }
  ...
  public entity.GLModifier clone() {
    return (entity.GLModifier)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GLModifier getBasedOn() {
    return (entity.GLModifier)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GLModifier getBasedOnValue() {
    return (entity.GLModifier)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GLModifier getFixed() {
    return (entity.GLModifier)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GLRateFactor[] getGLRateFactors() {
    return (entity.GLRateFactor[])__getInternalInterface().getFieldValue(GLRATEFACTORS_PROP.get());
  }
  ...
  public entity.GLModifier getSlice(java.util.Date sliceDate) {
    return (entity.GLModifier)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.GLModifier getSubtype() {
    return (typekey.GLModifier)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.GLModifier getUnsliced() {
    return (entity.GLModifier)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GLModifierVersionList getVersionList() {
    return (entity.windowed.GLModifierVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromGLRateFactors(entity.GLRateFactor element) {
    __getInternalInterface().removeArrayElement(GLRATEFACTORS_PROP.get(), element);
  }
  ...
  public void removeFromGLRateFactors(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(GLRATEFACTORS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.GLModifier value) {
   ...
   */
  private void setFixed(entity.GLModifier value) {
  ...
  public void setGLRateFactors(entity.GLRateFactor[] value) {
    __getInternalInterface().setFieldValue(GLRATEFACTORS_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.GLModifier value) {
  ...
  public entity.GLModifier split(java.util.Date splitDate) {
    return (entity.GLModifier)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GLModifierInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GLModifier.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ModifierAbstractDomainMethods", "gw.lob.gl.GLModifierAdapter");
    config.put("gw.api.domain.ModifierAdapter", "gw.lob.gl.GLModifierAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl.GLModifierMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl.GLModifierMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GLModifier.class, config);
    com.guidewire._generated.entity.GLModifierInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GLModifier, com.guidewire._generated.entity.GLModifierInternal>() {
      public java.lang.Object getImplementation(entity.GLModifier bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GLModifierInternal getInternalInterface(entity.GLModifier bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GLModifier newEmptyInstance() {
        return new entity.GLModifier((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "GLRateFactor")
public class GLRateFactor extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.RateFactor, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GLRateFactor, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GLRateFactor, entity.PolicyPeriod>("entity.GLRateFactor");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GLMODIFIER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GLModifier");
  ...
  private com.guidewire._generated.entity.GLRateFactorInternal _internal;
   ...
   */
  public GLRateFactor(entity.PolicyPeriod branch)  {
   ...
   */
  public GLRateFactor(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GLRateFactor(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GLRateFactorInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GLRateFactorInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GLRateFactor clone() {
    return (entity.GLRateFactor)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GLRateFactor getBasedOn() {
    return (entity.GLRateFactor)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GLRateFactor getBasedOnValue() {
    return (entity.GLRateFactor)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GLRateFactor getFixed() {
    return (entity.GLRateFactor)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  /**
   * Gets the value of the GLModifier field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GLModifier getGLModifier() {
    return (entity.GLModifier)__getInternalInterface().getFieldValue(GLMODIFIER_PROP.get());
  }
  ...
  public entity.GLRateFactor getSlice(java.util.Date sliceDate) {
    return (entity.GLRateFactor)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GLRateFactor getUnsliced() {
    return (entity.GLRateFactor)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GLRateFactorVersionList getVersionList() {
    return (entity.windowed.GLRateFactorVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GLRateFactor value) {
   ...
   */
  private void setFixed(entity.GLRateFactor value) {
  ...
  /**
   * Sets the value of the GLModifier field.
   */
  public void setGLModifier(entity.GLModifier value) {
    __getInternalInterface().setFieldValue(GLMODIFIER_PROP.get(), value);
  }
  ...
  public entity.GLRateFactor split(java.util.Date splitDate) {
    return (entity.GLRateFactor)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GLRateFactorInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GLRateFactor.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getGLModifierID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GLMODIFIER_PROP.get());
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.GLRateFactor value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.GLRateFactor value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
    ...
    public void setGLModifierID(gw.pl.persistence.core.Key value) {
      setFieldValue(GLMODIFIER_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.RateFactorAdapter", "gw.lob.gl.GLRateFactorAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl.GLRateFactorMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl.GLRateFactorMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GLRateFactor.class, config);
    com.guidewire._generated.entity.GLRateFactorInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GLRateFactor, com.guidewire._generated.entity.GLRateFactorInternal>() {
      public java.lang.Object getImplementation(entity.GLRateFactor bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GLRateFactorInternal getInternalInterface(entity.GLRateFactor bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GLRateFactor newEmptyInstance() {
        return new entity.GLRateFactor((java.lang.Void)null);
      }

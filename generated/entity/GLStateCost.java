...
/**
 * GLStateCost
 * A cost that is attached to a specific state.
 */
...
@gw.entity.EntityName(value = "GLStateCost")
public class GLStateCost extends entity.GLCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GLStateCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GLStateCost, entity.PolicyPeriod>("entity.GLStateCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> GLSTATE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "GLState");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> STATECOSTTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "StateCostType");
   ...
   */
  public GLStateCost(entity.PolicyPeriod branch)  {
   ...
   */
  public GLStateCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GLStateCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GLStateCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GLStateCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GLStateCostInternal)super.__getInternalInterface();
  }
  
  public entity.GLStateCost clone() {
    return (entity.GLStateCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.GLStateCost getBasedOn() {
    return (entity.GLStateCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public typekey.Jurisdiction getGLState() {
    return (typekey.Jurisdiction)__getInternalInterface().getFieldValue(GLSTATE_PROP.get());
  }
  
  public entity.GLStateCost getSlice(java.util.Date sliceDate) {
    return (entity.GLStateCost)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.GLStateCostType getStateCostType() {
    return (typekey.GLStateCostType)__getInternalInterface().getFieldValue(STATECOSTTYPE_PROP.get());
  }
  
  public entity.GLStateCost getUnsliced() {
    return (entity.GLStateCost)getUnslicedUntyped();
  }
  
  public entity.windowed.GLStateCostVersionList getVersionList() {
    return (entity.windowed.GLStateCostVersionList)getVersionListUntyped();
  }
  ...
  public void setGLState(typekey.Jurisdiction value) {
    __getInternalInterface().setFieldValue(GLSTATE_PROP.get(), value);
  }
  ...
  public void setStateCostType(typekey.GLStateCostType value) {
    __getInternalInterface().setFieldValue(STATECOSTTYPE_PROP.get(), value);
  }
  
  public entity.GLStateCost split(java.util.Date splitDate) {
    return (entity.GLStateCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GLStateCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GLStateCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.gl.financials.GLCostMethods", "gw.lob.gl.financials.GLStateCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GLStateCost.class, config);
    com.guidewire._generated.entity.GLStateCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GLStateCost, com.guidewire._generated.entity.GLStateCostInternal>() {
      public java.lang.Object getImplementation(entity.GLStateCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GLStateCostInternal getInternalInterface(entity.GLStateCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GLStateCost newEmptyInstance() {
        return new entity.GLStateCost((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "GLTransaction")
public class GLTransaction extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Transaction {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GLTransaction, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GLTransaction, entity.PolicyPeriod>("entity.GLTransaction");
  ...
  private com.guidewire._generated.entity.GLTransactionInternal _internal;
   ...
   */
  public GLTransaction(entity.PolicyPeriod branch)  {
   ...
   */
  public GLTransaction(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected GLTransaction(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GLTransactionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GLTransactionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GLTransaction clone() {
    return (entity.GLTransaction)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GLTransaction getBasedOn() {
    return (entity.GLTransaction)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GLTransaction getBasedOnValue() {
    return (entity.GLTransaction)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GLTransaction getFixed() {
    return (entity.GLTransaction)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GLTransaction getSlice(java.util.Date sliceDate) {
    return (entity.GLTransaction)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GLTransaction getUnsliced() {
    return (entity.GLTransaction)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GLTransactionVersionList getVersionList() {
    return (entity.windowed.GLTransactionVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GLTransaction value) {
   ...
   */
  private void setFixed(entity.GLTransaction value) {
  ...
  public entity.GLTransaction split(java.util.Date splitDate) {
    return (entity.GLTransaction)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GLTransactionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GLTransaction.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.GLTransaction value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.GLTransaction value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.financials.TransactionAdapter", "gw.lob.gl.financials.GLTransactionAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GLTransaction.class, config);
    com.guidewire._generated.entity.GLTransactionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GLTransaction, com.guidewire._generated.entity.GLTransactionInternal>() {
      public java.lang.Object getImplementation(entity.GLTransaction bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GLTransactionInternal getInternalInterface(entity.GLTransaction bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GLTransaction newEmptyInstance() {
        return new entity.GLTransaction((java.lang.Void)null);
      }

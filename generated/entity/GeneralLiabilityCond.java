 ...
 * A line-level condition for General Liability
 */
...
@gw.entity.EntityName(value = "GeneralLiabilityCond")
public class GeneralLiabilityCond extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PolicyCondition, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GeneralLiabilityCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GeneralLiabilityCond, entity.PolicyPeriod>("entity.GeneralLiabilityCond");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> STRINGTERM5_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "StringTerm5");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> STRINGTERM5AVL_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "StringTerm5Avl");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> STRINGTERM6_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "StringTerm6");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> STRINGTERM6AVL_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "StringTerm6Avl");
  ...
  private com.guidewire._generated.entity.GeneralLiabilityCondInternal _internal;
   ...
   */
  protected GeneralLiabilityCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GeneralLiabilityCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GeneralLiabilityCond(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GeneralLiabilityCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GeneralLiabilityCondInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GeneralLiabilityCond clone() {
    return (entity.GeneralLiabilityCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GeneralLiabilityCond getBasedOn() {
    return (entity.GeneralLiabilityCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GeneralLiabilityCond getBasedOnValue() {
    return (entity.GeneralLiabilityCond)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.GeneralLiabilityCond getFixed() {
    return (entity.GeneralLiabilityCond)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GeneralLiabilityCond getSlice(java.util.Date sliceDate) {
    return (entity.GeneralLiabilityCond)getSliceUntyped(sliceDate);
  }
  ...
  public java.lang.String getStringTerm5() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(STRINGTERM5_PROP.get());
  }
  ...
  public java.lang.String getStringTerm6() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(STRINGTERM6_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.GeneralLiabilityCond getSubtype() {
    return (typekey.GeneralLiabilityCond)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.GeneralLiabilityCond getUnsliced() {
    return (entity.GeneralLiabilityCond)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GeneralLiabilityCondVersionList getVersionList() {
    return (entity.windowed.GeneralLiabilityCondVersionList)getVersionListUntyped();
  }
  ...
  public java.lang.Boolean isStringTerm5Avl() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(STRINGTERM5AVL_PROP.get());
  }
  ...
  public java.lang.Boolean isStringTerm6Avl() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(STRINGTERM6AVL_PROP.get());
  }
   ...
   */
  private void setBasedOnValue(entity.GeneralLiabilityCond value) {
   ...
   */
  private void setFixed(entity.GeneralLiabilityCond value) {
   ...
   */
  private void setStringTerm5(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(STRINGTERM5_PROP.get(), value);
  }
  
  /**
   * Sets the value of the StringTerm5Avl field.
   */
  private void setStringTerm5Avl(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(STRINGTERM5AVL_PROP.get(), value);
  }
  
  /**
   * Sets the value of the StringTerm6 field.
   */
  private void setStringTerm6(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(STRINGTERM6_PROP.get(), value);
  }
  
  /**
   * Sets the value of the StringTerm6Avl field.
   */
  private void setStringTerm6Avl(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(STRINGTERM6AVL_PROP.get(), value);
  }
  
  /**
   * Sets the value of the Subtype field.
   */
  private void setSubtype(typekey.GeneralLiabilityCond value) {
  ...
  public entity.GeneralLiabilityCond split(java.util.Date splitDate) {
    return (entity.GeneralLiabilityCond)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GeneralLiabilityCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GeneralLiabilityCond.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.GeneralLiabilityCond value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.GeneralLiabilityCond value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.GeneralLiabilityCond value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl.GeneralLiabilityCondConditionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl.GeneralLiabilityCondConditionAdapter");
    config.put("gw.api.domain.PolicyConditionAdapter", "gw.lob.gl.GeneralLiabilityCondConditionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl.GeneralLiabilityCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl.GeneralLiabilityCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GeneralLiabilityCond.class, config);
    com.guidewire._generated.entity.GeneralLiabilityCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GeneralLiabilityCond, com.guidewire._generated.entity.GeneralLiabilityCondInternal>() {
      public java.lang.Object getImplementation(entity.GeneralLiabilityCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GeneralLiabilityCondInternal getInternalInterface(entity.GeneralLiabilityCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GeneralLiabilityCond newEmptyInstance() {
        return new entity.GeneralLiabilityCond((java.lang.Void)null);
      }

...
/**
 * GeneralLiabilityCov
 * A line-level coverage for General Liability
 */
...
@gw.entity.EntityName(value = "GeneralLiabilityCov")
public class GeneralLiabilityCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GeneralLiabilityCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GeneralLiabilityCov, entity.PolicyPeriod>("entity.GeneralLiabilityCov");
  ...
  private com.guidewire._generated.entity.GeneralLiabilityCovInternal _internal;
   ...
   */
  protected GeneralLiabilityCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GeneralLiabilityCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GeneralLiabilityCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GeneralLiabilityCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GeneralLiabilityCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GeneralLiabilityCov clone() {
    return (entity.GeneralLiabilityCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GeneralLiabilityCov getBasedOn() {
    return (entity.GeneralLiabilityCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GeneralLiabilityCov getSlice(java.util.Date sliceDate) {
    return (entity.GeneralLiabilityCov)getSliceUntyped(sliceDate);
  }
  ...
  public entity.GeneralLiabilityCov getUnsliced() {
    return (entity.GeneralLiabilityCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GeneralLiabilityCovVersionList getVersionList() {
    return (entity.windowed.GeneralLiabilityCovVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.GeneralLiabilityCov value) {
   ...
   */
  private void setFixed(entity.GeneralLiabilityCov value) {
   ...
   */
  private void setSubtype(typekey.GeneralLiabilityCov value) {
  ...
  public entity.GeneralLiabilityCov split(java.util.Date splitDate) {
    return (entity.GeneralLiabilityCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GeneralLiabilityCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GeneralLiabilityCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GeneralLiabilityCov.class, config);
    com.guidewire._generated.entity.GeneralLiabilityCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GeneralLiabilityCov, com.guidewire._generated.entity.GeneralLiabilityCovInternal>() {
      public java.lang.Object getImplementation(entity.GeneralLiabilityCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GeneralLiabilityCovInternal getInternalInterface(entity.GeneralLiabilityCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GeneralLiabilityCov newEmptyInstance() {
        return new entity.GeneralLiabilityCov((java.lang.Void)null);
      }

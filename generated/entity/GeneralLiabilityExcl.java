 ...
 * A line-level exclusion for General Liability
 */
...
@gw.entity.EntityName(value = "GeneralLiabilityExcl")
public class GeneralLiabilityExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GeneralLiabilityExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GeneralLiabilityExcl, entity.PolicyPeriod>("entity.GeneralLiabilityExcl");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DATETERM2_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DateTerm2");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DATETERM2AVL_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DateTerm2Avl");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GLLINE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GLLine");
  ...
  private com.guidewire._generated.entity.GeneralLiabilityExclInternal _internal;
   ...
   */
  protected GeneralLiabilityExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GeneralLiabilityExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GeneralLiabilityExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GeneralLiabilityExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GeneralLiabilityExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GeneralLiabilityExcl clone() {
    return (entity.GeneralLiabilityExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.Exclusion copyExclusion() {
    return ((com.guidewire.pc.domain.coverage.ExclusionPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.coverage.ExclusionPublicMethods")).copyExclusion();
  }
  ...
  public entity.GeneralLiabilityExcl getBasedOn() {
    return (entity.GeneralLiabilityExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.GeneralLiabilityExcl getBasedOnValue() {
    return (entity.GeneralLiabilityExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.GeneralLiabilityExcl getFixed() {
    return (entity.GeneralLiabilityExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.GeneralLiabilityLine getGLLine() {
    return (entity.GeneralLiabilityLine)__getInternalInterface().getFieldValue(GLLINE_PROP.get());
  }
  ...
  public entity.GeneralLiabilityExcl getSlice(java.util.Date sliceDate) {
    return (entity.GeneralLiabilityExcl)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.GeneralLiabilityExcl getSubtype() {
    return (typekey.GeneralLiabilityExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.GeneralLiabilityExcl getUnsliced() {
    return (entity.GeneralLiabilityExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.GeneralLiabilityExclVersionList getVersionList() {
    return (entity.windowed.GeneralLiabilityExclVersionList)getVersionListUntyped();
  }
  ...
  public boolean isCovTermChangedFromBasedOn(gw.api.productmodel.CovTermPattern pattern) {
    return ((com.guidewire.pc.domain.coverage.ExclusionPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.coverage.ExclusionPublicMethods")).isCovTermChangedFromBasedOn(pattern);
  }
   ...
   */
  private void setBasedOnValue(entity.GeneralLiabilityExcl value) {
   ...
   */
  private void setDateTerm2(java.util.Date value) {
   ...
   */
  private void setDateTerm2Avl(java.lang.Boolean value) {
   ...
   */
  private void setFixed(entity.GeneralLiabilityExcl value) {
  ...
  public void setGLLine(entity.GeneralLiabilityLine value) {
    __getInternalInterface().setFieldValue(GLLINE_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.GeneralLiabilityExcl value) {
  ...
  public entity.GeneralLiabilityExcl split(java.util.Date splitDate) {
    return (entity.GeneralLiabilityExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GeneralLiabilityExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GeneralLiabilityExcl.this.__getDelegateManager();
    }
    ...
    public void addToExclusionArray(entity.Exclusion exclusion) {
      ((gw.api.domain.ExclusionAdapter)__getDelegateManager().getImplementation("gw.api.domain.ExclusionAdapter")).addToExclusionArray(exclusion);
    }
    ...
    public java.util.List<? extends gw.api.web.productmodel.ProductModelSyncIssue> checkCovTermsAgainstProductModel(com.guidewire.pc.domain.productmodel.CovTermAvailabilityContext ctx) {
      return ((com.guidewire.pc.domain.coverage.impl.ExclusionInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.coverage.impl.ExclusionInternalMethods")).checkCovTermsAgainstProductModel(ctx);
    }
    ...
    public java.util.List<? extends gw.api.web.productmodel.ProductModelSyncIssue> checkCovTermsAgainstProductModelwLine(com.guidewire.pc.domain.productmodel.CovTermAvailabilityContext ctx, entity.PolicyLine policyLine, boolean fixIssue) {
      return ((com.guidewire.pc.domain.coverage.impl.ExclusionInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.coverage.impl.ExclusionInternalMethods")).checkCovTermsAgainstProductModelwLine(ctx, policyLine, fixIssue);
    }
    ...
    public void fireInitializeEvent() {
      ((com.guidewire.pc.domain.coverage.impl.ExclusionInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.coverage.impl.ExclusionInternalMethods")).fireInitializeEvent();
    }
    
    public void fireRemovalEvent() {
      ((com.guidewire.pc.domain.coverage.impl.ExclusionInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.coverage.impl.ExclusionInternalMethods")).fireRemovalEvent();
    }
    ...
    public gw.pl.persistence.core.Key getGLLineID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GLLINE_PROP.get());
    }
    ...
    public gw.lang.reflect.IType getProductModelType() {
      return ((com.guidewire.pc.domain.coverage.impl.ExclusionInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.coverage.impl.ExclusionInternalMethods")).getProductModelType();
    }
    ...
    public entity.Exclusion getSlice(java.util.Date sliceDate) {
      return ((gw.api.domain.ExclusionAdapter)__getDelegateManager().getImplementation("gw.api.domain.ExclusionAdapter")).getSlice(sliceDate);
    }
    ...
    public void setGLLineID(gw.pl.persistence.core.Key value) {
      setFieldValue(GLLINE_PROP.get(), value);
    }
    ...
    public void syncCovTermsWithProductModel(com.guidewire.pc.domain.productmodel.CovTermAvailabilityContext ctx) {
      ((com.guidewire.pc.domain.coverage.impl.ExclusionInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.coverage.impl.ExclusionInternalMethods")).syncCovTermsWithProductModel(ctx);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.coverage.ExclusionPublicMethods", "com.guidewire.pc.domain.coverage.impl.ExclusionImpl");
    config.put("com.guidewire.pc.domain.coverage.impl.ClauseInternal", "com.guidewire.pc.domain.coverage.impl.ExclusionImpl");
    config.put("com.guidewire.pc.domain.coverage.impl.ExclusionInternalMethods", "com.guidewire.pc.domain.coverage.impl.ExclusionImpl");
    ...
    config.put("gw.api.domain.Clause", "com.guidewire.pc.domain.coverage.impl.ExclusionImpl");
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.gl.GeneralLiabilityExclExclusionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.gl.GeneralLiabilityExclExclusionAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.gl.GeneralLiabilityExclExclusionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.gl.GeneralLiabilityExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.gl.GeneralLiabilityExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GeneralLiabilityExcl.class, config);
    com.guidewire._generated.entity.GeneralLiabilityExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GeneralLiabilityExcl, com.guidewire._generated.entity.GeneralLiabilityExclInternal>() {
      public java.lang.Object getImplementation(entity.GeneralLiabilityExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GeneralLiabilityExclInternal getInternalInterface(entity.GeneralLiabilityExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GeneralLiabilityExcl newEmptyInstance() {
        return new entity.GeneralLiabilityExcl((java.lang.Void)null);
      }

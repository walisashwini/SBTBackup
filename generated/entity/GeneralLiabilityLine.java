...
@gw.entity.EntityName(value = "GeneralLiabilityLine")
public class GeneralLiabilityLine extends entity.PolicyLine implements entity.Coverable, entity.Modifiable, gw.api.copier.EffDatedCopyable, gw.api.policy.PolicyLineJavaMethods {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.GeneralLiabilityLine, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.GeneralLiabilityLine, entity.PolicyPeriod>("entity.GeneralLiabilityLine");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CLAIMSMADEORIGEFFDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ClaimsMadeOrigEffDate");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> GLCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "GLCosts");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> GLCOVERAGEFORM_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "GLCoverageForm");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> GLLINECONDITIONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "GLLineConditions");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> GLLINECOVERAGES_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "GLLineCoverages");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> GLLINEEXCLUSIONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "GLLineExclusions");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> GLMODIFIERS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "GLModifiers");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LOCATIONLIMITS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LocationLimits");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> POLLUTIONCLEANUPEXP_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PollutionCleanupExp");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> SPLITLIMITS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "SplitLimits");
   ...
   */
  protected GeneralLiabilityLine(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected GeneralLiabilityLine(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected GeneralLiabilityLine(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GeneralLiabilityLineInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GeneralLiabilityLineInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GeneralLiabilityLineInternal)super.__getInternalInterface();
  }
  ...
  public void addToGLCosts(entity.GLCost element) {
    __getInternalInterface().addArrayElement(GLCOSTS_PROP.get(), element);
  }
  ...
  public void addToGLLineConditions(entity.GeneralLiabilityCond element) {
    __getInternalInterface().addArrayElement(GLLINECONDITIONS_PROP.get(), element);
  }
  ...
  public void addToGLLineCoverages(entity.GeneralLiabilityCov element) {
    __getInternalInterface().addArrayElement(GLLINECOVERAGES_PROP.get(), element);
  }
  ...
  public void addToGLLineExclusions(entity.GeneralLiabilityExcl element) {
    __getInternalInterface().addArrayElement(GLLINEEXCLUSIONS_PROP.get(), element);
  }
  ...
  public void addToGLModifiers(entity.GLModifier element) {
    __getInternalInterface().addArrayElement(GLMODIFIERS_PROP.get(), element);
  }
  ...
  public entity.GeneralLiabilityLine clone() {
    return (entity.GeneralLiabilityLine)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.GeneralLiabilityLine getBasedOn() {
    return (entity.GeneralLiabilityLine)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public java.util.Date getClaimsMadeOrigEffDate() {
    return (java.util.Date)__getInternalInterface().getFieldValue(CLAIMSMADEORIGEFFDATE_PROP.get());
  }
  ...
  public entity.GLExposure[] getExposures() {
    return (entity.GLExposure[])__getInternalInterface().getFieldValue(EXPOSURES_PROP.get());
  }
  ...
  public entity.GLCost[] getGLCosts() {
    return (entity.GLCost[])__getInternalInterface().getFieldValue(GLCOSTS_PROP.get());
  }
  ...
  public typekey.GLCoverageFormType getGLCoverageForm() {
    return (typekey.GLCoverageFormType)__getInternalInterface().getFieldValue(GLCOVERAGEFORM_PROP.get());
  }
  ...
  public entity.GeneralLiabilityCond[] getGLLineConditions() {
    return (entity.GeneralLiabilityCond[])__getInternalInterface().getFieldValue(GLLINECONDITIONS_PROP.get());
  }
  ...
  public entity.GeneralLiabilityCov[] getGLLineCoverages() {
    return (entity.GeneralLiabilityCov[])__getInternalInterface().getFieldValue(GLLINECOVERAGES_PROP.get());
  }
  ...
  public entity.GeneralLiabilityExcl[] getGLLineExclusions() {
    return (entity.GeneralLiabilityExcl[])__getInternalInterface().getFieldValue(GLLINEEXCLUSIONS_PROP.get());
  }
  ...
  public entity.GLModifier[] getGLModifiers() {
    return (entity.GLModifier[])__getInternalInterface().getFieldValue(GLMODIFIERS_PROP.get());
  }
  ...
  public entity.GeneralLiabilityLine getSlice(java.util.Date sliceDate) {
    return (entity.GeneralLiabilityLine)getSliceUntyped(sliceDate);
  }
  
  public entity.GeneralLiabilityLine getUnsliced() {
    return (entity.GeneralLiabilityLine)getUnslicedUntyped();
  }
  
  public entity.windowed.GeneralLiabilityLineVersionList getVersionList() {
    return (entity.windowed.GeneralLiabilityLineVersionList)getVersionListUntyped();
  }
  ...
  public java.lang.Boolean isLocationLimits() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(LOCATIONLIMITS_PROP.get());
  }
  ...
  public java.lang.Boolean isPollutionCleanupExp() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(POLLUTIONCLEANUPEXP_PROP.get());
  }
  ...
  public java.lang.Boolean isSplitLimits() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(SPLITLIMITS_PROP.get());
  }
  ...
  public void removeFromGLCosts(entity.GLCost element) {
    __getInternalInterface().removeArrayElement(GLCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromGLCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(GLCOSTS_PROP.get(), elementID);
  }
  ...
  public void removeFromGLLineConditions(entity.GeneralLiabilityCond element) {
    __getInternalInterface().removeArrayElement(GLLINECONDITIONS_PROP.get(), element);
  }
  ...
  public void removeFromGLLineConditions(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(GLLINECONDITIONS_PROP.get(), elementID);
  }
  ...
  public void removeFromGLLineCoverages(entity.GeneralLiabilityCov element) {
    __getInternalInterface().removeArrayElement(GLLINECOVERAGES_PROP.get(), element);
  }
  ...
  public void removeFromGLLineCoverages(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(GLLINECOVERAGES_PROP.get(), elementID);
  }
  ...
  public void removeFromGLLineExclusions(entity.GeneralLiabilityExcl element) {
    __getInternalInterface().removeArrayElement(GLLINEEXCLUSIONS_PROP.get(), element);
  }
  ...
  public void removeFromGLLineExclusions(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(GLLINEEXCLUSIONS_PROP.get(), elementID);
  }
  ...
  public void removeFromGLModifiers(entity.GLModifier element) {
    __getInternalInterface().removeArrayElement(GLMODIFIERS_PROP.get(), element);
  }
  ...
  public void removeFromGLModifiers(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(GLMODIFIERS_PROP.get(), elementID);
  }
  ...
  public void setClaimsMadeOrigEffDate(java.util.Date value) {
    __getInternalInterface().setFieldValue(CLAIMSMADEORIGEFFDATE_PROP.get(), value);
  }
  ...
  public void setGLCosts(entity.GLCost[] value) {
    __getInternalInterface().setFieldValue(GLCOSTS_PROP.get(), value);
  }
  ...
  public void setGLCoverageForm(typekey.GLCoverageFormType value) {
    __getInternalInterface().setFieldValue(GLCOVERAGEFORM_PROP.get(), value);
  }
  ...
  public void setGLLineConditions(entity.GeneralLiabilityCond[] value) {
    __getInternalInterface().setFieldValue(GLLINECONDITIONS_PROP.get(), value);
  }
  ...
  public void setGLLineCoverages(entity.GeneralLiabilityCov[] value) {
    __getInternalInterface().setFieldValue(GLLINECOVERAGES_PROP.get(), value);
  }
  ...
  public void setGLLineExclusions(entity.GeneralLiabilityExcl[] value) {
    __getInternalInterface().setFieldValue(GLLINEEXCLUSIONS_PROP.get(), value);
  }
  ...
  public void setGLModifiers(entity.GLModifier[] value) {
    __getInternalInterface().setFieldValue(GLMODIFIERS_PROP.get(), value);
  }
  ...
  public void setLocationLimits(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(LOCATIONLIMITS_PROP.get(), value);
  }
  ...
  public void setPollutionCleanupExp(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(POLLUTIONCLEANUPEXP_PROP.get(), value);
  }
  ...
  public void setSplitLimits(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(SPLITLIMITS_PROP.get(), value);
  }
  
  public entity.GeneralLiabilityLine split(java.util.Date splitDate) {
    return (entity.GeneralLiabilityLine)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GeneralLiabilityLineInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GeneralLiabilityLine.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.copier.EffDatedCopyable", "gw.lob.gl.GLPolicyLineEffDatedCopier");
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.gl.GLLineCoverableModifiableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.gl.GLLineCoverableModifiableAdapter");
    config.put("gw.api.domain.ModifiableAdapter", "gw.lob.gl.GLLineCoverableModifiableAdapter");
    ...
    config.put("gw.api.policy.PolicyLineJavaMethods", "gw.lob.gl.GLPolicyLineMethods");
    config.put("gw.api.policy.PolicyLineMethods", "gw.lob.gl.GLPolicyLineMethods");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GeneralLiabilityLine.class, config);
    com.guidewire._generated.entity.GeneralLiabilityLineInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GeneralLiabilityLine, com.guidewire._generated.entity.GeneralLiabilityLineInternal>() {
      public java.lang.Object getImplementation(entity.GeneralLiabilityLine bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GeneralLiabilityLineInternal getInternalInterface(entity.GeneralLiabilityLine bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GeneralLiabilityLine newEmptyInstance() {
        return new entity.GeneralLiabilityLine((java.lang.Void)null);
      }

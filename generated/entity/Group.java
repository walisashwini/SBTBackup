...
public class Group extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.Validatable, entity.EventAware, gw.api.assignment.Assignee {
  ...
  public static final gw.api.community.PublicGroupFinder finder = com.guidewire.pc.domain.community.impl.GroupCoreExtMethods.finder;
  ...
  public void addUser(entity.User user) {
    ((com.guidewire.pc.domain.community.impl.GroupCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.GroupCoreExtMethods")).addUser(user);
  }
  ...
  public boolean canAllowExternalAccess(entity.User user) {
    return ((com.guidewire.pc.domain.community.impl.GroupCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.GroupCoreExtMethods")).canAllowExternalAccess(user);
  }
  ...
  public entity.ProducerCode createAndAttachProducerCode() {
    return ((com.guidewire.pc.domain.community.impl.GroupCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.GroupCoreExtMethods")).createAndAttachProducerCode();
  }
  ...
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.Group_Description_L10N[] getDescription_L10N_ARRAY() {
    return (entity.Group_Description_L10N[])__getInternalInterface().getFieldValue(DESCRIPTION_L10N_ARRAY_PROP.get());
  }
   ...
   * Available producer codes to a group.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  ...
  public entity.ProducerCode[] getInheritedProducerCodes() {
    return ((com.guidewire.pc.domain.community.impl.GroupCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.GroupCoreExtMethods")).getInheritedProducerCodes();
  }
  ...
  public entity.Organization getOrganizationWithSetParent() {
    return ((com.guidewire.pc.domain.community.impl.GroupCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.GroupCoreExtMethods")).getOrganizationWithSetParent();
  }
  ...
  public entity.Group getParentWithCircularityCheck() {
    return ((com.guidewire.pc.domain.community.impl.GroupCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.GroupCoreExtMethods")).getParentWithCircularityCheck();
  }
  ...
  public entity.ProducerCode[] getProducerCodes() {
    return ((com.guidewire.pc.domain.community.impl.GroupCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.GroupCoreExtMethods")).getProducerCodes();
  }
  ...
  public boolean hasProducerCode(entity.ProducerCode producerCode) {
    return ((com.guidewire.pc.domain.community.impl.GroupCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.GroupCoreExtMethods")).hasProducerCode(producerCode);
  }
  ...
  public entity.OrganizationSelection makeOrganizationSelection() {
    return ((com.guidewire.pc.domain.community.impl.GroupCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.GroupCoreExtMethods")).makeOrganizationSelection();
  }
  
  public void populateUserProducerCode(entity.User user) {
    ((com.guidewire.pc.domain.community.impl.GroupCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.GroupCoreExtMethods")).populateUserProducerCode(user);
  }
  ...
  public void removeFromUsers(entity.GroupUser element) {
    ((com.guidewire.pc.domain.community.impl.GroupCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.GroupCoreExtMethods")).removeFromUsers(element);
  }
   ...
   */
  private void setDescription_L10N_ARRAY(entity.Group_Description_L10N[] value) {
  ...
  public void setOrganizationWithSetParent(entity.Organization org) {
    ((com.guidewire.pc.domain.community.impl.GroupCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.GroupCoreExtMethods")).setOrganizationWithSetParent(org);
  }
  ...
  public void setParentWithCircularityCheck(entity.Group parent) {
    ((com.guidewire.pc.domain.community.impl.GroupCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.GroupCoreExtMethods")).setParentWithCircularityCheck(parent);
  }
  ...
  public void setProducerCodeAvailability(entity.ProducerCode producerCode, boolean available) {
    ((com.guidewire.pc.domain.community.impl.GroupCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.GroupCoreExtMethods")).setProducerCodeAvailability(producerCode, available);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GroupInternal {
     ...
     */
    public void addToDescription_L10N_ARRAY(entity.Group_Description_L10N element) {
    ...
    public void attachProducerCode(entity.ProducerCode producerCode) {
      ((com.guidewire.pc.domain.community.impl.GroupCoreExtInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.GroupCoreExtInternalMethods")).attachProducerCode(producerCode);
    }
    ...
    public gw.pl.persistence.core.Key findOrganizationId() {
      return ((com.guidewire.pc.domain.community.impl.GroupCoreExtInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.GroupCoreExtInternalMethods")).findOrganizationId();
    }
    
    public gw.pl.persistence.core.Key findOrganizationIdInBundle(entity.Group root) {
      return ((com.guidewire.pc.domain.community.impl.GroupCoreExtInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.GroupCoreExtInternalMethods")).findOrganizationIdInBundle(root);
    }
     ...
     */
    public entity.Group_Description_L10N getDescription_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.Group_Description_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
     ...
     */
    public void removeFromDescription_L10N_ARRAY(entity.Group_Description_L10N element) {
     ...
     * Sets the value of the Description_L10N_ARRAY field.
     */
    public void setDescription_L10N_ARRAY(entity.Group_Description_L10N[] value) {
      __getInternalInterface().setFieldValue(DESCRIPTION_L10N_ARRAY_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.community.impl.GroupCoreExtInternalMethods", "com.guidewire.pc.domain.community.impl.GroupCoreExtMethodsImpl");
    config.put("com.guidewire.pc.domain.community.impl.GroupCoreExtMethods", "com.guidewire.pc.domain.community.impl.GroupCoreExtMethodsImpl");

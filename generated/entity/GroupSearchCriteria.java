...
public class GroupSearchCriteria extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable, java.io.Serializable {
  ...
  public entity.GroupSearchCriteria asBranchSearch() {
    return ((com.guidewire.pc.domain.community.impl.GroupSearchCriteriaCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.GroupSearchCriteriaCoreExtMethods")).asBranchSearch();
  }
  ...
  public boolean isBranchSearch() {
    return ((com.guidewire.pc.domain.community.impl.GroupSearchCriteriaCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.GroupSearchCriteriaCoreExtMethods")).isBranchSearch();
  }
  ...
  public void setExcludeRootGroup(java.lang.Boolean value) {
    ((com.guidewire.pc.domain.community.impl.GroupSearchCriteriaCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.GroupSearchCriteriaCoreExtMethods")).setExcludeRootGroup(value);
  }
  ...
  public void setGroupType(typekey.GroupType value) {
    ((com.guidewire.pc.domain.community.impl.GroupSearchCriteriaCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.GroupSearchCriteriaCoreExtMethods")).setGroupType(value);
  }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.community.impl.GroupSearchCriteriaCoreExtMethods", "com.guidewire.pc.domain.community.impl.GroupSearchCriteriaCoreExtMethodsImpl");

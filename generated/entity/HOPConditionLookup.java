...
/**
 * HOPConditionLookup
 * An availability lookup for HOP condition patterns.
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "HOPConditionLookup.eti;HOPConditionLookup.eix;HOPConditionLookup.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "HOPConditionLookup")
public class HOPConditionLookup extends entity.ConditionLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.HOPConditionLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.HOPConditionLookup>("entity.HOPConditionLookup");
   ...
   */
  protected HOPConditionLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected HOPConditionLookup(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPConditionLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPConditionLookupInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPConditionLookupInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPConditionLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPConditionLookup.this.__getDelegateManager();
    }
    ...
    /**
     * Gets the value of the ConditionPatternCode field.
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public java.lang.String getConditionPatternCode() {
      return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CONDITIONPATTERNCODE_PROP.get());
    }
     ...
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public typekey.ConditionLookup getSubtype() {
      return (typekey.ConditionLookup)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
    ...
    /**
     * Sets the value of the ConditionPatternCode field.
     */
    public void setConditionPatternCode(java.lang.String value) {
      __getInternalInterface().setFieldValueForCodegen(CONDITIONPATTERNCODE_PROP.get(), value);
    }
     ...
     */
    public void setSubtype(typekey.ConditionLookup value) {
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.productmodel.DenormLookupInitialisable", "com.guidewire.pc.domain.productmodel.impl.ConditionLookupImpl");
    config.put("com.guidewire.pc.domain.productmodel.impl.LookupInternalMethods", "com.guidewire.pc.domain.productmodel.impl.ConditionLookupImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.productmodel.impl.ConditionLookupImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPConditionLookup.class, config);
    com.guidewire._generated.entity.HOPConditionLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPConditionLookup, com.guidewire._generated.entity.HOPConditionLookupInternal>() {
      public java.lang.Object getImplementation(entity.HOPConditionLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPConditionLookupInternal getInternalInterface(entity.HOPConditionLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPConditionLookup newEmptyInstance() {
        return new entity.HOPConditionLookup((java.lang.Void)null);
      }

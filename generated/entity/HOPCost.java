...
/**
 * HOPCost
 * A unit of premium or other cost (taxes, fees, etc.) for the Homeowners line.
 */
...
public abstract class HOPCost extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPCost, entity.PolicyPeriod>("entity.HOPCost");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> HOPPREMIUMTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "HOPPremiumType");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ID");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> MODIFICATION_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "Modification");
  ...
  private com.guidewire._generated.entity.HOPCostInternal _internal;
  ...
  protected HOPCost(java.lang.Void ignored)  {
    
  }
  
  protected abstract com.guidewire._generated.entity.HOPCostInternal __createInternalInterface();
  ...
  protected com.guidewire._generated.entity.HOPCostInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPCost clone() {
    return (entity.HOPCost)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPCost getBasedOn() {
    return (entity.HOPCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPCost getSlice(java.util.Date sliceDate) {
    return (entity.HOPCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.HOPCost getUnsliced() {
    return (entity.HOPCost)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPCostVersionList getVersionList() {
    return (entity.windowed.HOPCostVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPCost value) {
   ...
   */
  private void setFixed(entity.HOPCost value) {
   ...
   */
  private void setSubtype(typekey.HOPCost value) {
   ...
   */
  private void setTransactions(entity.HOPTransaction[] value) {
  ...
  public entity.HOPCost split(java.util.Date splitDate) {
    return (entity.HOPCost)splitUntyped(splitDate);
  }
  ...
  static {
    com.guidewire._generated.entity.HOPCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.EntityFriendAccess<entity.HOPCost, com.guidewire._generated.entity.HOPCostInternal>() {
      public java.lang.Object getImplementation(entity.HOPCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPCostInternal getInternalInterface(entity.HOPCost bean) {
        if(bean == null) {
          return null;
        };

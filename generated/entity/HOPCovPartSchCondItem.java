...
/**
 * HOPCovPartSchCondItem
 * HOP coverage-part level condition scheduled item
 */
...
@gw.entity.EntityName(value = "HOPCovPartSchCondItem")
public class HOPCovPartSchCondItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.HOPScheduledItem, entity.ScheduledItem, entity.Coverable, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPCovPartSchCondItem, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPCovPartSchCondItem, entity.PolicyPeriod>("entity.HOPCovPartSchCondItem");
  ...
  private com.guidewire._generated.entity.HOPCovPartSchCondItemInternal _internal;
   ...
   */
  public HOPCovPartSchCondItem(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPCovPartSchCondItem(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPCovPartSchCondItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPCovPartSchCondItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPCovPartSchCondItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPCovPartSchCondItem clone() {
    return (entity.HOPCovPartSchCondItem)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPCovPartSchCondItem getBasedOn() {
    return (entity.HOPCovPartSchCondItem)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPCovPartSchCondItem getBasedOnValue() {
    return (entity.HOPCovPartSchCondItem)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPCovPartSchCondItem getFixed() {
    return (entity.HOPCovPartSchCondItem)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPCovPartScheduleCond getSchedule() {
    return (entity.HOPCovPartScheduleCond)__getInternalInterface().getFieldValue(SCHEDULE_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPCovPartSchCondItemCond getScheduledItemClause() {
    return (entity.HOPCovPartSchCondItemCond)__getInternalInterface().getFieldValue(SCHEDULEDITEMCLAUSE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPCovPartSchCondItemCond[] getScheduledItemClauseArray() {
    return (entity.HOPCovPartSchCondItemCond[])__getInternalInterface().getFieldValue(SCHEDULEDITEMCLAUSEARRAY_PROP.get());
  }
  ...
  public entity.HOPCovPartSchCondItem getSlice(java.util.Date sliceDate) {
    return (entity.HOPCovPartSchCondItem)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.HOPCovPartSchCondItem getSubtype() {
    return (typekey.HOPCovPartSchCondItem)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.HOPCovPartSchCondItem getUnsliced() {
    return (entity.HOPCovPartSchCondItem)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPCovPartSchCondItemVersionList getVersionList() {
    return (entity.windowed.HOPCovPartSchCondItemVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPCovPartSchCondItem value) {
   ...
   */
  private void setFixed(entity.HOPCovPartSchCondItem value) {
   ...
   */
  public void setSchedule(entity.HOPCovPartScheduleCond value) {
   ...
   */
  public void setScheduledItemClause(entity.HOPCovPartSchCondItemCond value) {
   ...
   */
  private void setScheduledItemClauseArray(entity.HOPCovPartSchCondItemCond[] value) {
   ...
   */
  private void setSubtype(typekey.HOPCovPartSchCondItem value) {
  ...
  public entity.HOPCovPartSchCondItem split(java.util.Date splitDate) {
    return (entity.HOPCovPartSchCondItem)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPCovPartSchCondItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPCovPartSchCondItem.this.__getDelegateManager();
    }
     ...
     */
    public void addToScheduledItemClauseArray(entity.HOPCovPartSchCondItemCond element) {
     ...
     */
    public void removeFromScheduledItemClauseArray(entity.HOPCovPartSchCondItemCond element) {
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.HOPCovPartSchCondItem value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.HOPCovPartSchCondItem value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the ScheduledItemClauseArray field.
     */
    public void setScheduledItemClauseArray(entity.HOPCovPartSchCondItemCond[] value) {
      __getInternalInterface().setFieldValue(SCHEDULEDITEMCLAUSEARRAY_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.HOPCovPartSchCondItem value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.hop.schedule.HOPCovPartScheduleCondItemCoverableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.hop.schedule.HOPCovPartScheduleCondItemCoverableAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPCovPartSchCondItemMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPCovPartSchCondItemMatcher");
    config.put("gw.api.productmodel.ScheduledItemAdapter", "gw.lob.hop.schedule.HOPCovPartScheduleCondItemCoverableAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPCovPartSchCondItem.class, config);
    com.guidewire._generated.entity.HOPCovPartSchCondItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPCovPartSchCondItem, com.guidewire._generated.entity.HOPCovPartSchCondItemInternal>() {
      public java.lang.Object getImplementation(entity.HOPCovPartSchCondItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPCovPartSchCondItemInternal getInternalInterface(entity.HOPCovPartSchCondItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPCovPartSchCondItem newEmptyInstance() {
        return new entity.HOPCovPartSchCondItem((java.lang.Void)null);
      }

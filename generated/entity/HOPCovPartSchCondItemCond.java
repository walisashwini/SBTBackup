...
/**
 * HOPCovPartSchCondItemCond
 * HOP coverage-part condition scheduled item with coverage terms
 */
...
@gw.entity.EntityName(value = "HOPCovPartSchCondItemCond")
public class HOPCovPartSchCondItemCond extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PolicyCondition, entity.ScheduledItemClause, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPCovPartSchCondItemCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPCovPartSchCondItemCond, entity.PolicyPeriod>("entity.HOPCovPartSchCondItemCond");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> HOPCOVPARTSCHCONDITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "HOPCovPartSchCondItem");
  ...
  private com.guidewire._generated.entity.HOPCovPartSchCondItemCondInternal _internal;
   ...
   */
  protected HOPCovPartSchCondItemCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected HOPCovPartSchCondItemCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected HOPCovPartSchCondItemCond(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPCovPartSchCondItemCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPCovPartSchCondItemCondInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPCovPartSchCondItemCond clone() {
    return (entity.HOPCovPartSchCondItemCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPCovPartSchCondItemCond getBasedOn() {
    return (entity.HOPCovPartSchCondItemCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPCovPartSchCondItemCond getBasedOnValue() {
    return (entity.HOPCovPartSchCondItemCond)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPCovPartSchCondItemCond getFixed() {
    return (entity.HOPCovPartSchCondItemCond)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  /**
   * Gets the value of the HOPCovPartSchCondItem field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPCovPartSchCondItem getHOPCovPartSchCondItem() {
    return (entity.HOPCovPartSchCondItem)__getInternalInterface().getFieldValue(HOPCOVPARTSCHCONDITEM_PROP.get());
  }
  ...
  public entity.HOPCovPartSchCondItemCond getSlice(java.util.Date sliceDate) {
    return (entity.HOPCovPartSchCondItemCond)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.HOPCovPartSchCondItemCond getSubtype() {
    return (typekey.HOPCovPartSchCondItemCond)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.HOPCovPartSchCondItemCond getUnsliced() {
    return (entity.HOPCovPartSchCondItemCond)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPCovPartSchCondItemCondVersionList getVersionList() {
    return (entity.windowed.HOPCovPartSchCondItemCondVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPCovPartSchCondItemCond value) {
   ...
   */
  private void setFixed(entity.HOPCovPartSchCondItemCond value) {
  ...
  /**
   * Sets the value of the HOPCovPartSchCondItem field.
   */
  public void setHOPCovPartSchCondItem(entity.HOPCovPartSchCondItem value) {
    __getInternalInterface().setFieldValue(HOPCOVPARTSCHCONDITEM_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.HOPCovPartSchCondItemCond value) {
  ...
  public entity.HOPCovPartSchCondItemCond split(java.util.Date splitDate) {
    return (entity.HOPCovPartSchCondItemCond)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPCovPartSchCondItemCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPCovPartSchCondItemCond.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getHOPCovPartSchCondItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(HOPCOVPARTSCHCONDITEM_PROP.get());
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.HOPCovPartSchCondItemCond value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.HOPCovPartSchCondItemCond value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
    ...
    public void setHOPCovPartSchCondItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(HOPCOVPARTSCHCONDITEM_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.HOPCovPartSchCondItemCond value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.hop.schedule.HOPCovPartSchCondItemCondConditionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.hop.schedule.HOPCovPartSchCondItemCondConditionAdapter");
    config.put("gw.api.domain.PolicyConditionAdapter", "gw.lob.hop.schedule.HOPCovPartSchCondItemCondConditionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPCovPartSchCondItemCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPCovPartSchCondItemCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPCovPartSchCondItemCond.class, config);
    com.guidewire._generated.entity.HOPCovPartSchCondItemCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPCovPartSchCondItemCond, com.guidewire._generated.entity.HOPCovPartSchCondItemCondInternal>() {
      public java.lang.Object getImplementation(entity.HOPCovPartSchCondItemCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPCovPartSchCondItemCondInternal getInternalInterface(entity.HOPCovPartSchCondItemCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPCovPartSchCondItemCond newEmptyInstance() {
        return new entity.HOPCovPartSchCondItemCond((java.lang.Void)null);
      }

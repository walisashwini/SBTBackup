...
/**
 * HOPCovPartSchCovItemCov
 * HOP Coverage Part coverage schedule item with coverage terms
 */
...
@gw.entity.EntityName(value = "HOPCovPartSchCovItemCov")
public class HOPCovPartSchCovItemCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, entity.ScheduledItemClause, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPCovPartSchCovItemCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPCovPartSchCovItemCov, entity.PolicyPeriod>("entity.HOPCovPartSchCovItemCov");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> HOPCOVPARTSCHCOVITEMCOVCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "HOPCovPartSchCovItemCovCosts");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> HOPCOVPARTSCHEDULECOVITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "HOPCovPartScheduleCovItem");
  ...
  private com.guidewire._generated.entity.HOPCovPartSchCovItemCovInternal _internal;
   ...
   */
  protected HOPCovPartSchCovItemCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected HOPCovPartSchCovItemCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected HOPCovPartSchCovItemCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPCovPartSchCovItemCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPCovPartSchCovItemCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToHOPCovPartSchCovItemCovCosts(entity.HOPCovPartSchCovItemCovCost element) {
    __getInternalInterface().addArrayElement(HOPCOVPARTSCHCOVITEMCOVCOSTS_PROP.get(), element);
  }
  ...
  public entity.HOPCovPartSchCovItemCov clone() {
    return (entity.HOPCovPartSchCovItemCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPCovPartSchCovItemCov getBasedOn() {
    return (entity.HOPCovPartSchCovItemCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPCovPartSchCovItemCov getBasedOnValue() {
    return (entity.HOPCovPartSchCovItemCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.HOPCovPartSchCovItemCov getFixed() {
    return (entity.HOPCovPartSchCovItemCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.HOPCovPartSchCovItemCovCost[] getHOPCovPartSchCovItemCovCosts() {
    return (entity.HOPCovPartSchCovItemCovCost[])__getInternalInterface().getFieldValue(HOPCOVPARTSCHCOVITEMCOVCOSTS_PROP.get());
  }
  ...
  public entity.HOPCovPartScheduleCovItem getHOPCovPartScheduleCovItem() {
    return (entity.HOPCovPartScheduleCovItem)__getInternalInterface().getFieldValue(HOPCOVPARTSCHEDULECOVITEM_PROP.get());
  }
  ...
  public entity.HOPCovPartSchCovItemCov getSlice(java.util.Date sliceDate) {
    return (entity.HOPCovPartSchCovItemCov)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.HOPCovPartSchCovItemCov getSubtype() {
    return (typekey.HOPCovPartSchCovItemCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.HOPCovPartSchCovItemCov getUnsliced() {
    return (entity.HOPCovPartSchCovItemCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPCovPartSchCovItemCovVersionList getVersionList() {
    return (entity.windowed.HOPCovPartSchCovItemCovVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromHOPCovPartSchCovItemCovCosts(entity.HOPCovPartSchCovItemCovCost element) {
    __getInternalInterface().removeArrayElement(HOPCOVPARTSCHCOVITEMCOVCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromHOPCovPartSchCovItemCovCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(HOPCOVPARTSCHCOVITEMCOVCOSTS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.HOPCovPartSchCovItemCov value) {
   ...
   */
  private void setFixed(entity.HOPCovPartSchCovItemCov value) {
  ...
  public void setHOPCovPartSchCovItemCovCosts(entity.HOPCovPartSchCovItemCovCost[] value) {
    __getInternalInterface().setFieldValue(HOPCOVPARTSCHCOVITEMCOVCOSTS_PROP.get(), value);
  }
  ...
  public void setHOPCovPartScheduleCovItem(entity.HOPCovPartScheduleCovItem value) {
    __getInternalInterface().setFieldValue(HOPCOVPARTSCHEDULECOVITEM_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.HOPCovPartSchCovItemCov value) {
  ...
  public entity.HOPCovPartSchCovItemCov split(java.util.Date splitDate) {
    return (entity.HOPCovPartSchCovItemCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPCovPartSchCovItemCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPCovPartSchCovItemCov.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getHOPCovPartScheduleCovItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(HOPCOVPARTSCHEDULECOVITEM_PROP.get());
    }
    ...
    public void setHOPCovPartScheduleCovItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(HOPCOVPARTSCHEDULECOVITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.hop.schedule.HOPCovPartSchCovItemCovCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.hop.schedule.HOPCovPartSchCovItemCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.hop.schedule.HOPCovPartSchCovItemCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.hop.schedule.HOPCovPartSchCovItemCovCoverageAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPCovPartSchCovItemCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPCovPartSchCovItemCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPCovPartSchCovItemCov.class, config);
    com.guidewire._generated.entity.HOPCovPartSchCovItemCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPCovPartSchCovItemCov, com.guidewire._generated.entity.HOPCovPartSchCovItemCovInternal>() {
      public java.lang.Object getImplementation(entity.HOPCovPartSchCovItemCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPCovPartSchCovItemCovInternal getInternalInterface(entity.HOPCovPartSchCovItemCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPCovPartSchCovItemCov newEmptyInstance() {
        return new entity.HOPCovPartSchCovItemCov((java.lang.Void)null);
      }

...
/**
 * HOPCovPartSchCovItemCovCost
 * Cost for HOP Coverage Part coverage schedule items with coverage terms
 */
...
@gw.entity.EntityName(value = "HOPCovPartSchCovItemCovCost")
public class HOPCovPartSchCovItemCovCost extends entity.HOPCost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPCovPartSchCovItemCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPCovPartSchCovItemCovCost, entity.PolicyPeriod>("entity.HOPCovPartSchCovItemCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> HOPCOVPARTSCHCOVITEMCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "HOPCovPartSchCovItemCov");
   ...
   */
  public HOPCovPartSchCovItemCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPCovPartSchCovItemCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPCovPartSchCovItemCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPCovPartSchCovItemCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPCovPartSchCovItemCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPCovPartSchCovItemCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.HOPCovPartSchCovItemCovCost clone() {
    return (entity.HOPCovPartSchCovItemCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.HOPCovPartSchCovItemCovCost getBasedOn() {
    return (entity.HOPCovPartSchCovItemCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPCovPartSchCovItemCov getHOPCovPartSchCovItemCov() {
    return (entity.HOPCovPartSchCovItemCov)__getInternalInterface().getFieldValue(HOPCOVPARTSCHCOVITEMCOV_PROP.get());
  }
  
  public entity.HOPCovPartSchCovItemCovCost getSlice(java.util.Date sliceDate) {
    return (entity.HOPCovPartSchCovItemCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.HOPCovPartSchCovItemCovCost getUnsliced() {
    return (entity.HOPCovPartSchCovItemCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.HOPCovPartSchCovItemCovCostVersionList getVersionList() {
    return (entity.windowed.HOPCovPartSchCovItemCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setHOPCovPartSchCovItemCov(entity.HOPCovPartSchCovItemCov value) {
    __getInternalInterface().setFieldValue(HOPCOVPARTSCHCOVITEMCOV_PROP.get(), value);
  }
  
  public entity.HOPCovPartSchCovItemCovCost split(java.util.Date splitDate) {
    return (entity.HOPCovPartSchCovItemCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPCovPartSchCovItemCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPCovPartSchCovItemCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getHOPCovPartSchCovItemCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(HOPCOVPARTSCHCOVITEMCOV_PROP.get());
    }
    ...
    public void setHOPCovPartSchCovItemCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(HOPCOVPARTSCHCOVITEMCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.hop.financials.HOPCostMethods", "gw.lob.hop.financials.HOPCovPartSchCovItemCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPCovPartSchCovItemCovCost.class, config);
    com.guidewire._generated.entity.HOPCovPartSchCovItemCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPCovPartSchCovItemCovCost, com.guidewire._generated.entity.HOPCovPartSchCovItemCovCostInternal>() {
      public java.lang.Object getImplementation(entity.HOPCovPartSchCovItemCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPCovPartSchCovItemCovCostInternal getInternalInterface(entity.HOPCovPartSchCovItemCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPCovPartSchCovItemCovCost newEmptyInstance() {
        return new entity.HOPCovPartSchCovItemCovCost((java.lang.Void)null);
      }

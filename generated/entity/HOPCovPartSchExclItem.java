...
/**
 * HOPCovPartSchExclItem
 * HOP Coverage Part level exclucion schedule item
 */
...
@gw.entity.EntityName(value = "HOPCovPartSchExclItem")
public class HOPCovPartSchExclItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.HOPScheduledItem, entity.ScheduledItem, entity.Coverable, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPCovPartSchExclItem, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPCovPartSchExclItem, entity.PolicyPeriod>("entity.HOPCovPartSchExclItem");
  ...
  private com.guidewire._generated.entity.HOPCovPartSchExclItemInternal _internal;
   ...
   */
  public HOPCovPartSchExclItem(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPCovPartSchExclItem(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPCovPartSchExclItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPCovPartSchExclItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPCovPartSchExclItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPCovPartSchExclItem clone() {
    return (entity.HOPCovPartSchExclItem)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPCovPartSchExclItem getBasedOn() {
    return (entity.HOPCovPartSchExclItem)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPCovPartSchExclItem getBasedOnValue() {
    return (entity.HOPCovPartSchExclItem)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPCovPartSchExclItem getFixed() {
    return (entity.HOPCovPartSchExclItem)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPCovPartScheduleExcl getSchedule() {
    return (entity.HOPCovPartScheduleExcl)__getInternalInterface().getFieldValue(SCHEDULE_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPCovPartSchExclItemExcl getScheduledItemClause() {
    return (entity.HOPCovPartSchExclItemExcl)__getInternalInterface().getFieldValue(SCHEDULEDITEMCLAUSE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPCovPartSchExclItemExcl[] getScheduledItemClauseArray() {
    return (entity.HOPCovPartSchExclItemExcl[])__getInternalInterface().getFieldValue(SCHEDULEDITEMCLAUSEARRAY_PROP.get());
  }
  ...
  public entity.HOPCovPartSchExclItem getSlice(java.util.Date sliceDate) {
    return (entity.HOPCovPartSchExclItem)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.HOPCovPartSchExclItem getSubtype() {
    return (typekey.HOPCovPartSchExclItem)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.HOPCovPartSchExclItem getUnsliced() {
    return (entity.HOPCovPartSchExclItem)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPCovPartSchExclItemVersionList getVersionList() {
    return (entity.windowed.HOPCovPartSchExclItemVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPCovPartSchExclItem value) {
   ...
   */
  private void setFixed(entity.HOPCovPartSchExclItem value) {
   ...
   */
  public void setSchedule(entity.HOPCovPartScheduleExcl value) {
   ...
   */
  public void setScheduledItemClause(entity.HOPCovPartSchExclItemExcl value) {
   ...
   */
  private void setScheduledItemClauseArray(entity.HOPCovPartSchExclItemExcl[] value) {
   ...
   */
  private void setSubtype(typekey.HOPCovPartSchExclItem value) {
  ...
  public entity.HOPCovPartSchExclItem split(java.util.Date splitDate) {
    return (entity.HOPCovPartSchExclItem)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPCovPartSchExclItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPCovPartSchExclItem.this.__getDelegateManager();
    }
     ...
     */
    public void addToScheduledItemClauseArray(entity.HOPCovPartSchExclItemExcl element) {
     ...
     */
    public void removeFromScheduledItemClauseArray(entity.HOPCovPartSchExclItemExcl element) {
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.HOPCovPartSchExclItem value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.HOPCovPartSchExclItem value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the ScheduledItemClauseArray field.
     */
    public void setScheduledItemClauseArray(entity.HOPCovPartSchExclItemExcl[] value) {
      __getInternalInterface().setFieldValue(SCHEDULEDITEMCLAUSEARRAY_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.HOPCovPartSchExclItem value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.hop.schedule.HOPCovPartScheduleExclItemCoverableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.hop.schedule.HOPCovPartScheduleExclItemCoverableAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPCovPartSchExclItemMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPCovPartSchExclItemMatcher");
    config.put("gw.api.productmodel.ScheduledItemAdapter", "gw.lob.hop.schedule.HOPCovPartScheduleExclItemCoverableAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPCovPartSchExclItem.class, config);
    com.guidewire._generated.entity.HOPCovPartSchExclItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPCovPartSchExclItem, com.guidewire._generated.entity.HOPCovPartSchExclItemInternal>() {
      public java.lang.Object getImplementation(entity.HOPCovPartSchExclItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPCovPartSchExclItemInternal getInternalInterface(entity.HOPCovPartSchExclItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPCovPartSchExclItem newEmptyInstance() {
        return new entity.HOPCovPartSchExclItem((java.lang.Void)null);
      }

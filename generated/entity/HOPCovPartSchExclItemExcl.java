...
/**
 * HOPCovPartSchExclItemExcl
 * HOP Coverage Part schedule item with coverage terms
 */
...
@gw.entity.EntityName(value = "HOPCovPartSchExclItemExcl")
public class HOPCovPartSchExclItemExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, entity.ScheduledItemClause, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPCovPartSchExclItemExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPCovPartSchExclItemExcl, entity.PolicyPeriod>("entity.HOPCovPartSchExclItemExcl");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> HOPCOVPARTSCHEXCLITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "HOPCovPartSchExclItem");
  ...
  private com.guidewire._generated.entity.HOPCovPartSchExclItemExclInternal _internal;
   ...
   */
  protected HOPCovPartSchExclItemExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected HOPCovPartSchExclItemExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected HOPCovPartSchExclItemExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPCovPartSchExclItemExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPCovPartSchExclItemExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPCovPartSchExclItemExcl clone() {
    return (entity.HOPCovPartSchExclItemExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPCovPartSchExclItemExcl getBasedOn() {
    return (entity.HOPCovPartSchExclItemExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPCovPartSchExclItemExcl getBasedOnValue() {
    return (entity.HOPCovPartSchExclItemExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.HOPCovPartSchExclItemExcl getFixed() {
    return (entity.HOPCovPartSchExclItemExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.HOPCovPartSchExclItem getHOPCovPartSchExclItem() {
    return (entity.HOPCovPartSchExclItem)__getInternalInterface().getFieldValue(HOPCOVPARTSCHEXCLITEM_PROP.get());
  }
  ...
  public entity.HOPCovPartSchExclItemExcl getSlice(java.util.Date sliceDate) {
    return (entity.HOPCovPartSchExclItemExcl)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.HOPCovPartSchExclItemExcl getSubtype() {
    return (typekey.HOPCovPartSchExclItemExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.HOPCovPartSchExclItemExcl getUnsliced() {
    return (entity.HOPCovPartSchExclItemExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPCovPartSchExclItemExclVersionList getVersionList() {
    return (entity.windowed.HOPCovPartSchExclItemExclVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPCovPartSchExclItemExcl value) {
   ...
   */
  private void setFixed(entity.HOPCovPartSchExclItemExcl value) {
  ...
  public void setHOPCovPartSchExclItem(entity.HOPCovPartSchExclItem value) {
    __getInternalInterface().setFieldValue(HOPCOVPARTSCHEXCLITEM_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.HOPCovPartSchExclItemExcl value) {
  ...
  public entity.HOPCovPartSchExclItemExcl split(java.util.Date splitDate) {
    return (entity.HOPCovPartSchExclItemExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPCovPartSchExclItemExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPCovPartSchExclItemExcl.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getHOPCovPartSchExclItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(HOPCOVPARTSCHEXCLITEM_PROP.get());
    }
    ...
    public void setHOPCovPartSchExclItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(HOPCOVPARTSCHEXCLITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.hop.schedule.HOPCovPartSchExclItemExclExclusionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.hop.schedule.HOPCovPartSchExclItemExclExclusionAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.hop.schedule.HOPCovPartSchExclItemExclExclusionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPCovPartSchExclItemExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPCovPartSchExclItemExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPCovPartSchExclItemExcl.class, config);
    com.guidewire._generated.entity.HOPCovPartSchExclItemExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPCovPartSchExclItemExcl, com.guidewire._generated.entity.HOPCovPartSchExclItemExclInternal>() {
      public java.lang.Object getImplementation(entity.HOPCovPartSchExclItemExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPCovPartSchExclItemExclInternal getInternalInterface(entity.HOPCovPartSchExclItemExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPCovPartSchExclItemExcl newEmptyInstance() {
        return new entity.HOPCovPartSchExclItemExcl((java.lang.Void)null);
      }

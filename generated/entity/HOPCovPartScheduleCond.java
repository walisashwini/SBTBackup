...
/**
 * HOPCovPartScheduleCond
 * HOP Coverage Part condition with a schedule
 */
...
@gw.entity.EntityName(value = "HOPCovPartScheduleCond")
public class HOPCovPartScheduleCond extends entity.HOPCoveragePartCond implements entity.ScheduleAutoNumberSequence, gw.api.domain.Schedule {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPCovPartScheduleCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPCovPartScheduleCond, entity.PolicyPeriod>("entity.HOPCovPartScheduleCond");
   ...
   */
  protected HOPCovPartScheduleCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected HOPCovPartScheduleCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected HOPCovPartScheduleCond(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPCovPartScheduleCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPCovPartScheduleCondInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPCovPartScheduleCondInternal)super.__getInternalInterface();
  }
  ...
  public entity.HOPCovPartScheduleCond clone() {
    return (entity.HOPCovPartScheduleCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPCovPartScheduleCond getBasedOn() {
    return (entity.HOPCovPartScheduleCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPCovPartSchCondItem[] getHOPCovPartScheduledItems() {
    return (entity.HOPCovPartSchCondItem[])__getInternalInterface().getFieldValue(HOPCOVPARTSCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.HOPCovPartScheduleCond getSlice(java.util.Date sliceDate) {
    return (entity.HOPCovPartScheduleCond)getSliceUntyped(sliceDate);
  }
  
  public entity.HOPCovPartScheduleCond getUnsliced() {
    return (entity.HOPCovPartScheduleCond)getUnslicedUntyped();
  }
  
  public entity.windowed.HOPCovPartScheduleCondVersionList getVersionList() {
    return (entity.windowed.HOPCovPartScheduleCondVersionList)getVersionListUntyped();
  }
  ...
  public entity.HOPCovPartScheduleCond split(java.util.Date splitDate) {
    return (entity.HOPCovPartScheduleCond)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPCovPartScheduleCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPCovPartScheduleCond.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.Schedule", "gw.lob.hop.schedule.HOPCovPartScheduleCondImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPCovPartScheduleCond.class, config);
    com.guidewire._generated.entity.HOPCovPartScheduleCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPCovPartScheduleCond, com.guidewire._generated.entity.HOPCovPartScheduleCondInternal>() {
      public java.lang.Object getImplementation(entity.HOPCovPartScheduleCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPCovPartScheduleCondInternal getInternalInterface(entity.HOPCovPartScheduleCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPCovPartScheduleCond newEmptyInstance() {
        return new entity.HOPCovPartScheduleCond((java.lang.Void)null);
      }

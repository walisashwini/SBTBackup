...
/**
 * HOPCovPartScheduleCov
 * HOP Coverage Part coverage with a schedule
 */
...
@gw.entity.EntityName(value = "HOPCovPartScheduleCov")
public class HOPCovPartScheduleCov extends entity.HOPCoveragePartCov implements entity.ScheduleAutoNumberSequence, gw.api.domain.Schedule {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPCovPartScheduleCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPCovPartScheduleCov, entity.PolicyPeriod>("entity.HOPCovPartScheduleCov");
   ...
   */
  protected HOPCovPartScheduleCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected HOPCovPartScheduleCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected HOPCovPartScheduleCov(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPCovPartScheduleCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPCovPartScheduleCovInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPCovPartScheduleCovInternal)super.__getInternalInterface();
  }
  ...
  public entity.HOPCovPartScheduleCov clone() {
    return (entity.HOPCovPartScheduleCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPCovPartScheduleCov getBasedOn() {
    return (entity.HOPCovPartScheduleCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPCovPartScheduleCovItem[] getHOPCovPartScheduledItems() {
    return (entity.HOPCovPartScheduleCovItem[])__getInternalInterface().getFieldValue(HOPCOVPARTSCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.HOPCovPartScheduleCov getSlice(java.util.Date sliceDate) {
    return (entity.HOPCovPartScheduleCov)getSliceUntyped(sliceDate);
  }
  
  public entity.HOPCovPartScheduleCov getUnsliced() {
    return (entity.HOPCovPartScheduleCov)getUnslicedUntyped();
  }
  
  public entity.windowed.HOPCovPartScheduleCovVersionList getVersionList() {
    return (entity.windowed.HOPCovPartScheduleCovVersionList)getVersionListUntyped();
  }
  ...
  public entity.HOPCovPartScheduleCov split(java.util.Date splitDate) {
    return (entity.HOPCovPartScheduleCov)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPCovPartScheduleCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPCovPartScheduleCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.Schedule", "gw.lob.hop.schedule.HOPCovPartScheduleCovImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPCovPartScheduleCov.class, config);
    com.guidewire._generated.entity.HOPCovPartScheduleCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPCovPartScheduleCov, com.guidewire._generated.entity.HOPCovPartScheduleCovInternal>() {
      public java.lang.Object getImplementation(entity.HOPCovPartScheduleCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPCovPartScheduleCovInternal getInternalInterface(entity.HOPCovPartScheduleCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPCovPartScheduleCov newEmptyInstance() {
        return new entity.HOPCovPartScheduleCov((java.lang.Void)null);
      }

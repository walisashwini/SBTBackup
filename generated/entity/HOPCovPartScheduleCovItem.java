...
/**
 * HOPCovPartScheduleCovItem
 * HOP Coverage Part level coverage schedule item
 */
...
@gw.entity.EntityName(value = "HOPCovPartScheduleCovItem")
public class HOPCovPartScheduleCovItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.HOPScheduledItem, entity.ScheduledItem, entity.Coverable, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPCovPartScheduleCovItem, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPCovPartScheduleCovItem, entity.PolicyPeriod>("entity.HOPCovPartScheduleCovItem");
  ...
  private com.guidewire._generated.entity.HOPCovPartScheduleCovItemInternal _internal;
   ...
   */
  public HOPCovPartScheduleCovItem(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPCovPartScheduleCovItem(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPCovPartScheduleCovItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPCovPartScheduleCovItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPCovPartScheduleCovItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPCovPartScheduleCovItem clone() {
    return (entity.HOPCovPartScheduleCovItem)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPCovPartScheduleCovItem getBasedOn() {
    return (entity.HOPCovPartScheduleCovItem)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPCovPartScheduleCovItem getBasedOnValue() {
    return (entity.HOPCovPartScheduleCovItem)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPCovPartScheduleCovItem getFixed() {
    return (entity.HOPCovPartScheduleCovItem)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPCovPartScheduleCov getSchedule() {
    return (entity.HOPCovPartScheduleCov)__getInternalInterface().getFieldValue(SCHEDULE_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPCovPartSchCovItemCov getScheduledItemClause() {
    return (entity.HOPCovPartSchCovItemCov)__getInternalInterface().getFieldValue(SCHEDULEDITEMCLAUSE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPCovPartSchCovItemCov[] getScheduledItemClauseArray() {
    return (entity.HOPCovPartSchCovItemCov[])__getInternalInterface().getFieldValue(SCHEDULEDITEMCLAUSEARRAY_PROP.get());
  }
  ...
  public entity.HOPCovPartScheduleCovItem getSlice(java.util.Date sliceDate) {
    return (entity.HOPCovPartScheduleCovItem)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.HOPCovPartScheduleCovItem getSubtype() {
    return (typekey.HOPCovPartScheduleCovItem)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.HOPCovPartScheduleCovItem getUnsliced() {
    return (entity.HOPCovPartScheduleCovItem)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPCovPartScheduleCovItemVersionList getVersionList() {
    return (entity.windowed.HOPCovPartScheduleCovItemVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPCovPartScheduleCovItem value) {
   ...
   */
  private void setFixed(entity.HOPCovPartScheduleCovItem value) {
   ...
   */
  public void setSchedule(entity.HOPCovPartScheduleCov value) {
   ...
   */
  public void setScheduledItemClause(entity.HOPCovPartSchCovItemCov value) {
   ...
   */
  private void setScheduledItemClauseArray(entity.HOPCovPartSchCovItemCov[] value) {
   ...
   */
  private void setSubtype(typekey.HOPCovPartScheduleCovItem value) {
  ...
  public entity.HOPCovPartScheduleCovItem split(java.util.Date splitDate) {
    return (entity.HOPCovPartScheduleCovItem)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPCovPartScheduleCovItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPCovPartScheduleCovItem.this.__getDelegateManager();
    }
     ...
     */
    public void addToScheduledItemClauseArray(entity.HOPCovPartSchCovItemCov element) {
     ...
     */
    public void removeFromScheduledItemClauseArray(entity.HOPCovPartSchCovItemCov element) {
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.HOPCovPartScheduleCovItem value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.HOPCovPartScheduleCovItem value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the ScheduledItemClauseArray field.
     */
    public void setScheduledItemClauseArray(entity.HOPCovPartSchCovItemCov[] value) {
      __getInternalInterface().setFieldValue(SCHEDULEDITEMCLAUSEARRAY_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.HOPCovPartScheduleCovItem value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.hop.schedule.HOPCovPartScheduleCovItemCoverableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.hop.schedule.HOPCovPartScheduleCovItemCoverableAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPCovPartSchCovItemMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPCovPartSchCovItemMatcher");
    config.put("gw.api.productmodel.ScheduledItemAdapter", "gw.lob.hop.schedule.HOPCovPartScheduleCovItemCoverableAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPCovPartScheduleCovItem.class, config);
    com.guidewire._generated.entity.HOPCovPartScheduleCovItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPCovPartScheduleCovItem, com.guidewire._generated.entity.HOPCovPartScheduleCovItemInternal>() {
      public java.lang.Object getImplementation(entity.HOPCovPartScheduleCovItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPCovPartScheduleCovItemInternal getInternalInterface(entity.HOPCovPartScheduleCovItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPCovPartScheduleCovItem newEmptyInstance() {
        return new entity.HOPCovPartScheduleCovItem((java.lang.Void)null);
      }

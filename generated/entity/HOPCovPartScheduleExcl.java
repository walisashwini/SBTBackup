...
/**
 * HOPCovPartScheduleExcl
 * HOP Coverage Part exclusion with a schedule
 */
...
@gw.entity.EntityName(value = "HOPCovPartScheduleExcl")
public class HOPCovPartScheduleExcl extends entity.HOPCoveragePartExcl implements entity.ScheduleAutoNumberSequence, gw.api.domain.Schedule {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPCovPartScheduleExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPCovPartScheduleExcl, entity.PolicyPeriod>("entity.HOPCovPartScheduleExcl");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> HOPCOVPARTSCHEDULEDITEMS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "HOPCovPartScheduledItems");
   ...
   */
  protected HOPCovPartScheduleExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected HOPCovPartScheduleExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected HOPCovPartScheduleExcl(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPCovPartScheduleExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPCovPartScheduleExclInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPCovPartScheduleExclInternal)super.__getInternalInterface();
  }
  ...
  public void addToHOPCovPartScheduledItems(entity.HOPCovPartSchExclItem element) {
    __getInternalInterface().addArrayElement(HOPCOVPARTSCHEDULEDITEMS_PROP.get(), element);
  }
  ...
  public entity.HOPCovPartScheduleExcl clone() {
    return (entity.HOPCovPartScheduleExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPCovPartScheduleExcl getBasedOn() {
    return (entity.HOPCovPartScheduleExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPCovPartSchExclItem[] getHOPCovPartScheduledItems() {
    return (entity.HOPCovPartSchExclItem[])__getInternalInterface().getFieldValue(HOPCOVPARTSCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.HOPCovPartScheduleExcl getSlice(java.util.Date sliceDate) {
    return (entity.HOPCovPartScheduleExcl)getSliceUntyped(sliceDate);
  }
  
  public entity.HOPCovPartScheduleExcl getUnsliced() {
    return (entity.HOPCovPartScheduleExcl)getUnslicedUntyped();
  }
  
  public entity.windowed.HOPCovPartScheduleExclVersionList getVersionList() {
    return (entity.windowed.HOPCovPartScheduleExclVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromHOPCovPartScheduledItems(entity.HOPCovPartSchExclItem element) {
    __getInternalInterface().removeArrayElement(HOPCOVPARTSCHEDULEDITEMS_PROP.get(), element);
  }
  ...
  public void removeFromHOPCovPartScheduledItems(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(HOPCOVPARTSCHEDULEDITEMS_PROP.get(), elementID);
  }
  ...
  public void setHOPCovPartScheduledItems(entity.HOPCovPartSchExclItem[] value) {
    __getInternalInterface().setFieldValue(HOPCOVPARTSCHEDULEDITEMS_PROP.get(), value);
  }
  ...
  public entity.HOPCovPartScheduleExcl split(java.util.Date splitDate) {
    return (entity.HOPCovPartScheduleExcl)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPCovPartScheduleExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPCovPartScheduleExcl.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.Schedule", "gw.lob.hop.schedule.HOPCovPartScheduleExclImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPCovPartScheduleExcl.class, config);
    com.guidewire._generated.entity.HOPCovPartScheduleExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPCovPartScheduleExcl, com.guidewire._generated.entity.HOPCovPartScheduleExclInternal>() {
      public java.lang.Object getImplementation(entity.HOPCovPartScheduleExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPCovPartScheduleExclInternal getInternalInterface(entity.HOPCovPartScheduleExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPCovPartScheduleExcl newEmptyInstance() {
        return new entity.HOPCovPartScheduleExcl((java.lang.Void)null);
      }

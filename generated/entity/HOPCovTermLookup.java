...
/**
 * HOPCovTermLookup
 * An availability lookup for HOP coverage term patterns.
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "HOPCovTermLookup.eti;HOPCovTermLookup.eix;HOPCovTermLookup.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "HOPCovTermLookup")
public class HOPCovTermLookup extends entity.CovTermLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.HOPCovTermLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.HOPCovTermLookup>("entity.HOPCovTermLookup");
   ...
   */
  protected HOPCovTermLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected HOPCovTermLookup(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPCovTermLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPCovTermLookupInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPCovTermLookupInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPCovTermLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPCovTermLookup.this.__getDelegateManager();
    }
    ...
    public typekey.CovTermLookup getSubtype() {
      return (typekey.CovTermLookup)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.productmodel.CovTermLookupPublicMethods", "com.guidewire.pc.domain.productmodel.impl.CovTermLookupImpl");
    config.put("com.guidewire.pc.domain.productmodel.DenormLookupInitialisable", "com.guidewire.pc.domain.productmodel.impl.CovTermLookupImpl");
    config.put("com.guidewire.pc.domain.productmodel.impl.LookupInternalMethods", "com.guidewire.pc.domain.productmodel.impl.CovTermLookupImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.productmodel.impl.CovTermLookupImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPCovTermLookup.class, config);
    com.guidewire._generated.entity.HOPCovTermLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPCovTermLookup, com.guidewire._generated.entity.HOPCovTermLookupInternal>() {
      public java.lang.Object getImplementation(entity.HOPCovTermLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPCovTermLookupInternal getInternalInterface(entity.HOPCovTermLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPCovTermLookup newEmptyInstance() {
        return new entity.HOPCovTermLookup((java.lang.Void)null);
      }

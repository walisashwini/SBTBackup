...
/**
 * HOPCovTermOptLookup
 * An availability lookup for HOP coverage term option patterns.
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "HOPCovTermOptLookup.eti;HOPCovTermOptLookup.eix;HOPCovTermOptLookup.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "HOPCovTermOptLookup")
public class HOPCovTermOptLookup extends entity.CovTermOptLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.HOPCovTermOptLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.HOPCovTermOptLookup>("entity.HOPCovTermOptLookup");
   ...
   */
  protected HOPCovTermOptLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected HOPCovTermOptLookup(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPCovTermOptLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPCovTermOptLookupInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPCovTermOptLookupInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPCovTermOptLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPCovTermOptLookup.this.__getDelegateManager();
    }
    ...
    public java.lang.String getCovTermOptCode() {
      return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(COVTERMOPTCODE_PROP.get());
    }
    ...
    public typekey.CovTermOptLookup getSubtype() {
      return (typekey.CovTermOptLookup)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
    ...
    public void setCovTermOptCode(java.lang.String value) {
      __getInternalInterface().setFieldValueForCodegen(COVTERMOPTCODE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.productmodel.CovTermOptLookupPublicMethods", "com.guidewire.pc.domain.productmodel.impl.CovTermOptLookupImpl");
    config.put("com.guidewire.pc.domain.productmodel.DenormLookupInitialisable", "com.guidewire.pc.domain.productmodel.impl.CovTermOptLookupImpl");
    config.put("com.guidewire.pc.domain.productmodel.impl.LookupInternalMethods", "com.guidewire.pc.domain.productmodel.impl.CovTermOptLookupImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.productmodel.impl.CovTermOptLookupImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPCovTermOptLookup.class, config);
    com.guidewire._generated.entity.HOPCovTermOptLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPCovTermOptLookup, com.guidewire._generated.entity.HOPCovTermOptLookupInternal>() {
      public java.lang.Object getImplementation(entity.HOPCovTermOptLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPCovTermOptLookupInternal getInternalInterface(entity.HOPCovTermOptLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPCovTermOptLookup newEmptyInstance() {
        return new entity.HOPCovTermOptLookup((java.lang.Void)null);
      }

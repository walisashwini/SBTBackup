...
/**
 * HOPCovTermPackLookup
 * An availability lookup for HOP cov term pack patterns.
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "HOPCovTermPackLookup.eti;HOPCovTermPackLookup.eix;HOPCovTermPackLookup.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "HOPCovTermPackLookup")
public class HOPCovTermPackLookup extends entity.CovTermPackLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.HOPCovTermPackLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.HOPCovTermPackLookup>("entity.HOPCovTermPackLookup");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> HOPCOVERAGEFORM_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "HOPCoverageForm");
   ...
   */
  protected HOPCovTermPackLookup()  {
   ...
   */
  protected HOPCovTermPackLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected HOPCovTermPackLookup(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPCovTermPackLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPCovTermPackLookupInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPCovTermPackLookupInternal)super.__getInternalInterface();
  }
  ...
  /**
   * Gets the value of the HOPCoverageForm field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.HOPCoverageForm getHOPCoverageForm() {
    return (typekey.HOPCoverageForm)__getInternalInterface().getFieldValue(HOPCOVERAGEFORM_PROP.get());
  }
  ...
  /**
   * Sets the value of the HOPCoverageForm field.
   */
  public void setHOPCoverageForm(typekey.HOPCoverageForm value) {
    __getInternalInterface().setFieldValue(HOPCOVERAGEFORM_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPCovTermPackLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPCovTermPackLookup.this.__getDelegateManager();
    }
    ...
    public java.lang.String getCovTermPackCode() {
      return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(COVTERMPACKCODE_PROP.get());
    }
    ...
    public java.lang.String getCovTermPatternCode() {
      return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(COVTERMPATTERNCODE_PROP.get());
    }
    ...
    public typekey.CovTermPackLookup getSubtype() {
      return (typekey.CovTermPackLookup)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
    ...
    public void setCovTermPackCode(java.lang.String value) {
      __getInternalInterface().setFieldValueForCodegen(COVTERMPACKCODE_PROP.get(), value);
    }
    ...
    public void setCovTermPatternCode(java.lang.String value) {
      __getInternalInterface().setFieldValueForCodegen(COVTERMPATTERNCODE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.productmodel.CovTermPackLookupPublicMethods", "com.guidewire.pc.domain.productmodel.impl.CovTermPackLookupImpl");
    config.put("com.guidewire.pc.domain.productmodel.DenormLookupInitialisable", "com.guidewire.pc.domain.productmodel.impl.CovTermPackLookupImpl");
    config.put("com.guidewire.pc.domain.productmodel.impl.LookupInternalMethods", "com.guidewire.pc.domain.productmodel.impl.CovTermPackLookupImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.productmodel.impl.CovTermPackLookupImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPCovTermPackLookup.class, config);
    com.guidewire._generated.entity.HOPCovTermPackLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPCovTermPackLookup, com.guidewire._generated.entity.HOPCovTermPackLookupInternal>() {
      public java.lang.Object getImplementation(entity.HOPCovTermPackLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPCovTermPackLookupInternal getInternalInterface(entity.HOPCovTermPackLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPCovTermPackLookup newEmptyInstance() {
        return new entity.HOPCovTermPackLookup((java.lang.Void)null);
      }

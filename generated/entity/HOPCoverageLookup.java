...
/**
 * HOPCoverageLookup
 * An availability lookup for HOP coverage patterns.
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "HOPCoverageLookup.eti;HOPCoverageLookup.eix;HOPCoverageLookup.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "HOPCoverageLookup")
public class HOPCoverageLookup extends entity.CoverageLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.HOPCoverageLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.HOPCoverageLookup>("entity.HOPCoverageLookup");
   ...
   */
  protected HOPCoverageLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected HOPCoverageLookup(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPCoverageLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPCoverageLookupInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPCoverageLookupInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPCoverageLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPCoverageLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPCoverageLookup.class, config);
    com.guidewire._generated.entity.HOPCoverageLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPCoverageLookup, com.guidewire._generated.entity.HOPCoverageLookupInternal>() {
      public java.lang.Object getImplementation(entity.HOPCoverageLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPCoverageLookupInternal getInternalInterface(entity.HOPCoverageLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPCoverageLookup newEmptyInstance() {
        return new entity.HOPCoverageLookup((java.lang.Void)null);
      }

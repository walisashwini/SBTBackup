...
/**
 * HOPCoveragePartCond
 * Conditions directly attached to each HOPCoveragePart2
 */
...
@gw.entity.EntityName(value = "HOPCoveragePartCond")
public class HOPCoveragePartCond extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PolicyCondition, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPCoveragePartCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPCoveragePartCond, entity.PolicyPeriod>("entity.HOPCoveragePartCond");
  ...
  private com.guidewire._generated.entity.HOPCoveragePartCondInternal _internal;
   ...
   */
  protected HOPCoveragePartCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected HOPCoveragePartCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected HOPCoveragePartCond(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPCoveragePartCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPCoveragePartCondInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPCoveragePartCond clone() {
    return (entity.HOPCoveragePartCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPCoveragePartCond getBasedOn() {
    return (entity.HOPCoveragePartCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPCoveragePartCond getBasedOnValue() {
    return (entity.HOPCoveragePartCond)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPCoveragePartCond getFixed() {
    return (entity.HOPCoveragePartCond)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.HOPCoveragePartCond getSlice(java.util.Date sliceDate) {
    return (entity.HOPCoveragePartCond)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.HOPCoveragePartCond getSubtype() {
    return (typekey.HOPCoveragePartCond)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.HOPCoveragePartCond getUnsliced() {
    return (entity.HOPCoveragePartCond)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPCoveragePartCondVersionList getVersionList() {
    return (entity.windowed.HOPCoveragePartCondVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPCoveragePartCond value) {
   ...
   */
  private void setFixed(entity.HOPCoveragePartCond value) {
   ...
   */
  private void setSubtype(typekey.HOPCoveragePartCond value) {
  ...
  public entity.HOPCoveragePartCond split(java.util.Date splitDate) {
    return (entity.HOPCoveragePartCond)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPCoveragePartCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPCoveragePartCond.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.HOPCoveragePartCond value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.HOPCoveragePartCond value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.HOPCoveragePartCond value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.hop.HOPCoveragePartCondConditionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.hop.HOPCoveragePartCondConditionAdapter");
    config.put("gw.api.domain.PolicyConditionAdapter", "gw.lob.hop.HOPCoveragePartCondConditionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPCoveragePartCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPCoveragePartCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPCoveragePartCond.class, config);
    com.guidewire._generated.entity.HOPCoveragePartCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPCoveragePartCond, com.guidewire._generated.entity.HOPCoveragePartCondInternal>() {
      public java.lang.Object getImplementation(entity.HOPCoveragePartCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPCoveragePartCondInternal getInternalInterface(entity.HOPCoveragePartCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPCoveragePartCond newEmptyInstance() {
        return new entity.HOPCoveragePartCond((java.lang.Void)null);
      }

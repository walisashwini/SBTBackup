...
/**
 * HOPCoveragePartExcl
 * Exclusions directly attached to each HOPCoveragePart
 */
...
@gw.entity.EntityName(value = "HOPCoveragePartExcl")
public class HOPCoveragePartExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPCoveragePartExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPCoveragePartExcl, entity.PolicyPeriod>("entity.HOPCoveragePartExcl");
  ...
  private com.guidewire._generated.entity.HOPCoveragePartExclInternal _internal;
   ...
   */
  protected HOPCoveragePartExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected HOPCoveragePartExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected HOPCoveragePartExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPCoveragePartExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPCoveragePartExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPCoveragePartExcl clone() {
    return (entity.HOPCoveragePartExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPCoveragePartExcl getBasedOn() {
    return (entity.HOPCoveragePartExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPCoveragePartExcl getBasedOnValue() {
    return (entity.HOPCoveragePartExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPCoveragePartExcl getFixed() {
    return (entity.HOPCoveragePartExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.HOPCoveragePartExcl getSlice(java.util.Date sliceDate) {
    return (entity.HOPCoveragePartExcl)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.HOPCoveragePartExcl getSubtype() {
    return (typekey.HOPCoveragePartExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.HOPCoveragePartExcl getUnsliced() {
    return (entity.HOPCoveragePartExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPCoveragePartExclVersionList getVersionList() {
    return (entity.windowed.HOPCoveragePartExclVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPCoveragePartExcl value) {
   ...
   */
  private void setFixed(entity.HOPCoveragePartExcl value) {
   ...
   */
  private void setSubtype(typekey.HOPCoveragePartExcl value) {
  ...
  public entity.HOPCoveragePartExcl split(java.util.Date splitDate) {
    return (entity.HOPCoveragePartExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPCoveragePartExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPCoveragePartExcl.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.HOPCoveragePartExcl value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.HOPCoveragePartExcl value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.HOPCoveragePartExcl value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.hop.HOPCoveragePartExclExclusionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.hop.HOPCoveragePartExclExclusionAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.hop.HOPCoveragePartExclExclusionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPCoveragePartExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPCoveragePartExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPCoveragePartExcl.class, config);
    com.guidewire._generated.entity.HOPCoveragePartExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPCoveragePartExcl, com.guidewire._generated.entity.HOPCoveragePartExclInternal>() {
      public java.lang.Object getImplementation(entity.HOPCoveragePartExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPCoveragePartExclInternal getInternalInterface(entity.HOPCoveragePartExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPCoveragePartExcl newEmptyInstance() {
        return new entity.HOPCoveragePartExcl((java.lang.Void)null);
      }

...
/**
 * HOPCoveragePartMod
 * A modifier for HOPCoveragePart
 */
...
@gw.entity.EntityName(value = "HOPCoveragePartMod")
public class HOPCoveragePartMod extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Modifier, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPCoveragePartMod, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPCoveragePartMod, entity.PolicyPeriod>("entity.HOPCoveragePartMod");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> HOPCOVERAGEPARTRATEFACTORS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "HOPCoveragePartRateFactors");
  ...
  private com.guidewire._generated.entity.HOPCoveragePartModInternal _internal;
   ...
   */
  public HOPCoveragePartMod(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPCoveragePartMod(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPCoveragePartMod(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPCoveragePartModInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPCoveragePartModInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToHOPCoveragePartRateFactors(entity.HOPCoveragePartRF element) {
    __getInternalInterface().addArrayElement(HOPCOVERAGEPARTRATEFACTORS_PROP.get(), element);
  }
  ...
  public entity.HOPCoveragePartMod clone() {
    return (entity.HOPCoveragePartMod)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPCoveragePartMod getBasedOn() {
    return (entity.HOPCoveragePartMod)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPCoveragePartMod getBasedOnValue() {
    return (entity.HOPCoveragePartMod)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.HOPCoveragePartMod getFixed() {
    return (entity.HOPCoveragePartMod)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.HOPCoveragePartRF[] getHOPCoveragePartRateFactors() {
    return (entity.HOPCoveragePartRF[])__getInternalInterface().getFieldValue(HOPCOVERAGEPARTRATEFACTORS_PROP.get());
  }
  ...
  public entity.HOPCoveragePartMod getSlice(java.util.Date sliceDate) {
    return (entity.HOPCoveragePartMod)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.HOPCoveragePartMod getSubtype() {
    return (typekey.HOPCoveragePartMod)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.HOPCoveragePartMod getUnsliced() {
    return (entity.HOPCoveragePartMod)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPCoveragePartModVersionList getVersionList() {
    return (entity.windowed.HOPCoveragePartModVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromHOPCoveragePartRateFactors(entity.HOPCoveragePartRF element) {
    __getInternalInterface().removeArrayElement(HOPCOVERAGEPARTRATEFACTORS_PROP.get(), element);
  }
  ...
  public void removeFromHOPCoveragePartRateFactors(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(HOPCOVERAGEPARTRATEFACTORS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.HOPCoveragePartMod value) {
   ...
   */
  private void setFixed(entity.HOPCoveragePartMod value) {
  ...
  public void setHOPCoveragePartRateFactors(entity.HOPCoveragePartRF[] value) {
    __getInternalInterface().setFieldValue(HOPCOVERAGEPARTRATEFACTORS_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.HOPCoveragePartMod value) {
  ...
  public entity.HOPCoveragePartMod split(java.util.Date splitDate) {
    return (entity.HOPCoveragePartMod)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPCoveragePartModInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPCoveragePartMod.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ModifierAbstractDomainMethods", "gw.lob.hop.HOPCoveragePartModifierAdapter");
    config.put("gw.api.domain.ModifierAdapter", "gw.lob.hop.HOPCoveragePartModifierAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPCoveragePartModifierMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPCoveragePartModifierMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPCoveragePartMod.class, config);
    com.guidewire._generated.entity.HOPCoveragePartModInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPCoveragePartMod, com.guidewire._generated.entity.HOPCoveragePartModInternal>() {
      public java.lang.Object getImplementation(entity.HOPCoveragePartMod bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPCoveragePartModInternal getInternalInterface(entity.HOPCoveragePartMod bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPCoveragePartMod newEmptyInstance() {
        return new entity.HOPCoveragePartMod((java.lang.Void)null);
      }

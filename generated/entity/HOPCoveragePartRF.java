...
@gw.entity.EntityName(value = "HOPCoveragePartRF")
public class HOPCoveragePartRF extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.RateFactor, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPCoveragePartRF, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPCoveragePartRF, entity.PolicyPeriod>("entity.HOPCoveragePartRF");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> HOPCOVERAGEPARTMODIFIER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "HOPCoveragePartModifier");
  ...
  private com.guidewire._generated.entity.HOPCoveragePartRFInternal _internal;
   ...
   */
  public HOPCoveragePartRF(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPCoveragePartRF(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPCoveragePartRF(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPCoveragePartRFInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPCoveragePartRFInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPCoveragePartRF clone() {
    return (entity.HOPCoveragePartRF)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPCoveragePartRF getBasedOn() {
    return (entity.HOPCoveragePartRF)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPCoveragePartRF getBasedOnValue() {
    return (entity.HOPCoveragePartRF)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.HOPCoveragePartRF getFixed() {
    return (entity.HOPCoveragePartRF)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.HOPCoveragePartMod getHOPCoveragePartModifier() {
    return (entity.HOPCoveragePartMod)__getInternalInterface().getFieldValue(HOPCOVERAGEPARTMODIFIER_PROP.get());
  }
  ...
  public entity.HOPCoveragePartRF getSlice(java.util.Date sliceDate) {
    return (entity.HOPCoveragePartRF)getSliceUntyped(sliceDate);
  }
  ...
  public entity.HOPCoveragePartRF getUnsliced() {
    return (entity.HOPCoveragePartRF)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPCoveragePartRFVersionList getVersionList() {
    return (entity.windowed.HOPCoveragePartRFVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPCoveragePartRF value) {
   ...
   */
  private void setFixed(entity.HOPCoveragePartRF value) {
  ...
  public void setHOPCoveragePartModifier(entity.HOPCoveragePartMod value) {
    __getInternalInterface().setFieldValue(HOPCOVERAGEPARTMODIFIER_PROP.get(), value);
  }
  ...
  public entity.HOPCoveragePartRF split(java.util.Date splitDate) {
    return (entity.HOPCoveragePartRF)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPCoveragePartRFInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPCoveragePartRF.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getHOPCoveragePartModifierID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(HOPCOVERAGEPARTMODIFIER_PROP.get());
    }
    ...
    public void setHOPCoveragePartModifierID(gw.pl.persistence.core.Key value) {
      setFieldValue(HOPCOVERAGEPARTMODIFIER_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.RateFactorAdapter", "gw.lob.hop.HOPCoveragePartRateFactorAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPCoveragePartRateFactorMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPCoveragePartRateFactorMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPCoveragePartRF.class, config);
    com.guidewire._generated.entity.HOPCoveragePartRFInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPCoveragePartRF, com.guidewire._generated.entity.HOPCoveragePartRFInternal>() {
      public java.lang.Object getImplementation(entity.HOPCoveragePartRF bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPCoveragePartRFInternal getInternalInterface(entity.HOPCoveragePartRF bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPCoveragePartRF newEmptyInstance() {
        return new entity.HOPCoveragePartRF((java.lang.Void)null);
      }

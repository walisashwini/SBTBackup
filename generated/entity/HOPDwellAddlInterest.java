 ...
 * An additional interest on a homeowner's dwelling
 */
...
@gw.entity.EntityName(value = "HOPDwellAddlInterest")
public class HOPDwellAddlInterest extends entity.AddlInterestDetail implements gw.api.copier.EffDatedCopyable, gw.api.domain.account.Mergeable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPDwellAddlInterest, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPDwellAddlInterest, entity.PolicyPeriod>("entity.HOPDwellAddlInterest");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ADDLINTEFFDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AddlIntEffDate");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ADDLINTEXPDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AddlIntExpDate");
   ...
   */
  public HOPDwellAddlInterest(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPDwellAddlInterest(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPDwellAddlInterest(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPDwellAddlInterestInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPDwellAddlInterestInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPDwellAddlInterestInternal)super.__getInternalInterface();
  }
  
  public entity.HOPDwellAddlInterest clone() {
    return (entity.HOPDwellAddlInterest)__getInternalInterface().cloneUntyped();
  }
  ...
  public java.util.Date getAddlIntEffDate() {
    return (java.util.Date)__getInternalInterface().getFieldValue(ADDLINTEFFDATE_PROP.get());
  }
  ...
  public java.util.Date getAddlIntExpDate() {
    return (java.util.Date)__getInternalInterface().getFieldValue(ADDLINTEXPDATE_PROP.get());
  }
  
  public entity.HOPDwellAddlInterest getBasedOn() {
    return (entity.HOPDwellAddlInterest)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPDwellAddlInterest getSlice(java.util.Date sliceDate) {
    return (entity.HOPDwellAddlInterest)getSliceUntyped(sliceDate);
  }
  
  public entity.HOPDwellAddlInterest getUnsliced() {
    return (entity.HOPDwellAddlInterest)getUnslicedUntyped();
  }
  
  public entity.windowed.HOPDwellAddlInterestVersionList getVersionList() {
    return (entity.windowed.HOPDwellAddlInterestVersionList)getVersionListUntyped();
  }
  ...
  public void setAddlIntEffDate(java.util.Date value) {
    __getInternalInterface().setFieldValue(ADDLINTEFFDATE_PROP.get(), value);
  }
  ...
  public void setAddlIntExpDate(java.util.Date value) {
    __getInternalInterface().setFieldValue(ADDLINTEXPDATE_PROP.get(), value);
  }
  ...
  public entity.HOPDwellAddlInterest split(java.util.Date splitDate) {
    return (entity.HOPDwellAddlInterest)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPDwellAddlInterestInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPDwellAddlInterest.this.__getDelegateManager();
    }
    ...
    /**
     * Called when an AddlInterestDetail is removed
     */
    public void addlInterestDetailRemoved() {
      ((gw.api.contact.AddlInterestDetailJavaMethods)__getDelegateManager().getImplementation("gw.api.contact.AddlInterestDetailJavaMethods")).addlInterestDetailRemoved();
    }
    ...
    public typekey.AdditionalInterestType getAdditionalInterestType() {
      return (typekey.AdditionalInterestType)__getInternalInterface().getFieldValue(ADDITIONALINTERESTTYPE_PROP.get());
    }
    ...
    public entity.AddlInterestDetail getBasedOnValue() {
      return (entity.AddlInterestDetail)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public java.lang.String getContractNumber() {
      return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CONTRACTNUMBER_PROP.get());
    }
    ...
    public entity.AddlInterestDetail getFixed() {
      return (entity.AddlInterestDetail)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public entity.PolicyAddlInterest getPolicyAddlInterest() {
      return (entity.PolicyAddlInterest)__getInternalInterface().getFieldValue(POLICYADDLINTEREST_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getPolicyAddlInterestID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(POLICYADDLINTEREST_PROP.get());
    }
    ...
    public typekey.AddlInterestDetail getSubtype() {
      return (typekey.AddlInterestDetail)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
    ...
    public java.lang.Boolean isCertRequired() {
      return (java.lang.Boolean)__getInternalInterface().getFieldValue(CERTREQUIRED_PROP.get());
    }
    ...
    public void setAdditionalInterestType(typekey.AdditionalInterestType value) {
      __getInternalInterface().setFieldValue(ADDITIONALINTERESTTYPE_PROP.get(), value);
    }
    ...
    public void setCertRequired(java.lang.Boolean value) {
      __getInternalInterface().setFieldValue(CERTREQUIRED_PROP.get(), value);
    }
    ...
    public void setContractNumber(java.lang.String value) {
      __getInternalInterface().setFieldValueForCodegen(CONTRACTNUMBER_PROP.get(), value);
    }
    ...
    public void setPolicyAddlInterest(entity.PolicyAddlInterest value) {
      __getInternalInterface().setFieldValue(POLICYADDLINTEREST_PROP.get(), value);
    }
    
    public void setPolicyAddlInterestID(gw.pl.persistence.core.Key value) {
      setFieldValue(POLICYADDLINTEREST_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.contact.AddlInterestDetailPublicMethods", "com.guidewire.pc.domain.contact.impl.AddlInterestDetailImpl");
    ...
    config.put("gw.api.contact.AddlInterestDetailJavaMethods", "gw.api.contact.AddlInterestDetailMethodsDefaultImpl");
    config.put("gw.api.contact.AddlInterestDetailMethods", "gw.api.contact.AddlInterestDetailMethodsDefaultImpl");
    config.put("gw.api.copier.EffDatedCopyable", "gw.api.copier.EffDatedCopier");
    config.put("gw.api.domain.account.Mergeable", "gw.lob.hop.HOPDwellAddlInterestMergeableImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPDwellAddlInterestMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPDwellAddlInterestMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPDwellAddlInterest.class, config);
    com.guidewire._generated.entity.HOPDwellAddlInterestInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPDwellAddlInterest, com.guidewire._generated.entity.HOPDwellAddlInterestInternal>() {
      public java.lang.Object getImplementation(entity.HOPDwellAddlInterest bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPDwellAddlInterestInternal getInternalInterface(entity.HOPDwellAddlInterest bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPDwellAddlInterest newEmptyInstance() {
        return new entity.HOPDwellAddlInterest((java.lang.Void)null);
      }

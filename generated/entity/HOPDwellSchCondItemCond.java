...
/**
 * HOPDwellSchCondItemCond
 * HOP Dwelling condition scheduled item with coverage terms
 */
...
@gw.entity.EntityName(value = "HOPDwellSchCondItemCond")
public class HOPDwellSchCondItemCond extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PolicyCondition, entity.ScheduledItemClause, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPDwellSchCondItemCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPDwellSchCondItemCond, entity.PolicyPeriod>("entity.HOPDwellSchCondItemCond");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> HOPDWELLSCHEDULECONDITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "HOPDwellScheduleCondItem");
  ...
  private com.guidewire._generated.entity.HOPDwellSchCondItemCondInternal _internal;
   ...
   */
  protected HOPDwellSchCondItemCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected HOPDwellSchCondItemCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected HOPDwellSchCondItemCond(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPDwellSchCondItemCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPDwellSchCondItemCondInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPDwellSchCondItemCond clone() {
    return (entity.HOPDwellSchCondItemCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPDwellSchCondItemCond getBasedOn() {
    return (entity.HOPDwellSchCondItemCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPDwellSchCondItemCond getBasedOnValue() {
    return (entity.HOPDwellSchCondItemCond)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.HOPDwellSchCondItemCond getFixed() {
    return (entity.HOPDwellSchCondItemCond)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.HOPDwellScheduleCondItem getHOPDwellScheduleCondItem() {
    return (entity.HOPDwellScheduleCondItem)__getInternalInterface().getFieldValue(HOPDWELLSCHEDULECONDITEM_PROP.get());
  }
  ...
  public entity.HOPDwellSchCondItemCond getSlice(java.util.Date sliceDate) {
    return (entity.HOPDwellSchCondItemCond)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.HOPDwellSchCondItemCond getSubtype() {
    return (typekey.HOPDwellSchCondItemCond)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.HOPDwellSchCondItemCond getUnsliced() {
    return (entity.HOPDwellSchCondItemCond)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPDwellSchCondItemCondVersionList getVersionList() {
    return (entity.windowed.HOPDwellSchCondItemCondVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPDwellSchCondItemCond value) {
   ...
   */
  private void setFixed(entity.HOPDwellSchCondItemCond value) {
  ...
  public void setHOPDwellScheduleCondItem(entity.HOPDwellScheduleCondItem value) {
    __getInternalInterface().setFieldValue(HOPDWELLSCHEDULECONDITEM_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.HOPDwellSchCondItemCond value) {
  ...
  public entity.HOPDwellSchCondItemCond split(java.util.Date splitDate) {
    return (entity.HOPDwellSchCondItemCond)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPDwellSchCondItemCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPDwellSchCondItemCond.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getHOPDwellScheduleCondItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(HOPDWELLSCHEDULECONDITEM_PROP.get());
    }
    ...
    public void setHOPDwellScheduleCondItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(HOPDWELLSCHEDULECONDITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.hop.schedule.HOPDwellSchCondItemCondConditionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.hop.schedule.HOPDwellSchCondItemCondConditionAdapter");
    config.put("gw.api.domain.PolicyConditionAdapter", "gw.lob.hop.schedule.HOPDwellSchCondItemCondConditionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPDwellSchCondItemCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPDwellSchCondItemCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPDwellSchCondItemCond.class, config);
    com.guidewire._generated.entity.HOPDwellSchCondItemCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPDwellSchCondItemCond, com.guidewire._generated.entity.HOPDwellSchCondItemCondInternal>() {
      public java.lang.Object getImplementation(entity.HOPDwellSchCondItemCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPDwellSchCondItemCondInternal getInternalInterface(entity.HOPDwellSchCondItemCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPDwellSchCondItemCond newEmptyInstance() {
        return new entity.HOPDwellSchCondItemCond((java.lang.Void)null);
      }

 ...
 * HOP Dwelling coverage scheduled item with coverage terms
 */
...
@gw.entity.EntityName(value = "HOPDwellSchCovItemCov")
public class HOPDwellSchCovItemCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, entity.ScheduledItemClause, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPDwellSchCovItemCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPDwellSchCovItemCov, entity.PolicyPeriod>("entity.HOPDwellSchCovItemCov");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> HOPDWELLSCHCOVITEMCOVCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "HOPDwellSchCovItemCovCosts");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> HOPDWELLSCHEDULECOVITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "HOPDwellScheduleCovItem");
  ...
  private com.guidewire._generated.entity.HOPDwellSchCovItemCovInternal _internal;
   ...
   */
  protected HOPDwellSchCovItemCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected HOPDwellSchCovItemCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected HOPDwellSchCovItemCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPDwellSchCovItemCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPDwellSchCovItemCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToHOPDwellSchCovItemCovCosts(entity.HOPDwellSchCovItemCovCost element) {
    __getInternalInterface().addArrayElement(HOPDWELLSCHCOVITEMCOVCOSTS_PROP.get(), element);
  }
  ...
  public entity.HOPDwellSchCovItemCov clone() {
    return (entity.HOPDwellSchCovItemCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPDwellSchCovItemCov getBasedOn() {
    return (entity.HOPDwellSchCovItemCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPDwellSchCovItemCov getBasedOnValue() {
    return (entity.HOPDwellSchCovItemCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.HOPDwellSchCovItemCov getFixed() {
    return (entity.HOPDwellSchCovItemCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.HOPDwellSchCovItemCovCost[] getHOPDwellSchCovItemCovCosts() {
    return (entity.HOPDwellSchCovItemCovCost[])__getInternalInterface().getFieldValue(HOPDWELLSCHCOVITEMCOVCOSTS_PROP.get());
  }
  ...
  public entity.HOPDwellScheduleCovItem getHOPDwellScheduleCovItem() {
    return (entity.HOPDwellScheduleCovItem)__getInternalInterface().getFieldValue(HOPDWELLSCHEDULECOVITEM_PROP.get());
  }
  ...
  public entity.HOPDwellSchCovItemCov getSlice(java.util.Date sliceDate) {
    return (entity.HOPDwellSchCovItemCov)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.HOPDwellSchCovItemCov getSubtype() {
    return (typekey.HOPDwellSchCovItemCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.HOPDwellSchCovItemCov getUnsliced() {
    return (entity.HOPDwellSchCovItemCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPDwellSchCovItemCovVersionList getVersionList() {
    return (entity.windowed.HOPDwellSchCovItemCovVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromHOPDwellSchCovItemCovCosts(entity.HOPDwellSchCovItemCovCost element) {
    __getInternalInterface().removeArrayElement(HOPDWELLSCHCOVITEMCOVCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromHOPDwellSchCovItemCovCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(HOPDWELLSCHCOVITEMCOVCOSTS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.HOPDwellSchCovItemCov value) {
   ...
   */
  private void setFixed(entity.HOPDwellSchCovItemCov value) {
  ...
  public void setHOPDwellSchCovItemCovCosts(entity.HOPDwellSchCovItemCovCost[] value) {
    __getInternalInterface().setFieldValue(HOPDWELLSCHCOVITEMCOVCOSTS_PROP.get(), value);
  }
  ...
  public void setHOPDwellScheduleCovItem(entity.HOPDwellScheduleCovItem value) {
    __getInternalInterface().setFieldValue(HOPDWELLSCHEDULECOVITEM_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.HOPDwellSchCovItemCov value) {
  ...
  public entity.HOPDwellSchCovItemCov split(java.util.Date splitDate) {
    return (entity.HOPDwellSchCovItemCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPDwellSchCovItemCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPDwellSchCovItemCov.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getHOPDwellScheduleCovItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(HOPDWELLSCHEDULECOVITEM_PROP.get());
    }
    ...
    public void setHOPDwellScheduleCovItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(HOPDWELLSCHEDULECOVITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.hop.schedule.HOPDwellSchCovItemCovCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.hop.schedule.HOPDwellSchCovItemCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.hop.schedule.HOPDwellSchCovItemCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.hop.schedule.HOPDwellSchCovItemCovCoverageAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPDwellSchCovItemCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPDwellSchCovItemCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPDwellSchCovItemCov.class, config);
    com.guidewire._generated.entity.HOPDwellSchCovItemCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPDwellSchCovItemCov, com.guidewire._generated.entity.HOPDwellSchCovItemCovInternal>() {
      public java.lang.Object getImplementation(entity.HOPDwellSchCovItemCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPDwellSchCovItemCovInternal getInternalInterface(entity.HOPDwellSchCovItemCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPDwellSchCovItemCov newEmptyInstance() {
        return new entity.HOPDwellSchCovItemCov((java.lang.Void)null);
      }

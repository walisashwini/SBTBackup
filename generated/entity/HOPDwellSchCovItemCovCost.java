 ...
 * Cost for HOP Dwelling coverage scheduled items with coverage terms
 */
...
@gw.entity.EntityName(value = "HOPDwellSchCovItemCovCost")
public class HOPDwellSchCovItemCovCost extends entity.HOPCost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPDwellSchCovItemCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPDwellSchCovItemCovCost, entity.PolicyPeriod>("entity.HOPDwellSchCovItemCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> HOPDWELLSCHCOVITEMCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "HOPDwellSchCovItemCov");
   ...
   */
  public HOPDwellSchCovItemCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPDwellSchCovItemCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPDwellSchCovItemCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPDwellSchCovItemCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPDwellSchCovItemCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPDwellSchCovItemCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.HOPDwellSchCovItemCovCost clone() {
    return (entity.HOPDwellSchCovItemCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.HOPDwellSchCovItemCovCost getBasedOn() {
    return (entity.HOPDwellSchCovItemCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPDwellSchCovItemCovCost getSlice(java.util.Date sliceDate) {
    return (entity.HOPDwellSchCovItemCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.HOPDwellSchCovItemCovCost getUnsliced() {
    return (entity.HOPDwellSchCovItemCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.HOPDwellSchCovItemCovCostVersionList getVersionList() {
    return (entity.windowed.HOPDwellSchCovItemCovCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.HOPDwellSchCovItemCovCost split(java.util.Date splitDate) {
    return (entity.HOPDwellSchCovItemCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPDwellSchCovItemCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPDwellSchCovItemCovCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPDwellSchCovItemCovCost.class, config);
    com.guidewire._generated.entity.HOPDwellSchCovItemCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPDwellSchCovItemCovCost, com.guidewire._generated.entity.HOPDwellSchCovItemCovCostInternal>() {
      public java.lang.Object getImplementation(entity.HOPDwellSchCovItemCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPDwellSchCovItemCovCostInternal getInternalInterface(entity.HOPDwellSchCovItemCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPDwellSchCovItemCovCost newEmptyInstance() {
        return new entity.HOPDwellSchCovItemCovCost((java.lang.Void)null);
      }

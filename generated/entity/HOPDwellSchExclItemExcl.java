...
/**
 * HOPDwellSchExclItemExcl
 * HOP Dwelling exclusion scheduled item with coverage terms
 */
...
@gw.entity.EntityName(value = "HOPDwellSchExclItemExcl")
public class HOPDwellSchExclItemExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, entity.ScheduledItemClause, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPDwellSchExclItemExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPDwellSchExclItemExcl, entity.PolicyPeriod>("entity.HOPDwellSchExclItemExcl");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> HOPDWELLSCHEDULEEXCLITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "HOPDwellScheduleExclItem");
  ...
  private com.guidewire._generated.entity.HOPDwellSchExclItemExclInternal _internal;
   ...
   */
  protected HOPDwellSchExclItemExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected HOPDwellSchExclItemExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected HOPDwellSchExclItemExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPDwellSchExclItemExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPDwellSchExclItemExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPDwellSchExclItemExcl clone() {
    return (entity.HOPDwellSchExclItemExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPDwellSchExclItemExcl getBasedOn() {
    return (entity.HOPDwellSchExclItemExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPDwellSchExclItemExcl getBasedOnValue() {
    return (entity.HOPDwellSchExclItemExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.HOPDwellSchExclItemExcl getFixed() {
    return (entity.HOPDwellSchExclItemExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.HOPDwellScheduleExclItem getHOPDwellScheduleExclItem() {
    return (entity.HOPDwellScheduleExclItem)__getInternalInterface().getFieldValue(HOPDWELLSCHEDULEEXCLITEM_PROP.get());
  }
  ...
  public entity.HOPDwellSchExclItemExcl getSlice(java.util.Date sliceDate) {
    return (entity.HOPDwellSchExclItemExcl)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.HOPDwellSchExclItemExcl getSubtype() {
    return (typekey.HOPDwellSchExclItemExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.HOPDwellSchExclItemExcl getUnsliced() {
    return (entity.HOPDwellSchExclItemExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPDwellSchExclItemExclVersionList getVersionList() {
    return (entity.windowed.HOPDwellSchExclItemExclVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPDwellSchExclItemExcl value) {
   ...
   */
  private void setFixed(entity.HOPDwellSchExclItemExcl value) {
  ...
  public void setHOPDwellScheduleExclItem(entity.HOPDwellScheduleExclItem value) {
    __getInternalInterface().setFieldValue(HOPDWELLSCHEDULEEXCLITEM_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.HOPDwellSchExclItemExcl value) {
  ...
  public entity.HOPDwellSchExclItemExcl split(java.util.Date splitDate) {
    return (entity.HOPDwellSchExclItemExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPDwellSchExclItemExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPDwellSchExclItemExcl.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getHOPDwellScheduleExclItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(HOPDWELLSCHEDULEEXCLITEM_PROP.get());
    }
    ...
    public void setHOPDwellScheduleExclItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(HOPDWELLSCHEDULEEXCLITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.hop.schedule.HOPDwellSchExclItemExclExclusionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.hop.schedule.HOPDwellSchExclItemExclExclusionAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.hop.schedule.HOPDwellSchExclItemExclExclusionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPDwellSchExclItemExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPDwellSchExclItemExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPDwellSchExclItemExcl.class, config);
    com.guidewire._generated.entity.HOPDwellSchExclItemExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPDwellSchExclItemExcl, com.guidewire._generated.entity.HOPDwellSchExclItemExclInternal>() {
      public java.lang.Object getImplementation(entity.HOPDwellSchExclItemExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPDwellSchExclItemExclInternal getInternalInterface(entity.HOPDwellSchExclItemExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPDwellSchExclItemExcl newEmptyInstance() {
        return new entity.HOPDwellSchExclItemExcl((java.lang.Void)null);
      }

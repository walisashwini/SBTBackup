 ...
 * Non peril coverage cost for HOP Dwelling coverage scheduled items with coverage terms
 */
...
@gw.entity.EntityName(value = "HOPDwellSchNonPerilCovItemCovCost")
public class HOPDwellSchNonPerilCovItemCovCost extends entity.HOPDwellSchCovItemCovCost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPDwellSchNonPerilCovItemCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPDwellSchNonPerilCovItemCovCost, entity.PolicyPeriod>("entity.HOPDwellSchNonPerilCovItemCovCost");
   ...
   */
  public HOPDwellSchNonPerilCovItemCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPDwellSchNonPerilCovItemCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPDwellSchNonPerilCovItemCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPDwellSchNonPerilCovItemCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPDwellSchNonPerilCovItemCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPDwellSchNonPerilCovItemCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.HOPDwellSchNonPerilCovItemCovCost clone() {
    return (entity.HOPDwellSchNonPerilCovItemCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.HOPDwellSchNonPerilCovItemCovCost getBasedOn() {
    return (entity.HOPDwellSchNonPerilCovItemCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPDwellSchNonPerilCovItemCovCost getSlice(java.util.Date sliceDate) {
    return (entity.HOPDwellSchNonPerilCovItemCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.HOPDwellSchNonPerilCovItemCovCost getUnsliced() {
    return (entity.HOPDwellSchNonPerilCovItemCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.HOPDwellSchNonPerilCovItemCovCostVersionList getVersionList() {
    return (entity.windowed.HOPDwellSchNonPerilCovItemCovCostVersionList)getVersionListUntyped();
  }
  
  public entity.HOPDwellSchNonPerilCovItemCovCost split(java.util.Date splitDate) {
    return (entity.HOPDwellSchNonPerilCovItemCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPDwellSchNonPerilCovItemCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPDwellSchNonPerilCovItemCovCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPDwellSchNonPerilCovItemCovCost.class, config);
    com.guidewire._generated.entity.HOPDwellSchNonPerilCovItemCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPDwellSchNonPerilCovItemCovCost, com.guidewire._generated.entity.HOPDwellSchNonPerilCovItemCovCostInternal>() {
      public java.lang.Object getImplementation(entity.HOPDwellSchNonPerilCovItemCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPDwellSchNonPerilCovItemCovCostInternal getInternalInterface(entity.HOPDwellSchNonPerilCovItemCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPDwellSchNonPerilCovItemCovCost newEmptyInstance() {
        return new entity.HOPDwellSchNonPerilCovItemCovCost((java.lang.Void)null);
      }

 ...
 * Peril coverage cost for HOP Dwelling coverage scheduled items with coverage terms
 */
...
@gw.entity.EntityName(value = "HOPDwellSchPerilCovItemCovCost")
public class HOPDwellSchPerilCovItemCovCost extends entity.HOPDwellSchCovItemCovCost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPDwellSchPerilCovItemCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPDwellSchPerilCovItemCovCost, entity.PolicyPeriod>("entity.HOPDwellSchPerilCovItemCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> RATEDPERIL_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "RatedPeril");
   ...
   */
  public HOPDwellSchPerilCovItemCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPDwellSchPerilCovItemCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPDwellSchPerilCovItemCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPDwellSchPerilCovItemCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPDwellSchPerilCovItemCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPDwellSchPerilCovItemCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.HOPDwellSchPerilCovItemCovCost clone() {
    return (entity.HOPDwellSchPerilCovItemCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.HOPDwellSchPerilCovItemCovCost getBasedOn() {
    return (entity.HOPDwellSchPerilCovItemCovCost)__getInternalInterface().getBasedOnUntyped();
  }
   ...
   * Rated peril for dwelling coverage scheduled item with coverage terms
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.RatedPeril getRatedPeril() {
    return (typekey.RatedPeril)__getInternalInterface().getFieldValue(RATEDPERIL_PROP.get());
  }
  
  public entity.HOPDwellSchPerilCovItemCovCost getSlice(java.util.Date sliceDate) {
    return (entity.HOPDwellSchPerilCovItemCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.HOPDwellSchPerilCovItemCovCost getUnsliced() {
    return (entity.HOPDwellSchPerilCovItemCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.HOPDwellSchPerilCovItemCovCostVersionList getVersionList() {
    return (entity.windowed.HOPDwellSchPerilCovItemCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setRatedPeril(typekey.RatedPeril value) {
    __getInternalInterface().setFieldValue(RATEDPERIL_PROP.get(), value);
  }
  
  public entity.HOPDwellSchPerilCovItemCovCost split(java.util.Date splitDate) {
    return (entity.HOPDwellSchPerilCovItemCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPDwellSchPerilCovItemCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPDwellSchPerilCovItemCovCost.this.__getDelegateManager();
    }
    ...
    public entity.HOPCost getBasedOnValue() {
      return (entity.HOPCost)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public entity.HOPCost getFixed() {
      return (entity.HOPCost)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public entity.HOPDwellSchCovItemCov getHOPDwellSchCovItemCov() {
      return (entity.HOPDwellSchCovItemCov)__getInternalInterface().getFieldValue(HOPDWELLSCHCOVITEMCOV_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getHOPDwellSchCovItemCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(HOPDWELLSCHCOVITEMCOV_PROP.get());
    }
    ...
    public typekey.HOPPremiumType getHOPPremiumType() {
      return (typekey.HOPPremiumType)__getInternalInterface().getFieldValue(HOPPREMIUMTYPE_PROP.get());
    }
    ...
    public typekey.Modification getModification() {
      return (typekey.Modification)__getInternalInterface().getFieldValue(MODIFICATION_PROP.get());
    }
    ...
    public typekey.HOPCost getSubtype() {
      return (typekey.HOPCost)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
    ...
    public entity.HOPTransaction[] getTransactions() {
      return (entity.HOPTransaction[])__getInternalInterface().getFieldValue(TRANSACTIONS_PROP.get());
    }
    ...
    public void setHOPDwellSchCovItemCov(entity.HOPDwellSchCovItemCov value) {
      __getInternalInterface().setFieldValue(HOPDWELLSCHCOVITEMCOV_PROP.get(), value);
    }
    
    public void setHOPDwellSchCovItemCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(HOPDWELLSCHCOVITEMCOV_PROP.get(), value);
    }
    ...
    public void setHOPPremiumType(typekey.HOPPremiumType value) {
      __getInternalInterface().setFieldValue(HOPPREMIUMTYPE_PROP.get(), value);
    }
    ...
    public void setModification(typekey.Modification value) {
      __getInternalInterface().setFieldValue(MODIFICATION_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.financials.CostAdapter", "gw.lob.hop.financials.HOPCostAdapter");
    config.put("gw.lob.hop.financials.HOPCostMethods", "gw.lob.hop.financials.HOPDwellSchCovItemCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPDwellSchPerilCovItemCovCost.class, config);
    com.guidewire._generated.entity.HOPDwellSchPerilCovItemCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPDwellSchPerilCovItemCovCost, com.guidewire._generated.entity.HOPDwellSchPerilCovItemCovCostInternal>() {
      public java.lang.Object getImplementation(entity.HOPDwellSchPerilCovItemCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPDwellSchPerilCovItemCovCostInternal getInternalInterface(entity.HOPDwellSchPerilCovItemCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPDwellSchPerilCovItemCovCost newEmptyInstance() {
        return new entity.HOPDwellSchPerilCovItemCovCost((java.lang.Void)null);
      }

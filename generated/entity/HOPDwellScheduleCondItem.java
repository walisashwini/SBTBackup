...
/**
 * HOPDwellScheduleCondItem
 * HOP Dwelling level condition scheduled item
 */
...
@gw.entity.EntityName(value = "HOPDwellScheduleCondItem")
public class HOPDwellScheduleCondItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.HOPScheduledItem, entity.ScheduledItem, entity.Coverable, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPDwellScheduleCondItem, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPDwellScheduleCondItem, entity.PolicyPeriod>("entity.HOPDwellScheduleCondItem");
  ...
  private com.guidewire._generated.entity.HOPDwellScheduleCondItemInternal _internal;
   ...
   */
  public HOPDwellScheduleCondItem(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPDwellScheduleCondItem(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPDwellScheduleCondItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPDwellScheduleCondItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPDwellScheduleCondItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPDwellScheduleCondItem clone() {
    return (entity.HOPDwellScheduleCondItem)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPDwellScheduleCondItem getBasedOn() {
    return (entity.HOPDwellScheduleCondItem)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPDwellScheduleCondItem getBasedOnValue() {
    return (entity.HOPDwellScheduleCondItem)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.HOPDwellScheduleCondItem getFixed() {
    return (entity.HOPDwellScheduleCondItem)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.HOPDwellingScheduleCond getSchedule() {
    return (entity.HOPDwellingScheduleCond)__getInternalInterface().getFieldValue(SCHEDULE_PROP.get());
  }
  ...
  public entity.HOPDwellSchCondItemCond getScheduledItemClause() {
    return (entity.HOPDwellSchCondItemCond)__getInternalInterface().getFieldValue(SCHEDULEDITEMCLAUSE_PROP.get());
  }
  ...
  public entity.HOPDwellSchCondItemCond[] getScheduledItemClauseArray() {
    return (entity.HOPDwellSchCondItemCond[])__getInternalInterface().getFieldValue(SCHEDULEDITEMCLAUSEARRAY_PROP.get());
  }
  ...
  public entity.HOPDwellScheduleCondItem getSlice(java.util.Date sliceDate) {
    return (entity.HOPDwellScheduleCondItem)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.HOPDwellScheduleCondItem getSubtype() {
    return (typekey.HOPDwellScheduleCondItem)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.HOPDwellScheduleCondItem getUnsliced() {
    return (entity.HOPDwellScheduleCondItem)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPDwellScheduleCondItemVersionList getVersionList() {
    return (entity.windowed.HOPDwellScheduleCondItemVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPDwellScheduleCondItem value) {
   ...
   */
  private void setFixed(entity.HOPDwellScheduleCondItem value) {
   ...
   */
  private void setScheduledItemClauseArray(entity.HOPDwellSchCondItemCond[] value) {
   ...
   */
  private void setSubtype(typekey.HOPDwellScheduleCondItem value) {
  ...
  public entity.HOPDwellScheduleCondItem split(java.util.Date splitDate) {
    return (entity.HOPDwellScheduleCondItem)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPDwellScheduleCondItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPDwellScheduleCondItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.hop.schedule.HOPDwellScheduleCondItemCoverableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.hop.schedule.HOPDwellScheduleCondItemCoverableAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPDwellScheduleCondItemMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPDwellScheduleCondItemMatcher");
    config.put("gw.api.productmodel.ScheduledItemAdapter", "gw.lob.hop.schedule.HOPDwellScheduleCondItemCoverableAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPDwellScheduleCondItem.class, config);
    com.guidewire._generated.entity.HOPDwellScheduleCondItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPDwellScheduleCondItem, com.guidewire._generated.entity.HOPDwellScheduleCondItemInternal>() {
      public java.lang.Object getImplementation(entity.HOPDwellScheduleCondItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPDwellScheduleCondItemInternal getInternalInterface(entity.HOPDwellScheduleCondItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPDwellScheduleCondItem newEmptyInstance() {
        return new entity.HOPDwellScheduleCondItem((java.lang.Void)null);
      }

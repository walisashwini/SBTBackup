 ...
 * HOP Dwelling level coverage scheduled item
 */
...
@gw.entity.EntityName(value = "HOPDwellScheduleCovItem")
public class HOPDwellScheduleCovItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.HOPScheduledItem, entity.ScheduledItem, entity.Coverable, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPDwellScheduleCovItem, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPDwellScheduleCovItem, entity.PolicyPeriod>("entity.HOPDwellScheduleCovItem");
  ...
  private com.guidewire._generated.entity.HOPDwellScheduleCovItemInternal _internal;
   ...
   */
  public HOPDwellScheduleCovItem(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPDwellScheduleCovItem(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPDwellScheduleCovItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPDwellScheduleCovItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPDwellScheduleCovItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPDwellScheduleCovItem clone() {
    return (entity.HOPDwellScheduleCovItem)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPDwellScheduleCovItem getBasedOn() {
    return (entity.HOPDwellScheduleCovItem)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPDwellScheduleCovItem getBasedOnValue() {
    return (entity.HOPDwellScheduleCovItem)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.HOPDwellScheduleCovItem getFixed() {
    return (entity.HOPDwellScheduleCovItem)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.HOPDwellingScheduleCov getSchedule() {
    return (entity.HOPDwellingScheduleCov)__getInternalInterface().getFieldValue(SCHEDULE_PROP.get());
  }
  ...
  public entity.HOPDwellSchCovItemCov getScheduledItemClause() {
    return (entity.HOPDwellSchCovItemCov)__getInternalInterface().getFieldValue(SCHEDULEDITEMCLAUSE_PROP.get());
  }
  ...
  public entity.HOPDwellSchCovItemCov[] getScheduledItemClauseArray() {
    return (entity.HOPDwellSchCovItemCov[])__getInternalInterface().getFieldValue(SCHEDULEDITEMCLAUSEARRAY_PROP.get());
  }
  ...
  public entity.HOPDwellScheduleCovItem getSlice(java.util.Date sliceDate) {
    return (entity.HOPDwellScheduleCovItem)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.HOPDwellScheduleCovItem getSubtype() {
    return (typekey.HOPDwellScheduleCovItem)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.HOPDwellScheduleCovItem getUnsliced() {
    return (entity.HOPDwellScheduleCovItem)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPDwellScheduleCovItemVersionList getVersionList() {
    return (entity.windowed.HOPDwellScheduleCovItemVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPDwellScheduleCovItem value) {
   ...
   */
  private void setFixed(entity.HOPDwellScheduleCovItem value) {
   ...
   */
  private void setScheduledItemClauseArray(entity.HOPDwellSchCovItemCov[] value) {
   ...
   */
  private void setSubtype(typekey.HOPDwellScheduleCovItem value) {
  ...
  public entity.HOPDwellScheduleCovItem split(java.util.Date splitDate) {
    return (entity.HOPDwellScheduleCovItem)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPDwellScheduleCovItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPDwellScheduleCovItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.hop.schedule.HOPDwellScheduleCovItemCoverableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.hop.schedule.HOPDwellScheduleCovItemCoverableAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPDwellScheduleCovItemMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPDwellScheduleCovItemMatcher");
    config.put("gw.api.productmodel.ScheduledItemAdapter", "gw.lob.hop.schedule.HOPDwellScheduleCovItemCoverableAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPDwellScheduleCovItem.class, config);
    com.guidewire._generated.entity.HOPDwellScheduleCovItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPDwellScheduleCovItem, com.guidewire._generated.entity.HOPDwellScheduleCovItemInternal>() {
      public java.lang.Object getImplementation(entity.HOPDwellScheduleCovItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPDwellScheduleCovItemInternal getInternalInterface(entity.HOPDwellScheduleCovItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPDwellScheduleCovItem newEmptyInstance() {
        return new entity.HOPDwellScheduleCovItem((java.lang.Void)null);
      }

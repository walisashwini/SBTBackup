...
/**
 * HOPDwellingCond
 * Conditions directly attached to each Dwelling
 */
...
@gw.entity.EntityName(value = "HOPDwellingCond")
public class HOPDwellingCond extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PolicyCondition, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPDwellingCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPDwellingCond, entity.PolicyPeriod>("entity.HOPDwellingCond");
  ...
  private com.guidewire._generated.entity.HOPDwellingCondInternal _internal;
   ...
   */
  protected HOPDwellingCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected HOPDwellingCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected HOPDwellingCond(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPDwellingCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPDwellingCondInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPDwellingCond clone() {
    return (entity.HOPDwellingCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPDwellingCond getBasedOn() {
    return (entity.HOPDwellingCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPDwellingCond getBasedOnValue() {
    return (entity.HOPDwellingCond)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPDwellingCond getFixed() {
    return (entity.HOPDwellingCond)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.HOPDwellingCond getSlice(java.util.Date sliceDate) {
    return (entity.HOPDwellingCond)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.HOPDwellingCond getSubtype() {
    return (typekey.HOPDwellingCond)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.HOPDwellingCond getUnsliced() {
    return (entity.HOPDwellingCond)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPDwellingCondVersionList getVersionList() {
    return (entity.windowed.HOPDwellingCondVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPDwellingCond value) {
   ...
   */
  private void setFixed(entity.HOPDwellingCond value) {
   ...
   */
  private void setSubtype(typekey.HOPDwellingCond value) {
  ...
  public entity.HOPDwellingCond split(java.util.Date splitDate) {
    return (entity.HOPDwellingCond)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPDwellingCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPDwellingCond.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.HOPDwellingCond value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.HOPDwellingCond value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.HOPDwellingCond value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.hop.HOPDwellingCondConditionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.hop.HOPDwellingCondConditionAdapter");
    config.put("gw.api.domain.PolicyConditionAdapter", "gw.lob.hop.HOPDwellingCondConditionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPDwellingCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPDwellingCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPDwellingCond.class, config);
    com.guidewire._generated.entity.HOPDwellingCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPDwellingCond, com.guidewire._generated.entity.HOPDwellingCondInternal>() {
      public java.lang.Object getImplementation(entity.HOPDwellingCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPDwellingCondInternal getInternalInterface(entity.HOPDwellingCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPDwellingCond newEmptyInstance() {
        return new entity.HOPDwellingCond((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "HOPDwellingCovCost")
public class HOPDwellingCovCost extends entity.HOPCost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPDwellingCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPDwellingCovCost, entity.PolicyPeriod>("entity.HOPDwellingCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> HOPDWELLINGCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "HOPDwellingCov");
   ...
   */
  public HOPDwellingCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPDwellingCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPDwellingCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPDwellingCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPDwellingCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPDwellingCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.HOPDwellingCovCost clone() {
    return (entity.HOPDwellingCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.HOPDwellingCovCost getBasedOn() {
    return (entity.HOPDwellingCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPDwellingCovCost getSlice(java.util.Date sliceDate) {
    return (entity.HOPDwellingCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.HOPDwellingCovCost getUnsliced() {
    return (entity.HOPDwellingCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.HOPDwellingCovCostVersionList getVersionList() {
    return (entity.windowed.HOPDwellingCovCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.HOPDwellingCovCost split(java.util.Date splitDate) {
    return (entity.HOPDwellingCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPDwellingCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPDwellingCovCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPDwellingCovCost.class, config);
    com.guidewire._generated.entity.HOPDwellingCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPDwellingCovCost, com.guidewire._generated.entity.HOPDwellingCovCostInternal>() {
      public java.lang.Object getImplementation(entity.HOPDwellingCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPDwellingCovCostInternal getInternalInterface(entity.HOPDwellingCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPDwellingCovCost newEmptyInstance() {
        return new entity.HOPDwellingCovCost((java.lang.Void)null);
      }

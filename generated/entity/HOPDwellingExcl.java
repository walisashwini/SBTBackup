...
/**
 * HOPDwellingExcl
 * Exclusions directly attached to each Dwelling
 */
...
@gw.entity.EntityName(value = "HOPDwellingExcl")
public class HOPDwellingExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPDwellingExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPDwellingExcl, entity.PolicyPeriod>("entity.HOPDwellingExcl");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> HOPDWELLING_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "HOPDwelling");
  ...
  private com.guidewire._generated.entity.HOPDwellingExclInternal _internal;
   ...
   */
  protected HOPDwellingExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected HOPDwellingExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected HOPDwellingExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPDwellingExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPDwellingExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPDwellingExcl clone() {
    return (entity.HOPDwellingExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPDwellingExcl getBasedOn() {
    return (entity.HOPDwellingExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPDwellingExcl getBasedOnValue() {
    return (entity.HOPDwellingExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPDwellingExcl getFixed() {
    return (entity.HOPDwellingExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.HOPDwelling getHOPDwelling() {
    return (entity.HOPDwelling)__getInternalInterface().getFieldValue(HOPDWELLING_PROP.get());
  }
  ...
  public entity.HOPDwellingExcl getSlice(java.util.Date sliceDate) {
    return (entity.HOPDwellingExcl)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.HOPDwellingExcl getSubtype() {
    return (typekey.HOPDwellingExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.HOPDwellingExcl getUnsliced() {
    return (entity.HOPDwellingExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPDwellingExclVersionList getVersionList() {
    return (entity.windowed.HOPDwellingExclVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPDwellingExcl value) {
   ...
   */
  private void setFixed(entity.HOPDwellingExcl value) {
  ...
  public void setHOPDwelling(entity.HOPDwelling value) {
    __getInternalInterface().setFieldValue(HOPDWELLING_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.HOPDwellingExcl value) {
  ...
  public entity.HOPDwellingExcl split(java.util.Date splitDate) {
    return (entity.HOPDwellingExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPDwellingExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPDwellingExcl.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getHOPDwellingID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(HOPDWELLING_PROP.get());
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.HOPDwellingExcl value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.HOPDwellingExcl value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
    ...
    public void setHOPDwellingID(gw.pl.persistence.core.Key value) {
      setFieldValue(HOPDWELLING_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.HOPDwellingExcl value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.hop.HOPDwellingExclExclusionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.hop.HOPDwellingExclExclusionAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.hop.HOPDwellingExclExclusionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPDwellingExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPDwellingExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPDwellingExcl.class, config);
    com.guidewire._generated.entity.HOPDwellingExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPDwellingExcl, com.guidewire._generated.entity.HOPDwellingExclInternal>() {
      public java.lang.Object getImplementation(entity.HOPDwellingExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPDwellingExclInternal getInternalInterface(entity.HOPDwellingExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPDwellingExcl newEmptyInstance() {
        return new entity.HOPDwellingExcl((java.lang.Void)null);
      }

...
/**
 * HOPDwellingModifierCost
 * Costs for Dwelling modifiers
 */
...
@gw.entity.EntityName(value = "HOPDwellingModifierCost")
public class HOPDwellingModifierCost extends entity.HOPCost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPDwellingModifierCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPDwellingModifierCost, entity.PolicyPeriod>("entity.HOPDwellingModifierCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> HOPDWELLINGMOD_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "HOPDwellingMod");
   ...
   */
  public HOPDwellingModifierCost(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPDwellingModifierCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPDwellingModifierCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPDwellingModifierCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPDwellingModifierCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPDwellingModifierCostInternal)super.__getInternalInterface();
  }
  
  public entity.HOPDwellingModifierCost clone() {
    return (entity.HOPDwellingModifierCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.HOPDwellingModifierCost getBasedOn() {
    return (entity.HOPDwellingModifierCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPDwellingMod getHOPDwellingMod() {
    return (entity.HOPDwellingMod)__getInternalInterface().getFieldValue(HOPDWELLINGMOD_PROP.get());
  }
  
  public entity.HOPDwellingModifierCost getSlice(java.util.Date sliceDate) {
    return (entity.HOPDwellingModifierCost)getSliceUntyped(sliceDate);
  }
  
  public entity.HOPDwellingModifierCost getUnsliced() {
    return (entity.HOPDwellingModifierCost)getUnslicedUntyped();
  }
  
  public entity.windowed.HOPDwellingModifierCostVersionList getVersionList() {
    return (entity.windowed.HOPDwellingModifierCostVersionList)getVersionListUntyped();
  }
  ...
  public void setHOPDwellingMod(entity.HOPDwellingMod value) {
    __getInternalInterface().setFieldValue(HOPDWELLINGMOD_PROP.get(), value);
  }
  
  public entity.HOPDwellingModifierCost split(java.util.Date splitDate) {
    return (entity.HOPDwellingModifierCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPDwellingModifierCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPDwellingModifierCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getHOPDwellingModID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(HOPDWELLINGMOD_PROP.get());
    }
    ...
    public void setHOPDwellingModID(gw.pl.persistence.core.Key value) {
      setFieldValue(HOPDWELLINGMOD_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.hop.financials.HOPCostMethods", "gw.lob.hop.financials.HOPCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPDwellingModifierCost.class, config);
    com.guidewire._generated.entity.HOPDwellingModifierCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPDwellingModifierCost, com.guidewire._generated.entity.HOPDwellingModifierCostInternal>() {
      public java.lang.Object getImplementation(entity.HOPDwellingModifierCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPDwellingModifierCostInternal getInternalInterface(entity.HOPDwellingModifierCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPDwellingModifierCost newEmptyInstance() {
        return new entity.HOPDwellingModifierCost((java.lang.Void)null);
      }

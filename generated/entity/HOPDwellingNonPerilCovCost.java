...
/**
 * HOPDwellingNonPerilCovCost
 * Non peril coverage cost for dwelling
 */
...
@gw.entity.EntityName(value = "HOPDwellingNonPerilCovCost")
public class HOPDwellingNonPerilCovCost extends entity.HOPDwellingCovCost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPDwellingNonPerilCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPDwellingNonPerilCovCost, entity.PolicyPeriod>("entity.HOPDwellingNonPerilCovCost");
   ...
   */
  public HOPDwellingNonPerilCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPDwellingNonPerilCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPDwellingNonPerilCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPDwellingNonPerilCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPDwellingNonPerilCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPDwellingNonPerilCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.HOPDwellingNonPerilCovCost clone() {
    return (entity.HOPDwellingNonPerilCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.HOPDwellingNonPerilCovCost getBasedOn() {
    return (entity.HOPDwellingNonPerilCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPDwellingNonPerilCovCost getSlice(java.util.Date sliceDate) {
    return (entity.HOPDwellingNonPerilCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.HOPDwellingNonPerilCovCost getUnsliced() {
    return (entity.HOPDwellingNonPerilCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.HOPDwellingNonPerilCovCostVersionList getVersionList() {
    return (entity.windowed.HOPDwellingNonPerilCovCostVersionList)getVersionListUntyped();
  }
  
  public entity.HOPDwellingNonPerilCovCost split(java.util.Date splitDate) {
    return (entity.HOPDwellingNonPerilCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPDwellingNonPerilCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPDwellingNonPerilCovCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPDwellingNonPerilCovCost.class, config);
    com.guidewire._generated.entity.HOPDwellingNonPerilCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPDwellingNonPerilCovCost, com.guidewire._generated.entity.HOPDwellingNonPerilCovCostInternal>() {
      public java.lang.Object getImplementation(entity.HOPDwellingNonPerilCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPDwellingNonPerilCovCostInternal getInternalInterface(entity.HOPDwellingNonPerilCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPDwellingNonPerilCovCost newEmptyInstance() {
        return new entity.HOPDwellingNonPerilCovCost((java.lang.Void)null);
      }

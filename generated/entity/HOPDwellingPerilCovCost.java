...
/**
 * HOPDwellingPerilCovCost
 * Peril coverage cost for dwelling
 */
...
@gw.entity.EntityName(value = "HOPDwellingPerilCovCost")
public class HOPDwellingPerilCovCost extends entity.HOPDwellingCovCost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPDwellingPerilCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPDwellingPerilCovCost, entity.PolicyPeriod>("entity.HOPDwellingPerilCovCost");
   ...
   */
  public HOPDwellingPerilCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPDwellingPerilCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPDwellingPerilCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPDwellingPerilCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPDwellingPerilCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPDwellingPerilCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.HOPDwellingPerilCovCost clone() {
    return (entity.HOPDwellingPerilCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.HOPDwellingPerilCovCost getBasedOn() {
    return (entity.HOPDwellingPerilCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPDwellingPerilCovCost getSlice(java.util.Date sliceDate) {
    return (entity.HOPDwellingPerilCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.HOPDwellingPerilCovCost getUnsliced() {
    return (entity.HOPDwellingPerilCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.HOPDwellingPerilCovCostVersionList getVersionList() {
    return (entity.windowed.HOPDwellingPerilCovCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.HOPDwellingPerilCovCost split(java.util.Date splitDate) {
    return (entity.HOPDwellingPerilCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPDwellingPerilCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPDwellingPerilCovCost.this.__getDelegateManager();
    }
    ...
    public entity.HOPDwellingCov getHOPDwellingCov() {
      return (entity.HOPDwellingCov)__getInternalInterface().getFieldValue(HOPDWELLINGCOV_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getHOPDwellingCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(HOPDWELLINGCOV_PROP.get());
    }
    ...
    public void setHOPDwellingCov(entity.HOPDwellingCov value) {
      __getInternalInterface().setFieldValue(HOPDWELLINGCOV_PROP.get(), value);
    }
    
    public void setHOPDwellingCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(HOPDWELLINGCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.hop.financials.HOPCostMethods", "gw.lob.hop.financials.HOPDwellingCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPDwellingPerilCovCost.class, config);
    com.guidewire._generated.entity.HOPDwellingPerilCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPDwellingPerilCovCost, com.guidewire._generated.entity.HOPDwellingPerilCovCostInternal>() {
      public java.lang.Object getImplementation(entity.HOPDwellingPerilCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPDwellingPerilCovCostInternal getInternalInterface(entity.HOPDwellingPerilCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPDwellingPerilCovCost newEmptyInstance() {
        return new entity.HOPDwellingPerilCovCost((java.lang.Void)null);
      }

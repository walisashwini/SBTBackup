...
/**
 * HOPDwellingRF
 * A rate factor is a risk characteristic and its associated numeric value which might have an impact on premium. As used here rate factors are applied to base premium rather than rates. A common example of Rate Factors are the components of IRPM (individual risk premium modifier).
 */
...
@gw.entity.EntityName(value = "HOPDwellingRF")
public class HOPDwellingRF extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.RateFactor, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPDwellingRF, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPDwellingRF, entity.PolicyPeriod>("entity.HOPDwellingRF");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ARCHIVEPARTITION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ArchivePartition");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ASSESSMENT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Assessment");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> HOPDWELLINGMODIFIER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "HOPDwellingModifier");
  ...
  private com.guidewire._generated.entity.HOPDwellingRFInternal _internal;
   ...
   */
  public HOPDwellingRF(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPDwellingRF(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPDwellingRF(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPDwellingRFInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPDwellingRFInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPDwellingRF clone() {
    return (entity.HOPDwellingRF)__getInternalInterface().cloneUntyped();
  }
  ...
  public java.math.BigDecimal getAssessment() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(ASSESSMENT_PROP.get());
  }
  ...
  public java.math.BigDecimal getAssessmentWithinLimits() {
    return ((com.guidewire.pc.domain.policy.entity.RateFactorPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.policy.entity.RateFactorPublicMethods")).getAssessmentWithinLimits();
  }
  
  public entity.HOPDwellingRF getBasedOn() {
    return (entity.HOPDwellingRF)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPDwellingRF getBasedOnValue() {
    return (entity.HOPDwellingRF)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPDwellingRF getFixed() {
    return (entity.HOPDwellingRF)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  /**
   * Gets the value of the HOPDwellingModifier field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPDwellingMod getHOPDwellingModifier() {
    return (entity.HOPDwellingMod)__getInternalInterface().getFieldValue(HOPDWELLINGMODIFIER_PROP.get());
  }
  ...
  public java.math.BigDecimal getMaximum() {
    return ((com.guidewire.pc.domain.policy.entity.RateFactorPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.policy.entity.RateFactorPublicMethods")).getMaximum();
  }
  ...
  public java.math.BigDecimal getMinimum() {
    return ((com.guidewire.pc.domain.policy.entity.RateFactorPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.policy.entity.RateFactorPublicMethods")).getMinimum();
  }
  
  public entity.Modifier getModifier() {
    return ((gw.api.domain.RateFactorAdapter)__getDelegateManager().getImplementation("gw.api.domain.RateFactorAdapter")).getModifier();
  }
  ...
  public gw.api.productmodel.RateFactorPatternBase getPattern() {
    return ((com.guidewire.pc.domain.policy.entity.RateFactorPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.policy.entity.RateFactorPublicMethods")).getPattern();
  }
  ...
  public typekey.RateFactorType getRateFactorType() {
    return ((com.guidewire.pc.domain.policy.entity.RateFactorPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.policy.entity.RateFactorPublicMethods")).getRateFactorType();
  }
  
  public entity.HOPDwellingRF getSlice(java.util.Date sliceDate) {
    return (entity.HOPDwellingRF)getSliceUntyped(sliceDate);
  }
  ...
  public entity.HOPDwellingRF getUnsliced() {
    return (entity.HOPDwellingRF)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPDwellingRFVersionList getVersionList() {
    return (entity.windowed.HOPDwellingRFVersionList)getVersionListUntyped();
  }
  ...
  public void setAssessmentWithinLimits(java.math.BigDecimal value) {
    ((com.guidewire.pc.domain.policy.entity.RateFactorPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.policy.entity.RateFactorPublicMethods")).setAssessmentWithinLimits(value);
  }
  
  /**
   * Sets the value of the BasedOnValue field.
   */
  private void setBasedOnValue(entity.HOPDwellingRF value) {
   ...
   */
  private void setFixed(entity.HOPDwellingRF value) {
  ...
  /**
   * Sets the value of the HOPDwellingModifier field.
   */
  public void setHOPDwellingModifier(entity.HOPDwellingMod value) {
    __getInternalInterface().setFieldValue(HOPDWELLINGMODIFIER_PROP.get(), value);
  }
  ...
  public void setPattern(gw.api.productmodel.RateFactorPatternBase pattern) {
    ((com.guidewire.pc.domain.policy.entity.RateFactorPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.policy.entity.RateFactorPublicMethods")).setPattern(pattern);
  }
  ...
  public entity.HOPDwellingRF split(java.util.Date splitDate) {
    return (entity.HOPDwellingRF)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPDwellingRFInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPDwellingRF.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getHOPDwellingModifierID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(HOPDWELLINGMODIFIER_PROP.get());
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.HOPDwellingRF value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.HOPDwellingRF value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
    ...
    public void setHOPDwellingModifierID(gw.pl.persistence.core.Key value) {
      setFieldValue(HOPDWELLINGMODIFIER_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.policy.entity.RateFactorPublicMethods", "com.guidewire.pc.domain.policy.impl.RateFactorImpl");
    config.put("com.guidewire.pc.domain.policy.impl.RateFactorInternalMethods", "com.guidewire.pc.domain.policy.impl.RateFactorImpl");
    ...
    config.put("gw.api.domain.RateFactorAdapter", "gw.lob.hop.HOPDwellingRateFactorAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPDwellingRateFactorMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPDwellingRateFactorMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPDwellingRF.class, config);
    com.guidewire._generated.entity.HOPDwellingRFInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPDwellingRF, com.guidewire._generated.entity.HOPDwellingRFInternal>() {
      public java.lang.Object getImplementation(entity.HOPDwellingRF bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPDwellingRFInternal getInternalInterface(entity.HOPDwellingRF bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPDwellingRF newEmptyInstance() {
        return new entity.HOPDwellingRF((java.lang.Void)null);
      }

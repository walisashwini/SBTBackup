...
/**
 * HOPDwellingScheduleCond
 * HOP Dwelling condition with a schedule
 */
...
@gw.entity.EntityName(value = "HOPDwellingScheduleCond")
public class HOPDwellingScheduleCond extends entity.HOPDwellingCond implements entity.ScheduleAutoNumberSequence, gw.api.domain.Schedule {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPDwellingScheduleCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPDwellingScheduleCond, entity.PolicyPeriod>("entity.HOPDwellingScheduleCond");
   ...
   */
  protected HOPDwellingScheduleCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected HOPDwellingScheduleCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected HOPDwellingScheduleCond(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPDwellingScheduleCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPDwellingScheduleCondInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPDwellingScheduleCondInternal)super.__getInternalInterface();
  }
  ...
  public entity.HOPDwellingScheduleCond clone() {
    return (entity.HOPDwellingScheduleCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPDwellingScheduleCond getBasedOn() {
    return (entity.HOPDwellingScheduleCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPDwellScheduleCondItem[] getHOPDwellScheduledItems() {
    return (entity.HOPDwellScheduleCondItem[])__getInternalInterface().getFieldValue(HOPDWELLSCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.HOPDwellingScheduleCond getSlice(java.util.Date sliceDate) {
    return (entity.HOPDwellingScheduleCond)getSliceUntyped(sliceDate);
  }
  
  public entity.HOPDwellingScheduleCond getUnsliced() {
    return (entity.HOPDwellingScheduleCond)getUnslicedUntyped();
  }
  
  public entity.windowed.HOPDwellingScheduleCondVersionList getVersionList() {
    return (entity.windowed.HOPDwellingScheduleCondVersionList)getVersionListUntyped();
  }
  ...
  public entity.HOPDwellingScheduleCond split(java.util.Date splitDate) {
    return (entity.HOPDwellingScheduleCond)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPDwellingScheduleCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPDwellingScheduleCond.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.Schedule", "gw.lob.hop.schedule.HOPDwellingScheduleCondImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPDwellingScheduleCond.class, config);
    com.guidewire._generated.entity.HOPDwellingScheduleCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPDwellingScheduleCond, com.guidewire._generated.entity.HOPDwellingScheduleCondInternal>() {
      public java.lang.Object getImplementation(entity.HOPDwellingScheduleCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPDwellingScheduleCondInternal getInternalInterface(entity.HOPDwellingScheduleCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPDwellingScheduleCond newEmptyInstance() {
        return new entity.HOPDwellingScheduleCond((java.lang.Void)null);
      }

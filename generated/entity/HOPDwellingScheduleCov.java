 ...
 * HOP Dwelling coverage with a schedule
 */
...
@gw.entity.EntityName(value = "HOPDwellingScheduleCov")
public class HOPDwellingScheduleCov extends entity.HOPDwellingCov implements entity.ScheduleAutoNumberSequence, gw.api.domain.Schedule {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPDwellingScheduleCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPDwellingScheduleCov, entity.PolicyPeriod>("entity.HOPDwellingScheduleCov");
   ...
   */
  protected HOPDwellingScheduleCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected HOPDwellingScheduleCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected HOPDwellingScheduleCov(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPDwellingScheduleCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPDwellingScheduleCovInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPDwellingScheduleCovInternal)super.__getInternalInterface();
  }
  ...
  public entity.HOPDwellingScheduleCov clone() {
    return (entity.HOPDwellingScheduleCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPDwellingScheduleCov getBasedOn() {
    return (entity.HOPDwellingScheduleCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPDwellScheduleCovItem[] getHOPDwellScheduledItems() {
    return (entity.HOPDwellScheduleCovItem[])__getInternalInterface().getFieldValue(HOPDWELLSCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.HOPDwellingScheduleCov getSlice(java.util.Date sliceDate) {
    return (entity.HOPDwellingScheduleCov)getSliceUntyped(sliceDate);
  }
  
  public entity.HOPDwellingScheduleCov getUnsliced() {
    return (entity.HOPDwellingScheduleCov)getUnslicedUntyped();
  }
  
  public entity.windowed.HOPDwellingScheduleCovVersionList getVersionList() {
    return (entity.windowed.HOPDwellingScheduleCovVersionList)getVersionListUntyped();
  }
  ...
  public entity.HOPDwellingScheduleCov split(java.util.Date splitDate) {
    return (entity.HOPDwellingScheduleCov)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPDwellingScheduleCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPDwellingScheduleCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.Schedule", "gw.lob.hop.schedule.HOPDwellingScheduleCovImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPDwellingScheduleCov.class, config);
    com.guidewire._generated.entity.HOPDwellingScheduleCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPDwellingScheduleCov, com.guidewire._generated.entity.HOPDwellingScheduleCovInternal>() {
      public java.lang.Object getImplementation(entity.HOPDwellingScheduleCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPDwellingScheduleCovInternal getInternalInterface(entity.HOPDwellingScheduleCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPDwellingScheduleCov newEmptyInstance() {
        return new entity.HOPDwellingScheduleCov((java.lang.Void)null);
      }

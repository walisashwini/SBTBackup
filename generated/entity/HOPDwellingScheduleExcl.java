...
/**
 * HOPDwellingScheduleExcl
 * HOP Dwelling exclusion with a schedule
 */
...
@gw.entity.EntityName(value = "HOPDwellingScheduleExcl")
public class HOPDwellingScheduleExcl extends entity.HOPDwellingExcl implements entity.ScheduleAutoNumberSequence, gw.api.domain.Schedule {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPDwellingScheduleExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPDwellingScheduleExcl, entity.PolicyPeriod>("entity.HOPDwellingScheduleExcl");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> HOPDWELLSCHEDULEDITEMS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "HOPDwellScheduledItems");
   ...
   */
  protected HOPDwellingScheduleExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected HOPDwellingScheduleExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected HOPDwellingScheduleExcl(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPDwellingScheduleExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPDwellingScheduleExclInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPDwellingScheduleExclInternal)super.__getInternalInterface();
  }
  ...
  public void addToHOPDwellScheduledItems(entity.HOPDwellScheduleExclItem element) {
    __getInternalInterface().addArrayElement(HOPDWELLSCHEDULEDITEMS_PROP.get(), element);
  }
  ...
  public entity.HOPDwellingScheduleExcl clone() {
    return (entity.HOPDwellingScheduleExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPDwellingScheduleExcl getBasedOn() {
    return (entity.HOPDwellingScheduleExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPDwellScheduleExclItem[] getHOPDwellScheduledItems() {
    return (entity.HOPDwellScheduleExclItem[])__getInternalInterface().getFieldValue(HOPDWELLSCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.HOPDwellingScheduleExcl getSlice(java.util.Date sliceDate) {
    return (entity.HOPDwellingScheduleExcl)getSliceUntyped(sliceDate);
  }
  
  public entity.HOPDwellingScheduleExcl getUnsliced() {
    return (entity.HOPDwellingScheduleExcl)getUnslicedUntyped();
  }
  
  public entity.windowed.HOPDwellingScheduleExclVersionList getVersionList() {
    return (entity.windowed.HOPDwellingScheduleExclVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromHOPDwellScheduledItems(entity.HOPDwellScheduleExclItem element) {
    __getInternalInterface().removeArrayElement(HOPDWELLSCHEDULEDITEMS_PROP.get(), element);
  }
  ...
  public void removeFromHOPDwellScheduledItems(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(HOPDWELLSCHEDULEDITEMS_PROP.get(), elementID);
  }
  ...
  public void setHOPDwellScheduledItems(entity.HOPDwellScheduleExclItem[] value) {
    __getInternalInterface().setFieldValue(HOPDWELLSCHEDULEDITEMS_PROP.get(), value);
  }
  ...
  public entity.HOPDwellingScheduleExcl split(java.util.Date splitDate) {
    return (entity.HOPDwellingScheduleExcl)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPDwellingScheduleExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPDwellingScheduleExcl.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.Schedule", "gw.lob.hop.schedule.HOPDwellingScheduleExclImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPDwellingScheduleExcl.class, config);
    com.guidewire._generated.entity.HOPDwellingScheduleExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPDwellingScheduleExcl, com.guidewire._generated.entity.HOPDwellingScheduleExclInternal>() {
      public java.lang.Object getImplementation(entity.HOPDwellingScheduleExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPDwellingScheduleExclInternal getInternalInterface(entity.HOPDwellingScheduleExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPDwellingScheduleExcl newEmptyInstance() {
        return new entity.HOPDwellingScheduleExcl((java.lang.Void)null);
      }

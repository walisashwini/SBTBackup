...
/**
 * HOPExclusionLookup
 * An availability lookup for HOP exclusion patterns.
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "HOPExclusionLookup.eti;HOPExclusionLookup.eix;HOPExclusionLookup.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "HOPExclusionLookup")
public class HOPExclusionLookup extends entity.ExclusionLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.HOPExclusionLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.HOPExclusionLookup>("entity.HOPExclusionLookup");
   ...
   */
  protected HOPExclusionLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected HOPExclusionLookup(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPExclusionLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPExclusionLookupInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPExclusionLookupInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPExclusionLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPExclusionLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPExclusionLookup.class, config);
    com.guidewire._generated.entity.HOPExclusionLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPExclusionLookup, com.guidewire._generated.entity.HOPExclusionLookupInternal>() {
      public java.lang.Object getImplementation(entity.HOPExclusionLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPExclusionLookupInternal getInternalInterface(entity.HOPExclusionLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPExclusionLookup newEmptyInstance() {
        return new entity.HOPExclusionLookup((java.lang.Void)null);
      }

...
/**
 * HOPLineCond
 * Conditions for the Homeowners line
 */
...
@gw.entity.EntityName(value = "HOPLineCond")
public class HOPLineCond extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PolicyCondition, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPLineCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPLineCond, entity.PolicyPeriod>("entity.HOPLineCond");
  ...
  private com.guidewire._generated.entity.HOPLineCondInternal _internal;
   ...
   */
  protected HOPLineCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected HOPLineCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected HOPLineCond(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPLineCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPLineCondInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPLineCond clone() {
    return (entity.HOPLineCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPLineCond getBasedOn() {
    return (entity.HOPLineCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPLineCond getSlice(java.util.Date sliceDate) {
    return (entity.HOPLineCond)getSliceUntyped(sliceDate);
  }
  ...
  public entity.HOPLineCond getUnsliced() {
    return (entity.HOPLineCond)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPLineCondVersionList getVersionList() {
    return (entity.windowed.HOPLineCondVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPLineCond value) {
   ...
   */
  private void setFixed(entity.HOPLineCond value) {
   ...
   */
  private void setSubtype(typekey.HOPLineCond value) {
  ...
  public entity.HOPLineCond split(java.util.Date splitDate) {
    return (entity.HOPLineCond)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPLineCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPLineCond.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPLineCond.class, config);
    com.guidewire._generated.entity.HOPLineCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPLineCond, com.guidewire._generated.entity.HOPLineCondInternal>() {
      public java.lang.Object getImplementation(entity.HOPLineCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPLineCondInternal getInternalInterface(entity.HOPLineCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPLineCond newEmptyInstance() {
        return new entity.HOPLineCond((java.lang.Void)null);
      }

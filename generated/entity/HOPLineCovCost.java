...
@gw.entity.EntityName(value = "HOPLineCovCost")
public class HOPLineCovCost extends entity.HOPCost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPLineCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPLineCovCost, entity.PolicyPeriod>("entity.HOPLineCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> HOPLINECOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "HOPLineCov");
   ...
   */
  public HOPLineCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPLineCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPLineCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPLineCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPLineCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPLineCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.HOPLineCovCost clone() {
    return (entity.HOPLineCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.HOPLineCovCost getBasedOn() {
    return (entity.HOPLineCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPLineCov getHOPLineCov() {
    return (entity.HOPLineCov)__getInternalInterface().getFieldValue(HOPLINECOV_PROP.get());
  }
  
  public entity.HOPLineCovCost getSlice(java.util.Date sliceDate) {
    return (entity.HOPLineCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.HOPLineCovCost getUnsliced() {
    return (entity.HOPLineCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.HOPLineCovCostVersionList getVersionList() {
    return (entity.windowed.HOPLineCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setHOPLineCov(entity.HOPLineCov value) {
    __getInternalInterface().setFieldValue(HOPLINECOV_PROP.get(), value);
  }
  
  public entity.HOPLineCovCost split(java.util.Date splitDate) {
    return (entity.HOPLineCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPLineCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPLineCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getHOPLineCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(HOPLINECOV_PROP.get());
    }
    ...
    public void setHOPLineCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(HOPLINECOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.hop.financials.HOPCostMethods", "gw.lob.hop.financials.HOPLineCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPLineCovCost.class, config);
    com.guidewire._generated.entity.HOPLineCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPLineCovCost, com.guidewire._generated.entity.HOPLineCovCostInternal>() {
      public java.lang.Object getImplementation(entity.HOPLineCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPLineCovCostInternal getInternalInterface(entity.HOPLineCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPLineCovCost newEmptyInstance() {
        return new entity.HOPLineCovCost((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "HOPLineMod")
public class HOPLineMod extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Modifier, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPLineMod, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPLineMod, entity.PolicyPeriod>("entity.HOPLineMod");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> HOPLINEMODIFIERCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "HOPLineModifierCosts");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> HOPLINERATEFACTORS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "HOPLineRateFactors");
  ...
  private com.guidewire._generated.entity.HOPLineModInternal _internal;
   ...
   */
  public HOPLineMod(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPLineMod(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPLineMod(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPLineModInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPLineModInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToHOPLineModifierCosts(entity.HOPLineModifierCost element) {
    __getInternalInterface().addArrayElement(HOPLINEMODIFIERCOSTS_PROP.get(), element);
  }
  ...
  public void addToHOPLineRateFactors(entity.HOPLineRF element) {
    __getInternalInterface().addArrayElement(HOPLINERATEFACTORS_PROP.get(), element);
  }
  ...
  public entity.HOPLineMod clone() {
    return (entity.HOPLineMod)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPLineMod getBasedOn() {
    return (entity.HOPLineMod)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPLineMod getBasedOnValue() {
    return (entity.HOPLineMod)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.HOPLineMod getFixed() {
    return (entity.HOPLineMod)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.HOPLineModifierCost[] getHOPLineModifierCosts() {
    return (entity.HOPLineModifierCost[])__getInternalInterface().getFieldValue(HOPLINEMODIFIERCOSTS_PROP.get());
  }
  ...
  public entity.HOPLineRF[] getHOPLineRateFactors() {
    return (entity.HOPLineRF[])__getInternalInterface().getFieldValue(HOPLINERATEFACTORS_PROP.get());
  }
  ...
  public entity.HOPLineMod getSlice(java.util.Date sliceDate) {
    return (entity.HOPLineMod)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.HOPLineMod getSubtype() {
    return (typekey.HOPLineMod)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.HOPLineMod getUnsliced() {
    return (entity.HOPLineMod)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPLineModVersionList getVersionList() {
    return (entity.windowed.HOPLineModVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromHOPLineModifierCosts(entity.HOPLineModifierCost element) {
    __getInternalInterface().removeArrayElement(HOPLINEMODIFIERCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromHOPLineModifierCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(HOPLINEMODIFIERCOSTS_PROP.get(), elementID);
  }
  ...
  public void removeFromHOPLineRateFactors(entity.HOPLineRF element) {
    __getInternalInterface().removeArrayElement(HOPLINERATEFACTORS_PROP.get(), element);
  }
  ...
  public void removeFromHOPLineRateFactors(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(HOPLINERATEFACTORS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.HOPLineMod value) {
   ...
   */
  private void setFixed(entity.HOPLineMod value) {
  ...
  public void setHOPLineModifierCosts(entity.HOPLineModifierCost[] value) {
    __getInternalInterface().setFieldValue(HOPLINEMODIFIERCOSTS_PROP.get(), value);
  }
  ...
  public void setHOPLineRateFactors(entity.HOPLineRF[] value) {
    __getInternalInterface().setFieldValue(HOPLINERATEFACTORS_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.HOPLineMod value) {
  ...
  public entity.HOPLineMod split(java.util.Date splitDate) {
    return (entity.HOPLineMod)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPLineModInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPLineMod.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ModifierAbstractDomainMethods", "gw.lob.hop.HOPLineModifierAdapter");
    config.put("gw.api.domain.ModifierAdapter", "gw.lob.hop.HOPLineModifierAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPLineModifierMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPLineModifierMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPLineMod.class, config);
    com.guidewire._generated.entity.HOPLineModInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPLineMod, com.guidewire._generated.entity.HOPLineModInternal>() {
      public java.lang.Object getImplementation(entity.HOPLineMod bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPLineModInternal getInternalInterface(entity.HOPLineMod bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPLineMod newEmptyInstance() {
        return new entity.HOPLineMod((java.lang.Void)null);
      }

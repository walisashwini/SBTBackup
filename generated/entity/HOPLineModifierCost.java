...
@gw.entity.EntityName(value = "HOPLineModifierCost")
public class HOPLineModifierCost extends entity.HOPCost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPLineModifierCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPLineModifierCost, entity.PolicyPeriod>("entity.HOPLineModifierCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> HOPLINEMOD_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "HOPLineMod");
   ...
   */
  public HOPLineModifierCost(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPLineModifierCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPLineModifierCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPLineModifierCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPLineModifierCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPLineModifierCostInternal)super.__getInternalInterface();
  }
  
  public entity.HOPLineModifierCost clone() {
    return (entity.HOPLineModifierCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.HOPLineModifierCost getBasedOn() {
    return (entity.HOPLineModifierCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPLineMod getHOPLineMod() {
    return (entity.HOPLineMod)__getInternalInterface().getFieldValue(HOPLINEMOD_PROP.get());
  }
  
  public entity.HOPLineModifierCost getSlice(java.util.Date sliceDate) {
    return (entity.HOPLineModifierCost)getSliceUntyped(sliceDate);
  }
  
  public entity.HOPLineModifierCost getUnsliced() {
    return (entity.HOPLineModifierCost)getUnslicedUntyped();
  }
  
  public entity.windowed.HOPLineModifierCostVersionList getVersionList() {
    return (entity.windowed.HOPLineModifierCostVersionList)getVersionListUntyped();
  }
  ...
  public void setHOPLineMod(entity.HOPLineMod value) {
    __getInternalInterface().setFieldValue(HOPLINEMOD_PROP.get(), value);
  }
  
  public entity.HOPLineModifierCost split(java.util.Date splitDate) {
    return (entity.HOPLineModifierCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPLineModifierCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPLineModifierCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getHOPLineModID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(HOPLINEMOD_PROP.get());
    }
    ...
    public void setHOPLineModID(gw.pl.persistence.core.Key value) {
      setFieldValue(HOPLINEMOD_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPLineModifierCost.class, config);
    com.guidewire._generated.entity.HOPLineModifierCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPLineModifierCost, com.guidewire._generated.entity.HOPLineModifierCostInternal>() {
      public java.lang.Object getImplementation(entity.HOPLineModifierCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPLineModifierCostInternal getInternalInterface(entity.HOPLineModifierCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPLineModifierCost newEmptyInstance() {
        return new entity.HOPLineModifierCost((java.lang.Void)null);
      }

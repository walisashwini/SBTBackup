...
@gw.entity.EntityName(value = "HOPLineRF")
public class HOPLineRF extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.RateFactor, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPLineRF, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPLineRF, entity.PolicyPeriod>("entity.HOPLineRF");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> HOPLINEMODIFIER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "HOPLineModifier");
  ...
  private com.guidewire._generated.entity.HOPLineRFInternal _internal;
   ...
   */
  public HOPLineRF(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPLineRF(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPLineRF(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPLineRFInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPLineRFInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPLineRF clone() {
    return (entity.HOPLineRF)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPLineRF getBasedOn() {
    return (entity.HOPLineRF)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPLineRF getBasedOnValue() {
    return (entity.HOPLineRF)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.HOPLineRF getFixed() {
    return (entity.HOPLineRF)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.HOPLineMod getHOPLineModifier() {
    return (entity.HOPLineMod)__getInternalInterface().getFieldValue(HOPLINEMODIFIER_PROP.get());
  }
  ...
  public entity.HOPLineRF getSlice(java.util.Date sliceDate) {
    return (entity.HOPLineRF)getSliceUntyped(sliceDate);
  }
  ...
  public entity.HOPLineRF getUnsliced() {
    return (entity.HOPLineRF)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPLineRFVersionList getVersionList() {
    return (entity.windowed.HOPLineRFVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPLineRF value) {
   ...
   */
  private void setFixed(entity.HOPLineRF value) {
  ...
  public void setHOPLineModifier(entity.HOPLineMod value) {
    __getInternalInterface().setFieldValue(HOPLINEMODIFIER_PROP.get(), value);
  }
  ...
  public entity.HOPLineRF split(java.util.Date splitDate) {
    return (entity.HOPLineRF)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPLineRFInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPLineRF.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getHOPLineModifierID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(HOPLINEMODIFIER_PROP.get());
    }
    ...
    public void setHOPLineModifierID(gw.pl.persistence.core.Key value) {
      setFieldValue(HOPLINEMODIFIER_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.RateFactorAdapter", "gw.lob.hop.HOPLineRateFactorAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPLineRateFactorMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPLineRateFactorMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPLineRF.class, config);
    com.guidewire._generated.entity.HOPLineRFInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPLineRF, com.guidewire._generated.entity.HOPLineRFInternal>() {
      public java.lang.Object getImplementation(entity.HOPLineRF bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPLineRFInternal getInternalInterface(entity.HOPLineRF bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPLineRF newEmptyInstance() {
        return new entity.HOPLineRF((java.lang.Void)null);
      }

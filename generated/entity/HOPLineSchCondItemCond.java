...
/**
 * HOPLineSchCondItemCond
 * HOP Line condition scheduled item with coverage terms
 */
...
@gw.entity.EntityName(value = "HOPLineSchCondItemCond")
public class HOPLineSchCondItemCond extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PolicyCondition, entity.ScheduledItemClause, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPLineSchCondItemCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPLineSchCondItemCond, entity.PolicyPeriod>("entity.HOPLineSchCondItemCond");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> HOPLINESCHEDULECONDITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "HOPLineScheduleCondItem");
  ...
  private com.guidewire._generated.entity.HOPLineSchCondItemCondInternal _internal;
   ...
   */
  protected HOPLineSchCondItemCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected HOPLineSchCondItemCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected HOPLineSchCondItemCond(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPLineSchCondItemCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPLineSchCondItemCondInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPLineSchCondItemCond clone() {
    return (entity.HOPLineSchCondItemCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPLineSchCondItemCond getBasedOn() {
    return (entity.HOPLineSchCondItemCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPLineSchCondItemCond getBasedOnValue() {
    return (entity.HOPLineSchCondItemCond)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.HOPLineSchCondItemCond getFixed() {
    return (entity.HOPLineSchCondItemCond)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.HOPLineScheduleCondItem getHOPLineScheduleCondItem() {
    return (entity.HOPLineScheduleCondItem)__getInternalInterface().getFieldValue(HOPLINESCHEDULECONDITEM_PROP.get());
  }
  ...
  public entity.HOPLineSchCondItemCond getSlice(java.util.Date sliceDate) {
    return (entity.HOPLineSchCondItemCond)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.HOPLineSchCondItemCond getSubtype() {
    return (typekey.HOPLineSchCondItemCond)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.HOPLineSchCondItemCond getUnsliced() {
    return (entity.HOPLineSchCondItemCond)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPLineSchCondItemCondVersionList getVersionList() {
    return (entity.windowed.HOPLineSchCondItemCondVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPLineSchCondItemCond value) {
   ...
   */
  private void setFixed(entity.HOPLineSchCondItemCond value) {
  ...
  public void setHOPLineScheduleCondItem(entity.HOPLineScheduleCondItem value) {
    __getInternalInterface().setFieldValue(HOPLINESCHEDULECONDITEM_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.HOPLineSchCondItemCond value) {
  ...
  public entity.HOPLineSchCondItemCond split(java.util.Date splitDate) {
    return (entity.HOPLineSchCondItemCond)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPLineSchCondItemCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPLineSchCondItemCond.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getHOPLineScheduleCondItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(HOPLINESCHEDULECONDITEM_PROP.get());
    }
    ...
    public void setHOPLineScheduleCondItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(HOPLINESCHEDULECONDITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.hop.schedule.HOPLineSchCondItemCondConditionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.hop.schedule.HOPLineSchCondItemCondConditionAdapter");
    config.put("gw.api.domain.PolicyConditionAdapter", "gw.lob.hop.schedule.HOPLineSchCondItemCondConditionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPLineSchCondItemCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPLineSchCondItemCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPLineSchCondItemCond.class, config);
    com.guidewire._generated.entity.HOPLineSchCondItemCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPLineSchCondItemCond, com.guidewire._generated.entity.HOPLineSchCondItemCondInternal>() {
      public java.lang.Object getImplementation(entity.HOPLineSchCondItemCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPLineSchCondItemCondInternal getInternalInterface(entity.HOPLineSchCondItemCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPLineSchCondItemCond newEmptyInstance() {
        return new entity.HOPLineSchCondItemCond((java.lang.Void)null);
      }

...
/**
 * HOPLineSchCovItemCov
 * HOP Line coverage scheduled item with coverage terms
 */
...
@gw.entity.EntityName(value = "HOPLineSchCovItemCov")
public class HOPLineSchCovItemCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, entity.ScheduledItemClause, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPLineSchCovItemCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPLineSchCovItemCov, entity.PolicyPeriod>("entity.HOPLineSchCovItemCov");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> HOPLINESCHCOVITEMCOVCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "HOPLineSchCovItemCovCosts");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> HOPLINESCHEDULECOVITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "HOPLineScheduleCovItem");
  ...
  private com.guidewire._generated.entity.HOPLineSchCovItemCovInternal _internal;
   ...
   */
  protected HOPLineSchCovItemCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected HOPLineSchCovItemCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected HOPLineSchCovItemCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPLineSchCovItemCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPLineSchCovItemCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToHOPLineSchCovItemCovCosts(entity.HOPLineSchCovItemCovCost element) {
    __getInternalInterface().addArrayElement(HOPLINESCHCOVITEMCOVCOSTS_PROP.get(), element);
  }
  ...
  public entity.HOPLineSchCovItemCov clone() {
    return (entity.HOPLineSchCovItemCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPLineSchCovItemCov getBasedOn() {
    return (entity.HOPLineSchCovItemCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPLineSchCovItemCov getBasedOnValue() {
    return (entity.HOPLineSchCovItemCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.HOPLineSchCovItemCov getFixed() {
    return (entity.HOPLineSchCovItemCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.HOPLineSchCovItemCovCost[] getHOPLineSchCovItemCovCosts() {
    return (entity.HOPLineSchCovItemCovCost[])__getInternalInterface().getFieldValue(HOPLINESCHCOVITEMCOVCOSTS_PROP.get());
  }
  ...
  public entity.HOPLineScheduleCovItem getHOPLineScheduleCovItem() {
    return (entity.HOPLineScheduleCovItem)__getInternalInterface().getFieldValue(HOPLINESCHEDULECOVITEM_PROP.get());
  }
  ...
  public entity.HOPLineSchCovItemCov getSlice(java.util.Date sliceDate) {
    return (entity.HOPLineSchCovItemCov)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.HOPLineSchCovItemCov getSubtype() {
    return (typekey.HOPLineSchCovItemCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.HOPLineSchCovItemCov getUnsliced() {
    return (entity.HOPLineSchCovItemCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPLineSchCovItemCovVersionList getVersionList() {
    return (entity.windowed.HOPLineSchCovItemCovVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromHOPLineSchCovItemCovCosts(entity.HOPLineSchCovItemCovCost element) {
    __getInternalInterface().removeArrayElement(HOPLINESCHCOVITEMCOVCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromHOPLineSchCovItemCovCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(HOPLINESCHCOVITEMCOVCOSTS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.HOPLineSchCovItemCov value) {
   ...
   */
  private void setFixed(entity.HOPLineSchCovItemCov value) {
  ...
  public void setHOPLineSchCovItemCovCosts(entity.HOPLineSchCovItemCovCost[] value) {
    __getInternalInterface().setFieldValue(HOPLINESCHCOVITEMCOVCOSTS_PROP.get(), value);
  }
  ...
  public void setHOPLineScheduleCovItem(entity.HOPLineScheduleCovItem value) {
    __getInternalInterface().setFieldValue(HOPLINESCHEDULECOVITEM_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.HOPLineSchCovItemCov value) {
  ...
  public entity.HOPLineSchCovItemCov split(java.util.Date splitDate) {
    return (entity.HOPLineSchCovItemCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPLineSchCovItemCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPLineSchCovItemCov.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getHOPLineScheduleCovItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(HOPLINESCHEDULECOVITEM_PROP.get());
    }
    ...
    public void setHOPLineScheduleCovItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(HOPLINESCHEDULECOVITEM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.hop.schedule.HOPLineSchCovItemCovCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.hop.schedule.HOPLineSchCovItemCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.hop.schedule.HOPLineSchCovItemCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.hop.schedule.HOPLineSchCovItemCovCoverageAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPLineSchCovItemCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPLineSchCovItemCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPLineSchCovItemCov.class, config);
    com.guidewire._generated.entity.HOPLineSchCovItemCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPLineSchCovItemCov, com.guidewire._generated.entity.HOPLineSchCovItemCovInternal>() {
      public java.lang.Object getImplementation(entity.HOPLineSchCovItemCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPLineSchCovItemCovInternal getInternalInterface(entity.HOPLineSchCovItemCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPLineSchCovItemCov newEmptyInstance() {
        return new entity.HOPLineSchCovItemCov((java.lang.Void)null);
      }

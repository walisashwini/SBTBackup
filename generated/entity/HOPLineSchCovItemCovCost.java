...
/**
 * HOPLineSchCovItemCovCost
 * Costs for HOP Line Scheduled Items with coverage terms
 */
...
@gw.entity.EntityName(value = "HOPLineSchCovItemCovCost")
public class HOPLineSchCovItemCovCost extends entity.HOPCost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPLineSchCovItemCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPLineSchCovItemCovCost, entity.PolicyPeriod>("entity.HOPLineSchCovItemCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> HOPLINESCHCOVITEMCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "HOPLineSchCovItemCov");
   ...
   */
  public HOPLineSchCovItemCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPLineSchCovItemCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPLineSchCovItemCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPLineSchCovItemCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPLineSchCovItemCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPLineSchCovItemCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.HOPLineSchCovItemCovCost clone() {
    return (entity.HOPLineSchCovItemCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.HOPLineSchCovItemCovCost getBasedOn() {
    return (entity.HOPLineSchCovItemCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPLineSchCovItemCov getHOPLineSchCovItemCov() {
    return (entity.HOPLineSchCovItemCov)__getInternalInterface().getFieldValue(HOPLINESCHCOVITEMCOV_PROP.get());
  }
  
  public entity.HOPLineSchCovItemCovCost getSlice(java.util.Date sliceDate) {
    return (entity.HOPLineSchCovItemCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.HOPLineSchCovItemCovCost getUnsliced() {
    return (entity.HOPLineSchCovItemCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.HOPLineSchCovItemCovCostVersionList getVersionList() {
    return (entity.windowed.HOPLineSchCovItemCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setHOPLineSchCovItemCov(entity.HOPLineSchCovItemCov value) {
    __getInternalInterface().setFieldValue(HOPLINESCHCOVITEMCOV_PROP.get(), value);
  }
  
  public entity.HOPLineSchCovItemCovCost split(java.util.Date splitDate) {
    return (entity.HOPLineSchCovItemCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPLineSchCovItemCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPLineSchCovItemCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getHOPLineSchCovItemCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(HOPLINESCHCOVITEMCOV_PROP.get());
    }
    ...
    public void setHOPLineSchCovItemCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(HOPLINESCHCOVITEMCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.hop.financials.HOPCostMethods", "gw.lob.hop.financials.HOPLineSchCovItemCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPLineSchCovItemCovCost.class, config);
    com.guidewire._generated.entity.HOPLineSchCovItemCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPLineSchCovItemCovCost, com.guidewire._generated.entity.HOPLineSchCovItemCovCostInternal>() {
      public java.lang.Object getImplementation(entity.HOPLineSchCovItemCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPLineSchCovItemCovCostInternal getInternalInterface(entity.HOPLineSchCovItemCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPLineSchCovItemCovCost newEmptyInstance() {
        return new entity.HOPLineSchCovItemCovCost((java.lang.Void)null);
      }

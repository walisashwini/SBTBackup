...
/**
 * HOPLineSchExclItemExcl
 * HOP Line exclusion scheduled item with coverage terms
 */
...
@gw.entity.EntityName(value = "HOPLineSchExclItemExcl")
public class HOPLineSchExclItemExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, entity.ScheduledItemClause, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPLineSchExclItemExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPLineSchExclItemExcl, entity.PolicyPeriod>("entity.HOPLineSchExclItemExcl");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> HOPLINESCHEDULEEXCLITEM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "HOPLineScheduleExclItem");
  ...
  private com.guidewire._generated.entity.HOPLineSchExclItemExclInternal _internal;
   ...
   */
  protected HOPLineSchExclItemExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected HOPLineSchExclItemExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected HOPLineSchExclItemExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPLineSchExclItemExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPLineSchExclItemExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPLineSchExclItemExcl clone() {
    return (entity.HOPLineSchExclItemExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPLineSchExclItemExcl getBasedOn() {
    return (entity.HOPLineSchExclItemExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPLineSchExclItemExcl getBasedOnValue() {
    return (entity.HOPLineSchExclItemExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPLineSchExclItemExcl getFixed() {
    return (entity.HOPLineSchExclItemExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  /**
   * Gets the value of the HOPLineScheduleExclItem field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.HOPLineScheduleExclItem getHOPLineScheduleExclItem() {
    return (entity.HOPLineScheduleExclItem)__getInternalInterface().getFieldValue(HOPLINESCHEDULEEXCLITEM_PROP.get());
  }
  ...
  public entity.HOPLineSchExclItemExcl getSlice(java.util.Date sliceDate) {
    return (entity.HOPLineSchExclItemExcl)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.HOPLineSchExclItemExcl getSubtype() {
    return (typekey.HOPLineSchExclItemExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.HOPLineSchExclItemExcl getUnsliced() {
    return (entity.HOPLineSchExclItemExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPLineSchExclItemExclVersionList getVersionList() {
    return (entity.windowed.HOPLineSchExclItemExclVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPLineSchExclItemExcl value) {
   ...
   */
  private void setFixed(entity.HOPLineSchExclItemExcl value) {
  ...
  /**
   * Sets the value of the HOPLineScheduleExclItem field.
   */
  public void setHOPLineScheduleExclItem(entity.HOPLineScheduleExclItem value) {
    __getInternalInterface().setFieldValue(HOPLINESCHEDULEEXCLITEM_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.HOPLineSchExclItemExcl value) {
  ...
  public entity.HOPLineSchExclItemExcl split(java.util.Date splitDate) {
    return (entity.HOPLineSchExclItemExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPLineSchExclItemExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPLineSchExclItemExcl.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getHOPLineScheduleExclItemID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(HOPLINESCHEDULEEXCLITEM_PROP.get());
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.HOPLineSchExclItemExcl value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.HOPLineSchExclItemExcl value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
    ...
    public void setHOPLineScheduleExclItemID(gw.pl.persistence.core.Key value) {
      setFieldValue(HOPLINESCHEDULEEXCLITEM_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.HOPLineSchExclItemExcl value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.hop.schedule.HOPLineSchExclItemExclExclusionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.hop.schedule.HOPLineSchExclItemExclExclusionAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.hop.schedule.HOPLineSchExclItemExclExclusionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPLineSchExclItemExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPLineSchExclItemExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPLineSchExclItemExcl.class, config);
    com.guidewire._generated.entity.HOPLineSchExclItemExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPLineSchExclItemExcl, com.guidewire._generated.entity.HOPLineSchExclItemExclInternal>() {
      public java.lang.Object getImplementation(entity.HOPLineSchExclItemExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPLineSchExclItemExclInternal getInternalInterface(entity.HOPLineSchExclItemExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPLineSchExclItemExcl newEmptyInstance() {
        return new entity.HOPLineSchExclItemExcl((java.lang.Void)null);
      }

...
/**
 * HOPLineScheduleCondItem
 * HOP Line level condition scheduled item
 */
...
@gw.entity.EntityName(value = "HOPLineScheduleCondItem")
public class HOPLineScheduleCondItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.HOPScheduledItem, entity.ScheduledItem, entity.Coverable, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPLineScheduleCondItem, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPLineScheduleCondItem, entity.PolicyPeriod>("entity.HOPLineScheduleCondItem");
  ...
  private com.guidewire._generated.entity.HOPLineScheduleCondItemInternal _internal;
   ...
   */
  public HOPLineScheduleCondItem(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPLineScheduleCondItem(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPLineScheduleCondItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPLineScheduleCondItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPLineScheduleCondItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPLineScheduleCondItem clone() {
    return (entity.HOPLineScheduleCondItem)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPLineScheduleCondItem getBasedOn() {
    return (entity.HOPLineScheduleCondItem)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPLineScheduleCondItem getBasedOnValue() {
    return (entity.HOPLineScheduleCondItem)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.HOPLineScheduleCondItem getFixed() {
    return (entity.HOPLineScheduleCondItem)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.HOPLineScheduleCond getSchedule() {
    return (entity.HOPLineScheduleCond)__getInternalInterface().getFieldValue(SCHEDULE_PROP.get());
  }
  ...
  public entity.HOPLineSchCondItemCond getScheduledItemClause() {
    return (entity.HOPLineSchCondItemCond)__getInternalInterface().getFieldValue(SCHEDULEDITEMCLAUSE_PROP.get());
  }
  ...
  public entity.HOPLineSchCondItemCond[] getScheduledItemClauseArray() {
    return (entity.HOPLineSchCondItemCond[])__getInternalInterface().getFieldValue(SCHEDULEDITEMCLAUSEARRAY_PROP.get());
  }
  ...
  public entity.HOPLineScheduleCondItem getSlice(java.util.Date sliceDate) {
    return (entity.HOPLineScheduleCondItem)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.HOPLineScheduleCondItem getSubtype() {
    return (typekey.HOPLineScheduleCondItem)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.HOPLineScheduleCondItem getUnsliced() {
    return (entity.HOPLineScheduleCondItem)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPLineScheduleCondItemVersionList getVersionList() {
    return (entity.windowed.HOPLineScheduleCondItemVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPLineScheduleCondItem value) {
   ...
   */
  private void setFixed(entity.HOPLineScheduleCondItem value) {
   ...
   */
  private void setScheduledItemClauseArray(entity.HOPLineSchCondItemCond[] value) {
   ...
   */
  private void setSubtype(typekey.HOPLineScheduleCondItem value) {
  ...
  public entity.HOPLineScheduleCondItem split(java.util.Date splitDate) {
    return (entity.HOPLineScheduleCondItem)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPLineScheduleCondItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPLineScheduleCondItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.hop.schedule.HOPLineScheduleCondItemCoverableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.hop.schedule.HOPLineScheduleCondItemCoverableAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPLineScheduleCondItemMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPLineScheduleCondItemMatcher");
    config.put("gw.api.productmodel.ScheduledItemAdapter", "gw.lob.hop.schedule.HOPLineScheduleCondItemCoverableAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPLineScheduleCondItem.class, config);
    com.guidewire._generated.entity.HOPLineScheduleCondItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPLineScheduleCondItem, com.guidewire._generated.entity.HOPLineScheduleCondItemInternal>() {
      public java.lang.Object getImplementation(entity.HOPLineScheduleCondItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPLineScheduleCondItemInternal getInternalInterface(entity.HOPLineScheduleCondItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPLineScheduleCondItem newEmptyInstance() {
        return new entity.HOPLineScheduleCondItem((java.lang.Void)null);
      }

...
/**
 * HOPLineScheduleCov
 * HOP Line coverage with a schedule
 */
...
@gw.entity.EntityName(value = "HOPLineScheduleCov")
public class HOPLineScheduleCov extends entity.HOPLineCov implements entity.ScheduleAutoNumberSequence, gw.api.domain.Schedule {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPLineScheduleCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPLineScheduleCov, entity.PolicyPeriod>("entity.HOPLineScheduleCov");
   ...
   */
  protected HOPLineScheduleCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected HOPLineScheduleCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected HOPLineScheduleCov(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPLineScheduleCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPLineScheduleCovInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPLineScheduleCovInternal)super.__getInternalInterface();
  }
  ...
  public entity.HOPLineScheduleCov clone() {
    return (entity.HOPLineScheduleCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPLineScheduleCov getBasedOn() {
    return (entity.HOPLineScheduleCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPLineScheduleCovItem[] getHOPLineScheduledItems() {
    return (entity.HOPLineScheduleCovItem[])__getInternalInterface().getFieldValue(HOPLINESCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.HOPLineScheduleCov getSlice(java.util.Date sliceDate) {
    return (entity.HOPLineScheduleCov)getSliceUntyped(sliceDate);
  }
  
  public entity.HOPLineScheduleCov getUnsliced() {
    return (entity.HOPLineScheduleCov)getUnslicedUntyped();
  }
  
  public entity.windowed.HOPLineScheduleCovVersionList getVersionList() {
    return (entity.windowed.HOPLineScheduleCovVersionList)getVersionListUntyped();
  }
  ...
  public entity.HOPLineScheduleCov split(java.util.Date splitDate) {
    return (entity.HOPLineScheduleCov)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPLineScheduleCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPLineScheduleCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.Schedule", "gw.lob.hop.schedule.HOPLineScheduleCovImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPLineScheduleCov.class, config);
    com.guidewire._generated.entity.HOPLineScheduleCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPLineScheduleCov, com.guidewire._generated.entity.HOPLineScheduleCovInternal>() {
      public java.lang.Object getImplementation(entity.HOPLineScheduleCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPLineScheduleCovInternal getInternalInterface(entity.HOPLineScheduleCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPLineScheduleCov newEmptyInstance() {
        return new entity.HOPLineScheduleCov((java.lang.Void)null);
      }

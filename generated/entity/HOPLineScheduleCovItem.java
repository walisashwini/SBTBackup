 ...
 * HOP Line level coverage scheduled item
 */
...
@gw.entity.EntityName(value = "HOPLineScheduleCovItem")
public class HOPLineScheduleCovItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.HOPScheduledItem, entity.ScheduledItem, entity.Coverable, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPLineScheduleCovItem, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPLineScheduleCovItem, entity.PolicyPeriod>("entity.HOPLineScheduleCovItem");
  ...
  private com.guidewire._generated.entity.HOPLineScheduleCovItemInternal _internal;
   ...
   */
  public HOPLineScheduleCovItem(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPLineScheduleCovItem(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPLineScheduleCovItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPLineScheduleCovItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPLineScheduleCovItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPLineScheduleCovItem clone() {
    return (entity.HOPLineScheduleCovItem)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPLineScheduleCovItem getBasedOn() {
    return (entity.HOPLineScheduleCovItem)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPLineScheduleCovItem getBasedOnValue() {
    return (entity.HOPLineScheduleCovItem)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.HOPLineScheduleCovItem getFixed() {
    return (entity.HOPLineScheduleCovItem)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.HOPLineScheduleCov getSchedule() {
    return (entity.HOPLineScheduleCov)__getInternalInterface().getFieldValue(SCHEDULE_PROP.get());
  }
  ...
  public entity.HOPLineSchCovItemCov getScheduledItemClause() {
    return (entity.HOPLineSchCovItemCov)__getInternalInterface().getFieldValue(SCHEDULEDITEMCLAUSE_PROP.get());
  }
  ...
  public entity.HOPLineSchCovItemCov[] getScheduledItemClauseArray() {
    return (entity.HOPLineSchCovItemCov[])__getInternalInterface().getFieldValue(SCHEDULEDITEMCLAUSEARRAY_PROP.get());
  }
  ...
  public entity.HOPLineScheduleCovItem getSlice(java.util.Date sliceDate) {
    return (entity.HOPLineScheduleCovItem)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.HOPLineScheduleCovItem getSubtype() {
    return (typekey.HOPLineScheduleCovItem)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.HOPLineScheduleCovItem getUnsliced() {
    return (entity.HOPLineScheduleCovItem)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPLineScheduleCovItemVersionList getVersionList() {
    return (entity.windowed.HOPLineScheduleCovItemVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPLineScheduleCovItem value) {
   ...
   */
  private void setFixed(entity.HOPLineScheduleCovItem value) {
   ...
   */
  private void setScheduledItemClauseArray(entity.HOPLineSchCovItemCov[] value) {
   ...
   */
  private void setSubtype(typekey.HOPLineScheduleCovItem value) {
  ...
  public entity.HOPLineScheduleCovItem split(java.util.Date splitDate) {
    return (entity.HOPLineScheduleCovItem)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPLineScheduleCovItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPLineScheduleCovItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.hop.schedule.HOPLineScheduleCovItemCoverableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.hop.schedule.HOPLineScheduleCovItemCoverableAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPLineScheduleCovItemMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPLineScheduleCovItemMatcher");
    config.put("gw.api.productmodel.ScheduledItemAdapter", "gw.lob.hop.schedule.HOPLineScheduleCovItemCoverableAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPLineScheduleCovItem.class, config);
    com.guidewire._generated.entity.HOPLineScheduleCovItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPLineScheduleCovItem, com.guidewire._generated.entity.HOPLineScheduleCovItemInternal>() {
      public java.lang.Object getImplementation(entity.HOPLineScheduleCovItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPLineScheduleCovItemInternal getInternalInterface(entity.HOPLineScheduleCovItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPLineScheduleCovItem newEmptyInstance() {
        return new entity.HOPLineScheduleCovItem((java.lang.Void)null);
      }

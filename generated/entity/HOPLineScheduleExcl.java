...
/**
 * HOPLineScheduleExcl
 * HOP Line exclusion with a schedule
 */
...
@gw.entity.EntityName(value = "HOPLineScheduleExcl")
public class HOPLineScheduleExcl extends entity.HOPLineExcl implements entity.ScheduleAutoNumberSequence, gw.api.domain.Schedule {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPLineScheduleExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPLineScheduleExcl, entity.PolicyPeriod>("entity.HOPLineScheduleExcl");
   ...
   */
  protected HOPLineScheduleExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected HOPLineScheduleExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected HOPLineScheduleExcl(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPLineScheduleExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPLineScheduleExclInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPLineScheduleExclInternal)super.__getInternalInterface();
  }
  ...
  public entity.HOPLineScheduleExcl clone() {
    return (entity.HOPLineScheduleExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPLineScheduleExcl getBasedOn() {
    return (entity.HOPLineScheduleExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPLineScheduleExclItem[] getHOPLineScheduledItems() {
    return (entity.HOPLineScheduleExclItem[])__getInternalInterface().getFieldValue(HOPLINESCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.HOPLineScheduleExcl getSlice(java.util.Date sliceDate) {
    return (entity.HOPLineScheduleExcl)getSliceUntyped(sliceDate);
  }
  
  public entity.HOPLineScheduleExcl getUnsliced() {
    return (entity.HOPLineScheduleExcl)getUnslicedUntyped();
  }
  
  public entity.windowed.HOPLineScheduleExclVersionList getVersionList() {
    return (entity.windowed.HOPLineScheduleExclVersionList)getVersionListUntyped();
  }
  ...
  public entity.HOPLineScheduleExcl split(java.util.Date splitDate) {
    return (entity.HOPLineScheduleExcl)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPLineScheduleExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPLineScheduleExcl.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.Schedule", "gw.lob.hop.schedule.HOPLineScheduleExclImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPLineScheduleExcl.class, config);
    com.guidewire._generated.entity.HOPLineScheduleExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPLineScheduleExcl, com.guidewire._generated.entity.HOPLineScheduleExclInternal>() {
      public java.lang.Object getImplementation(entity.HOPLineScheduleExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPLineScheduleExclInternal getInternalInterface(entity.HOPLineScheduleExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPLineScheduleExcl newEmptyInstance() {
        return new entity.HOPLineScheduleExcl((java.lang.Void)null);
      }

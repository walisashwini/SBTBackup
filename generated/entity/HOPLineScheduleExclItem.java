...
/**
 * HOPLineScheduleExclItem
 * HOP Line level exclusion scheduled item
 */
...
@gw.entity.EntityName(value = "HOPLineScheduleExclItem")
public class HOPLineScheduleExclItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.HOPScheduledItem, entity.ScheduledItem, entity.Coverable, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPLineScheduleExclItem, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPLineScheduleExclItem, entity.PolicyPeriod>("entity.HOPLineScheduleExclItem");
  ...
  private com.guidewire._generated.entity.HOPLineScheduleExclItemInternal _internal;
   ...
   */
  public HOPLineScheduleExclItem(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPLineScheduleExclItem(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPLineScheduleExclItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPLineScheduleExclItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPLineScheduleExclItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPLineScheduleExclItem clone() {
    return (entity.HOPLineScheduleExclItem)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPLineScheduleExclItem getBasedOn() {
    return (entity.HOPLineScheduleExclItem)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPLineScheduleExclItem getBasedOnValue() {
    return (entity.HOPLineScheduleExclItem)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.HOPLineScheduleExclItem getFixed() {
    return (entity.HOPLineScheduleExclItem)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.HOPLineScheduleExcl getSchedule() {
    return (entity.HOPLineScheduleExcl)__getInternalInterface().getFieldValue(SCHEDULE_PROP.get());
  }
  ...
  public entity.HOPLineSchExclItemExcl getScheduledItemClause() {
    return (entity.HOPLineSchExclItemExcl)__getInternalInterface().getFieldValue(SCHEDULEDITEMCLAUSE_PROP.get());
  }
  ...
  public entity.HOPLineSchExclItemExcl[] getScheduledItemClauseArray() {
    return (entity.HOPLineSchExclItemExcl[])__getInternalInterface().getFieldValue(SCHEDULEDITEMCLAUSEARRAY_PROP.get());
  }
  ...
  public entity.HOPLineScheduleExclItem getSlice(java.util.Date sliceDate) {
    return (entity.HOPLineScheduleExclItem)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.HOPLineScheduleExclItem getSubtype() {
    return (typekey.HOPLineScheduleExclItem)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.HOPLineScheduleExclItem getUnsliced() {
    return (entity.HOPLineScheduleExclItem)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPLineScheduleExclItemVersionList getVersionList() {
    return (entity.windowed.HOPLineScheduleExclItemVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPLineScheduleExclItem value) {
   ...
   */
  private void setFixed(entity.HOPLineScheduleExclItem value) {
   ...
   */
  private void setScheduledItemClauseArray(entity.HOPLineSchExclItemExcl[] value) {
   ...
   */
  private void setSubtype(typekey.HOPLineScheduleExclItem value) {
  ...
  public entity.HOPLineScheduleExclItem split(java.util.Date splitDate) {
    return (entity.HOPLineScheduleExclItem)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPLineScheduleExclItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPLineScheduleExclItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.hop.schedule.HOPLineScheduleExclItemCoverableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.hop.schedule.HOPLineScheduleExclItemCoverableAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPLineScheduleExclItemMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPLineScheduleExclItemMatcher");
    config.put("gw.api.productmodel.ScheduledItemAdapter", "gw.lob.hop.schedule.HOPLineScheduleExclItemCoverableAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPLineScheduleExclItem.class, config);
    com.guidewire._generated.entity.HOPLineScheduleExclItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPLineScheduleExclItem, com.guidewire._generated.entity.HOPLineScheduleExclItemInternal>() {
      public java.lang.Object getImplementation(entity.HOPLineScheduleExclItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPLineScheduleExclItemInternal getInternalInterface(entity.HOPLineScheduleExclItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPLineScheduleExclItem newEmptyInstance() {
        return new entity.HOPLineScheduleExclItem((java.lang.Void)null);
      }

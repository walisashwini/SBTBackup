...
/**
 * HOPModifierLookup
 * An availability lookup for HOP modifier patterns.
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "HOPModifierLookup.eti;HOPModifierLookup.eix;HOPModifierLookup.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "HOPModifierLookup")
public class HOPModifierLookup extends entity.ModifierLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.HOPModifierLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.HOPModifierLookup>("entity.HOPModifierLookup");
   ...
   */
  protected HOPModifierLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected HOPModifierLookup(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPModifierLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPModifierLookupInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPModifierLookupInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPModifierLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPModifierLookup.this.__getDelegateManager();
    }
    ...
    public java.lang.String getModifierPatternCode() {
      return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(MODIFIERPATTERNCODE_PROP.get());
    }
    ...
    public typekey.ModifierLookup getSubtype() {
      return (typekey.ModifierLookup)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
    ...
    public void setModifierPatternCode(java.lang.String value) {
      __getInternalInterface().setFieldValueForCodegen(MODIFIERPATTERNCODE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.productmodel.DenormLookupInitialisable", "com.guidewire.pc.domain.productmodel.impl.ModifierLookupImpl");
    config.put("com.guidewire.pc.domain.productmodel.ModifierLookupPublicMethods", "com.guidewire.pc.domain.productmodel.impl.ModifierLookupImpl");
    config.put("com.guidewire.pc.domain.productmodel.impl.LookupInternalMethods", "com.guidewire.pc.domain.productmodel.impl.ModifierLookupImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.productmodel.impl.ModifierLookupImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPModifierLookup.class, config);
    com.guidewire._generated.entity.HOPModifierLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPModifierLookup, com.guidewire._generated.entity.HOPModifierLookupInternal>() {
      public java.lang.Object getImplementation(entity.HOPModifierLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPModifierLookupInternal getInternalInterface(entity.HOPModifierLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPModifierLookup newEmptyInstance() {
        return new entity.HOPModifierLookup((java.lang.Void)null);
      }

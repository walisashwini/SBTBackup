...
/**
 * HOPRateFactorLookup
 * An availability lookup for HOP rate factor patterns.
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "HOPRateFactorLookup.eti;HOPRateFactorLookup.eix;HOPRateFactorLookup.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "HOPRateFactorLookup")
public class HOPRateFactorLookup extends entity.RateFactorLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.HOPRateFactorLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.HOPRateFactorLookup>("entity.HOPRateFactorLookup");
   ...
   */
  protected HOPRateFactorLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected HOPRateFactorLookup(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.HOPRateFactorLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPRateFactorLookupInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.HOPRateFactorLookupInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPRateFactorLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPRateFactorLookup.this.__getDelegateManager();
    }
    ...
    public java.lang.String getRateFactorPatternCode() {
      return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(RATEFACTORPATTERNCODE_PROP.get());
    }
    ...
    public typekey.RateFactorLookup getSubtype() {
      return (typekey.RateFactorLookup)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
    ...
    public void setRateFactorPatternCode(java.lang.String value) {
      __getInternalInterface().setFieldValueForCodegen(RATEFACTORPATTERNCODE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.productmodel.DenormLookupInitialisable", "com.guidewire.pc.domain.productmodel.impl.RateFactorLookupImpl");
    config.put("com.guidewire.pc.domain.productmodel.impl.LookupInternalMethods", "com.guidewire.pc.domain.productmodel.impl.RateFactorLookupImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.productmodel.impl.RateFactorLookupImpl");
    config.put("gw.pc.productmodel.entity.RateFactorLookup", "com.guidewire.pc.domain.productmodel.impl.RateFactorLookupImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPRateFactorLookup.class, config);
    com.guidewire._generated.entity.HOPRateFactorLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPRateFactorLookup, com.guidewire._generated.entity.HOPRateFactorLookupInternal>() {
      public java.lang.Object getImplementation(entity.HOPRateFactorLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPRateFactorLookupInternal getInternalInterface(entity.HOPRateFactorLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPRateFactorLookup newEmptyInstance() {
        return new entity.HOPRateFactorLookup((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "HOPSwimmingPool")
public class HOPSwimmingPool extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPSwimmingPool, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPSwimmingPool, entity.PolicyPeriod>("entity.HOPSwimmingPool");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> APPROVEDFENCE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ApprovedFence");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DIVINGBOARD_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DivingBoard");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> POOLTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "PoolType");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PUBLICID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PublicID");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> SLIDE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Slide");
  ...
  private com.guidewire._generated.entity.HOPSwimmingPoolInternal _internal;
   ...
   */
  public HOPSwimmingPool(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPSwimmingPool(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPSwimmingPool(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPSwimmingPoolInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPSwimmingPoolInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPSwimmingPool clone() {
    return (entity.HOPSwimmingPool)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPSwimmingPool getBasedOn() {
    return (entity.HOPSwimmingPool)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPSwimmingPool getBasedOnValue() {
    return (entity.HOPSwimmingPool)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.HOPSwimmingPool getFixed() {
    return (entity.HOPSwimmingPool)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public typekey.HOPSwimmingPoolType getPoolType() {
    return (typekey.HOPSwimmingPoolType)__getInternalInterface().getFieldValue(POOLTYPE_PROP.get());
  }
  ...
  public entity.HOPSwimmingPool getSlice(java.util.Date sliceDate) {
    return (entity.HOPSwimmingPool)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.HOPSwimmingPool getSubtype() {
    return (typekey.HOPSwimmingPool)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.HOPSwimmingPool getUnsliced() {
    return (entity.HOPSwimmingPool)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPSwimmingPoolVersionList getVersionList() {
    return (entity.windowed.HOPSwimmingPoolVersionList)getVersionListUntyped();
  }
  ...
  public java.lang.Boolean isApprovedFence() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(APPROVEDFENCE_PROP.get());
  }
  ...
  public java.lang.Boolean isDivingBoard() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(DIVINGBOARD_PROP.get());
  }
  ...
  public java.lang.Boolean isSlide() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(SLIDE_PROP.get());
  }
  ...
  public void setApprovedFence(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(APPROVEDFENCE_PROP.get(), value);
  }
   ...
   */
  private void setBasedOnValue(entity.HOPSwimmingPool value) {
  ...
  public void setDivingBoard(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(DIVINGBOARD_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.HOPSwimmingPool value) {
  ...
  public void setPoolType(typekey.HOPSwimmingPoolType value) {
    __getInternalInterface().setFieldValue(POOLTYPE_PROP.get(), value);
  }
  ...
  public void setSlide(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(SLIDE_PROP.get(), value);
  }
  
  /**
   * Sets the value of the Subtype field.
   */
  private void setSubtype(typekey.HOPSwimmingPool value) {
  ...
  public entity.HOPSwimmingPool split(java.util.Date splitDate) {
    return (entity.HOPSwimmingPool)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPSwimmingPoolInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPSwimmingPool.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.hop.HOPSwimmingPoolMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.hop.HOPSwimmingPoolMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPSwimmingPool.class, config);
    com.guidewire._generated.entity.HOPSwimmingPoolInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPSwimmingPool, com.guidewire._generated.entity.HOPSwimmingPoolInternal>() {
      public java.lang.Object getImplementation(entity.HOPSwimmingPool bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPSwimmingPoolInternal getInternalInterface(entity.HOPSwimmingPool bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPSwimmingPool newEmptyInstance() {
        return new entity.HOPSwimmingPool((java.lang.Void)null);
      }

...
/**
 * HOPTransaction
 * A transaction for the Homeowners line
 */
...
@gw.entity.EntityName(value = "HOPTransaction")
public class HOPTransaction extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Transaction {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.HOPTransaction, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.HOPTransaction, entity.PolicyPeriod>("entity.HOPTransaction");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> HOPCOST_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "HOPCost");
  ...
  private com.guidewire._generated.entity.HOPTransactionInternal _internal;
   ...
   */
  public HOPTransaction(entity.PolicyPeriod branch)  {
   ...
   */
  public HOPTransaction(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected HOPTransaction(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.HOPTransactionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.HOPTransactionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.HOPTransaction clone() {
    return (entity.HOPTransaction)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.HOPTransaction getBasedOn() {
    return (entity.HOPTransaction)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.HOPTransaction getBasedOnValue() {
    return (entity.HOPTransaction)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.HOPTransaction getFixed() {
    return (entity.HOPTransaction)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.HOPCost getHOPCost() {
    return (entity.HOPCost)__getInternalInterface().getFieldValue(HOPCOST_PROP.get());
  }
  ...
  public entity.HOPTransaction getSlice(java.util.Date sliceDate) {
    return (entity.HOPTransaction)getSliceUntyped(sliceDate);
  }
  ...
  public entity.HOPTransaction getUnsliced() {
    return (entity.HOPTransaction)getUnslicedUntyped();
  }
  ...
  public entity.windowed.HOPTransactionVersionList getVersionList() {
    return (entity.windowed.HOPTransactionVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.HOPTransaction value) {
   ...
   */
  private void setFixed(entity.HOPTransaction value) {
  ...
  public void setHOPCost(entity.HOPCost value) {
    __getInternalInterface().setFieldValue(HOPCOST_PROP.get(), value);
  }
  ...
  public entity.HOPTransaction split(java.util.Date splitDate) {
    return (entity.HOPTransaction)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HOPTransactionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.HOPTransaction.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getHOPCostID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(HOPCOST_PROP.get());
    }
    ...
    public void setHOPCostID(gw.pl.persistence.core.Key value) {
      setFieldValue(HOPCOST_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.financials.TransactionAdapter", "gw.lob.hop.financials.HOPTransactionAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.HOPTransaction.class, config);
    com.guidewire._generated.entity.HOPTransactionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.HOPTransaction, com.guidewire._generated.entity.HOPTransactionInternal>() {
      public java.lang.Object getImplementation(entity.HOPTransaction bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.HOPTransactionInternal getInternalInterface(entity.HOPTransaction bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.HOPTransaction newEmptyInstance() {
        return new entity.HOPTransaction((java.lang.Void)null);
      }

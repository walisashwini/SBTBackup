 ...
 * Costs for an inland marine accounts receivable coverage
 */
...
@gw.entity.EntityName(value = "IMAccountsRecCovCost")
public class IMAccountsRecCovCost extends entity.IMAccountsRecPartCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.IMAccountsRecCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.IMAccountsRecCovCost, entity.PolicyPeriod>("entity.IMAccountsRecCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> IMACCOUNTSRECCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "IMAccountsRecCov");
   ...
   */
  public IMAccountsRecCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public IMAccountsRecCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected IMAccountsRecCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.IMAccountsRecCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.IMAccountsRecCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.IMAccountsRecCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.IMAccountsRecCovCost clone() {
    return (entity.IMAccountsRecCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.IMAccountsRecCovCost getBasedOn() {
    return (entity.IMAccountsRecCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.IMAccountsRecCov getIMAccountsRecCov() {
    return (entity.IMAccountsRecCov)__getInternalInterface().getFieldValue(IMACCOUNTSRECCOV_PROP.get());
  }
  
  public entity.IMAccountsRecCovCost getSlice(java.util.Date sliceDate) {
    return (entity.IMAccountsRecCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.IMAccountsRecCovCost getUnsliced() {
    return (entity.IMAccountsRecCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.IMAccountsRecCovCostVersionList getVersionList() {
    return (entity.windowed.IMAccountsRecCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setIMAccountsRecCov(entity.IMAccountsRecCov value) {
    __getInternalInterface().setFieldValue(IMACCOUNTSRECCOV_PROP.get(), value);
  }
  
  public entity.IMAccountsRecCovCost split(java.util.Date splitDate) {
    return (entity.IMAccountsRecCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.IMAccountsRecCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.IMAccountsRecCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getIMAccountsRecCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(IMACCOUNTSRECCOV_PROP.get());
    }
    ...
    public void setIMAccountsRecCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(IMACCOUNTSRECCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.financials.CostAdapter", "gw.lob.im.financials.IMAccountsRecCovCostAdapter");
    config.put("gw.lob.im.financials.IMCostMethods", "gw.lob.im.financials.IMAccountsRecCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.IMAccountsRecCovCost.class, config);
    com.guidewire._generated.entity.IMAccountsRecCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.IMAccountsRecCovCost, com.guidewire._generated.entity.IMAccountsRecCovCostInternal>() {
      public java.lang.Object getImplementation(entity.IMAccountsRecCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IMAccountsRecCovCostInternal getInternalInterface(entity.IMAccountsRecCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.IMAccountsRecCovCost newEmptyInstance() {
        return new entity.IMAccountsRecCovCost((java.lang.Void)null);
      }

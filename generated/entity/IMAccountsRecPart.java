...
@gw.entity.EntityName(value = "IMAccountsRecPart")
public class IMAccountsRecPart extends entity.IMCoveragePart implements entity.Coverable {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.IMAccountsRecPart, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.IMAccountsRecPart, entity.PolicyPeriod>("entity.IMAccountsRecPart");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> ARAUTONUMBERSEQ_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ARAutoNumberSeq");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> BUSINESSCLASS_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "BusinessClass");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> COINSURANCE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "Coinsurance");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> IMACCOUNTSRECPARTCONDITIONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "IMAccountsRecPartConditions");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> IMACCOUNTSRECPARTCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "IMAccountsRecPartCosts");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> IMACCOUNTSRECPARTCOVS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "IMAccountsRecPartCovs");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> IMACCOUNTSRECPARTEXCLUSIONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "IMAccountsRecPartExclusions");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> IMACCOUNTSRECEIVABLES_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "IMAccountsReceivables");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> IMEXCLUDEDACCOUNTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "IMExcludedAccounts");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> REPORTING_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Reporting");
   ...
   */
  public IMAccountsRecPart(entity.PolicyPeriod branch)  {
   ...
   */
  public IMAccountsRecPart(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected IMAccountsRecPart(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.IMAccountsRecPartInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.IMAccountsRecPartInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.IMAccountsRecPartInternal)super.__getInternalInterface();
  }
  ...
  public void addToIMAccountsRecPartConditions(entity.IMAccountsRecPartCond element) {
    __getInternalInterface().addArrayElement(IMACCOUNTSRECPARTCONDITIONS_PROP.get(), element);
  }
  ...
  public void addToIMAccountsRecPartCosts(entity.IMAccountsRecPartCost element) {
    __getInternalInterface().addArrayElement(IMACCOUNTSRECPARTCOSTS_PROP.get(), element);
  }
  ...
  public void addToIMAccountsRecPartCovs(entity.IMAccountsRecPartCov element) {
    __getInternalInterface().addArrayElement(IMACCOUNTSRECPARTCOVS_PROP.get(), element);
  }
  ...
  public void addToIMAccountsRecPartExclusions(entity.IMAccountsRecPartExcl element) {
    __getInternalInterface().addArrayElement(IMACCOUNTSRECPARTEXCLUSIONS_PROP.get(), element);
  }
  ...
  public void addToIMAccountsReceivables(entity.IMAccountsReceivable element) {
    __getInternalInterface().addArrayElement(IMACCOUNTSRECEIVABLES_PROP.get(), element);
  }
  ...
  public void addToIMExcludedAccounts(entity.IMExcludedAccount element) {
    __getInternalInterface().addArrayElement(IMEXCLUDEDACCOUNTS_PROP.get(), element);
  }
  ...
  public entity.IMAccountsRecPart clone() {
    return (entity.IMAccountsRecPart)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.AutoNumberSequence getARAutoNumberSeq() {
    return (entity.AutoNumberSequence)__getInternalInterface().getFieldValue(ARAUTONUMBERSEQ_PROP.get());
  }
  ...
  public entity.IMAccountsRecPart getBasedOn() {
    return (entity.IMAccountsRecPart)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public typekey.BusinessClass getBusinessClass() {
    return (typekey.BusinessClass)__getInternalInterface().getFieldValue(BUSINESSCLASS_PROP.get());
  }
  ...
  public typekey.Coinsurance getCoinsurance() {
    return (typekey.Coinsurance)__getInternalInterface().getFieldValue(COINSURANCE_PROP.get());
  }
  ...
  public entity.IMAccountsRecPartCond[] getIMAccountsRecPartConditions() {
    return (entity.IMAccountsRecPartCond[])__getInternalInterface().getFieldValue(IMACCOUNTSRECPARTCONDITIONS_PROP.get());
  }
  ...
  public entity.IMAccountsRecPartCost[] getIMAccountsRecPartCosts() {
    return (entity.IMAccountsRecPartCost[])__getInternalInterface().getFieldValue(IMACCOUNTSRECPARTCOSTS_PROP.get());
  }
  ...
  public entity.IMAccountsRecPartCov[] getIMAccountsRecPartCovs() {
    return (entity.IMAccountsRecPartCov[])__getInternalInterface().getFieldValue(IMACCOUNTSRECPARTCOVS_PROP.get());
  }
  ...
  public entity.IMAccountsRecPartExcl[] getIMAccountsRecPartExclusions() {
    return (entity.IMAccountsRecPartExcl[])__getInternalInterface().getFieldValue(IMACCOUNTSRECPARTEXCLUSIONS_PROP.get());
  }
  ...
  public entity.IMAccountsReceivable[] getIMAccountsReceivables() {
    return (entity.IMAccountsReceivable[])__getInternalInterface().getFieldValue(IMACCOUNTSRECEIVABLES_PROP.get());
  }
  ...
  public entity.IMExcludedAccount[] getIMExcludedAccounts() {
    return (entity.IMExcludedAccount[])__getInternalInterface().getFieldValue(IMEXCLUDEDACCOUNTS_PROP.get());
  }
  ...
  public entity.IMAccountsRecPart getSlice(java.util.Date sliceDate) {
    return (entity.IMAccountsRecPart)getSliceUntyped(sliceDate);
  }
  
  public entity.IMAccountsRecPart getUnsliced() {
    return (entity.IMAccountsRecPart)getUnslicedUntyped();
  }
  
  public entity.windowed.IMAccountsRecPartVersionList getVersionList() {
    return (entity.windowed.IMAccountsRecPartVersionList)getVersionListUntyped();
  }
  ...
  public java.lang.Boolean isReporting() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(REPORTING_PROP.get());
  }
  ...
  public void removeFromIMAccountsRecPartConditions(entity.IMAccountsRecPartCond element) {
    __getInternalInterface().removeArrayElement(IMACCOUNTSRECPARTCONDITIONS_PROP.get(), element);
  }
  ...
  public void removeFromIMAccountsRecPartConditions(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(IMACCOUNTSRECPARTCONDITIONS_PROP.get(), elementID);
  }
  ...
  public void removeFromIMAccountsRecPartCosts(entity.IMAccountsRecPartCost element) {
    __getInternalInterface().removeArrayElement(IMACCOUNTSRECPARTCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromIMAccountsRecPartCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(IMACCOUNTSRECPARTCOSTS_PROP.get(), elementID);
  }
  ...
  public void removeFromIMAccountsRecPartCovs(entity.IMAccountsRecPartCov element) {
    __getInternalInterface().removeArrayElement(IMACCOUNTSRECPARTCOVS_PROP.get(), element);
  }
  ...
  public void removeFromIMAccountsRecPartCovs(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(IMACCOUNTSRECPARTCOVS_PROP.get(), elementID);
  }
  ...
  public void removeFromIMAccountsRecPartExclusions(entity.IMAccountsRecPartExcl element) {
    __getInternalInterface().removeArrayElement(IMACCOUNTSRECPARTEXCLUSIONS_PROP.get(), element);
  }
  ...
  public void removeFromIMAccountsRecPartExclusions(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(IMACCOUNTSRECPARTEXCLUSIONS_PROP.get(), elementID);
  }
  ...
  public void removeFromIMAccountsReceivables(entity.IMAccountsReceivable element) {
    __getInternalInterface().removeArrayElement(IMACCOUNTSRECEIVABLES_PROP.get(), element);
  }
  ...
  public void removeFromIMAccountsReceivables(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(IMACCOUNTSRECEIVABLES_PROP.get(), elementID);
  }
  ...
  public void removeFromIMExcludedAccounts(entity.IMExcludedAccount element) {
    __getInternalInterface().removeArrayElement(IMEXCLUDEDACCOUNTS_PROP.get(), element);
  }
  ...
  public void removeFromIMExcludedAccounts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(IMEXCLUDEDACCOUNTS_PROP.get(), elementID);
  }
  ...
  public void setARAutoNumberSeq(entity.AutoNumberSequence value) {
    __getInternalInterface().setFieldValue(ARAUTONUMBERSEQ_PROP.get(), value);
  }
  ...
  public void setBusinessClass(typekey.BusinessClass value) {
    __getInternalInterface().setFieldValue(BUSINESSCLASS_PROP.get(), value);
  }
  ...
  public void setIMAccountsRecPartConditions(entity.IMAccountsRecPartCond[] value) {
    __getInternalInterface().setFieldValue(IMACCOUNTSRECPARTCONDITIONS_PROP.get(), value);
  }
  ...
  public void setIMAccountsRecPartCosts(entity.IMAccountsRecPartCost[] value) {
    __getInternalInterface().setFieldValue(IMACCOUNTSRECPARTCOSTS_PROP.get(), value);
  }
  ...
  public void setIMAccountsRecPartCovs(entity.IMAccountsRecPartCov[] value) {
    __getInternalInterface().setFieldValue(IMACCOUNTSRECPARTCOVS_PROP.get(), value);
  }
  ...
  public void setIMAccountsRecPartExclusions(entity.IMAccountsRecPartExcl[] value) {
    __getInternalInterface().setFieldValue(IMACCOUNTSRECPARTEXCLUSIONS_PROP.get(), value);
  }
  ...
  public void setIMAccountsReceivables(entity.IMAccountsReceivable[] value) {
    __getInternalInterface().setFieldValue(IMACCOUNTSRECEIVABLES_PROP.get(), value);
  }
  ...
  public void setIMExcludedAccounts(entity.IMExcludedAccount[] value) {
    __getInternalInterface().setFieldValue(IMEXCLUDEDACCOUNTS_PROP.get(), value);
  }
  ...
  public void setReporting(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(REPORTING_PROP.get(), value);
  }
  
  public entity.IMAccountsRecPart split(java.util.Date splitDate) {
    return (entity.IMAccountsRecPart)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.IMAccountsRecPartInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.IMAccountsRecPart.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getARAutoNumberSeqID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(ARAUTONUMBERSEQ_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getInlandMarineLineID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(INLANDMARINELINE_PROP.get());
    }
    ...
    public void setARAutoNumberSeqID(gw.pl.persistence.core.Key value) {
      setFieldValue(ARAUTONUMBERSEQ_PROP.get(), value);
    }
    ...
    public void setInlandMarineLineID(gw.pl.persistence.core.Key value) {
      setFieldValue(INLANDMARINELINE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.copier.EffDatedCopyable", "gw.lob.im.IMCoveragePartCopier");
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.im.ar.IMAccountsRecPartCoverableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.im.ar.IMAccountsRecPartCoverableAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.im.IMCoveragePartMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.im.IMCoveragePartMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.IMAccountsRecPart.class, config);
    com.guidewire._generated.entity.IMAccountsRecPartInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.IMAccountsRecPart, com.guidewire._generated.entity.IMAccountsRecPartInternal>() {
      public java.lang.Object getImplementation(entity.IMAccountsRecPart bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IMAccountsRecPartInternal getInternalInterface(entity.IMAccountsRecPart bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.IMAccountsRecPart newEmptyInstance() {
        return new entity.IMAccountsRecPart((java.lang.Void)null);
      }

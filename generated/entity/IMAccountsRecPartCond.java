...
/**
 * IMAccountsRecPartCond
 * An Accounts Receivable part-level condition for Inland Marine
 */
...
@gw.entity.EntityName(value = "IMAccountsRecPartCond")
public class IMAccountsRecPartCond extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PolicyCondition, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.IMAccountsRecPartCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.IMAccountsRecPartCond, entity.PolicyPeriod>("entity.IMAccountsRecPartCond");
  ...
  private com.guidewire._generated.entity.IMAccountsRecPartCondInternal _internal;
   ...
   */
  protected IMAccountsRecPartCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected IMAccountsRecPartCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected IMAccountsRecPartCond(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.IMAccountsRecPartCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.IMAccountsRecPartCondInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.IMAccountsRecPartCond clone() {
    return (entity.IMAccountsRecPartCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.IMAccountsRecPartCond getBasedOn() {
    return (entity.IMAccountsRecPartCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.IMAccountsRecPartCond getBasedOnValue() {
    return (entity.IMAccountsRecPartCond)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.IMAccountsRecPartCond getFixed() {
    return (entity.IMAccountsRecPartCond)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.IMAccountsRecPartCond getSlice(java.util.Date sliceDate) {
    return (entity.IMAccountsRecPartCond)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.IMAccountsRecPartCond getSubtype() {
    return (typekey.IMAccountsRecPartCond)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.IMAccountsRecPartCond getUnsliced() {
    return (entity.IMAccountsRecPartCond)getUnslicedUntyped();
  }
  ...
  public entity.windowed.IMAccountsRecPartCondVersionList getVersionList() {
    return (entity.windowed.IMAccountsRecPartCondVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.IMAccountsRecPartCond value) {
   ...
   */
  private void setFixed(entity.IMAccountsRecPartCond value) {
   ...
   */
  private void setSubtype(typekey.IMAccountsRecPartCond value) {
  ...
  public entity.IMAccountsRecPartCond split(java.util.Date splitDate) {
    return (entity.IMAccountsRecPartCond)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.IMAccountsRecPartCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.IMAccountsRecPartCond.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.IMAccountsRecPartCond value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.IMAccountsRecPartCond value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.IMAccountsRecPartCond value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.im.ar.IMAccountsRecPartCondConditionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.im.ar.IMAccountsRecPartCondConditionAdapter");
    config.put("gw.api.domain.PolicyConditionAdapter", "gw.lob.im.ar.IMAccountsRecPartCondConditionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.im.IMAccountsRecPartCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.im.IMAccountsRecPartCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.IMAccountsRecPartCond.class, config);
    com.guidewire._generated.entity.IMAccountsRecPartCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.IMAccountsRecPartCond, com.guidewire._generated.entity.IMAccountsRecPartCondInternal>() {
      public java.lang.Object getImplementation(entity.IMAccountsRecPartCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IMAccountsRecPartCondInternal getInternalInterface(entity.IMAccountsRecPartCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.IMAccountsRecPartCond newEmptyInstance() {
        return new entity.IMAccountsRecPartCond((java.lang.Void)null);
      }

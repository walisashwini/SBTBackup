...
/**
 * IMAccountsRecPartCost
 * Costs for inland marine accounts receivable part
 */
...
@gw.entity.EntityName(value = "IMAccountsRecPartCost")
public class IMAccountsRecPartCost extends entity.IMTaxableCost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.IMAccountsRecPartCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.IMAccountsRecPartCost, entity.PolicyPeriod>("entity.IMAccountsRecPartCost");
   ...
   */
  public IMAccountsRecPartCost(entity.PolicyPeriod branch)  {
   ...
   */
  public IMAccountsRecPartCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected IMAccountsRecPartCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.IMAccountsRecPartCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.IMAccountsRecPartCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.IMAccountsRecPartCostInternal)super.__getInternalInterface();
  }
  
  public entity.IMAccountsRecPartCost clone() {
    return (entity.IMAccountsRecPartCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.IMAccountsRecPartCost getBasedOn() {
    return (entity.IMAccountsRecPartCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.IMAccountsRecPartCost getSlice(java.util.Date sliceDate) {
    return (entity.IMAccountsRecPartCost)getSliceUntyped(sliceDate);
  }
  
  public entity.IMAccountsRecPartCost getUnsliced() {
    return (entity.IMAccountsRecPartCost)getUnslicedUntyped();
  }
  
  public entity.windowed.IMAccountsRecPartCostVersionList getVersionList() {
    return (entity.windowed.IMAccountsRecPartCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.IMAccountsRecPartCost split(java.util.Date splitDate) {
    return (entity.IMAccountsRecPartCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.IMAccountsRecPartCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.IMAccountsRecPartCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.IMAccountsRecPartCost.class, config);
    com.guidewire._generated.entity.IMAccountsRecPartCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.IMAccountsRecPartCost, com.guidewire._generated.entity.IMAccountsRecPartCostInternal>() {
      public java.lang.Object getImplementation(entity.IMAccountsRecPartCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IMAccountsRecPartCostInternal getInternalInterface(entity.IMAccountsRecPartCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.IMAccountsRecPartCost newEmptyInstance() {
        return new entity.IMAccountsRecPartCost((java.lang.Void)null);
      }

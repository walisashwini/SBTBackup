 ...
 * Costs for inland marine accounts receivable part coverage
 */
...
@gw.entity.EntityName(value = "IMAccountsRecPartCovCost")
public class IMAccountsRecPartCovCost extends entity.IMAccountsRecPartCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.IMAccountsRecPartCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.IMAccountsRecPartCovCost, entity.PolicyPeriod>("entity.IMAccountsRecPartCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> IMACCOUNTSRECPARTCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "IMAccountsRecPartCov");
   ...
   */
  public IMAccountsRecPartCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public IMAccountsRecPartCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected IMAccountsRecPartCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.IMAccountsRecPartCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.IMAccountsRecPartCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.IMAccountsRecPartCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.IMAccountsRecPartCovCost clone() {
    return (entity.IMAccountsRecPartCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.IMAccountsRecPartCovCost getBasedOn() {
    return (entity.IMAccountsRecPartCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.IMAccountsRecPartCov getIMAccountsRecPartCov() {
    return (entity.IMAccountsRecPartCov)__getInternalInterface().getFieldValue(IMACCOUNTSRECPARTCOV_PROP.get());
  }
  
  public entity.IMAccountsRecPartCovCost getSlice(java.util.Date sliceDate) {
    return (entity.IMAccountsRecPartCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.IMAccountsRecPartCovCost getUnsliced() {
    return (entity.IMAccountsRecPartCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.IMAccountsRecPartCovCostVersionList getVersionList() {
    return (entity.windowed.IMAccountsRecPartCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setIMAccountsRecPartCov(entity.IMAccountsRecPartCov value) {
    __getInternalInterface().setFieldValue(IMACCOUNTSRECPARTCOV_PROP.get(), value);
  }
  
  public entity.IMAccountsRecPartCovCost split(java.util.Date splitDate) {
    return (entity.IMAccountsRecPartCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.IMAccountsRecPartCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.IMAccountsRecPartCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getIMAccountsRecPartCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(IMACCOUNTSRECPARTCOV_PROP.get());
    }
    ...
    public void setIMAccountsRecPartCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(IMACCOUNTSRECPARTCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.im.financials.IMCostMethods", "gw.lob.im.financials.IMAccountsRecPartCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.IMAccountsRecPartCovCost.class, config);
    com.guidewire._generated.entity.IMAccountsRecPartCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.IMAccountsRecPartCovCost, com.guidewire._generated.entity.IMAccountsRecPartCovCostInternal>() {
      public java.lang.Object getImplementation(entity.IMAccountsRecPartCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IMAccountsRecPartCovCostInternal getInternalInterface(entity.IMAccountsRecPartCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.IMAccountsRecPartCovCost newEmptyInstance() {
        return new entity.IMAccountsRecPartCovCost((java.lang.Void)null);
      }

...
/**
 * IMAccountsRecPartExcl
 * An Accounts Receivable part-level exclusion for Inland Marine
 */
...
@gw.entity.EntityName(value = "IMAccountsRecPartExcl")
public class IMAccountsRecPartExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.IMAccountsRecPartExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.IMAccountsRecPartExcl, entity.PolicyPeriod>("entity.IMAccountsRecPartExcl");
  ...
  private com.guidewire._generated.entity.IMAccountsRecPartExclInternal _internal;
   ...
   */
  protected IMAccountsRecPartExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected IMAccountsRecPartExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected IMAccountsRecPartExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.IMAccountsRecPartExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.IMAccountsRecPartExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.IMAccountsRecPartExcl clone() {
    return (entity.IMAccountsRecPartExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.IMAccountsRecPartExcl getBasedOn() {
    return (entity.IMAccountsRecPartExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.IMAccountsRecPartExcl getBasedOnValue() {
    return (entity.IMAccountsRecPartExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.IMAccountsRecPartExcl getFixed() {
    return (entity.IMAccountsRecPartExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.IMAccountsRecPartExcl getSlice(java.util.Date sliceDate) {
    return (entity.IMAccountsRecPartExcl)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.IMAccountsRecPartExcl getSubtype() {
    return (typekey.IMAccountsRecPartExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.IMAccountsRecPartExcl getUnsliced() {
    return (entity.IMAccountsRecPartExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.IMAccountsRecPartExclVersionList getVersionList() {
    return (entity.windowed.IMAccountsRecPartExclVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.IMAccountsRecPartExcl value) {
   ...
   */
  private void setFixed(entity.IMAccountsRecPartExcl value) {
   ...
   */
  private void setSubtype(typekey.IMAccountsRecPartExcl value) {
  ...
  public entity.IMAccountsRecPartExcl split(java.util.Date splitDate) {
    return (entity.IMAccountsRecPartExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.IMAccountsRecPartExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.IMAccountsRecPartExcl.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.IMAccountsRecPartExcl value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.IMAccountsRecPartExcl value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.IMAccountsRecPartExcl value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.im.ar.IMAccountsRecPartExclExclusionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.im.ar.IMAccountsRecPartExclExclusionAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.im.ar.IMAccountsRecPartExclExclusionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.im.IMAccountsRecPartExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.im.IMAccountsRecPartExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.IMAccountsRecPartExcl.class, config);
    com.guidewire._generated.entity.IMAccountsRecPartExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.IMAccountsRecPartExcl, com.guidewire._generated.entity.IMAccountsRecPartExclInternal>() {
      public java.lang.Object getImplementation(entity.IMAccountsRecPartExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IMAccountsRecPartExclInternal getInternalInterface(entity.IMAccountsRecPartExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.IMAccountsRecPartExcl newEmptyInstance() {
        return new entity.IMAccountsRecPartExcl((java.lang.Void)null);
      }

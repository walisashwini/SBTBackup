...
@gw.entity.EntityName(value = "IMAccountsReceivable")
public class IMAccountsReceivable extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverable, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.IMAccountsReceivable, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.IMAccountsReceivable, entity.PolicyPeriod>("entity.IMAccountsReceivable");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ACCOUNTSRECNUMBER_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AccountsRecNumber");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> FORWARDTOHOMEOFFICE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ForwardToHomeOffice");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> IMBUILDING_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "IMBuilding");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> PERCENTDUPLICATED_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "PercentDuplicated");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> RECEPTACLETYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "ReceptacleType");
  ...
  private com.guidewire._generated.entity.IMAccountsReceivableInternal _internal;
   ...
   */
  public IMAccountsReceivable(entity.PolicyPeriod branch)  {
   ...
   */
  public IMAccountsReceivable(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected IMAccountsReceivable(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.IMAccountsReceivableInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.IMAccountsReceivableInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.IMAccountsReceivable clone() {
    return (entity.IMAccountsReceivable)__getInternalInterface().cloneUntyped();
  }
  ...
  public java.lang.Integer getAccountsRecNumber() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(ACCOUNTSRECNUMBER_PROP.get());
  }
  ...
  public entity.IMAccountsReceivable getBasedOn() {
    return (entity.IMAccountsReceivable)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.IMAccountsReceivable getBasedOnValue() {
    return (entity.IMAccountsReceivable)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.IMAccountsRecCov[] getCoverages() {
    return (entity.IMAccountsRecCov[])__getInternalInterface().getFieldValue(COVERAGES_PROP.get());
  }
  ...
  public entity.IMAccountsReceivable getFixed() {
    return (entity.IMAccountsReceivable)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.IMBuilding getIMBuilding() {
    return (entity.IMBuilding)__getInternalInterface().getFieldValue(IMBUILDING_PROP.get());
  }
  ...
  public typekey.PercentDuplicated getPercentDuplicated() {
    return (typekey.PercentDuplicated)__getInternalInterface().getFieldValue(PERCENTDUPLICATED_PROP.get());
  }
  ...
  public typekey.ReceptacleType getReceptacleType() {
    return (typekey.ReceptacleType)__getInternalInterface().getFieldValue(RECEPTACLETYPE_PROP.get());
  }
  ...
  public entity.IMAccountsReceivable getSlice(java.util.Date sliceDate) {
    return (entity.IMAccountsReceivable)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.IMAccountsReceivable getSubtype() {
    return (typekey.IMAccountsReceivable)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.IMAccountsReceivable getUnsliced() {
    return (entity.IMAccountsReceivable)getUnslicedUntyped();
  }
  ...
  public entity.windowed.IMAccountsReceivableVersionList getVersionList() {
    return (entity.windowed.IMAccountsReceivableVersionList)getVersionListUntyped();
  }
  ...
  public java.lang.Boolean isForwardToHomeOffice() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(FORWARDTOHOMEOFFICE_PROP.get());
  }
  ...
  public void setAccountsRecNumber(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(ACCOUNTSRECNUMBER_PROP.get(), value);
  }
   ...
   */
  private void setBasedOnValue(entity.IMAccountsReceivable value) {
   ...
   */
  private void setFixed(entity.IMAccountsReceivable value) {
  ...
  public void setForwardToHomeOffice(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(FORWARDTOHOMEOFFICE_PROP.get(), value);
  }
  ...
  public void setIMBuilding(entity.IMBuilding value) {
    __getInternalInterface().setFieldValue(IMBUILDING_PROP.get(), value);
  }
  ...
  public void setPercentDuplicated(typekey.PercentDuplicated value) {
    __getInternalInterface().setFieldValue(PERCENTDUPLICATED_PROP.get(), value);
  }
  ...
  public void setReceptacleType(typekey.ReceptacleType value) {
    __getInternalInterface().setFieldValue(RECEPTACLETYPE_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.IMAccountsReceivable value) {
  ...
  public entity.IMAccountsReceivable split(java.util.Date splitDate) {
    return (entity.IMAccountsReceivable)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.IMAccountsReceivableInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.IMAccountsReceivable.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getIMBuildingID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(IMBUILDING_PROP.get());
    }
    ...
    public void setIMBuildingID(gw.pl.persistence.core.Key value) {
      setFieldValue(IMBUILDING_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.im.ar.IMARCoverableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.im.ar.IMARCoverableAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.im.ar.IMAccountsReceivableMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.im.ar.IMAccountsReceivableMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.IMAccountsReceivable.class, config);
    com.guidewire._generated.entity.IMAccountsReceivableInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.IMAccountsReceivable, com.guidewire._generated.entity.IMAccountsReceivableInternal>() {
      public java.lang.Object getImplementation(entity.IMAccountsReceivable bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IMAccountsReceivableInternal getInternalInterface(entity.IMAccountsReceivable bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.IMAccountsReceivable newEmptyInstance() {
        return new entity.IMAccountsReceivable((java.lang.Void)null);
      }

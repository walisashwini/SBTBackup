...
/**
 * IMCededPremium
 * An InlandMarine implementation of the RICededPremium delegate
 */
...
@gw.entity.EntityName(value = "IMCededPremium")
public class IMCededPremium extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.RICededPremium, entity.FrozenSetMember, gw.api.reinsurance.RICededPremiumAdapter {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.IMCededPremium> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.IMCededPremium>("entity.IMCededPremium");
  ...
  private com.guidewire._generated.entity.IMCededPremiumInternal _internal;
   ...
   */
  public IMCededPremium(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected IMCededPremium(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.IMCededPremiumInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.IMCededPremiumInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.IMCededPremiumHistory[] getCedingHistory() {
    return (entity.IMCededPremiumHistory[])__getInternalInterface().getFieldValue(CEDINGHISTORY_PROP.get());
  }
  ...
  public entity.IMCededPremiumTransaction[] getCedingTransactions() {
    return (entity.IMCededPremiumTransaction[])__getInternalInterface().getFieldValue(CEDINGTRANSACTIONS_PROP.get());
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.IMCededPremiumInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.IMCededPremium.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.reinsurance.RICededPremiumAdapter", "gw.reinsurance.ceding.IMCededPremiumAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.IMCededPremium.class, config);
    com.guidewire._generated.entity.IMCededPremiumInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.IMCededPremium, com.guidewire._generated.entity.IMCededPremiumInternal>() {
      public java.lang.Object getImplementation(entity.IMCededPremium bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IMCededPremiumInternal getInternalInterface(entity.IMCededPremium bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.IMCededPremium newEmptyInstance() {
        return new entity.IMCededPremium((java.lang.Void)null);
      }

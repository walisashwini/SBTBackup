...
/**
 * IMCededPremiumTransaction
 * An InlandMarine implementation of the RICededPremiumTransaction delegate
 */
...
@gw.entity.EntityName(value = "IMCededPremiumTransaction")
public class IMCededPremiumTransaction extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.RICededPremiumTransaction, entity.FrozenSetMember, gw.api.reinsurance.RICededPremiumTxnAdapter {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.IMCededPremiumTransaction> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.IMCededPremiumTransaction>("entity.IMCededPremiumTransaction");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> IMCEDEDPREMIUM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "IMCededPremium");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> IMCEDEDPREMIUMHISTORY_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "IMCededPremiumHistory");
  ...
  private com.guidewire._generated.entity.IMCededPremiumTransactionInternal _internal;
   ...
   */
  public IMCededPremiumTransaction()  {
   ...
   */
  public IMCededPremiumTransaction(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected IMCededPremiumTransaction(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.IMCededPremiumTransactionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.IMCededPremiumTransactionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.IMCededPremium getIMCededPremium() {
    return (entity.IMCededPremium)__getInternalInterface().getFieldValue(IMCEDEDPREMIUM_PROP.get());
  }
  ...
  public entity.IMCededPremiumHistory getIMCededPremiumHistory() {
    return (entity.IMCededPremiumHistory)__getInternalInterface().getFieldValue(IMCEDEDPREMIUMHISTORY_PROP.get());
  }
  ...
  public void setIMCededPremium(entity.IMCededPremium value) {
    __getInternalInterface().setFieldValue(IMCEDEDPREMIUM_PROP.get(), value);
  }
  ...
  public void setIMCededPremiumHistory(entity.IMCededPremiumHistory value) {
    __getInternalInterface().setFieldValue(IMCEDEDPREMIUMHISTORY_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.IMCededPremiumTransactionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.IMCededPremiumTransaction.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getIMCededPremiumHistoryID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(IMCEDEDPREMIUMHISTORY_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getIMCededPremiumID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(IMCEDEDPREMIUM_PROP.get());
    }
    ...
    public void setIMCededPremiumHistoryID(gw.pl.persistence.core.Key value) {
      setFieldValue(IMCEDEDPREMIUMHISTORY_PROP.get(), value);
    }
    
    public void setIMCededPremiumID(gw.pl.persistence.core.Key value) {
      setFieldValue(IMCEDEDPREMIUM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.reinsurance.RICededPremiumTxnAdapter", "gw.reinsurance.ceding.IMCededPremiumTransactionAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.IMCededPremiumTransaction.class, config);
    com.guidewire._generated.entity.IMCededPremiumTransactionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.IMCededPremiumTransaction, com.guidewire._generated.entity.IMCededPremiumTransactionInternal>() {
      public java.lang.Object getImplementation(entity.IMCededPremiumTransaction bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IMCededPremiumTransactionInternal getInternalInterface(entity.IMCededPremiumTransaction bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.IMCededPremiumTransaction newEmptyInstance() {
        return new entity.IMCededPremiumTransaction((java.lang.Void)null);
      }

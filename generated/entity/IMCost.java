...
/**
 * IMCost
 * A Inland Marine unit of price for a period of time that should not be broken up any further.
 */
...
public abstract class IMCost extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.IMCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.IMCost, entity.PolicyPeriod>("entity.IMCost");
  ...
  private com.guidewire._generated.entity.IMCostInternal _internal;
  ...
  protected IMCost(java.lang.Void ignored)  {
    
  }
  
  protected abstract com.guidewire._generated.entity.IMCostInternal __createInternalInterface();
  ...
  protected com.guidewire._generated.entity.IMCostInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.IMCost clone() {
    return (entity.IMCost)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.IMCost getBasedOn() {
    return (entity.IMCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.IMCost getSlice(java.util.Date sliceDate) {
    return (entity.IMCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.IMCost getUnsliced() {
    return (entity.IMCost)getUnslicedUntyped();
  }
  ...
  public entity.windowed.IMCostVersionList getVersionList() {
    return (entity.windowed.IMCostVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.IMCost value) {
   ...
   */
  private void setFixed(entity.IMCost value) {
   ...
   */
  private void setSubtype(typekey.IMCost value) {
   ...
   */
  private void setTransactions(entity.IMTransaction[] value) {
  ...
  public entity.IMCost split(java.util.Date splitDate) {
    return (entity.IMCost)splitUntyped(splitDate);
  }
  ...
  static {
    com.guidewire._generated.entity.IMCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.EntityFriendAccess<entity.IMCost, com.guidewire._generated.entity.IMCostInternal>() {
      public java.lang.Object getImplementation(entity.IMCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IMCostInternal getInternalInterface(entity.IMCost bean) {
        if(bean == null) {
          return null;
        };

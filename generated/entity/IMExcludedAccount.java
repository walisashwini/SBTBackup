...
/**
 * IMExcludedAccount
 * Inland Marine Excluded Account for Account Receivable
 */
...
@gw.entity.EntityName(value = "IMExcludedAccount")
public class IMExcludedAccount extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.IMExcludedAccount, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.IMExcludedAccount, entity.PolicyPeriod>("entity.IMExcludedAccount");
  ...
  private com.guidewire._generated.entity.IMExcludedAccountInternal _internal;
   ...
   */
  public IMExcludedAccount(entity.PolicyPeriod branch)  {
   ...
   */
  public IMExcludedAccount(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected IMExcludedAccount(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.IMExcludedAccountInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.IMExcludedAccountInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.IMExcludedAccount clone() {
    return (entity.IMExcludedAccount)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.IMExcludedAccount getBasedOn() {
    return (entity.IMExcludedAccount)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.IMExcludedAccount getBasedOnValue() {
    return (entity.IMExcludedAccount)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.IMExcludedAccount getFixed() {
    return (entity.IMExcludedAccount)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.IMExcludedAccount getSlice(java.util.Date sliceDate) {
    return (entity.IMExcludedAccount)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.IMExcludedAccount getSubtype() {
    return (typekey.IMExcludedAccount)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.IMExcludedAccount getUnsliced() {
    return (entity.IMExcludedAccount)getUnslicedUntyped();
  }
  ...
  public entity.windowed.IMExcludedAccountVersionList getVersionList() {
    return (entity.windowed.IMExcludedAccountVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.IMExcludedAccount value) {
   ...
   */
  private void setFixed(entity.IMExcludedAccount value) {
   ...
   */
  private void setSubtype(typekey.IMExcludedAccount value) {
  ...
  public entity.IMExcludedAccount split(java.util.Date splitDate) {
    return (entity.IMExcludedAccount)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.IMExcludedAccountInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.IMExcludedAccount.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.IMExcludedAccount.class, config);
    com.guidewire._generated.entity.IMExcludedAccountInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.IMExcludedAccount, com.guidewire._generated.entity.IMExcludedAccountInternal>() {
      public java.lang.Object getImplementation(entity.IMExcludedAccount bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IMExcludedAccountInternal getInternalInterface(entity.IMExcludedAccount bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.IMExcludedAccount newEmptyInstance() {
        return new entity.IMExcludedAccount((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "IMLocation")
public class IMLocation extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, gw.api.copier.EffDatedCopyable, gw.api.domain.LineSpecificLocation, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.IMLocation, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.IMLocation, entity.PolicyPeriod>("entity.IMLocation");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> IMLINE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "IMLine");
  ...
  private com.guidewire._generated.entity.IMLocationInternal _internal;
   ...
   */
  public IMLocation(entity.PolicyPeriod branch)  {
   ...
   */
  public IMLocation(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected IMLocation(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.IMLocationInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.IMLocationInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.IMLocation clone() {
    return (entity.IMLocation)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.IMLocation getBasedOn() {
    return (entity.IMLocation)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.IMLocation getBasedOnValue() {
    return (entity.IMLocation)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.IMBuilding[] getBuildings() {
    return (entity.IMBuilding[])__getInternalInterface().getFieldValue(BUILDINGS_PROP.get());
  }
  ...
  public entity.IMLocation getFixed() {
    return (entity.IMLocation)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.InlandMarineLine getIMLine() {
    return (entity.InlandMarineLine)__getInternalInterface().getFieldValue(IMLINE_PROP.get());
  }
  ...
  public entity.IMLocation getSlice(java.util.Date sliceDate) {
    return (entity.IMLocation)getSliceUntyped(sliceDate);
  }
  ...
  public entity.IMLocation getUnsliced() {
    return (entity.IMLocation)getUnslicedUntyped();
  }
  ...
  public entity.windowed.IMLocationVersionList getVersionList() {
    return (entity.windowed.IMLocationVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.IMLocation value) {
   ...
   */
  private void setFixed(entity.IMLocation value) {
  ...
  public void setIMLine(entity.InlandMarineLine value) {
    __getInternalInterface().setFieldValue(IMLINE_PROP.get(), value);
  }
  ...
  public entity.IMLocation split(java.util.Date splitDate) {
    return (entity.IMLocation)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.IMLocationInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.IMLocation.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getIMLineID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(IMLINE_PROP.get());
    }
    ...
    public void setIMLineID(gw.pl.persistence.core.Key value) {
      setFieldValue(IMLINE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.copier.EffDatedCopyable", "gw.lob.im.IMLocationCopier");
    config.put("gw.api.domain.LineSpecificLocation", "gw.lob.im.IMSpecificLocation");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.im.IMLocationMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.im.IMLocationMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.IMLocation.class, config);
    com.guidewire._generated.entity.IMLocationInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.IMLocation, com.guidewire._generated.entity.IMLocationInternal>() {
      public java.lang.Object getImplementation(entity.IMLocation bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IMLocationInternal getInternalInterface(entity.IMLocation bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.IMLocation newEmptyInstance() {
        return new entity.IMLocation((java.lang.Void)null);
      }

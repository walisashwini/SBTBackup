 ...
 * An additional interest on a piece of contractors equipment
 */
...
@gw.entity.EntityName(value = "IMSchEquipAddlInterest")
public class IMSchEquipAddlInterest extends entity.AddlInterestDetail implements gw.api.copier.EffDatedCopyable, gw.api.domain.account.Mergeable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.IMSchEquipAddlInterest, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.IMSchEquipAddlInterest, entity.PolicyPeriod>("entity.IMSchEquipAddlInterest");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> CONTRACTORSEQUIPMENT_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ContractorsEquipment");
   ...
   */
  public IMSchEquipAddlInterest(entity.PolicyPeriod branch)  {
   ...
   */
  public IMSchEquipAddlInterest(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected IMSchEquipAddlInterest(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.IMSchEquipAddlInterestInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.IMSchEquipAddlInterestInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.IMSchEquipAddlInterestInternal)super.__getInternalInterface();
  }
  
  public entity.IMSchEquipAddlInterest clone() {
    return (entity.IMSchEquipAddlInterest)__getInternalInterface().cloneUntyped();
  }
  
  public entity.IMSchEquipAddlInterest getBasedOn() {
    return (entity.IMSchEquipAddlInterest)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.ContractorsEquipment getContractorsEquipment() {
    return (entity.ContractorsEquipment)__getInternalInterface().getFieldValue(CONTRACTORSEQUIPMENT_PROP.get());
  }
  
  public entity.IMSchEquipAddlInterest getSlice(java.util.Date sliceDate) {
    return (entity.IMSchEquipAddlInterest)getSliceUntyped(sliceDate);
  }
  
  public entity.IMSchEquipAddlInterest getUnsliced() {
    return (entity.IMSchEquipAddlInterest)getUnslicedUntyped();
  }
  
  public entity.windowed.IMSchEquipAddlInterestVersionList getVersionList() {
    return (entity.windowed.IMSchEquipAddlInterestVersionList)getVersionListUntyped();
  }
  ...
  public void setContractorsEquipment(entity.ContractorsEquipment value) {
    __getInternalInterface().setFieldValue(CONTRACTORSEQUIPMENT_PROP.get(), value);
  }
  
  public entity.IMSchEquipAddlInterest split(java.util.Date splitDate) {
    return (entity.IMSchEquipAddlInterest)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.IMSchEquipAddlInterestInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.IMSchEquipAddlInterest.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getContractorsEquipmentID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(CONTRACTORSEQUIPMENT_PROP.get());
    }
    ...
    public void setContractorsEquipmentID(gw.pl.persistence.core.Key value) {
      setFieldValue(CONTRACTORSEQUIPMENT_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.account.Mergeable", "gw.lob.im.IMSchEquipAddlInterestMergeableImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.im.IMSchEquipAddlInterestMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.im.IMSchEquipAddlInterestMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.IMSchEquipAddlInterest.class, config);
    com.guidewire._generated.entity.IMSchEquipAddlInterestInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.IMSchEquipAddlInterest, com.guidewire._generated.entity.IMSchEquipAddlInterestInternal>() {
      public java.lang.Object getImplementation(entity.IMSchEquipAddlInterest bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IMSchEquipAddlInterestInternal getInternalInterface(entity.IMSchEquipAddlInterest bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.IMSchEquipAddlInterest newEmptyInstance() {
        return new entity.IMSchEquipAddlInterest((java.lang.Void)null);
      }

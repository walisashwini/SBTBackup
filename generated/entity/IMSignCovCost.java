...
/**
 * IMSignCovCost
 * Costs for an inland marine sign coverage
 */
...
@gw.entity.EntityName(value = "IMSignCovCost")
public class IMSignCovCost extends entity.IMSignPartCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.IMSignCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.IMSignCovCost, entity.PolicyPeriod>("entity.IMSignCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> IMSIGNCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "IMSignCov");
   ...
   */
  public IMSignCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public IMSignCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected IMSignCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.IMSignCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.IMSignCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.IMSignCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.IMSignCovCost clone() {
    return (entity.IMSignCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.IMSignCovCost getBasedOn() {
    return (entity.IMSignCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.IMSignCov getIMSignCov() {
    return (entity.IMSignCov)__getInternalInterface().getFieldValue(IMSIGNCOV_PROP.get());
  }
  
  public entity.IMSignCovCost getSlice(java.util.Date sliceDate) {
    return (entity.IMSignCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.IMSignCovCost getUnsliced() {
    return (entity.IMSignCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.IMSignCovCostVersionList getVersionList() {
    return (entity.windowed.IMSignCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setIMSignCov(entity.IMSignCov value) {
    __getInternalInterface().setFieldValue(IMSIGNCOV_PROP.get(), value);
  }
  
  public entity.IMSignCovCost split(java.util.Date splitDate) {
    return (entity.IMSignCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.IMSignCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.IMSignCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getIMSignCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(IMSIGNCOV_PROP.get());
    }
    ...
    public void setIMSignCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(IMSIGNCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.financials.CostAdapter", "gw.lob.im.financials.IMSignCovCostAdapter");
    config.put("gw.lob.im.financials.IMCostMethods", "gw.lob.im.financials.IMSignCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.IMSignCovCost.class, config);
    com.guidewire._generated.entity.IMSignCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.IMSignCovCost, com.guidewire._generated.entity.IMSignCovCostInternal>() {
      public java.lang.Object getImplementation(entity.IMSignCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IMSignCovCostInternal getInternalInterface(entity.IMSignCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.IMSignCovCost newEmptyInstance() {
        return new entity.IMSignCovCost((java.lang.Void)null);
      }

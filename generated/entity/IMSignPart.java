...
@gw.entity.EntityName(value = "IMSignPart")
public class IMSignPart extends entity.IMCoveragePart {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.IMSignPart, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.IMSignPart, entity.PolicyPeriod>("entity.IMSignPart");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> IMSIGNPARTCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "IMSignPartCosts");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> IMSIGNS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "IMSigns");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> SIGNAUTONUMBERSEQ_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "SignAutoNumberSeq");
   ...
   */
  public IMSignPart(entity.PolicyPeriod branch)  {
   ...
   */
  public IMSignPart(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected IMSignPart(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.IMSignPartInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.IMSignPartInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.IMSignPartInternal)super.__getInternalInterface();
  }
  ...
  public void addToIMSignPartCosts(entity.IMSignPartCost element) {
    __getInternalInterface().addArrayElement(IMSIGNPARTCOSTS_PROP.get(), element);
  }
  ...
  public void addToIMSigns(entity.IMSign element) {
    __getInternalInterface().addArrayElement(IMSIGNS_PROP.get(), element);
  }
  
  public entity.IMSignPart clone() {
    return (entity.IMSignPart)__getInternalInterface().cloneUntyped();
  }
  
  public entity.IMSignPart getBasedOn() {
    return (entity.IMSignPart)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.IMSignPartCost[] getIMSignPartCosts() {
    return (entity.IMSignPartCost[])__getInternalInterface().getFieldValue(IMSIGNPARTCOSTS_PROP.get());
  }
  ...
  public entity.IMSign[] getIMSigns() {
    return (entity.IMSign[])__getInternalInterface().getFieldValue(IMSIGNS_PROP.get());
  }
  ...
  public entity.AutoNumberSequence getSignAutoNumberSeq() {
    return (entity.AutoNumberSequence)__getInternalInterface().getFieldValue(SIGNAUTONUMBERSEQ_PROP.get());
  }
  
  public entity.IMSignPart getSlice(java.util.Date sliceDate) {
    return (entity.IMSignPart)getSliceUntyped(sliceDate);
  }
  
  public entity.IMSignPart getUnsliced() {
    return (entity.IMSignPart)getUnslicedUntyped();
  }
  
  public entity.windowed.IMSignPartVersionList getVersionList() {
    return (entity.windowed.IMSignPartVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromIMSignPartCosts(entity.IMSignPartCost element) {
    __getInternalInterface().removeArrayElement(IMSIGNPARTCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromIMSignPartCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(IMSIGNPARTCOSTS_PROP.get(), elementID);
  }
  ...
  public void removeFromIMSigns(entity.IMSign element) {
    __getInternalInterface().removeArrayElement(IMSIGNS_PROP.get(), element);
  }
  ...
  public void removeFromIMSigns(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(IMSIGNS_PROP.get(), elementID);
  }
  ...
  public void setIMSignPartCosts(entity.IMSignPartCost[] value) {
    __getInternalInterface().setFieldValue(IMSIGNPARTCOSTS_PROP.get(), value);
  }
  ...
  public void setIMSigns(entity.IMSign[] value) {
    __getInternalInterface().setFieldValue(IMSIGNS_PROP.get(), value);
  }
  ...
  public void setSignAutoNumberSeq(entity.AutoNumberSequence value) {
    __getInternalInterface().setFieldValue(SIGNAUTONUMBERSEQ_PROP.get(), value);
  }
  
  public entity.IMSignPart split(java.util.Date splitDate) {
    return (entity.IMSignPart)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.IMSignPartInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.IMSignPart.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getSignAutoNumberSeqID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(SIGNAUTONUMBERSEQ_PROP.get());
    }
    ...
    public void setSignAutoNumberSeqID(gw.pl.persistence.core.Key value) {
      setFieldValue(SIGNAUTONUMBERSEQ_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.IMSignPart.class, config);
    com.guidewire._generated.entity.IMSignPartInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.IMSignPart, com.guidewire._generated.entity.IMSignPartInternal>() {
      public java.lang.Object getImplementation(entity.IMSignPart bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IMSignPartInternal getInternalInterface(entity.IMSignPart bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.IMSignPart newEmptyInstance() {
        return new entity.IMSignPart((java.lang.Void)null);
      }

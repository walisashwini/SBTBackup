...
@gw.entity.EntityName(value = "IMTaxCost")
public class IMTaxCost extends entity.IMCost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.IMTaxCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.IMTaxCost, entity.PolicyPeriod>("entity.IMTaxCost");
   ...
   */
  public IMTaxCost(entity.PolicyPeriod branch)  {
   ...
   */
  public IMTaxCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected IMTaxCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.IMTaxCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.IMTaxCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.IMTaxCostInternal)super.__getInternalInterface();
  }
  
  public entity.IMTaxCost clone() {
    return (entity.IMTaxCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.IMTaxCost getBasedOn() {
    return (entity.IMTaxCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.IMTaxCost getSlice(java.util.Date sliceDate) {
    return (entity.IMTaxCost)getSliceUntyped(sliceDate);
  }
  
  public entity.IMTaxCost getUnsliced() {
    return (entity.IMTaxCost)getUnslicedUntyped();
  }
  
  public entity.windowed.IMTaxCostVersionList getVersionList() {
    return (entity.windowed.IMTaxCostVersionList)getVersionListUntyped();
  }
  
  public entity.IMTaxCost split(java.util.Date splitDate) {
    return (entity.IMTaxCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.IMTaxCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.IMTaxCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.IMTaxCost.class, config);
    com.guidewire._generated.entity.IMTaxCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.IMTaxCost, com.guidewire._generated.entity.IMTaxCostInternal>() {
      public java.lang.Object getImplementation(entity.IMTaxCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IMTaxCostInternal getInternalInterface(entity.IMTaxCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.IMTaxCost newEmptyInstance() {
        return new entity.IMTaxCost((java.lang.Void)null);
      }

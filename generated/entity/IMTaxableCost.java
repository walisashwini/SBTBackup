...
/**
 * IMTaxableCost
 * Taxable cost items for inland marine
 */
...
@gw.entity.EntityName(value = "IMTaxableCost")
public class IMTaxableCost extends entity.IMCost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.IMTaxableCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.IMTaxableCost, entity.PolicyPeriod>("entity.IMTaxableCost");
   ...
   */
  public IMTaxableCost(entity.PolicyPeriod branch)  {
   ...
   */
  public IMTaxableCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected IMTaxableCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.IMTaxableCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.IMTaxableCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.IMTaxableCostInternal)super.__getInternalInterface();
  }
  
  public entity.IMTaxableCost clone() {
    return (entity.IMTaxableCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.IMTaxableCost getBasedOn() {
    return (entity.IMTaxableCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.IMTaxableCost getSlice(java.util.Date sliceDate) {
    return (entity.IMTaxableCost)getSliceUntyped(sliceDate);
  }
  
  public entity.IMTaxableCost getUnsliced() {
    return (entity.IMTaxableCost)getUnslicedUntyped();
  }
  
  public entity.windowed.IMTaxableCostVersionList getVersionList() {
    return (entity.windowed.IMTaxableCostVersionList)getVersionListUntyped();
  }
  
  public entity.IMTaxableCost split(java.util.Date splitDate) {
    return (entity.IMTaxableCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.IMTaxableCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.IMTaxableCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.IMTaxableCost.class, config);
    com.guidewire._generated.entity.IMTaxableCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.IMTaxableCost, com.guidewire._generated.entity.IMTaxableCostInternal>() {
      public java.lang.Object getImplementation(entity.IMTaxableCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IMTaxableCostInternal getInternalInterface(entity.IMTaxableCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.IMTaxableCost newEmptyInstance() {
        return new entity.IMTaxableCost((java.lang.Void)null);
      }

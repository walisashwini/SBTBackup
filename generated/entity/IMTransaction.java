...
/**
 * IMTransaction
 * A transaction for the Inland Marine line
 */
...
@gw.entity.EntityName(value = "IMTransaction")
public class IMTransaction extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Transaction {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.IMTransaction, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.IMTransaction, entity.PolicyPeriod>("entity.IMTransaction");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> IMCOST_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "IMCost");
  ...
  private com.guidewire._generated.entity.IMTransactionInternal _internal;
   ...
   */
  public IMTransaction(entity.PolicyPeriod branch)  {
   ...
   */
  public IMTransaction(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected IMTransaction(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.IMTransactionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.IMTransactionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.IMTransaction clone() {
    return (entity.IMTransaction)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.IMTransaction getBasedOn() {
    return (entity.IMTransaction)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.IMTransaction getBasedOnValue() {
    return (entity.IMTransaction)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.IMTransaction getFixed() {
    return (entity.IMTransaction)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.IMCost getIMCost() {
    return (entity.IMCost)__getInternalInterface().getFieldValue(IMCOST_PROP.get());
  }
  ...
  public entity.IMTransaction getSlice(java.util.Date sliceDate) {
    return (entity.IMTransaction)getSliceUntyped(sliceDate);
  }
  ...
  public entity.IMTransaction getUnsliced() {
    return (entity.IMTransaction)getUnslicedUntyped();
  }
  ...
  public entity.windowed.IMTransactionVersionList getVersionList() {
    return (entity.windowed.IMTransactionVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.IMTransaction value) {
   ...
   */
  private void setFixed(entity.IMTransaction value) {
  ...
  public void setIMCost(entity.IMCost value) {
    __getInternalInterface().setFieldValue(IMCOST_PROP.get(), value);
  }
  ...
  public entity.IMTransaction split(java.util.Date splitDate) {
    return (entity.IMTransaction)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.IMTransactionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.IMTransaction.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getIMCostID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(IMCOST_PROP.get());
    }
    ...
    public void setIMCostID(gw.pl.persistence.core.Key value) {
      setFieldValue(IMCOST_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.financials.TransactionAdapter", "gw.lob.im.financials.IMTransactionAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.IMTransaction.class, config);
    com.guidewire._generated.entity.IMTransactionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.IMTransaction, com.guidewire._generated.entity.IMTransactionInternal>() {
      public java.lang.Object getImplementation(entity.IMTransaction bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IMTransactionInternal getInternalInterface(entity.IMTransaction bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.IMTransaction newEmptyInstance() {
        return new entity.IMTransaction((java.lang.Void)null);
      }

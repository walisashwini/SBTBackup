 ...
 * Temporary entity to store location level errors from the risk assessment service
 */
...
@gw.entity.EntityName(value = "InboundLocationRiskAssessmentErrorTempStore")
public class InboundLocationRiskAssessmentErrorTempStore extends com.guidewire.pl.persistence.code.BeanBase implements entity.Editable, entity.InboundRiskAssessmentErrorTempStore, entity.FrozenSetMember {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.InboundLocationRiskAssessmentErrorTempStore> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.InboundLocationRiskAssessmentErrorTempStore>("entity.InboundLocationRiskAssessmentErrorTempStore");
  ...
  private com.guidewire._generated.entity.InboundLocationRiskAssessmentErrorTempStoreInternal _internal;
   ...
   */
  public InboundLocationRiskAssessmentErrorTempStore()  {
   ...
   */
  public InboundLocationRiskAssessmentErrorTempStore(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected InboundLocationRiskAssessmentErrorTempStore(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.InboundLocationRiskAssessmentErrorTempStoreInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.InboundLocationRiskAssessmentErrorTempStoreInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.InboundLocationRiskAssessmentErrorTempStoreInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.InboundLocationRiskAssessmentErrorTempStore.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.InboundLocationRiskAssessmentErrorTempStore.class, config);
    com.guidewire._generated.entity.InboundLocationRiskAssessmentErrorTempStoreInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.InboundLocationRiskAssessmentErrorTempStore, com.guidewire._generated.entity.InboundLocationRiskAssessmentErrorTempStoreInternal>() {
      public java.lang.Object getImplementation(entity.InboundLocationRiskAssessmentErrorTempStore bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.InboundLocationRiskAssessmentErrorTempStoreInternal getInternalInterface(entity.InboundLocationRiskAssessmentErrorTempStore bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.InboundLocationRiskAssessmentErrorTempStore newEmptyInstance() {
        return new entity.InboundLocationRiskAssessmentErrorTempStore((java.lang.Void)null);
      }

...
/**
 * InclusionPerson
 * Named individuals for purpose of inclusion/exclusion from coverage (e.g. include Sally who is a resident family member, exclude Jack the family butler in a state where coverage for domestic workers is optional)
 */
...
@gw.entity.EntityName(value = "InclusionPerson")
public class InclusionPerson extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.InclusionPerson, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.InclusionPerson, entity.PolicyPeriod>("entity.InclusionPerson");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DUTIES_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Duties");
  ...
  private com.guidewire._generated.entity.InclusionPersonInternal _internal;
   ...
   */
  public InclusionPerson(entity.PolicyPeriod branch)  {
   ...
   */
  public InclusionPerson(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected InclusionPerson(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.InclusionPersonInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.InclusionPersonInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.InclusionPerson clone() {
    return (entity.InclusionPerson)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.InclusionPerson getBasedOn() {
    return (entity.InclusionPerson)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.InclusionPerson getBasedOnValue() {
    return (entity.InclusionPerson)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public java.lang.String getDuties() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(DUTIES_PROP.get());
  }
  ...
  public entity.InclusionPerson getFixed() {
    return (entity.InclusionPerson)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public typekey.Relationship getRelationship() {
    return (typekey.Relationship)__getInternalInterface().getFieldValue(RELATIONSHIP_PROP.get());
  }
  
  public entity.InclusionPerson getSlice(java.util.Date sliceDate) {
    return (entity.InclusionPerson)getSliceUntyped(sliceDate);
  }
  ...
  public entity.InclusionPerson getUnsliced() {
    return (entity.InclusionPerson)getUnslicedUntyped();
  }
  ...
  public entity.windowed.InclusionPersonVersionList getVersionList() {
    return (entity.windowed.InclusionPersonVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.InclusionPerson value) {
  ...
  public void setDuties(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(DUTIES_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.InclusionPerson value) {
  ...
  public entity.InclusionPerson split(java.util.Date splitDate) {
    return (entity.InclusionPerson)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.InclusionPersonInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.InclusionPerson.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.wc.InclusionPersonMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.wc.InclusionPersonMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.InclusionPerson.class, config);
    com.guidewire._generated.entity.InclusionPersonInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.InclusionPerson, com.guidewire._generated.entity.InclusionPersonInternal>() {
      public java.lang.Object getImplementation(entity.InclusionPerson bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.InclusionPersonInternal getInternalInterface(entity.InclusionPerson bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.InclusionPerson newEmptyInstance() {
        return new entity.InclusionPerson((java.lang.Void)null);
      }

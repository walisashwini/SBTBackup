...
/**
 * IndustryCode
 * A standardized code describing operations performed
 */
...
@gw.entity.EntityName(value = "IndustryCode")
public class IndustryCode extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.IndustryCode> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.IndustryCode>("entity.IndustryCode");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> DOMAIN_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "Domain");
  ...
  private com.guidewire._generated.entity.IndustryCodeInternal _internal;
   ...
   */
  public IndustryCode(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected IndustryCode(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.IndustryCodeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.IndustryCodeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.IndustryCode_Classification_L10N[] getClassification_L10N_ARRAY() {
    return (entity.IndustryCode_Classification_L10N[])__getInternalInterface().getFieldValue(CLASSIFICATION_L10N_ARRAY_PROP.get());
  }
  ...
  public typekey.IndustryCodeType getDomain() {
    return (typekey.IndustryCodeType)__getInternalInterface().getFieldValue(DOMAIN_PROP.get());
  }
  ...
  /**
   * Returns whether this industry code is available based on the given reference date.
   * @param referenceDate the date to check for availability
   * @return true if available on the given date
   */
  public boolean isAvailable(java.util.Date referenceDate) {
    return ((com.guidewire.pc.domain.product.IndustryCodePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.product.IndustryCodePublicMethods")).isAvailable(referenceDate);
  }
   ...
   */
  private void setClassification_L10N_ARRAY(entity.IndustryCode_Classification_L10N[] value) {
  ...
  public void setDomain(typekey.IndustryCodeType value) {
    __getInternalInterface().setFieldValue(DOMAIN_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.IndustryCodeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.IndustryCode.this.__getDelegateManager();
    }
    ...
    public entity.IndustryCode_Classification_L10N getClassification_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.IndustryCode_Classification_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.product.IndustryCodePublicMethods", "com.guidewire.pc.domain.product.impl.IndustryCodeImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.IndustryCode.class, config);
    com.guidewire._generated.entity.IndustryCodeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.IndustryCode, com.guidewire._generated.entity.IndustryCodeInternal>() {
      public java.lang.Object getImplementation(entity.IndustryCode bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IndustryCodeInternal getInternalInterface(entity.IndustryCode bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.IndustryCode newEmptyInstance() {
        return new entity.IndustryCode((java.lang.Void)null);
      }

...
/**
 * Issuance
 * Issuance process object relating to one or more versions of a policy
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "Issuance.eti;Issuance.eix;Issuance.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "Issuance")
public class Issuance extends entity.Job {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.Issuance> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.Issuance>("entity.Issuance");
   ...
   */
  public Issuance(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected Issuance(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.IssuanceInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.IssuanceInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.IssuanceInternal)super.__getInternalInterface();
  }
  
  /**
   * Starts an issuance job on the latest bound period of the policy.
   * The EditEffectiveDate will be the effective date of that period.
  ...
  public void startJob(entity.Policy policy) throws com.guidewire.pl.web.controller.UserDisplayableException {
    ((com.guidewire.pc.domain.job.IssuancePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.IssuancePublicMethods")).startJob(policy);
  }
  
  /**
   * Same as startJob() but commits the job's bundle after starting the job.
   * @param policy The policy for which the job is to be started
   * @param location the web location so that data can be validated
   * @return true if the job is started
   */
  public boolean startJobAndCommit(entity.Policy policy, pcf.api.Location location) {
    return ((com.guidewire.pc.domain.job.IssuancePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.IssuancePublicMethods")).startJobAndCommit(policy, location);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.IssuanceInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.Issuance.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.job.IssuancePublicMethods", "com.guidewire.pc.domain.job.impl.IssuanceImpl");
    config.put("com.guidewire.pc.domain.job.JobPublicMethods", "com.guidewire.pc.domain.job.impl.IssuanceImpl");
    config.put("com.guidewire.pc.domain.job.impl.JobInternalMethods", "com.guidewire.pc.domain.job.impl.JobImpl");
    config.put("com.guidewire.pc.domain.note.NoteContainer", "com.guidewire.pc.domain.job.impl.IssuanceImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.job.impl.IssuanceImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.pc.domain.job.impl.JobImpl");
    config.put("com.guidewire.pl.system.entity.DoesNotValidateOnCommit", "com.guidewire.pc.domain.job.impl.IssuanceImpl");
    config.put("gw.api.assignment.UserRoleOwner", "com.guidewire.pc.domain.job.impl.IssuanceImpl");
    config.put("gw.api.domain.document.DocumentContainer", "com.guidewire.pc.domain.job.impl.IssuanceImpl");
    config.put("gw.api.domain.linkedobject.LinkedObjectContainer", "com.guidewire.pc.domain.job.impl.IssuanceImpl");
    config.put("gw.api.history.CustomHistory", "gw.api.history.JobCustomHistoryImpl");
    config.put("gw.api.job.JobMethods", "gw.api.job.IssuanceJobMethods");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.Issuance.class, config);
    com.guidewire._generated.entity.IssuanceInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.Issuance, com.guidewire._generated.entity.IssuanceInternal>() {
      public java.lang.Object getImplementation(entity.Issuance bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IssuanceInternal getInternalInterface(entity.Issuance bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.Issuance newEmptyInstance() {
        return new entity.Issuance((java.lang.Void)null);
      }

...
/**
 * IssueRenewalWF
 * Workflow for issuing renewals
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "IssueRenewalWF.eti;IssueRenewalWF.eix;IssueRenewalWF.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "IssueRenewalWF")
public class IssueRenewalWF extends entity.PolicyPeriodWorkflow {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.IssueRenewalWF> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.IssueRenewalWF>("entity.IssueRenewalWF");
   ...
   */
  public IssueRenewalWF(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected IssueRenewalWF(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.IssueRenewalWFInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.IssueRenewalWFInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.IssueRenewalWFInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.IssueRenewalWFInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.IssueRenewalWF.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.IssueRenewalWF.class, config);
    com.guidewire._generated.entity.IssueRenewalWFInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.IssueRenewalWF, com.guidewire._generated.entity.IssueRenewalWFInternal>() {
      public java.lang.Object getImplementation(entity.IssueRenewalWF bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IssueRenewalWFInternal getInternalInterface(entity.IssueRenewalWF bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.IssueRenewalWF newEmptyInstance() {
        return new entity.IssueRenewalWF((java.lang.Void)null);
      }

...
/**
 * JobLetter
 * Referencess one Job referred to in a letter.
 */
...
@gw.entity.EntityName(value = "JobLetter")
public class JobLetter extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable, entity.Extractable, entity.FrozenSetMember {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.JobLetter> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.JobLetter>("entity.JobLetter");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> LETTER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "Letter");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PUBLICID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PublicID");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.JobLetterInternal _internal;
   ...
   */
  public JobLetter(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected JobLetter(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.JobLetterInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.JobLetterInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.Letter getLetter() {
    return (entity.Letter)__getInternalInterface().getFieldValue(LETTER_PROP.get());
  }
  ...
  public void setLetter(entity.Letter value) {
    __getInternalInterface().setFieldValue(LETTER_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.JobLetterInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.JobLetter.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getLetterID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(LETTER_PROP.get());
    }
    ...
    public void setLetterID(gw.pl.persistence.core.Key value) {
      setFieldValue(LETTER_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.JobLetter.class, config);
    com.guidewire._generated.entity.JobLetterInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.JobLetter, com.guidewire._generated.entity.JobLetterInternal>() {
      public java.lang.Object getImplementation(entity.JobLetter bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.JobLetterInternal getInternalInterface(entity.JobLetter bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.JobLetter newEmptyInstance() {
        return new entity.JobLetter((java.lang.Void)null);
      }

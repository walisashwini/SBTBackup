 ...
 *   
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "LaborClient.eti;LaborClient.eix;LaborClient.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "LaborClient")
public class LaborClient extends entity.AccountContactRole implements entity.Extractable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.LaborClient> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.LaborClient>("entity.LaborClient");
   ...
   */
  public LaborClient(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected LaborClient(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.LaborClientInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.LaborClientInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.LaborClientInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.LaborClientInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.LaborClient.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.LaborClient.class, config);
    com.guidewire._generated.entity.LaborClientInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.LaborClient, com.guidewire._generated.entity.LaborClientInternal>() {
      public java.lang.Object getImplementation(entity.LaborClient bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.LaborClientInternal getInternalInterface(entity.LaborClient bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.LaborClient newEmptyInstance() {
        return new entity.LaborClient((java.lang.Void)null);
      }

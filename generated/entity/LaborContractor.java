 ...
 *   
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "LaborContractor.eti;LaborContractor.eix;LaborContractor.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "LaborContractor")
public class LaborContractor extends entity.AccountContactRole {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.LaborContractor> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.LaborContractor>("entity.LaborContractor");
   ...
   */
  public LaborContractor(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected LaborContractor(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.LaborContractorInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.LaborContractorInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.LaborContractorInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.LaborContractorInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.LaborContractor.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.LaborContractor.class, config);
    com.guidewire._generated.entity.LaborContractorInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.LaborContractor, com.guidewire._generated.entity.LaborContractorInternal>() {
      public java.lang.Object getImplementation(entity.LaborContractor bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.LaborContractorInternal getInternalInterface(entity.LaborContractor bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.LaborContractor newEmptyInstance() {
        return new entity.LaborContractor((java.lang.Void)null);
      }

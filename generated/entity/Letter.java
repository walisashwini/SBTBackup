...
/**
 * Letter
 * Record of a business letter that has been sent for one or more Jobs
 */
...
@gw.entity.EntityName(value = "Letter")
public class Letter extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.Extractable, entity.FrozenSetMember, entity.EventAware {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.Letter> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.Letter>("entity.Letter");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> JOBLETTERS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "JobLetters");
  ...
  private com.guidewire._generated.entity.LetterInternal _internal;
  
  private static final com.guidewire.pl.persistence.code.DelegateMap DELEGATE_MAP;
  
  public static final gw.pl.persistence.type.DynamicEntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> RETIRED_DYNPROP = com.guidewire.pl.domain.persistence.core.RetireablePublicMethods.RETIRED_DYNPROP;
  
  public static final java.lang.String LETTERADDED_EVENT = "LetterAdded";
  
  public static final java.lang.String LETTERCHANGED_EVENT = "LetterChanged";
  
  public static final java.lang.String LETTERREMOVED_EVENT = "LetterRemoved";
   ...
   */
  public Letter(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected Letter(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.LetterInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.LetterInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addJobs(entity.Job[] jobs) {
    ((com.guidewire.pc.domain.job.LetterPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.LetterPublicMethods")).addJobs(jobs);
  }
  ...
  public void addToJobLetters(entity.JobLetter element) {
    __getInternalInterface().addArrayElement(JOBLETTERS_PROP.get(), element);
  }
  ...
  public entity.JobLetter[] getJobLetters() {
    return (entity.JobLetter[])__getInternalInterface().getFieldValue(JOBLETTERS_PROP.get());
  }
  ...
  public typekey.LetterType getType() {
    return (typekey.LetterType)__getInternalInterface().getFieldValue(TYPE_PROP.get());
  }
  ...
  public void removeFromJobLetters(entity.JobLetter element) {
    __getInternalInterface().removeArrayElement(JOBLETTERS_PROP.get(), element);
  }
  ...
  public void removeFromJobLetters(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(JOBLETTERS_PROP.get(), elementID);
  }
  ...
  public void setJobLetters(entity.JobLetter[] value) {
    __getInternalInterface().setFieldValue(JOBLETTERS_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.LetterInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.Letter.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.job.LetterPublicMethods", "com.guidewire.pc.domain.job.impl.LetterImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.Letter.class, config);
    com.guidewire._generated.entity.LetterInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.Letter, com.guidewire._generated.entity.LetterInternal>() {
      public java.lang.Object getImplementation(entity.Letter bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.LetterInternal getInternalInterface(entity.Letter bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.Letter newEmptyInstance() {
        return new entity.Letter((java.lang.Void)null);
      }

...
/**
 * LicensedState
 * The state, policy type and segment a UWCompany is eligible to insure.
 */
...
@gw.entity.EntityName(value = "LicensedState")
public class LicensedState extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.LicensedState> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.LicensedState>("entity.LicensedState");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PRICEFACTOR_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PriceFactor");
  ...
  private com.guidewire._generated.entity.LicensedStateInternal _internal;
   ...
   */
  public LicensedState(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected LicensedState(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.LicensedStateInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.LicensedStateInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.math.BigDecimal getPriceFactor() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(PRICEFACTOR_PROP.get());
  }
  
  /**
   * 
   * @return the product this licensed state is part of
   */
  public gw.api.productmodel.Product getProduct() {
    return ((com.guidewire.pc.domain.policy.LicensedStatePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.policy.LicensedStatePublicMethods")).getProduct();
  }
  ...
  public void setPriceFactor(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(PRICEFACTOR_PROP.get(), value);
  }
  
  /**
   * 
   * @param product the product to associate with this licensed state
   */
  public void setProduct(gw.api.productmodel.Product product) {
    ((com.guidewire.pc.domain.policy.LicensedStatePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.policy.LicensedStatePublicMethods")).setProduct(product);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.LicensedStateInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.LicensedState.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.policy.LicensedStatePublicMethods", "com.guidewire.pc.domain.policy.impl.LicensedStateImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.LicensedState.class, config);
    com.guidewire._generated.entity.LicensedStateInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.LicensedState, com.guidewire._generated.entity.LicensedStateInternal>() {
      public java.lang.Object getImplementation(entity.LicensedState bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.LicensedStateInternal getInternalInterface(entity.LicensedState bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.LicensedState newEmptyInstance() {
        return new entity.LicensedState((java.lang.Void)null);
      }

...
/**
 * LocationAnswer
 * Links location and answer references - answers are persisted text responses to questions in the location ui. Specific to PolicyCenter.
 */
...
@gw.entity.EntityName(value = "LocationAnswer")
public class LocationAnswer extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PCAnswerDelegate, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.LocationAnswer, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.LocationAnswer, entity.PolicyPeriod>("entity.LocationAnswer");
  ...
  private com.guidewire._generated.entity.LocationAnswerInternal _internal;
   ...
   */
  public LocationAnswer(entity.PolicyPeriod branch)  {
   ...
   */
  public LocationAnswer(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected LocationAnswer(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.LocationAnswerInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.LocationAnswerInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.LocationAnswer clone() {
    return (entity.LocationAnswer)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.LocationAnswer getBasedOn() {
    return (entity.LocationAnswer)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.LocationAnswer getBasedOnValue() {
    return (entity.LocationAnswer)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.LocationAnswer getFixed() {
    return (entity.LocationAnswer)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.LocationAnswer getSlice(java.util.Date sliceDate) {
    return (entity.LocationAnswer)getSliceUntyped(sliceDate);
  }
  ...
  public entity.LocationAnswer getUnsliced() {
    return (entity.LocationAnswer)getUnslicedUntyped();
  }
  ...
  public entity.windowed.LocationAnswerVersionList getVersionList() {
    return (entity.windowed.LocationAnswerVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.LocationAnswer value) {
   ...
   */
  private void setFixed(entity.LocationAnswer value) {
  ...
  public entity.LocationAnswer split(java.util.Date splitDate) {
    return (entity.LocationAnswer)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.LocationAnswerInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.LocationAnswer.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.question.LocationAnswerMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.question.LocationAnswerMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.LocationAnswer.class, config);
    com.guidewire._generated.entity.LocationAnswerInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.LocationAnswer, com.guidewire._generated.entity.LocationAnswerInternal>() {
      public java.lang.Object getImplementation(entity.LocationAnswer bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.LocationAnswerInternal getInternalInterface(entity.LocationAnswer bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.LocationAnswer newEmptyInstance() {
        return new entity.LocationAnswer((java.lang.Void)null);
      }

 ...
 * An named insured on a location on a policy.
 */
...
@gw.entity.EntityName(value = "LocationNamedInsured")
public class LocationNamedInsured extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, gw.api.copier.EffDatedCopyable, gw.api.domain.account.Mergeable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.LocationNamedInsured, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.LocationNamedInsured, entity.PolicyPeriod>("entity.LocationNamedInsured");
  ...
  private com.guidewire._generated.entity.LocationNamedInsuredInternal _internal;
   ...
   */
  public LocationNamedInsured(entity.PolicyPeriod branch)  {
   ...
   */
  public LocationNamedInsured(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected LocationNamedInsured(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.LocationNamedInsuredInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.LocationNamedInsuredInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.LocationNamedInsured clone() {
    return (entity.LocationNamedInsured)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.LocationNamedInsured getBasedOn() {
    return (entity.LocationNamedInsured)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.LocationNamedInsured getBasedOnValue() {
    return (entity.LocationNamedInsured)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.LocationNamedInsured getFixed() {
    return (entity.LocationNamedInsured)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.LocationNamedInsured getSlice(java.util.Date sliceDate) {
    return (entity.LocationNamedInsured)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.LocationNamedInsured getSubtype() {
    return (typekey.LocationNamedInsured)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.LocationNamedInsured getUnsliced() {
    return (entity.LocationNamedInsured)getUnslicedUntyped();
  }
  ...
  public entity.windowed.LocationNamedInsuredVersionList getVersionList() {
    return (entity.windowed.LocationNamedInsuredVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.LocationNamedInsured value) {
   ...
   */
  private void setFixed(entity.LocationNamedInsured value) {
   ...
   */
  private void setSubtype(typekey.LocationNamedInsured value) {
  ...
  public entity.LocationNamedInsured split(java.util.Date splitDate) {
    return (entity.LocationNamedInsured)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.LocationNamedInsuredInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.LocationNamedInsured.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.copier.EffDatedCopyable", "gw.policy.LocationNamedInsuredCopier");
    config.put("gw.api.domain.account.Mergeable", "gw.account.EffDatedDefaultMergeableImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.policy.LocationNamedInsuredMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.policy.LocationNamedInsuredMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.LocationNamedInsured.class, config);
    com.guidewire._generated.entity.LocationNamedInsuredInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.LocationNamedInsured, com.guidewire._generated.entity.LocationNamedInsuredInternal>() {
      public java.lang.Object getImplementation(entity.LocationNamedInsured bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.LocationNamedInsuredInternal getInternalInterface(entity.LocationNamedInsured bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.LocationNamedInsured newEmptyInstance() {
        return new entity.LocationNamedInsured((java.lang.Void)null);
      }

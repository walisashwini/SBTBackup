...
@gw.entity.EntityName(value = "LocationRisk")
public class LocationRisk extends entity.Reinsurable implements gw.api.copier.EffDatedCopyable, gw.api.domain.DenormalizedFKOutOfDomainGraph, gw.api.logicalmatch.EffDatedLogicalMatcher, gw.api.reinsurance.ReinsurableAdapter {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.LocationRisk, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.LocationRisk, entity.PolicyPeriod>("entity.LocationRisk");
   ...
   */
  public LocationRisk(entity.PolicyPeriod branch)  {
   ...
   */
  public LocationRisk(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected LocationRisk(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.LocationRiskInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.LocationRiskInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.LocationRiskInternal)super.__getInternalInterface();
  }
  
  public entity.LocationRisk clone() {
    return (entity.LocationRisk)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.LocationRisk getBasedOn() {
    return (entity.LocationRisk)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.LocationRisk getSlice(java.util.Date sliceDate) {
    return (entity.LocationRisk)getSliceUntyped(sliceDate);
  }
  
  public entity.LocationRisk getUnsliced() {
    return (entity.LocationRisk)getUnslicedUntyped();
  }
  
  public entity.windowed.LocationRiskVersionList getVersionList() {
    return (entity.windowed.LocationRiskVersionList)getVersionListUntyped();
  }
  ...
  public entity.LocationRisk split(java.util.Date splitDate) {
    return (entity.LocationRisk)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.LocationRiskInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.LocationRisk.this.__getDelegateManager();
    }
    ...
    public entity.Reinsurable getBasedOnValue() {
      return (entity.Reinsurable)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    /**
     * 
     * @return The reinsurable coverable that this reinsurable risk represents.
     */
    public gw.api.reinsurance.ReinsurableCoverable getCoverable() {
      return ((gw.api.reinsurance.ReinsurableAdapter)__getDelegateManager().getImplementation("gw.api.reinsurance.ReinsurableAdapter")).getCoverable();
    }
    ...
    public typekey.Currency getCoverageCurrency() {
      return ((com.guidewire.pc.domain.reinsurance.ReinsurablePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.reinsurance.ReinsurablePublicMethods")).getCoverageCurrency();
    }
    ...
    public typekey.RICoverageGroupType getCoverageGroup() {
      return (typekey.RICoverageGroupType)__getInternalInterface().getFieldValue(COVERAGEGROUP_PROP.get());
    }
    ...
    public entity.Reinsurable getFixed() {
      return (entity.Reinsurable)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public typekey.Currency getReinsuranceCurrency() {
      return (typekey.Currency)__getInternalInterface().getFieldValue(REINSURANCECURRENCY_PROP.get());
    }
    ...
    public typekey.Reinsurable getSubtype() {
      return (typekey.Reinsurable)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
    ...
    /**
     * Remove a reinsurable risk entirely from the term.  This is different from the normal
     * {@link entity.EffDated#remove()} mechanics that normally
     * truncate to the slice date.  This method removes and never persists a Reinsurable if
     * it has not been persisted.  If it has already been persisted, then it sets ExpirationDate
     * to the EffectiveDate so that it is a zero-length slice.
     */
    public void removeFromTerm() {
      ((com.guidewire.pc.domain.reinsurance.ReinsurablePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.reinsurance.ReinsurablePublicMethods")).removeFromTerm();
    }
    ...
    public void setCoverageGroup(typekey.RICoverageGroupType value) {
      __getInternalInterface().setFieldValue(COVERAGEGROUP_PROP.get(), value);
    }
    ...
    public void setReinsuranceCurrency(typekey.Currency value) {
      __getInternalInterface().setFieldValue(REINSURANCECURRENCY_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.reinsurance.ReinsurablePublicMethods", "com.guidewire.pc.domain.reinsurance.impl.ReinsurableImpl");
    ...
    config.put("gw.api.copier.EffDatedCopyable", "gw.reinsurance.LocationRiskCopier");
    config.put("gw.api.domain.DenormalizedFKOutOfDomainGraph", "gw.reinsurance.risk.LocationRiskDenormalizedFKImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.reinsurance.LocationRiskMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.reinsurance.LocationRiskMatcher");
    config.put("gw.api.reinsurance.ReinsurableAdapter", "gw.reinsurance.risk.LocationRiskReinsurableAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.LocationRisk.class, config);
    com.guidewire._generated.entity.LocationRiskInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.LocationRisk, com.guidewire._generated.entity.LocationRiskInternal>() {
      public java.lang.Object getImplementation(entity.LocationRisk bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.LocationRiskInternal getInternalInterface(entity.LocationRisk bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.LocationRisk newEmptyInstance() {
        return new entity.LocationRisk((java.lang.Void)null);
      }

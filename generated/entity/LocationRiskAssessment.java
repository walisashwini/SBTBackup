 ...
 * Risk assessment result of a policy location
 */
...
@gw.entity.EntityName(value = "LocationRiskAssessment")
public class LocationRiskAssessment extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.RiskAssessmentResult {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.LocationRiskAssessment, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.LocationRiskAssessment, entity.PolicyPeriod>("entity.LocationRiskAssessment");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> INPUTCHECKSUM_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "InputChecksum");
  ...
  private com.guidewire._generated.entity.LocationRiskAssessmentInternal _internal;
   ...
   */
  public LocationRiskAssessment(entity.PolicyPeriod branch)  {
   ...
   */
  public LocationRiskAssessment(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected LocationRiskAssessment(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.LocationRiskAssessmentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.LocationRiskAssessmentInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.LocationRiskAssessment clone() {
    return (entity.LocationRiskAssessment)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.LocationRiskAssessment getBasedOn() {
    return (entity.LocationRiskAssessment)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.LocationRiskAssessment getBasedOnValue() {
    return (entity.LocationRiskAssessment)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.LocationRiskAssessment getFixed() {
    return (entity.LocationRiskAssessment)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public java.lang.String getInputChecksum() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(INPUTCHECKSUM_PROP.get());
  }
  ...
  public entity.LocationRiskAssessment getSlice(java.util.Date sliceDate) {
    return (entity.LocationRiskAssessment)getSliceUntyped(sliceDate);
  }
  ...
  public entity.LocationRiskAssessment getUnsliced() {
    return (entity.LocationRiskAssessment)getUnslicedUntyped();
  }
  ...
  public entity.windowed.LocationRiskAssessmentVersionList getVersionList() {
    return (entity.windowed.LocationRiskAssessmentVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.LocationRiskAssessment value) {
   ...
   */
  private void setFixed(entity.LocationRiskAssessment value) {
  ...
  public void setInputChecksum(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(INPUTCHECKSUM_PROP.get(), value);
  }
  ...
  public entity.LocationRiskAssessment split(java.util.Date splitDate) {
    return (entity.LocationRiskAssessment)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.LocationRiskAssessmentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.LocationRiskAssessment.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.riskassessment.LocationRiskAssessmentPublicMethods", "gw.riskassessment.LocationRiskAssessmentImpl");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.LocationRiskAssessment.class, config);
    com.guidewire._generated.entity.LocationRiskAssessmentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.LocationRiskAssessment, com.guidewire._generated.entity.LocationRiskAssessmentInternal>() {
      public java.lang.Object getImplementation(entity.LocationRiskAssessment bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.LocationRiskAssessmentInternal getInternalInterface(entity.LocationRiskAssessment bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.LocationRiskAssessment newEmptyInstance() {
        return new entity.LocationRiskAssessment((java.lang.Void)null);
      }

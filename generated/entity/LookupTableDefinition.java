 ...
 * The table holds metadata information for a lookup table
 */
...
@gw.entity.EntityName(value = "LookupTableDefinition")
public class LookupTableDefinition extends com.guidewire.pl.persistence.code.BeanBase implements entity.Editable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.LookupTableDefinition> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.LookupTableDefinition>("entity.LookupTableDefinition");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> EXISTENCE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Existence");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ID");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> INPUTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "Inputs");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> OUTPUT_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "Output");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> OUTPUTARRAY_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "OutputArray");
  ...
  private com.guidewire._generated.entity.LookupTableDefinitionInternal _internal;
   ...
   */
  public LookupTableDefinition(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected LookupTableDefinition(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.LookupTableDefinitionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.LookupTableDefinitionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToInputs(entity.LookupTableInputColumn element) {
    __getInternalInterface().addArrayElement(INPUTS_PROP.get(), element);
  }
  ...
  public entity.LookupTableInputColumn[] getInputs() {
    return (entity.LookupTableInputColumn[])__getInternalInterface().getFieldValue(INPUTS_PROP.get());
  }
  ...
  public entity.LookupTableOutputColumn getOutput() {
    return (entity.LookupTableOutputColumn)__getInternalInterface().getFieldValue(OUTPUT_PROP.get());
  }
  ...
  public entity.LookupTableOutputColumn[] getOutputArray() {
    return (entity.LookupTableOutputColumn[])__getInternalInterface().getFieldValue(OUTPUTARRAY_PROP.get());
  }
  ...
  public typekey.LookupTableDefinition getSubtype() {
    return (typekey.LookupTableDefinition)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public java.lang.Boolean isExistence() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(EXISTENCE_PROP.get());
  }
  ...
  public void removeFromInputs(entity.LookupTableInputColumn element) {
    __getInternalInterface().removeArrayElement(INPUTS_PROP.get(), element);
  }
  ...
  public void removeFromInputs(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(INPUTS_PROP.get(), elementID);
  }
  ...
  public void setInputs(entity.LookupTableInputColumn[] value) {
    __getInternalInterface().setFieldValue(INPUTS_PROP.get(), value);
  }
  ...
  public void setOutput(entity.LookupTableOutputColumn value) {
    __getInternalInterface().setFieldValue(OUTPUT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the OutputArray field.
   */
  private void setOutputArray(entity.LookupTableOutputColumn[] value) {
    __getInternalInterface().setFieldValue(OUTPUTARRAY_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.LookupTableDefinition value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.LookupTableDefinitionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.LookupTableDefinition.this.__getDelegateManager();
    }
    ...
    public void addToOutputArray(entity.LookupTableOutputColumn element) {
      __getInternalInterface().addArrayElement(OUTPUTARRAY_PROP.get(), element);
    }
    ...
    public gw.pl.persistence.core.Key getOutputID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(OUTPUT_PROP.get());
    }
    ...
    public void removeFromOutputArray(entity.LookupTableOutputColumn element) {
      __getInternalInterface().removeArrayElement(OUTPUTARRAY_PROP.get(), element);
    }
    ...
    public void removeFromOutputArray(gw.pl.persistence.core.Key elementID) {
      __getInternalInterface().removeArrayElement(OUTPUTARRAY_PROP.get(), elementID);
    }
    ...
    public void setOutputID(gw.pl.persistence.core.Key value) {
      setFieldValue(OUTPUT_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.LookupTableDefinition.class, config);
    com.guidewire._generated.entity.LookupTableDefinitionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.LookupTableDefinition, com.guidewire._generated.entity.LookupTableDefinitionInternal>() {
      public java.lang.Object getImplementation(entity.LookupTableDefinition bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.LookupTableDefinitionInternal getInternalInterface(entity.LookupTableDefinition bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.LookupTableDefinition newEmptyInstance() {
        return new entity.LookupTableDefinition((java.lang.Void)null);
      }

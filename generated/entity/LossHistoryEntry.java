...
/**
 * LossHistoryEntry
 * Prior loss financial and policy line detail, status and description
 */
...
@gw.entity.EntityName(value = "LossHistoryEntry")
public class LossHistoryEntry extends com.guidewire.pl.persistence.code.BeanBase implements entity.Editable, entity.Extractable, entity.FrozenSetMember {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.LossHistoryEntry> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.LossHistoryEntry>("entity.LossHistoryEntry");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IMonetaryAmountPropertyInfo> AMOUNTPAID_PROP = new com.guidewire.commons.metadata.types.MonetaryAmountPropertyInfoCache(TYPE, "AmountPaid");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> AMOUNTPAID_AMT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AmountPaid_amt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> AMOUNTPAID_CUR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "AmountPaid_cur");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IMonetaryAmountPropertyInfo> AMOUNTRESV_PROP = new com.guidewire.commons.metadata.types.MonetaryAmountPropertyInfoCache(TYPE, "AmountResv");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> AMOUNTRESV_AMT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AmountResv_amt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> AMOUNTRESV_CUR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "AmountResv_cur");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> LOSSSTATUS_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "LossStatus");
  ...
  private com.guidewire._generated.entity.LossHistoryEntryInternal _internal;
   ...
   */
  public LossHistoryEntry(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected LossHistoryEntry(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.LossHistoryEntryInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.LossHistoryEntryInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public gw.pl.currency.MonetaryAmount getAmountPaid() {
    return (gw.pl.currency.MonetaryAmount)__getInternalInterface().getFieldValue(AMOUNTPAID_PROP.get());
  }
  ...
  public java.math.BigDecimal getAmountPaid_amt() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(AMOUNTPAID_AMT_PROP.get());
  }
  ...
  public typekey.Currency getAmountPaid_cur() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(AMOUNTPAID_CUR_PROP.get());
  }
  ...
  public gw.pl.currency.MonetaryAmount getAmountResv() {
    return (gw.pl.currency.MonetaryAmount)__getInternalInterface().getFieldValue(AMOUNTRESV_PROP.get());
  }
  ...
  public java.math.BigDecimal getAmountResv_amt() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(AMOUNTRESV_AMT_PROP.get());
  }
  ...
  public typekey.Currency getAmountResv_cur() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(AMOUNTRESV_CUR_PROP.get());
  }
  ...
  public typekey.LossEntryCause getLossCause() {
    return (typekey.LossEntryCause)__getInternalInterface().getFieldValue(LOSSCAUSE_PROP.get());
  }
  ...
  public typekey.LossEntryStatus getLossStatus() {
    return (typekey.LossEntryStatus)__getInternalInterface().getFieldValue(LOSSSTATUS_PROP.get());
  }
  ...
  /**
   * 
   * @return the policy line pattern for the loss history entry
   */
  public gw.api.productmodel.PolicyLinePattern getPolicyLinePattern() {
    return ((com.guidewire.pc.domain.losshistory.LossHistoryEntryPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.losshistory.LossHistoryEntryPublicMethods")).getPolicyLinePattern();
  }
  ...
  public void setAmountPaid(gw.pl.currency.MonetaryAmount value) {
    __getInternalInterface().setFieldValue(AMOUNTPAID_PROP.get(), value);
  }
  
  /**
   * Sets the value of the AmountPaid_amt field.
   */
  private void setAmountPaid_amt(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(AMOUNTPAID_AMT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the AmountPaid_cur field.
   */
  private void setAmountPaid_cur(typekey.Currency value) {
    __getInternalInterface().setFieldValue(AMOUNTPAID_CUR_PROP.get(), value);
  }
  ...
  public void setAmountResv(gw.pl.currency.MonetaryAmount value) {
    __getInternalInterface().setFieldValue(AMOUNTRESV_PROP.get(), value);
  }
  
  /**
   * Sets the value of the AmountResv_amt field.
   */
  private void setAmountResv_amt(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(AMOUNTRESV_AMT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the AmountResv_cur field.
   */
  private void setAmountResv_cur(typekey.Currency value) {
    __getInternalInterface().setFieldValue(AMOUNTRESV_CUR_PROP.get(), value);
  }
  ...
  public void setLossStatus(typekey.LossEntryStatus value) {
    __getInternalInterface().setFieldValue(LOSSSTATUS_PROP.get(), value);
  }
  ...
  /**
   * 
   * @param pattern set the policy line pattern for this loss history entry to this
   */
  public void setPolicyLinePattern(gw.api.productmodel.PolicyLinePattern pattern) {
    ((com.guidewire.pc.domain.losshistory.LossHistoryEntryPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.losshistory.LossHistoryEntryPublicMethods")).setPolicyLinePattern(pattern);
  }
  ...
  /**
   * Returns a shallow clone of this LossHistoryEntry
   * @return a shallow clone of this LossHistoryEntry
   */
  public entity.LossHistoryEntry shallowClone() {
    return ((com.guidewire.pc.domain.losshistory.LossHistoryEntryPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.losshistory.LossHistoryEntryPublicMethods")).shallowClone();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.LossHistoryEntryInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.LossHistoryEntry.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.losshistory.LossHistoryEntryPublicMethods", "com.guidewire.pc.domain.losshistory.impl.LossHistoryEntryImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.LossHistoryEntry.class, config);
    com.guidewire._generated.entity.LossHistoryEntryInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.LossHistoryEntry, com.guidewire._generated.entity.LossHistoryEntryInternal>() {
      public java.lang.Object getImplementation(entity.LossHistoryEntry bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.LossHistoryEntryInternal getInternalInterface(entity.LossHistoryEntry bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.LossHistoryEntry newEmptyInstance() {
        return new entity.LossHistoryEntry((java.lang.Void)null);
      }

...
public class MessageContext extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable {
  ...
  public entity.Message createMessage(entity.Message msg) {
    return ((com.guidewire.pc.domain.messaging.impl.MessageContextCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.messaging.impl.MessageContextCoreExtMethods")).createMessage(msg);
  }
  
  public entity.Message createMessage(java.lang.String payLoad) {
    return ((com.guidewire.pc.domain.messaging.impl.MessageContextCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.messaging.impl.MessageContextCoreExtMethods")).createMessage(payLoad);
  }
  
  public entity.Message createPersonalDataPurgeMessage(java.lang.String payload) {
    return ((com.guidewire.pc.domain.messaging.impl.MessageContextCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.messaging.impl.MessageContextCoreExtMethods")).createPersonalDataPurgeMessage(payload);
  }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.messaging.impl.MessageContextCoreExtMethods", "com.guidewire.pc.domain.messaging.impl.MessageContextCoreExtMethodsImpl");

...
public class MessageHistory extends com.guidewire.pl.persistence.code.BeanBase implements entity.KeyableBean, entity.Extractable, entity.FrozenSetMember {
   ...
   * Associated account, if applicable.  If null, then the associated object is a cross-policy object.
   */
   ...
   * Associated policy period, if applicable.
   */
  @gw.internal.gosu.parser.ExtendedProperty
   ...
   */
  private void setPolicyPeriod(entity.PolicyPeriod value) {
  ...
  static {
    ...
    config.put("com.guidewire.pl.domain.messaging.MessageHistoryPublicMethods", "com.guidewire.pl.domain.messaging.impl.MessageHistoryImpl");

...
@gw.entity.EntityName(value = "ModifierLookup")
public class ModifierLookup extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.ProductModelDelegate, entity.AvailabilityLookup, entity.StateDrivenLookup, entity.JobTypeFilteredLookup, entity.UWCompanyFilteredLookup, entity.PolicyLinePatternFilteredLookup, com.guidewire.pc.domain.productmodel.DenormLookupInitialisable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ModifierLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ModifierLookup>("entity.ModifierLookup");
  ...
  private com.guidewire._generated.entity.ModifierLookupInternal _internal;
   ...
   */
  protected ModifierLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ModifierLookup(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ModifierLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ModifierLookupInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setSubtype(typekey.ModifierLookup value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ModifierLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ModifierLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ModifierLookup.class, config);
    com.guidewire._generated.entity.ModifierLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ModifierLookup, com.guidewire._generated.entity.ModifierLookupInternal>() {
      public java.lang.Object getImplementation(entity.ModifierLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ModifierLookupInternal getInternalInterface(entity.ModifierLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ModifierLookup newEmptyInstance() {
        return new entity.ModifierLookup((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "NamedInsured")
public class NamedInsured extends entity.AccountContactRole implements entity.Extractable, gw.api.domain.account.AccountContactRoleMethods {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.NamedInsured> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.NamedInsured>("entity.NamedInsured");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BUSOPSDESCRIPTION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BusOpsDescription");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ORGTYPE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "OrgType");
   ...
   */
  public NamedInsured(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected NamedInsured(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.NamedInsuredInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.NamedInsuredInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.NamedInsuredInternal)super.__getInternalInterface();
  }
  ...
  public java.lang.String getBusOpsDescription() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(BUSOPSDESCRIPTION_PROP.get());
  }
  ...
  public java.lang.String getOrgType() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(ORGTYPE_PROP.get());
  }
  ...
  public void setBusOpsDescription(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(BUSOPSDESCRIPTION_PROP.get(), value);
  }
  ...
  public void setOrgType(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(ORGTYPE_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.NamedInsuredInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.NamedInsured.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.account.AccountContactRoleMethods", "gw.api.domain.account.NamedInsuredAccountContactRoleMethods");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.NamedInsured.class, config);
    com.guidewire._generated.entity.NamedInsuredInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.NamedInsured, com.guidewire._generated.entity.NamedInsuredInternal>() {
      public java.lang.Object getImplementation(entity.NamedInsured bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.NamedInsuredInternal getInternalInterface(entity.NamedInsured bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.NamedInsured newEmptyInstance() {
        return new entity.NamedInsured((java.lang.Void)null);
      }

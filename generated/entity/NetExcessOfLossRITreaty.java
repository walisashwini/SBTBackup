 ...
 * 
 *     Net Excess of Loss reinsurance treaty.  
 *   
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "NetExcessOfLossRITreaty.eti;NetExcessOfLossRITreaty.eix;NetExcessOfLossRITreaty.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "NetExcessOfLossRITreaty")
public class NetExcessOfLossRITreaty extends entity.NonProportionalRIAgreement implements entity.PerRisk, entity.Treaty, entity.LossDateAttachable {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> ATTACHMENTBASIS_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "AttachmentBasis");
  ...
  public typekey.AttachmentBasisType[] getAcceptableAttachmentBasisTypes() {
    return ((com.guidewire.pc.domain.reinsurance.LossDateAttachablePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.reinsurance.LossDateAttachablePublicMethods")).getAcceptableAttachmentBasisTypes();
  }
  ...
  public typekey.AttachmentBasisType getAttachmentBasis() {
    return (typekey.AttachmentBasisType)__getInternalInterface().getFieldValue(ATTACHMENTBASIS_PROP.get());
  }
  ...
  public void setAttachmentBasis(typekey.AttachmentBasisType value) {
    ((com.guidewire.pc.domain.reinsurance.LossDateAttachablePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.reinsurance.LossDateAttachablePublicMethods")).setAttachmentBasis(value);
  }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.reinsurance.LossDateAttachablePublicMethods", "com.guidewire.pc.domain.reinsurance.impl.NetExcessOfLossRITreatyImpl");
    config.put("com.guidewire.pc.domain.reinsurance.NonProportionalRIAgreementPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.NetExcessOfLossRITreatyImpl");
    config.put("com.guidewire.pc.domain.reinsurance.PerRiskPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.PerRiskImpl");
    config.put("com.guidewire.pc.domain.reinsurance.RIAgreementPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.NetExcessOfLossRITreatyImpl");
    ...
    config.put("com.guidewire.pc.domain.reinsurance.impl.RIAgreementInternalMethods", "com.guidewire.pc.domain.reinsurance.impl.NetExcessOfLossRITreatyImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.reinsurance.impl.NetExcessOfLossRITreatyImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.pc.domain.reinsurance.impl.NetExcessOfLossRITreatyImpl");
    config.put("gw.api.contact.ContactOwner", "com.guidewire.pc.domain.reinsurance.impl.NetExcessOfLossRITreatyImpl");
    config.put("gw.api.domain.reinsurance.RICoverageGroupOwner", "com.guidewire.pc.domain.reinsurance.impl.NetExcessOfLossRITreatyImpl");
    config.put("gw.api.reinsurance.CedingRecipient", "gw.plugin.reinsurance.CedingRecipientAdapter");
    config.put("gw.pc.reinsurance.entity.NetExcessOfLossRITreaty", "com.guidewire.pc.domain.reinsurance.impl.NetExcessOfLossRITreatyImpl");

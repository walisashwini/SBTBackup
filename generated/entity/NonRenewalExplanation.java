 ...
 * The non-renewal explanation chosen
 */
...
@gw.entity.EntityName(value = "NonRenewalExplanation")
public class NonRenewalExplanation extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.Extractable, entity.FrozenSetMember {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.NonRenewalExplanation> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.NonRenewalExplanation>("entity.NonRenewalExplanation");
  ...
  private com.guidewire._generated.entity.NonRenewalExplanationInternal _internal;
   ...
   */
  public NonRenewalExplanation(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected NonRenewalExplanation(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.NonRenewalExplanationInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.NonRenewalExplanationInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.NonRenewalExplanationInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.NonRenewalExplanation.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.NonRenewalExplanation.class, config);
    com.guidewire._generated.entity.NonRenewalExplanationInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.NonRenewalExplanation, com.guidewire._generated.entity.NonRenewalExplanationInternal>() {
      public java.lang.Object getImplementation(entity.NonRenewalExplanation bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.NonRenewalExplanationInternal getInternalInterface(entity.NonRenewalExplanation bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.NonRenewalExplanation newEmptyInstance() {
        return new entity.NonRenewalExplanation((java.lang.Void)null);
      }

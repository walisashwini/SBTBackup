...
/**
 * OfferingLookup
 * The Offering availability lookup type.
 */
...
@gw.entity.EntityName(value = "OfferingLookup")
public class OfferingLookup extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.ProductModelDelegate, entity.AvailabilityLookup, entity.StateDrivenLookup, entity.IndustryCodeDrivenLookup, entity.JobTypeFilteredLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.OfferingLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.OfferingLookup>("entity.OfferingLookup");
  ...
  private com.guidewire._generated.entity.OfferingLookupInternal _internal;
   ...
   */
  protected OfferingLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected OfferingLookup(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.OfferingLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.OfferingLookupInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public typekey.OfferingLookup getSubtype() {
    return (typekey.OfferingLookup)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
   ...
   */
  private void setSubtype(typekey.OfferingLookup value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.OfferingLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.OfferingLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.productmodel.OfferingLookupPublicMethods", "com.guidewire.pc.domain.productmodel.impl.OfferingLookupImpl");
    config.put("com.guidewire.pc.domain.productmodel.impl.LookupInternalMethods", "com.guidewire.pc.domain.productmodel.impl.OfferingLookupImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.OfferingLookup.class, config);
    com.guidewire._generated.entity.OfferingLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.OfferingLookup, com.guidewire._generated.entity.OfferingLookupInternal>() {
      public java.lang.Object getImplementation(entity.OfferingLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.OfferingLookupInternal getInternalInterface(entity.OfferingLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.OfferingLookup newEmptyInstance() {
        return new entity.OfferingLookup((java.lang.Void)null);
      }

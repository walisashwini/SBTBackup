 ...
 * Temporary entity for request level information being sent for risk assessments
 */
...
@gw.entity.EntityName(value = "OutboundPeriodRiskAssessmentTempStore")
public class OutboundPeriodRiskAssessmentTempStore extends com.guidewire.pl.persistence.code.BeanBase implements entity.Editable, entity.Extractable, entity.FrozenSetMember {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.OutboundPeriodRiskAssessmentTempStore> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.OutboundPeriodRiskAssessmentTempStore>("entity.OutboundPeriodRiskAssessmentTempStore");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> INBOUNDPERIODRISKASSESSMENTERRORTEMPSTORE_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "InboundPeriodRiskAssessmentErrorTempStore");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> OUTBOUNDLOCATIONRISKASSESSMENTTEMPSTORE_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "OutboundLocationRiskAssessmentTempStore");
  ...
  private com.guidewire._generated.entity.OutboundPeriodRiskAssessmentTempStoreInternal _internal;
   ...
   */
  public OutboundPeriodRiskAssessmentTempStore()  {
   ...
   */
  public OutboundPeriodRiskAssessmentTempStore(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected OutboundPeriodRiskAssessmentTempStore(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.OutboundPeriodRiskAssessmentTempStoreInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.OutboundPeriodRiskAssessmentTempStoreInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToInboundPeriodRiskAssessmentErrorTempStore(entity.InboundPeriodRiskAssessmentErrorTempStore element) {
    __getInternalInterface().addArrayElement(INBOUNDPERIODRISKASSESSMENTERRORTEMPSTORE_PROP.get(), element);
  }
  ...
  public void addToOutboundLocationRiskAssessmentTempStore(entity.OutboundLocationRiskAssessmentTempStore element) {
    __getInternalInterface().addArrayElement(OUTBOUNDLOCATIONRISKASSESSMENTTEMPSTORE_PROP.get(), element);
  }
  ...
  public entity.InboundPeriodRiskAssessmentErrorTempStore[] getInboundPeriodRiskAssessmentErrorTempStore() {
    return (entity.InboundPeriodRiskAssessmentErrorTempStore[])__getInternalInterface().getFieldValue(INBOUNDPERIODRISKASSESSMENTERRORTEMPSTORE_PROP.get());
  }
  ...
  public void removeFromInboundPeriodRiskAssessmentErrorTempStore(entity.InboundPeriodRiskAssessmentErrorTempStore element) {
    __getInternalInterface().removeArrayElement(INBOUNDPERIODRISKASSESSMENTERRORTEMPSTORE_PROP.get(), element);
  }
  ...
  public void removeFromInboundPeriodRiskAssessmentErrorTempStore(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(INBOUNDPERIODRISKASSESSMENTERRORTEMPSTORE_PROP.get(), elementID);
  }
  ...
  public void removeFromOutboundLocationRiskAssessmentTempStore(entity.OutboundLocationRiskAssessmentTempStore element) {
    __getInternalInterface().removeArrayElement(OUTBOUNDLOCATIONRISKASSESSMENTTEMPSTORE_PROP.get(), element);
  }
  ...
  public void removeFromOutboundLocationRiskAssessmentTempStore(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(OUTBOUNDLOCATIONRISKASSESSMENTTEMPSTORE_PROP.get(), elementID);
  }
  ...
  public void setInboundPeriodRiskAssessmentErrorTempStore(entity.InboundPeriodRiskAssessmentErrorTempStore[] value) {
    __getInternalInterface().setFieldValue(INBOUNDPERIODRISKASSESSMENTERRORTEMPSTORE_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.OutboundPeriodRiskAssessmentTempStoreInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.OutboundPeriodRiskAssessmentTempStore.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.OutboundPeriodRiskAssessmentTempStore.class, config);
    com.guidewire._generated.entity.OutboundPeriodRiskAssessmentTempStoreInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.OutboundPeriodRiskAssessmentTempStore, com.guidewire._generated.entity.OutboundPeriodRiskAssessmentTempStoreInternal>() {
      public java.lang.Object getImplementation(entity.OutboundPeriodRiskAssessmentTempStore bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.OutboundPeriodRiskAssessmentTempStoreInternal getInternalInterface(entity.OutboundPeriodRiskAssessmentTempStore bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.OutboundPeriodRiskAssessmentTempStore newEmptyInstance() {
        return new entity.OutboundPeriodRiskAssessmentTempStore((java.lang.Void)null);
      }

 ...
 * Temporary entity for saving reinsurable data sent to risk assessment service
 */
...
@gw.entity.EntityName(value = "OutboundReinsurableRiskAssessmentTempStore")
public class OutboundReinsurableRiskAssessmentTempStore extends com.guidewire.pl.persistence.code.BeanBase implements entity.Editable, entity.Extractable, entity.FrozenSetMember {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.OutboundReinsurableRiskAssessmentTempStore> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.OutboundReinsurableRiskAssessmentTempStore>("entity.OutboundReinsurableRiskAssessmentTempStore");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ARCHIVEPARTITION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ArchivePartition");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BEANVERSION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BeanVersion");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> COVERAGEGROUP_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "CoverageGroup");
  ...
  private com.guidewire._generated.entity.OutboundReinsurableRiskAssessmentTempStoreInternal _internal;
   ...
   */
  public OutboundReinsurableRiskAssessmentTempStore()  {
   ...
   */
  public OutboundReinsurableRiskAssessmentTempStore(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected OutboundReinsurableRiskAssessmentTempStore(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.OutboundReinsurableRiskAssessmentTempStoreInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.OutboundReinsurableRiskAssessmentTempStoreInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.OutboundReinsurableRiskAssessmentTempStoreInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.OutboundReinsurableRiskAssessmentTempStore.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.OutboundReinsurableRiskAssessmentTempStore.class, config);
    com.guidewire._generated.entity.OutboundReinsurableRiskAssessmentTempStoreInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.OutboundReinsurableRiskAssessmentTempStore, com.guidewire._generated.entity.OutboundReinsurableRiskAssessmentTempStoreInternal>() {
      public java.lang.Object getImplementation(entity.OutboundReinsurableRiskAssessmentTempStore bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.OutboundReinsurableRiskAssessmentTempStoreInternal getInternalInterface(entity.OutboundReinsurableRiskAssessmentTempStore bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.OutboundReinsurableRiskAssessmentTempStore newEmptyInstance() {
        return new entity.OutboundReinsurableRiskAssessmentTempStore((java.lang.Void)null);
      }

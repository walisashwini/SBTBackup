 ...
 *   
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "OwnerOfficer.eti;OwnerOfficer.eix;OwnerOfficer.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "OwnerOfficer")
public class OwnerOfficer extends entity.AccountContactRole implements entity.Extractable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.OwnerOfficer> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.OwnerOfficer>("entity.OwnerOfficer");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> RELATIONSHIPTITLE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "RelationshipTitle");
   ...
   */
  public OwnerOfficer(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected OwnerOfficer(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.OwnerOfficerInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.OwnerOfficerInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.OwnerOfficerInternal)super.__getInternalInterface();
  }
  ...
  public typekey.Relationship getRelationshipTitle() {
    return (typekey.Relationship)__getInternalInterface().getFieldValue(RELATIONSHIPTITLE_PROP.get());
  }
  ...
  public void setRelationshipTitle(typekey.Relationship value) {
    __getInternalInterface().setFieldValue(RELATIONSHIPTITLE_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.OwnerOfficerInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.OwnerOfficer.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.OwnerOfficer.class, config);
    com.guidewire._generated.entity.OwnerOfficerInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.OwnerOfficer, com.guidewire._generated.entity.OwnerOfficerInternal>() {
      public java.lang.Object getImplementation(entity.OwnerOfficer bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.OwnerOfficerInternal getInternalInterface(entity.OwnerOfficer bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.OwnerOfficer newEmptyInstance() {
        return new entity.OwnerOfficer((java.lang.Void)null);
      }

...
/**
 * PACededPremium
 * A PersonalAuto implementation of the RICededPremium delegate
 */
...
@gw.entity.EntityName(value = "PACededPremium")
public class PACededPremium extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.RICededPremium, entity.FrozenSetMember, gw.api.reinsurance.RICededPremiumAdapter {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PACededPremium> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PACededPremium>("entity.PACededPremium");
  ...
  private com.guidewire._generated.entity.PACededPremiumInternal _internal;
   ...
   */
  public PACededPremium(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PACededPremium(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PACededPremiumInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PACededPremiumInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.PACededPremiumHistory[] getCedingHistory() {
    return (entity.PACededPremiumHistory[])__getInternalInterface().getFieldValue(CEDINGHISTORY_PROP.get());
  }
  ...
  public entity.PACededPremiumTransaction[] getCedingTransactions() {
    return (entity.PACededPremiumTransaction[])__getInternalInterface().getFieldValue(CEDINGTRANSACTIONS_PROP.get());
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PACededPremiumInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PACededPremium.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.reinsurance.RICededPremiumAdapter", "gw.reinsurance.ceding.PACededPremiumAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PACededPremium.class, config);
    com.guidewire._generated.entity.PACededPremiumInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PACededPremium, com.guidewire._generated.entity.PACededPremiumInternal>() {
      public java.lang.Object getImplementation(entity.PACededPremium bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PACededPremiumInternal getInternalInterface(entity.PACededPremium bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PACededPremium newEmptyInstance() {
        return new entity.PACededPremium((java.lang.Void)null);
      }

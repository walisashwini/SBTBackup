...
/**
 * PACededPremiumTransaction
 * A PersonalAuto implementation of the RICededPremiumTransaction delegate
 */
...
@gw.entity.EntityName(value = "PACededPremiumTransaction")
public class PACededPremiumTransaction extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.RICededPremiumTransaction, entity.FrozenSetMember, gw.api.reinsurance.RICededPremiumTxnAdapter {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PACededPremiumTransaction> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PACededPremiumTransaction>("entity.PACededPremiumTransaction");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> PACEDEDPREMIUM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "PACededPremium");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> PACEDEDPREMIUMHISTORY_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "PACededPremiumHistory");
  ...
  private com.guidewire._generated.entity.PACededPremiumTransactionInternal _internal;
   ...
   */
  public PACededPremiumTransaction()  {
   ...
   */
  public PACededPremiumTransaction(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PACededPremiumTransaction(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PACededPremiumTransactionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PACededPremiumTransactionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.PACededPremium getPACededPremium() {
    return (entity.PACededPremium)__getInternalInterface().getFieldValue(PACEDEDPREMIUM_PROP.get());
  }
  ...
  public entity.PACededPremiumHistory getPACededPremiumHistory() {
    return (entity.PACededPremiumHistory)__getInternalInterface().getFieldValue(PACEDEDPREMIUMHISTORY_PROP.get());
  }
  ...
  public void setPACededPremium(entity.PACededPremium value) {
    __getInternalInterface().setFieldValue(PACEDEDPREMIUM_PROP.get(), value);
  }
  ...
  public void setPACededPremiumHistory(entity.PACededPremiumHistory value) {
    __getInternalInterface().setFieldValue(PACEDEDPREMIUMHISTORY_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PACededPremiumTransactionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PACededPremiumTransaction.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getPACededPremiumHistoryID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(PACEDEDPREMIUMHISTORY_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getPACededPremiumID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(PACEDEDPREMIUM_PROP.get());
    }
    ...
    public void setPACededPremiumHistoryID(gw.pl.persistence.core.Key value) {
      setFieldValue(PACEDEDPREMIUMHISTORY_PROP.get(), value);
    }
    
    public void setPACededPremiumID(gw.pl.persistence.core.Key value) {
      setFieldValue(PACEDEDPREMIUM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.reinsurance.RICededPremiumTxnAdapter", "gw.reinsurance.ceding.PACededPremiumTransactionAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PACededPremiumTransaction.class, config);
    com.guidewire._generated.entity.PACededPremiumTransactionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PACededPremiumTransaction, com.guidewire._generated.entity.PACededPremiumTransactionInternal>() {
      public java.lang.Object getImplementation(entity.PACededPremiumTransaction bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PACededPremiumTransactionInternal getInternalInterface(entity.PACededPremiumTransaction bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PACededPremiumTransaction newEmptyInstance() {
        return new entity.PACededPremiumTransaction((java.lang.Void)null);
      }

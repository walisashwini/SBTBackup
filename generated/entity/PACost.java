...
/**
 * PACost
 * A PersonalAuto unit of price for a period of time that should not be broken up any further.
 */
...
public abstract class PACost extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PACost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PACost, entity.PolicyPeriod>("entity.PACost");
  ...
  private com.guidewire._generated.entity.PACostInternal _internal;
  ...
  protected PACost(java.lang.Void ignored)  {
    
  }
  
  protected abstract com.guidewire._generated.entity.PACostInternal __createInternalInterface();
  ...
  protected com.guidewire._generated.entity.PACostInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.PACost clone() {
    return (entity.PACost)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.PACost getBasedOn() {
    return (entity.PACost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PACost getSlice(java.util.Date sliceDate) {
    return (entity.PACost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.PACost getUnsliced() {
    return (entity.PACost)getUnslicedUntyped();
  }
  ...
  public entity.windowed.PACostVersionList getVersionList() {
    return (entity.windowed.PACostVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.PACost value) {
   ...
   */
  private void setFixed(entity.PACost value) {
   ...
   */
  private void setSubtype(typekey.PACost value) {
   ...
   */
  private void setTransactions(entity.PATransaction[] value) {
  ...
  public entity.PACost split(java.util.Date splitDate) {
    return (entity.PACost)splitUntyped(splitDate);
  }
  ...
  static {
    com.guidewire._generated.entity.PACostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.EntityFriendAccess<entity.PACost, com.guidewire._generated.entity.PACostInternal>() {
      public java.lang.Object getImplementation(entity.PACost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PACostInternal getInternalInterface(entity.PACost bean) {
        if(bean == null) {
          return null;
        };

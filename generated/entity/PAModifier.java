...
/**
 * PAModifier
 * A line-level modifier for Personal Auto
 */
...
@gw.entity.EntityName(value = "PAModifier")
public class PAModifier extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Modifier, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PAModifier, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PAModifier, entity.PolicyPeriod>("entity.PAModifier");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> PARATEFACTORS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "PARateFactors");
  ...
  private com.guidewire._generated.entity.PAModifierInternal _internal;
   ...
   */
  public PAModifier(entity.PolicyPeriod branch)  {
   ...
   */
  public PAModifier(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PAModifier(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PAModifierInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PAModifierInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToPARateFactors(entity.PARateFactor element) {
    __getInternalInterface().addArrayElement(PARATEFACTORS_PROP.get(), element);
  }
  ...
  public entity.PAModifier clone() {
    return (entity.PAModifier)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.PAModifier getBasedOn() {
    return (entity.PAModifier)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PAModifier getBasedOnValue() {
    return (entity.PAModifier)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.PAModifier getFixed() {
    return (entity.PAModifier)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.PARateFactor[] getPARateFactors() {
    return (entity.PARateFactor[])__getInternalInterface().getFieldValue(PARATEFACTORS_PROP.get());
  }
  ...
  public entity.PAModifier getSlice(java.util.Date sliceDate) {
    return (entity.PAModifier)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.PAModifier getSubtype() {
    return (typekey.PAModifier)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.PAModifier getUnsliced() {
    return (entity.PAModifier)getUnslicedUntyped();
  }
  ...
  public entity.windowed.PAModifierVersionList getVersionList() {
    return (entity.windowed.PAModifierVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromPARateFactors(entity.PARateFactor element) {
    __getInternalInterface().removeArrayElement(PARATEFACTORS_PROP.get(), element);
  }
  ...
  public void removeFromPARateFactors(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(PARATEFACTORS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.PAModifier value) {
   ...
   */
  private void setFixed(entity.PAModifier value) {
  ...
  public void setPARateFactors(entity.PARateFactor[] value) {
    __getInternalInterface().setFieldValue(PARATEFACTORS_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.PAModifier value) {
  ...
  public entity.PAModifier split(java.util.Date splitDate) {
    return (entity.PAModifier)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PAModifierInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PAModifier.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ModifierAbstractDomainMethods", "gw.lob.pa.PAModifierAdapter");
    config.put("gw.api.domain.ModifierAdapter", "gw.lob.pa.PAModifierAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.pa.PAModifierMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.pa.PAModifierMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PAModifier.class, config);
    com.guidewire._generated.entity.PAModifierInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PAModifier, com.guidewire._generated.entity.PAModifierInternal>() {
      public java.lang.Object getImplementation(entity.PAModifier bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PAModifierInternal getInternalInterface(entity.PAModifier bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PAModifier newEmptyInstance() {
        return new entity.PAModifier((java.lang.Void)null);
      }

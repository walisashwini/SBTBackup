 ...
 * A taxable unit of price for a period of time, not to be broken up any further, for a Personal Auto multi-policy discount
 */
...
@gw.entity.EntityName(value = "PAMultiPolicyDiscCost")
public class PAMultiPolicyDiscCost extends entity.PAGeneralPremium implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PAMultiPolicyDiscCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PAMultiPolicyDiscCost, entity.PolicyPeriod>("entity.PAMultiPolicyDiscCost");
   ...
   */
  public PAMultiPolicyDiscCost(entity.PolicyPeriod branch)  {
   ...
   */
  public PAMultiPolicyDiscCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PAMultiPolicyDiscCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PAMultiPolicyDiscCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PAMultiPolicyDiscCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PAMultiPolicyDiscCostInternal)super.__getInternalInterface();
  }
  
  public entity.PAMultiPolicyDiscCost clone() {
    return (entity.PAMultiPolicyDiscCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.PAMultiPolicyDiscCost getBasedOn() {
    return (entity.PAMultiPolicyDiscCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PAMultiPolicyDiscCost getSlice(java.util.Date sliceDate) {
    return (entity.PAMultiPolicyDiscCost)getSliceUntyped(sliceDate);
  }
  
  public entity.PAMultiPolicyDiscCost getUnsliced() {
    return (entity.PAMultiPolicyDiscCost)getUnslicedUntyped();
  }
  
  public entity.windowed.PAMultiPolicyDiscCostVersionList getVersionList() {
    return (entity.windowed.PAMultiPolicyDiscCostVersionList)getVersionListUntyped();
  }
  
  public entity.PAMultiPolicyDiscCost split(java.util.Date splitDate) {
    return (entity.PAMultiPolicyDiscCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PAMultiPolicyDiscCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PAMultiPolicyDiscCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PAMultiPolicyDiscCost.class, config);
    com.guidewire._generated.entity.PAMultiPolicyDiscCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PAMultiPolicyDiscCost, com.guidewire._generated.entity.PAMultiPolicyDiscCostInternal>() {
      public java.lang.Object getImplementation(entity.PAMultiPolicyDiscCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PAMultiPolicyDiscCostInternal getInternalInterface(entity.PAMultiPolicyDiscCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PAMultiPolicyDiscCost newEmptyInstance() {
        return new entity.PAMultiPolicyDiscCost((java.lang.Void)null);
      }

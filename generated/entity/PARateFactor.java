...
@gw.entity.EntityName(value = "PARateFactor")
public class PARateFactor extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.RateFactor, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PARateFactor, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PARateFactor, entity.PolicyPeriod>("entity.PARateFactor");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> PAMODIFIER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "PAModifier");
  ...
  private com.guidewire._generated.entity.PARateFactorInternal _internal;
   ...
   */
  public PARateFactor(entity.PolicyPeriod branch)  {
   ...
   */
  public PARateFactor(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PARateFactor(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PARateFactorInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PARateFactorInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.PARateFactor clone() {
    return (entity.PARateFactor)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.PARateFactor getBasedOn() {
    return (entity.PARateFactor)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.PARateFactor getBasedOnValue() {
    return (entity.PARateFactor)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.PARateFactor getFixed() {
    return (entity.PARateFactor)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  /**
   * Gets the value of the PAModifier field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.PAModifier getPAModifier() {
    return (entity.PAModifier)__getInternalInterface().getFieldValue(PAMODIFIER_PROP.get());
  }
  ...
  public entity.PARateFactor getSlice(java.util.Date sliceDate) {
    return (entity.PARateFactor)getSliceUntyped(sliceDate);
  }
  ...
  public entity.PARateFactor getUnsliced() {
    return (entity.PARateFactor)getUnslicedUntyped();
  }
  ...
  public entity.windowed.PARateFactorVersionList getVersionList() {
    return (entity.windowed.PARateFactorVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.PARateFactor value) {
   ...
   */
  private void setFixed(entity.PARateFactor value) {
  ...
  /**
   * Sets the value of the PAModifier field.
   */
  public void setPAModifier(entity.PAModifier value) {
    __getInternalInterface().setFieldValue(PAMODIFIER_PROP.get(), value);
  }
  ...
  public entity.PARateFactor split(java.util.Date splitDate) {
    return (entity.PARateFactor)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PARateFactorInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PARateFactor.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getPAModifierID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(PAMODIFIER_PROP.get());
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.PARateFactor value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.PARateFactor value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
    ...
    public void setPAModifierID(gw.pl.persistence.core.Key value) {
      setFieldValue(PAMODIFIER_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.RateFactorAdapter", "gw.lob.pa.PARateFactorAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.pa.PARateFactorMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.pa.PARateFactorMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PARateFactor.class, config);
    com.guidewire._generated.entity.PARateFactorInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PARateFactor, com.guidewire._generated.entity.PARateFactorInternal>() {
      public java.lang.Object getImplementation(entity.PARateFactor bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PARateFactorInternal getInternalInterface(entity.PARateFactor bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PARateFactor newEmptyInstance() {
        return new entity.PARateFactor((java.lang.Void)null);
      }

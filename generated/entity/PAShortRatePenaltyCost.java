 ...
 * A taxable unit of price for a period of time, not to be broken up any further, for a Personal Auto short rate penalty
 */
...
@gw.entity.EntityName(value = "PAShortRatePenaltyCost")
public class PAShortRatePenaltyCost extends entity.PATaxable implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PAShortRatePenaltyCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PAShortRatePenaltyCost, entity.PolicyPeriod>("entity.PAShortRatePenaltyCost");
   ...
   */
  public PAShortRatePenaltyCost(entity.PolicyPeriod branch)  {
   ...
   */
  public PAShortRatePenaltyCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PAShortRatePenaltyCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PAShortRatePenaltyCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PAShortRatePenaltyCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PAShortRatePenaltyCostInternal)super.__getInternalInterface();
  }
  
  public entity.PAShortRatePenaltyCost clone() {
    return (entity.PAShortRatePenaltyCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.PAShortRatePenaltyCost getBasedOn() {
    return (entity.PAShortRatePenaltyCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PAShortRatePenaltyCost getSlice(java.util.Date sliceDate) {
    return (entity.PAShortRatePenaltyCost)getSliceUntyped(sliceDate);
  }
  
  public entity.PAShortRatePenaltyCost getUnsliced() {
    return (entity.PAShortRatePenaltyCost)getUnslicedUntyped();
  }
  
  public entity.windowed.PAShortRatePenaltyCostVersionList getVersionList() {
    return (entity.windowed.PAShortRatePenaltyCostVersionList)getVersionListUntyped();
  }
  
  public entity.PAShortRatePenaltyCost split(java.util.Date splitDate) {
    return (entity.PAShortRatePenaltyCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PAShortRatePenaltyCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PAShortRatePenaltyCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.lob.pa.financials.PACostMethods", "gw.lob.pa.financials.PACostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PAShortRatePenaltyCost.class, config);
    com.guidewire._generated.entity.PAShortRatePenaltyCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PAShortRatePenaltyCost, com.guidewire._generated.entity.PAShortRatePenaltyCostInternal>() {
      public java.lang.Object getImplementation(entity.PAShortRatePenaltyCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PAShortRatePenaltyCostInternal getInternalInterface(entity.PAShortRatePenaltyCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PAShortRatePenaltyCost newEmptyInstance() {
        return new entity.PAShortRatePenaltyCost((java.lang.Void)null);
      }

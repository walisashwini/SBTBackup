...
/**
 * PATransaction
 * A transaction for the Personal Auto line
 */
...
@gw.entity.EntityName(value = "PATransaction")
public class PATransaction extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Transaction {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PATransaction, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PATransaction, entity.PolicyPeriod>("entity.PATransaction");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> PACOST_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "PACost");
  ...
  private com.guidewire._generated.entity.PATransactionInternal _internal;
   ...
   */
  public PATransaction(entity.PolicyPeriod branch)  {
   ...
   */
  public PATransaction(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PATransaction(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PATransactionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PATransactionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.PATransaction clone() {
    return (entity.PATransaction)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.PATransaction getBasedOn() {
    return (entity.PATransaction)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PATransaction getBasedOnValue() {
    return (entity.PATransaction)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.PATransaction getFixed() {
    return (entity.PATransaction)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.PACost getPACost() {
    return (entity.PACost)__getInternalInterface().getFieldValue(PACOST_PROP.get());
  }
  ...
  public entity.PATransaction getSlice(java.util.Date sliceDate) {
    return (entity.PATransaction)getSliceUntyped(sliceDate);
  }
  ...
  public entity.PATransaction getUnsliced() {
    return (entity.PATransaction)getUnslicedUntyped();
  }
  ...
  public entity.windowed.PATransactionVersionList getVersionList() {
    return (entity.windowed.PATransactionVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.PATransaction value) {
   ...
   */
  private void setFixed(entity.PATransaction value) {
  ...
  public void setPACost(entity.PACost value) {
    __getInternalInterface().setFieldValue(PACOST_PROP.get(), value);
  }
  ...
  public entity.PATransaction split(java.util.Date splitDate) {
    return (entity.PATransaction)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PATransactionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PATransaction.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getPACostID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(PACOST_PROP.get());
    }
    ...
    public void setPACostID(gw.pl.persistence.core.Key value) {
      setFieldValue(PACOST_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.financials.TransactionAdapter", "gw.lob.pa.financials.PATransactionAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PATransaction.class, config);
    com.guidewire._generated.entity.PATransactionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PATransaction, com.guidewire._generated.entity.PATransactionInternal>() {
      public java.lang.Object getImplementation(entity.PATransaction bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PATransactionInternal getInternalInterface(entity.PATransaction bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PATransaction newEmptyInstance() {
        return new entity.PATransaction((java.lang.Void)null);
      }

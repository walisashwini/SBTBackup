...
/**
 * PAVehicleCovLookup
 * PersonalVehicle Coverage Lookup Table.
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PAVehicleCovLookup.eti;PAVehicleCovLookup.eix;PAVehicleCovLookup.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PAVehicleCovLookup")
public class PAVehicleCovLookup extends entity.CoverageLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PAVehicleCovLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PAVehicleCovLookup>("entity.PAVehicleCovLookup");
   ...
   */
  protected PAVehicleCovLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PAVehicleCovLookup(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PAVehicleCovLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PAVehicleCovLookupInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PAVehicleCovLookupInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PAVehicleCovLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PAVehicleCovLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PAVehicleCovLookup.class, config);
    com.guidewire._generated.entity.PAVehicleCovLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PAVehicleCovLookup, com.guidewire._generated.entity.PAVehicleCovLookupInternal>() {
      public java.lang.Object getImplementation(entity.PAVehicleCovLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PAVehicleCovLookupInternal getInternalInterface(entity.PAVehicleCovLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PAVehicleCovLookup newEmptyInstance() {
        return new entity.PAVehicleCovLookup((java.lang.Void)null);
      }

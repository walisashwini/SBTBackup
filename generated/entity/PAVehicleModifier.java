...
/**
 * PAVehicleModifier
 * A vehicle-level modifier for Personal Auto
 */
...
@gw.entity.EntityName(value = "PAVehicleModifier")
public class PAVehicleModifier extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Modifier, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PAVehicleModifier, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PAVehicleModifier, entity.PolicyPeriod>("entity.PAVehicleModifier");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> PAVEHICLERATEFACTORS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "PAVehicleRateFactors");
  ...
  private com.guidewire._generated.entity.PAVehicleModifierInternal _internal;
   ...
   */
  public PAVehicleModifier(entity.PolicyPeriod branch)  {
   ...
   */
  public PAVehicleModifier(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PAVehicleModifier(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PAVehicleModifierInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PAVehicleModifierInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToPAVehicleRateFactors(entity.PAVehicleRateFactor element) {
    __getInternalInterface().addArrayElement(PAVEHICLERATEFACTORS_PROP.get(), element);
  }
  ...
  public entity.PAVehicleModifier clone() {
    return (entity.PAVehicleModifier)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.PAVehicleModifier getBasedOn() {
    return (entity.PAVehicleModifier)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PAVehicleModifier getBasedOnValue() {
    return (entity.PAVehicleModifier)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.PAVehicleModifier getFixed() {
    return (entity.PAVehicleModifier)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.PAVehicleRateFactor[] getPAVehicleRateFactors() {
    return (entity.PAVehicleRateFactor[])__getInternalInterface().getFieldValue(PAVEHICLERATEFACTORS_PROP.get());
  }
  ...
  public entity.PAVehicleModifier getSlice(java.util.Date sliceDate) {
    return (entity.PAVehicleModifier)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.PAVehicleModifier getSubtype() {
    return (typekey.PAVehicleModifier)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.PAVehicleModifier getUnsliced() {
    return (entity.PAVehicleModifier)getUnslicedUntyped();
  }
  ...
  public entity.windowed.PAVehicleModifierVersionList getVersionList() {
    return (entity.windowed.PAVehicleModifierVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromPAVehicleRateFactors(entity.PAVehicleRateFactor element) {
    __getInternalInterface().removeArrayElement(PAVEHICLERATEFACTORS_PROP.get(), element);
  }
  ...
  public void removeFromPAVehicleRateFactors(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(PAVEHICLERATEFACTORS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.PAVehicleModifier value) {
   ...
   */
  private void setFixed(entity.PAVehicleModifier value) {
  ...
  public void setPAVehicleRateFactors(entity.PAVehicleRateFactor[] value) {
    __getInternalInterface().setFieldValue(PAVEHICLERATEFACTORS_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.PAVehicleModifier value) {
  ...
  public entity.PAVehicleModifier split(java.util.Date splitDate) {
    return (entity.PAVehicleModifier)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PAVehicleModifierInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PAVehicleModifier.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ModifierAbstractDomainMethods", "gw.lob.pa.PAVehicleModifierAdapter");
    config.put("gw.api.domain.ModifierAdapter", "gw.lob.pa.PAVehicleModifierAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.pa.PAVehicleModifierMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.pa.PAVehicleModifierMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PAVehicleModifier.class, config);
    com.guidewire._generated.entity.PAVehicleModifierInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PAVehicleModifier, com.guidewire._generated.entity.PAVehicleModifierInternal>() {
      public java.lang.Object getImplementation(entity.PAVehicleModifier bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PAVehicleModifierInternal getInternalInterface(entity.PAVehicleModifier bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PAVehicleModifier newEmptyInstance() {
        return new entity.PAVehicleModifier((java.lang.Void)null);
      }

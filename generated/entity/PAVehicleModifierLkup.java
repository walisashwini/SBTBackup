...
/**
 * PAVehicleModifierLkup
 * PAVehicle-Level Modifier Lookup Table.
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PAVehicleModifierLkup.eti;PAVehicleModifierLkup.eix;PAVehicleModifierLkup.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PAVehicleModifierLkup")
public class PAVehicleModifierLkup extends entity.ModifierLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PAVehicleModifierLkup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PAVehicleModifierLkup>("entity.PAVehicleModifierLkup");
   ...
   */
  protected PAVehicleModifierLkup()  {
   ...
   */
  protected PAVehicleModifierLkup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PAVehicleModifierLkup(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PAVehicleModifierLkupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PAVehicleModifierLkupInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PAVehicleModifierLkupInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PAVehicleModifierLkupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PAVehicleModifierLkup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PAVehicleModifierLkup.class, config);
    com.guidewire._generated.entity.PAVehicleModifierLkupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PAVehicleModifierLkup, com.guidewire._generated.entity.PAVehicleModifierLkupInternal>() {
      public java.lang.Object getImplementation(entity.PAVehicleModifierLkup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PAVehicleModifierLkupInternal getInternalInterface(entity.PAVehicleModifierLkup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PAVehicleModifierLkup newEmptyInstance() {
        return new entity.PAVehicleModifierLkup((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "PAVehicleRateFactor")
public class PAVehicleRateFactor extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.RateFactor, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PAVehicleRateFactor, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PAVehicleRateFactor, entity.PolicyPeriod>("entity.PAVehicleRateFactor");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> PAVEHICLEMODIFIER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "PAVehicleModifier");
  ...
  private com.guidewire._generated.entity.PAVehicleRateFactorInternal _internal;
   ...
   */
  public PAVehicleRateFactor(entity.PolicyPeriod branch)  {
   ...
   */
  public PAVehicleRateFactor(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PAVehicleRateFactor(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PAVehicleRateFactorInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PAVehicleRateFactorInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.PAVehicleRateFactor clone() {
    return (entity.PAVehicleRateFactor)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.PAVehicleRateFactor getBasedOn() {
    return (entity.PAVehicleRateFactor)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PAVehicleRateFactor getBasedOnValue() {
    return (entity.PAVehicleRateFactor)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.PAVehicleRateFactor getFixed() {
    return (entity.PAVehicleRateFactor)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.PAVehicleModifier getPAVehicleModifier() {
    return (entity.PAVehicleModifier)__getInternalInterface().getFieldValue(PAVEHICLEMODIFIER_PROP.get());
  }
  ...
  public entity.PAVehicleRateFactor getSlice(java.util.Date sliceDate) {
    return (entity.PAVehicleRateFactor)getSliceUntyped(sliceDate);
  }
  ...
  public entity.PAVehicleRateFactor getUnsliced() {
    return (entity.PAVehicleRateFactor)getUnslicedUntyped();
  }
  ...
  public entity.windowed.PAVehicleRateFactorVersionList getVersionList() {
    return (entity.windowed.PAVehicleRateFactorVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.PAVehicleRateFactor value) {
   ...
   */
  private void setFixed(entity.PAVehicleRateFactor value) {
  ...
  public void setPAVehicleModifier(entity.PAVehicleModifier value) {
    __getInternalInterface().setFieldValue(PAVEHICLEMODIFIER_PROP.get(), value);
  }
  ...
  public entity.PAVehicleRateFactor split(java.util.Date splitDate) {
    return (entity.PAVehicleRateFactor)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PAVehicleRateFactorInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PAVehicleRateFactor.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getPAVehicleModifierID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(PAVEHICLEMODIFIER_PROP.get());
    }
    ...
    public void setPAVehicleModifierID(gw.pl.persistence.core.Key value) {
      setFieldValue(PAVEHICLEMODIFIER_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.RateFactorAdapter", "gw.lob.pa.PAVehicleRateFactorAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.pa.PAVehicleRateFactorMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.pa.PAVehicleRateFactorMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PAVehicleRateFactor.class, config);
    com.guidewire._generated.entity.PAVehicleRateFactorInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PAVehicleRateFactor, com.guidewire._generated.entity.PAVehicleRateFactorInternal>() {
      public java.lang.Object getImplementation(entity.PAVehicleRateFactor bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PAVehicleRateFactorInternal getInternalInterface(entity.PAVehicleRateFactor bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PAVehicleRateFactor newEmptyInstance() {
        return new entity.PAVehicleRateFactor((java.lang.Void)null);
      }

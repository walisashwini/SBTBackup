...
/**
 * PAVhcleAddlInterest
 * An additional interest on a personal auto vehicle
 */
...
@gw.entity.EntityName(value = "PAVhcleAddlInterest")
public class PAVhcleAddlInterest extends entity.AddlInterestDetail implements gw.api.copier.EffDatedCopyable, gw.api.domain.account.Mergeable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PAVhcleAddlInterest, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PAVhcleAddlInterest, entity.PolicyPeriod>("entity.PAVhcleAddlInterest");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> PAVEHICLE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "PAVehicle");
   ...
   */
  public PAVhcleAddlInterest(entity.PolicyPeriod branch)  {
   ...
   */
  public PAVhcleAddlInterest(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PAVhcleAddlInterest(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PAVhcleAddlInterestInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PAVhcleAddlInterestInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PAVhcleAddlInterestInternal)super.__getInternalInterface();
  }
  
  public entity.PAVhcleAddlInterest clone() {
    return (entity.PAVhcleAddlInterest)__getInternalInterface().cloneUntyped();
  }
  
  public entity.PAVhcleAddlInterest getBasedOn() {
    return (entity.PAVhcleAddlInterest)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PersonalVehicle getPAVehicle() {
    return (entity.PersonalVehicle)__getInternalInterface().getFieldValue(PAVEHICLE_PROP.get());
  }
  
  public entity.PAVhcleAddlInterest getSlice(java.util.Date sliceDate) {
    return (entity.PAVhcleAddlInterest)getSliceUntyped(sliceDate);
  }
  
  public entity.PAVhcleAddlInterest getUnsliced() {
    return (entity.PAVhcleAddlInterest)getUnslicedUntyped();
  }
  
  public entity.windowed.PAVhcleAddlInterestVersionList getVersionList() {
    return (entity.windowed.PAVhcleAddlInterestVersionList)getVersionListUntyped();
  }
  ...
  public void setPAVehicle(entity.PersonalVehicle value) {
    __getInternalInterface().setFieldValue(PAVEHICLE_PROP.get(), value);
  }
  
  public entity.PAVhcleAddlInterest split(java.util.Date splitDate) {
    return (entity.PAVhcleAddlInterest)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PAVhcleAddlInterestInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PAVhcleAddlInterest.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getPAVehicleID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(PAVEHICLE_PROP.get());
    }
    ...
    public void setPAVehicleID(gw.pl.persistence.core.Key value) {
      setFieldValue(PAVEHICLE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.account.Mergeable", "gw.lob.pa.PAVhcleAddlInterestMergeableImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.pa.PAVhcleAddlInterestMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.pa.PAVhcleAddlInterestMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PAVhcleAddlInterest.class, config);
    com.guidewire._generated.entity.PAVhcleAddlInterestInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PAVhcleAddlInterest, com.guidewire._generated.entity.PAVhcleAddlInterestInternal>() {
      public java.lang.Object getImplementation(entity.PAVhcleAddlInterest bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PAVhcleAddlInterestInternal getInternalInterface(entity.PAVhcleAddlInterest bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PAVhcleAddlInterest newEmptyInstance() {
        return new entity.PAVhcleAddlInterest((java.lang.Void)null);
      }

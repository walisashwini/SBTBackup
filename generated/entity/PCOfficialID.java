...
/**
 * PCOfficialID
 * OfficialID that has an fk to an OfficialIDPattern.
 */
...
@gw.entity.EntityName(value = "PCOfficialID")
public class PCOfficialID extends entity.OfficialID implements gw.api.obfuscation.Obfuscator {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PCOfficialID> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PCOfficialID>("entity.PCOfficialID");
   ...
   */
  public PCOfficialID(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PCOfficialID(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PCOfficialIDInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PCOfficialIDInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PCOfficialIDInternal)super.__getInternalInterface();
  }
  
  /**
   * Returns this OfficialID's pattern
   * @return the pattern for this PCOfficialID
   */
  public gw.api.productmodel.OfficialIdPattern getPattern() {
    return ((com.guidewire.pc.domain.contact.PCOfficialIDPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.contact.PCOfficialIDPublicMethods")).getPattern();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PCOfficialIDInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PCOfficialID.this.__getDelegateManager();
    }
    ...
    public void setPattern(gw.api.productmodel.OfficialIdPattern pattern) {
      ((com.guidewire.pc.domain.contact.impl.PCOfficialIDInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.contact.impl.PCOfficialIDInternalMethods")).setPattern(pattern);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.contact.PCOfficialIDPublicMethods", "com.guidewire.pc.domain.contact.impl.PCOfficialIDImpl");
    config.put("com.guidewire.pc.domain.contact.impl.PCOfficialIDInternalMethods", "com.guidewire.pc.domain.contact.impl.PCOfficialIDImpl");
    ...
    config.put("gw.api.obfuscation.Obfuscator", "gw.personaldata.obfuscation.PCOfficialIDObfuscator");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PCOfficialID.class, config);
    com.guidewire._generated.entity.PCOfficialIDInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PCOfficialID, com.guidewire._generated.entity.PCOfficialIDInternal>() {
      public java.lang.Object getImplementation(entity.PCOfficialID bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PCOfficialIDInternal getInternalInterface(entity.PCOfficialID bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PCOfficialID newEmptyInstance() {
        return new entity.PCOfficialID((java.lang.Void)null);
      }

...
/**
 * PendingAccountContactRoleUpdatesWorkItem
 * WorkItem to apply the pending account contact role updates
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PendingAccountContactRoleUpdatesWorkItem.eti;PendingAccountContactRoleUpdatesWorkItem.eix;PendingAccountContactRoleUpdatesWorkItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PendingAccountContactRoleUpdatesWorkItem")
public class PendingAccountContactRoleUpdatesWorkItem extends entity.PendingUpdatesWorkItem {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PendingAccountContactRoleUpdatesWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PendingAccountContactRoleUpdatesWorkItem>("entity.PendingAccountContactRoleUpdatesWorkItem");
   ...
   */
  public PendingAccountContactRoleUpdatesWorkItem()  {
   ...
   */
  public PendingAccountContactRoleUpdatesWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PendingAccountContactRoleUpdatesWorkItem(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PendingAccountContactRoleUpdatesWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PendingAccountContactRoleUpdatesWorkItemInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PendingAccountContactRoleUpdatesWorkItemInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PendingAccountContactRoleUpdatesWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PendingAccountContactRoleUpdatesWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.account.PendingUpdates", "gw.account.PendingAccountContactRoleUpdatesWorkItemAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PendingAccountContactRoleUpdatesWorkItem.class, config);
    com.guidewire._generated.entity.PendingAccountContactRoleUpdatesWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PendingAccountContactRoleUpdatesWorkItem, com.guidewire._generated.entity.PendingAccountContactRoleUpdatesWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.PendingAccountContactRoleUpdatesWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PendingAccountContactRoleUpdatesWorkItemInternal getInternalInterface(entity.PendingAccountContactRoleUpdatesWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PendingAccountContactRoleUpdatesWorkItem newEmptyInstance() {
        return new entity.PendingAccountContactRoleUpdatesWorkItem((java.lang.Void)null);
      }

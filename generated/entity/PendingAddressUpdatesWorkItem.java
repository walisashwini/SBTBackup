...
/**
 * PendingAddressUpdatesWorkItem
 * WorkItem to apply the pending address updates
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PendingAddressUpdatesWorkItem.eti;PendingAddressUpdatesWorkItem.eix;PendingAddressUpdatesWorkItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PendingAddressUpdatesWorkItem")
public class PendingAddressUpdatesWorkItem extends entity.PendingUpdatesWorkItem {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PendingAddressUpdatesWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PendingAddressUpdatesWorkItem>("entity.PendingAddressUpdatesWorkItem");
   ...
   */
  public PendingAddressUpdatesWorkItem()  {
   ...
   */
  public PendingAddressUpdatesWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PendingAddressUpdatesWorkItem(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PendingAddressUpdatesWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PendingAddressUpdatesWorkItemInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PendingAddressUpdatesWorkItemInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PendingAddressUpdatesWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PendingAddressUpdatesWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.account.PendingUpdates", "gw.account.PendingAddressUpdatesWorkItemAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PendingAddressUpdatesWorkItem.class, config);
    com.guidewire._generated.entity.PendingAddressUpdatesWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PendingAddressUpdatesWorkItem, com.guidewire._generated.entity.PendingAddressUpdatesWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.PendingAddressUpdatesWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PendingAddressUpdatesWorkItemInternal getInternalInterface(entity.PendingAddressUpdatesWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PendingAddressUpdatesWorkItem newEmptyInstance() {
        return new entity.PendingAddressUpdatesWorkItem((java.lang.Void)null);
      }

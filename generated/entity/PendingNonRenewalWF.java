...
/**
 * PendingNonRenewalWF
 * Workflow for not renewing renewals
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PendingNonRenewalWF.eti;PendingNonRenewalWF.eix;PendingNonRenewalWF.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PendingNonRenewalWF")
public class PendingNonRenewalWF extends entity.PolicyPeriodWorkflow {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PendingNonRenewalWF> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PendingNonRenewalWF>("entity.PendingNonRenewalWF");
   ...
   */
  public PendingNonRenewalWF(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PendingNonRenewalWF(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PendingNonRenewalWFInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PendingNonRenewalWFInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PendingNonRenewalWFInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PendingNonRenewalWFInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PendingNonRenewalWF.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PendingNonRenewalWF.class, config);
    com.guidewire._generated.entity.PendingNonRenewalWFInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PendingNonRenewalWF, com.guidewire._generated.entity.PendingNonRenewalWFInternal>() {
      public java.lang.Object getImplementation(entity.PendingNonRenewalWF bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PendingNonRenewalWFInternal getInternalInterface(entity.PendingNonRenewalWF bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PendingNonRenewalWF newEmptyInstance() {
        return new entity.PendingNonRenewalWF((java.lang.Void)null);
      }

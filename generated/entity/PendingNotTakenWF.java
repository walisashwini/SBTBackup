...
/**
 * PendingNotTakenWF
 * Workflow for not taking renewals
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PendingNotTakenWF.eti;PendingNotTakenWF.eix;PendingNotTakenWF.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PendingNotTakenWF")
public class PendingNotTakenWF extends entity.PolicyPeriodWorkflow {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PendingNotTakenWF> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PendingNotTakenWF>("entity.PendingNotTakenWF");
   ...
   */
  public PendingNotTakenWF(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PendingNotTakenWF(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PendingNotTakenWFInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PendingNotTakenWFInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PendingNotTakenWFInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PendingNotTakenWFInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PendingNotTakenWF.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PendingNotTakenWF.class, config);
    com.guidewire._generated.entity.PendingNotTakenWFInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PendingNotTakenWF, com.guidewire._generated.entity.PendingNotTakenWFInternal>() {
      public java.lang.Object getImplementation(entity.PendingNotTakenWF bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PendingNotTakenWFInternal getInternalInterface(entity.PendingNotTakenWF bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PendingNotTakenWF newEmptyInstance() {
        return new entity.PendingNotTakenWF((java.lang.Void)null);
      }

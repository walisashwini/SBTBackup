...
/**
 * PendingRenewalWF
 * Workflow for pending renewals
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PendingRenewalWF.eti;PendingRenewalWF.eix;PendingRenewalWF.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PendingRenewalWF")
public class PendingRenewalWF extends entity.PolicyPeriodWorkflow {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PendingRenewalWF> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PendingRenewalWF>("entity.PendingRenewalWF");
   ...
   */
  public PendingRenewalWF(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PendingRenewalWF(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PendingRenewalWFInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PendingRenewalWFInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PendingRenewalWFInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PendingRenewalWFInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PendingRenewalWF.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PendingRenewalWF.class, config);
    com.guidewire._generated.entity.PendingRenewalWFInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PendingRenewalWF, com.guidewire._generated.entity.PendingRenewalWFInternal>() {
      public java.lang.Object getImplementation(entity.PendingRenewalWF bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PendingRenewalWFInternal getInternalInterface(entity.PendingRenewalWF bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PendingRenewalWF newEmptyInstance() {
        return new entity.PendingRenewalWF((java.lang.Void)null);
      }

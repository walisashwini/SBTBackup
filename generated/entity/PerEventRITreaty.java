 ...
 * PerEventRITreaty
 * 
 *     Per-event aggregate reinsurance treaty.  
 *   
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PerEventRITreaty.eti;PerEventRITreaty.eix;PerEventRITreaty.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PerEventRITreaty")
public class PerEventRITreaty extends entity.NonProportionalRIAgreement implements entity.Treaty, entity.LossDateAttachable {
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.reinsurance.LossDateAttachablePublicMethods", "com.guidewire.pc.domain.reinsurance.impl.PerEventRITreatyImpl");
    config.put("com.guidewire.pc.domain.reinsurance.NonProportionalRIAgreementPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.PerEventRITreatyImpl");
    config.put("com.guidewire.pc.domain.reinsurance.PerEventRITreatyPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.PerEventRITreatyImpl");
    config.put("com.guidewire.pc.domain.reinsurance.RIAgreementPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.PerEventRITreatyImpl");
    ...
    config.put("com.guidewire.pc.domain.reinsurance.impl.RIAgreementInternalMethods", "com.guidewire.pc.domain.reinsurance.impl.PerEventRITreatyImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.reinsurance.impl.PerEventRITreatyImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.pc.domain.reinsurance.impl.PerEventRITreatyImpl");
    config.put("gw.api.contact.ContactOwner", "com.guidewire.pc.domain.reinsurance.impl.PerEventRITreatyImpl");
    config.put("gw.api.domain.reinsurance.RICoverageGroupOwner", "com.guidewire.pc.domain.reinsurance.impl.PerEventRITreatyImpl");

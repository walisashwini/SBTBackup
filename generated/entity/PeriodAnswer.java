...
/**
 * PeriodAnswer
 * Links policy period and answer references - answers are persisted text responses to questions in the UI. Specific to PolicyCenter.
 */
...
@gw.entity.EntityName(value = "PeriodAnswer")
public class PeriodAnswer extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PCAnswerDelegate, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PeriodAnswer, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PeriodAnswer, entity.PolicyPeriod>("entity.PeriodAnswer");
  ...
  private com.guidewire._generated.entity.PeriodAnswerInternal _internal;
   ...
   */
  public PeriodAnswer(entity.PolicyPeriod branch)  {
   ...
   */
  public PeriodAnswer(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PeriodAnswer(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PeriodAnswerInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PeriodAnswerInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.PeriodAnswer clone() {
    return (entity.PeriodAnswer)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.PeriodAnswer getBasedOn() {
    return (entity.PeriodAnswer)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PeriodAnswer getBasedOnValue() {
    return (entity.PeriodAnswer)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.PeriodAnswer getFixed() {
    return (entity.PeriodAnswer)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.PeriodAnswer getSlice(java.util.Date sliceDate) {
    return (entity.PeriodAnswer)getSliceUntyped(sliceDate);
  }
  ...
  public entity.PeriodAnswer getUnsliced() {
    return (entity.PeriodAnswer)getUnslicedUntyped();
  }
  ...
  public entity.windowed.PeriodAnswerVersionList getVersionList() {
    return (entity.windowed.PeriodAnswerVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.PeriodAnswer value) {
   ...
   */
  private void setFixed(entity.PeriodAnswer value) {
  ...
  public entity.PeriodAnswer split(java.util.Date splitDate) {
    return (entity.PeriodAnswer)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PeriodAnswerInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PeriodAnswer.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.question.PeriodAnswerMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.question.PeriodAnswerMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PeriodAnswer.class, config);
    com.guidewire._generated.entity.PeriodAnswerInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PeriodAnswer, com.guidewire._generated.entity.PeriodAnswerInternal>() {
      public java.lang.Object getImplementation(entity.PeriodAnswer bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PeriodAnswerInternal getInternalInterface(entity.PeriodAnswer bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PeriodAnswer newEmptyInstance() {
        return new entity.PeriodAnswer((java.lang.Void)null);
      }

...
/**
 * PersonalAutoCond
 * A line-level condition for Personal Auto
 */
...
@gw.entity.EntityName(value = "PersonalAutoCond")
public class PersonalAutoCond extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PolicyCondition, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PersonalAutoCond, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PersonalAutoCond, entity.PolicyPeriod>("entity.PersonalAutoCond");
  ...
  private com.guidewire._generated.entity.PersonalAutoCondInternal _internal;
   ...
   */
  protected PersonalAutoCond(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected PersonalAutoCond(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected PersonalAutoCond(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PersonalAutoCondInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PersonalAutoCondInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.PersonalAutoCond clone() {
    return (entity.PersonalAutoCond)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.PersonalAutoCond getBasedOn() {
    return (entity.PersonalAutoCond)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.PersonalAutoCond getBasedOnValue() {
    return (entity.PersonalAutoCond)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.PersonalAutoCond getFixed() {
    return (entity.PersonalAutoCond)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.PersonalAutoCond getSlice(java.util.Date sliceDate) {
    return (entity.PersonalAutoCond)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.PersonalAutoCond getSubtype() {
    return (typekey.PersonalAutoCond)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.PersonalAutoCond getUnsliced() {
    return (entity.PersonalAutoCond)getUnslicedUntyped();
  }
  ...
  public entity.windowed.PersonalAutoCondVersionList getVersionList() {
    return (entity.windowed.PersonalAutoCondVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.PersonalAutoCond value) {
   ...
   */
  private void setFixed(entity.PersonalAutoCond value) {
   ...
   */
  private void setSubtype(typekey.PersonalAutoCond value) {
  ...
  public entity.PersonalAutoCond split(java.util.Date splitDate) {
    return (entity.PersonalAutoCond)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PersonalAutoCondInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PersonalAutoCond.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.PersonalAutoCond value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.PersonalAutoCond value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.PersonalAutoCond value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.pa.PersonalAutoCondConditionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.pa.PersonalAutoCondConditionAdapter");
    config.put("gw.api.domain.PolicyConditionAdapter", "gw.lob.pa.PersonalAutoCondConditionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.pa.PersonalAutoCondMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.pa.PersonalAutoCondMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PersonalAutoCond.class, config);
    com.guidewire._generated.entity.PersonalAutoCondInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PersonalAutoCond, com.guidewire._generated.entity.PersonalAutoCondInternal>() {
      public java.lang.Object getImplementation(entity.PersonalAutoCond bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PersonalAutoCondInternal getInternalInterface(entity.PersonalAutoCond bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PersonalAutoCond newEmptyInstance() {
        return new entity.PersonalAutoCond((java.lang.Void)null);
      }

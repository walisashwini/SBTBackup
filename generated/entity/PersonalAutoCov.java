...
/**
 * PersonalAutoCov
 * A line-level coverage for Personal Auto
 */
...
@gw.entity.EntityName(value = "PersonalAutoCov")
public class PersonalAutoCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PersonalAutoCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PersonalAutoCov, entity.PolicyPeriod>("entity.PersonalAutoCov");
  ...
  private com.guidewire._generated.entity.PersonalAutoCovInternal _internal;
   ...
   */
  protected PersonalAutoCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected PersonalAutoCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected PersonalAutoCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PersonalAutoCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PersonalAutoCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.PersonalAutoCov clone() {
    return (entity.PersonalAutoCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.PersonalAutoCov getBasedOn() {
    return (entity.PersonalAutoCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PersonalAutoCov getBasedOnValue() {
    return (entity.PersonalAutoCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.PersonalAutoCov getFixed() {
    return (entity.PersonalAutoCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.PersonalAutoCov getSlice(java.util.Date sliceDate) {
    return (entity.PersonalAutoCov)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.PersonalAutoCov getSubtype() {
    return (typekey.PersonalAutoCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.PersonalAutoCov getUnsliced() {
    return (entity.PersonalAutoCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.PersonalAutoCovVersionList getVersionList() {
    return (entity.windowed.PersonalAutoCovVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.PersonalAutoCov value) {
   ...
   */
  private void setFixed(entity.PersonalAutoCov value) {
   ...
   */
  private void setSubtype(typekey.PersonalAutoCov value) {
  ...
  public entity.PersonalAutoCov split(java.util.Date splitDate) {
    return (entity.PersonalAutoCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PersonalAutoCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PersonalAutoCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.pa.PersonalAutoCovCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.pa.PersonalAutoCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.pa.PersonalAutoCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.pa.PersonalAutoCovCoverageAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.pa.PersonalAutoCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.pa.PersonalAutoCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PersonalAutoCov.class, config);
    com.guidewire._generated.entity.PersonalAutoCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PersonalAutoCov, com.guidewire._generated.entity.PersonalAutoCovInternal>() {
      public java.lang.Object getImplementation(entity.PersonalAutoCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PersonalAutoCovInternal getInternalInterface(entity.PersonalAutoCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PersonalAutoCov newEmptyInstance() {
        return new entity.PersonalAutoCov((java.lang.Void)null);
      }

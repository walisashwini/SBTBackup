...
@gw.entity.EntityName(value = "PersonalAutoCovCost")
public class PersonalAutoCovCost extends entity.PACoveragePremium implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PersonalAutoCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PersonalAutoCovCost, entity.PolicyPeriod>("entity.PersonalAutoCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> PERSONALAUTOCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "PersonalAutoCov");
   ...
   */
  public PersonalAutoCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public PersonalAutoCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PersonalAutoCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PersonalAutoCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PersonalAutoCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PersonalAutoCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.PersonalAutoCovCost clone() {
    return (entity.PersonalAutoCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.PersonalAutoCovCost getBasedOn() {
    return (entity.PersonalAutoCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PersonalAutoCovCost getSlice(java.util.Date sliceDate) {
    return (entity.PersonalAutoCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.PersonalAutoCovCost getUnsliced() {
    return (entity.PersonalAutoCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.PersonalAutoCovCostVersionList getVersionList() {
    return (entity.windowed.PersonalAutoCovCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.PersonalAutoCovCost split(java.util.Date splitDate) {
    return (entity.PersonalAutoCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PersonalAutoCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PersonalAutoCovCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PersonalAutoCovCost.class, config);
    com.guidewire._generated.entity.PersonalAutoCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PersonalAutoCovCost, com.guidewire._generated.entity.PersonalAutoCovCostInternal>() {
      public java.lang.Object getImplementation(entity.PersonalAutoCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PersonalAutoCovCostInternal getInternalInterface(entity.PersonalAutoCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PersonalAutoCovCost newEmptyInstance() {
        return new entity.PersonalAutoCovCost((java.lang.Void)null);
      }

...
/**
 * PersonalAutoExcl
 * A line-level exclusion for Personal Auto
 */
...
@gw.entity.EntityName(value = "PersonalAutoExcl")
public class PersonalAutoExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PersonalAutoExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PersonalAutoExcl, entity.PolicyPeriod>("entity.PersonalAutoExcl");
  ...
  private com.guidewire._generated.entity.PersonalAutoExclInternal _internal;
   ...
   */
  protected PersonalAutoExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected PersonalAutoExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected PersonalAutoExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PersonalAutoExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PersonalAutoExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.PersonalAutoExcl clone() {
    return (entity.PersonalAutoExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.PersonalAutoExcl getBasedOn() {
    return (entity.PersonalAutoExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.PersonalAutoExcl getBasedOnValue() {
    return (entity.PersonalAutoExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.PersonalAutoExcl getFixed() {
    return (entity.PersonalAutoExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.PersonalAutoExcl getSlice(java.util.Date sliceDate) {
    return (entity.PersonalAutoExcl)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.PersonalAutoExcl getSubtype() {
    return (typekey.PersonalAutoExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.PersonalAutoExcl getUnsliced() {
    return (entity.PersonalAutoExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.PersonalAutoExclVersionList getVersionList() {
    return (entity.windowed.PersonalAutoExclVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.PersonalAutoExcl value) {
   ...
   */
  private void setFixed(entity.PersonalAutoExcl value) {
   ...
   */
  private void setSubtype(typekey.PersonalAutoExcl value) {
  ...
  public entity.PersonalAutoExcl split(java.util.Date splitDate) {
    return (entity.PersonalAutoExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PersonalAutoExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PersonalAutoExcl.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.PersonalAutoExcl value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.PersonalAutoExcl value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.PersonalAutoExcl value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.pa.PersonalAutoExclExclusionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.pa.PersonalAutoExclExclusionAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.pa.PersonalAutoExclExclusionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.pa.PersonalAutoExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.pa.PersonalAutoExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PersonalAutoExcl.class, config);
    com.guidewire._generated.entity.PersonalAutoExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PersonalAutoExcl, com.guidewire._generated.entity.PersonalAutoExclInternal>() {
      public java.lang.Object getImplementation(entity.PersonalAutoExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PersonalAutoExclInternal getInternalInterface(entity.PersonalAutoExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PersonalAutoExcl newEmptyInstance() {
        return new entity.PersonalAutoExcl((java.lang.Void)null);
      }

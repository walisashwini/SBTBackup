...
@gw.entity.EntityName(value = "PersonalAutoLine")
public class PersonalAutoLine extends entity.PolicyLine implements entity.Coverable, entity.Modifiable, gw.api.policy.PolicyLineJavaMethods {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PersonalAutoLine, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PersonalAutoLine, entity.PolicyPeriod>("entity.PersonalAutoLine");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> PACOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "PACosts");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> PALINECONDITIONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "PALineConditions");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> PALINECOVERAGES_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "PALineCoverages");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> PALINEEXCLUSIONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "PALineExclusions");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> PAMODIFIERS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "PAModifiers");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> PERSONALVEHICLEAUTONUMBERSEQ_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "PersonalVehicleAutoNumberSeq");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> POLICYDRIVERMVRS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "PolicyDriverMVRs");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> POLICYDRIVERS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "PolicyDrivers");
   ...
   */
  protected PersonalAutoLine(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected PersonalAutoLine(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected PersonalAutoLine(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PersonalAutoLineInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PersonalAutoLineInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PersonalAutoLineInternal)super.__getInternalInterface();
  }
  ...
  public void addToPACosts(entity.PACost element) {
    __getInternalInterface().addArrayElement(PACOSTS_PROP.get(), element);
  }
  ...
  public void addToPALineConditions(entity.PersonalAutoCond element) {
    __getInternalInterface().addArrayElement(PALINECONDITIONS_PROP.get(), element);
  }
  ...
  public void addToPALineCoverages(entity.PersonalAutoCov element) {
    __getInternalInterface().addArrayElement(PALINECOVERAGES_PROP.get(), element);
  }
  ...
  public void addToPALineExclusions(entity.PersonalAutoExcl element) {
    __getInternalInterface().addArrayElement(PALINEEXCLUSIONS_PROP.get(), element);
  }
  ...
  public void addToPAModifiers(entity.PAModifier element) {
    __getInternalInterface().addArrayElement(PAMODIFIERS_PROP.get(), element);
  }
  ...
  public void addToPolicyDriverMVRs(entity.PolicyDriverMVR element) {
    __getInternalInterface().addArrayElement(POLICYDRIVERMVRS_PROP.get(), element);
  }
  ...
  public void addToPolicyDrivers(entity.PolicyDriver element) {
    __getInternalInterface().addArrayElement(POLICYDRIVERS_PROP.get(), element);
  }
  ...
  public entity.PersonalAutoLine clone() {
    return (entity.PersonalAutoLine)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.PersonalAutoLine getBasedOn() {
    return (entity.PersonalAutoLine)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PACost[] getPACosts() {
    return (entity.PACost[])__getInternalInterface().getFieldValue(PACOSTS_PROP.get());
  }
  ...
  public entity.PersonalAutoCond[] getPALineConditions() {
    return (entity.PersonalAutoCond[])__getInternalInterface().getFieldValue(PALINECONDITIONS_PROP.get());
  }
  ...
  public entity.PersonalAutoCov[] getPALineCoverages() {
    return (entity.PersonalAutoCov[])__getInternalInterface().getFieldValue(PALINECOVERAGES_PROP.get());
  }
  ...
  public entity.PersonalAutoExcl[] getPALineExclusions() {
    return (entity.PersonalAutoExcl[])__getInternalInterface().getFieldValue(PALINEEXCLUSIONS_PROP.get());
  }
  ...
  public entity.PAModifier[] getPAModifiers() {
    return (entity.PAModifier[])__getInternalInterface().getFieldValue(PAMODIFIERS_PROP.get());
  }
  ...
  public entity.AutoNumberSequence getPersonalVehicleAutoNumberSeq() {
    return (entity.AutoNumberSequence)__getInternalInterface().getFieldValue(PERSONALVEHICLEAUTONUMBERSEQ_PROP.get());
  }
  ...
  public entity.PolicyDriverMVR[] getPolicyDriverMVRs() {
    return (entity.PolicyDriverMVR[])__getInternalInterface().getFieldValue(POLICYDRIVERMVRS_PROP.get());
  }
  ...
  public entity.PolicyDriver[] getPolicyDrivers() {
    return (entity.PolicyDriver[])__getInternalInterface().getFieldValue(POLICYDRIVERS_PROP.get());
  }
  ...
  public entity.PersonalAutoLine getSlice(java.util.Date sliceDate) {
    return (entity.PersonalAutoLine)getSliceUntyped(sliceDate);
  }
  
  public entity.PersonalAutoLine getUnsliced() {
    return (entity.PersonalAutoLine)getUnslicedUntyped();
  }
  ...
  public entity.PersonalVehicle[] getVehicles() {
    return (entity.PersonalVehicle[])__getInternalInterface().getFieldValue(VEHICLES_PROP.get());
  }
  
  public entity.windowed.PersonalAutoLineVersionList getVersionList() {
    return (entity.windowed.PersonalAutoLineVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromPACosts(entity.PACost element) {
    __getInternalInterface().removeArrayElement(PACOSTS_PROP.get(), element);
  }
  ...
  public void removeFromPACosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(PACOSTS_PROP.get(), elementID);
  }
  ...
  public void removeFromPALineConditions(entity.PersonalAutoCond element) {
    __getInternalInterface().removeArrayElement(PALINECONDITIONS_PROP.get(), element);
  }
  ...
  public void removeFromPALineConditions(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(PALINECONDITIONS_PROP.get(), elementID);
  }
  ...
  public void removeFromPALineCoverages(entity.PersonalAutoCov element) {
    __getInternalInterface().removeArrayElement(PALINECOVERAGES_PROP.get(), element);
  }
  ...
  public void removeFromPALineCoverages(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(PALINECOVERAGES_PROP.get(), elementID);
  }
  ...
  public void removeFromPALineExclusions(entity.PersonalAutoExcl element) {
    __getInternalInterface().removeArrayElement(PALINEEXCLUSIONS_PROP.get(), element);
  }
  ...
  public void removeFromPALineExclusions(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(PALINEEXCLUSIONS_PROP.get(), elementID);
  }
  ...
  public void removeFromPAModifiers(entity.PAModifier element) {
    __getInternalInterface().removeArrayElement(PAMODIFIERS_PROP.get(), element);
  }
  ...
  public void removeFromPAModifiers(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(PAMODIFIERS_PROP.get(), elementID);
  }
  ...
  public void removeFromPolicyDriverMVRs(entity.PolicyDriverMVR element) {
    __getInternalInterface().removeArrayElement(POLICYDRIVERMVRS_PROP.get(), element);
  }
  ...
  public void removeFromPolicyDriverMVRs(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(POLICYDRIVERMVRS_PROP.get(), elementID);
  }
  ...
  public void removeFromPolicyDrivers(entity.PolicyDriver element) {
    __getInternalInterface().removeArrayElement(POLICYDRIVERS_PROP.get(), element);
  }
  ...
  public void removeFromPolicyDrivers(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(POLICYDRIVERS_PROP.get(), elementID);
  }
  ...
  public void setPACosts(entity.PACost[] value) {
    __getInternalInterface().setFieldValue(PACOSTS_PROP.get(), value);
  }
  ...
  public void setPALineConditions(entity.PersonalAutoCond[] value) {
    __getInternalInterface().setFieldValue(PALINECONDITIONS_PROP.get(), value);
  }
  ...
  public void setPALineCoverages(entity.PersonalAutoCov[] value) {
    __getInternalInterface().setFieldValue(PALINECOVERAGES_PROP.get(), value);
  }
  ...
  public void setPALineExclusions(entity.PersonalAutoExcl[] value) {
    __getInternalInterface().setFieldValue(PALINEEXCLUSIONS_PROP.get(), value);
  }
  ...
  public void setPAModifiers(entity.PAModifier[] value) {
    __getInternalInterface().setFieldValue(PAMODIFIERS_PROP.get(), value);
  }
  ...
  public void setPersonalVehicleAutoNumberSeq(entity.AutoNumberSequence value) {
    __getInternalInterface().setFieldValue(PERSONALVEHICLEAUTONUMBERSEQ_PROP.get(), value);
  }
  ...
  public void setPolicyDriverMVRs(entity.PolicyDriverMVR[] value) {
    __getInternalInterface().setFieldValue(POLICYDRIVERMVRS_PROP.get(), value);
  }
  ...
  public void setPolicyDrivers(entity.PolicyDriver[] value) {
    __getInternalInterface().setFieldValue(POLICYDRIVERS_PROP.get(), value);
  }
  ...
  public entity.PersonalAutoLine split(java.util.Date splitDate) {
    return (entity.PersonalAutoLine)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PersonalAutoLineInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PersonalAutoLine.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getPersonalVehicleAutoNumberSeqID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(PERSONALVEHICLEAUTONUMBERSEQ_PROP.get());
    }
    ...
    public void setPersonalVehicleAutoNumberSeqID(gw.pl.persistence.core.Key value) {
      setFieldValue(PERSONALVEHICLEAUTONUMBERSEQ_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.pa.PALineCoverableModifiableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.pa.PALineCoverableModifiableAdapter");
    config.put("gw.api.domain.ModifiableAdapter", "gw.lob.pa.PALineCoverableModifiableAdapter");
    ...
    config.put("gw.api.policy.PolicyLineJavaMethods", "gw.lob.pa.PAPolicyLineMethods");
    config.put("gw.api.policy.PolicyLineMethods", "gw.lob.pa.PAPolicyLineMethods");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PersonalAutoLine.class, config);
    com.guidewire._generated.entity.PersonalAutoLineInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PersonalAutoLine, com.guidewire._generated.entity.PersonalAutoLineInternal>() {
      public java.lang.Object getImplementation(entity.PersonalAutoLine bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PersonalAutoLineInternal getInternalInterface(entity.PersonalAutoLine bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PersonalAutoLine newEmptyInstance() {
        return new entity.PersonalAutoLine((java.lang.Void)null);
      }

...
/**
 * PersonalAutoPIPCovCost
 * A taxable unit of price for a period of time, not to be broken up any further, for a line-level Personal Auto coverage
 */
...
@gw.entity.EntityName(value = "PersonalAutoPIPCovCost")
public class PersonalAutoPIPCovCost extends entity.PersonalAutoCovCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PersonalAutoPIPCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PersonalAutoPIPCovCost, entity.PolicyPeriod>("entity.PersonalAutoPIPCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> PAPIPCOVCOSTTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "PAPIPCovCostType");
   ...
   */
  public PersonalAutoPIPCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public PersonalAutoPIPCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PersonalAutoPIPCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PersonalAutoPIPCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PersonalAutoPIPCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PersonalAutoPIPCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.PersonalAutoPIPCovCost clone() {
    return (entity.PersonalAutoPIPCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.PersonalAutoPIPCovCost getBasedOn() {
    return (entity.PersonalAutoPIPCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public typekey.PAPIPCovCostType getPAPIPCovCostType() {
    return (typekey.PAPIPCovCostType)__getInternalInterface().getFieldValue(PAPIPCOVCOSTTYPE_PROP.get());
  }
  
  public entity.PersonalAutoPIPCovCost getSlice(java.util.Date sliceDate) {
    return (entity.PersonalAutoPIPCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.PersonalAutoPIPCovCost getUnsliced() {
    return (entity.PersonalAutoPIPCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.PersonalAutoPIPCovCostVersionList getVersionList() {
    return (entity.windowed.PersonalAutoPIPCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setPAPIPCovCostType(typekey.PAPIPCovCostType value) {
    __getInternalInterface().setFieldValue(PAPIPCOVCOSTTYPE_PROP.get(), value);
  }
  
  public entity.PersonalAutoPIPCovCost split(java.util.Date splitDate) {
    return (entity.PersonalAutoPIPCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PersonalAutoPIPCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PersonalAutoPIPCovCost.this.__getDelegateManager();
    }
    ...
    public entity.PACost getBasedOnValue() {
      return (entity.PACost)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public entity.PACost getFixed() {
      return (entity.PACost)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public entity.PersonalAutoCov getPersonalAutoCov() {
      return (entity.PersonalAutoCov)__getInternalInterface().getFieldValue(PERSONALAUTOCOV_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getPersonalAutoCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(PERSONALAUTOCOV_PROP.get());
    }
    ...
    public entity.PersonalVehicle getPersonalVehicle() {
      return (entity.PersonalVehicle)__getInternalInterface().getFieldValue(PERSONALVEHICLE_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getPersonalVehicleID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(PERSONALVEHICLE_PROP.get());
    }
    ...
    public typekey.PACost getSubtype() {
      return (typekey.PACost)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
    ...
    public entity.PATransaction[] getTransactions() {
      return (entity.PATransaction[])__getInternalInterface().getFieldValue(TRANSACTIONS_PROP.get());
    }
    ...
    public void setPersonalAutoCov(entity.PersonalAutoCov value) {
      __getInternalInterface().setFieldValue(PERSONALAUTOCOV_PROP.get(), value);
    }
    
    public void setPersonalAutoCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(PERSONALAUTOCOV_PROP.get(), value);
    }
    ...
    public void setPersonalVehicle(entity.PersonalVehicle value) {
      __getInternalInterface().setFieldValue(PERSONALVEHICLE_PROP.get(), value);
    }
    
    public void setPersonalVehicleID(gw.pl.persistence.core.Key value) {
      setFieldValue(PERSONALVEHICLE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.financials.CostAdapter", "gw.lob.pa.financials.PACostAdapter");
    config.put("gw.lob.pa.financials.PACostMethods", "gw.lob.pa.financials.PersonalAutoCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PersonalAutoPIPCovCost.class, config);
    com.guidewire._generated.entity.PersonalAutoPIPCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PersonalAutoPIPCovCost, com.guidewire._generated.entity.PersonalAutoPIPCovCostInternal>() {
      public java.lang.Object getImplementation(entity.PersonalAutoPIPCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PersonalAutoPIPCovCostInternal getInternalInterface(entity.PersonalAutoPIPCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PersonalAutoPIPCovCost newEmptyInstance() {
        return new entity.PersonalAutoPIPCovCost((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "PersonalAutoTaxCost")
public class PersonalAutoTaxCost extends entity.PACost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PersonalAutoTaxCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PersonalAutoTaxCost, entity.PolicyPeriod>("entity.PersonalAutoTaxCost");
   ...
   */
  public PersonalAutoTaxCost(entity.PolicyPeriod branch)  {
   ...
   */
  public PersonalAutoTaxCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PersonalAutoTaxCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PersonalAutoTaxCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PersonalAutoTaxCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PersonalAutoTaxCostInternal)super.__getInternalInterface();
  }
  
  public entity.PersonalAutoTaxCost clone() {
    return (entity.PersonalAutoTaxCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.PersonalAutoTaxCost getBasedOn() {
    return (entity.PersonalAutoTaxCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PersonalAutoTaxCost getSlice(java.util.Date sliceDate) {
    return (entity.PersonalAutoTaxCost)getSliceUntyped(sliceDate);
  }
  
  public entity.PersonalAutoTaxCost getUnsliced() {
    return (entity.PersonalAutoTaxCost)getUnslicedUntyped();
  }
  
  public entity.windowed.PersonalAutoTaxCostVersionList getVersionList() {
    return (entity.windowed.PersonalAutoTaxCostVersionList)getVersionListUntyped();
  }
  
  public entity.PersonalAutoTaxCost split(java.util.Date splitDate) {
    return (entity.PersonalAutoTaxCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PersonalAutoTaxCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PersonalAutoTaxCost.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PersonalAutoTaxCost.class, config);
    com.guidewire._generated.entity.PersonalAutoTaxCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PersonalAutoTaxCost, com.guidewire._generated.entity.PersonalAutoTaxCostInternal>() {
      public java.lang.Object getImplementation(entity.PersonalAutoTaxCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PersonalAutoTaxCostInternal getInternalInterface(entity.PersonalAutoTaxCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PersonalAutoTaxCost newEmptyInstance() {
        return new entity.PersonalAutoTaxCost((java.lang.Void)null);
      }

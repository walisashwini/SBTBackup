...
@gw.entity.EntityName(value = "PersonalVehicle")
public class PersonalVehicle extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Modifiable, entity.Coverable, gw.api.contact.AdditionalInterestContainer, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PersonalVehicle, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PersonalVehicle, entity.PolicyPeriod>("entity.PersonalVehicle");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ANNUALMILEAGE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AnnualMileage");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BASISAMOUNT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BasisAmount");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> COMMUTINGMILES_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CommutingMiles");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GARAGELOCATION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GarageLocation");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> PALINE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "PALine");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> PAVEHICLEMODIFIERS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "PAVehicleModifiers");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> QUICKQUOTENUMBER_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "QuickQuoteNumber");
  ...
  private com.guidewire._generated.entity.PersonalVehicleInternal _internal;
   ...
   */
  public PersonalVehicle(entity.PolicyPeriod branch)  {
   ...
   */
  public PersonalVehicle(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PersonalVehicle(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PersonalVehicleInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PersonalVehicleInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToPAVehicleModifiers(entity.PAVehicleModifier element) {
    __getInternalInterface().addArrayElement(PAVEHICLEMODIFIERS_PROP.get(), element);
  }
  ...
  public entity.PersonalVehicle clone() {
    return (entity.PersonalVehicle)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.PAVhcleAddlInterest[] getAdditionalInterests() {
    return (entity.PAVhcleAddlInterest[])__getInternalInterface().getFieldValue(ADDITIONALINTERESTS_PROP.get());
  }
  ...
  public java.lang.Integer getAnnualMileage() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(ANNUALMILEAGE_PROP.get());
  }
  ...
  public entity.PersonalVehicle getBasedOn() {
    return (entity.PersonalVehicle)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PersonalVehicle getBasedOnValue() {
    return (entity.PersonalVehicle)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public java.lang.Integer getBasisAmount() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(BASISAMOUNT_PROP.get());
  }
  ...
  public java.lang.Integer getCommutingMiles() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(COMMUTINGMILES_PROP.get());
  }
  ...
  public entity.PersonalAutoCovCost[] getCosts() {
    return (entity.PersonalAutoCovCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
  }
  ...
  public entity.PersonalVehicleCov[] getCoverages() {
    return (entity.PersonalVehicleCov[])__getInternalInterface().getFieldValue(COVERAGES_PROP.get());
  }
  ...
  public entity.VehicleDriver[] getDrivers() {
    return (entity.VehicleDriver[])__getInternalInterface().getFieldValue(DRIVERS_PROP.get());
  }
  ...
  public entity.PersonalVehicle getFixed() {
    return (entity.PersonalVehicle)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.PolicyLocation getGarageLocation() {
    return (entity.PolicyLocation)__getInternalInterface().getFieldValue(GARAGELOCATION_PROP.get());
  }
  ...
  public entity.PersonalAutoLine getPALine() {
    return (entity.PersonalAutoLine)__getInternalInterface().getFieldValue(PALINE_PROP.get());
  }
  ...
  public entity.PAVehicleModifier[] getPAVehicleModifiers() {
    return (entity.PAVehicleModifier[])__getInternalInterface().getFieldValue(PAVEHICLEMODIFIERS_PROP.get());
  }
  ...
  public java.lang.Integer getQuickQuoteNumber() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(QUICKQUOTENUMBER_PROP.get());
  }
  ...
  public entity.PersonalVehicle getSlice(java.util.Date sliceDate) {
    return (entity.PersonalVehicle)getSliceUntyped(sliceDate);
  }
  ...
  public entity.PersonalVehicle getUnsliced() {
    return (entity.PersonalVehicle)getUnslicedUntyped();
  }
  ...
  public entity.windowed.PersonalVehicleVersionList getVersionList() {
    return (entity.windowed.PersonalVehicleVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromPAVehicleModifiers(entity.PAVehicleModifier element) {
    __getInternalInterface().removeArrayElement(PAVEHICLEMODIFIERS_PROP.get(), element);
  }
  ...
  public void removeFromPAVehicleModifiers(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(PAVEHICLEMODIFIERS_PROP.get(), elementID);
  }
  ...
  public void setAnnualMileage(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(ANNUALMILEAGE_PROP.get(), value);
  }
   ...
   */
  private void setBasedOnValue(entity.PersonalVehicle value) {
  ...
  public void setBasisAmount(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(BASISAMOUNT_PROP.get(), value);
  }
  ...
  public void setCommutingMiles(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(COMMUTINGMILES_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.PersonalVehicle value) {
  ...
  public void setGarageLocation(entity.PolicyLocation value) {
    __getInternalInterface().setFieldValue(GARAGELOCATION_PROP.get(), value);
  }
  ...
  public void setPALine(entity.PersonalAutoLine value) {
    __getInternalInterface().setFieldValue(PALINE_PROP.get(), value);
  }
  ...
  public void setPAVehicleModifiers(entity.PAVehicleModifier[] value) {
    __getInternalInterface().setFieldValue(PAVEHICLEMODIFIERS_PROP.get(), value);
  }
  ...
  public void setQuickQuoteNumber(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(QUICKQUOTENUMBER_PROP.get(), value);
  }
  ...
  public entity.PersonalVehicle split(java.util.Date splitDate) {
    return (entity.PersonalVehicle)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PersonalVehicleInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PersonalVehicle.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getGarageLocationID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GARAGELOCATION_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getPALineID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(PALINE_PROP.get());
    }
    ...
    public void setGarageLocationID(gw.pl.persistence.core.Key value) {
      setFieldValue(GARAGELOCATION_PROP.get(), value);
    }
    ...
    public void setPALineID(gw.pl.persistence.core.Key value) {
      setFieldValue(PALINE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.contact.AdditionalInterestContainer", "gw.lob.pa.PersonalVehicleAdditionalInterestContainerCoverableModifiableAdapter");
    config.put("gw.api.copier.EffDatedCopyable", "gw.lob.pa.PersonalVehicleEffDatedCopier");
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.pa.PersonalVehicleAdditionalInterestContainerCoverableModifiableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.pa.PersonalVehicleAdditionalInterestContainerCoverableModifiableAdapter");
    config.put("gw.api.domain.ModifiableAdapter", "gw.lob.pa.PersonalVehicleAdditionalInterestContainerCoverableModifiableAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.pa.PersonalVehicleMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.pa.PersonalVehicleMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PersonalVehicle.class, config);
    com.guidewire._generated.entity.PersonalVehicleInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PersonalVehicle, com.guidewire._generated.entity.PersonalVehicleInternal>() {
      public java.lang.Object getImplementation(entity.PersonalVehicle bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PersonalVehicleInternal getInternalInterface(entity.PersonalVehicle bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PersonalVehicle newEmptyInstance() {
        return new entity.PersonalVehicle((java.lang.Void)null);
      }

...
/**
 * PersonalVehicleCov
 * A vehicle-level coverage for Personal Auto
 */
...
@gw.entity.EntityName(value = "PersonalVehicleCov")
public class PersonalVehicleCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PersonalVehicleCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PersonalVehicleCov, entity.PolicyPeriod>("entity.PersonalVehicleCov");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> PERSONALVEHICLE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "PersonalVehicle");
  ...
  private com.guidewire._generated.entity.PersonalVehicleCovInternal _internal;
   ...
   */
  protected PersonalVehicleCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected PersonalVehicleCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected PersonalVehicleCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PersonalVehicleCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PersonalVehicleCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.PersonalVehicleCov clone() {
    return (entity.PersonalVehicleCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.PersonalVehicleCov getBasedOn() {
    return (entity.PersonalVehicleCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PersonalVehicleCov getBasedOnValue() {
    return (entity.PersonalVehicleCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.PersonalVehicleCovCost[] getCosts() {
    return (entity.PersonalVehicleCovCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
  }
  ...
  public entity.PersonalVehicleCov getFixed() {
    return (entity.PersonalVehicleCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.PersonalVehicleCov getSlice(java.util.Date sliceDate) {
    return (entity.PersonalVehicleCov)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.PersonalVehicleCov getSubtype() {
    return (typekey.PersonalVehicleCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.PersonalVehicleCov getUnsliced() {
    return (entity.PersonalVehicleCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.PersonalVehicleCovVersionList getVersionList() {
    return (entity.windowed.PersonalVehicleCovVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.PersonalVehicleCov value) {
   ...
   */
  private void setFixed(entity.PersonalVehicleCov value) {
   ...
   */
  private void setSubtype(typekey.PersonalVehicleCov value) {
  ...
  public entity.PersonalVehicleCov split(java.util.Date splitDate) {
    return (entity.PersonalVehicleCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PersonalVehicleCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PersonalVehicleCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.pa.PersonalVehicleCovCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.pa.PersonalVehicleCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.pa.PersonalVehicleCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.pa.PersonalVehicleCovCoverageAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.pa.PersonalVehicleCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.pa.PersonalVehicleCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PersonalVehicleCov.class, config);
    com.guidewire._generated.entity.PersonalVehicleCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PersonalVehicleCov, com.guidewire._generated.entity.PersonalVehicleCovInternal>() {
      public java.lang.Object getImplementation(entity.PersonalVehicleCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PersonalVehicleCovInternal getInternalInterface(entity.PersonalVehicleCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PersonalVehicleCov newEmptyInstance() {
        return new entity.PersonalVehicleCov((java.lang.Void)null);
      }

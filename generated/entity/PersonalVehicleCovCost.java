 ...
 * A taxable unit of price for a period of time, not to be broken up any further, for a Personal Auto vehicle coverage
 */
...
@gw.entity.EntityName(value = "PersonalVehicleCovCost")
public class PersonalVehicleCovCost extends entity.PACoveragePremium implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PersonalVehicleCovCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PersonalVehicleCovCost, entity.PolicyPeriod>("entity.PersonalVehicleCovCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> PERSONALVEHICLECOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "PersonalVehicleCov");
   ...
   */
  public PersonalVehicleCovCost(entity.PolicyPeriod branch)  {
   ...
   */
  public PersonalVehicleCovCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PersonalVehicleCovCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PersonalVehicleCovCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PersonalVehicleCovCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PersonalVehicleCovCostInternal)super.__getInternalInterface();
  }
  
  public entity.PersonalVehicleCovCost clone() {
    return (entity.PersonalVehicleCovCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.PersonalVehicleCovCost getBasedOn() {
    return (entity.PersonalVehicleCovCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PersonalVehicleCov getPersonalVehicleCov() {
    return (entity.PersonalVehicleCov)__getInternalInterface().getFieldValue(PERSONALVEHICLECOV_PROP.get());
  }
  
  public entity.PersonalVehicleCovCost getSlice(java.util.Date sliceDate) {
    return (entity.PersonalVehicleCovCost)getSliceUntyped(sliceDate);
  }
  
  public entity.PersonalVehicleCovCost getUnsliced() {
    return (entity.PersonalVehicleCovCost)getUnslicedUntyped();
  }
  
  public entity.windowed.PersonalVehicleCovCostVersionList getVersionList() {
    return (entity.windowed.PersonalVehicleCovCostVersionList)getVersionListUntyped();
  }
  ...
  public void setPersonalVehicleCov(entity.PersonalVehicleCov value) {
    __getInternalInterface().setFieldValue(PERSONALVEHICLECOV_PROP.get(), value);
  }
  
  public entity.PersonalVehicleCovCost split(java.util.Date splitDate) {
    return (entity.PersonalVehicleCovCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PersonalVehicleCovCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PersonalVehicleCovCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getPersonalVehicleCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(PERSONALVEHICLECOV_PROP.get());
    }
    ...
    public void setPersonalVehicleCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(PERSONALVEHICLECOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.pa.financials.PACostMethods", "gw.lob.pa.financials.PersonalVehicleCovCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PersonalVehicleCovCost.class, config);
    com.guidewire._generated.entity.PersonalVehicleCovCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PersonalVehicleCovCost, com.guidewire._generated.entity.PersonalVehicleCovCostInternal>() {
      public java.lang.Object getImplementation(entity.PersonalVehicleCovCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PersonalVehicleCovCostInternal getInternalInterface(entity.PersonalVehicleCovCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PersonalVehicleCovCost newEmptyInstance() {
        return new entity.PersonalVehicleCovCost((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "PolicyAddlInsured")
public class PolicyAddlInsured extends entity.PolicyContactRole implements gw.api.copier.EffDatedCopyable, gw.api.domain.account.Mergeable, gw.api.effdate.UniqueOnPolicyPeriod, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PolicyAddlInsured, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PolicyAddlInsured, entity.PolicyPeriod>("entity.PolicyAddlInsured");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> POLICYADDITIONALINSUREDDETAILS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "PolicyAdditionalInsuredDetails");
   ...
   */
  public PolicyAddlInsured(entity.PolicyPeriod branch)  {
   ...
   */
  public PolicyAddlInsured(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PolicyAddlInsured(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PolicyAddlInsuredInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PolicyAddlInsuredInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PolicyAddlInsuredInternal)super.__getInternalInterface();
  }
  ...
  public void addToPolicyAdditionalInsuredDetails(entity.PolicyAddlInsuredDetail element) {
    __getInternalInterface().addArrayElement(POLICYADDITIONALINSUREDDETAILS_PROP.get(), element);
  }
  
  public entity.PolicyAddlInsured clone() {
    return (entity.PolicyAddlInsured)__getInternalInterface().cloneUntyped();
  }
  
  public entity.PolicyAddlInsured getBasedOn() {
    return (entity.PolicyAddlInsured)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PolicyAddlInsuredDetail[] getPolicyAdditionalInsuredDetails() {
    return (entity.PolicyAddlInsuredDetail[])__getInternalInterface().getFieldValue(POLICYADDITIONALINSUREDDETAILS_PROP.get());
  }
  ...
  public entity.PolicyAddlInsured getSlice(java.util.Date sliceDate) {
    return (entity.PolicyAddlInsured)getSliceUntyped(sliceDate);
  }
  
  public entity.PolicyAddlInsured getUnsliced() {
    return (entity.PolicyAddlInsured)getUnslicedUntyped();
  }
  
  public entity.windowed.PolicyAddlInsuredVersionList getVersionList() {
    return (entity.windowed.PolicyAddlInsuredVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromPolicyAdditionalInsuredDetails(entity.PolicyAddlInsuredDetail element) {
    __getInternalInterface().removeArrayElement(POLICYADDITIONALINSUREDDETAILS_PROP.get(), element);
  }
  ...
  public void removeFromPolicyAdditionalInsuredDetails(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(POLICYADDITIONALINSUREDDETAILS_PROP.get(), elementID);
  }
  ...
  public void setPolicyAdditionalInsuredDetails(entity.PolicyAddlInsuredDetail[] value) {
    __getInternalInterface().setFieldValue(POLICYADDITIONALINSUREDDETAILS_PROP.get(), value);
  }
  ...
  public entity.PolicyAddlInsured split(java.util.Date splitDate) {
    return (entity.PolicyAddlInsured)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicyAddlInsuredInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PolicyAddlInsured.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.copier.EffDatedCopyable", "gw.contact.PolicyAddlInsuredCopier");
    ...
    config.put("gw.api.domain.account.AccountSyncable", "gw.contact.PolicyContactRoleAccountSyncableImpl");
    config.put("gw.api.domain.account.Mergeable", "gw.contact.PolicyAddlInsuredMergeableImpl");
    config.put("gw.api.effdate.UniqueOnPolicyPeriod", "gw.api.effdate.PolicyAddlInsuredUniqueKeyGen");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.contact.PolicyAddlInsuredMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.contact.PolicyAddlInsuredMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PolicyAddlInsured.class, config);
    com.guidewire._generated.entity.PolicyAddlInsuredInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PolicyAddlInsured, com.guidewire._generated.entity.PolicyAddlInsuredInternal>() {
      public java.lang.Object getImplementation(entity.PolicyAddlInsured bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PolicyAddlInsuredInternal getInternalInterface(entity.PolicyAddlInsured bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PolicyAddlInsured newEmptyInstance() {
        return new entity.PolicyAddlInsured((java.lang.Void)null);
      }

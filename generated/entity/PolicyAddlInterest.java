 ...
 * PolicyAddlInterest
 * 
 *     A person or company with a financial interest in an object (e.g., building,
 *     vehicle, piece of equipment) protected by the policy.
 * 
 *   
 */
...
@gw.entity.EntityName(value = "PolicyAddlInterest")
public class PolicyAddlInterest extends entity.PolicyContactRole implements gw.api.domain.account.Mergeable {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PolicyAddlInterest, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PolicyAddlInterest, entity.PolicyPeriod>("entity.PolicyAddlInterest");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> ADDITIONALINTERESTDETAILS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "AdditionalInterestDetails");
   ...
   */
  public PolicyAddlInterest(entity.PolicyPeriod branch)  {
   ...
   */
  public PolicyAddlInterest(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PolicyAddlInterest(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PolicyAddlInterestInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PolicyAddlInterestInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PolicyAddlInterestInternal)super.__getInternalInterface();
  }
  ...
  public void addToAdditionalInterestDetails(entity.AddlInterestDetail element) {
    __getInternalInterface().addArrayElement(ADDITIONALINTERESTDETAILS_PROP.get(), element);
  }
  
  public entity.PolicyAddlInterest clone() {
    return (entity.PolicyAddlInterest)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.AddlInterestDetail[] getAdditionalInterestDetails() {
    return (entity.AddlInterestDetail[])__getInternalInterface().getFieldValue(ADDITIONALINTERESTDETAILS_PROP.get());
  }
  
  public entity.PolicyAddlInterest getBasedOn() {
    return (entity.PolicyAddlInterest)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PolicyAddlInterest getSlice(java.util.Date sliceDate) {
    return (entity.PolicyAddlInterest)getSliceUntyped(sliceDate);
  }
  
  public entity.PolicyAddlInterest getUnsliced() {
    return (entity.PolicyAddlInterest)getUnslicedUntyped();
  }
  
  public entity.windowed.PolicyAddlInterestVersionList getVersionList() {
    return (entity.windowed.PolicyAddlInterestVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromAdditionalInterestDetails(entity.AddlInterestDetail element) {
    __getInternalInterface().removeArrayElement(ADDITIONALINTERESTDETAILS_PROP.get(), element);
  }
  ...
  public void removeFromAdditionalInterestDetails(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(ADDITIONALINTERESTDETAILS_PROP.get(), elementID);
  }
  ...
  public void setAdditionalInterestDetails(entity.AddlInterestDetail[] value) {
    __getInternalInterface().setFieldValue(ADDITIONALINTERESTDETAILS_PROP.get(), value);
  }
  
  public entity.PolicyAddlInterest split(java.util.Date splitDate) {
    return (entity.PolicyAddlInterest)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicyAddlInterestInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PolicyAddlInterest.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.copier.EffDatedCopyable", "gw.contact.PolicyContactRoleCopier");
    ...
    config.put("gw.api.domain.account.Mergeable", "gw.contact.PolicyAddlInterestMergeableImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PolicyAddlInterest.class, config);
    com.guidewire._generated.entity.PolicyAddlInterestInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PolicyAddlInterest, com.guidewire._generated.entity.PolicyAddlInterestInternal>() {
      public java.lang.Object getImplementation(entity.PolicyAddlInterest bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PolicyAddlInterestInternal getInternalInterface(entity.PolicyAddlInterest bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PolicyAddlInterest newEmptyInstance() {
        return new entity.PolicyAddlInterest((java.lang.Void)null);
      }

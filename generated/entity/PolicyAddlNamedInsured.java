 ...
 *     Out of the box, the additional named insured role is used in all lines except Personal Auto.
 *   
 */
...
@gw.entity.EntityName(value = "PolicyAddlNamedInsured")
public class PolicyAddlNamedInsured extends entity.PlcyNonPriNamedInsured {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PolicyAddlNamedInsured, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PolicyAddlNamedInsured, entity.PolicyPeriod>("entity.PolicyAddlNamedInsured");
   ...
   */
  public PolicyAddlNamedInsured(entity.PolicyPeriod branch)  {
   ...
   */
  public PolicyAddlNamedInsured(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PolicyAddlNamedInsured(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PolicyAddlNamedInsuredInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PolicyAddlNamedInsuredInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PolicyAddlNamedInsuredInternal)super.__getInternalInterface();
  }
  
  public entity.PolicyAddlNamedInsured clone() {
    return (entity.PolicyAddlNamedInsured)__getInternalInterface().cloneUntyped();
  }
  
  public entity.PolicyAddlNamedInsured getBasedOn() {
    return (entity.PolicyAddlNamedInsured)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PolicyAddlNamedInsured getSlice(java.util.Date sliceDate) {
    return (entity.PolicyAddlNamedInsured)getSliceUntyped(sliceDate);
  }
  
  public entity.PolicyAddlNamedInsured getUnsliced() {
    return (entity.PolicyAddlNamedInsured)getUnslicedUntyped();
  }
  
  public entity.windowed.PolicyAddlNamedInsuredVersionList getVersionList() {
    return (entity.windowed.PolicyAddlNamedInsuredVersionList)getVersionListUntyped();
  }
  
  public entity.PolicyAddlNamedInsured split(java.util.Date splitDate) {
    return (entity.PolicyAddlNamedInsured)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicyAddlNamedInsuredInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PolicyAddlNamedInsured.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.contact.PlcyNonPriNamedInsuredPublicMethods", "com.guidewire.pc.domain.contact.impl.PolicyAddlNamedInsuredImpl");
    config.put("com.guidewire.pc.domain.contact.PolicyAddlNamedInsuredPublicMethods", "com.guidewire.pc.domain.contact.impl.PolicyAddlNamedInsuredImpl");
    config.put("com.guidewire.pc.domain.contact.PolicyNamedInsuredPublicMethods", "com.guidewire.pc.domain.contact.impl.PolicyAddlNamedInsuredImpl");
    ...
    config.put("gw.api.domain.account.Mergeable", "gw.contact.PolicyNamedInsuredMergeableImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PolicyAddlNamedInsured.class, config);
    com.guidewire._generated.entity.PolicyAddlNamedInsuredInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PolicyAddlNamedInsured, com.guidewire._generated.entity.PolicyAddlNamedInsuredInternal>() {
      public java.lang.Object getImplementation(entity.PolicyAddlNamedInsured bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PolicyAddlNamedInsuredInternal getInternalInterface(entity.PolicyAddlNamedInsured bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PolicyAddlNamedInsured newEmptyInstance() {
        return new entity.PolicyAddlNamedInsured((java.lang.Void)null);
      }

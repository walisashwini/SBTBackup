...
/**
 * PolicyAddress
 * Policy address specific information.
 */
...
@gw.entity.EntityName(value = "PolicyAddress")
public class PolicyAddress extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.EventAware, gw.api.copier.EffDatedCopyable, gw.api.domain.RefersOutOfDomainGraph, gw.api.domain.account.AccountSyncable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PolicyAddress, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PolicyAddress, entity.PolicyPeriod>("entity.PolicyAddress");
  ...
  private com.guidewire._generated.entity.PolicyAddressInternal _internal;
  ...
  public static final java.lang.String POLICYADDRESSADDED_EVENT = "PolicyAddressAdded";
  
  public static final java.lang.String POLICYADDRESSCHANGED_EVENT = "PolicyAddressChanged";
  
  public static final java.lang.String POLICYADDRESSREMOVED_EVENT = "PolicyAddressRemoved";
  
  /**
   * Constructs a new instance of this entity in the given branch.
   */
  public PolicyAddress(entity.PolicyPeriod branch)  {
   ...
   */
  public PolicyAddress(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PolicyAddress(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PolicyAddressInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PolicyAddressInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.PolicyAddress clone() {
    return (entity.PolicyAddress)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.PolicyAddress getBasedOn() {
    return (entity.PolicyAddress)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PolicyAddress getBasedOnValue() {
    return (entity.PolicyAddress)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.PolicyAddress getFixed() {
    return (entity.PolicyAddress)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.PolicyAddress getSlice(java.util.Date sliceDate) {
    return (entity.PolicyAddress)getSliceUntyped(sliceDate);
  }
  ...
  public entity.PolicyAddress getUnsliced() {
    return (entity.PolicyAddress)getUnslicedUntyped();
  }
  ...
  public entity.windowed.PolicyAddressVersionList getVersionList() {
    return (entity.windowed.PolicyAddressVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setAddress(entity.Address value) {
   ...
   */
  private void setBasedOnValue(entity.PolicyAddress value) {
   ...
   */
  private void setFixed(entity.PolicyAddress value) {
  ...
  public entity.PolicyAddress split(java.util.Date splitDate) {
    return (entity.PolicyAddress)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicyAddressInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PolicyAddress.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.RefersOutOfDomainGraph", "gw.policyaddress.PolicyAddressRefersOutOfDomainGraphImpl");
    config.put("gw.api.domain.account.AccountSyncable", "gw.policyaddress.PolicyAddressAccountSyncableImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.policyaddress.PolicyAddressMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.policyaddress.PolicyAddressMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PolicyAddress.class, config);
    com.guidewire._generated.entity.PolicyAddressInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PolicyAddress, com.guidewire._generated.entity.PolicyAddressInternal>() {
      public java.lang.Object getImplementation(entity.PolicyAddress bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PolicyAddressInternal getInternalInterface(entity.PolicyAddress bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PolicyAddress newEmptyInstance() {
        return new entity.PolicyAddress((java.lang.Void)null);
      }

 ...
 * 
 *     A company (e.g. accounting firm) or person representing an insured entity
 *     who would be the primary source of information to resolve billing issues
 *     for the account or one of its underlying policies.
 * 
 *   
 */
...
@gw.entity.EntityName(value = "PolicyBillingContact")
public class PolicyBillingContact extends entity.PolicyContactRole implements gw.api.domain.account.AccountSyncable, gw.api.domain.account.Mergeable {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PolicyBillingContact, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PolicyBillingContact, entity.PolicyPeriod>("entity.PolicyBillingContact");
   ...
   */
  public PolicyBillingContact(entity.PolicyPeriod branch)  {
   ...
   */
  public PolicyBillingContact(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PolicyBillingContact(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PolicyBillingContactInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PolicyBillingContactInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PolicyBillingContactInternal)super.__getInternalInterface();
  }
  
  public entity.PolicyBillingContact clone() {
    return (entity.PolicyBillingContact)__getInternalInterface().cloneUntyped();
  }
  
  public entity.PolicyBillingContact getBasedOn() {
    return (entity.PolicyBillingContact)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PolicyBillingContact getSlice(java.util.Date sliceDate) {
    return (entity.PolicyBillingContact)getSliceUntyped(sliceDate);
  }
  
  public entity.PolicyBillingContact getUnsliced() {
    return (entity.PolicyBillingContact)getUnslicedUntyped();
  }
  
  public entity.windowed.PolicyBillingContactVersionList getVersionList() {
    return (entity.windowed.PolicyBillingContactVersionList)getVersionListUntyped();
  }
  
  public entity.PolicyBillingContact split(java.util.Date splitDate) {
    return (entity.PolicyBillingContact)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicyBillingContactInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PolicyBillingContact.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.account.AccountSyncable", "gw.contact.PolicyBillingContactAccountSyncableImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PolicyBillingContact.class, config);
    com.guidewire._generated.entity.PolicyBillingContactInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PolicyBillingContact, com.guidewire._generated.entity.PolicyBillingContactInternal>() {
      public java.lang.Object getImplementation(entity.PolicyBillingContact bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PolicyBillingContactInternal getInternalInterface(entity.PolicyBillingContact bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PolicyBillingContact newEmptyInstance() {
        return new entity.PolicyBillingContact((java.lang.Void)null);
      }

 ...
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PolicyChange.eti;PolicyChange.eix;PolicyChange.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PolicyChange")
public class PolicyChange extends entity.Job implements entity.EventAware {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PolicyChange> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PolicyChange>("entity.PolicyChange");
  
  private static final com.guidewire.pl.persistence.code.DelegateMap DELEGATE_MAP;
  
  public static final java.lang.String POLICYCHANGEADDED_EVENT = "PolicyChangeAdded";
  
  public static final java.lang.String POLICYCHANGECHANGED_EVENT = "PolicyChangeChanged";
  
  public static final java.lang.String POLICYCHANGEREMOVED_EVENT = "PolicyChangeRemoved";
   ...
   */
  public PolicyChange(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PolicyChange(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PolicyChangeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PolicyChangeInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PolicyChangeInternal)super.__getInternalInterface();
  }
  
  /**
   * Starts the policy chnage in automatic mode. That is the policy change will try
   * to proceed automatically to completion.
   * @param policy the policy to be changed
   * @param effDate the effDate for the change
   ...
   */
  public void startAutomatic(entity.Policy policy, java.util.Date effDate, entity.User user) throws com.guidewire.pl.web.controller.UserDisplayableException {
    ((com.guidewire.pc.domain.job.PolicyChangePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.PolicyChangePublicMethods")).startAutomatic(policy, effDate, user);
  }
  
  /**
   * Starts a change job on the latest bound period of the passed-in policy that includes the given effective date.
   * @param policy The policy for which the job is to be started
   * @param effDate The date at which the policy change should be started.
   * @throws com.guidewire.pl.web.controller.UserDisplayableException if the job cannot be started
   */
  public void startJob(entity.Policy policy, java.util.Date effDate) throws com.guidewire.pl.web.controller.UserDisplayableException {
    ((com.guidewire.pc.domain.job.PolicyChangePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.PolicyChangePublicMethods")).startJob(policy, effDate);
  }
   ...
   */
  public boolean startJobAndCommit(entity.Policy policy, java.util.Date effDate, pcf.api.Location location) {
    return ((com.guidewire.pc.domain.job.PolicyChangePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.PolicyChangePublicMethods")).startJobAndCommit(policy, effDate, location);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicyChangeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PolicyChange.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.job.JobPublicMethods", "com.guidewire.pc.domain.job.impl.PolicyChangeImpl");
    config.put("com.guidewire.pc.domain.job.PolicyChangePublicMethods", "com.guidewire.pc.domain.job.impl.PolicyChangeImpl");
    config.put("com.guidewire.pc.domain.job.impl.JobInternalMethods", "com.guidewire.pc.domain.job.impl.JobImpl");
    config.put("com.guidewire.pc.domain.note.NoteContainer", "com.guidewire.pc.domain.job.impl.PolicyChangeImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.job.impl.PolicyChangeImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.pc.domain.job.impl.JobImpl");
    config.put("com.guidewire.pl.system.entity.DoesNotValidateOnCommit", "com.guidewire.pc.domain.job.impl.PolicyChangeImpl");
    config.put("gw.api.assignment.UserRoleOwner", "com.guidewire.pc.domain.job.impl.PolicyChangeImpl");
    config.put("gw.api.domain.document.DocumentContainer", "com.guidewire.pc.domain.job.impl.PolicyChangeImpl");
    config.put("gw.api.domain.linkedobject.LinkedObjectContainer", "com.guidewire.pc.domain.job.impl.PolicyChangeImpl");
    config.put("gw.api.history.CustomHistory", "gw.api.history.JobCustomHistoryImpl");
    config.put("gw.api.job.JobMethods", "gw.api.job.PolicyChangeJobMethods");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PolicyChange.class, config);
    com.guidewire._generated.entity.PolicyChangeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PolicyChange, com.guidewire._generated.entity.PolicyChangeInternal>() {
      public java.lang.Object getImplementation(entity.PolicyChange bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PolicyChangeInternal getInternalInterface(entity.PolicyChange bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PolicyChange newEmptyInstance() {
        return new entity.PolicyChange((java.lang.Void)null);
      }

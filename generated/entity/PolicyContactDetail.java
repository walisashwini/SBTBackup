...
@gw.entity.EntityName(value = "PolicyContactDetail")
public class PolicyContactDetail extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, gw.api.copier.EffDatedCopyable, gw.api.domain.account.Mergeable {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PolicyContactDetail, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PolicyContactDetail, entity.PolicyPeriod>("entity.PolicyContactDetail");
  ...
  private com.guidewire._generated.entity.PolicyContactDetailInternal _internal;
   ...
   */
  public PolicyContactDetail(entity.PolicyPeriod branch)  {
   ...
   */
  public PolicyContactDetail(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PolicyContactDetail(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PolicyContactDetailInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PolicyContactDetailInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.PolicyContactDetail clone() {
    return (entity.PolicyContactDetail)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.PolicyContactDetail getBasedOn() {
    return (entity.PolicyContactDetail)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PolicyContactDetail getBasedOnValue() {
    return (entity.PolicyContactDetail)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.PolicyContactDetail getFixed() {
    return (entity.PolicyContactDetail)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.PolicyContactDetail getSlice(java.util.Date sliceDate) {
    return (entity.PolicyContactDetail)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.PolicyContactDetail getSubtype() {
    return (typekey.PolicyContactDetail)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.PolicyContactDetail getUnsliced() {
    return (entity.PolicyContactDetail)getUnslicedUntyped();
  }
  ...
  public entity.windowed.PolicyContactDetailVersionList getVersionList() {
    return (entity.windowed.PolicyContactDetailVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.PolicyContactDetail value) {
   ...
   */
  private void setFixed(entity.PolicyContactDetail value) {
   ...
   */
  private void setSubtype(typekey.PolicyContactDetail value) {
  ...
  public entity.PolicyContactDetail split(java.util.Date splitDate) {
    return (entity.PolicyContactDetail)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicyContactDetailInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PolicyContactDetail.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PolicyContactDetail.class, config);
    com.guidewire._generated.entity.PolicyContactDetailInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PolicyContactDetail, com.guidewire._generated.entity.PolicyContactDetailInternal>() {
      public java.lang.Object getImplementation(entity.PolicyContactDetail bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PolicyContactDetailInternal getInternalInterface(entity.PolicyContactDetail bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PolicyContactDetail newEmptyInstance() {
        return new entity.PolicyContactDetail((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "PolicyException")
public class PolicyException extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable, entity.Extractable, entity.FrozenSetMember {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PolicyException> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PolicyException>("entity.PolicyException");
  ...
  private com.guidewire._generated.entity.PolicyExceptionInternal _internal;
   ...
   */
  public PolicyException(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PolicyException(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PolicyExceptionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PolicyExceptionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicyExceptionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PolicyException.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.pc.policy.period.entity.PolicyException", "com.guidewire.pc.domain.policy.period.impl.PolicyExceptionImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PolicyException.class, config);
    com.guidewire._generated.entity.PolicyExceptionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PolicyException, com.guidewire._generated.entity.PolicyExceptionInternal>() {
      public java.lang.Object getImplementation(entity.PolicyException bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PolicyExceptionInternal getInternalInterface(entity.PolicyException bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PolicyException newEmptyInstance() {
        return new entity.PolicyException((java.lang.Void)null);
      }

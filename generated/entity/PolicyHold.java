...
/**
 * PolicyHold
 * Policy hold definition (rules, regions, etc.)
 */
...
@gw.entity.EntityName(value = "PolicyHold")
public class PolicyHold extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PolicyHold> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PolicyHold>("entity.PolicyHold");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> HELDJOBS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "HeldJobs");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> HOLDTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "HoldType");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> POLICYHOLDCODE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PolicyHoldCode");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> POLICYHOLDZONES_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "PolicyHoldZones");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> UWISSUELONGDESC_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "UWIssueLongDesc");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> UWISSUELONGDESC_L10N_ARRAY_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "UWIssueLongDesc_L10N_ARRAY");
  ...
  private com.guidewire._generated.entity.PolicyHoldInternal _internal;
  
  private static final com.guidewire.pl.persistence.code.DelegateMap DELEGATE_MAP;
  
  public static final gw.pl.persistence.type.DynamicEntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> RETIRED_DYNPROP = com.guidewire.pl.domain.persistence.core.RetireablePublicMethods.RETIRED_DYNPROP;
  
  public static final gw.api.domain.policyhold.PublicPolicyHoldFinder finder = gw.pc.policyhold.entity.PolicyHold.finder;
   ...
   */
  public PolicyHold(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PolicyHold(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PolicyHoldInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PolicyHoldInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToHeldJobs(entity.PolicyHoldJob element) {
    __getInternalInterface().addArrayElement(HELDJOBS_PROP.get(), element);
  }
  ...
  public void addToPolicyHoldZones(entity.PolicyHoldZone element) {
    __getInternalInterface().addArrayElement(POLICYHOLDZONES_PROP.get(), element);
  }
  ...
  public entity.PolicyHold_Description_L10N[] getDescription_L10N_ARRAY() {
    return (entity.PolicyHold_Description_L10N[])__getInternalInterface().getFieldValue(DESCRIPTION_L10N_ARRAY_PROP.get());
  }
  ...
  public entity.PolicyHoldJob[] getHeldJobs() {
    return (entity.PolicyHoldJob[])__getInternalInterface().getFieldValue(HELDJOBS_PROP.get());
  }
  ...
  public typekey.UWIssueCheckingSet getHoldType() {
    return (typekey.UWIssueCheckingSet)__getInternalInterface().getFieldValue(HOLDTYPE_PROP.get());
  }
  ...
  public java.lang.String getPolicyHoldCode() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(POLICYHOLDCODE_PROP.get());
  }
  ...
  public entity.PolicyHoldZone[] getPolicyHoldZones() {
    return (entity.PolicyHoldZone[])__getInternalInterface().getFieldValue(POLICYHOLDZONES_PROP.get());
  }
  ...
  public entity.PolicyHoldRule[] getRules() {
    return (entity.PolicyHoldRule[])__getInternalInterface().getFieldValue(RULES_PROP.get());
  }
  ...
  public java.lang.String getUWIssueLongDesc() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(UWISSUELONGDESC_PROP.get());
  }
  ...
  public entity.PolicyHold_UWIssueLongDesc_L10N[] getUWIssueLongDesc_L10N_ARRAY() {
    return (entity.PolicyHold_UWIssueLongDesc_L10N[])__getInternalInterface().getFieldValue(UWISSUELONGDESC_L10N_ARRAY_PROP.get());
  }
  
  /**
   * Array association accessor for key en_US on array UWIssueLongDesc_L10N_ARRAY
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getUWIssueLongDesc_en_US() {
    return (java.lang.String)__getInternalInterface().getLocalizedFieldValueForCodeGen((com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo)TYPE.get().getTypeInfo().getProperty("UWIssueLongDesc_en_US"));
  }
  ...
  public void removeFromHeldJobs(entity.PolicyHoldJob element) {
    __getInternalInterface().removeArrayElement(HELDJOBS_PROP.get(), element);
  }
  ...
  public void removeFromHeldJobs(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(HELDJOBS_PROP.get(), elementID);
  }
  ...
  public void removeFromPolicyHoldZones(entity.PolicyHoldZone element) {
    __getInternalInterface().removeArrayElement(POLICYHOLDZONES_PROP.get(), element);
  }
  ...
  public void removeFromPolicyHoldZones(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(POLICYHOLDZONES_PROP.get(), elementID);
  }
   ...
   */
  private void setDescription_L10N_ARRAY(entity.PolicyHold_Description_L10N[] value) {
  ...
  public void setHeldJobs(entity.PolicyHoldJob[] value) {
    __getInternalInterface().setFieldValue(HELDJOBS_PROP.get(), value);
  }
  ...
  public void setHoldType(typekey.UWIssueCheckingSet value) {
    __getInternalInterface().setFieldValue(HOLDTYPE_PROP.get(), value);
  }
  ...
  public void setPolicyHoldCode(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(POLICYHOLDCODE_PROP.get(), value);
  }
  ...
  public void setPolicyHoldZones(entity.PolicyHoldZone[] value) {
    __getInternalInterface().setFieldValue(POLICYHOLDZONES_PROP.get(), value);
  }
  ...
  public void setUWIssueLongDesc(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(UWISSUELONGDESC_PROP.get(), value);
  }
  
  /**
   * Sets the value of the UWIssueLongDesc_L10N_ARRAY field.
   */
  private void setUWIssueLongDesc_L10N_ARRAY(entity.PolicyHold_UWIssueLongDesc_L10N[] value) {
    __getInternalInterface().setFieldValue(UWISSUELONGDESC_L10N_ARRAY_PROP.get(), value);
  }
  
  /**
   * Array association mutator for key UWIssueLongDesc_ on array UWIssueLongDesc_L10N_ARRAY
   */
  public void setUWIssueLongDesc_en_US(java.lang.String value) {
    __getInternalInterface().setLocalizedFieldValueForCodeGen((com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo)TYPE.get().getTypeInfo().getProperty("UWIssueLongDesc_en_US"), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicyHoldInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PolicyHold.this.__getDelegateManager();
    }
    ...
    public void addToUWIssueLongDesc_L10N_ARRAY(entity.PolicyHold_UWIssueLongDesc_L10N element) {
      __getInternalInterface().addArrayElement(UWISSUELONGDESC_L10N_ARRAY_PROP.get(), element);
    }
    ...
    public entity.PolicyHold_Description_L10N getDescription_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.PolicyHold_Description_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
    ...
    public entity.PolicyHold_UWIssueLongDesc_L10N getUWIssueLongDesc_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.PolicyHold_UWIssueLongDesc_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
    ...
    public void removeFromUWIssueLongDesc_L10N_ARRAY(entity.PolicyHold_UWIssueLongDesc_L10N element) {
      __getInternalInterface().removeArrayElement(UWISSUELONGDESC_L10N_ARRAY_PROP.get(), element);
    }
    ...
    public void removeFromUWIssueLongDesc_L10N_ARRAY(gw.pl.persistence.core.Key elementID) {
      __getInternalInterface().removeArrayElement(UWISSUELONGDESC_L10N_ARRAY_PROP.get(), elementID);
    }
  ...
  static {
    ...
    config.put("gw.pc.policyhold.entity.PolicyHold", "com.guidewire.pc.domain.policyhold.impl.PolicyHoldImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PolicyHold.class, config);
    com.guidewire._generated.entity.PolicyHoldInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PolicyHold, com.guidewire._generated.entity.PolicyHoldInternal>() {
      public java.lang.Object getImplementation(entity.PolicyHold bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PolicyHoldInternal getInternalInterface(entity.PolicyHold bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PolicyHold newEmptyInstance() {
        return new entity.PolicyHold((java.lang.Void)null);
      }

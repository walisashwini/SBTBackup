...
/**
 * PolicyHoldJob
 * Contains a policy hold and job pair, indicating the last time the job was evaluated against the policy hold.
 */
...
@gw.entity.EntityName(value = "PolicyHoldJob")
public class PolicyHoldJob extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable, entity.Extractable, entity.FrozenSetMember {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PolicyHoldJob> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PolicyHoldJob>("entity.PolicyHoldJob");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LASTEVALTIME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LastEvalTime");
  ...
  private com.guidewire._generated.entity.PolicyHoldJobInternal _internal;
   ...
   */
  public PolicyHoldJob(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PolicyHoldJob(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PolicyHoldJobInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PolicyHoldJobInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.util.Date getLastEvalTime() {
    return (java.util.Date)__getInternalInterface().getFieldValue(LASTEVALTIME_PROP.get());
  }
  ...
  public void setLastEvalTime(java.util.Date value) {
    __getInternalInterface().setFieldValue(LASTEVALTIME_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicyHoldJobInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PolicyHoldJob.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PolicyHoldJob.class, config);
    com.guidewire._generated.entity.PolicyHoldJobInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PolicyHoldJob, com.guidewire._generated.entity.PolicyHoldJobInternal>() {
      public java.lang.Object getImplementation(entity.PolicyHoldJob bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PolicyHoldJobInternal getInternalInterface(entity.PolicyHoldJob bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PolicyHoldJob newEmptyInstance() {
        return new entity.PolicyHoldJob((java.lang.Void)null);
      }

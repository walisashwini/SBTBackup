 ...
 * PolicyLaborClient
 * 
 *     The third party labor contractor or professional employee organization
 *     (PEO) that staffs an insured entity with long-term workers.
 * 
 *   
 */
...
@gw.entity.EntityName(value = "PolicyLaborClient")
public class PolicyLaborClient extends entity.WCLaborContact {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PolicyLaborClient, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PolicyLaborClient, entity.PolicyPeriod>("entity.PolicyLaborClient");
   ...
   */
  public PolicyLaborClient(entity.PolicyPeriod branch)  {
   ...
   */
  public PolicyLaborClient(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PolicyLaborClient(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PolicyLaborClientInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PolicyLaborClientInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PolicyLaborClientInternal)super.__getInternalInterface();
  }
  
  public entity.PolicyLaborClient clone() {
    return (entity.PolicyLaborClient)__getInternalInterface().cloneUntyped();
  }
  
  public entity.PolicyLaborClient getBasedOn() {
    return (entity.PolicyLaborClient)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PolicyLaborClient getSlice(java.util.Date sliceDate) {
    return (entity.PolicyLaborClient)getSliceUntyped(sliceDate);
  }
  
  public entity.PolicyLaborClient getUnsliced() {
    return (entity.PolicyLaborClient)getUnslicedUntyped();
  }
  
  public entity.windowed.PolicyLaborClientVersionList getVersionList() {
    return (entity.windowed.PolicyLaborClientVersionList)getVersionListUntyped();
  }
  
  public entity.PolicyLaborClient split(java.util.Date splitDate) {
    return (entity.PolicyLaborClient)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicyLaborClientInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PolicyLaborClient.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PolicyLaborClient.class, config);
    com.guidewire._generated.entity.PolicyLaborClientInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PolicyLaborClient, com.guidewire._generated.entity.PolicyLaborClientInternal>() {
      public java.lang.Object getImplementation(entity.PolicyLaborClient bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PolicyLaborClientInternal getInternalInterface(entity.PolicyLaborClient bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PolicyLaborClient newEmptyInstance() {
        return new entity.PolicyLaborClient((java.lang.Void)null);
      }

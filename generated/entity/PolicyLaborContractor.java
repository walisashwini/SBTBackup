 ...
 * 
 *     The insured entity that provides employees on a long term basis to work
 *     at/for a third party business entity.
 * 
 *   
 */
...
@gw.entity.EntityName(value = "PolicyLaborContractor")
public class PolicyLaborContractor extends entity.WCLaborContact {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PolicyLaborContractor, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PolicyLaborContractor, entity.PolicyPeriod>("entity.PolicyLaborContractor");
   ...
   */
  public PolicyLaborContractor(entity.PolicyPeriod branch)  {
   ...
   */
  public PolicyLaborContractor(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PolicyLaborContractor(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PolicyLaborContractorInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PolicyLaborContractorInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PolicyLaborContractorInternal)super.__getInternalInterface();
  }
  
  public entity.PolicyLaborContractor clone() {
    return (entity.PolicyLaborContractor)__getInternalInterface().cloneUntyped();
  }
  
  public entity.PolicyLaborContractor getBasedOn() {
    return (entity.PolicyLaborContractor)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PolicyLaborContractor getSlice(java.util.Date sliceDate) {
    return (entity.PolicyLaborContractor)getSliceUntyped(sliceDate);
  }
  
  public entity.PolicyLaborContractor getUnsliced() {
    return (entity.PolicyLaborContractor)getUnslicedUntyped();
  }
  
  public entity.windowed.PolicyLaborContractorVersionList getVersionList() {
    return (entity.windowed.PolicyLaborContractorVersionList)getVersionListUntyped();
  }
  
  public entity.PolicyLaborContractor split(java.util.Date splitDate) {
    return (entity.PolicyLaborContractor)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicyLaborContractorInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PolicyLaborContractor.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.account.Mergeable", "gw.contact.WCLaborContactMergeableImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PolicyLaborContractor.class, config);
    com.guidewire._generated.entity.PolicyLaborContractorInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PolicyLaborContractor, com.guidewire._generated.entity.PolicyLaborContractorInternal>() {
      public java.lang.Object getImplementation(entity.PolicyLaborContractor bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PolicyLaborContractorInternal getInternalInterface(entity.PolicyLaborContractor bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PolicyLaborContractor newEmptyInstance() {
        return new entity.PolicyLaborContractor((java.lang.Void)null);
      }

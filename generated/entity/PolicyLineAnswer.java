...
/**
 * PolicyLineAnswer
 * A merge table linking answers to a specific policyline. Specific to PolicyCenter.
 */
...
@gw.entity.EntityName(value = "PolicyLineAnswer")
public class PolicyLineAnswer extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.PCAnswerDelegate, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PolicyLineAnswer, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PolicyLineAnswer, entity.PolicyPeriod>("entity.PolicyLineAnswer");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CHOICEANSWERCODE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ChoiceAnswerCode");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> QUESTIONCODE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "QuestionCode");
  ...
  private com.guidewire._generated.entity.PolicyLineAnswerInternal _internal;
   ...
   */
  public PolicyLineAnswer(entity.PolicyPeriod branch)  {
   ...
   */
  public PolicyLineAnswer(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PolicyLineAnswer(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PolicyLineAnswerInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PolicyLineAnswerInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.PolicyLineAnswer clone() {
    return (entity.PolicyLineAnswer)__getInternalInterface().cloneUntyped();
  }
  ...
  public java.lang.Object getAnswerValue() {
    return ((com.guidewire.pc.domain.question.PCAnswerDelegatePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.question.PCAnswerDelegatePublicMethods")).getAnswerValue();
  }
  ...
  public entity.PolicyLineAnswer getBasedOn() {
    return (entity.PolicyLineAnswer)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PolicyLineAnswer getBasedOnValue() {
    return (entity.PolicyLineAnswer)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public gw.api.productmodel.QuestionChoice getChoiceAnswer() {
    return ((com.guidewire.pc.domain.question.PCAnswerDelegatePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.question.PCAnswerDelegatePublicMethods")).getChoiceAnswer();
  }
  ...
  public java.lang.String getChoiceAnswerCode() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CHOICEANSWERCODE_PROP.get());
  }
  ...
  public entity.PolicyLineAnswer getFixed() {
    return (entity.PolicyLineAnswer)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public gw.api.productmodel.Question getQuestion() {
    return ((com.guidewire.pc.domain.question.PCAnswerDelegatePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.question.PCAnswerDelegatePublicMethods")).getQuestion();
  }
  ...
  public java.lang.String getQuestionCode() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(QUESTIONCODE_PROP.get());
  }
  
  public entity.PolicyLineAnswer getSlice(java.util.Date sliceDate) {
    return (entity.PolicyLineAnswer)getSliceUntyped(sliceDate);
  }
  ...
  public entity.PolicyLineAnswer getUnsliced() {
    return (entity.PolicyLineAnswer)getUnslicedUntyped();
  }
  ...
  public entity.windowed.PolicyLineAnswerVersionList getVersionList() {
    return (entity.windowed.PolicyLineAnswerVersionList)getVersionListUntyped();
  }
  ...
  public void setAnswerValue(java.lang.Object value) {
    ((com.guidewire.pc.domain.question.PCAnswerDelegatePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.question.PCAnswerDelegatePublicMethods")).setAnswerValue(value);
  }
   ...
   */
  private void setBasedOnValue(entity.PolicyLineAnswer value) {
  ...
  public void setBooleanAnswer(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(BOOLEANANSWER_PROP.get(), value);
  }
  ...
  public void setChoiceAnswer(gw.api.productmodel.QuestionChoice choice) {
    ((com.guidewire.pc.domain.question.PCAnswerDelegatePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.question.PCAnswerDelegatePublicMethods")).setChoiceAnswer(choice);
  }
  ...
  public void setChoiceAnswerCode(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CHOICEANSWERCODE_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.PolicyLineAnswer value) {
  ...
  public void setQuestion(gw.api.productmodel.Question question) {
    ((com.guidewire.pc.domain.question.PCAnswerDelegatePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.question.PCAnswerDelegatePublicMethods")).setQuestion(question);
  }
  ...
  public void setQuestionCode(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(QUESTIONCODE_PROP.get(), value);
  }
  ...
  public void setTextAnswer(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(TEXTANSWER_PROP.get(), value);
  }
  ...
  public entity.PolicyLineAnswer split(java.util.Date splitDate) {
    return (entity.PolicyLineAnswer)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicyLineAnswerInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PolicyLineAnswer.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.question.PCAnswerDelegatePublicMethods", "com.guidewire.pc.domain.question.impl.PCAnswerDelegateImpl");
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.question.PolicyLineAnswerMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.question.PolicyLineAnswerMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PolicyLineAnswer.class, config);
    com.guidewire._generated.entity.PolicyLineAnswerInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PolicyLineAnswer, com.guidewire._generated.entity.PolicyLineAnswerInternal>() {
      public java.lang.Object getImplementation(entity.PolicyLineAnswer bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PolicyLineAnswerInternal getInternalInterface(entity.PolicyLineAnswer bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PolicyLineAnswer newEmptyInstance() {
        return new entity.PolicyLineAnswer((java.lang.Void)null);
      }

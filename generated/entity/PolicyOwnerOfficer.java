...
@gw.entity.EntityName(value = "PolicyOwnerOfficer")
public class PolicyOwnerOfficer extends entity.WCPolicyContactRole implements gw.api.copier.EffDatedCopyable, gw.api.domain.account.AccountSyncable {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PolicyOwnerOfficer, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PolicyOwnerOfficer, entity.PolicyPeriod>("entity.PolicyOwnerOfficer");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> INCLUDED_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "Included");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> OWNERSHIPPCT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "OwnershipPct");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> RELATIONSHIPTITLEINTERNAL_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "RelationshipTitleInternal");
   ...
   */
  public PolicyOwnerOfficer(entity.PolicyPeriod branch)  {
   ...
   */
  public PolicyOwnerOfficer(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PolicyOwnerOfficer(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PolicyOwnerOfficerInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PolicyOwnerOfficerInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PolicyOwnerOfficerInternal)super.__getInternalInterface();
  }
  
  public entity.PolicyOwnerOfficer clone() {
    return (entity.PolicyOwnerOfficer)__getInternalInterface().cloneUntyped();
  }
  
  public entity.PolicyOwnerOfficer getBasedOn() {
    return (entity.PolicyOwnerOfficer)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.WCClassCode getClassCode() {
    return (entity.WCClassCode)__getInternalInterface().getFieldValue(CLASSCODE_PROP.get());
  }
  ...
  public typekey.Inclusion getIncluded() {
    return (typekey.Inclusion)__getInternalInterface().getFieldValue(INCLUDED_PROP.get());
  }
  ...
  public java.lang.Integer getOwnershipPct() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(OWNERSHIPPCT_PROP.get());
  }
  ...
  public typekey.Relationship getRelationshipTitleInternal() {
    return (typekey.Relationship)__getInternalInterface().getFieldValue(RELATIONSHIPTITLEINTERNAL_PROP.get());
  }
  
  public entity.PolicyOwnerOfficer getSlice(java.util.Date sliceDate) {
    return (entity.PolicyOwnerOfficer)getSliceUntyped(sliceDate);
  }
  ...
  public entity.PolicyOwnerOfficer getUnsliced() {
    return (entity.PolicyOwnerOfficer)getUnslicedUntyped();
  }
  
  public entity.windowed.PolicyOwnerOfficerVersionList getVersionList() {
    return (entity.windowed.PolicyOwnerOfficerVersionList)getVersionListUntyped();
  }
  ...
  public void setIncluded(typekey.Inclusion value) {
    __getInternalInterface().setFieldValue(INCLUDED_PROP.get(), value);
  }
  ...
  public void setOwnershipPct(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(OWNERSHIPPCT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the RelationshipTitleInternal field.
   */
  private void setRelationshipTitleInternal(typekey.Relationship value) {
    __getInternalInterface().setFieldValue(RELATIONSHIPTITLEINTERNAL_PROP.get(), value);
  }
  ...
  public entity.PolicyOwnerOfficer split(java.util.Date splitDate) {
    return (entity.PolicyOwnerOfficer)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicyOwnerOfficerInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PolicyOwnerOfficer.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.copier.EffDatedCopyable", "gw.lob.wc.contact.PolicyOwnerOfficerCopier");
    ...
    config.put("gw.api.domain.account.AccountSyncable", "gw.lob.wc.contact.PolicyOwnerOfficerAccountSyncableImpl");
    config.put("gw.api.domain.account.Mergeable", "gw.contact.PolicyContactRoleMergeableImpl");
    config.put("gw.api.effdate.UniqueOnPolicyPeriod", "gw.api.effdate.PolicyContactRoleUniqueKeyGen");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.contact.PolicyContactRoleMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.contact.PolicyContactRoleMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PolicyOwnerOfficer.class, config);
    com.guidewire._generated.entity.PolicyOwnerOfficerInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PolicyOwnerOfficer, com.guidewire._generated.entity.PolicyOwnerOfficerInternal>() {
      public java.lang.Object getImplementation(entity.PolicyOwnerOfficer bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PolicyOwnerOfficerInternal getInternalInterface(entity.PolicyOwnerOfficer bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PolicyOwnerOfficer newEmptyInstance() {
        return new entity.PolicyOwnerOfficer((java.lang.Void)null);
      }

 ...
 * 
 *     The primary person or company directly protected by the policy with full rights and responsibilities.
 *   
 */
...
@gw.entity.EntityName(value = "PolicyPriNamedInsured")
public class PolicyPriNamedInsured extends entity.PolicyNamedInsured implements gw.api.domain.account.Mergeable {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PolicyPriNamedInsured, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PolicyPriNamedInsured, entity.PolicyPeriod>("entity.PolicyPriNamedInsured");
   ...
   */
  public PolicyPriNamedInsured(entity.PolicyPeriod branch)  {
   ...
   */
  public PolicyPriNamedInsured(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PolicyPriNamedInsured(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PolicyPriNamedInsuredInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PolicyPriNamedInsuredInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PolicyPriNamedInsuredInternal)super.__getInternalInterface();
  }
  
  public entity.PolicyPriNamedInsured clone() {
    return (entity.PolicyPriNamedInsured)__getInternalInterface().cloneUntyped();
  }
  
  public entity.PolicyPriNamedInsured getBasedOn() {
    return (entity.PolicyPriNamedInsured)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PolicyPriNamedInsured getSlice(java.util.Date sliceDate) {
    return (entity.PolicyPriNamedInsured)getSliceUntyped(sliceDate);
  }
  
  public entity.PolicyPriNamedInsured getUnsliced() {
    return (entity.PolicyPriNamedInsured)getUnslicedUntyped();
  }
  
  public entity.windowed.PolicyPriNamedInsuredVersionList getVersionList() {
    return (entity.windowed.PolicyPriNamedInsuredVersionList)getVersionListUntyped();
  }
  
  public entity.PolicyPriNamedInsured split(java.util.Date splitDate) {
    return (entity.PolicyPriNamedInsured)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicyPriNamedInsuredInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PolicyPriNamedInsured.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.contact.PolicyNamedInsuredPublicMethods", "com.guidewire.pc.domain.contact.impl.PolicyPriNamedInsuredImpl");
    config.put("com.guidewire.pc.domain.contact.PolicyPriNamedInsuredPublicMethods", "com.guidewire.pc.domain.contact.impl.PolicyPriNamedInsuredImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PolicyPriNamedInsured.class, config);
    com.guidewire._generated.entity.PolicyPriNamedInsuredInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PolicyPriNamedInsured, com.guidewire._generated.entity.PolicyPriNamedInsuredInternal>() {
      public java.lang.Object getImplementation(entity.PolicyPriNamedInsured bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PolicyPriNamedInsuredInternal getInternalInterface(entity.PolicyPriNamedInsured bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PolicyPriNamedInsured newEmptyInstance() {
        return new entity.PolicyPriNamedInsured((java.lang.Void)null);
      }

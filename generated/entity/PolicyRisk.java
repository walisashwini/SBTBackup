...
/**
 * PolicyRisk
 * A reinsurable risk associated with a policy as a whole.
 */
...
@gw.entity.EntityName(value = "PolicyRisk")
public class PolicyRisk extends entity.Reinsurable implements gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher, gw.api.reinsurance.ReinsurableAdapter {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PolicyRisk, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PolicyRisk, entity.PolicyPeriod>("entity.PolicyRisk");
   ...
   */
  public PolicyRisk(entity.PolicyPeriod branch)  {
   ...
   */
  public PolicyRisk(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PolicyRisk(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PolicyRiskInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PolicyRiskInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PolicyRiskInternal)super.__getInternalInterface();
  }
  
  public entity.PolicyRisk clone() {
    return (entity.PolicyRisk)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.PolicyRisk getBasedOn() {
    return (entity.PolicyRisk)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PolicyRisk getSlice(java.util.Date sliceDate) {
    return (entity.PolicyRisk)getSliceUntyped(sliceDate);
  }
  
  public entity.PolicyRisk getUnsliced() {
    return (entity.PolicyRisk)getUnslicedUntyped();
  }
  
  public entity.windowed.PolicyRiskVersionList getVersionList() {
    return (entity.windowed.PolicyRiskVersionList)getVersionListUntyped();
  }
  ...
  public entity.PolicyRisk split(java.util.Date splitDate) {
    return (entity.PolicyRisk)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicyRiskInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PolicyRisk.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.copier.EffDatedCopyable", "gw.reinsurance.PolicyRiskCopier");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.reinsurance.PolicyRiskMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.reinsurance.PolicyRiskMatcher");
    config.put("gw.api.reinsurance.ReinsurableAdapter", "gw.reinsurance.risk.PolicyRiskReinsurableAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PolicyRisk.class, config);
    com.guidewire._generated.entity.PolicyRiskInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PolicyRisk, com.guidewire._generated.entity.PolicyRiskInternal>() {
      public java.lang.Object getImplementation(entity.PolicyRisk bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PolicyRiskInternal getInternalInterface(entity.PolicyRisk bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PolicyRisk newEmptyInstance() {
        return new entity.PolicyRisk((java.lang.Void)null);
      }

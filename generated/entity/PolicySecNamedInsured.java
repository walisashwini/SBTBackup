 ...
 * 
 *     The non-primary person directly protected by the policy with full rights and responsibilities.
 *     Out of the box, the secondary named insured role is only used in Personal Auto.
 *   
 */
...
@gw.entity.EntityName(value = "PolicySecNamedInsured")
public class PolicySecNamedInsured extends entity.PlcyNonPriNamedInsured implements gw.api.domain.account.Mergeable {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PolicySecNamedInsured, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PolicySecNamedInsured, entity.PolicyPeriod>("entity.PolicySecNamedInsured");
   ...
   */
  public PolicySecNamedInsured(entity.PolicyPeriod branch)  {
   ...
   */
  public PolicySecNamedInsured(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PolicySecNamedInsured(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PolicySecNamedInsuredInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PolicySecNamedInsuredInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PolicySecNamedInsuredInternal)super.__getInternalInterface();
  }
  
  public entity.PolicySecNamedInsured clone() {
    return (entity.PolicySecNamedInsured)__getInternalInterface().cloneUntyped();
  }
  
  public entity.PolicySecNamedInsured getBasedOn() {
    return (entity.PolicySecNamedInsured)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PolicySecNamedInsured getSlice(java.util.Date sliceDate) {
    return (entity.PolicySecNamedInsured)getSliceUntyped(sliceDate);
  }
  
  public entity.PolicySecNamedInsured getUnsliced() {
    return (entity.PolicySecNamedInsured)getUnslicedUntyped();
  }
  
  public entity.windowed.PolicySecNamedInsuredVersionList getVersionList() {
    return (entity.windowed.PolicySecNamedInsuredVersionList)getVersionListUntyped();
  }
  
  public entity.PolicySecNamedInsured split(java.util.Date splitDate) {
    return (entity.PolicySecNamedInsured)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicySecNamedInsuredInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PolicySecNamedInsured.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.contact.PlcyNonPriNamedInsuredPublicMethods", "com.guidewire.pc.domain.contact.impl.PolicySecNamedInsuredImpl");
    config.put("com.guidewire.pc.domain.contact.PolicyNamedInsuredPublicMethods", "com.guidewire.pc.domain.contact.impl.PolicySecNamedInsuredImpl");
    config.put("com.guidewire.pc.domain.contact.PolicySecNamedInsuredPublicMethods", "com.guidewire.pc.domain.contact.impl.PolicySecNamedInsuredImpl");
    ...
    config.put("gw.api.copier.EffDatedCopyable", "gw.contact.PlcyNonPriNamedInsuredCopier");
    ...
    config.put("gw.api.domain.account.Mergeable", "gw.contact.SingletonPolicyContactRoleMergeableImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PolicySecNamedInsured.class, config);
    com.guidewire._generated.entity.PolicySecNamedInsuredInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PolicySecNamedInsured, com.guidewire._generated.entity.PolicySecNamedInsuredInternal>() {
      public java.lang.Object getImplementation(entity.PolicySecNamedInsured bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PolicySecNamedInsuredInternal getInternalInterface(entity.PolicySecNamedInsured bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PolicySecNamedInsured newEmptyInstance() {
        return new entity.PolicySecNamedInsured((java.lang.Void)null);
      }

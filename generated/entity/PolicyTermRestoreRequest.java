 ...
 * Represents a request to retrieve a PolicyTerm from the Archive.
 */
...
@gw.entity.EntityName(value = "PolicyTermRestoreRequest")
public class PolicyTermRestoreRequest extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.Extractable, entity.FrozenSetMember {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PolicyTermRestoreRequest> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PolicyTermRestoreRequest>("entity.PolicyTermRestoreRequest");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> SHOULDCREATEACTIVITY_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ShouldCreateActivity");
  ...
  private com.guidewire._generated.entity.PolicyTermRestoreRequestInternal _internal;
   ...
   */
  public PolicyTermRestoreRequest()  {
   ...
   */
  public PolicyTermRestoreRequest(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PolicyTermRestoreRequest(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PolicyTermRestoreRequestInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PolicyTermRestoreRequestInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.Boolean isShouldCreateActivity() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(SHOULDCREATEACTIVITY_PROP.get());
  }
  ...
  public void setShouldCreateActivity(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(SHOULDCREATEACTIVITY_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicyTermRestoreRequestInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PolicyTermRestoreRequest.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PolicyTermRestoreRequest.class, config);
    com.guidewire._generated.entity.PolicyTermRestoreRequestInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PolicyTermRestoreRequest, com.guidewire._generated.entity.PolicyTermRestoreRequestInternal>() {
      public java.lang.Object getImplementation(entity.PolicyTermRestoreRequest bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PolicyTermRestoreRequestInternal getInternalInterface(entity.PolicyTermRestoreRequest bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PolicyTermRestoreRequest newEmptyInstance() {
        return new entity.PolicyTermRestoreRequest((java.lang.Void)null);
      }

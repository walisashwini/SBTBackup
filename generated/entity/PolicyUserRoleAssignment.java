...
/**
 * PolicyUserRoleAssignment
 * User role assignments for Policies.
 */
...
@gw.entity.EntityName(value = "PolicyUserRoleAssignment")
public class PolicyUserRoleAssignment extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.UserRoleAssignment, entity.Extractable, entity.FrozenSetMember, entity.EventAware {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PolicyUserRoleAssignment> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PolicyUserRoleAssignment>("entity.PolicyUserRoleAssignment");
  ...
  private com.guidewire._generated.entity.PolicyUserRoleAssignmentInternal _internal;
  ...
  public static final java.lang.String POLICYUSERROLEASSIGNMENTADDED_EVENT = "PolicyUserRoleAssignmentAdded";
  
  public static final java.lang.String POLICYUSERROLEASSIGNMENTCHANGED_EVENT = "PolicyUserRoleAssignmentChanged";
  
  public static final java.lang.String POLICYUSERROLEASSIGNMENTREMOVED_EVENT = "PolicyUserRoleAssignmentRemoved";
  
  /**
   * Constructs a new instance of this entity in the {@link gw.transaction.Transaction#getCurrent() current} bundle.
   * @throws java.lang.NullPointerException if there is no current bundle defined
   */
  public PolicyUserRoleAssignment()  {
   ...
   */
  public PolicyUserRoleAssignment(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PolicyUserRoleAssignment(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PolicyUserRoleAssignmentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PolicyUserRoleAssignmentInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicyUserRoleAssignmentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PolicyUserRoleAssignment.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PolicyUserRoleAssignment.class, config);
    com.guidewire._generated.entity.PolicyUserRoleAssignmentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PolicyUserRoleAssignment, com.guidewire._generated.entity.PolicyUserRoleAssignmentInternal>() {
      public java.lang.Object getImplementation(entity.PolicyUserRoleAssignment bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PolicyUserRoleAssignmentInternal getInternalInterface(entity.PolicyUserRoleAssignment bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PolicyUserRoleAssignment newEmptyInstance() {
        return new entity.PolicyUserRoleAssignment((java.lang.Void)null);
      }

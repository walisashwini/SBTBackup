...
/**
 * ProcessMVRsWF
 * Workflow for processing MVRs
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ProcessMVRsWF.eti;ProcessMVRsWF.eix;ProcessMVRsWF.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ProcessMVRsWF")
public class ProcessMVRsWF extends entity.PolicyPeriodWorkflow {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ProcessMVRsWF> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ProcessMVRsWF>("entity.ProcessMVRsWF");
   ...
   */
  public ProcessMVRsWF(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ProcessMVRsWF(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ProcessMVRsWFInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ProcessMVRsWFInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ProcessMVRsWFInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ProcessMVRsWFInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ProcessMVRsWF.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ProcessMVRsWF.class, config);
    com.guidewire._generated.entity.ProcessMVRsWFInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ProcessMVRsWF, com.guidewire._generated.entity.ProcessMVRsWFInternal>() {
      public java.lang.Object getImplementation(entity.ProcessMVRsWF bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ProcessMVRsWFInternal getInternalInterface(entity.ProcessMVRsWF bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ProcessMVRsWF newEmptyInstance() {
        return new entity.ProcessMVRsWF((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "ProducerSelection")
public class ProducerSelection extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ProducerSelection> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ProducerSelection>("entity.ProducerSelection");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DEFAULTPPEFFDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DefaultPPEffDate");
  ...
  private com.guidewire._generated.entity.ProducerSelectionInternal _internal;
   ...
   */
  public ProducerSelection(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ProducerSelection(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ProducerSelectionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ProducerSelectionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.util.Date getDefaultPPEffDate() {
    return (java.util.Date)__getInternalInterface().getFieldValue(DEFAULTPPEFFDATE_PROP.get());
  }
  ...
  public void setDefaultPPEffDate(java.util.Date value) {
    __getInternalInterface().setFieldValue(DEFAULTPPEFFDATE_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ProducerSelectionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ProducerSelection.this.__getDelegateManager();
    }
    ...
    public void setForCurrentUser() {
      ((com.guidewire.pc.domain.product.impl.ProducerSelectionInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.product.impl.ProducerSelectionInternalMethods")).setForCurrentUser();
    }
    
    public void setForCurrentUserAndAccount(entity.Account account) {
      ((com.guidewire.pc.domain.product.impl.ProducerSelectionInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.product.impl.ProducerSelectionInternalMethods")).setForCurrentUserAndAccount(account);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.product.impl.ProducerSelectionInternalMethods", "com.guidewire.pc.domain.product.impl.ProducerSelectionImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ProducerSelection.class, config);
    com.guidewire._generated.entity.ProducerSelectionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ProducerSelection, com.guidewire._generated.entity.ProducerSelectionInternal>() {
      public java.lang.Object getImplementation(entity.ProducerSelection bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ProducerSelectionInternal getInternalInterface(entity.ProducerSelection bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ProducerSelection newEmptyInstance() {
        return new entity.ProducerSelection((java.lang.Void)null);
      }

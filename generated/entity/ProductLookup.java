...
/**
 * ProductLookup
 * The Product availability lookup type.
 */
...
@gw.entity.EntityName(value = "ProductLookup")
public class ProductLookup extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.ProductModelDelegate, entity.AvailabilityLookup, entity.StateDrivenLookup, entity.IndustryCodeDrivenLookup, entity.JobTypeFilteredLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ProductLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ProductLookup>("entity.ProductLookup");
  ...
  private com.guidewire._generated.entity.ProductLookupInternal _internal;
   ...
   */
  protected ProductLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ProductLookup(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ProductLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ProductLookupInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public typekey.ProductLookup getSubtype() {
    return (typekey.ProductLookup)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
   ...
   */
  private void setSubtype(typekey.ProductLookup value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ProductLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ProductLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.productmodel.ProductLookupPublicMethods", "com.guidewire.pc.domain.productmodel.impl.ProductLookupImpl");
    config.put("com.guidewire.pc.domain.productmodel.impl.LookupInternalMethods", "com.guidewire.pc.domain.productmodel.impl.ProductLookupImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ProductLookup.class, config);
    com.guidewire._generated.entity.ProductLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ProductLookup, com.guidewire._generated.entity.ProductLookupInternal>() {
      public java.lang.Object getImplementation(entity.ProductLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ProductLookupInternal getInternalInterface(entity.ProductLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ProductLookup newEmptyInstance() {
        return new entity.ProductLookup((java.lang.Void)null);
      }

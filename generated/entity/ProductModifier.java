...
/**
 * ProductModifier
 * A product-level modifier that is not associated with any specific policy line
 */
...
@gw.entity.EntityName(value = "ProductModifier")
public class ProductModifier extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Modifier, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.ProductModifier, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.ProductModifier, entity.PolicyPeriod>("entity.ProductModifier");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> PRODUCTRATEFACTORS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "ProductRateFactors");
  ...
  private com.guidewire._generated.entity.ProductModifierInternal _internal;
   ...
   */
  public ProductModifier(entity.PolicyPeriod branch)  {
   ...
   */
  public ProductModifier(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected ProductModifier(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ProductModifierInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ProductModifierInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToProductRateFactors(entity.ProductRateFactor element) {
    __getInternalInterface().addArrayElement(PRODUCTRATEFACTORS_PROP.get(), element);
  }
  ...
  public entity.ProductModifier clone() {
    return (entity.ProductModifier)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.ProductModifier getBasedOn() {
    return (entity.ProductModifier)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.ProductModifier getBasedOnValue() {
    return (entity.ProductModifier)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.ProductModifier getFixed() {
    return (entity.ProductModifier)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.ProductRateFactor[] getProductRateFactors() {
    return (entity.ProductRateFactor[])__getInternalInterface().getFieldValue(PRODUCTRATEFACTORS_PROP.get());
  }
  ...
  public entity.ProductModifier getSlice(java.util.Date sliceDate) {
    return (entity.ProductModifier)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.ProductModifier getSubtype() {
    return (typekey.ProductModifier)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.ProductModifier getUnsliced() {
    return (entity.ProductModifier)getUnslicedUntyped();
  }
  ...
  public entity.windowed.ProductModifierVersionList getVersionList() {
    return (entity.windowed.ProductModifierVersionList)getVersionListUntyped();
  }
  ...
  public void removeFromProductRateFactors(entity.ProductRateFactor element) {
    __getInternalInterface().removeArrayElement(PRODUCTRATEFACTORS_PROP.get(), element);
  }
  ...
  public void removeFromProductRateFactors(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(PRODUCTRATEFACTORS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.ProductModifier value) {
   ...
   */
  private void setFixed(entity.ProductModifier value) {
  ...
  public void setProductRateFactors(entity.ProductRateFactor[] value) {
    __getInternalInterface().setFieldValue(PRODUCTRATEFACTORS_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.ProductModifier value) {
  ...
  public entity.ProductModifier split(java.util.Date splitDate) {
    return (entity.ProductModifier)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ProductModifierInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ProductModifier.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ModifierAbstractDomainMethods", "gw.lob.common.ProductModifierAdapter");
    config.put("gw.api.domain.ModifierAdapter", "gw.lob.common.ProductModifierAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.common.ProductModifierMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.common.ProductModifierMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ProductModifier.class, config);
    com.guidewire._generated.entity.ProductModifierInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ProductModifier, com.guidewire._generated.entity.ProductModifierInternal>() {
      public java.lang.Object getImplementation(entity.ProductModifier bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ProductModifierInternal getInternalInterface(entity.ProductModifier bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ProductModifier newEmptyInstance() {
        return new entity.ProductModifier((java.lang.Void)null);
      }

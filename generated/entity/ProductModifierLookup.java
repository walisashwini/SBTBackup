...
/**
 * ProductModifierLookup
 * The modifier lookup type.
 */
...
@gw.entity.EntityName(value = "ProductModifierLookup")
public class ProductModifierLookup extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.ProductModelDelegate, entity.AvailabilityLookup, entity.StateDrivenLookup, entity.JobTypeFilteredLookup, entity.UWCompanyFilteredLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ProductModifierLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ProductModifierLookup>("entity.ProductModifierLookup");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MODIFIERPATTERNCODE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ModifierPatternCode");
  ...
  private com.guidewire._generated.entity.ProductModifierLookupInternal _internal;
   ...
   */
  protected ProductModifierLookup()  {
   ...
   */
  protected ProductModifierLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ProductModifierLookup(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ProductModifierLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ProductModifierLookupInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public typekey.ProductModifierLookup getSubtype() {
    return (typekey.ProductModifierLookup)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
   ...
   */
  private void setSubtype(typekey.ProductModifierLookup value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ProductModifierLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ProductModifierLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.productmodel.ProductModifierLookupPublicMethods", "com.guidewire.pc.domain.productmodel.impl.ProductModifierLookupImpl");
    config.put("com.guidewire.pc.domain.productmodel.impl.LookupInternalMethods", "com.guidewire.pc.domain.productmodel.impl.ProductModifierLookupImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.productmodel.impl.ProductModifierLookupImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ProductModifierLookup.class, config);
    com.guidewire._generated.entity.ProductModifierLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ProductModifierLookup, com.guidewire._generated.entity.ProductModifierLookupInternal>() {
      public java.lang.Object getImplementation(entity.ProductModifierLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ProductModifierLookupInternal getInternalInterface(entity.ProductModifierLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ProductModifierLookup newEmptyInstance() {
        return new entity.ProductModifierLookup((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "ProductRateFactor")
public class ProductRateFactor extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.RateFactor, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.ProductRateFactor, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.ProductRateFactor, entity.PolicyPeriod>("entity.ProductRateFactor");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> PRODUCTMODIFIER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ProductModifier");
  ...
  private com.guidewire._generated.entity.ProductRateFactorInternal _internal;
   ...
   */
  public ProductRateFactor(entity.PolicyPeriod branch)  {
   ...
   */
  public ProductRateFactor(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected ProductRateFactor(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ProductRateFactorInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ProductRateFactorInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.ProductRateFactor clone() {
    return (entity.ProductRateFactor)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.ProductRateFactor getBasedOn() {
    return (entity.ProductRateFactor)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.ProductRateFactor getBasedOnValue() {
    return (entity.ProductRateFactor)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.ProductRateFactor getFixed() {
    return (entity.ProductRateFactor)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.ProductModifier getProductModifier() {
    return (entity.ProductModifier)__getInternalInterface().getFieldValue(PRODUCTMODIFIER_PROP.get());
  }
  ...
  public entity.ProductRateFactor getSlice(java.util.Date sliceDate) {
    return (entity.ProductRateFactor)getSliceUntyped(sliceDate);
  }
  ...
  public entity.ProductRateFactor getUnsliced() {
    return (entity.ProductRateFactor)getUnslicedUntyped();
  }
  ...
  public entity.windowed.ProductRateFactorVersionList getVersionList() {
    return (entity.windowed.ProductRateFactorVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.ProductRateFactor value) {
   ...
   */
  private void setFixed(entity.ProductRateFactor value) {
  ...
  public void setProductModifier(entity.ProductModifier value) {
    __getInternalInterface().setFieldValue(PRODUCTMODIFIER_PROP.get(), value);
  }
  ...
  public entity.ProductRateFactor split(java.util.Date splitDate) {
    return (entity.ProductRateFactor)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ProductRateFactorInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ProductRateFactor.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getProductModifierID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(PRODUCTMODIFIER_PROP.get());
    }
    ...
    public void setProductModifierID(gw.pl.persistence.core.Key value) {
      setFieldValue(PRODUCTMODIFIER_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.RateFactorAdapter", "gw.lob.common.ProductRateFactorAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.common.ProductRateFactorMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.common.ProductRateFactorMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ProductRateFactor.class, config);
    com.guidewire._generated.entity.ProductRateFactorInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ProductRateFactor, com.guidewire._generated.entity.ProductRateFactorInternal>() {
      public java.lang.Object getImplementation(entity.ProductRateFactor bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ProductRateFactorInternal getInternalInterface(entity.ProductRateFactor bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ProductRateFactor newEmptyInstance() {
        return new entity.ProductRateFactor((java.lang.Void)null);
      }

...
/**
 * ProductRateFactorLookup
 * The rating factor lookup.
 */
...
@gw.entity.EntityName(value = "ProductRateFactorLookup")
public class ProductRateFactorLookup extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.ProductModelDelegate, entity.AvailabilityLookup, entity.StateDrivenLookup, entity.JobTypeFilteredLookup, entity.UWCompanyFilteredLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ProductRateFactorLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ProductRateFactorLookup>("entity.ProductRateFactorLookup");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> RATEFACTORPATTERNCODE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "RateFactorPatternCode");
  ...
  private com.guidewire._generated.entity.ProductRateFactorLookupInternal _internal;
   ...
   */
  protected ProductRateFactorLookup()  {
   ...
   */
  protected ProductRateFactorLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ProductRateFactorLookup(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ProductRateFactorLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ProductRateFactorLookupInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public typekey.ProductRateFactorLookup getSubtype() {
    return (typekey.ProductRateFactorLookup)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
   ...
   */
  private void setSubtype(typekey.ProductRateFactorLookup value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ProductRateFactorLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ProductRateFactorLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.productmodel.ProductRateFactorLookupPublicMethods", "com.guidewire.pc.domain.productmodel.impl.ProductRateFactorLookupImpl");
    config.put("com.guidewire.pc.domain.productmodel.impl.LookupInternalMethods", "com.guidewire.pc.domain.productmodel.impl.ProductRateFactorLookupImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.productmodel.impl.ProductRateFactorLookupImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ProductRateFactorLookup.class, config);
    com.guidewire._generated.entity.ProductRateFactorLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ProductRateFactorLookup, com.guidewire._generated.entity.ProductRateFactorLookupInternal>() {
      public java.lang.Object getImplementation(entity.ProductRateFactorLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ProductRateFactorLookupInternal getInternalInterface(entity.ProductRateFactorLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ProductRateFactorLookup newEmptyInstance() {
        return new entity.ProductRateFactorLookup((java.lang.Void)null);
      }

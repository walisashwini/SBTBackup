...
@gw.entity.EntityName(value = "ProgramTreaty")
public class ProgramTreaty extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable, entity.EventAware {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ProgramTreaty> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ProgramTreaty>("entity.ProgramTreaty");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> TREATY_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "Treaty");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.ProgramTreatyInternal _internal;
  
  private static final com.guidewire.pl.persistence.code.DelegateMap DELEGATE_MAP;
  
  public static final java.lang.String PROGRAMTREATYADDED_EVENT = "ProgramTreatyAdded";
  
  public static final java.lang.String PROGRAMTREATYCHANGED_EVENT = "ProgramTreatyChanged";
  
  public static final java.lang.String PROGRAMTREATYREMOVED_EVENT = "ProgramTreatyRemoved";
  
  /**
   * Constructs a new instance of this entity in the {@link gw.transaction.Transaction#getCurrent() current} bundle.
   * @throws java.lang.NullPointerException if there is no current bundle defined
   */
  public ProgramTreaty()  {
   ...
   */
  public ProgramTreaty(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ProgramTreaty(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ProgramTreatyInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ProgramTreatyInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.RIAgreement getTreaty() {
    return (entity.RIAgreement)__getInternalInterface().getFieldValue(TREATY_PROP.get());
  }
  ...
  public void setTreaty(entity.RIAgreement value) {
    __getInternalInterface().setFieldValue(TREATY_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ProgramTreatyInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ProgramTreaty.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getTreatyID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(TREATY_PROP.get());
    }
    ...
    public void setTreatyID(gw.pl.persistence.core.Key value) {
      setFieldValue(TREATY_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ProgramTreaty.class, config);
    com.guidewire._generated.entity.ProgramTreatyInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ProgramTreaty, com.guidewire._generated.entity.ProgramTreatyInternal>() {
      public java.lang.Object getImplementation(entity.ProgramTreaty bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ProgramTreatyInternal getInternalInterface(entity.ProgramTreaty bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ProgramTreaty newEmptyInstance() {
        return new entity.ProgramTreaty((java.lang.Void)null);
      }

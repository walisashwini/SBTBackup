...
@gw.entity.EntityName(value = "QuestionLookup")
public class QuestionLookup extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.ProductModelDelegate, entity.AvailabilityLookup, entity.StateDrivenLookup, entity.JobTypeFilteredLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.QuestionLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.QuestionLookup>("entity.QuestionLookup");
  ...
  private com.guidewire._generated.entity.QuestionLookupInternal _internal;
   ...
   */
  protected QuestionLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected QuestionLookup(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.QuestionLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.QuestionLookupInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public typekey.QuestionLookup getSubtype() {
    return (typekey.QuestionLookup)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
   ...
   */
  private void setSubtype(typekey.QuestionLookup value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.QuestionLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.QuestionLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.productmodel.QuestionLookupPublicMethods", "com.guidewire.pc.domain.productmodel.impl.QuestionLookupImpl");
    config.put("com.guidewire.pc.domain.productmodel.impl.LookupInternalMethods", "com.guidewire.pc.domain.productmodel.impl.QuestionLookupImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.QuestionLookup.class, config);
    com.guidewire._generated.entity.QuestionLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.QuestionLookup, com.guidewire._generated.entity.QuestionLookupInternal>() {
      public java.lang.Object getImplementation(entity.QuestionLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.QuestionLookupInternal getInternalInterface(entity.QuestionLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.QuestionLookup newEmptyInstance() {
        return new entity.QuestionLookup((java.lang.Void)null);
      }

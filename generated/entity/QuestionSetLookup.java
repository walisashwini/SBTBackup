...
@gw.entity.EntityName(value = "QuestionSetLookup")
public class QuestionSetLookup extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.ProductModelDelegate, entity.AvailabilityLookup, entity.StateDrivenLookup, entity.IndustryCodeDrivenLookup, entity.JobTypeFilteredLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.QuestionSetLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.QuestionSetLookup>("entity.QuestionSetLookup");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> QUESTIONSETCODE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "QuestionSetCode");
  ...
  private com.guidewire._generated.entity.QuestionSetLookupInternal _internal;
   ...
   */
  protected QuestionSetLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected QuestionSetLookup(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.QuestionSetLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.QuestionSetLookupInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.String getQuestionSetCode() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(QUESTIONSETCODE_PROP.get());
  }
  ...
  public typekey.QuestionSetLookup getSubtype() {
    return (typekey.QuestionSetLookup)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public void setQuestionSetCode(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(QUESTIONSETCODE_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.QuestionSetLookup value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.QuestionSetLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.QuestionSetLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.productmodel.QuestionSetLookupPublicMethods", "com.guidewire.pc.domain.productmodel.impl.QuestionSetLookupImpl");
    config.put("com.guidewire.pc.domain.productmodel.impl.LookupInternalMethods", "com.guidewire.pc.domain.productmodel.impl.QuestionSetLookupImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.QuestionSetLookup.class, config);
    com.guidewire._generated.entity.QuestionSetLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.QuestionSetLookup, com.guidewire._generated.entity.QuestionSetLookupInternal>() {
      public java.lang.Object getImplementation(entity.QuestionSetLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.QuestionSetLookupInternal getInternalInterface(entity.QuestionSetLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.QuestionSetLookup newEmptyInstance() {
        return new entity.QuestionSetLookup((java.lang.Void)null);
      }

 ...
 *   
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "QuotaShareRITreaty.eti;QuotaShareRITreaty.eix;QuotaShareRITreaty.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "QuotaShareRITreaty")
public class QuotaShareRITreaty extends entity.ProportionalRIAgreement implements entity.Treaty, entity.PerRisk {
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.reinsurance.ProportionalRIAgreementPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.QuotaShareRITreatyImpl");
    config.put("com.guidewire.pc.domain.reinsurance.QuotaShareRITreatyPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.QuotaShareRITreatyImpl");
    config.put("com.guidewire.pc.domain.reinsurance.RIAgreementPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.QuotaShareRITreatyImpl");
    ...
    config.put("com.guidewire.pc.domain.reinsurance.impl.RIAgreementInternalMethods", "com.guidewire.pc.domain.reinsurance.impl.QuotaShareRITreatyImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.reinsurance.impl.QuotaShareRITreatyImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.pc.domain.reinsurance.impl.QuotaShareRITreatyImpl");
    config.put("gw.api.contact.ContactOwner", "com.guidewire.pc.domain.reinsurance.impl.QuotaShareRITreatyImpl");
    config.put("gw.api.domain.reinsurance.RICoverageGroupOwner", "com.guidewire.pc.domain.reinsurance.impl.QuotaShareRITreatyImpl");

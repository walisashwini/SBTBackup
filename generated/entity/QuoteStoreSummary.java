...
/**
 * QuoteStoreSummary
 * Encapsulates the "summary" or "header" fields needed to display the results of a HVQ Quote PolicyPeriod search.
 */
...
@gw.entity.EntityName(value = "QuoteStoreSummary")
public class QuoteStoreSummary extends com.guidewire.pl.persistence.code.BeanBase implements entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.QuoteStoreSummary> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.QuoteStoreSummary>("entity.QuoteStoreSummary");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> SUBMISSIONNUMBER_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "SubmissionNumber");
  ...
  private com.guidewire._generated.entity.QuoteStoreSummaryInternal _internal;
   ...
   */
  public QuoteStoreSummary(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected QuoteStoreSummary(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.QuoteStoreSummaryInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.QuoteStoreSummaryInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.String getSubmissionNumber() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(SUBMISSIONNUMBER_PROP.get());
  }
  ...
  public void setSubmissionNumber(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(SUBMISSIONNUMBER_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.QuoteStoreSummaryInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.QuoteStoreSummary.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.QuoteStoreSummary.class, config);
    com.guidewire._generated.entity.QuoteStoreSummaryInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.QuoteStoreSummary, com.guidewire._generated.entity.QuoteStoreSummaryInternal>() {
      public java.lang.Object getImplementation(entity.QuoteStoreSummary bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.QuoteStoreSummaryInternal getInternalInterface(entity.QuoteStoreSummary bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.QuoteStoreSummary newEmptyInstance() {
        return new entity.QuoteStoreSummary((java.lang.Void)null);
      }

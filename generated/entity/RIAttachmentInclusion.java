 ...
 * RI attachment exclusions, inclusions, and special acceptances
 */
...
@gw.entity.EntityName(value = "RIAttachmentInclusion")
public class RIAttachmentInclusion extends com.guidewire.pl.persistence.code.BeanBase implements entity.Editable, entity.Extractable, entity.FrozenSetMember {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.RIAttachmentInclusion> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.RIAttachmentInclusion>("entity.RIAttachmentInclusion");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> DRAFTRISKVERSIONLIST_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "DraftRiskVersionList");
  ...
  private com.guidewire._generated.entity.RIAttachmentInclusionInternal _internal;
   ...
   */
  public RIAttachmentInclusion(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected RIAttachmentInclusion(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.RIAttachmentInclusionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RIAttachmentInclusionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.RIRiskVersionList getDraftRiskVersionList() {
    return (entity.RIRiskVersionList)__getInternalInterface().getFieldValue(DRAFTRISKVERSIONLIST_PROP.get());
  }
  ...
  public typekey.RIAttachmentInclusionType getInclusion() {
    return (typekey.RIAttachmentInclusionType)__getInternalInterface().getFieldValue(INCLUSION_PROP.get());
  }
  ...
  public typekey.RIAttachmentInclusion getSubtype() {
    return (typekey.RIAttachmentInclusion)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public void setDraftRiskVersionList(entity.RIRiskVersionList value) {
    __getInternalInterface().setFieldValue(DRAFTRISKVERSIONLIST_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.RIAttachmentInclusion value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RIAttachmentInclusionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RIAttachmentInclusion.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getDraftRiskVersionListID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(DRAFTRISKVERSIONLIST_PROP.get());
    }
    ...
    public void setDraftRiskVersionListID(gw.pl.persistence.core.Key value) {
      setFieldValue(DRAFTRISKVERSIONLIST_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RIAttachmentInclusion.class, config);
    com.guidewire._generated.entity.RIAttachmentInclusionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RIAttachmentInclusion, com.guidewire._generated.entity.RIAttachmentInclusionInternal>() {
      public java.lang.Object getImplementation(entity.RIAttachmentInclusion bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RIAttachmentInclusionInternal getInternalInterface(entity.RIAttachmentInclusion bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RIAttachmentInclusion newEmptyInstance() {
        return new entity.RIAttachmentInclusion((java.lang.Void)null);
      }

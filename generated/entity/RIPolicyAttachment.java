...
/**
 * RIPolicyAttachment
 * An attachment of a reinsurable risk to a reinsurance agreement.
 */
...
@gw.entity.EntityName(value = "RIPolicyAttachment")
public class RIPolicyAttachment extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.Extractable, entity.FrozenSetMember, gw.api.reinsurance.MergeableAdapter {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.RIPolicyAttachment> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.RIPolicyAttachment>("entity.RIPolicyAttachment");
  ...
  private com.guidewire._generated.entity.RIPolicyAttachmentInternal _internal;
   ...
   */
  public RIPolicyAttachment(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected RIPolicyAttachment(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.RIPolicyAttachmentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RIPolicyAttachmentInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.RIRisk getRisk() {
    return (entity.RIRisk)__getInternalInterface().getFieldValue(RISK_PROP.get());
  }
  ...
  public typekey.RIPolicyAttachment getSubtype() {
    return (typekey.RIPolicyAttachment)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
   ...
   */
  private void setRisk(entity.RIRisk value) {
   ...
   */
  private void setSubtype(typekey.RIPolicyAttachment value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RIPolicyAttachmentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RIPolicyAttachment.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.reinsurance.RIPolicyAttachmentPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.RIPolicyAttachmentImpl");
    ...
    config.put("gw.api.reinsurance.MergeableAdapter", "gw.reinsurance.risk.RIPolicyAttachmentMergeableAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RIPolicyAttachment.class, config);
    com.guidewire._generated.entity.RIPolicyAttachmentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RIPolicyAttachment, com.guidewire._generated.entity.RIPolicyAttachmentInternal>() {
      public java.lang.Object getImplementation(entity.RIPolicyAttachment bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RIPolicyAttachmentInternal getInternalInterface(entity.RIPolicyAttachment bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RIPolicyAttachment newEmptyInstance() {
        return new entity.RIPolicyAttachment((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "RIProgramChangeCedingWorkItem")
public class RIProgramChangeCedingWorkItem extends entity.RIPolicyPeriodCedingWorkItem {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.RIProgramChangeCedingWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.RIProgramChangeCedingWorkItem>("entity.RIProgramChangeCedingWorkItem");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> CHANGEDPROGRAMS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "ChangedPrograms");
   ...
   */
  public RIProgramChangeCedingWorkItem()  {
   ...
   */
  public RIProgramChangeCedingWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected RIProgramChangeCedingWorkItem(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.RIProgramChangeCedingWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RIProgramChangeCedingWorkItemInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.RIProgramChangeCedingWorkItemInternal)super.__getInternalInterface();
  }
  ...
  public void addToChangedPrograms(entity.RICedingProgramChange element) {
    __getInternalInterface().addArrayElement(CHANGEDPROGRAMS_PROP.get(), element);
  }
  ...
  public entity.RICedingProgramChange[] getChangedPrograms() {
    return (entity.RICedingProgramChange[])__getInternalInterface().getFieldValue(CHANGEDPROGRAMS_PROP.get());
  }
  ...
  public void removeFromChangedPrograms(entity.RICedingProgramChange element) {
    __getInternalInterface().removeArrayElement(CHANGEDPROGRAMS_PROP.get(), element);
  }
  ...
  public void removeFromChangedPrograms(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(CHANGEDPROGRAMS_PROP.get(), elementID);
  }
  ...
  public void setChangedPrograms(entity.RICedingProgramChange[] value) {
    __getInternalInterface().setFieldValue(CHANGEDPROGRAMS_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RIProgramChangeCedingWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RIProgramChangeCedingWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RIProgramChangeCedingWorkItem.class, config);
    com.guidewire._generated.entity.RIProgramChangeCedingWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RIProgramChangeCedingWorkItem, com.guidewire._generated.entity.RIProgramChangeCedingWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.RIProgramChangeCedingWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RIProgramChangeCedingWorkItemInternal getInternalInterface(entity.RIProgramChangeCedingWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RIProgramChangeCedingWorkItem newEmptyInstance() {
        return new entity.RIProgramChangeCedingWorkItem((java.lang.Void)null);
      }

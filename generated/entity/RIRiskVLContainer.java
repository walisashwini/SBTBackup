...
/**
 * RIRiskVLContainer
 * Container for RIRiskVersionLists 
 */
...
@gw.entity.EntityName(value = "RIRiskVLContainer")
public class RIRiskVLContainer extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.Extractable, entity.FrozenSetMember {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.RIRiskVLContainer> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.RIRiskVLContainer>("entity.RIRiskVLContainer");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> VERSIONLISTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "VersionLists");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.RIRiskVLContainerInternal _internal;
   ...
   */
  public RIRiskVLContainer(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected RIRiskVLContainer(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.RIRiskVLContainerInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RIRiskVLContainerInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToVersionLists(entity.RIRiskVersionList element) {
    __getInternalInterface().addArrayElement(VERSIONLISTS_PROP.get(), element);
  }
  
  public void changeRiskNumber(java.lang.String newNumber) {
    ((com.guidewire.pc.domain.reinsurance.RIRiskVLContainerPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.reinsurance.RIRiskVLContainerPublicMethods")).changeRiskNumber(newNumber);
  }
  ...
  public entity.RIRiskVersionList[] getVersionLists() {
    return (entity.RIRiskVersionList[])__getInternalInterface().getFieldValue(VERSIONLISTS_PROP.get());
  }
  ...
  public void removeFromVersionLists(entity.RIRiskVersionList element) {
    __getInternalInterface().removeArrayElement(VERSIONLISTS_PROP.get(), element);
  }
  ...
  public void removeFromVersionLists(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(VERSIONLISTS_PROP.get(), elementID);
  }
  ...
  public void setVersionLists(entity.RIRiskVersionList[] value) {
    __getInternalInterface().setFieldValue(VERSIONLISTS_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RIRiskVLContainerInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RIRiskVLContainer.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.reinsurance.RIRiskVLContainerPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.RIRiskVLContainerImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RIRiskVLContainer.class, config);
    com.guidewire._generated.entity.RIRiskVLContainerInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RIRiskVLContainer, com.guidewire._generated.entity.RIRiskVLContainerInternal>() {
      public java.lang.Object getImplementation(entity.RIRiskVLContainer bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RIRiskVLContainerInternal getInternalInterface(entity.RIRiskVLContainer bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RIRiskVLContainer newEmptyInstance() {
        return new entity.RIRiskVLContainer((java.lang.Void)null);
      }

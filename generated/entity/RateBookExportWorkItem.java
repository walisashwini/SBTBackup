...
/**
 * RateBookExportWorkItem
 * WorkItem to process ratebook export in Excel or XML
 */
...
@gw.entity.EntityName(value = "RateBookExportWorkItem")
public class RateBookExportWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.KeyableBean, entity.WorkItem {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.RateBookExportWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.RateBookExportWorkItem>("entity.RateBookExportWorkItem");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> LANGUAGETYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "LanguageType");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> LOCALETYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "LocaleType");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> RATEBOOKEXPORTTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "RateBookExportType");
  ...
  private com.guidewire._generated.entity.RateBookExportWorkItemInternal _internal;
   ...
   */
  public RateBookExportWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected RateBookExportWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.RateBookExportWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RateBookExportWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public typekey.LanguageType getLanguageType() {
    return (typekey.LanguageType)__getInternalInterface().getFieldValue(LANGUAGETYPE_PROP.get());
  }
  ...
  public typekey.LocaleType getLocaleType() {
    return (typekey.LocaleType)__getInternalInterface().getFieldValue(LOCALETYPE_PROP.get());
  }
  ...
  public typekey.RateBookExportType getRateBookExportType() {
    return (typekey.RateBookExportType)__getInternalInterface().getFieldValue(RATEBOOKEXPORTTYPE_PROP.get());
  }
  ...
  public void setLanguageType(typekey.LanguageType value) {
    __getInternalInterface().setFieldValue(LANGUAGETYPE_PROP.get(), value);
  }
  ...
  public void setLocaleType(typekey.LocaleType value) {
    __getInternalInterface().setFieldValue(LOCALETYPE_PROP.get(), value);
  }
  ...
  public void setRateBookExportType(typekey.RateBookExportType value) {
    __getInternalInterface().setFieldValue(RATEBOOKEXPORTTYPE_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RateBookExportWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RateBookExportWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RateBookExportWorkItem.class, config);
    com.guidewire._generated.entity.RateBookExportWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RateBookExportWorkItem, com.guidewire._generated.entity.RateBookExportWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.RateBookExportWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RateBookExportWorkItemInternal getInternalInterface(entity.RateBookExportWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RateBookExportWorkItem newEmptyInstance() {
        return new entity.RateBookExportWorkItem((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "RateFactorLookup")
public class RateFactorLookup extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.ProductModelDelegate, entity.AvailabilityLookup, entity.StateDrivenLookup, entity.PolicyLinePatternFilteredLookup, entity.JobTypeFilteredLookup, entity.UWCompanyFilteredLookup, com.guidewire.pc.domain.productmodel.DenormLookupInitialisable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.RateFactorLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.RateFactorLookup>("entity.RateFactorLookup");
  ...
  private com.guidewire._generated.entity.RateFactorLookupInternal _internal;
   ...
   */
  protected RateFactorLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected RateFactorLookup(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.RateFactorLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RateFactorLookupInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setSubtype(typekey.RateFactorLookup value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RateFactorLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RateFactorLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RateFactorLookup.class, config);
    com.guidewire._generated.entity.RateFactorLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RateFactorLookup, com.guidewire._generated.entity.RateFactorLookupInternal>() {
      public java.lang.Object getImplementation(entity.RateFactorLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RateFactorLookupInternal getInternalInterface(entity.RateFactorLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RateFactorLookup newEmptyInstance() {
        return new entity.RateFactorLookup((java.lang.Void)null);
      }

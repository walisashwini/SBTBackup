 ...
 *   
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "RateGLClassCodeExt.eti;RateGLClassCodeExt.eix;RateGLClassCodeExt.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "RateGLClassCodeExt")
public class RateGLClassCodeExt extends com.guidewire.pl.persistence.code.BeanBase implements entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.RateGLClassCodeExt> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.RateGLClassCodeExt>("entity.RateGLClassCodeExt");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MINPREMIUM_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "minPremium");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> SPLITTYPE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "splitType");
  ...
  private com.guidewire._generated.entity.RateGLClassCodeExtInternal _internal;
   ...
   */
  public RateGLClassCodeExt(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected RateGLClassCodeExt(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.RateGLClassCodeExtInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RateGLClassCodeExtInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.Integer getminPremium() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(MINPREMIUM_PROP.get());
  }
  ...
  public java.lang.String getsplitType() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(SPLITTYPE_PROP.get());
  }
  ...
  public void setminPremium(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(MINPREMIUM_PROP.get(), value);
  }
  ...
  public void setsplitType(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(SPLITTYPE_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RateGLClassCodeExtInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RateGLClassCodeExt.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RateGLClassCodeExt.class, config);
    com.guidewire._generated.entity.RateGLClassCodeExtInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RateGLClassCodeExt, com.guidewire._generated.entity.RateGLClassCodeExtInternal>() {
      public java.lang.Object getImplementation(entity.RateGLClassCodeExt bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RateGLClassCodeExtInternal getInternalInterface(entity.RateGLClassCodeExt bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RateGLClassCodeExt newEmptyInstance() {
        return new entity.RateGLClassCodeExt((java.lang.Void)null);
      }

 ...
 * Describes the argument source set for a Rate Table.
 */
...
@gw.entity.EntityName(value = "RateTableArgumentSourceSet")
public class RateTableArgumentSourceSet extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.RateTableArgumentSourceSet> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.RateTableArgumentSourceSet>("entity.RateTableArgumentSourceSet");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> RATETABLEARGUMENTSOURCES_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "RateTableArgumentSources");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> RATETABLEDEFINITION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "RateTableDefinition");
  ...
  private com.guidewire._generated.entity.RateTableArgumentSourceSetInternal _internal;
   ...
   */
  public RateTableArgumentSourceSet()  {
   ...
   */
  public RateTableArgumentSourceSet(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected RateTableArgumentSourceSet(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.RateTableArgumentSourceSetInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RateTableArgumentSourceSetInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToRateTableArgumentSources(entity.RateTableArgumentSource element) {
    __getInternalInterface().addArrayElement(RATETABLEARGUMENTSOURCES_PROP.get(), element);
  }
  ...
  public entity.RateTableArgumentSourceSet_Name_L10N[] getName_L10N_ARRAY() {
    return (entity.RateTableArgumentSourceSet_Name_L10N[])__getInternalInterface().getFieldValue(NAME_L10N_ARRAY_PROP.get());
  }
  ...
  public entity.RateTableArgumentSource[] getRateTableArgumentSources() {
    return (entity.RateTableArgumentSource[])__getInternalInterface().getFieldValue(RATETABLEARGUMENTSOURCES_PROP.get());
  }
  ...
  public entity.RateTableDefinition getRateTableDefinition() {
    return (entity.RateTableDefinition)__getInternalInterface().getFieldValue(RATETABLEDEFINITION_PROP.get());
  }
  ...
  public void removeFromRateTableArgumentSources(entity.RateTableArgumentSource element) {
    __getInternalInterface().removeArrayElement(RATETABLEARGUMENTSOURCES_PROP.get(), element);
  }
  ...
  public void removeFromRateTableArgumentSources(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(RATETABLEARGUMENTSOURCES_PROP.get(), elementID);
  }
   ...
   */
  private void setName_L10N_ARRAY(entity.RateTableArgumentSourceSet_Name_L10N[] value) {
  ...
  public void setRateTableArgumentSources(entity.RateTableArgumentSource[] value) {
    __getInternalInterface().setFieldValue(RATETABLEARGUMENTSOURCES_PROP.get(), value);
  }
  ...
  public void setRateTableDefinition(entity.RateTableDefinition value) {
    __getInternalInterface().setFieldValue(RATETABLEDEFINITION_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RateTableArgumentSourceSetInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RateTableArgumentSourceSet.this.__getDelegateManager();
    }
    ...
    public entity.RateTableArgumentSourceSet_Name_L10N getName_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.RateTableArgumentSourceSet_Name_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
    ...
    public gw.pl.persistence.core.Key getRateTableDefinitionID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(RATETABLEDEFINITION_PROP.get());
    }
    ...
    public void setRateTableDefinitionID(gw.pl.persistence.core.Key value) {
      setFieldValue(RATETABLEDEFINITION_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RateTableArgumentSourceSet.class, config);
    com.guidewire._generated.entity.RateTableArgumentSourceSetInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RateTableArgumentSourceSet, com.guidewire._generated.entity.RateTableArgumentSourceSetInternal>() {
      public java.lang.Object getImplementation(entity.RateTableArgumentSourceSet bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RateTableArgumentSourceSetInternal getInternalInterface(entity.RateTableArgumentSourceSet bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RateTableArgumentSourceSet newEmptyInstance() {
        return new entity.RateTableArgumentSourceSet((java.lang.Void)null);
      }

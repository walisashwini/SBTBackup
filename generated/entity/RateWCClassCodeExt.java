...
@gw.entity.EntityName(value = "RateWCClassCodeExt")
public class RateWCClassCodeExt extends com.guidewire.pl.persistence.code.BeanBase implements entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.RateWCClassCodeExt> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.RateWCClassCodeExt>("entity.RateWCClassCodeExt");
  ...
  private com.guidewire._generated.entity.RateWCClassCodeExtInternal _internal;
   ...
   */
  public RateWCClassCodeExt(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected RateWCClassCodeExt(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.RateWCClassCodeExtInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RateWCClassCodeExtInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RateWCClassCodeExtInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RateWCClassCodeExt.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RateWCClassCodeExt.class, config);
    com.guidewire._generated.entity.RateWCClassCodeExtInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RateWCClassCodeExt, com.guidewire._generated.entity.RateWCClassCodeExtInternal>() {
      public java.lang.Object getImplementation(entity.RateWCClassCodeExt bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RateWCClassCodeExtInternal getInternalInterface(entity.RateWCClassCodeExt bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RateWCClassCodeExt newEmptyInstance() {
        return new entity.RateWCClassCodeExt((java.lang.Void)null);
      }

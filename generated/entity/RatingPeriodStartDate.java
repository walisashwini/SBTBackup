 ...
 * A date which marks the beginning of a new rating period. During a rating period the basis amounts for basis-scalable exposures are typically constant.
 */
...
@gw.entity.EntityName(value = "RatingPeriodStartDate")
public class RatingPeriodStartDate extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.RatingPeriodStartDate, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.RatingPeriodStartDate, entity.PolicyPeriod>("entity.RatingPeriodStartDate");
  ...
  private com.guidewire._generated.entity.RatingPeriodStartDateInternal _internal;
   ...
   */
  public RatingPeriodStartDate(entity.PolicyPeriod branch)  {
   ...
   */
  public RatingPeriodStartDate(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected RatingPeriodStartDate(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.RatingPeriodStartDateInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RatingPeriodStartDateInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.RatingPeriodStartDate clone() {
    return (entity.RatingPeriodStartDate)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.RatingPeriodStartDate getBasedOn() {
    return (entity.RatingPeriodStartDate)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.RatingPeriodStartDate getBasedOnValue() {
    return (entity.RatingPeriodStartDate)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.RatingPeriodStartDate getFixed() {
    return (entity.RatingPeriodStartDate)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.RatingPeriodStartDate getSlice(java.util.Date sliceDate) {
    return (entity.RatingPeriodStartDate)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.RPSDType getType() {
    return (typekey.RPSDType)__getInternalInterface().getFieldValue(TYPE_PROP.get());
  }
  
  public entity.RatingPeriodStartDate getUnsliced() {
    return (entity.RatingPeriodStartDate)getUnslicedUntyped();
  }
  ...
  public entity.windowed.RatingPeriodStartDateVersionList getVersionList() {
    return (entity.windowed.RatingPeriodStartDateVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.RatingPeriodStartDate value) {
   ...
   */
  private void setFixed(entity.RatingPeriodStartDate value) {
  ...
  public entity.RatingPeriodStartDate split(java.util.Date splitDate) {
    return (entity.RatingPeriodStartDate)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RatingPeriodStartDateInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RatingPeriodStartDate.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RatingPeriodStartDate.class, config);
    com.guidewire._generated.entity.RatingPeriodStartDateInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RatingPeriodStartDate, com.guidewire._generated.entity.RatingPeriodStartDateInternal>() {
      public java.lang.Object getImplementation(entity.RatingPeriodStartDate bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RatingPeriodStartDateInternal getInternalInterface(entity.RatingPeriodStartDate bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RatingPeriodStartDate newEmptyInstance() {
        return new entity.RatingPeriodStartDate((java.lang.Void)null);
      }

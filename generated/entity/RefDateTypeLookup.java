...
/**
 * RefDateTypeLookup
 * Reference date type lookup table
 */
...
@gw.entity.EntityName(value = "RefDateTypeLookup")
public class RefDateTypeLookup extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.AvailabilityLookup, entity.StateDrivenLookup, entity.UWCompanyFilteredLookup {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.RefDateTypeLookup> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.RefDateTypeLookup>("entity.RefDateTypeLookup");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> REFERENCEDATETYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "ReferenceDateType");
  ...
  private com.guidewire._generated.entity.RefDateTypeLookupInternal _internal;
   ...
   */
  protected RefDateTypeLookup(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected RefDateTypeLookup(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.RefDateTypeLookupInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RefDateTypeLookupInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public typekey.ReferenceDateType getReferenceDateType() {
    return (typekey.ReferenceDateType)__getInternalInterface().getFieldValue(REFERENCEDATETYPE_PROP.get());
  }
  ...
  public typekey.RefDateTypeLookup getSubtype() {
    return (typekey.RefDateTypeLookup)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public void setReferenceDateType(typekey.ReferenceDateType value) {
    __getInternalInterface().setFieldValue(REFERENCEDATETYPE_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.RefDateTypeLookup value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RefDateTypeLookupInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RefDateTypeLookup.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.productmodel.RefDateTypeLookupPublicMethods", "com.guidewire.pc.domain.productmodel.impl.RefDateTypeLookupImpl");
    config.put("com.guidewire.pc.domain.productmodel.impl.LookupInternalMethods", "com.guidewire.pc.domain.productmodel.impl.RefDateTypeLookupImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RefDateTypeLookup.class, config);
    com.guidewire._generated.entity.RefDateTypeLookupInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RefDateTypeLookup, com.guidewire._generated.entity.RefDateTypeLookupInternal>() {
      public java.lang.Object getImplementation(entity.RefDateTypeLookup bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RefDateTypeLookupInternal getInternalInterface(entity.RefDateTypeLookup bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RefDateTypeLookup newEmptyInstance() {
        return new entity.RefDateTypeLookup((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "Renewal")
public class Renewal extends entity.Job implements entity.EventAware {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.Renewal> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.Renewal>("entity.Renewal");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ESCALATEAFTERHOLDRELEASED_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "EscalateAfterHoldReleased");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> NONRENEWALCODE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "NonRenewalCode");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> NONRENEWALNOTIFDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "NonRenewalNotifDate");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> NOTTAKENNOTIFDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "NotTakenNotifDate");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> RENEWALCODE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "RenewalCode");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> RENEWALNOTIFDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "RenewalNotifDate");
  
  private static final com.guidewire.pl.persistence.code.DelegateMap DELEGATE_MAP;
  
  public static final java.lang.String RENEWALADDED_EVENT = "RenewalAdded";
  
  public static final java.lang.String RENEWALCHANGED_EVENT = "RenewalChanged";
  
  public static final java.lang.String RENEWALREMOVED_EVENT = "RenewalRemoved";
   ...
   */
  public Renewal(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected Renewal(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.RenewalInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RenewalInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.RenewalInternal)super.__getInternalInterface();
  }
  ...
  public typekey.NonRenewalCode getNonRenewalCode() {
    return (typekey.NonRenewalCode)__getInternalInterface().getFieldValue(NONRENEWALCODE_PROP.get());
  }
  ...
  public java.util.Date getNonRenewalNotifDate() {
    return (java.util.Date)__getInternalInterface().getFieldValue(NONRENEWALNOTIFDATE_PROP.get());
  }
  ...
  public java.util.Date getNotTakenNotifDate() {
    return (java.util.Date)__getInternalInterface().getFieldValue(NOTTAKENNOTIFDATE_PROP.get());
  }
  ...
  public typekey.RenewalCode getRenewalCode() {
    return (typekey.RenewalCode)__getInternalInterface().getFieldValue(RENEWALCODE_PROP.get());
  }
  
  /**
   * Returns the {@link RenewalGroup} to which this Renewal belongs or null if the Renewal
   * does not belong to any group.
   * @return the group this renewal belongs to if any; otherwise null
   */
  public entity.RenewalGroup getRenewalGroup() {
    return ((com.guidewire.pc.domain.job.RenewalPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.RenewalPublicMethods")).getRenewalGroup();
  }
  ...
  public java.util.Date getRenewalNotifDate() {
    return (java.util.Date)__getInternalInterface().getFieldValue(RENEWALNOTIFDATE_PROP.get());
  }
  ...
  public java.lang.Boolean isEscalateAfterHoldReleased() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(ESCALATEAFTERHOLDRELEASED_PROP.get());
  }
  ...
  public void setEscalateAfterHoldReleased(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(ESCALATEAFTERHOLDRELEASED_PROP.get(), value);
  }
  ...
  public void setNonRenewalCode(typekey.NonRenewalCode value) {
    __getInternalInterface().setFieldValue(NONRENEWALCODE_PROP.get(), value);
  }
  ...
  public void setNonRenewalNotifDate(java.util.Date value) {
    __getInternalInterface().setFieldValue(NONRENEWALNOTIFDATE_PROP.get(), value);
  }
  ...
  public void setNotTakenNotifDate(java.util.Date value) {
    __getInternalInterface().setFieldValue(NOTTAKENNOTIFDATE_PROP.get(), value);
  }
  ...
  public void setRenewalCode(typekey.RenewalCode value) {
    __getInternalInterface().setFieldValue(RENEWALCODE_PROP.get(), value);
  }
  ...
  public void setRenewalNotifDate(java.util.Date value) {
    __getInternalInterface().setFieldValue(RENEWALNOTIFDATE_PROP.get(), value);
  }
  
  /**
   * Starts a renewal job on the latest bound period of the passed-in policy.
   * The effective date of the renewal period is the expiration date of the based-on period
   ...
   */
  public void startJob(entity.Policy policy) throws com.guidewire.pl.web.controller.UserDisplayableException {
    ((com.guidewire.pc.domain.job.RenewalPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.RenewalPublicMethods")).startJob(policy);
  }
   ...
   */
  public boolean startJobAndCommit(entity.Policy policy, pcf.api.Location location) {
    return ((com.guidewire.pc.domain.job.RenewalPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.RenewalPublicMethods")).startJobAndCommit(policy, location);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RenewalInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.Renewal.this.__getDelegateManager();
    }
    ...
    public void startConversionJob(java.util.Date effectiveDate, entity.ProducerCode producerCode, gw.api.policy.PeriodFromExternalPopulator populatePeriod) {
      ((com.guidewire.pc.domain.job.impl.RenewalInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.impl.RenewalInternalMethods")).startConversionJob(effectiveDate, producerCode, populatePeriod);
    }
    
    public void startConversionRenewalJob(entity.ProducerCode producerCode, java.lang.String policyNumber, gw.api.policy.PeriodFromExternalPopulator populatePeriod) {
      ((com.guidewire.pc.domain.job.impl.RenewalInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.impl.RenewalInternalMethods")).startConversionRenewalJob(producerCode, policyNumber, populatePeriod);
    }
  ...
  static {
    ...
    config.put("com.guidewire.commons.metadata.internal.version.MetadataVersionProvider", "com.guidewire.pc.domain.job.impl.RenewalImpl");
    config.put("com.guidewire.pc.domain.job.JobPublicMethods", "com.guidewire.pc.domain.job.impl.RenewalImpl");
    config.put("com.guidewire.pc.domain.job.RenewalPublicMethods", "com.guidewire.pc.domain.job.impl.RenewalImpl");
    config.put("com.guidewire.pc.domain.job.impl.JobInternalMethods", "com.guidewire.pc.domain.job.impl.RenewalImpl");
    config.put("com.guidewire.pc.domain.job.impl.RenewalInternalMethods", "com.guidewire.pc.domain.job.impl.RenewalImpl");
    config.put("com.guidewire.pc.domain.note.NoteContainer", "com.guidewire.pc.domain.job.impl.RenewalImpl");
    config.put("com.guidewire.pl.domain.assignment.impl.UserRoleOwnerInternalMethods", "com.guidewire.pc.domain.job.impl.RenewalImpl");
    config.put("com.guidewire.pl.domain.extract.RootInfoPublicMethods", "com.guidewire.pc.domain.job.impl.RenewalImpl");
    config.put("com.guidewire.pl.domain.extract.impl.RootInfoInternalMethods", "com.guidewire.pc.domain.job.impl.RenewalImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.job.impl.RenewalImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.pc.domain.job.impl.JobImpl");
    config.put("com.guidewire.pl.system.entity.DoesNotValidateOnCommit", "com.guidewire.pc.domain.job.impl.RenewalImpl");
    config.put("gw.api.assignment.UserRoleOwner", "com.guidewire.pc.domain.job.impl.RenewalImpl");
    config.put("gw.api.domain.document.DocumentContainer", "com.guidewire.pc.domain.job.impl.RenewalImpl");
    config.put("gw.api.domain.linkedobject.LinkedObjectContainer", "com.guidewire.pc.domain.job.impl.RenewalImpl");
    config.put("gw.api.history.CustomHistory", "gw.api.history.JobCustomHistoryImpl");
    config.put("gw.api.job.JobMethods", "gw.api.job.RenewalJobMethods");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.Renewal.class, config);
    com.guidewire._generated.entity.RenewalInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.Renewal, com.guidewire._generated.entity.RenewalInternal>() {
      public java.lang.Object getImplementation(entity.Renewal bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RenewalInternal getInternalInterface(entity.Renewal bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.Renewal newEmptyInstance() {
        return new entity.Renewal((java.lang.Void)null);
      }

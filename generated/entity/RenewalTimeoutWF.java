...
@gw.entity.EntityName(value = "RenewalTimeoutWF")
public class RenewalTimeoutWF extends entity.PolicyPeriodWorkflow {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.RenewalTimeoutWF> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.RenewalTimeoutWF>("entity.RenewalTimeoutWF");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> FUNCTIONTOCALL_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "FunctionToCall");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> RENEWALOFFER_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "RenewalOffer");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> WAKEUPTIME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "WakeupTime");
   ...
   */
  public RenewalTimeoutWF(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected RenewalTimeoutWF(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.RenewalTimeoutWFInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RenewalTimeoutWFInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.RenewalTimeoutWFInternal)super.__getInternalInterface();
  }
  ...
  public java.lang.String getFunctionToCall() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(FUNCTIONTOCALL_PROP.get());
  }
  ...
  public java.util.Date getWakeupTime() {
    return (java.util.Date)__getInternalInterface().getFieldValue(WAKEUPTIME_PROP.get());
  }
  ...
  public java.lang.Boolean isRenewalOffer() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(RENEWALOFFER_PROP.get());
  }
  ...
  public void setFunctionToCall(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(FUNCTIONTOCALL_PROP.get(), value);
  }
  ...
  public void setRenewalOffer(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(RENEWALOFFER_PROP.get(), value);
  }
  ...
  public void setWakeupTime(java.util.Date value) {
    __getInternalInterface().setFieldValue(WAKEUPTIME_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RenewalTimeoutWFInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RenewalTimeoutWF.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.workflow.PolicyPeriodWorkflowPublicMethods", "com.guidewire.pc.domain.workflow.impl.PolicyPeriodWorkflowImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RenewalTimeoutWF.class, config);
    com.guidewire._generated.entity.RenewalTimeoutWFInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RenewalTimeoutWF, com.guidewire._generated.entity.RenewalTimeoutWFInternal>() {
      public java.lang.Object getImplementation(entity.RenewalTimeoutWF bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RenewalTimeoutWFInternal getInternalInterface(entity.RenewalTimeoutWF bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RenewalTimeoutWF newEmptyInstance() {
        return new entity.RenewalTimeoutWF((java.lang.Void)null);
      }

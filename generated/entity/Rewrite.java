...
@gw.entity.EntityName(value = "Rewrite")
public class Rewrite extends entity.Job implements entity.EventAware {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.Rewrite> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.Rewrite>("entity.Rewrite");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CHANGEPOLICYNUMBER_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ChangePolicyNumber");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> REWRITETYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "RewriteType");
  
  private static final com.guidewire.pl.persistence.code.DelegateMap DELEGATE_MAP;
  
  public static final java.lang.String REWRITEADDED_EVENT = "RewriteAdded";
  
  public static final java.lang.String REWRITECHANGED_EVENT = "RewriteChanged";
  
  public static final java.lang.String REWRITEREMOVED_EVENT = "RewriteRemoved";
   ...
   */
  public Rewrite(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected Rewrite(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.RewriteInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RewriteInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.RewriteInternal)super.__getInternalInterface();
  }
  
  /**
   * Gets the PolicyPeriod associated with this (single version) Rewrite job.
   * @throws IllegalStateException if called on a multiversion rewrite
   * @return the policy period associated with this rewrite
   * @deprecated (Since 10.0.0) Rewrite now supports MultiQuote and Side-by-Side Quoting
   * so there can be multiple policy periods. Job.getPeriods() should be used instead.
   */
  @java.lang.Deprecated
  public entity.PolicyPeriod getPolicyPeriod() {
    return ((com.guidewire.pc.domain.job.RewritePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.RewritePublicMethods")).getPolicyPeriod();
  }
  ...
  public typekey.RewriteType getRewriteType() {
    return (typekey.RewriteType)__getInternalInterface().getFieldValue(REWRITETYPE_PROP.get());
  }
  ...
  public java.lang.Boolean isChangePolicyNumber() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(CHANGEPOLICYNUMBER_PROP.get());
  }
  ...
  public void setChangePolicyNumber(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(CHANGEPOLICYNUMBER_PROP.get(), value);
  }
  ...
  public void setRewriteType(typekey.RewriteType value) {
    __getInternalInterface().setFieldValue(REWRITETYPE_PROP.get(), value);
  }
  
  /**
   * Starts a rewrite job on the latest bound period of the passed-in policy that includes the given effective date.
   * @param policy The policy for which the job is to be started
   * @param effDate The date at which the job should be started.
   * @param expDate The date at which the job should end.
   * @throws com.guidewire.pl.web.controller.UserDisplayableException if the job cannot be started
   */
  public void startJob(entity.Policy policy, java.util.Date effDate, java.util.Date expDate) throws com.guidewire.pl.web.controller.UserDisplayableException {
    ((com.guidewire.pc.domain.job.RewritePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.RewritePublicMethods")).startJob(policy, effDate, expDate);
  }
   ...
   */
  public boolean startJobAndCommit(entity.Policy policy, java.util.Date effDate, java.util.Date expDate, pcf.api.Location location) {
    return ((com.guidewire.pc.domain.job.RewritePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.RewritePublicMethods")).startJobAndCommit(policy, effDate, expDate, location);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RewriteInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.Rewrite.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.job.JobPublicMethods", "com.guidewire.pc.domain.job.impl.RewriteImpl");
    config.put("com.guidewire.pc.domain.job.RewritePublicMethods", "com.guidewire.pc.domain.job.impl.RewriteImpl");
    config.put("com.guidewire.pc.domain.job.impl.JobInternalMethods", "com.guidewire.pc.domain.job.impl.JobImpl");
    config.put("com.guidewire.pc.domain.note.NoteContainer", "com.guidewire.pc.domain.job.impl.RewriteImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.job.impl.RewriteImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.pc.domain.job.impl.JobImpl");
    config.put("com.guidewire.pl.system.entity.DoesNotValidateOnCommit", "com.guidewire.pc.domain.job.impl.RewriteImpl");
    config.put("gw.api.assignment.UserRoleOwner", "com.guidewire.pc.domain.job.impl.RewriteImpl");
    config.put("gw.api.domain.document.DocumentContainer", "com.guidewire.pc.domain.job.impl.RewriteImpl");
    config.put("gw.api.domain.linkedobject.LinkedObjectContainer", "com.guidewire.pc.domain.job.impl.RewriteImpl");
    config.put("gw.api.history.CustomHistory", "gw.api.history.JobCustomHistoryImpl");
    config.put("gw.api.job.JobMethods", "gw.api.job.RewriteJobMethods");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.Rewrite.class, config);
    com.guidewire._generated.entity.RewriteInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.Rewrite, com.guidewire._generated.entity.RewriteInternal>() {
      public java.lang.Object getImplementation(entity.Rewrite bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RewriteInternal getInternalInterface(entity.Rewrite bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.Rewrite newEmptyInstance() {
        return new entity.Rewrite((java.lang.Void)null);
      }

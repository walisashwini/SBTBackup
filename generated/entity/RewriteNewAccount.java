...
/**
 * RewriteNewAccount
 * RewriteNewAccount process
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "RewriteNewAccount.eti;RewriteNewAccount.eix;RewriteNewAccount.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "RewriteNewAccount")
public class RewriteNewAccount extends entity.Job implements entity.EventAware {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.RewriteNewAccount> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.RewriteNewAccount>("entity.RewriteNewAccount");
  
  private static final com.guidewire.pl.persistence.code.DelegateMap DELEGATE_MAP;
  
  public static final java.lang.String REWRITENEWACCOUNTADDED_EVENT = "RewriteNewAccountAdded";
  
  public static final java.lang.String REWRITENEWACCOUNTCHANGED_EVENT = "RewriteNewAccountChanged";
  
  public static final java.lang.String REWRITENEWACCOUNTREMOVED_EVENT = "RewriteNewAccountRemoved";
  
  /**
   * Constructs a new instance of this entity in the {@link gw.transaction.Transaction#getCurrent() current} bundle.
   * @throws java.lang.NullPointerException if there is no current bundle defined
   */
  public RewriteNewAccount()  {
   ...
   */
  public RewriteNewAccount(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected RewriteNewAccount(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.RewriteNewAccountInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RewriteNewAccountInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.RewriteNewAccountInternal)super.__getInternalInterface();
  }
  
  /**
   * Gets the PolicyPeriod associated with this RewriteNewAccount job.
   * There should be one and only one PolicyPeriod to find!
   * @return the policy period assocated with this rewrite new account
   */
  public entity.PolicyPeriod getPolicyPeriod() {
    return ((com.guidewire.pc.domain.job.RewriteNewAccountPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.RewriteNewAccountPublicMethods")).getPolicyPeriod();
  }
  
  /**
   * Starts a rewrite new account job on the latest bound period of the passed-in policy that
   * includes the given effective date if one exists (representing a rewrite of a canceled policy)
   * or the latest bound period otherwise (representing a rewrite of an expired policy).
   * @param policy The policy for which the job is to be started
   * @param effectiveDate Effective date for the rewrite new account
   * @param accountNumber Account number of the Account to which the policy should be rewritten
   * @throws com.guidewire.pl.web.controller.UserDisplayableException if the job cannot be started
   */
  public void startJob(entity.Policy policy, java.util.Date effectiveDate, java.lang.String accountNumber) throws com.guidewire.pl.web.controller.UserDisplayableException {
    ((com.guidewire.pc.domain.job.RewriteNewAccountPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.RewriteNewAccountPublicMethods")).startJob(policy, effectiveDate, accountNumber);
  }
   ...
   * @param policy The policy for which the job is to be started
   * @param effectiveDate Effective date for the rewrite new account
   * @param accountNumber Account number to which the policy should be rewritten
   * @param location The current web location so data can be validated
   * @return true if the job was started
   */
  public boolean startJobAndCommit(entity.Policy policy, java.util.Date effectiveDate, java.lang.String accountNumber, pcf.api.Location location) {
    return ((com.guidewire.pc.domain.job.RewriteNewAccountPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.RewriteNewAccountPublicMethods")).startJobAndCommit(policy, effectiveDate, accountNumber, location);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RewriteNewAccountInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RewriteNewAccount.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.job.JobPublicMethods", "com.guidewire.pc.domain.job.impl.RewriteNewAccountImpl");
    config.put("com.guidewire.pc.domain.job.RewriteNewAccountPublicMethods", "com.guidewire.pc.domain.job.impl.RewriteNewAccountImpl");
    config.put("com.guidewire.pc.domain.job.impl.JobInternalMethods", "com.guidewire.pc.domain.job.impl.JobImpl");
    config.put("com.guidewire.pc.domain.note.NoteContainer", "com.guidewire.pc.domain.job.impl.RewriteNewAccountImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.job.impl.RewriteNewAccountImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.pc.domain.job.impl.JobImpl");
    config.put("com.guidewire.pl.system.entity.DoesNotValidateOnCommit", "com.guidewire.pc.domain.job.impl.RewriteNewAccountImpl");
    config.put("gw.api.assignment.UserRoleOwner", "com.guidewire.pc.domain.job.impl.RewriteNewAccountImpl");
    config.put("gw.api.domain.document.DocumentContainer", "com.guidewire.pc.domain.job.impl.RewriteNewAccountImpl");
    config.put("gw.api.domain.linkedobject.LinkedObjectContainer", "com.guidewire.pc.domain.job.impl.RewriteNewAccountImpl");
    config.put("gw.api.history.CustomHistory", "gw.api.history.JobCustomHistoryImpl");
    config.put("gw.api.job.JobMethods", "gw.api.job.RewriteNewAccountJobMethods");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RewriteNewAccount.class, config);
    com.guidewire._generated.entity.RewriteNewAccountInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RewriteNewAccount, com.guidewire._generated.entity.RewriteNewAccountInternal>() {
      public java.lang.Object getImplementation(entity.RewriteNewAccount bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RewriteNewAccountInternal getInternalInterface(entity.RewriteNewAccount bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RewriteNewAccount newEmptyInstance() {
        return new entity.RewriteNewAccount((java.lang.Void)null);
      }

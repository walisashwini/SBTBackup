...
@gw.entity.EntityName(value = "RiskClass")
public class RiskClass extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.RiskClass> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.RiskClass>("entity.RiskClass");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BEANVERSION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BeanVersion");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> COVERAGEPATTERNCODE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CoveragePatternCode");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> HAZARD_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Hazard");
  ...
  private com.guidewire._generated.entity.RiskClassInternal _internal;
   ...
   */
  public RiskClass(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected RiskClass(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.RiskClassInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RiskClassInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.RiskClass_Description_L10N[] getDescription_L10N_ARRAY() {
    return (entity.RiskClass_Description_L10N[])__getInternalInterface().getFieldValue(DESCRIPTION_L10N_ARRAY_PROP.get());
  }
  ...
  public java.lang.Integer getHazard() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(HAZARD_PROP.get());
  }
   ...
   */
  private void setDescription_L10N_ARRAY(entity.RiskClass_Description_L10N[] value) {
  ...
  public void setHazard(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(HAZARD_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RiskClassInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RiskClass.this.__getDelegateManager();
    }
    ...
    public entity.RiskClass_Description_L10N getDescription_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.RiskClass_Description_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RiskClass.class, config);
    com.guidewire._generated.entity.RiskClassInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RiskClass, com.guidewire._generated.entity.RiskClassInternal>() {
      public java.lang.Object getImplementation(entity.RiskClass bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RiskClassInternal getInternalInterface(entity.RiskClass bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RiskClass newEmptyInstance() {
        return new entity.RiskClass((java.lang.Void)null);
      }

...
/**
 * RiskEvaluationWorkItem
 * Work Item for support of asynchronous risk evaluation
 */
...
@gw.entity.EntityName(value = "RiskEvaluationWorkItem")
public class RiskEvaluationWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.KeyableBean, entity.Extractable, entity.FrozenSetMember, entity.WorkItem {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.RiskEvaluationWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.RiskEvaluationWorkItem>("entity.RiskEvaluationWorkItem");
  ...
  private com.guidewire._generated.entity.RiskEvaluationWorkItemInternal _internal;
   ...
   */
  public RiskEvaluationWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected RiskEvaluationWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.RiskEvaluationWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RiskEvaluationWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public typekey.RiskEvaluationWorkItem getSubtype() {
    return (typekey.RiskEvaluationWorkItem)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
   ...
   */
  private void setSubtype(typekey.RiskEvaluationWorkItem value) {
    __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RiskEvaluationWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RiskEvaluationWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RiskEvaluationWorkItem.class, config);
    com.guidewire._generated.entity.RiskEvaluationWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RiskEvaluationWorkItem, com.guidewire._generated.entity.RiskEvaluationWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.RiskEvaluationWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RiskEvaluationWorkItemInternal getInternalInterface(entity.RiskEvaluationWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RiskEvaluationWorkItem newEmptyInstance() {
        return new entity.RiskEvaluationWorkItem((java.lang.Void)null);
      }

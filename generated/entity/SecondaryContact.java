 ...
 * SecondaryContact
 * 
 *     The secondary contact for an account.
 * 
 *   
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "SecondaryContact.eti;SecondaryContact.eix;SecondaryContact.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "SecondaryContact")
public class SecondaryContact extends entity.AccountContactRole {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.SecondaryContact> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.SecondaryContact>("entity.SecondaryContact");
   ...
   */
  public SecondaryContact(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected SecondaryContact(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.SecondaryContactInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.SecondaryContactInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.SecondaryContactInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.SecondaryContactInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.SecondaryContact.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.SecondaryContact.class, config);
    com.guidewire._generated.entity.SecondaryContactInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.SecondaryContact, com.guidewire._generated.entity.SecondaryContactInternal>() {
      public java.lang.Object getImplementation(entity.SecondaryContact bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.SecondaryContactInternal getInternalInterface(entity.SecondaryContact bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.SecondaryContact newEmptyInstance() {
        return new entity.SecondaryContact((java.lang.Void)null);
      }

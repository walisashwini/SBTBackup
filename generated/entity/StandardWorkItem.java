...
public class StandardWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.KeyableBean, entity.WorkItem {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BUSINESSCREATIONTIME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BusinessCreationTime");
  ...
  /**
   * Gets the value of the BusinessCreationTime field.
   * Work item creation time according to standard system clock.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.util.Date getBusinessCreationTime() {
    return (java.util.Date)__getInternalInterface().getFieldValue(BUSINESSCREATIONTIME_PROP.get());
  }
  ...
  /**
   * Sets the value of the BusinessCreationTime field.
   */
  public void setBusinessCreationTime(java.util.Date value) {
    __getInternalInterface().setFieldValue(BUSINESSCREATIONTIME_PROP.get(), value);
  }

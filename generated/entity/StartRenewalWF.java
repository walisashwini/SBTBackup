...
/**
 * StartRenewalWF
 * Workflow for starting renewals
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "StartRenewalWF.eti;StartRenewalWF.eix;StartRenewalWF.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "StartRenewalWF")
public class StartRenewalWF extends entity.PolicyPeriodWorkflow {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.StartRenewalWF> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.StartRenewalWF>("entity.StartRenewalWF");
   ...
   */
  public StartRenewalWF(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected StartRenewalWF(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.StartRenewalWFInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.StartRenewalWFInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.StartRenewalWFInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.StartRenewalWFInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.StartRenewalWF.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.StartRenewalWF.class, config);
    com.guidewire._generated.entity.StartRenewalWFInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.StartRenewalWF, com.guidewire._generated.entity.StartRenewalWFInternal>() {
      public java.lang.Object getImplementation(entity.StartRenewalWF bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.StartRenewalWFInternal getInternalInterface(entity.StartRenewalWF bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.StartRenewalWF newEmptyInstance() {
        return new entity.StartRenewalWF((java.lang.Void)null);
      }

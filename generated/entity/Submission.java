...
/**
 * Submission
 * Submission process object relating to one or more versions of a policy
 */
...
@gw.entity.EntityName(value = "Submission")
public class Submission extends entity.Job {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.Submission> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.Submission>("entity.Submission");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> BINDOPTION_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "BindOption");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DATEQUOTENEEDED_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DateQuoteNeeded");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> QUOTETYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "QuoteType");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> REJECTREASON_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "RejectReason");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> REJECTREASONTEXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "RejectReasonText");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> SUBMISSIONDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "SubmissionDate");
   ...
   */
  public Submission(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected Submission(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.SubmissionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.SubmissionInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.SubmissionInternal)super.__getInternalInterface();
  }
  ...
  public typekey.BindOption getBindOption() {
    return (typekey.BindOption)__getInternalInterface().getFieldValue(BINDOPTION_PROP.get());
  }
  ...
  public java.util.Date getDateQuoteNeeded() {
    return (java.util.Date)__getInternalInterface().getFieldValue(DATEQUOTENEEDED_PROP.get());
  }
  
  /**
   * Gets all Letters of the given type that have been created for this Job
   * @param letterType the type of letter to be found
   * @return letters on the submission matching the type
   */
  public gw.api.database.IQueryBeanResult<entity.Letter> getLetters(typekey.LetterType letterType) {
    return ((com.guidewire.pc.domain.job.SubmissionPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.SubmissionPublicMethods")).getLetters(letterType);
  }
  ...
  public typekey.QuoteType getQuoteType() {
    return (typekey.QuoteType)__getInternalInterface().getFieldValue(QUOTETYPE_PROP.get());
  }
  ...
  public typekey.ReasonCode getRejectReason() {
    return (typekey.ReasonCode)__getInternalInterface().getFieldValue(REJECTREASON_PROP.get());
  }
  ...
  public java.lang.String getRejectReasonText() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(REJECTREASONTEXT_PROP.get());
  }
  ...
  public java.util.Date getSubmissionDate() {
    return (java.util.Date)__getInternalInterface().getFieldValue(SUBMISSIONDATE_PROP.get());
  }
  
  /**
   * Returns the group to which this Submission belongs or null if the Submission
   * does not belong to any group.
   * @return the submission group to which this submission belongs, or null if none
   */
  public entity.SubmissionGroup getSubmissionGroup() {
    return ((com.guidewire.pc.domain.job.SubmissionPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.SubmissionPublicMethods")).getSubmissionGroup();
  }
  
  /**
   * Returns the cost of this Submission if it is appropriate to include it in the owning account's total cost, otherwise returns zero
   * @return total cost of this submission
   */
  public gw.pl.currency.MonetaryAmount getTotalCost() {
    return ((com.guidewire.pc.domain.job.SubmissionPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.SubmissionPublicMethods")).getTotalCost();
  }
  
  /**
   * True if any Letters of the given type have been created for this Job
   * @param letterType the type of letter to check for
   * @return true if such a letter is present
   */
  public boolean hasLetter(typekey.LetterType letterType) {
    return ((com.guidewire.pc.domain.job.SubmissionPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.SubmissionPublicMethods")).hasLetter(letterType);
  }
  
  /**
   * True if the Submission has a confirmation or declination Letter without
   * having an associated confirm / decline document
   * @return true if there is an unsent letter
   */
  public boolean hasUnsentLetter() {
    return ((com.guidewire.pc.domain.job.SubmissionPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.SubmissionPublicMethods")).hasUnsentLetter();
  }
  
  /**
   * Initializes the Submission, which sets default values for the CloseDate, JobNumber,
   * SubmissionDate, QuoteType and DateQuoteNeeded. Also assigns the creator
   * role.
   */
  public void initializeJob() {
    ((com.guidewire.pc.domain.job.SubmissionPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.SubmissionPublicMethods")).initializeJob();
  }
  
  /**
   * 
   * @return true if this submission is a full application.
   */
  public boolean isFullMode() {
    return ((com.guidewire.pc.domain.job.SubmissionPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.SubmissionPublicMethods")).isFullMode();
  }
  
  /**
   * 
   * @return true if this submission is a quick application.
   */
  public boolean isQuickMode() {
    return ((com.guidewire.pc.domain.job.SubmissionPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.SubmissionPublicMethods")).isQuickMode();
  }
  ...
  public void setBindOption(typekey.BindOption value) {
    __getInternalInterface().setFieldValue(BINDOPTION_PROP.get(), value);
  }
  ...
  public void setDateQuoteNeeded(java.util.Date value) {
    __getInternalInterface().setFieldValue(DATEQUOTENEEDED_PROP.get(), value);
  }
  ...
  public void setQuoteType(typekey.QuoteType value) {
    __getInternalInterface().setFieldValue(QUOTETYPE_PROP.get(), value);
  }
  ...
  public void setRejectReason(typekey.ReasonCode value) {
    __getInternalInterface().setFieldValue(REJECTREASON_PROP.get(), value);
  }
  ...
  public void setRejectReasonText(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(REJECTREASONTEXT_PROP.get(), value);
  }
  ...
  public void setSubmissionDate(java.util.Date value) {
    __getInternalInterface().setFieldValue(SUBMISSIONDATE_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.SubmissionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.Submission.this.__getDelegateManager();
    }
    ...
    public void startJob(java.util.Date effectiveDate, entity.ProducerCode producerCode, typekey.Jurisdiction state, gw.api.policy.PeriodFromExternalPopulator populatePeriod) {
      ((com.guidewire.pc.domain.job.impl.SubmissionInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.job.impl.SubmissionInternalMethods")).startJob(effectiveDate, producerCode, state, populatePeriod);
    }
  ...
  static {
    ...
    config.put("com.guidewire.commons.metadata.internal.version.MetadataVersionProvider", "com.guidewire.pc.domain.job.impl.SubmissionImpl");
    config.put("com.guidewire.pc.domain.job.JobPublicMethods", "com.guidewire.pc.domain.job.impl.SubmissionImpl");
    config.put("com.guidewire.pc.domain.job.SubmissionPublicMethods", "com.guidewire.pc.domain.job.impl.SubmissionImpl");
    config.put("com.guidewire.pc.domain.job.impl.JobInternalMethods", "com.guidewire.pc.domain.job.impl.SubmissionImpl");
    config.put("com.guidewire.pc.domain.job.impl.SubmissionInternalMethods", "com.guidewire.pc.domain.job.impl.SubmissionImpl");
    config.put("com.guidewire.pc.domain.note.NoteContainer", "com.guidewire.pc.domain.job.impl.SubmissionImpl");
    config.put("com.guidewire.pl.domain.assignment.impl.UserRoleOwnerInternalMethods", "com.guidewire.pc.domain.job.impl.SubmissionImpl");
    config.put("com.guidewire.pl.domain.extract.RootInfoPublicMethods", "com.guidewire.pc.domain.job.impl.SubmissionImpl");
    config.put("com.guidewire.pl.domain.extract.impl.RootInfoInternalMethods", "com.guidewire.pc.domain.job.impl.SubmissionImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.job.impl.SubmissionImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.pc.domain.job.impl.JobImpl");
    config.put("com.guidewire.pl.system.entity.DoesNotValidateOnCommit", "com.guidewire.pc.domain.job.impl.SubmissionImpl");
    config.put("gw.api.assignment.UserRoleOwner", "com.guidewire.pc.domain.job.impl.SubmissionImpl");
    config.put("gw.api.domain.document.DocumentContainer", "com.guidewire.pc.domain.job.impl.SubmissionImpl");
    config.put("gw.api.domain.linkedobject.LinkedObjectContainer", "com.guidewire.pc.domain.job.impl.SubmissionImpl");
    config.put("gw.api.history.CustomHistory", "gw.api.history.JobCustomHistoryImpl");
    config.put("gw.api.job.JobMethods", "gw.api.job.SubmissionJobMethods");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.Submission.class, config);
    com.guidewire._generated.entity.SubmissionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.Submission, com.guidewire._generated.entity.SubmissionInternal>() {
      public java.lang.Object getImplementation(entity.Submission bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.SubmissionInternal getInternalInterface(entity.Submission bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.Submission newEmptyInstance() {
        return new entity.Submission((java.lang.Void)null);
      }

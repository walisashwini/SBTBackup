...
public class SurplusRITreaty extends entity.ProportionalRIAgreement implements entity.Treaty, entity.PerRisk {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> DEPOSITPAYMENTSCHEDULE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "DepositPaymentSchedule");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IMonetaryAmountPropertyInfo> MAXRETENTION_PROP = new com.guidewire.commons.metadata.types.MonetaryAmountPropertyInfoCache(TYPE, "MaxRetention");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MAXRETENTION_AMT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "MaxRetention_amt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> MAXRETENTION_CUR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "MaxRetention_cur");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IMonetaryAmountPropertyInfo> MINDEPOSITPREMIUM_PROP = new com.guidewire.commons.metadata.types.MonetaryAmountPropertyInfoCache(TYPE, "MinDepositPremium");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MINDEPOSITPREMIUM_AMT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "MinDepositPremium_amt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> MINDEPOSITPREMIUM_CUR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "MinDepositPremium_cur");
  ...
  public typekey.DepPmntScheduleType getDepositPaymentSchedule() {
    return (typekey.DepPmntScheduleType)__getInternalInterface().getFieldValue(DEPOSITPAYMENTSCHEDULE_PROP.get());
  }
  ...
  public gw.pl.currency.MonetaryAmount getMaxRetention() {
    return (gw.pl.currency.MonetaryAmount)__getInternalInterface().getFieldValue(MAXRETENTION_PROP.get());
  }
  ...
  public java.math.BigDecimal getMaxRetention_amt() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(MAXRETENTION_AMT_PROP.get());
  }
  ...
  public typekey.Currency getMaxRetention_cur() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(MAXRETENTION_CUR_PROP.get());
  }
  ...
  public gw.pl.currency.MonetaryAmount getMinDepositPremium() {
    return (gw.pl.currency.MonetaryAmount)__getInternalInterface().getFieldValue(MINDEPOSITPREMIUM_PROP.get());
  }
  ...
  public java.math.BigDecimal getMinDepositPremium_amt() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(MINDEPOSITPREMIUM_AMT_PROP.get());
  }
  ...
  public typekey.Currency getMinDepositPremium_cur() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(MINDEPOSITPREMIUM_CUR_PROP.get());
  }
  ...
  public typekey.Currency getTreatyCurrency() {
    return ((com.guidewire.pc.domain.reinsurance.TreatyPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.reinsurance.TreatyPublicMethods")).getTreatyCurrency();
  }
  ...
  public void setDepositPaymentSchedule(typekey.DepPmntScheduleType value) {
    __getInternalInterface().setFieldValue(DEPOSITPAYMENTSCHEDULE_PROP.get(), value);
  }
  ...
  public void setMaxRetention(gw.pl.currency.MonetaryAmount value) {
    __getInternalInterface().setFieldValue(MAXRETENTION_PROP.get(), value);
  }
  
  /**
   * Sets the value of the MaxRetention_amt field.
   */
  private void setMaxRetention_amt(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(MAXRETENTION_AMT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the MaxRetention_cur field.
   */
  private void setMaxRetention_cur(typekey.Currency value) {
    __getInternalInterface().setFieldValue(MAXRETENTION_CUR_PROP.get(), value);
  }
  ...
  public void setMinDepositPremium(gw.pl.currency.MonetaryAmount value) {
    __getInternalInterface().setFieldValue(MINDEPOSITPREMIUM_PROP.get(), value);
  }
  
  /**
   * Sets the value of the MinDepositPremium_amt field.
   */
  private void setMinDepositPremium_amt(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(MINDEPOSITPREMIUM_AMT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the MinDepositPremium_cur field.
   */
  private void setMinDepositPremium_cur(typekey.Currency value) {
    __getInternalInterface().setFieldValue(MINDEPOSITPREMIUM_CUR_PROP.get(), value);
  }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.reinsurance.ProportionalRIAgreementPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.SurplusRITreatyImpl");
    config.put("com.guidewire.pc.domain.reinsurance.RIAgreementPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.SurplusRITreatyImpl");
    ...
    config.put("com.guidewire.pc.domain.reinsurance.SurplusRITreatyPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.SurplusRITreatyImpl");
    config.put("com.guidewire.pc.domain.reinsurance.TreatyPublicMethods", "com.guidewire.pc.domain.reinsurance.impl.TreatyImpl");
    config.put("com.guidewire.pc.domain.reinsurance.impl.RIAgreementInternalMethods", "com.guidewire.pc.domain.reinsurance.impl.SurplusRITreatyImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.reinsurance.impl.SurplusRITreatyImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.pc.domain.reinsurance.impl.SurplusRITreatyImpl");
    config.put("gw.api.contact.ContactOwner", "com.guidewire.pc.domain.reinsurance.impl.SurplusRITreatyImpl");
    config.put("gw.api.domain.reinsurance.RICoverageGroupOwner", "com.guidewire.pc.domain.reinsurance.impl.SurplusRITreatyImpl");
    config.put("gw.api.reinsurance.CedingRecipient", "gw.plugin.reinsurance.ProportionalCedingRecipientAdapter");

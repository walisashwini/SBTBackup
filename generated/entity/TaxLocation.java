...
/**
 * TaxLocation
 * A defined location for tax purposes.
 */
...
@gw.entity.EntityName(value = "TaxLocation")
public class TaxLocation extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.TaxLocation> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.TaxLocation>("entity.TaxLocation");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> TLPREFIX_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "TLPrefix");
  ...
  private com.guidewire._generated.entity.TaxLocationInternal _internal;
   ...
   */
  public TaxLocation(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected TaxLocation(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.TaxLocationInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.TaxLocationInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.String getTLPrefix() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(TLPREFIX_PROP.get());
  }
  ...
  public void setTLPrefix(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(TLPREFIX_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.TaxLocationInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.TaxLocation.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.TaxLocation.class, config);
    com.guidewire._generated.entity.TaxLocationInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.TaxLocation, com.guidewire._generated.entity.TaxLocationInternal>() {
      public java.lang.Object getImplementation(entity.TaxLocation bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.TaxLocationInternal getInternalInterface(entity.TaxLocation bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.TaxLocation newEmptyInstance() {
        return new entity.TaxLocation((java.lang.Void)null);
      }

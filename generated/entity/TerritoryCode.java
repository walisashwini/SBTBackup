...
/**
 * TerritoryCode
 * A territory code attached to a location.
 */
...
@gw.entity.EntityName(value = "TerritoryCode")
public class TerritoryCode extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.TerritoryCode, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.TerritoryCode, entity.PolicyPeriod>("entity.TerritoryCode");
  ...
  private com.guidewire._generated.entity.TerritoryCodeInternal _internal;
   ...
   */
  public TerritoryCode(entity.PolicyPeriod branch)  {
   ...
   */
  public TerritoryCode(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected TerritoryCode(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.TerritoryCodeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.TerritoryCodeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.TerritoryCode clone() {
    return (entity.TerritoryCode)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.TerritoryCode getBasedOn() {
    return (entity.TerritoryCode)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.TerritoryCode getBasedOnValue() {
    return (entity.TerritoryCode)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.TerritoryCode getFixed() {
    return (entity.TerritoryCode)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  /**
   * 
   * @return the line pattern for this code
   */
  public gw.api.productmodel.PolicyLinePattern getPolicyLinePattern() {
    return ((com.guidewire.pc.domain.product.TerritoryCodePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.product.TerritoryCodePublicMethods")).getPolicyLinePattern();
  }
  ...
  public entity.TerritoryCode getSlice(java.util.Date sliceDate) {
    return (entity.TerritoryCode)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.TerritoryCode getSubtype() {
    return (typekey.TerritoryCode)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.TerritoryCode getUnsliced() {
    return (entity.TerritoryCode)getUnslicedUntyped();
  }
  ...
  public entity.windowed.TerritoryCodeVersionList getVersionList() {
    return (entity.windowed.TerritoryCodeVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.TerritoryCode value) {
   ...
   */
  private void setFixed(entity.TerritoryCode value) {
  ...
  /**
   * 
   * @param pattern set the line pattern for the code to this
   */
  public void setPolicyLinePattern(gw.api.productmodel.PolicyLinePattern pattern) {
    ((com.guidewire.pc.domain.product.TerritoryCodePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.product.TerritoryCodePublicMethods")).setPolicyLinePattern(pattern);
  }
   ...
   */
  private void setSubtype(typekey.TerritoryCode value) {
  ...
  public entity.TerritoryCode split(java.util.Date splitDate) {
    return (entity.TerritoryCode)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.TerritoryCodeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.TerritoryCode.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.product.TerritoryCodePublicMethods", "com.guidewire.pc.domain.product.impl.TerritoryCodeImpl");
    ...
    config.put("gw.api.copier.EffDatedCopyable", "gw.product.TerritoryCodeEffDatedCopier");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.product.TerritoryCodeMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.product.TerritoryCodeMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.TerritoryCode.class, config);
    com.guidewire._generated.entity.TerritoryCodeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.TerritoryCode, com.guidewire._generated.entity.TerritoryCodeInternal>() {
      public java.lang.Object getImplementation(entity.TerritoryCode bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.TerritoryCodeInternal getInternalInterface(entity.TerritoryCode bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.TerritoryCode newEmptyInstance() {
        return new entity.TerritoryCode((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "TimeoutWF")
public class TimeoutWF extends entity.PolicyPeriodWorkflow {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.TimeoutWF> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.TimeoutWF>("entity.TimeoutWF");
   ...
   */
  public TimeoutWF(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected TimeoutWF(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.TimeoutWFInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.TimeoutWFInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.TimeoutWFInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.TimeoutWFInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.TimeoutWF.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.TimeoutWF.class, config);
    com.guidewire._generated.entity.TimeoutWFInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.TimeoutWF, com.guidewire._generated.entity.TimeoutWFInternal>() {
      public java.lang.Object getImplementation(entity.TimeoutWF bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.TimeoutWFInternal getInternalInterface(entity.TimeoutWF bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.TimeoutWF newEmptyInstance() {
        return new entity.TimeoutWF((java.lang.Void)null);
      }

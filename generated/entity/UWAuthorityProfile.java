...
/**
 * UWAuthorityProfile
 * A UWAuthorityProfile collects up a set of UWAuthorityGrants that can be assigned to a user.
 */
...
@gw.entity.EntityName(value = "UWAuthorityProfile")
public class UWAuthorityProfile extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.UWAuthorityProfile> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.UWAuthorityProfile>("entity.UWAuthorityProfile");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> GRANTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "Grants");
  ...
  private com.guidewire._generated.entity.UWAuthorityProfileInternal _internal;
  
  private static final com.guidewire.pl.persistence.code.DelegateMap DELEGATE_MAP;
  
  public static final gw.pl.persistence.type.DynamicEntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> RETIRED_DYNPROP = com.guidewire.pl.domain.persistence.core.RetireablePublicMethods.RETIRED_DYNPROP;
  
  public static final gw.api.admin.PublicUWAuthorityProfileFinder finder = com.guidewire.pc.domain.community.UWAuthorityProfilePublicMethods.finder;
   ...
   */
  public UWAuthorityProfile(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected UWAuthorityProfile(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.UWAuthorityProfileInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.UWAuthorityProfileInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToGrants(entity.UWAuthorityGrant element) {
    __getInternalInterface().addArrayElement(GRANTS_PROP.get(), element);
  }
  ...
  public entity.UWAuthorityProfile_Description_L10N[] getDescription_L10N_ARRAY() {
    return (entity.UWAuthorityProfile_Description_L10N[])__getInternalInterface().getFieldValue(DESCRIPTION_L10N_ARRAY_PROP.get());
  }
  ...
  public entity.UWAuthorityGrant[] getGrants() {
    return (entity.UWAuthorityGrant[])__getInternalInterface().getFieldValue(GRANTS_PROP.get());
  }
  ...
  public entity.UWAuthorityProfile_Name_L10N[] getName_L10N_ARRAY() {
    return (entity.UWAuthorityProfile_Name_L10N[])__getInternalInterface().getFieldValue(NAME_L10N_ARRAY_PROP.get());
  }
  ...
  public void removeFromGrants(entity.UWAuthorityGrant element) {
    __getInternalInterface().removeArrayElement(GRANTS_PROP.get(), element);
  }
  ...
  public void removeFromGrants(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(GRANTS_PROP.get(), elementID);
  }
   ...
   */
  private void setDescription_L10N_ARRAY(entity.UWAuthorityProfile_Description_L10N[] value) {
  ...
  public void setGrants(entity.UWAuthorityGrant[] value) {
    __getInternalInterface().setFieldValue(GRANTS_PROP.get(), value);
  }
   ...
   */
  private void setName_L10N_ARRAY(entity.UWAuthorityProfile_Name_L10N[] value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.UWAuthorityProfileInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.UWAuthorityProfile.this.__getDelegateManager();
    }
    ...
    public entity.UWAuthorityProfile_Description_L10N getDescription_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.UWAuthorityProfile_Description_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
    ...
    public entity.UWAuthorityProfile_Name_L10N getName_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.UWAuthorityProfile_Name_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.community.UWAuthorityProfilePublicMethods", "com.guidewire.pc.domain.community.impl.UWAuthorityProfileImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.UWAuthorityProfile.class, config);
    com.guidewire._generated.entity.UWAuthorityProfileInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.UWAuthorityProfile, com.guidewire._generated.entity.UWAuthorityProfileInternal>() {
      public java.lang.Object getImplementation(entity.UWAuthorityProfile bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.UWAuthorityProfileInternal getInternalInterface(entity.UWAuthorityProfile bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.UWAuthorityProfile newEmptyInstance() {
        return new entity.UWAuthorityProfile((java.lang.Void)null);
      }

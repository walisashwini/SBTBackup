...
/**
 * UWInterventionClassificationCode
 * UW Intervention Classification Codes
 */
...
@gw.entity.EntityName(value = "UWInterventionClassificationCode")
public class UWInterventionClassificationCode extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.UWInterventionClassificationCode> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.UWInterventionClassificationCode>("entity.UWInterventionClassificationCode");
  ...
  private com.guidewire._generated.entity.UWInterventionClassificationCodeInternal _internal;
   ...
   */
  public UWInterventionClassificationCode()  {
   ...
   */
  public UWInterventionClassificationCode(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected UWInterventionClassificationCode(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.UWInterventionClassificationCodeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.UWInterventionClassificationCodeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.UWInterventionClassificationCodeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.UWInterventionClassificationCode.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.UWInterventionClassificationCode.class, config);
    com.guidewire._generated.entity.UWInterventionClassificationCodeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.UWInterventionClassificationCode, com.guidewire._generated.entity.UWInterventionClassificationCodeInternal>() {
      public java.lang.Object getImplementation(entity.UWInterventionClassificationCode bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.UWInterventionClassificationCodeInternal getInternalInterface(entity.UWInterventionClassificationCode bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.UWInterventionClassificationCode newEmptyInstance() {
        return new entity.UWInterventionClassificationCode((java.lang.Void)null);
      }

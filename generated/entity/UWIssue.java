...
/**
 * UWIssue
 * A UWIssue is a raised issue of business concern.  It can be created at any point in the lifetime of a PolicyPeriod.
 */
...
@gw.entity.EntityName(value = "UWIssue")
public class UWIssue extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.UWIssueDelegate, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.UWIssue, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.UWIssue, entity.PolicyPeriod>("entity.UWIssue");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> APPROVALBLOCKINGPOINT_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "ApprovalBlockingPoint");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> APPROVALVALUE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ApprovalValue");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> APPROVINGUSER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ApprovingUser");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ARCHIVEPARTITION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ArchivePartition");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> AUTOMATICAPPROVALCAUSE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AutomaticApprovalCause");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CANEDITAPPROVALBEFOREBIND_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CanEditApprovalBeforeBind");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> HASAPPROVALORREJECTION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "HasApprovalOrRejection");
  ...
  private com.guidewire._generated.entity.UWIssueInternal _internal;
   ...
   */
  public UWIssue(entity.PolicyPeriod branch)  {
   ...
   */
  public UWIssue(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected UWIssue(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.UWIssueInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.UWIssueInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.UWIssue clone() {
    return (entity.UWIssue)__getInternalInterface().cloneUntyped();
  }
  ...
  public typekey.UWIssueBlockingPoint getApprovalBlockingPoint() {
    return (typekey.UWIssueBlockingPoint)__getInternalInterface().getFieldValue(APPROVALBLOCKINGPOINT_PROP.get());
  }
  ...
  public java.lang.String getApprovalValue() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(APPROVALVALUE_PROP.get());
  }
  ...
  public entity.User getApprovingUser() {
    return (entity.User)__getInternalInterface().getFieldValue(APPROVINGUSER_PROP.get());
  }
  ...
  public java.lang.String getAutomaticApprovalCause() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(AUTOMATICAPPROVALCAUSE_PROP.get());
  }
  
  public entity.UWIssue getBasedOn() {
    return (entity.UWIssue)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.UWIssue getBasedOnValue() {
    return (entity.UWIssue)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.UWIssue getFixed() {
    return (entity.UWIssue)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.UWIssue_LongDescription_L10N[] getLongDescription_L10N_ARRAY() {
    return (entity.UWIssue_LongDescription_L10N[])__getInternalInterface().getFieldValue(LONGDESCRIPTION_L10N_ARRAY_PROP.get());
  }
  ...
  /**
   * Returns the PolicyPeriod which owns this UWIssue.
   */
  public entity.PolicyPeriod getPolicyPeriod() {
    return ((com.guidewire.pc.domain.policy.UWIssuePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.policy.UWIssuePublicMethods")).getPolicyPeriod();
  }
  ...
  public entity.UWIssue_ShortDescription_L10N[] getShortDescription_L10N_ARRAY() {
    return (entity.UWIssue_ShortDescription_L10N[])__getInternalInterface().getFieldValue(SHORTDESCRIPTION_L10N_ARRAY_PROP.get());
  }
  ...
  public entity.UWIssue getSlice(java.util.Date sliceDate) {
    return (entity.UWIssue)getSliceUntyped(sliceDate);
  }
  ...
  public entity.UWIssue getUnsliced() {
    return (entity.UWIssue)getUnslicedUntyped();
  }
  ...
  public entity.windowed.UWIssueVersionList getVersionList() {
    return (entity.windowed.UWIssueVersionList)getVersionListUntyped();
  }
  ...
  public java.lang.Boolean isCanEditApprovalBeforeBind() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(CANEDITAPPROVALBEFOREBIND_PROP.get());
  }
  ...
  public java.lang.Boolean isHasApprovalOrRejection() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(HASAPPROVALORREJECTION_PROP.get());
  }
  ...
  public void setApprovalBlockingPoint(typekey.UWIssueBlockingPoint value) {
    __getInternalInterface().setFieldValue(APPROVALBLOCKINGPOINT_PROP.get(), value);
  }
  ...
  public void setApprovalValue(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(APPROVALVALUE_PROP.get(), value);
  }
  ...
  public void setApprovingUser(entity.User value) {
    __getInternalInterface().setFieldValue(APPROVINGUSER_PROP.get(), value);
  }
  ...
  public void setAutomaticApprovalCause(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(AUTOMATICAPPROVALCAUSE_PROP.get(), value);
  }
  
  /**
   * Sets the value of the BasedOnValue field.
   */
  private void setBasedOnValue(entity.UWIssue value) {
  ...
  public void setCanEditApprovalBeforeBind(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(CANEDITAPPROVALBEFOREBIND_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.UWIssue value) {
  ...
  public void setHasApprovalOrRejection(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(HASAPPROVALORREJECTION_PROP.get(), value);
  }
   ...
   */
  private void setLongDescription_L10N_ARRAY(entity.UWIssue_LongDescription_L10N[] value) {
   ...
   */
  private void setShortDescription_L10N_ARRAY(entity.UWIssue_ShortDescription_L10N[] value) {
  ...
  public entity.UWIssue split(java.util.Date splitDate) {
    return (entity.UWIssue)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.UWIssueInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.UWIssue.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getApprovingUserID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(APPROVINGUSER_PROP.get());
    }
    ...
    public entity.UWIssue_LongDescription_L10N getLongDescription_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.UWIssue_LongDescription_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
    ...
    public entity.UWIssue_ShortDescription_L10N getShortDescription_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.UWIssue_ShortDescription_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
    ...
    public void setApprovingUserID(gw.pl.persistence.core.Key value) {
      setFieldValue(APPROVINGUSER_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.policy.UWIssuePublicMethods", "com.guidewire.pc.domain.policy.impl.UWIssueImpl");
    ...
    config.put("gw.api.copier.EffDatedCopyable", "gw.policy.UWIssueCopier");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.policy.UWIssueMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.policy.UWIssueMatcher");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.UWIssue.class, config);
    com.guidewire._generated.entity.UWIssueInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.UWIssue, com.guidewire._generated.entity.UWIssueInternal>() {
      public java.lang.Object getImplementation(entity.UWIssue bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.UWIssueInternal getInternalInterface(entity.UWIssue bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.UWIssue newEmptyInstance() {
        return new entity.UWIssue((java.lang.Void)null);
      }

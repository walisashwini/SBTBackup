...
@gw.entity.EntityName(value = "UWIssueType")
public class UWIssueType extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.RuleVersionDependent, entity.Validatable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.UWIssueType> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.UWIssueType>("entity.UWIssueType");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> AUTOAPPROVABLE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AutoApprovable");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> CHECKINGSET_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "CheckingSet");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> COMPARATOR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "Comparator");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CREATETIME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CreateTime");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> CREATEUSER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "CreateUser");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> DEFAULTAPPROVALBLOCKINGPOINT_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "DefaultApprovalBlockingPoint");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> DEFAULTDURATIONTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "DefaultDurationType");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DEFAULTEDITBEFOREBIND_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DefaultEditBeforeBind");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> DEFAULTVALUEASSIGNMENTTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "DefaultValueAssignmentType");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DEFAULTVALUEOFFSETAMOUNT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DefaultValueOffsetAmount");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> DEFAULTVALUEOFFSETCURRENCY_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "DefaultValueOffsetCurrency");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> UWRULEARRAY_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "UWRuleArray");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> UPDATETIME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "UpdateTime");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> UPDATEUSER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "UpdateUser");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> VALUEFORMATTERTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "ValueFormatterType");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.UWIssueTypeInternal _internal;
  ...
  public static final gw.api.admin.UWIssueTypeFinder finder = com.guidewire.pc.domain.community.UWIssueTypePublicMethods.finder;
  
  public static final com.guidewire.pc.domain.community.UWIssueCheckingSetMapper mapper = com.guidewire.pc.domain.community.UWIssueTypePublicMethods.mapper;
   ...
   */
  public UWIssueType(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected UWIssueType(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.UWIssueTypeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.UWIssueTypeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public typekey.UWIssueCheckingSet getCheckingSet() {
    return (typekey.UWIssueCheckingSet)__getInternalInterface().getFieldValue(CHECKINGSET_PROP.get());
  }
  ...
  public typekey.ValueComparator getComparator() {
    return (typekey.ValueComparator)__getInternalInterface().getFieldValue(COMPARATOR_PROP.get());
  }
  ...
  public typekey.UWIssueBlockingPoint getDefaultApprovalBlockingPoint() {
    return (typekey.UWIssueBlockingPoint)__getInternalInterface().getFieldValue(DEFAULTAPPROVALBLOCKINGPOINT_PROP.get());
  }
  ...
  public typekey.UWApprovalDurationType getDefaultDurationType() {
    return (typekey.UWApprovalDurationType)__getInternalInterface().getFieldValue(DEFAULTDURATIONTYPE_PROP.get());
  }
  ...
  public typekey.UWValueAssignmentType getDefaultValueAssignmentType() {
    return (typekey.UWValueAssignmentType)__getInternalInterface().getFieldValue(DEFAULTVALUEASSIGNMENTTYPE_PROP.get());
  }
  ...
  public java.math.BigDecimal getDefaultValueOffsetAmount() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(DEFAULTVALUEOFFSETAMOUNT_PROP.get());
  }
  ...
  public typekey.Currency getDefaultValueOffsetCurrency() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(DEFAULTVALUEOFFSETCURRENCY_PROP.get());
  }
  ...
  public entity.UWIssueType_Description_L10N[] getDescription_L10N_ARRAY() {
    return (entity.UWIssueType_Description_L10N[])__getInternalInterface().getFieldValue(DESCRIPTION_L10N_ARRAY_PROP.get());
  }
  ...
  public entity.UWIssueType_Name_L10N[] getName_L10N_ARRAY() {
    return (entity.UWIssueType_Name_L10N[])__getInternalInterface().getFieldValue(NAME_L10N_ARRAY_PROP.get());
  }
  ...
  public entity.UWRule[] getUWRuleArray() {
    return (entity.UWRule[])__getInternalInterface().getFieldValue(UWRULEARRAY_PROP.get());
  }
  ...
  public typekey.ValueFormatterType getValueFormatterType() {
    return (typekey.ValueFormatterType)__getInternalInterface().getFieldValue(VALUEFORMATTERTYPE_PROP.get());
  }
  ...
  public java.lang.Boolean isAutoApprovable() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(AUTOAPPROVABLE_PROP.get());
  }
  
  public boolean isCodeUnique() {
    return ((com.guidewire.pc.domain.community.UWIssueTypePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.UWIssueTypePublicMethods")).isCodeUnique();
  }
  ...
  public java.lang.Boolean isDefaultEditBeforeBind() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(DEFAULTEDITBEFOREBIND_PROP.get());
  }
  ...
  public void setAutoApprovable(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(AUTOAPPROVABLE_PROP.get(), value);
  }
  ...
  public void setCheckingSet(typekey.UWIssueCheckingSet value) {
    __getInternalInterface().setFieldValue(CHECKINGSET_PROP.get(), value);
  }
  ...
  public void setComparator(typekey.ValueComparator value) {
    __getInternalInterface().setFieldValue(COMPARATOR_PROP.get(), value);
  }
  ...
  public void setDefaultApprovalBlockingPoint(typekey.UWIssueBlockingPoint value) {
    __getInternalInterface().setFieldValue(DEFAULTAPPROVALBLOCKINGPOINT_PROP.get(), value);
  }
  ...
  public void setDefaultDurationType(typekey.UWApprovalDurationType value) {
    __getInternalInterface().setFieldValue(DEFAULTDURATIONTYPE_PROP.get(), value);
  }
  ...
  public void setDefaultEditBeforeBind(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(DEFAULTEDITBEFOREBIND_PROP.get(), value);
  }
  ...
  public void setDefaultValueAssignmentType(typekey.UWValueAssignmentType value) {
    __getInternalInterface().setFieldValue(DEFAULTVALUEASSIGNMENTTYPE_PROP.get(), value);
  }
  ...
  public void setDefaultValueOffsetAmount(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(DEFAULTVALUEOFFSETAMOUNT_PROP.get(), value);
  }
  ...
  public void setDefaultValueOffsetCurrency(typekey.Currency value) {
    __getInternalInterface().setFieldValue(DEFAULTVALUEOFFSETCURRENCY_PROP.get(), value);
  }
   ...
   */
  private void setDescription_L10N_ARRAY(entity.UWIssueType_Description_L10N[] value) {
   ...
   */
  private void setName_L10N_ARRAY(entity.UWIssueType_Name_L10N[] value) {
   ...
   */
  private void setUWRuleArray(entity.UWRule[] value) {
    __getInternalInterface().setFieldValue(UWRULEARRAY_PROP.get(), value);
  }
  ...
  public void setValueFormatterType(typekey.ValueFormatterType value) {
    __getInternalInterface().setFieldValue(VALUEFORMATTERTYPE_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.UWIssueTypeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.UWIssueType.this.__getDelegateManager();
    }
    ...
    public void addToUWRuleArray(entity.UWRule element) {
      __getInternalInterface().addArrayElement(UWRULEARRAY_PROP.get(), element);
    }
    ...
    public entity.UWIssueType_Description_L10N getDescription_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.UWIssueType_Description_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
    ...
    public entity.UWIssueType_Name_L10N getName_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.UWIssueType_Name_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
    ...
    public void removeFromUWRuleArray(entity.UWRule element) {
      __getInternalInterface().removeArrayElement(UWRULEARRAY_PROP.get(), element);
    }
    ...
    public void removeFromUWRuleArray(gw.pl.persistence.core.Key elementID) {
      __getInternalInterface().removeArrayElement(UWRULEARRAY_PROP.get(), elementID);
    }
  ...
  static {
    ...
    config.put("com.guidewire.bizrules.management.RuleVersionAwareInternal", "com.guidewire.pc.domain.community.impl.UWIssueTypeImpl");
    config.put("com.guidewire.commons.entity.Keyable", "com.guidewire.pl.system.entity.proxy.AbstractVersionableBeanProxy");
    config.put("com.guidewire.commons.entity.Sourceable", "com.guidewire.pl.system.entity.proxy.AbstractVersionableBeanProxy");
    config.put("com.guidewire.pc.domain.community.UWIssueTypePublicMethods", "com.guidewire.pc.domain.community.impl.UWIssueTypeImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.CommitCallback", "com.guidewire.pc.domain.community.impl.UWIssueTypeImpl");
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pc.domain.community.impl.UWIssueTypeImpl");
    config.put("com.guidewire.pl.system.bundle.RemoveCallback", "com.guidewire.pc.domain.community.impl.UWIssueTypeImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.pc.domain.community.impl.UWIssueTypeImpl");
    config.put("com.guidewire.pl.system.entity.PreInitCallback", "com.guidewire.pc.domain.community.impl.UWIssueTypeImpl");
    config.put("gw.bizrules.domain.RuleVersionDependent", "com.guidewire.pc.domain.community.impl.UWIssueTypeImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.UWIssueType.class, config);
    com.guidewire._generated.entity.UWIssueTypeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.UWIssueType, com.guidewire._generated.entity.UWIssueTypeInternal>() {
      public java.lang.Object getImplementation(entity.UWIssueType bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.UWIssueTypeInternal getInternalInterface(entity.UWIssueType bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.UWIssueType newEmptyInstance() {
        return new entity.UWIssueType((java.lang.Void)null);
      }

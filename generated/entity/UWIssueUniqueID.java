...
/**
 * UWIssueUniqueID
 * A UWIssueUniqueID is an issue type/issue key pair, uniquely idenitifying a UWIssue.
 */
...
@gw.entity.EntityName(value = "UWIssueUniqueID")
public class UWIssueUniqueID extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.Extractable, entity.FrozenSetMember {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.UWIssueUniqueID> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.UWIssueUniqueID>("entity.UWIssueUniqueID");
  ...
  private com.guidewire._generated.entity.UWIssueUniqueIDInternal _internal;
   ...
   */
  public UWIssueUniqueID(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected UWIssueUniqueID(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.UWIssueUniqueIDInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.UWIssueUniqueIDInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.UWIssueUniqueIDInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.UWIssueUniqueID.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.UWIssueUniqueID.class, config);
    com.guidewire._generated.entity.UWIssueUniqueIDInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.UWIssueUniqueID, com.guidewire._generated.entity.UWIssueUniqueIDInternal>() {
      public java.lang.Object getImplementation(entity.UWIssueUniqueID bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.UWIssueUniqueIDInternal getInternalInterface(entity.UWIssueUniqueID bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.UWIssueUniqueID newEmptyInstance() {
        return new entity.UWIssueUniqueID((java.lang.Void)null);
      }

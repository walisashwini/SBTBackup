...
@gw.entity.EntityName(value = "UWIssue_ShortDescription_L10N")
public class UWIssue_ShortDescription_L10N extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.UWIssue_ShortDescription_L10N, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.UWIssue_ShortDescription_L10N, entity.PolicyPeriod>("entity.UWIssue_ShortDescription_L10N");
  ...
  private com.guidewire._generated.entity.UWIssue_ShortDescription_L10NInternal _internal;
   ...
   */
  public UWIssue_ShortDescription_L10N(entity.PolicyPeriod branch)  {
   ...
   */
  public UWIssue_ShortDescription_L10N(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected UWIssue_ShortDescription_L10N(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.UWIssue_ShortDescription_L10NInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.UWIssue_ShortDescription_L10NInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.UWIssue_ShortDescription_L10N clone() {
    return (entity.UWIssue_ShortDescription_L10N)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.UWIssue_ShortDescription_L10N getBasedOn() {
    return (entity.UWIssue_ShortDescription_L10N)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.UWIssue_ShortDescription_L10N getBasedOnValue() {
    return (entity.UWIssue_ShortDescription_L10N)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.UWIssue_ShortDescription_L10N getFixed() {
    return (entity.UWIssue_ShortDescription_L10N)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.UWIssue getOwner() {
    return (entity.UWIssue)__getInternalInterface().getFieldValue(OWNER_PROP.get());
  }
  ...
  public entity.UWIssue_ShortDescription_L10N getSlice(java.util.Date sliceDate) {
    return (entity.UWIssue_ShortDescription_L10N)getSliceUntyped(sliceDate);
  }
  ...
  public entity.UWIssue_ShortDescription_L10N getUnsliced() {
    return (entity.UWIssue_ShortDescription_L10N)getUnslicedUntyped();
  }
  ...
  public entity.windowed.UWIssue_ShortDescription_L10NVersionList getVersionList() {
    return (entity.windowed.UWIssue_ShortDescription_L10NVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.UWIssue_ShortDescription_L10N value) {
   ...
   */
  private void setFixed(entity.UWIssue_ShortDescription_L10N value) {
   ...
   */
  public void setOwner(entity.UWIssue value) {
  ...
  public entity.UWIssue_ShortDescription_L10N split(java.util.Date splitDate) {
    return (entity.UWIssue_ShortDescription_L10N)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.UWIssue_ShortDescription_L10NInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.UWIssue_ShortDescription_L10N.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.UWIssue_ShortDescription_L10N value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.UWIssue_ShortDescription_L10N value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.UWIssue_ShortDescription_L10N.class, config);
    com.guidewire._generated.entity.UWIssue_ShortDescription_L10NInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.UWIssue_ShortDescription_L10N, com.guidewire._generated.entity.UWIssue_ShortDescription_L10NInternal>() {
      public java.lang.Object getImplementation(entity.UWIssue_ShortDescription_L10N bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.UWIssue_ShortDescription_L10NInternal getInternalInterface(entity.UWIssue_ShortDescription_L10N bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.UWIssue_ShortDescription_L10N newEmptyInstance() {
        return new entity.UWIssue_ShortDescription_L10N((java.lang.Void)null);
      }

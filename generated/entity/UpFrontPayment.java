...
/**
 * UpFrontPayment
 * Entity that stores the payment information collected from the customer
 */
...
@gw.entity.EntityName(value = "UpFrontPayment")
public class UpFrontPayment extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.Extractable, entity.FrozenSetMember {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.UpFrontPayment> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.UpFrontPayment>("entity.UpFrontPayment");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PAYMENTINSTRUMENT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PaymentInstrument");
  ...
  private com.guidewire._generated.entity.UpFrontPaymentInternal _internal;
   ...
   */
  public UpFrontPayment(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected UpFrontPayment(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.UpFrontPaymentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.UpFrontPaymentInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.String getPaymentInstrument() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(PAYMENTINSTRUMENT_PROP.get());
  }
  ...
  public typekey.UpFrontPaymentMethod getPaymentMethod() {
    return (typekey.UpFrontPaymentMethod)__getInternalInterface().getFieldValue(PAYMENTMETHOD_PROP.get());
  }
  ...
  public void setPaymentInstrument(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(PAYMENTINSTRUMENT_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.UpFrontPaymentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.UpFrontPayment.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.UpFrontPayment.class, config);
    com.guidewire._generated.entity.UpFrontPaymentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.UpFrontPayment, com.guidewire._generated.entity.UpFrontPaymentInternal>() {
      public java.lang.Object getImplementation(entity.UpFrontPayment bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.UpFrontPaymentInternal getInternalInterface(entity.UpFrontPayment bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.UpFrontPayment newEmptyInstance() {
        return new entity.UpFrontPayment((java.lang.Void)null);
      }

...
public class User extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.Validatable, entity.Obfuscatable, entity.EventAware, gw.api.obfuscation.Obfuscator {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> RELATEDAGENCIES_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "RelatedAgencies");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> USEORGADDRESS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "UseOrgAddress");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> USEPRODUCERCODESECURITY_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "UseProducerCodeSecurity");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> USERAUTHORITYPROFILES_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "UserAuthorityProfiles");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> USERTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "UserType");
  ...
  public void addToGroup(entity.GroupUser gu) {
    ((com.guidewire.pc.domain.community.impl.UserCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtMethods")).addToGroup(gu);
  }
  ...
  public void addToRelatedAgencies(entity.OrganizationUnderwriter element) {
    __getInternalInterface().addArrayElement(RELATEDAGENCIES_PROP.get(), element);
  }
  
  public void addToRelatedAgenciesAndSetUnderwriterToThis(entity.OrganizationUnderwriter element) {
    ((com.guidewire.pc.domain.community.impl.UserCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtMethods")).addToRelatedAgenciesAndSetUnderwriterToThis(element);
  }
  ...
  public void addToUserAuthorityProfiles(entity.UserAuthorityProfile element) {
    __getInternalInterface().addArrayElement(USERAUTHORITYPROFILES_PROP.get(), element);
  }
  ...
  public void assertCanView(entity.KeyableBean obj) {
    ((com.guidewire.pc.domain.community.impl.UserCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtMethods")).assertCanView(obj);
  }
  
  public boolean canView(entity.KeyableBean obj) {
    return ((com.guidewire.pc.domain.community.impl.UserCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtMethods")).canView(obj);
  }
  ...
  public gw.api.database.IQueryBeanResult<entity.SecurityZone> findAvailableSecurityZones() {
    return ((com.guidewire.pc.domain.community.impl.UserCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtMethods")).findAvailableSecurityZones();
  }
  
  public java.util.Set<entity.ProducerCode> getAdditionalProducerCodes() {
    return ((com.guidewire.pc.domain.community.impl.UserCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtMethods")).getAdditionalProducerCodes();
  }
  
  public entity.Contact[] getAgencyContacts() {
    return ((com.guidewire.pc.domain.community.impl.UserCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtMethods")).getAgencyContacts();
  }
  ...
  public entity.GroupUser[] getAllGroupUsersAsArray() {
    return ((com.guidewire.pc.domain.community.impl.UserCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtMethods")).getAllGroupUsersAsArray();
  }
  ...
  public java.util.Set<entity.ProducerCode> getInheritedProducerCodes() {
    return ((com.guidewire.pc.domain.community.impl.UserCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtMethods")).getInheritedProducerCodes();
  }
  ...
  public entity.Organization getOrganizationWithUpdate() {
    return ((com.guidewire.pc.domain.community.impl.UserCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtMethods")).getOrganizationWithUpdate();
  }
  ...
  public entity.OrganizationUnderwriter[] getRelatedAgencies() {
    return (entity.OrganizationUnderwriter[])__getInternalInterface().getFieldValue(RELATEDAGENCIES_PROP.get());
  }
  ...
  public entity.UserAuthorityProfile[] getUserAuthorityProfiles() {
    return (entity.UserAuthorityProfile[])__getInternalInterface().getFieldValue(USERAUTHORITYPROFILES_PROP.get());
  }
  ...
  public typekey.UserType getUserType() {
    return (typekey.UserType)__getInternalInterface().getFieldValue(USERTYPE_PROP.get());
  }
  ...
  public boolean isOnlyContainedInGroup(entity.Group group) {
    return ((com.guidewire.pc.domain.community.impl.UserCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtMethods")).isOnlyContainedInGroup(group);
  }
  ...
  public java.lang.Boolean isUseOrgAddress() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(USEORGADDRESS_PROP.get());
  }
  ...
  public java.lang.Boolean isUseProducerCodeSecurity() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(USEPRODUCERCODESECURITY_PROP.get());
  }
  
  public entity.OrganizationSelection makeOrganizationSelection() {
    return ((com.guidewire.pc.domain.community.impl.UserCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtMethods")).makeOrganizationSelection();
  }
  ...
  public void maybeSetContactInfo() {
    ((com.guidewire.pc.domain.community.impl.UserCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtMethods")).maybeSetContactInfo();
  }
  ...
  public void removeFromGroup(entity.GroupUser groupUser) {
    ((com.guidewire.pc.domain.community.impl.UserCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtMethods")).removeFromGroup(groupUser);
  }
  ...
  public void removeFromRelatedAgencies(entity.OrganizationUnderwriter element) {
    __getInternalInterface().removeArrayElement(RELATEDAGENCIES_PROP.get(), element);
  }
  ...
  public void removeFromRelatedAgencies(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(RELATEDAGENCIES_PROP.get(), elementID);
  }
  ...
  public void removeFromUserAuthorityProfiles(entity.UserAuthorityProfile element) {
    __getInternalInterface().removeArrayElement(USERAUTHORITYPROFILES_PROP.get(), element);
  }
  ...
  public void removeFromUserAuthorityProfiles(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(USERAUTHORITYPROFILES_PROP.get(), elementID);
  }
  ...
  public boolean removeRelatedAgency(entity.Organization agency) {
    return ((com.guidewire.pc.domain.community.impl.UserCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtMethods")).removeRelatedAgency(agency);
  }
  ...
  public void setExternalUser(java.lang.Boolean value) {
    ((com.guidewire.pc.domain.community.impl.UserCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtMethods")).setExternalUser(value);
  }
  ...
  public void setOrganizationWithUpdate(entity.Organization organization) {
    ((com.guidewire.pc.domain.community.impl.UserCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtMethods")).setOrganizationWithUpdate(organization);
  }
   ...
   */
  @java.lang.Deprecated
  private void setRelatedAgencies(entity.OrganizationUnderwriter[] value) {
    __getInternalInterface().setFieldValue(RELATEDAGENCIES_PROP.get(), value);
  }
  ...
  public void setUseOrgAddress(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(USEORGADDRESS_PROP.get(), value);
  }
  ...
  public void setUseProducerCodeSecurity(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(USEPRODUCERCODESECURITY_PROP.get(), value);
  }
  ...
  public void setUserAuthorityProfiles(entity.UserAuthorityProfile[] value) {
    __getInternalInterface().setFieldValue(USERAUTHORITYPROFILES_PROP.get(), value);
  }
  ...
  public void setUserType(typekey.UserType value) {
    __getInternalInterface().setFieldValue(USERTYPE_PROP.get(), value);
  }
  ...
  public void updateUseProducerCodeSecurity(boolean value) {
    ((com.guidewire.pc.domain.community.impl.UserCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtMethods")).updateUseProducerCodeSecurity(value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.UserInternal {
    ...
    public void checkGroupsInSameOrganization(gw.api.validation.ValidationResult result) {
      ((com.guidewire.pc.domain.community.impl.UserCoreExtInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtInternalMethods")).checkGroupsInSameOrganization(result);
    }
    ...
    public entity.Group[] getAllGroupsFromDBAndBundle() {
      return ((com.guidewire.pc.domain.community.impl.UserCoreExtInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtInternalMethods")).getAllGroupsFromDBAndBundle();
    }
    ...
    public java.util.Set<entity.ProducerCode> getInheritedProducerCodes(entity.Group excludeGroup) {
      return ((com.guidewire.pc.domain.community.impl.UserCoreExtInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtInternalMethods")).getInheritedProducerCodes(excludeGroup);
    }
    ...
    public java.util.Set<entity.ProducerCode> getProducerCodes() {
      return ((com.guidewire.pc.domain.community.impl.UserCoreExtInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtInternalMethods")).getProducerCodes();
    }
    ...
    public void updateUseProducerCodeSecurityFlagBasedOnOrganization(entity.Organization organization) {
      ((com.guidewire.pc.domain.community.impl.UserCoreExtInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.community.impl.UserCoreExtInternalMethods")).updateUseProducerCodeSecurityFlagBasedOnOrganization(organization);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.community.impl.UserCoreExtInternalMethods", "com.guidewire.pc.domain.community.impl.UserCoreExtMethodsImpl");
    config.put("com.guidewire.pc.domain.community.impl.UserCoreExtMethods", "com.guidewire.pc.domain.community.impl.UserCoreExtMethodsImpl");
    config.put("com.guidewire.pl.domain.community.UserPublicMethods", "com.guidewire.pc.domain.community.impl.UserCoreExtMethodsImpl");
    config.put("com.guidewire.pl.domain.community.impl.UserInternalMethods", "com.guidewire.pc.domain.community.impl.UserCoreExtMethodsImpl");
    ...
    config.put("com.guidewire.pl.domain.validation.ValidatablePublicMethods", "com.guidewire.pc.domain.community.impl.UserCoreExtMethodsImpl");
    config.put("com.guidewire.pl.domain.validation.impl.ValidatableInternalMethods", "com.guidewire.pc.domain.community.impl.UserCoreExtMethodsImpl");
    ...
    config.put("gw.api.obfuscation.Obfuscator", "gw.personaldata.obfuscation.UserDefaultObfuscator");

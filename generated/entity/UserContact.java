 ...
 *     
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "UserContact.eti;UserContact.eix;UserContact.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "UserContact")
public class UserContact extends entity.Person implements entity.Extractable, entity.OverlapTable, gw.api.obfuscation.Obfuscator {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.UserContactInternal {
    ...
    public java.lang.Integer getAccountHolderCount() {
      return (java.lang.Integer)__getInternalInterface().getFieldValue(ACCOUNTHOLDERCOUNT_PROP.get());
    }
    ...
    public java.lang.Integer getExternalVersion() {
      return (java.lang.Integer)__getInternalInterface().getFieldValue(EXTERNALVERSION_PROP.get());
    }
    ...
    public void setAccountHolderCount(java.lang.Integer value) {
      __getInternalInterface().setFieldValue(ACCOUNTHOLDERCOUNT_PROP.get(), value);
    }
    ...
    public void setDoNotDestroy(java.lang.Boolean value, java.util.concurrent.Callable<java.lang.String> getDescription) {
      ((com.guidewire.pc.domain.contact.PCContactPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.contact.PCContactPublicMethods")).setDoNotDestroy(value, getDescription);
    }
    ...
    public void setExternalVersion(java.lang.Integer value) {
      __getInternalInterface().setFieldValue(EXTERNALVERSION_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.commons.metadata.internal.version.MetadataVersionProvider", "com.guidewire.pc.domain.contact.PCContactImpl");
    config.put("com.guidewire.pc.domain.contact.PCContactPublicMethods", "com.guidewire.pc.domain.contact.PCContactImpl");
    config.put("com.guidewire.pc.domain.personaldata.PinnableDomainMethods", "com.guidewire.pc.domain.personaldata.ContactPinnableAdapter");
    ...
    config.put("com.guidewire.pl.domain.extract.RootInfoPublicMethods", "com.guidewire.pc.domain.contact.PCContactImpl");
    config.put("com.guidewire.pl.domain.extract.impl.RootInfoInternalMethods", "com.guidewire.pc.domain.contact.PCContactImpl");
    ...
    config.put("gw.api.contact.ContactLifecycle", "gw.api.contact.PCContactLifecycle");
    config.put("gw.api.contact.ContactMinimalTags", "gw.api.contact.ContactMinimalTagsImpl");
    config.put("gw.api.history.CustomHistory", "gw.api.history.ContactCustomHistoryImpl");

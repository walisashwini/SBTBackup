...
/**
 * UserProducerCode
 * The relationship between a user and its producer codes and associated roles.
 */
...
@gw.entity.EntityName(value = "UserProducerCode")
public class UserProducerCode extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.UserProducerCode> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.UserProducerCode>("entity.UserProducerCode");
  ...
  private com.guidewire._generated.entity.UserProducerCodeInternal _internal;
   ...
   */
  public UserProducerCode(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected UserProducerCode(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.UserProducerCodeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.UserProducerCodeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.UserProducerCodeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.UserProducerCode.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.UserProducerCode.class, config);
    com.guidewire._generated.entity.UserProducerCodeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.UserProducerCode, com.guidewire._generated.entity.UserProducerCodeInternal>() {
      public java.lang.Object getImplementation(entity.UserProducerCode bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.UserProducerCodeInternal getInternalInterface(entity.UserProducerCode bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.UserProducerCode newEmptyInstance() {
        return new entity.UserProducerCode((java.lang.Void)null);
      }

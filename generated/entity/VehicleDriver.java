...
/**
 * VehicleDriver
 * Associates a vehicle and a driver in Personal Auto
 */
...
@gw.entity.EntityName(value = "VehicleDriver")
public class VehicleDriver extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, gw.api.copier.EffDatedCopyable, gw.api.domain.account.Mergeable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.VehicleDriver, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.VehicleDriver, entity.PolicyPeriod>("entity.VehicleDriver");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PERCENTAGEDRIVEN_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PercentageDriven");
  ...
  private com.guidewire._generated.entity.VehicleDriverInternal _internal;
   ...
   */
  public VehicleDriver(entity.PolicyPeriod branch)  {
   ...
   */
  public VehicleDriver(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected VehicleDriver(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.VehicleDriverInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.VehicleDriverInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.VehicleDriver clone() {
    return (entity.VehicleDriver)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.VehicleDriver getBasedOn() {
    return (entity.VehicleDriver)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.VehicleDriver getBasedOnValue() {
    return (entity.VehicleDriver)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.VehicleDriver getFixed() {
    return (entity.VehicleDriver)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public java.lang.Integer getPercentageDriven() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(PERCENTAGEDRIVEN_PROP.get());
  }
  ...
  public entity.VehicleDriver getSlice(java.util.Date sliceDate) {
    return (entity.VehicleDriver)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.VehicleDriver getSubtype() {
    return (typekey.VehicleDriver)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.VehicleDriver getUnsliced() {
    return (entity.VehicleDriver)getUnslicedUntyped();
  }
  ...
  public entity.PersonalVehicle getVehicle() {
    return (entity.PersonalVehicle)__getInternalInterface().getFieldValue(VEHICLE_PROP.get());
  }
  
  public entity.windowed.VehicleDriverVersionList getVersionList() {
    return (entity.windowed.VehicleDriverVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.VehicleDriver value) {
   ...
   */
  private void setFixed(entity.VehicleDriver value) {
  ...
  public void setPercentageDriven(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(PERCENTAGEDRIVEN_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.VehicleDriver value) {
  ...
  public entity.VehicleDriver split(java.util.Date splitDate) {
    return (entity.VehicleDriver)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.VehicleDriverInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.VehicleDriver.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.copier.EffDatedCopyable", "gw.lob.pa.VehicleDriverCopier");
    config.put("gw.api.domain.account.Mergeable", "gw.contact.VehicleDriverMergeableImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.pa.VehicleDriverMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.pa.VehicleDriverMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.VehicleDriver.class, config);
    com.guidewire._generated.entity.VehicleDriverInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.VehicleDriver, com.guidewire._generated.entity.VehicleDriverInternal>() {
      public java.lang.Object getImplementation(entity.VehicleDriver bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.VehicleDriverInternal getInternalInterface(entity.VehicleDriver bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.VehicleDriver newEmptyInstance() {
        return new entity.VehicleDriver((java.lang.Void)null);
      }

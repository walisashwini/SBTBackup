...
/**
 * WCAircraftSeat
 * Workers' Comp Aircraft Seat Data
 */
...
@gw.entity.EntityName(value = "WCAircraftSeat")
public class WCAircraftSeat extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.WCAircraftSeat, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.WCAircraftSeat, entity.PolicyPeriod>("entity.WCAircraftSeat");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> AIRCRAFTNUMBER_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AircraftNumber");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PASSENGERSEATS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PassengerSeats");
  ...
  private com.guidewire._generated.entity.WCAircraftSeatInternal _internal;
   ...
   */
  public WCAircraftSeat(entity.PolicyPeriod branch)  {
   ...
   */
  public WCAircraftSeat(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected WCAircraftSeat(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.WCAircraftSeatInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WCAircraftSeatInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.WCAircraftSeat clone() {
    return (entity.WCAircraftSeat)__getInternalInterface().cloneUntyped();
  }
  ...
  public java.lang.String getAircraftNumber() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(AIRCRAFTNUMBER_PROP.get());
  }
  ...
  public entity.WCAircraftSeat getBasedOn() {
    return (entity.WCAircraftSeat)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.WCAircraftSeat getBasedOnValue() {
    return (entity.WCAircraftSeat)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.WCAircraftSeat getFixed() {
    return (entity.WCAircraftSeat)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public java.lang.Integer getPassengerSeats() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(PASSENGERSEATS_PROP.get());
  }
  ...
  public entity.WCAircraftSeat getSlice(java.util.Date sliceDate) {
    return (entity.WCAircraftSeat)getSliceUntyped(sliceDate);
  }
  ...
  public entity.WCAircraftSeat getUnsliced() {
    return (entity.WCAircraftSeat)getUnslicedUntyped();
  }
  ...
  public entity.windowed.WCAircraftSeatVersionList getVersionList() {
    return (entity.windowed.WCAircraftSeatVersionList)getVersionListUntyped();
  }
  ...
  public void setAircraftNumber(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(AIRCRAFTNUMBER_PROP.get(), value);
  }
   ...
   */
  private void setBasedOnValue(entity.WCAircraftSeat value) {
   ...
   */
  private void setFixed(entity.WCAircraftSeat value) {
  ...
  public void setPassengerSeats(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(PASSENGERSEATS_PROP.get(), value);
  }
  ...
  public entity.WCAircraftSeat split(java.util.Date splitDate) {
    return (entity.WCAircraftSeat)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WCAircraftSeatInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WCAircraftSeat.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.wc.WCAircraftSeatMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.wc.WCAircraftSeatMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WCAircraftSeat.class, config);
    com.guidewire._generated.entity.WCAircraftSeatInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WCAircraftSeat, com.guidewire._generated.entity.WCAircraftSeatInternal>() {
      public java.lang.Object getImplementation(entity.WCAircraftSeat bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WCAircraftSeatInternal getInternalInterface(entity.WCAircraftSeat bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WCAircraftSeat newEmptyInstance() {
        return new entity.WCAircraftSeat((java.lang.Void)null);
      }

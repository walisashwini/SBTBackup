...
/**
 * WCCededPremium
 * A Workers' Comp implementation of the RICededPremium delegate
 */
...
@gw.entity.EntityName(value = "WCCededPremium")
public class WCCededPremium extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.RICededPremium, entity.FrozenSetMember, gw.api.reinsurance.RICededPremiumAdapter {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.WCCededPremium> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.WCCededPremium>("entity.WCCededPremium");
  ...
  private com.guidewire._generated.entity.WCCededPremiumInternal _internal;
   ...
   */
  public WCCededPremium(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected WCCededPremium(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.WCCededPremiumInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WCCededPremiumInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.WCCededPremiumHistory[] getCedingHistory() {
    return (entity.WCCededPremiumHistory[])__getInternalInterface().getFieldValue(CEDINGHISTORY_PROP.get());
  }
  ...
  public entity.WCCededPremiumTransaction[] getCedingTransactions() {
    return (entity.WCCededPremiumTransaction[])__getInternalInterface().getFieldValue(CEDINGTRANSACTIONS_PROP.get());
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WCCededPremiumInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WCCededPremium.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.reinsurance.RICededPremiumAdapter", "gw.reinsurance.ceding.WCCededPremiumAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WCCededPremium.class, config);
    com.guidewire._generated.entity.WCCededPremiumInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WCCededPremium, com.guidewire._generated.entity.WCCededPremiumInternal>() {
      public java.lang.Object getImplementation(entity.WCCededPremium bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WCCededPremiumInternal getInternalInterface(entity.WCCededPremium bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WCCededPremium newEmptyInstance() {
        return new entity.WCCededPremium((java.lang.Void)null);
      }

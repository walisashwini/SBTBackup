...
/**
 * WCCededPremiumTransaction
 * A Workers' Comp implementation of the RICededPremiumTransaction delegate
 */
...
@gw.entity.EntityName(value = "WCCededPremiumTransaction")
public class WCCededPremiumTransaction extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.RICededPremiumTransaction, entity.FrozenSetMember, gw.api.reinsurance.RICededPremiumTxnAdapter {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.WCCededPremiumTransaction> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.WCCededPremiumTransaction>("entity.WCCededPremiumTransaction");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> WCCEDEDPREMIUM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "WCCededPremium");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> WCCEDEDPREMIUMHISTORY_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "WCCededPremiumHistory");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.WCCededPremiumTransactionInternal _internal;
   ...
   */
  public WCCededPremiumTransaction()  {
   ...
   */
  public WCCededPremiumTransaction(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected WCCededPremiumTransaction(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.WCCededPremiumTransactionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WCCededPremiumTransactionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.WCCededPremium getWCCededPremium() {
    return (entity.WCCededPremium)__getInternalInterface().getFieldValue(WCCEDEDPREMIUM_PROP.get());
  }
  ...
  public entity.WCCededPremiumHistory getWCCededPremiumHistory() {
    return (entity.WCCededPremiumHistory)__getInternalInterface().getFieldValue(WCCEDEDPREMIUMHISTORY_PROP.get());
  }
  ...
  public void setWCCededPremium(entity.WCCededPremium value) {
    __getInternalInterface().setFieldValue(WCCEDEDPREMIUM_PROP.get(), value);
  }
  ...
  public void setWCCededPremiumHistory(entity.WCCededPremiumHistory value) {
    __getInternalInterface().setFieldValue(WCCEDEDPREMIUMHISTORY_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WCCededPremiumTransactionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WCCededPremiumTransaction.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getWCCededPremiumHistoryID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(WCCEDEDPREMIUMHISTORY_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getWCCededPremiumID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(WCCEDEDPREMIUM_PROP.get());
    }
    ...
    public void setWCCededPremiumHistoryID(gw.pl.persistence.core.Key value) {
      setFieldValue(WCCEDEDPREMIUMHISTORY_PROP.get(), value);
    }
    
    public void setWCCededPremiumID(gw.pl.persistence.core.Key value) {
      setFieldValue(WCCEDEDPREMIUM_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.reinsurance.RICededPremiumTxnAdapter", "gw.reinsurance.ceding.WCCededPremiumTransactionAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WCCededPremiumTransaction.class, config);
    com.guidewire._generated.entity.WCCededPremiumTransactionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WCCededPremiumTransaction, com.guidewire._generated.entity.WCCededPremiumTransactionInternal>() {
      public java.lang.Object getImplementation(entity.WCCededPremiumTransaction bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WCCededPremiumTransactionInternal getInternalInterface(entity.WCCededPremiumTransaction bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WCCededPremiumTransaction newEmptyInstance() {
        return new entity.WCCededPremiumTransaction((java.lang.Void)null);
      }

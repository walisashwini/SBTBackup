...
/**
 * WCClassCode
 * Workers' comp class codes.  Premium calculations are driven by class codes and both premium and losses are reported by class codes to rating bureaus.
 */
...
@gw.entity.EntityName(value = "WCClassCode")
public class WCClassCode extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.SimpleEffDated {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.WCClassCode> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.WCClassCode>("entity.WCClassCode");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> SHORTDESC_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ShortDesc");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> SHORTDESC_L10N_ARRAY_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "ShortDesc_L10N_ARRAY");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> UPDATETIME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "UpdateTime");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> UPDATEUSER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "UpdateUser");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> WCDOMAIN_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "WCDomain");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.WCClassCodeInternal _internal;
   ...
   */
  public WCClassCode(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected WCClassCode(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.WCClassCodeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WCClassCodeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.WCClassCode_Classification_L10N[] getClassification_L10N_ARRAY() {
    return (entity.WCClassCode_Classification_L10N[])__getInternalInterface().getFieldValue(CLASSIFICATION_L10N_ARRAY_PROP.get());
  }
  ...
  public java.lang.String getShortDesc() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(SHORTDESC_PROP.get());
  }
  ...
  public entity.WCClassCode_ShortDesc_L10N[] getShortDesc_L10N_ARRAY() {
    return (entity.WCClassCode_ShortDesc_L10N[])__getInternalInterface().getFieldValue(SHORTDESC_L10N_ARRAY_PROP.get());
  }
  
  /**
   * Array association accessor for key en_US on array ShortDesc_L10N_ARRAY
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getShortDesc_en_US() {
    return (java.lang.String)__getInternalInterface().getLocalizedFieldValueForCodeGen((com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo)TYPE.get().getTypeInfo().getProperty("ShortDesc_en_US"));
  }
  ...
  public java.lang.String getWCDomain() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(WCDOMAIN_PROP.get());
  }
   ...
   */
  private void setClassification_L10N_ARRAY(entity.WCClassCode_Classification_L10N[] value) {
  ...
  public void setShortDesc(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(SHORTDESC_PROP.get(), value);
  }
  
  /**
   * Sets the value of the ShortDesc_L10N_ARRAY field.
   */
  private void setShortDesc_L10N_ARRAY(entity.WCClassCode_ShortDesc_L10N[] value) {
    __getInternalInterface().setFieldValue(SHORTDESC_L10N_ARRAY_PROP.get(), value);
  }
  
  /**
   * Array association mutator for key ShortDesc_ on array ShortDesc_L10N_ARRAY
   */
  public void setShortDesc_en_US(java.lang.String value) {
    __getInternalInterface().setLocalizedFieldValueForCodeGen((com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo)TYPE.get().getTypeInfo().getProperty("ShortDesc_en_US"), value);
  }
  ...
  public void setWCDomain(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(WCDOMAIN_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WCClassCodeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WCClassCode.this.__getDelegateManager();
    }
    ...
    public void addToShortDesc_L10N_ARRAY(entity.WCClassCode_ShortDesc_L10N element) {
      __getInternalInterface().addArrayElement(SHORTDESC_L10N_ARRAY_PROP.get(), element);
    }
    ...
    public entity.WCClassCode_Classification_L10N getClassification_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.WCClassCode_Classification_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
    ...
    public entity.WCClassCode_ShortDesc_L10N getShortDesc_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.WCClassCode_ShortDesc_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
    ...
    public void removeFromShortDesc_L10N_ARRAY(entity.WCClassCode_ShortDesc_L10N element) {
      __getInternalInterface().removeArrayElement(SHORTDESC_L10N_ARRAY_PROP.get(), element);
    }
    ...
    public void removeFromShortDesc_L10N_ARRAY(gw.pl.persistence.core.Key elementID) {
      __getInternalInterface().removeArrayElement(SHORTDESC_L10N_ARRAY_PROP.get(), elementID);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WCClassCode.class, config);
    com.guidewire._generated.entity.WCClassCodeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WCClassCode, com.guidewire._generated.entity.WCClassCodeInternal>() {
      public java.lang.Object getImplementation(entity.WCClassCode bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WCClassCodeInternal getInternalInterface(entity.WCClassCode bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WCClassCode newEmptyInstance() {
        return new entity.WCClassCode((java.lang.Void)null);
      }

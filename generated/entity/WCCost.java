...
/**
 * WCCost
 * A WorkersComp unit of price for a period of time that should not be broken up any further.
 */
...
public abstract class WCCost extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.WCCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.WCCost, entity.PolicyPeriod>("entity.WCCost");
  ...
  private com.guidewire._generated.entity.WCCostInternal _internal;
  ...
  protected WCCost(java.lang.Void ignored)  {
    
  }
  
  protected abstract com.guidewire._generated.entity.WCCostInternal __createInternalInterface();
  ...
  protected com.guidewire._generated.entity.WCCostInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.WCCost clone() {
    return (entity.WCCost)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.WCCost getBasedOn() {
    return (entity.WCCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.WCCost getSlice(java.util.Date sliceDate) {
    return (entity.WCCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.WCCost getUnsliced() {
    return (entity.WCCost)getUnslicedUntyped();
  }
  ...
  public entity.windowed.WCCostVersionList getVersionList() {
    return (entity.windowed.WCCostVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.WCCost value) {
   ...
   */
  private void setFixed(entity.WCCost value) {
   ...
   */
  private void setSubtype(typekey.WCCost value) {
   ...
   */
  private void setTransactions(entity.WCTransaction[] value) {
  ...
  public entity.WCCost split(java.util.Date splitDate) {
    return (entity.WCCost)splitUntyped(splitDate);
  }
  ...
  static {
    com.guidewire._generated.entity.WCCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.EntityFriendAccess<entity.WCCost, com.guidewire._generated.entity.WCCostInternal>() {
      public java.lang.Object getImplementation(entity.WCCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WCCostInternal getInternalInterface(entity.WCCost bean) {
        if(bean == null) {
          return null;
        };

...
/**
 * WCCovEmpCost
 * A unit of price for a period of time, not to be broken up any further, for a Workers' Comp employee coverage
 */
...
@gw.entity.EntityName(value = "WCCovEmpCost")
public class WCCovEmpCost extends entity.WCCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.WCCovEmpCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.WCCovEmpCost, entity.PolicyPeriod>("entity.WCCovEmpCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> WCCOVEREDEMPLOYEE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "WCCoveredEmployee");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> WORKERSCOMPCOV_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "WorkersCompCov");
   ...
   */
  public WCCovEmpCost(entity.PolicyPeriod branch)  {
   ...
   */
  public WCCovEmpCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected WCCovEmpCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.WCCovEmpCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WCCovEmpCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.WCCovEmpCostInternal)super.__getInternalInterface();
  }
  
  public entity.WCCovEmpCost clone() {
    return (entity.WCCovEmpCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.WCCovEmpCost getBasedOn() {
    return (entity.WCCovEmpCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.WCCovEmpCost getSlice(java.util.Date sliceDate) {
    return (entity.WCCovEmpCost)getSliceUntyped(sliceDate);
  }
  
  public entity.WCCovEmpCost getUnsliced() {
    return (entity.WCCovEmpCost)getUnslicedUntyped();
  }
  
  public entity.windowed.WCCovEmpCostVersionList getVersionList() {
    return (entity.windowed.WCCovEmpCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.WCCoveredEmployee getWCCoveredEmployee() {
    return (entity.WCCoveredEmployee)__getInternalInterface().getFieldValue(WCCOVEREDEMPLOYEE_PROP.get());
  }
  ...
  public entity.WorkersCompCov getWorkersCompCov() {
    return (entity.WorkersCompCov)__getInternalInterface().getFieldValue(WORKERSCOMPCOV_PROP.get());
  }
  ...
  public void setWCCoveredEmployee(entity.WCCoveredEmployee value) {
    __getInternalInterface().setFieldValue(WCCOVEREDEMPLOYEE_PROP.get(), value);
  }
  ...
  public void setWorkersCompCov(entity.WorkersCompCov value) {
    __getInternalInterface().setFieldValue(WORKERSCOMPCOV_PROP.get(), value);
  }
  
  public entity.WCCovEmpCost split(java.util.Date splitDate) {
    return (entity.WCCovEmpCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WCCovEmpCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WCCovEmpCost.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getWCCoveredEmployeeID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(WCCOVEREDEMPLOYEE_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getWorkersCompCovID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(WORKERSCOMPCOV_PROP.get());
    }
    ...
    public void setWCCoveredEmployeeID(gw.pl.persistence.core.Key value) {
      setFieldValue(WCCOVEREDEMPLOYEE_PROP.get(), value);
    }
    ...
    public void setWorkersCompCovID(gw.pl.persistence.core.Key value) {
      setFieldValue(WORKERSCOMPCOV_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.lob.wc.financials.WCCostMethods", "gw.lob.wc.financials.WCCovEmpCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WCCovEmpCost.class, config);
    com.guidewire._generated.entity.WCCovEmpCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WCCovEmpCost, com.guidewire._generated.entity.WCCovEmpCostInternal>() {
      public java.lang.Object getImplementation(entity.WCCovEmpCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WCCovEmpCostInternal getInternalInterface(entity.WCCovEmpCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WCCovEmpCost newEmptyInstance() {
        return new entity.WCCovEmpCost((java.lang.Void)null);
      }

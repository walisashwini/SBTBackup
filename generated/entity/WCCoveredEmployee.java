...
@gw.entity.EntityName(value = "WCCoveredEmployee")
public class WCCoveredEmployee extends entity.WCCoveredEmployeeBase {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.WCCoveredEmployee, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.WCCoveredEmployee, entity.PolicyPeriod>("entity.WCCoveredEmployee");
   ...
   */
  public WCCoveredEmployee(entity.PolicyPeriod branch)  {
   ...
   */
  public WCCoveredEmployee(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected WCCoveredEmployee(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.WCCoveredEmployeeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WCCoveredEmployeeInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.WCCoveredEmployeeInternal)super.__getInternalInterface();
  }
  ...
  public entity.WCCoveredEmployee clone() {
    return (entity.WCCoveredEmployee)__getInternalInterface().cloneUntyped();
  }
  
  public entity.WCCoveredEmployee getBasedOn() {
    return (entity.WCCoveredEmployee)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.WCCoveredEmployee getSlice(java.util.Date sliceDate) {
    return (entity.WCCoveredEmployee)getSliceUntyped(sliceDate);
  }
  
  public entity.WCCoveredEmployee getUnsliced() {
    return (entity.WCCoveredEmployee)getUnslicedUntyped();
  }
  
  public entity.windowed.WCCoveredEmployeeVersionList getVersionList() {
    return (entity.windowed.WCCoveredEmployeeVersionList)getVersionListUntyped();
  }
  ...
  public entity.WCCoveredEmployee split(java.util.Date splitDate) {
    return (entity.WCCoveredEmployee)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WCCoveredEmployeeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WCCoveredEmployee.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WCCoveredEmployee.class, config);
    com.guidewire._generated.entity.WCCoveredEmployeeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WCCoveredEmployee, com.guidewire._generated.entity.WCCoveredEmployeeInternal>() {
      public java.lang.Object getImplementation(entity.WCCoveredEmployee bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WCCoveredEmployeeInternal getInternalInterface(entity.WCCoveredEmployee bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WCCoveredEmployee newEmptyInstance() {
        return new entity.WCCoveredEmployee((java.lang.Void)null);
      }

 ...
 * A Workers' Comp Covered Employee
 */
...
public abstract class WCCoveredEmployeeBase extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Auditable, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.WCCoveredEmployeeBase, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.WCCoveredEmployeeBase, entity.PolicyPeriod>("entity.WCCoveredEmployeeBase");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ARCHIVEPARTITION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ArchivePartition");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> AUDITEDAMOUNT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AuditedAmount");
  ...
  private com.guidewire._generated.entity.WCCoveredEmployeeBaseInternal _internal;
  ...
  protected WCCoveredEmployeeBase(java.lang.Void ignored)  {
    
  }
  
  protected abstract com.guidewire._generated.entity.WCCoveredEmployeeBaseInternal __createInternalInterface();
  ...
  protected com.guidewire._generated.entity.WCCoveredEmployeeBaseInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.WCCoveredEmployeeBase clone() {
    return (entity.WCCoveredEmployeeBase)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.WCCoveredEmployeeBase getBasedOn() {
    return (entity.WCCoveredEmployeeBase)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.WCCoveredEmployeeBase getSlice(java.util.Date sliceDate) {
    return (entity.WCCoveredEmployeeBase)getSliceUntyped(sliceDate);
  }
  ...
  public entity.WCCoveredEmployeeBase getUnsliced() {
    return (entity.WCCoveredEmployeeBase)getUnslicedUntyped();
  }
  ...
  public entity.windowed.WCCoveredEmployeeBaseVersionList getVersionList() {
    return (entity.windowed.WCCoveredEmployeeBaseVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.WCCoveredEmployeeBase value) {
   ...
   */
  private void setFixed(entity.WCCoveredEmployeeBase value) {
   ...
   */
  private void setSubtype(typekey.WCCoveredEmployeeBase value) {
  ...
  public entity.WCCoveredEmployeeBase split(java.util.Date splitDate) {
    return (entity.WCCoveredEmployeeBase)splitUntyped(splitDate);
  }
  ...
  static {
    com.guidewire._generated.entity.WCCoveredEmployeeBaseInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.EntityFriendAccess<entity.WCCoveredEmployeeBase, com.guidewire._generated.entity.WCCoveredEmployeeBaseInternal>() {
      public java.lang.Object getImplementation(entity.WCCoveredEmployeeBase bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WCCoveredEmployeeBaseInternal getInternalInterface(entity.WCCoveredEmployeeBase bean) {
        if(bean == null) {
          return null;
        };

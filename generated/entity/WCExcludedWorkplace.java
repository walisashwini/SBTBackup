...
/**
 * WCExcludedWorkplace
 * Defines an exclusion for workplaces.
 */
...
@gw.entity.EntityName(value = "WCExcludedWorkplace")
public class WCExcludedWorkplace extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.WCExcludedWorkplace, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.WCExcludedWorkplace, entity.PolicyPeriod>("entity.WCExcludedWorkplace");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> EXCLUDEDITEM_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ExcludedItem");
  ...
  private com.guidewire._generated.entity.WCExcludedWorkplaceInternal _internal;
   ...
   */
  public WCExcludedWorkplace(entity.PolicyPeriod branch)  {
   ...
   */
  public WCExcludedWorkplace(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected WCExcludedWorkplace(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.WCExcludedWorkplaceInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WCExcludedWorkplaceInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.WCExcludedWorkplace clone() {
    return (entity.WCExcludedWorkplace)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.WCExcludedWorkplace getBasedOn() {
    return (entity.WCExcludedWorkplace)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.WCExcludedWorkplace getBasedOnValue() {
    return (entity.WCExcludedWorkplace)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public java.lang.String getExcludedItem() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(EXCLUDEDITEM_PROP.get());
  }
  ...
  public entity.WCExcludedWorkplace getFixed() {
    return (entity.WCExcludedWorkplace)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.WCExcludedWorkplace getSlice(java.util.Date sliceDate) {
    return (entity.WCExcludedWorkplace)getSliceUntyped(sliceDate);
  }
  ...
  public entity.WCExcludedWorkplace getUnsliced() {
    return (entity.WCExcludedWorkplace)getUnslicedUntyped();
  }
  ...
  public entity.windowed.WCExcludedWorkplaceVersionList getVersionList() {
    return (entity.windowed.WCExcludedWorkplaceVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.WCExcludedWorkplace value) {
  ...
  public void setExcludedItem(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(EXCLUDEDITEM_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.WCExcludedWorkplace value) {
  ...
  public entity.WCExcludedWorkplace split(java.util.Date splitDate) {
    return (entity.WCExcludedWorkplace)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WCExcludedWorkplaceInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WCExcludedWorkplace.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.wc.WCExcludedWorkplaceMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.wc.WCExcludedWorkplaceMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WCExcludedWorkplace.class, config);
    com.guidewire._generated.entity.WCExcludedWorkplaceInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WCExcludedWorkplace, com.guidewire._generated.entity.WCExcludedWorkplaceInternal>() {
      public java.lang.Object getImplementation(entity.WCExcludedWorkplace bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WCExcludedWorkplaceInternal getInternalInterface(entity.WCExcludedWorkplace bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WCExcludedWorkplace newEmptyInstance() {
        return new entity.WCExcludedWorkplace((java.lang.Void)null);
      }

 ...
 * A Workers' Comp Federal Covered Employee
 */
...
@gw.entity.EntityName(value = "WCFedCoveredEmployee")
public class WCFedCoveredEmployee extends entity.WCCoveredEmployeeBase {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.WCFedCoveredEmployee, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.WCFedCoveredEmployee, entity.PolicyPeriod>("entity.WCFedCoveredEmployee");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> RAILROADORVESSEL_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "RailroadOrVessel");
   ...
   */
  public WCFedCoveredEmployee(entity.PolicyPeriod branch)  {
   ...
   */
  public WCFedCoveredEmployee(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected WCFedCoveredEmployee(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.WCFedCoveredEmployeeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WCFedCoveredEmployeeInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.WCFedCoveredEmployeeInternal)super.__getInternalInterface();
  }
  
  public entity.WCFedCoveredEmployee clone() {
    return (entity.WCFedCoveredEmployee)__getInternalInterface().cloneUntyped();
  }
  
  public entity.WCFedCoveredEmployee getBasedOn() {
    return (entity.WCFedCoveredEmployee)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  /**
   * Gets the value of the RailroadOrVessel field.
   * Railroad or vessel name for program 1
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getRailroadOrVessel() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(RAILROADORVESSEL_PROP.get());
  }
  
  public entity.WCFedCoveredEmployee getSlice(java.util.Date sliceDate) {
    return (entity.WCFedCoveredEmployee)getSliceUntyped(sliceDate);
  }
  
  public entity.WCFedCoveredEmployee getUnsliced() {
    return (entity.WCFedCoveredEmployee)getUnslicedUntyped();
  }
  
  public entity.windowed.WCFedCoveredEmployeeVersionList getVersionList() {
    return (entity.windowed.WCFedCoveredEmployeeVersionList)getVersionListUntyped();
  }
  
  /**
   * Sets the value of the RailroadOrVessel field.
   */
  public void setRailroadOrVessel(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(RAILROADORVESSEL_PROP.get(), value);
  }
  
  public entity.WCFedCoveredEmployee split(java.util.Date splitDate) {
    return (entity.WCFedCoveredEmployee)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WCFedCoveredEmployeeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WCFedCoveredEmployee.this.__getDelegateManager();
    }
    ...
    public java.lang.Integer getAuditedAmount() {
      return (java.lang.Integer)__getInternalInterface().getFieldValue(AUDITEDAMOUNT_PROP.get());
    }
    ...
    public entity.WCCoveredEmployeeBase getBasedOnValue() {
      return (entity.WCCoveredEmployeeBase)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public entity.WCCoveredEmployeeBase getFixed() {
      return (entity.WCCoveredEmployeeBase)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public typekey.WCCoveredEmployeeBase getSubtype() {
      return (typekey.WCCoveredEmployeeBase)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
    ...
    public void setAuditedAmount(java.lang.Integer value) {
      __getInternalInterface().setFieldValue(AUDITEDAMOUNT_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.wc.WCCoveredEmployeeBaseMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.wc.WCCoveredEmployeeBaseMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WCFedCoveredEmployee.class, config);
    com.guidewire._generated.entity.WCFedCoveredEmployeeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WCFedCoveredEmployee, com.guidewire._generated.entity.WCFedCoveredEmployeeInternal>() {
      public java.lang.Object getImplementation(entity.WCFedCoveredEmployee bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WCFedCoveredEmployeeInternal getInternalInterface(entity.WCFedCoveredEmployee bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WCFedCoveredEmployee newEmptyInstance() {
        return new entity.WCFedCoveredEmployee((java.lang.Void)null);
      }

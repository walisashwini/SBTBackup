...
/**
 * WCFormAssociation
 * Associates a Workers' Comp waiver of subrogation entity with its related form.
 */
...
@gw.entity.EntityName(value = "WCFormAssociation")
public class WCFormAssociation extends entity.FormAssociation {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.WCFormAssociation, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.WCFormAssociation, entity.PolicyPeriod>("entity.WCFormAssociation");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> WCWAIVEROFSUBRO_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "WCWaiverOfSubro");
   ...
   */
  public WCFormAssociation(entity.PolicyPeriod branch)  {
   ...
   */
  public WCFormAssociation(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected WCFormAssociation(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.WCFormAssociationInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WCFormAssociationInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.WCFormAssociationInternal)super.__getInternalInterface();
  }
  
  public entity.WCFormAssociation clone() {
    return (entity.WCFormAssociation)__getInternalInterface().cloneUntyped();
  }
  
  public entity.WCFormAssociation getBasedOn() {
    return (entity.WCFormAssociation)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.WCFormAssociation getSlice(java.util.Date sliceDate) {
    return (entity.WCFormAssociation)getSliceUntyped(sliceDate);
  }
  
  public entity.WCFormAssociation getUnsliced() {
    return (entity.WCFormAssociation)getUnslicedUntyped();
  }
  
  public entity.windowed.WCFormAssociationVersionList getVersionList() {
    return (entity.windowed.WCFormAssociationVersionList)getVersionListUntyped();
  }
  
  /**
   * Gets the value of the WCWaiverOfSubro field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.WCWaiverOfSubro getWCWaiverOfSubro() {
    return (entity.WCWaiverOfSubro)__getInternalInterface().getFieldValue(WCWAIVEROFSUBRO_PROP.get());
  }
  
  /**
   * Sets the value of the WCWaiverOfSubro field.
   */
  public void setWCWaiverOfSubro(entity.WCWaiverOfSubro value) {
    __getInternalInterface().setFieldValue(WCWAIVEROFSUBRO_PROP.get(), value);
  }
  
  public entity.WCFormAssociation split(java.util.Date splitDate) {
    return (entity.WCFormAssociation)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WCFormAssociationInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WCFormAssociation.this.__getDelegateManager();
    }
    ...
    public entity.FormAssociation getBasedOnValue() {
      return (entity.FormAssociation)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public entity.FormAssociation getFixed() {
      return (entity.FormAssociation)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public entity.Form getForm() {
      return (entity.Form)__getInternalInterface().getFieldValue(FORM_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getFormID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(FORM_PROP.get());
    }
    ...
    public typekey.FormAssociation getSubtype() {
      return (typekey.FormAssociation)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getWCWaiverOfSubroID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(WCWAIVEROFSUBRO_PROP.get());
    }
    ...
    public void setForm(entity.Form value) {
      __getInternalInterface().setFieldValue(FORM_PROP.get(), value);
    }
    
    public void setFormID(gw.pl.persistence.core.Key value) {
      setFieldValue(FORM_PROP.get(), value);
    }
    ...
    public void setWCWaiverOfSubroID(gw.pl.persistence.core.Key value) {
      setFieldValue(WCWAIVEROFSUBRO_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WCFormAssociation.class, config);
    com.guidewire._generated.entity.WCFormAssociationInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WCFormAssociation, com.guidewire._generated.entity.WCFormAssociationInternal>() {
      public java.lang.Object getImplementation(entity.WCFormAssociation bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WCFormAssociationInternal getInternalInterface(entity.WCFormAssociation bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WCFormAssociation newEmptyInstance() {
        return new entity.WCFormAssociation((java.lang.Void)null);
      }

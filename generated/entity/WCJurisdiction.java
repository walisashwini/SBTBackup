...
/**
 * WCJurisdiction
 * Container for state-level elements: coverages, modifiers, etc.
 */
...
@gw.entity.EntityName(value = "WCJurisdiction")
public class WCJurisdiction extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverable, entity.Modifiable, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.WCJurisdiction, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.WCJurisdiction, entity.PolicyPeriod>("entity.WCJurisdiction");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ANNIVERSARYDATEINTERNAL_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AnniversaryDateInternal");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> RATINGPERIODSTARTDATES_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "RatingPeriodStartDates");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> WCMODIFIERS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "WCModifiers");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.WCJurisdictionInternal _internal;
   ...
   */
  public WCJurisdiction(entity.PolicyPeriod branch)  {
   ...
   */
  public WCJurisdiction(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected WCJurisdiction(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.WCJurisdictionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WCJurisdictionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToRatingPeriodStartDates(entity.RatingPeriodStartDate element) {
    __getInternalInterface().addArrayElement(RATINGPERIODSTARTDATES_PROP.get(), element);
  }
  ...
  public void addToWCModifiers(entity.WCModifier element) {
    __getInternalInterface().addArrayElement(WCMODIFIERS_PROP.get(), element);
  }
  ...
  public entity.WCJurisdiction clone() {
    return (entity.WCJurisdiction)__getInternalInterface().cloneUntyped();
  }
  ...
  public java.util.Date getAnniversaryDateInternal() {
    return (java.util.Date)__getInternalInterface().getFieldValue(ANNIVERSARYDATEINTERNAL_PROP.get());
  }
  ...
  public entity.WCJurisdiction getBasedOn() {
    return (entity.WCJurisdiction)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.WCJurisdiction getBasedOnValue() {
    return (entity.WCJurisdiction)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.WCJurisdictionCost[] getCosts() {
    return (entity.WCJurisdictionCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
  }
  ...
  public entity.WCStateCov[] getCoverages() {
    return (entity.WCStateCov[])__getInternalInterface().getFieldValue(COVERAGES_PROP.get());
  }
  ...
  public entity.WCJurisdiction getFixed() {
    return (entity.WCJurisdiction)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.RatingPeriodStartDate[] getRatingPeriodStartDates() {
    return (entity.RatingPeriodStartDate[])__getInternalInterface().getFieldValue(RATINGPERIODSTARTDATES_PROP.get());
  }
  ...
  public entity.WCJurisdiction getSlice(java.util.Date sliceDate) {
    return (entity.WCJurisdiction)getSliceUntyped(sliceDate);
  }
  ...
  public entity.WCJurisdiction getUnsliced() {
    return (entity.WCJurisdiction)getUnslicedUntyped();
  }
  ...
  public entity.windowed.WCJurisdictionVersionList getVersionList() {
    return (entity.windowed.WCJurisdictionVersionList)getVersionListUntyped();
  }
  ...
  public entity.WCModifier[] getWCModifiers() {
    return (entity.WCModifier[])__getInternalInterface().getFieldValue(WCMODIFIERS_PROP.get());
  }
  ...
  public void removeFromRatingPeriodStartDates(entity.RatingPeriodStartDate element) {
    __getInternalInterface().removeArrayElement(RATINGPERIODSTARTDATES_PROP.get(), element);
  }
  ...
  public void removeFromRatingPeriodStartDates(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(RATINGPERIODSTARTDATES_PROP.get(), elementID);
  }
  ...
  public void removeFromWCModifiers(entity.WCModifier element) {
    __getInternalInterface().removeArrayElement(WCMODIFIERS_PROP.get(), element);
  }
  ...
  public void removeFromWCModifiers(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(WCMODIFIERS_PROP.get(), elementID);
  }
  
  /**
   * Sets the value of the AnniversaryDateInternal field.
   */
  private void setAnniversaryDateInternal(java.util.Date value) {
    __getInternalInterface().setFieldValue(ANNIVERSARYDATEINTERNAL_PROP.get(), value);
  }
   ...
   */
  private void setBasedOnValue(entity.WCJurisdiction value) {
   ...
   */
  private void setFixed(entity.WCJurisdiction value) {
  ...
  public void setRatingPeriodStartDates(entity.RatingPeriodStartDate[] value) {
    __getInternalInterface().setFieldValue(RATINGPERIODSTARTDATES_PROP.get(), value);
  }
  ...
  public void setWCModifiers(entity.WCModifier[] value) {
    __getInternalInterface().setFieldValue(WCMODIFIERS_PROP.get(), value);
  }
  
  public entity.WCJurisdiction split(java.util.Date splitDate) {
    return (entity.WCJurisdiction)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WCJurisdictionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WCJurisdiction.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.coverage.CoverablePublicMethods", "com.guidewire.pc.domain.coverage.impl.WCJurisdictionCoverableImpl");
    ...
    config.put("gw.api.copier.EffDatedCopyable", "gw.lob.wc.WCJurisdictionCopier");
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.wc.WCJurisdictionCoverableModifiableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.wc.WCJurisdictionCoverableModifiableAdapter");
    config.put("gw.api.domain.ModifiableAdapter", "gw.lob.wc.WCJurisdictionCoverableModifiableAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.wc.WCJurisdictionMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.wc.WCJurisdictionMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WCJurisdiction.class, config);
    com.guidewire._generated.entity.WCJurisdictionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WCJurisdiction, com.guidewire._generated.entity.WCJurisdictionInternal>() {
      public java.lang.Object getImplementation(entity.WCJurisdiction bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WCJurisdictionInternal getInternalInterface(entity.WCJurisdiction bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WCJurisdiction newEmptyInstance() {
        return new entity.WCJurisdiction((java.lang.Void)null);
      }

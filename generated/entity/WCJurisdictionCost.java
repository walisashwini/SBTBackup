...
/**
 * WCJurisdictionCost
 * A unit of price for a period of time, not to be broken up any further, for a Workers' Comp jurisdiction
 */
...
@gw.entity.EntityName(value = "WCJurisdictionCost")
public class WCJurisdictionCost extends entity.WCCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.WCJurisdictionCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.WCJurisdictionCost, entity.PolicyPeriod>("entity.WCJurisdictionCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> STATCODE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "StatCode");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> WCJURISDICTION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "WCJurisdiction");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> WCJURISDICTIONCOSTTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "WCJurisdictionCostType");
   ...
   */
  public WCJurisdictionCost(entity.PolicyPeriod branch)  {
   ...
   */
  public WCJurisdictionCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected WCJurisdictionCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.WCJurisdictionCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WCJurisdictionCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.WCJurisdictionCostInternal)super.__getInternalInterface();
  }
  
  public entity.WCJurisdictionCost clone() {
    return (entity.WCJurisdictionCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.WCJurisdictionCost getBasedOn() {
    return (entity.WCJurisdictionCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.WCJurisdictionCost getSlice(java.util.Date sliceDate) {
    return (entity.WCJurisdictionCost)getSliceUntyped(sliceDate);
  }
  ...
  public java.lang.String getStatCode() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(STATCODE_PROP.get());
  }
  
  public entity.WCJurisdictionCost getUnsliced() {
    return (entity.WCJurisdictionCost)getUnslicedUntyped();
  }
  
  public entity.windowed.WCJurisdictionCostVersionList getVersionList() {
    return (entity.windowed.WCJurisdictionCostVersionList)getVersionListUntyped();
  }
  ...
  public entity.WCJurisdiction getWCJurisdiction() {
    return (entity.WCJurisdiction)__getInternalInterface().getFieldValue(WCJURISDICTION_PROP.get());
  }
  ...
  public typekey.WCJurisdictionCostType getWCJurisdictionCostType() {
    return (typekey.WCJurisdictionCostType)__getInternalInterface().getFieldValue(WCJURISDICTIONCOSTTYPE_PROP.get());
  }
  ...
  public void setStatCode(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(STATCODE_PROP.get(), value);
  }
  ...
  public void setWCJurisdiction(entity.WCJurisdiction value) {
    __getInternalInterface().setFieldValue(WCJURISDICTION_PROP.get(), value);
  }
  ...
  public void setWCJurisdictionCostType(typekey.WCJurisdictionCostType value) {
    __getInternalInterface().setFieldValue(WCJURISDICTIONCOSTTYPE_PROP.get(), value);
  }
  
  public entity.WCJurisdictionCost split(java.util.Date splitDate) {
    return (entity.WCJurisdictionCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WCJurisdictionCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WCJurisdictionCost.this.__getDelegateManager();
    }
    ...
    public entity.WCCost getBasedOnValue() {
      return (entity.WCCost)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public entity.WCCost getFixed() {
      return (entity.WCCost)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public typekey.WCCost getSubtype() {
      return (typekey.WCCost)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
    ...
    public entity.WCTransaction[] getTransactions() {
      return (entity.WCTransaction[])__getInternalInterface().getFieldValue(TRANSACTIONS_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getWCJurisdictionID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(WCJURISDICTION_PROP.get());
    }
    ...
    public void setWCJurisdictionID(gw.pl.persistence.core.Key value) {
      setFieldValue(WCJURISDICTION_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.financials.CostAdapter", "gw.lob.wc.financials.WCCostAdapter");
    config.put("gw.lob.wc.financials.WCCostMethods", "gw.lob.wc.financials.WCJurisdictionCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WCJurisdictionCost.class, config);
    com.guidewire._generated.entity.WCJurisdictionCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WCJurisdictionCost, com.guidewire._generated.entity.WCJurisdictionCostInternal>() {
      public java.lang.Object getImplementation(entity.WCJurisdictionCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WCJurisdictionCostInternal getInternalInterface(entity.WCJurisdictionCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WCJurisdictionCost newEmptyInstance() {
        return new entity.WCJurisdictionCost((java.lang.Void)null);
      }

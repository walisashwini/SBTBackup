...
@gw.entity.EntityName(value = "WCLaborContactDetail")
public class WCLaborContactDetail extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, gw.api.copier.EffDatedCopyable, gw.api.domain.account.Mergeable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.WCLaborContactDetail, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.WCLaborContactDetail, entity.PolicyPeriod>("entity.WCLaborContactDetail");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CONTRACTEFFECTIVEDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ContractEffectiveDate");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CONTRACTEXPIRATIONDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ContractExpirationDate");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CREATETIME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CreateTime");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> CREATEUSER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "CreateUser");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DESCRIPTIONOFDUTIES_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DescriptionOfDuties");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> INCLUSION_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "Inclusion");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> NUMBEROFEMPLOYEES_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "NumberOfEmployees");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> WCLABORCONTACT_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "WCLaborContact");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> WORKLOCATION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "WorkLocation");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.WCLaborContactDetailInternal _internal;
   ...
   */
  public WCLaborContactDetail(entity.PolicyPeriod branch)  {
   ...
   */
  public WCLaborContactDetail(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected WCLaborContactDetail(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.WCLaborContactDetailInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WCLaborContactDetailInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.WCLaborContactDetail clone() {
    return (entity.WCLaborContactDetail)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.WCLaborContactDetail getBasedOn() {
    return (entity.WCLaborContactDetail)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.WCLaborContactDetail getBasedOnValue() {
    return (entity.WCLaborContactDetail)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public java.util.Date getContractEffectiveDate() {
    return (java.util.Date)__getInternalInterface().getFieldValue(CONTRACTEFFECTIVEDATE_PROP.get());
  }
  ...
  public java.util.Date getContractExpirationDate() {
    return (java.util.Date)__getInternalInterface().getFieldValue(CONTRACTEXPIRATIONDATE_PROP.get());
  }
  ...
  public java.lang.String getDescriptionOfDuties() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(DESCRIPTIONOFDUTIES_PROP.get());
  }
  ...
  public entity.WCLaborContactDetail getFixed() {
    return (entity.WCLaborContactDetail)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public typekey.Inclusion getInclusion() {
    return (typekey.Inclusion)__getInternalInterface().getFieldValue(INCLUSION_PROP.get());
  }
  ...
  public java.lang.Integer getNumberOfEmployees() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(NUMBEROFEMPLOYEES_PROP.get());
  }
  ...
  public entity.WCLaborContactDetail getSlice(java.util.Date sliceDate) {
    return (entity.WCLaborContactDetail)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.WCLaborContactDetail getSubtype() {
    return (typekey.WCLaborContactDetail)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.WCLaborContactDetail getUnsliced() {
    return (entity.WCLaborContactDetail)getUnslicedUntyped();
  }
  ...
  public entity.windowed.WCLaborContactDetailVersionList getVersionList() {
    return (entity.windowed.WCLaborContactDetailVersionList)getVersionListUntyped();
  }
  ...
  public entity.WCLaborContact getWCLaborContact() {
    return (entity.WCLaborContact)__getInternalInterface().getFieldValue(WCLABORCONTACT_PROP.get());
  }
  ...
  public java.lang.String getWorkLocation() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(WORKLOCATION_PROP.get());
  }
   ...
   */
  private void setBasedOnValue(entity.WCLaborContactDetail value) {
  ...
  public void setContractEffectiveDate(java.util.Date value) {
    __getInternalInterface().setFieldValue(CONTRACTEFFECTIVEDATE_PROP.get(), value);
  }
  ...
  public void setContractExpirationDate(java.util.Date value) {
    __getInternalInterface().setFieldValue(CONTRACTEXPIRATIONDATE_PROP.get(), value);
  }
  ...
  public void setDescriptionOfDuties(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(DESCRIPTIONOFDUTIES_PROP.get(), value);
  }
   ...
   */
  private void setFixed(entity.WCLaborContactDetail value) {
  ...
  public void setInclusion(typekey.Inclusion value) {
    __getInternalInterface().setFieldValue(INCLUSION_PROP.get(), value);
  }
  ...
  public void setNumberOfEmployees(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(NUMBEROFEMPLOYEES_PROP.get(), value);
  }
   ...
   */
  private void setSubtype(typekey.WCLaborContactDetail value) {
  ...
  public void setWCLaborContact(entity.WCLaborContact value) {
    __getInternalInterface().setFieldValue(WCLABORCONTACT_PROP.get(), value);
  }
  ...
  public void setWorkLocation(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(WORKLOCATION_PROP.get(), value);
  }
  
  public entity.WCLaborContactDetail split(java.util.Date splitDate) {
    return (entity.WCLaborContactDetail)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WCLaborContactDetailInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WCLaborContactDetail.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getWCLaborContactID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(WCLABORCONTACT_PROP.get());
    }
    ...
    public void setWCLaborContactID(gw.pl.persistence.core.Key value) {
      setFieldValue(WCLABORCONTACT_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.copier.EffDatedCopyable", "gw.lob.wc.contact.WCLaborContactDetailCopier");
    config.put("gw.api.domain.account.Mergeable", "gw.account.EffDatedDefaultMergeableImpl");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.wc.contact.WCLaborContactDetailMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.wc.contact.WCLaborContactDetailMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WCLaborContactDetail.class, config);
    com.guidewire._generated.entity.WCLaborContactDetailInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WCLaborContactDetail, com.guidewire._generated.entity.WCLaborContactDetailInternal>() {
      public java.lang.Object getImplementation(entity.WCLaborContactDetail bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WCLaborContactDetailInternal getInternalInterface(entity.WCLaborContactDetail bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WCLaborContactDetail newEmptyInstance() {
        return new entity.WCLaborContactDetail((java.lang.Void)null);
      }

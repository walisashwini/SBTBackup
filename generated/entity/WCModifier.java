...
/**
 * WCModifier
 * A line-level modifier for Workers' Comp
 */
...
@gw.entity.EntityName(value = "WCModifier")
public class WCModifier extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Modifier, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.WCModifier, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.WCModifier, entity.PolicyPeriod>("entity.WCModifier");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> WCRATEFACTORS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "WCRateFactors");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.WCModifierInternal _internal;
   ...
   */
  public WCModifier(entity.PolicyPeriod branch)  {
   ...
   */
  public WCModifier(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected WCModifier(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.WCModifierInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WCModifierInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToWCRateFactors(entity.WCRateFactor element) {
    __getInternalInterface().addArrayElement(WCRATEFACTORS_PROP.get(), element);
  }
  ...
  public entity.WCModifier clone() {
    return (entity.WCModifier)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.WCModifier getBasedOn() {
    return (entity.WCModifier)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.WCModifier getBasedOnValue() {
    return (entity.WCModifier)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.WCModifier getFixed() {
    return (entity.WCModifier)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.WCModifier getSlice(java.util.Date sliceDate) {
    return (entity.WCModifier)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.WCModifier getSubtype() {
    return (typekey.WCModifier)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.WCModifier getUnsliced() {
    return (entity.WCModifier)getUnslicedUntyped();
  }
  ...
  public entity.windowed.WCModifierVersionList getVersionList() {
    return (entity.windowed.WCModifierVersionList)getVersionListUntyped();
  }
  ...
  public entity.WCRateFactor[] getWCRateFactors() {
    return (entity.WCRateFactor[])__getInternalInterface().getFieldValue(WCRATEFACTORS_PROP.get());
  }
  ...
  public void removeFromWCRateFactors(entity.WCRateFactor element) {
    __getInternalInterface().removeArrayElement(WCRATEFACTORS_PROP.get(), element);
  }
  ...
  public void removeFromWCRateFactors(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(WCRATEFACTORS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.WCModifier value) {
   ...
   */
  private void setFixed(entity.WCModifier value) {
   ...
   */
  private void setSubtype(typekey.WCModifier value) {
  ...
  public void setWCRateFactors(entity.WCRateFactor[] value) {
    __getInternalInterface().setFieldValue(WCRATEFACTORS_PROP.get(), value);
  }
  
  public entity.WCModifier split(java.util.Date splitDate) {
    return (entity.WCModifier)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WCModifierInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WCModifier.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ModifierAbstractDomainMethods", "gw.lob.wc.WCModifierAdapter");
    config.put("gw.api.domain.ModifierAdapter", "gw.lob.wc.WCModifierAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.wc.WCModifierMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.wc.WCModifierMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WCModifier.class, config);
    com.guidewire._generated.entity.WCModifierInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WCModifier, com.guidewire._generated.entity.WCModifierInternal>() {
      public java.lang.Object getImplementation(entity.WCModifier bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WCModifierInternal getInternalInterface(entity.WCModifier bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WCModifier newEmptyInstance() {
        return new entity.WCModifier((java.lang.Void)null);
      }

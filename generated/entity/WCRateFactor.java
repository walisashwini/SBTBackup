...
@gw.entity.EntityName(value = "WCRateFactor")
public class WCRateFactor extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.RateFactor, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.WCRateFactor, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.WCRateFactor, entity.PolicyPeriod>("entity.WCRateFactor");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> WCMODIFIER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "WCModifier");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.WCRateFactorInternal _internal;
   ...
   */
  public WCRateFactor(entity.PolicyPeriod branch)  {
   ...
   */
  public WCRateFactor(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected WCRateFactor(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.WCRateFactorInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WCRateFactorInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.WCRateFactor clone() {
    return (entity.WCRateFactor)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.WCRateFactor getBasedOn() {
    return (entity.WCRateFactor)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.WCRateFactor getBasedOnValue() {
    return (entity.WCRateFactor)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.WCRateFactor getFixed() {
    return (entity.WCRateFactor)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.WCRateFactor getSlice(java.util.Date sliceDate) {
    return (entity.WCRateFactor)getSliceUntyped(sliceDate);
  }
  ...
  public entity.WCRateFactor getUnsliced() {
    return (entity.WCRateFactor)getUnslicedUntyped();
  }
  ...
  public entity.windowed.WCRateFactorVersionList getVersionList() {
    return (entity.windowed.WCRateFactorVersionList)getVersionListUntyped();
  }
  ...
  /**
   * Gets the value of the WCModifier field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.WCModifier getWCModifier() {
    return (entity.WCModifier)__getInternalInterface().getFieldValue(WCMODIFIER_PROP.get());
  }
   ...
   */
  private void setBasedOnValue(entity.WCRateFactor value) {
   ...
   */
  private void setFixed(entity.WCRateFactor value) {
  ...
  /**
   * Sets the value of the WCModifier field.
   */
  public void setWCModifier(entity.WCModifier value) {
    __getInternalInterface().setFieldValue(WCMODIFIER_PROP.get(), value);
  }
  
  public entity.WCRateFactor split(java.util.Date splitDate) {
    return (entity.WCRateFactor)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WCRateFactorInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WCRateFactor.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getWCModifierID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(WCMODIFIER_PROP.get());
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.WCRateFactor value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.WCRateFactor value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
    ...
    public void setWCModifierID(gw.pl.persistence.core.Key value) {
      setFieldValue(WCMODIFIER_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.RateFactorAdapter", "gw.lob.wc.WCRateFactorAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.wc.WCRateFactorMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.wc.WCRateFactorMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WCRateFactor.class, config);
    com.guidewire._generated.entity.WCRateFactorInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WCRateFactor, com.guidewire._generated.entity.WCRateFactorInternal>() {
      public java.lang.Object getImplementation(entity.WCRateFactor bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WCRateFactorInternal getInternalInterface(entity.WCRateFactor bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WCRateFactor newEmptyInstance() {
        return new entity.WCRateFactor((java.lang.Void)null);
      }

...
@gw.entity.EntityName(value = "WCRetroRatingLetterOfCredit")
public class WCRetroRatingLetterOfCredit extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.WCRetroRatingLetterOfCredit, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.WCRetroRatingLetterOfCredit, entity.PolicyPeriod>("entity.WCRetroRatingLetterOfCredit");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ISSUERNAME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "IssuerName");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> VALIDFROM_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ValidFrom");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> VALIDTO_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ValidTo");
  ...
  private com.guidewire._generated.entity.WCRetroRatingLetterOfCreditInternal _internal;
   ...
   */
  public WCRetroRatingLetterOfCredit(entity.PolicyPeriod branch)  {
   ...
   */
  public WCRetroRatingLetterOfCredit(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected WCRetroRatingLetterOfCredit(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.WCRetroRatingLetterOfCreditInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WCRetroRatingLetterOfCreditInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.WCRetroRatingLetterOfCredit clone() {
    return (entity.WCRetroRatingLetterOfCredit)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.WCRetroRatingLetterOfCredit getBasedOn() {
    return (entity.WCRetroRatingLetterOfCredit)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.WCRetroRatingLetterOfCredit getBasedOnValue() {
    return (entity.WCRetroRatingLetterOfCredit)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.WCRetroRatingLetterOfCredit getFixed() {
    return (entity.WCRetroRatingLetterOfCredit)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public java.lang.String getIssuerName() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(ISSUERNAME_PROP.get());
  }
  ...
  public entity.WCRetroRatingLetterOfCredit getSlice(java.util.Date sliceDate) {
    return (entity.WCRetroRatingLetterOfCredit)getSliceUntyped(sliceDate);
  }
  ...
  public entity.WCRetroRatingLetterOfCredit getUnsliced() {
    return (entity.WCRetroRatingLetterOfCredit)getUnslicedUntyped();
  }
  ...
  public java.util.Date getValidFrom() {
    return (java.util.Date)__getInternalInterface().getFieldValue(VALIDFROM_PROP.get());
  }
  ...
  public java.util.Date getValidTo() {
    return (java.util.Date)__getInternalInterface().getFieldValue(VALIDTO_PROP.get());
  }
  
  public entity.windowed.WCRetroRatingLetterOfCreditVersionList getVersionList() {
    return (entity.windowed.WCRetroRatingLetterOfCreditVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.WCRetroRatingLetterOfCredit value) {
   ...
   */
  private void setFixed(entity.WCRetroRatingLetterOfCredit value) {
  ...
  public void setIssuerName(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(ISSUERNAME_PROP.get(), value);
  }
  ...
  public void setValidFrom(java.util.Date value) {
    __getInternalInterface().setFieldValue(VALIDFROM_PROP.get(), value);
  }
  ...
  public void setValidTo(java.util.Date value) {
    __getInternalInterface().setFieldValue(VALIDTO_PROP.get(), value);
  }
  ...
  public entity.WCRetroRatingLetterOfCredit split(java.util.Date splitDate) {
    return (entity.WCRetroRatingLetterOfCredit)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WCRetroRatingLetterOfCreditInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WCRetroRatingLetterOfCredit.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WCRetroRatingLetterOfCredit.class, config);
    com.guidewire._generated.entity.WCRetroRatingLetterOfCreditInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WCRetroRatingLetterOfCredit, com.guidewire._generated.entity.WCRetroRatingLetterOfCreditInternal>() {
      public java.lang.Object getImplementation(entity.WCRetroRatingLetterOfCredit bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WCRetroRatingLetterOfCreditInternal getInternalInterface(entity.WCRetroRatingLetterOfCredit bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WCRetroRatingLetterOfCredit newEmptyInstance() {
        return new entity.WCRetroRatingLetterOfCredit((java.lang.Void)null);
      }

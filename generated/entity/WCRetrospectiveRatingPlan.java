 ...
 * A plan for retrospectively rating a policy line
 */
...
@gw.entity.EntityName(value = "WCRetrospectiveRatingPlan")
public class WCRetrospectiveRatingPlan extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.WCRetrospectiveRatingPlan, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.WCRetrospectiveRatingPlan, entity.PolicyPeriod>("entity.WCRetrospectiveRatingPlan");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BASICPREMIUMFACTOR1_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BasicPremiumFactor1");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BASICPREMIUMFACTOR2_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BasicPremiumFactor2");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BASICPREMIUMFACTOR3_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BasicPremiumFactor3");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> COMPUTATIONINTERVAL_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ComputationInterval");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IMonetaryAmountPropertyInfo> ESTIMATEDSTANDARDPREMIUM_PROP = new com.guidewire.commons.metadata.types.MonetaryAmountPropertyInfoCache(TYPE, "EstimatedStandardPremium");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ESTIMATEDSTANDARDPREMIUM_AMT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "EstimatedStandardPremium_amt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> ESTIMATEDSTANDARDPREMIUM_CUR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "EstimatedStandardPremium_cur");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> FIRSTCOMPUTATIONDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "FirstComputationDate");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> INCLUDEALAE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "IncludeALAE");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LASTCOMPUTATIONDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LastComputationDate");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> LETTERSOFCREDIT_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "LettersOfCredit");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LOSSCONVERSIONFACTOR_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LossConversionFactor");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IMonetaryAmountPropertyInfo> LOSSLIMITAMOUNT_PROP = new com.guidewire.commons.metadata.types.MonetaryAmountPropertyInfoCache(TYPE, "LossLimitAmount");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LOSSLIMITAMOUNT_AMT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LossLimitAmount_amt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> LOSSLIMITAMOUNT_CUR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "LossLimitAmount_cur");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MAXRETROPREMIUMRATIO_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "MaxRetroPremiumRatio");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MINRETROPREMIUMRATIO_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "MinRetroPremiumRatio");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PERCENTSTANDARDPREMIUM1_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PercentStandardPremium1");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PERCENTSTANDARDPREMIUM2_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PercentStandardPremium2");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PERCENTSTANDARDPREMIUM3_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PercentStandardPremium3");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PUBLICID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PublicID");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> STATEMULTIPLIERS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "StateMultipliers");
  ...
  private com.guidewire._generated.entity.WCRetrospectiveRatingPlanInternal _internal;
   ...
   */
  public WCRetrospectiveRatingPlan(entity.PolicyPeriod branch)  {
   ...
   */
  public WCRetrospectiveRatingPlan(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected WCRetrospectiveRatingPlan(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.WCRetrospectiveRatingPlanInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WCRetrospectiveRatingPlanInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToLettersOfCredit(entity.WCRetroRatingLetterOfCredit element) {
    __getInternalInterface().addArrayElement(LETTERSOFCREDIT_PROP.get(), element);
  }
  ...
  public void addToStateMultipliers(entity.WCStateMultiplier element) {
    __getInternalInterface().addArrayElement(STATEMULTIPLIERS_PROP.get(), element);
  }
  
  public entity.WCRetrospectiveRatingPlan clone() {
    return (entity.WCRetrospectiveRatingPlan)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.WCRetrospectiveRatingPlan getBasedOn() {
    return (entity.WCRetrospectiveRatingPlan)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.WCRetrospectiveRatingPlan getBasedOnValue() {
    return (entity.WCRetrospectiveRatingPlan)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public java.math.BigDecimal getBasicPremiumFactor1() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(BASICPREMIUMFACTOR1_PROP.get());
  }
  ...
  public java.math.BigDecimal getBasicPremiumFactor2() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(BASICPREMIUMFACTOR2_PROP.get());
  }
  ...
  public java.math.BigDecimal getBasicPremiumFactor3() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(BASICPREMIUMFACTOR3_PROP.get());
  }
  ...
  public java.lang.Integer getComputationInterval() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(COMPUTATIONINTERVAL_PROP.get());
  }
  ...
  public gw.pl.currency.MonetaryAmount getEstimatedStandardPremium() {
    return (gw.pl.currency.MonetaryAmount)__getInternalInterface().getFieldValue(ESTIMATEDSTANDARDPREMIUM_PROP.get());
  }
  ...
  public java.math.BigDecimal getEstimatedStandardPremium_amt() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(ESTIMATEDSTANDARDPREMIUM_AMT_PROP.get());
  }
  ...
  public typekey.Currency getEstimatedStandardPremium_cur() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(ESTIMATEDSTANDARDPREMIUM_CUR_PROP.get());
  }
  ...
  public java.util.Date getFirstComputationDate() {
    return (java.util.Date)__getInternalInterface().getFieldValue(FIRSTCOMPUTATIONDATE_PROP.get());
  }
  ...
  public entity.WCRetrospectiveRatingPlan getFixed() {
    return (entity.WCRetrospectiveRatingPlan)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public java.util.Date getLastComputationDate() {
    return (java.util.Date)__getInternalInterface().getFieldValue(LASTCOMPUTATIONDATE_PROP.get());
  }
  ...
  public entity.WCRetroRatingLetterOfCredit[] getLettersOfCredit() {
    return (entity.WCRetroRatingLetterOfCredit[])__getInternalInterface().getFieldValue(LETTERSOFCREDIT_PROP.get());
  }
  ...
  public java.math.BigDecimal getLossConversionFactor() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(LOSSCONVERSIONFACTOR_PROP.get());
  }
  ...
  public gw.pl.currency.MonetaryAmount getLossLimitAmount() {
    return (gw.pl.currency.MonetaryAmount)__getInternalInterface().getFieldValue(LOSSLIMITAMOUNT_PROP.get());
  }
  ...
  public java.math.BigDecimal getLossLimitAmount_amt() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(LOSSLIMITAMOUNT_AMT_PROP.get());
  }
  ...
  public typekey.Currency getLossLimitAmount_cur() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(LOSSLIMITAMOUNT_CUR_PROP.get());
  }
  ...
  public java.math.BigDecimal getMaxRetroPremiumRatio() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(MAXRETROPREMIUMRATIO_PROP.get());
  }
  ...
  public java.math.BigDecimal getMinRetroPremiumRatio() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(MINRETROPREMIUMRATIO_PROP.get());
  }
  ...
  public java.math.BigDecimal getPercentStandardPremium1() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(PERCENTSTANDARDPREMIUM1_PROP.get());
  }
  ...
  public java.math.BigDecimal getPercentStandardPremium2() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(PERCENTSTANDARDPREMIUM2_PROP.get());
  }
  ...
  public java.math.BigDecimal getPercentStandardPremium3() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(PERCENTSTANDARDPREMIUM3_PROP.get());
  }
  ...
  public entity.WCRetrospectiveRatingPlan getSlice(java.util.Date sliceDate) {
    return (entity.WCRetrospectiveRatingPlan)getSliceUntyped(sliceDate);
  }
  ...
  public entity.WCStateMultiplier[] getStateMultipliers() {
    return (entity.WCStateMultiplier[])__getInternalInterface().getFieldValue(STATEMULTIPLIERS_PROP.get());
  }
  
  public entity.WCRetrospectiveRatingPlan getUnsliced() {
    return (entity.WCRetrospectiveRatingPlan)getUnslicedUntyped();
  }
  ...
  public entity.windowed.WCRetrospectiveRatingPlanVersionList getVersionList() {
    return (entity.windowed.WCRetrospectiveRatingPlanVersionList)getVersionListUntyped();
  }
  ...
  public java.lang.Boolean isIncludeALAE() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(INCLUDEALAE_PROP.get());
  }
  ...
  public void removeFromLettersOfCredit(entity.WCRetroRatingLetterOfCredit element) {
    __getInternalInterface().removeArrayElement(LETTERSOFCREDIT_PROP.get(), element);
  }
  ...
  public void removeFromLettersOfCredit(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(LETTERSOFCREDIT_PROP.get(), elementID);
  }
  ...
  public void removeFromStateMultipliers(entity.WCStateMultiplier element) {
    __getInternalInterface().removeArrayElement(STATEMULTIPLIERS_PROP.get(), element);
  }
  ...
  public void removeFromStateMultipliers(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(STATEMULTIPLIERS_PROP.get(), elementID);
  }
   ...
   */
  private void setBasedOnValue(entity.WCRetrospectiveRatingPlan value) {
  ...
  public void setBasicPremiumFactor1(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(BASICPREMIUMFACTOR1_PROP.get(), value);
  }
  ...
  public void setBasicPremiumFactor2(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(BASICPREMIUMFACTOR2_PROP.get(), value);
  }
  ...
  public void setBasicPremiumFactor3(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(BASICPREMIUMFACTOR3_PROP.get(), value);
  }
  ...
  public void setComputationInterval(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(COMPUTATIONINTERVAL_PROP.get(), value);
  }
  ...
  public void setEstimatedStandardPremium(gw.pl.currency.MonetaryAmount value) {
    __getInternalInterface().setFieldValue(ESTIMATEDSTANDARDPREMIUM_PROP.get(), value);
  }
  
  /**
   * Sets the value of the EstimatedStandardPremium_amt field.
   */
  private void setEstimatedStandardPremium_amt(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(ESTIMATEDSTANDARDPREMIUM_AMT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the EstimatedStandardPremium_cur field.
   */
  private void setEstimatedStandardPremium_cur(typekey.Currency value) {
    __getInternalInterface().setFieldValue(ESTIMATEDSTANDARDPREMIUM_CUR_PROP.get(), value);
  }
  ...
  public void setFirstComputationDate(java.util.Date value) {
    __getInternalInterface().setFieldValue(FIRSTCOMPUTATIONDATE_PROP.get(), value);
  }
  
  /**
   * Sets the value of the Fixed field.
   */
  private void setFixed(entity.WCRetrospectiveRatingPlan value) {
  ...
  public void setIncludeALAE(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(INCLUDEALAE_PROP.get(), value);
  }
  ...
  public void setLastComputationDate(java.util.Date value) {
    __getInternalInterface().setFieldValue(LASTCOMPUTATIONDATE_PROP.get(), value);
  }
  ...
  public void setLettersOfCredit(entity.WCRetroRatingLetterOfCredit[] value) {
    __getInternalInterface().setFieldValue(LETTERSOFCREDIT_PROP.get(), value);
  }
  ...
  public void setLossConversionFactor(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(LOSSCONVERSIONFACTOR_PROP.get(), value);
  }
  ...
  public void setLossLimitAmount(gw.pl.currency.MonetaryAmount value) {
    __getInternalInterface().setFieldValue(LOSSLIMITAMOUNT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the LossLimitAmount_amt field.
   */
  private void setLossLimitAmount_amt(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(LOSSLIMITAMOUNT_AMT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the LossLimitAmount_cur field.
   */
  private void setLossLimitAmount_cur(typekey.Currency value) {
    __getInternalInterface().setFieldValue(LOSSLIMITAMOUNT_CUR_PROP.get(), value);
  }
  ...
  public void setMaxRetroPremiumRatio(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(MAXRETROPREMIUMRATIO_PROP.get(), value);
  }
  ...
  public void setMinRetroPremiumRatio(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(MINRETROPREMIUMRATIO_PROP.get(), value);
  }
  ...
  public void setPercentStandardPremium1(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(PERCENTSTANDARDPREMIUM1_PROP.get(), value);
  }
  ...
  public void setPercentStandardPremium2(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(PERCENTSTANDARDPREMIUM2_PROP.get(), value);
  }
  ...
  public void setPercentStandardPremium3(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(PERCENTSTANDARDPREMIUM3_PROP.get(), value);
  }
  ...
  public void setStateMultipliers(entity.WCStateMultiplier[] value) {
    __getInternalInterface().setFieldValue(STATEMULTIPLIERS_PROP.get(), value);
  }
  ...
  public entity.WCRetrospectiveRatingPlan split(java.util.Date splitDate) {
    return (entity.WCRetrospectiveRatingPlan)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WCRetrospectiveRatingPlanInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WCRetrospectiveRatingPlan.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getWorkersCompLineID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(WORKERSCOMPLINE_PROP.get());
    }
    ...
    public void setWorkersCompLineID(gw.pl.persistence.core.Key value) {
      setFieldValue(WORKERSCOMPLINE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.wc.rating.WCRetrospectiveRatingPlanMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.wc.rating.WCRetrospectiveRatingPlanMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WCRetrospectiveRatingPlan.class, config);
    com.guidewire._generated.entity.WCRetrospectiveRatingPlanInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WCRetrospectiveRatingPlan, com.guidewire._generated.entity.WCRetrospectiveRatingPlanInternal>() {
      public java.lang.Object getImplementation(entity.WCRetrospectiveRatingPlan bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WCRetrospectiveRatingPlanInternal getInternalInterface(entity.WCRetrospectiveRatingPlan bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WCRetrospectiveRatingPlan newEmptyInstance() {
        return new entity.WCRetrospectiveRatingPlan((java.lang.Void)null);
      }

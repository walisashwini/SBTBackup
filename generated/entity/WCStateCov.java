...
/**
 * WCStateCov
 * A state-level coverage for Workers Comp'
 */
...
@gw.entity.EntityName(value = "WCStateCov")
public class WCStateCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.WCStateCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.WCStateCov, entity.PolicyPeriod>("entity.WCStateCov");
  ...
  private com.guidewire._generated.entity.WCStateCovInternal _internal;
   ...
   */
  protected WCStateCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected WCStateCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected WCStateCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.WCStateCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WCStateCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.WCStateCov clone() {
    return (entity.WCStateCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.WCStateCov getBasedOn() {
    return (entity.WCStateCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.WCStateCov getBasedOnValue() {
    return (entity.WCStateCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.WCStateCov getFixed() {
    return (entity.WCStateCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.WCStateCov getSlice(java.util.Date sliceDate) {
    return (entity.WCStateCov)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.WCStateCov getSubtype() {
    return (typekey.WCStateCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.WCStateCov getUnsliced() {
    return (entity.WCStateCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.WCStateCovVersionList getVersionList() {
    return (entity.windowed.WCStateCovVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.WCStateCov value) {
   ...
   */
  private void setFixed(entity.WCStateCov value) {
   ...
   */
  private void setSubtype(typekey.WCStateCov value) {
  ...
  public entity.WCStateCov split(java.util.Date splitDate) {
    return (entity.WCStateCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WCStateCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WCStateCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.wc.WCStateCovCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.wc.WCStateCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.wc.WCStateCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.wc.WCStateCovCoverageAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.wc.WCStateCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.wc.WCStateCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WCStateCov.class, config);
    com.guidewire._generated.entity.WCStateCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WCStateCov, com.guidewire._generated.entity.WCStateCovInternal>() {
      public java.lang.Object getImplementation(entity.WCStateCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WCStateCovInternal getInternalInterface(entity.WCStateCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WCStateCov newEmptyInstance() {
        return new entity.WCStateCov((java.lang.Void)null);
      }

...
/**
 * WCTransaction
 * A transaction for the Workers' Comp line
 */
...
@gw.entity.EntityName(value = "WCTransaction")
public class WCTransaction extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Transaction {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.WCTransaction, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.WCTransaction, entity.PolicyPeriod>("entity.WCTransaction");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> WCCOST_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "WCCost");
  ...
  private com.guidewire._generated.entity.WCTransactionInternal _internal;
   ...
   */
  public WCTransaction(entity.PolicyPeriod branch)  {
   ...
   */
  public WCTransaction(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected WCTransaction(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.WCTransactionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WCTransactionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.WCTransaction clone() {
    return (entity.WCTransaction)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.WCTransaction getBasedOn() {
    return (entity.WCTransaction)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.WCTransaction getBasedOnValue() {
    return (entity.WCTransaction)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.WCTransaction getFixed() {
    return (entity.WCTransaction)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.WCTransaction getSlice(java.util.Date sliceDate) {
    return (entity.WCTransaction)getSliceUntyped(sliceDate);
  }
  ...
  public entity.WCTransaction getUnsliced() {
    return (entity.WCTransaction)getUnslicedUntyped();
  }
  ...
  public entity.windowed.WCTransactionVersionList getVersionList() {
    return (entity.windowed.WCTransactionVersionList)getVersionListUntyped();
  }
  ...
  public entity.WCCost getWCCost() {
    return (entity.WCCost)__getInternalInterface().getFieldValue(WCCOST_PROP.get());
  }
   ...
   */
  private void setBasedOnValue(entity.WCTransaction value) {
   ...
   */
  private void setFixed(entity.WCTransaction value) {
  ...
  public void setWCCost(entity.WCCost value) {
    __getInternalInterface().setFieldValue(WCCOST_PROP.get(), value);
  }
  ...
  public entity.WCTransaction split(java.util.Date splitDate) {
    return (entity.WCTransaction)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WCTransactionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WCTransaction.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getWCCostID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(WCCOST_PROP.get());
    }
    ...
    public void setWCCostID(gw.pl.persistence.core.Key value) {
      setFieldValue(WCCOST_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.financials.TransactionAdapter", "gw.lob.wc.financials.WCTransactionAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WCTransaction.class, config);
    com.guidewire._generated.entity.WCTransactionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WCTransaction, com.guidewire._generated.entity.WCTransactionInternal>() {
      public java.lang.Object getImplementation(entity.WCTransaction bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WCTransactionInternal getInternalInterface(entity.WCTransaction bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WCTransaction newEmptyInstance() {
        return new entity.WCTransaction((java.lang.Void)null);
      }

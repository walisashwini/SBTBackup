...
@gw.entity.EntityName(value = "WCWaiverOfSubro")
public class WCWaiverOfSubro extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.WCWaiverOfSubro, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.WCWaiverOfSubro, entity.PolicyPeriod>("entity.WCWaiverOfSubro");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> IFANYEXPOSURE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "IfAnyExposure");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> NUMEMPLOYEES_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "NumEmployees");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PUBLICID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PublicID");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> SPECIALCOV_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "SpecialCov");
  ...
  private com.guidewire._generated.entity.WCWaiverOfSubroInternal _internal;
   ...
   */
  public WCWaiverOfSubro(entity.PolicyPeriod branch)  {
   ...
   */
  public WCWaiverOfSubro(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected WCWaiverOfSubro(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.WCWaiverOfSubroInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WCWaiverOfSubroInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.WCWaiverOfSubro clone() {
    return (entity.WCWaiverOfSubro)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.WCWaiverOfSubro getBasedOn() {
    return (entity.WCWaiverOfSubro)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.WCWaiverOfSubro getBasedOnValue() {
    return (entity.WCWaiverOfSubro)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.WCWaiverOfSubro getFixed() {
    return (entity.WCWaiverOfSubro)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public java.lang.String getJobID() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(JOBID_PROP.get());
  }
  ...
  public java.lang.Integer getNumEmployees() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(NUMEMPLOYEES_PROP.get());
  }
  ...
  public entity.WCWaiverOfSubro getSlice(java.util.Date sliceDate) {
    return (entity.WCWaiverOfSubro)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.SpecialCov getSpecialCov() {
    return (typekey.SpecialCov)__getInternalInterface().getFieldValue(SPECIALCOV_PROP.get());
  }
  ...
  public typekey.WaiverOfSubrogationType getType() {
    return (typekey.WaiverOfSubrogationType)__getInternalInterface().getFieldValue(TYPE_PROP.get());
  }
  
  public entity.WCWaiverOfSubro getUnsliced() {
    return (entity.WCWaiverOfSubro)getUnslicedUntyped();
  }
  ...
  public entity.windowed.WCWaiverOfSubroVersionList getVersionList() {
    return (entity.windowed.WCWaiverOfSubroVersionList)getVersionListUntyped();
  }
  ...
  public java.lang.Boolean isIfAnyExposure() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(IFANYEXPOSURE_PROP.get());
  }
   ...
   */
  private void setBasedOnValue(entity.WCWaiverOfSubro value) {
   ...
   */
  private void setFixed(entity.WCWaiverOfSubro value) {
  ...
  public void setIfAnyExposure(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(IFANYEXPOSURE_PROP.get(), value);
  }
  ...
  public void setJobID(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(JOBID_PROP.get(), value);
  }
  ...
  public void setNumEmployees(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(NUMEMPLOYEES_PROP.get(), value);
  }
  ...
  public void setSpecialCov(typekey.SpecialCov value) {
    __getInternalInterface().setFieldValue(SPECIALCOV_PROP.get(), value);
  }
  ...
  public entity.WCWaiverOfSubro split(java.util.Date splitDate) {
    return (entity.WCWaiverOfSubro)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WCWaiverOfSubroInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WCWaiverOfSubro.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.wc.WCWaiverOfSubroMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.wc.WCWaiverOfSubroMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WCWaiverOfSubro.class, config);
    com.guidewire._generated.entity.WCWaiverOfSubroInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WCWaiverOfSubro, com.guidewire._generated.entity.WCWaiverOfSubroInternal>() {
      public java.lang.Object getImplementation(entity.WCWaiverOfSubro bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WCWaiverOfSubroInternal getInternalInterface(entity.WCWaiverOfSubro bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WCWaiverOfSubro newEmptyInstance() {
        return new entity.WCWaiverOfSubro((java.lang.Void)null);
      }

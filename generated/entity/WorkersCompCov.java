...
/**
 * WorkersCompCov
 * A line-level coverage for Workers' Comp
 */
...
@gw.entity.EntityName(value = "WorkersCompCov")
public class WorkersCompCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.WorkersCompCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.WorkersCompCov, entity.PolicyPeriod>("entity.WorkersCompCov");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> FEDEMPLIABLAWTERM1_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "FedEmpLiabLawTerm1");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> FEDEMPLIABLAWTERM1AVL_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "FedEmpLiabLawTerm1Avl");
  ...
  private com.guidewire._generated.entity.WorkersCompCovInternal _internal;
   ...
   */
  protected WorkersCompCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected WorkersCompCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected WorkersCompCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.WorkersCompCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WorkersCompCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.WorkersCompCov clone() {
    return (entity.WorkersCompCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.WorkersCompCov getBasedOn() {
    return (entity.WorkersCompCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.WorkersCompCov getBasedOnValue() {
    return (entity.WorkersCompCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.WCCovEmpCost[] getCosts() {
    return (entity.WCCovEmpCost[])__getInternalInterface().getFieldValue(COSTS_PROP.get());
  }
  ...
  public java.lang.String getFedEmpLiabLawTerm1() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(FEDEMPLIABLAWTERM1_PROP.get());
  }
  ...
  public entity.WorkersCompCov getFixed() {
    return (entity.WorkersCompCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.WorkersCompCov getSlice(java.util.Date sliceDate) {
    return (entity.WorkersCompCov)getSliceUntyped(sliceDate);
  }
  ...
  public typekey.WorkersCompCov getSubtype() {
    return (typekey.WorkersCompCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.WorkersCompCov getUnsliced() {
    return (entity.WorkersCompCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.WorkersCompCovVersionList getVersionList() {
    return (entity.windowed.WorkersCompCovVersionList)getVersionListUntyped();
  }
  ...
  public java.lang.Boolean isFedEmpLiabLawTerm1Avl() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(FEDEMPLIABLAWTERM1AVL_PROP.get());
  }
   ...
   */
  private void setBasedOnValue(entity.WorkersCompCov value) {
   ...
   */
  private void setFedEmpLiabLawTerm1(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(FEDEMPLIABLAWTERM1_PROP.get(), value);
  }
  
  /**
   * Sets the value of the FedEmpLiabLawTerm1Avl field.
   */
  private void setFedEmpLiabLawTerm1Avl(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(FEDEMPLIABLAWTERM1AVL_PROP.get(), value);
  }
  
  /**
   * Sets the value of the Fixed field.
   */
  private void setFixed(entity.WorkersCompCov value) {
   ...
   */
  private void setSubtype(typekey.WorkersCompCov value) {
  ...
  public entity.WorkersCompCov split(java.util.Date splitDate) {
    return (entity.WorkersCompCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WorkersCompCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WorkersCompCov.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.wc.WorkersCompCovCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.wc.WorkersCompCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.wc.WorkersCompCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.wc.WorkersCompCovCoverageAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.wc.WorkersCompCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.wc.WorkersCompCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WorkersCompCov.class, config);
    com.guidewire._generated.entity.WorkersCompCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WorkersCompCov, com.guidewire._generated.entity.WorkersCompCovInternal>() {
      public java.lang.Object getImplementation(entity.WorkersCompCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WorkersCompCovInternal getInternalInterface(entity.WorkersCompCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WorkersCompCov newEmptyInstance() {
        return new entity.WorkersCompCov((java.lang.Void)null);
      }

...
/**
 * WorkersCompExcl
 * A line-level exclusion for Workers' Comp
 */
...
@gw.entity.EntityName(value = "WorkersCompExcl")
public class WorkersCompExcl extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Exclusion, gw.api.copier.EffDatedCopyable, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.WorkersCompExcl, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.WorkersCompExcl, entity.PolicyPeriod>("entity.WorkersCompExcl");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> WCLINE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "WCLine");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.WorkersCompExclInternal _internal;
   ...
   */
  protected WorkersCompExcl(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected WorkersCompExcl(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected WorkersCompExcl(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.WorkersCompExclInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WorkersCompExclInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.WorkersCompExcl clone() {
    return (entity.WorkersCompExcl)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.WorkersCompExcl getBasedOn() {
    return (entity.WorkersCompExcl)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.WorkersCompExcl getBasedOnValue() {
    return (entity.WorkersCompExcl)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.WorkersCompExcl getFixed() {
    return (entity.WorkersCompExcl)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.WorkersCompExcl getSlice(java.util.Date sliceDate) {
    return (entity.WorkersCompExcl)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.WorkersCompExcl getSubtype() {
    return (typekey.WorkersCompExcl)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  
  public entity.WorkersCompExcl getUnsliced() {
    return (entity.WorkersCompExcl)getUnslicedUntyped();
  }
  ...
  public entity.windowed.WorkersCompExclVersionList getVersionList() {
    return (entity.windowed.WorkersCompExclVersionList)getVersionListUntyped();
  }
  ...
  public entity.WorkersCompLine getWCLine() {
    return (entity.WorkersCompLine)__getInternalInterface().getFieldValue(WCLINE_PROP.get());
  }
   ...
   */
  private void setBasedOnValue(entity.WorkersCompExcl value) {
   ...
   */
  private void setFixed(entity.WorkersCompExcl value) {
   ...
   */
  private void setSubtype(typekey.WorkersCompExcl value) {
  ...
  public void setWCLine(entity.WorkersCompLine value) {
    __getInternalInterface().setFieldValue(WCLINE_PROP.get(), value);
  }
  
  public entity.WorkersCompExcl split(java.util.Date splitDate) {
    return (entity.WorkersCompExcl)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WorkersCompExclInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WorkersCompExcl.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getWCLineID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(WCLINE_PROP.get());
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.WorkersCompExcl value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.WorkersCompExcl value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.WorkersCompExcl value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.wc.WorkersCompensationExclExclusionAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.wc.WorkersCompensationExclExclusionAdapter");
    config.put("gw.api.domain.ExclusionAdapter", "gw.lob.wc.WorkersCompensationExclExclusionAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.wc.WorkersCompExclMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.wc.WorkersCompExclMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WorkersCompExcl.class, config);
    com.guidewire._generated.entity.WorkersCompExclInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WorkersCompExcl, com.guidewire._generated.entity.WorkersCompExclInternal>() {
      public java.lang.Object getImplementation(entity.WorkersCompExcl bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WorkersCompExclInternal getInternalInterface(entity.WorkersCompExcl bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WorkersCompExcl newEmptyInstance() {
        return new entity.WorkersCompExcl((java.lang.Void)null);
      }

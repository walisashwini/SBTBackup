...
@gw.entity.EntityName(value = "WorkersCompLine")
public class WorkersCompLine extends entity.PolicyLine implements entity.Coverable, gw.api.policy.PolicyLineJavaMethods {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.WorkersCompLine, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.WorkersCompLine, entity.PolicyPeriod>("entity.WorkersCompLine");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> GOVERNINGCLASS_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "GoverningClass");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> INCLUSIONPERSONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "InclusionPersons");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MANUSCRIPTOPTIONDESC_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ManuscriptOptionDesc");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IMonetaryAmountPropertyInfo> MANUSCRIPTPREMIUM_PROP = new com.guidewire.commons.metadata.types.MonetaryAmountPropertyInfoCache(TYPE, "ManuscriptPremium");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MANUSCRIPTPREMIUM_AMT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ManuscriptPremium_amt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> MANUSCRIPTPREMIUM_CUR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "ManuscriptPremium_cur");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> PARTICIPATINGPLAN_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ParticipatingPlan");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> PARTICIPATINGPLANARRAY_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "ParticipatingPlanArray");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> POLICYLABORCLIENTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "PolicyLaborClients");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> POLICYLABORCONTRACTORS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "PolicyLaborContractors");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> POLICYOWNEROFFICERS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "PolicyOwnerOfficers");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> RETROSPECTIVERATINGPLAN_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "RetrospectiveRatingPlan");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> RETROSPECTIVERATINGPLANARRAY_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "RetrospectiveRatingPlanArray");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> WCAIRCRAFTSEATS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "WCAircraftSeats");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> WCCOSTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "WCCosts");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> WCCOVEREDEMPLOYEEBASES_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "WCCoveredEmployeeBases");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> WCCOVEREDEMPLOYEES_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "WCCoveredEmployees");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> WCEXCLUDEDWORKPLACES_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "WCExcludedWorkplaces");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> WCFEDCOVEREDEMPLOYEES_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "WCFedCoveredEmployees");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> WCLINECONDITIONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "WCLineConditions");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> WCLINECOVERAGES_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "WCLineCoverages");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> WCLINEEXCLUSIONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "WCLineExclusions");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> WCWAIVEROFSUBROS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "WCWaiverOfSubros");
   ...
   */
  protected WorkersCompLine(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected WorkersCompLine(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected WorkersCompLine(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.WorkersCompLineInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WorkersCompLineInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.WorkersCompLineInternal)super.__getInternalInterface();
  }
  ...
  public void addToInclusionPersons(entity.InclusionPerson element) {
    __getInternalInterface().addArrayElement(INCLUSIONPERSONS_PROP.get(), element);
  }
  ...
  public void addToPolicyLaborClients(entity.PolicyLaborClient element) {
    __getInternalInterface().addArrayElement(POLICYLABORCLIENTS_PROP.get(), element);
  }
  ...
  public void addToPolicyLaborContractors(entity.PolicyLaborContractor element) {
    __getInternalInterface().addArrayElement(POLICYLABORCONTRACTORS_PROP.get(), element);
  }
  ...
  public void addToPolicyOwnerOfficers(entity.PolicyOwnerOfficer element) {
    __getInternalInterface().addArrayElement(POLICYOWNEROFFICERS_PROP.get(), element);
  }
  ...
  public void addToWCAircraftSeats(entity.WCAircraftSeat element) {
    __getInternalInterface().addArrayElement(WCAIRCRAFTSEATS_PROP.get(), element);
  }
  ...
  public void addToWCCosts(entity.WCCost element) {
    __getInternalInterface().addArrayElement(WCCOSTS_PROP.get(), element);
  }
  ...
  public void addToWCCoveredEmployeeBases(entity.WCCoveredEmployeeBase element) {
    __getInternalInterface().addArrayElement(WCCOVEREDEMPLOYEEBASES_PROP.get(), element);
  }
  ...
  public void addToWCCoveredEmployees(entity.WCCoveredEmployee element) {
    __getInternalInterface().addArrayElement(WCCOVEREDEMPLOYEES_PROP.get(), element);
  }
  ...
  public void addToWCExcludedWorkplaces(entity.WCExcludedWorkplace element) {
    __getInternalInterface().addArrayElement(WCEXCLUDEDWORKPLACES_PROP.get(), element);
  }
  ...
  public void addToWCFedCoveredEmployees(entity.WCFedCoveredEmployee element) {
    __getInternalInterface().addArrayElement(WCFEDCOVEREDEMPLOYEES_PROP.get(), element);
  }
  ...
  public void addToWCLineConditions(entity.WorkersCompCond element) {
    __getInternalInterface().addArrayElement(WCLINECONDITIONS_PROP.get(), element);
  }
  ...
  public void addToWCLineCoverages(entity.WorkersCompCov element) {
    __getInternalInterface().addArrayElement(WCLINECOVERAGES_PROP.get(), element);
  }
  ...
  public void addToWCLineExclusions(entity.WorkersCompExcl element) {
    __getInternalInterface().addArrayElement(WCLINEEXCLUSIONS_PROP.get(), element);
  }
  ...
  public void addToWCWaiverOfSubros(entity.WCWaiverOfSubro element) {
    __getInternalInterface().addArrayElement(WCWAIVEROFSUBROS_PROP.get(), element);
  }
  ...
  public entity.WorkersCompLine clone() {
    return (entity.WorkersCompLine)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.WorkersCompLine getBasedOn() {
    return (entity.WorkersCompLine)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.WCClassCode getGoverningClass() {
    return (entity.WCClassCode)__getInternalInterface().getFieldValue(GOVERNINGCLASS_PROP.get());
  }
  ...
  public entity.InclusionPerson[] getInclusionPersons() {
    return (entity.InclusionPerson[])__getInternalInterface().getFieldValue(INCLUSIONPERSONS_PROP.get());
  }
  ...
  public entity.WCJurisdiction[] getJurisdictions() {
    return (entity.WCJurisdiction[])__getInternalInterface().getFieldValue(JURISDICTIONS_PROP.get());
  }
  ...
  public java.lang.String getManuscriptOptionDesc() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(MANUSCRIPTOPTIONDESC_PROP.get());
  }
  ...
  public gw.pl.currency.MonetaryAmount getManuscriptPremium() {
    return (gw.pl.currency.MonetaryAmount)__getInternalInterface().getFieldValue(MANUSCRIPTPREMIUM_PROP.get());
  }
  ...
  public java.math.BigDecimal getManuscriptPremium_amt() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(MANUSCRIPTPREMIUM_AMT_PROP.get());
  }
  ...
  public typekey.Currency getManuscriptPremium_cur() {
    return (typekey.Currency)__getInternalInterface().getFieldValue(MANUSCRIPTPREMIUM_CUR_PROP.get());
  }
  ...
  public entity.WCParticipatingPlan getParticipatingPlan() {
    return (entity.WCParticipatingPlan)__getInternalInterface().getFieldValue(PARTICIPATINGPLAN_PROP.get());
  }
  ...
  public entity.WCParticipatingPlan[] getParticipatingPlanArray() {
    return (entity.WCParticipatingPlan[])__getInternalInterface().getFieldValue(PARTICIPATINGPLANARRAY_PROP.get());
  }
  ...
  public entity.PolicyLaborClient[] getPolicyLaborClients() {
    return (entity.PolicyLaborClient[])__getInternalInterface().getFieldValue(POLICYLABORCLIENTS_PROP.get());
  }
  ...
  public entity.PolicyLaborContractor[] getPolicyLaborContractors() {
    return (entity.PolicyLaborContractor[])__getInternalInterface().getFieldValue(POLICYLABORCONTRACTORS_PROP.get());
  }
  ...
  public entity.PolicyOwnerOfficer[] getPolicyOwnerOfficers() {
    return (entity.PolicyOwnerOfficer[])__getInternalInterface().getFieldValue(POLICYOWNEROFFICERS_PROP.get());
  }
  ...
  public entity.WCRetrospectiveRatingPlan getRetrospectiveRatingPlan() {
    return (entity.WCRetrospectiveRatingPlan)__getInternalInterface().getFieldValue(RETROSPECTIVERATINGPLAN_PROP.get());
  }
  ...
  public entity.WCRetrospectiveRatingPlan[] getRetrospectiveRatingPlanArray() {
    return (entity.WCRetrospectiveRatingPlan[])__getInternalInterface().getFieldValue(RETROSPECTIVERATINGPLANARRAY_PROP.get());
  }
  
  public entity.WorkersCompLine getSlice(java.util.Date sliceDate) {
    return (entity.WorkersCompLine)getSliceUntyped(sliceDate);
  }
  
  public entity.WorkersCompLine getUnsliced() {
    return (entity.WorkersCompLine)getUnslicedUntyped();
  }
  
  public entity.windowed.WorkersCompLineVersionList getVersionList() {
    return (entity.windowed.WorkersCompLineVersionList)getVersionListUntyped();
  }
  ...
  public entity.WCAircraftSeat[] getWCAircraftSeats() {
    return (entity.WCAircraftSeat[])__getInternalInterface().getFieldValue(WCAIRCRAFTSEATS_PROP.get());
  }
  ...
  public entity.WCCost[] getWCCosts() {
    return (entity.WCCost[])__getInternalInterface().getFieldValue(WCCOSTS_PROP.get());
  }
  ...
  public entity.WCCoveredEmployeeBase[] getWCCoveredEmployeeBases() {
    return (entity.WCCoveredEmployeeBase[])__getInternalInterface().getFieldValue(WCCOVEREDEMPLOYEEBASES_PROP.get());
  }
  ...
  public entity.WCCoveredEmployee[] getWCCoveredEmployees() {
    return (entity.WCCoveredEmployee[])__getInternalInterface().getFieldValue(WCCOVEREDEMPLOYEES_PROP.get());
  }
  ...
  public entity.WCExcludedWorkplace[] getWCExcludedWorkplaces() {
    return (entity.WCExcludedWorkplace[])__getInternalInterface().getFieldValue(WCEXCLUDEDWORKPLACES_PROP.get());
  }
  ...
  public entity.WCFedCoveredEmployee[] getWCFedCoveredEmployees() {
    return (entity.WCFedCoveredEmployee[])__getInternalInterface().getFieldValue(WCFEDCOVEREDEMPLOYEES_PROP.get());
  }
  ...
  public entity.WorkersCompCond[] getWCLineConditions() {
    return (entity.WorkersCompCond[])__getInternalInterface().getFieldValue(WCLINECONDITIONS_PROP.get());
  }
  ...
  public entity.WorkersCompCov[] getWCLineCoverages() {
    return (entity.WorkersCompCov[])__getInternalInterface().getFieldValue(WCLINECOVERAGES_PROP.get());
  }
  ...
  public entity.WorkersCompExcl[] getWCLineExclusions() {
    return (entity.WorkersCompExcl[])__getInternalInterface().getFieldValue(WCLINEEXCLUSIONS_PROP.get());
  }
  ...
  public entity.WCWaiverOfSubro[] getWCWaiverOfSubros() {
    return (entity.WCWaiverOfSubro[])__getInternalInterface().getFieldValue(WCWAIVEROFSUBROS_PROP.get());
  }
  ...
  public void removeFromInclusionPersons(entity.InclusionPerson element) {
    __getInternalInterface().removeArrayElement(INCLUSIONPERSONS_PROP.get(), element);
  }
  ...
  public void removeFromInclusionPersons(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(INCLUSIONPERSONS_PROP.get(), elementID);
  }
  ...
  public void removeFromPolicyLaborClients(entity.PolicyLaborClient element) {
    __getInternalInterface().removeArrayElement(POLICYLABORCLIENTS_PROP.get(), element);
  }
  ...
  public void removeFromPolicyLaborClients(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(POLICYLABORCLIENTS_PROP.get(), elementID);
  }
  ...
  public void removeFromPolicyLaborContractors(entity.PolicyLaborContractor element) {
    __getInternalInterface().removeArrayElement(POLICYLABORCONTRACTORS_PROP.get(), element);
  }
  ...
  public void removeFromPolicyLaborContractors(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(POLICYLABORCONTRACTORS_PROP.get(), elementID);
  }
  ...
  public void removeFromPolicyOwnerOfficers(entity.PolicyOwnerOfficer element) {
    __getInternalInterface().removeArrayElement(POLICYOWNEROFFICERS_PROP.get(), element);
  }
  ...
  public void removeFromPolicyOwnerOfficers(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(POLICYOWNEROFFICERS_PROP.get(), elementID);
  }
  ...
  public void removeFromWCAircraftSeats(entity.WCAircraftSeat element) {
    __getInternalInterface().removeArrayElement(WCAIRCRAFTSEATS_PROP.get(), element);
  }
  ...
  public void removeFromWCAircraftSeats(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(WCAIRCRAFTSEATS_PROP.get(), elementID);
  }
  ...
  public void removeFromWCCosts(entity.WCCost element) {
    __getInternalInterface().removeArrayElement(WCCOSTS_PROP.get(), element);
  }
  ...
  public void removeFromWCCosts(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(WCCOSTS_PROP.get(), elementID);
  }
  ...
  public void removeFromWCCoveredEmployeeBases(entity.WCCoveredEmployeeBase element) {
    __getInternalInterface().removeArrayElement(WCCOVEREDEMPLOYEEBASES_PROP.get(), element);
  }
  ...
  public void removeFromWCCoveredEmployeeBases(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(WCCOVEREDEMPLOYEEBASES_PROP.get(), elementID);
  }
  ...
  public void removeFromWCCoveredEmployees(entity.WCCoveredEmployee element) {
    __getInternalInterface().removeArrayElement(WCCOVEREDEMPLOYEES_PROP.get(), element);
  }
  ...
  public void removeFromWCCoveredEmployees(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(WCCOVEREDEMPLOYEES_PROP.get(), elementID);
  }
  ...
  public void removeFromWCExcludedWorkplaces(entity.WCExcludedWorkplace element) {
    __getInternalInterface().removeArrayElement(WCEXCLUDEDWORKPLACES_PROP.get(), element);
  }
  ...
  public void removeFromWCExcludedWorkplaces(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(WCEXCLUDEDWORKPLACES_PROP.get(), elementID);
  }
  ...
  public void removeFromWCFedCoveredEmployees(entity.WCFedCoveredEmployee element) {
    __getInternalInterface().removeArrayElement(WCFEDCOVEREDEMPLOYEES_PROP.get(), element);
  }
  ...
  public void removeFromWCFedCoveredEmployees(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(WCFEDCOVEREDEMPLOYEES_PROP.get(), elementID);
  }
  ...
  public void removeFromWCLineConditions(entity.WorkersCompCond element) {
    __getInternalInterface().removeArrayElement(WCLINECONDITIONS_PROP.get(), element);
  }
  ...
  public void removeFromWCLineConditions(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(WCLINECONDITIONS_PROP.get(), elementID);
  }
  ...
  public void removeFromWCLineCoverages(entity.WorkersCompCov element) {
    __getInternalInterface().removeArrayElement(WCLINECOVERAGES_PROP.get(), element);
  }
  ...
  public void removeFromWCLineCoverages(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(WCLINECOVERAGES_PROP.get(), elementID);
  }
  ...
  public void removeFromWCLineExclusions(entity.WorkersCompExcl element) {
    __getInternalInterface().removeArrayElement(WCLINEEXCLUSIONS_PROP.get(), element);
  }
  ...
  public void removeFromWCLineExclusions(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(WCLINEEXCLUSIONS_PROP.get(), elementID);
  }
  ...
  public void removeFromWCWaiverOfSubros(entity.WCWaiverOfSubro element) {
    __getInternalInterface().removeArrayElement(WCWAIVEROFSUBROS_PROP.get(), element);
  }
  ...
  public void removeFromWCWaiverOfSubros(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(WCWAIVEROFSUBROS_PROP.get(), elementID);
  }
  ...
  public void setGoverningClass(entity.WCClassCode value) {
    __getInternalInterface().setFieldValue(GOVERNINGCLASS_PROP.get(), value);
  }
  ...
  public void setInclusionPersons(entity.InclusionPerson[] value) {
    __getInternalInterface().setFieldValue(INCLUSIONPERSONS_PROP.get(), value);
  }
  ...
  public void setManuscriptOptionDesc(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(MANUSCRIPTOPTIONDESC_PROP.get(), value);
  }
  ...
  public void setManuscriptPremium(gw.pl.currency.MonetaryAmount value) {
    __getInternalInterface().setFieldValue(MANUSCRIPTPREMIUM_PROP.get(), value);
  }
  
  /**
   * Sets the value of the ManuscriptPremium_amt field.
   */
  private void setManuscriptPremium_amt(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(MANUSCRIPTPREMIUM_AMT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the ManuscriptPremium_cur field.
   */
  private void setManuscriptPremium_cur(typekey.Currency value) {
    __getInternalInterface().setFieldValue(MANUSCRIPTPREMIUM_CUR_PROP.get(), value);
  }
  ...
  public void setParticipatingPlan(entity.WCParticipatingPlan value) {
    __getInternalInterface().setFieldValue(PARTICIPATINGPLAN_PROP.get(), value);
  }
  
  /**
   * Sets the value of the ParticipatingPlanArray field.
   */
  private void setParticipatingPlanArray(entity.WCParticipatingPlan[] value) {
    __getInternalInterface().setFieldValue(PARTICIPATINGPLANARRAY_PROP.get(), value);
  }
  ...
  public void setPolicyLaborClients(entity.PolicyLaborClient[] value) {
    __getInternalInterface().setFieldValue(POLICYLABORCLIENTS_PROP.get(), value);
  }
  ...
  public void setPolicyLaborContractors(entity.PolicyLaborContractor[] value) {
    __getInternalInterface().setFieldValue(POLICYLABORCONTRACTORS_PROP.get(), value);
  }
  ...
  public void setPolicyOwnerOfficers(entity.PolicyOwnerOfficer[] value) {
    __getInternalInterface().setFieldValue(POLICYOWNEROFFICERS_PROP.get(), value);
  }
  ...
  public void setRetrospectiveRatingPlan(entity.WCRetrospectiveRatingPlan value) {
    __getInternalInterface().setFieldValue(RETROSPECTIVERATINGPLAN_PROP.get(), value);
  }
  
  /**
   * Sets the value of the RetrospectiveRatingPlanArray field.
   */
  private void setRetrospectiveRatingPlanArray(entity.WCRetrospectiveRatingPlan[] value) {
    __getInternalInterface().setFieldValue(RETROSPECTIVERATINGPLANARRAY_PROP.get(), value);
  }
  ...
  public void setWCAircraftSeats(entity.WCAircraftSeat[] value) {
    __getInternalInterface().setFieldValue(WCAIRCRAFTSEATS_PROP.get(), value);
  }
  ...
  public void setWCCosts(entity.WCCost[] value) {
    __getInternalInterface().setFieldValue(WCCOSTS_PROP.get(), value);
  }
  ...
  public void setWCCoveredEmployeeBases(entity.WCCoveredEmployeeBase[] value) {
    __getInternalInterface().setFieldValue(WCCOVEREDEMPLOYEEBASES_PROP.get(), value);
  }
  ...
  public void setWCCoveredEmployees(entity.WCCoveredEmployee[] value) {
    __getInternalInterface().setFieldValue(WCCOVEREDEMPLOYEES_PROP.get(), value);
  }
  ...
  public void setWCExcludedWorkplaces(entity.WCExcludedWorkplace[] value) {
    __getInternalInterface().setFieldValue(WCEXCLUDEDWORKPLACES_PROP.get(), value);
  }
  ...
  public void setWCFedCoveredEmployees(entity.WCFedCoveredEmployee[] value) {
    __getInternalInterface().setFieldValue(WCFEDCOVEREDEMPLOYEES_PROP.get(), value);
  }
  ...
  public void setWCLineConditions(entity.WorkersCompCond[] value) {
    __getInternalInterface().setFieldValue(WCLINECONDITIONS_PROP.get(), value);
  }
  ...
  public void setWCLineCoverages(entity.WorkersCompCov[] value) {
    __getInternalInterface().setFieldValue(WCLINECOVERAGES_PROP.get(), value);
  }
  ...
  public void setWCLineExclusions(entity.WorkersCompExcl[] value) {
    __getInternalInterface().setFieldValue(WCLINEEXCLUSIONS_PROP.get(), value);
  }
  ...
  public void setWCWaiverOfSubros(entity.WCWaiverOfSubro[] value) {
    __getInternalInterface().setFieldValue(WCWAIVEROFSUBROS_PROP.get(), value);
  }
  
  public entity.WorkersCompLine split(java.util.Date splitDate) {
    return (entity.WorkersCompLine)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WorkersCompLineInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WorkersCompLine.this.__getDelegateManager();
    }
    ...
    public void addToParticipatingPlanArray(entity.WCParticipatingPlan element) {
      __getInternalInterface().addArrayElement(PARTICIPATINGPLANARRAY_PROP.get(), element);
    }
    ...
    public void addToRetrospectiveRatingPlanArray(entity.WCRetrospectiveRatingPlan element) {
      __getInternalInterface().addArrayElement(RETROSPECTIVERATINGPLANARRAY_PROP.get(), element);
    }
    ...
    public gw.pl.persistence.core.Key getGoverningClassID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(GOVERNINGCLASS_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getParticipatingPlanID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(PARTICIPATINGPLAN_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getRetrospectiveRatingPlanID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(RETROSPECTIVERATINGPLAN_PROP.get());
    }
    ...
    public void removeFromParticipatingPlanArray(entity.WCParticipatingPlan element) {
      __getInternalInterface().removeArrayElement(PARTICIPATINGPLANARRAY_PROP.get(), element);
    }
    ...
    public void removeFromParticipatingPlanArray(gw.pl.persistence.core.Key elementID) {
      __getInternalInterface().removeArrayElement(PARTICIPATINGPLANARRAY_PROP.get(), elementID);
    }
    ...
    public void removeFromRetrospectiveRatingPlanArray(entity.WCRetrospectiveRatingPlan element) {
      __getInternalInterface().removeArrayElement(RETROSPECTIVERATINGPLANARRAY_PROP.get(), element);
    }
    ...
    public void removeFromRetrospectiveRatingPlanArray(gw.pl.persistence.core.Key elementID) {
      __getInternalInterface().removeArrayElement(RETROSPECTIVERATINGPLANARRAY_PROP.get(), elementID);
    }
    ...
    public void setGoverningClassID(gw.pl.persistence.core.Key value) {
      setFieldValue(GOVERNINGCLASS_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.CoverableAbstractDomainMethods", "gw.lob.wc.WCLineCoverableAdapter");
    config.put("gw.api.domain.CoverableAdapter", "gw.lob.wc.WCLineCoverableAdapter");
    ...
    config.put("gw.api.policy.PolicyLineJavaMethods", "gw.lob.wc.WCPolicyLineMethods");
    config.put("gw.api.policy.PolicyLineMethods", "gw.lob.wc.WCPolicyLineMethods");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WorkersCompLine.class, config);
    com.guidewire._generated.entity.WorkersCompLineInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WorkersCompLine, com.guidewire._generated.entity.WorkersCompLineInternal>() {
      public java.lang.Object getImplementation(entity.WorkersCompLine bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WorkersCompLineInternal getInternalInterface(entity.WorkersCompLine bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WorkersCompLine newEmptyInstance() {
        return new entity.WorkersCompLine((java.lang.Void)null);
      }

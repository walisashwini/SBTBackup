...
public class WorkflowSearchCriteria extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable, java.io.Serializable {
   ...
   * Searches by corresponding Job's Subtype
   */
  @gw.internal.gosu.parser.ExtendedProperty
  ...
  public gw.api.productmodel.Product getProduct() {
    return ((com.guidewire.pc.domain.workflow.impl.WorkflowSearchCriteriaCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.workflow.impl.WorkflowSearchCriteriaCoreExtMethods")).getProduct();
  }
  ...
  public void setProduct(gw.api.productmodel.Product product) {
    ((com.guidewire.pc.domain.workflow.impl.WorkflowSearchCriteriaCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.pc.domain.workflow.impl.WorkflowSearchCriteriaCoreExtMethods")).setProduct(product);
  }
  ...
  static {
    ...
    config.put("com.guidewire.pc.domain.workflow.impl.WorkflowSearchCriteriaCoreExtMethods", "com.guidewire.pc.domain.workflow.impl.WorkflowSearchCriteriaCoreExtMethodsImpl");

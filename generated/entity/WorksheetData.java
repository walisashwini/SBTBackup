...
/**
 * WorksheetData
 * Repository for Worksheet XML data.
 */
...
@gw.entity.EntityName(value = "WorksheetData")
public class WorksheetData extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.Extractable, entity.FrozenSetMember {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.WorksheetData> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.WorksheetData>("entity.WorksheetData");
  ...
  private com.guidewire._generated.entity.WorksheetDataInternal _internal;
   ...
   */
  public WorksheetData(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected WorksheetData(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.WorksheetDataInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WorksheetDataInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WorksheetDataInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WorksheetData.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WorksheetData.class, config);
    com.guidewire._generated.entity.WorksheetDataInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WorksheetData, com.guidewire._generated.entity.WorksheetDataInternal>() {
      public java.lang.Object getImplementation(entity.WorksheetData bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WorksheetDataInternal getInternalInterface(entity.WorksheetData bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WorksheetData newEmptyInstance() {
        return new entity.WorksheetData((java.lang.Void)null);
      }

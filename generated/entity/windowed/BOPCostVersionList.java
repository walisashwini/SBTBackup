...
public interface BOPCostVersionList extends gw.pl.persistence.core.effdate.EffDatedVersionList {
  entity.BOPCost AsOf(java.util.Date date);
  ...
  java.util.List<? extends entity.BOPCost> getAllVersions();

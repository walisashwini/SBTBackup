...
public interface CPBuildingCovBroadCostVersionList extends entity.windowed.CPBuildingCovCostVersionList {
  entity.CPBuildingCovBroadCost AsOf(java.util.Date date);
  ...
  java.util.List<? extends entity.CPBuildingCovBroadCost> getAllVersions();

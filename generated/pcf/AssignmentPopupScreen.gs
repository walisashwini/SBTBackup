...
public class AssignmentPopupScreen extends com.guidewire.pl.web.codegen.SectionBase {
  function onEnter ($AssignmentPopup :  gw.api.assignment.AssignmentPopup) : void {
    __widgetOf(this, pcf.AssignmentPopupScreen, SECTION_WIDGET_CLASS).setVariables(false, {$AssignmentPopup})
  }
  
  function refreshVariables ($AssignmentPopup :  gw.api.assignment.AssignmentPopup) : void {
    __widgetOf(this, pcf.AssignmentPopupScreen, SECTION_WIDGET_CLASS).setVariables(true, {$AssignmentPopup})
  }

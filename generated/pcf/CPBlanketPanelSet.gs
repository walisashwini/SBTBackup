...
public class CPBlanketPanelSet extends com.guidewire.pl.web.codegen.SectionBase {
  function onEnter ($cpLine :  CommercialPropertyLine, $openForEdit :  boolean, $jobWizardHelper :  gw.api.web.job.JobWizardHelper) : void {
    __widgetOf(this, pcf.CPBlanketPanelSet, SECTION_WIDGET_CLASS).setVariables(false, {$cpLine, $openForEdit, $jobWizardHelper})
  }
  ...
  function refreshVariables ($cpLine :  CommercialPropertyLine, $openForEdit :  boolean, $jobWizardHelper :  gw.api.web.job.JobWizardHelper) : void {
    __widgetOf(this, pcf.CPBlanketPanelSet, SECTION_WIDGET_CLASS).setVariables(true, {$cpLine, $openForEdit, $jobWizardHelper})
  }

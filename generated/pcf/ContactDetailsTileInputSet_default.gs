...
public class ContactDetailsTileInputSet_default extends com.guidewire.pl.web.codegen.SectionBase {
  function onEnter ($accountDetailsTileHelper :  gw.api.web.dashboard.ui.account.AccountDetailHelper) : void {
    __widgetOf(this, pcf.ContactDetailsTileInputSet_default, SECTION_WIDGET_CLASS).setVariables(false, {$accountDetailsTileHelper})
  }
  
  function refreshVariables ($accountDetailsTileHelper :  gw.api.web.dashboard.ui.account.AccountDetailHelper) : void {
    __widgetOf(this, pcf.ContactDetailsTileInputSet_default, SECTION_WIDGET_CLASS).setVariables(true, {$accountDetailsTileHelper})
  }

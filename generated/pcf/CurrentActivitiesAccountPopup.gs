...
public class CurrentActivitiesAccountPopup extends com.guidewire.pl.web.codegen.LocationBase {
  static function createDestination (account :  Account) : pcf.api.Destination {
    return __newDestinationForLocation(pcf.CurrentActivitiesAccountPopup, {account}, 0)
  }
  
  static function push (account :  Account) : pcf.api.Location {
    return __newDestinationForLocation(pcf.CurrentActivitiesAccountPopup, {account}, 0).push()
  }

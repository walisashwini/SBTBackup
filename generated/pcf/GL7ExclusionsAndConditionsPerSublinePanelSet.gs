...
public class GL7ExclusionsAndConditionsPerSublinePanelSet extends com.guidewire.pl.web.codegen.SectionBase {
  function onEnter ($coverablePerSubline :  gw.lob.gl7.presenters.GL7CoverablePerSubline, $coverageCategories :  String[], $jobWizardHelper :  gw.api.web.job.JobWizardHelper, $label :  String, $openForEdit :  boolean) : void {
    __widgetOf(this, pcf.GL7ExclusionsAndConditionsPerSublinePanelSet, SECTION_WIDGET_CLASS).setVariables(false, {$coverablePerSubline, $coverageCategories, $jobWizardHelper, $label, $openForEdit})
  }
  ...
  function refreshVariables ($coverablePerSubline :  gw.lob.gl7.presenters.GL7CoverablePerSubline, $coverageCategories :  String[], $jobWizardHelper :  gw.api.web.job.JobWizardHelper, $label :  String, $openForEdit :  boolean) : void {
    __widgetOf(this, pcf.GL7ExclusionsAndConditionsPerSublinePanelSet, SECTION_WIDGET_CLASS).setVariables(true, {$coverablePerSubline, $coverageCategories, $jobWizardHelper, $label, $openForEdit})
  }

...
public class RuleExecutionInfoCell_uwrule extends com.guidewire.pl.web.codegen.SectionBase {
  function onEnter ($version :  RuleVersion, $versionController :  gw.bizrules.management.BizRulesVersionController) : void {
    __widgetOf(this, pcf.RuleExecutionInfoCell_uwrule, SECTION_WIDGET_CLASS).setVariables(false, {$version, $versionController})
  }
  
  function refreshVariables ($version :  RuleVersion, $versionController :  gw.bizrules.management.BizRulesVersionController) : void {
    __widgetOf(this, pcf.RuleExecutionInfoCell_uwrule, SECTION_WIDGET_CLASS).setVariables(true, {$version, $versionController})
  }

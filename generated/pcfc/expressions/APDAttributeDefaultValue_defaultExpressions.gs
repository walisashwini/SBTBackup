...
class APDAttributeDefaultValue_defaultExpressions {
  ...
  public static class APDAttributeDefaultValueExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on TextCell (id=value_Cell) at APDAttributeDefaultValue.default.pcf: line 28, column 58
    ...
    // 'initialValue' attribute on Variable at APDAttributeDefaultValue.default.pcf: line 23, column 32
    function initialValue_0 () : APDAttributeRule {
      return attribute.Rules?.firstWhere(\r -> r.RuleType == ruleType)
    }
    
    // 'value' attribute on TextCell (id=value_Cell) at APDAttributeDefaultValue.default.pcf: line 28, column 58
    function value_4 () : java.lang.String {
      return UIValue
    }
    
    // 'valueVisible' attribute on TextCell (id=value_Cell) at APDAttributeDefaultValue.default.pcf: line 28, column 58

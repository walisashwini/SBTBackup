...
class APDClaimCostCategoriesPopupExpressions {
  @javax.annotation.Generated("config/web/pcf/tools/apd/APDClaimCostCategoriesPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class APDClaimCostCategoriesPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=export) at APDClaimCostCategoriesPopup.pcf: line 24, column 86
    function action_1 () : void {
      costCodeHelper.saveSystemTableXML()
    }
    
    // EditButtons at APDClaimCostCategoriesPopup.pcf: line 18, column 23
    function label_0 () : java.lang.Object {
      return gw.api.util.LocationUtil.hasOwnBundle(CurrentLocation) ? DisplayKey.get("Button.Update") : DisplayKey.get("Button.OK")
    }
    
    // 'value' attribute on TextCell (id=CostCode_Cell) at APDClaimCostCategoriesPopup.pcf: line 44, column 42
    function sortValue_2 (costCode :  CostCode) : java.lang.Object {
      return costCode.CostCode
    }
    
    // 'value' attribute on TextCell (id=CostName_Cell) at APDClaimCostCategoriesPopup.pcf: line 50, column 42
    function sortValue_3 (costCode :  CostCode) : java.lang.Object {
      return costCode.CostName
    }
    
    // 'value' attribute on TextCell (id=Description_Cell) at APDClaimCostCategoriesPopup.pcf: line 56, column 45
    function sortValue_4 (costCode :  CostCode) : java.lang.Object {
      return costCode.Description
    }
    
    // 'value' attribute on TypeKeyCell (id=RateAmountType_Cell) at APDClaimCostCategoriesPopup.pcf: line 63, column 43
    function sortValue_5 (costCode :  CostCode) : java.lang.Object {
      return costCode.RateAmountType
    }
    
    // 'value' attribute on TypeKeyCell (id=ChargePattern_Cell) at APDClaimCostCategoriesPopup.pcf: line 70, column 42
    function sortValue_6 (costCode :  CostCode) : java.lang.Object {
      return costCode.ChargePatern
    }
    
    // 'value' attribute on TypeKeyCell (id=ProrationMethod_Cell) at APDClaimCostCategoriesPopup.pcf: line 77, column 44
    function sortValue_7 (costCode :  CostCode) : java.lang.Object {
      return costCode.ProrationMethod
    }
    
    // 'value' attribute on BooleanRadioCell (id=Overrideable_Cell) at APDClaimCostCategoriesPopup.pcf: line 83, column 46
    function sortValue_8 (costCode :  CostCode) : java.lang.Object {
      return costCode.Overrideable
    }
    
    // 'toAdd' attribute on RowIterator (id=CostCodes) at APDClaimCostCategoriesPopup.pcf: line 35, column 44
    function toAdd_40 (costCode :  CostCode) : void {
      costCodeHelper.addToCostCodes(costCode)
    }
    
    // 'toRemove' attribute on RowIterator (id=CostCodes) at APDClaimCostCategoriesPopup.pcf: line 35, column 44
    function toRemove_41 (costCode :  CostCode) : void {
      costCodeHelper.removeFromCostCodes(costCode)
    }
    
    // 'value' attribute on RowIterator (id=CostCodes) at APDClaimCostCategoriesPopup.pcf: line 35, column 44
    function value_42 () : List<CostCode> {
      return costCodeHelper.CostCodes
    }
    
    // 'valueType' attribute on RowIterator (id=CostCodes) at APDClaimCostCategoriesPopup.pcf: line 35, column 44
    ...
    override property get CurrentLocation () : pcf.APDClaimCostCategoriesPopup {
      return super.CurrentLocation as pcf.APDClaimCostCategoriesPopup
    }
  ...
  @javax.annotation.Generated("config/web/pcf/tools/apd/APDClaimCostCategoriesPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class IteratorEntryExpressionsImpl extends APDClaimCostCategoriesPopupExpressionsImpl {
    public construct(widget :  Object) {
      super(widget, 1)
    }
    ...
    // 'valueType' attribute on TypeKeyCell (id=RateAmountType_Cell) at APDClaimCostCategoriesPopup.pcf: line 63, column 43
    ...
    // 'valueType' attribute on TypeKeyCell (id=ChargePattern_Cell) at APDClaimCostCategoriesPopup.pcf: line 70, column 42
    ...
    // 'valueType' attribute on TypeKeyCell (id=ProrationMethod_Cell) at APDClaimCostCategoriesPopup.pcf: line 77, column 44

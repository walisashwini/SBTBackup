...
class ArgsSummaryLDVExpressions {
  ...
  public static class ArgsSummaryLDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function renderCall_36 (__writer :  java.io.Writer, __escaper :  gw.lang.parser.template.StringEscaper, __helper :  gw.api.web.template.TemplatePanelHelper) : void {
      pcfc.expressions.ArgsSummaryLDV_TemplatePanel1.render(__writer, __escaper, selectedArgsSummary, __helper)
    }
    
    // TemplatePanel at ArgsSummaryLDV.pcf: line 89, column 24
    function renderCall_37 (__writer :  java.io.Writer, __escaper :  gw.lang.parser.template.StringEscaper, __helper :  gw.api.web.template.TemplatePanelHelper) : void {
      pcfc.expressions.ArgsSummaryLDV_TemplatePanel2.render(__writer, __escaper, selectedArgsSummary, __helper)
    }
    
    // 'value' attribute on TextCell (id=ShortArgs_Cell) at ArgsSummaryLDV.pcf: line 29, column 53
    ...
    // 'value' attribute on TextCell (id=QueryCount_Cell) at ArgsSummaryLDV.pcf: line 37, column 46
    ...
    // 'value' attribute on TextCell (id=TotalQueryTime_Cell) at ArgsSummaryLDV.pcf: line 45, column 46
    function sortValue_2 (argsSummary :  gw.api.profiler.ArgsAggregatedQuerySummary) : java.lang.Object {
      return argsSummary.TotalTime
    }
    
    // 'value' attribute on TextCell (id=AverageTime_Cell) at ArgsSummaryLDV.pcf: line 51, column 45
    ...
    // 'value' attribute on TextCell (id=MaxQueryTime_Cell) at ArgsSummaryLDV.pcf: line 56, column 46
    ...
    // 'value' attribute on TextCell (id=TotalRowCount_Cell) at ArgsSummaryLDV.pcf: line 64, column 46
    ...
    // 'value' attribute on TextCell (id=AverageRowCount_Cell) at ArgsSummaryLDV.pcf: line 70, column 45
  ...
  public static class IteratorEntryExpressionsImpl extends ArgsSummaryLDVExpressionsImpl {
    ...
    // 'outputConversion' attribute on TextCell (id=AverageTime_Cell) at ArgsSummaryLDV.pcf: line 51, column 45
    function outputConversion_21 (VALUE :  java.lang.Double) : java.lang.String {
    ...
    // 'value' attribute on TextCell (id=AverageTime_Cell) at ArgsSummaryLDV.pcf: line 51, column 45
    function value_22 () : java.lang.Double {
      return argsSummary.AverageTime
    }
    ...
    // 'value' attribute on TextCell (id=AverageRowCount_Cell) at ArgsSummaryLDV.pcf: line 70, column 45
    function value_32 () : java.lang.Double {
      return argsSummary.AverageRowCount
    }

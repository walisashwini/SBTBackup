...
@javax.annotation.Generated("config/web/pcf/job/common/BindSummaryDV.Installments.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class BindSummaryDV_InstallmentsExpressions {
  @javax.annotation.Generated("config/web/pcf/job/common/BindSummaryDV.Installments.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class BindSummaryDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on InputSetRef at BindSummaryDV.Installments.pcf: line 20, column 107
    ...
    // 'def' attribute on InputSetRef at BindSummaryDV.Installments.pcf: line 24, column 91
    function def_onEnter_2 (def :  pcf.PaymentsSummaryInputSet) : void {
      def.onEnter(policyPeriodBillingInstructionsManager, thePeriod)
    }
    
    // 'def' attribute on InputSetRef at BindSummaryDV.Installments.pcf: line 28, column 89
    function def_onEnter_4 (def :  pcf.InvoiceStreamInputSet) : void {
      def.onEnter(policyPeriodBillingInstructionsManager, thePeriod)
    }
    ...
    // 'def' attribute on InputSetRef at BindSummaryDV.Installments.pcf: line 24, column 91
    function def_refreshVariables_3 (def :  pcf.PaymentsSummaryInputSet) : void {
      def.refreshVariables(policyPeriodBillingInstructionsManager, thePeriod)
    }
    
    // 'def' attribute on InputSetRef at BindSummaryDV.Installments.pcf: line 28, column 89
    function def_refreshVariables_5 (def :  pcf.InvoiceStreamInputSet) : void {
      def.refreshVariables(policyPeriodBillingInstructionsManager, thePeriod)
    }

...
class BusinessWeekPageExpressions {
  ...
  public static class BusinessWeekPageExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=BusinessWeek_AddBusinessWeek) at BusinessWeekPage.pcf: line 25, column 25
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=BusinessWeek_DeleteButton) at BusinessWeekPage.pcf: line 32, column 25
    ...
    // 'available' attribute on ToolbarButton (id=BusinessWeek_AddBusinessWeek) at BusinessWeekPage.pcf: line 25, column 25
    function available_1 () : java.lang.Boolean {
      return perm.BusinessWeek.create
    }
    
    // 'available' attribute on CheckedValuesToolbarButton (id=BusinessWeek_DeleteButton) at BusinessWeekPage.pcf: line 32, column 25
    ...
    // 'value' attribute on TextCell (id=Name_Cell) at BusinessWeekPage.pcf: line 49, column 42
  ...
  public static class IteratorEntryExpressionsImpl extends BusinessWeekPageExpressionsImpl {
    ...
    // 'action' attribute on TextCell (id=Name_Cell) at BusinessWeekPage.pcf: line 49, column 42
    ...
    // 'value' attribute on TextCell (id=Zones_Cell) at BusinessWeekPage.pcf: line 54, column 43

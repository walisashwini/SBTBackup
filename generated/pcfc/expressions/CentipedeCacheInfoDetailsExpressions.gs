...
class CentipedeCacheInfoDetailsExpressions {
  ...
  @javax.annotation.Generated("config/web/pcf/tools/infopages/CentipedeCacheInfoDetails.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class PanelIteratorEntry2ExpressionsImpl extends CentipedeCacheInfoDetailsExpressionsImpl {
    public construct(widget :  Object) {
      super(widget, 1)
    }
  ...
  @javax.annotation.Generated("config/web/pcf/tools/infopages/CentipedeCacheInfoDetails.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class PanelIteratorEntryExpressionsImpl extends CentipedeCacheInfoDetailsExpressionsImpl {
    public construct(widget :  Object) {
      super(widget, 1)
    }
    ...
    // 'def' attribute on PanelRef at CentipedeCacheInfoDetails.pcf: line 35, column 79
    function def_onEnter_2 (def :  pcf.CentipedeAgeDistributionSmallChart) : void {
      def.onEnter(pageHelper, snapshot)
    }
    
    // 'def' attribute on PanelRef at CentipedeCacheInfoDetails.pcf: line 35, column 79
    function def_refreshVariables_3 (def :  pcf.CentipedeAgeDistributionSmallChart) : void {
      def.refreshVariables(pageHelper, snapshot)
    }

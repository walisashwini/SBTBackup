...
class ClusterMembersDownloadConfigurePopupExpressions {
  ...
  public static class DetailViewPanelExpressionsImpl extends ClusterMembersDownloadConfigurePopupExpressionsImpl {
    ...
    // 'action' attribute on ButtonInput (id=CompleteDownload_Input) at ClusterMembersDownloadConfigurePopup.pcf: line 46, column 75
    function action_10 () : void {
      ClusterMembersData.downloadSummaryReport(IncludeHistory ? MaxHistoryRecords : 0)
    }
    
    // 'value' attribute on CheckBoxInput (id=IncludeHistory_Input) at ClusterMembersDownloadConfigurePopup.pcf: line 32, column 36
    function defaultSetter_3 (__VALUE_TO_SET :  java.lang.Object) : void {
      IncludeHistory = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'value' attribute on TextInput (id=MaxHistoryRecords_Input) at ClusterMembersDownloadConfigurePopup.pcf: line 41, column 44

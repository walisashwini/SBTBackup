...
class CoverageOptionsScreenExpressions {
  @javax.annotation.Generated("config/web/pcf/line/wc/policy/CoverageOptionsScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class CoverageOptionsScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at CoverageOptionsScreen.pcf: line 28, column 58
    function def_onEnter_20 (def :  pcf.OOSEPanelSet) : void {
      def.onEnter(policyPeriod, jobWizardHelper)
    }
    
    // 'def' attribute on PanelRef at CoverageOptionsScreen.pcf: line 30, column 59
    function def_onEnter_22 (def :  pcf.WCOptionsPanelSet) : void {
    ...
    // 'def' attribute on PanelRef at CoverageOptionsScreen.pcf: line 30, column 59
    function def_refreshVariables_23 (def :  pcf.WCOptionsPanelSet) : void {
      def.refreshVariables(policyPeriod, openForEdit)
    }
    
    // 'editable' attribute on Screen (id=CoverageOptionsScreen) at CoverageOptionsScreen.pcf: line 7, column 32
    function editable_24 () : java.lang.Boolean {
      return openForEdit
    }
    
    // 'mode' attribute on ToolbarButtonSetRef at CoverageOptionsScreen.pcf: line 21, column 104
    function mode_0 () : java.lang.Object {
      return policyPeriod.Job.Subtype
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at CoverageOptionsScreen.pcf: line 21, column 104
    ...
    // 'visible' attribute on AlertBar (id=QuoteRequestedAlert) at CoverageOptionsScreen.pcf: line 26, column 80

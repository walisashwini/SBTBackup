...
class CoveredAutoSymbolsScreenExpressions {
  @javax.annotation.Generated("config/web/pcf/line/ba/policy/CoveredAutoSymbolsScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class CoveredAutoSymbolsScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at CoveredAutoSymbolsScreen.pcf: line 28, column 58
    function def_onEnter_20 (def :  pcf.OOSEPanelSet) : void {
      def.onEnter(policyPeriod, jobWizardHelper)
    }
    
    // 'def' attribute on PanelRef at CoveredAutoSymbolsScreen.pcf: line 30, column 68
    function def_onEnter_22 (def :  pcf.CoveredAutoSymbolsPanelSet) : void {
    ...
    // 'def' attribute on PanelRef at CoveredAutoSymbolsScreen.pcf: line 30, column 68
    function def_refreshVariables_23 (def :  pcf.CoveredAutoSymbolsPanelSet) : void {
      def.refreshVariables(policyPeriod, openForEdit)
    }
    
    // 'editable' attribute on Screen (id=CoveredAutoSymbolsScreen) at CoveredAutoSymbolsScreen.pcf: line 7, column 35
    function editable_24 () : java.lang.Boolean {
      return openForEdit
    }
    
    // 'mode' attribute on ToolbarButtonSetRef at CoveredAutoSymbolsScreen.pcf: line 21, column 104
    function mode_0 () : java.lang.Object {
      return policyPeriod.Job.Subtype
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at CoveredAutoSymbolsScreen.pcf: line 21, column 104
    ...
    // 'visible' attribute on AlertBar (id=QuoteRequestedAlert) at CoveredAutoSymbolsScreen.pcf: line 26, column 80

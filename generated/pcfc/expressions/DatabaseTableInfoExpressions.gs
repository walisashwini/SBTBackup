...
class DatabaseTableInfoExpressions {
  ...
  public static class DatabaseTableInfoExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ButtonInput (id=DownloadParms_Input) at DatabaseTableInfo.pcf: line 99, column 105
    function action_12 () : void {
      PageHelper.download()
    }
    
    // 'action' attribute on ButtonInput (id=DownloadSchemaVerifierVerify_Input) at DatabaseTableInfo.pcf: line 46, column 130
    function action_4 () : void {
      DBSchemaPageHelper.getErrors(); verified = true; numVerificationErrors = DBSchemaPageHelper.Errors.Count
    }
    
    // 'action' attribute on ButtonInput (id=DownloadSchemaVerifierParms_Input) at DatabaseTableInfo.pcf: line 54, column 132
    ...
    // 'value' attribute on TextCell (id=error_Cell) at DatabaseTableInfo.pcf: line 85, column 30
    ...
    // 'value' attribute on TextInput (id=verified_Input) at DatabaseTableInfo.pcf: line 65, column 309

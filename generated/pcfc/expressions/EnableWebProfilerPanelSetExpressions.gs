...
class EnableWebProfilerPanelSetExpressions {
  ...
  public static class EnableWebProfilerPanelSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ButtonInput (id=TurnProfilingOn_Input) at EnableWebProfilerPanelSet.pcf: line 33, column 107
    function action_5 () : void {
      enableProfiling(enableProfilingActions)
    }
    
    // 'action' attribute on ButtonInput (id=TurnProfilingOff_Input) at EnableWebProfilerPanelSet.pcf: line 39, column 106
    ...
    // 'visible' attribute on ButtonInput (id=TurnProfilingOff_Input) at EnableWebProfilerPanelSet.pcf: line 39, column 106

...
class ErrorExpressions {
  ...
  public static class ErrorExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextAreaInput (id=Exception_Input) at Error.pcf: line 36, column 42
    function value_2 () : java.lang.String {
      return Exception
    }
    
    // 'value' attribute on TextAreaInput (id=StackTrace_Input) at Error.pcf: line 44, column 43
    function value_7 () : java.lang.String {
      return StackTrace
    }
    
    // 'visible' attribute on TextAreaInput (id=Exception_Input) at Error.pcf: line 36, column 42
    function visible_1 () : java.lang.Boolean {
      return Exception != null
    }
    
    // 'visible' attribute on InputDivider at Error.pcf: line 38, column 43

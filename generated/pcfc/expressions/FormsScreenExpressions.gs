...
class FormsScreenExpressions {
  @javax.annotation.Generated("config/web/pcf/policy/form/FormsScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class FormsScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at FormsScreen.pcf: line 24, column 58
    function def_onEnter_19 (def :  pcf.OOSEPanelSet) : void {
      def.onEnter(policyPeriod, jobWizardHelper)
    }
    
    // 'def' attribute on PanelRef at FormsScreen.pcf: line 26, column 36
    function def_onEnter_21 (def :  pcf.FormsDV) : void {
    ...
    // 'def' attribute on PanelRef at FormsScreen.pcf: line 26, column 36
    function def_refreshVariables_22 (def :  pcf.FormsDV) : void {
      def.refreshVariables(policyPeriod)
    }
    
    // 'editable' attribute on Screen (id=FormsScreen) at FormsScreen.pcf: line 7, column 22
    function editable_23 () : java.lang.Boolean {
      return openForEdit
    }
    
    // 'mode' attribute on ToolbarButtonSetRef at FormsScreen.pcf: line 21, column 104
    function mode_0 () : java.lang.Object {
      return policyPeriod.Job.Subtype
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at FormsScreen.pcf: line 21, column 104

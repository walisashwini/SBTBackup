...
class GeneralLiabilityEUScreenExpressions {
  @javax.annotation.Generated("config/web/pcf/line/gl/policy/GeneralLiabilityEUScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class GeneralLiabilityEUScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at GeneralLiabilityEUScreen.pcf: line 28, column 58
    function def_onEnter_20 (def :  pcf.OOSEPanelSet) : void {
      def.onEnter(policyPeriod, jobWizardHelper)
    }
    
    // 'def' attribute on PanelRef at GeneralLiabilityEUScreen.pcf: line 30, column 49
    function def_onEnter_22 (def :  pcf.GeneralLiabilityEUDV) : void {
    ...
    // 'def' attribute on PanelRef at GeneralLiabilityEUScreen.pcf: line 30, column 49
    function def_refreshVariables_23 (def :  pcf.GeneralLiabilityEUDV) : void {
      def.refreshVariables(policyPeriod)
    }
    
    // 'editable' attribute on Screen (id=GeneralLiabilityEUScreen) at GeneralLiabilityEUScreen.pcf: line 7, column 35
    function editable_24 () : java.lang.Boolean {
      return openForEdit
    }
    
    // 'mode' attribute on ToolbarButtonSetRef at GeneralLiabilityEUScreen.pcf: line 21, column 104
    function mode_0 () : java.lang.Object {
      return policyPeriod.Job.Subtype
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at GeneralLiabilityEUScreen.pcf: line 21, column 104
    ...
    // 'visible' attribute on AlertBar (id=QuoteRequestedAlert) at GeneralLiabilityEUScreen.pcf: line 26, column 80

...
@javax.annotation.Generated("config/web/pcf/line/hop/policy/HOPDwellingConstructionScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class HOPDwellingConstructionScreenExpressions {
  @javax.annotation.Generated("config/web/pcf/line/hop/policy/HOPDwellingConstructionScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class HOPDwellingConstructionScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at HOPDwellingConstructionScreen.pcf: line 32, column 58
    function def_onEnter_21 (def :  pcf.OOSEPanelSet) : void {
      def.onEnter(policyPeriod, jobWizardHelper)
    }
    
    // 'def' attribute on PanelRef at HOPDwellingConstructionScreen.pcf: line 34, column 90
    function def_onEnter_23 (def :  pcf.HOPDwellingConstructionPanelSet) : void {
    ...
    // 'def' attribute on PanelRef at HOPDwellingConstructionScreen.pcf: line 34, column 90
    function def_refreshVariables_24 (def :  pcf.HOPDwellingConstructionPanelSet) : void {
      def.refreshVariables(policyPeriod, openForEdit, jobWizardHelper)
    }
    
    // 'editable' attribute on Screen (id=HOPDwellingConstructionScreen) at HOPDwellingConstructionScreen.pcf: line 7, column 40
    function editable_25 () : java.lang.Boolean {
      return openForEdit
    }
    
    // 'initialValue' attribute on Variable at HOPDwellingConstructionScreen.pcf: line 20, column 26
    function initialValue_0 () : entity.Job {
      return policyPeriod.Job
    }
    
    // 'mode' attribute on ToolbarButtonSetRef at HOPDwellingConstructionScreen.pcf: line 25, column 91
    function mode_1 () : java.lang.Object {
      return job.Subtype
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at HOPDwellingConstructionScreen.pcf: line 25, column 91
    ...
    // 'visible' attribute on AlertBar (id=QuoteRequestedAlert) at HOPDwellingConstructionScreen.pcf: line 30, column 80

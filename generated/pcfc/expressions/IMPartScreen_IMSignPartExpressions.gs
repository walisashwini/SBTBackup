...
class IMPartScreen_IMSignPartExpressions {
  @javax.annotation.Generated("config/web/pcf/line/im/parts/signs/IMPartScreen.IMSignPart.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class IMPartScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at IMPartScreen.IMSignPart.pcf: line 36, column 58
    function def_onEnter_21 (def :  pcf.OOSEPanelSet) : void {
      def.onEnter(policyPeriod, jobWizardHelper)
    }
    
    // 'def' attribute on PanelRef at IMPartScreen.IMSignPart.pcf: line 38, column 73
    function def_onEnter_23 (def :  pcf.IMSignsPanelSet) : void {
      def.onEnter(policyPeriod, imSignPart, jobWizardHelper)
    }
    ...
    // 'def' attribute on PanelRef at IMPartScreen.IMSignPart.pcf: line 38, column 73
    function def_refreshVariables_24 (def :  pcf.IMSignsPanelSet) : void {
      def.refreshVariables(policyPeriod, imSignPart, jobWizardHelper)
    }
    
    // 'editable' attribute on Screen (id=IMPartScreen) at IMPartScreen.IMSignPart.pcf: line 8, column 23
    function editable_25 () : java.lang.Boolean {
      return openForEdit
    }
    
    // 'initialValue' attribute on Variable at IMPartScreen.IMSignPart.pcf: line 24, column 33
    function initialValue_0 () : entity.IMSignPart {
      return policyPeriod.IMLine.IMSignPart
    }
    
    // 'mode' attribute on ToolbarButtonSetRef at IMPartScreen.IMSignPart.pcf: line 29, column 91
    function mode_1 () : java.lang.Object {
      return job.Subtype
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at IMPartScreen.IMSignPart.pcf: line 29, column 91
    ...
    // 'visible' attribute on AlertBar (id=QuoteRequestedAlert) at IMPartScreen.IMSignPart.pcf: line 34, column 80

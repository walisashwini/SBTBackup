...
class InternalToolsTabBarExpressions {
  ...
  public static class InternalToolsTabBarExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function systemAlertBar_onEnter_133 (def :  pcf.SystemAlertBar) : void {
      def.onEnter()
    }
    
    // 'systemAlertBar' attribute on TabBar (id=InternalToolsTabBar) at InternalToolsTabBar.pcf: line 7, column 39
    function systemAlertBar_refreshVariables_134 (def :  pcf.SystemAlertBar) : void {
  ...
  public static class ServerToolsTabMenuItemExpressionsImpl extends InternalToolsTabBarExpressionsImpl {
    ...
    // 'location' attribute on Tab (id=ServerToolsTab) at ServerTools.pcf: line 36, column 38
    function action_106 () : void {
      pcf.ProductModelInfo.go()
    }
    ...
    function action_dest_107 () : pcf.api.Destination {
      return pcf.ProductModelInfo.createDestination()
    }
  ...
  public static class UnsupportedToolsTabMenuItemExpressionsImpl extends InternalToolsTabBarExpressionsImpl {
    ...
    // 'location' attribute on Tab (id=UnsupportedToolsTab) at UnsupportedTools.pcf: line 20, column 31
    function action_118 () : void {
      pcf.PCArchive.go()
    }
    
    // 'location' attribute on Tab (id=UnsupportedToolsTab) at UnsupportedTools.pcf: line 22, column 29
    function action_120 () : void {
      pcf.PCPurge.go()
    }
    
    // 'location' attribute on Tab (id=UnsupportedToolsTab) at UnsupportedTools.pcf: line 24, column 45
    function action_122 () : void {
      pcf.PersonalDataDestruction.go()
    }
    
    // 'location' attribute on Tab (id=UnsupportedToolsTab) at UnsupportedTools.pcf: line 26, column 32

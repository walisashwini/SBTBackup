...
class IssuanceWizard_QuoteScreenExpressions {
  @javax.annotation.Generated("config/web/pcf/job/issuance/IssuanceWizard_QuoteScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class IssuanceWizard_QuoteScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=CreateIssuanceQuote) at IssuanceWizard_QuoteScreen.pcf: line 37, column 23
    function action_21 () : void {
      policyPeriod.clickPrintQuoteButton("SubmissionQuote", "Issuance Quote")
    }
    
    // 'def' attribute on PanelRef at IssuanceWizard_QuoteScreen.pcf: line 40, column 76
    function def_onEnter_22 (def :  pcf.WarningsPanelSet) : void {
      def.onEnter(policyPeriod.getWizardQuoteScreenWarnings())
    }
    
    // 'def' attribute on PanelRef at IssuanceWizard_QuoteScreen.pcf: line 42, column 43
    function def_onEnter_24 (def :  pcf.Quote_SummaryDV) : void {
      def.onEnter(policyPeriod)
    }
    
    // 'def' attribute on PanelRef at IssuanceWizard_QuoteScreen.pcf: line 51, column 40
    ...
    // 'def' attribute on PanelRef at IssuanceWizard_QuoteScreen.pcf: line 63, column 40
    ...
    // 'initialValue' attribute on Variable at IssuanceWizard_QuoteScreen.pcf: line 22, column 46
    function initialValue_0 () : gw.document.DocumentProduction {
      return new gw.document.DocumentProduction()
    }
    
    // 'initialValue' attribute on Variable at IssuanceWizard_QuoteScreen.pcf: line 26, column 33
    function initialValue_1 () : entity.PolicyLine {
      return policyPeriod.RepresentativePolicyLines.first()
    }
    
    // 'mode' attribute on ToolbarButtonSetRef at IssuanceWizard_QuoteScreen.pcf: line 31, column 96
    function mode_2 () : java.lang.Object {
      return policyPeriod.Job.Subtype
    }
    
    // 'mode' attribute on PanelRef at IssuanceWizard_QuoteScreen.pcf: line 51, column 40
    function mode_50 () : java.lang.Object {
      return line.Pattern.PublicID
    }
    
    // 'title' attribute on TitleBar at IssuanceWizard_QuoteScreen.pcf: line 54, column 76
    function title_27 () : java.lang.String {
      return line.Pattern.DisplayName
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at IssuanceWizard_QuoteScreen.pcf: line 31, column 96
    ...
    // 'visible' attribute on TitleBar at IssuanceWizard_QuoteScreen.pcf: line 54, column 76

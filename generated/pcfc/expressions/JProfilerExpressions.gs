...
class JProfilerExpressions {
  ...
  public static class JProfilerScreenExpressionsImpl extends JProfilerExpressionsImpl {
    ...
    // 'action' attribute on ButtonInput (id=startthread_Input) at JProfiler.pcf: line 59, column 90
    function action_10 () : void {
      Result = gw.api.tools.InternalToolsUtil.doJProfilerAction("startthread")
    }
    
    // 'action' attribute on ButtonInput (id=stopAndRestartCPUAndThread_Input) at JProfiler.pcf: line 67, column 105
    function action_13 () : void {
      Result = gw.api.tools.InternalToolsUtil.doJProfilerAction("stopAndRestartCPUAndThread")
    }
    
    // 'action' attribute on ButtonInput (id=stop_Input) at JProfiler.pcf: line 75, column 83
    function action_16 () : void {
      Result = gw.api.tools.InternalToolsUtil.doJProfilerAction("stop")
    }
    
    // 'action' attribute on ButtonInput (id=dump_Input) at JProfiler.pcf: line 83, column 83
    function action_19 () : void {
      Result = gw.api.tools.InternalToolsUtil.doJProfilerAction("dump")
    }
    
    // 'action' attribute on ButtonInput (id=startmemory_Input) at JProfiler.pcf: line 43, column 90
    function action_4 () : void {
      Result = gw.api.tools.InternalToolsUtil.doJProfilerAction("startmemory")
    }
    
    // 'action' attribute on ButtonInput (id=startcpu_Input) at JProfiler.pcf: line 51, column 87
    function action_7 () : void {
      Result = gw.api.tools.InternalToolsUtil.doJProfilerAction("startcpu")
    }
    
    // 'available' attribute on ButtonInput (id=startmemory_Input) at JProfiler.pcf: line 43, column 90

...
class LoadStepsLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends LoadStepsLVExpressionsImpl {
    ...
    // 'action' attribute on TextCell (id=steptypecell_Cell) at LoadStepsLV.pcf: line 35, column 42
    ...
    // 'available' attribute on TextCell (id=steptypecell_Cell) at LoadStepsLV.pcf: line 35, column 42
    ...
    // 'value' attribute on TextCell (id=steptypecell_Cell) at LoadStepsLV.pcf: line 35, column 42
    function valueRoot_12 () : java.lang.Object {
      return DispStep
    }
    
    // 'value' attribute on TextCell (id=stepexecuteordercell_Cell) at LoadStepsLV.pcf: line 41, column 42
    ...
    // 'value' attribute on TextCell (id=stepstarttimecell_Cell) at LoadStepsLV.pcf: line 45, column 118
    function value_18 () : java.lang.String {
      return gw.api.util.StringUtil.formatDate(DispStep.LoadStep.StartTime, "MM/dd/yy HH:mm:ss.SSS")
    }
    
    // 'value' attribute on TextCell (id=stependtimecell_Cell) at LoadStepsLV.pcf: line 49, column 116
    function value_20 () : java.lang.String {
      return gw.api.util.StringUtil.formatDate(DispStep.LoadStep.EndTime, "MM/dd/yy HH:mm:ss.SSS")
    }
    
    // 'value' attribute on TextCell (id=stepdurationcell_Cell) at LoadStepsLV.pcf: line 55, column 121
    function value_22 () : java.lang.String {
      return gw.api.util.StringUtil.formatNumber(DispStep.LoadStep.getDuration() / 1000.0, "###,##0.0")
    }
    
    // 'value' attribute on TextCell (id=numopscell_Cell) at LoadStepsLV.pcf: line 62, column 40
    function value_24 () : java.lang.String {
      return gw.api.util.StringUtil.formatNumber(NumOps, "####0")
    }
    
    // 'visible' attribute on TextCell (id=numopscell_Cell) at LoadStepsLV.pcf: line 62, column 40
  ...
  public static class LoadStepsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'sortBy' attribute on TextCell (id=stepdurationcell_Cell) at LoadStepsLV.pcf: line 55, column 121
    function sortValue_4 (DispStep :  gw.api.tools.LoadStepDisplayable) : java.lang.Object {
      return DispStep.LoadStep.getDuration()
    }
    
    // 'sortBy' attribute on TextCell (id=numopscell_Cell) at LoadStepsLV.pcf: line 62, column 40
    function sortValue_5 (DispStep :  gw.api.tools.LoadStepDisplayable) : java.lang.Object {
      return DispStep.LoadStep.Operations.length
    }

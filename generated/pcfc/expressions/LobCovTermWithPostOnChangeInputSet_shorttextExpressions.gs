...
@javax.annotation.Generated("config/web/pcf/shared/coverage/LobCovTermWithPostOnChangeInputSet.shorttext.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class LobCovTermWithPostOnChangeInputSet_shorttextExpressions {
  @javax.annotation.Generated("config/web/pcf/shared/coverage/LobCovTermWithPostOnChangeInputSet.shorttext.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class LobCovTermWithPostOnChangeInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=StringTermInput_Input) at LobCovTermWithPostOnChangeInputSet.shorttext.pcf: line 27, column 111
    function defaultSetter_6 (__VALUE_TO_SET :  java.lang.Object) : void {
      (term as gw.api.domain.covterm.GenericCovTerm<String>).Value = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'editable' attribute on TextInput (id=StringTermInput_Input) at LobCovTermWithPostOnChangeInputSet.shorttext.pcf: line 27, column 111
    function editable_2 () : java.lang.Boolean {
      return displayable.Editable
    }
    
    // 'initialValue' attribute on Variable at LobCovTermWithPostOnChangeInputSet.shorttext.pcf: line 21, column 63
    ...
    // 'label' attribute on TextInput (id=StringTermInput_Input) at LobCovTermWithPostOnChangeInputSet.shorttext.pcf: line 27, column 111
    function label_3 () : java.lang.Object {
      return term.Pattern.DisplayName
    }
    
    // 'onChange' attribute on PostOnChange at LobCovTermWithPostOnChangeInputSet.shorttext.pcf: line 29, column 119
    function onChange_1 () : void {
      gw.lob.common.LobPropertyService.Instance.updateCovTermDependentProperties(term, jobWizardHelper)
    }
    
    // 'required' attribute on TextInput (id=StringTermInput_Input) at LobCovTermWithPostOnChangeInputSet.shorttext.pcf: line 27, column 111

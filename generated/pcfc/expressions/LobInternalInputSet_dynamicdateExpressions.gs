...
class LobInternalInputSet_dynamicdateExpressions {
  @javax.annotation.Generated("config/web/pcf/widgets/datamodel/LobInternalInputSet.dynamicdate.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class LobInternalInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'confirmMessage' attribute on DateInput (id=Input_Input) at LobInternalInputSet.dynamicdate.pcf: line 18, column 36
    function confirmMessage_1 () : java.lang.String {
      return displayable.ConfirmMessage
    }
    
    // 'value' attribute on DateInput (id=Input_Input) at LobInternalInputSet.dynamicdate.pcf: line 18, column 36
    function defaultSetter_5 (__VALUE_TO_SET :  java.lang.Object) : void {
      displayable.Value = __VALUE_TO_SET
    }
    
    // 'label' attribute on DateInput (id=Input_Input) at LobInternalInputSet.dynamicdate.pcf: line 18, column 36
    function label_2 () : java.lang.Object {
      return displayable.Label
    }
    
    // 'onChange' attribute on PostOnChange at LobInternalInputSet.dynamicdate.pcf: line 20, column 44
    function onChange_0 () : void {
      displayable.onChange()
    }
    
    // 'required' attribute on DateInput (id=Input_Input) at LobInternalInputSet.dynamicdate.pcf: line 18, column 36

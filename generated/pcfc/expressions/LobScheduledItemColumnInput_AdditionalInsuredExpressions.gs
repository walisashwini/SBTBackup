...
@javax.annotation.Generated("config/web/pcf/shared/coverage/LobScheduledItemColumnInput.AdditionalInsured.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class LobScheduledItemColumnInput_AdditionalInsuredExpressions {
  @javax.annotation.Generated("config/web/pcf/shared/coverage/LobScheduledItemColumnInput.AdditionalInsured.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class LobScheduledItemColumnInputExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on TextCell (id=AddlInsured_Cell) at LobScheduledItemColumnInput.AdditionalInsured.pcf: line 38, column 76
    function action_2 () : void {
      EditPolicyContactRolePopup.push(scheduledItem.getAdditionalInsuredProperty().PolicyAddlInsured, openForEdit)
    }
    
    // 'action' attribute on TextCell (id=AddlInsured_Cell) at LobScheduledItemColumnInput.AdditionalInsured.pcf: line 38, column 76
    function action_dest_3 () : pcf.api.Destination {
      return pcf.EditPolicyContactRolePopup.createDestination(scheduledItem.getAdditionalInsuredProperty().PolicyAddlInsured, openForEdit)
    }
    
    // 'initialValue' attribute on Variable at LobScheduledItemColumnInput.AdditionalInsured.pcf: line 32, column 84
    function initialValue_0 () : gw.lob.common.displayable.Displayable<PolicyAddlInsuredDetail> {
      return displayableFactory.createSchedulePropertyInfoDisplayable(clause, scheduledItem, schedulePropertyInfo) as gw.lob.common.displayable.Displayable<PolicyAddlInsuredDetail>
    }
    
    // 'onChange' attribute on PostOnChange at LobScheduledItemColumnInput.AdditionalInsured.pcf: line 40, column 59
    function onChange_1 () : void {
      displayable.onChange(jobWizardHelper)
    }
    
    // 'required' attribute on TextCell (id=AddlInsured_Cell) at LobScheduledItemColumnInput.AdditionalInsured.pcf: line 38, column 76
    function required_4 () : java.lang.Boolean {
      return displayable.Required
    }
    
    // 'value' attribute on TextCell (id=AddlInsured_Cell) at LobScheduledItemColumnInput.AdditionalInsured.pcf: line 38, column 76
    function valueRoot_6 () : java.lang.Object {
      return displayable
    }
    
    // 'value' attribute on TextCell (id=AddlInsured_Cell) at LobScheduledItemColumnInput.AdditionalInsured.pcf: line 38, column 76
    function value_5 () : entity.PolicyAddlInsuredDetail {
    ...
    property get displayable () : gw.lob.common.displayable.Displayable<PolicyAddlInsuredDetail> {
      return getVariableValue("displayable", 0) as gw.lob.common.displayable.Displayable<PolicyAddlInsuredDetail>
    }

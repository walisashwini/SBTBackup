...
@javax.annotation.Generated("config/web/pcf/shared/coverage/LobScheduledItemColumnInput.Boolean.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class LobScheduledItemColumnInput_BooleanExpressions {
  @javax.annotation.Generated("config/web/pcf/shared/coverage/LobScheduledItemColumnInput.Boolean.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class LobScheduledItemColumnInputExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'available' attribute on CheckBoxCell (id=BoolValue_Cell) at LobScheduledItemColumnInput.Boolean.pcf: line 38, column 33
    function available_2 () : java.lang.Boolean {
      return displayable.Available
    }
    
    // 'value' attribute on CheckBoxCell (id=BoolValue_Cell) at LobScheduledItemColumnInput.Boolean.pcf: line 38, column 33
    function defaultSetter_5 (__VALUE_TO_SET :  java.lang.Object) : void {
      displayable.Value = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'initialValue' attribute on Variable at LobScheduledItemColumnInput.Boolean.pcf: line 17, column 68
    function initialValue_0 () : gw.lob.common.displayable.Displayable<Boolean> {
      return displayableFactory.createSchedulePropertyInfoDisplayable(clause, scheduledItem, schedulePropertyInfo) as gw.lob.common.displayable.Displayable<Boolean>
    }
    
    // 'onChange' attribute on PostOnChange at LobScheduledItemColumnInput.Boolean.pcf: line 40, column 59
    function onChange_1 () : void {
      displayable.onChange(jobWizardHelper)
    }
    
    // 'required' attribute on CheckBoxCell (id=BoolValue_Cell) at LobScheduledItemColumnInput.Boolean.pcf: line 38, column 33
    ...
    property get displayable () : gw.lob.common.displayable.Displayable<Boolean> {
      return getVariableValue("displayable", 0) as gw.lob.common.displayable.Displayable<Boolean>
    }

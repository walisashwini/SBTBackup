...
class MessageDestinationStatisticsDVExpressions {
  ...
  public static class MessageDestinationStatisticsDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=Status_Input) at MessageDestinationStatisticsDV.pcf: line 21, column 36
    ...
    // 'value' attribute on TextInput (id=InFlight_Input) at MessageDestinationStatisticsDV.pcf: line 36, column 40
    function value_10 () : java.lang.Integer {
      return statistics.Inflight
    }
    
    // 'value' attribute on TextInput (id=Unsent_Input) at MessageDestinationStatisticsDV.pcf: line 41, column 40
    function value_13 () : java.lang.Integer {
      return statistics.Unsent
    }
    
    // 'value' attribute on TextInput (id=Batched_Input) at MessageDestinationStatisticsDV.pcf: line 46, column 40
    function value_16 () : java.lang.Integer {
      return statistics.BatchSize
    }
    
    // 'value' attribute on TextInput (id=ErrorCount_Input) at MessageDestinationStatisticsDV.pcf: line 51, column 40
    function value_19 () : java.lang.Integer {
      return statistics.AwaitingRetry
    }
    
    // 'value' attribute on TextInput (id=Error_Input) at MessageDestinationStatisticsDV.pcf: line 26, column 40
    function value_4 () : java.lang.Integer {
      return statistics.Error
    }
    
    // 'value' attribute on TextInput (id=Retry_Input) at MessageDestinationStatisticsDV.pcf: line 31, column 40

...
class OracleAWRInfoExpressions {
  ...
  public static class OracleAWRInfoScreenExpressionsImpl extends OracleAWRInfoExpressionsImpl {
    ...
    // 'percentage' attribute on ProgressInput (id=batchProgress_Input) at OracleAWRInfo.pcf: line 57, column 214
    function percentage_6 () : java.lang.Double {
      return PageHelper.BatchRunning ? -1 : 100
    }
    
    // 'status' attribute on ProgressInput (id=batchProgress_Input) at OracleAWRInfo.pcf: line 57, column 214
    function status_7 () : java.lang.String {
      return PageHelper.BatchRunning ? DisplayKey.get("Web.InternalTools.InfoPages.PerfDownload.RunningBatchProcess", AwrReportUserSettings.getDescription(), PageHelper.DetailedStatus) : null
    }

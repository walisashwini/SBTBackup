...
class OracleStatspackInfoExpressions {
  ...
  public static class OracleStatspackInfoExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=download) at OracleStatspackInfo.pcf: line 35, column 66
    function action_2 () : void {
      PageHelper.downloadStatspackInfo()
    }
    
    // 'action' attribute on ToolbarButton (id=refresh) at OracleStatspackInfo.pcf: line 39, column 65
    function action_3 () : void {
      PageHelper.loadSnapshotInfo()
    }
    
    // 'action' attribute on ToolbarButton (id=TogglePaging) at OracleStatspackInfo.pcf: line 43, column 172
    function action_4 () : void {
      Paging = !Paging
    }
    
    // 'available' attribute on ToolbarButton (id=download) at OracleStatspackInfo.pcf: line 35, column 66
    ...
    // 'label' attribute on ToolbarButton (id=TogglePaging) at OracleStatspackInfo.pcf: line 43, column 172

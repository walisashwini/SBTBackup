...
class OracleStatspackLV_nopagingExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends OracleStatspackLVExpressionsImpl {
    ...
    // 'value' attribute on CheckBoxCell (id=selector_Cell) at OracleStatspackLV.nopaging.pcf: line 23, column 38
    ...
    // 'value' attribute on DateCell (id=startuptime_Cell) at OracleStatspackLV.nopaging.pcf: line 46, column 36
    function value_10 () : java.util.Date {
      return Row.StartupTime
    }
    
    // 'value' attribute on TextCell (id=Description_Cell) at OracleStatspackLV.nopaging.pcf: line 51, column 36
    function value_13 () : java.lang.String {
      return Row.Description
    }
    
    // 'value' attribute on TextCell (id=SnapshotID_Cell) at OracleStatspackLV.nopaging.pcf: line 32, column 42
    function value_4 () : java.lang.Integer {
      return Row.Id
    }
    
    // 'value' attribute on DateCell (id=time_Cell) at OracleStatspackLV.nopaging.pcf: line 39, column 33

...
class PADriversScreenExpressions {
  @javax.annotation.Generated("config/web/pcf/line/pa/policy/PADriversScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class PADriversScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at PADriversScreen.pcf: line 31, column 58
    function def_onEnter_20 (def :  pcf.OOSEPanelSet) : void {
      def.onEnter(policyPeriod, jobWizardHelper)
    }
    
    // 'def' attribute on PanelRef at PADriversScreen.pcf: line 33, column 90
    function def_onEnter_22 (def :  pcf.PADriversPanelSet) : void {
      def.onEnter(policyPeriod, policyPeriod.PersonalAutoLine, openForEdit)
    }
    ...
    // 'def' attribute on PanelRef at PADriversScreen.pcf: line 33, column 90
    function def_refreshVariables_23 (def :  pcf.PADriversPanelSet) : void {
      def.refreshVariables(policyPeriod, policyPeriod.PersonalAutoLine, openForEdit)
    }
    
    // 'editable' attribute on Screen (id=PADriversScreen) at PADriversScreen.pcf: line 7, column 26
    function editable_24 () : java.lang.Boolean {
      return openForEdit
    }
    
    // 'mode' attribute on ToolbarButtonSetRef at PADriversScreen.pcf: line 24, column 91
    function mode_0 () : java.lang.Object {
      return job.Subtype
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at PADriversScreen.pcf: line 24, column 91
    ...
    // 'visible' attribute on AlertBar (id=QuoteRequestedAlert) at PADriversScreen.pcf: line 29, column 80

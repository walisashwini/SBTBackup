...
class PickProfilerSourceLV_BatchProcessExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends PickProfilerSourceLVExpressionsImpl {
    ...
    // 'value' attribute on TypeKeyCell (id=BatchProcess_Cell) at PickProfilerSourceLV.BatchProcess.pcf: line 37, column 49
    function valueRoot_6 () : java.lang.Object {
      return batchProcessHistory
    }
    
    // 'value' attribute on TextCell (id=Description_Cell) at PickProfilerSourceLV.BatchProcess.pcf: line 42, column 64
    function valueRoot_9 () : java.lang.Object {
      return batchProcessHistory.ProcessType
    }
    
    // 'value' attribute on DateCell (id=StartDate_Cell) at PickProfilerSourceLV.BatchProcess.pcf: line 50, column 50
    function value_11 () : java.util.Date {
      return batchProcessHistory.StartDate
    }
    
    // 'value' attribute on DateCell (id=CompleteDate_Cell) at PickProfilerSourceLV.BatchProcess.pcf: line 56, column 53
    function value_14 () : java.util.Date {
      return batchProcessHistory.CompleteDate
    }
    
    // 'value' attribute on BooleanRadioCell (id=RanToCompletion_Cell) at PickProfilerSourceLV.BatchProcess.pcf: line 60, column 56

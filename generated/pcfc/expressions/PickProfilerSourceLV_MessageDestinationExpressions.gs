...
class PickProfilerSourceLV_MessageDestinationExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends PickProfilerSourceLVExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=MessageDestinationID_Cell) at PickProfilerSourceLV.MessageDestination.pcf: line 38, column 42
    function valueRoot_7 () : java.lang.Object {
      return instrumentedMessage
    }
    
    // 'value' attribute on DateCell (id=StartTime_Cell) at PickProfilerSourceLV.MessageDestination.pcf: line 51, column 50
    function value_12 () : java.util.Date {
      return instrumentedMessage.StartTime
    }
    
    // 'value' attribute on DateCell (id=EndTime_Cell) at PickProfilerSourceLV.MessageDestination.pcf: line 57, column 48
    ...
    // 'value' attribute on TextCell (id=MessageDestinationName_Cell) at PickProfilerSourceLV.MessageDestination.pcf: line 43, column 45

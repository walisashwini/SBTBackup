...
class PickProfilerSourceLV_StartablePluginExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends PickProfilerSourceLVExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=ServiceName_Cell) at PickProfilerSourceLV.StartablePlugin.pcf: line 38, column 54
    function valueRoot_7 () : java.lang.Object {
      return startablePluginHistory
    }
    
    // 'value' attribute on DateCell (id=CompleteDate_Cell) at PickProfilerSourceLV.StartablePlugin.pcf: line 52, column 56
    ...
    // 'value' attribute on DateCell (id=StartDate_Cell) at PickProfilerSourceLV.StartablePlugin.pcf: line 46, column 53
  ...
  public static class PickProfilerSourceLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function deleteProfilerData(startablePluginHistory : StartablePluginHistory) {
      gw.transaction.Transaction.runWithNewBundle( \ bundle -> {
          bundle.delete( startablePluginHistory )
        }
      )
    }

...
class PickProfilerSourceLV_WorkQueueExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends PickProfilerSourceLVExpressionsImpl {
    ...
    // 'outputConversion' attribute on TextCell (id=Duration_Cell) at PickProfilerSourceLV.WorkQueue.pcf: line 71, column 50
    function outputConversion_21 (VALUE :  gw.api.web.tools.Duration) : java.lang.String {
      return VALUE.DisplayString
    }
    
    // 'value' attribute on TextCell (id=InstanceNumber_Cell) at PickProfilerSourceLV.WorkQueue.pcf: line 50, column 42
    function valueRoot_13 () : java.lang.Object {
      return instrumentedWorkerTask
    }
    
    // 'value' attribute on TypeKeyCell (id=WorkQueueName_Cell) at PickProfilerSourceLV.WorkQueue.pcf: line 38, column 49
    ...
    // 'value' attribute on DateCell (id=StartTime_Cell) at PickProfilerSourceLV.WorkQueue.pcf: line 58, column 53
    function value_15 () : java.util.Date {
      return instrumentedWorkerTask.StartTime
    }
    
    // 'value' attribute on DateCell (id=EndTime_Cell) at PickProfilerSourceLV.WorkQueue.pcf: line 64, column 51
    function value_18 () : java.util.Date {
      return instrumentedWorkerTask.EndTime
    }
    
    // 'value' attribute on TextCell (id=Duration_Cell) at PickProfilerSourceLV.WorkQueue.pcf: line 71, column 50
    ...
    // 'value' attribute on TextCell (id=AppServerName_Cell) at PickProfilerSourceLV.WorkQueue.pcf: line 44, column 82

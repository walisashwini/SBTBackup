...
class PolicyChangeWizard_PolicyInfoScreenExpressions {
  @javax.annotation.Generated("config/web/pcf/job/policychange/PolicyChangeWizard_PolicyInfoScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class PolicyChangeWizard_PolicyInfoScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at PolicyChangeWizard_PolicyInfoScreen.pcf: line 31, column 52
    function def_onEnter_20 (def :  pcf.OOSEPanelSet) : void {
      def.onEnter(period, jobWizardHelper)
    }
    
    // 'def' attribute on PanelRef at PolicyChangeWizard_PolicyInfoScreen.pcf: line 33, column 54
    function def_onEnter_22 (def :  pcf.PolicyChangeWizard_PolicyInfoDV) : void {
      def.onEnter(period)
    }
    ...
    // 'def' attribute on PanelRef at PolicyChangeWizard_PolicyInfoScreen.pcf: line 33, column 54
    function def_refreshVariables_23 (def :  pcf.PolicyChangeWizard_PolicyInfoDV) : void {
      def.refreshVariables(period)
    }
    
    // 'editable' attribute on Screen (id=PolicyChangeWizard_PolicyInfoScreen) at PolicyChangeWizard_PolicyInfoScreen.pcf: line 7, column 46
    function editable_24 () : java.lang.Boolean {
      return openForEdit
    }
    
    // 'mode' attribute on ToolbarButtonSetRef at PolicyChangeWizard_PolicyInfoScreen.pcf: line 24, column 94
    function mode_0 () : java.lang.Object {
      return period.Job.Subtype
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at PolicyChangeWizard_PolicyInfoScreen.pcf: line 24, column 94
    function toolbarButtonSet_onEnter_1 (def :  pcf.JobWizardToolbarButtonSet_Audit) : void {
      def.onEnter(period, policyChange, jobWizardHelper)
    }
    ...
    function toolbarButtonSet_refreshVariables_10 (def :  pcf.JobWizardToolbarButtonSet_Reinstatement) : void {
      def.refreshVariables(period, policyChange, jobWizardHelper)
    }
    ...
    // 'visible' attribute on AlertBar (id=QuoteRequestedAlert) at PolicyChangeWizard_PolicyInfoScreen.pcf: line 29, column 74

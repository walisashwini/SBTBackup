...
class ProfilerExpressions {
  ...
  public static class LocationGroupMenuItemExpressionsImpl extends ProfilerExpressionsImpl {
    ...
    // 'location' attribute on LocationGroup (id=Profiler) at ProfilerAnalysisLG.pcf: line 28, column 67
    function action_12 () : void {
      pcf.ProfilerAnalysisPage.go("RestOperation")
    }
    
    // 'location' attribute on LocationGroup (id=Profiler) at ProfilerAnalysisLG.pcf: line 31, column 69
    function action_14 () : void {
      pcf.ProfilerAnalysisPage.go("StartablePlugin")
    }
    
    // 'location' attribute on LocationGroup (id=Profiler) at ProfilerAnalysisLG.pcf: line 34, column 61
    function action_16 () : void {
      pcf.ProfilerAnalysisPage.go("Upgrade")
    }
    
    // 'location' attribute on LocationGroup (id=Profiler) at ProfilerAnalysisLG.pcf: line 37, column 60
    ...
    // 'location' attribute on LocationGroup (id=Profiler) at ProfilerAnalysisLG.pcf: line 40, column 63
    function action_20 () : void {
      pcf.ProfilerAnalysisPage.go("SavedFile")
    }
    
    // 'location' attribute on LocationGroup (id=Profiler) at ProfilerAnalysisLG.pcf: line 43, column 65
  ...
  public static class ProfilerExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function tabBar_onEnter_28 (def :  pcf.InternalToolsTabBar) : void {
      def.onEnter()
    }
    
    // 'tabBar' attribute on LocationGroup (id=Profiler) at Profiler.pcf: line 8, column 54
    function tabBar_refreshVariables_29 (def :  pcf.InternalToolsTabBar) : void {

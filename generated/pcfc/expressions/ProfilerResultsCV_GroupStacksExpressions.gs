...
class ProfilerResultsCV_GroupStacksExpressions {
  ...
  public static class ProfilerResultsCVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=stacks_Input) at ProfilerResultsCV.GroupStacks.pcf: line 30, column 44
    ...
    // 'value' attribute on TextInput (id=frames_Input) at ProfilerResultsCV.GroupStacks.pcf: line 35, column 44
    function value_6 () : java.lang.Integer {
      return profilerDataSource.ProfilerFrameGroupSource.FrameCount
    }
    
    // 'value' attribute on TextInput (id=time_Input) at ProfilerResultsCV.GroupStacks.pcf: line 40, column 44

...
class QuestionModalInput_BooleanRadioExpressions {
  @javax.annotation.Generated("config/web/pcf/shared/question/QuestionModalInput.BooleanRadio.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class QuestionModalInputExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on BooleanRadioCell (id=BooleanRadioInput_Cell) at QuestionModalInput.BooleanRadio.pcf: line 21, column 65
    function defaultSetter_3 (__VALUE_TO_SET :  java.lang.Object) : void {
      answerContainer.getAnswer(question).BooleanAnswer = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'onChange' attribute on PostOnChange at QuestionModalInput.BooleanRadio.pcf: line 23, column 64
    function onChange_0 () : void {
      if (onChangeBlock != null) onChangeBlock()
    }
    
    // 'required' attribute on BooleanRadioCell (id=BooleanRadioInput_Cell) at QuestionModalInput.BooleanRadio.pcf: line 21, column 65

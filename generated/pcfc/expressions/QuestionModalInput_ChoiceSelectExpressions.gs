...
class QuestionModalInput_ChoiceSelectExpressions {
  @javax.annotation.Generated("config/web/pcf/shared/question/QuestionModalInput.ChoiceSelect.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class QuestionModalInputExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RangeCell (id=ChoiceSelectInput_Cell) at QuestionModalInput.ChoiceSelect.pcf: line 23, column 54
    function defaultSetter_3 (__VALUE_TO_SET :  java.lang.Object) : void {
      answerContainer.getAnswer(question).ChoiceAnswer = (__VALUE_TO_SET as gw.api.productmodel.QuestionChoice)
    }
    
    // 'onChange' attribute on PostOnChange at QuestionModalInput.ChoiceSelect.pcf: line 25, column 64
    function onChange_0 () : void {
      if (onChangeBlock != null) onChangeBlock()
    }
    
    // 'required' attribute on RangeCell (id=ChoiceSelectInput_Cell) at QuestionModalInput.ChoiceSelect.pcf: line 23, column 54
    function required_1 () : java.lang.Boolean {
      return question.Required
    }
    
    // 'valueRange' attribute on RangeCell (id=ChoiceSelectInput_Cell) at QuestionModalInput.ChoiceSelect.pcf: line 23, column 54

...
class QuestionModalInput_StringFieldExpressions {
  @javax.annotation.Generated("config/web/pcf/shared/question/QuestionModalInput.StringField.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class QuestionModalInputExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=StringFieldInput_Cell) at QuestionModalInput.StringField.pcf: line 22, column 19
    function defaultSetter_3 (__VALUE_TO_SET :  java.lang.Object) : void {
      answerContainer.getAnswer(question).TextAnswer = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'onChange' attribute on PostOnChange at QuestionModalInput.StringField.pcf: line 24, column 64
    function onChange_0 () : void {
      if (onChangeBlock != null) onChangeBlock()
    }
    
    // 'required' attribute on TextCell (id=StringFieldInput_Cell) at QuestionModalInput.StringField.pcf: line 22, column 19

...
class RateRoutineConditionalPopupFirstOperand_variableExpressions {
  @javax.annotation.Generated("config/web/pcf/admin/forms/RateRoutineConditionalPopupFirstOperand.variable.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class RateRoutineConditionalPopupFirstOperandExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on MenuItemSetRef at RateRoutineConditionalPopupFirstOperand.variable.pcf: line 31, column 133
    ...
    // 'value' attribute on TextCell (id=leftOperandName_Cell) at RateRoutineConditionalPopupFirstOperand.variable.pcf: line 28, column 123
    ...
    function value_3 () : java.lang.String {
      return conditionalOperand.First.OperandName
    }
    
    // 'valueVisible' attribute on TextCell (id=leftOperandName_Cell) at RateRoutineConditionalPopupFirstOperand.variable.pcf: line 28, column 123
    function visible_2 () : java.lang.Boolean {
      return (conditionalOperand.First.OperandType != null) and (not conditionalOperand.First.IsEditableConstant)
    }

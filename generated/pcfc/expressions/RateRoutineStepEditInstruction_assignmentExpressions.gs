...
@javax.annotation.Generated("config/web/pcf/admin/rating/RateRoutineStepEditInstruction.assignment.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class RateRoutineStepEditInstruction_assignmentExpressions {
  @javax.annotation.Generated("config/web/pcf/admin/rating/RateRoutineStepEditInstruction.assignment.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class RateRoutineStepEditInstructionExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on MenuItemSetRef at RateRoutineStepEditInstruction.assignment.pcf: line 33, column 109
    ...
    // 'outputConversion' attribute on TextCell (id=RateRoutineStepEditInstructionForAssignment_Cell) at RateRoutineStepEditInstruction.assignment.pcf: line 31, column 93
    ...
    // 'value' attribute on TextCell (id=RateRoutineStepEditInstructionForAssignment_Cell) at RateRoutineStepEditInstruction.assignment.pcf: line 31, column 93
    function value_3 () : java.lang.String {
      return step.InScopeParam == null ? step.StoreLocation : step.StoreLocationForDisplay
    }

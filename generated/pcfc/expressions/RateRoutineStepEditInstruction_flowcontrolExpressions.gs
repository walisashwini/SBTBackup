...
@javax.annotation.Generated("config/web/pcf/admin/rating/RateRoutineStepEditInstruction.flowcontrol.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class RateRoutineStepEditInstruction_flowcontrolExpressions {
  @javax.annotation.Generated("config/web/pcf/admin/rating/RateRoutineStepEditInstruction.flowcontrol.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class RateRoutineStepEditInstructionExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on MenuItemSetRef at RateRoutineStepEditInstruction.flowcontrol.pcf: line 33, column 109
    ...
    // 'outputConversion' attribute on TextCell (id=RateRoutineStepInstructionForFlowControl_Cell) at RateRoutineStepEditInstruction.flowcontrol.pcf: line 31, column 39
    function outputConversion_2 (VALUE :  java.lang.String) : java.lang.String {
      return step.indentValue(VALUE, indentLevelMap)
    }
    
    // 'value' attribute on TextCell (id=RateRoutineStepInstructionForFlowControl_Cell) at RateRoutineStepEditInstruction.flowcontrol.pcf: line 31, column 39
    ...
    function value_3 () : java.lang.String {
      return step.StepTypeForDisplay
    }

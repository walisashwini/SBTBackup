...
class RateTableFactorModalCell_dateExpressions {
  @javax.annotation.Generated("config/web/pcf/admin/rating/RateTableFactorModalCell.date.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class RateTableFactorModalCellExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on DateCell (id=ValueCell_Cell) at RateTableFactorModalCell.date.pcf: line 22, column 95
    function defaultSetter_2 (__VALUE_TO_SET :  java.lang.Object) : void {
      (cell as gw.rating.rtm.domain.table.RateTableCell<java.util.Date>).Value = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'required' attribute on DateCell (id=ValueCell_Cell) at RateTableFactorModalCell.date.pcf: line 22, column 95

...
class RatingCumulDetailsPanelSet_ManualLineExpressions {
  @javax.annotation.Generated("config/web/pcf/line/apd/policy/RatingCumulDetailsPanelSet.ManualLine.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class IteratorEntry2ExpressionsImpl extends IteratorEntryExpressionsImpl {
    ...
    // 'action' attribute on TextCell (id=Type_Cell) at RatingCumulDetailsPanelSet.ManualLine.pcf: line 117, column 44
    ...
    // 'value' attribute on TextCell (id=Type_Cell) at RatingCumulDetailsPanelSet.ManualLine.pcf: line 117, column 44
    ...
    // 'value' attribute on TextCell (id=Description_Cell) at RatingCumulDetailsPanelSet.ManualLine.pcf: line 120, column 47
    function value_33 () : java.lang.String {
      return detail.Description
    }
    
    // 'value' attribute on TextCell (id=SettlementAmount_Cell) at RatingCumulDetailsPanelSet.ManualLine.pcf: line 125, column 62
    function value_36 () : gw.pl.currency.MonetaryAmount {
      return detail.SettlementAmount
    }
    
    // 'value' attribute on TextCell (id=Amount_Cell) at RatingCumulDetailsPanelSet.ManualLine.pcf: line 130, column 62
    function value_39 () : gw.pl.currency.MonetaryAmount {
      return detail.Amount
    }
    
    // 'value' attribute on TextCell (id=CurrentTerm_Cell) at RatingCumulDetailsPanelSet.ManualLine.pcf: line 135, column 62
    function value_42 () : gw.pl.currency.MonetaryAmount {
      return detail.CurrentTerm
    }
    
    // 'value' attribute on TextCell (id=FutureTerm_Cell) at RatingCumulDetailsPanelSet.ManualLine.pcf: line 140, column 62
  ...
  public static class IteratorEntryExpressionsImpl extends PanelIteratorEntryExpressionsImpl {
    ...
    // 'actionAvailable' attribute on TextCell (id=Type_Cell) at RatingCumulDetailsPanelSet.ManualLine.pcf: line 74, column 42
    function actionAvailable_8 () : java.lang.Boolean {
      return charge.Details.Count == 0
    }
    
    // 'action' attribute on TextCell (id=Type_Cell) at RatingCumulDetailsPanelSet.ManualLine.pcf: line 74, column 42
    ...
    // 'sortBy' attribute on IteratorSort at RatingCumulDetailsPanelSet.ManualLine.pcf: line 108, column 32
    function sortBy_27 (detail :  gw.apd.policy.QuoteHelperLine) : java.lang.Object {
      return detail.Description
    }
    
    // 'sortBy' attribute on IteratorSort at RatingCumulDetailsPanelSet.ManualLine.pcf: line 111, column 32
    function sortBy_28 (detail :  gw.apd.policy.QuoteHelperLine) : java.lang.Object {
      return detail.Order
    }
    
    // 'value' attribute on TextCell (id=Type_Cell) at RatingCumulDetailsPanelSet.ManualLine.pcf: line 74, column 42
    function valueRoot_10 () : java.lang.Object {
      return charge
    }
    
    // 'value' attribute on TextCell (id=Description_Cell) at RatingCumulDetailsPanelSet.ManualLine.pcf: line 77, column 45
    function value_12 () : java.lang.String {
      return charge.Description
    }
    
    // 'value' attribute on TextCell (id=SettlementAmount_Cell) at RatingCumulDetailsPanelSet.ManualLine.pcf: line 82, column 60
    function value_15 () : gw.pl.currency.MonetaryAmount {
      return charge.SettlementAmount
    }
    
    // 'value' attribute on TextCell (id=Amount_Cell) at RatingCumulDetailsPanelSet.ManualLine.pcf: line 87, column 60
    function value_18 () : gw.pl.currency.MonetaryAmount {
      return charge.Amount
    }
    
    // 'value' attribute on TextCell (id=CurrentTerm_Cell) at RatingCumulDetailsPanelSet.ManualLine.pcf: line 92, column 60
    function value_21 () : gw.pl.currency.MonetaryAmount {
      return charge.CurrentTerm
    }
    
    // 'value' attribute on TextCell (id=FutureTerm_Cell) at RatingCumulDetailsPanelSet.ManualLine.pcf: line 97, column 60
    function value_24 () : gw.pl.currency.MonetaryAmount {
      return charge.FutureTerm
    }
    
    // 'value' attribute on RowIterator at RatingCumulDetailsPanelSet.ManualLine.pcf: line 105, column 71
    ...
    // 'valueType' attribute on RowIterator at RatingCumulDetailsPanelSet.ManualLine.pcf: line 105, column 71
  ...
  public static class PanelIteratorEntryExpressionsImpl extends RatingCumulDetailsPanelSetExpressionsImpl {
    ...
    // 'def' attribute on PanelRef (id=RatingOverrideButtonDV) at RatingCumulDetailsPanelSet.ManualLine.pcf: line 27, column 38
    function def_onEnter_1 (def :  pcf.RatingOverrideButtonDV) : void {
      def.onEnter(period, line, jobWizardHelper, CurrentLocation.InEditMode and not period.Job.Complete)
    }
    
    // 'def' attribute on PanelRef (id=RatingOverrideButtonDV) at RatingCumulDetailsPanelSet.ManualLine.pcf: line 27, column 38
    function def_refreshVariables_2 (def :  pcf.RatingOverrideButtonDV) : void {
      def.refreshVariables(period, line, jobWizardHelper, CurrentLocation.InEditMode and not period.Job.Complete)
    }
    
    // 'initialValue' attribute on Variable at RatingCumulDetailsPanelSet.ManualLine.pcf: line 24, column 43
    function initialValue_0 () : gw.apd.policy.QuoteHelper {
      return new gw.apd.policy.QuoteHelper(line)
    }
    
    // PanelIterator at RatingCumulDetailsPanelSet.ManualLine.pcf: line 20, column 32
    function initializeVariables_54 () : void {
        quoteHelper = new gw.apd.policy.QuoteHelper(line);

    }
    
    // 'sortBy' attribute on IteratorSort at RatingCumulDetailsPanelSet.ManualLine.pcf: line 64, column 30
    function sortBy_5 (charge :  gw.apd.policy.QuoteHelperLine) : java.lang.Object {
      return charge.Order
    }
    
    // 'sortBy' attribute on IteratorSort at RatingCumulDetailsPanelSet.ManualLine.pcf: line 67, column 30
    function sortBy_6 (charge :  gw.apd.policy.QuoteHelperLine) : java.lang.Object {
      return charge.Description
    }
    
    // 'value' attribute on TextCell (id=FutureTermHeading_Cell) at RatingCumulDetailsPanelSet.ManualLine.pcf: line 53, column 229
    ...
    // 'value' attribute on RowIterator (id=ChargeLV) at RatingCumulDetailsPanelSet.ManualLine.pcf: line 61, column 69
    function value_51 () : List<gw.apd.policy.QuoteHelperLine> {
      return quoteHelper.Charges
    }
    
    // 'valueType' attribute on RowIterator (id=ChargeLV) at RatingCumulDetailsPanelSet.ManualLine.pcf: line 61, column 69
  ...
  public static class RatingCumulDetailsPanelSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on PanelIterator at RatingCumulDetailsPanelSet.ManualLine.pcf: line 20, column 32

...
class RewriteNewAccountWizard_PolicyInfoDVExpressions {
  @javax.annotation.Generated("config/web/pcf/job/rewritenewaccount/RewriteNewAccountWizard_PolicyInfoDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class RewriteNewAccountWizard_PolicyInfoDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ButtonInput (id=AutoSelectUWCompany_Input) at RewriteNewAccountWizard_PolicyInfoDV.pcf: line 62, column 53
    function action_29 () : void {
      policyPeriod.autoSelectUWCompany()
    }
    
    // 'currency' attribute on MonetaryAmountInput (id=estimatedPremiumInput_Input) at RewriteNewAccountWizard_PolicyInfoDV.pcf: line 30, column 77
    function currency_5 () : typekey.Currency {
      return policyPeriod.PreferredSettlementCurrency
    }
    
    // 'def' attribute on InputSetRef at RewriteNewAccountWizard_PolicyInfoDV.pcf: line 34, column 60
    function def_onEnter_10 (def :  pcf.SecondaryNamedInsuredInputSet) : void {
      def.onEnter(policyPeriod)
    }
    
    // 'def' attribute on InputSetRef at RewriteNewAccountWizard_PolicyInfoDV.pcf: line 36, column 74
    function def_onEnter_12 (def :  pcf.AdditionalNamedInsuredInputSet) : void {
      def.onEnter(policyPeriod, openForEdit)
    }
    
    // 'def' attribute on InputSetRef at RewriteNewAccountWizard_PolicyInfoDV.pcf: line 41, column 38
    function def_onEnter_14 (def :  pcf.PolicyInfoInputSet) : void {
      def.onEnter(policyPeriod, true, true, false)
    }
    
    // 'def' attribute on InputSetRef at RewriteNewAccountWizard_PolicyInfoDV.pcf: line 44, column 102
    ...
    // 'def' attribute on InputSetRef at RewriteNewAccountWizard_PolicyInfoDV.pcf: line 65, column 56
    function def_onEnter_31 (def :  pcf.PreferredCurrencyInputSet) : void {
      def.onEnter(policyPeriod)
    }
    
    // 'def' attribute on InputSetRef at RewriteNewAccountWizard_PolicyInfoDV.pcf: line 32, column 50
    ...
    function def_refreshVariables_15 (def :  pcf.PolicyInfoInputSet) : void {
      def.refreshVariables(policyPeriod, true, true, false)
    }
    ...
    // 'value' attribute on RangeInput (id=UWCompany_Input) at RewriteNewAccountWizard_PolicyInfoDV.pcf: line 56, column 41
    function defaultSetter_20 (__VALUE_TO_SET :  java.lang.Object) : void {
      policyPeriod.UWCompany = (__VALUE_TO_SET as entity.UWCompany)
    }
    
    // 'value' attribute on MonetaryAmountInput (id=estimatedPremiumInput_Input) at RewriteNewAccountWizard_PolicyInfoDV.pcf: line 30, column 77
    function defaultSetter_3 (__VALUE_TO_SET :  java.lang.Object) : void {
      policyPeriod.EstimatedPremium = (__VALUE_TO_SET as gw.pl.currency.MonetaryAmount)
    }
    
    // 'editable' attribute on RangeInput (id=UWCompany_Input) at RewriteNewAccountWizard_PolicyInfoDV.pcf: line 56, column 41
    function editable_18 () : java.lang.Boolean {
      return perm.System.multicompquote
    }
    
    // 'initialValue' attribute on Variable at RewriteNewAccountWizard_PolicyInfoDV.pcf: line 19, column 43
    function initialValue_0 () : gw.job.AvailableUWCompanies {
      return new gw.job.AvailableUWCompanies(policyPeriod)
    }
    
    // 'optionLabel' attribute on RangeInput (id=UWCompany_Input) at RewriteNewAccountWizard_PolicyInfoDV.pcf: line 56, column 41
    function optionLabel_22 (VALUE :  entity.UWCompany) : java.lang.String {
      return VALUE.DisplayName
    }
    
    // 'valueRange' attribute on RangeInput (id=UWCompany_Input) at RewriteNewAccountWizard_PolicyInfoDV.pcf: line 56, column 41
    ...
    // 'visible' attribute on MonetaryAmountInput (id=estimatedPremiumInput_Input) at RewriteNewAccountWizard_PolicyInfoDV.pcf: line 30, column 77
    function visible_1 () : java.lang.Boolean {
      return policyPeriod.Policy.Product.ProductType == TC_COMMERCIAL
    }
    
    // 'visible' attribute on ButtonInput (id=AutoSelectUWCompany_Input) at RewriteNewAccountWizard_PolicyInfoDV.pcf: line 62, column 53

...
class SideBySideCovTermInputSet_datetime_notargetExpressions {
  @javax.annotation.Generated("config/web/pcf/shared/coverage/SideBySideCovTermInputSet.datetime_notarget.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class SideBySideCovTermInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'colspan' attribute on LayoutConfig at SideBySideCovTermInputSet.datetime_notarget.pcf: line 47, column 95
    function colspan_13 () : java.lang.Integer {
      return colWidth
    }
    
    // 'value' attribute on DateInput (id=SideBySideDateTimeCovTermValue_Input) at SideBySideCovTermInputSet.datetime_notarget.pcf: line 44, column 37
    function defaultSetter_20 (__VALUE_TO_SET :  java.lang.Object) : void {
      covTermInfo.DateValue = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on CheckBoxInput (id=covTermEnabledId_Input) at SideBySideCovTermInputSet.datetime_notarget.pcf: line 23, column 28
    function defaultSetter_5 (__VALUE_TO_SET :  java.lang.Object) : void {
      covTermInfo.CovInfo.Selected = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'disablePostOnEnter' attribute on PostOnChange at SideBySideCovTermInputSet.datetime_notarget.pcf: line 50, column 68
    ...
    // 'editable' attribute on DateInput (id=SideBySideDateTimeCovTermValue_Input) at SideBySideCovTermInputSet.datetime_notarget.pcf: line 44, column 37
    function editable_17 () : java.lang.Boolean {
      return covTermInfo.CovInfo.PeriodInfo.SxSEditable and covTermInfo.Editable
    }
    
    // 'editable' attribute on CheckBoxInput (id=covTermEnabledId_Input) at SideBySideCovTermInputSet.datetime_notarget.pcf: line 23, column 28
    ...
    // 'onChange' attribute on PostOnChange at SideBySideCovTermInputSet.datetime_notarget.pcf: line 27, column 68
    function onChange_1 () : void {
      covTermInfo.CovInfo.coverageSelectionRefresh()
    }
    
    // 'onChange' attribute on PostOnChange at SideBySideCovTermInputSet.datetime_notarget.pcf: line 50, column 68
    function onChange_16 () : void {
      covTermInfo.CovInfo.coverageSelectionRefresh()
    }
    
    // 'tdClass' attribute on LayoutConfig at SideBySideCovTermInputSet.datetime_notarget.pcf: line 25, column 95
    function tdClass_0 () : java.lang.String {
      return "pc-sxs-col-" + (covTermInfo.CovInfo.PeriodInfo.ColumnIndex % 2)
    }
    
    // 'validationExpression' attribute on DateInput (id=SideBySideDateTimeCovTermValue_Input) at SideBySideCovTermInputSet.datetime_notarget.pcf: line 44, column 37
    ...
    // 'visible' attribute on TextInput (id=datetimeSpacer_Input) at SideBySideCovTermInputSet.datetime_notarget.pcf: line 34, column 29
    function visible_11 () : java.lang.Boolean {
      return !selectable
    }
    
    // 'visible' attribute on CheckBoxInput (id=covTermEnabledId_Input) at SideBySideCovTermInputSet.datetime_notarget.pcf: line 23, column 28

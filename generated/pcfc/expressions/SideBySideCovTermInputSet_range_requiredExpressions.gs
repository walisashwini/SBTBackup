...
class SideBySideCovTermInputSet_range_requiredExpressions {
  ...
  public static class SideBySideCovTermInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'colspan' attribute on LayoutConfig at SideBySideCovTermInputSet.range_required.pcf: line 51, column 95
    function colspan_13 () : java.lang.Integer {
      return colWidth
    }
    
    // 'value' attribute on RangeInput (id=SideBySideRangeCovTermValue_Input) at SideBySideCovTermInputSet.range_required.pcf: line 48, column 36
    function defaultSetter_21 (__VALUE_TO_SET :  java.lang.Object) : void {
      covTermInfo.RangeValue = __VALUE_TO_SET
    }
    
    // 'value' attribute on CheckBoxInput (id=covTermEnabledId_Input) at SideBySideCovTermInputSet.range_required.pcf: line 23, column 28
    function defaultSetter_5 (__VALUE_TO_SET :  java.lang.Object) : void {
      covTermInfo.CovInfo.Selected = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'disablePostOnEnter' attribute on PostOnChange at SideBySideCovTermInputSet.range_required.pcf: line 54, column 68
    ...
    // 'editable' attribute on RangeInput (id=SideBySideRangeCovTermValue_Input) at SideBySideCovTermInputSet.range_required.pcf: line 48, column 36
    function editable_18 () : java.lang.Boolean {
      return covTermInfo.CovInfo.PeriodInfo.SxSEditable and covTermInfo.Editable
    }
    
    // 'editable' attribute on CheckBoxInput (id=covTermEnabledId_Input) at SideBySideCovTermInputSet.range_required.pcf: line 23, column 28
    ...
    // 'onChange' attribute on PostOnChange at SideBySideCovTermInputSet.range_required.pcf: line 28, column 68
    function onChange_1 () : void {
      covTermInfo.CovInfo.coverageSelectionRefresh()
    }
    
    // 'onChange' attribute on PostOnChange at SideBySideCovTermInputSet.range_required.pcf: line 54, column 68
    function onChange_16 () : void {
      covTermInfo.CovInfo.coverageSelectionRefresh()
    }
    
    // 'tdClass' attribute on LayoutConfig at SideBySideCovTermInputSet.range_required.pcf: line 25, column 95
    function tdClass_0 () : java.lang.String {
      return "pc-sxs-col-" + (covTermInfo.CovInfo.PeriodInfo.ColumnIndex % 2)
    }
    
    // 'validationExpression' attribute on RangeInput (id=SideBySideRangeCovTermValue_Input) at SideBySideCovTermInputSet.range_required.pcf: line 48, column 36
    ...
    // 'valueRange' attribute on RangeInput (id=SideBySideRangeCovTermValue_Input) at SideBySideCovTermInputSet.range_required.pcf: line 48, column 36
    ...
    // 'visible' attribute on TextInput (id=rangeSpacer_Input) at SideBySideCovTermInputSet.range_required.pcf: line 35, column 29
    function visible_11 () : java.lang.Boolean {
      return !selectable
    }
    
    // 'visible' attribute on CheckBoxInput (id=covTermEnabledId_Input) at SideBySideCovTermInputSet.range_required.pcf: line 23, column 28

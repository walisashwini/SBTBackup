...
class SideBySideCovTermInputSet_shorttextExpressions {
  ...
  public static class SideBySideCovTermInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'colspan' attribute on LayoutConfig at SideBySideCovTermInputSet.shorttext.pcf: line 47, column 95
    function colspan_13 () : java.lang.Integer {
      return colWidth
    }
    
    // 'value' attribute on TextInput (id=SideBySideTextCovTermValue_Input) at SideBySideCovTermInputSet.shorttext.pcf: line 44, column 39
    function defaultSetter_20 (__VALUE_TO_SET :  java.lang.Object) : void {
      covTermInfo.StringValue = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on CheckBoxInput (id=covTermEnabledId_Input) at SideBySideCovTermInputSet.shorttext.pcf: line 23, column 28
    function defaultSetter_5 (__VALUE_TO_SET :  java.lang.Object) : void {
      covTermInfo.CovInfo.Selected = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'disablePostOnEnter' attribute on PostOnChange at SideBySideCovTermInputSet.shorttext.pcf: line 50, column 138
    ...
    // 'editable' attribute on TextInput (id=SideBySideTextCovTermValue_Input) at SideBySideCovTermInputSet.shorttext.pcf: line 44, column 39
    function editable_17 () : java.lang.Boolean {
      return covTermInfo.CovInfo.PeriodInfo.SxSEditable and covTermInfo.Editable
    }
    
    // 'editable' attribute on CheckBoxInput (id=covTermEnabledId_Input) at SideBySideCovTermInputSet.shorttext.pcf: line 23, column 28
    ...
    // 'onChange' attribute on PostOnChange at SideBySideCovTermInputSet.shorttext.pcf: line 28, column 68
    function onChange_1 () : void {
      covTermInfo.CovInfo.coverageSelectionRefresh()
    }
    
    // 'onChange' attribute on PostOnChange at SideBySideCovTermInputSet.shorttext.pcf: line 50, column 138
    ...
    // 'tdClass' attribute on LayoutConfig at SideBySideCovTermInputSet.shorttext.pcf: line 25, column 95
    function tdClass_0 () : java.lang.String {
      return "pc-sxs-col-" + (covTermInfo.CovInfo.PeriodInfo.ColumnIndex % 2)
    }
    
    // 'validationExpression' attribute on TextInput (id=SideBySideTextCovTermValue_Input) at SideBySideCovTermInputSet.shorttext.pcf: line 44, column 39
    ...
    // 'visible' attribute on TextInput (id=shorttextSpacer_Input) at SideBySideCovTermInputSet.shorttext.pcf: line 35, column 29
    function visible_11 () : java.lang.Boolean {
      return !selectable
    }
    
    // 'visible' attribute on CheckBoxInput (id=covTermEnabledId_Input) at SideBySideCovTermInputSet.shorttext.pcf: line 23, column 28

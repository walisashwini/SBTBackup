...
class StackSummaryLDVExpressions {
  ...
  public static class IteratorEntry2ExpressionsImpl extends StackSummaryLDVExpressionsImpl {
    ...
    // 'outputConversion' attribute on TextCell (id=ArgsAverageTime_Cell) at StackSummaryLDV.pcf: line 132, column 49
    function outputConversion_47 (VALUE :  java.lang.Double) : java.lang.String {
      return formatAverage(VALUE)
    }
    
    // 'value' attribute on TextCell (id=AllArgs_Cell) at StackSummaryLDV.pcf: line 110, column 32
    ...
    // 'value' attribute on TextCell (id=ArgsQueryCount_Cell) at StackSummaryLDV.pcf: line 118, column 50
    function value_41 () : java.lang.Integer {
      return args.ExecutionCount
    }
    
    // 'value' attribute on TextCell (id=ArgsTotalQueryTime_Cell) at StackSummaryLDV.pcf: line 126, column 50
    function value_44 () : java.lang.Integer {
      return args.TotalTime
    }
    
    // 'value' attribute on TextCell (id=ArgsAverageTime_Cell) at StackSummaryLDV.pcf: line 132, column 49
    function value_48 () : java.lang.Double {
      return args.AverageTime
    }
    
    // 'value' attribute on TextCell (id=ArgsMaxQueryTime_Cell) at StackSummaryLDV.pcf: line 137, column 50
    function value_51 () : java.lang.Integer {
      return args.MaxQueryTime
    }
    
    // 'value' attribute on TextCell (id=TotalRowCount_Cell) at StackSummaryLDV.pcf: line 145, column 50
    function value_54 () : java.lang.Integer {
      return args.TotalRowCount
    }
    
    // 'value' attribute on TextCell (id=AverageRowCount_Cell) at StackSummaryLDV.pcf: line 151, column 49
    function value_58 () : java.lang.Double {
  ...
  public static class IteratorEntryExpressionsImpl extends StackSummaryLDVExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=ArgsCount_Cell) at StackSummaryLDV.pcf: line 35, column 46
    function valueRoot_13 () : java.lang.Object {
      return stack
    }
    
    // 'value' attribute on TextCell (id=SummarizedStack_Cell) at StackSummaryLDV.pcf: line 29, column 54
    ...
    // 'value' attribute on TextCell (id=TotalQueryTime_Cell) at StackSummaryLDV.pcf: line 43, column 46
    function value_15 () : java.lang.Integer {
      return stack.TotalTime
    }
    
    // 'value' attribute on TextCell (id=TotalRowCount_Cell) at StackSummaryLDV.pcf: line 51, column 46
  ...
  public static class StackSummaryLDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function renderCall_22 (__writer :  java.io.Writer, __escaper :  gw.lang.parser.template.StringEscaper, __helper :  gw.api.web.template.TemplatePanelHelper) : void {
    ...
    function renderCall_23 (__writer :  java.io.Writer, __escaper :  gw.lang.parser.template.StringEscaper, __helper :  gw.api.web.template.TemplatePanelHelper) : void {
    ...
    function renderCall_24 (__writer :  java.io.Writer, __escaper :  gw.lang.parser.template.StringEscaper, __helper :  gw.api.web.template.TemplatePanelHelper) : void {
      pcfc.expressions.StackSummaryLDV_TemplatePanel3.render(__writer, __escaper, selectedStackSummary, __helper)
    }

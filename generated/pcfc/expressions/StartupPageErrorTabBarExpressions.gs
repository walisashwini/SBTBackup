...
class StartupPageErrorTabBarExpressions {
  ...
  public static class StartupPageErrorTabBarExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on TabBarLink (id=HelpTabBarLink) at StartupPageErrorTabBar.pcf: line 11, column 24
    ...
    // 'label' attribute on TabBarLogout (id=LogoutTabBarLink) at StartupPageErrorTabBar.pcf: line 20, column 21

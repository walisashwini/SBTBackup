...
class ViewLogsExpressions {
  ...
  public static class ViewLogsExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ButtonInput (id=ViewLogs_Input) at ViewLogs.pcf: line 61, column 86
    function action_16 () : void {
      logText = gw.api.system.logging.LogViewerUtil.readLog(logFile, maxLines, filter)
    }
    
    // 'action' attribute on ButtonInput (id=StreamLogs_Input) at ViewLogs.pcf: line 67, column 67
    function action_19 () : void {
      LogViewer.push(logFile.toString())
    }
    
    // 'action' attribute on ButtonInput (id=StreamLogs_Input) at ViewLogs.pcf: line 67, column 67
    function action_dest_20 () : pcf.api.Destination {
      return pcf.LogViewer.createDestination(logFile.toString())
    }
    
    // 'available' attribute on ButtonInput (id=ViewLogs_Input) at ViewLogs.pcf: line 61, column 86
    ...
    // 'value' attribute on TextInput (id=LogFilter_Input) at ViewLogs.pcf: line 49, column 29
    function defaultSetter_10 (__VALUE_TO_SET :  java.lang.Object) : void {
      filter = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextInput (id=MaxLines_Input) at ViewLogs.pcf: line 55, column 44
    function defaultSetter_13 (__VALUE_TO_SET :  java.lang.Object) : void {
      maxLines = (__VALUE_TO_SET as java.lang.Integer)
    }
    
    // 'value' attribute on RangeInput (id=LogFile_Input) at ViewLogs.pcf: line 41, column 44
    ...
    // 'optionLabel' attribute on RangeInput (id=LogFile_Input) at ViewLogs.pcf: line 41, column 44
    function optionLabel_4 (VALUE :  java.nio.file.Path) : java.lang.String {
    ...
    // 'valueRange' attribute on RangeInput (id=LogFile_Input) at ViewLogs.pcf: line 41, column 44
    ...
    // 'value' attribute on TextAreaInput (id=LogDisplay_Input) at ViewLogs.pcf: line 76, column 30
    ...
    // 'valueRange' attribute on RangeInput (id=LogFile_Input) at ViewLogs.pcf: line 41, column 44
    function verifyValueRangeIsAllowedType_6 ($$arg :  java.nio.file.Path[]) : void {

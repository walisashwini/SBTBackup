...
class WorkQueueHistoryDownloadConfigurePopupExpressions {
  ...
  public static class WorkQueueHistoryDownloadConfigurePopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ButtonInput (id=download_Input) at WorkQueueHistoryDownloadConfigurePopup.pcf: line 57, column 75
    ...
    // 'available' attribute on ButtonInput (id=download_Input) at WorkQueueHistoryDownloadConfigurePopup.pcf: line 57, column 75
    function available_8 () : java.lang.Boolean {
      return WorkQueueDisplayInfo.WriterLastExecutionTime != null
    }
    
    // 'value' attribute on DateInput (id=StartDate_Input) at WorkQueueHistoryDownloadConfigurePopup.pcf: line 43, column 32
    function defaultSetter_3 (__VALUE_TO_SET :  java.lang.Object) : void {
      StartDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on DateInput (id=EndDate_Input) at WorkQueueHistoryDownloadConfigurePopup.pcf: line 50, column 30

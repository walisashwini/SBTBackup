...
class WorkQueueWorkItemsLV_ArchiveExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends WorkQueueWorkItemsLVExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=ItemId_Cell) at WorkQueueWorkItemsLV.Archive.pcf: line 49, column 27
    ...
    // 'value' attribute on DateCell (id=createdTime_Cell) at WorkQueueWorkItemsLV.Archive.pcf: line 55, column 38
    function value_14 () : java.util.Date {
      return item.CreationTime
    }
    
    // 'value' attribute on DateCell (id=updateTime_Cell) at WorkQueueWorkItemsLV.Archive.pcf: line 61, column 40
    function value_17 () : java.util.Date {
      return item.LastUpdateTime
    }
    
    // 'value' attribute on DateCell (id=availableAt_Cell) at WorkQueueWorkItemsLV.Archive.pcf: line 68, column 46
    function value_20 () : java.util.Date {
      return item.AvailableSinceAsDate
    }
    
    // 'value' attribute on TextCell (id=checkedOutBy_Cell) at WorkQueueWorkItemsLV.Archive.pcf: line 72, column 38
    function value_23 () : java.lang.String {
      return item.CheckedOutBy
    }
    
    // 'value' attribute on TextCell (id=writerId_Cell) at WorkQueueWorkItemsLV.Archive.pcf: line 77, column 39
    function value_26 () : java.lang.Long {
      return item.ProcessHistoryID
    }
    
    // 'value' attribute on TextCell (id=retries_Cell) at WorkQueueWorkItemsLV.Archive.pcf: line 82, column 42
    function value_29 () : java.lang.Integer {
      return item.Attempts
    }
    
    // 'value' attribute on TextCell (id=itemInfo_Cell) at WorkQueueWorkItemsLV.Archive.pcf: line 87, column 123

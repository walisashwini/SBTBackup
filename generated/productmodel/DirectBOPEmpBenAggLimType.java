...
public interface DirectBOPEmpBenAggLimType extends gw.api.domain.covterm.DirectCovTerm {
  productmodel.BOPEmpBenefits getBOPEmpBenefits();
  
  
  productmodel.BOPEmpBenefits getCoverage();

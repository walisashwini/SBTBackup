...
public interface DirectBOPLiquorPersonPDLimType extends gw.api.domain.covterm.DirectCovTerm {
  productmodel.BOPLiquorCov getBOPLiquorCov();
  
  
  productmodel.BOPLiquorCov getCoverage();

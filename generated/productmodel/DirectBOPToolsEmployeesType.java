...
public interface DirectBOPToolsEmployeesType extends gw.api.domain.covterm.DirectCovTerm {
  productmodel.BOPToolsInstallUnschedCov getBOPToolsInstallUnschedCov();
  
  
  productmodel.BOPToolsInstallUnschedCov getCoverage();

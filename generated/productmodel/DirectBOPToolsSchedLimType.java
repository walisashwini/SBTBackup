...
public interface DirectBOPToolsSchedLimType extends gw.api.domain.covterm.DirectCovTerm {
  productmodel.BOPToolsSchedCov getBOPToolsSchedCov();
  
  
  productmodel.BOPToolsSchedCov getCoverage();

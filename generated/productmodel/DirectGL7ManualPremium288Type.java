...
public interface DirectGL7ManualPremium288Type extends gw.api.domain.covterm.DirectCovTerm {
  productmodel.GL7CannabisExclEDL getExclusion();
  
  
  productmodel.GL7CannabisExclEDL getGL7CannabisExclEDL();

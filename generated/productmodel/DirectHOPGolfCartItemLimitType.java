...
public interface DirectHOPGolfCartItemLimitType extends gw.api.domain.covterm.DirectCovTerm {
  productmodel.HOPGolfCartItem getCoverage();
  
  
  productmodel.HOPGolfCartItem getHOPGolfCartItem();

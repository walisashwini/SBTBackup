...
public interface GenericBAOwnedMedPayCoordinateType extends gw.api.domain.covterm.BooleanCovTerm {
  productmodel.BAOwnedMedPayCov getBAOwnedMedPayCov();
  
  
  productmodel.BAOwnedMedPayCov getCoverage();

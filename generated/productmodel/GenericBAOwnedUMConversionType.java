...
public interface GenericBAOwnedUMConversionType extends gw.api.domain.covterm.BooleanCovTerm {
  productmodel.BAOwnedUMBICov getBAOwnedUMBICov();
  
  
  productmodel.BAOwnedUMBICov getCoverage();

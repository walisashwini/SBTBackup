...
public interface GenericBAPIP_AR_WorkLossType extends gw.api.domain.covterm.BooleanCovTerm {
  productmodel.CA_PIP_AR getCA_PIP_AR();
  
  
  productmodel.CA_PIP_AR getCoverage();

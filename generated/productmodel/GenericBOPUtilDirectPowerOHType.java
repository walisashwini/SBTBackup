...
public interface GenericBOPUtilDirectPowerOHType extends gw.api.domain.covterm.BooleanCovTerm {
  productmodel.BOPUtilDirectCov getBOPUtilDirectCov();
  
  
  productmodel.BOPUtilDirectCov getCoverage();

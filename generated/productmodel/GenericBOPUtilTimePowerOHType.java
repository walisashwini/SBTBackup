...
public interface GenericBOPUtilTimePowerOHType extends gw.api.domain.covterm.BooleanCovTerm {
  productmodel.BOPUtilTimeCov getBOPUtilTimeCov();
  
  
  productmodel.BOPUtilTimeCov getCoverage();

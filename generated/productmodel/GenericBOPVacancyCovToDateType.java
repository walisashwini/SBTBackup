...
public interface GenericBOPVacancyCovToDateType extends gw.api.domain.covterm.DateTimeCovTerm {
  productmodel.BOPVacancyCov getBOPVacancyCov();
  
  
  productmodel.BOPVacancyCov getCoverage();

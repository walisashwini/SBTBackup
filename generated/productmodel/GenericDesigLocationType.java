...
public interface GenericDesigLocationType extends gw.api.domain.covterm.StringCovTerm {
  productmodel.ExcludeDesigOperations getExcludeDesigOperations();
  
  
  productmodel.ExcludeDesigOperations getExclusion();

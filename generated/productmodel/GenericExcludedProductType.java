...
public interface GenericExcludedProductType extends gw.api.domain.covterm.StringCovTerm {
  productmodel.ExcludeProducts getExcludeProducts();
  
  
  productmodel.ExcludeProducts getExclusion();

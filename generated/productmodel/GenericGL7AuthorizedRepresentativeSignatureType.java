...
public interface GenericGL7AuthorizedRepresentativeSignatureType extends gw.api.domain.covterm.StringCovTerm {
  productmodel.GL7PolicyChanges getCondition();
  
  
  productmodel.GL7PolicyChanges getGL7PolicyChanges();

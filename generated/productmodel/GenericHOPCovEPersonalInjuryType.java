...
public interface GenericHOPCovEPersonalInjuryType extends gw.api.domain.covterm.BooleanCovTerm {
  productmodel.HOPCovE getCoverage();
  
  
  productmodel.HOPCovE getHOPCovE();

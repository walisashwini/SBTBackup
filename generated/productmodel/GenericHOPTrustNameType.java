...
public interface GenericHOPTrustNameType extends gw.api.domain.covterm.StringCovTerm {
  productmodel.HOPTrust getCondition();
  
  
  productmodel.HOPTrust getHOPTrust();

...
public interface GenericPAPIPKY_MotorcycleType extends gw.api.domain.covterm.BooleanCovTerm {
  productmodel.PAPIP_KY getCoverage();
  
  
  productmodel.PAPIP_KY getPAPIP_KY();

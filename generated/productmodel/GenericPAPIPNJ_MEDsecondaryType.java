...
public interface GenericPAPIPNJ_MEDsecondaryType extends gw.api.domain.covterm.BooleanCovTerm {
  productmodel.PAPIP_NJ getCoverage();
  
  
  productmodel.PAPIP_NJ getPAPIP_NJ();

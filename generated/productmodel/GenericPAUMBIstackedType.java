...
public interface GenericPAUMBIstackedType extends gw.api.domain.covterm.BooleanCovTerm {
  productmodel.PAUMBICov getCoverage();
  
  
  productmodel.PAUMBICov getPAUMBICov();

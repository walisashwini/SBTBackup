...
public interface GenericPIPMA_AIRBAGType extends gw.api.domain.covterm.BooleanCovTerm {
  productmodel.CAPIP_MA getCAPIP_MA();
  
  
  productmodel.CAPIP_MA getCoverage();

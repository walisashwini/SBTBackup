...
public interface GenericPIPMD_WAIVERType extends gw.api.domain.covterm.BooleanCovTerm {
  productmodel.CAPIP_MD getCAPIP_MD();
  
  
  productmodel.CAPIP_MD getCoverage();

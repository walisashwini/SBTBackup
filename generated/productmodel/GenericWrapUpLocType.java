...
public interface GenericWrapUpLocType extends gw.api.domain.covterm.StringCovTerm {
  productmodel.ExcludeDesigWrapUpOps getExcludeDesigWrapUpOps();
  
  
  productmodel.ExcludeDesigWrapUpOps getExclusion();

...
public interface OptionBAPIP_DC_WorkLossType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionBAPIP_DC_WorkLossType> {
  productmodel.CA_PIP_DC getCA_PIP_DC();
  
  
  productmodel.CA_PIP_DC getCoverage();

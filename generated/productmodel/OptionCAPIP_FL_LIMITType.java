...
public interface OptionCAPIP_FL_LIMITType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionCAPIP_FL_LIMITType> {
  productmodel.CAPIP_FL getCAPIP_FL();
  
  
  productmodel.CAPIP_FL getCoverage();

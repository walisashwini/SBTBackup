...
public interface OptionPAPIPKS_FUNERALType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionPAPIPKS_FUNERALType> {
  productmodel.PAPIP_KS getCoverage();
  
  
  productmodel.PAPIP_KS getPAPIP_KS();

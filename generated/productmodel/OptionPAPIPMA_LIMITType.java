...
public interface OptionPAPIPMA_LIMITType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionPAPIPMA_LIMITType> {
  productmodel.PAPIP_MA getCoverage();
  
  
  productmodel.PAPIP_MA getPAPIP_MA();

...
public interface OptionPAPIPMI_DEDUCTIBLEType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionPAPIPMI_DEDUCTIBLEType> {
  productmodel.PAPIP_MI getCoverage();
  
  
  productmodel.PAPIP_MI getPAPIP_MI();

...
public interface OptionPAPIPND_SURVIVORType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionPAPIPND_SURVIVORType> {
  productmodel.PAPIP_ND getCoverage();
  
  
  productmodel.PAPIP_ND getPAPIP_ND();

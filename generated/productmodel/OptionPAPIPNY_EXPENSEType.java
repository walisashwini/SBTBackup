...
public interface OptionPAPIPNY_EXPENSEType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionPAPIPNY_EXPENSEType> {
  productmodel.PAPIP_NY getCoverage();
  
  
  productmodel.PAPIP_NY getPAPIP_NY();

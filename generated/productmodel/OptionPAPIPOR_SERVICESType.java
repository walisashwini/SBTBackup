...
public interface OptionPAPIPOR_SERVICESType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionPAPIPOR_SERVICESType> {
  productmodel.PAPIP_OR getCoverage();
  
  
  productmodel.PAPIP_OR getPAPIP_OR();

...
public interface OptionPAPIPUT_WORKType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionPAPIPUT_WORKType> {
  productmodel.PAPIP_UT getCoverage();
  
  
  productmodel.PAPIP_UT getPAPIP_UT();

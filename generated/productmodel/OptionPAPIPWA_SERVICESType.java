...
public interface OptionPAPIPWA_SERVICESType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionPAPIPWA_SERVICESType> {
  productmodel.PAPIP_WA getCoverage();
  
  
  productmodel.PAPIP_WA getPAPIP_WA();

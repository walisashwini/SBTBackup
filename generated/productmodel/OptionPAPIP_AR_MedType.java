...
public interface OptionPAPIP_AR_MedType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionPAPIP_AR_MedType> {
  productmodel.PAPIP_AR getCoverage();
  
  
  productmodel.PAPIP_AR getPAPIP_AR();

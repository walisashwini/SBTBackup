...
public interface OptionPAPIP_DC_WorkLossType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionPAPIP_DC_WorkLossType> {
  productmodel.PAPIP_DC getCoverage();
  
  
  productmodel.PAPIP_DC getPAPIP_DC();

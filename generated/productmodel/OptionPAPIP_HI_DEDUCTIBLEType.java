...
public interface OptionPAPIP_HI_DEDUCTIBLEType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionPAPIP_HI_DEDUCTIBLEType> {
  productmodel.PAPIP_HI getCoverage();
  
  
  productmodel.PAPIP_HI getPAPIP_HI();

...
public interface OptionPIPKS_SERVICESType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionPIPKS_SERVICESType> {
  productmodel.CAPIP_KS getCAPIP_KS();
  
  
  productmodel.CAPIP_KS getCoverage();

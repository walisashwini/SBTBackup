...
public interface OptionPIPKYWEEKLYType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionPIPKYWEEKLYType> {
  productmodel.CAPIP_KY getCAPIP_KY();
  
  
  productmodel.CAPIP_KY getCoverage();

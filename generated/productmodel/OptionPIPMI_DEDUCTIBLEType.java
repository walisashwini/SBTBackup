...
public interface OptionPIPMI_DEDUCTIBLEType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionPIPMI_DEDUCTIBLEType> {
  productmodel.CAPIP_MI getCAPIP_MI();
  
  
  productmodel.CAPIP_MI getCoverage();

...
public interface OptionPIPMN_MED_DEDUCTType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionPIPMN_MED_DEDUCTType> {
  productmodel.CAPIP_MN getCAPIP_MN();
  
  
  productmodel.CAPIP_MN getCoverage();

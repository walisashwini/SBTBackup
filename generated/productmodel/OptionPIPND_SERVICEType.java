...
public interface OptionPIPND_SERVICEType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionPIPND_SERVICEType> {
  productmodel.CAPIP_ND getCAPIP_ND();
  
  
  productmodel.CAPIP_ND getCoverage();

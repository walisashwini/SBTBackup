...
public interface OptionPIPNJ_MEDDEDUCTType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionPIPNJ_MEDDEDUCTType> {
  productmodel.CAPIP_NJ getCAPIP_NJ();
  
  
  productmodel.CAPIP_NJ getCoverage();

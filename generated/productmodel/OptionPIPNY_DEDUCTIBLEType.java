...
public interface OptionPIPNY_DEDUCTIBLEType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionPIPNY_DEDUCTIBLEType> {
  productmodel.CAPIP_NY getCAPIP_NY();
  
  
  productmodel.CAPIP_NY getCoverage();

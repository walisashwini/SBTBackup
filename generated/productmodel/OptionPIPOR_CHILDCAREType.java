...
public interface OptionPIPOR_CHILDCAREType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionPIPOR_CHILDCAREType> {
  productmodel.CAPIP_OR getCAPIP_OR();
  
  
  productmodel.CAPIP_OR getCoverage();

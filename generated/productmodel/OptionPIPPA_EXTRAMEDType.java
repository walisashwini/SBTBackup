...
public interface OptionPIPPA_EXTRAMEDType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionPIPPA_EXTRAMEDType> {
  productmodel.CAPIP_PA getCAPIP_PA();
  
  
  productmodel.CAPIP_PA getCoverage();

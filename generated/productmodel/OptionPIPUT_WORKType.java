...
public interface OptionPIPUT_WORKType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionPIPUT_WORKType> {
  productmodel.CAPIP_UT getCAPIP_UT();
  
  
  productmodel.CAPIP_UT getCoverage();

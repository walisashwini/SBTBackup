...
public interface OptionPIPWA_SERVICESType extends gw.api.domain.covterm.OptionCovTerm<productmodel.OptionPIPWA_SERVICESType> {
  productmodel.CAPIP_WA getCAPIP_WA();
  
  
  productmodel.CAPIP_WA getCoverage();

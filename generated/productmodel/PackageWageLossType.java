...
public interface PackageWageLossType extends gw.api.domain.covterm.PackageCovTerm<productmodel.PackageWageLossType> {
  productmodel.CAPIP_HI getCAPIP_HI();
  
  
  productmodel.CAPIP_HI getCoverage();

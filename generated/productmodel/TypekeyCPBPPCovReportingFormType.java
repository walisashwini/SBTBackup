...
public interface TypekeyCPBPPCovReportingFormType extends gw.api.domain.covterm.TypekeyCovTerm<typekey.CPReportingForm> {
  productmodel.CPBPPCov getCPBPPCov();
  
  
  productmodel.CPBPPCov getCoverage();

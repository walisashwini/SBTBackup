...
public interface TypekeyPAPIP_FL_ApplyDeductibleType extends gw.api.domain.covterm.TypekeyCovTerm<typekey.PIPHousehold> {
  productmodel.PAPIP_FL getCoverage();
  
  
  productmodel.PAPIP_FL getPAPIP_FL();

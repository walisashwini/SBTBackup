...
public class ActivityCategory implements gw.entity.TypeKey {
  ...
  /**
   * Underwriter Review
   * An activity related to the underwriter review cycle.  Only one of these should be open against a job at a time.
   */
  public static final typekey.ActivityCategory TC_UWREVIEW = new typekey.ActivityCategory("uwreview");

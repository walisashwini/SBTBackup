...
public class ConsistencyCheckType implements gw.entity.TypeKey {
  ...
  /**
   * Product model check
   * Verifies policy data is consistent with product model
   */
  public static final typekey.ConsistencyCheckType TC_PRODUCTMODEL = new typekey.ConsistencyCheckType("productmodel");

...
public class DateFieldsToSearchType implements gw.entity.TypeKey {
   ...
   * Audit due date
   */
  public static final typekey.DateFieldsToSearchType TC_AUDITDUEDATE = new typekey.DateFieldsToSearchType("AuditDueDate");
  
  /**
   * Audit period end date
   * Audit period end date
   */
  public static final typekey.DateFieldsToSearchType TC_AUDITPERIODENDDATE = new typekey.DateFieldsToSearchType("AuditPeriodEndDate");
  
  /**
   * Creation date
   * Creation date
   */
  public static final typekey.DateFieldsToSearchType TC_CREATIONDATE = new typekey.DateFieldsToSearchType("CreationDate");
  
  /**
   * Effective date
   * Effective date
   */
  public static final typekey.DateFieldsToSearchType TC_EFFECTIVEDATE = new typekey.DateFieldsToSearchType("EffectiveDate");
  
  public static final gw.entity.ITypeFilter<typekey.DateFieldsToSearchType> TF_AUDITSEARCHTYPES = new com.guidewire.commons.entity.type2.TypeFilterImpl<typekey.DateFieldsToSearchType>("DateFieldsToSearchType", "AuditSearchTypes");
  
  public static final gw.entity.ITypeFilter<typekey.DateFieldsToSearchType> TF_NONAUDITSEARCHTYPES = new com.guidewire.commons.entity.type2.TypeFilterImpl<typekey.DateFieldsToSearchType>("DateFieldsToSearchType", "NonAuditSearchTypes");

...
public class NoteTopicType implements gw.entity.TypeKey {
   ...
   * business Development
   */
  public static final typekey.NoteTopicType TC_BUSDEVELOPMENT = new typekey.NoteTopicType("busdevelopment");
   ...
   * Financial issues
   */
  public static final typekey.NoteTopicType TC_CREDITWORTHY = new typekey.NoteTopicType("creditworthy");
  
  /**
   * Data Destruction
   * Data Destruction
   */
  public static final typekey.NoteTopicType TC_DATADESTRUCTION = new typekey.NoteTopicType("datadestruction");
  
  /**
   * Coverage gaps
   * coverage Gaps
   */
  public static final typekey.NoteTopicType TC_GAPS = new typekey.NoteTopicType("gaps");
   ...
   * Legal
   */
  public static final typekey.NoteTopicType TC_LEGAL = new typekey.NoteTopicType("legal");
  
  /**
   * Loss Control
   * Loss control
   */
  public static final typekey.NoteTopicType TC_LOSSCONTROL = new typekey.NoteTopicType("losscontrol");
  
  /**
   * Meetings/Agreements
   * Meetings/agreements
   */
  public static final typekey.NoteTopicType TC_MEETINGSAGREEMENTS = new typekey.NoteTopicType("meetingsagreements");
  
  /**
   * Pre-renewal direction
   * Pre-renewal direction
   */
  public static final typekey.NoteTopicType TC_PRERENEWAL = new typekey.NoteTopicType("prerenewal");
  
  /**
   * Relation management
   * Relation Management
   */
  public static final typekey.NoteTopicType TC_RELATIONMGT = new typekey.NoteTopicType("relationmgt");
  
  /**
   * Risk characteristics
   * Risk Characteristics
   */
  public static final typekey.NoteTopicType TC_RISK = new typekey.NoteTopicType("risk");

...
public class RuleSetType implements gw.entity.TypeKey {
  ...
  /**
   * Audit
   * Rules for actions for Audits
   */
  public static final typekey.RuleSetType TC_AU = new typekey.RuleSetType("AU");
  ...
  /**
   * Cancellation
   * Rules for actions for Cancellations
   */
  public static final typekey.RuleSetType TC_CN = new typekey.RuleSetType("CN");
   ...
   */
  public static final typekey.RuleSetType TC_EVAL = new typekey.RuleSetType("EVAL");
  ...
  /**
   * Midterm Change
   * Rules for actions for Midterm Changes
   */
  public static final typekey.RuleSetType TC_MTC = new typekey.RuleSetType("MTC");
  ...
  /**
   * Reinstatement
   * Rules for actions for Reinstatements
   */
  public static final typekey.RuleSetType TC_RE = new typekey.RuleSetType("RE");
  
  /**
   * Renewal
   * Rules for actions for Renewals
   */
  public static final typekey.RuleSetType TC_RN = new typekey.RuleSetType("RN");
  
  /**
   * Rewrite
   * Rules for actions for Rewrites
   */
  public static final typekey.RuleSetType TC_RW = new typekey.RuleSetType("RW");
  
  /**
   * Submission
   * Rules for actions for Submissions
   */
  public static final typekey.RuleSetType TC_SUB = new typekey.RuleSetType("SUB");
  ...
  /**
   * Withdrawal
   * Rules for job withdrawal
   */
  public static final typekey.RuleSetType TC_WD = new typekey.RuleSetType("WD");

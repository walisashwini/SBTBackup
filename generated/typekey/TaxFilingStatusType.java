...
public class TaxFilingStatusType implements gw.entity.TypeKey {
   ...
   * Married/filing jointly
   */
  public static final typekey.TaxFilingStatusType TC_MARRIEDJOINT = new typekey.TaxFilingStatusType("MarriedJoint");
  
  /**
   * Married/filing separately
   * Married/filing separately
   */
  public static final typekey.TaxFilingStatusType TC_MARRIEDSEP = new typekey.TaxFilingStatusType("MarriedSep");
   ...
   * Single/Head of household
   */
  public static final typekey.TaxFilingStatusType TC_SINGLEHH = new typekey.TaxFilingStatusType("SingleHH");

...
public class UpgradeDBStorageSetType implements gw.entity.TypeKey {
  ...
  /**
   * PostgreSQL database
   * Storage info for a PostgreSQL database
   */
  public static final typekey.UpgradeDBStorageSetType TC_POSTGRESQLDATABASE = new typekey.UpgradeDBStorageSetType("postgresqldatabase");
  
  /**
   * PostgreSQL indexes
   * Storage info for PostgreSQL indexes
   */
  public static final typekey.UpgradeDBStorageSetType TC_POSTGRESQLINDEXES = new typekey.UpgradeDBStorageSetType("postgresqlindexes");
  
  /**
   * PostgreSQL tables
   * Storage info for PostgreSQL tables
   */
  public static final typekey.UpgradeDBStorageSetType TC_POSTGRESQLTABLES = new typekey.UpgradeDBStorageSetType("postgresqltables");

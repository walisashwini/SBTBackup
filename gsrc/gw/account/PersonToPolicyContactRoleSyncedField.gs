...
class PersonToPolicyContactRoleSyncedField<S extends PolicyContactRole, T> extends ContactToPolicyContactRoleSyncedField<S, T> {
  ...
  public static final var DateOfBirth     : PersonToPolicyContactRoleSyncedField<PolicyContactRole, Date> = new PersonToPolicyContactRoleSyncedField<PolicyContactRole, Date>("DateOfBirth")

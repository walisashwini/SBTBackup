...
enhancement FormPatternCovTermEnhancement : entity.FormPatternCovTerm {
  ...
  property get Description() : String {
    return CovTermPatternLookup.getByPublicID(this.CovTermPatternCode).Description
  }
  ...
  property get Name() : String {
    return CovTermPatternLookup.getByPublicID(this.CovTermPatternCode).Name
  }

  /**
   * @return the CodeIdentifier of the selected covterm pattern.
   */
  property get CodeIdentifier() : String {
    return CovTermPatternLookup.getByPublicID(this.CovTermPatternCode).CodeIdentifier
  }
  ...
  property get ValueTypeName() : String {
    return CovTermPatternLookup.getByPublicID(this.CovTermPatternCode).ModelType.DisplayName
  }
   ...
   */
   property get AvailablePackageCovTermValues() : CovTermPack[] {
     ...
     var packageCovTermPat = ( CovTermPatternLookup.getByPublicID(this.CovTermPatternCode) as PackageCovTermPattern)
   ...
   */
   property get AvailableOptionCovTermValues() : CovTermOpt[] {
     var addedValues = this.SelectedCovTermValues.map( \ v -> v.Code).toSet()
     var optionCovTermPat = ( CovTermPatternLookup.getByPublicID(this.CovTermPatternCode) as OptionCovTermPattern)
   ...
   */
   property get AvailableTypekeyCovTermValues() : List<TypeKey> {
     var addedValues = this.SelectedCovTermValues.map( \ v -> v.Code).toSet()
     var typekeyCovTermPat = ( CovTermPatternLookup.getByPublicID(this.CovTermPatternCode) as TypekeyCovTermPattern)

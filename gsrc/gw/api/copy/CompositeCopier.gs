...
abstract class CompositeCopier<T extends KeyableBean, S extends KeyableBean> extends Copier<T> {
  var _delegateCopiers = new ArrayList<Copier<Object>>()
   ...
   */
  final function addCopier(copier : Copier< Object >) {
   ...
   */
  final function addAllCopiers(copiers : Collection<Copier< Object >>) {
   ...
   */
  property get AllCopiers() : List<Copier< Object >> {
   ...
   */
  final function getCopiersWhere(cond(elt : Copier< Object >) : boolean) : List<Copier< Object >> {
    var copiers = new ArrayList<Copier< Object >>()
   ...
   * </pre>
   */
  protected function collectCopiersWhere(cond(elt : Copier< Object >) : boolean, list : List<Copier< Object >>) {
    for (copier in _delegateCopiers) {
   ...
   */
  protected function conditionalCollectCopier(cond(elt : Copier< Object >) : boolean, copier : Copier< Object >, list : List<Copier< Object >>) {
    if (cond(copier)) {
      list.add(copier)
    } else if (copier typeis CompositeCopier<S, KeyableBean >) {

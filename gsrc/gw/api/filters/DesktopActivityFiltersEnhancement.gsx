...
enhancement DesktopActivityFiltersEnhancement : gw.api.web.desktop.DesktopActivityFilters {
  ...
  static function dueToday() : NamedFilter {
    ...
    return new NamedFilter(DisplayKey.get("Java.ToolBar.Activities.CurrentOpen"), filterParts)
  }
  ...
  static function dueSoon() : NamedFilter {
    ...
    return new NamedFilter(DisplayKey.get("Java.ToolBar.Activities.Due7Days"), (filterParts))
  }
  
  static function allOpen() : NamedFilter {
    var filterParts = {new ActivityFilters.NotAssignmentReview(),
            ActivityFilters.Status.getOpen()}.toTypedArray()
    return new NamedFilter(DisplayKey.get("Java.ToolBar.Activities.AllOpen"), (filterParts))
  }
  ...
  static function overdue() : NamedFilter {
    ...
    return new NamedFilter(DisplayKey.get("Java.ToolBar.Activities.Overdue"), (filterParts))
  }
  ...
  static function closedLast30Days() : NamedFilter {
    ...
    return new NamedFilter(DisplayKey.get("Java.ToolBar.Activities.ClosedLastNDays", 30), (filterParts))
  }
}

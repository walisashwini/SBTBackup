...
uses gw.contactmapper.ab1000.ContactMapperPCBase
uses gw.contactmapper.ab1000.PCTaxIDFieldMapping
  ...
  override property get Mappings() : Set<PropertyMapping> {
    ...
    return {
      ...
      fieldMapping(ContactAddress#AddressBookUID)
          .withMappingDirection(TO_XML)
          .withABName(LINK_ID),
      fieldMapping(ContactAddress#ExternalID)
            .withMappingDirection(TO_XML)
            .withABName(EXTERNAL_UNIQUE_ID),
      ...
      fieldMapping(Address#AddressBookUID)
          .withMappingDirection(TO_XML)
          .withABName(LINK_ID),
     fieldMapping(Address#ExternalID)
          .withMappingDirection(TO_XML)
          .withABName(EXTERNAL_UNIQUE_ID),

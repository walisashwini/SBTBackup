...
enhancement PolicyHoldEnhancement : entity.PolicyHold {
  ...
  function copyPolicyHold(copyRules : boolean, copyRegions : boolean) : PolicyHold {
    ...
    newPolicyHold.PolicyHoldCode = DisplayKey.get("Web.Admin.PolicyHold.CodeCopy", this.PolicyHoldCode)
    newPolicyHold.Description = DisplayKey.get("Web.Admin.PolicyHold.Copy", this.Description)
    newPolicyHold.UWIssueLongDesc = DisplayKey.get("Web.Admin.PolicyHold.Copy", this.UWIssueLongDesc)

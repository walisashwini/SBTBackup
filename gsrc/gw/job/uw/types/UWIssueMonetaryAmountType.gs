...
class UWIssueMonetaryAmountType implements UWIssueValueType {
  ...
  override function deserialize(value : String) : MonetaryAmount {
    try {
      ...
      return new MonetaryAmount(new BigDecimal(value.trim()), CurrencyUtil.getDefaultCurrency());
    }
  }
  ...
  override function validate(value : String) : String {
    try {
      ...
      return DisplayKey.get("UWIssue.MonetaryAmountType.InvalidMonetaryAmount", value)

...
class BOPSysTableRatingEngine extends AbstractRatingEngine<BOPLine> {
  ...
  private function getEmpDishonestyRate(cov : BOPEmpDisCov) : BigDecimal {
    ...
    switch( limit ) {
      case PCCoercions.makeOptionCovTerm<CovTermOpt<productmodel.OptionBOPEmpDisLimitType>>("5000")  : return 0.6
      case null    : // drops through
      case PCCoercions.makeOptionCovTerm<CovTermOpt<productmodel.OptionBOPEmpDisLimitType>>("10000") : return 1.0
      case PCCoercions.makeOptionCovTerm<CovTermOpt<productmodel.OptionBOPEmpDisLimitType>>("25000") : return 2.0
      case PCCoercions.makeOptionCovTerm<CovTermOpt<productmodel.OptionBOPEmpDisLimitType>>("50000") : return 4.4
      case PCCoercions.makeOptionCovTerm<CovTermOpt<productmodel.OptionBOPEmpDisLimitType>>("100000"): return 8.8
    }
  ...
  function getForgeryLimitRate(cov : BOPForgeAltCov) : BigDecimal {
    ...
    switch( limit ) {
      case PCCoercions.makeOptionCovTerm<CovTermOpt<productmodel.OptionBOPForgeAltLimitType>>("5000") : return 0.6
      case null   : // drops through
      case PCCoercions.makeOptionCovTerm<CovTermOpt<productmodel.OptionBOPForgeAltLimitType>>("10000"): return 1.0
      case PCCoercions.makeOptionCovTerm<CovTermOpt<productmodel.OptionBOPForgeAltLimitType>>("25000"): return 2.3
      case PCCoercions.makeOptionCovTerm<CovTermOpt<productmodel.OptionBOPForgeAltLimitType>>("50000"): return 4.0
    }
  ...
  private function rateBOPLiabilityCov(cov : BOPLiabilityCov) {
    var start = cov.SliceDate
    var end = getNextSliceDateAfter(start)
    for (building in cov.BOPLine.BOPLocations.arrays("Buildings").toArray(new BOPBuilding[0])) {
  ...
  function getLiabilityBasis(cov : BOPLiabilityCov) : BigDecimal
  {
    ...
    {
      case null:
      case PCCoercions.makePackageOptionCovTerm<CovTermPack<productmodel.PackageBOPLiabilityType>>("300/600/600")   : // drops through
      case PCCoercions.makePackageOptionCovTerm<CovTermPack<productmodel.PackageBOPLiabilityType>>("300/900/600")   : return 300000
      case PCCoercions.makePackageOptionCovTerm<CovTermPack<productmodel.PackageBOPLiabilityType>>("500/1000/1000") : // drops through
      case PCCoercions.makePackageOptionCovTerm<CovTermPack<productmodel.PackageBOPLiabilityType>>("500/1500/1000") : return 500000
      case PCCoercions.makePackageOptionCovTerm<CovTermPack<productmodel.PackageBOPLiabilityType>>("1000/2000/2000"): // drops through
      case PCCoercions.makePackageOptionCovTerm<CovTermPack<productmodel.PackageBOPLiabilityType>>("1000/3000/2000"): return 1000000
      case PCCoercions.makePackageOptionCovTerm<CovTermPack<productmodel.PackageBOPLiabilityType>>("2000/4000/4000"): // drops through
      case PCCoercions.makePackageOptionCovTerm<CovTermPack<productmodel.PackageBOPLiabilityType>>("2000/6000/4000"): return 2000000
    }
  ...
  function getLiabilityIncrAggFactor(cov : BOPLiabilityCov) : BigDecimal
  {
    ...
    switch( limit )
    {
      ...
      case PCCoercions.makePackageOptionCovTerm<CovTermPack<productmodel.PackageBOPLiabilityType>>("500/1000/1000") : // drops through
      case PCCoercions.makePackageOptionCovTerm<CovTermPack<productmodel.PackageBOPLiabilityType>>("1000/2000/2000"): // drops through
      case PCCoercions.makePackageOptionCovTerm<CovTermPack<productmodel.PackageBOPLiabilityType>>("2000/4000/4000"): return 1.0
      case PCCoercions.makePackageOptionCovTerm<CovTermPack<productmodel.PackageBOPLiabilityType>>("300/900/600")   : // drops through
      case PCCoercions.makePackageOptionCovTerm<CovTermPack<productmodel.PackageBOPLiabilityType>>("500/1500/1000") : // drops through
      case PCCoercions.makePackageOptionCovTerm<CovTermPack<productmodel.PackageBOPLiabilityType>>("1000/3000/2000"): // drops through
      case PCCoercions.makePackageOptionCovTerm<CovTermPack<productmodel.PackageBOPLiabilityType>>("2000/6000/4000"): return 1.1
    }
  ...
  private function rateAddlInsFlatCharges(lineVersion : BOPLine) {
    if ( lineVersion.Branch.RefundCalcMethod != TC_FLAT )  // context.CancelMethod returns null if the period is not canceled
    {
  ...
  private function getConstructionFactor(building : BOPBuilding) : BigDecimal
  {
    ...
    switch( construction )
    {
      case TC_F  : return 1.0
      case TC_JM : return 0.9
      case TC_NC : return 0.9
      case TC_MNC: return 0.7
      case TC_R  : return 0.6
    }
  ...
  private function  getSprinklerFactor(building : BOPBuilding) : BigDecimal
  {
    ...
    {
      case null:
      case TC_0  : return 1.0
      case TC_10 : return 1.0
      case TC_20 : return 1.0
      case TC_30 : return 1.0
      case TC_40 : return 1.0
      case TC_50 : return 1.0
      case TC_60 : return 0.98
      case TC_70 : return 0.95
      case TC_80 : return 0.90
      case TC_90 : return 0.80
      case TC_100: return 0.75
    }
  ...
  private function getFireProtectionFactor(building : BOPBuilding) : BigDecimal {
    ...
    switch( code )
    {
      ...
      case TC_1: return 0.8
      case TC_2: return 0.9
      case TC_3: return 1.0
      case TC_4: return 2.0
      case TC_5: return 3.0
    }
  ...
  private function getAlarmFactor(building : BOPBuilding) : BigDecimal {
    ...
    switch( code )
    {
      ...
      case TC_LOCAL  : return 1.0
      case TC_CENTRAL: // drops through
      case TC_POLICE : return 0.9
    }

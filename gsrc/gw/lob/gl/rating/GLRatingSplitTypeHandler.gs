...
abstract class GLRatingSplitTypeHandler {
   ...
   */
  public static final var PD_SPLIT_TYPE_HANDLER : GLRatingSplitTypeHandler = new GLRatingSplitTypeHandler(TC_PD, PD_MIN_RATE, PD_MAX_RATE) { 
   ...
   * Implemented as singleton anonymous class.
   */
  public static final var BI_SPLIT_TYPE_HANDLER : GLRatingSplitTypeHandler = new GLRatingSplitTypeHandler(TC_BI, BI_MIN_RATE, BI_MAX_RATE) { 
    override function calcIncreasedLimitsFactor( wrapper: gw.lob.gl.rating.GLSysTableRatingEngine.GLCovWrapper ) : BigDecimal {
   ...
   * Implemented as singleton anonymous class.
   */
  public static final var CSL_SPLIT_TYPE_HANDLER : GLRatingSplitTypeHandler = new GLRatingSplitTypeHandler(TC_CSL, Double.NaN_, Double.NaN_) { 
    override function calcIncreasedLimitsFactor( wrapper: gw.lob.gl.rating.GLSysTableRatingEngine.GLCovWrapper ) : BigDecimal {

...
class CG00330413 extends gw.lob.common.forms.GeneratedAvailabilityForm {
  ...
  private function isAvailable0() : boolean {
    ...
    return GeneralLiabilityLiquorLiabCovForm()
  }

  private function GeneralLiabilityLiquorLiabCovForm() : boolean {

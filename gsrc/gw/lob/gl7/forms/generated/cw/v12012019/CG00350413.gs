...
class CG00350413 extends gw.lob.common.forms.GeneratedAvailabilityForm {
  ...
  private function isAvailable0() : boolean {
    return GeneralLiabilityRailroadProtvLiabCovForm()
  }

  private function GeneralLiabilityRailroadProtvLiabCovForm() : boolean {

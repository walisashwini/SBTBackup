...
class CG00370413 extends gw.lob.common.forms.GeneratedAvailabilityForm {
  ...
  private function isAvailable0() : boolean {
    ...
    return GeneralLiabilityProdsCompletedOpsLiabCovForm()
  }

  private function GeneralLiabilityProdsCompletedOpsLiabCovForm() : boolean {
    if (ED.tempGL7SublineTypes.Subline == "Products/Completed Operations" && ED.tempGL7SublineTypes.PremOpsProdsCoverageForm == "Occurrence") {
      return true
    }
    return false
  }

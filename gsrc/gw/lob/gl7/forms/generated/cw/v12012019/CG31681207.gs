...
class CG31681207 extends gw.lob.common.forms.GeneratedAvailabilityForm {
  ...
  private function isAvailable0() : boolean {
    ...
    return GeneralLiabilityExclusionCoverageAProductWithdrawalExpense()
  }

  private function GeneralLiabilityExclusionCoverageAProductWithdrawalExpense() : boolean {
    if (ED.tempGL7SublineTypes.Subline == "Product Withdrawal" && ED.tempGL7SublineTypes.ProductWithdrawalCoverageType == "Liability") {
      return true
    }
    return false
  }

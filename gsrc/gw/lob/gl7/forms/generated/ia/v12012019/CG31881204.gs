...
class CG31881204 extends gw.lob.common.forms.GeneratedAvailabilityForm {
  ...
  private function isAvailable0() : boolean {
    ...
    return GeneralLiabilityIowaChangesCancellationAndNonrenewalProductWithdrawal()
  }

  private function GeneralLiabilityIowaChangesCancellationAndNonrenewalProductWithdrawal() : boolean {

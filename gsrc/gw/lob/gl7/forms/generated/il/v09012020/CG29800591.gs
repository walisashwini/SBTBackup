...
class CG29800591 extends gw.lob.common.forms.GeneratedAvailabilityForm {
  ...
  private function isAvailable0() : boolean {
    ...
    return GeneralLiabilityChangesLiquorCovFormClaimsMade()
  }

  private function GeneralLiabilityChangesLiquorCovFormClaimsMade() : boolean {

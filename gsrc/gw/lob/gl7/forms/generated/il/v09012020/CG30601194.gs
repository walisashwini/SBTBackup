...
class CG30601194 extends gw.lob.common.forms.GeneratedAvailabilityForm {
  ...
  private function isAvailable0() : boolean {
    return GeneralLiabilityAmendatoryEndorsementExtendedReportingPeriods()
  }

  private function GeneralLiabilityAmendatoryEndorsementExtendedReportingPeriods() : boolean {

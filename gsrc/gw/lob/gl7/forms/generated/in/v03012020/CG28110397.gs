...
class CG28110397 extends gw.lob.common.forms.GeneratedAvailabilityForm {
  ...
  private function isAvailable0() : boolean {
    ...
    return GeneralLiabilityIndianaChangesPollutionExclusionRailroad()
  }

  private function GeneralLiabilityIndianaChangesPollutionExclusionRailroad() : boolean {
    if (ED.tempGL7SublineTypes.Subline == "Railroad" && _cf.count(ED.tempGL7SublineTypes.Sublines.singleWhere( \ elm -> elm.Jurisdiction.Code == Parameters.getParam("Jurisdiction")).GL7AmendmentOfDefinitionOfPollutantsRailRoadCov) == 0) {
      return true
    }
    return false
  }

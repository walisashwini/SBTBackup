...
class IL01171210 extends gw.lob.common.forms.GeneratedAvailabilityForm {
  ...
  private function isAvailable0() : boolean {
    ...
    return GeneralLiabilityStateChangesWorkersCompensationExclusion()
  }

  private function GeneralLiabilityStateChangesWorkersCompensationExclusion() : boolean {

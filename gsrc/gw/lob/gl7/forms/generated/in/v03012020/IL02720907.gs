...
class IL02720907 extends gw.lob.common.forms.GeneratedAvailabilityForm {
  ...
  private function GeneralLiabilityChangesCancellationAndNonrenewalPremOpsProdsCompldOpsLiquorPollution() : boolean {
    if (ED.tempGL7SublineTypes.Subline == "Premises/Operations and Products/Completed Operations" || ED.tempGL7SublineTypes.Subline == "Premises/Operations" || ED.tempGL7SublineTypes.Subline == "Products/Completed Operations" || ED.tempGL7SublineTypes.Subline == "Liquor" || ED.tempGL7SublineTypes.Subline == "Pollution") {
      return true
    }
    return false
  }

...
class CG26220417 extends gw.lob.common.forms.GeneratedAvailabilityForm {
  ...
  private function isAvailable0() : boolean {
    ...
    return GeneralLiabilityChangesLiquorCovFormOccurence()
  }

  private function GeneralLiabilityChangesLiquorCovFormOccurence() : boolean {
    if (ED.tempGL7SublineTypes.Subline == "Liquor" && ED.tempGL7SublineTypes.LiquorCoverageForm == "Occurrence") {
      return true
    }
    return false
  }

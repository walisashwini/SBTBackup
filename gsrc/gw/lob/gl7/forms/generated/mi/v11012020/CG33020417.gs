...
class CG33020417 extends gw.lob.common.forms.GeneratedAvailabilityForm {
  ...
  private function GeneralLiabilityChangesCancellationAndNonrenewalProductWithdrawal() : boolean {
    if (ED.tempGL7SublineTypes.Subline == "Product Withdrawal" || ED.tempGL7SublineTypes.Subline == "Electronic Data Liability" || ED.tempGL7SublineTypes.Subline == "Pollution") {
      return true
    }
    return false
  }

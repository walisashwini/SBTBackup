...
abstract class GL7GeneralLiabilityClassificationExclusionCoverageAProductWithdrawalExpenseDTO extends gw.rating.LineModelObject {
  ...
  public construct(_gL7ClassificationExclCovAProductWithdrawalExpense : GL7ClassificationExclCovAProductWithdrawalExpense, parent : GL7GeneralLiabilityClassificationDTO) {
    ...
    _parent = parent
    _dataModel = _gL7ClassificationExclCovAProductWithdrawalExpense
    _displayName = _gL7ClassificationExclCovAProductWithdrawalExpense.DisplayName
  }
  ...
  @VisibleInRateflow
  protected var _productWithdrawlExpenseFactor : java.math.BigDecimal as ProductWithdrawlExpenseFactor = 0.0
  ...
  property get AsDataModel() : GL7ClassificationExclCovAProductWithdrawalExpense {
   return _dataModel as GL7ClassificationExclCovAProductWithdrawalExpense
  }

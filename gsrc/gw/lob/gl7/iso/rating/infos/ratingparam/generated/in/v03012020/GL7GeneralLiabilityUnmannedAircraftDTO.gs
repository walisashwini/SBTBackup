...
class GL7GeneralLiabilityUnmannedAircraftDTO extends gw.lob.gl7.iso.rating.infos.ratingparam.generated.cw.v12012019.GL7GeneralLiabilityUnmannedAircraftDTO {
  ...
  public construct(_gL7UnmannedAircraft : GL7UnmannedAircraft, parent : GL7GeneralLiabilityClassificationDTO) {
    ...
    _aggregateLimitGovernmentalSubdivision = (_cf.stateMatches(_gL7UnmannedAircraft.GL7UnmannedAircraf.OwningCoverable, Parameters)) ? _gL7UnmannedAircraft.GL7UnmannedAircraf.GL7AggLimitGovSubdivisionTerm.OptionValue.DisplayName : _aggregateLimitGovernmentalSubdivision
  ...
  @VisibleInRateflow
  var _aggregateLimitGovernmentalSubdivision : java.lang.String as AggregateLimitGovernmentalSubdivision = ""

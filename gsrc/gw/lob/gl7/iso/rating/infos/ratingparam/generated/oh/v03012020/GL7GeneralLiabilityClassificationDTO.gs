...
class GL7GeneralLiabilityClassificationDTO extends gw.lob.gl7.iso.rating.infos.ratingparam.generated.cw.v12012019.GL7GeneralLiabilityClassificationDTO {
  ...
  public construct(_gL7Exposure : GL7Exposure, parent : GL7GeneralLiabilityLocationDTO) {
    ...
    _climbingFacilityOperator = (_cf.stateMatches(_gL7Exposure, Parameters)) ? _gL7Exposure.ClimbingFacilityOperator : _climbingFacilityOperator
    _stopGapIncrdLimitFactorOverride = (_cf.stateMatches(_gL7Exposure, Parameters)) ? _gL7Exposure.StopGapIncrdLimitFactorOverride : _stopGapIncrdLimitFactorOverride
  ...
  @VisibleInRateflow
  @gw.lob.common.annotations.StatCode("StopGapStatCode")
  var _stopGapStatCode : java.lang.String as StopGapStatCode = ""

  @VisibleInRateflow
  var _stopGapPremium : java.math.BigDecimal as StopGapPremium = 0.0

  @VisibleInRateflow
  var _stopGapIncrdLimitFactorOverride : java.math.BigDecimal as StopGapIncrdLimitFactorOverride = 0.0

  @VisibleInRateflow
  var _stopGapIncrdLimitFactor : java.math.BigDecimal as StopGapIncrdLimitFactor = 0.0

  @VisibleInRateflow
  var _stopGapFinalRate : java.math.BigDecimal as StopGapFinalRate = 0.0

  @VisibleInRateflow
  var _stopGapFactor : java.math.BigDecimal as StopGapFactor = 0.0

  @VisibleInRateflow
  var _climbingFacilityOperator : java.lang.String as ClimbingFacilityOperator = ""

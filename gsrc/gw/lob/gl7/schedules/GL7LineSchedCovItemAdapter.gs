...
class GL7LineSchedCovItemAdapter extends AbstractScheduledItemAdapter {

  var _owner : GL7LineSchCovItem as readonly Owner

  construct(item : GL7LineSchCovItem) {
    _owner = item
  }
  ...
  override property get PolicyLine() : PolicyLine {
    return _owner.ScheduleCoverage.GL7Line
  }
  ...
  override function addCoverage(coverage : Coverage) {
    //_owner.addToCoverages(coverage as GL7LineSchCovItmCov)
  }

  override function removeCoverage(coverage : Coverage) {
    //_owner.removeFromCoverages(coverage as GL7LineSchCovItmCov)
  }
  ...
  override function addCondition(cond : PolicyCondition) {
    //_owner.addToConditions(cond as GL7LineSchCovItmCond)
  }

  override function removeCondition(cond : PolicyCondition) {
    //_owner.removeFromConditions(cond as GL7LineSchCovItmCond)
  }
  ...
  override function addExclusion(exclusion : Exclusion) {
    //_owner.addToExclusions(exclusion as GL7LineSchCovItmExcl)
  }

  override function removeExclusion(exclusion : Exclusion) {
    //_owner.removeFromExclusions(exclusion as GL7LineSchCovItmExcl)
  }

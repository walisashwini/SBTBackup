...
class GL7UAircrSchedCovItemAdapter extends AbstractScheduledItemAdapter {

  var _owner : GL7UAircrSchedCovItem as readonly Owner

  construct(item : GL7UAircrSchedCovItem) {
    _owner = item
  }
  ...
  override function addCoverage(clause : Coverage) {
   _owner.addToCoverages(clause as GL7UAircrSchedCovItemCov)
  }

  override function removeCoverage(clause : Coverage) {
    _owner.removeFromCoverages(clause as GL7UAircrSchedCovItemCov)
  }

...
class GL7UAircrSchedExclItemAdapter extends AbstractScheduledItemAdapter {

  var _owner : GL7UAircrSchedExclItem as readonly Owner

  construct(item : GL7UAircrSchedExclItem) {
    _owner = item
  }
  ...
  override function addCoverage(clause : Coverage) {
   _owner.addToCoverages(clause as GL7UAircrSchedExclItemCov)
  }

  override function removeCoverage(clause : Coverage) {
    _owner.removeFromCoverages(clause as GL7UAircrSchedExclItemCov)
  }

...
class GL7_ER_a207 extends gw.lob.gl7.validation.GL7GeneratedValidation<GL7SublineType> {
  ...
  private function OnlyonePollutionExclusionformCG2149_CG2155orCG2165canbeattached() {
    if (_cf.count(ED.tempGL7SublineTypes.GL7TotalPollutionExclEndt) > 0 && _cf.count(ED.tempGL7SublineTypes.GL7TotalPollutionExclWithAHostileFireExcptn) > 0 || (_cf.count(ED.tempGL7SublineTypes.GL7TotalPollutionExclWithABldgHeatgEquipmtExcptnHo) > 0 && _cf.count(ED.tempGL7SublineTypes.GL7TotalPollutionExclEndt) > 0) || (_cf.count(ED.tempGL7SublineTypes.GL7TotalPollutionExclWithAHostileFireExcptn) > 0 && _cf.count(ED.tempGL7SublineTypes.GL7TotalPollutionExclWithABldgHeatgEquipmtExcptnHo) > 0)) {

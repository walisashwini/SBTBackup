...
class GL7_ER_ba61 extends gw.lob.gl7.validation.GL7GeneratedValidation<GL7SublineType> {
  ...
  override public function validate(_coverable : GL7SublineType) : java.lang.String {
    ...
    Forexperienceratingtoapply_atleastonecompletedpolicyyearisnecessaryendingatleast6monthspriortotheratingdateThestartofbusinessdateenteredislessthan18monthspriortopolicyeffectivedate_soexperienceratingcannotbeapplied()
  ...
  private function Forexperienceratingtoapply_atleastonecompletedpolicyyearisnecessaryendingatleast6monthspriortotheratingdateThestartofbusinessdateenteredislessthan18monthspriortopolicyeffectivedate_soexperienceratingcannotbeapplied() {
    if (ED.tempGL7SublineTypes.ExperienceRatingApplies == "Yes" && ExperienceNumberYearsRequiredCLV < 1) {
      Error_Message = "[{0}] For experience rating to apply, at least one completed policy year is necessary (ending at least 6 months prior to the rating date.) The start of business date entered is less than 18 months prior to policy effective date, so experience rating cannot be applied"
    }
  }

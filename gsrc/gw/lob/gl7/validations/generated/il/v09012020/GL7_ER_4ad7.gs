...
class GL7_ER_4ad7 extends gw.lob.gl7.validation.GL7GeneratedValidation<GL7Subline> {
  ...
  override public function validate(_coverable : GL7Subline) : java.lang.String {
    ...
    classCodeCount()
    CondominiumAssociationmustbeYesforClassificationselected()
  ...
  private function CondominiumAssociationmustbeYesforClassificationselected() {
    if (classCodeCount > 0 && ED.tempGL7SublineTypes.Sublines.firstWhere( \ elm -> elm.Constraint.matchesConditionsForCoverable(coverable)).CondominiumAssociation == "No") {
      Error_Message = "[{0}] Condominium Association must be Yes for Classification selected"
    }
  }

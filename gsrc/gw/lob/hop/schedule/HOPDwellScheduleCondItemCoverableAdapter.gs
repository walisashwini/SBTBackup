...
@Export
class HOPDwellScheduleCondItemCoverableAdapter extends AbstractScheduledItemAdapter {
  var _owner: HOPDwellScheduleCondItem as readonly Owner

  construct(item: HOPDwellScheduleCondItem) {
    _owner = item
  }
  ...
  override function addCondition(cond: PolicyCondition) {
    _owner.ScheduledItemClause = cond as HOPDwellSchCondItemCond
  }

...
@Export
class HOPDwellScheduleExclItemCoverableAdapter extends AbstractScheduledItemAdapter {
  var _owner: HOPDwellScheduleExclItem as readonly Owner

  construct(item: HOPDwellScheduleExclItem) {
    _owner = item
  }
  ...
  override function addExclusion(excl: Exclusion) {
    _owner.ScheduledItemClause = excl as HOPDwellSchExclItemExcl
  }

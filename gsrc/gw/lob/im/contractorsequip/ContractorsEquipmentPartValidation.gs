...
class ContractorsEquipmentPartValidation extends PCValidationBase {
  ...
  private function atLeastOneEquipmentOrMiscCoverageExists() {
    ...
    var msg = DisplayKey.get("Web.Policy.IM.Validation.AtLeastOneEquipmentOrMiscCoverageExists") 
    ...
    for (equipment in _equipPart.ContractorsEquipments) {
      ...
      for (detail in equipment.AdditionalInterestDetails) {
        ...
        if (thisSet.Count < oldCount - 1) {
          Result.addError(equipment, TC_DEFAULT, DisplayKey.get("EntityName.PolicyLine.Validation.AddlInterestDetailUnique", detail.DisplayName))
  ...
  private function checkLimitVsDeductible() {
    if ( _equipPart.ContractorsEquipMiscUnscheduledCovExists ) {
      if ( _equipPart.ContractorsEquipMiscUnscheduledCov.ContractorsEquipMiscUnscheduledLimitTerm.Value <
           _equipPart.ContractorsEquipMiscUnscheduledCov.ContractorsEquipMiscUnscheduledDeductibleTerm.Value ) {
             Result.addError( _equipPart, TC_DEFAULT,
               DisplayKey.get("Web.Policy.IM.Validation.limitcannotbelessthandeductible", _equipPart.ContractorsEquipMiscUnscheduledCov.Pattern.DisplayName), "impartstep")
      }
    }
    if (_equipPart.ContractorsEquipEmployeesToolsExists ) {
      if ( _equipPart.ContractorsEquipEmployeesTools.ContractorsEquipEmployeesToolsLimitTerm.Value <
           _equipPart.ContractorsEquipEmployeesTools.ContractorsEquipEmployeesToolsDeductibleTerm.Value ) {
             Result.addError( _equipPart, TC_DEFAULT, DisplayKey.get("Web.Policy.IM.Validation.limitcannotbelessthandeductible", _equipPart.ContractorsEquipEmployeesTools.Pattern.DisplayName), "impartstep" )
      }
    }
    if ( _equipPart.ContractorsEquipRentedEquipmentExists ) {
      if ( _equipPart.ContractorsEquipRentedEquipment.ContractorsEquipRentedEquipmentLimitTerm.Value <
           _equipPart.ContractorsEquipRentedEquipment.ContractorsEquipRentedEquipmentDeductibleTerm.Value ) {
             Result.addError( _equipPart, TC_DEFAULT, DisplayKey.get("Web.Policy.IM.Validation.limitcannotbelessthandeductible", _equipPart.ContractorsEquipRentedEquipment.Pattern.DisplayName), "impartstep" )
      }
    }
    if ( _equipPart.ContractorsEquipRentalReibursementExists ) {
      if ( _equipPart.ContractorsEquipRentalReibursement.ContractorsEquipRentalReibursementOccurrenceLimitTerm.Value <
           _equipPart.ContractorsEquipRentalReibursement.ContractorsEquipRentalReibursementDeductibleTerm.Value ) {
             Result.addError( _equipPart, TC_DEFAULT, DisplayKey.get("Web.Policy.IM.Validation.limitcannotbelessthandeductible", _equipPart.ContractorsEquipRentalReibursement.Pattern.DisplayName), "impartstep" )
      }
    }
    _equipPart.ContractorsEquipments
                  ...
                  .each( \ eq -> Result.addError( eq, TC_DEFAULT, DisplayKey.get("Web.Policy.IM.Validation.limitcannotbelessthandeductible", "Item " + eq.ContractorsEquipmentNumber), "impartstep" ) )
  }
}

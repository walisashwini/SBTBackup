...
{  
  ...
  override property get TypeLabel() : String {
    return DisplayKey.get("PersonalAuto.Vehicle.AdditionalInterest.LVLabel")
  }
  ...
  override function addToAdditionalInterestDetails( interestDetail: AddlInterestDetail ) : void
  {
    if (not (interestDetail typeis PAVhcleAddlInterest)) {
      throw DisplayKey.get("PersonalAuto.Vehicle.AdditionalInterest.Error.AdditionalInterestIsWrongType", interestDetail.Subtype)
    }

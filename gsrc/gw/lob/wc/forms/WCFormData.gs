...
abstract class WCFormData extends FormData {
  ...
  protected static reified function mapEmployeeBases<O>(context : FormInferenceContext, 
  ...
  protected static reified function mapEmployees<O>(context : FormInferenceContext, 

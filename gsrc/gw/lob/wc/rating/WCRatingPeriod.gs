...
class WCRatingPeriod
{
   ...
   * period start
   */
  var _start : Date as readonly Start

/**
 * period end
 */
  var _end   : Date as readonly End
   ...
   */
  var _ratingDate : Date as readonly RatingDate

  /**
   * period start accounting for audit
   */
  var _ratingStart : Date as readonly RatingStart

  /**
   * period end accounting for audit and cancellation
   */
  var _ratingEnd   : Date as readonly RatingEnd
  ...
  construct( jurisArg : WCJurisdiction, startArg : Date, endArg : Date, _number : int)
  {
   ...
   */
  private function calculateRatingStart() : Date
  {
    var effDate = Start
   ...
   */
  private function calculateRatingEnd() : Date
  {
    var expDate = End

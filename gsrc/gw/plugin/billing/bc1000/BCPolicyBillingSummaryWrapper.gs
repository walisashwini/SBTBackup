...
uses wsi.remote.gw.webservice.bc.bc1000.billingsummaryapi.types.complex.PolicyBillingSummary
...
final class BCPolicyBillingSummaryWrapper implements BillingPeriodInfo {
  ...
  override property get BillingMethod() : BillingMethod {
    return BillingMethod.get(_soapObject.BillingStatus.BillingMethodCode)
  }
  ...
  override property get Invoices() : BillingInvoiceInfo[] {
    return _soapObject.Invoices.Entry*.$TypeInstance.map(\ p -> new gw.plugin.billing.bc1000.BCInvoiceInfoWrapper(p))
  }
  ...
  override property get WrittenOff() : MonetaryAmount { return _soapObject.WrittenOff }
  ...
  override property get Archived() : Boolean {
    return _soapObject.Archived
  }

  override property get Retrieved() : Boolean {
    return _soapObject.Retrieved
  }

  override property get TotalBilledUnsettled() : MonetaryAmount {
    return _soapObject.BillingStatus.TotalBilledUnsettled
  }
}

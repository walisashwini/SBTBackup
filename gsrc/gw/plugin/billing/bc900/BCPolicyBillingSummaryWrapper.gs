...
uses wsi.remote.gw.webservice.bc.bc900.billingsummaryapi.types.complex.PolicyBillingSummary
...
final class BCPolicyBillingSummaryWrapper implements BillingPeriodInfo {
  ...
  override property get BillingMethod() : BillingMethod {
    return typekey.BillingMethod.get(_soapObject.BillingStatus.BillingMethodCode)
  }

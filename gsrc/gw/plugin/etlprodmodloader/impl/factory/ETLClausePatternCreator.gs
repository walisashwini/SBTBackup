...
abstract class ETLClausePatternCreator {
   ...
   */
  static function createETLClausePattern(clausePattern: ClausePattern, bundle : Bundle) : ETLClausePattern {
    final var etlClausePattern = new ETLClausePattern(bundle)
    ...
    etlClausePattern.CoverageCategory = clausePattern.CoverageCategory.PublicID
    etlClausePattern.OwningEntityType = clausePattern.OwningEntityType
    etlClausePattern.PatternID = clausePattern.PublicID
    etlClausePattern.CodeIdentifier = clausePattern.CodeIdentifier

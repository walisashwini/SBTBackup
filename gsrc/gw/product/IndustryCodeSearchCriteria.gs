...
class IndustryCodeSearchCriteria extends EntitySearchCriteria<IndustryCode> {
  ...
  construct(domain : IndustryCodeType, refDate : Date, prevIndCode : IndustryCode) {
    _domain = domain
    _effectiveOnDate = refDate
    _previousCode = prevIndCode.Code
  }

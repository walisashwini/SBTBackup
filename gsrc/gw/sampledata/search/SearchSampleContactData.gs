...
class SearchSampleContactData extends AbstractSampleDataCollection {
  ...
  override function load() {
    gw.transaction.Transaction.runWithNewBundle(\ b -> {
      loadPerson(b, TC_MS, "Jennifer", "Song", PrimaryPhoneType.TC_HOME, "415-867-5309", null, 
      ...
      loadPerson(b, TC_MR, "Billy Ray", "Sheet", PrimaryPhoneType.TC_HOME, "650-382-1627", null,
                 AddressType.TC_HOME, "1432 California St", "Palo Alto", TC_CA, "94306", Country.TC_US.Code, "429-19-5653")
      loadPerson(b, TC_DR, "Anna", "Raymond", PrimaryPhoneType.TC_MOBILE, "813-261-1624", VendorType.TC_DOCTOR,
                 AddressType.TC_BILLING, "1962 Bascom Ave. Ste 321", "Campbell", TC_CA, "95008", Country.TC_US.Code, "481-19-7531")
      loadPerson(b, TC_DR, "Houston John", "Roger", PrimaryPhoneType.TC_MOBILE, "813-261-1624", VendorType.TC_DOCTOR,
                 AddressType.TC_BILLING, "1962 Bascom Ave. Ste 321", "Campbell", TC_CA, "95008", Country.TC_US.Code, "123-45-6789")
      loadPerson(b, TC_MR, "Roger", "Houston", PrimaryPhoneType.TC_HOME, "650-432-9812", VendorType.TC_INDPROPINSPECTOR,
                 AddressType.TC_BILLING, "3214 San Antonio Road", "Mountain View", TC_CA, "94040", Country.TC_US.Code, "422-18-1285")
      loadPerson(b, TC_MR, "Marcel", "Pi-Sunyer", PrimaryPhoneType.TC_MOBILE, "510-242-2143", null,
                 AddressType.TC_HOME, "3295 Washington Ave", "Fremont", TC_CA, "94439", Country.TC_US.Code, "423-78-2355")
      loadPerson(b, TC_MRS, "Carmen", "Bach y Rita", PrimaryPhoneType.TC_WORK, "408-255-1342", null,
                 AddressType.TC_OTHER, "1324 E Fremont Ave", "Sunnyvale", TC_CA, "94087", Country.TC_US.Code, "532-73-1337")
      loadPerson(b, TC_MS, "Ann-Marie", "Ray", PrimaryPhoneType.TC_HOME, "408-235-1472", VendorType.TC_EXTERNALADJUSTER,
                 AddressType.TC_HOME, "551 E Washington Ave", "Sunnyvale", TC_CA, "94085", Country.TC_US.Code, "328-12-2349")
      loadPerson(b, TC_MS, "Ellen", "Smythe Jones", PrimaryPhoneType.TC_HOME, "650-362-1264", VendorType.TC_NURSE,
                 AddressType.TC_HOME, "1109 O'Connor St", "E Palo Alto", TC_CA, "94303", Country.TC_US.Code, "183-12-1767") 
      loadPerson(b, TC_MR, "Patrick", "O'Connor", PrimaryPhoneType.TC_HOME, "650-322-1423", null,

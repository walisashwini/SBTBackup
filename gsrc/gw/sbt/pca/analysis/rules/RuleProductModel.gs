...
/**
 * Applies to all product model objects
 */
class RuleProductModel extends DecisionRequiredRuleBase {
  ...
  override function checkComparisonType(comparison: Comparison<Object>): boolean {
    return comparison.CanonicalVersion typeis ProductModelObject
  }

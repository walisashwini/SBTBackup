...
<html>
  <head>
    ...
    <link rel="icon" type="image/png" href="<%writer.write(WebUtil.getResourcesPath())%>/img/app/favicon.ico"/>
    <style>
      .about-body {
  ...
  <body class="about-body">
    ...
    <div class="preview-text">${DisplayKey.get("Java.AboutDialog.PreviewWarning")}<br><br></div>
    <% } %>
    <div class="about-text">
      <b>${info.CopyrightInfo}</b><br>
      <b>${info.TrademarkInfo}</b><br>
      <br>

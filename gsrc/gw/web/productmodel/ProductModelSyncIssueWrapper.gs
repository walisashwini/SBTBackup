 ...
 */
@Export
abstract class ProductModelSyncIssueWrapper<T extends gw.api.web.productmodel.ProductModelSyncIssue> implements IProductModelSyncIssueWrapper, Comparable<ProductModelSyncIssueWrapper> {
  var _issue : T
   ...
   */
  override final property get Message() : String {
   ...
   */
  abstract override property get BaseMessage() : String
   ...
   */
  abstract override property get ShouldFixDuringNormalSync() : boolean
   ...
   */
  abstract override property get ShouldFixDuringQuote() : boolean
   ...
   */
  override property get Issue() : T { return _issue }
   ...
   */
  override property get ShouldBlockQuote() : boolean { return Severity == ERROR }

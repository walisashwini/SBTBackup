...
class UnavailableOptionValueIssueWrapper extends ProductModelSyncIssueWrapper<gw.api.web.productmodel.UnavailableOptionValueIssue> {
  ...
  override property get BaseMessage() : String {
    return DisplayKey.get("Web.JobWizard.ProductModelSync.UnavailableOptionValue", Issue.Option.DisplayName, Issue.CovTerm.Pattern.DisplayName, Issue.Option.CovTermPattern.ClausePattern.DisplayName)
  }

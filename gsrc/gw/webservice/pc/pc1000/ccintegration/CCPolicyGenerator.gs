...
uses gw.webservice.pc.pc1000.ccintegration.entities.anonymous.elements.CCPolicySummary_Properties
uses gw.webservice.pc.pc1000.ccintegration.entities.anonymous.elements.CCPolicySummary_Vehicles
uses gw.webservice.pc.pc1000.ccintegration.entities.anonymous.elements.CCPolicy_Endorsements
uses gw.webservice.pc.pc1000.ccintegration.entities.anonymous.elements.Envelope_CCAddress
uses gw.webservice.pc.pc1000.ccintegration.entities.anonymous.elements.Envelope_CCBuilding
uses gw.webservice.pc.pc1000.ccintegration.entities.anonymous.elements.Envelope_CCClassCode
uses gw.webservice.pc.pc1000.ccintegration.entities.anonymous.elements.Envelope_CCContact
uses gw.webservice.pc.pc1000.ccintegration.entities.anonymous.elements.Envelope_CCPolicyLocation
uses gw.webservice.pc.pc1000.ccintegration.entities.anonymous.elements.Envelope_CCPropertyOwner
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCAddress
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCBuilding
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCClassCode
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCContact
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCEndorsement
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCLocationBasedRU
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCPCFilteringCriteria
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCPolicy
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCPolicyLocation
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCPolicySummary
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCPolicySummaryProperty
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCPolicySummaryVehicle
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCPropertyOwner
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCVehicleRU
uses gw.webservice.pc.pc1000.ccintegration.lob.CCAPDPolicyLineMapper
uses gw.webservice.pc.pc1000.ccintegration.lob.CCBAPolicyLineMapper
uses gw.webservice.pc.pc1000.ccintegration.lob.CCBOPPolicyLineMapper
uses gw.webservice.pc.pc1000.ccintegration.lob.CCCPPolicyLineMapper
uses gw.webservice.pc.pc1000.ccintegration.lob.CCGLPolicyLineMapper
uses gw.webservice.pc.pc1000.ccintegration.lob.CCHOPPolicyLineMapper
uses gw.webservice.pc.pc1000.ccintegration.lob.CCIMPolicyLineMapper
uses gw.webservice.pc.pc1000.ccintegration.lob.CCPAPolicyLineMapper
uses gw.webservice.pc.pc1000.ccintegration.lob.CCWCPolicyLineMapper
...
class CCPolicyGenerator {
  ...
  private var _contactGenerator : gw.webservice.pc.pc1000.ccintegration.CCContactGenerator
  ...
  public construct(statusDate : Date, filter : CCPCFilteringCriteria) {
    ...
    _contactGenerator = new gw.webservice.pc.pc1000.ccintegration.CCContactGenerator(this)
  }
  ...
  public function generatePolicy( pcPolicyPeriod : PolicyPeriod ) : Envelope {
    ...
    if (!pcPolicyPeriod.Archived) {
      ...
      var primaryNamedInsured = pcPolicyPeriod.PolicyContactRoles.singleWhere(\elt -> elt typeis PolicyPriNamedInsured).AccountContactRole.AccountContact.Contact
        ...
        if (policyContactRole.AccountContactRole.AccountContact.Contact != null) {
          switch(typeof policyContactRole) {
            ...
            case PolicyDriver:
              ...
              if (driverContact typeis Person and driverContact != primaryNamedInsured) {  // This should always be a Person (not a Company), so this is just to be safe.
      ...
      for( form in pcPolicyPeriod.Forms.sortBy(\ f -> f.EndorsementNumber) ) {
        ...
        if( form.EndorsementNumber != null ) {
          endorsement.Comments = DisplayKey.get("CCPolicySearchIntegration.Endorsement.Comment", form.EndorsementNumber)
        }
  ...
  private function getLineSpecificMapper(line : PolicyLine) : gw.webservice.pc.pc1000.ccintegration.CCBasePolicyLineMapper {
    var mapper : gw.webservice.pc.pc1000.ccintegration.CCBasePolicyLineMapper;
    switch (line.PatternCode) {
      ...
      case "PersonalAutoLine":
        ...
        break;
      case "HOPLine":
        mapper = new CCHOPPolicyLineMapper(line, this);
        break;
      case "WorkersCompLine":
        mapper = new CCWCPolicyLineMapper(line, this);
        break;
      case "ManualLine":  //APD specific change to handle Manual lines
        mapper = new CCAPDPolicyLineMapper(line, this);
        break;
  ...
  public function getContactGenerator() : gw.webservice.pc.pc1000.ccintegration.CCContactGenerator {
...
//    print("does not meetsPolicySystemIDFilteringCriteria(id=" + id)
  ...
  */
  ...
  private function mapPolicyType(pp : PolicyPeriod) : String {
    return CCProductModelCodeMappingUtil.getCCTypeCodeForPMType(pp.Policy.Product)
  }

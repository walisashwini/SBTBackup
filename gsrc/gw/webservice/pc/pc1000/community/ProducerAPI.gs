package gw.webservice.pc.pc1000.community
 ...
 */
@WsiWebService("http://guidewire.com/pc/ws/gw/webservice/pc/pc1000/community/ProducerAPI")
...
class ProducerAPI {
  ...
  function getCarrierOrganization() : gw.webservice.pc.pc1000.community.datamodel.OrganizationDTO {
    var externalOrg = new gw.webservice.pc.pc1000.community.datamodel.OrganizationDTO()
  ...
  @WsiPermissions({SystemPermissionType.TC_ORGVIEWBASIC})
  function getOrganizationByPublicId(organizationID : String) : gw.webservice.pc.pc1000.community.datamodel.OrganizationDTO {
  ...
  function createOrganization(orgModel : gw.webservice.pc.pc1000.community.datamodel.OrganizationDTO) : String {
    SOAPUtil.require(orgModel, "orgModel")
    var foundOrg = loadOrgByPublicID(orgModel.PublicID)
    if (foundOrg != null) {
      throw new BadIdentifierException(DisplayKey.get("ProducerAPI.Error.CreateOrganization.OrgWithPublicIDAlreadyExists", orgModel.PublicID))
    }
  ...
  function updateOrganization(orgModel : gw.webservice.pc.pc1000.community.datamodel.OrganizationDTO) {
    SOAPUtil.require(orgModel, "orgModel")
    if (orgModel.PublicID == null) {
      throw new BadIdentifierException(DisplayKey.get("ProducerAPI.Error.UpdateOrganization.NullPublicID"))
    }
    
    var foundOrg = loadOrgByPublicID(orgModel.PublicID)
    if (foundOrg == null) {
      throw new BadIdentifierException(DisplayKey.get("ProducerAPI.Error.UpdateOrganization.OrgWithPublicIDDoesNotExist", orgModel.PublicID))
    }
    gw.transaction.Transaction.runWithNewBundle(\ bundle -> {
  ...
  function getGroupByPublicId(groupID : String) : gw.webservice.pc.pc1000.community.datamodel.GroupDTO {
    SOAPUtil.require(groupID, "groupID")
    var externalGroup = new gw.webservice.pc.pc1000.community.datamodel.GroupDTO()
  ...
  function addNewGroupToOrganization(orgPublicID : String, groupModel : gw.webservice.pc.pc1000.community.datamodel.GroupDTO) : String {
    SOAPUtil.require(orgPublicID, "orgPublicID")
    SOAPUtil.require(groupModel, "groupModel")
    var foundOrg = loadOrgByPublicID(orgPublicID)
    if (foundOrg == null) {
      throw new BadIdentifierException(DisplayKey.get("ProducerAPI.Error.CreateGroup.NoOrganizationWithPublicId", orgPublicID))
    }
    
    var foundGroup = loadGroupByPublicID(groupModel.PublicID)
    if (foundGroup != null) {
      throw new BadIdentifierException(DisplayKey.get("ProducerAPI.Error.CreateGroup.GroupWithPublicIDAlreadyExists", groupModel.PublicID))
    }
  ...
  function updateGroup(groupModel : gw.webservice.pc.pc1000.community.datamodel.GroupDTO) {
    SOAPUtil.require(groupModel, "groupModel")
    if (groupModel.PublicID == null) {
      throw new BadIdentifierException(DisplayKey.get("ProducerAPI.Error.UpdateGroup.NullPublicID"))
    }
    
    var foundGroup = loadGroupByPublicID(groupModel.PublicID)
    if (foundGroup == null) {
      throw new BadIdentifierException(DisplayKey.get("ProducerAPI.Error.UpdateGroup.GroupWithPublicIDDoesNotExist", groupModel.PublicID))
    }
    gw.transaction.Transaction.runWithNewBundle(\ bundle -> {
  ...
  function getProducerCodeByPublicId(producerCodeID : String) : gw.webservice.pc.pc1000.community.datamodel.ProducerCodeDTO {
    SOAPUtil.require(producerCodeID, "producerCodeID")
    var externalProducerCode = new gw.webservice.pc.pc1000.community.datamodel.ProducerCodeDTO()
  ...
  function addNewProducerCodeToOrganization(orgPublicID : String, producerCodeModel : gw.webservice.pc.pc1000.community.datamodel.ProducerCodeDTO) : String {
    SOAPUtil.require(orgPublicID, "orgPublicID")
    SOAPUtil.require(producerCodeModel, "producerCodeModel")
    var foundOrg = loadOrgByPublicID(orgPublicID)
    if (foundOrg == null) {
      throw new BadIdentifierException(DisplayKey.get("ProducerAPI.Error.CreateProducerCode.NoOrganizationWithPublicId", orgPublicID))
    }

    var foundProducerCode = loadProducerCodeByPublicID(producerCodeModel.PublicID)
    if (foundProducerCode != null) {
      throw new BadIdentifierException(DisplayKey.get("ProducerAPI.Error.CreateProducerCode.ProducerCodeWithPublicIDAlreadyExists", producerCodeModel.PublicID))
    }
  ...
  function updateProducerCode(producerCodeModel : gw.webservice.pc.pc1000.community.datamodel.ProducerCodeDTO) {
    SOAPUtil.require(producerCodeModel, "producerCodeModel")
    if (producerCodeModel.PublicID == null) {
      throw new BadIdentifierException(DisplayKey.get("ProducerAPI.Error.UpdateProducerCode.NullPublicID"))
    }
    
    var foundGroup = loadProducerCodeByPublicID(producerCodeModel.PublicID)
    if (foundGroup == null) {
      throw new BadIdentifierException(DisplayKey.get("ProducerAPI.Error.UpdateProducerCode.ProducerCodeWithPublicIDDoesNotExist", producerCodeModel.PublicID))
    }
    gw.transaction.Transaction.runWithNewBundle(\ bundle -> {
  ...
  private function loadOrgByPublicID(publicID : String) : Organization {
    return publicID == null ? null : PCBeanFinder.loadBeanByPublicID<Organization>(publicID, entity.Organization)
  }

  private function loadGroupByPublicID(publicID : String) : Group {
    return publicID == null ? null : PCBeanFinder.loadBeanByPublicID<Group>(publicID, entity.Group)
  }

  private function loadProducerCodeByPublicID(publicID : String) : ProducerCode {
    return publicID == null ? null : PCBeanFinder.loadBeanByPublicID<ProducerCode>(publicID, entity.ProducerCode)
  }  
}

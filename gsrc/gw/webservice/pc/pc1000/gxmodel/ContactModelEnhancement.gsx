...
enhancement ContactModelEnhancement : gw.webservice.pc.pc1000.gxmodel.contactmodel.types.complex.Contact {
  
  function populateContact(contact : Contact){
    gw.webservice.pc.pc1000.gxmodel.SimpleValuePopulator.populate(this, contact)
    ...
    gw.webservice.pc.pc1000.gxmodel.SimpleValuePopulator.populate(this.PrimaryAddress.$TypeInstance, contact.PrimaryAddress)
  }

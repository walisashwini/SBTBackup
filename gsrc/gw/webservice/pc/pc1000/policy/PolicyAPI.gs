...
uses gw.webservice.pc.pc1000.gxmodel.activitymodel.types.complex.Activity
uses gw.xml.ws.annotation.WsiPermissions
uses gw.xml.ws.annotation.WsiWebService
uses gw.webservice.pc.pc1000.gxmodel.activitymodel.types.complex.Activity

@WsiWebService( "http://guidewire.com/pc/ws/gw/webservice/pc/pc1000/policy/PolicyAPI" )
@Export
class PolicyAPI {
  ...
  function addActivityFromPatternAndAutoAssign(policyId : String, activityType : ActivityType, activityPatternCode : String, activityFields : Activity) : String {
    ...
    Transaction.runWithNewBundle(\ bundle -> {
      ...
      if(activityFields != null){
        gw.webservice.pc.pc1000.gxmodel.SimpleValuePopulator.populate(activityFields, policyActivity)
      }
  ...
  function updateProducerCode(producerCodeInfo : gw.webservice.pc.pc1000.policy.ProducerCodeInfo) {

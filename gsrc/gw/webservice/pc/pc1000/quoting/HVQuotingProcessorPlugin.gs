package gw.webservice.pc.pc1000.quoting
 ...
 */
@Deprecated(:value="Use QuoteDataManager instead", :version="9.x")
@Export
class HVQuotingProcessorPlugin implements QuotingProcessorPlugin {
  ...
  protected function getAccount(policyPeriodData : gw.webservice.pc.pc1000.gxmodel.quotingpolicyperiodmodel.PolicyPeriod)
      : Account {
  ...
  protected function startSubmission(bundle : Bundle, productCode : String,
      policyPeriodData : gw.webservice.pc.pc1000.gxmodel.quotingpolicyperiodmodel.PolicyPeriod) : PolicyPeriod {
  ...
  function quoteSubmission(productCode : String, policyPeriodData : XmlElement) : QuoteData {
    var policyPeriodDataGX = policyPeriodData as gw.webservice.pc.pc1000.gxmodel.quotingpolicyperiodmodel.PolicyPeriod
    ...
    var model = new gw.webservice.pc.pc1000.gxmodel.quotingpolicyperiodmodel.PolicyPeriod(policyPeriod)

...
uses gw.webservice.pc.pc900.ccintegration.entities.types.complex.CCWCCovEmpRU
...
class CCWCPolicyLineMapper extends CCBasePolicyLineMapper {
  ...
  var _wcLine : entity.WorkersCompLine;
  ...
  override function getLineCoverages() : List<entity.Coverage> {
    return _wcLine.WCLineCoverages?.toList() as List<entity.Coverage>
  }

package gw.webservice.pc.pc900.contact
 ...
 */
@gw.xml.ws.annotation.WsiWebService( "http://guidewire.com/pc/ws/gw/webservice/pc/pc900/contact/ContactAPI" )
@Export
...
class ContactAPI implements ABClientAPI {
  ...
  function getAssociatedWorkOrders(addressBookUID : String, workOrderStatus : PolicyPeriodStatus) : gw.webservice.pc.pc900.gxmodel.jobmodel.types.complex.Job[] {
  ...
  private function getAssociatedWorkOrders(contact : Contact, workOrderStatus : PolicyPeriodStatus) : gw.webservice.pc.pc900.gxmodel.jobmodel.types.complex.Job[] {
    var jobs = contact.AssociationFinder.findWorkOrders(workOrderStatus)
    var infos = jobs.map(\ job -> new gw.webservice.pc.pc900.gxmodel.jobmodel.Job(job).$TypeInstance)
  ...
  @WsiPermissions({SystemPermissionType.TC_VIEWSUBMISSION, SystemPermissionType.TC_VIEWRENEWAL, SystemPermissionType.TC_VIEWPOLCHANGE, SystemPermissionType.TC_VIEWREINSTATE, SystemPermissionType.TC_VIEWCANCELLATION, SystemPermissionType.TC_VIEWREWRITE, SystemPermissionType.TC_VIEWREWRNEWACCT, SystemPermissionType.TC_VIEWISSUANCE, SystemPermissionType.TC_VIEWAUDIT})
  @Returns("Array of Job objects representing all work orders associated with the Contact")
  function getAssociatedWorkOrdersByPublicID(publicId : String, workOrderStatus : PolicyPeriodStatus) : gw.webservice.pc.pc900.gxmodel.jobmodel.types.complex.Job[] {
  ...
  function getAssociatedPolicies(addressBookUID : String) : gw.webservice.pc.pc900.gxmodel.policyperiodmodel.types.complex.PolicyPeriod[] {
    // helper checks for null public ID
    var contact = findContactByAddressBookUID(addressBookUID)
    if (contact == null) {
       throw new BadIdentifierException(DisplayKey.get("Webservice.Error.CannotFindContactByAddressBookUID", addressBookUID))
  ...
  private function getAssociatedPolicies(contact : Contact) : gw.webservice.pc.pc900.gxmodel.policyperiodmodel.types.complex.PolicyPeriod[] {
    var periods = contact.AssociationFinder.findPolicyPeriods()
    var infos = periods.map(\ period ->
      new gw.webservice.pc.pc900.gxmodel.policyperiodmodel.PolicyPeriod(period.getSlice(period.EditEffectiveDate)).$TypeInstance
    )
    return infos.toTypedArray()
  }
  ...
  @WsiPermissions({SystemPermissionType.TC_VIEWPOLICYFILE, SystemPermissionType.TC_PFILEDETAILS})
  @Returns("array of PolicyPeriods associated with the Contact")
  function getAssociatedPoliciesByPublicID(publicId : String) : gw.webservice.pc.pc900.gxmodel.policyperiodmodel.types.complex.PolicyPeriod[] {
    // helper checks for null public ID
    var contact = findContactByPublicID(publicId)
    if (contact == null) {
       throw new BadIdentifierException(DisplayKey.get("Webservice.Error.CannotFindContactByPublicID", publicId))
  ...
  function getAssociatedAccounts(addressBookUID : String) : gw.webservice.pc.pc900.gxmodel.accountmodel.types.complex.Account[] {
  ...
  private function getAssociatedAccounts(contact : Contact) : gw.webservice.pc.pc900.gxmodel.accountmodel.types.complex.Account[]{
    var accounts = contact.AssociationFinder.findAccounts()
    var infos = accounts.map(\ account ->
       new gw.webservice.pc.pc900.gxmodel.accountmodel.Account(account).$TypeInstance
    )
    return infos
  }
  ...
  @WsiPermissions({SystemPermissionType.TC_VIEWACCOUNT, SystemPermissionType.TC_SEARCHACCOUNTS})
  @Returns("array of Accounts associated with the Contact")
  function getAssociatedAccountsByPublicID(publicId : String) : gw.webservice.pc.pc900.gxmodel.accountmodel.types.complex.Account[] {
    // helper checks for null public ID
    var contact = findContactByPublicID(publicId)
    if (contact == null) {
       throw new BadIdentifierException(DisplayKey.get("Webservice.Error.CannotFindContactByPublicID", publicId))
  ...
  function addContact(externalContact : gw.webservice.pc.pc900.gxmodel.contactmodel.types.complex.Contact) : String {

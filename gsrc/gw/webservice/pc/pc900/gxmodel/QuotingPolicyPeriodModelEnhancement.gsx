...
uses gw.webservice.pc.pc900.gxmodel.quotingpolicyperiodmodel.anonymous.elements.PolicyPeriod_PersonalAutoLine_PolicyDrivers_Entry
...
enhancement QuotingPolicyPeriodModelEnhancement : gw.webservice.pc.pc900.gxmodel.quotingpolicyperiodmodel.types.complex.PolicyPeriod {

  protected function populatePALine(line : entity.PersonalAutoLine) {
    SimpleValuePopulator.populate(this.PersonalAutoLine.$TypeInstance, line)
    // populate coverage

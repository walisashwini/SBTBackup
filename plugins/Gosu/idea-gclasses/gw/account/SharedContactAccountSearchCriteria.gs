...
uses gw.api.database.SubselectOption
...
class SharedContactAccountSearchCriteria extends EntitySearchCriteria<AccountSummary> {
  ...
  function makeQuery() : ISelectQueryBuilder {
    ...
    accountSummaryQuery.subselect(AccountSummary#ID, CompareIn, accountContactQuery, AccountContact#Account, {SubselectOption.PostgreSQL_ANY_ARRAY})

...
@Export
class ${productLine.LinePrefix}RateRoutineConfigBase implements IRateRoutineConfig {
  ...
  override function worksheetsEnabledForLine(policyLinePatternCode : String) : boolean {
    return true
  }

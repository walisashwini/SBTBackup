...
class PCContactLifecycle extends ContactLifecycleImpl {
  ...
  override function handleBeforeInsert() {
    _contact.Bundle.addBundleTransactionCallback(new SetExternalIdsCallback(\ -> {
  ...
  class SetExternalIdsCallback extends AbstractBundleTransactionCallback {
    var _updateIds : block()

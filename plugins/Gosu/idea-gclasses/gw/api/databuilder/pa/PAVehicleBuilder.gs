...
class PAVehicleBuilder extends DataBuilder<PersonalVehicle, PAVehicleBuilder> {
  ...
  function withVehicleDriver(vehicleDriverBuilder : VehicleDriverBuilder) : PAVehicleBuilder {
    addPopulator(new BuilderArrayPopulator<PersonalVehicle>(PersonalVehicle.Type.TypeInfo.getProperty("Drivers") as IArrayPropertyInfo, vehicleDriverBuilder))
    return this
  }

  function withPAVehicleAdditionalInterest(addInterestBuilder : PAVehicleAdditionalInterestBuilder) : PAVehicleBuilder {
    addPopulator(new BuilderArrayPopulator<PersonalVehicle>(PersonalVehicle.Type.TypeInfo.getProperty("AdditionalInterests") as IArrayPropertyInfo, addInterestBuilder))
    return this
  }

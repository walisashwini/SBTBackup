...
abstract class AbstractPolicyContactRoleAccountSyncableImpl<S extends PolicyContactRole> extends AbstractDateAwareAccountSyncableImpl<S> {
  ...
  static final var ACCOUNT_SYNCED_FIELDS : Set<AccountSyncedField<AccountSyncable, Object >> =
    Collections.unmodifiableSet<AccountSyncedField<AccountSyncable, Object >>({
  ...
  override protected function handleInvalidAccountAndPolicyEntityFields() {
    throw new DisplayableException(DisplayKey.get("Web.Policy.Contact.Validation.MustRequote"))
  }
  ...
  override property get LastUpdateTime() : Date {

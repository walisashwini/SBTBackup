 ...
 */
@Export
class ColumnDataResolverFactory implements IColumnDataResolverFactory {
  ...
  static final var TYPE_RESOLVER_MAP : Map<Type, Type<ColumnDataResolver>> = {
    ...
    CPClassCode ->CPClassCodeColumnDataResolver
  }
  ...
  override function createResolver(aColumnInfo : ColumnInfo) : ColumnDataResolver {
    ...
    var type = TYPE_RESOLVER_MAP.Keys.firstWhere(\ type ->
        ( gw.api.util.TypeUtil.isNominallyOrStructurallyAssignable(aColumnInfo.ColumnType, type) )

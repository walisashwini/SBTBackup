...
class FormDataCreator {
   ...
   */
  private function createFormDataObjectsForSlice(context : FormInferenceContext, startDate : Date, endDate : Date) : List<FormData> {
   ...
   */
  private function getAvailableStates(pattern : FormPattern, context : FormInferenceContext, lookupDates: Map<Jurisdiction, Date>) : Set<Jurisdiction> {

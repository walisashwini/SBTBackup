...
enhancement AccountEnhancement : gw.integration.document.production.gxmodel.account.accountmodel.Account {
  ...
  public static function create(object : entity.Account) : gw.integration.document.production.gxmodel.account.accountmodel.Account {
    return new gw.integration.document.production.gxmodel.account.accountmodel.Account(object)
  }

  public static function create(object : entity.Account, options : gw.api.gx.GXOptions) : gw.integration.document.production.gxmodel.account.accountmodel.Account {
    return new gw.integration.document.production.gxmodel.account.accountmodel.Account(object, options)
  }

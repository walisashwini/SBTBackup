...
class CancellationLeadTimeCalculator {
   ...
   * underwriting period.
   */
  construct(cancellationReasonCode : ReasonCode, lineToJurisdictions : Map<PolicyLinePattern, Jurisdiction[]>, processingDate : Date, inUWPeriod : boolean) {

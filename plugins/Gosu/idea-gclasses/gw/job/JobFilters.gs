...
class JobFilters
{
  ...
  private static function createJobTypeFilter( jobType : typekey.Job ) : DisplayedObject<typekey.Job> {
    var display = \ -> DisplayKey.get("Web.Job.Filter.All")
    if (jobType != null) {
  ...
  public static var AllProductsFilter : DisplayedObject<gw.api.productmodel.Product> = new DisplayedObject<gw.api.productmodel.Product>(\ -> DisplayKey.get("Java.AccountFile.WorkOrders.Filter.AllProducts"), null)

...
class CG00020413 extends gw.lob.common.forms.GeneratedAvailabilityForm {
  ...
  private function isAvailable0() : boolean {
    ...
    return GeneralLiabilityCommlGeneralLiabCovFormClaimsMade()
  }

  private function GeneralLiabilityCommlGeneralLiabCovFormClaimsMade() : boolean {

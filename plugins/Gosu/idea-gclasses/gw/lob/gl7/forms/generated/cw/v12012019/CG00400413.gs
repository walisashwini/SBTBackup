...
class CG00400413 extends gw.lob.common.forms.GeneratedAvailabilityForm {
  ...
  private function isAvailable0() : boolean {
    ...
    return GeneralLiabilityPollutionLiabLimitedCovFormDesigntdSites()
  }

  private function GeneralLiabilityPollutionLiabLimitedCovFormDesigntdSites() : boolean {
    if (ED.tempGL7SublineTypes.Subline == "Pollution" && ED.tempGL7SublineTypes.PollutionCleanUpCoverage == "No") {
      return true
    }
    return false
  }

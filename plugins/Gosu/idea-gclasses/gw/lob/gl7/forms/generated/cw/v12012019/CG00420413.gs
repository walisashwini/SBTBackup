...
class CG00420413 extends gw.lob.common.forms.GeneratedAvailabilityForm {
  ...
  private function isAvailable0() : boolean {
    return GeneralLiabilityUndergroundStorageTankPolicy()
  }

  private function GeneralLiabilityUndergroundStorageTankPolicy() : boolean {

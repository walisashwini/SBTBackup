...
class CG31691204 extends gw.lob.common.forms.GeneratedAvailabilityForm {
  ...
  private function isAvailable0() : boolean {
    ...
    return GeneralLiabilityExclusionCoverageBProductWithdrawalLiability()
  }

  private function GeneralLiabilityExclusionCoverageBProductWithdrawalLiability() : boolean {
    if (ED.tempGL7SublineTypes.Subline == "Product Withdrawal" && ED.tempGL7SublineTypes.ProductWithdrawalCoverageType == "Expense") {
      return true
    }
    return false
  }

...
class CG31911204 extends gw.lob.common.forms.GeneratedAvailabilityForm {
  ...
  private function isAvailable0() : boolean {
    ...
    return GeneralLiabilityIndianaChangesProductWithdrawal()
  }

  private function GeneralLiabilityIndianaChangesProductWithdrawal() : boolean {

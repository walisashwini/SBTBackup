...
class CG33011204 extends gw.lob.common.forms.GeneratedAvailabilityForm {
  ...
  private function isAvailable0() : boolean {
    ...
    return GeneralLiabilityIndianaChangesPollutionExclusion()
  }

  private function GeneralLiabilityIndianaChangesPollutionExclusion() : boolean {
    if (ED.tempGL7SublineTypes.Subline == "Product Withdrawal" && _cf.count(ED.tempGL7SublineTypes.Sublines.singleWhere( \ elm -> elm.Jurisdiction.Code == Parameters.getParam("Jurisdiction")).GL7AmendmentOfDefinitionOfPollutants) == 0) {
      return true
    }
    return false
  }

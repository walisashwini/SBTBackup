...
class GL7GeneralLiabilityDTO extends gw.lob.gl7.iso.rating.infos.ratingparam.generated.cw.v12012019.GL7GeneralLiabilityDTO {
  ...
  public construct(_gL7GeneralLiabilityLine : GL7GeneralLiabilityLine, parameters : gw.lob.common.parameters.Parameters) {
    ...
    _byLawsCreatedOrAmendedOnOrAfterDate = (_cf.stateMatches(tempGL7SublineTypes.Sublines.singleWhere( \ elm -> elm.Jurisdiction.Code == Parameters.getParam("Jurisdiction")), Parameters)) ? tempSublines.ByLawsCreatedOrAmendedOnOrAfterDate : _byLawsCreatedOrAmendedOnOrAfterDate
    _condominiumAssociation = (_cf.stateMatches(tempGL7SublineTypes.Sublines.singleWhere( \ elm -> elm.Jurisdiction.Code == Parameters.getParam("Jurisdiction")), Parameters)) ? tempSublines.CondominiumAssociation : _condominiumAssociation
    _doesThisRiskOperateScaffoldBuildingsInChicagoThatRequirePermit = (_cf.stateMatches(tempGL7SublineTypes.Sublines.singleWhere( \ elm -> elm.Jurisdiction.Code == Parameters.getParam("Jurisdiction")), Parameters)) ? tempSublines.DoesThisRiskOperateScaffoldBuildingsInChicagoThatRequirePermit : _doesThisRiskOperateScaffoldBuildingsInChicagoThatRequirePermit
    _doesThisRiskOperateScaffolds = (_cf.stateMatches(tempGL7SublineTypes.Sublines.singleWhere( \ elm -> elm.Jurisdiction.Code == Parameters.getParam("Jurisdiction")), Parameters)) ? tempSublines.DoesThisRiskOperateScaffolds : _doesThisRiskOperateScaffolds
    _doesThisRiskPerformHomeRepairAndRemodeling = (_cf.stateMatches(tempGL7SublineTypes.Sublines.singleWhere( \ elm -> elm.Jurisdiction.Code == Parameters.getParam("Jurisdiction")), Parameters)) ? tempSublines.DoesThisRiskPerformHomeRepairAndRemodeling : _doesThisRiskPerformHomeRepairAndRemodeling
    _energyEfficiencyInstaller = (_cf.stateMatches(tempGL7SublineTypes.Sublines.singleWhere( \ elm -> elm.Jurisdiction.Code == Parameters.getParam("Jurisdiction")), Parameters)) ? tempSublines.EnergyEfficiencyInstaller : _energyEfficiencyInstaller
    _lossSupportPerInjuredPerson = (_cf.stateMatches(tempSublines.GL7LmtsState.OwningCoverable, Parameters)) ? tempSublines.GL7LmtsState.GL7LossSupportPerInjuredPersonTerm.OptionValue.DisplayName : _lossSupportPerInjuredPerson
    _perPersonLimit = tempSublines.GL7LmtsState.GL7PerPersonLimitTerm.OptionValue.DisplayName
    _perPersonLimitPD = (_cf.stateMatches(tempSublines.GL7LmtsState.OwningCoverable, Parameters)) ? tempSublines.GL7LmtsState.GL7PerPersonLimitPDTerm.OptionValue.DisplayName : _perPersonLimitPD
    ...
    _extendedReportingPeriodEndorsementPollutionLiability = tempSublines.GL7ExtendedReportingPeriodEndorsementPollutionLiab != null ? new GL7GeneralLiabilityExtendedReportingPeriodEndorsementPollutionLiabilityDTO(tempSublines.GL7ExtendedReportingPeriodEndorsementPollutionLiab, this) : null
    _extendedReportingPeriodEndorsementPollutionLiabilityLimited = tempSublines.GL7ExtendedReportingPeriodEndorsementPollutionLia1 != null ? new GL7GeneralLiabilityExtendedReportingPeriodEndorsementPollutionLiabilityLimitedDTO(tempSublines.GL7ExtendedReportingPeriodEndorsementPollutionLia1, this) : null
    ...
    _illinoisChangesAdditionalInsuredCityOfChicagoScaffolding = tempSublines.GL7ILChangesAdditionalInsuredCityOfChicagoScaffold != null ? new GL7GeneralLiabilityIllinoisChangesAdditionalInsuredCityOfChicagoScaffoldingDTO(tempSublines.GL7ILChangesAdditionalInsuredCityOfChicagoScaffold, this) : null
    _illinoisChangesContractorsHomeRepairAndRemodeling = tempSublines.GL7ILChangesContractorsHomeRepairAndRemodeling != null ? new GL7GeneralLiabilityIllinoisChangesContractorsHomeRepairAndRemodelingDTO(tempSublines.GL7ILChangesContractorsHomeRepairAndRemodeling, this) : null
    _illinoisChangesLiquorLiability = tempSublines.GL7ILChangesLiquorLiab != null ? new GL7GeneralLiabilityIllinoisChangesLiquorLiabilityDTO(tempSublines.GL7ILChangesLiquorLiab, this) : null
    ...
    _policyChangesExceptions = tempSublines.GL7PolicyChangesExceptions != null ? new GL7GeneralLiabilityPolicyChangesExceptionsDTO(tempSublines.GL7PolicyChangesExceptions, this) : null
  ...
  @VisibleInRateflow
  var _policyChangesExceptions : GL7GeneralLiabilityPolicyChangesExceptionsDTO as readonly PolicyChangesExceptions  
  ...
  @VisibleInRateflow
  var _illinoisChangesLiquorLiability : GL7GeneralLiabilityIllinoisChangesLiquorLiabilityDTO as readonly IllinoisChangesLiquorLiability  

  @VisibleInRateflow
  var _illinoisChangesContractorsHomeRepairAndRemodeling : GL7GeneralLiabilityIllinoisChangesContractorsHomeRepairAndRemodelingDTO as readonly IllinoisChangesContractorsHomeRepairAndRemodeling  

  @VisibleInRateflow
  var _illinoisChangesAdditionalInsuredCityOfChicagoScaffolding : GL7GeneralLiabilityIllinoisChangesAdditionalInsuredCityOfChicagoScaffoldingDTO as readonly IllinoisChangesAdditionalInsuredCityOfChicagoScaffolding  
  ...
  @VisibleInRateflow
  var _extendedReportingPeriodEndorsementPollutionLiabilityLimited : GL7GeneralLiabilityExtendedReportingPeriodEndorsementPollutionLiabilityLimitedDTO as readonly ExtendedReportingPeriodEndorsementPollutionLiabilityLimited  

  @VisibleInRateflow
  var _extendedReportingPeriodEndorsementPollutionLiability : GL7GeneralLiabilityExtendedReportingPeriodEndorsementPollutionLiabilityDTO as readonly ExtendedReportingPeriodEndorsementPollutionLiability  
  ...
  @VisibleInRateflow
  var _perPersonLimitPD : java.lang.String as PerPersonLimitPD = ""

  @VisibleInRateflow
  var _lossSupportPerInjuredPerson : java.lang.String as LossSupportPerInjuredPerson = ""

  @VisibleInRateflow
  var _energyEfficiencyInstaller : java.lang.String as EnergyEfficiencyInstaller = ""

  @VisibleInRateflow
  var _doesThisRiskPerformHomeRepairAndRemodeling : java.lang.String as DoesThisRiskPerformHomeRepairAndRemodeling = ""

  @VisibleInRateflow
  var _doesThisRiskOperateScaffolds : java.lang.String as DoesThisRiskOperateScaffolds = ""

  @VisibleInRateflow
  var _doesThisRiskOperateScaffoldBuildingsInChicagoThatRequirePermit : java.lang.String as DoesThisRiskOperateScaffoldBuildingsInChicagoThatRequirePermit = ""

  @VisibleInRateflow
  var _condominiumAssociation : java.lang.String as CondominiumAssociation = ""

  @VisibleInRateflow
  var _byLawsCreatedOrAmendedOnOrAfterDate : java.lang.String as ByLawsCreatedOrAmendedOnOrAfterDate = ""

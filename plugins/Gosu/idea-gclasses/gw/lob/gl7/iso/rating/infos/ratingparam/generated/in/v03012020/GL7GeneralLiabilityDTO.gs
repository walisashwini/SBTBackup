...
class GL7GeneralLiabilityDTO extends gw.lob.gl7.iso.rating.infos.ratingparam.generated.cw.v12012019.GL7GeneralLiabilityDTO {
  ...
  public construct(_gL7GeneralLiabilityLine : GL7GeneralLiabilityLine, parameters : gw.lob.common.parameters.Parameters) {
    ...
    var tempGL7LmtsState = tempSublines.GL7LmtsState
    _currentJurisdiction = Jurisdiction.get(parameters.getParam("Jurisdiction"))
    _generalAggregateLimitGovernmentalSubdivision = tempGL7LmtsState.GL7GeneralAggLimitGovSubdivisionTerm.OptionValue.DisplayName
    _perPersonLimit = tempGL7LmtsState.GL7PerPersonLimitTerm.OptionValue.DisplayName
    _personalAndAdvertisingInjuryLimitGovernmentalSubdivision = (_cf.stateMatches(tempGL7LmtsState.OwningCoverable, Parameters)) ? tempGL7LmtsState.GL7PersonalAndAdvertisingInjuryLimitGovSubdivisionTerm.OptionValue.DisplayName : _personalAndAdvertisingInjuryLimitGovernmentalSubdivision
    _premOpsProdsEachOccurrenceLimitGovernmentalSubdivision = tempGL7LmtsState.GL7PremOpsProdsEachOccurrenceLimitGovSubdivisionTerm.OptionValue.DisplayName
    _prodsCompldOpsAggregateLimitGovernmentalSubdivision = tempGL7LmtsState.GL7ProdsCompldOpsAggLimitGovSubdivisionTerm.OptionValue.DisplayName
    ...
    _amendmentOfDefinitionOfPollutants = tempSublines.GL7AmendmentOfDefinitionOfPollutants != null ? new GL7GeneralLiabilityAmendmentOfDefinitionOfPollutantsDTO(tempSublines.GL7AmendmentOfDefinitionOfPollutants, this) : null
    _amendmentOfDefinitionOfPollutantsRailRoadCov = tempSublines.GL7AmendmentOfDefinitionOfPollutantsRailRoadCov != null ? new GL7GeneralLiabilityAmendmentOfDefinitionOfPollutantsRailRoadCovDTO(tempSublines.GL7AmendmentOfDefinitionOfPollutantsRailRoadCov, this) : null
    ...
    _indianaChangesPerPersonLimitsOfInsuranceGovernmentalSubdivisions = tempSublines.GL7INChangesPerPersonLmtsOfInsGovSubdivisions != null ? new GL7GeneralLiabilityIndianaChangesPerPersonLimitsOfInsuranceGovernmentalSubdivisionsDTO(tempSublines.GL7INChangesPerPersonLmtsOfInsGovSubdivisions, this) : null
  ...
  @VisibleInRateflow
  var _indianaChangesPerPersonLimitsOfInsuranceGovernmentalSubdivisions : GL7GeneralLiabilityIndianaChangesPerPersonLimitsOfInsuranceGovernmentalSubdivisionsDTO as readonly IndianaChangesPerPersonLimitsOfInsuranceGovernmentalSubdivisions  
  ...
  @VisibleInRateflow
  var _amendmentOfDefinitionOfPollutantsRailRoadCov : GL7GeneralLiabilityAmendmentOfDefinitionOfPollutantsRailRoadCovDTO as readonly AmendmentOfDefinitionOfPollutantsRailRoadCov  

  @VisibleInRateflow
  var _amendmentOfDefinitionOfPollutants : GL7GeneralLiabilityAmendmentOfDefinitionOfPollutantsDTO as readonly AmendmentOfDefinitionOfPollutants  
  ...
  @VisibleInRateflow
  var _personalAndAdvertisingInjuryLimitGovernmentalSubdivision : java.lang.String as PersonalAndAdvertisingInjuryLimitGovernmentalSubdivision = ""

...
class GL7Classification_ER_c3cf extends gw.lob.gl7.validation.GL7GeneratedValidation<GL7Exposure> {
  ...
  override public function validate(_coverable : GL7Exposure) : java.lang.String {
    ...
    TheProdsCompldOpsPDDeductibleFactorcannotexceedtheIncreasedLimitsFactor()
  ...
  private function TheProdsCompldOpsPDDeductibleFactorcannotexceedtheIncreasedLimitsFactor() {
    if ((SublineCLV == "Products/Completed Operations" || SublineCLV == "Premises/Operations and Products/Completed Operations") && (coverable.ProdsCompldOpsPDDeductible == "250 Per Claim" || coverable.ProdsCompldOpsPDDeductible == "500 Per Claim" || coverable.ProdsCompldOpsPDDeductible == "750 Per Claim" || coverable.ProdsCompldOpsPDDeductible == "1,000 Per Claim" || coverable.ProdsCompldOpsPDDeductible == "2,000 Per Claim" || coverable.ProdsCompldOpsPDDeductible == "3,000 Per Claim" || coverable.ProdsCompldOpsPDDeductible == "4,000 Per Claim" || coverable.ProdsCompldOpsPDDeductible == "5,000 Per Claim" || coverable.ProdsCompldOpsPDDeductible == "10,000 Per Claim" || coverable.ProdsCompldOpsPDDeductible == "15,000 Per Claim" || coverable.ProdsCompldOpsPDDeductible == "20,000 Per Claim" || coverable.ProdsCompldOpsPDDeductible == "25,000 Per Claim" || coverable.ProdsCompldOpsPDDeductible == "50,000 Per Claim" || coverable.ProdsCompldOpsPDDeductible == "75,000 Per Claim" || coverable.ProdsCompldOpsPDDeductible == "100,000 Per Claim") && coverable.ProdsCompldOpsPDDeductibleFactorOverride > ProdsCompldOpsIncrdLimitFactorCLV) {
      Error_Message = "[{0}] The Prods Compld Ops PD Deductible Factor cannot exceed the Increased Limits Factor"
    }
  }

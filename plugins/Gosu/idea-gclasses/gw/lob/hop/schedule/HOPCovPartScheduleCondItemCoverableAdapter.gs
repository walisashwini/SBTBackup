...
@Export
class HOPCovPartScheduleCondItemCoverableAdapter extends AbstractScheduledItemAdapter {
  var _owner: HOPCovPartSchCondItem as readonly Owner

  construct(item: HOPCovPartSchCondItem) {
    _owner = item
  }
  ...
  override function addCondition(cond: PolicyCondition) {
    _owner.ScheduledItemClause = cond as HOPCovPartSchCondItemCond
  }

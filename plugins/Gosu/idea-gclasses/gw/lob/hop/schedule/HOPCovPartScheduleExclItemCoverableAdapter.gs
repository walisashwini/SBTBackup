...
@Export
class HOPCovPartScheduleExclItemCoverableAdapter extends AbstractScheduledItemAdapter {
  var _owner: HOPCovPartSchExclItem as readonly Owner

  construct(item: HOPCovPartSchExclItem) {
    _owner = item
  }
  ...
  override function addExclusion(excl: Exclusion) {
    _owner.ScheduledItemClause = excl as HOPCovPartSchExclItemExcl
  }

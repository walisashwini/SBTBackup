...
class IMARPartValidation extends PCValidationBase
{
  ...
  private function atLeastOneCoverageExists() {
    ...
    var msg = DisplayKey.get("Web.Policy.IM.Validation.AtLeastOneAccountsReceivableCoverageExists")
    if (_arPart.IMAccountsReceivables.arrays("Coverages").toArray(new IMAccountsRecCov[0]).Count == 0) {

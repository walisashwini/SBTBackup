...
enhancement IMTransactionSetEnhancement<T extends IMTransaction> : Set<T>
{
   ...
   */
  reified function bySignPartPremium() : Map<Boolean, Set<T>>
  {
   ...
   */
  reified function byFixedSign() : Map<IMSign, Set<T>>
  {
  ...
  reified function byFixedContractorsEquipment() : Map<ContractorsEquipment, Set<T>> {
  ...
  reified function byFixedARItem() : Map<IMAccountsReceivable, Set<T>> {

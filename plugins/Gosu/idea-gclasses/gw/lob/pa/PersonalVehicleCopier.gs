package gw.lob.pa
uses gw.api.copy.CompositeCopyReferenceDateInternalCopier
 ...
 */
@Export
class PersonalVehicleCopier extends CompositeCopyReferenceDateInternalCopier<PersonalAutoLine, PersonalVehicle> {

...
*/
  ...
  protected function rateTaxes(line : PersonalAutoLine) {
    ...
    var level = (line.BaseState == TC_NY or line.BaseState == TC_FL) ? 2 : this.RoundingLevel
  ...
  private function getRateFactorInRange(factorName : String, lookup : Double, cov : PersonalVehicleCov, ratingDate : Date) : BigDecimal {
  ...
  private function getNoLossDiscountFactor(line : entity.PersonalAutoLine, ratingDate : Date) : BigDecimal {
    if ( line.PAModifiers.hasMatch( \ modifier -> modifier.Pattern.PublicID == "PANoLossDiscount" and modifier.BooleanModifier ) ) {

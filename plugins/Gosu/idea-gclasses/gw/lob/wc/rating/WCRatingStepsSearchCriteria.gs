...
class WCRatingStepsSearchCriteria
{
   ...
   */
  function matchAllInRange( fromStep : int, toStep : int ) : IQueryBeanResult<WCRatingStepExt>
  {
   ...
   * The steps are ordered ascending by their calcOrder.
   */
  private function findInRange( findState : Jurisdiction, fromStep : int, toStep : int ) : IQueryBeanResult<WCRatingStepExt>
  {
    ...
    stepQuery.orderBy(QuerySelectColumns.path(Paths.make(WCRatingStepExt#calcOrder)))
    return stepQuery
  }

package gw.plugin.claimsearch.cc900
...
uses wsi.remote.gw.webservice.cc.cc900.pcclaimsearchintegrationapi.PCClaimSearchIntegrationAPI
uses wsi.remote.gw.webservice.cc.cc900.pcclaimsearchintegrationapi.anonymous.elements.PCClaimSearchCriteria_PolicyNumbers
uses wsi.remote.gw.webservice.cc.cc900.pcclaimsearchintegrationapi.types.complex.PCClaim
uses wsi.remote.gw.webservice.cc.cc900.pcclaimsearchintegrationapi.types.complex.PCClaimSearchCriteria
...
@Export
@gw.lang.Deprecated(:value="900 inter-app integration packages will be removed in PC11.", :version="PC 10.0.0")

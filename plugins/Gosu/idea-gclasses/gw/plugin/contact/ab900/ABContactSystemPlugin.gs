...
uses wsi.remote.gw.webservice.ab.ab900.abcontactapi.types.complex.ABContactAPISearchSpec
  ...
  **/
  override function addContact(contact : Contact, payload : String,  transactionId : String) {
    ...
    try {
      ...
      var abXmlBackedInstance = wsi.remote.gw.webservice.ab.ab900.beanmodel.XmlBackedInstance.parse(payload)
  ...
  override function updateContact(contact : Contact, changes : String, transactionId : String) {
    ...
    try {
      ...
      var abXmlBackedInstance = wsi.remote.gw.webservice.ab.ab900.beanmodel.XmlBackedInstance.parse(changes)
  ...
  override function removeContact(contact : Contact, removeInfo : String, transactionId : String) {
    try {
      ...
      var abXmlBackedInstance = wsi.remote.gw.webservice.ab.ab900.beanmodel.XmlBackedInstance.parse(removeInfo)
  ...
  override function findDuplicates(contact : Contact) : DuplicateContactResultContainer {
    ...
    return new DuplicateContactResultContainerImpl(callWebService(\api -> {
      var abXmlBackedInstance = wsi.remote.gw.webservice.ab.ab900.beanmodel.XmlBackedInstance.parse(xml.bytes())
   ...
   */
  protected function updateAddressBookUIDs(contact : Contact, abuidContainer : AddressBookUIDContainer) {
  ...
  private function retrieveContactXML(addressBookUID : String) : XmlBackedInstance {
    var abContactXML : wsi.remote.gw.webservice.ab.ab900.beanmodel.XmlBackedInstance
    try {

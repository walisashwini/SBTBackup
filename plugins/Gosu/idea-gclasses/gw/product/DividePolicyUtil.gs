...
class DividePolicyUtil {
  ...
  static function createSplitPolicyActivity(sourcePolicy : PolicyPeriod) : Activity {
    ...
    var splitActivityTitle = DisplayKey.get("Job.DividePolicy.Split.Activity.Subject", periodNumber)
    var splitActivityDescription = DisplayKey.get("Job.DividePolicy.Split.Activity.Description", periodNumber)

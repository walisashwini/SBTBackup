...
@Export
class CPDTOSampleDataFactorRowBuilder extends AbstractSampleDataFactorRowBuilder {
...
//    { "cpDeductSpecial", null, 0 , 100000000, "", 3.14159 }
  ...
  final private static var NAME_MAP : Map<String, List<Object[]>> = {
      CPDTOSampleDataTablesBuilder.CP_COV_BASE_RATE_CODE       -> BASE_RATE_TABLE,
      CPDTOSampleDataTablesBuilder.CP_DEDUCT_CODE              -> DEDUCT_TABLE,
      CPDTOSampleDataTablesBuilder.CP_FIRE_PROTECT_CLASS_CODE  -> FIRE_PROTECT_CLASS_TABLE,
      CPDTOSampleDataTablesBuilder.CP_UW_COMPANY_CODE          -> UW_COMPANY_TABLE
  }

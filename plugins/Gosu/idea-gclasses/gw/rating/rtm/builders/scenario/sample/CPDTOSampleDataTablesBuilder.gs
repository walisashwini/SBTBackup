...
@Export
class CPDTOSampleDataTablesBuilder extends AbstractSampleDataTablesBuilder {

  public final static var CP_LINE                      : String = "CPLine"
  // Arg Src Sets
  public final static var CP_ARG_SET_CODE          : String = "cp_arg_src_set_dto"
  public final static var CP_ARG_SET_NAME          : String = "LookupByWrappedCov"
  // Rate Tables
  public final static var CP_COV_BASE_RATE_CODE        : String = "cp_coverage_base_rate_dto"
  ...
  public final static var CP_DEDUCT_CODE               : String = "cp_deduct_dto"
  public final static var CP_DEDUCT_FACTOR             :   String = "Factor"
  public final static var CP_DEDUCT_NAME               :   String = "DeductibleFactor"
  public final static var CP_FIRE_PROTECT_CLASS_CODE   : String = "cp_fire_protect_class_dto"
  ...
  public final static var CP_UW_COMPANY_CODE           : String = "cp_uw_company_dto"
  ...
  //TODO: This class seems to duplicate CPSampleDataTablesBuilder
  static var _CPDTOCoverageWrapperParamSetLocal = LockingLazyVar<CalcRoutineParameterSet>.make(\ -> {
    new TinySampleRatingData().load()
  return getCalcRoutineParameterSet("CPDTOCoverageWrapperParamSet")
  })
  static var _CPDTOCoverageWrapperParamSet : CalcRoutineParameterSet as CPDTOCoverageWrapperParamSet = _CPDTOCoverageWrapperParamSetLocal.get()
  ...
  static property get BaseRateTableDefBuilder() : RateTableDefinitionBuilder {
    ...
    var argSrcSetBldr1 = new RateTableArgumentSourceSetBuilder()
            ...
            .withCalcRoutineParamSet(CPDTOCoverageWrapperParamSet)
  ...
  static property get FireProtectClassDefBuilder() : RateTableDefinitionBuilder {
    ...
    var matchOpBldr1 = getMatchOp(paramBldr1, "FireProtectClass", argSrcBldr1) // Changed from entity based version
            .withMatchOpDefinition(EXACT_MATCH_OP_DEF)

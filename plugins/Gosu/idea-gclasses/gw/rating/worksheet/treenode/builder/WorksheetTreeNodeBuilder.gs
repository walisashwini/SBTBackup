...
uses gw.rating.RateRoutineExecutionOperator
...
abstract class WorksheetTreeNodeBuilder<T extends WorksheetEntry> {
  ...
  /**
   * Returns the string used to represent the given RateRoutineExecutionOperator.
   * @param op the RateRoutineExecutionOperator to display
   * @return the string representing the given RateRoutineExecutionOperator
   */
  function getOperatorForDisplay(op : RateRoutineExecutionOperator) : String {

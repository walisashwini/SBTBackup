...
class SmallSamplePolicyData extends AbstractSampleDataCollection
{
  ...
  public override function load() {
    ...
    runBlockAsUser( "aapplegate", "SmallSamplePolicyData -- aapplegate", \ -> {
      // SIMPLE SUBMISSIONS    
      period = loadSubmission("47586734721", "C000143542", PCCoercions.makeProductModel<Product>("PersonalAuto"), SampleDataConstants.getBaseDateMinus(30), new String[0], true)

      loadSubmission("47586734722", "C000456352", PCCoercions.makeProductModel<Product>("BusinessOwners"), SampleDataConstants.getBaseDateMinus(275), SampleDataConstants.ACCOUNT_COMPANY_NAMES, true)
      loadSubmission("453453462", "C000456354", PCCoercions.makeProductModel<Product>("PersonalAuto"), SampleDataConstants.getBaseDateMinus(2, 0, 90), new String[0], true)
      loadSubmission("47563857556", "C000456356", PCCoercions.makeProductModel<Product>("HOPHomeowners"), SampleDataConstants.getBaseDateMinus(30), {"John Shirley"}, true)

      // JOB CHAINS
      loadSubmission("SUB00000001", "C000212105", PCCoercions.makeProductModel<Product>("WorkersComp"), SampleDataConstants.getBaseDateMinus(2, 0, 90), SampleDataConstants.ACCOUNT_COMPANY_NAMES, true)
    ...
    runBlockAsUser( "bbaker", "SmallSamplePolicyData -- bbaker", \ -> {
      loadSubmission("SUB00000002", "C000212105", PCCoercions.makeProductModel<Product>("BusinessOwners"), SampleDataConstants.getBaseDateMinus(1, 0, 90), SampleDataConstants.ACCOUNT_COMPANY_NAMES, true)

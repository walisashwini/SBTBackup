 ...
 */
@Export
class SolrPolicyIndexRequest extends AbstractIndexRequest implements ISolrPolicyIndexRequest {
  ...
  override function processPeriod(period : PolicyPeriod, solrContext : SolrIndexContext){

 ...
 */
@Export
class SolrPolicyResultDocument implements ISolrPolicyResultDocument {
  ...
  property get PolicyNumberDisplayString(): String {
    return _policyNumber.NotBlank ? _policyNumber : DisplayKey.get("EntityName.PolicyPeriod.PolicyNumber.Unassigned")
  }

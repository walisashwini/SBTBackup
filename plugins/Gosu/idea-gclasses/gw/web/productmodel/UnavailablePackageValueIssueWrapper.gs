...
class UnavailablePackageValueIssueWrapper extends ProductModelSyncIssueWrapper<gw.api.web.productmodel.UnavailablePackageValueIssue> {
  ...
  override property get BaseMessage() : String {
    return DisplayKey.get("Web.JobWizard.ProductModelSync.UnavailablePackageValue", Issue.CovTermPack.DisplayName, Issue.CovTerm.Pattern.DisplayName, Issue.CovTermPack.CovTermPattern.ClausePattern.DisplayName)
  }

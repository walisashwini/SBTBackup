...
uses gw.webservice.pc.pc1000.ccintegration.entities.anonymous.elements.CCContact_ContactAddresses
...
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCAdjudicator
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCCompany
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCCompanyVendor
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCContact
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCContactAddress
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCLegalVenue
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCOfficialID
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCPerson
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCPersonVendor
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCPlace
...
class CCContactGenerator {
  ...
  var _gen : gw.webservice.pc.pc1000.ccintegration.CCPolicyGenerator

  construct(gen : gw.webservice.pc.pc1000.ccintegration.CCPolicyGenerator) {
    _gen = gen;
  }

  public function getOrCreateContact(pcContact : Contact) : XmlElement {
    ...
    if (pcContact typeis Person && ccContact typeis CCPerson) {
      if (pcContact typeis Adjudicator && ccContact typeis CCAdjudicator) {
    ...
    if (pcContact typeis LegalVenue && ccContact typeis CCLegalVenue) {
   ...
   */
  function getOrCreatePersonFromInclusionPerson(inclusionPerson : InclusionPerson) : XmlElement {
   ...
   * all normal Contacts first using that method.
   */
  function getOrCreatePersonFromCommercialDriver(driver : CommercialDriver) : XmlElement {
  ...
  protected function getOrCreateAddress(pcAddress : Address) : XmlElement {
  ...
  protected function createContactAddress(pcContactAddress : ContactAddress) : CCContactAddress {
  ...
  protected function createOfficialID(pcOfficialID : OfficialID) : CCOfficialID {

...
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.PolicyLocationInfo
 ...
 */
@WsiWebService( "http://guidewire.com/pc/ws/gw/webservice/pc/pc1000/ccintegration/PolicyLocationSearchAPI" )
@Export
class PolicyLocationSearchAPI {
  ...
  function findPolicyLocationsWithinBoundingBox(effDate : Date, productCodes : String[],
   ...
   if (results == null) {
     ...
     criteria.ProductCodes = productCodes?.toList() as ArrayList<String>

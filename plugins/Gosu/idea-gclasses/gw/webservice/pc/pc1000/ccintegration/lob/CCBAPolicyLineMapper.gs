...
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCVehicleCoverage
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCVehicleRU

@Export
class CCBAPolicyLineMapper extends gw.webservice.pc.pc1000.ccintegration.CCBasePolicyLineMapper {
  ...
  override function getLineCoverages() : List<Coverage> {
    return _baLine.BALineCoverages?.toList() as List<Coverage>
  }

...
@Export
class CCBOPPolicyLineMapper extends gw.webservice.pc.pc1000.ccintegration.CCBasePolicyLineMapper {
  ...
  override function getLineCoverages() : List<Coverage> {
    return _bopLine.BOPLineCoverages?.toList() as List<Coverage>
  }

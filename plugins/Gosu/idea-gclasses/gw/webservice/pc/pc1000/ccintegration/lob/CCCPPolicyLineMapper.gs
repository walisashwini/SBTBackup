...
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCBuildingRU
...
@Export
class CCCPPolicyLineMapper extends gw.webservice.pc.pc1000.ccintegration.CCBasePolicyLineMapper {
  ...
  override function getLineCoverages() : List<Coverage> {
    return _cpLine.CPLineCoverages?.toList() as List<Coverage>
  }

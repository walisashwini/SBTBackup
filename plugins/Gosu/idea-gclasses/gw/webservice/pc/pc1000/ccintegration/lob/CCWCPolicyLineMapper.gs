...
uses entity.WCCoveredEmployeeBase
...
uses gw.webservice.pc.pc1000.ccintegration.entities.types.complex.CCWCCovEmpRU
uses gw.xml.XmlElement

@Export
class CCWCPolicyLineMapper extends gw.webservice.pc.pc1000.ccintegration.CCBasePolicyLineMapper {
  ...
  override function getLineCoverages() : List<Coverage> {
    return _wcLine.WCLineCoverages?.toList() as List<Coverage>
  }

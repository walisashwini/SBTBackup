...
enhancement AccountLocationModelEnhancement : gw.webservice.pc.pc1000.gxmodel.accountlocationmodel.types.complex.AccountLocation {
  ...
  function populateAccountLocation(accountLocation : AccountLocation){
    gw.webservice.pc.pc1000.gxmodel.SimpleValuePopulator.populate(this, accountLocation)
  }
}
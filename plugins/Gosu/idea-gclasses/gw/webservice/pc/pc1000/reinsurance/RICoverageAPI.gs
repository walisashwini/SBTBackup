...
@Export
@gw.xml.ws.annotation.WsiWebService( "http://guidewire.com/pc/ws/gw/webservice/pc/pc1000/reinsurance/RICoverageAPI")
class RICoverageAPI {
  ...
  public function findRIRiskByCoverableID(policyNumber : String, coverableID : String, coverageCode : String, date : Date) : gw.webservice.pc.pc1000.reinsurance.RIRiskInfo {
    ...
    return gw.webservice.pc.pc1000.reinsurance.RIRiskInfo.of(plugin.findReinsuranceRiskInfo(risks, riCovGroup, date))
  }
  ...
  @WsiPermissions({SystemPermissionType.TC_VIEWREINSURANCEFORPOLICY})
  @Returns("RIRiskInfo which contains RIRisk ID & Description + array of attachments if found, else returns null")
  public function findRIPolicyRisk(policyNumber : String, coverageCode : String, date : Date) : gw.webservice.pc.pc1000.reinsurance.RIRiskInfo {
    SOAPUtil.require(policyNumber, "Policy Number")
    SOAPUtil.require(coverageCode, "Coverage Code")
    SOAPUtil.require(date, "As of Date")
    ...
    SOAPUtil.notNull(period, DisplayKey.get("ReinsuranceAPI.Error.CannotFindPolicyPeriod", policyNumber, date.Time))
    var plugin = Plugins.get(IReinsurancePlugin)
    return gw.webservice.pc.pc1000.reinsurance.RIRiskInfo.of(plugin.findReinsuranceRiskInfo(period.PolicyRisks, riCovGroup, date))
  }
}
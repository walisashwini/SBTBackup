package gw.webservice.pc.pc900.account
 ...
 */
@Export
@WsiWebService("http://guidewire.com/pc/ws/gw/webservice/pc/pc900/account/AccountAPI")
...
class AccountAPI {
  ...
  function findAccounts(accountSearchInfo : AccountSearchInfo) : String[] {
    ...
    SOAPUtil.convertToSOAPException(PCLoggerCategory.ACCOUNT_API, \ -> {
        var accountQueryBuilder = new AccountQueryBuilder()
          .withAccountStatus(typekey.AccountStatus.get(accountSearchInfo.AccountStatus))
          ...
          .withAccountOrgType(typekey.AccountOrgType.get(accountSearchInfo.AccountOrgType))
          .withOriginationDate(accountSearchInfo.OriginationDate)
          .withPrimaryLanguage(typekey.LanguageType.get(accountSearchInfo.PrimaryLanguage))
        ...
        if (accountSearchInfo.FirstName.NotBlank
          ...
          var contactQueryBuilder = new ContactQueryBuilder()
              ...
              .withStateDenorm(typekey.State.get(accountSearchInfo.State))
          if (accountSearchInfo.AddressLine1.NotBlank
            ...
            contactQueryBuilder.withPrimaryAddress(new AddressQueryBuilder()
                ...
                .withCountry(typekey.Country.get(accountSearchInfo.Country))
  ...
  function addAccount(externalAccount : gw.webservice.pc.pc900.gxmodel.accountmodel.types.complex.Account) : String {
  ...
  function addLocationToAccount(accountNumber : String,
      externalLocation : gw.webservice.pc.pc900.gxmodel.accountlocationmodel.types.complex.AccountLocation) : String {
    SOAPUtil.require(accountNumber, "accountNumber")
  ...
  function addContactToAccount(externalContact : gw.webservice.pc.pc900.gxmodel.contactmodel.types.complex.Contact,
  ...
  function updateAccountContactsAddressFields(addressPublicID : String,
      externalAddress : gw.webservice.pc.pc900.gxmodel.addressmodel.types.complex.Address) : String {
  ...
  function addAndAutoAssignActivityForAccount(accountNumber : String,
        ...
        externalActivity : gw.webservice.pc.pc900.gxmodel.activitymodel.types.complex.Activity) {
    SOAPUtil.require(accountNumber, "accountNumber")
  ...
  function addDocumentToAccount(accountNumber : String,
      externalDocument : gw.webservice.pc.pc900.gxmodel.documentmodel.types.complex.Document) : String {
    SOAPUtil.require(accountNumber, "accountNumber")
  ...
  function addNoteToAccount(accountNumber : String,
      externalNote : gw.webservice.pc.pc900.gxmodel.notemodel.types.complex.Note) : String {
    SOAPUtil.require(accountNumber, "accountNumber")
  ...
  function addAccountContactRole(
        ...
        accountContactRoleInfo : gw.webservice.pc.pc900.gxmodel.accountcontactrolemodel.types.complex.AccountContactRole) : String {
    SOAPUtil.require(accountNumber, "accountNumber")
    SOAPUtil.require(contactPublicID, "contactPublicID")
  ...
  function updateAccountContactRoleFields(
      accountNumber : String,
      contactPublicID : String,
      contactRoleInfo : gw.webservice.pc.pc900.gxmodel.accountcontactrolemodel.types.complex.AccountContactRole) : String {
    SOAPUtil.require(accountNumber, "accountNumber")
    SOAPUtil.require(contactPublicID, "contactPublicID")

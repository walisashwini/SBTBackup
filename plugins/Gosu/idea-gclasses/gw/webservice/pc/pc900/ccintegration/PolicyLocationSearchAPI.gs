 ...
 */
@WsiWebService( "http://guidewire.com/pc/ws/gw/webservice/pc/pc900/ccintegration/PolicyLocationSearchAPI" )
@Export
...
class PolicyLocationSearchAPI {
  ...
  function findPolicyLocationsWithinBoundingBox(effDate : Date, productCodes : String[],
   ...
   if (results == null) {
     ...
     criteria.ProductCodes = productCodes?.toList() as java.util.ArrayList<String>
     ...
     var queryResults = criteria.performSearch()
      ...
      var comparator = new Comparator<PolicyLocationInfo>() {
        override function compare(obj1 : PolicyLocationInfo, obj2 : PolicyLocationInfo) : int {

...
uses gw.webservice.pc.pc900.ccintegration.entities.types.complex.CCVehicleCoverage
...
class CCPAPolicyLineMapper extends CCBasePolicyLineMapper {
  ...
  var _paLine : entity.PersonalAutoLine;
  ...
  override function getLineCoverages() : List<entity.Coverage> {
    return _paLine.PALineCoverages?.toList() as List<entity.Coverage>
  }

...
enhancement BusinessAutoLineModelEnhancement : gw.webservice.pc.pc900.gxmodel.businessautolinemodel.types.complex.BusinessAutoLine {
  ...
  private function populateClause(j : BAJurisdiction, cov : gw.webservice.pc.pc900.gxmodel.clausemodel.types.complex.Clause){

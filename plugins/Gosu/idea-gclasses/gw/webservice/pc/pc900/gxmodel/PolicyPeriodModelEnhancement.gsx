...
enhancement PolicyPeriodModelEnhancement : gw.webservice.pc.pc900.gxmodel.policyperiodmodel.types.complex.PolicyPeriod {
  ...
  function populatePolicyPeriod(period : PolicyPeriod) {
    ...
    period.PreferredCoverageCurrency = (this.PreferredCoverageCurrency != null) ? typekey.Currency.get( this.PreferredCoverageCurrency as String ) : period.Policy.Account.PreferredCoverageCurrency
    period.PreferredSettlementCurrency = (this.PreferredSettlementCurrency != null) ? typekey.Currency.get( this.PreferredSettlementCurrency as String ) : period.Policy.Account.PreferredSettlementCurrency
  }
}

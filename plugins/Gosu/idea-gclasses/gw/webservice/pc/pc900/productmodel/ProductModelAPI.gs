...
uses gw.webservice.pc.pc900.gxmodel.clausepatternmodel.types.complex.ClausePattern
uses gw.webservice.pc.pc900.gxmodel.questionsetmodel.types.complex.QuestionSet
 ...
 * <br/><br/>
 */
@gw.xml.ws.annotation.WsiWebService( "http://guidewire.com/pc/ws/gw/webservice/pc/pc900/productmodel/ProductModelAPI" )
  ...
  function getAvailableQuestions(lookupRoot : LookupRootImpl,
    ...
    for(questionSet in allQuestionSets){
      ...
      if(questionSet.maybeQuestionSetAvailable(lookupRoot, lookupDate, offering)){
        var questionSetModel = new gw.webservice.pc.pc900.gxmodel.questionsetmodel.QuestionSet(questionSet)
        // filter out question
  ...
  function getAvailableClausePatterns(lookupRoot : LookupRootImpl,
    ...
    for(pattern in allPatterns){
      ...
      if(clauseAvailabilityInfo.Available){
        var result = new gw.webservice.pc.pc900.gxmodel.clausepatternmodel.ClausePattern(pattern).$TypeInstance

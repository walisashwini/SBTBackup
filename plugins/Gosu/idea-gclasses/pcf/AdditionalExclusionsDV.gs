...
public class AdditionalExclusionsDV extends com.guidewire.pl.web.codegen.SectionBase {
  function onEnter ($coverable :  Coverable, $coverageCategories :  String[], $includeExclude :  boolean) : void {
    __widgetOf(this, pcf.AdditionalExclusionsDV, SECTION_WIDGET_CLASS).setVariables(false, {$coverable, $coverageCategories, $includeExclude})
  }
  
  function refreshVariables ($coverable :  Coverable, $coverageCategories :  String[], $includeExclude :  boolean) : void {
    __widgetOf(this, pcf.AdditionalExclusionsDV, SECTION_WIDGET_CLASS).setVariables(true, {$coverable, $coverageCategories, $includeExclude})
  }

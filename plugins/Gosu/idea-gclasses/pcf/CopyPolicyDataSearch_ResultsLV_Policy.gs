...
public class CopyPolicyDataSearch_ResultsLV_Policy extends com.guidewire.pl.web.codegen.SectionBase {
  function onEnter ($searchResults :  gw.api.database.IQueryBeanResult<PolicyPeriodSummary>, $destPeriod :  PolicyPeriod) : void {
    __widgetOf(this, pcf.CopyPolicyDataSearch_ResultsLV_Policy, SECTION_WIDGET_CLASS).setVariables(false, {$searchResults, $destPeriod})
  }
  ...
  function refreshVariables ($searchResults :  gw.api.database.IQueryBeanResult<PolicyPeriodSummary>, $destPeriod :  PolicyPeriod) : void {
    __widgetOf(this, pcf.CopyPolicyDataSearch_ResultsLV_Policy, SECTION_WIDGET_CLASS).setVariables(true, {$searchResults, $destPeriod})
  }

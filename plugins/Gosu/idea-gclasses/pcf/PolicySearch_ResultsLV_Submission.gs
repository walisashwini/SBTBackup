...
public class PolicySearch_ResultsLV_Submission extends com.guidewire.pl.web.codegen.SectionBase {
  function onEnter ($searchResults :  gw.api.database.IQueryBeanResult<PolicyPeriodSummary>) : void {
    __widgetOf(this, pcf.PolicySearch_ResultsLV_Submission, SECTION_WIDGET_CLASS).setVariables(false, {$searchResults})
  }
  
  function refreshVariables ($searchResults :  gw.api.database.IQueryBeanResult<PolicyPeriodSummary>) : void {
    __widgetOf(this, pcf.PolicySearch_ResultsLV_Submission, SECTION_WIDGET_CLASS).setVariables(true, {$searchResults})
  }

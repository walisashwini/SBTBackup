...
public class ScheduledItemColumnInput_ForeignKey extends com.guidewire.pl.web.codegen.SectionBase {
  function onEnter ($schedulePropertyInfo :  gw.api.productmodel.SchedulePropertyInfo, $scheduledItem :  ScheduledItem) : void {
    __widgetOf(this, pcf.ScheduledItemColumnInput_ForeignKey, SECTION_WIDGET_CLASS).setVariables(false, {$schedulePropertyInfo, $scheduledItem})
  }
  
  function refreshVariables ($schedulePropertyInfo :  gw.api.productmodel.SchedulePropertyInfo, $scheduledItem :  ScheduledItem) : void {
    __widgetOf(this, pcf.ScheduledItemColumnInput_ForeignKey, SECTION_WIDGET_CLASS).setVariables(true, {$schedulePropertyInfo, $scheduledItem})
  }

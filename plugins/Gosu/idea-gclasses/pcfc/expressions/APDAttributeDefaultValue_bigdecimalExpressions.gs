...
class APDAttributeDefaultValue_bigdecimalExpressions {
  ...
  public static class APDAttributeDefaultValueExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on TextCell (id=value_Cell) at APDAttributeDefaultValue.bigdecimal.pcf: line 29, column 41
    ...
    // 'initialValue' attribute on Variable at APDAttributeDefaultValue.bigdecimal.pcf: line 23, column 32
    function initialValue_0 () : APDAttributeRule {
      return attribute.Rules?.firstWhere(\r -> r.RuleType == ruleType)
    }
    
    // 'value' attribute on TextCell (id=value_Cell) at APDAttributeDefaultValue.bigdecimal.pcf: line 29, column 41

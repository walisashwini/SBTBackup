...
class APDAttributeDefaultValue_booleanExpressions {
  @javax.annotation.Generated("config/web/pcf/tools/apd/APDAttributeDefaultValue.boolean.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class APDAttributeDefaultValueExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on BooleanRadioCell (id=value_Cell) at APDAttributeDefaultValue.boolean.pcf: line 28, column 58
    ...
    // 'initialValue' attribute on Variable at APDAttributeDefaultValue.boolean.pcf: line 23, column 32
    function initialValue_0 () : APDAttributeRule {
      return attribute.Rules?.firstWhere(\r -> r.RuleType == ruleType)
    }
    
    // 'value' attribute on BooleanRadioCell (id=value_Cell) at APDAttributeDefaultValue.boolean.pcf: line 28, column 58
    function value_4 () : java.lang.Boolean {
      return UIValue
    }
    
    // 'valueVisible' attribute on BooleanRadioCell (id=value_Cell) at APDAttributeDefaultValue.boolean.pcf: line 28, column 58

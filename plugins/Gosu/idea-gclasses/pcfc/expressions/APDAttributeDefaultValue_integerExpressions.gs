...
class APDAttributeDefaultValue_integerExpressions {
  @javax.annotation.Generated("config/web/pcf/tools/apd/APDAttributeDefaultValue.integer.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class APDAttributeDefaultValueExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on TextCell (id=value_Cell) at APDAttributeDefaultValue.integer.pcf: line 29, column 28
    ...
    // 'initialValue' attribute on Variable at APDAttributeDefaultValue.integer.pcf: line 23, column 32
    function initialValue_0 () : APDAttributeRule {
      return attribute.Rules?.firstWhere(\r -> r.RuleType == ruleType)
    }
    
    // 'value' attribute on TextCell (id=value_Cell) at APDAttributeDefaultValue.integer.pcf: line 29, column 28
    function value_3 () : Integer {
      return UIValue
    }

...
class AccountContactDisplayCell_NamedInsuredExpressions {
  @javax.annotation.Generated("config/web/pcf/account/AccountContactDisplayCell.NamedInsured.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class AccountContactDisplayCellExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on Link (id=editContactRole) at AccountContactDisplayCell.NamedInsured.pcf: line 19, column 36
    ...
    // 'value' attribute on TextInput (id=IndustryCode_Input) at AccountContactDisplayCell.NamedInsured.pcf: line 25, column 59
    ...
    function value_4 () : java.lang.String {
      return (acctContactRole as NamedInsured).IndustryCode.Code
    }
    
    // 'visible' attribute on ContentInput at AccountContactDisplayCell.NamedInsured.pcf: line 14, column 46
    function visible_2 () : java.lang.Boolean {
      return CurrentLocation.InEditMode
    }
    
    // 'visible' attribute on TextInput (id=IndustryCode_Input) at AccountContactDisplayCell.NamedInsured.pcf: line 25, column 59

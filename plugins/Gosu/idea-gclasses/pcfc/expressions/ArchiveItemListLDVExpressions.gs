...
class ArchiveItemListLDVExpressions {
  ...
  public static class ArchiveItemListLDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=FailureDetails_Input) at ArchiveItemListLDV.pcf: line 69, column 94
    ...
    // 'value' attribute on TextInput (id=TraceDetails_Input) at ArchiveItemListLDV.pcf: line 82, column 137
    ...
    // 'visible' attribute on ButtonCell (id=Reset_Cell) at ArchiveItemListLDV.pcf: line 49, column 52
  ...
  public static class IteratorEntryExpressionsImpl extends ArchiveItemListLDVExpressionsImpl {
    ...
    // 'action' attribute on TextCell (id=Item_Cell) at ArchiveItemListLDV.pcf: line 43, column 145
    function action_4 () : void {
      gw.api.web.tools.ArchiveInfoPage.goToPage(rootInfoElem as RootInfo)
    }
    
    // 'action' attribute on ButtonCell (id=Reset_Cell) at ArchiveItemListLDV.pcf: line 49, column 52
    ...
    // 'action' attribute on ButtonCell (id=DebugItem_Cell) at ArchiveItemListLDV.pcf: line 55, column 52
    ...
    // 'value' attribute on TextCell (id=Item_Cell) at ArchiveItemListLDV.pcf: line 43, column 145

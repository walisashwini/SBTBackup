...
class BALineScreenExpressions {
  @javax.annotation.Generated("config/web/pcf/line/ba/policy/BALineScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class BALineScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at BALineScreen.pcf: line 32, column 58
    function def_onEnter_21 (def :  pcf.OOSEPanelSet) : void {
      def.onEnter(policyPeriod, jobWizardHelper)
    }
    
    // 'def' attribute on PanelRef at BALineScreen.pcf: line 34, column 50
    function def_onEnter_23 (def :  pcf.BALinePanelSet) : void {
    ...
    // 'def' attribute on PanelRef at BALineScreen.pcf: line 34, column 50
    function def_refreshVariables_24 (def :  pcf.BALinePanelSet) : void {
      def.refreshVariables(baLine, openForEdit)
    }
    
    // 'editable' attribute on Screen (id=BALineScreen) at BALineScreen.pcf: line 7, column 23
    function editable_25 () : java.lang.Boolean {
      return openForEdit
    }
    
    // 'initialValue' attribute on Variable at BALineScreen.pcf: line 20, column 32
    function initialValue_0 () : BusinessAutoLine {
      return policyPeriod.BusinessAutoLine
    }
    
    // 'mode' attribute on ToolbarButtonSetRef at BALineScreen.pcf: line 25, column 104
    function mode_1 () : java.lang.Object {
      return policyPeriod.Job.Subtype
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at BALineScreen.pcf: line 25, column 104
    ...
    // 'visible' attribute on AlertBar (id=QuoteRequestedAlert) at BALineScreen.pcf: line 30, column 80

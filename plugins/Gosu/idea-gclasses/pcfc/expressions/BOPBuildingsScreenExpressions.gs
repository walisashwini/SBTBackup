...
class BOPBuildingsScreenExpressions {
  @javax.annotation.Generated("config/web/pcf/line/bop/policy/BOPBuildingsScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class BOPBuildingsScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at BOPBuildingsScreen.pcf: line 28, column 58
    function def_onEnter_20 (def :  pcf.OOSEPanelSet) : void {
      def.onEnter(policyPeriod, jobWizardHelper)
    }
    
    // 'def' attribute on PanelRef at BOPBuildingsScreen.pcf: line 30, column 73
    function def_onEnter_22 (def :  pcf.BOPBuildingsCV) : void {
    ...
    // 'def' attribute on PanelRef at BOPBuildingsScreen.pcf: line 30, column 73
    function def_refreshVariables_23 (def :  pcf.BOPBuildingsCV) : void {
      def.refreshVariables(policyPeriod, openForEdit, jobWizardHelper)
    }
    
    // 'editable' attribute on Screen (id=BOPBuildingsScreen) at BOPBuildingsScreen.pcf: line 7, column 29
    function editable_24 () : java.lang.Boolean {
      return openForEdit
    }
    
    // 'mode' attribute on ToolbarButtonSetRef at BOPBuildingsScreen.pcf: line 21, column 104
    function mode_0 () : java.lang.Object {
      return policyPeriod.Job.Subtype
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at BOPBuildingsScreen.pcf: line 21, column 104
    ...
    // 'visible' attribute on AlertBar (id=QuoteRequestedAlert) at BOPBuildingsScreen.pcf: line 26, column 80

...
class BatchProcessDownloadConfigureExpressions {
  ...
  public static class BatchProcessDownloadConfigureScreenExpressionsImpl extends BatchProcessDownloadConfigureExpressionsImpl {
    ...
    // 'action' attribute on ButtonInput (id=BackButton_Input) at BatchProcessDownloadConfigure.pcf: line 51, column 118
    function action_10 () : void {
      BatchProcessInfo.go()
    }
    
    // 'action' attribute on ButtonInput (id=download_Input) at BatchProcessDownloadConfigure.pcf: line 47, column 75
    ...
    // 'value' attribute on DateInput (id=StartDate_Input) at BatchProcessDownloadConfigure.pcf: line 34, column 48
    function defaultSetter_2 (__VALUE_TO_SET :  java.lang.Object) : void {
      BatchInfoHelper.StartDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on DateInput (id=StopDate_Input) at BatchProcessDownloadConfigure.pcf: line 42, column 46

...
class BulkEditDocumentDetailsPopupExpressions {
  ...
  public static class BulkEditDocumentDetailsPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at BulkEditDocumentDetailsPopup.pcf: line 25, column 80
    ...
    // 'value' attribute on TextCell (id=documentName_Cell) at BulkEditDocumentDetailsPopup.pcf: line 45, column 43
    function sortValue_3 (documentName :  String) : java.lang.Object {
      return documentName
    }
    
    // 'value' attribute on RowIterator at BulkEditDocumentDetailsPopup.pcf: line 40, column 38
    function value_6 () : String[] {
      return documentDetailsHelper.DocumentNames
    }
    
    // 'visible' attribute on PanelColumn at BulkEditDocumentDetailsPopup.pcf: line 28, column 61

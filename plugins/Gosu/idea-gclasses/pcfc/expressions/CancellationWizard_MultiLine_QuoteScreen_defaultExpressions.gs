...
class CancellationWizard_MultiLine_QuoteScreen_defaultExpressions {
  @javax.annotation.Generated("config/web/pcf/job/cancellation/CancellationWizard_MultiLine_QuoteScreen.default.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class CancellationWizard_MultiLine_QuoteScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=CreateCancellationQuote) at CancellationWizard_MultiLine_QuoteScreen.default.pcf: line 32, column 23
    ...
    // 'def' attribute on PanelRef at CancellationWizard_MultiLine_QuoteScreen.default.pcf: line 36, column 35
    ...
    // 'initialValue' attribute on Variable at CancellationWizard_MultiLine_QuoteScreen.default.pcf: line 21, column 28
    function initialValue_0 () : PolicyPeriod {
      return cancellation.PolicyPeriod
    }
    
    // 'mode' attribute on ToolbarButtonSetRef at CancellationWizard_MultiLine_QuoteScreen.default.pcf: line 26, column 100
    function mode_1 () : java.lang.Object {
      return policyPeriod.Job.Subtype
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at CancellationWizard_MultiLine_QuoteScreen.default.pcf: line 26, column 100

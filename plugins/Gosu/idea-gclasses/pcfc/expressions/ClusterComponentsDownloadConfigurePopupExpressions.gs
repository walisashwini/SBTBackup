...
class ClusterComponentsDownloadConfigurePopupExpressions {
  ...
  public static class ClusterComponentsDownloadConfigurePopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ButtonInput (id=download_Input) at ClusterComponentsDownloadConfigurePopup.pcf: line 33, column 75
    function action_5 () : void {
      gw.api.tools.ClusterComponentsData.downloadReport(maxDaysInHistory * 24)
    }
    
    // 'value' attribute on TextInput (id=maxDays_Input) at ClusterComponentsDownloadConfigurePopup.pcf: line 25, column 40
    ...
    // 'requestValidationExpression' attribute on TextInput (id=maxDays_Input) at ClusterComponentsDownloadConfigurePopup.pcf: line 25, column 40
    function requestValidationExpression_1 (VALUE :  java.lang.Long) : java.lang.Object {
      return VALUE >= 0 ? null : DisplayKey.get("Validator.PositiveInteger", VALUE)
    }
    
    // 'value' attribute on TextInput (id=maxDays_Input) at ClusterComponentsDownloadConfigurePopup.pcf: line 25, column 40
    function value_2 () : java.lang.Long {

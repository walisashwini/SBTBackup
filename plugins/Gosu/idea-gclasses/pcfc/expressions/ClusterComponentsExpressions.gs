...
class ClusterComponentsExpressions {
  ...
  public static class ClusterComponentsExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on ToolbarRangeInput (id=TypeFilter_Input) at ClusterComponents.pcf: line 27, column 59
    ...
    // 'optionLabel' attribute on ToolbarRangeInput (id=TypeFilter_Input) at ClusterComponents.pcf: line 27, column 59
    function optionLabel_6 (VALUE :  gw.api.system.cluster.ComponentType) : java.lang.String {
    ...
    // 'valueRange' attribute on ToolbarRangeInput (id=TypeFilter_Input) at ClusterComponents.pcf: line 27, column 59
    ...
    // 'valueRange' attribute on ToolbarRangeInput (id=TypeFilter_Input) at ClusterComponents.pcf: line 27, column 59
    function verifyValueRangeIsAllowedType_8 ($$arg :  gw.api.system.cluster.ComponentType[]) : void {

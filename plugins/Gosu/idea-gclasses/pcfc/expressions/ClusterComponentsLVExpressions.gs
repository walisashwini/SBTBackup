...
class ClusterComponentsLVExpressions {
  ...
  public static class ClusterComponentsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=Type_Cell) at ClusterComponentsLV.pcf: line 30, column 47
    function sortValue_0 (component :  gw.api.system.cluster.ComponentInfo) : java.lang.Object {
      return component.Type.DisplayName
    }
    
    // 'value' attribute on TextCell (id=Name_Cell) at ClusterComponentsLV.pcf: line 36, column 53
    function sortValue_1 (component :  gw.api.system.cluster.ComponentInfo) : java.lang.Object {
      return component.Name ?: component.Code
    }
    
    // 'value' attribute on TextCell (id=TransferTarget_Cell) at ClusterComponentsLV.pcf: line 94, column 45
    function sortValue_10 (component :  gw.api.system.cluster.ComponentInfo) : java.lang.Object {
      return component.TransferTarget
    }
    
    // 'value' attribute on DateCell (id=RetryFailover_Cell) at ClusterComponentsLV.pcf: line 100, column 44
    function sortValue_11 (component :  gw.api.system.cluster.ComponentInfo) : java.lang.Object {
      return component.RetryFailover
    }
    
    // 'value' attribute on TextCell (id=State_Cell) at ClusterComponentsLV.pcf: line 40, column 62
  ...
  public static class IteratorEntryExpressionsImpl extends ClusterComponentsLVExpressionsImpl {
    ...
    // 'action' attribute on TextCell (id=Name_Cell) at ClusterComponentsLV.pcf: line 36, column 53
    function action_16 () : void {
      ClusterComponentHistoryPopup.push(data, component)
    }
    
    // 'action' attribute on Link (id=CompleteFailedFailover) at ClusterComponentsLV.pcf: line 77, column 112
    ...
    // 'available' attribute on TextCell (id=Name_Cell) at ClusterComponentsLV.pcf: line 36, column 53
    ...
    // 'visible' attribute on Link (id=CompleteFailedFailover) at ClusterComponentsLV.pcf: line 77, column 112

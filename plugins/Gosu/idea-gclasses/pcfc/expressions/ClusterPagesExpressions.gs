...
class ClusterPagesExpressions {
  ...
  public static class ClusterPagesExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'location' attribute on LocationGroup (id=ClusterPages) at ClusterPages.pcf: line 12, column 36
    function action_0 () : void {
      pcf.ClusterMembers.go()
    }
    
    // 'location' attribute on LocationGroup (id=ClusterPages) at ClusterPages.pcf: line 14, column 39
    ...
    // 'canVisit' attribute on LocationGroup (id=ClusterPages) at ClusterPages.pcf: line 9, column 81
    static function canVisit_4 () : java.lang.Boolean {
      return perm.User.ViewCluster or perm.User.DevAllAccess
    }
    
    // LocationGroup (id=ClusterPages) at ClusterPages.pcf: line 9, column 81
    ...
    // 'tabBar' attribute on LocationGroup (id=ClusterPages) at ClusterPages.pcf: line 9, column 81

...
class ConsistencyChecksLVExpressions {
  ...
  public static class ConsistencyChecksLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=table_Cell) at ConsistencyChecksLV.pcf: line 29, column 32
    ...
    // 'value' attribute on TextCell (id=Cell0_Cell) at ConsistencyChecksLV.pcf: line 33, column 70
  ...
  public static class IteratorEntryExpressionsImpl extends ConsistencyChecksLVExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=consistencyCheckDescription_Cell) at ConsistencyChecksLV.pcf: line 40, column 24

...
class CopyPolicyDataSearch_ResultsLV_RewriteExpressions {
  @javax.annotation.Generated("config/web/pcf/job/common/copydata/CopyPolicyDataSearch_ResultsLV.Rewrite.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class CopyPolicyDataSearch_ResultsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'sortBy' attribute on TextCell (id=PolicyNumber_Cell) at CopyPolicyDataSearch_ResultsLV.Rewrite.pcf: line 32, column 66
    ...
    // 'value' attribute on TextCell (id=WorkOrderNumber_Cell) at CopyPolicyDataSearch_ResultsLV.Rewrite.pcf: line 37, column 54
    ...
    // 'value' attribute on TextCell (id=Version_Cell) at CopyPolicyDataSearch_ResultsLV.Rewrite.pcf: line 41, column 51
    ...
    // 'value' attribute on TextCell (id=PrimaryNamedInsured_Cell) at CopyPolicyDataSearch_ResultsLV.Rewrite.pcf: line 45, column 59
    ...
    // 'value' attribute on TextCell (id=AccountNumber_Cell) at CopyPolicyDataSearch_ResultsLV.Rewrite.pcf: line 50, column 54
    ...
    // 'value' attribute on DateCell (id=CreationDate_Cell) at CopyPolicyDataSearch_ResultsLV.Rewrite.pcf: line 60, column 55
    ...
    // 'value' attribute on DateCell (id=EffectiveDate_Cell) at CopyPolicyDataSearch_ResultsLV.Rewrite.pcf: line 64, column 58
    ...
    // 'value' attribute on RowIterator at CopyPolicyDataSearch_ResultsLV.Rewrite.pcf: line 20, column 86
  ...
  public static class IteratorEntryExpressionsImpl extends CopyPolicyDataSearch_ResultsLVExpressionsImpl {
    ...
    // 'action' attribute on TextCell (id=WorkOrderNumber_Cell) at CopyPolicyDataSearch_ResultsLV.Rewrite.pcf: line 37, column 54
    function action_14 () : void {
      JobForward.go(policyPeriodSummary.Job)
    }
    
    // 'action' attribute on ButtonCell (id=SelectButtonCell_Cell) at CopyPolicyDataSearch_ResultsLV.Rewrite.pcf: line 27, column 99
    ...
    // 'available' attribute on TextCell (id=AccountNumber_Cell) at CopyPolicyDataSearch_ResultsLV.Rewrite.pcf: line 50, column 54
    function available_25 () : java.lang.Boolean {
      return perm.System.viewaccount
    }
    
    // 'available' attribute on ButtonCell (id=SelectButtonCell_Cell) at CopyPolicyDataSearch_ResultsLV.Rewrite.pcf: line 27, column 99
    function available_7 () : java.lang.Boolean {
      return !policyPeriodSummary.TermArchived
    }
    
    // 'useArchivedStyle' attribute on Row at CopyPolicyDataSearch_ResultsLV.Rewrite.pcf: line 22, column 61
    function useArchivedStyle_39 () : java.lang.Boolean {
      return policyPeriodSummary.TermArchived
    }
    
    // 'value' attribute on TextCell (id=PolicyNumber_Cell) at CopyPolicyDataSearch_ResultsLV.Rewrite.pcf: line 32, column 66
    ...
    // 'value' attribute on TypeKeyCell (id=PolicyPeriodStatus_Cell) at CopyPolicyDataSearch_ResultsLV.Rewrite.pcf: line 56, column 51

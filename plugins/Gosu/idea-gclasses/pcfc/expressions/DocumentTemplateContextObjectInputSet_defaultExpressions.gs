...
class DocumentTemplateContextObjectInputSet_defaultExpressions {
  ...
  public static class DocumentTemplateContextObjectInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RangeInput (id=DynamicInput_Input) at DocumentTemplateContextObjectInputSet.default.pcf: line 28, column 22
    function defaultSetter_4 (__VALUE_TO_SET :  java.lang.Object) : void {
      ContextObjectValue = __VALUE_TO_SET
    }
    
    // 'label' attribute on RangeInput (id=DynamicInput_Input) at DocumentTemplateContextObjectInputSet.default.pcf: line 28, column 22
    function label_1 () : java.lang.Object {
      return dynamicWidgetInfo.DisplayName
    }
    
    // 'onChange' attribute on PostOnChange at DocumentTemplateContextObjectInputSet.default.pcf: line 31, column 168
    ...
    // 'optionLabel' attribute on RangeInput (id=DynamicInput_Input) at DocumentTemplateContextObjectInputSet.default.pcf: line 28, column 22
    function optionLabel_5 (VALUE :  java.lang.Object) : java.lang.String {
    ...
    // 'required' attribute on RangeInput (id=DynamicInput_Input) at DocumentTemplateContextObjectInputSet.default.pcf: line 28, column 22
    function required_2 () : java.lang.Boolean {
      return !dynamicWidgetInfo.ShowNoneSelected
    }
    
    // 'valueRange' attribute on RangeInput (id=DynamicInput_Input) at DocumentTemplateContextObjectInputSet.default.pcf: line 28, column 22

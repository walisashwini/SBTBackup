...
class DocumentTemplateContextObjectInputSet_stringExpressions {
  ...
  public static class DocumentTemplateContextObjectInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=DynamicInput_Input) at DocumentTemplateContextObjectInputSet.string.pcf: line 26, column 22
    function defaultSetter_4 (__VALUE_TO_SET :  java.lang.Object) : void {
      ContextObjectValue = __VALUE_TO_SET
    }
    
    // 'label' attribute on TextInput (id=DynamicInput_Input) at DocumentTemplateContextObjectInputSet.string.pcf: line 26, column 22
    function label_1 () : java.lang.Object {
      return dynamicWidgetInfo.DisplayName
    }
    
    // 'onChange' attribute on PostOnChange at DocumentTemplateContextObjectInputSet.string.pcf: line 29, column 168
    ...
    // 'required' attribute on TextInput (id=DynamicInput_Input) at DocumentTemplateContextObjectInputSet.string.pcf: line 26, column 22

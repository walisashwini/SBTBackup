...
class DocumentTemplateContextObjectInputSet_textExpressions {
  @javax.annotation.Generated("config/web/pcf/document/DocumentTemplateContextObjectInputSet.text.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class DocumentTemplateContextObjectInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextAreaInput (id=DynamicInput_Input) at DocumentTemplateContextObjectInputSet.text.pcf: line 26, column 22
    function defaultSetter_4 (__VALUE_TO_SET :  java.lang.Object) : void {
      ContextObjectValue = __VALUE_TO_SET
    }
    
    // 'label' attribute on TextAreaInput (id=DynamicInput_Input) at DocumentTemplateContextObjectInputSet.text.pcf: line 26, column 22
    function label_1 () : java.lang.Object {
      return dynamicWidgetInfo.DisplayName
    }
    
    // 'onChange' attribute on PostOnChange at DocumentTemplateContextObjectInputSet.text.pcf: line 29, column 168
    ...
    // 'required' attribute on TextAreaInput (id=DynamicInput_Input) at DocumentTemplateContextObjectInputSet.text.pcf: line 26, column 22

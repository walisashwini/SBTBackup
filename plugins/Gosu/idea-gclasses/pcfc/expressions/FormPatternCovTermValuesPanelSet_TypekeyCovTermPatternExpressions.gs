...
class FormPatternCovTermValuesPanelSet_TypekeyCovTermPatternExpressions {
  @javax.annotation.Generated("config/web/pcf/admin/forms/FormPatternCovTermValuesPanelSet.TypekeyCovTermPattern.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class FormPatternCovTermValuesPanelSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'available' attribute on ToolbarButton (id=AddFormPatternCovTermValue) at FormPatternCovTermValuesPanelSet.TypekeyCovTermPattern.pcf: line 23, column 67
    function available_3 () : java.lang.Boolean {
      return formPatternCovTerm.AvailableTypekeyCovTermValues.Count > 0
    }
    
    // 'value' attribute on TextCell (id=Description_Cell) at FormPatternCovTermValuesPanelSet.TypekeyCovTermPattern.pcf: line 61, column 64
    ...
    // 'value' attribute on TextCell (id=Code_Cell) at FormPatternCovTermValuesPanelSet.TypekeyCovTermPattern.pcf: line 65, column 57
    ...
    // 'toRemove' attribute on RowIterator at FormPatternCovTermValuesPanelSet.TypekeyCovTermPattern.pcf: line 54, column 60
    ...
    // 'value' attribute on RowIterator at FormPatternCovTermValuesPanelSet.TypekeyCovTermPattern.pcf: line 54, column 60
    function value_13 () : entity.FormPatternCovTermValue[] {
      return formPatternCovTerm.SelectedCovTermValues
    }
    
    // 'value' attribute on MenuItemIterator (id=formPatternCovTermValues) at FormPatternCovTermValuesPanelSet.TypekeyCovTermPattern.pcf: line 28, column 69
    function value_2 () : java.util.List<gw.entity.TypeKey> {
      return formPatternCovTerm.AvailableTypekeyCovTermValues
    }
  ...
  public static class IteratorEntryExpressionsImpl extends FormPatternCovTermValuesPanelSetExpressionsImpl {
    ...
    // 'action' attribute on MenuItem (id=CovTermPatternValueItem) at FormPatternCovTermValuesPanelSet.TypekeyCovTermPattern.pcf: line 32, column 64
    function action_0 () : void {
      formPatternCovTerm.addTypekeyCovTermValue(formPatternCovTermValue)
    }
    
    // 'label' attribute on MenuItem (id=CovTermPatternValueItem) at FormPatternCovTermValuesPanelSet.TypekeyCovTermPattern.pcf: line 32, column 64
    function label_1 () : java.lang.Object {
      return formPatternCovTermValue.DisplayName
    }
    
    property get formPatternCovTermValue () : gw.entity.TypeKey {

...
@javax.annotation.Generated("config/web/pcf/line/gl7/policy/GL7ExposuresScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class GL7ExposuresScreenExpressions {
  @javax.annotation.Generated("config/web/pcf/line/gl7/policy/GL7ExposuresScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class GL7ExposuresScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at GL7ExposuresScreen.pcf: line 25, column 60
    function def_onEnter_19 (def :  pcf.OOSEPanelSet) : void {
      def.onEnter(policyPeriod, jobWizardHelper)
    }
    
    // 'def' attribute on PanelRef at GL7ExposuresScreen.pcf: line 27, column 81
    function def_onEnter_21 (def :  pcf.GL7ExposuresPanelSet) : void {
    ...
    // 'def' attribute on PanelRef at GL7ExposuresScreen.pcf: line 27, column 81
    function def_refreshVariables_22 (def :  pcf.GL7ExposuresPanelSet) : void {
      def.refreshVariables(policyPeriod, openForEdit, jobWizardHelper)
    }
    
    // 'editable' attribute on Screen (id=GL7ExposuresScreen) at GL7ExposuresScreen.pcf: line 7, column 29
    function editable_23 () : java.lang.Boolean {
      return openForEdit
    }
    
    // 'mode' attribute on ToolbarButtonSetRef at GL7ExposuresScreen.pcf: line 21, column 104
    function mode_0 () : java.lang.Object {
      return policyPeriod.Job.Subtype
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at GL7ExposuresScreen.pcf: line 21, column 104

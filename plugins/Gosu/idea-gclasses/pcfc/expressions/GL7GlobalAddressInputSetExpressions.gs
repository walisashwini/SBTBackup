...
class GL7GlobalAddressInputSetExpressions {
  @javax.annotation.Generated("config/web/pcf/line/gl7/policy/GL7GlobalAddressInputSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class GL7GlobalAddressInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on AddressAutoFillInput (id=PostalCode_Input) at GL7GlobalAddressInputSet.pcf: line 134, column 87
    ...
    // 'action' attribute on AddressAutoFillInput (id=City_Input) at GL7GlobalAddressInputSet.pcf: line 87, column 81
    ...
    function autoComplete_141 () : gw.api.contact.AutocompleteHandler {
      return pchandler
    }
    ...
    // 'autoComplete' attribute on AddressAutoFillInput (id=County_Input) at AddressAutoFillWidget.xml: line 7, column 71
    function autoComplete_95 () : gw.api.contact.AutocompleteHandler {
      return countyhandler
    }
    
    // 'available' attribute on TypeKeyInput (id=Country_Input) at GL7GlobalAddressInputSet.pcf: line 47, column 84
    function available_10 () : java.lang.Boolean {
      return addressOwner.isAvailable(gw.api.address.AddressOwnerFieldId.COUNTRY)
    }
    
    // 'available' attribute on RangeInput (id=State_Input) at GL7GlobalAddressInputSet.pcf: line 115, column 82
    function available_109 () : java.lang.Boolean {
      return addressOwner.isAvailable(gw.api.address.AddressOwnerFieldId.STATE)
    }
    
    // 'available' attribute on AddressAutoFillInput (id=PostalCode_Input) at GL7GlobalAddressInputSet.pcf: line 134, column 87
    function available_143 () : java.lang.Boolean {
      return addressOwner.isAvailable(gw.api.address.AddressOwnerFieldId.POSTALCODE)
    }
    
    // 'available' attribute on TextInput (id=AddressLine1_Input) at GL7GlobalAddressInputSet.pcf: line 57, column 90
    function available_21 () : java.lang.Boolean {
      return addressOwner.isAvailable(gw.api.address.AddressOwnerFieldId.ADDRESSLINE1)
    }
    
    // 'available' attribute on TextInput (id=AddressLine2_Input) at GL7GlobalAddressInputSet.pcf: line 65, column 90
    function available_34 () : java.lang.Boolean {
      return addressOwner.isAvailable(gw.api.address.AddressOwnerFieldId.ADDRESSLINE2)
    }
    
    // 'available' attribute on TextInput (id=AddressLine3_Input) at GL7GlobalAddressInputSet.pcf: line 73, column 90
    function available_45 () : java.lang.Boolean {
      return addressOwner.isAvailable(gw.api.address.AddressOwnerFieldId.ADDRESSLINE3)
    }
    
    // 'available' attribute on AddressAutoFillInput (id=City_Input) at GL7GlobalAddressInputSet.pcf: line 87, column 81
    function available_70 () : java.lang.Boolean {
      return addressOwner.isAvailable(gw.api.address.AddressOwnerFieldId.CITY)
    }
    
    // 'available' attribute on AddressAutoFillInput (id=County_Input) at GL7GlobalAddressInputSet.pcf: line 101, column 83
    function available_96 () : java.lang.Boolean {
      return addressOwner.isAvailable(gw.api.address.AddressOwnerFieldId.COUNTY)
    }
    
    // 'value' attribute on RangeInput (id=State_Input) at GL7GlobalAddressInputSet.pcf: line 115, column 82
    ...
    // 'value' attribute on TypeKeyInput (id=Country_Input) at GL7GlobalAddressInputSet.pcf: line 47, column 84
    function defaultSetter_15 (__VALUE_TO_SET :  java.lang.Object) : void {
      addressOwner.SelectedCountry = (__VALUE_TO_SET as typekey.Country)
    }
    
    // 'value' attribute on TextInput (id=AddressLine1_Input) at GL7GlobalAddressInputSet.pcf: line 57, column 90
    function defaultSetter_27 (__VALUE_TO_SET :  java.lang.Object) : void {
      addressOwner.AddressDelegate.AddressLine1 = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextInput (id=AddressLine2_Input) at GL7GlobalAddressInputSet.pcf: line 65, column 90
    function defaultSetter_39 (__VALUE_TO_SET :  java.lang.Object) : void {
      addressOwner.AddressDelegate.AddressLine2 = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextInput (id=AddressLine3_Input) at GL7GlobalAddressInputSet.pcf: line 73, column 90
    ...
    // 'value' attribute on AddressAutoFillInput (id=County_Input) at AddressAutoFillWidget.xml: line 7, column 71
    ...
    // 'editable' attribute on TypeKeyInput (id=Country_Input) at GL7GlobalAddressInputSet.pcf: line 47, column 84
    function editable_11 () : java.lang.Boolean {
      return addressOwner.isEditable(gw.api.address.AddressOwnerFieldId.COUNTRY)
    }
    
    // 'editable' attribute on RangeInput (id=State_Input) at GL7GlobalAddressInputSet.pcf: line 115, column 82
    ...
    // 'editable' attribute on TextInput (id=AddressLine1_Input) at GL7GlobalAddressInputSet.pcf: line 57, column 90
    function editable_22 () : java.lang.Boolean {
      return addressOwner.isEditable(gw.api.address.AddressOwnerFieldId.ADDRESSLINE1)
    }
    
    // 'editable' attribute on TextInput (id=AddressLine2_Input) at GL7GlobalAddressInputSet.pcf: line 65, column 90
    function editable_35 () : java.lang.Boolean {
      return addressOwner.isEditable(gw.api.address.AddressOwnerFieldId.ADDRESSLINE2)
    }
    
    // 'editable' attribute on TextInput (id=AddressLine3_Input) at GL7GlobalAddressInputSet.pcf: line 73, column 90
    ...
    // 'editable' attribute on AddressAutoFillInput (id=County_Input) at AddressAutoFillWidget.xml: line 7, column 71
    function editable_88 () : java.lang.Boolean {
      return addressOwner.isEditable(gw.api.address.AddressOwnerFieldId.COUNTY)
    }
    
    // 'initialValue' attribute on Variable at GL7GlobalAddressInputSet.pcf: line 16, column 50
    ...
    // 'initialValue' attribute on Variable at GL7GlobalAddressInputSet.pcf: line 20, column 50
    ...
    // 'initialValue' attribute on Variable at GL7GlobalAddressInputSet.pcf: line 24, column 50
    ...
    // 'initialValue' attribute on Variable at GL7GlobalAddressInputSet.pcf: line 31, column 33
    ...
    function inputConversion_136 (VALUE :  java.lang.String) : java.lang.Object {
    ...
    function inputMask_142 () : java.lang.String {
      return gw.api.contact.AddressAutocompleteUtil.getInputMask(addressOwner.AddressDelegate, "PostalCode")
    }
    
    // 'label' attribute on RangeInput (id=State_Input) at GL7GlobalAddressInputSet.pcf: line 115, column 82
    ...
    // 'label' attribute on TextInput (id=AddressLine1_Input) at GL7GlobalAddressInputSet.pcf: line 57, column 90
    function label_24 () : java.lang.Object {
      return addressOwner.AddressLine1Label
    }
    
    // 'label' attribute on TextInput (id=AddressSummary_Input) at GL7GlobalAddressInputSet.pcf: line 36, column 50
    ...
    // 'onChange' attribute on PostOnChange at GL7GlobalAddressInputSet.pcf: line 117, column 241
    function onChange_108 () : void {
      presenter.resetLocations(); gw.api.web.PebblesUtil.invalidateIterators(CurrentLocation, gw.lob.gl7.presenters.GL7LocationPresenter.SublineChoice); gw.api.web.PebblesUtil.invalidateIterators(CurrentLocation, GL7Location)
    }
    
    // 'onChange' attribute on AddressAutoFillInput (id=PostalCode_Input) at GL7GlobalAddressInputSet.pcf: line 136, column 196
    function onChange_130 () : void {
      if (addressOwner.AutofillEnabled) gw.api.contact.AddressAutocompleteUtil.autofillAddress(addressOwner.AddressDelegate, "PostalCode", false); presenter.syncZipCode()
    }
    
    // 'onChange' attribute on AddressAutoFillInput (id=City_Input) at GL7GlobalAddressInputSet.pcf: line 89, column 165
    ...
    // 'onChange' attribute on AddressAutoFillInput (id=County_Input) at GL7GlobalAddressInputSet.pcf: line 103, column 191
    function onChange_87 () : void {
      if (addressOwner.AutofillEnabled) gw.api.contact.AddressAutocompleteUtil.autofillAddress(addressOwner.AddressDelegate, "County", false); presenter.syncCounty()
    }
    
    // 'required' attribute on RangeInput (id=State_Input) at GL7GlobalAddressInputSet.pcf: line 115, column 82
    function required_114 () : java.lang.Boolean {
      return addressOwner.isRequired(gw.api.address.AddressOwnerFieldId.STATE)
    }
    
    // 'required' attribute on TypeKeyInput (id=Country_Input) at GL7GlobalAddressInputSet.pcf: line 47, column 84
    ...
    // 'required' attribute on TextInput (id=AddressLine1_Input) at GL7GlobalAddressInputSet.pcf: line 57, column 90
    function required_25 () : java.lang.Boolean {
      return addressOwner.isRequired(gw.api.address.AddressOwnerFieldId.ADDRESSLINE1)
    }
    
    // 'required' attribute on TextInput (id=AddressLine2_Input) at GL7GlobalAddressInputSet.pcf: line 65, column 90
    function required_37 () : java.lang.Boolean {
      return addressOwner.isRequired(gw.api.address.AddressOwnerFieldId.ADDRESSLINE2)
    }
    
    // 'required' attribute on TextInput (id=AddressLine3_Input) at GL7GlobalAddressInputSet.pcf: line 73, column 90
    ...
    // 'required' attribute on AddressAutoFillInput (id=County_Input) at AddressAutoFillWidget.xml: line 7, column 71
    function required_91 () : java.lang.Boolean {
      return addressOwner.isRequired(gw.api.address.AddressOwnerFieldId.COUNTY)
    }
    
    // 'tooltip' attribute on AddressAutoFillInput (id=City_Input) at GL7GlobalAddressInputSet.pcf: line 87, column 81
    function tooltip_76 () : java.lang.String {
      return addressOwner.AutofillIconEnabled ? DisplayKey.get("AutoFill.Override") : ""
    }
    
    // 'validationExpression' attribute on RangeInput (id=State_Input) at GL7GlobalAddressInputSet.pcf: line 115, column 82
    function validationExpression_111 () : java.lang.Object {
    ...
    // 'validationExpression' attribute on AddressAutoFillInput (id=County_Input) at AddressAutoFillWidget.xml: line 7, column 71
    ...
    // 'valueRange' attribute on RangeInput (id=State_Input) at GL7GlobalAddressInputSet.pcf: line 115, column 82
    ...
    // 'value' attribute on RangeInput (id=State_Input) at GL7GlobalAddressInputSet.pcf: line 115, column 82
    function value_115 () : typekey.State {
    ...
    // 'value' attribute on TextInput (id=AddressSummary_Input) at GL7GlobalAddressInputSet.pcf: line 36, column 50
    ...
    // 'valueRange' attribute on RangeInput (id=State_Input) at GL7GlobalAddressInputSet.pcf: line 115, column 82
    function verifyValueRangeIsAllowedType_119 ($$arg :  typekey.State[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    ...
    // 'visible' attribute on RangeInput (id=State_Input) at GL7GlobalAddressInputSet.pcf: line 115, column 82
    function visible_112 () : java.lang.Boolean {
      return addressOwner.isVisible(gw.api.address.AddressOwnerFieldId.STATE)
    }
    
    // 'visible' attribute on TypeKeyInput (id=Country_Input) at GL7GlobalAddressInputSet.pcf: line 47, column 84
    ...
    // 'visible' attribute on TextInput (id=AddressLine1_Input) at GL7GlobalAddressInputSet.pcf: line 57, column 90
    function visible_23 () : java.lang.Boolean {
      return addressOwner.isVisible(gw.api.address.AddressOwnerFieldId.ADDRESSLINE1)
    }
    
    // 'visible' attribute on TextInput (id=AddressLine2_Input) at GL7GlobalAddressInputSet.pcf: line 65, column 90
    function visible_36 () : java.lang.Boolean {
      return addressOwner.isVisible(gw.api.address.AddressOwnerFieldId.ADDRESSLINE2)
    }
    
    // 'visible' attribute on TextInput (id=AddressSummary_Input) at GL7GlobalAddressInputSet.pcf: line 36, column 50
    function visible_4 () : java.lang.Boolean {
      return addressOwner.ShowAddressSummary
    }
    
    // 'visible' attribute on TextInput (id=AddressLine3_Input) at GL7GlobalAddressInputSet.pcf: line 73, column 90
    ...
    // 'visible' attribute on AddressAutoFillInput (id=County_Input) at AddressAutoFillWidget.xml: line 7, column 71

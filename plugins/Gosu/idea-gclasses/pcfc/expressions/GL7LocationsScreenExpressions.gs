...
class GL7LocationsScreenExpressions {
  @javax.annotation.Generated("config/web/pcf/line/gl7/policy/GL7LocationsScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class GL7LocationsScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at GL7LocationsScreen.pcf: line 27, column 58
    function def_onEnter_19 (def :  pcf.OOSEPanelSet) : void {
      def.onEnter(policyPeriod, jobWizardHelper)
    }
    
    // 'def' attribute on PanelRef at GL7LocationsScreen.pcf: line 29, column 108
    function def_onEnter_21 (def :  pcf.GL7LocationsPanelSet) : void {
      def.onEnter(policyPeriod, openForEdit, supportsNonSpecificLocation, jobWizardHelper)
    }
    ...
    // 'def' attribute on PanelRef at GL7LocationsScreen.pcf: line 29, column 108
    function def_refreshVariables_22 (def :  pcf.GL7LocationsPanelSet) : void {
      def.refreshVariables(policyPeriod, openForEdit, supportsNonSpecificLocation, jobWizardHelper)
    }
    
    // 'editable' attribute on Screen (id=GL7LocationsScreen) at GL7LocationsScreen.pcf: line 7, column 29
    function editable_23 () : java.lang.Boolean {
      return openForEdit
    }
    
    // 'mode' attribute on ToolbarButtonSetRef at GL7LocationsScreen.pcf: line 24, column 104
    function mode_0 () : java.lang.Object {
      return policyPeriod.Job.Subtype
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at GL7LocationsScreen.pcf: line 24, column 104

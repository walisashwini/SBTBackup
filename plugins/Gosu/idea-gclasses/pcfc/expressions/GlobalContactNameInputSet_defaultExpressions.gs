...
class GlobalContactNameInputSet_defaultExpressions {
  ...
  public static class GlobalContactNameInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'available' attribute on TextInput (id=Name_Input) at GlobalContactNameInputSet.default.pcf: line 22, column 44
    function available_1 () : java.lang.Boolean {
      return nameOwner.isAvailable(gw.api.name.NameOwnerFieldId.NP_NAME)
    }
    
    // 'value' attribute on TextInput (id=Name_Input) at GlobalContactNameInputSet.default.pcf: line 22, column 44
    function defaultSetter_6 (__VALUE_TO_SET :  java.lang.Object) : void {
      nameOwner.ContactName.Name  = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'editable' attribute on TextInput (id=Name_Input) at GlobalContactNameInputSet.default.pcf: line 22, column 44
    ...
    // 'label' attribute on TextInput (id=Name_Input) at GlobalContactNameInputSet.default.pcf: line 22, column 44
    function label_3 () : java.lang.Object {
      return nameOwner.ContactNameLabel
    }
    
    // 'required' attribute on TextInput (id=Name_Input) at GlobalContactNameInputSet.default.pcf: line 22, column 44

...
class GlobalPhoneInputSetExpressions {
  ...
  public static class GlobalPhoneInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=NationalSubscriberNumber_Input) at GlobalPhoneInputSet.pcf: line 37, column 98
    function defaultSetter_20 (__VALUE_TO_SET :  java.lang.Object) : void {
      phoneOwner.PhoneFields.NationalSubscriberNumber = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextInput (id=Extension_Input) at GlobalPhoneInputSet.pcf: line 50, column 81
    function defaultSetter_34 (__VALUE_TO_SET :  java.lang.Object) : void {
      phoneOwner.PhoneFields.Extension = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TypeKeyInput (id=CountryCode_Input) at GlobalPhoneInputSet.pcf: line 24, column 84
    function defaultSetter_6 (__VALUE_TO_SET :  java.lang.Object) : void {
      phoneOwner.PhoneFields.CountryCode = (__VALUE_TO_SET as typekey.PhoneCountryCode)
    }
    
    // 'editable' attribute on TypeKeyInput (id=CountryCode_Input) at GlobalPhoneInputSet.pcf: line 24, column 84
    function editable_1 () : java.lang.Boolean {
      return phoneOwner.isEditable(gw.api.phone.PhoneOwnerFieldId.COUNTRY_CODE)
    }
    
    // 'editable' attribute on TextInput (id=NationalSubscriberNumber_Input) at GlobalPhoneInputSet.pcf: line 37, column 98
    ...
    // 'editable' attribute on TextInput (id=Extension_Input) at GlobalPhoneInputSet.pcf: line 50, column 81
    function editable_28 () : java.lang.Boolean {
      return phoneOwner.isEditable(gw.api.phone.PhoneOwnerFieldId.EXTENSION)
    }
    
    // 'helpText' attribute on TextInput (id=NationalSubscriberNumber_Input) at GlobalPhoneInputSet.pcf: line 37, column 98
    function helpText_17 () : java.lang.String {
    ...
    // 'label' attribute on TextInput (id=NationalSubscriberNumber_Input) at GlobalPhoneInputSet.pcf: line 37, column 98
    function label_16 () : java.lang.Object {
      return phoneOwner.getPhoneLabel(singleInput)
    }
    
    // 'label' attribute on TypeKeyInput (id=CountryCode_Input) at GlobalPhoneInputSet.pcf: line 24, column 84
    function label_3 () : java.lang.Object {
      return DisplayKey.get("Web.ContactDetail.Phone.MultiField.RegionCode", phoneOwner.WidgetLabel)
    }
    
    // 'label' attribute on TextInput (id=Extension_Input) at GlobalPhoneInputSet.pcf: line 50, column 81
    ...
    // 'label' attribute on TextInput (id=PhoneDisplay_Input) at GlobalPhoneInputSet.pcf: line 60, column 86
    function label_42 () : java.lang.Object {
      return phoneOwner.WidgetLabel
    }
    
    // 'onChange' attribute on PostOnChange at GlobalPhoneInputSet.pcf: line 40, column 138
    ...
    // 'onChange' attribute on PostOnChange at GlobalPhoneInputSet.pcf: line 53, column 138
    function onChange_27 () : void {
      phoneOwner.autoFormatAndCorrect(phoneOwner.PhoneFields.NationalSubscriberNumber, phoneOwner.PhoneFields.CountryCode)
    }
    
    // 'required' attribute on TextInput (id=NationalSubscriberNumber_Input) at GlobalPhoneInputSet.pcf: line 37, column 98
    ...
    // 'required' attribute on TextInput (id=Extension_Input) at GlobalPhoneInputSet.pcf: line 50, column 81
    function required_32 () : java.lang.Boolean {
      return phoneOwner.isRequired(gw.api.phone.PhoneOwnerFieldId.EXTENSION)
    }
    
    // 'required' attribute on TypeKeyInput (id=CountryCode_Input) at GlobalPhoneInputSet.pcf: line 24, column 84
    ...
    // 'validationExpression' attribute on TextInput (id=NationalSubscriberNumber_Input) at GlobalPhoneInputSet.pcf: line 37, column 98
    function validationExpression_14 () : java.lang.Object {
      return phoneOwner.validatePhone()
    }
    
    // 'validationExpression' attribute on TextInput (id=Extension_Input) at GlobalPhoneInputSet.pcf: line 50, column 81
    ...
    // 'value' attribute on TextInput (id=PhoneDisplay_Input) at GlobalPhoneInputSet.pcf: line 60, column 86
    function value_43 () : java.lang.String {
      return phoneOwner.format()
    }
    
    // 'value' attribute on TypeKeyInput (id=CountryCode_Input) at GlobalPhoneInputSet.pcf: line 24, column 84
    function value_5 () : typekey.PhoneCountryCode {
      return phoneOwner.PhoneFields.CountryCode
    }
    
    // 'visible' attribute on TextInput (id=NationalSubscriberNumber_Input) at GlobalPhoneInputSet.pcf: line 37, column 98
    function visible_15 () : java.lang.Boolean {
      return isVisible(phoneOwner, gw.api.phone.PhoneOwnerFieldId.NATIONAL_SUBSCRIBER_NUMBER)
    }
    
    // 'visible' attribute on TypeKeyInput (id=CountryCode_Input) at GlobalPhoneInputSet.pcf: line 24, column 84
    function visible_2 () : java.lang.Boolean {
      return isVisible(phoneOwner, gw.api.phone.PhoneOwnerFieldId.COUNTRY_CODE)
    }
    
    // 'visible' attribute on TextInput (id=Extension_Input) at GlobalPhoneInputSet.pcf: line 50, column 81
    function visible_30 () : java.lang.Boolean {
      return isVisible(phoneOwner, gw.api.phone.PhoneOwnerFieldId.EXTENSION)
    }
    
    // 'visible' attribute on TextInput (id=PhoneDisplay_Input) at GlobalPhoneInputSet.pcf: line 60, column 86

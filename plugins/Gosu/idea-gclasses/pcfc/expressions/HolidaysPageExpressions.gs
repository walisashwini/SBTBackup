...
class HolidaysPageExpressions {
  ...
  public static class HolidaysPageExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=Holidays_AddHolidayButton) at HolidaysPage.pcf: line 23, column 27
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=Holidays_DeleteButton) at HolidaysPage.pcf: line 31, column 27
    ...
    // 'available' attribute on ToolbarButton (id=Holidays_AddHolidayButton) at HolidaysPage.pcf: line 23, column 27
    function available_1 () : java.lang.Boolean {
      return perm.Holiday.create
    }
    
    // 'available' attribute on CheckedValuesToolbarButton (id=Holidays_DeleteButton) at HolidaysPage.pcf: line 31, column 27
    ...
    // 'def' attribute on PanelRef at HolidaysPage.pcf: line 16, column 36

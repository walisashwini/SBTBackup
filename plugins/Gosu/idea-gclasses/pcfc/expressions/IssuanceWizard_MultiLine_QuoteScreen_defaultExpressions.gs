...
@javax.annotation.Generated("config/web/pcf/job/issuance/IssuanceWizard_MultiLine_QuoteScreen.default.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class IssuanceWizard_MultiLine_QuoteScreen_defaultExpressions {
  @javax.annotation.Generated("config/web/pcf/job/issuance/IssuanceWizard_MultiLine_QuoteScreen.default.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class IssuanceWizard_MultiLine_QuoteScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=CreateIssuanceQuote) at IssuanceWizard_MultiLine_QuoteScreen.default.pcf: line 30, column 23
    function action_19 () : void {
      policyPeriod.printDocument("SubmissionQuote", "Issuance Quote", gw.api.web.document.DocumentsHelper.PrintQuoteParameters)
    }
    
    // 'def' attribute on PanelRef at IssuanceWizard_MultiLine_QuoteScreen.default.pcf: line 34, column 35
    ...
    // 'mode' attribute on ToolbarButtonSetRef at IssuanceWizard_MultiLine_QuoteScreen.default.pcf: line 24, column 96
    function mode_0 () : java.lang.Object {
      return policyPeriod.Job.Subtype
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at IssuanceWizard_MultiLine_QuoteScreen.default.pcf: line 24, column 96

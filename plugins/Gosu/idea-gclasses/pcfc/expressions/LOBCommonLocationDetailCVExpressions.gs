...
class LOBCommonLocationDetailCVExpressions {
  @javax.annotation.Generated("config/web/pcf/LOBCommonLocationDetailCV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class LOBCommonLocationDetailCVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on Link (id=SynchronizedLink) at LOBCommonLocationDetailCV.pcf: line 42, column 101
    ...
    // 'def' attribute on InputSetRef at LOBCommonLocationDetailCV.pcf: line 23, column 107
    function def_onEnter_0 (def :  pcf.LOBCommonLocationDetailInputSet) : void {
      def.onEnter(polLocation, supportsNonSpecificLocation, openForEdit)
    }
    
    // 'def' attribute on PanelRef at LOBCommonLocationDetailCV.pcf: line 53, column 66
    ...
    // 'def' attribute on PanelRef at LOBCommonLocationDetailCV.pcf: line 60, column 165
    ...
    // 'def' attribute on InputSetRef at LOBCommonLocationDetailCV.pcf: line 28, column 70
    ...
    // 'def' attribute on InputSetRef at LOBCommonLocationDetailCV.pcf: line 23, column 107
    function def_refreshVariables_1 (def :  pcf.LOBCommonLocationDetailInputSet) : void {
    ...
    // 'mode' attribute on InputSetRef at LOBCommonLocationDetailCV.pcf: line 28, column 70
    function mode_8 () : java.lang.Object {
      return polLocation.Branch.Policy.Product.CodeIdentifier
    }
    
    // 'visible' attribute on DetailViewPanel (id=AccountLocationUpToDateDV) at LOBCommonLocationDetailCV.pcf: line 33, column 77
    function visible_11 () : java.lang.Boolean {
      return polLocation.Branch.Promoted and !polLocation.isUpToDate()
    }
    
    // 'visible' attribute on Card (id=AdditionalCoveragesCard) at LOBCommonLocationDetailCV.pcf: line 50, column 161
    ...
    // 'visible' attribute on Card (id=LocationQuestionsCard) at LOBCommonLocationDetailCV.pcf: line 58, column 58

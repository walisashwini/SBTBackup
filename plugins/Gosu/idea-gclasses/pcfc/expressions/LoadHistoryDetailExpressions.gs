...
class LoadHistoryDetailExpressions {
  ...
  public static class IteratorEntry2ExpressionsImpl extends LoadHistoryDetailExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=stagingtablename_Cell) at LoadHistoryDetail.pcf: line 119, column 56
    ...
    // 'value' attribute on TextCell (id=stagingtablerowcount_Cell) at LoadHistoryDetail.pcf: line 124, column 49
    function value_37 () : java.lang.Long {
      return RowCount.StagingRowCount
    }
    
    // 'value' attribute on TextCell (id=stagingtableblockcount_Cell) at LoadHistoryDetail.pcf: line 130, column 73
    function value_40 () : java.lang.Integer {
      return RowCount.StagingBlockCount
    }
    
    // 'value' attribute on TextCell (id=sourcetablename_Cell) at LoadHistoryDetail.pcf: line 134, column 55
    function value_44 () : java.lang.String {
      return RowCount.SourceTableName
    }
    
    // 'value' attribute on TextCell (id=sourcetablerowcount_Cell) at LoadHistoryDetail.pcf: line 139, column 49
    function value_47 () : java.lang.Long {
      return RowCount.SourceRowCount
    }
    
    // 'value' attribute on TextCell (id=sourcetableblockcount_Cell) at LoadHistoryDetail.pcf: line 145, column 73
    function value_50 () : java.lang.Integer {
      return RowCount.SourceBlockCount
    }
    
    // 'visible' attribute on TextCell (id=stagingtableblockcount_Cell) at LoadHistoryDetail.pcf: line 130, column 73
  ...
  public static class IteratorEntry3ExpressionsImpl extends LoadHistoryDetailExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=cmdtablename_Cell) at LoadHistoryDetail.pcf: line 196, column 48
    ...
    // 'value' attribute on TextAreaCell (id=cmdcommand_Cell) at LoadHistoryDetail.pcf: line 201, column 51
  ...
  public static class IteratorEntryExpressionsImpl extends LoadHistoryDetailExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=parmname_Cell) at LoadHistoryDetail.pcf: line 79, column 51
    ...
    // 'value' attribute on TextCell (id=parmvalue_Cell) at LoadHistoryDetail.pcf: line 83, column 52
  ...
  public static class LoadHistoryDetailExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef (id=LoadEncryptTablePanelRef) at LoadHistoryDetail.pcf: line 213, column 44
    ...
    // 'value' attribute on TextCell (id=stagingtableblockcount_Cell) at LoadHistoryDetail.pcf: line 130, column 73
    function sortValue_28 (RowCount :  entity.LoadRowCount) : java.lang.Object {
      return RowCount.StagingBlockCount
    }
    ...
    // 'value' attribute on TextCell (id=sourcetableblockcount_Cell) at LoadHistoryDetail.pcf: line 145, column 73
    function sortValue_32 (RowCount :  entity.LoadRowCount) : java.lang.Object {
      return RowCount.SourceBlockCount
    }
    ...
    // 'title' attribute on Card (id=TableEncryptsCard) at LoadHistoryDetail.pcf: line 210, column 44
    ...
    // 'visible' attribute on Card (id=TableEncryptsCard) at LoadHistoryDetail.pcf: line 210, column 44

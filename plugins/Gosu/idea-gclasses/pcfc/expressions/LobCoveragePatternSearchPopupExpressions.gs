...
class LobCoveragePatternSearchPopupExpressions {
  @javax.annotation.Generated("config/web/pcf/shared/coverage/LobCoveragePatternSearchPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class LobCoveragePatternSearchPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'initialValue' attribute on Variable at LobCoveragePatternSearchPopup.pcf: line 18, column 53
    function initialValue_0 () : gw.api.productmodel.PolicyLinePattern {
      return coverable.PolicyLine.Pattern
    }
    
    // 'title' attribute on Popup (id=LobCoveragePatternSearchPopup) at LobCoveragePatternSearchPopup.pcf: line 9, column 240
    ...
    override property get CurrentLocation () : pcf.LobCoveragePatternSearchPopup {
      return super.CurrentLocation as pcf.LobCoveragePatternSearchPopup
    }
    ...
    function updateClausesDependents(updatedClauses : gw.api.productmodel.ClausePattern[]) {
      updatedClauses.each(\updatedClause -> {
        gw.lob.common.LobPropertyService.Instance.updateClauseDependentProperties(updatedClause, coverable)
      })
    }
  ...
  @javax.annotation.Generated("config/web/pcf/shared/coverage/LobCoveragePatternSearchPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class SearchPanelExpressionsImpl extends LobCoveragePatternSearchPopupExpressionsImpl {
    public construct(widget :  Object) {
      super(widget, 1)
    }
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=AddCoverageButton) at LobCoveragePatternSearchPopup.pcf: line 48, column 240
    function allCheckedRowsAction_4 (CheckedValues :  gw.api.productmodel.ClausePattern[], CheckedValuesErrors :  java.util.Map) : void {
      CurrentLocation.pickValueAndCommit( CheckedValues ); updateClausesDependents( CheckedValues )
    }
    
    // 'def' attribute on PanelRef at LobCoveragePatternSearchPopup.pcf: line 40, column 117
    ...
    // 'def' attribute on PanelRef at LobCoveragePatternSearchPopup.pcf: line 42, column 66
    ...
    // 'label' attribute on CheckedValuesToolbarButton (id=AddCoverageButton) at LobCoveragePatternSearchPopup.pcf: line 48, column 240
    ...
    // 'searchCriteria' attribute on SearchPanel at LobCoveragePatternSearchPopup.pcf: line 38, column 65
    ...
    // 'search' attribute on SearchPanel at LobCoveragePatternSearchPopup.pcf: line 38, column 65

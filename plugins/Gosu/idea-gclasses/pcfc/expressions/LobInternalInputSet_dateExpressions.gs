...
@javax.annotation.Generated("config/web/pcf/widgets/datamodel/LobInternalInputSet.date.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class LobInternalInputSet_dateExpressions {
  @javax.annotation.Generated("config/web/pcf/widgets/datamodel/LobInternalInputSet.date.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class LobInternalInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'confirmMessage' attribute on DateInput (id=Input_Input) at LobInternalInputSet.date.pcf: line 18, column 37
    function confirmMessage_0 () : java.lang.String {
      return displayable.ConfirmMessage
    }
    
    // 'value' attribute on DateInput (id=Input_Input) at LobInternalInputSet.date.pcf: line 18, column 37
    function defaultSetter_4 (__VALUE_TO_SET :  java.lang.Object) : void {
      displayable.Value = __VALUE_TO_SET
    }
    
    // 'label' attribute on DateInput (id=Input_Input) at LobInternalInputSet.date.pcf: line 18, column 37
    function label_1 () : java.lang.Object {
      return displayable.Label
    }
    
    // 'required' attribute on DateInput (id=Input_Input) at LobInternalInputSet.date.pcf: line 18, column 37

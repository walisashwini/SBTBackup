...
@javax.annotation.Generated("config/web/pcf/shared/coverage/LobScheduledItemColumnInput.Date.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class LobScheduledItemColumnInput_DateExpressions {
  @javax.annotation.Generated("config/web/pcf/shared/coverage/LobScheduledItemColumnInput.Date.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class LobScheduledItemColumnInputExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'available' attribute on DateCell (id=DateValue_Cell) at LobScheduledItemColumnInput.Date.pcf: line 39, column 33
    function available_2 () : java.lang.Boolean {
      return displayable.Available
    }
    
    // 'value' attribute on DateCell (id=DateValue_Cell) at LobScheduledItemColumnInput.Date.pcf: line 39, column 33
    function defaultSetter_5 (__VALUE_TO_SET :  java.lang.Object) : void {
      displayable.Value = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'initialValue' attribute on Variable at LobScheduledItemColumnInput.Date.pcf: line 32, column 75
    function initialValue_0 () : gw.lob.common.displayable.Displayable<java.util.Date> {
      return displayableFactory.createSchedulePropertyInfoDisplayable(clause, scheduledItem, schedulePropertyInfo) as gw.lob.common.displayable.Displayable<java.util.Date>
    }
    
    // 'onChange' attribute on PostOnChange at LobScheduledItemColumnInput.Date.pcf: line 41, column 59
    function onChange_1 () : void {
      displayable.onChange(jobWizardHelper)
    }
    
    // 'required' attribute on DateCell (id=DateValue_Cell) at LobScheduledItemColumnInput.Date.pcf: line 39, column 33
    ...
    property get displayable () : gw.lob.common.displayable.Displayable<java.util.Date> {
      return getVariableValue("displayable", 0) as gw.lob.common.displayable.Displayable<java.util.Date>
    }

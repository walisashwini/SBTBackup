...
@javax.annotation.Generated("config/web/pcf/shared/coverage/LobScheduledItemColumnInput.ForeignKey.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class LobScheduledItemColumnInput_ForeignKeyExpressions {
  @javax.annotation.Generated("config/web/pcf/shared/coverage/LobScheduledItemColumnInput.ForeignKey.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class LobScheduledItemColumnInputExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'available' attribute on RangeCell (id=RangeValue_Cell) at LobScheduledItemColumnInput.ForeignKey.pcf: line 40, column 105
    function available_2 () : java.lang.Boolean {
      return displayable.Available
    }
    
    // 'value' attribute on RangeCell (id=RangeValue_Cell) at LobScheduledItemColumnInput.ForeignKey.pcf: line 40, column 105
    function defaultSetter_5 (__VALUE_TO_SET :  java.lang.Object) : void {
      displayable.Value = __VALUE_TO_SET
    }
    
    // 'initialValue' attribute on Variable at LobScheduledItemColumnInput.ForeignKey.pcf: line 32, column 53
    ...
    // 'onChange' attribute on PostOnChange at LobScheduledItemColumnInput.ForeignKey.pcf: line 42, column 59
    function onChange_1 () : void {
      displayable.onChange(jobWizardHelper)
    }
    
    // 'required' attribute on RangeCell (id=RangeValue_Cell) at LobScheduledItemColumnInput.ForeignKey.pcf: line 40, column 105
    function required_3 () : java.lang.Boolean {
      return displayable.Required
    }
    
    // 'valueRange' attribute on RangeCell (id=RangeValue_Cell) at LobScheduledItemColumnInput.ForeignKey.pcf: line 40, column 105

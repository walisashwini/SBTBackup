...
class LobScheduledItemColumnInput_ForeignKeyWithOptionLabelsExpressions {
  @javax.annotation.Generated("config/web/pcf/shared/coverage/LobScheduledItemColumnInput.ForeignKeyWithOptionLabels.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class LobScheduledItemColumnInputExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'available' attribute on RangeCell (id=RangeValue_Cell) at LobScheduledItemColumnInput.ForeignKeyWithOptionLabels.pcf: line 41, column 105
    function available_2 () : java.lang.Boolean {
      return displayable.Available
    }
    
    // 'value' attribute on RangeCell (id=RangeValue_Cell) at LobScheduledItemColumnInput.ForeignKeyWithOptionLabels.pcf: line 41, column 105
    function defaultSetter_5 (__VALUE_TO_SET :  java.lang.Object) : void {
      displayable.Value = __VALUE_TO_SET
    }
    
    // 'initialValue' attribute on Variable at LobScheduledItemColumnInput.ForeignKeyWithOptionLabels.pcf: line 32, column 53
    ...
    // 'onChange' attribute on PostOnChange at LobScheduledItemColumnInput.ForeignKeyWithOptionLabels.pcf: line 43, column 59
    function onChange_1 () : void {
      displayable.onChange(jobWizardHelper)
    }
    
    // 'optionGroupLabel' attribute on RangeCell (id=RangeValue_Cell) at LobScheduledItemColumnInput.ForeignKeyWithOptionLabels.pcf: line 41, column 105
    function optionGroupLabel_7 (VALUE :  java.lang.Object) : java.lang.String {
      return displayable.getOptionGroupLabel(VALUE)
    }
    
    // 'required' attribute on RangeCell (id=RangeValue_Cell) at LobScheduledItemColumnInput.ForeignKeyWithOptionLabels.pcf: line 41, column 105
    function required_3 () : java.lang.Boolean {
      return displayable.Required
    }
    
    // 'valueRange' attribute on RangeCell (id=RangeValue_Cell) at LobScheduledItemColumnInput.ForeignKeyWithOptionLabels.pcf: line 41, column 105
    function valueRange_8 () : java.lang.Object {
      return gw.api.upgrade.Coercions.makeArray<entity.KeyableBean>(displayable.ValueRange)
    }
    ...
    function verifyValueRange_10 () : void {
      var __valueRangeArg = gw.api.upgrade.Coercions.makeArray<entity.KeyableBean>(displayable.ValueRange)

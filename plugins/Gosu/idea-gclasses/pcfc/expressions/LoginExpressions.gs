...
class LoginExpressions {
  ...
  public static class LoginExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at Login.pcf: line 35, column 36
    ...
    function initialValue_0 () : gw.api.util.LoginForm {
      return new gw.api.web.util.PCLoginForm(target, entryException)
    }
    
    // 'label' attribute on Verbatim (id=LoginFormMessage) at Login.pcf: line 38, column 40

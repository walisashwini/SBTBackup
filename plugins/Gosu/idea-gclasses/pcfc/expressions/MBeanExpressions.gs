...
class MBeanExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends MBeanExpressionsImpl {
    ...
    // 'action' attribute on Link (id=doit) at MBean.pcf: line 74, column 44
    function action_10 () : void {
      GWMBeansData.executeBeanOperation(GWMBean, operation)
    }
    
    // 'value' attribute on TextCell (id=operation_Cell) at MBean.pcf: line 66, column 30
    function valueRoot_8 () : java.lang.Object {
      return operation
    }
    
    // 'value' attribute on TextCell (id=Value_Cell) at MBean.pcf: line 81, column 47
  ...
  public static class MBeanExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at MBean.pcf: line 88, column 61
    ...
    // 'visible' attribute on PanelRef at MBean.pcf: line 88, column 61

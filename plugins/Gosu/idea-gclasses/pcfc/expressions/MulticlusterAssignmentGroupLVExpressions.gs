...
class MulticlusterAssignmentGroupLVExpressions {
  @javax.annotation.Generated("config/web/pcf/shared/assignment/MulticlusterAssignmentGroupLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class IteratorEntryExpressionsImpl extends MulticlusterAssignmentGroupLVExpressionsImpl {
    ...
    // 'pickValue' attribute on RowIterator at MulticlusterAssignmentGroupLV.pcf: line 18, column 72
    function pickValue_26 () : gw.api.assignment.Assignee {
      return new gw.api.assignment.multicluster.MulticlusterAssignee.Builder(group).withGroupId(group.PublicID).build()
    }
    ...
    // 'value' attribute on TextCell (id=Organization_Cell) at MulticlusterAssignmentGroupLV.pcf: line 35, column 44
  ...
  @javax.annotation.Generated("config/web/pcf/shared/assignment/MulticlusterAssignmentGroupLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class MulticlusterAssignmentGroupLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    public construct(widget :  Object) {
      super(widget, 0)
    }
    ...
    // 'value' attribute on GroupCell (id=Group_Cell) at MulticlusterAssignmentGroupLV.pcf: line 24, column 26
    function sortValue_0 (group :  entity.Group) : java.lang.Object {
      return group
    }
    
    // 'value' attribute on RowIterator at MulticlusterAssignmentGroupLV.pcf: line 18, column 72

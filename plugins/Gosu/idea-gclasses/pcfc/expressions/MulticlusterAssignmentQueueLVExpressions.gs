...
class MulticlusterAssignmentQueueLVExpressions {
  @javax.annotation.Generated("config/web/pcf/shared/assignment/MulticlusterAssignmentQueueLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class IteratorEntryExpressionsImpl extends MulticlusterAssignmentQueueLVExpressionsImpl {
    ...
    // 'pickValue' attribute on RowIterator at MulticlusterAssignmentQueueLV.pcf: line 16, column 82
    function pickValue_19 () : gw.api.assignment.Assignee {
      return new gw.api.assignment.multicluster.MulticlusterAssignee.Builder(Queue).withQueueId(Queue.PublicID).build()
    }
    ...
    // 'value' attribute on TextCell (id=Description_Cell) at MulticlusterAssignmentQueueLV.pcf: line 33, column 38
    function value_16 () : java.lang.String {
      return Queue.Description
    }
    
    // 'value' attribute on TextCell (id=Name_Cell) at MulticlusterAssignmentQueueLV.pcf: line 23, column 47
  ...
  @javax.annotation.Generated("config/web/pcf/shared/assignment/MulticlusterAssignmentQueueLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class MulticlusterAssignmentQueueLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    public construct(widget :  Object) {
      super(widget, 0)
    }
    ...
    // 'value' attribute on RowIterator at MulticlusterAssignmentQueueLV.pcf: line 16, column 82

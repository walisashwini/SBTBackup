...
class NewActivityDV_UWApprovalExpressions {
  @javax.annotation.Generated("config/web/pcf/activity/NewActivityDV.UWApproval.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class NewActivityDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'pickLocation' attribute on DocumentTemplateInput (id=DocumentTemplate_Input) at NewActivityDV.UWApproval.pcf: line 71, column 98
    function action_31 () : void {
      DocumentTemplateSearchPopup.push(symbolProvider)
    }
    
    // 'pickLocation' attribute on PickerInput (id=EmailTemplate_Input) at NewActivityDV.UWApproval.pcf: line 81, column 39
    function action_40 () : void {
      PickEmailTemplatePopup.push(new gw.api.email.EmailTemplateSearchCriteria(symbolProvider.names()?.toTypedArray()))
    }
    
    // 'action' attribute on MenuItem (id=AssigneePicker) at NewActivityDV.UWApproval.pcf: line 92, column 48
    ...
    // 'available' attribute on RangeInput (id=SelectFromList_Input) at NewActivityDV.UWApproval.pcf: line 92, column 48
    function available_50 () : java.lang.Boolean {
      return assignmentPopup.SelectionType == TC_FROMLIST
    }
    
    // 'conversionExpression' attribute on DocumentTemplateInput (id=DocumentTemplate_Input) at NewActivityDV.UWApproval.pcf: line 71, column 98
    ...
    // 'conversionExpression' attribute on PickerInput (id=EmailTemplate_Input) at NewActivityDV.UWApproval.pcf: line 81, column 39
    ...
    // 'value' attribute on DateInput (id=TargetDate_Input) at NewActivityDV.UWApproval.pcf: line 38, column 38
    function defaultSetter_10 (__VALUE_TO_SET :  java.lang.Object) : void {
      activity.TargetDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on DateInput (id=EscalationDate_Input) at NewActivityDV.UWApproval.pcf: line 43, column 42
    function defaultSetter_14 (__VALUE_TO_SET :  java.lang.Object) : void {
      activity.EscalationDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on TypeKeyInput (id=Priority_Input) at NewActivityDV.UWApproval.pcf: line 50, column 39
    function defaultSetter_18 (__VALUE_TO_SET :  java.lang.Object) : void {
      activity.Priority = (__VALUE_TO_SET as typekey.Priority)
    }
    
    // 'value' attribute on TextInput (id=Subject_Input) at NewActivityDV.UWApproval.pcf: line 28, column 35
    function defaultSetter_2 (__VALUE_TO_SET :  java.lang.Object) : void {
      activity.Subject = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on BooleanRadioInput (id=Mandatory_Input) at NewActivityDV.UWApproval.pcf: line 55, column 37
    function defaultSetter_22 (__VALUE_TO_SET :  java.lang.Object) : void {
      activity.Mandatory = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'value' attribute on BooleanRadioInput (id=Recurring_Input) at NewActivityDV.UWApproval.pcf: line 61, column 529
    function defaultSetter_27 (__VALUE_TO_SET :  java.lang.Object) : void {
      activity.Recurring = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'value' attribute on DocumentTemplateInput (id=DocumentTemplate_Input) at NewActivityDV.UWApproval.pcf: line 71, column 98
    function defaultSetter_36 (__VALUE_TO_SET :  java.lang.Object) : void {
      activity.DocumentTemplate = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on PickerInput (id=EmailTemplate_Input) at NewActivityDV.UWApproval.pcf: line 81, column 39
    function defaultSetter_45 (__VALUE_TO_SET :  java.lang.Object) : void {
      activity.EmailTemplate = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on RangeInput (id=SelectFromList_Input) at NewActivityDV.UWApproval.pcf: line 92, column 48
    function defaultSetter_52 (__VALUE_TO_SET :  java.lang.Object) : void {
      assigneePicker.SelectedAssignee = (__VALUE_TO_SET as gw.api.assignment.Assignee)
    }
    
    // 'value' attribute on TextInput (id=Description_Input) at NewActivityDV.UWApproval.pcf: line 33, column 39
    function defaultSetter_6 (__VALUE_TO_SET :  java.lang.Object) : void {
      activity.Description = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'filter' attribute on RangeInput (id=SelectFromList_Input) at NewActivityDV.UWApproval.pcf: line 92, column 48
    ...
    // 'initialValue' attribute on Variable at NewActivityDV.UWApproval.pcf: line 21, column 48
    ...
    // 'outputConversion' attribute on PickerInput (id=EmailTemplate_Input) at NewActivityDV.UWApproval.pcf: line 81, column 39
    function outputConversion_43 (VALUE :  java.lang.String) : java.lang.String {
      return getEmailDisplayName(VALUE)
    }
    
    // 'valueRange' attribute on RangeInput (id=SelectFromList_Input) at NewActivityDV.UWApproval.pcf: line 92, column 48
    ...
    // 'visible' attribute on BooleanRadioInput (id=Recurring_Input) at NewActivityDV.UWApproval.pcf: line 61, column 529
    ...
    // 'visible' attribute on DocumentTemplateInput (id=DocumentTemplate_Input) at NewActivityDV.UWApproval.pcf: line 71, column 98

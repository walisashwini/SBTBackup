...
class OracleOutlineDetailsPopupExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends OracleOutlineDetailsPopupExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=Node_Cell) at OracleOutlineDetailsPopup.pcf: line 41, column 48
    function valueRoot_6 () : java.lang.Object {
      return hint
    }
    
    // 'value' attribute on TextCell (id=JoinPos_Cell) at OracleOutlineDetailsPopup.pcf: line 51, column 48
    function value_11 () : java.lang.Integer {
      return hint.JoinPos
    }
    
    // 'value' attribute on TextCell (id=Hint_Cell) at OracleOutlineDetailsPopup.pcf: line 55, column 36
    ...
    // 'value' attribute on TextCell (id=Stage_Cell) at OracleOutlineDetailsPopup.pcf: line 46, column 48
  ...
  public static class OracleOutlineDetailsPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function renderCall_0 (__writer :  java.io.Writer, __escaper :  gw.lang.parser.template.StringEscaper, __helper :  gw.api.web.template.TemplatePanelHelper) : void {
      pcfc.expressions.OracleOutlineDetailsPopup_TemplatePanel1.render(__writer, __escaper, outline, __helper)
    }

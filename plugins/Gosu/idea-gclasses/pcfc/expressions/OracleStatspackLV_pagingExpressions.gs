...
class OracleStatspackLV_pagingExpressions {
  @javax.annotation.Generated("config/web/pcf/tools/infopages/OracleStatspackLV.paging.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class IteratorEntryExpressionsImpl extends OracleStatspackLVExpressionsImpl {
    ...
    // 'value' attribute on CheckBoxCell (id=selector_Cell) at OracleStatspackLV.paging.pcf: line 24, column 38
    ...
    // 'value' attribute on DateCell (id=startuptime_Cell) at OracleStatspackLV.paging.pcf: line 47, column 36
    function value_10 () : java.util.Date {
      return Row.StartupTime
    }
    
    // 'value' attribute on TextCell (id=Description_Cell) at OracleStatspackLV.paging.pcf: line 52, column 36
    function value_13 () : java.lang.String {
      return Row.Description
    }
    
    // 'value' attribute on TextCell (id=SnapshotID_Cell) at OracleStatspackLV.paging.pcf: line 33, column 42
    function value_4 () : java.lang.Integer {
      return Row.Id
    }
    
    // 'value' attribute on DateCell (id=time_Cell) at OracleStatspackLV.paging.pcf: line 40, column 33
  ...
  public static class OracleStatspackLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RowIterator at OracleStatspackLV.paging.pcf: line 18, column 58

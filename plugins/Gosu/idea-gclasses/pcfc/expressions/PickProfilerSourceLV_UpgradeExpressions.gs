...
class PickProfilerSourceLV_UpgradeExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends PickProfilerSourceLVExpressionsImpl {
    ...
    // 'value' attribute on DateCell (id=UpgradeStartTime_Cell) at PickProfilerSourceLV.Upgrade.pcf: line 33, column 46
    ...
    // 'value' attribute on DateCell (id=UpgradeEndTime_Cell) at PickProfilerSourceLV.Upgrade.pcf: line 39, column 44
    function value_6 () : java.util.Date {
      return upgradeInstance.EndTime
    }
    
    // 'value' attribute on TextCell (id=UpgradeDuration_Cell) at PickProfilerSourceLV.Upgrade.pcf: line 44, column 42

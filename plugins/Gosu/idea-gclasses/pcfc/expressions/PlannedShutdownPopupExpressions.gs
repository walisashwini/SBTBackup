...
class PlannedShutdownPopupExpressions {
  ...
  public static class DetailViewPanelExpressionsImpl extends PlannedShutdownPopupExpressionsImpl {
    ...
    function action_18 () : void {
      new gw.api.tools.ClusterMembersData().schedulePlannedShutdown(serverId, new gw.api.system.server.ShutdownOptions(ShutdownMessageDisplayKey, ShutdownMessage, ShutdownTime, false, TerminateBatchProcesses)); CurrentLocation.cancel()
    }
    ...
    // 'value' attribute on DateInput (id=ShutdownTime_Input) at PlannedShutdownPopup.pcf: line 77, column 35
    function defaultSetter_13 (__VALUE_TO_SET :  java.lang.Object) : void {
      ShutdownTime = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on CheckBoxInput (id=TerminateBatchProcesses_Input) at PlannedShutdownPopup.pcf: line 83, column 46
    ...
    // 'value' attribute on TextInput (id=CustomMessageText_Input) at PlannedShutdownPopup.pcf: line 68, column 40
    ...
    function option_8 () : java.lang.Object {

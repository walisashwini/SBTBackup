...
class Policy_DocumentSearchDVExpressions {
  @javax.annotation.Generated("config/web/pcf/policy/Policy_DocumentSearchDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class Policy_DocumentSearchDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on InputSetRef at Policy_DocumentSearchDV.pcf: line 66, column 41
    ...
    // 'value' attribute on TextInput (id=Name_Input) at Policy_DocumentSearchDV.pcf: line 18, column 42
    function defaultSetter_1 (__VALUE_TO_SET :  java.lang.Object) : void {
      searchCriteria.NameOrID = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TypeKeyInput (id=Status_Input) at Policy_DocumentSearchDV.pcf: line 33, column 49
    function defaultSetter_13 (__VALUE_TO_SET :  java.lang.Object) : void {
      searchCriteria.Status = (__VALUE_TO_SET as typekey.DocumentStatusType)
    }
    
    // 'value' attribute on TypeKeyInput (id=Language_Input) at Policy_DocumentSearchDV.pcf: line 40, column 67
    function defaultSetter_18 (__VALUE_TO_SET :  java.lang.Object) : void {
      searchCriteria.Language = (__VALUE_TO_SET as typekey.LanguageType)
    }
    
    // 'value' attribute on DateInput (id=DateFrom_Input) at Policy_DocumentSearchDV.pcf: line 47, column 42
    function defaultSetter_23 (__VALUE_TO_SET :  java.lang.Object) : void {
      searchCriteria.DateFrom = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on DateInput (id=DateTo_Input) at Policy_DocumentSearchDV.pcf: line 52, column 40
    function defaultSetter_27 (__VALUE_TO_SET :  java.lang.Object) : void {
      searchCriteria.DateTo = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on TextInput (id=Author_Input) at Policy_DocumentSearchDV.pcf: line 57, column 40
    function defaultSetter_31 (__VALUE_TO_SET :  java.lang.Object) : void {
      searchCriteria.Author = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on BooleanRadioInput (id=IncludeObsoletes_Input) at Policy_DocumentSearchDV.pcf: line 62, column 50
    function defaultSetter_35 (__VALUE_TO_SET :  java.lang.Object) : void {
      searchCriteria.IncludeObsoletes = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'value' attribute on RangeInput (id=RelatedTo_Input) at Policy_DocumentSearchDV.pcf: line 27, column 39
    function defaultSetter_5 (__VALUE_TO_SET :  java.lang.Object) : void {
      searchCriteria.RelatedTo = __VALUE_TO_SET
    }
    
    // 'optionLabel' attribute on RangeInput (id=RelatedTo_Input) at Policy_DocumentSearchDV.pcf: line 27, column 39
    function optionLabel_7 (VALUE :  java.lang.Object) : java.lang.String {
      return Note.getLevelDisplayString(VALUE)
    }
    
    // 'valueRange' attribute on RangeInput (id=RelatedTo_Input) at Policy_DocumentSearchDV.pcf: line 27, column 39
    ...
    function verifyValueRange_10 () : void {
      var __valueRangeArg = searchCriteria.getRelatedToOptionsForPolicyFile(policyPeriod)
    ...
    // 'visible' attribute on TypeKeyInput (id=Language_Input) at Policy_DocumentSearchDV.pcf: line 40, column 67

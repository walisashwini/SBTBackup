...
class PreferredCoverageCurrency_trueExpressions {
  @javax.annotation.Generated("config/web/pcf/line/common/PreferredCoverageCurrency.true.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class PreferredCoverageCurrencyExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RangeCell (id=Currency_Cell) at PreferredCoverageCurrency.true.pcf: line 25, column 36
    function defaultSetter_4 (__VALUE_TO_SET :  java.lang.Object) : void {
      coverable.PreferredCoverageCurrency = (__VALUE_TO_SET as typekey.Currency)
    }
    
    // 'initialValue' attribute on Variable at PreferredCoverageCurrency.true.pcf: line 17, column 32
    function initialValue_0 () : entity.Coverable {
      return policyLine as Coverable
    }
    
    // 'onChange' attribute on PostOnChange at PreferredCoverageCurrency.true.pcf: line 27, column 137
    ...
    // 'showConfirmMessage' attribute on RangeCell (id=Currency_Cell) at PreferredCoverageCurrency.true.pcf: line 25, column 36
    function showConfirmMessage_2 () : java.lang.Boolean {
      return coverable.CoveragesFromCoverable.length > 0
    }
    
    // 'valueRange' attribute on RangeCell (id=Currency_Cell) at PreferredCoverageCurrency.true.pcf: line 25, column 36

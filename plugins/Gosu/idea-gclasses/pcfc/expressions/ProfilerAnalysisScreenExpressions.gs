...
class ProfilerAnalysisScreenExpressions {
  ...
  public static class ListDetailPanelExpressionsImpl extends ProfilerAnalysisScreenExpressionsImpl {
    ...
    function def_onEnter_10 (def :  pcf.PickProfilerSourceLV_RestOperation) : void {
      def.onEnter()
    }
    
    // 'def' attribute on PanelRef at ProfilerAnalysisScreen.pcf: line 21, column 31
    function def_onEnter_12 (def :  pcf.PickProfilerSourceLV_SavedFile) : void {
      def.onEnter()
    }
    
    // 'def' attribute on PanelRef at ProfilerAnalysisScreen.pcf: line 21, column 31
    function def_onEnter_14 (def :  pcf.PickProfilerSourceLV_StartablePlugin) : void {
      def.onEnter()
    }
    
    // 'def' attribute on PanelRef at ProfilerAnalysisScreen.pcf: line 21, column 31
    function def_onEnter_16 (def :  pcf.PickProfilerSourceLV_Upgrade) : void {
      def.onEnter()
    }
    
    // 'def' attribute on PanelRef at ProfilerAnalysisScreen.pcf: line 21, column 31
    function def_onEnter_18 (def :  pcf.PickProfilerSourceLV_Web) : void {
      def.onEnter()
    }
    ...
    // 'def' attribute on PanelRef at ProfilerAnalysisScreen.pcf: line 21, column 31
    function def_onEnter_20 (def :  pcf.PickProfilerSourceLV_WebService) : void {
      def.onEnter()
    }
    
    // 'def' attribute on PanelRef at ProfilerAnalysisScreen.pcf: line 21, column 31
    function def_onEnter_22 (def :  pcf.PickProfilerSourceLV_WorkQueue) : void {
      def.onEnter()
    }
    
    // 'def' attribute on PanelRef at ProfilerAnalysisScreen.pcf: line 38, column 77
    function def_onEnter_25 (def :  pcf.ProfilerAnalysisPanelSet) : void {
    ...
    // 'def' attribute on PanelRef at ProfilerAnalysisScreen.pcf: line 21, column 31
    function def_onEnter_6 (def :  pcf.PickProfilerSourceLV_GosuServlet) : void {
      def.onEnter()
    }
    
    // 'def' attribute on PanelRef at ProfilerAnalysisScreen.pcf: line 21, column 31
    function def_onEnter_8 (def :  pcf.PickProfilerSourceLV_MessageDestination) : void {
      def.onEnter()
    }
    
    // 'def' attribute on PanelRef at ProfilerAnalysisScreen.pcf: line 21, column 31
    function def_refreshVariables_11 (def :  pcf.PickProfilerSourceLV_RestOperation) : void {
      def.refreshVariables()
    }
    
    // 'def' attribute on PanelRef at ProfilerAnalysisScreen.pcf: line 21, column 31
    function def_refreshVariables_13 (def :  pcf.PickProfilerSourceLV_SavedFile) : void {
      def.refreshVariables()
    }
    
    // 'def' attribute on PanelRef at ProfilerAnalysisScreen.pcf: line 21, column 31
    function def_refreshVariables_15 (def :  pcf.PickProfilerSourceLV_StartablePlugin) : void {
      def.refreshVariables()
    }
    
    // 'def' attribute on PanelRef at ProfilerAnalysisScreen.pcf: line 21, column 31
    function def_refreshVariables_17 (def :  pcf.PickProfilerSourceLV_Upgrade) : void {
      def.refreshVariables()
    }
    
    // 'def' attribute on PanelRef at ProfilerAnalysisScreen.pcf: line 21, column 31
    function def_refreshVariables_19 (def :  pcf.PickProfilerSourceLV_Web) : void {
      def.refreshVariables()
    }
    
    // 'def' attribute on PanelRef at ProfilerAnalysisScreen.pcf: line 21, column 31
    function def_refreshVariables_21 (def :  pcf.PickProfilerSourceLV_WebService) : void {
      def.refreshVariables()
    }
    
    // 'def' attribute on PanelRef at ProfilerAnalysisScreen.pcf: line 21, column 31
    function def_refreshVariables_23 (def :  pcf.PickProfilerSourceLV_WorkQueue) : void {
      def.refreshVariables()
    }
    
    // 'def' attribute on PanelRef at ProfilerAnalysisScreen.pcf: line 38, column 77
    function def_refreshVariables_26 (def :  pcf.ProfilerAnalysisPanelSet) : void {
    ...
    // 'def' attribute on PanelRef at ProfilerAnalysisScreen.pcf: line 21, column 31
    function def_refreshVariables_7 (def :  pcf.PickProfilerSourceLV_GosuServlet) : void {
      def.refreshVariables()
    }
    
    // 'def' attribute on PanelRef at ProfilerAnalysisScreen.pcf: line 21, column 31
    function def_refreshVariables_9 (def :  pcf.PickProfilerSourceLV_MessageDestination) : void {
      def.refreshVariables()
    }

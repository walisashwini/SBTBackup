...
class ProfilerResultsCV_QuerySpelunkerExpressions {
  ...
  public static class IteratorEntry2ExpressionsImpl extends ListDetailPanelExpressionsImpl {
    ...
    // 'outputConversion' attribute on TextCell (id=AverageRowCount_Cell) at ProfilerResultsCV.QuerySpelunker.pcf: line 179, column 53
    function outputConversion_88 (VALUE :  java.lang.Double) : java.lang.String {
      return formatAverage(VALUE)
    }
    
    // 'value' attribute on TextCell (id=StackName_Cell) at ProfilerResultsCV.QuerySpelunker.pcf: line 128, column 60
    ...
    // 'value' attribute on TextCell (id=Requests_Cell) at ProfilerResultsCV.QuerySpelunker.pcf: line 134, column 54
    function value_67 () : java.lang.Integer {
      return stackQuerySummary.StackCount
    }
    
    // 'value' attribute on TextCell (id=QueryCount_Cell) at ProfilerResultsCV.QuerySpelunker.pcf: line 140, column 54
    function value_70 () : java.lang.Integer {
      return stackQuerySummary.QueryCount
    }
    
    // 'value' attribute on TextCell (id=QueriesPerRequest_Cell) at ProfilerResultsCV.QuerySpelunker.pcf: line 147, column 54
    function value_73 () : java.lang.Integer {
      return stackQuerySummary.QueriesPerStack
    }
    
    // 'value' attribute on TextCell (id=TotalQueryTime_Cell) at ProfilerResultsCV.QuerySpelunker.pcf: line 155, column 54
    function value_76 () : java.lang.Integer {
      return stackQuerySummary.TotalQueryTime
    }
    
    // 'value' attribute on TextCell (id=AverageQueryTime_Cell) at ProfilerResultsCV.QuerySpelunker.pcf: line 160, column 53
    function value_79 () : java.lang.Double {
      return stackQuerySummary.AverageQueryTime
    }
    
    // 'value' attribute on TextCell (id=MaxQueryTime_Cell) at ProfilerResultsCV.QuerySpelunker.pcf: line 165, column 54
    function value_82 () : java.lang.Integer {
      return stackQuerySummary.MaxQueryTime
    }
    
    // 'value' attribute on TextCell (id=TotalRowCount_Cell) at ProfilerResultsCV.QuerySpelunker.pcf: line 173, column 54
    function value_85 () : java.lang.Integer {
      return stackQuerySummary.TotalRowCount
    }
    
    // 'value' attribute on TextCell (id=AverageRowCount_Cell) at ProfilerResultsCV.QuerySpelunker.pcf: line 179, column 53
    function value_89 () : java.lang.Double {
  ...
  public static class IteratorEntryExpressionsImpl extends ListDetailPanelExpressionsImpl {
    ...
    // 'outputConversion' attribute on TextCell (id=AverageTime_Cell) at ProfilerResultsCV.QuerySpelunker.pcf: line 71, column 49
    function outputConversion_29 (VALUE :  java.lang.Double) : java.lang.String {
      return formatAverage(VALUE)
    }
    
    // 'value' attribute on TextCell (id=ArgsCount_Cell) at ProfilerResultsCV.QuerySpelunker.pcf: line 49, column 50
    function valueRoot_21 () : java.lang.Object {
      return aggregatedQuerySummary
    }
    
    // 'value' attribute on TextCell (id=QueryText_Cell) at ProfilerResultsCV.QuerySpelunker.pcf: line 43, column 75
    ...
    // 'value' attribute on TextCell (id=Executions_Cell) at ProfilerResultsCV.QuerySpelunker.pcf: line 57, column 50
    function value_23 () : java.lang.Integer {
      return aggregatedQuerySummary.ExecutionCount
    }
    
    // 'value' attribute on TextCell (id=TotalTime_Cell) at ProfilerResultsCV.QuerySpelunker.pcf: line 65, column 50
    function value_26 () : java.lang.Integer {
      return aggregatedQuerySummary.TotalTime
    }
    
    // 'value' attribute on TextCell (id=AverageTime_Cell) at ProfilerResultsCV.QuerySpelunker.pcf: line 71, column 49
    function value_30 () : java.lang.Double {
      return aggregatedQuerySummary.AverageTime
    }
    
    // 'value' attribute on TextCell (id=TotalRowCount_Cell) at ProfilerResultsCV.QuerySpelunker.pcf: line 79, column 50
    function value_33 () : java.lang.Integer {
      return aggregatedQuerySummary.TotalRowCount
    }
    
    // 'value' attribute on TextCell (id=AverageRowCount_Cell) at ProfilerResultsCV.QuerySpelunker.pcf: line 85, column 49
    function value_37 () : java.lang.Double {

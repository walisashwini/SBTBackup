...
class ProfilerResultsCV_StacksGroupedExpressions {
  ...
  public static class IteratorEntry2ExpressionsImpl extends ListDetailPanelExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=name_Cell) at ProfilerResultsCV.StacksGrouped.pcf: line 81, column 63
    ...
    // 'value' attribute on TextCell (id=time_Cell) at ProfilerResultsCV.StacksGrouped.pcf: line 86, column 54
  ...
  public static class IteratorEntryExpressionsImpl extends ListDetailPanelExpressionsImpl {
    ...
    // 'label' attribute on TextCell (id=count_Cell) at ProfilerResultsCV.StacksGrouped.pcf: line 39, column 50
    function label_14 () : java.lang.Object {
      return "# " + DisplayKey.get("Web.Profiler.Stacks")
    }
    
    // 'label' attribute on TextCell (id=total_Cell) at ProfilerResultsCV.StacksGrouped.pcf: line 44, column 50
    function label_19 () : java.lang.Object {
      return "Total " + DisplayKey.get("Web.Profiler.ElapsedTime")
    }
    
    // 'label' attribute on TextCell (id=average_Cell) at ProfilerResultsCV.StacksGrouped.pcf: line 49, column 50
    function label_24 () : java.lang.Object {
      return "Ave " + DisplayKey.get("Web.Profiler.ElapsedTime")
    }
    
    // 'label' attribute on TextCell (id=min_Cell) at ProfilerResultsCV.StacksGrouped.pcf: line 54, column 50
    function label_29 () : java.lang.Object {
      return "Min " + DisplayKey.get("Web.Profiler.ElapsedTime")
    }
    
    // 'label' attribute on TextCell (id=max_Cell) at ProfilerResultsCV.StacksGrouped.pcf: line 59, column 50
    function label_34 () : java.lang.Object {
      return "Max " + DisplayKey.get("Web.Profiler.ElapsedTime")
    }
    
    // 'value' attribute on TextCell (id=StackName_Cell) at ProfilerResultsCV.StacksGrouped.pcf: line 34, column 51
    ...
    // 'value' attribute on TextCell (id=count_Cell) at ProfilerResultsCV.StacksGrouped.pcf: line 39, column 50
    function value_15 () : java.lang.Integer {
      return stackSummary.StackCount
    }
    
    // 'value' attribute on TextCell (id=total_Cell) at ProfilerResultsCV.StacksGrouped.pcf: line 44, column 50
    function value_20 () : java.lang.Integer {
      return stackSummary.TotalElapsed
    }
    
    // 'value' attribute on TextCell (id=average_Cell) at ProfilerResultsCV.StacksGrouped.pcf: line 49, column 50
    function value_25 () : java.lang.Integer {
      return stackSummary.AverageElapsed
    }
    
    // 'value' attribute on TextCell (id=min_Cell) at ProfilerResultsCV.StacksGrouped.pcf: line 54, column 50
    function value_30 () : java.lang.Integer {
      return stackSummary.MinElapsed
    }
    
    // 'value' attribute on TextCell (id=max_Cell) at ProfilerResultsCV.StacksGrouped.pcf: line 59, column 50

...
class QuerySummaryLDVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends QuerySummaryLDVExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=QueryTime_Cell) at QuerySummaryLDV.pcf: line 46, column 46
    function valueRoot_13 () : java.lang.Object {
      return querySummary
    }
    
    // 'value' attribute on TextCell (id=Args_Cell) at QuerySummaryLDV.pcf: line 38, column 54
    ...
    // 'value' attribute on TextCell (id=TotalRowCount_Cell) at QuerySummaryLDV.pcf: line 54, column 46
    function value_15 () : java.lang.Integer {
      return querySummary.RowCount
    }
    
    // 'value' attribute on TextCell (id=CallStack_Cell) at QuerySummaryLDV.pcf: line 34, column 62
  ...
  public static class QuerySummaryLDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function renderCall_19 (__writer :  java.io.Writer, __escaper :  gw.lang.parser.template.StringEscaper, __helper :  gw.api.web.template.TemplatePanelHelper) : void {
    ...
    function renderCall_20 (__writer :  java.io.Writer, __escaper :  gw.lang.parser.template.StringEscaper, __helper :  gw.api.web.template.TemplatePanelHelper) : void {
    ...
    function renderCall_21 (__writer :  java.io.Writer, __escaper :  gw.lang.parser.template.StringEscaper, __helper :  gw.api.web.template.TemplatePanelHelper) : void {
    ...
    function renderCall_22 (__writer :  java.io.Writer, __escaper :  gw.lang.parser.template.StringEscaper, __helper :  gw.api.web.template.TemplatePanelHelper) : void {
      pcfc.expressions.QuerySummaryLDV_TemplatePanel4.render(__writer, __escaper, SelectedQuerySummary, __helper)
    }
    ...
    function renderCall_23 (__writer :  java.io.Writer, __escaper :  gw.lang.parser.template.StringEscaper, __helper :  gw.api.web.template.TemplatePanelHelper) : void {
      pcfc.expressions.QuerySummaryLDV_TemplatePanel5.render(__writer, __escaper, SelectedQuerySummary, __helper)
    }

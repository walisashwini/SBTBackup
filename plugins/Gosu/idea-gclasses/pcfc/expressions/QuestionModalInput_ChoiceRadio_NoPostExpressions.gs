...
class QuestionModalInput_ChoiceRadio_NoPostExpressions {
  @javax.annotation.Generated("config/web/pcf/shared/question/QuestionModalInput.ChoiceRadio_NoPost.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class QuestionModalInputExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RangeRadioCell (id=ChoiceRadioInput_NoPost_Cell) at QuestionModalInput.ChoiceRadio_NoPost.pcf: line 24, column 20
    function defaultSetter_2 (__VALUE_TO_SET :  java.lang.Object) : void {
      answerContainer.getAnswer(question).ChoiceAnswer = (__VALUE_TO_SET as gw.api.productmodel.QuestionChoice)
    }
    
    // 'required' attribute on RangeRadioCell (id=ChoiceRadioInput_NoPost_Cell) at QuestionModalInput.ChoiceRadio_NoPost.pcf: line 24, column 20
    function required_0 () : java.lang.Boolean {
      return question.Required
    }
    
    // 'valueRange' attribute on RangeRadioCell (id=ChoiceRadioInput_NoPost_Cell) at QuestionModalInput.ChoiceRadio_NoPost.pcf: line 24, column 20

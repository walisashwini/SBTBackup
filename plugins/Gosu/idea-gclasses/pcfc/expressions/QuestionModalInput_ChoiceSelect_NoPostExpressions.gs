...
@javax.annotation.Generated("config/web/pcf/shared/question/QuestionModalInput.ChoiceSelect_NoPost.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class QuestionModalInput_ChoiceSelect_NoPostExpressions {
  @javax.annotation.Generated("config/web/pcf/shared/question/QuestionModalInput.ChoiceSelect_NoPost.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class QuestionModalInputExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RangeCell (id=ChoiceSelectInput_NoPost_Cell) at QuestionModalInput.ChoiceSelect_NoPost.pcf: line 24, column 20
    function defaultSetter_2 (__VALUE_TO_SET :  java.lang.Object) : void {
      answerContainer.getAnswer(question).ChoiceAnswer = (__VALUE_TO_SET as gw.api.productmodel.QuestionChoice)
    }
    
    // 'required' attribute on RangeCell (id=ChoiceSelectInput_NoPost_Cell) at QuestionModalInput.ChoiceSelect_NoPost.pcf: line 24, column 20
    function required_0 () : java.lang.Boolean {
      return question.Required
    }
    
    // 'valueRange' attribute on RangeCell (id=ChoiceSelectInput_NoPost_Cell) at QuestionModalInput.ChoiceSelect_NoPost.pcf: line 24, column 20
    ...
    // 'value' attribute on RangeCell (id=ChoiceSelectInput_NoPost_Cell) at QuestionModalInput.ChoiceSelect_NoPost.pcf: line 24, column 20
    function value_1 () : gw.api.productmodel.QuestionChoice {
      return answerContainer.getAnswer(question).ChoiceAnswer
    }
    
    // 'valueRange' attribute on RangeCell (id=ChoiceSelectInput_NoPost_Cell) at QuestionModalInput.ChoiceSelect_NoPost.pcf: line 24, column 20
    function verifyValueRangeIsAllowedType_5 ($$arg :  gw.api.productmodel.QuestionChoice[]) : void {

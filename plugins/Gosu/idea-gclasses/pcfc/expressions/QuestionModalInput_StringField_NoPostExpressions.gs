...
class QuestionModalInput_StringField_NoPostExpressions {
  ...
  public static class QuestionModalInputExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=StringFieldInput_NoPost_Cell) at QuestionModalInput.StringField_NoPost.pcf: line 22, column 20
    function defaultSetter_2 (__VALUE_TO_SET :  java.lang.Object) : void {
      answerContainer.getAnswer(question).TextAnswer = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'required' attribute on TextCell (id=StringFieldInput_NoPost_Cell) at QuestionModalInput.StringField_NoPost.pcf: line 22, column 20

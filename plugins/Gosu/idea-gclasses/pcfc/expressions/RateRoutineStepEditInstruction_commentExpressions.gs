...
class RateRoutineStepEditInstruction_commentExpressions {
  @javax.annotation.Generated("config/web/pcf/admin/rating/RateRoutineStepEditInstruction.comment.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class RateRoutineStepEditInstructionExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on MenuItemSetRef at RateRoutineStepEditInstruction.comment.pcf: line 33, column 109
    ...
    // 'outputConversion' attribute on TextCell (id=RateRoutineStepEditInstructionForComment_Cell) at RateRoutineStepEditInstruction.comment.pcf: line 31, column 86

...
@javax.annotation.Generated("config/web/pcf/admin/rating/RateTableFactorModalCell.large.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class RateTableFactorModalCell_largeExpressions {
  @javax.annotation.Generated("config/web/pcf/admin/rating/RateTableFactorModalCell.large.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class RateTableFactorModalCellExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=ValueCell_Cell) at RateTableFactorModalCell.large.pcf: line 26, column 65
    function defaultSetter_4 (__VALUE_TO_SET :  java.lang.Object) : void {
      cell.Value = (__VALUE_TO_SET as java.lang.Comparable<java.lang.Object>)
    }
    
    // 'inputConversion' attribute on TextCell (id=ValueCell_Cell) at RateTableFactorModalCell.large.pcf: line 26, column 65
    function inputConversion_0 (VALUE :  java.lang.String) : java.lang.Object {
      return VALUE
    }
    
    // 'outputConversion' attribute on TextCell (id=ValueCell_Cell) at RateTableFactorModalCell.large.pcf: line 26, column 65
    function outputConversion_1 (VALUE :  java.lang.Comparable<java.lang.Object>) : java.lang.String {
      return cell.DisplayValue
    }
    
    // 'required' attribute on TextCell (id=ValueCell_Cell) at RateTableFactorModalCell.large.pcf: line 26, column 65

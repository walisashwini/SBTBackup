...
@javax.annotation.Generated("config/web/pcf/admin/rating/RateTableModalCell.selectwithrefresh.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class RateTableModalCell_selectwithrefreshExpressions {
  @javax.annotation.Generated("config/web/pcf/admin/rating/RateTableModalCell.selectwithrefresh.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class RateTableModalCellExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'available' attribute on RangeCell (id=ValueCell_Cell) at RateTableModalCell.selectwithrefresh.pcf: line 27, column 64
    function available_0 () : java.lang.Boolean {
      return cell.checkAvailable(valueProvider)
    }
    
    // 'value' attribute on RangeCell (id=ValueCell_Cell) at RateTableModalCell.selectwithrefresh.pcf: line 27, column 64
    function defaultSetter_3 (__VALUE_TO_SET :  java.lang.Object) : void {
      cell.Value = (__VALUE_TO_SET as java.lang.Comparable<java.lang.Object>)
    }
    
    // 'optionLabel' attribute on RangeCell (id=ValueCell_Cell) at RateTableModalCell.selectwithrefresh.pcf: line 27, column 64
    ...
    // 'required' attribute on RangeCell (id=ValueCell_Cell) at RateTableModalCell.selectwithrefresh.pcf: line 27, column 64
    function required_1 () : java.lang.Boolean {
      return valueRequired
    }
    
    // 'valueRange' attribute on RangeCell (id=ValueCell_Cell) at RateTableModalCell.selectwithrefresh.pcf: line 27, column 64

...
class RegionSearchDVExpressions {
  ...
  public static class RegionSearchDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'autoComplete' attribute on TextInput (id=Code_Input) at RegionSearchDV.pcf: line 41, column 42
    function autoComplete_19 () : gw.api.contact.AutocompleteHandler {
      return zoneHandler
    }
    ...
    // 'value' attribute on TextInput (id=Code_Input) at RegionSearchDV.pcf: line 41, column 42
    function defaultSetter_17 (__VALUE_TO_SET :  java.lang.Object) : void {
      SearchCriteria.ZoneCode = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextInput (id=Name_Input) at RegionSearchDV.pcf: line 24, column 44
    function defaultSetter_3 (__VALUE_TO_SET :  java.lang.Object) : void {
      SearchCriteria.RegionName = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on RangeInput (id=zoneType_Input) at RegionSearchDV.pcf: line 33, column 39
    function defaultSetter_8 (__VALUE_TO_SET :  java.lang.Object) : void {
      SearchCriteria.ZoneType = (__VALUE_TO_SET as typekey.ZoneType)
    }
    
    // 'editable' attribute on RangeInput (id=zoneType_Input) at RegionSearchDV.pcf: line 33, column 39
    ...
    // 'valueRange' attribute on RangeInput (id=zoneType_Input) at RegionSearchDV.pcf: line 33, column 39
    ...
    // 'valueRange' attribute on RangeInput (id=zoneType_Input) at RegionSearchDV.pcf: line 33, column 39
    function verifyValueRangeIsAllowedType_11 ($$arg :  typekey.ZoneType[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }

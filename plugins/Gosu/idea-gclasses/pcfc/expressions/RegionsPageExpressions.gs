...
class RegionsPageExpressions {
  ...
  public static class RegionsPageExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'visible' attribute on Verbatim at RegionsPage.pcf: line 21, column 97
  ...
  public static class SearchPanelExpressionsImpl extends RegionsPageExpressionsImpl {
    ...
    // 'action' attribute on ToolbarButton (id=Regions_AddRegionButton) at RegionsPage.pcf: line 46, column 29
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=Regions_DeleteButton) at RegionsPage.pcf: line 54, column 45
    ...
    // 'def' attribute on PanelRef at RegionsPage.pcf: line 35, column 61
    function def_onEnter_11 (def :  pcf.RegionSearchResultsLV) : void {
      def.onEnter(allRegions,true,true)
    }
    
    // 'def' attribute on PanelRef at RegionsPage.pcf: line 33, column 52
    ...
    // 'searchCriteria' attribute on SearchPanel at RegionsPage.pcf: line 30, column 76
    function searchCriteria_14 () : gw.api.admin.RegionSearchCriteria {
      return new gw.api.admin.RegionSearchCriteria()
    }
    
    // 'search' attribute on SearchPanel at RegionsPage.pcf: line 30, column 76
    function search_13 () : java.lang.Object {
      return SearchCriteria.performSearch() as gw.api.database.IQueryBeanResult<Region>
    }
    
    // 'visible' attribute on Toolbar (id=RegionSearchResultsLV_tb) at RegionsPage.pcf: line 41, column 100
    function visible_10 () : java.lang.Boolean {
      return gw.api.admin.BaseAdminUtil.getRegionZoneTypesForDefaultCountry().length != 0
    }
    
    // 'visible' attribute on PanelRef at RegionsPage.pcf: line 33, column 52
    function visible_2 () : java.lang.Boolean {
      return uiHelper.searchPanelVisible()
    }
    
    // 'visible' attribute on CheckedValuesToolbarButton (id=Regions_DeleteButton) at RegionsPage.pcf: line 54, column 45

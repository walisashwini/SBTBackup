...
class ReinstatementWizard_MultiLine_QuoteScreen_CommercialPackageExpressions {
  @javax.annotation.Generated("config/web/pcf/job/reinstatement/ReinstatementWizard_MultiLine_QuoteScreen.CommercialPackage.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ReinstatementWizard_MultiLine_QuoteScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=ReinstateQuote) at ReinstatementWizard_MultiLine_QuoteScreen.CommercialPackage.pcf: line 31, column 23
    ...
    // 'def' attribute on PanelRef at ReinstatementWizard_MultiLine_QuoteScreen.CommercialPackage.pcf: line 35, column 45
    ...
    // 'mode' attribute on ToolbarButtonSetRef at ReinstatementWizard_MultiLine_QuoteScreen.CommercialPackage.pcf: line 25, column 101
    function mode_0 () : java.lang.Object {
      return policyPeriod.Job.Subtype
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at ReinstatementWizard_MultiLine_QuoteScreen.CommercialPackage.pcf: line 25, column 101

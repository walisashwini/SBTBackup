...
class ReloadExpressions {
  ...
  public static class ReloadExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ButtonInput (id=PCF_Input) at Reload.pcf: line 23, column 79
    function action_1 () : void {
      gw.api.tools.InternalToolsUtil.reloadPCFsAndCurrentLocation()
    }
    
    // 'action' attribute on ButtonInput (id=GSTemplates_Input) at Reload.pcf: line 29, column 87
    function action_2 () : void {
      gw.api.tools.InternalToolsUtil.reloadUI()
    }
    
    // 'action' attribute on ButtonInput (id=WorkflowEngine_Input) at Reload.pcf: line 35, column 90
    function action_3 () : void {
      gw.api.tools.InternalToolsUtil.reloadWorkflowEngine()
    }
    
    // 'action' attribute on ButtonInput (id=DisplayNames_Input) at Reload.pcf: line 41, column 88

...
class RenewalWizard_PolicyInfoScreenExpressions {
  @javax.annotation.Generated("config/web/pcf/job/renewal/RenewalWizard_PolicyInfoScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class RenewalWizard_PolicyInfoScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at RenewalWizard_PolicyInfoScreen.pcf: line 31, column 52
    function def_onEnter_20 (def :  pcf.OOSEPanelSet) : void {
      def.onEnter(period, jobWizardHelper)
    }
    
    // 'def' attribute on PanelRef at RenewalWizard_PolicyInfoScreen.pcf: line 33, column 71
    function def_onEnter_22 (def :  pcf.RenewalWizard_PolicyInfoDV) : void {
      def.onEnter(period, renewal, openForEdit)
    }
    ...
    // 'def' attribute on PanelRef at RenewalWizard_PolicyInfoScreen.pcf: line 33, column 71
    function def_refreshVariables_23 (def :  pcf.RenewalWizard_PolicyInfoDV) : void {
      def.refreshVariables(period, renewal, openForEdit)
    }
    
    // 'editable' attribute on Screen (id=RenewalWizard_PolicyInfoScreen) at RenewalWizard_PolicyInfoScreen.pcf: line 7, column 41
    function editable_24 () : java.lang.Boolean {
      return openForEdit
    }
    
    // 'mode' attribute on ToolbarButtonSetRef at RenewalWizard_PolicyInfoScreen.pcf: line 24, column 89
    function mode_0 () : java.lang.Object {
      return period.Job.Subtype
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at RenewalWizard_PolicyInfoScreen.pcf: line 24, column 89
    function toolbarButtonSet_onEnter_1 (def :  pcf.JobWizardToolbarButtonSet_Audit) : void {
      def.onEnter(period, renewal, jobWizardHelper)
    }
    ...
    function toolbarButtonSet_refreshVariables_10 (def :  pcf.JobWizardToolbarButtonSet_Reinstatement) : void {
      def.refreshVariables(period, renewal, jobWizardHelper)
    }
    ...
    // 'visible' attribute on AlertBar (id=QuoteRequestedAlert) at RenewalWizard_PolicyInfoScreen.pcf: line 29, column 74

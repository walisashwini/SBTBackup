...
class RewriteWizard_MultiLine_QuoteScreen_CommercialPackageExpressions {
  @javax.annotation.Generated("config/web/pcf/job/rewrite/RewriteWizard_MultiLine_QuoteScreen.CommercialPackage.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class RewriteWizard_MultiLine_QuoteScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=CreateRewriteQuote) at RewriteWizard_MultiLine_QuoteScreen.CommercialPackage.pcf: line 31, column 23
    function action_19 () : void {
      policyPeriod.printDocument("RewriteQuote", "Rewrite Quote", gw.api.web.document.DocumentsHelper.PrintQuoteParameters)
    }
    
    // 'def' attribute on PanelRef at RewriteWizard_MultiLine_QuoteScreen.CommercialPackage.pcf: line 35, column 45
    ...
    // 'mode' attribute on ToolbarButtonSetRef at RewriteWizard_MultiLine_QuoteScreen.CommercialPackage.pcf: line 25, column 91
    function mode_0 () : java.lang.Object {
      return policyPeriod.Job.Subtype
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at RewriteWizard_MultiLine_QuoteScreen.CommercialPackage.pcf: line 25, column 91

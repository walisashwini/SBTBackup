...
class RunCommandPopupExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends RunCommandPopupExpressionsImpl {
    ...
    property get arg () : gw.command.Argument<java.lang.Object> {
      return getIteratedValue(1) as gw.command.Argument<java.lang.Object>
    }
  ...
  public static class RunCommandPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    static function __constructorIndex (command :  gw.command.BaseCommand, methodInfo :  gw.lang.reflect.IMethodInfo) : int {
      return 0
    }
    ...
    static function title_9 (command :  gw.command.BaseCommand, methodInfo :  gw.lang.reflect.IMethodInfo) : java.lang.Object {
      return "Parameters for " + methodInfo.Name
    }
    
    // 'value' attribute on RowIterator at RunCommandPopup.pcf: line 34, column 89
    function value_7 () : java.util.List<gw.command.Argument<java.lang.Object>> {
    ...
    property get command () : gw.command.BaseCommand {
      return getVariableValue("command", 0) as gw.command.BaseCommand
    }
    
    property set command ($arg :  gw.command.BaseCommand) {

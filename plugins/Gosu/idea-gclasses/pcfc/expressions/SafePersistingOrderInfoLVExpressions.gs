...
class SafePersistingOrderInfoLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends SafePersistingOrderInfoLVExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=order_Cell) at SafePersistingOrderInfoLV.pcf: line 29, column 42
    function valueRoot_7 () : java.lang.Object {
      return pair
    }
    
    // 'value' attribute on TextCell (id=Table_Cell) at SafePersistingOrderInfoLV.pcf: line 37, column 35
    function value_12 () : java.lang.String {
      return pair.TableName
    }
    
    // 'value' attribute on BooleanRadioCell (id=PreUpdateRules_Cell) at SafePersistingOrderInfoLV.pcf: line 41, column 34
    ...
    // 'value' attribute on TextCell (id=Name_Cell) at SafePersistingOrderInfoLV.pcf: line 33, column 36

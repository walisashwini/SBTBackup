...
class ServerToolsExpressions {
  ...
  public static class ServerToolsExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'location' attribute on LocationGroup (id=ServerTools) at ServerTools.pcf: line 36, column 38
    ...
    static function canVisit_108 () : java.lang.Boolean {
      return perm.User.ServerTools or perm.User.DevAllAccess
    }
    
    // LocationGroup (id=ServerTools) at ServerTools.pcf: line 10, column 26
    static function firstVisitableChildDestinationMethod_113 () : pcf.api.Destination {
      ...
      dest = pcf.ProductModelInfo.createDestination()
      if (dest.canVisitSelf()) {
        return dest
      }
      return null
    ...
    function menuActions_onEnter_109 (def :  pcf.InternalToolsMenuActions) : void {
      def.onEnter()
    }
    
    // 'menuActions' attribute on LocationGroup (id=ServerTools) at ServerTools.pcf: line 10, column 26
    function menuActions_refreshVariables_110 (def :  pcf.InternalToolsMenuActions) : void {
      def.refreshVariables()
    }
    
    // 'tabBar' attribute on LocationGroup (id=ServerTools) at ServerTools.pcf: line 10, column 26
    function tabBar_onEnter_111 (def :  pcf.InternalToolsTabBar) : void {
      def.onEnter()
    }
    
    // 'tabBar' attribute on LocationGroup (id=ServerTools) at ServerTools.pcf: line 10, column 26
    function tabBar_refreshVariables_112 (def :  pcf.InternalToolsTabBar) : void {
      def.refreshVariables()
    }

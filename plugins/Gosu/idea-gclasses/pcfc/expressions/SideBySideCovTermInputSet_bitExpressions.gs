...
class SideBySideCovTermInputSet_bitExpressions {
  @javax.annotation.Generated("config/web/pcf/shared/coverage/SideBySideCovTermInputSet.bit.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class SideBySideCovTermInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'colspan' attribute on LayoutConfig at SideBySideCovTermInputSet.bit.pcf: line 48, column 95
    function colspan_13 () : java.lang.Integer {
      return colWidth
    }
    
    // 'value' attribute on BooleanRadioInput (id=SideBySideBooleanCovTermValue_Input) at SideBySideCovTermInputSet.bit.pcf: line 45, column 40
    function defaultSetter_20 (__VALUE_TO_SET :  java.lang.Object) : void {
      covTermInfo.BooleanValue = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'value' attribute on CheckBoxInput (id=covTermEnabledId_Input) at SideBySideCovTermInputSet.bit.pcf: line 23, column 28
    function defaultSetter_5 (__VALUE_TO_SET :  java.lang.Object) : void {
      covTermInfo.CovInfo.Selected = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'disablePostOnEnter' attribute on PostOnChange at SideBySideCovTermInputSet.bit.pcf: line 51, column 68
    ...
    // 'editable' attribute on BooleanRadioInput (id=SideBySideBooleanCovTermValue_Input) at SideBySideCovTermInputSet.bit.pcf: line 45, column 40
    function editable_17 () : java.lang.Boolean {
      return covTermInfo.CovInfo.PeriodInfo.SxSEditable and covTermInfo.Editable
    }
    
    // 'editable' attribute on CheckBoxInput (id=covTermEnabledId_Input) at SideBySideCovTermInputSet.bit.pcf: line 23, column 28
    ...
    // 'onChange' attribute on PostOnChange at SideBySideCovTermInputSet.bit.pcf: line 28, column 68
    function onChange_1 () : void {
      covTermInfo.CovInfo.coverageSelectionRefresh()
    }
    
    // 'onChange' attribute on PostOnChange at SideBySideCovTermInputSet.bit.pcf: line 51, column 68
    function onChange_16 () : void {
      covTermInfo.CovInfo.coverageSelectionRefresh()
    }
    
    // 'tdClass' attribute on LayoutConfig at SideBySideCovTermInputSet.bit.pcf: line 25, column 95
    function tdClass_0 () : java.lang.String {
      return "pc-sxs-col-" + (covTermInfo.CovInfo.PeriodInfo.ColumnIndex % 2)
    }
    
    // 'validationExpression' attribute on BooleanRadioInput (id=SideBySideBooleanCovTermValue_Input) at SideBySideCovTermInputSet.bit.pcf: line 45, column 40
    ...
    // 'visible' attribute on TextInput (id=bitSpacer_Input) at SideBySideCovTermInputSet.bit.pcf: line 35, column 29
    function visible_11 () : java.lang.Boolean {
      return !selectable
    }
    
    // 'visible' attribute on CheckBoxInput (id=covTermEnabledId_Input) at SideBySideCovTermInputSet.bit.pcf: line 23, column 28

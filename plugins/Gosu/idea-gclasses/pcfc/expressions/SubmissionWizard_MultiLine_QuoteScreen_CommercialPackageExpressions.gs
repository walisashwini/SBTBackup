...
class SubmissionWizard_MultiLine_QuoteScreen_CommercialPackageExpressions {
  @javax.annotation.Generated("config/web/pcf/job/submission/SubmissionWizard_MultiLine_QuoteScreen.CommercialPackage.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class SubmissionWizard_MultiLine_QuoteScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=CreateSubmissionQuote) at SubmissionWizard_MultiLine_QuoteScreen.CommercialPackage.pcf: line 30, column 23
    function action_19 () : void {
      policyPeriod.printDocument("SubmissionQuote", "Submission Quote", gw.api.web.document.DocumentsHelper.PrintQuoteParameters)
    }
    
    // 'def' attribute on PanelRef at SubmissionWizard_MultiLine_QuoteScreen.CommercialPackage.pcf: line 34, column 45
    ...
    // 'mode' attribute on ToolbarButtonSetRef at SubmissionWizard_MultiLine_QuoteScreen.CommercialPackage.pcf: line 24, column 98
    function mode_0 () : java.lang.Object {
      return policyPeriod.Job.Subtype
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at SubmissionWizard_MultiLine_QuoteScreen.CommercialPackage.pcf: line 24, column 98

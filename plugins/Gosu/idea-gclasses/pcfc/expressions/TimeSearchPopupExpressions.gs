...
class TimeSearchPopupExpressions {
  ...
  public static class TimeSearchPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on DateInput (id=StartTime_Input) at TimeSearchPopup.pcf: line 35, column 32
    function defaultSetter_3 (__VALUE_TO_SET :  java.lang.Object) : void {
      beginTime = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on DateInput (id=EndTime_Input) at TimeSearchPopup.pcf: line 45, column 30
    function defaultSetter_6 (__VALUE_TO_SET :  java.lang.Object) : void {
      endTime = (__VALUE_TO_SET as java.util.Date)
    }
    
    // EditButtons at TimeSearchPopup.pcf: line 24, column 111
    function label_1 () : java.lang.Object {
      return gw.api.util.LocationUtil.hasOwnBundle(CurrentLocation) ? DisplayKey.get("Button.Update") : DisplayKey.get("Button.OK")
    }
    
    // 'pickValue' attribute on EditButtons at TimeSearchPopup.pcf: line 24, column 111

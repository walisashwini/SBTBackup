...
class UpdateStatsLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends UpdateStatsLVExpressionsImpl {
    ...
    // 'action' attribute on Link (id=LVGetZip) at UpdateStatsLV.pcf: line 33, column 44
    function action_1 () : void {
      PageHelper.downloadDatabaseUpdateStats(Row)
    }
    
    // 'action' attribute on Link (id=LVDelete) at UpdateStatsLV.pcf: line 46, column 44
    function action_3 () : void {
      PageHelper.deleteDatabaseUpdateStats(Row)
    }
    
    // 'value' attribute on TextCell (id=LVDescription_Cell) at UpdateStatsLV.pcf: line 52, column 36
    function valueRoot_5 () : java.lang.Object {
      return Row
    }
    
    // 'value' attribute on DateCell (id=LVStartTime_Cell) at UpdateStatsLV.pcf: line 64, column 34
    function value_10 () : java.util.Date {
      return Row.StartTime
    }
    
    // 'value' attribute on DateCell (id=LVEndTime_Cell) at UpdateStatsLV.pcf: line 71, column 32
    ...
    // 'value' attribute on BooleanRadioCell (id=LVIncremental_Cell) at UpdateStatsLV.pcf: line 57, column 36
    function value_7 () : java.lang.Boolean {
      return Row.Incremental
    }
    
    // 'visible' attribute on Link (id=LVGetZip) at UpdateStatsLV.pcf: line 33, column 44

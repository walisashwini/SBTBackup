...
class UploadDocumentScreenExpressions {
  ...
  public static class UploadDocumentScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=EditDocumentCreationInfo) at UploadDocumentScreen.pcf: line 64, column 41
    function allCheckedRowsAction_10 (CheckedValues :  gw.document.DocumentCreationInfo[], CheckedValuesErrors :  java.util.Map) : void {
    ...
    // 'def' attribute on PanelRef at UploadDocumentScreen.pcf: line 53, column 54
    function def_onEnter_12 (def :  pcf.DocumentDetailsEditLVPanelSet) : void {
      def.onEnter(DocumentApplicationContext,DocumentCreationInfos)
    }
    
    // 'def' attribute on PanelRef at UploadDocumentScreen.pcf: line 53, column 54
    function def_refreshVariables_13 (def :  pcf.DocumentDetailsEditLVPanelSet) : void {
      def.refreshVariables(DocumentApplicationContext,DocumentCreationInfos)
    }
    
    // 'value' attribute on FileInput (id=FileInput_Input) at UploadDocumentScreen.pcf: line 45, column 37

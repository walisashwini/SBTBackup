...
class UserPreferencesInputSetExpressions {
  ...
  public static class UserPreferencesInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyInput (id=DefaultCountry_Input) at UserPreferencesInputSet.pcf: line 29, column 36
    function defaultSetter_13 (__VALUE_TO_SET :  java.lang.Object) : void {
      user.UserDefaultCountry = (__VALUE_TO_SET as typekey.Country)
    }
    
    // 'value' attribute on TypeKeyInput (id=DefaultPhoneCountry_Input) at UserPreferencesInputSet.pcf: line 35, column 45
    function defaultSetter_17 (__VALUE_TO_SET :  java.lang.Object) : void {
      user.UserDefaultPhoneCountry = (__VALUE_TO_SET as typekey.PhoneCountryCode)
    }
    
    // 'value' attribute on TypeKeyInput (id=Language_Input) at UserPreferencesInputSet.pcf: line 16, column 61
    function defaultSetter_2 (__VALUE_TO_SET :  java.lang.Object) : void {
      user.UserLanguage = (__VALUE_TO_SET as typekey.LanguageType)
    }
    
    // 'value' attribute on TypeKeyInput (id=RegionalFormats_Input) at UserPreferencesInputSet.pcf: line 23, column 59
    ...
    // 'visible' attribute on TypeKeyInput (id=Language_Input) at UserPreferencesInputSet.pcf: line 16, column 61
    function visible_0 () : java.lang.Boolean {
      return gw.api.util.LocaleUtil.canSwitchLanguage()
    }
    
    // 'visible' attribute on TypeKeyInput (id=RegionalFormats_Input) at UserPreferencesInputSet.pcf: line 23, column 59

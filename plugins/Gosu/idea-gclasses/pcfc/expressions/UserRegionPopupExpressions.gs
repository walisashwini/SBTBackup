...
class UserRegionPopupExpressions {
  @javax.annotation.Generated("config/web/pcf/admin/users/UserRegionPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class SearchPanelExpressionsImpl extends UserRegionPopupExpressionsImpl {
    ...
    // 'def' attribute on PanelRef at UserRegionPopup.pcf: line 19, column 49
    function def_onEnter_0 (def :  pcf.RegionSearchDV) : void {
      def.onEnter(SearchCriteria)
    }
    
    // 'def' attribute on PanelRef at UserRegionPopup.pcf: line 21, column 66
    ...
    // 'pickValue' attribute on CheckedValuesToolbarButton (id=UserRegionPopup_SelectButton) at UserRegionPopup.pcf: line 30, column 42
    function pickValue_2 (CheckedValues :  entity.Region[]) : Region[] {
      return CheckedValues
    }
    
    // 'searchCriteria' attribute on SearchPanel at UserRegionPopup.pcf: line 17, column 76
    function searchCriteria_6 () : gw.api.admin.RegionSearchCriteria {
      return new gw.api.admin.RegionSearchCriteria()
    }
    
    // 'search' attribute on SearchPanel at UserRegionPopup.pcf: line 17, column 76
  ...
  @javax.annotation.Generated("config/web/pcf/admin/users/UserRegionPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class UserRegionPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    public construct(widget :  Object) {
      super(widget, 0)
    }
    ...
    override property get CurrentLocation () : pcf.UserRegionPopup {
      return super.CurrentLocation as pcf.UserRegionPopup
    }

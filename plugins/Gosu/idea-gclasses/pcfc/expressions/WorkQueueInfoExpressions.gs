...
class WorkQueueInfoExpressions {
  ...
  public static class DetailViewPanelExpressionsImpl extends WorkQueueInfoExpressionsImpl {
    ...
    // 'value' attribute on TextInput (id=maximumPoolSize_Input) at WorkQueueInfo.pcf: line 38, column 44
    ...
    // 'value' attribute on TextInput (id=poolSize_Input) at WorkQueueInfo.pcf: line 45, column 44
    function value_5 () : java.lang.Integer {
      return PoolInfo.ThreadPoolSize
    }
    
    // 'value' attribute on TextInput (id=activeThreads_Input) at WorkQueueInfo.pcf: line 52, column 44
  ...
  public static class IteratorEntryExpressionsImpl extends ListDetailPanelExpressionsImpl {
    ...
    // 'action' attribute on Link (id=RunWriter) at WorkQueueInfo.pcf: line 134, column 46
    function action_41 () : void {
      SelectedQueue = WorkQueueRow;Page.runWriter(WorkQueueRow)
    }
    
    // 'action' attribute on Link (id=Notify) at WorkQueueInfo.pcf: line 139, column 46
    function action_42 () : void {
      SelectedQueue = WorkQueueRow;Page.notifyWorkers(WorkQueueRow)
    }
    
    // 'action' attribute on Link (id=StopWorkers) at WorkQueueInfo.pcf: line 144, column 46
    function action_43 () : void {
      Page.stopWorkers(WorkQueueRow)
    }
    
    // 'action' attribute on Link (id=RestartWorkers) at WorkQueueInfo.pcf: line 149, column 46
    function action_44 () : void {
      Page.restartWorkers(WorkQueueRow)
    }
    
    // 'action' attribute on Link (id=PrintHistory) at WorkQueueInfo.pcf: line 154, column 46
    function action_45 () : void {
      SelectedQueue = WorkQueueRow; WorkQueueHistoryDownloadConfigurePopup.push(WorkQueueRow);
    }
    
    // 'available' attribute on Link (id=RunWriter) at WorkQueueInfo.pcf: line 134, column 46
    ...
    // 'value' attribute on TextCell (id=WorkQueueName_Cell) at WorkQueueInfo.pcf: line 92, column 65
    function valueRoot_22 () : java.lang.Object {
      return WorkQueueRow.WorkQueueInfo
    }
    
    // 'value' attribute on TextCell (id=numActive_Cell) at WorkQueueInfo.pcf: line 98, column 50
    ...
    // 'value' attribute on TextCell (id=numCheckedOut_Cell) at WorkQueueInfo.pcf: line 104, column 50
    function value_27 () : java.lang.Integer {
      return WorkQueueRow.CheckedOutCount
    }
    
    // 'value' attribute on TextCell (id=numFailed_Cell) at WorkQueueInfo.pcf: line 110, column 50
    function value_30 () : java.lang.Integer {
      return WorkQueueRow.FailedCount
    }
    
    // 'value' attribute on TextCell (id=numExecutorsActive_Cell) at WorkQueueInfo.pcf: line 116, column 50
    function value_33 () : java.lang.Integer {
      return WorkQueueRow.ExecutorsRunning
    }
    
    // 'value' attribute on TextCell (id=startedClusterWide_Cell) at WorkQueueInfo.pcf: line 120, column 175
    ...
    // 'value' attribute on TextCell (id=WriterStatus_Cell) at WorkQueueInfo.pcf: line 124, column 63
    function value_38 () : java.lang.String {
      return Page.getWriterStatus(WorkQueueRow)
    }
    
    // 'visible' attribute on LinkCell (id=NotifyCell) at WorkQueueInfo.pcf: line 128, column 79
  ...
  public static class ListDetailPanelExpressionsImpl extends WorkQueueInfoExpressionsImpl {
    ...
    // 'def' attribute on PanelRef at WorkQueueInfo.pcf: line 169, column 70
    function def_onEnter_50 (def :  pcf.WorkQueueWritersPanelSet) : void {
      def.onEnter(Page, SelectedQueue)
    }
    
    // 'def' attribute on PanelRef at WorkQueueInfo.pcf: line 175, column 72
    function def_onEnter_52 (def :  pcf.WorkQueueExecutorsPanelSet) : void {
      def.onEnter(Page, SelectedQueue)
    }
    
    // 'def' attribute on PanelRef at WorkQueueInfo.pcf: line 181, column 67

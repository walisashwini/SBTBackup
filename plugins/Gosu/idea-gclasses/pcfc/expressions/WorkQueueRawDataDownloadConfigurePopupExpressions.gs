...
class WorkQueueRawDataDownloadConfigurePopupExpressions {
  ...
  public static class WorkQueueRawDataDownloadConfigurePopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ButtonInput (id=download_Input) at WorkQueueRawDataDownloadConfigurePopup.pcf: line 50, column 75
    ...
    // 'value' attribute on DateInput (id=StartDate_Input) at WorkQueueRawDataDownloadConfigurePopup.pcf: line 36, column 36
    function defaultSetter_2 (__VALUE_TO_SET :  java.lang.Object) : void {
      StartDateTime = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on DateInput (id=EndDate_Input) at WorkQueueRawDataDownloadConfigurePopup.pcf: line 44, column 34

...
class WorkersCompCoverageConfigScreenExpressions {
  @javax.annotation.Generated("config/web/pcf/line/wc/policy/WorkersCompCoverageConfigScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class WorkersCompCoverageConfigScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at WorkersCompCoverageConfigScreen.pcf: line 28, column 58
    function def_onEnter_20 (def :  pcf.OOSEPanelSet) : void {
      def.onEnter(policyPeriod, jobWizardHelper)
    }
    
    // 'def' attribute on PanelRef at WorkersCompCoverageConfigScreen.pcf: line 30, column 79
    function def_onEnter_22 (def :  pcf.WorkersCompCoverageCV) : void {
      def.onEnter(policyPeriod.WorkersCompLine, openForEdit)
    }
    ...
    // 'def' attribute on PanelRef at WorkersCompCoverageConfigScreen.pcf: line 30, column 79
    function def_refreshVariables_23 (def :  pcf.WorkersCompCoverageCV) : void {
      def.refreshVariables(policyPeriod.WorkersCompLine, openForEdit)
    }
    
    // 'editable' attribute on Screen (id=WorkersCompCoverageConfigScreen) at WorkersCompCoverageConfigScreen.pcf: line 7, column 42
    function editable_24 () : java.lang.Boolean {
      return openForEdit
    }
    
    // 'mode' attribute on ToolbarButtonSetRef at WorkersCompCoverageConfigScreen.pcf: line 21, column 104
    function mode_0 () : java.lang.Object {
      return policyPeriod.Job.Subtype
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at WorkersCompCoverageConfigScreen.pcf: line 21, column 104
    ...
    // 'visible' attribute on AlertBar (id=QuoteRequestedAlert) at WorkersCompCoverageConfigScreen.pcf: line 26, column 80

...
class WorkflowSearchResultPanelSet_defaultExpressions {
  @javax.annotation.Generated("config/web/pcf/admin/workflow/WorkflowSearchResultPanelSet.default.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class WorkflowSearchResultPanelSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=Workflows_ManageAllButton) at WorkflowSearchResultPanelSet.default.pcf: line 28, column 25
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=Workflows_ManageButton) at WorkflowSearchResultPanelSet.default.pcf: line 22, column 25
    ...
    // 'available' attribute on ToolbarButton (id=Workflows_ManageAllButton) at WorkflowSearchResultPanelSet.default.pcf: line 28, column 25
    function available_1 () : java.lang.Boolean {
      return workflows == null ? false : workflows.getCount() > 0
    }
    
    // 'def' attribute on PanelRef at WorkflowSearchResultPanelSet.default.pcf: line 15, column 42
    function def_onEnter_4 (def :  pcf.WorkflowsLV) : void {
      def.onEnter(workflows, true)
    }
    
    // 'def' attribute on PanelRef at WorkflowSearchResultPanelSet.default.pcf: line 15, column 42
    function def_refreshVariables_5 (def :  pcf.WorkflowsLV) : void {

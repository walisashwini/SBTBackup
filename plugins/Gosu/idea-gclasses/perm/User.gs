...
class User {
  ...
  static property get ViewProductModelInfo () : boolean {
    return com.guidewire._generated.security.UserPermKeys.VIEWPRODUCTMODELINFO.hasPermission(entity.User.util.CurrentUser, null)
  }
